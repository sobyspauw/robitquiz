#!/usr/bin/env python3
"""
Bulk expand quiz files to 100 questions
"""
import os
import glob
import json

def create_expansion_script():
    """Create a Node.js script to expand questions using AI"""
...
"""
    ...
    with open('temp/analyze_expansion_needs.js', 'w', encoding='utf-8') as f:
        f.write(script)

    print("Created analyze_expansion_needs.js")
    print("Run: node temp/analyze_expansion_needs.js")

if __name__ == "__main__":
    create_expansion_script()

    # Also create a list of subjects that need work
    subjects_path = r"C:\Users\rbosch\OneDrive - A.S. Watson Europe\prive\RobitQuiz\src\questions\data\subjects"

    print("\n=== Subjects needing expansion ===")
    for subject in ['famous-people', 'famous-buildings']:
        ...
        if os.path.exists(subject_path):
            ...
            print(f"{subject}: {need_expansion}/{total_files} files need expansion")