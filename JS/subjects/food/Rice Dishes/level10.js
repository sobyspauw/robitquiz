...
(function() {
  const level10 = {
    ...
    questions: [
      {
        question: {
          en: "What is the most commonly consumed type of rice worldwide?",
          es: "¿Cuál es el tipo de arroz más consumido en el mundo?",
          de: "Welche Reisart wird weltweit am häufigsten konsumiert?",
          nl: "Wat is de meest geconsumeerde rijstsoort ter wereld?"
        },
        options: [
        ...
        correct: 0,
        explanation: {
          en: "White rice is the most consumed rice variety globally, accounting for about 80% of rice consumption worldwide.",
          es: "El arroz blanco es la variedad de arroz más consumida a nivel mundial, representando aproximadamente el 80% del consumo de arroz en todo el mundo.",
          de: "Weißer Reis ist die weltweit am meisten konsumierte Reissorte und macht etwa 80% des weltweiten Reiskonsums aus.",
          nl: "Witte rijst is de meest geconsumeerde rijstsoort wereldwijd en vertegenwoordigt ongeveer 80% van de wereldwijde rijstconsumptie."
        }
      },
      {
        question: {
