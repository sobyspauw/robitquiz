  ...
  const level1 = {
    ...
    questions: [
      ...
      },
      {
        question: {
          en: "What is the 'doubling cube' used for in backgammon?",
          es: "¿Para qué se usa el 'cubo de duplicación' en backgammon?",
          de: "Wofür wird der 'Verdopplungswürfel' beim Backgammon verwendet?",
          nl: "Waarvoor wordt de 'verdubbelddobbelsteen' gebruikt in backgammon?"
        },
        options: [
          { en: "Double # of moves", es: "Para duplicar el número de movimientos", de: "Um die Anzahl der Züge zu verdoppeln", nl: "Om het aantal zetten te verdubbelen" },
          { en: "Double game stakes", es: "Para duplicar las apuestas del juego", de: "Um den Einsatz des Spiels zu verdoppeln", nl: "Om de inzet van het spel te verdubbelen" },
          { en: "Roll 2 dice at once", es: "Para lanzar dos dados a la vez", de: "Um zwei Würfel gleichzeitig zu werfen", nl: "Om twee dobbelstenen tegelijk te gooien" },
          { en: "Count pts twice", es: "Para contar puntos dos veces", de: "Um Punkte doppelt zu zählen", nl: "Om punten dubbel te tellen" }
        ],
        correct: 1,
        explanation: {
          en: "The doubling cube is used to increase the stakes of the game. Either player can offer to double the stakes during their turn, and the opponent must accept or forfeit the current game.",
          es: "El cubo de duplicación se usa para aumentar las apuestas del juego. Cualquier jugador puede ofrecer duplicar las apuestas durante su turno, y el oponente debe aceptar o perder el juego actual.",
          de: "Der Verdopplungswürfel wird verwendet, um den Einsatz des Spiels zu erhöhen. Jeder Spieler kann während seines Zuges anbieten, den Einsatz zu verdoppeln, und der Gegner muss akzeptieren oder das aktuelle Spiel aufgeben.",
          nl: "De verdubbelddobbelsteen wordt gebruikt om de inzet van het spel te verhogen. Elke speler kan aanbieden om de inzet te verdubbelen tijdens hun beurt, en de tegenstander moet accepteren of het huidige spel opgeven."
        }
      }
    ]
  };
