  ...
  const level8 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Validation curves plot performance vs hyperparameter values, learning curves plot performance vs training set size", es: "Curvas de validación grafican rendimiento vs valores de hiperparámetros, curvas de aprendizaje grafican rendimiento vs tamaño del conjunto de entrenamiento", de: "Validierungskurven plotten Leistung vs Hyperparameter-Werte, Lernkurven plotten Leistung vs Trainingssatz-Größe", nl: "Validatiecurves plotten prestaties vs hyperparameterwaarden, leercurves plotten prestaties vs trainingssetgrootte" },
      ...
      },
      {
        ...
        options: [
          { en: "Simultaneously optimizes multiple conflicting objectives like accuracy, speed, and memory usage to find Pareto-optimal solutions", es: "Optimiza simultáneamente múltiples objetivos conflictivos como precisión, velocidad y uso de memoria para encontrar soluciones Pareto-óptimas", de: "Optimiert gleichzeitig mehrere widersprüchliche Ziele wie Genauigkeit, Geschwindigkeit und Speicherverbrauch um Pareto-optimale Lösungen zu finden", nl: "Optimaliseert gelijktijdig meerdere conflicterende doelstellingen zoals nauwkeurigheid, snelheid en geheugengebruik om Pareto-optimale oplossingen te vinden" },
