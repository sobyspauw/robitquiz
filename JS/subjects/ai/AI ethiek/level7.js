  ...
  const level7 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Using algorithms to predict where crimes might occur, risking bias reinforcement and over-policing of certain communities", es: "Usar algoritmos para predecir donde podrian ocurrir crimenes, arriesgando refuerzo de sesgo y sobre-vigilancia de ciertas comunidades", de: "Algorithmen verwenden um vorherzusagen wo Verbrechen auftreten koennten, mit dem Risiko der Voreingenommenheitsverstaerkung und Ueberueberwachung bestimmter Gemeinschaften", nl: "Algoritmes gebruiken om te voorspellen waar misdaden kunnen plaatsvinden, met risico op bias versterking en overbeveiliging van bepaalde gemeenschappen" },
      ...
      },
      {
        ...
        options: [
          { en: "Using AI to screen and select job candidates, potentially introducing bias and reducing human judgment in hiring decisions", es: "Usar IA para examinar y seleccionar candidatos de trabajo, potencialmente introduciendo sesgo y reduciendo juicio humano en decisiones de contratacion", de: "KI verwenden um Stellenbewerber zu pruefen und auszuwaehlen, was moeglicherweise Voreingenommenheit einfuehrt und menschliches Urteilsvermoegen in Einstellungsentscheidungen reduziert", nl: "AI gebruiken om sollicitanten te screenen en selecteren, wat mogelijk bias introduceert en menselijk oordeel in aanwervingsbeslissingen vermindert" },
      ...
      },
      {
        ...
        options: [
          { en: "Using algorithms to subtly influence behavior while preserving choice, raising questions about manipulation and autonomy", es: "Usar algoritmos para influir sutilmente el comportamiento mientras se preserva la eleccion, planteando preguntas sobre manipulacion y autonomia", de: "Algorithmen verwenden um Verhalten subtil zu beeinflussen waehrend Wahlfreiheit bewahrt wird, was Fragen ueber Manipulation und Autonomie aufwirft", nl: "Algoritmes gebruiken om gedrag subtiel te beïnvloeden terwijl keuze behouden blijft, wat vragen oproept over manipulatie en autonomie" },
      ...
      },
      {
        ...
        options: [
          { en: "Ensuring decisions would be the same for individuals in a counterfactual world where they belonged to different demographic groups", es: "Asegurar que decisiones serian las mismas para individuos en un mundo contrafactual donde pertenecieran a grupos demograficos diferentes", de: "Sicherstellen dass Entscheidungen fuer Individuen in einer kontrafaktischen Welt wo sie zu verschiedenen demografischen Gruppen gehoeren dieselben waeren", nl: "Ervoor zorgen dat beslissingen hetzelfde zouden zijn voor individuen in een contrafeitelijke wereld waar ze tot verschillende demografische groepen behoren" },
      ...
      },
      {
        ...
        options: [
          { en: "Ensuring the decision-making process itself is fair, transparent, and consistent across all individuals", es: "Asegurar que el proceso de toma de decisiones en si mismo sea justo, transparente y consistente para todos los individuos", de: "Sicherstellen dass der Entscheidungsprozess selbst fair, transparent und konsistent fuer alle Individuen ist", nl: "Ervoor zorgen dat het besluitvormingsproces zelf eerlijk, transparant en consistent is voor alle individuen" },
      ...
      },
      {
        ...
        options: [
          { en: "Humans having sufficient knowledge, capability, and authority to oversee and intervene in automated decisions", es: "Humanos teniendo conocimiento suficiente, capacidad y autoridad para supervisar e intervenir en decisiones automatizadas", de: "Menschen haben ausreichendes Wissen, Faehigkeit und Autoritaet um automatisierte Entscheidungen zu ueberwachen und einzugreifen", nl: "Mensen hebben voldoende kennis, vermogen en autoriteit om geautomatiseerde beslissingen te overzien en in te grijpen" },
      ...
      },
      {
        ...
        options: [
          { en: "Systematic evaluation of potential risks, benefits, and societal impacts before deploying algorithmic systems", es: "Evaluacion sistematica de riesgos potenciales, beneficios e impactos sociales antes de desplegar sistemas algoritmicos", de: "Systematische Bewertung potentieller Risiken, Vorteile und gesellschaftlicher Auswirkungen vor der Bereitstellung algorithmischer Systeme", nl: "Systematische evaluatie van potentiële risico's, voordelen en maatschappelijke impact voor het implementeren van algoritmische systemen" },
      ...
      },
      {
        ...
        options: [
          { en: "When individuals become overwhelmed by constant consent requests and stop making informed decisions", es: "Cuando individuos se sienten abrumados por solicitudes constantes de consentimiento y dejan de tomar decisiones informadas", de: "Wenn Individuen von staendigen Einwilligungsanfragen ueberwaeltigt werden und aufhoeren informierte Entscheidungen zu treffen", nl: "Wanneer individuen overweldigd raken door constante toestemmingsverzoeken en stoppen met het nemen van geïnformeerde beslissingen" },
      ...
      },
      {
        ...
        options: [
          { en: "The challenge of assigning accountability when multiple actors contribute to algorithmic decisions", es: "El desafio de asignar responsabilidad cuando multiples actores contribuyen a decisiones algoritmicas", de: "Die Herausforderung Verantwortlichkeit zuzuweisen wenn mehrere Akteure zu algorithmischen Entscheidungen beitragen", nl: "De uitdaging van het toewijzen van verantwoordelijkheid wanneer meerdere actoren bijdragen aan algoritmische beslissingen" },
      ...
      },
      {
        ...
        options: [
          { en: "The ability to trace and document the complete history of how an algorithmic decision was made", es: "La capacidad de rastrear y documentar la historia completa de como se tomo una decision algoritmica", de: "Die Faehigkeit die vollstaendige Geschichte wie eine algorithmische Entscheidung getroffen wurde zu verfolgen und zu dokumentieren", nl: "Het vermogen om de volledige geschiedenis van hoe een algoritmische beslissing werd genomen te traceren en documenteren" },
