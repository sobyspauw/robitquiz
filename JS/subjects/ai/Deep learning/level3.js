  ...
  const level3 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "A technique that adds a fraction of the previous update to the current update, helping overcome local minima and accelerate convergence", es: "Una técnica que añade una fracción de la actualización previa a la actualización actual, ayudando a superar mínimos locales y acelerar convergencia", de: "Eine Technik die einen Bruchteil der vorherigen Aktualisierung zur aktuellen Aktualisierung hinzufügt, hilft lokale Minima zu überwinden und Konvergenz zu beschleunigen", nl: "Een techniek die een fractie van de vorige update toevoegt aan de huidige update, helpt lokale minima te overwinnen en convergentie te versnellen" },
      ...
      },
      {
        ...
        options: [
          { en: "An adaptive learning rate algorithm that combines momentum and RMSprop, automatically adjusting learning rates for each parameter", es: "Un algoritmo de tasa de aprendizaje adaptativo que combina momentum y RMSprop, ajustando automáticamente tasas de aprendizaje para cada parámetro", de: "Ein adaptiver Lernraten-Algorithmus der Momentum und RMSprop kombiniert, passt automatisch Lernraten für jeden Parameter an", nl: "Een adaptief learning rate algoritme dat momentum en RMSprop combineert, past automatisch learning rates aan voor elke parameter" },
      ...
      },
      {
        ...
        options: [
          { en: "Gradients become extremely large causing unstable training, addressed by gradient clipping, proper weight initialization, or architectural changes", es: "Los gradientes se vuelven extremadamente grandes causando entrenamiento inestable, abordado por recorte de gradientes, inicialización adecuada de pesos, o cambios arquitectónicos", de: "Gradienten werden extrem groß und verursachen instabiles Training, angegangen durch Gradienten-Clipping, richtige Gewichtsinitialisierung oder architektonische Änderungen", nl: "Gradiënten worden extreem groot wat instabiele training veroorzaakt, aangepakt door gradient clipping, juiste gewichtinitialisatie, of architecturale veranderingen" },
      ...
      },
      {
        ...
        options: [
          { en: "A regularization technique that stops training when validation performance stops improving, preventing overfitting", es: "Una técnica de regularización que detiene entrenamiento cuando el rendimiento de validación deja de mejorar, previniendo sobreajuste", de: "Eine Regularisierungstechnik die Training stoppt wenn Validierungsleistung aufhört sich zu verbessern, verhindert Overfitting", nl: "Een regularisatietechniek die training stopt wanneer validatieprestaties stoppen met verbeteren, voorkomt overfitting" },
      ...
      },
      {
        ...
        options: [
          { en: "A loss function measuring difference between predicted and true probability distributions, commonly used for classification tasks", es: "Una función de pérdida que mide diferencia entre distribuciones de probabilidad predichas y verdaderas, comúnmente usada para tareas de clasificación", de: "Eine Verlustfunktion die Unterschied zwischen vorhergesagten und wahren Wahrscheinlichkeitsverteilungen misst, häufig für Klassifikationsaufgaben verwendet", nl: "Een verliesfunctie die verschil meet tussen voorspelde en echte waarschijnlijkheidsverdelingen, vaak gebruikt voor classificatietaken" },
      ...
      },
      {
        ...
        options: [
          { en: "The average of squared differences between predicted and actual values, commonly used for regression tasks", es: "El promedio de diferencias al cuadrado entre valores predichos y reales, comúnmente usado para tareas de regresión", de: "Der Durchschnitt quadrierter Unterschiede zwischen vorhergesagten und tatsächlichen Werten, häufig für Regressionsaufgaben verwendet", nl: "Het gemiddelde van gekwadrateerde verschillen tussen voorspelde en werkelijke waarden, vaak gebruikt voor regressietaken" },
