// Pharaohs Quiz - Level 9: Advanced Knowledge
(function() {
  const level9 = {
    name: {
      en: "Pharaohs Level 9",
    ...
    questions: [
      {
        ...
        options: [
          { en: "Power plant hypothesis and astronomical observatory theories (fringe archaeology)", es: "Hipotesis de planta de energia y teorias de observatorio astronomico (arqueologia marginal)", de: "Kraftwerkshypothese und astronomische Observatoriumstheorien (Randarchaeologie)", nl: "Energiecentralehypothese en astronomisch observatorium theorieën (randarcheologie)" },
          { en: "Mainstream scholarly consensus supports cenotaph function", es: "Consenso academico principal apoya funcion de cenotafio", de: "Mainstream-wissenschaftlicher Konsens unterstuetzt Kenotaph-Funktion", nl: "Mainstream wetenschappelijke consensus ondersteunt cenotaaf functie" },
          { en: "Grain storage facility as proposed by medieval scholars", es: "Instalacion de almacenamiento de grano propuesta por eruditos medievales", de: "Getreidespeicheranlage wie von mittelalterlichen Gelehrten vorgeschlagen", nl: "Graanopslagfaciliteit zoals voorgesteld door middeleeuwse geleerden" },
          { en: "Temple complex for religious ceremonies only", es: "Complejo de templo solo para ceremonias religiosas", de: "Tempelkomplex nur fuer religioese Zeremonien", nl: "Tempelcomplex alleen voor religieuze ceremonies" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Whether she was Nefertiti ruling independently or Meritaten acting as co-regent", es: "Si ella era Nefertiti gobernando independientemente o Meritaten actuando como co-regente", de: "Ob sie Nofretete war, die unabhaengig herrschte, oder Meritaton als Mitregentin fungierte", nl: "Of ze Nefertiti was die onafhankelijk regeerde of Meritaten die als co-regent fungeerde" },
          { en: "Whether she was Greek or Egyptian", es: "Si ella era griega o egipcia", de: "Ob sie griechisch oder aegyptisch war", nl: "Of ze Grieks of Egyptisch was" },
          { en: "Whether she actually existed at all", es: "Si ella realmente existio", de: "Ob sie ueberhaupt existierte", nl: "Of ze überhaupt bestond" },
          { en: "Whether she ruled before or after the Old Kingdom", es: "Si ella goberno antes o despues del Reino Antiguo", de: "Ob sie vor oder nach dem Alten Reich herrschte", nl: "Of ze voor of na het Oude Rijk regeerde" }
        ],
        correct: 0,
        explanation: {
