// AI in Transport Quiz - Level 8: Expert Transportation AI Systems
(function() {
  const level8 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Performing computations on encrypted vehicle data without decrypting it, preserving complete privacy", es: "Realizar cálculos en datos de vehículos encriptados sin desencriptarlos, preservando privacidad completa", de: "Berechnungen an verschlüsselten Fahrzeugdaten durchführen ohne sie zu entschlüsseln, komplette Privatsphäre bewahrend", nl: "Berekeningen uitvoeren op versleutelde voertuigdata zonder het te ontsleutelen, volledige privacy behoudend" },
          { en: "Similar encryption methods for all vehicles", es: "Métodos de encriptación similares para todos los vehículos", de: "Ähnliche Verschlüsselungsmethoden für alle Fahrzeuge", nl: "Vergelijkbare versleutelingsmethoden voor alle voertuigen" },
          { en: "Morphing encryption keys automatically", es: "Transformar claves de encriptación automáticamente", de: "Verschlüsselungsschlüssel automatisch morphen", nl: "Versleutelingssleutels automatisch morphen" },
          { en: "Home-based encryption for vehicle data", es: "Encriptación basada en hogar para datos de vehículo", de: "Heimbasierte Verschlüsselung für Fahrzeugdaten", nl: "Thuis-gebaseerde versleuteling voor voertuigdata" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Enabling multiple AI agents to learn cooperative traffic strategies through competitive and collaborative interactions", es: "Permitir a múltiples agentes IA aprender estrategias cooperativas de tráfico a través de interacciones competitivas y colaborativas", de: "Mehreren KI-Agenten ermöglichen kooperative Verkehrsstrategien durch kompetitive und kollaborative Interaktionen zu lernen", nl: "Meerdere AI-agenten in staat stellen coöperatieve verkeersstrategieën te leren door competitieve en collaboratieve interacties" },
          { en: "Multiple agents controlling single vehicles", es: "Múltiples agentes controlando vehículos únicos", de: "Mehrere Agenten kontrollieren einzelne Fahrzeuge", nl: "Meerdere agenten die enkele voertuigen besturen" },
          { en: "Deep learning for multiple transport modes", es: "Aprendizaje profundo para múltiples modos de transporte", de: "Deep Learning für mehrere Transportmodi", nl: "Deep learning voor meerdere transportmodi" },
          { en: "Agent-based modeling of traffic flows", es: "Modelado basado en agentes de flujos de tráfico", de: "Agentenbasierte Modellierung von Verkehrsflüssen", nl: "Agent-gebaseerde modellering van verkeersstromen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creating unlimited realistic training scenarios including rare and dangerous situations that are difficult to collect in real world", es: "Crear escenarios de entrenamiento realistas ilimitados incluyendo situaciones raras y peligrosas que son difíciles de recopilar en el mundo real", de: "Unbegrenzte realistische Trainingsszenarien erstellen einschließlich seltener und gefährlicher Situationen die in der realen Welt schwer zu sammeln sind", nl: "Onbeperkte realistische trainingsscenario's creëren inclusief zeldzame en gevaarlijke situaties die moeilijk te verzamelen zijn in de echte wereld" },
          { en: "Synthesizing artificial vehicle materials", es: "Sintetizar materiales artificiales de vehículos", de: "Künstliche Fahrzeugmaterialien synthetisieren", nl: "Kunstmatige voertuigmaterialen synthetiseren" },
          ...
          { en: "Creating artificial traffic patterns", es: "Crear patrones de tráfico artificiales", de: "Künstliche Verkehrsmuster erstellen", nl: "Kunstmatige verkeerspatronen creëren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Understanding cause-and-effect relationships to make reasoned decisions rather than just pattern matching", es: "Entender relaciones causa-efecto para tomar decisiones razonadas en lugar de solo coincidencia de patrones", de: "Ursache-Wirkung-Beziehungen verstehen um begründete Entscheidungen zu treffen anstatt nur Mustererkennung", nl: "Oorzaak-gevolg relaties begrijpen om beredeneerde beslissingen te nemen in plaats van alleen patroonherkenning" },
          { en: "Causing accidents to test AI systems", es: "Causar accidentes para probar sistemas IA", de: "Unfälle verursachen um KI-Systeme zu testen", nl: "Ongevallen veroorzaken om AI-systemen te testen" },
          { en: "AI systems that cause traffic improvements", es: "Sistemas IA que causan mejoras de tráfico", de: "KI-Systeme die Verkehrsverbesserungen verursachen", nl: "AI-systemen die verkeerverbeteringen veroorzaken" },
          { en: "Causal modeling of vehicle mechanics", es: "Modelado causal de mecánica de vehículos", de: "Kausale Modellierung von Fahrzeugmechanik", nl: "Causale modellering van voertuigmechanica" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Recognizing and handling completely new objects and situations without any prior training examples", es: "Reconocer y manejar objetos y situaciones completamente nuevos sin ejemplos de entrenamiento previos", de: "Völlig neue Objekte und Situationen erkennen und handhaben ohne vorherige Trainingsbeispiele", nl: "Volledig nieuwe objecten en situaties herkennen en hanteren zonder eerdere trainingsvoorbeelden" },
          { en: "Learning without taking any shots", es: "Aprender sin tomar ninguna foto", de: "Lernen ohne Aufnahmen zu machen", nl: "Leren zonder foto's te nemen" },
          { en: "Zero accidents during learning phase", es: "Cero accidentes durante fase de aprendizaje", de: "Null Unfälle während der Lernphase", nl: "Nul ongevallen tijdens de leerfase" },
          { en: "Starting from zero knowledge", es: "Empezar desde conocimiento cero", de: "Von null Wissen beginnen", nl: "Beginnen vanaf nul kennis" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Mathematical proof that AI decision-making algorithms will always behave safely under specified conditions", es: "Prueba matemática de que algoritmos de toma de decisiones IA siempre se comportarán de forma segura bajo condiciones especificadas", de: "Mathematischer Beweis dass KI-Entscheidungsalgorithmen unter spezifizierten Bedingungen immer sicher verhalten", nl: "Wiskundig bewijs dat AI-besluitvormingsalgoritmes altijd veilig zullen gedragen onder gespecificeerde condities" },
          { en: "Formal documentation of vehicle features", es: "Documentación formal de características vehiculares", de: "Formale Dokumentation von Fahrzeugmerkmalen", nl: "Formele documentatie van voertuigkenmerken" },
          { en: "Verification through formal testing only", es: "Verificación solo a través de pruebas formales", de: "Verifikation nur durch formale Tests", nl: "Verificatie alleen door formele testen" },
          { en: "Official approval from authorities", es: "Aprobación oficial de autoridades", de: "Offizielle Genehmigung von Behörden", nl: "Officiële goedkeuring van autoriteiten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Robustness against malicious attacks and edge cases by training on intentionally challenging examples", es: "Robustez contra ataques maliciosos y casos extremos entrenando en ejemplos intencionalmente desafiantes", de: "Robustheit gegen bösartige Angriffe und Grenzfälle durch Training an absichtlich herausfordernden Beispielen", nl: "Robuustheid tegen kwaadaardige aanvallen en randgevallen door training op opzettelijk uitdagende voorbeelden" },
          { en: "Training against competing vehicles", es: "Entrenamiento contra vehículos competidores", de: "Training gegen konkurrierende Fahrzeuge", nl: "Training tegen concurrerende voertuigen" },
          { en: "Adverse weather condition training", es: "Entrenamiento en condiciones climáticas adversas", de: "Training bei widrigen Wetterbedingungen", nl: "Training in slechte weersomstandigheden" },
          { en: "Training with adversarial instructors", es: "Entrenamiento con instructores adversarios", de: "Training mit gegnerischen Ausbildern", nl: "Training met vijandige instructeurs" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Graceful degradation to safe states when components fail, preventing catastrophic system failures", es: "Degradación elegante a estados seguros cuando componentes fallan, previniendo fallas catastróficas del sistema", de: "Elegante Degradation zu sicheren Zuständen wenn Komponenten ausfallen, verhindert katastrophale Systemausfälle", nl: "Elegante degradatie naar veilige toestanden wanneer componenten falen, waarbij catastrofale systeemfalen worden voorkomen" },
          { en: "Ensuring failures never happen", es: "Asegurar que fallas nunca ocurran", de: "Sicherstellen dass Ausfälle nie passieren", nl: "Ervoor zorgen dat storingen nooit gebeuren" },
          { en: "Safe storage of failure data", es: "Almacenamiento seguro de datos de falla", de: "Sichere Speicherung von Ausfalldaten", nl: "Veilige opslag van storingsdata" },
          { en: "Architecture that cannot fail", es: "Arquitectura que no puede fallar", de: "Architektur die nicht ausfallen kann", nl: "Architectuur die niet kan falen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Real-time monitoring and prevention of malicious attacks on vehicle communication systems and critical functions", es: "Monitoreo en tiempo real y prevención de ataques maliciosos en sistemas de comunicación vehicular y funciones críticas", de: "Echtzeit-Überwachung und Verhinderung bösartiger Angriffe auf Fahrzeugkommunikationssysteme und kritische Funktionen", nl: "Realtime monitoring en preventie van kwaadaardige aanvallen op voertuigcommunicatiesystemen en kritieke functies" },
          { en: "Physical security of vehicle entry", es: "Seguridad física de entrada vehicular", de: "Physische Sicherheit des Fahrzeugzugangs", nl: "Fysieke beveiliging van voertuigtoegang" },
          { en: "Detection of vehicle break-ins", es: "Detección de robos de vehículos", de: "Erkennung von Fahrzeugeinbrüchen", nl: "Detectie van voertuiginbraken" },
          { en: "Intrusion detection for passengers", es: "Detección de intrusión para pasajeros", de: "Eindringlingserkennung für Passagiere", nl: "Inbraakdetectie voor passagiers" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cross-verification of sensor data to detect failures, malfunctions, and inconsistencies in real-time", es: "Verificación cruzada de datos de sensores para detectar fallas, mal funcionamiento e inconsistencias en tiempo real", de: "Kreuzvalidierung von Sensordaten um Ausfälle, Fehlfunktionen und Inkonsistenzen in Echtzeit zu erkennen", nl: "Kruisvalidatie van sensordata om storingen, defecten en inconsistenties in realtime te detecteren" },
          { en: "Having extra sensors for backup", es: "Tener sensores extra para respaldo", de: "Extra Sensoren als Backup haben", nl: "Extra sensoren hebben als backup" },
          { en: "Validating sensor installation", es: "Validar instalación de sensores", de: "Sensorinstallation validieren", nl: "Sensorinstallatie valideren" },
          { en: "Reducing sensor redundancy", es: "Reducir redundancia de sensores", de: "Sensor-Redundanz reduzieren", nl: "Sensorredundantie verminderen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Ensuring only verified, authentic software can run on vehicle systems from startup to prevent malicious code injection", es: "Asegurar que solo software verificado y auténtico pueda ejecutarse en sistemas vehiculares desde el arranque para prevenir inyección de código malicioso", de: "Gewährleisten dass nur verifizierte, authentische Software auf Fahrzeugsystemen vom Start an laufen kann um bösartige Code-Injection zu verhindern", nl: "Ervoor zorgen dat alleen geverifieerde, authentieke software kan draaien op voertuigsystemen vanaf opstarten om kwaadaardige code-injectie te voorkomen" },
          { en: "Secure physical vehicle startup", es: "Arranque físico seguro del vehículo", de: "Sicherer physischer Fahrzeugstart", nl: "Veilige fysieke voertuigstart" },
          { en: "Boot protection from weather", es: "Protección de arranque del clima", de: "Boot-Schutz vor Wetter", nl: "Bescherming van opstarten tegen weer" },
          { en: "Secure storage of boot data", es: "Almacenamiento seguro de datos de arranque", de: "Sichere Speicherung von Boot-Daten", nl: "Veilige opslag van opstartdata" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Clear, interpretable explanations of why AI systems made specific driving decisions for accountability and safety validation", es: "Explicaciones claras e interpretables de por qué sistemas IA tomaron decisiones específicas de conducción para responsabilidad y validación de seguridad", de: "Klare, interpretierbare Erklärungen warum KI-Systeme spezifische Fahrentscheidungen trafen für Verantwortlichkeit und Sicherheitsvalidierung", nl: "Duidelijke, interpreteerbare verklaringen van waarom AI-systemen specifieke rijbeslissingen namen voor verantwoordelijkheid en veiligheidsvalidatie" },
          { en: "Explaining AI concepts to users", es: "Explicar conceptos IA a usuarios", de: "KI-Konzepte an Nutzer erklären", nl: "AI-concepten uitleggen aan gebruikers" },
          { en: "Model documentation for developers", es: "Documentación de modelo para desarrolladores", de: "Modelldokumentation für Entwickler", nl: "Modeldocumentatie voor ontwikkelaars" },
          { en: "Explaining vehicle features", es: "Explicar características vehiculares", de: "Fahrzeugmerkmale erklären", nl: "Voertuigkenmerken uitleggen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cryptographic keys and sensitive operations through tamper-resistant hardware that cannot be compromised by software attacks", es: "Claves criptográficas y operaciones sensibles a través de hardware resistente a manipulación que no puede ser comprometido por ataques de software", de: "Kryptographische Schlüssel und sensible Operationen durch manipulationsresistente Hardware die nicht durch Software-Angriffe kompromittiert werden kann", nl: "Cryptografische sleutels en gevoelige operaties door manipulatiebestendige hardware die niet gecompromitteerd kan worden door software-aanvallen" },
          { en: "Hardware system maintenance", es: "Mantenimiento de sistema de hardware", de: "Hardware-System-Wartung", nl: "Hardware systeem onderhoud" },
          { en: "Security for hardware components", es: "Seguridad para componentes de hardware", de: "Sicherheit für Hardware-Komponenten", nl: "Beveiliging voor hardware componenten" },
          { en: "Module for hardware security training", es: "Módulo para entrenamiento de seguridad de hardware", de: "Modul für Hardware-Sicherheitstraining", nl: "Module voor hardware beveiligingstraining" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "System consensus and operation even when some vehicles behave maliciously or unpredictably", es: "Consenso y operación del sistema incluso cuando algunos vehículos se comportan maliciosamente o impredeciblemente", de: "Systemkonsens und -betrieb auch wenn einige Fahrzeuge bösartig oder unvorhersagbar verhalten", nl: "Systeemconsensus en werking zelfs wanneer sommige voertuigen zich kwaadaardig of onvoorspelbaar gedragen" },
          { en: "Tolerance for Byzantine architecture", es: "Tolerancia para arquitectura bizantina", de: "Toleranz für byzantinische Architektur", nl: "Tolerantie voor Byzantijnse architectuur" },
          { en: "Historical fault analysis", es: "Análisis histórico de fallas", de: "Historische Fehleranalyse", nl: "Historische foutanalyse" },
          { en: "Fault tolerance in ancient systems", es: "Tolerancia a fallos en sistemas antiguos", de: "Fehlertoleranz in antiken Systemen", nl: "Fouttolerantie in oude systemen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Individual privacy while enabling useful aggregate analysis by adding carefully calibrated statistical noise", es: "Privacidad individual mientras permite análisis agregado útil añadiendo ruido estadístico cuidadosamente calibrado", de: "Individuelle Privatsphäre während nützliche Aggregatanalyse ermöglicht wird durch Hinzufügen sorgfältig kalibriertes statistisches Rauschen", nl: "Individuele privacy terwijl nuttige geaggregeerde analyse mogelijk blijft door zorgvuldig gekalibreerde statistische ruis toe te voegen" },
          { en: "Differences in privacy policies", es: "Diferencias en políticas de privacidad", de: "Unterschiede in Datenschutzrichtlinien", nl: "Verschillen in privacybeleid" },
          { en: "Private data differentiation", es: "Diferenciación de datos privados", de: "Private Datendifferenzierung", nl: "Privé data differentiatie" },
          { en: "Privacy for different user groups", es: "Privacidad para diferentes grupos de usuarios", de: "Privatsphäre für verschiedene Benutzergruppen", nl: "Privacy voor verschillende gebruikersgroepen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Critical safety tasks always receive processing priority and meet strict timing deadlines", es: "Tareas críticas de seguridad siempre reciben prioridad de procesamiento y cumplen fechas límite estrictas", de: "Kritische Sicherheitsaufgaben erhalten immer Verarbeitungspriorität und erfüllen strenge Zeitfristen", nl: "Kritieke veiligheidstaken krijgen altijd verwerkingsprioriteit en halen strikte timing deadlines" },
          { en: "Scheduling vehicle maintenance safely", es: "Programar mantenimiento vehicular de forma segura", de: "Fahrzeugwartung sicher planen", nl: "Voertuigonderhoud veilig inplannen" },
          { en: "Real-time scheduling of passenger trips", es: "Programación en tiempo real de viajes de pasajeros", de: "Echtzeit-Planung von Passagierfahrten", nl: "Realtime planning van passagiersreizen" },
          { en: "Critical scheduling for traffic lights", es: "Programación crítica para semáforos", de: "Kritische Planung für Ampeln", nl: "Kritieke planning voor verkeerslichten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Isolated execution space where critical AI decisions and cryptographic operations cannot be accessed by compromised software", es: "Espacio de ejecución aislado donde decisiones críticas IA y operaciones criptográficas no pueden ser accedidas por software comprometido", de: "Isolierter Ausführungsraum wo kritische KI-Entscheidungen und kryptographische Operationen nicht durch kompromittierte Software zugegriffen werden können", nl: "Geïsoleerde uitvoeringsruimte waar kritieke AI-beslissingen en cryptografische operaties niet benaderd kunnen worden door gecompromitteerde software" },
          { en: "Trusted testing environment", es: "Entorno de pruebas confiable", de: "Vertrauensvolle Testumgebung", nl: "Vertrouwde testomgeving" },
          { en: "Environment for trusted users", es: "Entorno para usuarios confiables", de: "Umgebung für vertrauensvolle Nutzer", nl: "Omgeving voor vertrouwde gebruikers" },
          { en: "Execution environment documentation", es: "Documentación de entorno de ejecución", de: "Ausführungsumgebung-Dokumentation", nl: "Uitvoeringsomgeving documentatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "AI model performance degradation, unexpected behaviors, and confidence levels to detect when systems may be operating outside safe parameters", es: "Degradación de rendimiento de modelos IA, comportamientos inesperados y niveles de confianza para detectar cuando sistemas pueden estar operando fuera de parámetros seguros", de: "KI-Modell-Leistungsabfall, unerwartete Verhaltensweisen und Vertrauensniveaus um zu erkennen wenn Systeme außerhalb sicherer Parameter operieren könnten", nl: "AI-model prestatieverval, onverwacht gedrag en vertrouwensniveaus om te detecteren wanneer systemen mogelijk buiten veilige parameters opereren" },
          { en: "Safety equipment monitoring only", es: "Solo monitoreo de equipo de seguridad", de: "Nur Sicherheitsausrüstung-Überwachung", nl: "Alleen veiligheidsuitrusting monitoring" },
          { en: "AI safety training progress", es: "Progreso de entrenamiento de seguridad IA", de: "KI-Sicherheitstraining-Fortschritt", nl: "AI-veiligheids trainingsvoortgang" },
          { en: "Safety monitoring of AI developers", es: "Monitoreo de seguridad de desarrolladores IA", de: "Sicherheitsüberwachung von KI-Entwicklern", nl: "Veiligheidsmonitoring van AI-ontwikkelaars" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Malicious software injection during remote updates through cryptographic verification and secure communication channels", es: "Inyección de software malicioso durante actualizaciones remotas a través de verificación criptográfica y canales de comunicación seguros", de: "Bösartige Software-Injection während Remote-Updates durch kryptographische Verifikation und sichere Kommunikationskanäle", nl: "Kwaadaardige software-injectie tijdens externe updates door cryptografische verificatie en veilige communicatiekanalen" },
          { en: "Updates during flight only", es: "Actualizaciones solo durante vuelo", de: "Updates nur während des Flugs", nl: "Updates alleen tijdens vlucht" },
          { en: "Air pollution during updates", es: "Contaminación del aire durante actualizaciones", de: "Luftverschmutzung während Updates", nl: "Luchtvervuiling tijdens updates" },
          { en: "Over-the-air radio interference", es: "Interferencia de radio por aire", de: "Over-the-Air Radio-Interferenz", nl: "Over-the-air radio interferentie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Security vulnerabilities by simulating real-world attack scenarios to identify and fix weaknesses before deployment", es: "Vulnerabilidades de seguridad simulando escenarios de ataque del mundo real para identificar y corregir debilidades antes del despliegue", de: "Sicherheitsvulnerabilitäten durch Simulation realer Angriffsszenarien um Schwachstellen vor Deployment zu identifizieren und beheben", nl: "Beveiligingskwetsbaarheden door realistische aanvalsscenario's te simuleren om zwakke punten te identificeren en op te lossen voor implementatie" },
          { en: "Penetration depth of vehicle materials", es: "Profundidad de penetración de materiales vehiculares", de: "Penetrationstiefe von Fahrzeugmaterialien", nl: "Penetratiediepte van voertuigmaterialen" },
          { en: "Testing vehicle entry systems", es: "Probar sistemas de entrada vehicular", de: "Fahrzeugzugangssysteme testen", nl: "Voertuigtoegangsystemen testen" },
          { en: "Penetration testing for crash safety", es: "Pruebas de penetración para seguridad de choques", de: "Penetrationstests für Crash-Sicherheit", nl: "Penetratietests voor botsbeveiliging" }
        ],
        correct: 0,
        explanation: {
