  ...
  const level6 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Complex collective behaviors arising from simple individual vehicle interactions that weren't explicitly programmed", es: "Comportamientos colectivos complejos que surgen de interacciones simples individuales de vehículos que no fueron explícitamente programados", de: "Komplexe kollektive Verhaltensweisen die aus einfachen individuellen Fahrzeuginteraktionen entstehen die nicht explizit programmiert wurden", nl: "Complexe collectieve gedragingen die ontstaan uit eenvoudige individuele voertuiginteracties die niet expliciet geprogrammeerd waren" },
      ...
      },
      {
        ...
        options: [
          { en: "Analyzing sensor data and usage patterns to predict component failures before they occur, minimizing downtime and optimizing maintenance schedules", es: "Analizar datos de sensores y patrones de uso para predecir fallas de componentes antes de que ocurran, minimizando tiempo de inactividad y optimizando horarios de mantenimiento", de: "Sensordaten und Nutzungsmuster analysieren um Komponentenausfälle vorherzusagen bevor sie auftreten, minimiert Ausfallzeiten und optimiert Wartungspläne", nl: "Sensordata en gebruikspatronen analyseren om componentdefecten te voorspellen voordat ze optreden, minimaliseert uitvaltijd en optimaliseert onderhoudsschema's" },
      ...
      },
      {
        ...
        options: [
          { en: "Creating resilient communication networks where vehicles act as nodes, allowing data to route through multiple paths even when some vehicles leave the network", es: "Crear redes de comunicación resilientes donde vehículos actúan como nodos, permitiendo que datos se enruten a través de múltiples caminos incluso cuando algunos vehículos dejan la red", de: "Resiliente Kommunikationsnetzwerke erstellen wo Fahrzeuge als Knoten fungieren, ermöglichen Datenrouting durch mehrere Pfade auch wenn einige Fahrzeuge das Netzwerk verlassen", nl: "Veerkrachtige communicatienetwerken creëren waarbij voertuigen fungeren als knooppunten, waardoor data kan worden gerouteerd via meerdere paden zelfs wanneer sommige voertuigen het netwerk verlaten" },
      ...
      },
      {
        ...
        options: [
          { en: "Enabling thousands of vehicles to self-organize and coordinate using simple local rules to achieve complex global behaviors like efficient traffic flow and collision avoidance", es: "Permitir a miles de vehículos auto-organizarse y coordinarse usando reglas locales simples para lograr comportamientos globales complejos como flujo de tráfico eficiente y evitación de colisiones", de: "Tausenden von Fahrzeugen ermöglichen sich selbst zu organisieren und zu koordinieren mit einfachen lokalen Regeln um komplexe globale Verhaltensweisen wie effizienten Verkehrsfluss und Kollisionsvermeidung zu erreichen", nl: "Duizenden voertuigen in staat stellen zichzelf te organiseren en te coördineren met eenvoudige lokale regels om complexe globale gedragingen te bereiken zoals efficiënte verkeersstroom en botsingvermijding" },
