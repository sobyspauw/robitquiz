  ...
  const level5 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "An adaptive learning rate algorithm that divides the learning rate by an exponentially decaying average of squared gradients", es: "Un algoritmo de tasa de aprendizaje adaptativa que divide la tasa de aprendizaje por un promedio de decaimiento exponencial de gradientes al cuadrado", de: "Ein adaptiver Lernraten-Algorithmus der die Lernrate durch einen exponentiell abklingenden Durchschnitt quadrierter Gradienten teilt", nl: "Een adaptief leersnelheidsalgoritme dat de leersnelheid deelt door een exponentieel afnemend gemiddelde van gekwadrateerde gradiënten" },
