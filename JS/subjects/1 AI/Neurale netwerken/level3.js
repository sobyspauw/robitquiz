  ...
  const level3 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Online learning updates the model continuously with new data, while offline learning trains on a fixed dataset", es: "El aprendizaje en línea actualiza el modelo continuamente con nuevos datos, mientras que el aprendizaje fuera de línea entrena en un conjunto de datos fijo", de: "Online-Lernen aktualisiert das Modell kontinuierlich mit neuen Daten, während Offline-Lernen auf einem festen Datensatz trainiert", nl: "Online learning werkt het model continu bij met nieuwe data, terwijl offline learning traint op een vaste dataset" },
      ...
      },
      {
        ...
        options: [
          { en: "The fundamental tradeoff between a model's ability to fit training data and generalize to new data", es: "El compromiso fundamental entre la capacidad de un modelo para ajustarse a datos de entrenamiento y generalizar a nuevos datos", de: "Der grundlegende Kompromiss zwischen der Fähigkeit eines Modells Trainingsdaten anzupassen und auf neue Daten zu generalisieren", nl: "De fundamentele afweging tussen het vermogen van een model om trainingsdata te fitten en te generaliseren naar nieuwe data" },
