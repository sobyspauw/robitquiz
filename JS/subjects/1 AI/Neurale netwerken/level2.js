  ...
  const level2 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "A theorem stating that a neural network with enough neurons can approximate any continuous function", es: "Un teorema que establece que una red neuronal con suficientes neuronas puede aproximar cualquier función continua", de: "Ein Theorem das besagt dass ein neuronales Netzwerk mit genügend Neuronen jede kontinuierliche Funktion approximieren kann", nl: "Een stelling die zegt dat een neuraal netwerk met genoeg neuronen elke continue functie kan benaderen" },
