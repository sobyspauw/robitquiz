// Natuurlijke taalverwerking Quiz - Level 9
(function() {
  const level9 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Models that only work with large vocabularies",
                  "es": "Modelos que solo funcionan con vocabularios grandes",
                  "de": "Modelle die nur mit großen Vokabularen funktionieren",
                  "nl": "Modellen die alleen werken met grote vocabulaires"
        },
        {
                  "en": "Models designed for processing long documents",
                  "es": "Modelos diseñados para procesar documentos largos",
                  "de": "Modelle entworfen für die Verarbeitung langer Dokumente",
                  "nl": "Modellen ontworpen voor het verwerken van lange documenten"
        },
        {
                  "en": "Language models that require large amounts of memory",
                  "es": "Modelos de lenguaje que requieren grandes cantidades de memoria",
                  "de": "Sprachmodelle die große Mengen an Speicher benötigen",
                  "nl": "Taalmodellen die grote hoeveelheden geheugen vereisen"
        },
        {
                  "en": "Neural networks trained on massive text corpora that can generate human-like text and perform various language tasks",
                  "es": "Redes neuronales entrenadas en corpus de texto masivos que pueden generar texto similar al humano y realizar varias tareas de lenguaje",
                  "de": "Neuronale Netzwerke trainiert auf massiven Textkorpora die menschenähnlichen Text generieren und verschiedene Sprachaufgaben durchführen können",
                  "nl": "Neurale netwerken getraind op massieve tekstcorpora die mensachtige tekst kunnen genereren en verschillende taaltaken kunnen uitvoeren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning to perform new tasks with only a few examples provided in the input prompt",
                  "es": "Aprender a realizar nuevas tareas con solo unos pocos ejemplos proporcionados en el prompt de entrada",
                  "de": "Lernen neue Aufgaben mit nur wenigen Beispielen im Eingabeprompt durchzuführen",
                  "nl": "Leren om nieuwe taken uit te voeren met slechts enkele voorbeelden in de invoerprompt"
        },
        {
                  "en": "Quick learning algorithms",
                  "es": "Algoritmos de aprendizaje rápido",
                  "de": "Schnelle Lernalgorithmen",
                  "nl": "Snelle leeralgoritmes"
        },
        {
                  "en": "Learning in a few iterations",
                  "es": "Aprender en pocas iteraciones",
                  "de": "In wenigen Iterationen lernen",
                  "nl": "Leren in enkele iteraties"
        },
        {
                  "en": "Training models with small datasets",
                  "es": "Entrenar modelos con datasets pequeños",
                  "de": "Modelle mit kleinen Datensätzen trainieren",
                  "nl": "Modellen trainen met kleine datasets"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Automating prompt generation",
                  "es": "Automatizar generación de prompts",
                  "de": "Prompt-Generierung automatisieren",
                  "nl": "Prompt generatie automatiseren"
        },
        {
                  "en": "Designing effective input prompts to guide language models toward desired outputs and behaviors",
                  "es": "Diseñar prompts de entrada efectivos para guiar modelos de lenguaje hacia salidas y comportamientos deseados",
                  "de": "Effektive Eingabeprompts entwerfen um Sprachmodelle zu gewünschten Ausgaben und Verhaltensweisen zu führen",
                  "nl": "Effectieve invoerprompts ontwerpen om taalmodellen naar gewenste outputs en gedragingen te leiden"
        },
        {
                  "en": "Creating prompts for engineering applications",
                  "es": "Crear prompts para aplicaciones de ingeniería",
                  "de": "Prompts für Ingenieuranwendungen erstellen",
                  "nl": "Prompts maken voor technische toepassingen"
        },
        {
                  "en": "Engineering faster prompts for better performance",
                  "es": "Diseñar prompts más rápidos para mejor rendimiento",
                  "de": "Schnellere Prompts für bessere Leistung entwickeln",
                  "nl": "Snellere prompts engineeren voor betere prestaties"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining language models with external knowledge retrieval to enhance generation with relevant information",
                  "es": "Combinar modelos de lenguaje con recuperación de conocimiento externo para mejorar generación con información relevante",
                  "de": "Sprachmodelle mit externer Wissensabfrage kombinieren um Generierung mit relevanter Information zu verbessern",
                  "nl": "Taalmodellen combineren met externe kennisophaling om generatie te verbeteren met relevante informatie"
        },
        {
                  "en": "Retrieving and generating random text",
                  "es": "Recuperar y generar texto aleatorio",
                  "de": "Zufälligen Text abrufen und generieren",
                  "nl": "Willekeurige tekst ophalen en genereren"
        },
        {
                  "en": "Generating text from retrieved documents",
                  "es": "Generar texto de documentos recuperados",
                  "de": "Text aus abgerufenen Dokumenten generieren",
                  "nl": "Tekst genereren uit opgehaalde documenten"
        },
        {
                  "en": "A method for improving text retrieval speed",
                  "es": "Un método para mejorar velocidad de recuperación de texto",
                  "de": "Eine Methode zur Verbesserung der Textabrufgeschwindigkeit",
                  "nl": "Een methode voor het verbeteren van tekstophalings snelheid"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Aligning text properly in generated output",
                  "es": "Alinear texto apropiadamente en salida generada",
                  "de": "Text ordnungsgemäß in generierter Ausgabe ausrichten",
                  "nl": "Tekst correct uitlijnen in gegenereerde output"
        },
        {
                  "en": "Aligning model parameters during training",
                  "es": "Alinear parámetros del modelo durante entrenamiento",
                  "de": "Modellparameter während des Trainings ausrichten",
                  "nl": "Modelparameters uitlijnen tijdens training"
        },
        {
                  "en": "Ensuring language models behave according to human values and intentions rather than optimizing for unintended objectives",
                  "es": "Asegurar que modelos de lenguaje se comporten según valores e intenciones humanas en lugar de optimizar objetivos no deseados",
                  "de": "Sicherstellen dass Sprachmodelle sich nach menschlichen Werten und Absichten verhalten anstatt unbeabsichtigte Ziele zu optimieren",
                  "nl": "Ervoor zorgen dat taalmodellen zich gedragen volgens menselijke waarden en intenties in plaats van onbedoelde doelstellingen te optimaliseren"
        },
        {
                  "en": "Synchronizing multiple language models",
                  "es": "Sincronizar múltiples modelos de lenguaje",
                  "de": "Mehrere Sprachmodelle synchronisieren",
                  "nl": "Meerdere taalmodellen synchroniseren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Quickly emerging trends in NLP research",
                  "es": "Tendencias que emergen rápidamente en investigación de PLN",
                  "de": "Schnell entstehende Trends in der NLP-Forschung",
                  "nl": "Snel opkomende trends in NLP-onderzoek"
        },
        {
                  "en": "Capabilities that arise spontaneously at certain model scales, not explicitly programmed or trained for",
                  "es": "Capacidades que surgen espontáneamente en ciertas escalas de modelo, no programadas o entrenadas explícitamente",
                  "de": "Fähigkeiten die spontan bei bestimmten Modellgrößen entstehen, nicht explizit programmiert oder trainiert",
                  "nl": "Capaciteiten die spontaan ontstaan bij bepaalde modelschalen, niet expliciet geprogrammeerd of getraind"
        },
        {
                  "en": "Emergency protocols for model failures",
                  "es": "Protocolos de emergencia para fallas del modelo",
                  "de": "Notfallprotokolle für Modellausfälle",
                  "nl": "Noodprotocollen voor modelfouten"
        },
        {
                  "en": "Behaviors that emerge during the first training epoch",
                  "es": "Comportamientos que emergen durante la primera época de entrenamiento",
                  "de": "Verhalten das während der ersten Trainingsepoche entsteht",
                  "nl": "Gedragingen die opkomen tijdens de eerste training epoch"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Encouraging models to show their reasoning steps by providing examples of step-by-step problem solving",
                  "es": "Alentar modelos a mostrar sus pasos de razonamiento proporcionando ejemplos de resolución de problemas paso a paso",
                  "de": "Modelle ermutigen ihre Denkschritte zu zeigen durch Bereitstellung von Beispielen schrittweiser Problemlösung",
                  "nl": "Modellen aanmoedigen hun redeneerstappen te tonen door voorbeelden van stap-voor-stap probleemoplossing te geven"
        },
        {
                  "en": "Linking multiple prompts together in sequence",
                  "es": "Vincular múltiples prompts juntos en secuencia",
                  "de": "Mehrere Prompts in Sequenz verknüpfen",
                  "nl": "Meerdere prompts in volgorde aan elkaar koppelen"
        },
        {
                  "en": "Using chains of related concepts in prompts",
                  "es": "Usar cadenas de conceptos relacionados en prompts",
                  "de": "Ketten verwandter Konzepte in Prompts verwenden",
                  "nl": "Ketens van gerelateerde concepten gebruiken in prompts"
        },
        {
                  "en": "Creating prompts based on thought patterns",
                  "es": "Crear prompts basados en patrones de pensamiento",
                  "de": "Prompts basierend auf Denkmustern erstellen",
                  "nl": "Prompts maken gebaseerd op denkpatronen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Getting real-time feedback during model inference",
                  "es": "Obtener retroalimentación en tiempo real durante inferencia del modelo",
                  "de": "Echtzeit-Feedback während der Modellinferenz erhalten",
                  "nl": "Real-time feedback krijgen tijdens modelinferentie"
        },
        {
                  "en": "Learning from human error patterns",
                  "es": "Aprender de patrones de error humano",
                  "de": "Von menschlichen Fehlermustern lernen",
                  "nl": "Leren van menselijke foutpatronen"
        },
        {
                  "en": "Training language models using human preferences to align outputs with human values and improve safety",
                  "es": "Entrenar modelos de lenguaje usando preferencias humanas para alinear salidas con valores humanos y mejorar seguridad",
                  "de": "Sprachmodelle mit menschlichen Präferenzen trainieren um Ausgaben mit menschlichen Werten auszurichten und Sicherheit zu verbessern",
                  "nl": "Taalmodellen trainen met menselijke voorkeuren om outputs uit te lijnen met menselijke waarden en veiligheid te verbeteren"
        },
        {
                  "en": "Using humans to label training data",
                  "es": "Usar humanos para etiquetar datos de entrenamiento",
                  "de": "Menschen verwenden um Trainingsdaten zu beschriften",
                  "nl": "Mensen gebruiken om trainingsgegevens te labelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI systems designed for government use",
                  "es": "Sistemas de IA diseñados para uso gubernamental",
                  "de": "KI-Systeme für Regierungsgebrauch entwickelt",
                  "nl": "AI-systemen ontworpen voor overheidsgebruik"
        },
        {
                  "en": "Building AI systems with legal frameworks",
                  "es": "Construir sistemas de IA con marcos legales",
                  "de": "KI-Systeme mit rechtlichen Rahmen aufbauen",
                  "nl": "AI-systemen bouwen met juridische kaders"
        },
        {
                  "en": "Training AI systems to follow a set of principles or constitution to ensure safe and beneficial behavior",
                  "es": "Entrenar sistemas de IA para seguir un conjunto de principios o constitución para asegurar comportamiento seguro y beneficioso",
                  "de": "KI-Systeme trainieren um einer Reihe von Prinzipien oder Verfassung zu folgen um sicheres und vorteilhaftes Verhalten zu gewährleisten",
                  "nl": "AI-systemen trainen om een set principes of grondwet te volgen om veilig en gunstig gedrag te waarborgen"
        },
        {
                  "en": "AI that follows constitutional law",
                  "es": "IA que sigue la ley constitucional",
                  "de": "KI die Verfassungsrecht folgt",
                  "nl": "AI die grondwettelijk recht volgt"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training models on contextual embeddings",
                  "es": "Entrenar modelos en embeddings contextuales",
                  "de": "Modelle auf kontextuellen Embeddings trainieren",
                  "nl": "Modellen trainen op contextuele embeddings"
        },
        {
                  "en": "Learning within specific application contexts",
                  "es": "Aprender dentro de contextos de aplicación específicos",
                  "de": "Lernen innerhalb spezifischer Anwendungskontexte",
                  "nl": "Leren binnen specifieke toepassingscontexten"
        },
        {
                  "en": "The ability to learn and adapt to new tasks using only examples provided in the input context, without parameter updates",
                  "es": "La capacidad de aprender y adaptarse a nuevas tareas usando solo ejemplos proporcionados en el contexto de entrada, sin actualizaciones de parámetros",
                  "de": "Die Fähigkeit neue Aufgaben zu lernen und sich anzupassen nur mit Beispielen im Eingabekontext, ohne Parameterupdates",
                  "nl": "Het vermogen om nieuwe taken te leren en zich aan te passen met alleen voorbeelden in de invoercontext, zonder parameterupdates"
        },
        {
                  "en": "Learning about the context of conversations",
                  "es": "Aprender sobre el contexto de conversaciones",
                  "de": "Den Kontext von Gesprächen lernen",
                  "nl": "Leren over de context van gesprekken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Large-scale pre-trained models that serve as a base for adapting to many downstream tasks across different domains",
                  "es": "Modelos pre-entrenados a gran escala que sirven como base para adaptarse a muchas tareas posteriores en diferentes dominios",
                  "de": "Großskalige vortrainierte Modelle die als Basis dienen für Anpassung an viele nachgelagerte Aufgaben über verschiedene Domänen",
                  "nl": "Grootschalige voorgetrainde modellen die dienen als basis voor aanpassing aan veel downstream-taken over verschillende domeinen"
        },
        {
                  "en": "Models built on foundational mathematical principles",
                  "es": "Modelos construidos en principios matemáticos fundamentales",
                  "de": "Modelle basierend auf grundlegenden mathematischen Prinzipien",
                  "nl": "Modellen gebouwd op fundamentele wiskundige principes"
        },
        {
                  "en": "Basic models that require significant additional training",
                  "es": "Modelos básicos que requieren entrenamiento adicional significativo",
                  "de": "Grundmodelle die erhebliches zusätzliches Training benötigen",
                  "nl": "Basismodellen die aanzienlijke aanvullende training vereisen"
        },
        {
                  "en": "The first models developed in a research field",
                  "es": "Los primeros modelos desarrollados en un campo de investigación",
                  "de": "Die ersten Modelle die in einem Forschungsbereich entwickelt wurden",
                  "nl": "De eerste modellen ontwikkeld in een onderzoeksgebied"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Language models trained on multiple datasets",
                  "es": "Modelos de lenguaje entrenados en múltiples conjuntos de datos",
                  "de": "Sprachmodelle auf mehreren Datensätzen trainiert",
                  "nl": "Taalmodellen getraind op meerdere datasets"
        },
        {
                  "en": "AI systems that can process and generate content across multiple modalities like text, images, audio, and video",
                  "es": "Sistemas de IA que pueden procesar y generar contenido a través de múltiples modalidades como texto, imágenes, audio y video",
                  "de": "KI-Systeme die Inhalte über mehrere Modalitäten wie Text, Bilder, Audio und Video verarbeiten und generieren können",
                  "nl": "AI-systemen die inhoud kunnen verwerken en genereren over meerdere modaliteiten zoals tekst, afbeeldingen, audio en video"
        },
        {
                  "en": "AI with multiple operating modes",
                  "es": "IA con múltiples modos operativos",
                  "de": "KI mit mehreren Betriebsmodi",
                  "nl": "AI met meerdere operationele modi"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Scaling models to work on different hardware",
                  "es": "Escalar modelos para trabajar en diferentes hardware",
                  "de": "Modelle skalieren um auf verschiedener Hardware zu funktionieren",
                  "nl": "Modellen schalen om te werken op verschillende hardware"
        },
        {
                  "en": "Resizing input and output dimensions",
                  "es": "Redimensionar dimensiones de entrada y salida",
                  "de": "Eingabe- und Ausgabedimensionen ändern",
                  "nl": "Invoer- en uitvoerdimensies aanpassen"
        },
        {
                  "en": "Adjusting model complexity for different tasks",
                  "es": "Ajustar complejidad del modelo para diferentes tareas",
                  "de": "Modellkomplexität für verschiedene Aufgaben anpassen",
                  "nl": "Modelcomplexiteit aanpassen voor verschillende taken"
        },
        {
                  "en": "Increasing model size (parameters), training data, or compute to improve performance following predictable scaling laws",
                  "es": "Aumentar tamaño del modelo (parámetros), datos de entrenamiento, o cómputo para mejorar rendimiento siguiendo leyes de escalamiento predecibles",
                  "de": "Modellgröße (Parameter), Trainingsdaten oder Berechnung erhöhen um Leistung zu verbessern nach vorhersagbaren Skalierungsgesetzen",
                  "nl": "Modelgrootte (parameters), trainingsgegevens, of rekenkracht verhogen om prestaties te verbeteren volgens voorspelbare schalingswetten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Random outputs due to model errors",
                  "es": "Salidas aleatorias debido a errores del modelo",
                  "de": "Zufällige Ausgaben aufgrund von Modellfehlern",
                  "nl": "Willekeurige outputs door modelfouten"
        },
        {
                  "en": "Models experiencing visual distortions",
                  "es": "Modelos experimentando distorsiones visuales",
                  "de": "Modelle die visuelle Verzerrungen erfahren",
                  "nl": "Modellen die visuele verstoringen ervaren"
        },
        {
                  "en": "When models generate plausible-sounding but factually incorrect or fabricated information",
                  "es": "Cuando modelos generan información que suena plausible pero es factualmente incorrecta o fabricada",
                  "de": "Wenn Modelle plausibel klingende aber faktisch falsche oder erfundene Informationen generieren",
                  "nl": "Wanneer modellen plausibel klinkende maar feitelijk onjuiste of verzonnen informatie genereren"
        },
        {
                  "en": "Generating creative or imaginative content",
                  "es": "Generar contenido creativo o imaginativo",
                  "de": "Kreativen oder fantasievollen Inhalt generieren",
                  "nl": "Creatieve of fantasierijke inhoud genereren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Techniques to reduce model size and computational requirements while maintaining performance through methods like quantization, pruning, and distillation",
                  "es": "Técnicas para reducir tamaño del modelo y requisitos computacionales mientras mantienen rendimiento a través de métodos como cuantización, poda y destilación",
                  "de": "Techniken um Modellgröße und Rechenanforderungen zu reduzieren während Leistung beibehalten wird durch Methoden wie Quantisierung, Pruning und Destillation",
                  "nl": "Technieken om modelgrootte en computationele vereisten te verminderen terwijl prestaties behouden blijven door methoden zoals kwantisatie, pruning en distillatie"
        },
        {
                  "en": "Simplifying model architecture design",
                  "es": "Simplificar diseño de arquitectura del modelo",
                  "de": "Modellarchitektur-Design vereinfachen",
                  "nl": "Modelarchitectuurontwerp vereenvoudigen"
        },
        {
                  "en": "Compressing training data to reduce storage",
                  "es": "Comprimir datos de entrenamiento para reducir almacenamiento",
                  "de": "Trainingsdaten komprimieren um Speicher zu reduzieren",
                  "nl": "Trainingsgegevens comprimeren om opslag te verminderen"
        },
        {
                  "en": "Reducing the length of model outputs",
                  "es": "Reducir la longitud de salidas del modelo",
                  "de": "Die Länge der Modellausgaben reduzieren",
                  "nl": "De lengte van modeloutputs verminderen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Optimizing model training instructions",
                  "es": "Optimizar instrucciones de entrenamiento del modelo",
                  "de": "Modelltrainingsanweisungen optimieren",
                  "nl": "Modeltrainingsinstructies optimaliseren"
        },
        {
                  "en": "Providing better documentation for model use",
                  "es": "Proporcionar mejor documentación para uso del modelo",
                  "de": "Bessere Dokumentation für Modellnutzung bereitstellen",
                  "nl": "Betere documentatie bieden voor modelgebruik"
        },
        {
                  "en": "Fine-tuning models on diverse instruction-following datasets to improve their ability to understand and follow natural language instructions",
                  "es": "Ajustar modelos en conjuntos de datos diversos de seguimiento de instrucciones para mejorar su capacidad de entender y seguir instrucciones en lenguaje natural",
                  "de": "Modelle auf diversen instruktionsfolgenden Datensätzen feinabstimmen um ihre Fähigkeit zu verbessern natürlichsprachliche Anweisungen zu verstehen und zu befolgen",
                  "nl": "Modellen fine-tunen op diverse instructievolgingsdatasets om hun vermogen te verbeteren natuurlijke taalinstructies te begrijpen en te volgen"
        },
        {
                  "en": "Teaching models to follow programming instructions",
                  "es": "Enseñar modelos a seguir instrucciones de programación",
                  "de": "Modelle lehren Programmieranweisungen zu folgen",
                  "nl": "Modellen leren programmeringsinstructies te volgen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Non-parametric models cannot learn from data",
                  "es": "Los modelos no paramétricos no pueden aprender de datos",
                  "de": "Nicht-parametrische Modelle können nicht aus Daten lernen",
                  "nl": "Niet-parametrische modellen kunnen niet leren van gegevens"
        },
        {
                  "en": "Parametric models have more parameters than non-parametric ones",
                  "es": "Los modelos paramétricos tienen más parámetros que los no paramétricos",
                  "de": "Parametrische Modelle haben mehr Parameter als nicht-parametrische",
                  "nl": "Parametrische modellen hebben meer parameters dan niet-parametrische"
        },
        {
                  "en": "Parametric knowledge is more accurate than non-parametric",
                  "es": "El conocimiento paramétrico es más preciso que el no paramétrico",
                  "de": "Parametrisches Wissen ist genauer als nicht-parametrisches",
                  "nl": "Parametrische kennis is nauwkeuriger dan niet-parametrische"
        },
        {
                  ...
                  "es": "El conocimiento paramétrico se almacena en pesos del modelo, el conocimiento no paramétrico se recupera de fuentes externas durante inferencia",
                  "de": "Parametrisches Wissen wird in Modellgewichten gespeichert, nicht-parametrisches Wissen wird während der Inferenz aus externen Quellen abgerufen",
                  "nl": "Parametrische kennis wordt opgeslagen in modelgewichten, niet-parametrische kennis wordt opgehaald uit externe bronnen tijdens inferentie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measuring model accuracy on benchmark tasks",
                  "es": "Medir precisión del modelo en tareas de referencia",
                  "de": "Modellgenauigkeit bei Benchmark-Aufgaben messen",
                  "nl": "Modelnauwkeurigheid meten op benchmark-taken"
        },
        {
                  "en": "Assessing whether AI systems behave according to human values and intentions, measuring safety, helpfulness, and harmlessness",
                  "es": "Evaluar si los sistemas de IA se comportan según valores e intenciones humanas, midiendo seguridad, utilidad e inocuidad",
                  "de": "Bewerten ob KI-Systeme sich nach menschlichen Werten und Absichten verhalten, misst Sicherheit, Hilfsbereitschaft und Harmlosigkeit",
                  "nl": "Beoordelen of AI-systemen zich gedragen volgens menselijke waarden en intenties, meet veiligheid, behulpzaamheid en onschadelijkheid"
        },
        {
                  "en": "Aligning model outputs with expected formats",
                  "es": "Alinear salidas del modelo con formatos esperados",
                  "de": "Modellausgaben mit erwarteten Formaten ausrichten",
                  "nl": "Modeloutputs uitlijnen met verwachte formaten"
        },
        {
                  "en": "Checking if model weights are properly aligned",
                  "es": "Verificar si los pesos del modelo están apropiadamente alineados",
                  "de": "Prüfen ob Modellgewichte ordnungsgemäß ausgerichtet sind",
                  "nl": "Controleren of modelgewichten correct uitgelijnd zijn"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Risks include misinformation generation, bias amplification, misuse for harmful content, and potential for deception or manipulation",
                  "es": "Los riesgos incluyen generación de desinformación, amplificación de sesgos, mal uso para contenido dañino, y potencial para engaño o manipulación",
                  "de": "Risiken umfassen Fehlinformationsgenerierung, Bias-Verstärkung, Missbrauch für schädlichen Inhalt und Potenzial für Täuschung oder Manipulation",
                  "nl": "Risico's omvatten desinformatiegeneratie, bias-versterking, misbruik voor schadelijke inhoud, en potentieel voor misleiding of manipulatie"
        },
        {
                  "en": "Primarily issues with model training speed",
                  "es": "Principalmente problemas con velocidad de entrenamiento del modelo",
                  "de": "Hauptsächlich Probleme mit Modelltrainingsgeschwindigkeit",
                  "nl": "Voornamelijk problemen met modeltrainingsnelheid"
        },
        {
                  "en": "Safety is not a concern for language models",
                  "es": "La seguridad no es una preocupación para modelos de lenguaje",
                  "de": "Sicherheit ist kein Anliegen für Sprachmodelle",
                  "nl": "Veiligheid is geen zorg voor taalmodellen"
        },
        {
                  "en": "Only concerns about computational resource usage",
                  "es": "Solo preocupaciones sobre uso de recursos computacionales",
                  "de": "Nur Bedenken über Rechenressourcennutzung",
                  "nl": "Alleen zorgen over computationeel resourcegebruik"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A neural architecture using self-attention mechanisms that can process sequences in parallel, enabling efficient training and better long-range dependencies",
                  "es": "Una arquitectura neuronal usando mecanismos de auto-atención que puede procesar secuencias en paralelo, habilitando entrenamiento eficiente y mejores dependencias de largo alcance",
                  "de": "Eine neuronale Architektur die Selbstaufmerksamkeitsmechanismen verwendet um Sequenzen parallel zu verarbeiten, ermöglicht effizientes Training und bessere weitreichende Abhängigkeiten",
                  "nl": "Een neurale architectuur die zelf-aandachtmechanismen gebruikt die sequenties parallel kan verwerken, maakt efficiënte training en betere lange-afstand afhankelijkheden mogelijk"
        },
        {
                  "en": "A programming framework for NLP applications",
                  "es": "Un framework de programación para aplicaciones de PLN",
                  "de": "Ein Programmierungsframework für NLP-Anwendungen",
                  "nl": "Een programmeerframework voor NLP-toepassingen"
        },
        {
                  "en": "A technique for compressing language models",
                  "es": "Una técnica para comprimir modelos de lenguaje",
                  "de": "Eine Technik zur Komprimierung von Sprachmodellen",
                  "nl": "Een techniek voor het comprimeren van taalmodellen"
        },
        {
                  "en": "A method for transforming text between different formats",
                  "es": "Un método para transformar texto entre diferentes formatos",
                  "de": "Eine Methode um Text zwischen verschiedenen Formaten zu transformieren",
                  "nl": "Een methode voor het transformeren van tekst tussen verschillende formaten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Models that cannot learn new tasks",
                  "es": "Modelos que no pueden aprender nuevas tareas",
                  "de": "Modelle die keine neuen Aufgaben lernen können",
                  "nl": "Modellen die geen nieuwe taken kunnen leren"
        },
        {
                  "en": "Learning from negative examples only",
                  "es": "Aprender solo de ejemplos negativos",
                  "de": "Nur von negativen Beispielen lernen",
                  "nl": "Alleen leren van negatieve voorbeelden"
        },
        {
        ...
        {
                  "en": "The ability to perform tasks without any task-specific examples, using only task descriptions or instructions",
                  "es": "La capacidad de realizar tareas sin ejemplos específicos de la tarea, usando solo descripciones o instrucciones de la tarea",
                  "de": "Die Fähigkeit Aufgaben ohne aufgabenspezifische Beispiele auszuführen, nur mit Aufgabenbeschreibungen oder Anweisungen",
                  "nl": "Het vermogen om taken uit te voeren zonder taakspecifieke voorbeelden, met alleen taakbeschrijvingen of instructies"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting models to different programming languages",
                  "es": "Convertir modelos a diferentes lenguajes de programación",
                  "de": "Modelle in verschiedene Programmiersprachen konvertieren",
                  "nl": "Modellen converteren naar verschillende programmeertalen"
        },
        {
                  "en": "Moving training data to inference systems",
                  "es": "Mover datos de entrenamiento a sistemas de inferencia",
                  "de": "Trainingsdaten zu Inferenzsystemen verschieben",
                  "nl": "Trainingsgegevens verplaatsen naar inferentiesystemen"
        },
        {
                  "en": "Transferring models between different computers",
                  "es": "Transferir modelos entre diferentes computadoras",
                  "de": "Modelle zwischen verschiedenen Computern übertragen",
                  "nl": "Modellen overdragen tussen verschillende computers"
        },
        {
                  "en": "Leveraging knowledge learned from one task or dataset to improve performance on different but related tasks",
                  "es": "Aprovechar conocimiento aprendido de una tarea o conjunto de datos para mejorar rendimiento en tareas diferentes pero relacionadas",
                  "de": "Wissen aus einer Aufgabe oder Datensatz nutzen um Leistung bei verschiedenen aber verwandten Aufgaben zu verbessern",
                  "nl": "Kennis geleerd van één taak of dataset benutten om prestaties te verbeteren op verschillende maar gerelateerde taken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Translating model responses to different languages",
                  "es": "Traducir respuestas del modelo a diferentes idiomas",
                  "de": "Modellantworten in verschiedene Sprachen übersetzen",
                  "nl": "Modelreacties vertalen naar verschillende talen"
        },
        {
                  "en": "Simplifying model architecture for better performance",
                  "es": "Simplificar arquitectura del modelo para mejor rendimiento",
                  "de": "Modellarchitektur vereinfachen für bessere Leistung",
                  "nl": "Modelarchitectuur vereenvoudigen voor betere prestaties"
        },
        {
                  "en": "Making model outputs easier to read",
                  "es": "Hacer salidas del modelo más fáciles de leer",
                  "de": "Modellausgaben leichter lesbar machen",
                  "nl": "Modeloutputs gemakkelijker leesbaar maken"
        },
        {
                  "en": "Understanding how models make decisions and what patterns they learn, crucial for trust, debugging, and ensuring safe deployment",
                  "es": "Entender cómo los modelos toman decisiones y qué patrones aprenden, crucial para confianza, depuración y asegurar despliegue seguro",
                  "de": "Verstehen wie Modelle Entscheidungen treffen und welche Muster sie lernen, entscheidend für Vertrauen, Debugging und sichere Bereitstellung",
                  "nl": "Begrijpen hoe modellen beslissingen nemen en welke patronen ze leren, cruciaal voor vertrouwen, debuggen en veilige implementatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Attention mechanisms that run faster on GPUs",
                  "es": "Mecanismos de atención que funcionan más rápido en GPUs",
                  "de": "Aufmerksamkeitsmechanismen die schneller auf GPUs laufen",
                  "nl": "Aandachtmechanismen die sneller draaien op GPU's"
        },
        {
                  "en": "Attention that uses less memory",
                  "es": "Atención que usa menos memoria",
                  "de": "Aufmerksamkeit die weniger Speicher verwendet",
                  "nl": "Aandacht die minder geheugen gebruikt"
        },
        {
                  "en": "Simplified versions of standard attention",
                  "es": "Versiones simplificadas de atención estándar",
                  "de": "Vereinfachte Versionen von Standard-Aufmerksamkeit",
                  "nl": "Vereenvoudigde versies van standaard aandacht"
        },
        {
                  "en": "Variants of attention that reduce computational complexity from O(n²) to enable processing of longer sequences efficiently",
                  "es": "Variantes de atención que reducen complejidad computacional de O(n²) para permitir procesamiento eficiente de secuencias más largas",
                  "de": "Varianten von Aufmerksamkeit die rechnerische Komplexität von O(n²) reduzieren um effiziente Verarbeitung längerer Sequenzen zu ermöglichen",
                  "nl": "Varianten van aandacht die computationele complexiteit van O(n²) verminderen om efficiënte verwerking van langere sequenties mogelijk te maken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fine-tuning updates model parameters on task data, prompt-based adaptation uses carefully designed inputs without changing weights",
                  "es": "El ajuste fino actualiza parámetros del modelo en datos de tarea, la adaptación basada en prompts usa entradas cuidadosamente diseñadas sin cambiar pesos",
                  "de": "Finetuning aktualisiert Modellparameter auf Aufgabendaten, prompt-basierte Anpassung verwendet sorgfältig gestaltete Eingaben ohne Gewichte zu ändern",
                  "nl": "Fine-tuning werkt modelparameters bij op taakgegevens, prompt-gebaseerde aanpassing gebruikt zorgvuldig ontworpen invoer zonder gewichten te veranderen"
        },
        {
                  "en": "Fine-tuning is faster than prompt-based methods",
                  "es": "El ajuste fino es más rápido que métodos basados en prompts",
                  "de": "Finetuning ist schneller als prompt-basierte Methoden",
                  "nl": "Fine-tuning is sneller dan prompt-gebaseerde methoden"
        },
        {
                  "en": "Both methods are exactly the same",
                  "es": "Ambos métodos son exactamente iguales",
                  "de": "Beide Methoden sind genau gleich",
                  "nl": "Beide methoden zijn precies hetzelfde"
        },
        {
                  "en": "Prompt-based methods require more computational resources",
                  "es": "Los métodos basados en prompts requieren más recursos computacionales",
                  "de": "Prompt-basierte Methoden erfordern mehr Rechenressourcen",
                  "nl": "Prompt-gebaseerde methoden vereisen meer computationele bronnen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Malicious inputs designed to override system instructions and manipulate model behavior",
                  "es": "Entradas maliciosas diseñadas para anular instrucciones del sistema y manipular comportamiento del modelo",
                  "de": "Böswillige Eingaben die entwickelt wurden um Systeminstruktionen zu überschreiben und Modellverhalten zu manipulieren",
                  "nl": "Kwaadaardige invoer ontworpen om systeeminstructies te overschrijven en modelgedrag te manipuleren"
        },
        {
                  "en": "Adding prompts during model training",
                  "es": "Añadir prompts durante entrenamiento del modelo",
                  "de": "Prompts während Modelltraining hinzufügen",
                  "nl": "Prompts toevoegen tijdens modeltraining"
        },
        {
                  "en": "Injecting examples into prompts",
                  "es": "Inyectar ejemplos en prompts",
                  "de": "Beispiele in Prompts einfügen",
                  "nl": "Voorbeelden in prompts injecteren"
        },
        {
                  "en": "Using prompts to improve model performance",
                  "es": "Usar prompts para mejorar rendimiento del modelo",
                  "de": "Prompts verwenden um Modellleistung zu verbessern",
                  "nl": "Prompts gebruiken om modelprestaties te verbeteren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training models to process and integrate multiple data types like text, images, audio, and video",
                  "es": "Entrenar modelos para procesar e integrar múltiples tipos de datos como texto, imágenes, audio y video",
                  "de": "Modelle trainieren um mehrere Datentypen wie Text, Bilder, Audio und Video zu verarbeiten und zu integrieren",
                  "nl": "Modellen trainen om meerdere datatypes te verwerken en integreren zoals tekst, afbeeldingen, audio en video"
        },
        {
        ...
        {
                  "en": "Using multiple training modes simultaneously",
                  "es": "Usar múltiples modos de entrenamiento simultáneamente",
                  "de": "Mehrere Trainingsmodi gleichzeitig verwenden",
                  "nl": "Meerdere trainingsmodi tegelijkertijd gebruiken"
        },
        {
                  "en": "Running models in different computational modes",
                  "es": "Ejecutar modelos en diferentes modos computacionales",
                  "de": "Modelle in verschiedenen Rechenmodi ausführen",
                  "nl": "Modellen draaien in verschillende computationele modi"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Simplifying model architecture",
                  "es": "Simplificar arquitectura del modelo",
        ...
        },
        {
                  ...
                  "nl": "Trainingsgegevens comprimeren"
        },
        {
                  "en": "Reducing model size and computational requirements while maintaining performance for efficient deployment",
                  "es": "Reducir tamaño del modelo y requisitos computacionales mientras se mantiene rendimiento para despliegue eficiente",
                  "de": "Modellgröße und Rechenanforderungen reduzieren während Leistung für effiziente Bereitstellung beibehalten wird",
                  "nl": "Modelgrootte en rekenvereisten verminderen terwijl prestaties behouden blijven voor efficiënte implementatie"
        },
        {
                  "en": "Reducing the number of training epochs",
                  "es": "Reducir el número de épocas de entrenamiento",
                  "de": "Anzahl der Trainingsepochen reduzieren",
                  "nl": "Het aantal trainingsepochs verminderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Searching through training data",
                  "es": "Buscar a través de datos de entrenamiento",
                  "de": "Durch Trainingsdaten suchen",
                  "nl": "Zoeken door trainingsgegevens"
        },
        {
                  "en": "A decoding algorithm that maintains multiple candidate sequences to find higher quality outputs than greedy decoding",
                  "es": "Un algoritmo de decodificación que mantiene múltiples secuencias candidatas para encontrar salidas de mayor calidad que decodificación codiciosa",
                  "de": "Ein Dekodierungsalgorithmus der mehrere Kandidatensequenzen beibehält um qualitativ hochwertigere Ausgaben als gierige Dekodierung zu finden",
                  "nl": "Een decodeeralgoritme dat meerdere kandidaatsequenties behoudt om outputs van hogere kwaliteit te vinden dan greedy decoding"
        },
        {
                  "en": "Finding optimal model architectures",
                  "es": "Encontrar arquitecturas de modelo óptimas",
                  "de": "Optimale Modellarchitekturen finden",
                  "nl": "Optimale modelarchitecturen vinden"
        },
        {
                  "en": "Searching for the best hyperparameters",
                  "es": "Buscar los mejores hiperparámetros",
                  "de": "Nach den besten Hyperparametern suchen",
                  "nl": "Zoeken naar de beste hyperparameters"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Models forgetting training data",
                  "es": "Modelos olvidando datos de entrenamiento",
                  "de": "Modelle vergessen Trainingsdaten",
                  "nl": "Modellen vergeten trainingsgegevens"
        },
        {
                  "en": "Complete model failure during training",
                  "es": "Fallo completo del modelo durante entrenamiento",
                  "de": "Vollständiger Modellausfall während Training",
                  "nl": "Volledig modelfalen tijdens training"
        },
        {
                  "en": "The tendency of neural networks to forget previously learned knowledge when trained on new tasks",
                  "es": "La tendencia de redes neuronales a olvidar conocimiento aprendido previamente cuando se entrenan en nuevas tareas",
                  "de": "Die Tendenz neuronaler Netzwerke zuvor gelerntes Wissen zu vergessen wenn sie auf neue Aufgaben trainiert werden",
                  "nl": "De neiging van neurale netwerken om eerder geleerde kennis te vergeten wanneer getraind op nieuwe taken"
        },
        {
                  "en": "Loss of model weights",
                  "es": "Pérdida de pesos del modelo",
                  "de": "Verlust von Modellgewichten",
                  "nl": "Verlies van modelgewichten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "As vocabulary and feature spaces grow, data becomes sparse and models require exponentially more data to learn effectively",
                  "es": "A medida que crecen vocabulario y espacios de características, los datos se vuelven dispersos y los modelos requieren exponencialmente más datos para aprender efectivamente",
                  "de": "Wenn Vokabular und Feature-Räume wachsen, werden Daten spärlich und Modelle benötigen exponentiell mehr Daten um effektiv zu lernen",
                  "nl": "Naarmate vocabulaire en feature-ruimten groeien, worden gegevens schaars en hebben modellen exponentieel meer data nodig om effectief te leren"
        },
        {
                  "en": "Difficulty in visualizing high-dimensional data",
                  "es": "Dificultad en visualizar datos de alta dimensión",
                  "de": "Schwierigkeit hochdimensionale Daten zu visualisieren",
                  "nl": "Moeilijkheid met visualiseren van hoogdimensionale gegevens"
        },
        {
                  "en": "Too many hyperparameters to tune",
                  "es": "Demasiados hiperparámetros para ajustar",
                  "de": "Zu viele Hyperparameter zum Abstimmen",
                  "nl": "Te veel hyperparameters om af te stemmen"
        },
        {
                  "en": "Models becoming too large to train",
                  "es": "Modelos volviéndose demasiado grandes para entrenar",
                  "de": "Modelle werden zu groß zum Trainieren",
                  "nl": "Modellen worden te groot om te trainen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Automatically discovering optimal neural network architectures through algorithmic search rather than manual design",
                  "es": "Descubrir automáticamente arquitecturas de redes neuronales óptimas mediante búsqueda algorítmica en lugar de diseño manual",
                  "de": "Automatisches Entdecken optimaler neuronaler Netzwerkarchitekturen durch algorithmische Suche statt manuelles Design",
        ...
        },
        {
                  ...
                  "de": "Neuronale Netzwerke im Internet suchen",
                  "nl": "Neurale netwerken zoeken op internet"
        },
        {
                  "en": "Finding the best training data",
                  "es": "Encontrar los mejores datos de entrenamiento",
                  "de": "Die besten Trainingsdaten finden",
                  "nl": "De beste trainingsgegevens vinden"
        },
        {
                  "en": "Optimizing hyperparameters only",
                  "es": "Optimizar solo hiperparámetros",
                  "de": "Nur Hyperparameter optimieren",
                  "nl": "Alleen hyperparameters optimaliseren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding more data to the training set",
                  "es": "Añadir más datos al conjunto de entrenamiento",
                  "de": "Mehr Daten zum Trainingssatz hinzufügen",
                  "nl": "Meer gegevens toevoegen aan de trainingsset"
        },
        {
                  "en": "Creating additional training examples through transformations like back-translation, synonym replacement, or paraphrasing",
                  "es": "Crear ejemplos de entrenamiento adicionales mediante transformaciones como retrotraducción, reemplazo de sinónimos o paráfrasis",
                  "de": "Zusätzliche Trainingsbeispiele durch Transformationen wie Rückübersetzung, Synonymersetzung oder Paraphrasierung erstellen",
                  "nl": "Extra trainingsvoorbeelden creëren via transformaties zoals terug-vertaling, synoniemvervanging of parafrasering"
        },
        {
                  "en": "Collecting new labeled data",
                  "es": "Recopilar nuevos datos etiquetados",
                  "de": "Neue beschriftete Daten sammeln",
                  "nl": "Nieuwe gelabelde gegevens verzamelen"
        },
        {
                  "en": "Increasing model size",
                  "es": "Aumentar tamaño del modelo",
                  "de": "Modellgröße erhöhen",
                  "nl": "Modelgrootte vergroten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Setting initial model parameters",
                  "es": "Configurar parámetros iniciales del modelo",
                  "de": "Anfangsmodellparameter einstellen",
                  "nl": "Initiële modelparameters instellen"
        },
        {
        ...
        {
                  "en": "Ensuring predicted probabilities accurately reflect true likelihood of outcomes",
                  "es": "Asegurar que probabilidades predichas reflejen con precisión la verdadera probabilidad de resultados",
                  "de": "Sicherstellen dass vorhergesagte Wahrscheinlichkeiten die wahre Wahrscheinlichkeit von Ergebnissen genau widerspiegeln",
                  "nl": "Ervoor zorgen dat voorspelde waarschijnlijkheden de werkelijke waarschijnlijkheid van uitkomsten nauwkeurig weerspiegelen"
        },
        {
                  "en": "Normalizing input data",
                  "es": "Normalizar datos de entrada",
                  "de": "Eingabedaten normalisieren",
                  "nl": "Invoergegevens normaliseren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using adversarial networks for generation",
                  "es": "Usar redes adversariales para generación",
                  "de": "Adversariale Netzwerke für Generierung verwenden",
                  "nl": "Adversarial netwerken gebruiken voor generatie"
        },
        {
                  "en": "Training with negative examples only",
                  "es": "Entrenar solo con ejemplos negativos",
                  "de": "Nur mit negativen Beispielen trainieren",
                  "nl": "Alleen trainen met negatieve voorbeelden"
        },
        {
                  "en": "Training competing models against each other",
                  "es": "Entrenar modelos competidores entre sí",
                  "de": "Konkurrierende Modelle gegeneinander trainieren",
                  "nl": "Concurrerende modellen tegen elkaar trainen"
        },
        {
                  "en": "Training models on intentionally perturbed examples to improve resistance to adversarial attacks and input variations",
                  "es": "Entrenar modelos en ejemplos intencionalmente perturbados para mejorar resistencia a ataques adversariales y variaciones de entrada",
                  "de": "Modelle auf absichtlich gestörten Beispielen trainieren um Widerstand gegen adversariale Angriffe und Eingabevariationen zu verbessern",
                  "nl": "Modellen trainen op opzettelijk verstoorde voorbeelden om weerstand tegen adversarial aanvallen en invoervariaties te verbeteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Modelle kontinuierlich ohne Unterbrechung trainieren",
                  "nl": "Modellen continu trainen zonder te stoppen"
        },
        {
                  "en": "Never completing model training",
                  "es": "Nunca completar entrenamiento del modelo",
                  "de": "Modelltraining nie abschließen",
                  "nl": "Modeltraining nooit voltooien"
        },
        {
                  "en": "Enabling models to learn new tasks sequentially while retaining knowledge from previous tasks",
                  "es": "Permitir que modelos aprendan nuevas tareas secuencialmente mientras retienen conocimiento de tareas previas",
                  "de": "Modellen ermöglichen neue Aufgaben sequenziell zu lernen während Wissen aus vorherigen Aufgaben beibehalten wird",
                  "nl": "Modellen in staat stellen nieuwe taken opeenvolgend te leren terwijl kennis van eerdere taken behouden blijft"
        },
        {
                  "en": "Learning from streaming data",
                  "es": "Aprender de datos en streaming",
                  "de": "Von Streaming-Daten lernen",
                  "nl": "Leren van streaminggegevens"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Distillation trains a smaller model to mimic a larger one, pruning removes unnecessary weights from an existing model",
                  "es": "La destilación entrena un modelo más pequeño para imitar uno más grande, la poda elimina pesos innecesarios de un modelo existente",
                  "de": "Destillation trainiert ein kleineres Modell um ein größeres nachzuahmen, Pruning entfernt unnötige Gewichte aus einem bestehenden Modell",
                  "nl": "Distillatie traint een kleiner model om een groter na te bootsen, pruning verwijdert onnodige gewichten uit een bestaand model"
        },
        {
                  "en": "Distillation is faster than pruning",
                  "es": "La destilación es más rápida que la poda",
                  "de": "Destillation ist schneller als Pruning",
                  "nl": "Distillatie is sneller dan pruning"
        },
        {
                  "en": "Pruning requires a teacher model",
                  "es": "La poda requiere un modelo maestro",
                  "de": "Pruning benötigt ein Lehrermodell",
                  "nl": "Pruning vereist een leraarmodel"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Encoding word positions in sentences",
                  "es": "Codificar posiciones de palabras en oraciones",
                  "de": "Wortpositionen in Sätzen kodieren",
                  "nl": "Woordposities in zinnen coderen"
        },
        {
                  "en": "Providing sequence order information since self-attention is permutation-invariant",
                  "es": "Proporcionar información de orden de secuencia ya que la auto-atención es invariante a permutación",
                  "de": "Sequenzordnungsinformationen bereitstellen da Selbstaufmerksamkeit permutationsinvariant ist",
                  "nl": "Sequentievolgorde-informatie verschaffen omdat zelf-aandacht permutatie-invariant is"
        },
        {
                  "en": "Positioning attention heads",
                  "es": "Posicionar cabezas de atención",
                  "de": "Aufmerksamkeitsköpfe positionieren",
                  "nl": "Aandachtkoppen positioneren"
        },
        {
                  "en": "Storing embeddings at specific positions",
                  "es": "Almacenar embeddings en posiciones específicas",
                  "de": "Embeddings an spezifischen Positionen speichern",
                  "nl": "Embeddings opslaan op specifieke posities"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining different datasets",
                  "es": "Combinar diferentes conjuntos de datos",
                  "de": "Verschiedene Datensätze kombinieren",
                  "nl": "Verschillende datasets combineren"
        },
        {
        ...
        {
                  "en": "Merging model parameters",
                  "es": "Fusionar parámetros del modelo",
                  "de": "Modellparameter verschmelzen",
                  "nl": "Modelparameters samenvoegen"
        },
        {
                  "en": "Combining predictions from multiple models to improve accuracy and robustness beyond single model performance",
                  "es": "Combinar predicciones de múltiples modelos para mejorar precisión y robustez más allá del rendimiento de un solo modelo",
                  "de": "Vorhersagen mehrerer Modelle kombinieren um Genauigkeit und Robustheit über einzelne Modellleistung hinaus zu verbessern",
                  "nl": "Voorspellingen van meerdere modellen combineren om nauwkeurigheid en robuustheid te verbeteren boven enkele modelprestaties"
        }
        ],
        correct: 3,
        explanation: {
