  ...
  const level4 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "A model that predicts the next word based on the previous two words using P(wi|wi-2,wi-1)", es: "Un modelo que predice la siguiente palabra basándose en las dos palabras anteriores usando P(wi|wi-2,wi-1)", de: "Ein Modell das das nächste Wort basierend auf den vorherigen zwei Wörtern vorhersagt mit P(wi|wi-2,wi-1)", nl: "Een model dat het volgende woord voorspelt gebaseerd op de vorige twee woorden met P(wi|wi-2,wi-1)" },
          { en: "A model that uses three neural networks", es: "Un modelo que usa tres redes neuronales", de: "Ein Modell das drei neuronale Netzwerke verwendet", nl: "Een model dat drie neurale netwerken gebruikt" },
          { en: "A model trained on three languages", es: "Un modelo entrenado en tres idiomas", de: "Ein Modell das auf drei Sprachen trainiert ist", nl: "Een model getraind op drie talen" },
          { en: "A model that processes three words at once", es: "Un modelo que procesa tres palabras a la vez", de: "Ein Modell das drei Wörter auf einmal verarbeitet", nl: "Een model dat drie woorden tegelijkertijd verwerkt" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Using lower-order n-grams when higher-order n-grams are not available in the training data", es: "Usar n-gramas de orden inferior cuando n-gramas de orden superior no están disponibles en los datos de entrenamiento", de: "Verwenden von N-Grammen niedrigerer Ordnung wenn N-Gramme höherer Ordnung in den Trainingsdaten nicht verfügbar sind", nl: "Gebruiken van lagere-orde n-grammen wanneer hogere-orde n-grammen niet beschikbaar zijn in de trainingsgegevens" },
          { en: "Reducing the size of the language model", es: "Reducir el tamaño del modelo de lenguaje", de: "Die Größe des Sprachmodells reduzieren", nl: "De grootte van het taalmodel verkleinen" },
          { en: "Removing rare words from the vocabulary", es: "Eliminar palabras raras del vocabulario", de: "Seltene Wörter aus dem Vokabular entfernen", nl: "Zeldzame woorden uit het vocabulaire verwijderen" },
          { en: "Reverting to an earlier version of the model", es: "Volver a una versión anterior del modelo", de: "Zu einer früheren Version des Modells zurückkehren", nl: "Terugkeren naar een eerdere versie van het model" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Combining probabilities from different n-gram orders using weighted averages", es: "Combinar probabilidades de diferentes órdenes de n-gramas usando promedios ponderados", de: "Kombinieren von Wahrscheinlichkeiten aus verschiedenen N-Gramm-Ordnungen mit gewichteten Durchschnitten", nl: "Combineren van waarschijnlijkheden uit verschillende n-gram ordes met gewogen gemiddeldes" },
          { en: "Filling in missing words in a sentence", es: "Rellenar palabras faltantes en una oración", de: "Fehlende Wörter in einem Satz ausfüllen", nl: "Ontbrekende woorden in een zin invullen" },
          { en: "Creating new words between existing ones", es: "Crear nuevas palabras entre las existentes", de: "Neue Wörter zwischen bestehenden erstellen", nl: "Nieuwe woorden creëren tussen bestaande" },
          { en: "Estimating parameters for unseen data", es: "Estimar parámetros para datos no vistos", de: "Parameter für ungesehene Daten schätzen", nl: "Parameters schatten voor ongeziene gegevens" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Finding the most likely sequence of hidden states in Hidden Markov Models for tasks like POS tagging", es: "Encontrar la secuencia más probable de estados ocultos en Modelos Ocultos de Markov para tareas como etiquetado POS", de: "Finden der wahrscheinlichsten Sequenz versteckter Zustände in Hidden Markov Models für Aufgaben wie POS-Tagging", nl: "Vinden van de meest waarschijnlijke sequentie van verborgen toestanden in Hidden Markov Models voor taken zoals POS tagging" },
          { en: "Translating between languages", es: "Traducir entre idiomas", de: "Zwischen Sprachen übersetzen", nl: "Vertalen tussen talen" },
          { en: "Clustering similar documents", es: "Agrupar documentos similares", de: "Ähnliche Dokumente clustern", nl: "Vergelijkbare documenten clusteren" },
          { en: "Generating random text sequences", es: "Generar secuencias de texto aleatorias", de: "Zufällige Textsequenzen generieren", nl: "Willekeurige tekstsequenties genereren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Adding 1 to all n-gram counts to avoid zero probabilities", es: "Agregar 1 a todos los conteos de n-gramas para evitar probabilidades cero", de: "Hinzufügen von 1 zu allen N-Gramm-Zählungen um Null-Wahrscheinlichkeiten zu vermeiden", nl: "Toevoegen van 1 aan alle n-gram tellingen om nul waarschijnlijkheden te vermijden" },
          { en: "Removing noise from text data", es: "Eliminar ruido de datos de texto", de: "Rauschen aus Textdaten entfernen", nl: "Ruis verwijderen uit tekstgegevens" },
          { en: "Averaging probabilities across all n-grams", es: "Promediar probabilidades a través de todos los n-gramas", de: "Wahrscheinlichkeiten über alle N-Gramme mitteln", nl: "Gemiddelde waarschijnlijkheden over alle n-grammen" },
          { en: "Normalizing probability distributions", es: "Normalizar distribuciones de probabilidad", de: "Wahrscheinlichkeitsverteilungen normalisieren", nl: "Waarschijnlijkheidsverdelingen normaliseren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "An algorithm for computing the probability of being in each hidden state at each time step in an HMM", es: "Un algoritmo para calcular la probabilidad de estar en cada estado oculto en cada paso de tiempo en un HMM", de: "Ein Algorithmus zur Berechnung der Wahrscheinlichkeit in jedem versteckten Zustand zu jedem Zeitschritt in einem HMM zu sein", nl: "Een algoritme voor het berekenen van de waarschijnlijkheid van zijn in elke verborgen toestand op elk tijdstip in een HMM" },
          { en: "A bidirectional text processing technique", es: "Una técnica de procesamiento de texto bidireccional", de: "Eine bidirektionale Textverarbeitungstechnik", nl: "Een bidirectionele tekstverwerkingstechniek" },
          { en: "A method for reversing text sequences", es: "Un método para invertir secuencias de texto", de: "Eine Methode zum Umkehren von Textsequenzen", nl: "Een methode voor het omkeren van tekstsequenties" },
          { en: "An algorithm for forward and backward translation", es: "Un algoritmo para traducción hacia adelante y hacia atrás", de: "Ein Algorithmus für Vorwärts- und Rückwärtsübersetzung", nl: "Een algoritme voor voorwaartse en achterwaartse vertaling" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        question: {
          ...
          de: "Wofür wird der Naive Bayes Klassifikator häufig in NLP verwendet?",
          de: "Waarvoor wordt de Naive Bayes classificeerder vaak gebruikt in NLP?"
        },
        options: [
          { en: "Text classification tasks like spam detection and sentiment analysis by assuming feature independence", es: "Tareas de clasificación de texto como detección de spam y análisis de sentimiento asumiendo independencia de características", de: "Textklassifikationsaufgaben wie Spam-Erkennung und Sentimentanalyse durch Annahme von Merkmals-Unabhängigkeit", nl: "Tekstclassificatietaken zoals spamdetectie en sentimentanalyse door feature onafhankelijkheid aan te nemen" },
          { en: "Machine translation between languages", es: "Traducción automática entre idiomas", de: "Maschinelle Übersetzung zwischen Sprachen", nl: "Machinevertaling tussen talen" },
          { en: "Generating new text sequences", es: "Generar nuevas secuencias de texto", de: "Neue Textsequenzen generieren", nl: "Nieuwe tekstsequenties genereren" },
          { en: "Parsing sentence structures", es: "Analizar estructuras de oraciones", de: "Satzstrukturen parsen", nl: "Zinsstructuren parsen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A table showing true positives, true negatives, false positives, and false negatives for each class", es: "Una tabla mostrando verdaderos positivos, verdaderos negativos, falsos positivos, y falsos negativos para cada clase", de: "Eine Tabelle die wahre Positive, wahre Negative, falsche Positive und falsche Negative für jede Klasse zeigt", nl: "Een tabel die ware positieven, ware negatieven, valse positieven, en valse negatieven toont voor elke klasse" },
          { en: "A measure of how confused the classifier is", es: "Una medida de qué tan confundido está el clasificador", de: "Ein Maß dafür wie verwirrt der Klassifikator ist", nl: "Een maat voor hoe verward de classificeerder is" },
          { en: "A matrix of conflicting predictions", es: "Una matriz de predicciones conflictivas", de: "Eine Matrix widersprüchlicher Vorhersagen", nl: "Een matrix van conflicterende voorspellingen" },
          { en: "A visualization of classification errors only", es: "Una visualización solo de errores de clasificación", de: "Eine Visualisierung nur von Klassifikationsfehlern", nl: "Een visualisatie van alleen classificatiefouten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Computing metrics for each class independently then averaging them equally", es: "Calcular métricas para cada clase independientemente luego promediarlas igualmente", de: "Metriken für jede Klasse unabhängig berechnen dann gleich mitteln", nl: "Metrieken voor elke klasse onafhankelijk berekenen en dan gelijk middelen" },
          { en: "Weighting metrics by class frequency", es: "Ponderar métricas por frecuencia de clase", de: "Metriken nach Klassenhäufigkeit gewichten", nl: "Metrieken wegen op klassefrequentie" },
          { en: "Only averaging the largest classes", es: "Solo promediar las clases más grandes", de: "Nur die größten Klassen mitteln", nl: "Alleen de grootste klassen middelen" },
          { en: "Computing overall accuracy only", es: "Calcular solo exactitud general", de: "Nur Gesamtgenauigkeit berechnen", nl: "Alleen algemene nauwkeurigheid berekenen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Aggregating all predictions across classes to compute one overall metric", es: "Agregar todas las predicciones entre clases para calcular una métrica general", de: "Alle Vorhersagen über Klassen aggregieren um eine Gesamtmetrik zu berechnen", nl: "Alle voorspellingen over klassen aggregeren om één algemene metriek te berekenen" },
          { en: "Computing metrics for small classes only", es: "Calcular métricas solo para clases pequeñas", de: "Metriken nur für kleine Klassen berechnen", nl: "Metrieken alleen voor kleine klassen berekenen" },
          { en: "Using microscopic analysis of text", es: "Usar análisis microscópico de texto", de: "Mikroskopische Analyse von Text verwenden", nl: "Microscopische analyse van tekst gebruiken" },
          { en: "Averaging over a small sample", es: "Promediar sobre una muestra pequeña", de: "Über eine kleine Stichprobe mitteln", nl: "Middelen over een kleine steekproef" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Splitting data into k folds and training k models, each tested on a different fold", es: "Dividir datos en k pliegues y entrenar k modelos, cada uno probado en un pliegue diferente", de: "Daten in k Falten aufteilen und k Modelle trainieren, jedes auf einer anderen Falte getestet", nl: "Data opsplitsen in k vouwen en k modellen trainen, elk getest op een andere vouw" },
          { en: "Validating across multiple languages", es: "Validar a través de múltiples idiomas", de: "Über mehrere Sprachen validieren", nl: "Valideren over meerdere talen" },
          { en: "Checking for crossed wires in networks", es: "Verificar cables cruzados en redes", de: "Gekreuzte Leitungen in Netzwerken prüfen", nl: "Controleren op gekruiste verbindingen in netwerken" },
          { en: "Comparing models across datasets", es: "Comparar modelos a través de conjuntos de datos", de: "Modelle über Datensätze vergleichen", nl: "Modellen vergelijken over datasets" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Iteratively expanding training data by learning from a small seed set", es: "Expandir iterativamente datos de entrenamiento aprendiendo de un conjunto semilla pequeño", de: "Iterativ Trainingsdaten erweitern durch Lernen aus einem kleinen Seed-Set", nl: "Iteratief trainingsdata uitbreiden door te leren van een kleine zaadset" },
          { en: "Starting a computer or program", es: "Iniciar una computadora o programa", de: "Einen Computer oder ein Programm starten", nl: "Een computer of programma opstarten" },
          { en: "Loading initial parameters only", es: "Cargar solo parámetros iniciales", de: "Nur anfängliche Parameter laden", nl: "Alleen initiële parameters laden" },
          { en: "Using bootstrap CSS for styling", es: "Usar bootstrap CSS para estilo", de: "Bootstrap CSS für Styling verwenden", nl: "Bootstrap CSS gebruiken voor styling" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Strategically selecting which examples to label next to maximize model improvement", es: "Seleccionar estratégicamente qué ejemplos etiquetar a continuación para maximizar mejora del modelo", de: "Strategisch auswählen welche Beispiele als nächstes zu labeln um Modellverbesserung zu maximieren", nl: "Strategisch selecteren welke voorbeelden als volgende te labelen om modelverbetering te maximaliseren" },
          { en: "Learning that requires active participation from users", es: "Aprendizaje que requiere participación activa de usuarios", de: "Lernen das aktive Teilnahme von Nutzern erfordert", nl: "Leren dat actieve deelname van gebruikers vereist" },
          { en: "Training models during active hours only", es: "Entrenar modelos solo durante horas activas", de: "Modelle nur während aktiver Stunden trainieren", nl: "Modellen alleen tijdens actieve uren trainen" },
          { en: "Using activation functions in neural networks", es: "Usar funciones de activación en redes neuronales", de: "Aktivierungsfunktionen in neuronalen Netzen verwenden", nl: "Activatiefuncties in neurale netwerken gebruiken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Using knowledge from a pre-trained model on one task to improve performance on another task", es: "Usar conocimiento de un modelo pre-entrenado en una tarea para mejorar rendimiento en otra tarea", de: "Wissen aus einem vortrainierten Modell für eine Aufgabe verwenden um Leistung bei einer anderen Aufgabe zu verbessern", nl: "Kennis gebruiken van een voorgetraind model op één taak om prestaties op een andere taak te verbeteren" },
          { en: "Transferring models between computers", es: "Transferir modelos entre computadoras", de: "Modelle zwischen Computern übertragen", nl: "Modellen tussen computers overdragen" },
          { en: "Moving training data to different servers", es: "Mover datos de entrenamiento a diferentes servidores", de: "Trainingsdaten auf verschiedene Server verschieben", nl: "Trainingsdata naar verschillende servers verplaatsen" },
          { en: "Converting models between formats", es: "Convertir modelos entre formatos", de: "Modelle zwischen Formaten konvertieren", nl: "Modellen tussen formaten converteren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Adapting a model trained on one domain to work well on a different domain", es: "Adaptar un modelo entrenado en un dominio para funcionar bien en un dominio diferente", de: "Ein auf einer Domäne trainiertes Modell anpassen um gut auf einer anderen Domäne zu funktionieren", nl: "Een model getraind op één domein aanpassen om goed te werken op een ander domein" },
          { en: "Adapting to different domain names", es: "Adaptarse a diferentes nombres de dominio", de: "Sich an verschiedene Domänennamen anpassen", nl: "Aanpassen aan verschillende domeinnamen" },
          { en: "Changing model architecture for domains", es: "Cambiar arquitectura del modelo para dominios", de: "Modellarchitektur für Domänen ändern", nl: "Modelarchitectuur wijzigen voor domeinen" },
          { en: "Training separate models per domain", es: "Entrenar modelos separados por dominio", de: "Separate Modelle pro Domäne trainieren", nl: "Aparte modellen per domein trainen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Performing a task without any training examples for that specific task", es: "Realizar una tarea sin ningún ejemplo de entrenamiento para esa tarea específica", de: "Eine Aufgabe ohne Trainingsbeispiele für diese spezifische Aufgabe durchführen", nl: "Een taak uitvoeren zonder trainingsvoorbeelden voor die specifieke taak" },
          { en: "Training with zero data points", es: "Entrenar con cero puntos de datos", de: "Mit null Datenpunkten trainieren", nl: "Trainen met nul datapunten" },
          { en: "Learning without shooting any examples", es: "Aprender sin disparar ningún ejemplo", de: "Lernen ohne Beispiele zu schießen", nl: "Leren zonder voorbeelden te schieten" },
          { en: "Using models with zero parameters", es: "Usar modelos con cero parámetros", de: "Modelle mit null Parametern verwenden", nl: "Modellen met nul parameters gebruiken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Learning to perform a task with only a small number of training examples", es: "Aprender a realizar una tarea con solo un pequeño número de ejemplos de entrenamiento", de: "Lernen eine Aufgabe mit nur einer kleinen Anzahl von Trainingsbeispielen durchzuführen", nl: "Leren om een taak uit te voeren met slechts een klein aantal trainingsvoorbeelden" },
          { en: "Training with exactly three examples", es: "Entrenar con exactamente tres ejemplos", de: "Mit genau drei Beispielen trainieren", nl: "Trainen met precies drie voorbeelden" },
          { en: "Shooting a few examples for training", es: "Disparar algunos ejemplos para entrenamiento", de: "Ein paar Beispiele für Training schießen", nl: "Een paar voorbeelden schieten voor training" },
          { en: "Using minimal computational resources", es: "Usar recursos computacionales mínimos", de: "Minimale Rechenressourcen verwenden", nl: "Minimale rekenkracht gebruiken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Designing input prompts to elicit desired behaviors from language models", es: "Diseñar prompts de entrada para provocar comportamientos deseados de modelos de lenguaje", de: "Eingabe-Prompts entwerfen um gewünschte Verhaltensweisen von Sprachmodellen hervorzurufen", nl: "Input prompts ontwerpen om gewenst gedrag van taalmodellen te verkrijgen" },
          { en: "Engineering faster response times", es: "Ingeniar tiempos de respuesta más rápidos", de: "Schnellere Antwortzeiten entwickeln", nl: "Snellere responstijden ontwikkelen" },
          { en: "Building prompt systems for users", es: "Construir sistemas de prompts para usuarios", de: "Prompt-Systeme für Benutzer bauen", nl: "Promptsystemen bouwen voor gebruikers" },
          { en: "Debugging model prompts only", es: "Depurar solo prompts del modelo", de: "Nur Modell-Prompts debuggen", nl: "Alleen model prompts debuggen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Evaluating machine translation quality by comparing n-gram overlap with reference translations", es: "Evaluar calidad de traducción automática comparando superposición de n-gramas con traducciones de referencia", de: "Maschinelle Übersetzungsqualität evaluieren durch Vergleich von N-Gramm-Überlappung mit Referenzübersetzungen", nl: "Machinevertaalkwaliteit evalueren door n-gram overlap te vergelijken met referentievertalingen" },
          { en: "Measuring text color accuracy", es: "Medir precisión de color de texto", de: "Textfarbgenauigkeit messen", nl: "Tekstkleurnauwkeurigheid meten" },
          { en: "Evaluating blue-themed content only", es: "Evaluar solo contenido con tema azul", de: "Nur blau-thematischen Inhalt evaluieren", nl: "Alleen blauw-thematische content evalueren" },
          { en: "Scoring sentiment as positive or negative", es: "Puntuar sentimiento como positivo o negativo", de: "Sentiment als positiv oder negativ bewerten", nl: "Sentiment scoren als positief of negatief" }
        ],
        correct: 0,
        explanation: {
