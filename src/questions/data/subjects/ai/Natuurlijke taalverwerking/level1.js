// Natuurlijke taalverwerking Quiz - Level 1
(function() {
  const level1 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "A system for translating between computer languages",
                  "es": "Un sistema para traducir entre lenguajes de computadora",
                  "de": "Ein System zum Übersetzen zwischen Computersprachen",
                  "nl": "Een systeem voor het vertalen tussen computertalen"
        },
        {
                  "en": "A field of AI that helps computers understand and work with human language",
                  "es": "Un campo de IA que ayuda a las computadoras a entender y trabajar con el lenguaje humano",
                  "de": "Ein Bereich der KI der Computern hilft menschliche Sprache zu verstehen und damit zu arbeiten",
                  "nl": "Een gebied van AI dat computers helpt menselijke taal te begrijpen en ermee te werken"
        },
        {
                  "en": "A programming language for natural sciences",
                  "es": "Un lenguaje de programación para ciencias naturales",
                  "de": "Eine Programmiersprache für Naturwissenschaften",
                  "nl": "Een programmeertaal voor natuurwetenschappen"
        },
        {
                  "en": "A method for processing numerical data",
                  "es": "Un método para procesar datos numéricos",
                  "de": "Eine Methode zur Verarbeitung numerischer Daten",
                  "nl": "Een methode voor het verwerken van numerieke data"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Counting the number of words",
                  "es": "Contar el número de palabras",
                  "de": "Anzahl der Wörter zählen",
                  "nl": "Het aantal woorden tellen"
        },
        {
                  "en": "Converting text to uppercase",
                  "es": "Convertir texto a mayúsculas",
                  "de": "Text in Großbuchstaben umwandeln",
                  "nl": "Tekst naar hoofdletters omzetten"
        },
        {
                  "en": "Breaking text into smaller units like words or sentences",
                  "es": "Dividir texto en unidades más pequeñas como palabras u oraciones",
                  "de": "Text in kleinere Einheiten wie Wörter oder Sätze aufteilen",
                  "nl": "Tekst opdelen in kleinere eenheden zoals woorden of zinnen"
        },
        {
                  "en": "Removing punctuation from text",
                  "es": "Eliminar puntuación del texto",
                  "de": "Interpunktion aus Text entfernen",
                  "nl": "Leestekens uit tekst verwijderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Translating text to another language",
                  "es": "Traducir texto a otro idioma",
                  "de": "Text in eine andere Sprache übersetzen",
                  "nl": "Tekst naar een andere taal vertalen"
        },
        {
                  "en": "Reducing words to their root form",
                  "es": "Reducir palabras a su forma raíz",
                  "de": "Wörter auf ihre Grundform reduzieren",
                  "nl": "Woorden terugbrengen tot hun grondvorm"
        },
        {
                  "en": "Finding the emotional tone of text",
                  "es": "Encontrar el tono emocional del texto",
                  "de": "Den emotionalen Ton des Textes finden",
                  "nl": "De emotionele toon van tekst vinden"
        },
        {
                  "en": "Organizing text by themes",
                  "es": "Organizar texto por temas",
                  "de": "Text nach Themen organisieren",
                  "nl": "Tekst organiseren op thema's"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Analizar la gramática de las oraciones",
                  "de": "Die Grammatik von Sätzen analysieren",
                  "nl": "De grammatica van zinnen analyseren"
        },
        {
                  "en": "Determining the emotional tone or opinion expressed in text",
                  "es": "Determinar el tono emocional u opinión expresada en texto",
                  "de": "Den emotionalen Ton oder die Meinung im Text bestimmen",
                  "nl": "Het bepalen van de emotionele toon of mening uitgedrukt in tekst"
        },
        {
        ...
        {
                  "en": "Finding similar words in text",
                  "es": "Encontrar palabras similares en texto",
                  "de": "Ähnliche Wörter im Text finden",
                  "nl": "Vergelijkbare woorden in tekst vinden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A large collection of texts used for training and testing NLP models",
                  "es": "Una gran colección de textos usada para entrenar y probar modelos de PLN",
                  "de": "Eine große Sammlung von Texten die für Training und Testen von NLP-Modellen verwendet wird",
                  "nl": "Een grote verzameling teksten gebruikt voor het trainen en testen van NLP-modellen"
        },
        {
                  "en": "A grammar rule set",
                  "es": "Un conjunto de reglas gramaticales",
                  "de": "Ein Grammatikregelsatz",
                  "nl": "Een set grammaticaregels"
        },
        {
        ...
        {
                  "en": "A single document or article",
                  "es": "Un solo documento o artículo",
                  "de": "Ein einzelnes Dokument oder Artikel",
                  "nl": "Een enkel document of artikel"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Het identificeren van eigennamen",
                  "en": "Identifying proper nouns",
                  "es": "Identificar nombres propios",
                  "de": "Eigennamen identifizieren"
        },
        {
                  "nl": "Het tellen van woordfrequenties",
                  "en": "Counting word frequencies",
                  "es": "Contar frecuencias de palabras",
                  "de": "Worthäufigkeiten zählen"
        },
        {
                  "nl": "Het verwijderen van stopwoorden",
                  "en": "Removing stop words",
                  "es": "Eliminar palabras vacías",
                  "de": "Stoppwörter entfernen"
        },
        {
                  "nl": "Het terugbrengen van woorden tot hun basisvorm met grammaticale context",
                  "en": "Reducing words to their base form with grammatical context",
                  "es": "Reducir palabras a su forma base con contexto gramatical",
                  "de": "Wörter auf ihre Grundform mit grammatischem Kontext reduzieren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Belangrijke kernwoorden in een tekst",
                  "en": "Important keywords in a text",
                  "es": "Palabras clave importantes en un texto",
                  "de": "Wichtige Schlüsselwörter in einem Text"
        },
        {
                  "nl": "Veelvoorkomende woorden die meestal gefilterd worden uit tekstanalyse",
                  "en": "Common words that are usually filtered out from text analysis",
                  "es": "Palabras comunes que usualmente se filtran del análisis de texto",
                  "de": "Häufige Wörter die normalerweise aus der Textanalyse herausgefiltert werden"
        },
        {
                  "nl": "Woorden die een tekst stoppen",
                  "en": "Words that stop a text",
                  "es": "Palabras que detienen un texto",
                  "de": "Wörter die einen Text stoppen"
        },
        {
                  "nl": "Woorden met meer dan 10 letters",
                  "en": "Words with more than 10 letters",
                  "es": "Palabras con más de 10 letras",
                  "de": "Wörter mit mehr als 10 Buchstaben"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Het toekennen van grammaticale categorieën aan woorden",
                  "en": "Assigning grammatical categories to words",
                  "es": "Asignar categorías gramaticales a las palabras",
                  "de": "Grammatische Kategorien zu Wörtern zuweisen"
        },
        {
                  "nl": "Het groeperen van gelijkaardige zinnen",
                  "en": "Grouping similar sentences",
                  "es": "Agrupar oraciones similares",
                  "de": "Ähnliche Sätze gruppieren"
        },
        {
                  "nl": "Het markeren van positieve en negatieve woorden",
                  "en": "Marking positive and negative words",
                  "es": "Marcar palabras positivas y negativas",
                  "de": "Positive und negative Wörter markieren"
        },
        {
                  "nl": "Het nummeren van woorden in een tekst",
                  "en": "Numbering words in a text",
                  "es": "Numerar palabras en un texto",
                  "de": "Wörter in einem Text nummerieren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Een algoritme dat n stappen uitvoert",
                  "en": "An algorithm that performs n steps",
                  "es": "Un algoritmo que realiza n pasos",
                  "de": "Ein Algorithmus der n Schritte ausführt"
        },
        {
                  "nl": "Een reeks van n opeenvolgende woorden uit een tekst",
                  "en": "A sequence of n consecutive words from text",
                  "es": "Una secuencia de n palabras consecutivas de un texto",
                  "de": "Eine Folge von n aufeinanderfolgenden Wörtern aus einem Text"
        },
        {
                  "nl": "Een netwerk met n knopen",
                  "en": "A network with n nodes",
                  "es": "Una red con n nodos",
                  "de": "Ein Netzwerk mit n Knoten"
        },
        {
                  "nl": "Een grammaticaregel met n onderdelen",
                  "en": "A grammar rule with n parts",
                  "es": "Una regla gramatical con n partes",
                  "de": "Eine Grammatikregel mit n Teilen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Het creëren van nieuwe woorden",
                  "en": "Creating new words",
                  "es": "Crear nuevas palabras",
                  "de": "Neue Wörter erschaffen"
        },
        {
                  "nl": "Het identificeren en classificeren van eigennamen in tekst",
                  "en": "Identifying and classifying proper names in text",
                  "es": "Identificar y clasificar nombres propios en texto",
                  "de": "Eigennamen in Text identifizieren und klassifizieren"
        },
        {
                  "nl": "Het benoemen van variabelen in code",
                  "en": "Naming variables in code",
                  "es": "Nombrar variables en código",
                  "de": "Variablen in Code benennen"
        },
        {
                  "nl": "Het herkennen van stemmen in audio",
                  "en": "Recognizing voices in audio",
                  "es": "Reconocer voces en audio",
                  "de": "Stimmen in Audio erkennen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Het converteren van tekst naar een standaardformaat",
                  "en": "Converting text to a standard format",
                  "es": "Convertir texto a un formato estándar",
                  "de": "Text in ein Standardformat konvertieren"
        },
        {
                  "nl": "Het maken van tekst langer",
                  "en": "Making text longer",
                  "es": "Hacer el texto más largo",
                  "de": "Text länger machen"
        },
        {
                  "nl": "Het samenvatten van tekst",
                  "en": "Summarizing text",
                  "es": "Resumir texto",
                  "de": "Text zusammenfassen"
        },
        {
                  "nl": "Het vertalen van tekst",
                  "en": "Translating text",
                  "es": "Traducir texto",
                  "de": "Text übersetzen"
        }
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Een fysieke zak met woorden",
                  "en": "A physical bag containing words",
                  "es": "Una bolsa física que contiene palabras",
                  "de": "Ein physischer Beutel mit Wörtern"
        },
        {
                  "nl": "Een woordenboek met definities",
                  "en": "A dictionary with definitions",
                  "es": "Un diccionario con definiciones",
                  "de": "Ein Wörterbuch mit Definitionen"
        },
        {
                  "nl": "Een tekstrepresentatie die alleen woordfrequenties bijhoudt, zonder volgorde",
                  "en": "A text representation that only tracks word frequencies, ignoring order",
                  "es": "Una representación de texto que solo rastrea frecuencias de palabras, ignorando el orden",
                  "de": "Eine Textrepräsentation die nur Worthäufigkeiten verfolgt und die Reihenfolge ignoriert"
        },
        {
                  "nl": "Een model dat woorden sorteert",
                  "en": "A model that sorts words",
                  "es": "Un modelo que ordena palabras",
                  "de": "Ein Modell das Wörter sortiert"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Text Filtering-Information Display Format",
                  "en": "Text Filtering-Information Display Format",
                  "es": "Formato de Visualización de Información de Filtrado de Texto",
                  "de": "Text Filtering-Information Display Format"
        },
        {
                  "nl": "True False-Internet Data Format",
                  "en": "True False-Internet Data Format",
                  "es": "Formato de Datos de Internet Verdadero Falso",
                  "de": "True False-Internet Data Format"
        },
        {
                  "nl": "Technical Framework-Integrated Development Format",
                  "en": "Technical Framework-Integrated Development Format",
                  "es": "Marco Técnico-Formato de Desarrollo Integrado",
                  "de": "Technical Framework-Integrated Development Format"
        },
        {
                  "nl": "Term Frequency-Inverse Document Frequency, een manier om de belangrijkheid van woorden te meten",
                  "en": "Term Frequency-Inverse Document Frequency, a way to measure word importance",
                  "es": "Frecuencia de Término-Frecuencia Inversa de Documento, una forma de medir la importancia de las palabras",
                  "de": "Term Frequency-Inverse Document Frequency, eine Methode um Wortbedeutung zu messen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  ...
                  "de": "Eine Art Datenbank"
        },
        {
                  "nl": "Een patroon dat gebruikt wordt om tekst te zoeken en manipuleren",
                  "en": "A pattern used to search and manipulate text",
                  "es": "Un patrón usado para buscar y manipular texto",
                  "de": "Ein Muster das verwendet wird um Text zu suchen und zu manipulieren"
        },
        {
                  "nl": "Een programmeertalsleuteling",
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Het combineren van twee woorden",
                  "en": "Combining two words",
                  "es": "Combinar dos palabras",
                  "de": "Zwei Wörter kombinieren"
        },
        {
                  "nl": "Het verbergen van woorden in tekst",
                  "en": "Hiding words in text",
                  "es": "Ocultar palabras en texto",
                  "de": "Wörter in Text verstecken"
        },
        {
                  "nl": "Het insluiten van woorden in documenten",
                  "en": "Embedding words into documents",
                  "es": "Incrustar palabras en documentos",
                  "de": "Wörter in Dokumente einbetten"
        },
        {
                  "nl": "Numerieke vectorrepresentaties van woorden die semantische betekenis vastleggen",
                  "en": "Numerical vector representations of words that capture semantic meaning",
                  "es": "Representaciones vectoriales numéricas de palabras que capturan significado semántico",
                  "de": "Numerische Vektordarstellungen von Wörtern die semantische Bedeutung erfassen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Een type machine learning algoritme",
                  "en": "A type of machine learning algorithm",
                  "es": "Un tipo de algoritmo de aprendizaje automático",
                  "de": "Eine Art Machine Learning Algorithmus"
        },
        {
                  "nl": "Een trigonometrische functie",
                  "en": "A trigonometric function",
                  "es": "Una función trigonométrica",
                  "de": "Eine trigonometrische Funktion"
        },
        {
                  "nl": "Een database vergelijkingsmethode",
                  "en": "A database comparison method",
                  "es": "Un método de comparación de base de datos",
                  "de": "Eine Datenbankvergleichsmethode"
        },
        {
                  "nl": "Een meting van gelijkenis tussen twee vectoren gebaseerd op de cosinus van de hoek tussen hen",
                  "en": "A measure of similarity between two vectors based on the cosine of the angle between them",
                  "es": "Una medida de similitud entre dos vectores basada en el coseno del ángulo entre ellos",
                  "de": "Ein Maß für Ähnlichkeit zwischen zwei Vektoren basierend auf dem Kosinus des Winkels zwischen ihnen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Een statistisch model dat de waarschijnlijkheid van woordreeksen berekent",
                  "en": "A statistical model that computes the probability of word sequences",
                  "es": "Un modelo estadístico que calcula la probabilidad de secuencias de palabras",
                  "de": "Ein statistisches Modell das die Wahrscheinlichkeit von Wortfolgen berechnet"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Het analyseren van grammaticale relaties tussen woorden in een zin",
                  "en": "Analyzing grammatical relationships between words in a sentence",
                  "es": "Analizar las relaciones gramaticales entre palabras en una oración",
                  "de": "Grammatische Beziehungen zwischen Wörtern in einem Satz analysieren"
        },
        {
                  "nl": "Het identificeren van bestandsafhankelijkheden",
                  "en": "Identifying file dependencies",
                  "es": "Identificar dependencias de archivos",
                  "de": "Dateiabhängigkeiten identifizieren"
        },
        {
                  "nl": "Het parseren van database afhankelijkheden",
                  "en": "Parsing database dependencies",
                  "es": "Analizar dependencias de base de datos",
                  "de": "Datenbankabhängigkeiten parsen"
        },
        {
                  "nl": "Het controleren van software dependencies",
                  "en": "Checking software dependencies",
                  "es": "Verificar dependencias de software",
                  "de": "Software-Abhängigkeiten prüfen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Een chat applicatie",
                  "en": "A chat application",
                  "es": "Una aplicación de chat",
                  "de": "Eine Chat-Anwendung"
        },
        {
                  "nl": "Een computerprogramma dat gesprekken met mensen kan voeren",
                  "en": "A computer program that can conduct conversations with humans",
                  "es": "Un programa de computadora que puede mantener conversaciones con humanos",
                  "de": "Ein Computerprogramm das Gespräche mit Menschen führen kann"
        },
        {
                  "nl": "Een robot die kan lopen",
                  "en": "A robot that can walk",
                  "es": "Un robot que puede caminar",
                  "de": "Ein Roboter der laufen kann"
        },
        {
                  "nl": "Een persoon die veel chat",
                  "en": "A person who chats a lot",
                  "es": "Una persona que conversa mucho",
                  "de": "Eine Person die viel chattet"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "nl": "Het kost meer geld",
                  "en": "It costs more money",
                  "es": "Cuesta más dinero",
                  "de": "Es kostet mehr Geld"
        },
        {
                  "nl": "Het vertraagt het proces",
                  "en": "It slows down the process",
                  "es": "Ralentiza el proceso",
                  "de": "Es verlangsamt den Prozess"
        },
        {
                  "nl": "Het maakt tekst langer",
                  "en": "It makes text longer",
                  "es": "Hace el texto más largo",
                  "de": "Es macht Text länger"
        },
        {
                  "nl": "Het verbetert de kwaliteit van tekstanalyse",
                  "en": "It improves the quality of text analysis",
                  "es": "Mejora la calidad del análisis de texto",
                  "de": "Es verbessert die Qualität der Textanalyse"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Folding text into multiple lines",
                  "es": "Plegar texto en múltiples líneas",
                  "de": "Text in mehrere Zeilen falten",
                  "nl": "Tekst vouwen in meerdere regels"
        },
        {
                  "en": "Creating legal case documents",
                  "es": "Crear documentos de casos legales",
                  "de": "Rechtsdokumente erstellen",
                  "nl": "Juridische casedocumenten maken"
        },
        {
                  "en": "Organizing text by folders",
                  "es": "Organizar texto por carpetas",
                  "de": "Text nach Ordnern organisieren",
                  "nl": "Tekst organiseren in mappen"
        },
        {
                  "en": "Converting all text to the same case (usually lowercase)",
                  "es": "Convertir todo el texto al mismo caso (usualmente minúsculas)",
                  "de": "Allen Text in denselben Fall umwandeln (normalerweise Kleinbuchstaben)",
                  "nl": "Alle tekst omzetten naar dezelfde case (meestal kleine letters)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting text to audio",
                  "es": "Convertir texto a audio",
                  "de": "Text in Audio umwandeln",
                  "nl": "Tekst omzetten naar audio"
        },
        {
                  "en": "Encrypting text messages",
                  "es": "Encriptar mensajes de texto",
                  "de": "Textnachrichten verschlüsseln",
                  "nl": "Tekstberichten versleutelen"
        },
        {
                  "en": "Assigning predefined categories to text documents",
                  "es": "Asignar categorías predefinidas a documentos de texto",
                  "de": "Vordefinierte Kategorien zu Textdokumenten zuweisen",
                  "nl": "Vooraf gedefinieerde categorieën toewijzen aan tekstdocumenten"
        },
        {
                  "en": "Sorting text alphabetically",
                  "es": "Ordenar texto alfabéticamente",
                  "de": "Text alphabetisch sortieren",
                  "nl": "Tekst alfabetisch sorteren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Deleting unnecessary information",
                  "es": "Eliminar información innecesaria",
                  "de": "Unnötige Informationen löschen",
                  "nl": "Onnodige informatie verwijderen"
        },
        {
                  "en": "Compressing text files",
                  "es": "Comprimir archivos de texto",
                  "de": "Textdateien komprimieren",
                  "nl": "Tekstbestanden comprimeren"
        },
        {
                  "en": "Copying text from documents",
                  "es": "Copiar texto de documentos",
                  "de": "Text aus Dokumenten kopieren",
                  "nl": "Tekst uit documenten kopiëren"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Counting the syllables in words",
                  "es": "Contar las sílabas en palabras",
                  "de": "Silben in Wörtern zählen",
                  "nl": "Lettergrepen in woorden tellen"
        },
        {
                  "en": "Translating words into segments",
                  "es": "Traducir palabras en segmentos",
                  "de": "Wörter in Segmente übersetzen",
                  "nl": "Woorden vertalen in segmenten"
        },
        {
                  "en": "Breaking words into letters",
                  "es": "Romper palabras en letras",
                  "de": "Wörter in Buchstaben aufteilen",
                  "nl": "Woorden opdelen in letters"
        },
        {
                  "en": "Dividing text into individual words, especially important for languages without spaces",
                  "es": "Dividir texto en palabras individuales, especialmente importante para idiomas sin espacios",
                  "de": "Text in einzelne Wörter aufteilen, besonders wichtig für Sprachen ohne Leerzeichen",
                  "nl": "Tekst opdelen in individuele woorden, vooral belangrijk voor talen zonder spaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Detecting duplicate documents",
                  "es": "Detectar documentos duplicados",
                  "de": "Doppelte Dokumente erkennen",
                  "nl": "Dubbele documenten detecteren"
        },
        {
                  "en": "Resolving conflicts in code",
                  "es": "Resolver conflictos en código",
                  "de": "Konflikte im Code auflösen",
                  "nl": "Conflicten in code oplossen"
        },
        {
                  "en": "Finding the main topic of text",
                  "es": "Encontrar el tema principal del texto",
                  "de": "Das Hauptthema von Text finden",
                  "nl": "Het hoofdonderwerp van tekst vinden"
        },
        {
                  "en": "Identifying when different words refer to the same entity",
                  "es": "Identificar cuando diferentes palabras se refieren a la misma entidad",
                  "de": "Identifizieren wann verschiedene Wörter sich auf dieselbe Entität beziehen",
                  "nl": "Identificeren wanneer verschillende woorden naar dezelfde entiteit verwijzen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A decision tree for classification",
                  "es": "Un árbol de decisión para clasificación",
                  "de": "Ein Entscheidungsbaum für Klassifizierung",
                  "nl": "Een beslisboom voor classificatie"
        },
        {
                  "en": "A family tree of words",
                  "es": "Un árbol genealógico de palabras",
                  "de": "Ein Stammbaum von Wörtern",
                  "nl": "Een stamboom van woorden"
        },
        {
                  "en": "A tree diagram of topics",
                  "es": "Un diagrama de árbol de temas",
                  "de": "Ein Baumdiagramm von Themen",
                  "nl": "Een boomdiagram van onderwerpen"
        },
        {
                  "en": "A tree structure representing the syntactic structure of a sentence",
                  "es": "Una estructura de árbol que representa la estructura sintáctica de una oración",
                  "de": "Eine Baumstruktur die die syntaktische Struktur eines Satzes darstellt",
                  "nl": "Een boomstructuur die de syntactische structuur van een zin voorstelt"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating a shorter version of text while preserving key information",
                  "es": "Crear una versión más corta del texto preservando información clave",
                  "de": "Eine kürzere Version von Text erstellen während wichtige Informationen erhalten bleiben",
                  "nl": "Een kortere versie van tekst maken terwijl belangrijke informatie behouden blijft"
        },
        {
                  "en": "Translating text to another language",
                  "es": "Traducir texto a otro idioma",
        ...
        {
                  "en": "Counting the total words in text",
                  "es": "Contar el total de palabras en texto",
                  "de": "Gesamtanzahl der Wörter im Text zählen",
                  "nl": "Het totaal aantal woorden in tekst tellen"
        },
        {
                  "en": "Making text longer with details",
                  "es": "Hacer el texto más largo con detalles",
                  "de": "Text mit Details länger machen",
                  "nl": "Tekst langer maken met details"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Teaching machines to speak",
                  "es": "Enseñar a las máquinas a hablar",
                  "de": "Maschinen das Sprechen beibringen",
                  "nl": "Machines leren spreken"
        },
        {
                  "en": "Automatically translating text from one language to another using computers",
                  "es": "Traducir automáticamente texto de un idioma a otro usando computadoras",
                  "de": "Automatisches Übersetzen von Text von einer Sprache in eine andere mit Computern",
                  "nl": "Automatisch tekst vertalen van de ene taal naar de andere met computers"
        },
        {
                  "en": "Translating machine manuals",
                  "es": "Traducir manuales de máquinas",
                  "de": "Maschinenhandbücher übersetzen",
                  "nl": "Machinehandleidingen vertalen"
        },
        {
                  "en": "Converting text to machine code",
                  "es": "Convertir texto a código máquina",
                  "de": "Text in Maschinencode umwandeln",
                  "nl": "Tekst omzetten naar machinecode"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Una herramienta de revisión gramatical",
                  "de": "Ein Grammatikprüfungswerkzeug",
                  "nl": "Een grammatica-controletool"
        },
        {
                  "en": "A vocabulary of words and their linguistic information",
                  "es": "Un vocabulario de palabras y su información lingüística",
                  "de": "Ein Vokabular von Wörtern und ihren linguistischen Informationen",
                  "nl": "Een vocabulaire van woorden en hun linguïstische informatie"
        },
        {
                  "en": "A text editor application",
                  "es": "Una aplicación de editor de texto",
                  "de": "Eine Texteditor-Anwendung",
                  "nl": "Een teksteditorapplicatie"
        },
        {
                  "en": "A type of neural network",
                  "es": "Un tipo de red neuronal",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Teaching computers to speak",
                  "es": "Enseñar a las computadoras a hablar",
                  "de": "Computern das Sprechen beibringen",
                  "nl": "Computers leren spreken"
        },
        {
                  "en": "Identifying different speakers",
                  "es": "Identificar diferentes hablantes",
                  "de": "Verschiedene Sprecher identifizieren",
                  "nl": "Verschillende sprekers identificeren"
        },
        {
                  "en": "Converting spoken language into written text",
                  "es": "Convertir lenguaje hablado en texto escrito",
                  "de": "Gesprochene Sprache in geschriebenen Text umwandeln",
                  "nl": "Gesproken taal omzetten naar geschreven tekst"
        },
        {
                  "en": "Recognizing patterns in music",
                  "es": "Reconocer patrones en música",
                  "de": "Muster in Musik erkennen",
                  "nl": "Patronen in muziek herkennen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Asking questions to users",
                  "es": "Hacer preguntas a los usuarios",
                  "de": "Benutzern Fragen stellen",
                  "nl": "Vragen stellen aan gebruikers"
        },
        {
                  "en": "A system that automatically answers questions posed in natural language",
                  "es": "Un sistema que automáticamente responde preguntas formuladas en lenguaje natural",
                  "de": "Ein System das automatisch Fragen beantwortet die in natürlicher Sprache gestellt werden",
                  "nl": "Een systeem dat automatisch vragen beantwoordt die in natuurlijke taal gesteld worden"
        },
        {
                  "en": "Creating question banks for exams",
                  "es": "Crear bancos de preguntas para exámenes",
                  "de": "Fragenbänke für Prüfungen erstellen",
                  "nl": "Vragenbanken maken voor examens"
        },
        {
                  "en": "Analyzing survey responses",
                  "es": "Analizar respuestas de encuestas",
                  "de": "Umfrageantworten analysieren",
                  "nl": "Enquêteantwoorden analyseren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Comparing file sizes",
                  "es": "Comparar tamaños de archivos",
                  "de": "Dateigrößen vergleichen",
                  "nl": "Bestandsgroottes vergelijken"
        },
        {
                  "en": "Checking if text looks visually similar",
                  "es": "Verificar si el texto se ve visualmente similar",
                  "de": "Prüfen ob Text visuell ähnlich aussieht",
                  "nl": "Controleren of tekst er visueel vergelijkbaar uitziet"
        },
        {
                  "en": "Finding words with same number of letters",
                  "es": "Encontrar palabras con el mismo número de letras",
                  "de": "Wörter mit gleicher Buchstabenanzahl finden",
                  "nl": "Woorden vinden met hetzelfde aantal letters"
        },
        {
                  "en": "Measuring how similar two pieces of text are in meaning",
                  "es": "Medir qué tan similares son dos piezas de texto en significado",
                  "de": "Messen wie ähnlich zwei Textstücke in der Bedeutung sind",
                  "nl": "Meten hoe vergelijkbaar twee stukken tekst zijn in betekenis"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "nl": "Tekst op papier afdrukken"
        },
        {
                  "en": "Automatically creating new text using AI models",
                  "es": "Crear automáticamente texto nuevo usando modelos de IA",
                  "de": "Automatisch neuen Text mit KI-Modellen erstellen",
                  "nl": "Automatisch nieuwe tekst maken met AI-modellen"
        },
        {
                  "en": "Typing text manually",
                  "es": "Escribir texto manualmente",
                  "de": "Text manuell tippen",
                  "nl": "Tekst handmatig typen"
        },
        {
                  "en": "Copying existing text",
                  "es": "Copiar texto existente",
                  "de": "Bestehenden Text kopieren",
                  "nl": "Bestaande tekst kopiëren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A browser window for reading",
                  "es": "Una ventana de navegador para leer",
                  "de": "Ein Browserfenster zum Lesen",
                  "nl": "Een browservenster voor lezen"
        },
        {
                  "en": "The time frame for processing",
                  "es": "El marco de tiempo para procesamiento",
                  "de": "Der Zeitrahmen für die Verarbeitung",
                  "nl": "Het tijdsbestek voor verwerking"
        },
        {
                  "en": "A computer window showing text",
                  "es": "Una ventana de computadora mostrando texto",
                  "de": "Ein Computerfenster das Text zeigt",
                  "nl": "Een computervenster dat tekst toont"
        },
        {
                  "en": "The surrounding words considered when processing a specific word",
                  "es": "Las palabras circundantes consideradas al procesar una palabra específica",
                  "de": "Die umgebenden Wörter die beim Verarbeiten eines bestimmten Wortes berücksichtigt werden",
                  "nl": "De omringende woorden die worden overwogen bij het verwerken van een specifiek woord"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Recognizing faces in images",
                  "es": "Reconocer rostros en imágenes",
                  "de": "Gesichter in Bildern erkennen",
                  "nl": "Gezichten herkennen in afbeeldingen"
        },
        {
                  "en": "Converting images of text into machine-readable text",
                  "es": "Convertir imágenes de texto en texto legible por máquina",
                  "de": "Bilder von Text in maschinenlesbaren Text umwandeln",
                  "nl": "Afbeeldingen van tekst omzetten naar machineleesbare tekst"
        },
        {
                  "en": "Scanning documents for viruses",
                  "es": "Escanear documentos en busca de virus",
                  "de": "Dokumente nach Viren scannen",
                  "nl": "Documenten scannen op virussen"
        },
        {
                  "en": "Creating optical illusions",
                  "es": "Crear ilusiones ópticas",
                  "de": "Optische Täuschungen erstellen",
                  "nl": "Optische illusies maken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reading people's minds",
                  "es": "Leer las mentes de las personas",
                  "de": "Gedanken von Menschen lesen",
                  "nl": "Gedachten van mensen lezen"
        },
        {
                  "en": "Identifying user locations",
                  "es": "Identificar ubicaciones de usuarios",
                  "de": "Benutzerstandorte identifizieren",
                  "nl": "Gebruikerslocaties identificeren"
        },
        {
                  "en": "Identifying the goal or purpose behind a user's input",
                  "es": "Identificar el objetivo o propósito detrás de la entrada de un usuario",
                  "de": "Das Ziel oder den Zweck hinter der Eingabe eines Benutzers identifizieren",
                  "nl": "Het doel of de bedoeling achter de invoer van een gebruiker identificeren"
        },
        {
                  "en": "Detecting malicious intentions in code",
                  "es": "Detectar intenciones maliciosas en código",
                  "de": "Böswillige Absichten im Code erkennen",
                  "nl": "Kwaadaardige intenties in code detecteren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Grouping similar documents together based on their content",
                  "es": "Agrupar documentos similares según su contenido",
                  "de": "Ähnliche Dokumente basierend auf ihrem Inhalt gruppieren",
                  "nl": "Vergelijkbare documenten groeperen op basis van hun inhoud"
        },
        {
                  "en": "Compressing multiple documents",
                  "es": "Comprimir múltiples documentos",
                  "de": "Mehrere Dokumente komprimieren",
                  "nl": "Meerdere documenten comprimeren"
        },
        {
                  "en": "Printing documents together",
                  "es": "Imprimir documentos juntos",
                  "de": "Dokumente zusammen drucken",
                  "nl": "Documenten samen afdrukken"
        },
        {
                  "en": "Organizing files in folders",
                  "es": "Organizar archivos en carpetas",
                  "de": "Dateien in Ordnern organisieren",
                  "nl": "Bestanden organiseren in mappen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting written text into spoken audio",
                  "es": "Convertir texto escrito en audio hablado",
                  "de": "Geschriebenen Text in gesprochenes Audio umwandeln",
                  "nl": "Geschreven tekst omzetten naar gesproken audio"
        },
        {
                  "en": "Typing what someone says",
                  "es": "Escribir lo que alguien dice",
                  "de": "Tippen was jemand sagt",
                  "nl": "Typen wat iemand zegt"
        },
        {
        ...
        {
                  "en": "Teaching people to speak",
                  "es": "Enseñar a las personas a hablar",
                  "de": "Menschen das Sprechen beibringen",
                  "nl": "Mensen leren spreken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Finding spelling errors in words",
                  "es": "Encontrar errores de ortografía en palabras",
                  "de": "Rechtschreibfehler in Wörtern finden",
                  "nl": "Spelfouten in woorden vinden"
        },
        {
                  "en": "Translating ambiguous words",
                  "es": "Traducir palabras ambiguas",
                  "de": "Mehrdeutige Wörter übersetzen",
                  "nl": "Dubbelzinnige woorden vertalen"
        },
        {
                  "en": "Counting different words in text",
                  "es": "Contar diferentes palabras en texto",
                  "de": "Verschiedene Wörter im Text zählen",
                  "nl": "Verschillende woorden in tekst tellen"
        },
        {
                  "en": "Determining which meaning of a word is used in a specific context",
                  "es": "Determinar qué significado de una palabra se usa en un contexto específico",
                  "de": "Bestimmen welche Bedeutung eines Wortes in einem bestimmten Kontext verwendet wird",
                  "nl": "Bepalen welke betekenis van een woord wordt gebruikt in een specifieke context"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Teaching people new languages",
                  "es": "Enseñar a las personas nuevos idiomas",
                  "de": "Menschen neue Sprachen beibringen",
                  "nl": "Mensen nieuwe talen leren"
        },
        {
                  "en": "Automatically detecting which language a text is written in",
                  "es": "Detectar automáticamente en qué idioma está escrito un texto",
                  "de": "Automatisch erkennen in welcher Sprache ein Text geschrieben ist",
                  "nl": "Automatisch detecteren in welke taal een tekst geschreven is"
        },
        {
                  "en": "Creating new programming languages",
                  "es": "Crear nuevos lenguajes de programación",
                  "de": "Neue Programmiersprachen erstellen",
                  "nl": "Nieuwe programmeertalen maken"
        },
        {
                  "en": "Identifying grammatical errors",
                  "es": "Identificar errores gramaticales",
                  "de": "Grammatikalische Fehler identifizieren",
