// Natuurlijke taalverwerking Quiz - Level 8
(function() {
  const level8 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "GPT cannot be fine-tuned for specific tasks",
                  "es": "GPT no puede ser ajustado para tareas específicas",
                  "de": "GPT kann nicht für spezifische Aufgaben feinabgestimmt werden",
                  "nl": "GPT kan niet worden aangepast voor specifieke taken"
        },
        {
                  "en": "GPT uses a decoder-only architecture with autoregressive generation, while BERT uses an encoder with bidirectional context",
                  "es": "GPT usa una arquitectura solo-decodificador con generación autoregresiva, mientras BERT usa un codificador con contexto bidireccional",
                  "de": "GPT verwendet eine reine Decoder-Architektur mit autoregressiver Generierung, während BERT einen Encoder mit bidirektionalem Kontext verwendet",
                  "nl": "GPT gebruikt een decoder-only architectuur met autoregressieve generatie, terwijl BERT een encoder gebruikt met bidirectionele context"
        },
        {
                  "en": "GPT only works with English text",
                  "es": "GPT solo funciona con texto en inglés",
                  "de": "GPT funktioniert nur mit englischem Text",
                  "nl": "GPT werkt alleen met Engelse tekst"
        },
        {
                  "en": "GPT is smaller than BERT in parameter count",
                  "es": "GPT es más pequeño que BERT en número de parámetros",
                  "de": "GPT ist kleiner als BERT in der Parameteranzahl",
                  "nl": "GPT is kleiner dan BERT in aantal parameters"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "T5 cannot handle multiple languages",
                  "es": "T5 no puede manejar múltiples idiomas",
                  "de": "T5 kann nicht mit mehreren Sprachen umgehen",
                  "nl": "T5 kan niet omgaan met meerdere talen"
        },
        {
                  "en": "T5 uses only convolutional layers",
                  "es": "T5 usa solo capas convolucionales",
                  "de": "T5 verwendet nur Faltungsschichten",
                  "nl": "T5 gebruikt alleen convolutielagen"
        },
        {
                  "en": "T5 is trained only on code data",
                  "es": "T5 se entrena solo con datos de código",
                  "de": "T5 wird nur auf Code-Daten trainiert",
                  "nl": "T5 wordt alleen getraind op codedata"
        },
        {
                  "en": "T5 frames all NLP tasks as text-to-text problems, using a unified input-output format",
                  "es": "T5 enmarca todas las tareas de PLN como problemas texto-a-texto, usando un formato unificado de entrada-salida",
                  "de": "T5 rahmt alle NLP-Aufgaben als Text-zu-Text-Probleme ein und verwendet ein einheitliches Eingabe-Ausgabe-Format",
                  "nl": "T5 formuleert alle NLP-taken als tekst-naar-tekst problemen, met een uniform invoer-uitvoerformaat"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning to forget previous knowledge",
                  "es": "Aprender a olvidar conocimiento previo",
                  "de": "Lernen vorheriges Wissen zu vergessen",
                  "nl": "Leren om eerdere kennis te vergeten"
        },
        {
                  "en": "The ability to perform new tasks by providing just a few examples in the input prompt, without additional training",
                  "es": "La capacidad de realizar nuevas tareas proporcionando solo unos pocos ejemplos en el prompt de entrada, sin entrenamiento adicional",
                  "de": "Die Fähigkeit neue Aufgaben zu erfüllen indem nur wenige Beispiele im Eingabeprompt bereitgestellt werden, ohne zusätzliches Training",
                  "nl": "Het vermogen om nieuwe taken uit te voeren door slechts enkele voorbeelden in de invoerprompt te geven, zonder aanvullende training"
        },
        {
                  "en": "Using very small datasets for training",
                  "es": "Usar conjuntos de datos muy pequeños para entrenamiento",
                  "de": "Sehr kleine Datensätze für das Training verwenden",
                  "nl": "Zeer kleine datasets gebruiken voor training"
        },
        {
                  "en": "Training the model for only a few epochs",
                  "es": "Entrenar el modelo por solo unas pocas épocas",
                  "de": "Das Modell nur für wenige Epochen zu trainieren",
                  "nl": "Het model slechts voor enkele epochs trainen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A metric for measuring model size",
                  "es": "Una métrica para medir el tamaño del modelo",
                  "de": "Eine Metrik zur Messung der Modellgröße",
                  "nl": "Een metriek voor het meten van modelgrootte"
        },
        {
                  "en": "A count of unique words in the vocabulary",
                  "es": "Un conteo de palabras únicas en el vocabulario",
                  "de": "Eine Zählung einzigartiger Wörter im Vokabular",
                  "nl": "Een telling van unieke woorden in de woordenschat"
        },
        {
                  "en": "A metric that measures the quality of machine-generated text by comparing n-gram overlap with reference texts",
                  "es": "Una métrica que mide la calidad del texto generado por máquina comparando la superposición de n-gramas con textos de referencia",
                  "de": "Eine Metrik die die Qualität maschinengenerierter Texte misst indem sie N-Gramm-Überlappung mit Referenztexten vergleicht",
                  "nl": "Een metriek die de kwaliteit van machine-gegenereerde tekst meet door n-gram overlap te vergelijken met referentieteksten"
        },
        {
                  "en": "A measure of how fast a model can process text",
                  "es": "Una medida de qué tan rápido un modelo puede procesar texto",
                  "de": "Ein Maß dafür wie schnell ein Modell Text verarbeiten kann",
                  "nl": "Een maat voor hoe snel een model tekst kan verwerken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They measure how fast models can process text",
                  "es": "Miden qué tan rápido los modelos pueden procesar texto",
                  "de": "Sie messen wie schnell Modelle Text verarbeiten können",
                  "nl": "Ze meten hoe snel modellen tekst kunnen verwerken"
        },
        {
                  "en": "They describe the predictable relationship between model size, training data, and compute, showing that performance improves with scale",
                  "es": "Describen la relación predecible entre tamaño del modelo, datos de entrenamiento y cómputo, mostrando que el rendimiento mejora con la escala",
                  "de": "Sie beschreiben die vorhersagbare Beziehung zwischen Modellgröße, Trainingsdaten und Berechnung und zeigen dass Leistung mit Skalierung verbessert",
                  "nl": "Ze beschrijven de voorspelbare relatie tussen modelgrootte, trainingsdata en rekenkracht, waarbij wordt aangetoond dat prestaties verbeteren met schaal"
        },
        {
                  "en": "They determine the optimal learning rate for training",
                  "es": "Determinan la tasa de aprendizaje óptima para entrenamiento",
                  "de": "Sie bestimmen die optimale Lernrate für das Training",
                  "nl": "Ze bepalen de optimale leersnelheid voor training"
        },
        {
                  "en": "They show that smaller models are always better",
                  "es": "Muestran que los modelos más pequeños siempre son mejores",
                  "de": "Sie zeigen dass kleinere Modelle immer besser sind",
                  "nl": "Ze tonen aan dat kleinere modellen altijd beter zijn"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Masking attention weights during inference",
                  "es": "Enmascarar pesos de atención durante inferencia",
                  "de": "Aufmerksamkeitsgewichte während der Inferenz maskieren",
                  "nl": "Aandachtgewichten maskeren tijdens inferentie"
        },
        {
                  "en": "Using special masks to hide parts of the neural network",
                  "es": "Usar máscaras especiales para ocultar partes de la red neuronal",
                  "de": "Spezielle Masken verwenden um Teile des neuronalen Netzwerks zu verbergen",
                  "nl": "Speciale maskers gebruiken om delen van het neurale netwerk te verbergen"
        },
        {
                  "en": "Randomly masking tokens in input text and training the model to predict the original tokens using bidirectional context",
                  "es": "Enmascarar aleatoriamente tokens en texto de entrada y entrenar el modelo para predecir los tokens originales usando contexto bidireccional",
                  "de": "Zufällig Tokens im Eingabetext maskieren und das Modell trainieren die ursprünglichen Tokens mit bidirektionalem Kontext vorherzusagen",
                  "nl": "Willekeurig tokens maskeren in invoertekst en het model trainen om de oorspronkelijke tokens te voorspellen met bidirectionele context"
        },
        {
                  "en": "Applying filters to remove noise from training data",
                  "es": "Aplicar filtros para eliminar ruido de datos de entrenamiento",
                  "de": "Filter anwenden um Rauschen aus Trainingsdaten zu entfernen",
                  "nl": "Filters toepassen om ruis uit trainingsgegevens te verwijderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A binary classification task where BERT learns to predict if two sentences are consecutive in the original document",
                  "es": "Una tarea de clasificación binaria donde BERT aprende a predecir si dos oraciones son consecutivas en el documento original",
                  "de": "Eine binäre Klassifikationsaufgabe wo BERT lernt vorherzusagen ob zwei Sätze im ursprünglichen Dokument aufeinanderfolgend sind",
                  "nl": "Een binaire classificatietaak waarbij BERT leert te voorspellen of twee zinnen opeenvolgend zijn in het oorspronkelijke document"
        },
        {
                  "en": "Predicting the sentiment of the next sentence",
                  "es": "Predecir el sentimiento de la siguiente oración",
                  "de": "Das Sentiment des nächsten Satzes vorhersagen",
                  "nl": "Het sentiment van de volgende zin voorspellen"
        },
        {
                  "en": "Counting how many sentences follow",
                  "es": "Contar cuántas oraciones siguen",
                  "de": "Zählen wie viele Sätze folgen",
                  "nl": "Tellen hoeveel zinnen volgen"
        },
        {
                  "en": "Generating the next sentence given a prompt",
                  "es": "Generar la siguiente oración dado un prompt",
                  "de": "Den nächsten Satz bei gegebenem Prompt generieren",
                  "nl": "De volgende zin genereren gegeven een prompt"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Encoders work with text, decoders work with images",
                  "es": "Los codificadores funcionan con texto, los decodificadores con imágenes",
                  "de": "Encoder arbeiten mit Text, Decoder arbeiten mit Bildern",
                  "nl": "Encoders werken met tekst, decoders werken met afbeeldingen"
        },
        {
                  "en": "Encoders compress data, decoders expand it",
                  "es": "Los codificadores comprimen datos, los decodificadores los expanden",
                  "de": "Encoder komprimieren Daten, Decoder erweitern sie",
                  "nl": "Encoders comprimeren data, decoders breiden het uit"
        },
        {
                  "en": "Encoders are faster than decoders",
                  "es": "Los codificadores son más rápidos que los decodificadores",
                  "de": "Encoder sind schneller als Decoder",
                  "nl": "Encoders zijn sneller dan decoders"
        },
        {
                  "en": "Encoders use bidirectional self-attention to understand input, decoders use masked self-attention for sequential generation",
                  "es": "Los codificadores usan auto-atención bidireccional para entender entrada, los decodificadores usan auto-atención enmascarada para generación secuencial",
                  "de": "Encoder verwenden bidirektionale Selbstaufmerksamkeit zum Verstehen der Eingabe, Decoder verwenden maskierte Selbstaufmerksamkeit für sequenzielle Generierung",
                  "nl": "Encoders gebruiken bidirectionele zelf-aandacht om invoer te begrijpen, decoders gebruiken gemaskeerde zelf-aandacht voor sequentiële generatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They mark the beginning and end of every word",
                  "es": "Marcan el inicio y fin de cada palabra",
                  "de": "Sie markieren Anfang und Ende jedes Wortes",
                  "nl": "Ze markeren het begin en einde van elk woord"
        },
        {
                  "en": "[CLS] provides a sequence-level representation for classification, [SEP] separates different segments or sentences",
                  "es": "[CLS] proporciona una representación a nivel de secuencia para clasificación, [SEP] separa diferentes segmentos u oraciones",
                  "de": "[CLS] bietet eine Repräsentation auf Sequenzebene für Klassifikation, [SEP] trennt verschiedene Segmente oder Sätze",
                  "nl": "[CLS] biedt een representatie op sequentieniveau voor classificatie, [SEP] scheidt verschillende segmenten of zinnen"
        },
        {
                  "en": "They indicate punctuation in the text",
                  "es": "Indican puntuación en el texto",
                  "de": "Sie zeigen Interpunktion im Text an",
                  "nl": "Ze geven interpunctie in de tekst aan"
        },
        {
                  "en": "They represent unknown vocabulary items",
                  "es": "Representan elementos de vocabulario desconocidos",
                  "de": "Sie repräsentieren unbekannte Vokabularelemente",
                  "nl": "Ze vertegenwoordigen onbekende vocabulaire-items"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Autoregressive models predict next tokens sequentially (GPT), autoencoding models reconstruct masked tokens bidirectionally (BERT)",
                  "es": "Los modelos autoregresivos predicen tokens siguientes secuencialmente (GPT), los modelos autocodificadores reconstruyen tokens enmascarados bidireccionalmente (BERT)",
                  "de": "Autoregressive Modelle sagen nächste Tokens sequenziell vorher (GPT), autoenkodiergende Modelle rekonstruieren maskierte Tokens bidirektional (BERT)",
                  "nl": "Autoregressieve modellen voorspellen volgende tokens sequentieel (GPT), autocoderende modellen reconstrueren gemaskeerde tokens bidirectioneel (BERT)"
        },
        {
                  "en": "Autoregressive models work only with numbers",
                  "es": "Los modelos autoregresivos funcionan solo con números",
                  "de": "Autoregressive Modelle funktionieren nur mit Zahlen",
                  "nl": "Autoregressieve modellen werken alleen met getallen"
        },
        {
        ...
        {
                  "en": "Autoregressive models are larger than autoencoding models",
                  "es": "Los modelos autoregresivos son más grandes que los modelos autocodificadores",
                  "de": "Autoregressive Modelle sind größer als autoenkodierende Modelle",
                  "nl": "Autoregressieve modellen zijn groter dan autocoderende modellen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only recurrent neural networks",
                  "es": "Solo redes neuronales recurrentes",
                  "de": "Nur rekurrente neuronale Netzwerke",
                  "nl": "Alleen recurrente neurale netwerken"
        },
        {
                  "en": "Convolutional layers and pooling operations",
                  "es": "Capas convolucionales y operaciones de pooling",
                  "de": "Faltungsschichten und Pooling-Operationen",
                  "nl": "Convolutielagen en pooling-operaties"
        },
        {
                  "en": "Simple feedforward networks only",
                  "es": "Solo redes feedforward simples",
                  "de": "Nur einfache Feedforward-Netzwerke",
                  "nl": "Alleen eenvoudige feedforward netwerken"
        },
        {
                  "en": "Encoder stack, decoder stack, multi-head attention, position-wise feedforward networks, and positional encoding",
                  "es": "Pila de codificadores, pila de decodificadores, atención multi-cabeza, redes feedforward posicionales, y codificación posicional",
                  "de": "Encoder-Stapel, Decoder-Stapel, Multi-Head-Attention, positionsweise Feedforward-Netzwerke und Positionskodierung",
                  "nl": "Encoder stack, decoder stack, multi-head attention, positionele feedforward netwerken, en positionele encoding"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Die Anzahl der Parameter im Modell reduzieren",
                  "nl": "Het aantal parameters in het model verminderen"
        },
        {
                  "en": "Converting text to numerical values",
                  "es": "Convertir texto a valores numéricos",
                  "de": "Text in numerische Werte umwandeln",
                  "nl": "Tekst omzetten naar numerieke waarden"
        },
        {
                  "en": "Stabilizing training by normalizing activations across features, reducing internal covariate shift and enabling deeper networks",
                  "es": "Estabilizar entrenamiento normalizando activaciones a través de características, reduciendo cambio de covariable interno y permitiendo redes más profundas",
                  "de": "Training stabilisieren durch Normalisierung von Aktivierungen über Features, reduziert interne Kovariatenv erschiebung und ermöglicht tiefere Netzwerke",
                  "nl": "Training stabiliseren door activaties te normaliseren over features, vermindert interne covariate shift en maakt diepere netwerken mogelijk"
        },
        {
                  "en": "Speeding up inference time",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting between different data types",
                  "es": "Convertir entre diferentes tipos de datos",
                  "de": "Zwischen verschiedenen Datentypen konvertieren",
                  "nl": "Converteren tussen verschillende gegevenstypen"
        },
        {
                  "en": "Allowing gradients to flow directly through the network, preventing vanishing gradients and enabling training of deep models",
                  "es": "Permitir que gradientes fluyan directamente a través de la red, previniendo gradientes que desaparecen y permitiendo entrenamiento de modelos profundos",
                  "de": "Gradienten ermöglichen direkt durch das Netzwerk zu fließen, verhindert verschwindende Gradienten und ermöglicht Training tiefer Modelle",
                  "nl": "Gradiënten toestaan direct door het netwerk te stromen, voorkomt verdwijnende gradiënten en maakt training van diepe modellen mogelijk"
        },
        {
                  "en": "Reducing computational complexity",
                  "es": "Reducir complejidad computacional",
                  "de": "Rechnerische Komplexität reduzieren",
                  "nl": "Computationele complexiteit verminderen"
        },
        {
                  "en": "Adding more parameters to the model",
                  "es": "Añadir más parámetros al modelo",
                  "de": "Mehr Parameter zum Modell hinzufügen",
                  "nl": "Meer parameters aan het model toevoegen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Absolute encoding is more accurate than relative",
                  "es": "La codificación absoluta es más precisa que la relativa",
                  "de": "Absolute Kodierung ist genauer als relative",
                  "nl": "Absolute encoding is nauwkeuriger dan relatieve"
        },
        {
                  "en": "Relative encoding uses more computational resources",
                  "es": "La codificación relativa usa más recursos computacionales",
                  "de": "Relative Kodierung verwendet mehr Rechenressourcen",
                  "nl": "Relatieve encoding gebruikt meer computationele bronnen"
        },
        {
                  "en": "Absolute encoding assigns fixed position embeddings, relative encoding represents relationships between token positions",
                  "es": "La codificación absoluta asigna incrustaciones de posición fijas, la codificación relativa representa relaciones entre posiciones de tokens",
                  "de": "Absolute Kodierung weist feste Positionsembeddings zu, relative Kodierung repräsentiert Beziehungen zwischen Token-Positionen",
                  "nl": "Absolute encoding wijst vaste positie-embeddings toe, relatieve encoding vertegenwoordigt relaties tussen tokenposities"
        },
        {
                  "en": "They are exactly the same method",
                  "es": "Son exactamente el mismo método",
                  "de": "Sie sind genau dieselbe Methode",
                  "nl": "Het zijn precies dezelfde methode"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Loading the model parameters before training",
                  "es": "Cargar los parámetros del modelo antes del entrenamiento",
                  "de": "Die Modellparameter vor dem Training laden",
                  "nl": "De modelparameters laden voor training"
        },
        {
                  "en": "Testing the model on validation data first",
                  "es": "Probar el modelo en datos de validación primero",
                  "de": "Das Modell zuerst auf Validierungsdaten testen",
                  "nl": "Het model eerst testen op validatiegegevens"
        },
        {
                  "en": "Heating up the GPU for better performance",
                  "es": "Calentar la GPU para mejor rendimiento",
                  "de": "Die GPU aufheizen für bessere Leistung",
                  "nl": "De GPU opwarmen voor betere prestaties"
        },
        {
                  "en": "Gradually increasing the learning rate from zero to avoid unstable training in the early stages",
                  "es": "Aumentar gradualmente la tasa de aprendizaje desde cero para evitar entrenamiento inestable en las etapas tempranas",
                  "de": "Die Lernrate schrittweise von null erhöhen um instabiles Training in frühen Phasen zu vermeiden",
                  "nl": "Geleidelijk de leersnelheid verhogen vanaf nul om onstabiele training in de vroege stadia te vermijden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Having a human teacher supervise the training process",
                  "es": "Tener un maestro humano supervisar el proceso de entrenamiento",
                  "de": "Einen menschlichen Lehrer den Trainingsprozess überwachen lassen",
                  "nl": "Een menselijke leraar het trainingsproces laten superviseren"
        },
        {
                  "en": "Using ground truth tokens as inputs during training instead of the model's own predictions to speed up training",
                  "es": "Usar tokens de verdad fundamental como entradas durante entrenamiento en lugar de las predicciones del propio modelo para acelerar entrenamiento",
                  "de": "Ground-Truth-Tokens als Eingaben während des Trainings verwenden anstelle der eigenen Vorhersagen des Modells um Training zu beschleunigen",
                  "nl": "Ground truth tokens gebruiken als invoer tijdens training in plaats van de eigen voorspellingen van het model om training te versnellen"
        },
        {
                  "en": "Using only the best training examples",
                  "es": "Usar solo los mejores ejemplos de entrenamiento",
                  "de": "Nur die besten Trainingsbeispiele verwenden",
                  "nl": "Alleen de beste trainingsvoorbeelden gebruiken"
        },
        {
                  "en": "Forcing the model to learn faster",
                  "es": "Forzar al modelo a aprender más rápido",
                  "de": "Das Modell zwingen schneller zu lernen",
                  "nl": "Het model dwingen sneller te leren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "O(n²) donde n es la longitud de secuencia, debido a computar atención entre todos los pares de posiciones",
                  "de": "O(n²) wo n die Sequenzlänge ist, aufgrund der Berechnung von Aufmerksamkeit zwischen allen Positionspaaren",
                  "nl": "O(n²) waarbij n de sequentielengte is, vanwege het berekenen van aandacht tussen alle paren van posities"
        },
        {
                  "en": "O(1) constant complexity",
                  "es": "Complejidad constante O(1)",
                  "de": "Konstante Komplexität O(1)",
                  "nl": "Constante complexiteit O(1)"
        },
        {
                  "en": "O(log n) logarithmic complexity",
                  "es": "Complejidad logarítmica O(log n)",
                  "de": "Logarithmische Komplexität O(log n)",
                  "nl": "Logaritmische complexiteit O(log n)"
        },
        {
                  "en": "O(n) linear complexity",
                  "es": "Complejidad lineal O(n)",
                  "de": "Lineare Komplexität O(n)",
                  "nl": "Lineaire complexiteit O(n)"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dense attention connects all positions, sparse attention only connects selected positions to reduce computational cost",
                  "es": "La atención densa conecta todas las posiciones, la atención dispersa solo conecta posiciones seleccionadas para reducir costo computacional",
                  "de": "Dichte Aufmerksamkeit verbindet alle Positionen, spärliche Aufmerksamkeit verbindet nur ausgewählte Positionen um Rechenkosten zu reduzieren",
                  "nl": "Dichte aandacht verbindt alle posities, schaarse aandacht verbindt alleen geselecteerde posities om rekenkosten te verminderen"
        },
        {
                  "en": "They refer to different model sizes",
                  "es": "Se refieren a diferentes tamaños de modelo",
                  "de": "Sie beziehen sich auf verschiedene Modellgrößen",
                  "nl": "Ze verwijzen naar verschillende modelgroottes"
        },
        {
                  "en": "Sparse attention produces better results",
                  "es": "La atención dispersa produce mejores resultados",
                  "de": "Spärliche Aufmerksamkeit produziert bessere Ergebnisse",
                  "nl": "Schaarse aandacht produceert betere resultaten"
        },
        {
                  "en": "Dense attention is faster than sparse attention",
                  "es": "La atención densa es más rápida que la atención dispersa",
                  "de": "Dichte Aufmerksamkeit ist schneller als spärliche Aufmerksamkeit",
                  "nl": "Dichte aandacht is sneller dan schaarse aandacht"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Computing gradients over multiple mini-batches before updating parameters, simulating larger batch sizes with limited memory",
                  "es": "Computar gradientes sobre múltiples mini-lotes antes de actualizar parámetros, simulando tamaños de lote más grandes con memoria limitada",
                  "de": "Gradienten über mehrere Mini-Batches berechnen vor Parameterupdates, simuliert größere Batch-Größen mit begrenztem Speicher",
                  "nl": "Gradiënten berekenen over meerdere mini-batches voordat parameters worden bijgewerkt, simuleert grotere batch-groottes met beperkt geheugen"
        },
        {
                  "en": "Adding noise to gradients",
                  "es": "Añadir ruido a gradientes",
                  "de": "Rauschen zu Gradienten hinzufügen",
                  "nl": "Ruis toevoegen aan gradiënten"
        },
        {
                  "en": "Clipping gradients to prevent explosion",
                  "es": "Recortar gradientes para prevenir explosión",
                  "de": "Gradienten beschneiden um Explosion zu verhindern",
                  "nl": "Gradiënten afkappen om explosie te voorkomen"
        },
        {
                  "en": "Saving gradients for later analysis",
                  "es": "Guardar gradientes para análisis posterior",
                  "de": "Gradienten für spätere Analyse speichern",
                  "nl": "Gradiënten opslaan voor latere analyse"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Detener entrenamiento temprano",
                  "de": "Training früh stoppen",
                  "nl": "Training vroeg stoppen"
        },
        {
                  "en": "Randomly setting some neurons to zero during training to prevent overfitting and improve generalization",
                  "es": "Establecer aleatoriamente algunas neuronas a cero durante entrenamiento para prevenir sobreajuste y mejorar generalización",
                  "de": "Zufällig einige Neuronen auf null setzen während des Trainings um Überanpassung zu verhindern und Generalisierung zu verbessern",
                  "nl": "Willekeurig enkele neuronen op nul zetten tijdens training om overfitting te voorkomen en generalisatie te verbeteren"
        },
        {
                  "en": "Reducing the learning rate gradually",
                  "es": "Reducir la tasa de aprendizaje gradualmente",
                  "de": "Die Lernrate schrittweise reduzieren",
                  "nl": "De leersnelheid geleidelijk verminderen"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Preventing attention to future tokens to maintain autoregressive property and ensure each token can only attend to previous positions",
                  "es": "Prevenir atención a tokens futuros para mantener propiedad autoregresiva y asegurar que cada token solo pueda atender posiciones previas",
                  "de": "Aufmerksamkeit auf zukünftige Tokens verhindern um autoregressive Eigenschaft zu erhalten und sicherzustellen dass jeder Token nur auf vorherige Positionen achten kann",
                  "nl": "Voorkomen van aandacht voor toekomstige tokens om autoregressieve eigenschap te behouden en ervoor te zorgen dat elk token alleen naar vorige posities kan kijken"
        },
        {
                  "en": "Applying dropout to specific attention heads",
                  "es": "Aplicar dropout a cabezas de atención específicas",
                  "de": "Dropout auf spezifische Aufmerksamkeitsköpfe anwenden",
                  "nl": "Dropout toepassen op specifieke aandachtkoppen"
        },
        {
                  "en": "Masking random tokens during training",
                  "es": "Enmascarar tokens aleatorios durante entrenamiento",
                  "de": "Zufällige Tokens während des Trainings maskieren",
                  "nl": "Willekeurige tokens maskeren tijdens training"
        },
        {
                  "en": "Hiding certain layers from backpropagation",
                  "es": "Ocultar ciertas capas de retropropagación",
                  "de": "Bestimmte Schichten vor Backpropagation verbergen",
                  "nl": "Bepaalde lagen verbergen voor backpropagation"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training a smaller student model to mimic a larger teacher model's behavior, creating compact models with similar performance",
                  "es": "Entrenar un modelo estudiante más pequeño para imitar el comportamiento de un modelo profesor más grande, creando modelos compactos con rendimiento similar",
                  "de": "Ein kleineres Student-Modell trainieren um das Verhalten eines größeren Teacher-Modells nachzuahmen, erstellt kompakte Modelle mit ähnlicher Leistung",
                  "nl": "Een kleiner studentmodel trainen om het gedrag van een groter leraarmodel na te bootsen, creëert compacte modellen met vergelijkbare prestaties"
        },
        {
                  "en": "Removing redundant parameters from the model",
                  "es": "Eliminar parámetros redundantes del modelo",
                  "de": "Redundante Parameter aus dem Modell entfernen",
                  "nl": "Redundante parameters uit het model verwijderen"
        },
        {
                  "en": "Extracting key facts from training data",
                  "es": "Extraer hechos clave de datos de entrenamiento",
                  "de": "Schlüsselfakten aus Trainingsdaten extrahieren",
                  "nl": "Sleutelfakten extraheren uit trainingsgegevens"
        },
        {
                  "en": "Compressing the vocabulary size",
                  "es": "Comprimir el tamaño del vocabulario",
                  "de": "Die Vokabulargröße komprimieren",
                  "nl": "De vocabulairegrootte comprimeren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Compressing long documents into smaller representations",
                  "es": "Comprimir documentos largos en representaciones más pequeñas",
                  "de": "Lange Dokumente in kleinere Repräsentationen komprimieren",
                  "nl": "Lange documenten comprimeren in kleinere representaties"
        },
        {
                  "en": "Identifying the sentiment of each segment",
                  "es": "Identificar el sentimiento de cada segmento",
                  "de": "Das Sentiment jedes Segments identifizieren",
                  "nl": "Het sentiment van elk segment identificeren"
        },
        {
                  "en": "Distinguishing between different sentences or text segments in the input, enabling the model to process sentence pairs",
                  "es": "Distinguir entre diferentes oraciones o segmentos de texto en la entrada, permitiendo al modelo procesar pares de oraciones",
                  "de": "Zwischen verschiedenen Sätzen oder Textsegmenten in der Eingabe unterscheiden, ermöglicht dem Modell Satzpaare zu verarbeiten",
                  "nl": "Onderscheid maken tussen verschillende zinnen of tekstsegmenten in de invoer, stelt het model in staat zinsparen te verwerken"
        },
        {
                  "en": "Storing the original word order",
                  "es": "Almacenar el orden original de palabras",
                  "de": "Die ursprüngliche Wortreihenfolge speichern",
                  "nl": "De oorspronkelijke woordvolgorde opslaan"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "GPT-3 demonstrates strong few-shot and zero-shot learning capabilities that emerge from scale, while GPT-2 requires fine-tuning for most tasks",
                  "es": "GPT-3 demuestra fuertes capacidades de aprendizaje de pocos ejemplos y cero ejemplos que emergen de la escala, mientras GPT-2 requiere ajuste fino para la mayoría de tareas",
                  "de": "GPT-3 zeigt starke Few-Shot- und Zero-Shot-Lernfähigkeiten die aus Skalierung entstehen, während GPT-2 Feinabstimmung für die meisten Aufgaben benötigt",
                  "nl": "GPT-3 toont sterke few-shot en zero-shot leercapaciteiten die voortkomen uit schaal, terwijl GPT-2 fine-tuning vereist voor de meeste taken"
        },
        {
                  "en": "GPT-3 can only process images",
                  "es": "GPT-3 solo puede procesar imágenes",
                  "de": "GPT-3 kann nur Bilder verarbeiten",
                  "nl": "GPT-3 kan alleen afbeeldingen verwerken"
        },
        {
                  "en": "GPT-3 uses a completely different architecture",
                  "es": "GPT-3 usa una arquitectura completamente diferente",
                  "de": "GPT-3 verwendet eine völlig andere Architektur",
                  "nl": "GPT-3 gebruikt een compleet andere architectuur"
        },
        {
                  "en": "GPT-2 is faster for all tasks",
                  "es": "GPT-2 es más rápido para todas las tareas",
                  "de": "GPT-2 ist schneller für alle Aufgaben",
                  "nl": "GPT-2 is sneller voor alle taken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Generating the final output predictions",
                  "es": "Generar las predicciones de salida finales",
                  "de": "Die finalen Ausgabevorhersagen generieren",
                  "nl": "De finale uitvoervoorspellingen genereren"
        },
        {
                  "en": "Computing attention weights",
                  "es": "Computar pesos de atención",
                  "de": "Aufmerksamkeitsgewichte berechnen",
                  "nl": "Aandachtgewichten berekenen"
        },
        {
                  "en": "Connecting the encoder and decoder",
                  "es": "Conectar el codificador y decodificador",
                  "de": "Encoder und Decoder verbinden",
                  "nl": "Encoder en decoder verbinden"
        },
        {
                  "en": "Processing each position independently with two linear transformations and a nonlinearity, adding representational capacity beyond attention",
                  "es": "Procesar cada posición independientemente con dos transformaciones lineales y una no linealidad, añadiendo capacidad representacional más allá de la atención",
                  "de": "Jede Position unabhängig mit zwei linearen Transformationen und einer Nichtlinearität verarbeiten, fügt Repräsentationskapazität jenseits von Aufmerksamkeit hinzu",
                  "nl": "Elke positie onafhankelijk verwerken met twee lineaire transformaties en een non-lineariteit, voegt representatiecapaciteit toe naast aandacht"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The vocabulary size of the model",
                  "es": "El tamaño del vocabulario del modelo",
                  "de": "Die Vokabulargröße des Modells",
                  "nl": "De vocabulairegrootte van het model"
        },
        {
                  "en": "The maximum sequence length the model can process at once, determining how much context it can consider when generating or understanding text",
                  "es": "La longitud máxima de secuencia que el modelo puede procesar a la vez, determinando cuánto contexto puede considerar al generar o entender texto",
                  "de": "Die maximale Sequenzlänge die das Modell auf einmal verarbeiten kann, bestimmt wie viel Kontext es beim Generieren oder Verstehen von Text berücksichtigen kann",
                  "nl": "De maximale sequentielengte die het model tegelijk kan verwerken, bepaalt hoeveel context het kan overwegen bij het genereren of begrijpen van tekst"
        },
        {
                  "en": "The number of attention heads",
                  "es": "El número de cabezas de atención",
                  "de": "Die Anzahl der Aufmerksamkeitsköpfe",
                  "nl": "Het aantal aandachtkoppen"
        },
        {
                  ...
                  "nl": "De grootte van de trainingsdataset"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A measure of how well a model predicts a sample, with lower perplexity indicating better prediction and understanding of language patterns",
                  "es": "Una medida de qué tan bien un modelo predice una muestra, con perplejidad más baja indicando mejor predicción y comprensión de patrones de lenguaje",
                  "de": "Ein Maß dafür wie gut ein Modell eine Probe vorhersagt, wobei niedrigere Perplexität bessere Vorhersage und Verständnis von Sprachmustern anzeigt",
                  "nl": "Een maat voor hoe goed een model een sample voorspelt, waarbij lagere perplexiteit betere voorspelling en begrip van taalpatronen aangeeft"
        },
        {
        ...
        },
        {
                  ...
                  "de": "Die erforderliche Trainingszeit",
                  "nl": "De benodigde trainingstijd"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Including step-by-step reasoning in prompts to improve model performance on complex reasoning tasks",
                  "es": "Incluir razonamiento paso a paso en prompts para mejorar rendimiento del modelo en tareas de razonamiento complejas",
                  "de": "Schritt-für-Schritt-Reasoning in Prompts einbeziehen um Modellleistung bei komplexen Denkaufgaben zu verbessern",
                  "nl": "Stap-voor-stap redenering opnemen in prompts om modelprestaties bij complexe redeneertaken te verbeteren"
        },
        {
                  "en": "Creating prompt templates",
                  "es": "Crear plantillas de prompt",
                  "de": "Prompt-Vorlagen erstellen",
                  "nl": "Prompt-sjablonen maken"
        },
        {
                  "en": "Linking multiple prompts together",
                  "es": "Vincular múltiples prompts juntos",
                  "de": "Mehrere Prompts miteinander verknüpfen",
                  "nl": "Meerdere prompts aan elkaar koppelen"
        },
        {
                  "en": "Training models to follow chains of commands",
                  "es": "Entrenar modelos para seguir cadenas de comandos",
                  "de": "Modelle trainieren um Befehlsketten zu folgen",
                  "nl": "Modellen trainen om commandoketens te volgen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reducing precision of model weights from 32-bit to 8-bit or lower to decrease memory and improve inference speed",
                  "es": "Reducir precisión de pesos del modelo de 32 bits a 8 bits o menos para disminuir memoria y mejorar velocidad de inferencia",
                  "de": "Präzision von Modellgewichten von 32-Bit auf 8-Bit oder niedriger reduzieren um Speicher zu verringern und Inferenzgeschwindigkeit zu verbessern",
                  "nl": "Precisie van modelgewichten verlagen van 32-bit naar 8-bit of lager om geheugen te verminderen en inferentiesnelheid te verbeteren"
        },
        {
                  "en": "Converting models to quantum computers",
                  "es": "Convertir modelos a computadoras cuánticas",
                  "de": "Modelle für Quantencomputer umwandeln",
                  "nl": "Modellen converteren voor quantumcomputers"
        },
        {
                  "en": "Measuring model quality",
                  "es": "Medir calidad del modelo",
                  "de": "Modellqualität messen",
                  "nl": "Modelkwaliteit meten"
        },
        {
                  "en": "Breaking models into smaller parts",
                  "es": "Dividir modelos en partes más pequeñas",
                  "de": "Modelle in kleinere Teile zerlegen",
                  "nl": "Modellen opdelen in kleinere delen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining language models with external knowledge retrieval to ground responses in factual information",
                  "es": "Combinar modelos de lenguaje con recuperación de conocimiento externo para fundamentar respuestas en información factual",
                  "de": "Sprachmodelle mit externem Wissensabruf kombinieren um Antworten in faktischen Informationen zu verankern",
                  "nl": "Taalmodellen combineren met externe kennisopvraging om reacties te verankeren in feitelijke informatie"
        },
        {
                  "en": "Generating random augmented data",
                  "es": "Generar datos aumentados aleatorios",
                  "de": "Zufällige augmentierte Daten generieren",
                  "nl": "Willekeurige versterkte gegevens genereren"
        },
        {
                  "en": "Retrieving pre-written responses",
                  "es": "Recuperar respuestas pre-escritas",
                  "de": "Vorgeschriebene Antworten abrufen",
                  "nl": "Voorgeschreven reacties ophalen"
        },
        {
                  "en": "Augmenting training data with retrieval",
                  "es": "Aumentar datos de entrenamiento con recuperación",
                  "de": "Trainingsdaten mit Abruf augmentieren",
                  "nl": "Trainingsgegevens versterken met opvraging"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Attention with very few parameters",
                  "es": "Atención con muy pocos parámetros",
                  "de": "Aufmerksamkeit mit sehr wenigen Parametern",
                  "nl": "Aandacht met zeer weinig parameters"
        },
        {
                  "en": "Attention patterns that compute relationships only between selected token pairs, reducing O(n²) complexity for long sequences",
                  "es": "Patrones de atención que calculan relaciones solo entre pares de tokens seleccionados, reduciendo complejidad O(n²) para secuencias largas",
                  "de": "Aufmerksamkeitsmuster die Beziehungen nur zwischen ausgewählten Token-Paaren berechnen, reduziert O(n²) Komplexität für lange Sequenzen",
                  "nl": "Aandachtpatronen die relaties alleen berekenen tussen geselecteerde tokenparen, vermindert O(n²) complexiteit voor lange sequenties"
        },
        {
                  "en": "Removing attention layers",
                  "es": "Eliminar capas de atención",
                  "de": "Aufmerksamkeitsschichten entfernen",
                  "nl": "Aandachtlagen verwijderen"
        },
        {
                  "en": "Attention that rarely fires",
                  "es": "Atención que raramente se activa",
                  "de": "Aufmerksamkeit die selten feuert",
                  "nl": "Aandacht die zelden activeert"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI with fixed unchangeable rules",
                  "es": "IA con reglas fijas inmutables",
                  "de": "KI mit festen unveränderlichen Regeln",
                  "nl": "AI met vaste onveranderlijke regels"
        },
        {
                  "en": "Building AI based on constitutional laws",
                  "es": "Construir IA basada en leyes constitucionales",
                  "de": "KI basierend auf Verfassungsgesetzen bauen",
                  "nl": "AI bouwen gebaseerd op constitutionele wetten"
        },
        {
                  "en": "AI for government and legal systems",
                  "es": "IA para sistemas gubernamentales y legales",
                  "de": "KI für Regierungs- und Rechtssysteme",
                  "nl": "AI voor overheids- en rechtssystemen"
        },
        {
                  "en": "Training AI systems to follow a set of principles through self-critique and revision using constitutional guidelines",
                  "es": "Entrenar sistemas de IA para seguir un conjunto de principios a través de autocrítica y revisión usando pautas constitucionales",
                  "de": "KI-Systeme trainieren um einem Satz von Prinzipien zu folgen durch Selbstkritik und Revision mit konstitutionellen Richtlinien",
                  "nl": "AI-systemen trainen om een set principes te volgen via zelfkritiek en revisie met behulp van constitutionele richtlijnen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reinforcing model weights with human annotations",
                  "es": "Reforzar pesos del modelo con anotaciones humanas",
                  "de": "Modellgewichte mit menschlichen Annotationen verstärken",
                  "nl": "Modelgewichten versterken met menselijke annotaties"
        },
        {
                  "en": "Learning from human feedback during deployment",
                  "es": "Aprender de retroalimentación humana durante despliegue",
                  "de": "Aus menschlichem Feedback während Bereitstellung lernen",
                  "nl": "Leren van menselijke feedback tijdens inzet"
        },
        {
                  "en": "Having humans reinforce correct responses",
                  "es": "Hacer que humanos refuercen respuestas correctas",
                  "de": "Menschen korrekte Antworten verstärken lassen",
                  "nl": "Mensen correcte reacties laten versterken"
        },
        {
                  "en": "Training language models using human preferences to align outputs with human values and expectations",
                  "es": "Entrenar modelos de lenguaje usando preferencias humanas para alinear salidas con valores y expectativas humanas",
                  "de": "Sprachmodelle trainieren unter Verwendung menschlicher Präferenzen um Ausgaben mit menschlichen Werten und Erwartungen auszurichten",
                  "nl": "Taalmodellen trainen met behulp van menselijke voorkeuren om outputs af te stemmen op menselijke waarden en verwachtingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Encoder uses bidirectional self-attention for understanding, decoder uses causal self-attention plus cross-attention for generation",
                  "es": "Codificador usa auto-atención bidireccional para comprensión, decodificador usa auto-atención causal más atención cruzada para generación",
                  "de": "Encoder verwendet bidirektionale Selbstaufmerksamkeit für Verstehen, Decoder verwendet kausale Selbstaufmerksamkeit plus Cross-Attention für Generierung",
                  "nl": "Encoder gebruikt bidirectionele zelf-aandacht voor begrip, decoder gebruikt causale zelf-aandacht plus cross-attention voor generatie"
        },
        {
                  "en": "They have identical architectures",
                  "es": "Tienen arquitecturas idénticas",
                  "de": "Sie haben identische Architekturen",
                  "nl": "Ze hebben identieke architecturen"
        },
        {
                  "en": "Encoder is for training, decoder is for inference",
                  "es": "Codificador es para entrenamiento, decodificador es para inferencia",
                  "de": "Encoder ist für Training, Decoder ist für Inferenz",
                  "nl": "Encoder is voor training, decoder is voor inferentie"
        },
        {
                  "en": "Encoder is smaller than decoder",
                  "es": "Codificador es más pequeño que decodificador",
                  "de": "Encoder ist kleiner als Decoder",
                  "nl": "Encoder is kleiner dan decoder"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fine-tuning methods that update only a small subset of parameters, reducing memory and computation requirements",
                  "es": "Métodos de ajuste fino que actualizan solo un pequeño subconjunto de parámetros, reduciendo requisitos de memoria y computación",
                  "de": "Fine-Tuning-Methoden die nur eine kleine Teilmenge von Parametern aktualisieren, reduziert Speicher- und Rechenanforderungen",
                  "nl": "Fine-tuning methoden die alleen een kleine subset van parameters bijwerken, vermindert geheugen- en rekenvereisten"
        },
        {
                  "en": "Reducing the number of model layers",
                  "es": "Reducir el número de capas del modelo",
                  "de": "Anzahl der Modellschichten reduzieren",
                  "nl": "Het aantal modellagen verminderen"
        },
        {
                  "en": "Fine-tuning with fewer training examples",
                  "es": "Ajuste fino con menos ejemplos de entrenamiento",
                  "de": "Fine-Tuning mit weniger Trainingsbeispielen",
                  "nl": "Fine-tuning met minder trainingsvoorbeelden"
        },
        {
                  "en": "Fine-tuning faster than normal",
                  "es": "Ajuste fino más rápido que normal",
                  "de": "Schnelleres Fine-Tuning als normal",
                  "nl": "Fine-tuning sneller dan normaal"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A model compression technique",
                  "es": "Una técnica de compresión de modelos",
                  "de": "Eine Modellkomprimierungstechnik",
                  "nl": "Een modelcompressietechniek"
        },
        {
                  "en": "A long-range attention mechanism",
                  "es": "Un mecanismo de atención de largo alcance",
                  "de": "Ein Langstrecken-Aufmerksamkeitsmechanismus",
                  "nl": "Een langeafstands aandachtsmechanisme"
        },
        {
                  "en": "A PEFT method that adds trainable low-rank matrices to model layers, updating far fewer parameters than full fine-tuning",
                  "es": "Un método PEFT que añade matrices de rango bajo entrenables a capas del modelo, actualizando muchos menos parámetros que ajuste fino completo",
                  "de": "Eine PEFT-Methode die trainierbare Low-Rank-Matrizen zu Modellschichten hinzufügt, aktualisiert weit weniger Parameter als volles Fine-Tuning",
                  "nl": "Een PEFT-methode die trainbare low-rank matrices toevoegt aan modellagen, werkt veel minder parameters bij dan volledige fine-tuning"
        },
        {
                  "en": "A new optimizer algorithm",
                  "es": "Un nuevo algoritmo optimizador",
                  "de": "Ein neuer Optimierer-Algorithmus",
                  "nl": "Een nieuw optimalisatie-algoritme"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Indicating sentence boundaries",
                  "es": "Indicar límites de oraciones",
                  "de": "Satzgrenzen anzeigen",
                  "nl": "Zingrenzen aangeven"
        },
        {
                  "en": "Replacing tokens to be predicted during masked language modeling, forcing the model to learn bidirectional context",
                  "es": "Reemplazar tokens a predecir durante modelado de lenguaje enmascarado, forzando al modelo a aprender contexto bidireccional",
                  "de": "Tokens ersetzen die während maskierter Sprachmodellierung vorhergesagt werden sollen, zwingt das Modell bidirektionalen Kontext zu lernen",
                  "nl": "Tokens vervangen die voorspeld moeten worden tijdens gemaskeerde taalmodellering, dwingt het model bidirectionele context te leren"
        },
        {
                  "en": "Hiding sensitive information in text",
                  "es": "Ocultar información sensible en texto",
                  "de": "Sensible Informationen in Text verbergen",
                  "nl": "Gevoelige informatie in tekst verbergen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Visualizing model internals",
                  "es": "Visualizar internos del modelo",
                  "de": "Modell-Interna visualisieren",
                  "nl": "Model-interna visualiseren"
        },
        {
                  "en": "Generating plausible-sounding but factually incorrect or nonsensical information",
                  "es": "Generar información que suena plausible pero factualmente incorrecta o sin sentido",
                  "de": "Plausibel klingende aber faktisch falsche oder unsinnige Informationen generieren",
                  "nl": "Plausibel klinkende maar feitelijk onjuiste of zinloze informatie genereren"
        },
        {
                  "en": "Model dreaming during training",
                  "es": "Modelo soñando durante entrenamiento",
                  "de": "Modell träumt während Training",
                  "nl": "Model droomt tijdens training"
        },
        {
                  "en": "Generating creative fictional content",
                  "es": "Generar contenido ficticio creativo",
                  "de": "Kreative fiktionale Inhalte generieren",
                  "nl": "Creatieve fictieve inhoud genereren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Initializing model weights",
                  "es": "Inicializar pesos del modelo",
                  "de": "Modellgewichte initialisieren",
                  "nl": "Modelgewichten initialiseren"
        },
        {
                  "en": "Preventing gradient explosion",
                  "es": "Prevenir explosión de gradientes",
                  "de": "Gradientenexplosion verhindern",
                  "nl": "Gradiëntexplosie voorkomen"
        },
        {
                  "en": "Adding dropout during training",
                  "es": "Añadir dropout durante entrenamiento",
                  "de": "Dropout während Training hinzufügen",
                  "nl": "Dropout toevoegen tijdens training"
        },
        {
                  "en": "Adapting learning rates for each parameter using momentum and second-moment estimates for efficient optimization",
                  "es": "Adaptar tasas de aprendizaje para cada parámetro usando estimaciones de momento y segundo momento para optimización eficiente",
                  "de": "Lernraten für jeden Parameter anpassen unter Verwendung von Momentum und Zweitmoment-Schätzungen für effiziente Optimierung",
                  "nl": "Leersnelheden aanpassen voor elke parameter met behulp van momentum en tweede-moment schattingen voor efficiënte optimalisatie"
        }
        ],
        correct: 3,
        explanation: {
