// Machine learning Quiz - Level 10
(function() {
  const level10 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "A method for approximating correct predictions",
                  "es": "Un método para aproximar predicciones correctas",
                  "de": "Eine Methode zur Annäherung korrekter Vorhersagen",
                  "nl": "Een methode voor het benaderen van correcte voorspellingen"
        },
        {
                  "en": "Mathematical framework providing statistical learning bounds for algorithm performance with high probability",
                  "es": "Marco matemático que proporciona límites de aprendizaje estadístico para rendimiento de algoritmos con alta probabilidad",
                  "de": "Mathematisches Framework das statistische Lernschranken für Algorithmusleistung mit hoher Wahrscheinlichkeit bietet",
                  "nl": "Wiskundig raamwerk dat statistische leergrenzen biedt voor algoritmeprestaties met hoge waarschijnlijkheid"
        },
        {
                  "en": "Probabilistic accuracy checking for models",
                  "es": "Verificación probabilística de precisión para modelos",
                  "de": "Probabilistische Genauigkeitsprüfung für Modelle",
                  "nl": "Probabilistische nauwkeurigheidscontrole voor modellen"
        },
        {
                  "en": "A framework for packing algorithms correctly",
                  "es": "Un marco para empaquetar algoritmos correctamente",
                  "de": "Ein Framework zum korrekten Verpacken von Algorithmen",
                  "nl": "Een raamwerk voor het correct inpakken van algoritmes"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A measure of variance in model predictions",
                  "es": "Una medida de varianza en predicciones del modelo",
                  "de": "Ein Maß für Varianz in Modellvorhersagen",
                  "nl": "Een maat voor variantie in modelvoorspellingen"
        },
        {
                  "en": "Maximum number of points a hypothesis class can shatter, characterizing learning capacity and overfitting risk",
                  "es": "Número máximo de puntos que una clase de hipótesis puede fragmentar, caracterizando capacidad de aprendizaje y riesgo de overfitting",
                  "de": "Maximale Anzahl von Punkten die eine Hypothesenklasse zerschlagen kann, charakterisiert Lernkapazität und Overfitting-Risiko",
                  "nl": "Maximum aantal punten dat een hypotheseklasse kan verbrijzelen, karakteriseert leercapaciteit en overfitting risico"
        },
        {
                  "en": "A validation criterion for model selection",
                  "es": "Un criterio de validación para selección de modelos",
                  "de": "Ein Validierungskriterium für Modellauswahl",
                  "nl": "Een validatiecriterium voor modelselectie"
        },
        {
                  "en": "The complexity dimension of neural networks",
                  "es": "La dimensión de complejidad de redes neuronales",
                  "de": "Die Komplexitätsdimension neuronaler Netzwerke",
                  "nl": "De complexiteitsdimensie van neurale netwerken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Machine learning algorithms require significant computational resources",
                  "es": "Los algoritmos de machine learning requieren recursos computacionales significativos",
                  "de": "Maschinelle Lernalgorithmen benötigen erhebliche Rechenressourcen",
                  "nl": "Machine learning algoritmes vereisen aanzienlijke computationele middelen"
        },
        {
                  "en": "No algorithm performs better than others across all possible problems, emphasizing the importance of domain-specific algorithm selection",
                  "es": "Ningún algoritmo funciona mejor que otros en todos los problemas posibles, enfatizando importancia selección algoritmos específicos dominio",
                  "de": "Kein Algorithmus funktioniert besser als andere über alle möglichen Probleme, betont die Wichtigkeit domänenspezifischer Algorithmusauswahl",
                  "nl": "Geen algoritme presteert beter dan anderen over alle mogelijke problemen, benadrukt het belang van domeinspecifieke algoritme selectie"
        },
        {
                  "en": "Free algorithms don't exist in machine learning",
                  "es": "Los algoritmos gratuitos no existen en machine learning",
                  "de": "Kostenlose Algorithmen existieren nicht im maschinellen Lernen",
                  "nl": "Gratis algoritmes bestaan niet in machine learning"
        },
        {
                  "en": "All learning requires labeled training data",
                  "es": "Todo aprendizaje requiere datos de entrenamiento etiquetados",
                  "de": "Alles Lernen erfordert beschriftete Trainingsdaten",
                  "nl": "Al het leren vereist gelabelde trainingsdata"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Algorithm for measuring computational complexity",
                  "es": "Algoritmo para medir complejidad computacional",
                  "de": "Algorithmus zur Messung rechnerischer Komplexität",
                  "nl": "Algoritme voor het meten van computationele complexiteit"
        },
        {
                  "en": "Method for describing machine learning algorithms",
                  "es": "Método para describir algoritmos de machine learning",
                  "de": "Methode zur Beschreibung maschineller Lernalgorithmen",
                  "nl": "Methode voor het beschrijven van machine learning algoritmes"
        },
        {
                  "en": "Framework using Kolmogorov complexity to balance model fit and complexity by preferring models with shortest total description",
                  "es": "Marco usando complejidad Kolmogorov para equilibrar ajuste y complejidad del modelo prefiriendo modelos con descripción total más corta",
                  "de": "Framework das Kolmogorov-Komplexität verwendet um Modellanpassung und Komplexität zu balancieren durch Bevorzugung Modellen mit kürzester Beschreibung",
                  "nl": "Raamwerk dat Kolmogorov complexiteit gebruikt om modelfit en complexiteit te balanceren door modellen met kortste totale beschrijving te prefereren"
        },
        {
                  "en": "Theory about information processing in algorithms",
                  "es": "Teoría sobre procesamiento de información en algoritmos",
                  "de": "Theorie über Informationsverarbeitung in Algorithmen",
                  "nl": "Theorie over informatieverwerking in algoritmes"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "NP-hardness of many learning problems necessitates approximation algorithms and heuristics, with sample complexity bounds guiding data requirements",
                  "es": "NP-dureza de muchos problemas aprendizaje necesita algoritmos aproximación y heurísticas, con límites complejidad muestra guiando requerimientos datos",
                  "de": "NP-Härte vieler Lernprobleme erfordert Approximationsalgorithmen und Heuristiken, mit Stichprobenkomplexitätsbeschränkungen die Datenanforderungen leiten",
                  "nl": "NP-hardheid van veel leerproblemen vereist benaderingsalgoritmes en heuristieken, met steekproefcomplexiteitsgrenzen die datavereisten leiden"
        },
        {
                  "en": "Theoretical limitations only apply to classical algorithms",
                  "es": "Las limitaciones teóricas solo se aplican a algoritmos clásicos",
                  "de": "Theoretische Limitationen gelten nur für klassische Algorithmen",
                  "nl": "Theoretische beperkingen gelden alleen voor klassieke algoritmes"
        },
        {
                  "en": "All learning problems can be solved with enough computation",
                  "es": "Todos los problemas de aprendizaje pueden resolverse con suficiente computación",
                  "de": "Alle Lernprobleme können mit genug Berechnung gelöst werden",
                  "nl": "Alle leerproblemen kunnen worden opgelost met voldoende berekening"
        },
        {
                  "en": "Machine learning is fundamentally limited by available data",
                  "es": "Machine learning está fundamentalmente limitado por datos disponibles",
                  "de": "Maschinelles Lernen ist fundamental durch verfügbare Daten begrenzt",
                  "nl": "Machine learning is fundamenteel beperkt door beschikbare data"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Automatic hyperparameter optimization technique",
                  "es": "Técnica de optimización automática de hiperparámetros",
                  "de": "Automatische Hyperparameter-Optimierungstechnik",
                  "nl": "Automatische hyperparameter optimalisatietechniek"
        },
        {
                  "en": "Unified framework using game theory to assign consistent feature importance values that sum to model prediction",
                  "es": "Marco unificado usando teoría de juegos para asignar valores consistentes de importancia de características que suman a predicción del modelo",
                  "de": "Einheitliches Framework mit Spieltheorie um konsistente Feature-Wichtigkeitswerte zuzuweisen die sich zur Modellvorhersage summieren",
                  "nl": "Verenigd framework dat speltheorie gebruikt om consistente feature belangwaarden toe te wijzen die optellen tot modelvoorspelling"
        },
        {
                  "en": "Simple visualization tool for machine learning models",
                  "es": "Herramienta de visualización simple para modelos de machine learning",
                  "de": "Einfaches Visualisierungstool für maschinelle Lernmodelle",
                  "nl": "Eenvoudige visualisatietool voor machine learning modellen"
        },
        {
                  "en": "Statistical hypothesis testing for model validation",
                  "es": "Pruebas de hipótesis estadísticas para validación de modelos",
                  "de": "Statistische Hypothesentests für Modellvalidierung",
                  "nl": "Statistische hypothesetesten voor modelvalidatie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Preference for specific machine learning algorithms",
                  "es": "Preferencia por algoritmos específicos de machine learning",
                  "de": "Präferenz für spezifische maschinelle Lernalgorithmen",
                  "nl": "Voorkeur voor specifieke machine learning algoritmes"
        },
        {
                  "en": "Technical errors in algorithm implementation",
                  "es": "Errores técnicos en implementación de algoritmos",
                  "de": "Technische Fehler in Algorithmusimplementierung",
                  "nl": "Technische fouten in algoritme implementatie"
        },
        {
                  "en": "Systematic unfairness from historical data, sampling, labeling, representation, or algorithmic design choices",
                  "es": "Injusticia sistemática de datos históricos, muestreo, etiquetado, representación o elecciones de diseño algorítmico",
                  "de": "Systematische Ungerechtigkeit aus historischen Daten, Stichprobenziehung, Beschriftung, Repräsentation oder algorithmischen Designentscheidungen",
                  "nl": "Systematische oneerlijkheid van historische data, steekproeftrekking, labeling, representatie of algoritmische ontwerpkeuzes"
        },
        {
                  "en": "Computational limitations affecting model performance",
                  "es": "Limitaciones computacionales que afectan rendimiento del modelo",
                  "de": "Rechnerische Begrenzungen die Modellleistung beeinträchtigen",
                  "nl": "Computationele beperkingen die modelprestaties beïnvloeden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Practices combining ML development and operations for reliable, scalable, and maintainable AI systems in production",
                  "es": "Prácticas que combinan desarrollo ML y operaciones para sistemas IA confiables, escalables y mantenibles en producción",
                  "de": "Praktiken die ML-Entwicklung und Betrieb für zuverlässige, skalierbare und wartbare KI-Systeme in der Produktion kombinieren",
                  "nl": "Praktijken die ML ontwikkeling en operaties combineren voor betrouwbare, schaalbare en onderhoudbare AI systemen in productie"
        },
        {
                  "en": "Marketing and operations for ML products",
                  "es": "Marketing y operaciones para productos ML",
                  "de": "Marketing und Betrieb für ML-Produkte",
                  "nl": "Marketing en operaties voor ML producten"
        },
        {
                  "en": "Mathematical optimization for ML algorithms",
                  "es": "Optimización matemática para algoritmos ML",
                  "de": "Mathematische Optimierung für ML-Algorithmen",
                  "nl": "Wiskundige optimalisatie voor ML algoritmes"
        },
        {
                  "en": "Operations management for machine learning teams",
                  "es": "Gestión de operaciones para equipos de machine learning",
                  "de": "Betriebsmanagement für maschinelle Lernteams",
                  "nl": "Operationeel management voor machine learning teams"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gradual changes in model architecture over time",
                  "es": "Cambios graduales en arquitectura del modelo con el tiempo",
                  "de": "Graduelle Änderungen in Modellarchitektur über Zeit",
                  "nl": "Geleidelijke veranderingen in modelarchitectuur over tijd"
        },
        {
                  "en": "Performance degradation due to changes in data distribution, detected through monitoring and mitigated by retraining",
                  "es": "Degradación del rendimiento debido a cambios en distribución de datos, detectado a través de monitoreo y mitigado por reentrenamiento",
                  "de": "Leistungsverschlechterung aufgrund von Änderungen in Datenverteilung, erkannt durch Überwachung und gemildert durch Neutraining",
                  "nl": "Prestatievermindering door veranderingen in dataverdeling, gedetecteerd door monitoring en gemitigeerd door hertraining"
        },
        {
                  "en": "Drift in computational requirements for models",
                  "es": "Deriva en requerimientos computacionales para modelos",
                  "de": "Drift in rechnerischen Anforderungen für Modelle",
                  "nl": "Drift in computationele vereisten voor modellen"
        },
        {
                  "en": "Physical movement of model files in storage systems",
                  "es": "Movimiento físico de archivos de modelo en sistemas de almacenamiento",
                  "de": "Physische Bewegung von Modelldateien in Speichersystemen",
                  "nl": "Fysieke beweging van modelbestanden in opslagsystemen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Explains individual predictions by approximating complex models locally with simple interpretable models",
                  "es": "Explica predicciones individuales aproximando modelos complejos localmente con modelos simples interpretables",
                  "de": "Erklärt individuelle Vorhersagen durch lokale Approximation komplexer Modelle mit einfachen interpretierbaren Modellen",
                  "nl": "Verklaart individuele voorspellingen door complexe modellen lokaal te benaderen met eenvoudige interpreteerbare modellen"
        },
        {
                  "en": "Linear interpolation method for missing values",
                  "es": "Método de interpolación lineal para valores faltantes",
                  "de": "Lineare Interpolationsmethode für fehlende Werte",
                  "nl": "Lineaire interpolatiemethode voor missende waarden"
        },
        {
                  "en": "Loss function optimization for improved model training",
                  "es": "Optimización de función de pérdida para mejor entrenamiento de modelo",
                  "de": "Verlustfunktionsoptimierung für verbessertes Modelltraining",
                  "nl": "Verliesfunctie optimalisatie voor verbeterde modeltraining"
        },
        {
                  "en": "Lightweight machine learning framework for small datasets",
                  "es": "Marco de machine learning ligero para conjuntos de datos pequeños",
                  "de": "Leichtgewichtiges maschinelles Lern-Framework für kleine Datensätze",
                  "nl": "Lichtgewicht machine learning framework voor kleine datasets"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fair distribution of training data across algorithms",
                  "es": "Distribución justa de datos de entrenamiento entre algoritmos",
                  "de": "Faire Verteilung von Trainingsdaten über Algorithmen",
                  "nl": "Eerlijke verdeling van trainingsdata over algoritmes"
        },
        {
                  "en": "Balanced accuracy across different validation sets",
                  "es": "Precisión balanceada a través de diferentes conjuntos de validación",
                  "de": "Ausgewogene Genauigkeit über verschiedene Validierungssätze",
                  "nl": "Gebalanceerde nauwkeurigheid over verschillende validatiesets"
        },
        {
                  "en": "Equal computational resources for all machine learning models",
                  "es": "Recursos computacionales iguales para todos los modelos de machine learning",
                  "de": "Gleiche Rechenressourcen für alle maschinellen Lernmodelle",
                  "nl": "Gelijke computationele middelen voor alle machine learning modellen"
        },
        {
                  "en": "Ensuring equal treatment across groups using metrics like demographic parity, equality of opportunity, and equalized odds",
                  "es": "Asegurar trato igual entre grupos usando métricas como paridad demográfica, igualdad de oportunidad y probabilidades igualadas",
                  "de": "Sicherstellung gleicher Behandlung zwischen Gruppen mit Metriken wie demografische Parität, Chancengleichheit und ausgeglichene Quoten",
                  "nl": "Zorgen voor gelijke behandeling tussen groepen met metrieken zoals demografische pariteit, gelijkheid van kansen en gelijke odds"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trains models across decentralized data without sharing raw data, preserving privacy while enabling collaborative learning",
                  "es": "Entrena modelos a través de datos descentralizados sin compartir datos crudos, preservando privacidad mientras habilita aprendizaje colaborativo",
                  "de": "Trainiert Modelle über dezentralisierte Daten ohne Rohdaten zu teilen, bewahrt Privatsphäre während kollaboratives Lernen ermöglicht wird",
                  "nl": "Traint modellen over gedecentraliseerde data zonder ruwe data te delen, behoudt privacy terwijl collaboratief leren mogelijk wordt"
        },
        {
                  "en": "Learning algorithms developed by federal institutions",
                  "es": "Algoritmos de aprendizaje desarrollados por instituciones federales",
                  "de": "Lernalgorithmen entwickelt von föderalen Institutionen",
                  "nl": "Leeralgoritmes ontwikkeld door federale instellingen"
        },
        {
                  "en": "Federation of multiple machine learning frameworks",
                  "es": "Federación de múltiples marcos de machine learning",
                  "de": "Föderation mehrerer maschineller Lern-Frameworks",
                  "nl": "Federatie van meerdere machine learning frameworks"
        },
        {
                  "en": "Federal government regulations for machine learning",
                  "es": "Regulaciones del gobierno federal para machine learning",
                  "de": "Bundesregulierungen für maschinelles Lernen",
                  "nl": "Federale overheidsregulaties voor machine learning"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Compares performance of different models by randomly exposing users to variants and measuring business metrics",
                  "es": "Compara rendimiento de diferentes modelos exponiendo aleatoriamente usuarios a variantes y midiendo métricas de negocio",
                  "de": "Vergleicht Leistung verschiedener Modelle durch zufällige Exposition von Benutzern gegenüber Varianten und Messung von Geschäftsmetriken",
                  "nl": "Vergelijkt prestaties van verschillende modellen door willekeurig gebruikers bloot te stellen aan varianten en bedrijfsmetrieken te meten"
        },
        {
                  "en": "Binary classification performance evaluation",
                  "es": "Evaluación de rendimiento de clasificación binaria",
                  "de": "Binäre Klassifikationsleistungsbewertung",
                  "nl": "Binaire classificatie prestatie-evaluatie"
        },
        {
                  "en": "Alternating between two different algorithms",
                  "es": "Alternar entre dos algoritmos diferentes",
                  "de": "Wechseln zwischen zwei verschiedenen Algorithmen",
                  "nl": "Wisselen tussen twee verschillende algoritmes"
        },
        {
                  "en": "Testing models with datasets A and B separately",
                  "es": "Probar modelos con conjuntos de datos A y B por separado",
                  "de": "Testen von Modellen mit Datensätzen A und B separat",
                  "nl": "Testen van modellen met datasets A en B afzonderlijk"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Genetic lineage of datasets from common sources",
                  "es": "Linaje genético de conjuntos de datos de fuentes comunes",
                  "de": "Genetische Abstammung von Datensätzen aus gemeinsamen Quellen",
                  "nl": "Genetische afstamming van datasets van gemeenschappelijke bronnen"
        },
        {
                  "en": "Tracks data origin, transformations, and dependencies throughout ML pipeline for reproducibility and compliance",
                  "es": "Rastrea origen de datos, transformaciones y dependencias a través del pipeline ML para reproducibilidad y cumplimiento",
                  "de": "Verfolgt Datenherkunft, Transformationen und Abhängigkeiten durch ML-Pipeline für Reproduzierbarkeit und Compliance",
                  "nl": "Volgt data-origine, transformaties en afhankelijkheden door ML pipeline voor reproduceerbaarheid en compliance"
        },
        {
                  "en": "Chronological ordering of data collection",
                  "es": "Ordenamiento cronológico de recolección de datos",
                  "de": "Chronologische Reihenfolge der Datensammlung",
                  "nl": "Chronologische ordening van dataverzameling"
        },
        {
                  "en": "Linear relationships between data features",
                  "es": "Relaciones lineales entre características de datos",
                  "de": "Lineare Beziehungen zwischen Datenmerkmalen",
                  "nl": "Lineaire relaties tussen datafeatures"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Privacy protection through data encryption only",
                  "es": "Protección de privacidad solo a través de cifrado de datos",
                  "de": "Privatsphärenschutz nur durch Datenverschlüsselung",
                  "nl": "Privacybescherming alleen door dataversleuteling"
        },
        {
                  "en": "Different privacy settings for different users",
                  "es": "Diferentes configuraciones de privacidad para diferentes usuarios",
                  "de": "Verschiedene Privatsphäre-Einstellungen für verschiedene Benutzer",
                  "nl": "Verschillende privacy-instellingen voor verschillende gebruikers"
        },
        {
                  "en": "Difference in privacy levels between training and testing",
                  "es": "Diferencia en niveles de privacidad entre entrenamiento y prueba",
                  "de": "Unterschied in Privatsphäre-Ebenen zwischen Training und Testing",
                  "nl": "Verschil in privacyniveaus tussen training en testing"
        },
        {
                  "en": "Mathematical framework adding calibrated noise to queries, providing provable privacy guarantees while preserving utility",
                  "es": "Marco matemático que agrega ruido calibrado a consultas, proporcionando garantías de privacidad demostrables mientras preserva utilidad",
                  "de": "Mathematisches Framework das kalibrierten Rauschen zu Abfragen hinzufügt, bietet beweisbare Privatsphäre-Garantien während Nützlichkeit bewahrt wird",
                  "nl": "Wiskundig framework dat gekalibreerde ruis toevoegt aan queries, biedt bewijsbare privacygaranties terwijl nut behouden blijft"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Numbering models sequentially for organization",
                  "es": "Numerar modelos secuencialmente para organización",
                  "de": "Modelle sequenziell für Organisation nummerieren",
                  "nl": "Modellen sequentieel nummeren voor organisatie"
        },
        {
                  "en": "Creating different versions for different programming languages",
                  "es": "Crear diferentes versiones para diferentes lenguajes de programación",
                  "de": "Erstellen verschiedener Versionen für verschiedene Programmiersprachen",
                  "nl": "Creëren van verschillende versies voor verschillende programmeertalen"
        },
        {
                  "en": "Version control only for source code, not models",
                  "es": "Control de versión solo para código fuente, no modelos",
                  "de": "Versionskontrolle nur für Quellcode, nicht Modelle",
                  "nl": "Versiecontrole alleen voor broncode, niet modellen"
        },
        {
                  "en": "Systematic tracking of model changes, enabling rollbacks, experimentation, and collaborative development",
                  "es": "Seguimiento sistemático de cambios de modelo, habilitando reversiones, experimentación y desarrollo colaborativo",
                  "de": "Systematische Verfolgung von Modelländerungen, ermöglicht Rollbacks, Experimente und kollaborative Entwicklung",
                  "nl": "Systematisch volgen van modelwijzigingen, maakt rollbacks, experimenten en collaboratieve ontwikkeling mogelijk"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training models to be adversarial to human users",
                  "es": "Entrenar modelos para ser adversariales a usuarios humanos",
                  "de": "Training von Modellen um adversarial zu menschlichen Benutzern zu sein",
                  "nl": "Training van modellen om adversarieel te zijn tegen menselijke gebruikers"
        },
        {
                  "en": "Using adversarial optimization for better performance",
                  "es": "Usar optimización adversarial para mejor rendimiento",
                  "de": "Verwendung adversarialer Optimierung für bessere Leistung",
                  "nl": "Gebruik van adversariale optimalisatie voor betere prestaties"
        },
        {
                  "en": "Competition between different machine learning algorithms",
                  "es": "Competencia entre diferentes algoritmos de machine learning",
                  "de": "Wettbewerb zwischen verschiedenen maschinellen Lernalgorithmen",
                  "nl": "Competitie tussen verschillende machine learning algoritmes"
        },
        {
                  "en": "Study of vulnerabilities in ML models including evasion, poisoning, and model extraction attacks",
                  "es": "Estudio de vulnerabilidades en modelos ML incluyendo ataques de evasión, envenenamiento y extracción de modelos",
                  "de": "Studie von Schwachstellen in ML-Modellen einschließlich Umgehungs-, Vergiftungs- und Modellextraktionsangriffen",
                  "nl": "Studie van kwetsbaarheden in ML modellen inclusief ontwijking, vergiftiging en modelextractie aanvallen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Continuous tracking of model performance, data quality, prediction distribution, and system health metrics",
                  "es": "Seguimiento continuo de rendimiento del modelo, calidad de datos, distribución de predicción y métricas de salud del sistema",
                  "de": "Kontinuierliche Verfolgung von Modellleistung, Datenqualität, Vorhersageverteilung und Systemgesundheitsmetriken",
                  "nl": "Continue tracking van modelprestaties, datakwaliteit, voorspellingsdistributie en systeemgezondheidsmetrieken"
        },
        {
                  "en": "Tracking model development progress",
                  "es": "Rastrear progreso de desarrollo del modelo",
                  "de": "Verfolgung des Modellentwicklungsfortschritts",
                  "nl": "Volgen van modelontwikkelingsvoortgang"
        },
        {
                  "en": "Monitoring only computational resource usage",
                  "es": "Monitorear solo uso de recursos computacionales",
                  "de": "Überwachung nur des rechnerischen Ressourcenverbrauchs",
                  "nl": "Monitoren van alleen computationeel resourcegebruik"
        },
        {
                  "en": "Monitoring team performance and productivity",
                  "es": "Monitorear rendimiento y productividad del equipo",
                  "de": "Überwachung von Teamleistung und Produktivität",
                  "nl": "Monitoren van teamprestaties en productiviteit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Expert AI systems for specific domains only",
                  "es": "Sistemas IA expertos solo para dominios específicos",
                  "de": "Experten-KI-Systeme nur für spezifische Bereiche",
                  "nl": "Expert AI systemen alleen voor specifieke domeinen"
        },
        {
                  "en": "AI that provides detailed technical documentation",
                  "es": "IA que proporciona documentación técnica detallada",
                  "de": "KI die detaillierte technische Dokumentation bereitstellt",
                  "nl": "AI die gedetailleerde technische documentatie biedt"
        },
        {
                  "en": "AI systems that can explain other AI systems automatically",
                  "es": "Sistemas IA que pueden explicar otros sistemas IA automáticamente",
                  "de": "KI-Systeme die andere KI-Systeme automatisch erklären können",
                  "nl": "AI systemen die andere AI systemen automatisch kunnen uitleggen"
        },
        {
                  "en": "Methods to make AI decisions transparent and interpretable for trust, accountability, and regulatory compliance",
                  "es": "Métodos para hacer decisiones IA transparentes e interpretables para confianza, responsabilidad y cumplimiento regulatorio",
                  "de": "Methoden um KI-Entscheidungen transparent und interpretierbar für Vertrauen, Verantwortlichkeit und regulatorische Compliance zu machen",
                  "nl": "Methoden om AI beslissingen transparant en interpreteerbaar te maken voor vertrouwen, verantwoordelijkheid en regulatoire compliance"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI systems deployed only at network edges",
                  "es": "Sistemas IA desplegados solo en bordes de red",
                  "de": "KI-Systeme nur an Netzwerkrändern eingesetzt",
                  "nl": "AI systemen alleen gedeployed aan netwerk edges"
        },
        {
                  "en": "Cutting-edge AI research and development",
                  "es": "Investigación y desarrollo IA de vanguardia",
                  "de": "Hochmoderne KI-Forschung und -Entwicklung",
                  "nl": "Geavanceerd AI onderzoek en ontwikkeling"
        },
        {
                  "en": "AI for image edge detection algorithms",
                  "es": "IA para algoritmos de detección de bordes de imagen",
                  "de": "KI für Bildkanten-Erkennungsalgorithmen",
                  "nl": "AI voor beeldrand detectie-algoritmes"
        },
        {
                  "en": "AI inference on local devices with constraints of limited compute, memory, power, and connectivity requirements",
                  "es": "Inferencia IA en dispositivos locales con restricciones de computación limitada, memoria, energía y requerimientos de conectividad",
                  "de": "KI-Inferenz auf lokalen Geräten mit Beschränkungen begrenzter Berechnung, Speicher, Energie und Konnektivitätsanforderungen",
                  "nl": "AI inferentie op lokale apparaten met beperkingen van beperkte compute, geheugen, stroom en connectiviteitsvereisten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Abrupt performance loss on old tasks when learning new ones, mitigated by elastic weight consolidation, replay buffers, or progressive nets",
                  "es": "Pérdida abrupta de rendimiento en tareas antiguas al aprender nuevas, mitigado por consolidación elástica de pesos, buffers de repetición o redes progresivas",
                  "de": "Abrupter Leistungsverlust bei alten Aufgaben beim Lernen neuer, gemildert durch elastische Gewichtskonsolidierung, Replay-Puffer oder progressive Netze",
                  "nl": "Abrupt prestatieverlies op oude taken bij het leren van nieuwe, gemitigeerd door elastische gewichtsconsolidatie, replay buffers of progressieve netten"
        },
        {
                  "en": "Forgetting only catastrophic failure cases",
                  "es": "Olvidar solo casos de fallo catastrófico",
                  "de": "Vergessen nur katastrophaler Fehlerfälle",
                  "nl": "Vergeten van alleen catastrofale faalgevallen"
        },
        {
                  "en": "Gradual decay of neural network weights",
                  "es": "Decaimiento gradual de pesos de red neuronal",
                  "de": "Gradueller Zerfall neuronaler Netzwerkgewichte",
                  "nl": "Geleidelijk verval van neurale netwerkgewichten"
        },
        {
                  "en": "Complete memory loss requiring full retraining",
                  "es": "Pérdida completa de memoria requiriendo reentrenamiento completo",
                  "de": "Vollständiger Gedächtnisverlust erfordert vollständiges Neutraining",
                  "nl": "Volledig geheugenverlies vereist volledige hertraining"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pruning at initialization is impossible",
                  "es": "Poda en inicialización es imposible",
                  "de": "Pruning bei Initialisierung ist unmöglich",
                  "nl": "Pruning bij initialisatie is onmogelijk"
        },
        {
                  "en": "Only large networks benefit from pruning",
                  "es": "Solo redes grandes se benefician de poda",
                  "de": "Nur große Netzwerke profitieren von Pruning",
                  "nl": "Alleen grote netwerken profiteren van pruning"
        },
        {
                  "en": "Dense networks contain sparse subnetworks that can match full network performance when trained from their original initialization",
                  "es": "Redes densas contienen subredes dispersas que pueden igualar rendimiento de red completa cuando se entrenan desde su inicialización original",
                  "de": "Dichte Netzwerke enthalten spärliche Teilnetzwerke die volle Netzwerkleistung erreichen können wenn von ihrer ursprünglichen Initialisierung trainiert",
                  "nl": "Dichte netwerken bevatten dunne subnetwerken die volledige netwerkprestaties kunnen evenaren wanneer getraind vanaf hun originele initialisatie"
        },
        {
                  "en": "Random pruning always produces better networks",
                  "es": "Poda aleatoria siempre produce mejores redes",
                  "de": "Zufälliges Pruning produziert immer bessere Netzwerke",
                  "nl": "Willekeurige pruning produceert altijd betere netwerken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Framework showing infinite-width networks behave as kernel methods with fixed features during gradient descent",
                  "es": "Marco mostrando redes de ancho infinito se comportan como métodos de kernel con características fijas durante descenso de gradiente",
                  "de": "Framework zeigt dass unendlich-breite Netzwerke sich wie Kernel-Methoden mit festen Features während Gradientenabstieg verhalten",
                  "nl": "Framework toont dat oneindig-brede netwerken zich gedragen als kernel methoden met vaste features tijdens gradient descent"
        },
        {
                  "en": "Network topology analysis using kernel functions",
                  "es": "Análisis de topología de red usando funciones de kernel",
                  "de": "Netzwerk-Topologie-Analyse mit Kernel-Funktionen",
                  "nl": "Netwerktopologie analyse met kernel functies"
        },
        {
                  "en": "Tangent space optimization for neural networks",
                  "es": "Optimización de espacio tangente para redes neuronales",
                  "de": "Tangentialraum-Optimierung für neuronale Netzwerke",
                  "nl": "Tangent space optimalisatie voor neurale netwerken"
        },
        {
                  "en": "Kernel trick applied to neural network architectures",
                  "es": "Truco de kernel aplicado a arquitecturas de redes neuronales",
                  "de": "Kernel-Trick angewendet auf neuronale Netzwerkarchitekturen",
                  "nl": "Kernel truc toegepast op neurale netwerkarchitecturen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Loss descending twice during single epoch",
                  "es": "Pérdida descendiendo dos veces durante época única",
                  "de": "Verlust sinkt zweimal während einzelner Epoche",
                  "nl": "Verlies daalt twee keer tijdens enkele epoch"
        },
        {
                  "en": "Test error decreases, rises at interpolation threshold, then decreases again as model capacity increases beyond perfect training fit",
                  "es": "Error de prueba disminuye, aumenta en umbral de interpolación, luego disminuye nuevamente a medida que capacidad del modelo aumenta más allá de ajuste de entrenamiento perfecto",
                  "de": "Testfehler sinkt, steigt an Interpolationsschwelle, sinkt dann wieder wenn Modellkapazität über perfekten Trainingsfit hinaus steigt",
                  "nl": "Testfout daalt, stijgt bij interpolatiedrempel, daalt dan weer naarmate modelcapaciteit toeneemt voorbij perfecte training fit"
        },
        {
                  "en": "Two-phase descent in gradient optimization",
                  "es": "Descenso de dos fases en optimización de gradiente",
                  "de": "Zweiphasiger Abstieg in Gradientenoptimierung",
                  "nl": "Twee-fase descent in gradient optimalisatie"
        },
        {
                  "en": "Double the learning rate for faster descent",
                  "es": "Duplicar tasa de aprendizaje para descenso más rápido",
                  "de": "Verdoppeln der Lernrate für schnelleren Abstieg",
                  "nl": "Verdubbelen van learning rate voor snellere descent"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning how to learn by optimizing for rapid adaptation to new tasks through second-order gradients across tasks",
                  "es": "Aprender cómo aprender optimizando para adaptación rápida a nuevas tareas a través de gradientes de segundo orden a través de tareas",
                  "de": "Lernen wie man lernt durch Optimierung für schnelle Anpassung an neue Aufgaben durch Gradienten zweiter Ordnung über Aufgaben",
                  "nl": "Leren hoe te leren door te optimaliseren voor snelle aanpassing aan nieuwe taken door tweede-orde gradiënten over taken"
        },
        {
                  "en": "Meta-analysis of learning algorithm performance",
                  "es": "Meta-análisis de rendimiento de algoritmos de aprendizaje",
                  "de": "Meta-Analyse von Lernalgorithmus-Leistung",
                  "nl": "Meta-analyse van leeralgoritme prestaties"
        },
        {
                  "en": "Learning about metadata in training datasets",
                  "es": "Aprender sobre metadatos en conjuntos de datos de entrenamiento",
                  "de": "Lernen über Metadaten in Trainingsdatensätzen",
                  "nl": "Leren over metadata in trainingsdatasets"
        },
        {
                  "en": "Hierarchical learning with meta-layers",
                  "es": "Aprendizaje jerárquico con meta-capas",
                  "de": "Hierarchisches Lernen mit Meta-Schichten",
                  "nl": "Hiërarchisch leren met meta-lagen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Makes neural networks pay attention during training",
                  "es": "Hace que redes neuronales presten atención durante entrenamiento",
                  "de": "Bringt neuronale Netzwerke dazu während Training aufzupassen",
                  "nl": "Zorgt ervoor dat neurale netwerken aandacht besteden tijdens training"
        },
        {
                  "en": "Enables models to dynamically weight input elements, with self-attention computing relationships between all positions in parallel",
                  "es": "Permite a modelos ponderar dinámicamente elementos de entrada, con auto-atención computando relaciones entre todas las posiciones en paralelo",
                  "de": "Ermöglicht Modellen Eingabeelemente dynamisch zu gewichten, mit Self-Attention Berechnung von Beziehungen zwischen allen Positionen parallel",
                  "nl": "Stelt modellen in staat om invoerelementen dynamisch te wegen, met self-attention berekening van relaties tussen alle posities parallel"
        },
        {
                  "en": "Sequential processing with attention weights",
                  "es": "Procesamiento secuencial con pesos de atención",
                  "de": "Sequenzielle Verarbeitung mit Aufmerksamkeitsgewichten",
                  "nl": "Sequentiële verwerking met attention gewichten"
        },
        {
                  "en": "Attention only to important features",
                  "es": "Atención solo a características importantes",
                  "de": "Aufmerksamkeit nur auf wichtige Features",
                  "nl": "Aandacht alleen voor belangrijke features"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Distills essential features from training data",
                  "es": "Destila características esenciales de datos de entrenamiento",
                  "de": "Destilliert wesentliche Features aus Trainingsdaten",
                  "nl": "Destilleert essentiële features uit trainingsdata"
        },
        {
                  "en": "Trains smaller student models to mimic larger teacher models' soft predictions, compressing knowledge while maintaining performance",
                  "es": "Entrena modelos estudiante más pequeños para imitar predicciones suaves de modelos maestro más grandes, comprimiendo conocimiento mientras mantiene rendimiento",
                  "de": "Trainiert kleinere Schüler-Modelle um weiche Vorhersagen größerer Lehrer-Modelle nachzuahmen, komprimiert Wissen während Leistung erhalten bleibt",
                  "nl": "Traint kleinere student modellen om zachte voorspellingen van grotere leraar modellen na te bootsen, comprimeert kennis terwijl prestaties behouden blijven"
        },
        {
                  "en": "Extracts core vocabulary from large models",
                  "es": "Extrae vocabulario central de modelos grandes",
                  "de": "Extrahiert Kernvokabular aus großen Modellen",
                  "nl": "Extraheert kernvocabulaire uit grote modellen"
        },
        {
                  "en": "Purifies language models by removing noise",
                  "es": "Purifica modelos de lenguaje eliminando ruido",
                  "de": "Reinigt Sprachmodelle durch Entfernen von Rauschen",
                  "nl": "Zuivert taalmodellen door ruis te verwijderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Crafting input instructions using techniques like few-shot examples, chain-of-thought reasoning, and role specification",
                  "es": "Elaborar instrucciones de entrada usando técnicas como ejemplos de pocos disparos, razonamiento de cadena de pensamiento y especificación de roles",
                  "de": "Gestalten von Eingabeanweisungen mit Techniken wie Few-Shot-Beispiele, Chain-of-Thought-Reasoning und Rollenspezifikation",
                  "nl": "Ontwerpen van invoer instructies met technieken zoals few-shot voorbeelden, chain-of-thought redeneren en rol specificatie"
        },
        {
                  "en": "Engineering the user interface for prompts",
                  "es": "Diseñar la interfaz de usuario para prompts",
                  "de": "Benutzeroberfläche für Prompts gestalten",
                  "nl": "Gebruikersinterface voor prompts ontwerpen"
        },
        {
                  "en": "Prompt responses from models quickly",
                  "es": "Obtener respuestas rápidas de modelos",
                  "de": "Schnelle Antworten von Modellen erhalten",
                  "nl": "Snelle responses van modellen verkrijgen"
        },
        {
                  "en": "Automatic generation of training prompts",
                  "es": "Generación automática de prompts de entrenamiento",
                  "de": "Automatische Generierung von Trainings-Prompts",
                  "nl": "Automatische generatie van trainings prompts"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combines neural retrieval with generation by fetching relevant documents to ground outputs in factual knowledge",
                  "es": "Combina recuperación neuronal con generación obteniendo documentos relevantes para fundamentar salidas en conocimiento factual",
                  "de": "Kombiniert neuronale Suche mit Generierung durch Abrufen relevanter Dokumente um Ausgaben in faktischem Wissen zu verankern",
                  "nl": "Combineert neurale retrieval met generatie door relevante documenten op te halen om outputs te gronden in feitelijke kennis"
        },
        {
                  "en": "Augments generation speed through retrieval caching",
                  "es": "Aumenta velocidad de generación a través de caché de recuperación",
                  "de": "Erweitert Generierungsgeschwindigkeit durch Retrieval-Caching",
                  "nl": "Vergroot generatiesnelheid door retrieval caching"
        },
        {
                  "en": "Retrieves and augments training datasets",
                  "es": "Recupera y aumenta conjuntos de datos de entrenamiento",
                  "de": "Ruft ab und erweitert Trainingsdatensätze",
                  "nl": "Haalt op en augmenteert trainingsdatasets"
        },
        {
                  "en": "Generates random augmented data",
                  "es": "Genera datos aumentados aleatorios",
                  "de": "Generiert zufällige augmentierte Daten",
                  "nl": "Genereert willekeurige geaugmenteerde data"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Human feedback directly updates model weights",
                  "es": "Retroalimentación humana actualiza directamente pesos del modelo",
                  "de": "Menschliches Feedback aktualisiert direkt Modellgewichte",
                  "nl": "Menselijke feedback werkt modelgewichten direct bij"
        },
        {
                  "en": "Reinforces human-written training examples",
                  "es": "Refuerza ejemplos de entrenamiento escritos por humanos",
                  "de": "Verstärkt von Menschen geschriebene Trainingsbeispiele",
                  "nl": "Versterkt door mensen geschreven trainingsvoorbeelden"
        },
        {
                  "en": "Learns from human feedback logs only",
                  "es": "Aprende solo de registros de retroalimentación humana",
                  "de": "Lernt nur aus menschlichen Feedback-Protokollen",
                  "nl": "Leert alleen van menselijke feedback logs"
        },
        {
                  "en": "Trains reward models from human preferences, then optimizes language models using RL to maximize human-aligned rewards",
                  "es": "Entrena modelos de recompensa a partir de preferencias humanas, luego optimiza modelos de lenguaje usando RL para maximizar recompensas alineadas con humanos",
                  "de": "Trainiert Belohnungsmodelle aus menschlichen Präferenzen, optimiert dann Sprachmodelle mit RL um menschlich-ausgerichtete Belohnungen zu maximieren",
                  "nl": "Traint beloningsmodellen van menselijke voorkeuren, optimaliseert dan taalmodellen met RL om menselijk-georiënteerde beloningen te maximaliseren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Contextual understanding of training data",
                  "es": "Comprensión contextual de datos de entrenamiento",
                  "de": "Kontextuelles Verständnis von Trainingsdaten",
                  "nl": "Contextueel begrip van trainingsdata"
        },
        {
                  "en": "Models perform tasks by conditioning on examples in the prompt without parameter updates, unlike fine-tuning which modifies weights",
                  "es": "Modelos realizan tareas condicionando en ejemplos en el prompt sin actualizaciones de parámetros, a diferencia de ajuste fino que modifica pesos",
                  "de": "Modelle führen Aufgaben durch Konditionierung auf Beispiele im Prompt ohne Parameterupdates aus, im Gegensatz zu Fine-Tuning das Gewichte modifiziert",
                  "nl": "Modellen voeren taken uit door te conditioneren op voorbeelden in de prompt zonder parameter updates, in tegenstelling tot fine-tuning dat gewichten wijzigt"
        },
        {
                  "en": "Learning context embeddings during training",
                  "es": "Aprender embeddings de contexto durante entrenamiento",
                  "de": "Lernen von Kontext-Embeddings während Training",
                  "nl": "Leren van context embeddings tijdens training"
        },
        {
                  "en": "In-domain learning from context windows",
                  "es": "Aprendizaje en dominio de ventanas de contexto",
                  "de": "In-Domain-Lernen aus Kontextfenstern",
                  "nl": "In-domein leren van contextvensters"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Awareness of available quantization levels",
                  "es": "Conciencia de niveles de cuantización disponibles",
                  "de": "Bewusstsein verfügbarer Quantisierungsstufen",
                  "nl": "Bewustzijn van beschikbare quantization niveaus"
        },
        {
                  "en": "Quantization applied only during inference",
                  "es": "Cuantización aplicada solo durante inferencia",
                  "de": "Quantisierung nur während Inferenz angewendet",
                  "nl": "Quantization alleen toegepast tijdens inferentie"
        },
        {
                  "en": "Simulates quantization during training to learn robust low-precision weights, versus post-training which quantizes after training completes",
                  "es": "Simula cuantización durante entrenamiento para aprender pesos de baja precisión robustos, versus post-entrenamiento que cuantiza después de que entrenamiento se completa",
                  "de": "Simuliert Quantisierung während Training um robuste niedrigpräzise Gewichte zu lernen, versus Post-Training das nach Trainingsabschluss quantisiert",
                  "nl": "Simuleert quantization tijdens training om robuuste lage-precisie gewichten te leren, versus post-training dat quantiseert na training voltooid is"
        },
        {
                  "en": "Trains models to be aware of quantization errors",
                  "es": "Entrena modelos para estar conscientes de errores de cuantización",
                  "de": "Trainiert Modelle um sich Quantisierungsfehlern bewusst zu sein",
                  "nl": "Traint modellen om zich bewust te zijn van quantization fouten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Network analysis for security vulnerabilities",
                  "es": "Análisis de red para vulnerabilidades de seguridad",
                  "de": "Netzwerkanalyse für Sicherheitslücken",
                  "nl": "Netwerkanalyse voor beveiligingskwetsbaarheden"
        },
        {
                  "en": "Manually searching through architecture options",
                  "es": "Búsqueda manual a través de opciones de arquitectura",
                  "de": "Manuelle Suche durch Architekturoptionen",
                  "nl": "Handmatig zoeken door architectuuropties"
        },
        {
                  "en": "Searching for pre-trained architectures online",
                  "es": "Buscar arquitecturas pre-entrenadas en línea",
                  "de": "Suche nach vortrainierten Architekturen online",
                  "nl": "Zoeken naar voorgetrainde architecturen online"
        },
        {
                  "en": "Automated discovery of optimal architectures using reinforcement learning, evolutionary algorithms, or differentiable search methods",
                  "es": "Descubrimiento automatizado de arquitecturas óptimas usando aprendizaje por refuerzo, algoritmos evolutivos o métodos de búsqueda diferenciables",
                  "de": "Automatisierte Entdeckung optimaler Architekturen mit Reinforcement Learning, evolutionären Algorithmen oder differenzierbaren Suchmethoden",
                  "nl": "Geautomatiseerde ontdekking van optimale architecturen met reinforcement learning, evolutionaire algoritmes of differentieerbare zoekmethoden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Routes each input to a subset of expert networks via learned gating, activating only relevant experts for efficient scaling",
                  "es": "Enruta cada entrada a un subconjunto de redes expertas vía compuerta aprendida, activando solo expertos relevantes para escalado eficiente",
                  "de": "Leitet jede Eingabe zu einer Teilmenge von Experten-Netzwerken über gelerntes Gating, aktiviert nur relevante Experten für effizientes Skalieren",
        ...
        {
                  "en": "Combines predictions from multiple expert humans",
                  "es": "Combina predicciones de múltiples humanos expertos",
                  "de": "Kombiniert Vorhersagen mehrerer menschlicher Experten",
                  "nl": "Combineert voorspellingen van meerdere menselijke experts"
        },
        {
                  "en": "Ensemble of specialized domain models",
                  "es": "Conjunto de modelos de dominio especializados",
                  "de": "Ensemble spezialisierter Domänen-Modelle",
                  "nl": "Ensemble van gespecialiseerde domeinmodellen"
        },
        {
                  "en": "Mixture model for expert knowledge bases",
                  "es": "Modelo de mezcla para bases de conocimiento expertas",
                  "de": "Mischmodell für Experten-Wissensbasen",
                  "nl": "Mengselmodel voor expert kennisbanken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Must choose between trying new options to gather information vs selecting currently best-known option, UCB adds optimism bonus",
                  "es": "Debe elegir entre probar nuevas opciones para recopilar información vs seleccionar opción actualmente mejor conocida, UCB agrega bonus de optimismo",
                  "de": "Muss wählen zwischen Versuch neuer Optionen um Information zu sammeln vs Auswahl aktuell best-bekannter Option, UCB fügt Optimismus-Bonus hinzu",
                  "nl": "Moet kiezen tussen nieuwe opties proberen om informatie te verzamelen vs selecteren van huidige best-bekende optie, UCB voegt optimisme bonus toe"
        },
        {
                  "en": "Trade-off between computational resources",
                  "es": "Compensación entre recursos computacionales",
                  "de": "Tradeoff zwischen Rechenressourcen",
                  "nl": "Afweging tussen computationele middelen"
        },
        {
                  "en": "Balance between algorithm speed and accuracy",
                  "es": "Balance entre velocidad y precisión del algoritmo",
                  "de": "Balance zwischen Algorithmusgeschwindigkeit und Genauigkeit",
                  "nl": "Balans tussen algoritme snelheid en nauwkeurigheid"
        },
        {
                  "en": "Exploration finds bandits, exploitation uses them",
                  "es": "Exploración encuentra bandits, explotación los usa",
                  "de": "Exploration findet Bandits, Exploitation nutzt sie",
                  "nl": "Exploratie vindt bandits, exploitatie gebruikt ze"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Determining which past actions caused delayed rewards, TD learning bootstraps from value estimates to propagate credit faster",
                  "es": "Determinar qué acciones pasadas causaron recompensas retrasadas, aprendizaje TD hace bootstrap de estimaciones de valor para propagar crédito más rápido",
                  "de": "Bestimmen welche vergangenen Aktionen verzögerte Belohnungen verursachten, TD-Learning bootstrapt von Werteschätzungen um Kredit schneller zu propagieren",
                  "nl": "Bepalen welke eerdere acties vertraagde beloningen veroorzaakten, TD learning bootstrapt van waarde schattingen om credit sneller te propageren"
        },
        {
                  "en": "Distributing computational credits",
                  "es": "Distribuir créditos computacionales",
                  "de": "Verteilung rechnerischer Kredite",
                  "nl": "Verdelen van computationele credits"
        },
        {
                  "en": "Credit for discovering optimal policies",
                  "es": "Crédito por descubrir políticas óptimas",
                  "de": "Kredit für Entdeckung optimaler Richtlinien",
                  "nl": "Credit voor het ontdekken van optimale policies"
        },
        {
                  "en": "Assigning credit scores to training examples",
                  "es": "Asignar puntajes de crédito a ejemplos de entrenamiento",
                  "de": "Zuweisen von Kreditscores zu Trainingsbeispielen",
                  "nl": "Toewijzen van credit scores aan trainingsvoorbeelden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dynamic programming complexity measure",
                  "es": "Medida de complejidad de programación dinámica",
                  "de": "Maß für dynamische Programmierungskomplexität",
                  "nl": "Dynamische programmering complexiteitsmaat"
        },
        {
                  "en": "Equation for computing bell curves in statistics",
                  "es": "Ecuación para calcular curvas de campana en estadística",
                  "de": "Gleichung zur Berechnung von Glockenkurven in Statistik",
                  "nl": "Vergelijking voor het berekenen van klokcurves in statistiek"
        },
        {
                  "en": "Formula for optimal model selection",
                  "es": "Fórmula para selección óptima de modelos",
                  "de": "Formel für optimale Modellauswahl",
                  "nl": "Formule voor optimale modelselectie"
        },
        {
                  "en": "Recursive decomposition of value functions expressing optimal values as immediate reward plus discounted future values",
                  "es": "Descomposición recursiva de funciones de valor expresando valores óptimos como recompensa inmediata más valores futuros descontados",
                  "de": "Rekursive Zerlegung von Wertfunktionen ausdrückend optimale Werte als sofortige Belohnung plus diskontierte zukünftige Werte",
                  "nl": "Recursieve decompositie van waardefuncties die optimale waarden uitdrukken als directe beloning plus gedisconteerde toekomstige waarden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Two actors compete, critic selects winner",
                  "es": "Dos actores compiten, crítico selecciona ganador",
                  "de": "Zwei Actors konkurrieren, Critic wählt Gewinner",
                  "nl": "Twee actors concurreren, critic selecteert winnaar"
        },
        {
                  "en": "Theatrical metaphor for dual-network training",
                  "es": "Metáfora teatral para entrenamiento de red dual",
                  "de": "Theatralische Metapher für duales Netzwerk-Training",
                  "nl": "Theatrale metafoor voor duaal netwerk training"
        },
        {
                  "en": "Actor learns policy selecting actions, critic evaluates actions via value function, critic guides actor's learning",
                  "es": "Actor aprende política seleccionando acciones, crítico evalúa acciones vía función de valor, crítico guía aprendizaje del actor",
                  "de": "Actor lernt Richtlinie wählend Aktionen, Critic bewertet Aktionen via Wertfunktion, Critic leitet Lernen des Actors",
                  "nl": "Actor leert policy selecterend acties, critic evalueert acties via waardefunctie, critic leidt leren van actor"
        },
        {
                  "en": "Actor performs actions, critic provides ratings",
                  "es": "Actor realiza acciones, crítico proporciona calificaciones",
                  "de": "Actor führt Aktionen aus, Critic gibt Bewertungen",
                  "nl": "Actor voert acties uit, critic geeft beoordelingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Optimizes policies by proximity to optimal solution",
                  "es": "Optimiza políticas por proximidad a solución óptima",
                  "de": "Optimiert Richtlinien durch Nähe zu optimaler Lösung",
                  "nl": "Optimaliseert policies door nabijheid tot optimale oplossing"
        },
        {
                  "en": "Clips policy updates to prevent destructive large changes, balancing sample efficiency and stability for reliable training",
                  "es": "Recorta actualizaciones de política para prevenir cambios grandes destructivos, equilibrando eficiencia de muestra y estabilidad para entrenamiento confiable",
                  "de": "Clippt Policy-Updates um destruktive große Änderungen zu verhindern, balanciert Stichproben-Effizienz und Stabilität für zuverlässiges Training",
                  "nl": "Clipt policy updates om destructieve grote veranderingen te voorkomen, balanceert sample efficiëntie en stabiliteit voor betrouwbare training"
        },
        {
                  "en": "Uses proximal gradients for faster convergence",
                  "es": "Usa gradientes proximales para convergencia más rápida",
                  "de": "Verwendet proximale Gradienten für schnellere Konvergenz",
                  "nl": "Gebruikt proximale gradiënten voor snellere convergentie"
        },
        {
                  "en": "Approximately optimal policy search",
                  "es": "Búsqueda de política aproximadamente óptima",
                  "de": "Ungefähr optimale Richtliniensuche",
                  "nl": "Ongeveer optimale policy zoektocht"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses pre-trained models for RL tasks",
                  "es": "Usa modelos pre-entrenados para tareas RL",
                  "de": "Verwendet vortrainierte Modelle für RL-Aufgaben",
                  "nl": "Gebruikt voorgetrainde modellen voor RL taken"
        },
        {
                  "en": "Learns environment dynamics model for planning and simulation, achieving higher sample efficiency through imagined experience",
                  "es": "Aprende modelo de dinámica de entorno para planificación y simulación, logrando mayor eficiencia de muestra a través de experiencia imaginada",
                  "de": "Lernt Umgebungsdynamik-Modell für Planung und Simulation, erreicht höhere Stichproben-Effizienz durch imaginierte Erfahrung",
                  "nl": "Leert omgevingsdynamica model voor planning en simulatie, bereikt hogere sample efficiëntie door verbeelde ervaring"
        },
        {
                  "en": "Based on statistical models only",
                  "es": "Basado solo en modelos estadísticos",
                  "de": "Nur auf statistischen Modellen basierend",
                  "nl": "Alleen gebaseerd op statistische modellen"
        },
        {
                  "en": "Models the reward function explicitly",
                  "es": "Modela la función de recompensa explícitamente",
                  "de": "Modelliert die Belohnungsfunktion explizit",
                  "nl": "Modelleert de beloningsfunctie expliciet"
        }
        ],
        correct: 1,
        explanation: {
