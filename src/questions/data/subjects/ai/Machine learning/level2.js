  ...
  const level2 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "An algorithm is the process, a model is the result of training", es: "Un algoritmo es el proceso, un modelo es el resultado del entrenamiento", de: "Ein Algorithmus ist der Prozess, ein Modell ist das Ergebnis des Trainings", nl: "Een algoritme is het proces, een model is het resultaat van training" },
          { en: "They are exactly the same thing", es: "Son exactamente lo mismo", de: "Sie sind genau dasselbe", nl: "Ze zijn precies hetzelfde" },
          { en: "A model is always faster than an algorithm", es: "Un modelo es siempre más rápido que un algoritmo", de: "Ein Modell ist immer schneller als ein Algorithmus", nl: "Een model is altijd sneller dan een algoritme" },
          { en: "An algorithm is for math, a model is for images", es: "Un algoritmo es para matemáticas, un modelo es para imágenes", de: "Ein Algorithmus ist für Mathematik, ein Modell ist für Bilder", nl: "Een algoritme is voor wiskunde, een model is voor afbeeldingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Model is too simple and performs poorly on both training and new data", es: "El modelo es demasiado simple y funciona mal tanto en datos de entrenamiento como en datos nuevos", de: "Modell ist zu einfach und funktioniert schlecht sowohl bei Trainings- als auch neuen Daten", nl: "Model is te simpel en presteert slecht op zowel trainings- als nieuwe data" },
          { en: "Model doesn't fit in computer memory", es: "El modelo no cabe en la memoria de la computadora", de: "Modell passt nicht in den Computerspeicher", nl: "Model past niet in het computergeheugen" },
          { en: "Training data is too small", es: "Los datos de entrenamiento son demasiado pequeños", de: "Trainingsdaten sind zu klein", nl: "Trainingsdata is te klein" },
          { en: "Model trains too quickly", es: "El modelo entrena demasiado rápido", de: "Modell trainiert zu schnell", nl: "Model traint te snel" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A table showing correct vs incorrect predictions for each class", es: "Una tabla que muestra predicciones correctas vs incorrectas para cada clase", de: "Eine Tabelle die korrekte vs inkorrekte Vorhersagen für jede Klasse zeigt", nl: "Een tabel die correcte vs incorrecte voorspellingen toont voor elke klasse" },
          { en: "A matrix that causes confusion in calculations", es: "Una matriz que causa confusión en los cálculos", de: "Eine Matrix die Verwirrung in Berechnungen verursacht", nl: "Een matrix die verwarring veroorzaakt in berekeningen" },
          { en: "A confusing type of neural network", es: "Un tipo confuso de red neuronal", de: "Eine verwirrende Art von neuronalem Netzwerk", nl: "Een verwarrend type neuraal netwerk" },
          { en: "A list of errors in the code", es: "Una lista de errores en el código", de: "Eine Liste von Fehlern im Code", nl: "Een lijst van fouten in de code" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The ratio of correct positive predictions to all positive predictions", es: "La proporción de predicciones positivas correctas sobre todas las predicciones positivas", de: "Das Verhältnis korrekter positiver Vorhersagen zu allen positiven Vorhersagen", nl: "De verhouding van correcte positieve voorspellingen tot alle positieve voorspellingen" },
          { en: "How precise the measurements are", es: "Qué tan precisas son las mediciones", de: "Wie präzise die Messungen sind", nl: "Hoe precies de metingen zijn" },
          { en: "The total number of correct predictions", es: "El número total de predicciones correctas", de: "Die Gesamtzahl korrekter Vorhersagen", nl: "Het totaal aantal correcte voorspellingen" },
          { en: "How fast the model makes predictions", es: "Qué tan rápido el modelo hace predicciones", de: "Wie schnell das Modell Vorhersagen macht", nl: "Hoe snel het model voorspellingen maakt" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The ratio of correct positive predictions to all actual positives", es: "La proporción de predicciones positivas correctas sobre todos los positivos reales", de: "Das Verhältnis korrekter positiver Vorhersagen zu allen tatsächlichen Positiven", nl: "De verhouding van correcte positieve voorspellingen tot alle daadwerkelijke positieven" },
          { en: "How well the model remembers training data", es: "Qué tan bien el modelo recuerda los datos de entrenamiento", de: "Wie gut das Modell sich an Trainingsdaten erinnert", nl: "Hoe goed het model trainingsdata onthoudt" },
          { en: "Recalling previously made predictions", es: "Recordar predicciones hechas anteriormente", de: "Zuvor gemachte Vorhersagen abrufen", nl: "Eerder gemaakte voorspellingen herinneren" },
          { en: "The speed of retrieving predictions", es: "La velocidad de recuperar predicciones", de: "Die Geschwindigkeit des Abrufens von Vorhersagen", nl: "De snelheid van het ophalen van voorspellingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Balancing model simplicity (bias) against flexibility (variance)", es: "Equilibrar simplicidad del modelo (sesgo) contra flexibilidad (varianza)", de: "Balance zwischen Modell-Einfachheit (Bias) und Flexibilität (Varianz)", nl: "Balanceren van model-eenvoud (bias) tegen flexibiliteit (variance)" },
          { en: "Trading computational resources for accuracy", es: "Intercambiar recursos computacionales por precisión", de: "Rechenressourcen gegen Genauigkeit tauschen", nl: "Computationele middelen ruilen voor nauwkeurigheid" },
          { en: "Choosing between different algorithms", es: "Elegir entre diferentes algoritmos", de: "Wählen zwischen verschiedenen Algorithmen", nl: "Kiezen tussen verschillende algoritmes" },
          { en: "The cost of training vs testing", es: "El costo de entrenamiento vs prueba", de: "Die Kosten von Training vs Testen", nl: "De kosten van training vs testen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A parameter set before training that controls the learning process", es: "Un parámetro establecido antes del entrenamiento que controla el proceso de aprendizaje", de: "Ein Parameter der vor dem Training festgelegt wird und den Lernprozess steuert", nl: "Een parameter ingesteld voor training die het leerproces bestuurt" },
          { en: "An extremely important parameter", es: "Un parámetro extremadamente importante", de: "Ein extrem wichtiger Parameter", nl: "Een extreem belangrijke parameter" },
          { en: "A parameter that changes during training", es: "Un parámetro que cambia durante el entrenamiento", de: "Ein Parameter der sich während des Trainings ändert", nl: "Een parameter die verandert tijdens training" },
          { en: "The highest value in the dataset", es: "El valor más alto en el conjunto de datos", de: "Der höchste Wert im Datensatz", nl: "De hoogste waarde in de dataset" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "An optimization algorithm to minimize errors by adjusting parameters", es: "Un algoritmo de optimización para minimizar errores ajustando parámetros", de: "Ein Optimierungsalgorithmus um Fehler durch Anpassung von Parametern zu minimieren", nl: "Een optimalisatie-algoritme om fouten te minimaliseren door parameters aan te passen" },
          { en: "Going downhill in mountainous terrain", es: "Descender por terreno montañoso", de: "Bergab gehen in bergigem Gelände", nl: "Naar beneden gaan in bergachtig terrein" },
          { en: "Decreasing the dataset size gradually", es: "Disminuir el tamaño del conjunto de datos gradualmente", de: "Datensatzgröße schrittweise verringern", nl: "Geleidelijk de dataset-grootte verkleinen" },
          { en: "Reducing model complexity over time", es: "Reducir la complejidad del modelo con el tiempo", de: "Modellkomplexität im Laufe der Zeit reduzieren", nl: "Modelcomplexiteit verminderen over tijd" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A function that measures how wrong the model's predictions are", es: "Una función que mide qué tan incorrectas son las predicciones del modelo", de: "Eine Funktion die misst wie falsch die Vorhersagen des Modells sind", nl: "Een functie die meet hoe fout de voorspellingen van het model zijn" },
          { en: "A function that calculates data loss during storage", es: "Una función que calcula pérdida de datos durante el almacenamiento", de: "Eine Funktion die Datenverlust während der Speicherung berechnet", nl: "Een functie die dataverlies tijdens opslag berekent" },
          { en: "The cost of running the algorithm", es: "El costo de ejecutar el algoritmo", de: "Die Kosten des Algorithmus-Ausführens", nl: "De kosten van het draaien van het algoritme" },
          { en: "A function that removes bad data", es: "Una función que elimina datos malos", de: "Eine Funktion die schlechte Daten entfernt", nl: "Een functie die slechte data verwijdert" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Scaling features to a similar range for better training", es: "Escalar características a un rango similar para mejor entrenamiento", de: "Features auf einen ähnlichen Bereich skalieren für besseres Training", nl: "Features schalen naar een vergelijkbaar bereik voor betere training" },
          { en: "Making all data values equal to 1", es: "Hacer que todos los valores de datos sean iguales a 1", de: "Alle Datenwerte gleich 1 machen", nl: "Alle datawaarden gelijk maken aan 1" },
          { en: "Removing outliers from the dataset", es: "Eliminar valores atípicos del conjunto de datos", de: "Ausreißer aus dem Datensatz entfernen", nl: "Uitschieters uit de dataset verwijderen" },
          { en: "Converting all text to lowercase", es: "Convertir todo el texto a minúsculas", de: "Allen Text in Kleinbuchstaben umwandeln", nl: "Alle tekst naar kleine letters converteren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Number of training examples used in one iteration", es: "Número de ejemplos de entrenamiento usados en una iteración", de: "Anzahl der Trainingsbeispiele in einer Iteration", nl: "Aantal trainingsvoorbeelden gebruikt in één iteratie" },
          { en: "The total size of the dataset", es: "El tamaño total del conjunto de datos", de: "Die Gesamtgröße des Datensatzes", nl: "De totale grootte van de dataset" },
          { en: "How many models to train at once", es: "Cuántos modelos entrenar a la vez", de: "Wie viele Modelle gleichzeitig trainiert werden", nl: "Hoeveel modellen tegelijk te trainen" },
          { en: "The number of layers in the network", es: "El número de capas en la red", de: "Die Anzahl der Schichten im Netzwerk", nl: "Het aantal lagen in het netwerk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "One complete pass through the entire training dataset", es: "Un pase completo a través de todo el conjunto de datos de entrenamiento", de: "Ein vollständiger Durchlauf durch den gesamten Trainingsdatensatz", nl: "Eén complete doorgang door de hele trainingsdataset" },
          ...
          { en: "The time it takes to train a model", es: "El tiempo que tarda en entrenar un modelo", de: "Die Zeit die es braucht ein Modell zu trainieren", nl: "De tijd die het kost om een model te trainen" },
          { en: "A single training example", es: "Un solo ejemplo de entrenamiento", de: "Ein einzelnes Trainingsbeispiel", nl: "Een enkel trainingsvoorbeeld" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creating modified versions of data to expand training set", es: "Crear versiones modificadas de datos para expandir el conjunto de entrenamiento", de: "Modifizierte Versionen von Daten erstellen um Trainingsset zu erweitern", nl: "Gemodificeerde versies van data maken om trainingsset uit te breiden" },
          { en: "Adding more storage to hold data", es: "Agregar más almacenamiento para contener datos", de: "Mehr Speicher hinzufügen um Daten zu halten", nl: "Meer opslag toevoegen om data vast te houden" },
          { en: "Increasing the quality of images", es: "Aumentar la calidad de las imágenes", de: "Bildqualität erhöhen", nl: "Kwaliteit van afbeeldingen verhogen" },
          { en: "Collecting more real-world data", es: "Recolectar más datos del mundo real", de: "Mehr reale Daten sammeln", nl: "Meer real-world data verzamelen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Using a pre-trained model as starting point for a new task", es: "Usar un modelo pre-entrenado como punto de partida para una nueva tarea", de: "Ein vortrainiertes Modell als Ausgangspunkt für eine neue Aufgabe verwenden", nl: "Een voorgetraind model gebruiken als startpunt voor een nieuwe taak" },
          ...
          { en: "Moving a model from training to production", es: "Mover un modelo de entrenamiento a producción", de: "Ein Modell vom Training zur Produktion verschieben", nl: "Een model verplaatsen van training naar productie" },
          { en: "Teaching AI to learn faster", es: "Enseñar a IA a aprender más rápido", de: "KI beibringen schneller zu lernen", nl: "AI leren om sneller te leren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Reducing the number of input features while preserving important information", es: "Reducir el número de características de entrada mientras se preserva información importante", de: "Anzahl der Eingabefeatures reduzieren während wichtige Informationen erhalten bleiben", nl: "Aantal invoerfeatures verminderen terwijl belangrijke informatie behouden blijft" },
          { en: "Making images smaller in size", es: "Hacer imágenes más pequeñas en tamaño", de: "Bilder in der Größe verkleinern", nl: "Afbeeldingen kleiner maken in grootte" },
          { en: "Removing data from the dataset", es: "Eliminar datos del conjunto de datos", de: "Daten aus dem Datensatz entfernen", nl: "Data uit de dataset verwijderen" },
          { en: "Simplifying the model architecture", es: "Simplificar la arquitectura del modelo", de: "Modellarchitektur vereinfachen", nl: "Modelarchitectuur vereenvoudigen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The harmonic mean of precision and recall", es: "La media armónica de precisión y recall", de: "Das harmonische Mittel von Präzision und Recall", nl: "Het harmonisch gemiddelde van precisie en recall" },
          { en: "The first formula used in machine learning", es: "La primera fórmula usada en aprendizaje automático", de: "Die erste Formel im maschinellen Lernen", nl: "De eerste formule gebruikt in machine learning" },
          { en: "A score from 1 to 10 for model quality", es: "Una puntuación de 1 a 10 para calidad del modelo", de: "Eine Punktzahl von 1 bis 10 für Modellqualität", nl: "Een score van 1 tot 10 voor modelkwaliteit" },
          { en: "The final score after all testing", es: "La puntuación final después de todas las pruebas", de: "Die endgültige Punktzahl nach allen Tests", nl: "De uiteindelijke score na alle testen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Combining multiple models to improve predictions", es: "Combinar múltiples modelos para mejorar predicciones", de: "Mehrere Modelle kombinieren um Vorhersagen zu verbessern", nl: "Meerdere modellen combineren om voorspellingen te verbeteren" },
          { en: "Training models in groups", es: "Entrenar modelos en grupos", de: "Modelle in Gruppen trainieren", nl: "Modellen in groepen trainen" },
          { en: "Using music ensembles to teach AI", es: "Usar conjuntos musicales para enseñar IA", de: "Musik-Ensembles verwenden um KI zu lehren", nl: "Muziekensembles gebruiken om AI te leren" },
          { en: "Learning from multiple datasets simultaneously", es: "Aprender de múltiples conjuntos de datos simultáneamente", de: "Von mehreren Datensätzen gleichzeitig lernen", nl: "Leren van meerdere datasets tegelijkertijd" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A tree-like model that makes decisions through branching questions", es: "Un modelo en forma de árbol que toma decisiones a través de preguntas ramificadas", de: "Ein baumartiges Modell das Entscheidungen durch verzweigende Fragen trifft", nl: "Een boomachtig model dat beslissingen neemt via vertakkende vragen" },
          { en: "A diagram of all possible decisions", es: "Un diagrama de todas las decisiones posibles", de: "Ein Diagramm aller möglichen Entscheidungen", nl: "Een diagram van alle mogelijke beslissingen" },
          { en: "A forest of neural networks", es: "Un bosque de redes neuronales", de: "Ein Wald von neuronalen Netzwerken", nl: "Een bos van neurale netwerken" },
      ...
      },
      {
        ...
        options: [
          { en: "An ensemble of decision trees that vote on predictions", es: "Un conjunto de árboles de decisión que votan sobre predicciones", de: "Ein Ensemble von Entscheidungsbäumen die über Vorhersagen abstimmen", nl: "Een ensemble van decision trees die stemmen op voorspellingen" },
          { en: "A forest where trees are placed randomly", es: "Un bosque donde los árboles se colocan aleatoriamente", de: "Ein Wald wo Bäume zufällig platziert werden", nl: "Een bos waar bomen willekeurig geplaatst worden" },
          { en: "Random selection of training data", es: "Selección aleatoria de datos de entrenamiento", de: "Zufällige Auswahl von Trainingsdaten", nl: "Willekeurige selectie van trainingsdata" },
          { en: "A type of neural network architecture", es: "Un tipo de arquitectura de red neuronal", de: "Eine Art neuronaler Netzwerkarchitektur", nl: "Een type neuraal netwerkarchitectuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Splitting data into k parts, training k times using different parts for testing", es: "Dividir datos en k partes, entrenar k veces usando diferentes partes para prueba", de: "Daten in k Teile aufteilen, k-mal trainieren mit verschiedenen Teilen zum Testen", nl: "Data splitsen in k delen, k keer trainen met verschillende delen voor testen" },
          { en: "Validating the model k times with same data", es: "Validar el modelo k veces con los mismos datos", de: "Modell k-mal mit denselben Daten validieren", nl: "Model k keer valideren met dezelfde data" },
          { en: "Folding the paper k times for organization", es: "Doblar el papel k veces para organización", de: "Papier k-mal falten zur Organisation", nl: "Papier k keer vouwen voor organisatie" },
          { en: "Using k different algorithms", es: "Usar k algoritmos diferentes", de: "k verschiedene Algorithmen verwenden", nl: "k verschillende algoritmes gebruiken" }
        ],
        correct: 0,
        explanation: {
