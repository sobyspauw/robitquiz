    ...
    questions: [
      {
        ...
        {
                  "en": "Batch is faster than SGD",
                  "es": "Batch es mÃ¡s rÃ¡pido que SGD",
                  "de": "Batch ist schneller als SGD",
                  "nl": "Batch is sneller dan SGD"
        },
        {
                  "en": "SGD is more accurate than batch",
                  "es": "SGD es mÃ¡s preciso que batch",
                  "de": "SGD ist genauer als Batch",
                  "nl": "SGD is nauwkeuriger dan batch"
        },
        {
                  "en": "Batch uses entire dataset, SGD uses one sample at a time",
                  "es": "Batch usa todo el conjunto de datos, SGD usa una muestra a la vez",
                  "de": "Batch verwendet den gesamten Datensatz, SGD verwendet eine Stichprobe nach der anderen",
                  "nl": "Batch gebruikt hele dataset, SGD gebruikt Ã©Ã©n sample tegelijk"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Machine learning models become cursed",
                  "es": "Los modelos de machine learning se maldicen",
                  "de": "Maschinelle Lernmodelle werden verflucht",
                  "nl": "Machine learning modellen worden vervloekt"
        },
        {
                  "en": "Too many features make data sparse and algorithms ineffective",
                  "es": "Demasiadas caracterÃ­sticas hacen que los datos sean escasos y los algoritmos ineficaces",
                  "de": "Zu viele Features machen Daten spÃ¤rlich und Algorithmen ineffektiv",
                  "nl": "Te veel features maken data schaars en algoritmes ineffectief"
        },
        {
                  "en": "Training time increases linearly with features",
                  "es": "El tiempo de entrenamiento aumenta linealmente con las caracterÃ­sticas",
                  "de": "Trainingszeit steigt linear mit Features",
                  "nl": "Trainingstijd stijgt lineair met features"
        },
        {
                  "en": "Computers cannot handle 3D data",
                  "es": "Las computadoras no pueden manejar datos 3D",
                  "de": "Computer kÃ¶nnen keine 3D-Daten verarbeiten",
                  "nl": "Computers kunnen geen 3D data verwerken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Precision measures training time, recall measures testing time",
                  "es": "PrecisiÃ³n mide tiempo de entrenamiento, recall mide tiempo de prueba",
                  "de": "PrÃ¤zision misst Trainingszeit, Recall misst Testzeit",
                  "nl": "Precision meet trainingstijd, recall meet testtijd"
        },
        {
                  "en": "Precision is true positives / (true + false positives), recall is true positives / (true positives + false negatives)",
                  "es": "PrecisiÃ³n es verdaderos positivos / (verdaderos + falsos positivos), recall es verd. positivos / (verd. positivos + falsos negativos)",
                  "de": "PrÃ¤zision ist wahre Positive / (wahre + falsche Positive), Recall ist wahre Positive / (wahre Positive + falsche Negative)",
                  "nl": "Precision is true positives / (true + false positives), recall is true positives / (true positives + false negatives)"
        },
        {
                  "en": "Precision measures accuracy, recall measures speed",
                  "es": "La precisiÃ³n mide exactitud, recall mide velocidad",
                  "de": "PrÃ¤zision misst Genauigkeit, Recall misst Geschwindigkeit",
                  "nl": "Precision meet nauwkeurigheid, recall meet snelheid"
        },
        {
                  "en": "Precision and recall are the same metric",
                  "es": "PrecisiÃ³n y recall son la misma mÃ©trica",
                  "de": "PrÃ¤zision und Recall sind dieselbe Metrik",
                  "nl": "Precision en recall zijn dezelfde metriek"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Optimizing model configuration settings for best performance",
                  "es": "Optimizar la configuraciÃ³n del modelo para el mejor rendimiento",
                  "de": "Modellkonfigurationseinstellungen fÃ¼r beste Leistung optimieren",
                  "nl": "Model configuratie-instellingen optimaliseren voor beste prestaties"
        },
        {
                  "en": "Adjusting the volume of computer speakers",
                  "es": "Ajustar el volumen de los altavoces de la computadora",
                  "de": "LautstÃ¤rke der Computer-Lautsprecher einstellen",
                  "nl": "Het volume van computerspeakers aanpassen"
        },
        {
                  "en": "Tuning the computer's hardware",
                  "es": "Ajustar el hardware de la computadora",
                  "de": "Computer-Hardware abstimmen",
                  "nl": "Computer hardware afstemmen"
        },
        {
                  "en": "Training the model multiple times",
                  "es": "Entrenar el modelo mÃºltiples veces",
                  "de": "Das Modell mehrmals trainieren",
                  "nl": "Het model meerdere keren trainen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To remove bad training data",
                  "es": "Para eliminar datos de entrenamiento malos",
                  "de": "Um schlechte Trainingsdaten zu entfernen",
                  "nl": "Om slechte trainingsdata te verwijderen"
        },
        {
                  "en": "To reduce memory usage",
                  "es": "Para reducir el uso de memoria",
                  "de": "Um den Speicherverbrauch zu reduzieren",
                  "nl": "Om geheugengebruik te verminderen"
        },
        {
                  "en": "To speed up training",
                  "es": "Para acelerar el entrenamiento",
                  "de": "Um das Training zu beschleunigen",
                  "nl": "Om training te versnellen"
        },
        {
                  "en": "To prevent overfitting by randomly deactivating neurons",
                  "es": "Para prevenir overfitting desactivando aleatoriamente neuronas",
                  "de": "Um Overfitting zu verhindern, indem Neuronen zufÃ¤llig deaktiviert werden",
                  "nl": "Om overfitting te voorkomen door willekeurig neuronen te deactiveren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "nl": "Hoe nauwkeurig de metingen zijn"
        },
        {
                  "en": "The amount of data used",
                  "es": "La cantidad de datos utilizados",
                  "de": "Die Menge der verwendeten Daten",
                  "nl": "De hoeveelheid gebruikte data"
        },
        {
                  "en": "The speed of model training",
                  "es": "La velocidad del entrenamiento del modelo",
                  "de": "Die Geschwindigkeit des Modelltrainings",
                  "nl": "De snelheid van modeltraining"
        },
        {
                  "en": "The percentage of correct predictions out of all predictions",
                  "es": "El porcentaje de predicciones correctas de todas las predicciones",
                  "de": "Der Prozentsatz korrekter Vorhersagen von allen Vorhersagen",
                  "nl": "Het percentage correcte voorspellingen van alle voorspellingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "nl": "Het harmonisch gemiddelde van precision en recall"
        },
        {
                  "en": "The first score in a sequence",
                  "es": "La primera puntuación en una secuencia",
                  "de": "Die erste Punktzahl in einer Sequenz",
                  "nl": "De eerste score in een reeks"
        },
        {
                  "en": "A racing formula score",
                  "es": "Una puntuación de fórmula de carreras",
                  "de": "Eine Rennformel-Punktzahl",
                  "nl": "Een racefomule score"
        },
        {
                  "en": "The maximum of precision and recall",
                  "es": "El máximo de precisión y recall",
                  "de": "Das Maximum von Präzision und Recall",
                  "nl": "Het maximum van precision en recall"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A matrix that confuses the algorithm",
                  "es": "Una matriz que confunde al algoritmo",
                  "de": "Eine Matrix die den Algorithmus verwirrt",
                  "nl": "Een matrix die het algoritme verward"
        },
        {
                  "en": "A table of random numbers",
                  "es": "Una tabla de números aleatorios",
                  "de": "Eine Tabelle mit Zufallszahlen",
                  "nl": "Een tabel met willekeurige getallen"
        },
        {
                  "en": "A table showing true vs predicted classifications for each class",
                  "es": "Una tabla que muestra clasificaciones verdaderas vs predichas para cada clase",
                  "de": "Eine Tabelle die wahre vs vorhergesagte Klassifikationen für jede Klasse zeigt",
                  "nl": "Een tabel die ware vs voorspelde classificaties toont voor elke klasse"
        },
        {
                  "en": "A complex mathematical formula",
                  "es": "Una fórmula matemática compleja",
                  "de": "Eine komplexe mathematische Formel",
                  "nl": "Een complexe wiskundige formule"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A rock music rating system",
                  "es": "Un sistema de calificación de música rock",
                  "de": "Ein Rock-Musik-Bewertungssystem",
                  "nl": "Een rockmuziek beoordelingssysteem"
        },
        {
                  "en": "Area Under the ROC Curve, measuring classifier performance across thresholds",
                  "es": "Área Bajo la Curva ROC, midiendo rendimiento del clasificador a través de umbrales",
                  "de": "Fläche unter der ROC-Kurve, misst Klassifikatorleistung über Schwellwerte",
                  "nl": "Gebied onder de ROC-curve, meet classifier prestaties over drempelwaarden"
        },
        {
                  "en": "The speed of model training",
                  "es": "La velocidad del entrenamiento del modelo",
        ...
        },
        {
                  ...
                  "de": "Ein Typ neuronales Netzwerk",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A type of regression algorithm",
                  "es": "Un tipo de algoritmo de regresión",
                  "de": "Ein Typ Regressionsalgorithmus",
                  "nl": "Een type regressie algoritme"
        },
        {
                  "en": "The number of mistakes made",
                  "es": "El número de errores cometidos",
                  "de": "Die Anzahl der gemachten Fehler",
                  "nl": "Het aantal gemaakte fouten"
        },
        {
                  "en": "The largest error in the dataset",
                  "es": "El error más grande en el conjunto de datos",
                  "de": "Der größte Fehler im Datensatz",
                  "nl": "De grootste fout in de dataset"
        },
        {
                  "en": "Average of squared differences between predicted and actual values",
                  "es": "Promedio de diferencias al cuadrado entre valores predichos y reales",
                  "de": "Durchschnitt quadrierter Differenzen zwischen vorhergesagten und tatsächlichen Werten",
                  "nl": "Gemiddelde van gekwadrateerde verschillen tussen voorspelde en werkelijke waarden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To validate user passwords",
                  "es": "Para validar contraseñas de usuario",
                  "de": "Um Benutzerpasswörter zu validieren",
                  "nl": "Om gebruikerswachtwoorden te valideren"
        },
        {
                  "en": "To check data quality",
                  "es": "Para verificar la calidad de los datos",
                  "de": "Um Datenqualität zu prüfen",
                  "nl": "Om datakwaliteit te controleren"
        },
        {
                  "en": "To get more reliable estimates of model performance",
                  "es": "Para obtener estimaciones más confiables del rendimiento del modelo",
                  "de": "Um zuverlässigere Schätzungen der Modellleistung zu erhalten",
                  "nl": "Om betrouwbaardere schattingen van modelprestaties te krijgen"
        },
        {
                  "en": "To cross-reference different datasets",
                  "es": "Para hacer referencias cruzadas de diferentes conjuntos de datos",
                  "de": "Um verschiedene Datensätze zu kreuzen",
                  "nl": "Om verschillende datasets te kruisrefereren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The square of MSE",
                  "es": "El cuadrado de MSE",
                  "de": "Das Quadrat von MSE",
                  "nl": "Het kwadraat van MSE"
        },
        {
                  "en": "A more complex version of accuracy",
                  "es": "Una versión más compleja de exactitud",
                  "de": "Eine komplexere Version von Genauigkeit",
                  "nl": "Een complexere versie van nauwkeurigheid"
        },
        {
                  "en": "The square root of MSE, giving error in original units",
                  "es": "La raíz cuadrada de MSE, dando error en unidades originales",
                  "de": "Die Quadratwurzel von MSE, gibt Fehler in ursprünglichen Einheiten",
                  "nl": "De vierkantswortel van MSE, geeft fout in originele eenheden"
        },
        {
                  "en": "A classification metric",
                  "es": "Una métrica de clasificación",
                  "de": "Eine Klassifikationsmetrik",
                  "nl": "Een classificatiemetriek"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The average of all predictions",
                  "es": "El promedio de todas las predicciones",
                  "de": "Der Durchschnitt aller Vorhersagen",
                  "nl": "Het gemiddelde van alle voorspellingen"
        },
        {
                  "en": "A measure of model complexity",
                  "es": "Una medida de complejidad del modelo",
                  "de": "Ein Maß für Modellkomplexität",
                  "nl": "Een maat voor modelcomplexiteit"
        },
        {
                  "en": "Average of absolute differences between predicted and actual values",
                  "es": "Promedio de diferencias absolutas entre valores predichos y reales",
                  "de": "Durchschnitt absoluter Differenzen zwischen vorhergesagten und tatsächlichen Werten",
                  "nl": "Gemiddelde van absolute verschillen tussen voorspelde en werkelijke waarden"
        },
        {
                  "en": "The maximum error in predictions",
                  "es": "El error máximo en predicciones",
                  "de": "Der maximale Fehler in Vorhersagen",
                  "nl": "De maximale fout in voorspellingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To store backup copies of data",
                  "es": "Para almacenar copias de respaldo de datos",
                  "de": "Um Backup-Kopien von Daten zu speichern",
                  "nl": "Om backup kopieën van data op te slaan"
        },
        {
                  "en": "To test the final model performance",
                  "es": "Para probar el rendimiento final del modelo",
                  "de": "Um die finale Modellleistung zu testen",
                  "nl": "Om de finale modelprestaties te testen"
        },
        {
                  "en": "To evaluate model performance during training and tune hyperparameters",
                  "es": "Para evaluar el rendimiento del modelo durante el entrenamiento y ajustar hiperparámetros",
                  "de": "Um Modellleistung während des Trainings zu bewerten und Hyperparameter zu optimieren",
                  "nl": "Om modelprestaties te evalueren tijdens training en hyperparameters af te stellen"
        },
        {
                  "en": "To validate that data is correct",
                  "es": "Para validar que los datos son correctos",
                  "de": "Um zu validieren dass Daten korrekt sind",
                  "nl": "Om te valideren dat data correct is"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The model is too complex and overfits",
                  "es": "El modelo es demasiado complejo y sobreajusta",
                  "de": "Das Modell ist zu komplex und überpasst",
                  "nl": "Het model is te complex en overfit"
        },
        {
                  "en": "The model is too simple and underfits the data",
                  "es": "El modelo es demasiado simple y subajusta los datos",
                  "de": "Das Modell ist zu einfach und unterpasst die Daten",
                  "nl": "Het model is te eenvoudig en onderfit de data"
        },
        {
                  "en": "The model is prejudiced against certain groups",
                  "es": "El modelo está prejuiciado contra ciertos grupos",
                  "de": "Das Modell ist voreingenommen gegen bestimmte Gruppen",
                  "nl": "Het model is bevooroordeeld tegen bepaalde groepen"
        },
        {
                  "en": "The model takes too long to train",
                  "es": "El modelo tarda demasiado en entrenar",
                  "de": "Das Modell braucht zu lange zum Trainieren",
                  "nl": "Het model duurt te lang om te trainen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The model is too sensitive to training data and overfits",
                  "es": "El modelo es demasiado sensible a los datos de entrenamiento y sobreajusta",
                  "de": "Das Modell ist zu empfindlich für Trainingsdaten und überpasst",
                  "nl": "Het model is te gevoelig voor trainingsdata en overfit"
        },
        {
                  "en": "The model has inconsistent output format",
                  "es": "El modelo tiene formato de salida inconsistente",
                  "de": "Das Modell hat inkonsistentes Ausgabeformat",
                  "nl": "Het model heeft inconsistent uitvoerformaat"
        },
        {
                  "en": "The model parameters change randomly",
                  "es": "Los parámetros del modelo cambian aleatoriamente",
                  "de": "Die Modellparameter ändern sich zufällig",
                  "nl": "De modelparameters veranderen willekeurig"
        },
        {
                  "en": "The model uses many different algorithms",
                  "es": "El modelo usa muchos algoritmos diferentes",
                  "de": "Das Modell verwendet viele verschiedene Algorithmen",
                  "nl": "Het model gebruikt veel verschillende algoritmes"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "As you increase precision, recall typically decreases and vice versa",
                  "es": "Mientras aumentas precisión, el recall típicamente disminuye y viceversa",
                  "de": "Wenn Sie Präzision erhöhen, nimmt Recall typischerweise ab und umgekehrt",
                  "nl": "Naarmate je precision verhoogt, neemt recall meestal af en omgekeerd"
        },
        {
                  "en": "Precision and recall always move in the same direction",
                  "es": "Precisión y recall siempre se mueven en la misma dirección",
                  "de": "Präzision und Recall bewegen sich immer in dieselbe Richtung",
                  "nl": "Precision en recall bewegen altijd in dezelfde richting"
        },
        {
                  "en": "You must choose between precision and recall, can't have both",
                  "es": "Debes elegir entre precisión y recall, no puedes tener ambos",
                  "de": "Sie müssen zwischen Präzision und Recall wählen, können nicht beide haben",
                  "nl": "Je moet kiezen tussen precision en recall, je kunt niet beide hebben"
        },
        {
                  "en": "There is no relationship between precision and recall",
                  "es": "No hay relación entre precisión y recall",
                  "de": "Es gibt keine Beziehung zwischen Präzision und Recall",
                  "nl": "Er is geen relatie tussen precision en recall"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Type I occurs during training, Type II during testing",
                  "es": "Tipo I ocurre durante entrenamiento, Tipo II durante pruebas",
                  "de": "Typ I tritt während Training auf, Typ II während Testing",
                  "nl": "Type I treedt op tijdens training, Type II tijdens testen"
        },
        {
                  "en": "They are the same thing",
                  "es": "Son la misma cosa",
                  "de": "Sie sind dasselbe",
                  "nl": "Het zijn hetzelfde"
        },
        {
                  "en": "Type I is a minor error, Type II is a major error",
                  "es": "Tipo I es un error menor, Tipo II es un error mayor",
                  "de": "Typ I ist ein geringer Fehler, Typ II ist ein schwerer Fehler",
                  "nl": "Type I is een kleine fout, Type II is een grote fout"
        },
        {
                  "en": "Type I is false positive, Type II is false negative",
                  "es": "Tipo I es falso positivo, Tipo II es falso negativo",
                  "de": "Typ I ist falsch positiv, Typ II ist falsch negativ",
                  "nl": "Type I is vals positief, Type II is vals negatief"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating regular training schedules",
                  "es": "Crear horarios regulares de entrenamiento",
                  "de": "Regelmäßige Trainingspläne erstellen",
                  "nl": "Reguliere trainingsschema's maken"
        },
        {
                  "en": "Organizing data in regular intervals",
                  "es": "Organizar datos en intervalos regulares",
                  "de": "Daten in regelmäßigen Intervallen organisieren",
                  "nl": "Data organiseren in reguliere intervallen"
        },
        {
                  "en": "Making data follow regular patterns",
                  "es": "Hacer que los datos sigan patrones regulares",
                  "de": "Daten regelmäßigen Mustern folgen lassen",
                  "nl": "Data reguliere patronen laten volgen"
        },
        {
                  "en": "A technique to prevent overfitting by adding penalty terms to the loss function",
                  "es": "Una técnica para prevenir sobreajuste añadiendo términos de penalización a la función de pérdida",
                  "de": "Eine Technik zur Verhinderung von Overfitting durch Hinzufügen von Penalty-Termen zur Verlustfunktion",
                  "nl": "Een techniek om overfitting te voorkomen door penalty termen toe te voegen aan de loss functie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only using the best single model",
                  "es": "Solo usar el mejor modelo individual",
                  "de": "Nur das beste einzelne Modell verwenden",
                  "nl": "Alleen het beste individuele model gebruiken"
        },
        {
                  "en": "Learning from ensemble casts in movies",
                  "es": "Aprender de reparto coral en películas",
                  "de": "Von Ensemble-Besetzungen in Filmen lernen",
                  "nl": "Leren van ensemble-casts in films"
        },
        {
                  "en": "Training models in musical ensembles",
                  "es": "Entrenar modelos en conjuntos musicales",
                  "de": "Modelle in Musikensembles trainieren",
                  "nl": "Modellen trainen in muziekensembles"
        },
        {
                  "en": "Combining multiple models to make predictions, often achieving better performance than individual models",
                  "es": "Combinar múltiples modelos para hacer predicciones, a menudo logrando mejor rendimiento que modelos individuales",
                  "de": "Mehrere Modelle kombinieren um Vorhersagen zu treffen, erreicht oft bessere Leistung als einzelne Modelle",
                  "nl": "Meerdere modellen combineren om voorspellingen te maken, behaalt vaak betere prestaties dan individuele modellen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Increasing the learning rate gradually",
                  "es": "Aumentar gradualmente la tasa de aprendizaje",
                  "de": "Lernrate allmählich erhöhen",
                  "nl": "De learning rate geleidelijk verhogen"
        },
        {
                  "en": "An ensemble method that sequentially builds models to correct previous errors",
                  "es": "Un método ensemble que construye modelos secuencialmente para corregir errores previos",
                  "de": "Eine Ensemble-Methode die sequenziell Modelle baut um frühere Fehler zu korrigieren",
                  "nl": "Een ensemble methode die opeenvolgend modellen bouwt om eerdere fouten te corrigeren"
        },
        {
                  "en": "A way to speed up gradient descent",
                  "es": "Una forma de acelerar gradient descent",
                  "de": "Eine Methode um Gradientenabstieg zu beschleunigen",
                  "nl": "Een manier om gradient descent te versnellen"
        },
        {
                  "en": "Boosting computer performance for gradient calculations",
                  "es": "Aumentar el rendimiento del ordenador para cálculos de gradiente",
                  "de": "Computerleistung für Gradientenberechnungen steigern",
                  "nl": "Computerprestaties verhogen voor gradiëntberekeningen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Frequency counts of words",
                  "es": "Conteos de frecuencia de palabras",
                  "de": "Häufigkeitszählungen von Wörtern",
                  "nl": "Frequentietellingen van woorden"
        },
        {
                  "en": "Dictionary definitions of words",
                  "es": "Definiciones de diccionario de palabras",
                  "de": "Wörterbuchdefinitionen von Wörtern",
                  "nl": "Woordenboekdefinities van woorden"
        },
        {
                  "en": "Dense vector representations of words capturing semantic relationships",
                  "es": "Representaciones vectoriales densas de palabras que capturan relaciones semánticas",
                  "de": "Dichte Vektordarstellungen von Wörtern die semantische Beziehungen erfassen",
                  "nl": "Dichte vectorrepresentaties van woorden die semantische relaties vastleggen"
        },
        {
                  "en": "Words embedded in sentences",
                  "es": "Palabras incrustadas en oraciones",
                  "de": "Wörter eingebettet in Sätzen",
                  "nl": "Woorden ingebed in zinnen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "User attention tracking during inference",
                  "es": "Seguimiento de atención del usuario durante inferencia",
                  "de": "Benutzeraufmerksamkeitsverfolgung während Inferenz",
                  "nl": "Gebruikersaandacht volgen tijdens inferentie"
        },
        {
                  "en": "A mechanism that allows models to focus on relevant parts of input",
                  "es": "Un mecanismo que permite a los modelos enfocarse en partes relevantes de la entrada",
                  "de": "Ein Mechanismus der Modellen ermöglicht sich auf relevante Teile der Eingabe zu konzentrieren",
                  "nl": "Een mechanisme dat modellen in staat stelt zich te richten op relevante delen van de input"
        },
        {
                  "en": "A warning system for model errors",
                  "es": "Un sistema de advertencia para errores del modelo",
                  "de": "Ein Warnsystem für Modellfehler",
                  "nl": "Een waarschuwingssysteem voor modelfouten"
        },
        {
                  "en": "Making models more attentive to training time",
                  "es": "Hacer modelos más atentos al tiempo de entrenamiento",
                  "de": "Modelle aufmerksamer für Trainingszeit machen",
                  "nl": "Modellen attentiever maken voor trainingstijd"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Exhaustively trying all combinations of predefined parameter values",
                  "es": "Probar exhaustivamente todas las combinaciones de valores de parámetros predefinidos",
                  "de": "Erschöpfendes Ausprobieren aller Kombinationen vordefinierter Parameterwerte",
                  "nl": "Uitputtend alle combinaties van voorgedefinieerde parameterwaarden proberen"
        },
        {
                  "en": "Random search in parameter space",
                  "es": "Búsqueda aleatoria en espacio de parámetros",
                  "de": "Zufällige Suche im Parameterraum",
                  "nl": "Willekeurig zoeken in parameterruimte"
        },
        {
                  "en": "Searching for data in a grid structure",
                  "es": "Buscar datos en una estructura de cuadrícula",
                  "de": "Daten in einer Gitterstruktur suchen",
                  "nl": "Zoeken naar data in een rasterstructuur"
        },
        {
                  "en": "Organizing hyperparameters in a visual grid",
                  "es": "Organizar hiperparámetros en una cuadrícula visual",
                  "de": "Hyperparameter in einem visuellen Gitter organisieren",
                  "nl": "Hyperparameters organiseren in een visueel raster"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Memory leaks in the code",
                  "es": "Fugas de memoria en el código",
                  "de": "Speicherlecks im Code",
                  "nl": "Geheugenlekken in de code"
        },
        {
                  "en": "Data being stolen by hackers",
                  "es": "Datos siendo robados por hackers",
                  "de": "Daten werden von Hackern gestohlen",
                  "nl": "Data wordt gestolen door hackers"
        },
        {
                  "en": "When test/validation data information leaks into the training process",
                  "es": "Cuando información de datos de test/validación se filtra en el proceso de entrenamiento",
                  "de": "Wenn Test-/Validierungsdateninformationen in den Trainingsprozess lecken",
                  "nl": "Wanneer test/validatie data informatie lekt in het trainingsproces"
        },
        {
                  "en": "Data being lost during training",
                  "es": "Datos perdiéndose durante entrenamiento",
                  "de": "Daten gehen während Training verloren",
                  "nl": "Data raakt verloren tijdens training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Eager is faster, lazy is slower",
                  "es": "Eager es más rápido, lazy es más lento",
                  "de": "Eager ist schneller, Lazy ist langsamer",
                  "nl": "Eager is sneller, lazy is langzamer"
        },
        {
                  "en": "They are the same concept",
                  "es": "Son el mismo concepto",
                  "de": "Sie sind dasselbe Konzept",
                  "nl": "Het zijn hetzelfde concept"
        },
        {
                  "en": "Eager evaluates immediately, lazy delays until result is needed",
                  "es": "Eager evalúa inmediatamente, lazy retrasa hasta que se necesita el resultado",
                  "de": "Eager wertet sofort aus, Lazy verzögert bis Ergebnis benötigt wird",
                  "nl": "Eager evalueert direct, lazy stelt uit tot resultaat nodig is"
        },
        {
                  "en": "Eager uses more memory, lazy uses less",
                  "es": "Eager usa más memoria, lazy usa menos",
                  "de": "Eager verwendet mehr Speicher, Lazy weniger",
                  "nl": "Eager gebruikt meer geheugen, lazy minder"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training models with intentionally perturbed examples to improve robustness",
                  "es": "Entrenar modelos con ejemplos intencionalmente perturbados para mejorar robustez",
                  "de": "Modelle mit absichtlich gestörten Beispielen trainieren um Robustheit zu verbessern",
                  "nl": "Modellen trainen met opzettelijk verstoorde voorbeelden om robuustheid te verbeteren"
        },
        {
        ...
        {
                  "en": "Training models on adversarial datasets",
                  "es": "Entrenar modelos en conjuntos de datos adversariales",
                  "de": "Modelle auf adversarialen Datensätzen trainieren",
                  "nl": "Modellen trainen op adversariale datasets"
        },
        {
                  "en": "Training in hostile environments",
                  "es": "Entrenar en entornos hostiles",
                  "de": "In feindlichen Umgebungen trainieren",
                  "nl": "Trainen in vijandige omgevingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning how to learn - training models to adapt quickly to new tasks",
                  "es": "Aprender a aprender - entrenar modelos para adaptarse rápidamente a nuevas tareas",
                  "de": "Lernen zu lernen - Modelle trainieren um sich schnell an neue Aufgaben anzupassen",
                  "nl": "Leren te leren - modellen trainen om snel aan te passen aan nieuwe taken"
        },
        {
                  "en": "Learning metadata about datasets",
                  "es": "Aprender metadatos sobre conjuntos de datos",
                  "de": "Metadaten über Datensätze lernen",
                  "nl": "Metadata leren over datasets"
        },
        {
                  "en": "High-level abstract learning",
                  "es": "Aprendizaje abstracto de alto nivel",
                  "de": "Hochrangiges abstraktes Lernen",
                  "nl": "Hoog-niveau abstract leren"
        },
        {
                  "en": "Learning from meta tags",
                  "es": "Aprender de meta etiquetas",
                  "de": "Von Meta-Tags lernen",
                  "nl": "Leren van meta tags"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The future state depends only on the current state, not the full history",
                  "es": "El estado futuro depende solo del estado actual, no del historial completo",
                  "de": "Der zukünftige Zustand hängt nur vom aktuellen Zustand ab, nicht von der vollständigen Historie",
                  "nl": "De toekomstige staat hangt alleen af van de huidige staat, niet van de volledige geschiedenis"
        },
        {
                  "en": "The model was created by Markov",
                  "es": "El modelo fue creado por Markov",
                  "de": "Das Modell wurde von Markov erstellt",
                  "nl": "Het model is gemaakt door Markov"
        },
        {
                  "en": "All states are equally probable",
                  "es": "Todos los estados son igualmente probables",
                  "de": "Alle Zustände sind gleich wahrscheinlich",
                  "nl": "Alle staten zijn even waarschijnlijk"
        },
        {
                  "en": "States change randomly",
                  "es": "Los estados cambian aleatoriamente",
                  "de": "Zustände ändern sich zufällig",
                  "nl": "Staten veranderen willekeurig"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "nl": "Trainingstijd reduceren"
        },
        {
                  "en": "Techniques to reduce model size while maintaining performance",
                  "es": "Técnicas para reducir tamaño del modelo manteniendo rendimiento",
                  "de": "Techniken zur Reduzierung der Modellgröße bei Beibehaltung der Leistung",
                  "nl": "Technieken om modelgrootte te reduceren met behoud van prestaties"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting knowledge to liquid form",
                  "es": "Convertir conocimiento a forma líquida",
                  "de": "Wissen in flüssige Form umwandeln",
                  "nl": "Kennis omzetten naar vloeibare vorm"
        },
        {
                  "en": "Training a smaller model to mimic a larger teacher model",
                  "es": "Entrenar un modelo más pequeño para imitar un modelo maestro más grande",
                  "de": "Ein kleineres Modell trainieren um ein größeres Lehrermodell nachzuahmen",
                  "nl": "Een kleiner model trainen om een groter leraar model na te bootsen"
        },
        {
                  "en": "Extracting pure knowledge from data",
                  "es": "Extraer conocimiento puro de datos",
                  "de": "Reines Wissen aus Daten extrahieren",
                  "nl": "Zuivere kennis uit data extraheren"
        },
        {
                  "en": "Removing unnecessary knowledge",
                  "es": "Eliminar conocimiento innecesario",
                  "de": "Unnötiges Wissen entfernen",
                  "nl": "Onnodige kennis verwijderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Exploring data vs exploiting resources",
                  "es": "Explorar datos vs explotar recursos",
                  "de": "Daten erkunden vs Ressourcen ausbeuten",
                  "nl": "Data verkennen vs middelen exploiteren"
        },
        {
                  "en": "Balancing trying new actions vs using known good actions",
                  "es": "Balancear probar nuevas acciones vs usar acciones buenas conocidas",
                  "de": "Ausbalancieren neuer Aktionen ausprobieren vs bekannte gute Aktionen nutzen",
                  "nl": "Balanceren tussen nieuwe acties proberen vs bekende goede acties gebruiken"
        },
        {
                  "en": "Mining data vs using it",
                  "es": "Minar datos vs usarlos",
                  "de": "Daten abbauen vs verwenden",
                  "nl": "Data mijnen vs gebruiken"
        },
        {
                  "en": "Discovering vs applying knowledge",
                  "es": "Descubrir vs aplicar conocimiento",
                  "de": "Wissen entdecken vs anwenden",
                  "nl": "Kennis ontdekken vs toepassen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning time series patterns",
                  "es": "Aprender patrones de series temporales",
                  "de": "Zeitreihenmuster lernen",
                  "nl": "Tijdreekspatronen leren"
        },
        {
                  "en": "Calculating time differences in training",
                  "es": "Calcular diferencias de tiempo en entrenamiento",
                  "de": "Zeitunterschiede im Training berechnen",
                  "nl": "Tijdverschillen berekenen in training"
        },
        {
                  "en": "Training at different times",
                  "es": "Entrenar en diferentes momentos",
                  "de": "Zu verschiedenen Zeiten trainieren",
                  "nl": "Op verschillende tijden trainen"
        },
        {
                  "en": "Learning by comparing predictions at different time steps",
                  "es": "Aprender comparando predicciones en diferentes pasos temporales",
                  "de": "Lernen durch Vergleich von Vorhersagen zu verschiedenen Zeitpunkten",
                  "nl": "Leren door voorspellingen op verschillende tijdstappen te vergelijken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Creating learning schedules",
                  "es": "Crear horarios de aprendizaje",
                  "de": "Lernpläne erstellen",
                  "nl": "Leerplannen maken"
        },
        {
        ...
        {
                  "en": "Learning school curriculums",
                  "es": "Aprender currículos escolares",
                  "de": "Schullehrpläne lernen",
                  "nl": "Schoolcurricula leren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Quick learning sessions",
                  "es": "Sesiones de aprendizaje rápidas",
                  "de": "Schnelle Lernsitzungen",
                  "nl": "Snelle leersessies"
        },
        {
                  "en": "Learning a small number of classes",
                  "es": "Aprender un pequeño número de clases",
                  "de": "Eine kleine Anzahl von Klassen lernen",
                  "nl": "Een klein aantal klassen leren"
        },
        {
                  "en": "Learning to perform tasks with very few training examples",
                  "es": "Aprender a realizar tareas con muy pocos ejemplos de entrenamiento",
                  "de": "Lernen Aufgaben mit sehr wenigen Trainingsbeispielen durchzuführen",
                  "nl": "Leren taken uit te voeren met zeer weinig trainingsvoorbeelden"
        },
        {
                  "en": "Training with few epochs",
                  "es": "Entrenar con pocas épocas",
                  "de": "Mit wenigen Epochen trainieren",
                  "nl": "Trainen met weinig epochs"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning from contrasting colors",
                  "es": "Aprender de colores contrastantes",
                  "de": "Von kontrastierenden Farben lernen",
                  "nl": "Leren van contrasterende kleuren"
        },
        {
                  "en": "Learning by contrasting similar and dissimilar examples",
                  "es": "Aprender contrastando ejemplos similares y disímiles",
                  "de": "Lernen durch Kontrast ähnlicher und unähnlicher Beispiele",
                  "nl": "Leren door vergelijkbare en ongelijksoortige voorbeelden te contrasteren"
        },
        {
                  "en": "Comparing different learning methods",
                  "es": "Comparar diferentes métodos de aprendizaje",
                  "de": "Verschiedene Lernmethoden vergleichen",
                  "nl": "Verschillende leermethoden vergelijken"
        },
        {
                  "en": "Learning opposite concepts",
                  "es": "Aprender conceptos opuestos",
                  "de": "Gegensätzliche Konzepte lernen",
                  "nl": "Tegenovergestelde concepten leren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning from unlabeled data by creating pretext tasks from the data itself",
                  "es": "Aprender de datos sin etiquetar creando tareas pretexto de los datos mismos",
                  "de": "Aus unbeschrifteten Daten lernen durch Erstellen von Vorwand-Aufgaben aus den Daten selbst",
                  "nl": "Leren van ongelabelde data door pretext taken te creëren van de data zelf"
        },
        {
                  "en": "Automated supervised learning",
                  "es": "Aprendizaje supervisado automatizado",
                  "de": "Automatisiertes überwachtes Lernen",
                  "nl": "Geautomatiseerd gesuperviseerd leren"
        },
        {
                  "en": "Models teaching themselves",
                  "es": "Modelos enseñándose a sí mismos",
                  "de": "Modelle bringen sich selbst bei",
                  "nl": "Modellen leren zichzelf"
        },
        {
                  "en": "Models learning without any supervision",
                  "es": "Modelos aprendiendo sin supervisión",
                  "de": "Modelle lernen ohne Aufsicht",
                  "nl": "Modellen leren zonder supervisie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adapting to new hardware",
                  "es": "Adaptarse a nuevo hardware",
                  "de": "An neue Hardware anpassen",
                  "nl": "Aanpassen aan nieuwe hardware"
        },
        {
                  "en": "Changing the model's domain name",
                  "es": "Cambiar el nombre de dominio del modelo",
                  "de": "Den Domainnamen des Modells ändern",
                  "nl": "De domeinnaam van het model veranderen"
        },
        {
                  "en": "Adapting a model trained on one domain to work on a different domain",
                  "es": "Adaptar un modelo entrenado en un dominio para trabajar en un dominio diferente",
                  "de": "Ein auf einer Domäne trainiertes Modell für eine andere Domäne anpassen",
                  "nl": "Een model getraind op één domein aanpassen om te werken op een ander domein"
        },
        {
                  "en": "Learning multiple domains simultaneously",
                  "es": "Aprender múltiples dominios simultáneamente",
                  "de": "Mehrere Domänen gleichzeitig lernen",
                  "nl": "Meerdere domeinen tegelijk leren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reducing precision of weights and activations to use fewer bits",
                  "es": "Reducir precisión de pesos y activaciones para usar menos bits",
                  "de": "Präzision von Gewichten und Aktivierungen reduzieren um weniger Bits zu nutzen",
                  "nl": "Precisie van gewichten en activaties verminderen om minder bits te gebruiken"
        },
        {
                  "en": "Adding quantum layers",
                  "es": "Añadir capas cuánticas",
                  "de": "Quantenschichten hinzufügen",
                  "nl": "Kwantumlagen toevoegen"
        },
        {
                  "en": "Dividing the network into quantities",
                  "es": "Dividir la red en cantidades",
                  "de": "Das Netzwerk in Mengen aufteilen",
                  "nl": "Het netwerk verdelen in hoeveelheden"
        },
        {
                  "en": "Measuring quantum effects in networks",
                  "es": "Medir efectos cuánticos en redes",
                  "de": "Quanteneffekte in Netzwerken messen",
                  "nl": "Kwantumeffecten in netwerken meten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Organizing neural network documentation",
                  "es": "Organizar documentación de redes neuronales",
                  "de": "Dokumentation neuronaler Netzwerke organisieren",
                  "nl": "Neurale netwerk documentatie organiseren"
        },
        {
                  "en": "Searching for neural networks online",
                  "es": "Buscar redes neuronales en línea",
                  "de": "Online nach neuronalen Netzwerken suchen",
                  "nl": "Online zoeken naar neurale netwerken"
        },
        {
                  "en": "Finding neurons in brain scans",
                  "es": "Encontrar neuronas en escaneos cerebrales",
                  "de": "Neuronen in Gehirnscans finden",
                  "nl": "Neuronen vinden in hersenscans"
        },
        {
                  "en": "Automatically finding optimal neural network architectures",
                  "es": "Encontrar automáticamente arquitecturas óptimas de redes neuronales",
                  "de": "Automatisches Finden optimaler neuronaler Netzwerkarchitekturen",
                  "nl": "Automatisch optimale neurale netwerkarchitecturen vinden"
        }
        ],
        correct: 3,
        explanation: {
