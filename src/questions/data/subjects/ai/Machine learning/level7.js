    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Frequentist uses probabilities, Bayesian uses statistics",
                  "es": "Frecuentista usa probabilidades, Bayesiano usa estadísticas",
                  "de": "Frequentist verwendet Wahrscheinlichkeiten, Bayesianisch verwendet Statistiken",
                  "nl": "Frequentist gebruikt kansen, Bayesiaans gebruikt statistieken"
        },
        {
                  "en": "Frequentist treats parameters as fixed, Bayesian treats them as random variables with distributions",
                  "es": "Frecuentista trata parámetros como fijos, Bayesiano los trata como variables aleatorias con distribuciones",
                  "de": "Frequentist behandelt Parameter als fest, Bayesianisch behandelt sie als Zufallsvariablen mit Verteilungen",
                  "nl": "Frequentist behandelt parameters als vast, Bayesiaans behandelt ze als willekeurige variabelen met distributies"
        },
        {
                  "en": "Bayesian requires more data than frequentist",
                  "es": "Bayesiano requiere más datos que frecuentista",
                  "de": "Bayesianisch benötigt mehr Daten als Frequentist",
                  "nl": "Bayesiaans vereist meer data dan frequentist"
        },
        {
                  "en": "Frequentist is faster than Bayesian",
                  "es": "Frecuentista es más rápido que Bayesiano",
                  "de": "Frequentist ist schneller als Bayesianisch",
                  "nl": "Frequentist is sneller dan Bayesiaans"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Analyzing the primary causes of model errors",
                  "es": "Analizar las causas primarias de errores del modelo",
                  "de": "Die primären Ursachen von Modellfehlern analysieren",
                  "nl": "De primaire oorzaken van modelfouten analyseren"
        },
        {
                  "en": "Selecting the most important features manually",
                  "es": "Seleccionar las características más importantes manualmente",
                  "de": "Die wichtigsten Merkmale manuell auswählen",
                  "nl": "De belangrijkste features handmatig selecteren"
        },
        {
                  "en": "Finding the principal components of computer hardware",
                  "es": "Encontrar los componentes principales del hardware de computadora",
                  "de": "Die Hauptkomponenten der Computer-Hardware finden",
                  "nl": "De hoofdcomponenten van computerhardware vinden"
        },
        {
                  "en": "Dimensionality reduction by finding directions of maximum variance",
                  "es": "Reducción de dimensionalidad encontrando direcciones de máxima varianza",
                  "de": "Dimensionalitätsreduktion durch Finden von Richtungen maximaler Varianz",
                  "nl": "Dimensionaliteitsreductie door richtingen van maximale variantie te vinden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Calculate the computational complexity of algorithms",
                  "es": "Calcular la complejidad computacional de algoritmos",
                  "de": "Die Rechenkomplexität von Algorithmen berechnen",
                  "nl": "De computationele complexiteit van algoritmes berekenen"
        },
        {
                  "en": "Determine the optimal learning rate",
                  "es": "Determinar la tasa de aprendizaje óptima",
                  "de": "Die optimale Lernrate bestimmen",
                  "nl": "De optimale learning rate bepalen"
        },
        {
                  "en": "Balance model complexity and goodness of fit to avoid overfitting",
                  "es": "Equilibrar complejidad del modelo y bondad de ajuste para evitar overfitting",
                  "de": "Modellkomplexität und Anpassungsgüte ausbalancieren um Overfitting zu vermeiden",
                  "nl": "Modelcomplexiteit en goodness of fit balanceren om overfitting te vermijden"
        },
        {
                  "en": "Measure the accuracy of individual predictions",
                  "es": "Medir la precisión de predicciones individuales",
                  "de": "Die Genauigkeit einzelner Vorhersagen messen",
                  "nl": "De nauwkeurigheid van individuele voorspellingen meten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Models where future states depend only on current state, useful for sequential data",
                  "es": "Modelos donde estados futuros dependen solo del estado actual, útiles para datos secuenciales",
                  "de": "Modelle wo zukünftige Zustände nur vom aktuellen Zustand abhängen, nützlich für sequenzielle Daten",
                  "nl": "Modellen waarbij toekomstige toestanden alleen afhangen van de huidige toestand, nuttig voor sequentiële data"
        },
        {
                  "en": "Statistical models that require complete independence",
                  "es": "Modelos estadísticos que requieren independencia completa",
                  "de": "Statistische Modelle die vollständige Unabhängigkeit erfordern",
                  "nl": "Statistische modellen die volledige onafhankelijkheid vereisen"
        },
        {
                  "en": "Models that can predict any future event",
                  "es": "Modelos que pueden predecir cualquier evento futuro",
                  "de": "Modelle die jedes zukünftige Ereignis vorhersagen können",
                  "nl": "Modellen die elke toekomstige gebeurtenis kunnen voorspellen"
        },
        {
                  "en": "Models named after scientist Markov for image processing",
                  "es": "Modelos nombrados por el científico Markov para procesamiento de imágenes",
                  "de": "Nach dem Wissenschaftler Markov benannte Modelle für Bildverarbeitung",
                  "nl": "Modellen genoemd naar wetenschapper Markov voor beeldverwerking"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Time series uses temporal order and trends, cross-sectional analyzes snapshot data at one time point",
                  "es": "Series temporales usa orden temporal y tendencias, transversal analiza datos de instantánea en un punto temporal",
                  "de": "Zeitreihen verwenden zeitliche Ordnung und Trends, Querschnitt analysiert Momentaufnahme-Daten zu einem Zeitpunkt",
                  "nl": "Tijdreeksen gebruiken temporele volgorde en trends, cross-sectioneel analyseert momentopname data op één tijdstip"
        },
        {
                  "en": "Time series is faster than cross-sectional analysis",
                  "es": "Series temporales es más rápido que análisis transversal",
                  "de": "Zeitreihen sind schneller als Querschnittsanalyse",
                  "nl": "Tijdreeksen zijn sneller dan cross-sectionele analyse"
        },
        {
                  "en": "Cross-sectional uses more advanced algorithms",
                  "es": "Transversal usa algoritmos más avanzados",
                  "de": "Querschnitt verwendet fortgeschrittenere Algorithmen",
                  "nl": "Cross-sectioneel gebruikt geavanceerdere algoritmes"
        },
        {
                  "en": "Time series only works with numerical data",
                  "es": "Series temporales solo funciona con datos numéricos",
                  "de": "Zeitreihen funktionieren nur mit numerischen Daten",
                  "nl": "Tijdreeksen werken alleen met numerieke data"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Performance degradation in high-dimensional spaces due to sparse data and increased computational complexity",
                  "es": "Degradación del rendimiento en espacios de alta dimensión debido a datos dispersos y mayor complejidad computacional",
                  "de": "Leistungsverschlechterung in hochdimensionalen Räumen aufgrund spärlicher Daten und erhöhter rechnerischer Komplexität",
                  "nl": "Prestatievermindering in hoogdimensionale ruimtes door sparse data en verhoogde computationele complexiteit"
        },
        {
                  "en": "Inability to visualize data beyond three dimensions",
                  "es": "Incapacidad para visualizar datos más allá de tres dimensiones",
                  "de": "Unfähigkeit Daten jenseits von drei Dimensionen zu visualisieren",
                  "nl": "Onvermogen om data te visualiseren boven drie dimensies"
        },
        {
                  "en": "Linear increase in storage requirements",
                  "es": "Aumento lineal en requerimientos de almacenamiento",
                  "de": "Linearer Anstieg der Speicheranforderungen",
                  "nl": "Lineaire toename in opslagvereisten"
        },
        {
                  "en": "Limitation of algorithms to specific dimensions",
                  "es": "Limitación de algoritmos a dimensiones específicas",
                  "de": "Begrenzung von Algorithmen auf spezifische Dimensionen",
                  "nl": "Beperking van algoritmes tot specifieke dimensies"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "ICA finds statistically independent components while PCA finds orthogonal components with maximum variance",
                  "es": "ICA encuentra componentes estadísticamente independientes mientras PCA encuentra componentes ortogonales con máxima varianza",
                  "de": "ICA findet statistisch unabhängige Komponenten während PCA orthogonale Komponenten mit maximaler Varianz findet",
                  "nl": "ICA vindt statistisch onafhankelijke componenten terwijl PCA orthogonale componenten met maximale variantie vindt"
        },
        {
                  "en": "ICA works only with non-linear relationships",
                  "es": "ICA funciona solo con relaciones no lineales",
                  "de": "ICA funktioniert nur mit nichtlinearen Beziehungen",
                  "nl": "ICA werkt alleen met niet-lineaire relaties"
        },
        {
                  "en": "PCA requires labeled data while ICA doesn't",
                  "es": "PCA requiere datos etiquetados mientras ICA no",
                  "de": "PCA benötigt beschriftete Daten während ICA nicht",
                  "nl": "PCA vereist gelabelde data terwijl ICA dat niet doet"
        },
        {
                  "en": "ICA is faster than PCA for dimensionality reduction",
                  "es": "ICA es más rápido que PCA para reducción de dimensionalidad",
                  "de": "ICA ist schneller als PCA für Dimensionalitätsreduktion",
                  "nl": "ICA is sneller dan PCA voor dimensionaliteitsreductie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Selecting features with highest computational efficiency",
                  "es": "Seleccionar características con mayor eficiencia computacional",
                  "de": "Auswahl von Features mit höchster rechnerischer Effizienz",
                  "nl": "Selecteren van features met hoogste computationele efficiëntie"
        },
        {
                  "en": "Random selection of subset of available features",
                  "es": "Selección aleatoria de subconjunto de características disponibles",
                  "de": "Zufällige Auswahl einer Teilmenge verfügbarer Features",
                  "nl": "Willekeurige selectie van subset van beschikbare features"
        },
        {
                  "en": "Filter, wrapper, and embedded methods for selecting relevant features while removing irrelevant ones",
                  "es": "Métodos de filtro, envoltorio y embebidos para seleccionar características relevantes mientras se eliminan las irrelevantes",
                  "de": "Filter-, Wrapper- und eingebettete Methoden zur Auswahl relevanter Features während irrelevante entfernt werden",
                  "nl": "Filter, wrapper en embedded methoden voor het selecteren van relevante features terwijl irrelevante worden weggenomen"
        },
        {
                  "en": "Manual selection of features based on domain expertise",
                  "es": "Selección manual de características basada en experiencia del dominio",
                  "de": "Manuelle Auswahl von Features basierend auf Domänenexpertise",
                  "nl": "Handmatige selectie van features gebaseerd op domeinexpertise"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Non-linear dimensionality reduction excellent for visualization and preserving local neighborhood structure",
                  "es": "Reducción de dimensionalidad no lineal excelente para visualización y preservar estructura de vecindario local",
                  "de": "Nichtlineare Dimensionalitätsreduktion exzellent für Visualisierung und Erhaltung lokaler Nachbarschaftsstruktur",
                  "nl": "Niet-lineaire dimensionaliteitsreductie uitstekend voor visualisatie en behoud van lokale buurtstructuur"
        },
        {
                  "en": "Linear transformation for feature engineering",
                  "es": "Transformación lineal para ingeniería de características",
                  "de": "Lineare Transformation für Feature Engineering",
                  "nl": "Lineaire transformatie voor feature engineering"
        },
        {
                  "en": "Feature selection technique for high-dimensional data",
                  "es": "Técnica de selección de características para datos de alta dimensión",
                  "de": "Feature-Selektionstechnik für hochdimensionale Daten",
                  "nl": "Feature selectietechniek voor hoogdimensionale data"
        },
        {
                  "en": "Clustering algorithm for unsupervised learning",
                  "es": "Algoritmo de clustering para aprendizaje no supervisado",
                  "de": "Clustering-Algorithmus für unüberwachtes Lernen",
                  "nl": "Clustering algoritme voor ongesuperviseerd leren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Faster dimensionality reduction that better preserves global structure while maintaining local relationships",
                  "es": "Reducción de dimensionalidad más rápida que preserva mejor la estructura global mientras mantiene relaciones locales",
                  "de": "Schnellere Dimensionalitätsreduktion die globale Struktur besser erhält während lokale Beziehungen erhalten bleiben",
                  "nl": "Snellere dimensionaliteitsreductie die globale structuur beter behoudt terwijl lokale relaties behouden blijven"
        },
        {
                  "en": "Linear alternative to t-SNE for feature reduction",
                  "es": "Alternativa lineal a t-SNE para reducción de características",
                  "de": "Lineare Alternative zu t-SNE für Feature-Reduktion",
                  "nl": "Lineair alternatief voor t-SNE voor feature reductie"
        },
        {
                  "en": "Supervised version of t-SNE with labeled data",
                  "es": "Versión supervisada de t-SNE con datos etiquetados",
                  "de": "Überwachte Version von t-SNE mit beschrifteten Daten",
                  "nl": "Gesuperviseerde versie van t-SNE met gelabelde data"
        },
        {
                  "en": "Clustering algorithm that extends t-SNE capabilities",
                  "es": "Algoritmo de clustering que extiende capacidades de t-SNE",
                  "de": "Clustering-Algorithmus der t-SNE-Fähigkeiten erweitert",
                  "nl": "Clustering algoritme dat t-SNE mogelijkheden uitbreidt"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "PCA requires more assumptions about data distribution",
                  "es": "PCA requiere más suposiciones sobre distribución de datos",
                  "de": "PCA benötigt mehr Annahmen über Datenverteilung",
                  "nl": "PCA vereist meer aannames over dataverdeling"
        },
        {
                  "en": "Factor analysis is faster to compute than PCA",
                  "es": "Análisis factorial es más rápido de calcular que PCA",
                  "de": "Faktorenanalyse ist schneller zu berechnen als PCA",
                  "nl": "Factoranalyse is sneller te berekenen dan PCA"
        },
        {
                  "en": "Factor analysis works only with categorical variables",
                  "es": "Análisis factorial funciona solo con variables categóricas",
                  "de": "Faktorenanalyse funktioniert nur mit kategorialen Variablen",
                  "nl": "Factoranalyse werkt alleen met categorische variabelen"
        },
        {
                  "en": "Factor analysis assumes latent factors generate observed variables, PCA is purely mathematical transformation",
                  "es": "Análisis factorial asume factores latentes generan variables observadas, PCA es transformación puramente matemática",
                  "de": "Faktorenanalyse nimmt an latente Faktoren generieren beobachtete Variablen, PCA ist rein mathematische Transformation",
                  "nl": "Factoranalyse veronderstelt latente factoren genereren geobserveerde variabelen, PCA is puur wiskundige transformatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Algorithms for automatically generating new features",
                  "es": "Algoritmos para generar automáticamente nuevas características",
                  "de": "Algorithmen zur automatischen Generierung neuer Features",
                  "nl": "Algoritmes voor het automatisch genereren van nieuwe features"
        },
        {
                  "en": "Techniques for handling missing values in datasets",
                  "es": "Técnicas para manejar valores faltantes en conjuntos de datos",
                  "de": "Techniken zur Behandlung fehlender Werte in Datensätzen",
                  "nl": "Technieken voor het omgaan met missende waarden in datasets"
        },
        {
                  "en": "Metrics for measuring model prediction accuracy",
                  "es": "Métricas para medir precisión de predicción del modelo",
                  "de": "Metriken zur Messung der Modellvorhersagegenauigkeit",
                  "nl": "Metrieken voor het meten van modelvoorspellingsnauwkeurigheid"
        },
        {
                  "en": "Measures of statistical dependence between features and target variable for ranking feature relevance",
                  "es": "Medidas de dependencia estadística entre características y variable objetivo para clasificar relevancia de características",
                  "de": "Maße statistischer Abhängigkeit zwischen Features und Zielvariable zur Rangfolge der Feature-Relevanz",
                  "nl": "Maten van statistische afhankelijkheid tussen features en doelvariabele voor het rangschikken van feature relevantie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Univariate works with numerical data, multivariate with categorical",
                  "es": "Univariado funciona con datos numéricos, multivariado con categóricos",
                  "de": "Univariat funktioniert mit numerischen Daten, multivariat mit kategorialen",
                  "nl": "Univariaat werkt met numerieke data, multivariaat met categorische"
        },
        {
                  "en": "Univariate is faster but multivariate is more accurate",
                  "es": "Univariado es más rápido pero multivariado es más preciso",
                  "de": "Univariat ist schneller aber multivariat ist genauer",
                  "nl": "Univariaat is sneller maar multivariaat is nauwkeuriger"
        },
        {
                  "en": "Univariate evaluates features individually, multivariate considers feature interactions and dependencies",
                  "es": "Univariado evalúa características individualmente, multivariado considera interacciones y dependencias de características",
                  "de": "Univariat bewertet Features individuell, multivariat berücksichtigt Feature-Interaktionen und Abhängigkeiten",
                  "nl": "Univariaat evalueert features individueel, multivariaat overweegt feature interacties en afhankelijkheden"
        },
        {
                  "en": "Multivariate requires labeled data while univariate doesn't",
                  "es": "Multivariado requiere datos etiquetados mientras univariado no",
                  "de": "Multivariat benötigt beschriftete Daten während univariat nicht",
                  "nl": "Multivariaat vereist gelabelde data terwijl univariaat dat niet doet"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "LDA maximizes class separability while PCA maximizes variance, LDA is supervised while PCA is unsupervised",
                  "es": "LDA maximiza separabilidad de clases mientras PCA maximiza varianza, LDA es supervisado mientras PCA es no supervisado",
                  "de": "LDA maximiert Klassentrennung während PCA Varianz maximiert, LDA ist überwacht während PCA unüberwacht ist",
                  "nl": "LDA maximaliseert klassenscheiding terwijl PCA variantie maximaliseert, LDA is gesuperviseerd terwijl PCA ongesuperviseerd is"
        },
        {
                  "en": "LDA works only with categorical features",
                  "es": "LDA funciona solo con características categóricas",
                  "de": "LDA funktioniert nur mit kategorialen Features",
                  "nl": "LDA werkt alleen met categorische features"
        },
        {
                  "en": "PCA requires more computational resources than LDA",
                  "es": "PCA requiere más recursos computacionales que LDA",
                  "de": "PCA benötigt mehr Rechenressourcen als LDA",
                  "nl": "PCA vereist meer computationele middelen dan LDA"
        },
        {
                  "en": "LDA can only reduce to two dimensions",
                  "es": "LDA solo puede reducir a dos dimensiones",
                  "de": "LDA kann nur auf zwei Dimensionen reduzieren",
                  "nl": "LDA kan alleen reduceren tot twee dimensies"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Technique for finding optimal number of components by plotting explained variance and identifying the elbow point",
                  "es": "Técnica para encontrar número óptimo de componentes graficando varianza explicada e identificando punto de codo",
                  "de": "Technik zur Findung optimaler Komponentenanzahl durch Plotten erklärter Varianz und Identifikation des Ellbogenpunkts",
                  "nl": "Techniek voor het vinden van optimaal aantal componenten door verklaarde variantie te plotten en het elbow punt te identificeren"
        },
        {
                  "en": "Algorithm for non-linear feature transformation",
                  "es": "Algoritmo para transformación no lineal de características",
                  "de": "Algorithmus für nichtlineare Feature-Transformation",
                  "nl": "Algoritme voor niet-lineaire feature transformatie"
        },
        {
                  "en": "Technique for measuring feature correlation strength",
                  "es": "Técnica para medir fuerza de correlación de características",
                  "de": "Technik zur Messung der Feature-Korrelationsstärke",
                  "nl": "Techniek voor het meten van feature correlatiesterkte"
        },
        {
                  "en": "Method for detecting outliers in high-dimensional data",
                  "es": "Método para detectar valores atípicos en datos de alta dimensión",
                  "de": "Methode zur Erkennung von Ausreißern in hochdimensionalen Daten",
                  "nl": "Methode voor het detecteren van uitbijters in hoogdimensionale data"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Recursively applies PCA to reduce feature dimensions",
                  "es": "Aplica recursivamente PCA para reducir dimensiones de características",
                  "de": "Wendet rekursiv PCA an um Feature-Dimensionen zu reduzieren",
                  "nl": "Past recursief PCA toe om feature dimensies te verminderen"
        },
        {
                  "en": "Iteratively trains model, ranks features by importance, removes least important, until optimal subset found",
                  "es": "Iterativamente entrena modelo, clasifica características por importancia, elimina menos importantes, hasta encontrar subconjunto óptimo",
                  "de": "Trainiert iterativ Modell, ordnet Features nach Wichtigkeit, entfernt unwichtigste, bis optimale Teilmenge gefunden",
                  "nl": "Traint iteratief model, rankt features naar belangrijkheid, verwijdert minst belangrijke, tot optimale subset gevonden"
        },
        {
                  "en": "Eliminates features based on statistical significance tests",
                  "es": "Elimina características basado en pruebas de significancia estadística",
                  "de": "Eliminiert Features basierend auf statistischen Signifikanztests",
                  "nl": "Elimineert features gebaseerd op statistische significantietests"
        },
        {
                  "en": "Removes features with high correlation sequentially",
                  "es": "Elimina características con alta correlación secuencialmente",
                  "de": "Entfernt Features mit hoher Korrelation sequenziell",
                  "nl": "Verwijdert features met hoge correlatie sequentieel"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sets threshold for acceptable prediction variance",
                  "es": "Establece umbral para varianza de predicción aceptable",
                  "de": "Setzt Schwellwert für akzeptable Vorhersagevarianz",
                  "nl": "Stelt drempel in voor acceptabele voorspellingsvariantie"
        },
        {
                  "en": "Removes features with low variance as they provide little information for distinguishing samples",
                  "es": "Elimina características con baja varianza ya que proporcionan poca información para distinguir muestras",
                  "de": "Entfernt Features mit niedriger Varianz da sie wenig Information zur Unterscheidung von Stichproben bieten",
                  "nl": "Verwijdert features met lage variantie omdat ze weinig informatie bieden voor het onderscheiden van samples"
        },
        {
                  "en": "Measures threshold for feature correlation strength",
                  "es": "Mide umbral para fuerza de correlación de características",
                  "de": "Misst Schwellwert für Feature-Korrelationsstärke",
                  "nl": "Meet drempel voor feature correlatiesterkte"
        },
        {
                  "en": "Controls variance in cross-validation results",
                  "es": "Controla varianza en resultados de validación cruzada",
                  "de": "Kontrolliert Varianz in Kreuzvalidierungsergebnissen",
                  "nl": "Controleert variantie in cross-validatie resultaten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Non-linear dimensionality reduction using kernel trick to capture complex patterns that linear PCA cannot",
                  "es": "Reducción de dimensionalidad no lineal usando truco del kernel para capturar patrones complejos que PCA lineal no puede",
                  "de": "Nichtlineare Dimensionalitätsreduktion mit Kernel-Trick um komplexe Muster zu erfassen die lineares PCA nicht kann",
                  "nl": "Niet-lineaire dimensionaliteitsreductie met kernel trick om complexe patronen vast te leggen die lineaire PCA niet kan"
        },
        {
                  "en": "Faster computation than standard PCA",
                  "es": "Computación más rápida que PCA estándar",
                  "de": "Schnellere Berechnung als Standard-PCA",
                  "nl": "Snellere berekening dan standaard PCA"
        },
        {
                  "en": "Automatically determines optimal number of components",
                  "es": "Determina automáticamente número óptimo de componentes",
                  "de": "Bestimmt automatisch optimale Anzahl von Komponenten",
                  "nl": "Bepaalt automatisch optimaal aantal componenten"
        },
        {
                  "en": "Works only with categorical features",
                  "es": "Funciona solo con características categóricas",
                  "de": "Funktioniert nur mit kategorialen Features",
                  "nl": "Werkt alleen met categorische features"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Backward works only with linear models",
                  "es": "Hacia atrás funciona solo con modelos lineales",
                  "de": "Rückwärts funktioniert nur mit linearen Modellen",
                  "nl": "Backward werkt alleen met lineaire modellen"
        },
        {
                  "en": "Forward starts empty and adds features, backward starts full and removes features, both guided by model performance",
                  "es": "Hacia adelante comienza vacío y agrega características, hacia atrás comienza completo y elimina, ambos guiados por rendimiento",
                  "de": "Vorwärts beginnt leer und fügt Features hinzu, rückwärts beginnt voll und entfernt Features, beide geleitet von Modellleistung",
                  "nl": "Forward begint leeg en voegt features toe, backward begint vol en verwijdert features, beide geleid door modelprestaties"
        },
        {
                  "en": "Forward is faster than backward elimination",
                  "es": "Hacia adelante es más rápido que eliminación hacia atrás",
                  "de": "Vorwärts ist schneller als Rückwärtselimination",
                  "nl": "Forward is sneller dan backward elimination"
        },
        {
                  "en": "Forward selection requires labeled data",
                  "es": "Selección hacia adelante requiere datos etiquetados",
                  "de": "Vorwärtsselektion benötigt beschriftete Daten",
                  "nl": "Forward selection vereist gelabelde data"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Normalization is only for categorical features",
                  "es": "Normalización es solo para características categóricas",
                  "de": "Normalisierung ist nur für kategoriale Features",
                  "nl": "Normalisatie is alleen voor categorische features"
        },
        {
                  "en": "Standardization uses mean/std, normalization scales to [0,1], robust scaling uses median/IQR for outlier resistance",
                  "es": "Estandarización usa media/desv_est, normalización escala a [0,1], escalado robusto usa mediana/RIC para resistencia a valores atípicos",
                  "de": "Standardisierung verwendet Mittelwert/Stdabw, Normalisierung skaliert auf [0,1], robuste Skalierung verwendet Median/IQR für Ausreißerresistenz",
                  "nl": "Standaardisatie gebruikt gemiddelde/std, normalisatie schaalt naar [0,1], robuuste schaling gebruikt mediaan/IQR voor uitbijterresistentie"
        },
        {
                  "en": "All three methods produce identical results",
                  "es": "Los tres métodos producen resultados idénticos",
                  "de": "Alle drei Methoden produzieren identische Ergebnisse",
                  "nl": "Alle drie methoden produceren identieke resultaten"
        },
        {
                  "en": "Robust scaling requires the most computational resources",
                  "es": "Escalado robusto requiere más recursos computacionales",
                  "de": "Robuste Skalierung benötigt die meisten Rechenressourcen",
                  "nl": "Robuuste schaling vereist de meeste computationele middelen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Automatic feature encoder for categorical variables",
                  "es": "Codificador automático de características para variables categóricas",
                  "de": "Automatischer Feature-Encoder für kategoriale Variablen",
                  "nl": "Automatische feature encoder voor categorische variabelen"
        },
        {
                  "en": "Self-learning algorithm that encodes data patterns",
                  "es": "Algoritmo auto-aprendiz que codifica patrones de datos",
                  "de": "Selbstlernender Algorithmus der Datenmuster kodiert",
                  "nl": "Zelf-lerend algoritme dat datapatronen codeert"
        },
        {
                  "en": "Linear transformation technique like PCA",
                  "es": "Técnica de transformación lineal como PCA",
                  "de": "Lineare Transformationstechnik wie PCA",
                  "nl": "Lineaire transformatietechniek zoals PCA"
        },
        {
                  "en": "Neural network that learns compressed representation by encoding input to lower dimension then reconstructing it",
                  "es": "Red neuronal que aprende representación comprimida codificando entrada a menor dimensión luego reconstruyéndola",
                  "de": "Neuronales Netzwerk das komprimierte Repräsentation lernt durch Kodierung der Eingabe zu niedrigerer Dimension dann Rekonstruktion",
                  "nl": "Neuraal netwerk dat gecomprimeerde representatie leert door input te coderen naar lagere dimensie en dan te reconstrueren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Splitting error into training and testing components",
                  "es": "Dividir error en componentes de entrenamiento y prueba",
                  "de": "Aufteilung des Fehlers in Training- und Testkomponenten",
                  "nl": "Splitsen van fout in trainings- en testcomponenten"
        },
        {
                  "en": "Measuring bias and variance separately in datasets",
                  "es": "Medir sesgo y varianza separadamente en conjuntos de datos",
                  "de": "Bias und Varianz separat in Datensätzen messen",
                  "nl": "Bias en variantie afzonderlijk meten in datasets"
        },
        {
                  "en": "Decomposing model into biased and variant parts",
                  "es": "Descomponer modelo en partes sesgadas y variantes",
                  "de": "Modell in voreingenommene und variante Teile zerlegen",
                  "nl": "Model ontleden in bevooroordeelde en variante delen"
        },
        {
                  "en": "Error = Bias² + Variance + Irreducible Error, showing tradeoff between model simplicity and flexibility",
                  "es": "Error = Sesgo² + Varianza + Error Irreducible, mostrando tradeoff entre simplicidad y flexibilidad del modelo",
                  "de": "Fehler = Bias² + Varianz + Irreduzibler Fehler, zeigt Tradeoff zwischen Modellsimplizität und Flexibilität",
                  "nl": "Fout = Bias² + Variantie + Onvermijdbare Fout, toont tradeoff tussen modelsimpliciteit en flexibiliteit"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Parametric uses parameters, non-parametric doesn't use any parameters",
                  "es": "Paramétrico usa parámetros, no paramétrico no usa parámetros",
                  "de": "Parametrisch verwendet Parameter, nicht-parametrisch verwendet keine Parameter",
                  "nl": "Parametrisch gebruikt parameters, niet-parametrisch gebruikt geen parameters"
        },
        {
                  "en": "Non-parametric models are always more accurate",
                  "es": "Modelos no paramétricos siempre son más precisos",
                  "de": "Nicht-parametrische Modelle sind immer genauer",
                  "nl": "Niet-parametrische modellen zijn altijd nauwkeuriger"
        },
        {
                  "en": "Parametric models require more data to train",
                  "es": "Modelos paramétricos requieren más datos para entrenar",
                  "de": "Parametrische Modelle benötigen mehr Daten zum Trainieren",
                  "nl": "Parametrische modellen vereisen meer data om te trainen"
        },
        {
                  "en": "Parametric assumes fixed parameter count, non-parametric parameters grow with data size",
                  "es": "Paramétrico asume conteo de parámetros fijo, no paramétrico parámetros crecen con tamaño de datos",
                  "de": "Parametrisch nimmt feste Parameteranzahl an, nicht-parametrisch Parameter wachsen mit Datengröße",
                  "nl": "Parametrisch veronderstelt vast aantal parameters, niet-parametrisch parameters groeien met datagrootte"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Different feature scales causing computation issues",
                  "es": "Diferentes escalas de características causando problemas de computación",
                  "de": "Verschiedene Feature-Skalen verursachen Berechnungsprobleme",
                  "nl": "Verschillende feature schalen veroorzaken berekeningsproblemen"
        },
        {
                  "en": "Presence of outliers in the dataset",
                  "es": "Presencia de valores atípicos en el conjunto de datos",
                  "de": "Vorhandensein von Ausreißern im Datensatz",
                  "nl": "Aanwezigheid van uitbijters in de dataset"
        },
        {
                  "en": "Non-constant variance of errors across predictions, violates assumptions and affects inference",
                  "es": "Varianza no constante de errores a través de predicciones, viola suposiciones y afecta inferencia",
                  "de": "Nicht-konstante Varianz von Fehlern über Vorhersagen, verletzt Annahmen und beeinflusst Inferenz",
                  "nl": "Niet-constante variantie van fouten over voorspellingen, schendt aannames en beïnvloedt inferentie"
        },
        {
                  "en": "Correlation between predictor variables",
                  "es": "Correlación entre variables predictoras",
                  "de": "Korrelation zwischen Prädiktorvariablen",
                  "nl": "Correlatie tussen predictorvariabelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "High correlation between predictors causing unstable coefficient estimates and inflated standard errors",
                  "es": "Alta correlación entre predictores causando estimaciones de coeficientes inestables y errores estándar inflados",
                  "de": "Hohe Korrelation zwischen Prädiktoren verursacht instabile Koeffizientenschätzungen und aufgeblasene Standardfehler",
                  "nl": "Hoge correlatie tussen predictors veroorzaakt instabiele coëfficiënt schattingen en opgeblazen standaardfouten"
        },
        {
                  "en": "Non-linear relationships between variables",
                  "es": "Relaciones no lineales entre variables",
                  "de": "Nichtlineare Beziehungen zwischen Variablen",
                  "nl": "Niet-lineaire relaties tussen variabelen"
        },
        {
                  "en": "Different scales of predictor variables",
                  "es": "Diferentes escalas de variables predictoras",
                  "de": "Verschiedene Skalen von Prädiktorvariablen",
                  "nl": "Verschillende schalen van predictorvariabelen"
        },
        {
                  "en": "Multiple output variables in regression",
                  "es": "Múltiples variables de salida en regresión",
                  "de": "Mehrere Ausgabevariablen in Regression",
                  "nl": "Meerdere output variabelen in regressie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cross-validation metric for model selection",
                  "es": "Métrica de validación cruzada para selección de modelo",
                  "de": "Kreuzvalidierungsmetrik für Modellauswahl",
                  "nl": "Cross-validatie metriek voor modelselectie"
        },
        {
                  "en": "Logarithmic loss measuring probability distribution difference, better for classification than MSE",
                  "es": "Pérdida logarítmica midiendo diferencia de distribución de probabilidad, mejor para clasificación que MSE",
                  "de": "Logarithmischer Verlust misst Wahrscheinlichkeitsverteilungsunterschied, besser für Klassifikation als MSE",
                  "nl": "Logaritmisch verlies meet kansverdelingsverschil, beter voor classificatie dan MSE"
        },
        {
                  "en": "Loss function combining multiple entropy measures",
                  "es": "Función de pérdida combinando múltiples medidas de entropía",
                  "de": "Verlustfunktion kombiniert mehrere Entropie-Maße",
                  "nl": "Verliesfunctie combineert meerdere entropie metingen"
        },
        {
                  "en": "Error measurement across different datasets",
                  "es": "Medición de error a través de diferentes conjuntos de datos",
                  "de": "Fehlermessung über verschiedene Datensätze",
                  "nl": "Foutmeting over verschillende datasets"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "L2 always performs better than L1",
                  "es": "L2 siempre funciona mejor que L1",
                  "de": "L2 funktioniert immer besser als L1",
                  "nl": "L2 presteert altijd beter dan L1"
        },
        {
                  "en": "L1 produces faster convergence than L2",
                  "es": "L1 produce convergencia más rápida que L2",
                  "de": "L1 erzeugt schnellere Konvergenz als L2",
                  "nl": "L1 produceert snellere convergentie dan L2"
        },
        {
                  "en": "L1 constraint is diamond-shaped promoting sparsity, L2 is circular promoting small weights",
                  "es": "Restricción L1 es en forma de diamante promoviendo dispersión, L2 es circular promoviendo pesos pequeños",
                  "de": "L1-Beschränkung ist rautenförmig fördert Sparsität, L2 ist kreisförmig fördert kleine Gewichte",
                  "nl": "L1 beperking is ruitvormig bevordert sparsity, L2 is cirkelvormig bevordert kleine gewichten"
        },
        {
                  "en": "L1 works only with linear models",
                  "es": "L1 funciona solo con modelos lineales",
                  "de": "L1 funktioniert nur mit linearen Modellen",
                  "nl": "L1 werkt alleen met lineaire modellen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Resampling with replacement to estimate sampling distributions and uncertainty",
                  "es": "Remuestreo con reemplazo para estimar distribuciones de muestreo e incertidumbre",
                  "de": "Resampling mit Ersetzung um Stichprobenverteilungen und Unsicherheit zu schätzen",
                  "nl": "Hersampling met vervanging om steekproefverdelingen en onzekerheid te schatten"
        },
        {
                  "en": "Method for starting neural networks from scratch",
                  "es": "Método para iniciar redes neuronales desde cero",
                  "de": "Methode zum Starten neuronaler Netzwerke von Grund auf",
                  "nl": "Methode voor het starten van neurale netwerken vanaf nul"
        },
        {
                  "en": "Technique for cleaning and preprocessing data",
                  "es": "Técnica para limpiar y preprocesar datos",
                  "de": "Technik zum Reinigen und Vorverarbeiten von Daten",
                  "nl": "Techniek voor het schonen en voorverwerken van data"
        },
        {
                  "en": "Initial data loading process for model training",
                  "es": "Proceso inicial de carga de datos para entrenamiento de modelo",
                  "de": "Initialer Datenladeprozess für Modelltraining",
                  "nl": "Initieel data laadproces voor modeltraining"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Group similar samples together for efficient training",
                  "es": "Agrupar muestras similares juntas para entrenamiento eficiente",
                  "de": "Ähnliche Stichproben für effizientes Training gruppieren",
                  "nl": "Vergelijkbare samples groeperen voor efficiënte training"
        },
        {
                  "en": "Reduce computational cost by sampling fewer examples",
                  "es": "Reducir costo computacional muestreando menos ejemplos",
                  "de": "Rechenkosten durch Sampling weniger Beispiele reduzieren",
                  "nl": "Computationele kosten reduceren door minder voorbeelden te samplen"
        },
        {
                  "en": "Maintain class proportions when splitting data to ensure representative train/test sets",
                  "es": "Mantener proporciones de clase al dividir datos para asegurar conjuntos de entrenamiento/prueba representativos",
                  "de": "Klassenverhältnisse beim Aufteilen von Daten beibehalten um repräsentative Train/Test-Sets sicherzustellen",
                  "nl": "Klasseverhoudingen behouden bij splitsen van data om representatieve train/test sets te verzekeren"
        },
        {
                  "en": "Sample data from different layers of hierarchy",
                  "es": "Muestrear datos de diferentes capas de jerarquía",
                  "de": "Daten aus verschiedenen Hierarchieebenen sampeln",
                  "nl": "Data samplen van verschillende hiërarchie lagen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Causation is easier to prove than correlation",
                  "es": "Causación es más fácil de probar que correlación",
                  "de": "Kausalität ist einfacher zu beweisen als Korrelation",
                  "nl": "Causatie is makkelijker te bewijzen dan correlatie"
        },
        {
                  "en": "They are the same concept in machine learning",
                  "es": "Son el mismo concepto en machine learning",
                  "de": "Sie sind dasselbe Konzept im maschinellen Lernen",
                  "nl": "Het zijn hetzelfde concept in machine learning"
        },
        {
                  "en": "Correlation shows variables move together, causation shows one variable directly affects another",
                  "es": "Correlación muestra que variables se mueven juntas, causación muestra que una variable afecta directamente a otra",
                  "de": "Korrelation zeigt dass Variablen sich zusammen bewegen, Kausalität zeigt dass eine Variable eine andere direkt beeinflusst",
                  "nl": "Correlatie toont dat variabelen samen bewegen, causatie toont dat één variabele een andere direct beïnvloedt"
        },
        {
                  "en": "Correlation is stronger than causation",
                  "es": "Correlación es más fuerte que causación",
                  "de": "Korrelation ist stärker als Kausalität",
                  "nl": "Correlatie is sterker dan causatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Standardizing feature scales for training",
                  "es": "Estandarizar escalas de características para entrenamiento",
                  "de": "Feature-Skalen für Training standardisieren",
                  "nl": "Feature schalen standaardiseren voor training"
        },
        {
                  "en": "Creating new features from raw data to improve model performance through domain knowledge",
                  "es": "Crear nuevas características de datos crudos para mejorar rendimiento del modelo mediante conocimiento del dominio",
                  "de": "Neue Features aus Rohdaten erstellen um Modellleistung durch Domänenwissen zu verbessern",
                  "nl": "Nieuwe features creëren van ruwe data om modelprestaties te verbeteren door domeinkennis"
        },
        {
                  "en": "Automatically selecting best features from dataset",
                  "es": "Seleccionar automáticamente mejores características del conjunto de datos",
                  "de": "Automatisch beste Features aus Datensatz auswählen",
                  "nl": "Automatisch beste features selecteren uit dataset"
        },
        {
                  "en": "Engineering hardware for feature extraction",
                  "es": "Ingeniar hardware para extracción de características",
                  "de": "Hardware für Feature-Extraktion entwickeln",
                  "nl": "Hardware engineeren voor feature extractie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Convert categorical features to numerical",
                  "es": "Convertir características categóricas a numéricas",
                  "de": "Kategoriale Features in numerische umwandeln",
                  "nl": "Categorische features converteren naar numeriek"
        },
        {
                  "en": "Normalize features to standard scale",
                  "es": "Normalizar características a escala estándar",
                  "de": "Features auf Standardskala normalisieren",
                  "nl": "Features normaliseren naar standaardschaal"
        },
        {
                  "en": "Increase computational speed of algorithms",
                  "es": "Aumentar velocidad computacional de algoritmos",
                  "de": "Rechengeschwindigkeit von Algorithmen erhöhen",
                  "nl": "Computationele snelheid van algoritmes verhogen"
        },
        {
                  "en": "Handle skewed distributions and reduce impact of outliers by compressing large values",
                  "es": "Manejar distribuciones sesgadas y reducir impacto de valores atípicos comprimiendo valores grandes",
                  "de": "Schiefe Verteilungen behandeln und Auswirkung von Ausreißern reduzieren durch Kompression großer Werte",
                  "nl": "Scheefverdelingen behandelen en impact van uitbijters reduceren door grote waarden te comprimeren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "MCAR missingness unrelated to any data, MAR missingness related to observed but not missing data",
                  "es": "Ausencia MCAR no relacionada con ningún dato, ausencia MAR relacionada con datos observados pero no datos faltantes",
                  "de": "MCAR-Fehlwerte nicht mit Daten verbunden, MAR-Fehlwerte mit beobachteten aber nicht fehlenden Daten verbunden",
                  "nl": "MCAR missingness ongerelateerd aan data, MAR missingness gerelateerd aan geobserveerde maar niet missende data"
        },
        {
                  "en": "MAR is more common than MCAR in practice",
                  "es": "MAR es más común que MCAR en práctica",
                  "de": "MAR ist in der Praxis häufiger als MCAR",
                  "nl": "MAR is gebruikelijker dan MCAR in praktijk"
        },
        {
                  "en": "They are the same type of missingness",
                  "es": "Son el mismo tipo de ausencia",
                  "de": "Sie sind derselbe Typ von Fehlwerten",
                  "nl": "Het zijn hetzelfde type missingness"
        },
        {
                  "en": "MCAR requires imputation while MAR doesn't",
                  "es": "MCAR requiere imputación mientras MAR no",
                  "de": "MCAR benötigt Imputation während MAR nicht",
                  "nl": "MCAR vereist imputatie terwijl MAR dat niet doet"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ignore missing values during training",
                  "es": "Ignorar valores faltantes durante entrenamiento",
                  "de": "Fehlende Werte während Training ignorieren",
                  "nl": "Missende waarden negeren tijdens training"
        },
        {
                  "en": "Replace all missing values with zeros",
                  "es": "Reemplazar todos valores faltantes con ceros",
                  "de": "Alle fehlenden Werte durch Nullen ersetzen",
                  "nl": "Alle missende waarden vervangen met nullen"
        },
        {
                  "en": "Mean/median/mode imputation, KNN imputation, MICE (multiple imputation), or model-based imputation",
                  "es": "Imputación media/mediana/moda, imputación KNN, MICE (imputación múltiple), o imputación basada en modelo",
                  "de": "Mittelwert/Median/Modus-Imputation, KNN-Imputation, MICE (multiple Imputation), oder modellbasierte Imputation",
                  "nl": "Gemiddelde/mediaan/modus imputatie, KNN imputatie, MICE (multiple imputation), of model-gebaseerde imputatie"
        },
        {
                  "en": "Always delete rows with missing values",
                  "es": "Siempre eliminar filas con valores faltantes",
                  "de": "Zeilen mit fehlenden Werten immer löschen",
                  "nl": "Altijd rijen met missende waarden verwijderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only use for numerical features",
                  "es": "Solo usar para características numéricas",
                  "de": "Nur für numerische Features verwenden",
                  "nl": "Alleen gebruiken voor numerieke features"
        },
        {
                  "en": "Reduces dimensionality of categorical features",
                  "es": "Reduce dimensionalidad de características categóricas",
                  "de": "Reduziert Dimensionalität kategorialer Features",
                  "nl": "Vermindert dimensionaliteit van categorische features"
        },
        {
                  "en": "Assigns sequential numbers to categories",
                  "es": "Asigna números secuenciales a categorías",
                  "de": "Weist Kategorien sequenzielle Nummern zu",
                  "nl": "Wijst sequentiële nummers toe aan categorieën"
        },
        {
                  "en": "Creates binary columns for each category value, use for nominal categorical features without ordinal relationship",
                  "es": "Crea columnas binarias para cada valor de categoría, usar para características categóricas nominales sin relación ordinal",
                  "de": "Erstellt binäre Spalten für jeden Kategoriewert, verwenden für nominale kategoriale Features ohne ordinale Beziehung",
                  "nl": "Creëert binaire kolommen voor elke categoriewaarde, gebruik voor nominale categorische features zonder ordinale relatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Encoding scheme that targets specific features",
                  "es": "Esquema de codificación que apunta a características específicas",
                  "de": "Kodierungsschema das spezifische Features anvisiert",
                  "nl": "Coderingsschema dat specifieke features richt"
        },
        {
                  "en": "Always better than one-hot encoding",
                  "es": "Siempre mejor que codificación one-hot",
                  "de": "Immer besser als One-Hot-Encoding",
                  "nl": "Altijd beter dan one-hot encoding"
        },
        {
                  "en": "Used only for binary classification",
                  "es": "Usado solo para clasificación binaria",
                  "de": "Nur für binäre Klassifikation verwendet",
                  "nl": "Alleen gebruikt voor binaire classificatie"
        },
        {
                  "en": "Replace categories with target variable statistics, risks data leakage and overfitting if not done carefully",
                  "es": "Reemplazar categorías con estadísticas de variable objetivo, riesgos de filtración de datos y overfitting si no se hace cuidadosamente",
                  "de": "Kategorien durch Zielvariablen-Statistiken ersetzen, Risiken von Datenleckage und Overfitting wenn nicht sorgfältig durchgeführt",
                  "nl": "Vervang categorieën met doelvariabele statistieken, risico's van data leakage en overfitting als niet zorgvuldig gedaan"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Convert categorical to numerical features",
                  "es": "Convertir características categóricas a numéricas",
                  "de": "Kategoriale in numerische Features umwandeln",
                  "nl": "Categorische naar numerieke features converteren"
        },
        {
                  "en": "Reduce number of features in the model",
                  "es": "Reducir número de características en el modelo",
                  "de": "Anzahl der Features im Modell reduzieren",
                  "nl": "Aantal features in het model reduceren"
        },
        {
                  "en": "Speed up linear regression training",
                  "es": "Acelerar entrenamiento de regresión lineal",
                  "de": "Linear Regression Training beschleunigen",
                  "nl": "Lineaire regressie training versnellen"
        },
        {
                  "en": "Capture non-linear relationships by creating interaction and higher-degree terms from existing features",
                  "es": "Capturar relaciones no lineales creando términos de interacción y de mayor grado de características existentes",
                  "de": "Nichtlineare Beziehungen erfassen durch Erstellen von Interaktions- und höhergradigen Termen aus existierenden Features",
                  "nl": "Niet-lineaire relaties vastleggen door interactie en hogere-graad termen te creëren van bestaande features"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Batch requires less memory than mini-batch",
                  "es": "Lotes requiere menos memoria que mini-lotes",
                  "de": "Batch benötigt weniger Speicher als Mini-Batch",
                  "nl": "Batch vereist minder geheugen dan mini-batch"
        },
        {
                  "en": "Stochastic is always faster than batch",
                  "es": "Estocástico siempre es más rápido que lotes",
                  "de": "Stochastisch ist immer schneller als Batch",
                  "nl": "Stochastisch is altijd sneller dan batch"
        },
        {
                  "en": "Batch uses all data per update, mini-batch uses subset, stochastic uses one sample",
                  "es": "Lotes usa todos datos por actualización, mini-lotes usa subconjunto, estocástico usa una muestra",
                  "de": "Batch verwendet alle Daten pro Update, Mini-Batch verwendet Teilmenge, stochastisch verwendet eine Stichprobe",
                  "nl": "Batch gebruikt alle data per update, mini-batch gebruikt subset, stochastisch gebruikt één sample"
        },
        {
                  "en": "Mini-batch always produces best results",
                  "es": "Mini-lotes siempre produce mejores resultados",
                  "de": "Mini-Batch produziert immer beste Ergebnisse",
                  "nl": "Mini-batch produceert altijd beste resultaten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Matrix for storing model parameters",
                  "es": "Matriz para almacenar parámetros del modelo",
                  "de": "Matrix zur Speicherung von Modellparametern",
                  "nl": "Matrix voor opslaan van modelparameters"
        },
        {
                  "en": "Second-order partial derivatives describing curvature of loss surface for faster convergence",
                  "es": "Derivadas parciales de segundo orden describiendo curvatura de superficie de pérdida para convergencia más rápida",
                  "de": "Partielle Ableitungen zweiter Ordnung beschreiben Krümmung der Verlustoberfläche für schnellere Konvergenz",
                  "nl": "Tweede-orde partiële afgeleiden beschrijven kromming van verliesoppervlak voor snellere convergentie"
        },
        {
                  "en": "Technique for regularizing neural networks",
                  "es": "Técnica para regularizar redes neuronales",
                  "de": "Technik zur Regularisierung neuronaler Netzwerke",
                  "nl": "Techniek voor regulariseren van neurale netwerken"
        },
        {
                  "en": "Method for computing gradients faster",
                  "es": "Método para computar gradientes más rápido",
                  "de": "Methode zur schnelleren Gradientenberechnung",
                  "nl": "Methode voor sneller gradiënten berekenen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "L-BFGS requires more memory than gradient descent",
                  "es": "L-BFGS requiere más memoria que descenso de gradiente",
                  "de": "L-BFGS benötigt mehr Speicher als Gradientenabstieg",
                  "nl": "L-BFGS vereist meer geheugen dan gradient descent"
        },
        {
                  "en": "Gradient descent always converges faster than L-BFGS",
                  "es": "Descenso de gradiente siempre converge más rápido que L-BFGS",
                  "de": "Gradientenabstieg konvergiert immer schneller als L-BFGS",
                  "nl": "Gradient descent convergeert altijd sneller dan L-BFGS"
        },
        {
                  "en": "L-BFGS is a type of stochastic gradient descent",
                  "es": "L-BFGS es un tipo de descenso de gradiente estocástico",
                  "de": "L-BFGS ist eine Art stochastischer Gradientenabstieg",
                  "nl": "L-BFGS is een type stochastische gradient descent"
        },
        {
                  "en": "L-BFGS approximates second-order information for faster convergence, gradient descent uses only first-order",
                  "es": "L-BFGS aproxima información de segundo orden para convergencia más rápida, descenso de gradiente usa solo primer orden",
                  "de": "L-BFGS approximiert Informationen zweiter Ordnung für schnellere Konvergenz, Gradientenabstieg verwendet nur erster Ordnung",
                  "nl": "L-BFGS benadert tweede-orde informatie voor snellere convergentie, gradient descent gebruikt alleen eerste-orde"
        }
        ],
        correct: 3,
        explanation: {
