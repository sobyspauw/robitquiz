    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Learning algorithms that can quickly adapt to new tasks with minimal data by learning optimization strategies",
                  "es": "Algoritmos de aprendizaje que pueden adaptarse rápidamente a nuevas tareas con datos mínimos aprendiendo estrategias de optimización",
                  "de": "Lernalgorithmen die sich schnell an neue Aufgaben mit minimalen Daten anpassen können durch Lernen von Optimierungsstrategien",
                  "nl": "Leeralgoritmes die zich snel kunnen aanpassen aan nieuwe taken met minimale data door optimalisatiestrategieën te leren"
        },
        {
                  "en": "Learning to select the best machine learning model",
                  "es": "Aprender a seleccionar el mejor modelo de machine learning",
                  "de": "Lernen das beste maschinelle Lernmodell auszuwählen",
                  "nl": "Leren het beste machine learning model te selecteren"
        },
        {
                  "en": "Meta-analysis of different learning algorithms",
                  "es": "Meta-análisis de diferentes algoritmos de aprendizaje",
                  "de": "Meta-Analyse verschiedener Lernalgorithmen",
                  "nl": "Meta-analyse van verschillende leeralgoritmes"
        },
        {
                  "en": "Learning about the metadata of training datasets",
                  "es": "Aprender sobre los metadatos de conjuntos de datos de entrenamiento",
                  "de": "Lernen über Metadaten von Trainingsdatensätzen",
                  "nl": "Leren over metadata van trainingsdatasets"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pruning networks improves their generalization ability",
                  "es": "La poda de redes mejora su capacidad de generalización",
                  "de": "Pruning von Netzwerken verbessert ihre Generalisierungsfähigkeit",
                  "nl": "Het snoeien van netwerken verbetert hun generalisatievermogen"
        },
        {
                  "en": "Random weight initialization determines training success",
                  "es": "La inicialización aleatoria de pesos determina el éxito del entrenamiento",
                  "de": "Zufällige Gewichtsinitialisierung bestimmt Trainingserfolg",
                  "nl": "Willekeurige gewichtsinitialisatie bepaalt trainingsucces"
        },
        {
                  "en": "Dense networks contain sparse subnetworks that can achieve comparable performance when trained in isolation",
                  "es": "Las redes densas contienen subredes dispersas que pueden lograr rendimiento comparable cuando se entrenan en aislamiento",
                  "de": "Dichte Netzwerke enthalten spärliche Teilnetzwerke die vergleichbare Leistung erreichen können wenn isoliert trainiert",
                  "nl": "Dichte netwerken bevatten dunne subnetwerken die vergelijkbare prestaties kunnen bereiken wanneer getraind in isolatie"
        },
        {
                  "en": "Only a few neurons contribute to network performance",
                  "es": "Solo unas pocas neuronas contribuyen al rendimiento de la red",
                  "de": "Nur wenige Neuronen tragen zur Netzwerkleistung bei",
                  "nl": "Slechts een paar neuronen dragen bij aan netwerkprestaties"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Neural networks that search for patterns in data",
                  "es": "Redes neuronales que buscan patrones en datos",
                  "de": "Neuronale Netzwerke die nach Mustern in Daten suchen",
                  "nl": "Neurale netwerken die zoeken naar patronen in data"
        },
        {
                  "en": "Automated search algorithms that discover optimal neural architectures using reinforcement learning or evolutionary methods",
                  "es": "Algoritmos de búsqueda automatizada que descubren arquitecturas neuronales óptimas usando aprendizaje por refuerzo o métodos evolutivos",
                  "de": "Automatisierte Suchalgorithmen die optimale neuronale Architekturen durch Reinforcement Learning oder evolutionäre Methoden entdecken",
                  "nl": "Geautomatiseerde zoekalgoritmes die optimale neurale architecturen ontdekken met reinforcement learning of evolutionaire methoden"
        },
        {
                  "en": "Searching for optimal training algorithms",
                  "es": "Buscar algoritmos de entrenamiento óptimos",
                  "de": "Suche nach optimalen Trainingsalgorithmen",
                  "nl": "Zoeken naar optimale trainingsalgoritmes"
        },
        {
                  "en": "Searching for the best hyperparameters manually",
                  "es": "Buscar los mejores hiperparámetros manualmente",
                  "de": "Manuelle Suche nach den besten Hyperparametern",
                  "nl": "Handmatig zoeken naar de beste hyperparameters"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Verschiedene Privatsphäreneinstellungen für verschiedene Benutzer",
                  "nl": "Verschillende privacy-instellingen voor verschillende gebruikers"
        },
        {
                  "en": "Differential analysis of privacy breaches",
                  "es": "Análisis diferencial de violaciones de privacidad",
                  "de": "Differentielle Analyse von Privatsphärenverletzungen",
                  "nl": "Differentiële analyse van privacyschendingen"
        },
        {
                  "en": "Privacy that varies based on data sensitivity",
                  "es": "Privacidad que varía según la sensibilidad de los datos",
                  "de": "Privatsphäre die je nach Datensensitivität variiert",
                  "nl": "Privacy die varieert op basis van datagevoeligheid"
        },
        {
                  "en": "Mathematical framework that provides statistical guarantees about individual privacy in datasets by adding calibrated noise",
                  "es": "Marco matemático que proporciona garantías estadísticas sobre privacidad individual en conjuntos de datos agregando ruido calibrado",
                  "de": "Mathematisches Framework das statistische Garantien über individuelle Privatsphäre in Datensätzen durch Hinzufügen kalibriertem Rauschen bietet",
                  "nl": "Wiskundig raamwerk dat statistische garanties biedt over individuele privacy in datasets door gekalibreerde ruis toe te voegen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning that continues throughout the model's lifecycle",
                  "es": "Aprendizaje que continúa durante todo el ciclo de vida del modelo",
                  "de": "Lernen das während des gesamten Modelllebenszyklus fortsetzt",
                  "nl": "Leren dat doorgaat gedurende de levenscyclus van het model"
        },
        {
                  "en": "Learning new tasks sequentially without forgetting previous ones, using regularization, replay buffers, or dynamic architectures",
                  "es": "Aprender nuevas tareas secuencialmente sin olvidar las anteriores, usando regularización, buffers de repetición o arquitecturas dinámicas",
                  "de": "Neue Aufgaben sequenziell lernen ohne vorherige zu vergessen, verwendet Regularisierung, Replay-Puffer oder dynamische Architekturen",
        ...
        {
                  "en": "Continuous optimization of learning rates",
                  "es": "Optimización continua de tasas de aprendizaje",
                  "de": "Kontinuierliche Optimierung von Lernraten",
                  "nl": "Continue optimalisatie van leersnelheden"
        },
        {
                  "en": "Continuously training models without stopping",
                  "es": "Entrenar modelos continuamente sin parar",
                  "de": "Modelle kontinuierlich ohne Stoppen trainieren",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses knowledge learned from one task to improve performance on related tasks by fine-tuning pre-trained models",
                  "es": "Usa conocimiento aprendido de una tarea para mejorar rendimiento en tareas relacionadas ajustando finamente modelos preentrenados",
                  "de": "Verwendet Wissen aus einer Aufgabe um Leistung bei verwandten Aufgaben durch Feinabstimmung vortrainierter Modelle zu verbessern",
                  "nl": "Gebruikt kennis geleerd van één taak om prestaties op gerelateerde taken te verbeteren door fine-tuning van voorgetrainde modellen"
        },
        {
                  "en": "Transfers data between different machine learning algorithms",
                  "es": "Transfiere datos entre diferentes algoritmos de machine learning",
                  "de": "Überträgt Daten zwischen verschiedenen maschinellen Lernalgorithmen",
                  "nl": "Draagt data over tussen verschillende machine learning algoritmes"
        },
        {
                  "en": "Moves models from training to production environments",
                  "es": "Mueve modelos de entornos de entrenamiento a producción",
                  "de": "Bewegt Modelle von Training- zu Produktionsumgebungen",
                  "nl": "Verplaatst modellen van training naar productieomgevingen"
        },
        {
                  "en": "Learns to transfer knowledge between human experts",
                  "es": "Aprende a transferir conocimiento entre expertos humanos",
                  "de": "Lernt Wissen zwischen menschlichen Experten zu übertragen",
                  "nl": "Leert kennis over te dragen tussen menselijke experts"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses only a few shots or iterations during training",
                  "es": "Usa solo unos pocos disparos o iteraciones durante entrenamiento",
                  "de": "Verwendet nur wenige Schüsse oder Iterationen während des Trainings",
                  "nl": "Gebruikt slechts een paar shots of iteraties tijdens training"
        },
        {
                  "en": "Learns new tasks from very few examples by leveraging prior knowledge and meta-learning strategies",
                  "es": "Aprende nuevas tareas con muy pocos ejemplos aprovechando conocimiento previo y estrategias de meta-aprendizaje",
                  "de": "Lernt neue Aufgaben aus sehr wenigen Beispielen durch Nutzung von Vorwissen und Meta-Learning-Strategien",
                  "nl": "Leert nieuwe taken van zeer weinig voorbeelden door gebruik te maken van voorkennis en meta-learning strategieën"
        },
        {
                  "en": "Trains models with fewer computational resources",
                  "es": "Entrena modelos con menos recursos computacionales",
                  "de": "Trainiert Modelle mit weniger Rechenressourcen",
                  "nl": "Traint modellen met minder computationele middelen"
        },
        {
                  "en": "Focuses on learning from small datasets only",
                  "es": "Se enfoca en aprender solo de conjuntos de datos pequeños",
                  "de": "Konzentriert sich nur auf Lernen aus kleinen Datensätzen",
                  "nl": "Richt zich alleen op leren van kleine datasets"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The gradient computation becomes too slow",
                  "es": "El cálculo del gradiente se vuelve demasiado lento",
                  "de": "Die Gradientenberechnung wird zu langsam",
                  "nl": "De gradiëntberekening wordt te langzaam"
        },
        {
                  "en": "Gradients disappear completely after a few epochs",
                  "es": "Gradientes desaparecen completamente después de unas pocas épocas",
                  "de": "Gradienten verschwinden vollständig nach wenigen Epochen",
                  "nl": "Gradiënten verdwijnen volledig na een paar epochs"
        },
        {
                  "en": "Neural networks lose their gradient information during training",
                  "es": "Redes neuronales pierden su información de gradiente durante entrenamiento",
                  "de": "Neuronale Netzwerke verlieren ihre Gradienteninformation während des Trainings",
                  "nl": "Neurale netwerken verliezen hun gradiëntinformatie tijdens training"
        },
        {
                  "en": "Gradients become exponentially smaller in deeper layers, solved with residual connections, better activations, and normalization",
                  "es": "Gradientes se vuelven exponencialmente más pequeños en capas más profundas, resuelto con conexiones residuales, mejores activaciones y normalización",
                  "de": "Gradienten werden exponentiell kleiner in tieferen Schichten, gelöst mit residualen Verbindungen, besseren Aktivierungen und Normalisierung",
                  "nl": "Gradiënten worden exponentieel kleiner in diepere lagen, opgelost met residuele verbindingen, betere activaties en normalisatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Focuses computational resources on important neurons",
                  "es": "Enfoca recursos computacionales en neuronas importantes",
                  "de": "Fokussiert Rechenressourcen auf wichtige Neuronen",
                  "nl": "Richt computationele middelen op belangrijke neuronen"
        },
        {
                  "en": "Makes neural networks pay attention to training details",
                  "es": "Hace que redes neuronales presten atención a detalles de entrenamiento",
                  "de": "Bringt neuronale Netzwerke dazu auf Trainingsdetails zu achten",
                  "nl": "Zorgt ervoor dat neurale netwerken aandacht besteden aan trainingsdetails"
        },
        {
                  "en": "Automatically tunes hyperparameters during training",
                  "es": "Ajusta automáticamente hiperparámetros durante entrenamiento",
                  "de": "Stimmt automatisch Hyperparameter während des Trainings ab",
                  "nl": "Stemt automatisch hyperparameters af tijdens training"
        },
        {
                  "en": "Allows models to focus on relevant parts of input sequences dynamically, enabling better long-range dependencies",
                  "es": "Permite a modelos enfocarse en partes relevantes de secuencias de entrada dinámicamente, habilitando mejores dependencias de largo alcance",
                  "de": "Ermöglicht Modellen sich dynamisch auf relevante Teile von Eingabesequenzen zu fokussieren, ermöglicht bessere weitreichende Abhängigkeiten",
                  "nl": "Stelt modellen in staat om dynamisch te focussen op relevante delen van invoersequenties, maakt betere lange-afstand afhankelijkheden mogelijk"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learns only from positive examples and feedback",
                  "es": "Aprende solo de ejemplos positivos y retroalimentación",
                  "de": "Lernt nur aus positiven Beispielen und Feedback",
                  "nl": "Leert alleen van positieve voorbeelden en feedback"
        },
        {
                  "en": "Agent learns optimal actions through trial-and-error interactions with environment using rewards and penalties",
                  "es": "Agente aprende acciones óptimas a través de interacciones de ensayo y error con entorno usando recompensas y penalizaciones",
                  "de": "Agent lernt optimale Aktionen durch Trial-and-Error-Interaktionen mit Umgebung unter Verwendung von Belohnungen und Strafen",
                  "nl": "Agent leert optimale acties door trial-and-error interacties met omgeving met behulp van beloningen en straffen"
        },
        {
                  "en": "Uses reinforcement techniques to improve supervised learning",
                  "es": "Usa técnicas de refuerzo para mejorar aprendizaje supervisado",
                  "de": "Verwendet Verstärkungstechniken um überwachtes Lernen zu verbessern",
                  "nl": "Gebruikt versterkingstechnieken om gesuperviseerd leren te verbeteren"
        },
        {
                  "en": "Reinforces existing machine learning models with new data",
                  "es": "Refuerza modelos de machine learning existentes con nuevos datos",
                  "de": "Verstärkt bestehende maschinelle Lernmodelle mit neuen Daten",
                  "nl": "Versterkt bestaande machine learning modellen met nieuwe data"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Predicting future values using historical patterns while handling seasonality, trends, and non-stationarity",
                  "es": "Predecir valores futuros usando patrones históricos mientras se maneja estacionalidad, tendencias y no estacionariedad",
                  "de": "Zukünftige Werte unter Verwendung historischer Muster vorhersagen während Saisonalität, Trends und Nicht-Stationarität behandelt werden",
                  "nl": "Toekomstige waarden voorspellen met historische patronen terwijl seizoensgebondenheid, trends en niet-stationariteit worden behandeld"
        },
        {
                  "en": "Scheduling when to run time-sensitive models",
                  "es": "Programar cuándo ejecutar modelos sensibles al tiempo",
                  "de": "Planen wann zeitkritische Modelle ausgeführt werden",
                  "nl": "Plannen wanneer tijdgevoelige modellen uit te voeren"
        },
        {
                  "en": "Optimizing training time for large datasets",
                  "es": "Optimizar tiempo de entrenamiento para conjuntos de datos grandes",
                  "de": "Trainingszeit für große Datensätze optimieren",
                  "nl": "Trainingstijd optimaliseren voor grote datasets"
        },
        {
                  "en": "Analyzing time complexity of machine learning algorithms",
                  "es": "Analizar complejidad temporal de algoritmos de machine learning",
                  "de": "Zeitkomplexität von maschinellen Lernalgorithmen analysieren",
                  "nl": "Tijdcomplexiteit van machine learning algoritmes analyseren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Defensive networks against malicious attacks",
                  "es": "Redes defensivas contra ataques maliciosos",
                  "de": "Defensive Netzwerke gegen böswillige Angriffe",
                  "nl": "Defensieve netwerken tegen kwaadaardige aanvallen"
        },
        {
                  "en": "Networks that generate adversarial examples for testing",
                  "es": "Redes que generan ejemplos adversariales para pruebas",
                  "de": "Netzwerke die adversariale Beispiele für Tests generieren",
                  "nl": "Netwerken die adversariale voorbeelden genereren voor testen"
        },
        {
                  "en": "Two neural networks compete: generator creates fake data, discriminator detects fakes, improving both through adversarial training",
                  "es": "Dos redes neuronales compiten: generador crea datos falsos, discriminador detecta falsos, mejorando ambos por entrenamiento adversarial",
                  "de": "Zwei neuronale Netzwerke konkurrieren: Generator erstellt gefälschte Daten, Diskriminator erkennt Fälschungen, verbessert beide durch Training",
                  "nl": "Twee neurale netwerken concurreren: generator creëert nep data, discriminator detecteert nep, verbetert beide door adversarial training"
        },
        {
                  "en": "Networks trained on adversarial optimization techniques",
                  "es": "Redes entrenadas en técnicas de optimización adversarial",
                  "de": "Netzwerke trainiert auf adversarialen Optimierungstechniken",
                  "nl": "Netwerken getraind op adversariale optimalisatietechnieken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Long-term storage mechanism for trained models",
                  "es": "Mecanismo de almacenamiento a largo plazo para modelos entrenados",
                  "de": "Langzeitspeichermechanismus für trainierte Modelle",
                  "nl": "Lange-termijn opslagmechanisme voor getrainde modellen"
        },
        {
                  "en": "Short-term memory optimization technique",
                  "es": "Técnica de optimización de memoria a corto plazo",
                  "de": "Kurzzeitgedächtnis-Optimierungstechnik",
                  "nl": "Korte-termijn geheugen optimalisatietechniek"
        },
        {
                  "en": "Memory storage system for large datasets",
                  "es": "Sistema de almacenamiento de memoria para conjuntos de datos grandes",
                  "de": "Speichersystem für große Datensätze",
                  "nl": "Geheugenopslagsysteem voor grote datasets"
        },
        {
                  "en": "Recurrent network with gates to control information flow, solving vanishing gradients and capturing long-term dependencies",
                  "es": "Red recurrente con compuertas para controlar flujo de información, resolviendo gradientes que desaparecen y capturando dependencias a largo plazo",
                  "de": "Rekurrentes Netzwerk mit Gattern zur Kontrolle des Informationsflusses, löst verschwindende Gradienten und erfasst langfristige Abhängigkeiten",
                  "nl": "Recurrent netwerk met gates om informatieflow te controleren, lost vanishing gradients op en vangt lange-termijn afhankelijkheden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Online learning works only with neural networks",
                  "es": "Aprendizaje en línea funciona solo con redes neuronales",
                  "de": "Online Learning funktioniert nur mit neuronalen Netzwerken",
                  "nl": "Online learning werkt alleen met neurale netwerken"
        },
        {
                  "en": "Online learning requires internet connection, batch learning doesn't",
                  "es": "Aprendizaje en línea requiere conexión a internet, aprendizaje por lotes no",
                  "de": "Online Learning benötigt Internetverbindung, Batch Learning nicht",
                  "nl": "Online learning vereist internetverbinding, batch learning niet"
        },
        {
                  "en": "Online learning updates model incrementally with new data, batch learning trains on entire dataset at once",
                  "es": "Aprendizaje en línea actualiza modelo incrementalmente con nuevos datos, aprendizaje por lotes entrena en todo el conjunto de datos a la vez",
                  "de": "Online Learning aktualisiert Modell inkrementell mit neuen Daten, Batch Learning trainiert auf gesamtem Datensatz auf einmal",
                  "nl": "Online learning werkt model incrementeel bij met nieuwe data, batch learning traint op hele dataset tegelijk"
        },
        {
                  "en": "Batch learning is faster than online learning",
                  "es": "Aprendizaje por lotes es más rápido que aprendizaje en línea",
                  "de": "Batch Learning ist schneller als Online Learning",
                  "nl": "Batch learning is sneller dan online learning"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses gradient ascent instead of gradient descent",
                  "es": "Usa ascenso de gradiente en lugar de descenso de gradiente",
                  "de": "Verwendet Gradientenaufstieg anstatt Gradientenabstieg",
                  "nl": "Gebruikt gradient ascent in plaats van gradient descent"
        },
        {
                  "en": "Boosts gradient computation for faster training",
                  "es": "Impulsa computación de gradiente para entrenamiento más rápido",
                  "de": "Verstärkt Gradientenberechnung für schnelleres Training",
                  "nl": "Boost gradiëntberekening voor snellere training"
        },
        {
                  "en": "Applies boosting only to gradient-based algorithms",
                  "es": "Aplica boosting solo a algoritmos basados en gradiente",
                  "de": "Wendet Boosting nur auf gradientenbasierte Algorithmen an",
                  "nl": "Past boosting alleen toe op gradiënt-gebaseerde algoritmes"
        },
        {
                  "en": "Sequentially adds weak learners that predict residual errors of previous models, optimizing any differentiable loss function",
                  "es": "Agrega secuencialmente aprendices débiles que predicen errores residuales de modelos anteriores, optimizando función pérdida diferenciable",
                  "de": "Fügt sequenziell schwache Lerner hinzu die Residualfehler vorheriger Modelle vorhersagen, optimiert differenzierbare Verlustfunktion",
                  "nl": "Voegt sequentieel zwakke learners toe die residuele fouten van vorige modellen voorspellen, optimaliseert elke differentieerbare verliesfunctie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sequentially learns one task after another",
                  "es": "Aprende secuencialmente una tarea tras otra",
                  "de": "Lernt sequenziell eine Aufgabe nach der anderen",
                  "nl": "Leert sequentieel de ene taak na de andere"
        },
        {
                  "en": "Uses multiple CPUs for parallel task execution",
                  "es": "Usa múltiples CPUs para ejecución paralela de tareas",
                  "de": "Verwendet mehrere CPUs für parallele Aufgabenausführung",
                  "nl": "Gebruikt meerdere CPUs voor parallelle taakuitvoering"
        },
        {
                  "en": "Trains single model on multiple related tasks simultaneously, sharing representations to improve generalization",
                  "es": "Entrena un solo modelo en múltiples tareas relacionadas simultáneamente, compartiendo representaciones para mejorar generalización",
                  "de": "Trainiert einzelnes Modell auf mehreren verwandten Aufgaben gleichzeitig, teilt Repräsentationen um Generalisierung zu verbessern",
                  "nl": "Traint enkel model op meerdere gerelateerde taken tegelijk, deelt representaties om generalisatie te verbeteren"
        },
        {
                  "en": "Distributes different tasks across multiple models",
                  "es": "Distribuye diferentes tareas a través de múltiples modelos",
                  "de": "Verteilt verschiedene Aufgaben über mehrere Modelle",
                  "nl": "Verdeelt verschillende taken over meerdere modellen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adapts models to different hardware architectures",
                  "es": "Adapta modelos a diferentes arquitecturas de hardware",
                  "de": "Passt Modelle an verschiedene Hardware-Architekturen an",
                  "nl": "Past modellen aan voor verschillende hardware architecturen"
        },
        {
                  "en": "Adapts models to work with different programming languages",
                  "es": "Adapta modelos para trabajar con diferentes lenguajes de programación",
                  "de": "Passt Modelle an um mit verschiedenen Programmiersprachen zu arbeiten",
                  "nl": "Past modellen aan om te werken met verschillende programmeertalen"
        },
        {
                  "en": "Changes the domain name of machine learning applications",
                  "es": "Cambia el nombre de dominio de aplicaciones de machine learning",
                  "de": "Ändert den Domainnamen von maschinellen Lernanwendungen",
                  "nl": "Verandert de domeinnaam van machine learning applicaties"
        },
        {
                  "en": "Adapts models trained on source domain to perform well on different but related target domain",
                  "es": "Adapta modelos entrenados en dominio fuente para funcionar bien en dominio objetivo diferente pero relacionado",
                  "de": "Passt Modelle die auf Quelldomäne trainiert wurden an um gut auf verschiedener aber verwandter Zieldomäne zu funktionieren",
                  "nl": "Past modellen getraind op brondomein aan om goed te presteren op verschillend maar gerelateerd doeldomein"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Strategically selects most informative examples for human labeling to maximize learning with minimal labeled data",
                  "es": "Selecciona estratégicamente ejemplos más informativos para etiquetado humano para maximizar aprendizaje con datos etiquetados mínimos",
                  "de": "Wählt strategisch informativste Beispiele für menschliche Beschriftung um Lernen mit minimalen beschrifteten Daten zu maximieren",
                  "nl": "Selecteert strategisch meest informatieve voorbeelden voor menselijke labeling om leren te maximaliseren met minimale gelabelde data"
        },
        {
                  "en": "Continuously learns from real-time data streams",
                  "es": "Aprende continuamente de flujos de datos en tiempo real",
                  "de": "Lernt kontinuierlich aus Echtzeit-Datenströmen",
                  "nl": "Leert continu van real-time datastromen"
        },
        {
                  "en": "Actively searches for new training data sources",
                  "es": "Busca activamente nuevas fuentes de datos de entrenamiento",
                  "de": "Sucht aktiv nach neuen Trainingsdatenquellen",
                  "nl": "Zoekt actief naar nieuwe trainingsdatabronnen"
        },
        {
                  "en": "Uses reinforcement learning for active decision making",
                  "es": "Usa aprendizaje por refuerzo para toma de decisiones activa",
                  "de": "Verwendet Reinforcement Learning für aktive Entscheidungsfindung",
                  "nl": "Gebruikt reinforcement learning voor actieve besluitvorming"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses self-reflection techniques during learning",
                  "es": "Usa técnicas de autorreflexión durante aprendizaje",
                  "de": "Verwendet Selbstreflexionstechniken während des Lernens",
                  "nl": "Gebruikt zelfreflectietechnieken tijdens leren"
        },
        {
                  "en": "Creates supervision signals from data structure itself, learning representations through pretext tasks before fine-tuning",
                  "es": "Crea señales de supervisión de la estructura de datos misma, aprendiendo representaciones a través de tareas de pretexto antes de ajuste fino",
                  "de": "Erstellt Überwachungssignale aus Datenstruktur selbst, lernt Repräsentationen durch Pretext-Aufgaben vor Fine-Tuning",
                  "nl": "Creëert supervisiesignalen uit datastructuur zelf, leert representaties door pretext taken voor fine-tuning"
        },
        {
                  "en": "Supervises its own training process automatically",
                  "es": "Supervisa su propio proceso de entrenamiento automáticamente",
                  "de": "Überwacht seinen eigenen Trainingsprozess automatisch",
                  "nl": "Superviseert zijn eigen trainingsproces automatisch"
        },
        {
                  "en": "Automatically labels data for supervised learning",
                  "es": "Etiqueta automáticamente datos para aprendizaje supervisado",
                  "de": "Beschriftet automatisch Daten für überwachtes Lernen",
                  "nl": "Labelt automatisch data voor gesuperviseerd leren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Changes in underlying data distribution over time, detected through performance monitoring and handled by model retraining",
                  "es": "Cambios en distribución de datos subyacente con el tiempo, detectado a través de monitoreo de rendimiento y manejado por reentrenamiento de modelo",
                  "de": "Änderungen in zugrundeliegender Datenverteilung über Zeit, erkannt durch Leistungsüberwachung und behandelt durch Modell-Neutraining",
                  "nl": "Veranderingen in onderliggende dataverdeling over tijd, gedetecteerd door prestatiemonitoring en behandeld door model hertraining"
        },
        {
                  "en": "Gradual change in model architecture during training",
                  "es": "Cambio gradual en arquitectura del modelo durante entrenamiento",
                  "de": "Gradueller Wandel in Modellarchitektur während Training",
                  "nl": "Geleidelijke verandering in modelarchitectuur tijdens training"
        },
        {
                  "en": "Concept evolution in machine learning algorithms",
                  "es": "Evolución de conceptos en algoritmos de machine learning",
                  "de": "Konzeptentwicklung in maschinellen Lernalgorithmen",
                  "nl": "Conceptevolutie in machine learning algoritmes"
        },
        {
                  "en": "Changes in computational requirements over time",
                  "es": "Cambios en requerimientos computacionales con el tiempo",
                  "de": "Änderungen in Rechenanforderungen über Zeit",
                  "nl": "Veranderingen in computationele vereisten over tijd"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Interpretability is quantitative, explainability is qualitative",
                  "es": "Interpretabilidad es cuantitativa, explicabilidad es cualitativa",
                  "de": "Interpretierbarkeit ist quantitativ, Erklärbarkeit ist qualitativ",
                  "nl": "Interpreteerbaarheid is kwantitatief, verklaarbaarheid is kwalitatief"
        },
        {
                  "en": "Interpretability: inherent transparency of model, explainability: post-hoc methods to understand black-box predictions",
                  "es": "Interpretabilidad: transparencia inherente del modelo, explicabilidad: métodos post-hoc para entender predicciones de caja negra",
                  "de": "Interpretierbarkeit: inhärente Transparenz des Modells, Erklärbarkeit: Post-Hoc-Methoden um Black-Box-Vorhersagen zu verstehen",
                  "nl": "Interpreteerbaarheid: inherente transparantie van model, verklaarbaarheid: post-hoc methoden om black-box voorspellingen te begrijpen"
        },
        {
                  "en": "Interpretability is for technical users, explainability for non-technical",
                  "es": "Interpretabilidad es para usuarios técnicos, explicabilidad para no técnicos",
                  "de": "Interpretierbarkeit ist für technische Benutzer, Erklärbarkeit für nicht-technische",
                  "nl": "Interpreteerbaarheid is voor technische gebruikers, verklaarbaarheid voor niet-technische"
        },
        {
                  "en": "Both terms mean exactly the same thing",
                  "es": "Ambos términos significan exactamente lo mismo",
                  "de": "Beide Begriffe bedeuten genau dasselbe",
                  "nl": "Beide termen betekenen precies hetzelfde"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training models across decentralized devices without centralizing data, preserving user privacy",
                  "es": "Entrenar modelos a través de dispositivos descentralizados sin centralizar datos, preservando privacidad del usuario",
                  "de": "Training von Modellen über dezentrale Geräte ohne Daten zu zentralisieren, bewahrt Benutzerprivatsphäre",
                  "nl": "Trainen van modellen over gedecentraliseerde apparaten zonder data te centraliseren, behoudt gebruikersprivacy"
        },
        {
                  "en": "Combining multiple trained models into one",
                  "es": "Combinar múltiples modelos entrenados en uno",
                  "de": "Kombinieren mehrerer trainierter Modelle in eins",
                  "nl": "Combineren van meerdere getrainde modellen in één"
        },
        {
                  "en": "Federation of different machine learning algorithms",
                  "es": "Federación de diferentes algoritmos de machine learning",
                  "de": "Föderation verschiedener maschineller Lernalgorithmen",
                  "nl": "Federatie van verschillende machine learning algoritmes"
        },
        {
                  "en": "Learning from federated databases only",
                  "es": "Aprender solo de bases de datos federadas",
                  "de": "Lernen nur aus föderierten Datenbanken",
                  "nl": "Leren alleen van gefedereerde databases"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adversarial robustness measures network's defense against malware",
                  "es": "Robustez adversarial mide defensa de red contra malware",
                  "de": "Adversariale Robustheit misst Netzwerkverteidigung gegen Malware",
                  "nl": "Adversariale robuustheid meet netwerkverdediging tegen malware"
        },
        {
                  "en": "Attacks that compete against other neural networks",
                  "es": "Ataques que compiten contra otras redes neuronales",
                  "de": "Angriffe die gegen andere neuronale Netzwerke konkurrieren",
                  "nl": "Aanvallen die concurreren met andere neurale netwerken"
        },
        {
                  "en": "Robustness to adversarial data distributions",
                  "es": "Robustez a distribuciones de datos adversariales",
                  "de": "Robustheit gegenüber adversarialen Datenverteilungen",
                  "nl": "Robuustheid tegen adversariale dataverdelingen"
        },
        {
                  "en": "Adversarial attacks add imperceptible perturbations to fool models; robustness is resistance to such attacks",
                  "es": "Ataques adversariales agregan perturbaciones imperceptibles para engañar modelos; robustez es resistencia a tales ataques",
                  "de": "Adversariale Angriffe fügen nicht wahrnehmbare Störungen hinzu um Modelle zu täuschen; Robustheit ist Widerstand gegen solche Angriffe",
                  "nl": "Adversariale aanvallen voegen onmerkbare verstoringen toe om modellen te misleiden; robuustheid is weerstand tegen dergelijke aanvallen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training models on progressively harder examples from simple to complex, mimicking human learning",
                  "es": "Entrenar modelos en ejemplos progresivamente más difíciles de simple a complejo, imitando aprendizaje humano",
                  "de": "Training von Modellen auf progressiv schwierigeren Beispielen von einfach zu komplex, ahmt menschliches Lernen nach",
                  "nl": "Trainen van modellen op progressief moeilijkere voorbeelden van simpel naar complex, imiteert menselijk leren"
        },
        {
                  "en": "Organizing training data by subject matter",
                  "es": "Organizar datos de entrenamiento por materia",
                  "de": "Organisieren von Trainingsdaten nach Themengebiet",
                  "nl": "Organiseren van trainingsdata per onderwerp"
        },
        {
                  "en": "Following a predefined curriculum of machine learning topics",
                  "es": "Seguir un currículum predefinido de temas de machine learning",
                  "de": "Folgen eines vordefinierten Curriculums von maschinellen Lernthemen",
                  "nl": "Volgen van een voorgedefinieerd curriculum van machine learning onderwerpen"
        },
        {
                  "en": "Scheduling different learning algorithms sequentially",
                  "es": "Programar diferentes algoritmos de aprendizaje secuencialmente",
                  "de": "Sequenzielles Planen verschiedener Lernalgorithmen",
                  "nl": "Plannen van verschillende leeralgoritmes sequentieel"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Transfers knowledge from human experts to models",
                  "es": "Transfiere conocimiento de expertos humanos a modelos",
                  "de": "Überträgt Wissen von menschlichen Experten auf Modelle",
                  "nl": "Draagt kennis over van menselijke experts naar modellen"
        },
        {
                  "en": "Extracts pure knowledge from noisy datasets",
                  "es": "Extrae conocimiento puro de conjuntos de datos ruidosos",
                  "de": "Extrahiert reines Wissen aus verrauschten Datensätzen",
                  "nl": "Extraheert pure kennis uit ruizige datasets"
        },
        {
        ...
        {
                  "en": "Trains smaller student model to mimic larger teacher model's soft predictions, compressing knowledge",
                  "es": "Entrena modelo estudiante más pequeño para imitar predicciones suaves de modelo maestro más grande, comprimiendo conocimiento",
                  "de": "Trainiert kleineres Schüler-Modell um weiche Vorhersagen größeren Lehrer-Modells nachzuahmen, komprimiert Wissen",
                  "nl": "Traint kleiner student model om zachte voorspellingen van groter leraar model na te bootsen, comprimeert kennis"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses ensemble of datasets for training",
                  "es": "Usa conjunto de conjuntos de datos para entrenamiento",
                  "de": "Verwendet Ensemble von Datensätzen für Training",
                  "nl": "Gebruikt ensemble van datasets voor training"
        },
        {
                  "en": "Combines multiple models to reduce variance, bias, and improve predictions through voting or averaging",
                  "es": "Combina múltiples modelos para reducir varianza, sesgo y mejorar predicciones a través de votación o promedio",
                  "de": "Kombiniert mehrere Modelle um Varianz, Bias zu reduzieren und Vorhersagen durch Abstimmung oder Mittelung zu verbessern",
                  "nl": "Combineert meerdere modellen om variantie, bias te verminderen en voorspellingen te verbeteren door stemmen of middeling"
        },
        {
                  "en": "Combines different types of neural network layers",
                  "es": "Combina diferentes tipos de capas de redes neuronales",
                  "de": "Kombiniert verschiedene Arten von neuronalen Netzwerkschichten",
                  "nl": "Combineert verschillende soorten neurale netwerklagen"
        },
        {
                  "en": "Trains models in parallel for faster computation",
                  "es": "Entrena modelos en paralelo para computación más rápida",
                  "de": "Trainiert Modelle parallel für schnellere Berechnung",
                  "nl": "Traint modellen parallel voor snellere berekening"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trade-off between training speed and accuracy",
                  "es": "Compromiso entre velocidad de entrenamiento y precisión",
                  "de": "Tradeoff zwischen Trainingsgeschwindigkeit und Genauigkeit",
                  "nl": "Afweging tussen trainingssnelheid en nauwkeurigheid"
        },
        {
                  "en": "Balance between different types of data bias",
                  "es": "Balance entre diferentes tipos de sesgo de datos",
                  "de": "Balance zwischen verschiedenen Arten von Datenbias",
                  "nl": "Balans tussen verschillende soorten databias"
        },
        {
                  "en": "Choosing between biased and unbiased estimators",
                  "es": "Elegir entre estimadores sesgados y no sesgados",
                  "de": "Wahl zwischen biased und unbiased Schätzern",
                  "nl": "Kiezen tussen biased en unbiased schattingen"
        },
        {
                  "en": "Balancing model complexity: high bias underfits, high variance overfits; optimal models balance both",
                  "es": "Equilibrar complejidad del modelo: alto sesgo subajusta, alta varianza sobreajusta; modelos óptimos equilibran ambos",
                  "de": "Modellkomplexität ausbalancieren: hoher Bias unterpasst, hohe Varianz überpasst; optimale Modelle balancieren beide",
                  "nl": "Modelcomplexiteit balanceren: hoge bias underfit, hoge variantie overfit; optimale modellen balanceren beide"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Removes low-importance weights/neurons to reduce model size while maintaining performance",
                  "es": "Elimina pesos/neuronas de baja importancia para reducir tamaño del modelo mientras mantiene rendimiento",
                  "de": "Entfernt Gewichte/Neuronen mit geringer Wichtigkeit um Modellgröße zu reduzieren während Leistung erhalten bleibt",
                  "nl": "Verwijdert gewichten/neuronen met lage belangrijkheid om modelgrootte te verkleinen terwijl prestaties behouden blijven"
        },
        {
                  "en": "Prunes training data to remove outliers",
                  "es": "Poda datos de entrenamiento para eliminar valores atípicos",
                  "de": "Beschneidet Trainingsdaten um Ausreißer zu entfernen",
                  "nl": "Snoeit trainingsdata om uitbijters te verwijderen"
        },
        {
                  "en": "Removes unused features from input data",
                  "es": "Elimina características no usadas de datos de entrada",
                  "de": "Entfernt ungenutzte Features aus Eingabedaten",
                  "nl": "Verwijdert ongebruikte features uit invoerdata"
        },
        {
                  "en": "Cuts down training time by pruning epochs",
                  "es": "Reduce tiempo de entrenamiento podando épocas",
                  "de": "Reduziert Trainingszeit durch Beschneiden von Epochen",
                  "nl": "Vermindert trainingstijd door epochs te snoeien"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Divides neural network into quantized segments",
                  "es": "Divide red neuronal en segmentos cuantizados",
                  "de": "Teilt neuronales Netzwerk in quantisierte Segmente",
                  "nl": "Verdeelt neuraal netwerk in gekwantiseerde segmenten"
        },
        {
                  "en": "Measures quantum effects in neural computations",
                  "es": "Mide efectos cuánticos en computaciones neuronales",
                  "de": "Misst Quanteneffekte in neuronalen Berechnungen",
                  "nl": "Meet kwantumeffecten in neurale berekeningen"
        },
        {
                  "en": "Reduces numerical precision of weights/activations from float32 to int8, enabling faster hardware computation",
                  "es": "Reduce precisión numérica de pesos/activaciones de float32 a int8, habilitando computación de hardware más rápida",
                  "de": "Reduziert numerische Präzision von Gewichten/Aktivierungen von float32 auf int8, ermöglicht schnellere Hardware-Berechnung",
                  "nl": "Vermindert numerieke precisie van gewichten/activaties van float32 naar int8, maakt snellere hardware berekening mogelijk"
        },
        {
                  "en": "Quantifies model performance with numerical metrics",
                  "es": "Cuantifica rendimiento del modelo con métricas numéricas",
                  "de": "Quantifiziert Modellleistung mit numerischen Metriken",
                  "nl": "Kwantificeert modelprestaties met numerieke metrieken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Compresses training data to reduce storage",
                  "es": "Comprime datos de entrenamiento para reducir almacenamiento",
                  "de": "Komprimiert Trainingsdaten um Speicherplatz zu reduzieren",
                  "nl": "Comprimeert trainingsdata om opslag te verminderen"
        },
        {
                  "en": "Uses compression algorithms on model files",
                  "es": "Usa algoritmos de compresión en archivos de modelo",
                  "de": "Verwendet Kompressionsalgorithmen auf Modelldateien",
                  "nl": "Gebruikt compressiealgoritmes op modelbestanden"
        },
        {
                  "en": "Reduces the number of layers in neural networks",
                  "es": "Reduce el número de capas en redes neuronales",
                  "de": "Reduziert die Anzahl der Schichten in neuronalen Netzwerken",
                  "nl": "Vermindert het aantal lagen in neurale netwerken"
        },
        {
                  "en": "Reduces model size/complexity using pruning, quantization, knowledge distillation, and low-rank factorization",
                  "es": "Reduce tamaño/complejidad del modelo usando poda, cuantización, destilación de conocimiento y factorización de bajo rango",
                  "de": "Reduziert Modellgröße/-komplexität mit Pruning, Quantisierung, Knowledge Distillation und Low-Rank-Faktorisierung",
                  "nl": "Vermindert modelgrootte/-complexiteit met pruning, quantization, knowledge distillation en low-rank factorisatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Both terms refer to the same optimization process",
                  "es": "Ambos términos se refieren al mismo proceso de optimización",
                  "de": "Beide Begriffe beziehen sich auf denselben Optimierungsprozess",
                  "nl": "Beide termen verwijzen naar hetzelfde optimalisatieproces"
        },
        {
                  "en": "Hyperparameter tuning changes model architecture",
                  "es": "Ajuste de hiperparámetros cambia arquitectura del modelo",
                  "de": "Hyperparameter-Tuning ändert Modellarchitektur",
                  "nl": "Hyperparameter tuning verandert modelarchitectuur"
        },
        {
                  "en": "Architecture optimization is faster than hyperparameter tuning",
                  "es": "Optimización de arquitectura es más rápida que ajuste de hiperparámetros",
                  "de": "Architekturoptimierung ist schneller als Hyperparameter-Tuning",
                  "nl": "Architectuuroptimalisatie is sneller dan hyperparameter tuning"
        },
        {
                  "en": "Searches for optimal network structure (layers, connections) while hyperparameter tuning adjusts training settings",
                  "es": "Busca estructura de red óptima (capas, conexiones) mientras ajuste de hiperparámetros ajusta configuraciones de entrenamiento",
                  "de": "Sucht nach optimaler Netzwerkstruktur (Schichten, Verbindungen) während Hyperparameter-Tuning Trainingseinstellungen anpasst",
                  "nl": "Zoekt naar optimale netwerkstructuur (lagen, verbindingen) terwijl hyperparameter tuning trainingsinstellingen aanpast"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Never freeze any layers for best performance",
                  "es": "Nunca congelar ninguna capa para mejor rendimiento",
                  "de": "Niemals Schichten einfrieren für beste Leistung",
                  "nl": "Nooit lagen bevriezen voor beste prestaties"
        },
        {
                  "en": "Freeze early layers (general features) when data is limited, unfreeze more layers with larger related datasets",
                  "es": "Congelar capas tempranas (características generales) cuando datos son limitados, descongelar más capas con conjuntos de datos relacionados más grandes",
                  "de": "Frühe Schichten einfrieren (allgemeine Features) wenn Daten begrenzt sind, mehr Schichten auftauen mit größeren verwandten Datensätzen",
                  "nl": "Bevries vroege lagen (algemene features) wanneer data beperkt is, ontdooi meer lagen met grotere gerelateerde datasets"
        },
        {
                  "en": "Always freeze all layers except the last one",
                  "es": "Siempre congelar todas las capas excepto la última",
                  "de": "Immer alle Schichten außer der letzten einfrieren",
                  "nl": "Altijd alle lagen behalve de laatste bevriezen"
        },
        {
                  "en": "Freeze layers randomly during training",
                  "es": "Congelar capas aleatoriamente durante entrenamiento",
                  "de": "Schichten zufällig während des Trainings einfrieren",
                  "nl": "Lagen willekeurig bevriezen tijdens training"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses zero initialization for model weights",
                  "es": "Usa inicialización cero para pesos del modelo",
                  "de": "Verwendet Null-Initialisierung für Modellgewichte",
                  "nl": "Gebruikt nul initialisatie voor modelgewichten"
        },
        {
                  "en": "Performs learning in zero iterations",
                  "es": "Realiza aprendizaje en cero iteraciones",
                  "de": "Führt Lernen in null Iterationen durch",
                  "nl": "Voert leren uit in nul iteraties"
        },
        {
                  "en": "Uses semantic attributes or embeddings to classify classes never seen during training",
                  "es": "Usa atributos semánticos o embeddings para clasificar clases nunca vistas durante entrenamiento",
                  "de": "Verwendet semantische Attribute oder Embeddings um Klassen zu klassifizieren die während Training nie gesehen wurden",
                  "nl": "Gebruikt semantische attributen of embeddings om klassen te classificeren die nooit gezien zijn tijdens training"
        },
        {
                  "en": "Learns without any training examples",
                  "es": "Aprende sin ningún ejemplo de entrenamiento",
                  "de": "Lernt ohne jegliche Trainingsbeispiele",
                  "nl": "Leert zonder trainingsvoorbeelden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses contrast enhancement on training images",
                  "es": "Usa mejora de contraste en imágenes de entrenamiento",
                  "de": "Verwendet Kontrastverbesserung auf Trainingsbildern",
                  "nl": "Gebruikt contrastverbetering op trainingsafbeeldingen"
        },
        {
                  "en": "Contrasts different machine learning algorithms",
                  "es": "Contrasta diferentes algoritmos de machine learning",
                  "de": "Kontrastiert verschiedene maschinelle Lernalgorithmen",
                  "nl": "Contrasteert verschillende machine learning algoritmes"
        },
        {
                  "en": "Learns from contrasting positive and negative examples",
                  "es": "Aprende de contrastar ejemplos positivos y negativos",
                  "de": "Lernt aus Kontrastierung positiver und negativer Beispiele",
                  "nl": "Leert van contrasteren van positieve en negatieve voorbeelden"
        },
        {
                  "en": "Learns by pulling similar samples together and pushing dissimilar samples apart in embedding space",
                  "es": "Aprende juntando muestras similares y separando muestras diferentes en espacio de embedding",
                  "de": "Lernt durch Zusammenziehen ähnlicher Samples und Auseinanderschieben unähnlicher Samples im Embedding-Raum",
                  "nl": "Leert door vergelijkbare samples samen te trekken en verschillende samples uit elkaar te duwen in embedding ruimte"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ensures models perform fairly across different datasets",
                  "es": "Asegura que modelos funcionen equitativamente entre diferentes conjuntos de datos",
                  "de": "Stellt sicher dass Modelle fair über verschiedene Datensätze funktionieren",
                  "nl": "Zorgt ervoor dat modellen fair presteren over verschillende datasets"
        },
        {
                  "en": "Equal accuracy for all prediction classes",
                  "es": "Precisión igual para todas las clases de predicción",
                  "de": "Gleiche Genauigkeit für alle Vorhersageklassen",
                  "nl": "Gelijke nauwkeurigheid voor alle voorspellingsklassen"
        },
        {
                  "en": "Ensures equitable treatment across groups; measured by demographic parity, equal opportunity; mitigated through data balancing, fairness constraints",
                  "es": "Asegura tratamiento equitativo entre grupos; medido por paridad demográfica, igualdad de oportunidades; mitigado a través de balance de datos, restricciones de equidad",
                  "de": "Stellt gleichberechtigte Behandlung über Gruppen sicher; gemessen durch demografische Parität, Chancengleichheit; gemildert durch Datenausgleich, Fairness-Beschränkungen",
                  "nl": "Zorgt voor eerlijke behandeling tussen groepen; gemeten door demografische pariteit, gelijke kansen; gemitigeerd door data balancering, fairness beperkingen"
        },
        {
                  "en": "Fairness in distributing computational resources",
                  "es": "Equidad en distribuir recursos computacionales",
                  "de": "Fairness bei Verteilung von Rechenressourcen",
                  "nl": "Fairheid in verdeling van computationele middelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Applies different learning modes to same data",
                  "es": "Aplica diferentes modos de aprendizaje a mismos datos",
                  "de": "Wendet verschiedene Lernmodi auf dieselben Daten an",
                  "nl": "Past verschillende leermodi toe op dezelfde data"
        },
        {
                  "en": "Trains multiple models simultaneously",
                  "es": "Entrena múltiples modelos simultáneamente",
                  "de": "Trainiert mehrere Modelle gleichzeitig",
                  "nl": "Traint meerdere modellen gelijktijdig"
        },
        {
                  "en": "Integrates information from multiple modalities (text, image, audio, video) for richer understanding and cross-modal tasks",
                  "es": "Integra información de múltiples modalidades (texto, imagen, audio, video) para comprensión más rica y tareas cross-modales",
                  "de": "Integriert Information aus mehreren Modalitäten (Text, Bild, Audio, Video) für reicheres Verständnis und cross-modale Aufgaben",
                  "nl": "Integreert informatie van meerdere modaliteiten (tekst, beeld, audio, video) voor rijker begrip en cross-modale taken"
        },
        {
                  "en": "Uses multiple statistical modes for prediction",
                  "es": "Usa múltiples modos estadísticos para predicción",
                  "de": "Verwendet mehrere statistische Modi für Vorhersage",
                  "nl": "Gebruikt meerdere statistische modi voor voorspelling"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adjusts model accuracy to 100%",
                  "es": "Ajusta precisión del modelo a 100%",
                  "de": "Passt Modellgenauigkeit auf 100% an",
                  "nl": "Past modelnauwkeurigheid aan naar 100%"
        },
        {
                  "en": "Ensures equal performance across all classes",
                  "es": "Asegura rendimiento igual en todas las clases",
                  "de": "Stellt gleiche Leistung über alle Klassen sicher",
                  "nl": "Zorgt voor gelijke prestaties over alle klassen"
        },
        {
                  "en": "Ensures predicted probabilities match actual frequencies; crucial for decision-making under uncertainty",
                  "es": "Asegura que probabilidades predichas coincidan con frecuencias reales; crucial para toma de decisiones bajo incertidumbre",
                  "de": "Stellt sicher dass vorhergesagte Wahrscheinlichkeiten mit tatsächlichen Häufigkeiten übereinstimmen; entscheidend für Entscheidungsfindung unter Unsicherheit",
                  "nl": "Zorgt ervoor dat voorspelde waarschijnlijkheden overeenkomen met werkelijke frequenties; cruciaal voor besluitvorming onder onzekerheid"
        },
        {
                  "en": "Calibrates model parameters before training",
                  "es": "Calibra parámetros del modelo antes de entrenamiento",
                  "de": "Kalibriert Modellparameter vor dem Training",
                  "nl": "Kalibreert modelparameters voor training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enhances data quality through cleaning",
                  "es": "Mejora calidad de datos a través de limpieza",
                  "de": "Verbessert Datenqualität durch Bereinigung",
                  "nl": "Verbetert datakwaliteit door opschoning"
        },
        {
                  "en": "Artificially expands training data through transformations; advanced: mixup, cutout, AutoAugment, adversarial examples",
                  "es": "Expande artificialmente datos de entrenamiento a través de transformaciones; avanzado: mixup, cutout, AutoAugment, ejemplos adversariales",
                  "de": "Erweitert künstlich Trainingsdaten durch Transformationen; fortgeschritten: Mixup, Cutout, AutoAugment, adversariale Beispiele",
                  "nl": "Breidt kunstmatig trainingsdata uit door transformaties; geavanceerd: mixup, cutout, AutoAugment, adversariale voorbeelden"
        },
        {
                  "en": "Augments model architecture with more layers",
                  "es": "Aumenta arquitectura del modelo con más capas",
                  "de": "Erweitert Modellarchitektur mit mehr Schichten",
                  "nl": "Vergroot modelarchitectuur met meer lagen"
        },
        {
                  "en": "Increases dataset size by collecting more data",
                  "es": "Aumenta tamaño del conjunto de datos recolectando más datos",
                  "de": "Erhöht Datensatzgröße durch Sammeln mehr Daten",
                  "nl": "Vergroot datasetgrootte door meer data te verzamelen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Groups similar models together for organization",
                  "es": "Agrupa modelos similares juntos para organización",
                  "de": "Gruppiert ähnliche Modelle zusammen zur Organisation",
                  "nl": "Groepeert vergelijkbare modellen samen voor organisatie"
        },
        {
                  "en": "Ensembles datasets before training models",
                  "es": "Ensambla conjuntos de datos antes de entrenar modelos",
                  "de": "Assembliert Datensätze vor dem Trainieren von Modellen",
                  "nl": "Assembleert datasets voor het trainen van modellen"
        },
        {
                  "en": "Assembles model components into single architecture",
                  "es": "Ensambla componentes del modelo en arquitectura única",
                  "de": "Assembliert Modellkomponenten in einzelne Architektur",
                  "nl": "Assembleert modelcomponenten in enkele architectuur"
        },
        {
                  "en": "Combines predictions from multiple models via averaging, voting, or stacking for improved performance",
                  "es": "Combina predicciones de múltiples modelos vía promedio, votación o apilamiento para rendimiento mejorado",
                  "de": "Kombiniert Vorhersagen mehrerer Modelle via Mittelung, Abstimmung oder Stacking für verbesserte Leistung",
                  "nl": "Combineert voorspellingen van meerdere modellen via middeling, stemmen of stacking voor verbeterde prestaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trading off exploration time vs exploitation accuracy",
                  "es": "Compensar tiempo de exploración vs precisión de explotación",
                  "de": "Abwägen von Explorationszeit vs Exploitation-Genauigkeit",
                  "nl": "Afwegen van exploratietijd vs exploitatie nauwkeurigheid"
        },
        {
                  "en": "Balancing trying new actions (exploration) vs choosing known best actions (exploitation) to maximize long-term reward",
                  "es": "Equilibrar probar nuevas acciones (exploración) vs elegir mejores acciones conocidas (explotación) para maximizar recompensa a largo plazo",
                  "de": "Ausbalancieren neuer Aktionen versuchen (Exploration) vs bekannte beste Aktionen wählen (Exploitation) um langfristige Belohnung zu maximieren",
                  "nl": "Balanceren van nieuwe acties proberen (exploratie) vs bekende beste acties kiezen (exploitatie) om lange-termijn beloning te maximaliseren"
        },
        {
                  "en": "Balancing different types of reward signals",
                  "es": "Equilibrar diferentes tipos de señales de recompensa",
                  "de": "Ausbalancieren verschiedener Arten von Belohnungssignalen",
                  "nl": "Balanceren van verschillende soorten beloningssignalen"
        },
        {
                  "en": "Exploring the environment vs exploiting computational resources",
                  "es": "Explorar el entorno vs explotar recursos computacionales",
                  "de": "Umgebung erkunden vs Rechenressourcen ausnutzen",
                  "nl": "Omgeving verkennen vs computationele middelen exploiteren"
        }
        ],
        correct: 1,
        explanation: {
