    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Hierarchical is faster than partitional clustering",
                  "es": "Jerárquico es más rápido que clustering particional",
                  "de": "Hierarchisch ist schneller als partitionelles Clustering",
                  "nl": "Hiërarchisch is sneller dan partitionele clustering"
        },
        {
                  "en": "Hierarchical creates tree-like cluster structures, partitional divides data into k distinct clusters",
                  "es": "Jerárquico crea estructuras de clusters tipo árbol, particional divide datos en k clusters distintos",
                  "de": "Hierarchisch erstellt baumartige Cluster-Strukturen, partitionell teilt Daten in k unterschiedliche Cluster",
                  "nl": "Hiërarchisch creëert boomachtige cluster structuren, partitioneel verdeelt data in k verschillende clusters"
        },
        {
                  "en": "Hierarchical only works with numerical data",
                  "es": "Jerárquico solo funciona con datos numéricos",
                  "de": "Hierarchisch funktioniert nur mit numerischen Daten",
                  "nl": "Hiërarchisch werkt alleen met numerieke data"
        },
        {
                  "en": "Partitional requires labeled data, hierarchical doesn't",
                  "es": "Particional requiere datos etiquetados, jerárquico no",
                  "de": "Partitionell benötigt beschriftete Daten, hierarchisch nicht",
                  "nl": "Partitioneel vereist gelabelde data, hiërarchisch niet"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Perform supervised classification tasks",
                  "es": "Realizar tareas de clasificación supervisada",
                  "de": "Überwachte Klassifikationsaufgaben durchführen",
                  "nl": "Gesuperviseerde classificatietaken uitvoeren"
        },
        {
                  "en": "Generate synthetic training data",
                  "es": "Generar datos de entrenamiento sintéticos",
                  "de": "Synthetische Trainingsdaten generieren",
                  "nl": "Synthetische trainingsdata genereren"
        },
        {
                  "en": "Visualize high-dimensional data in 2D/3D while preserving local neighborhoods",
                  "es": "Visualizar datos de alta dimensión en 2D/3D preservando vecindarios locales",
                  "de": "Hochdimensionale Daten in 2D/3D visualisieren während lokale Nachbarschaften erhalten bleiben",
                  "nl": "Hoogdimensionale data visualiseren in 2D/3D terwijl lokale buurtschappen behouden blijven"
        },
        {
                  "en": "Speed up neural network training",
                  "es": "Acelerar entrenamiento de redes neuronales",
                  "de": "Neuronale Netzwerk-Training beschleunigen",
                  "nl": "Neurale netwerk training versnellen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Determine the optimal number of features",
                  "es": "Determinar el número óptimo de características",
                  "de": "Die optimale Anzahl von Merkmalen bestimmen",
                  "nl": "Het optimale aantal features bepalen"
        },
        {
                  "en": "Measure the speed of clustering algorithms",
                  "es": "Medir la velocidad de algoritmos de clustering",
                  "de": "Die Geschwindigkeit von Clustering-Algorithmen messen",
                  "nl": "De snelheid van clustering algoritmes meten"
        },
        {
                  "en": "Calculate the computational complexity",
                  "es": "Calcular la complejidad computacional",
                  "de": "Die Rechenkomplexität berechnen",
                  "nl": "De computationele complexiteit berekenen"
        },
        {
                  "en": "Measure how well-separated and cohesive clusters are",
                  "es": "Medir qué tan bien separados y cohesivos están los clusters",
                  "de": "Messen wie gut getrennt und kohäsiv Cluster sind",
                  "nl": "Meten hoe goed gescheiden en cohesief clusters zijn"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "DBSCAN works only with numerical data",
                  "es": "DBSCAN funciona solo con datos numéricos",
                  "de": "DBSCAN funktioniert nur mit numerischen Daten",
                  "nl": "DBSCAN werkt alleen met numerieke data"
        },
        {
                  "en": "DBSCAN requires fewer parameters than k-means",
                  "es": "DBSCAN requiere menos parámetros que k-means",
                  "de": "DBSCAN benötigt weniger Parameter als k-means",
                  "nl": "DBSCAN vereist minder parameters dan k-means"
        },
        {
                  "en": "DBSCAN is faster than k-means for all datasets",
                  "es": "DBSCAN es más rápido que k-means para todos los datasets",
                  "de": "DBSCAN ist schneller als k-means für alle Datensätze",
                  "nl": "DBSCAN is sneller dan k-means voor alle datasets"
        },
        {
                  "en": "Density-based algorithm that can find clusters of arbitrary shape and detect outliers",
                  "es": "Algoritmo basado en densidad que puede encontrar clusters de forma arbitraria y detectar valores atípicos",
                  "de": "Dichtebasierter Algorithmus der Cluster beliebiger Form finden und Ausreißer erkennen kann",
                  "nl": "Dichtheid-gebaseerd algoritme dat clusters van willekeurige vorm kan vinden en uitschieters kan detecteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Analyzing unusual weather patterns only",
                  "es": "Analizar solo patrones climáticos inusuales",
                  "de": "Nur ungewöhnliche Wettermuster analysieren",
                  "nl": "Alleen ongebruikelijke weerpatronen analyseren"
        },
        {
                  "en": "Finding anomalies in computer hardware",
                  "es": "Encontrar anomalías en hardware de computadora",
                  "de": "Anomalien in Computer-Hardware finden",
                  "nl": "Anomalieën vinden in computerhardware"
        },
        {
                  "en": "Detecting errors in machine learning algorithms",
                  "es": "Detectar errores en algoritmos de machine learning",
                  "de": "Fehler in maschinellen Lernalgorithmen erkennen",
                  "nl": "Fouten detecteren in machine learning algoritmes"
        },
        {
                  "en": "Identifying unusual patterns using statistical, isolation-based, or clustering methods",
                  "es": "Identificar patrones inusuales usando métodos estadísticos, basados en aislamiento o clustering",
                  "de": "Ungewöhnliche Muster mit statistischen, isolationsbasierten oder Clustering-Methoden identifizieren",
                  "nl": "Ongebruikelijke patronen identificeren met statistische, isolatie-gebaseerde of clustering methoden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tuning model configuration parameters not learned from data to optimize performance and prevent overfitting",
                  "es": "Ajustar parámetros de configuración del modelo no aprendidos de datos para optimizar rendimiento y prevenir overfitting",
                  "de": "Abstimmen von Modellkonfigurationsparametern die nicht aus Daten gelernt werden um Leistung zu optimieren und Overfitting zu verhindern",
                  "nl": "Het afstellen van modelconfiguratieparameters die niet van data geleerd worden om prestaties te optimaliseren en overfitting te voorkomen"
        },
        {
                  "en": "Selecting the best machine learning algorithm",
                  "es": "Seleccionar el mejor algoritmo de machine learning",
                  "de": "Den besten maschinellen Lernalgorithmus auswählen",
                  "nl": "Het beste machine learning algoritme selecteren"
        },
        {
                  "en": "Learning optimal weights and biases during training",
                  "es": "Aprender pesos y sesgos óptimos durante entrenamiento",
                  "de": "Optimale Gewichte und Verzerrungen während des Trainings lernen",
                  "nl": "Het leren van optimale gewichten en biases tijdens training"
        },
        {
                  "en": "Preprocessing data to improve model input quality",
                  "es": "Preprocesar datos para mejorar calidad de entrada del modelo",
                  "de": "Daten vorverarbeiten um Modell-Eingabequalität zu verbessern",
                  "nl": "Data voorverwerken om modelinvoerkwaliteit te verbeteren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Divides data into k folds, trains on k-1 and tests on 1, provides more robust performance estimates",
                  "es": "Divide datos en k pliegues, entrena en k-1 y prueba en 1, proporciona estimaciones de rendimiento más robustas",
                  "de": "Teilt Daten in k Folds, trainiert auf k-1 und testet auf 1, bietet robustere Leistungsschätzungen",
                  "nl": "Verdeelt data in k folds, traint op k-1 en test op 1, biedt robuustere prestatieschattingen"
        },
        {
                  "en": "Requires k times more computational resources",
                  "es": "Requiere k veces más recursos computacionales",
                  "de": "Benötigt k-mal mehr Rechenressourcen",
                  "nl": "Vereist k keer meer computationele middelen"
        },
        {
                  "en": "Trains k separate models simultaneously",
                  "es": "Entrena k modelos separados simultáneamente",
                  "de": "Trainiert k separate Modelle gleichzeitig",
                  "nl": "Traint k aparte modellen gelijktijdig"
        },
        {
                  "en": "Uses k different machine learning algorithms",
                  "es": "Usa k algoritmos diferentes de machine learning",
                  "de": "Verwendet k verschiedene maschinelle Lernalgorithmen",
                  "nl": "Gebruikt k verschillende machine learning algoritmes"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Grid search is always faster than random search",
                  "es": "Búsqueda en cuadrícula siempre es más rápida que búsqueda aleatoria",
                  "de": "Grid Search ist immer schneller als Random Search",
                  "nl": "Grid search is altijd sneller dan random search"
        },
        {
                  "en": "Random search works only with continuous parameters",
                  "es": "Búsqueda aleatoria funciona solo con parámetros continuos",
                  "de": "Random Search funktioniert nur mit kontinuierlichen Parametern",
                  "nl": "Random search werkt alleen met continue parameters"
        },
        {
                  "en": "Grid search provides guaranteed optimal results",
                  "es": "Búsqueda en cuadrícula proporciona resultados óptimos garantizados",
                  "de": "Grid Search bietet garantiert optimale Ergebnisse",
                  "nl": "Grid search biedt gegarandeerd optimale resultaten"
        },
        {
                  "en": "Grid search tests all combinations systematically, random search samples randomly from parameter space",
                  "es": "Búsqueda en cuadrícula prueba todas las combinaciones sistemáticamente, búsqueda aleatoria muestrea aleatoriamente del espacio de parámetros",
                  "de": "Grid Search testet alle Kombinationen systematisch, Random Search sampelt zufällig aus dem Parameterraum",
                  "nl": "Grid search test alle combinaties systematisch, random search neemt willekeurig samples uit de parameterruimte"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses Bayesian networks for hyperparameter relationships",
                  "es": "Usa redes bayesianas para relaciones de hiperparámetros",
                  "de": "Verwendet Bayesianische Netzwerke für Hyperparameter-Beziehungen",
                  "nl": "Gebruikt Bayesiaanse netwerken voor hyperparameterrelaties"
        },
        {
                  "en": "Applies Bayes' theorem to update parameter distributions",
                  "es": "Aplica teorema de Bayes para actualizar distribuciones de parámetros",
                  "de": "Wendet Bayes-Theorem an um Parameterverteilungen zu aktualisieren",
                  "nl": "Past Bayes' theorema toe om parameterdistributies bij te werken"
        },
        {
                  "en": "Searches only within Bayesian model constraints",
                  "es": "Busca solo dentro de restricciones del modelo bayesiano",
                  "de": "Sucht nur innerhalb Bayesianischer Modellbeschränkungen",
                  "nl": "Zoekt alleen binnen Bayesiaanse modelbeperkingen"
        },
        {
                  "en": "Builds probabilistic model of objective function to intelligently select next hyperparameters to evaluate",
                  "es": "Construye modelo probabilístico de función objetivo para seleccionar inteligentemente próximos hiperparámetros a evaluar",
                  "de": "Baut probabilistisches Modell der Zielfunktion um intelligent nächste zu evaluierende Hyperparameter auszuwählen",
                  "nl": "Bouwt probabilistisch model van objectieffunctie om intelligent volgende hyperparameters te selecteren voor evaluatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Divides data into strata based on feature importance",
                  "es": "Divide datos en estratos basados en importancia de características",
                  "de": "Teilt Daten in Schichten basierend auf Feature-Wichtigkeit",
                  "nl": "Verdeelt data in strata gebaseerd op feature belangrijk"
        },
        {
                  "en": "Stratifies features rather than target variables",
                  "es": "Estratifica características en lugar de variables objetivo",
                  "de": "Schichtet Features anstatt Zielvariablen",
                  "nl": "Stratificeert features in plaats van doelvariabelen"
        },
        {
                  "en": "Maintains class distribution proportions across all folds to ensure representative training and test sets",
                  "es": "Mantiene proporciones de distribución de clases a través de todos los pliegues para asegurar conjuntos de entrenamiento y prueba representativos",
                  "de": "Erhält Klassenverteilungsproportionen über alle Folds um repräsentative Training- und Testsätze sicherzustellen",
                  "nl": "Behoudt klassendistributieproporties over alle folds om representatieve training- en testsets te verzekeren"
        },
        {
                  "en": "Uses statistical stratification for sampling efficiency",
                  "es": "Usa estratificación estadística para eficiencia de muestreo",
                  "de": "Verwendet statistische Schichtung für Stichproben-Effizienz",
                  "nl": "Gebruikt statistische stratificatie voor steekproefefficiëntie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses n-1 samples for training and 1 for testing, repeated n times, providing maximum data usage but high variance",
                  "es": "Usa n-1 muestras para entrenamiento y 1 para prueba, repetido n veces, proporcionando máximo uso de datos pero alta varianza",
                  "de": "Verwendet n-1 Stichproben für Training und 1 für Testing, n-mal wiederholt, bietet maximale Datennutzung aber hohe Varianz",
                  "nl": "Gebruikt n-1 samples voor training en 1 voor testing, herhaald n keer, biedt maximaal datagebruik maar hoge variantie"
        },
        {
                  "en": "Uses only one fold for more efficient computation",
                  "es": "Usa solo un pliegue para computación más eficiente",
                  "de": "Verwendet nur einen Fold für effizientere Berechnung",
                  "nl": "Gebruikt slechts één fold voor efficiëntere berekening"
        },
        {
                  "en": "Leaves out outliers from cross-validation process",
                  "es": "Deja fuera valores atípicos del proceso de validación cruzada",
                  "de": "Lässt Ausreißer aus dem Kreuzvalidierungsprozess weg",
                  "nl": "Laat uitbijters weg uit het cross-validation proces"
        },
        {
                  "en": "Selects one best hyperparameter configuration",
                  "es": "Selecciona una mejor configuración de hiperparámetros",
                  "de": "Wählt eine beste Hyperparameter-Konfiguration",
                  "nl": "Selecteert één beste hyperparameterconfiguratie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses inner loop for hyperparameter tuning and outer loop for performance estimation to avoid data leakage",
                  "es": "Usa bucle interno para ajuste de hiperparámetros y bucle externo para estimación de rendimiento para evitar filtración de datos",
                  "de": "Verwendet innere Schleife für Hyperparameter-Tuning und äußere Schleife für Leistungsschätzung um Data Leakage zu vermeiden",
                  "nl": "Gebruikt binnenste lus voor hyperparameter tuning en buitenste lus voor prestatieschatting om data leakage te vermijden"
        },
        {
                  "en": "Nests multiple machine learning algorithms together",
                  "es": "Anida múltiples algoritmos de machine learning juntos",
                  "de": "Verschachtelt mehrere maschinelle Lernalgorithmen zusammen",
                  "nl": "Nest meerdere machine learning algoritmes samen"
        },
        {
                  "en": "Validates nested features within the dataset",
                  "es": "Valida características anidadas dentro del conjunto de datos",
                  "de": "Validiert verschachtelte Features innerhalb des Datensatzes",
                  "nl": "Valideert geneste features binnen de dataset"
        },
        {
                  "en": "Uses hierarchical cross-validation for tree models",
                  "es": "Usa validación cruzada jerárquica para modelos de árbol",
                  "de": "Verwendet hierarchische Kreuzvalidierung für Baummodelle",
                  "nl": "Gebruikt hiërarchische cross-validation voor boommodellen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Validation curves require more computational resources",
                  "es": "Curvas de validación requieren más recursos computacionales",
                  "de": "Validierungskurven benötigen mehr Rechenressourcen",
                  "nl": "Validatiecurves vereisen meer computationele middelen"
        },
        {
                  "en": "Learning curves are only for deep learning models",
                  "es": "Curvas de aprendizaje son solo para modelos de deep learning",
                  "de": "Lernkurven sind nur für Deep Learning Modelle",
                  "nl": "Leercurves zijn alleen voor deep learning modellen"
        },
        {
                  "en": "Validation curves show model accuracy, learning curves show training time",
                  "es": "Curvas de validación muestran precisión del modelo, curvas de aprendizaje muestran tiempo de entrenamiento",
                  "de": "Validierungskurven zeigen Modellgenauigkeit, Lernkurven zeigen Trainingszeit",
                  "nl": "Validatiecurves tonen modelnauwkeurigheid, leercurves tonen trainingstijd"
        },
        {
                  "en": "Validation curves plot performance vs hyperparameter values, learning curves plot performance vs training set size",
                  "es": "Curvas validación grafican rendimiento vs valores hiperparámetros, curvas aprendizaje grafican rendimiento vs tamaño conjunto entrenamiento",
                  "de": "Validierungskurven plotten Leistung vs Hyperparameter-Werte, Lernkurven plotten Leistung vs Trainingssatz-Größe",
                  "nl": "Validatiecurves plotten prestaties vs hyperparameterwaarden, leercurves plotten prestaties vs trainingssetgrootte"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Monitors validation performance during training and stops when validation error stops improving or starts increasing",
                  "es": "Monitorea rendimiento de validación durante entrenamiento y se detiene cuando error de validación deja de mejorar o comienza a aumentar",
                  "de": "Überwacht Validierungsleistung während Training und stoppt wenn Validierungsfehler sich nicht mehr verbessert oder zu steigen beginnt",
                  "nl": "Monitort validatieprestaties tijdens training en stopt wanneer validatiefout stopt met verbeteren of begint te stijgen"
        },
        {
                  "en": "Terminates training when computational resources are exhausted",
                  "es": "Termina entrenamiento cuando recursos computacionales se agotan",
                  "de": "Beendet Training wenn Rechenressourcen erschöpft sind",
                  "nl": "Beëindigt training wanneer computationele middelen uitgeput zijn"
        },
        {
                  "en": "Stops training after a predetermined number of epochs",
                  "es": "Detiene entrenamiento después de un número predeterminado de épocas",
                  "de": "Stoppt Training nach einer vorbestimmten Anzahl von Epochen",
                  "nl": "Stopt training na een vooraf bepaald aantal epochs"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Schedules when to run hyperparameter optimization",
                  "es": "Programa cuándo ejecutar optimización de hiperparámetros",
                  "de": "Plant wann Hyperparameter-Optimierung ausgeführt wird",
                  "nl": "Plant wanneer hyperparameter optimalisatie uit te voeren"
        },
        {
                  "en": "Sets fixed hyperparameter values for each training phase",
                  "es": "Establece valores fijos de hiperparámetros para cada fase de entrenamiento",
                  "de": "Setzt feste Hyperparameter-Werte für jede Trainingsphase",
                  "nl": "Stelt vaste hyperparameterwaarden in voor elke trainingsfase"
        },
        {
                  "en": "Dynamically adjusts hyperparameters during training based on training progress for better convergence and performance",
                  "es": "Ajusta dinámicamente hiperparámetros durante entrenamiento basado en progreso de entrenamiento para mejor convergencia y rendimiento",
                  "de": "Passt Hyperparameter dynamisch während Training basierend auf Trainingsfortschritt für bessere Konvergenz und Leistung an",
                  "nl": "Past hyperparameters dynamisch aan tijdens training gebaseerd op trainingsvoortgang voor betere convergentie en prestaties"
        },
        {
                  "en": "Automatically selects optimal training duration",
                  "es": "Selecciona automáticamente duración óptima de entrenamiento",
                  "de": "Wählt automatisch optimale Trainingsdauer",
                  "nl": "Selecteert automatisch optimale trainingsduur"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Targets multiple machine learning algorithms",
                  "es": "Apunta a múltiples algoritmos de machine learning",
                  "de": "Zielt auf mehrere maschinelle Lernalgorithmen",
                  "nl": "Richt zich op meerdere machine learning algoritmes"
        },
        {
                  "en": "Optimizes hyperparameters for multiple datasets",
                  "es": "Optimiza hiperparámetros para múltiples conjuntos de datos",
                  "de": "Optimiert Hyperparameter für mehrere Datensätze",
                  "nl": "Optimaliseert hyperparameters voor meerdere datasets"
        },
        {
                  "en": "Uses multiple optimization algorithms simultaneously",
                  "es": "Usa múltiples algoritmos de optimización simultáneamente",
                  "de": "Verwendet mehrere Optimierungsalgorithmen gleichzeitig",
                  "nl": "Gebruikt meerdere optimalisatie-algoritmes gelijktijdig"
        },
        {
                  "en": "Simultaneously optimizes multiple conflicting objectives like accuracy, speed, and memory usage to find Pareto-optimal solutions",
                  "es": "Optimiza simultáneamente múltiples objetivos conflictivos como precisión, velocidad y memoria para encontrar soluciones Pareto-óptimas",
                  "de": "Optimiert gleichzeitig mehrere widersprüchliche Ziele wie Genauigkeit, Geschwindigkeit und Speicherverbrauch um Pareto-optimale Lösungen zu finden",
                  "nl": "Optimaliseert gelijktijdig meerdere conflicterende doelstellingen zoals nauwkeurigheid, snelheid en geheugengebruik om Pareto-optimale oplossingen te vinden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Held-out validation works only with large datasets",
                  "es": "Validación retenida funciona solo con conjuntos de datos grandes",
                  "de": "Held-Out Validierung funktioniert nur mit großen Datensätzen",
                  "nl": "Held-out validation werkt alleen met grote datasets"
        },
        {
                  "en": "Held-out validation is more accurate than cross-validation",
                  "es": "Validación retenida es más precisa que validación cruzada",
                  "de": "Held-Out Validierung ist genauer als Kreuzvalidierung",
                  "nl": "Held-out validation is nauwkeuriger dan cross-validation"
        },
        {
                  "en": "Held-out uses single validation split, cross-validation uses multiple splits for more robust estimates but higher computation",
                  "es": "Retenida usa división única de validación, validación cruzada usa múltiples divisiones para estimaciones más robustas pero mayor computación",
                  "de": "Held-Out verwendet einzelne Validierungsaufteilung, Kreuzvalidierung verwendet mehrere Aufteilungen für robustere Schätzungen aber höhere Berechnung",
                  "nl": "Held-out gebruikt enkele validatiesplit, cross-validation gebruikt meerdere splits voor robuustere schattingen maar hogere berekening"
        },
        {
                  "en": "Cross-validation requires labeled data while held-out doesn't",
                  "es": "Validación cruzada requiere datos etiquetados mientras retenida no",
                  "de": "Kreuzvalidierung benötigt beschriftete Daten während Held-Out nicht",
                  "nl": "Cross-validation vereist gelabelde data terwijl held-out dat niet doet"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Regularize the coordinate system of features",
                  "es": "Regularizar el sistema de coordenadas de características",
                  "de": "Das Koordinatensystem der Features regularisieren",
                  "nl": "Het coördinatensysteem van features regulariseren"
        },
        {
                  "en": "Descend along coordinate axes for faster convergence",
                  "es": "Descender a lo largo de ejes de coordenadas para convergencia más rápida",
                  "de": "Entlang Koordinatenachsen absteigen für schnellere Konvergenz",
                  "nl": "Langs coördinatenassen afdalen voor snellere convergentie"
        },
        {
                  "en": "Coordinate different optimization algorithms",
                  "es": "Coordinar diferentes algoritmos de optimización",
                  "de": "Verschiedene Optimierungsalgorithmen koordinieren",
                  "nl": "Verschillende optimalisatie-algoritmes coördineren"
        },
        {
                  ...
                  "es": "Computar eficientemente soluciones a través de todo el rango de parámetros de regularización para encontrar fuerza de regularización óptima",
                  "de": "Effizient Lösungen über den gesamten Bereich von Regularisierungsparametern berechnen um optimale Regularisierungsstärke zu finden",
                  "nl": "Efficiënt oplossingen berekenen over hele bereik van regularisatieparameters om optimale regularisatiesterkte te vinden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only automates hyperparameter optimization",
                  "es": "Solo automatiza optimización de hiperparámetros",
                  "de": "Automatisiert nur Hyperparameter-Optimierung",
                  "nl": "Automatiseert alleen hyperparameter optimalisatie"
        },
        {
                  "en": "Automates data collection and labeling",
                  "es": "Automatiza recolección y etiquetado de datos",
                  "de": "Automatisiert Datensammlung und Beschriftung",
                  "nl": "Automatiseert dataverzameling en labeling"
        },
        {
                  "en": "Uses only machine learning for optimization",
                  "es": "Usa solo machine learning para optimización",
                  "de": "Verwendet nur maschinelles Lernen für Optimierung",
                  "nl": "Gebruikt alleen machine learning voor optimalisatie"
        },
        {
                  "en": "Automates entire ML pipeline including algorithm selection, feature engineering, and hyperparameter tuning using sophisticated search strategies",
                  "es": "Automatiza toda la pipeline ML incluyendo selección algoritmos, ingeniería características y ajuste hiperparámetros con estrategias búsqueda sofisticadas",
                  "de": "Automatisiert die gesamte ML-Pipeline einschließlich Algorithmusauswahl, Feature Engineering und Hyperparameter-Tuning mit ausgeklügelten Suchstrategien",
                  "nl": "Automatiseert hele ML pipeline inclusief algoritme selectie, feature engineering en hyperparameter tuning met geavanceerde zoekstrategieën"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learns from previous optimization experiences to warm-start hyperparameter search on new but similar datasets or tasks",
                  "es": "Aprende de experiencias optimización previas para inicializar búsqueda hiperparámetros en conjuntos datos o tareas nuevos pero similares",
                  "de": "Lernt aus vorherigen Optimierungserfahrungen um Hyperparameter-Suche auf neuen aber ähnlichen Datensätzen oder Aufgaben warm zu starten",
                  "nl": "Leert van vorige optimalisatie-ervaringen om hyperparameter zoeken warm op te starten op nieuwe maar vergelijkbare datasets of taken"
        },
        {
                  "en": "Learns metadata about dataset characteristics",
                  "es": "Aprende metadatos sobre características del conjunto de datos",
                  "de": "Lernt Metadaten über Datensatz-Eigenschaften",
                  "nl": "Leert metadata over dataset karakteristieken"
        },
        {
                  "en": "Meta-optimizes the optimization algorithms themselves",
                  "es": "Meta-optimiza los algoritmos de optimización mismos",
                  "de": "Meta-optimiert die Optimierungsalgorithmen selbst",
                  "nl": "Meta-optimaliseert de optimalisatie-algoritmes zelf"
        },
        {
                  "en": "Only applies to neural network architectures",
                  "es": "Solo se aplica a arquitecturas de redes neuronales",
                  "de": "Gilt nur für neuronale Netzwerkarchitekturen",
                  "nl": "Geldt alleen voor neurale netwerkarchitecturen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uniform Manifold Approximation preserves global and local structure, often faster than t-SNE with better scalability",
                  "es": "Uniform Manifold Approximation preserva estructura global y local, a menudo más rápido que t-SNE con mejor escalabilidad",
                  "de": "Uniform Manifold Approximation erhält globale und lokale Struktur, oft schneller als t-SNE mit besserer Skalierbarkeit",
                  "nl": "Uniform Manifold Approximation behoudt globale en lokale structuur, vaak sneller dan t-SNE met betere schaalbaarheid"
        },
        {
                  "en": "UMAP is only for categorical data",
                  "es": "UMAP es solo para datos categóricos",
                  "de": "UMAP ist nur für kategorische Daten",
                  "nl": "UMAP is alleen voor categorische data"
        },
        {
                  "en": "UMAP cannot preserve cluster structures",
                  "es": "UMAP no puede preservar estructuras de clusters",
                  "de": "UMAP kann Cluster-Strukturen nicht erhalten",
                  "nl": "UMAP kan clusterstructuren niet behouden"
        },
        {
                  "en": "UMAP requires more computational resources than t-SNE",
                  "es": "UMAP requiere más recursos computacionales que t-SNE",
                  "de": "UMAP benötigt mehr Rechenressourcen als t-SNE",
                  "nl": "UMAP vereist meer computationele middelen dan t-SNE"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Clusters data based on color spectrum",
                  "es": "Agrupa datos basado en espectro de color",
                  "de": "Clustert Daten basierend auf Farbspektrum",
                  "nl": "Clustert data gebaseerd op kleurenspectrum"
        },
        {
                  "en": "Analyzes frequency spectrum of data points",
                  "es": "Analiza espectro de frecuencia de puntos de datos",
                  "de": "Analysiert Frequenzspektrum von Datenpunkten",
                  "nl": "Analyseert frequentiespectrum van datapunten"
        },
        {
                  "en": "Uses eigenvalues of similarity matrix to reduce dimensions before clustering, handles non-convex clusters",
                  "es": "Usa valores propios de matriz de similitud para reducir dimensiones antes de clustering, maneja clusters no convexos",
                  "de": "Verwendet Eigenwerte der Ähnlichkeitsmatrix um Dimensionen vor Clustering zu reduzieren, behandelt nicht-konvexe Cluster",
                  "nl": "Gebruikt eigenwaarden van similariteitsmatrix om dimensies te reduceren voor clustering, behandelt niet-convexe clusters"
        },
        {
                  "en": "Only works with spectral data types",
                  "es": "Solo funciona con tipos de datos espectrales",
                  "de": "Funktioniert nur mit spektralen Datentypen",
                  "nl": "Werkt alleen met spectrale datatypes"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "GMM is always faster than k-means",
                  "es": "GMM siempre es más rápido que k-means",
                  "de": "GMM ist immer schneller als k-means",
                  "nl": "GMM is altijd sneller dan k-means"
        },
        {
                  "en": "GMM uses probabilistic soft assignment to clusters with different shapes/sizes, k-means uses hard assignment to spherical clusters",
                  "es": "GMM usa asignación suave probabilística a clusters con formas/tamaños diferentes, k-means usa asignación dura a clusters esféricos",
                  "de": "GMM verwendet probabilistische weiche Zuordnung zu Clustern mit verschiedenen Formen/Größen, k-means verwendet harte Zuordnung zu sphärischen Clustern",
                  "nl": "GMM gebruikt probabilistische zachte toewijzing aan clusters met verschillende vormen/groottes, k-means gebruikt harde toewijzing aan sferische clusters"
        },
        {
                  "en": "GMM works only with Gaussian distributions",
                  "es": "GMM funciona solo con distribuciones gaussianas",
                  "de": "GMM funktioniert nur mit Gaussschen Verteilungen",
                  "nl": "GMM werkt alleen met Gaussiaanse distributies"
        },
        {
                  "en": "GMM requires labeled training data",
                  "es": "GMM requiere datos de entrenamiento etiquetados",
                  "de": "GMM benötigt beschriftete Trainingsdaten",
                  "nl": "GMM vereist gelabelde trainingsdata"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Iteratively estimates cluster assignments (E-step) and updates parameters (M-step) to maximize likelihood",
                  "es": "Estima iterativamente asignaciones de clusters (paso-E) y actualiza parámetros (paso-M) para maximizar verosimilitud",
                  "de": "Schätzt iterativ Cluster-Zuordnungen (E-Schritt) und aktualisiert Parameter (M-Schritt) um Likelihood zu maximieren",
                  "nl": "Schat iteratief clustertoewijzingen (E-stap) en werkt parameters bij (M-stap) om likelihood te maximaliseren"
        },
        {
                  "en": "Explores models and selects maximum performance",
                  "es": "Explora modelos y selecciona máximo rendimiento",
                  "de": "Erkundet Modelle und wählt maximale Leistung",
                  "nl": "Verkent modellen en selecteert maximale prestaties"
        },
        {
                  "en": "Estimates missing data and maximizes accuracy",
                  "es": "Estima datos faltantes y maximiza precisión",
                  "de": "Schätzt fehlende Daten und maximiert Genauigkeit",
                  "nl": "Schat ontbrekende data en maximaliseert nauwkeurigheid"
        },
        {
                  "en": "Expects clusters and maximizes their separation",
                  "es": "Espera clusters y maximiza su separación",
                  "de": "Erwartet Cluster und maximiert ihre Trennung",
                  "nl": "Verwacht clusters en maximaliseert hun scheiding"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Always provides a definitive optimal k value",
                  "es": "Siempre proporciona un valor k óptimo definitivo",
                  "de": "Bietet immer einen definitiven optimalen k-Wert",
                  "nl": "Biedt altijd een definitieve optimale k waarde"
        },
        {
                  "en": "Plots within-cluster variance vs k, optimal k is at elbow where adding clusters yields diminishing returns",
                  "es": "Grafica varianza intra-cluster vs k, k óptimo está en codo donde agregar clusters produce rendimientos decrecientes",
                  "de": "Plottet Innerhalb-Cluster-Varianz vs k, optimales k ist am Ellbogen wo Hinzufügen von Clustern abnehmende Erträge liefert",
                  "nl": "Plot binnen-cluster variantie vs k, optimale k is bij elbow waar toevoegen van clusters afnemende opbrengsten oplevert"
        },
        {
                  "en": "Uses elbow joint angle to measure cluster separation",
                  "es": "Usa ángulo de articulación del codo para medir separación de clusters",
                  "de": "Verwendet Ellbogengelenkwinkel um Cluster-Trennung zu messen",
                  "nl": "Gebruikt ellebooggewrichthoek om clusterscheiding te meten"
        },
        {
                  "en": "Bends the feature space to optimize clustering",
                  "es": "Dobla el espacio de características para optimizar clustering",
                  "de": "Biegt den Feature-Raum um Clustering zu optimieren",
                  "nl": "Buigt de feature ruimte om clustering te optimaliseren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Inliers are inside the dataset, outliers are outside",
                  "es": "Valores internos están dentro del conjunto de datos, valores atípicos están fuera",
                  "de": "Inliers sind innerhalb des Datensatzes, Outliers sind außerhalb",
                  "nl": "Inliers zijn binnen de dataset, outliers zijn buiten"
        },
        {
                  "en": "Outliers are always errors in data collection",
                  "es": "Valores atípicos son siempre errores en recolección de datos",
                  "de": "Outliers sind immer Fehler in Datensammlung",
                  "nl": "Outliers zijn altijd fouten in dataverzameling"
        },
        {
                  "en": "Inliers are more important than outliers",
                  "es": "Valores internos son más importantes que valores atípicos",
                  "de": "Inliers sind wichtiger als Outliers",
                  "nl": "Inliers zijn belangrijker dan outliers"
        },
        {
                  "en": "Inliers conform to normal data patterns, outliers deviate significantly from expected behavior",
                  "es": "Valores internos se conforman a patrones de datos normales, valores atípicos se desvían significativamente de comportamiento esperado",
                  "de": "Inliers entsprechen normalen Datenmustern, Outliers weichen signifikant vom erwarteten Verhalten ab",
                  "nl": "Inliers conformeren aan normale datapatronen, outliers wijken significant af van verwacht gedrag"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses forest density to detect anomalies",
                  "es": "Usa densidad del bosque para detectar anomalías",
                  "de": "Verwendet Walddichte um Anomalien zu erkennen",
                  "nl": "Gebruikt bosdichtheid om anomalieën te detecteren"
        },
        {
                  "en": "Builds random trees where anomalies are isolated faster with shorter paths due to their distinctiveness",
                  "es": "Construye árboles aleatorios donde anomalías se aíslan más rápido con caminos más cortos debido a su distintividad",
                  "de": "Baut zufällige Bäume wo Anomalien schneller mit kürzeren Pfaden isoliert werden aufgrund ihrer Unterscheidbarkeit",
                  "nl": "Bouwt willekeurige bomen waar anomalieën sneller worden geïsoleerd met kortere paden vanwege hun onderscheidendheid"
        },
        {
                  "en": "Isolates anomalies in separate forest regions",
                  "es": "Aísla anomalías en regiones forestales separadas",
                  "de": "Isoliert Anomalien in separaten Waldregionen",
                  "nl": "Isoleert anomalieën in aparte bosregio's"
        },
        {
                  "en": "Requires labeled anomaly examples for training",
                  "es": "Requiere ejemplos de anomalías etiquetadas para entrenamiento",
                  "de": "Benötigt beschriftete Anomalie-Beispiele für Training",
                  "nl": "Vereist gelabelde anomalie voorbeelden voor training"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learns decision boundary around normal data in high-dimensional space, classifies points outside as anomalies",
                  "es": "Aprende límite de decisión alrededor de datos normales en espacio de alta dimensión, clasifica puntos fuera como anomalías",
                  "de": "Lernt Entscheidungsgrenze um normale Daten in hochdimensionalem Raum, klassifiziert Punkte außerhalb als Anomalien",
                  "nl": "Leert beslissingsgrens rond normale data in hoogdimensionale ruimte, classificeert punten buiten als anomalieën"
        },
        {
                  "en": "Uses a single support vector for classification",
                  "es": "Usa un solo vector de soporte para clasificación",
                  "de": "Verwendet einen einzelnen Support-Vektor für Klassifikation",
                  "nl": "Gebruikt één enkele support vector voor classificatie"
        },
        {
                  "en": "Only works with one class of labeled data",
                  "es": "Solo funciona con una clase de datos etiquetados",
                  "de": "Funktioniert nur mit einer Klasse beschrifteter Daten",
                  "nl": "Werkt alleen met één klasse gelabelde data"
        },
        {
                  "en": "Detects anomalies in univariate data only",
                  "es": "Detecta anomalías solo en datos univariados",
                  "de": "Erkennt Anomalien nur in univariaten Daten",
                  "nl": "Detecteert anomalieën alleen in univariate data"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dimensions become cursed after data transformation",
                  "es": "Dimensiones se maldicen después de transformación de datos",
                  "de": "Dimensionen werden verflucht nach Datentransformation",
                  "nl": "Dimensies worden vervloekt na datatransformatie"
        },
        {
                  "en": "High dimensions make distances uniform and data sparse, reducing clustering effectiveness and requiring dimensionality reduction",
                  "es": "Altas dimensiones hacen distancias uniformes y datos dispersos, reduciendo efectividad de clustering y requiriendo reducción de dimensionalidad",
                  "de": "Hohe Dimensionen machen Abstände uniform und Daten spärlich, reduziert Clustering-Effektivität und erfordert Dimensionalitätsreduktion",
                  "nl": "Hoge dimensies maken afstanden uniform en data schaars, vermindert clustering effectiviteit en vereist dimensionaliteitsreductie"
        },
        {
                  "en": "Only affects supervised learning algorithms",
                  "es": "Solo afecta algoritmos de aprendizaje supervisado",
                  "de": "Betrifft nur überwachte Lernalgorithmen",
                  "nl": "Beïnvloedt alleen gesuperviseerde leeralgoritmes"
        },
        {
                  "en": "More dimensions always improve clustering quality",
                  "es": "Más dimensiones siempre mejoran calidad de clustering",
                  "de": "Mehr Dimensionen verbessern immer Clustering-Qualität",
                  "nl": "Meer dimensies verbeteren altijd clustering kwaliteit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Divisive clustering is always faster",
                  "es": "Clustering divisivo siempre es más rápido",
                  "de": "Divisives Clustering ist immer schneller",
                  "nl": "Divisieve clustering is altijd sneller"
        },
        {
                  "en": "Agglomerative adds points, divisive removes outliers",
                  "es": "Aglomerativo agrega puntos, divisivo elimina valores atípicos",
                  "de": "Agglomerativ fügt Punkte hinzu, divisiv entfernt Ausreißer",
                  "nl": "Agglomeratief voegt punten toe, divisief verwijdert uitbijters"
        },
        {
                  "en": "Agglomerative starts with individual points and merges, divisive starts with all points and splits clusters",
                  "es": "Aglomerativo comienza con puntos individuales y fusiona, divisivo comienza con todos los puntos y divide clusters",
                  "de": "Agglomerativ beginnt mit einzelnen Punkten und verschmilzt, divisiv beginnt mit allen Punkten und teilt Cluster",
                  "nl": "Agglomeratief begint met individuele punten en voegt samen, divisief begint met alle punten en splitst clusters"
        },
        {
                  "en": "Agglomerative requires fewer computational resources",
                  "es": "Aglomerativo requiere menos recursos computacionales",
                  "de": "Agglomerativ benötigt weniger Rechenressourcen",
                  "nl": "Agglomeratief vereist minder computationele middelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Determine when to stop merging clusters",
                  "es": "Determinan cuándo dejar de fusionar clusters",
                  "de": "Bestimmen wann Cluster-Verschmelzung gestoppt wird",
                  "nl": "Bepalen wanneer stoppen met samenvoegen van clusters"
        },
        {
                  "en": "All linkage methods produce identical results",
                  "es": "Todos los métodos de enlace producen resultados idénticos",
                  "de": "Alle Verknüpfungsmethoden produzieren identische Ergebnisse",
                  "nl": "Alle linkage methoden produceren identieke resultaten"
        },
        {
                  "en": "Define cluster distance: single (minimum), complete (maximum), average, ward (variance minimization)",
                  "es": "Definen distancia de cluster: simple (mínimo), completo (máximo), promedio, ward (minimización de varianza)",
                  "de": "Definieren Cluster-Distanz: single (minimum), complete (maximum), average, ward (Varianzminimierung)",
                  "nl": "Definiëren clusterafstand: single (minimum), complete (maximum), average, ward (variantieminimalisatie)"
        },
        {
                  "en": "Link clusters based on density thresholds",
                  "es": "Enlazan clusters basado en umbrales de densidad",
                  "de": "Verknüpfen Cluster basierend auf Dichteschwellen",
                  "nl": "Koppelen clusters gebaseerd op dichtheidsdrempels"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Requires labeled data for calculation",
                  "es": "Requiere datos etiquetados para cálculo",
                  "de": "Benötigt beschriftete Daten für Berechnung",
                  "nl": "Vereist gelabelde data voor berekening"
        },
        {
                  "en": "Higher values always mean better clustering",
                  "es": "Valores más altos siempre significan mejor clustering",
                  "de": "Höhere Werte bedeuten immer besseres Clustering",
                  "nl": "Hogere waarden betekenen altijd betere clustering"
        },
        {
                  "en": "Only applicable to k-means clustering",
                  "es": "Solo aplicable a clustering k-means",
                  "de": "Nur anwendbar auf k-means Clustering",
                  "nl": "Alleen toepasbaar op k-means clustering"
        },
        {
                  "en": "Measures cluster separation and compactness; lower values indicate better-defined, well-separated clusters",
                  "es": "Mide separación y compacidad de clusters; valores más bajos indican clusters mejor definidos y bien separados",
                  "de": "Misst Cluster-Trennung und Kompaktheit; niedrigere Werte zeigen besser definierte, gut getrennte Cluster an",
                  "nl": "Meet clusterscheiding en compactheid; lagere waarden geven beter gedefinieerde, goed gescheiden clusters aan"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Requires labeled data for supervised reduction",
                  "es": "Requiere datos etiquetados para reducción supervisada",
                  "de": "Benötigt beschriftete Daten für überwachte Reduktion",
                  "nl": "Vereist gelabelde data voor gesuperviseerde reductie"
        },
        {
                  "en": "Removes principal features from the dataset",
                  "es": "Elimina características principales del conjunto de datos",
                  "de": "Entfernt Hauptmerkmale aus dem Datensatz",
                  "nl": "Verwijdert principale features uit de dataset"
        },
        {
                  "en": "Analyzes only categorical components",
                  "es": "Analiza solo componentes categóricos",
                  "de": "Analysiert nur kategorische Komponenten",
                  "nl": "Analyseert alleen categorische componenten"
        },
        {
                  "en": "Finds orthogonal directions of maximum variance and projects data onto top principal components",
                  "es": "Encuentra direcciones ortogonales de máxima varianza y proyecta datos en componentes principales superiores",
                  "de": "Findet orthogonale Richtungen maximaler Varianz und projiziert Daten auf Top-Hauptkomponenten",
                  "nl": "Vindt orthogonale richtingen van maximale variantie en projecteert data op top principale componenten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "PCA requires labeled data, LDA doesn't",
                  "es": "PCA requiere datos etiquetados, LDA no",
                  "de": "PCA benötigt beschriftete Daten, LDA nicht",
                  "nl": "PCA vereist gelabelde data, LDA niet"
        },
        {
                  "en": "PCA is supervised, LDA is unsupervised",
                  "es": "PCA es supervisado, LDA es no supervisado",
                  "de": "PCA ist überwacht, LDA ist unüberwacht",
                  "nl": "PCA is gesuperviseerd, LDA is ongesuperviseerd"
        },
        {
                  "en": "LDA is always better than PCA",
                  "es": "LDA siempre es mejor que PCA",
                  "de": "LDA ist immer besser als PCA",
                  "nl": "LDA is altijd beter dan PCA"
        },
        {
                  "en": "PCA maximizes variance (unsupervised), LDA maximizes class separability (supervised)",
                  "es": "PCA maximiza varianza (no supervisado), LDA maximiza separabilidad de clases (supervisado)",
                  "de": "PCA maximiert Varianz (unüberwacht), LDA maximiert Klassentrennung (überwacht)",
                  "nl": "PCA maximaliseert variantie (ongesuperviseerd), LDA maximaliseert klassenscheidbaarheid (gesuperviseerd)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mines rules only from labeled datasets",
                  "es": "Mina reglas solo de conjuntos de datos etiquetados",
                  "de": "Schürft Regeln nur aus beschrifteten Datensätzen",
                  "nl": "Delft regels alleen uit gelabelde datasets"
        },
        {
                  "en": "Prioritizes important features before analysis",
                  "es": "Prioriza características importantes antes del análisis",
                  "de": "Priorisiert wichtige Features vor der Analyse",
                  "nl": "Prioriteert belangrijke features voor analyse"
        },
        {
                  "en": "Associates features with target variables",
                  "es": "Asocia características con variables objetivo",
                  "de": "Assoziiert Features mit Zielvariablen",
                  "nl": "Associeert features met doelvariabelen"
        },
        {
                  "en": "Discovers frequent itemsets and rules showing relationships between items, used for market basket analysis",
                  "es": "Descubre conjuntos de ítems frecuentes y reglas que muestran relaciones entre ítems, usado para análisis de cesta de mercado",
                  "de": "Entdeckt häufige Itemsets und Regeln die Beziehungen zwischen Items zeigen, verwendet für Warenkorbanalyse",
                  "nl": "Ontdekt frequente itemsets en regels die relaties tussen items tonen, gebruikt voor marktmandje analyse"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Support: frequency of itemset, confidence: conditional probability, lift: strength of association beyond randomness",
                  "es": "Soporte: frecuencia de conjunto de ítems, confianza: probabilidad condicional, lift: fuerza de asociación más allá de aleatoriedad",
                  "de": "Support: Häufigkeit des Itemsets, Confidence: bedingte Wahrscheinlichkeit, Lift: Stärke der Assoziation jenseits Zufälligkeit",
        ...
        {
                  "en": "Only support is needed for rule mining",
                  "es": "Solo se necesita soporte para minería de reglas",
                  "de": "Nur Support wird für Regel-Mining benötigt",
                  "nl": "Alleen support is nodig voor regel mining"
        },
        {
                  "en": "All three metrics measure the same thing",
                  "es": "Las tres métricas miden lo mismo",
                  "de": "Alle drei Metriken messen dasselbe",
                  "nl": "Alle drie de metrieken meten hetzelfde"
        },
        {
                  "en": "Support: data quality, confidence: model accuracy, lift: performance gain",
                  "es": "Soporte: calidad de datos, confianza: precisión del modelo, lift: ganancia de rendimiento",
                  "de": "Support: Datenqualität, Confidence: Modellgenauigkeit, Lift: Leistungsgewinn",
                  "nl": "Support: datakwaliteit, confidence: modelnauwkeurigheid, lift: prestatiewinst"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Kernel PCA is faster than standard PCA",
                  "es": "Kernel PCA es más rápido que PCA estándar",
                  "de": "Kernel PCA ist schneller als Standard-PCA",
                  "nl": "Kernel PCA is sneller dan standaard PCA"
        },
        {
                  "en": "Requires less computational resources",
                  "es": "Requiere menos recursos computacionales",
                  "de": "Benötigt weniger Rechenressourcen",
                  "nl": "Vereist minder computationele middelen"
        },
        {
                  "en": "Only works with small datasets",
                  "es": "Solo funciona con conjuntos de datos pequeños",
                  "de": "Funktioniert nur mit kleinen Datensätzen",
                  "nl": "Werkt alleen met kleine datasets"
        },
        {
                  "en": "Uses kernel trick to perform PCA in high-dimensional space, capturing non-linear patterns standard PCA misses",
                  "es": "Usa truco de kernel para realizar PCA en espacio de alta dimensión, capturando patrones no lineales que PCA estándar pierde",
                  "de": "Verwendet Kernel-Trick um PCA in hochdimensionalem Raum durchzuführen, erfasst nicht-lineare Muster die Standard-PCA verfehlt",
                  "nl": "Gebruikt kernel truc om PCA uit te voeren in hoogdimensionale ruimte, vangt niet-lineaire patronen die standaard PCA mist"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Negative matrix values improve accuracy",
                  "es": "Valores de matriz negativos mejoran precisión",
                  "de": "Negative Matrixwerte verbessern Genauigkeit",
                  "nl": "Negatieve matrixwaarden verbeteren nauwkeurigheid"
        },
        {
                  "en": "Decomposes data into non-negative factors, producing additive parts-based representations easier to interpret",
                  "es": "Descompone datos en factores no negativos, produciendo representaciones aditivas basadas en partes más fáciles de interpretar",
                  "de": "Zerlegt Daten in nicht-negative Faktoren, produziert additive teilebasierte Darstellungen die einfacher zu interpretieren sind",
                  "nl": "Decomponneert data in niet-negatieve factoren, produceert additieve op onderdelen gebaseerde representaties die makkelijker te interpreteren zijn"
        },
        {
                  "en": "Only works with negative values in datasets",
                  "es": "Solo funciona con valores negativos en conjuntos de datos",
                  "de": "Funktioniert nur mit negativen Werten in Datensätzen",
                  "nl": "Werkt alleen met negatieve waarden in datasets"
        },
        {
                  "en": "NMF is always faster than PCA",
                  "es": "NMF siempre es más rápido que PCA",
                  "de": "NMF ist immer schneller als PCA",
                  "nl": "NMF is altijd sneller dan PCA"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hard assigns each point to exactly one cluster, soft allows probabilistic membership in multiple clusters",
                  "es": "Duro asigna cada punto a exactamente un cluster, suave permite membresía probabilística en múltiples clusters",
                  "de": "Hart weist jeden Punkt genau einem Cluster zu, weich erlaubt probabilistische Zugehörigkeit in mehreren Clustern",
                  "nl": "Hard wijst elk punt toe aan precies één cluster, zacht staat probabilistische lidmaatschap in meerdere clusters toe"
        },
        {
                  "en": "Hard clustering produces better results",
                  "es": "Clustering duro produce mejores resultados",
                  "de": "Hartes Clustering produziert bessere Ergebnisse",
                  "nl": "Hard clustering produceert betere resultaten"
        },
        {
                  "en": "Soft clustering requires labeled data",
                  "es": "Clustering suave requiere datos etiquetados",
                  "de": "Weiches Clustering benötigt beschriftete Daten",
                  "nl": "Zacht clustering vereist gelabelde data"
        },
        {
                  "en": "Hard clustering is more computationally intensive",
                  "es": "Clustering duro es más intensivo computacionalmente",
                  "de": "Hartes Clustering ist rechenintensiver",
                  "nl": "Hard clustering is computationeel intensiever"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Local outliers require more computational resources",
                  "es": "Valores atípicos locales requieren más recursos computacionales",
                  "de": "Lokale Outliers benötigen mehr Rechenressourcen",
                  "nl": "Lokale outliers vereisen meer computationele middelen"
        },
        {
                  "en": "Global outliers are always easier to detect",
                  "es": "Valores atípicos globales siempre son más fáciles de detectar",
                  "de": "Globale Outliers sind immer einfacher zu erkennen",
                  "nl": "Globale outliers zijn altijd makkelijker te detecteren"
        },
        {
                  "en": "Local outliers are less important than global outliers",
                  "es": "Valores atípicos locales son menos importantes que valores atípicos globales",
                  "de": "Lokale Outliers sind weniger wichtig als globale Outliers",
                  "nl": "Lokale outliers zijn minder belangrijk dan globale outliers"
        },
        {
                  "en": "Global outliers deviate from entire dataset, local outliers deviate only from their neighborhood despite being normal globally",
                  "es": "Valores atípicos globales se desvían de todo el conjunto de datos, valores atípicos locales se desvían solo de su vecindario a pesar de ser normales globalmente",
                  "de": "Globale Outliers weichen vom gesamten Datensatz ab, lokale Outliers weichen nur von ihrer Nachbarschaft ab trotz global normal zu sein",
                  "nl": "Globale outliers wijken af van hele dataset, lokale outliers wijken alleen af van hun buurt ondanks globaal normaal te zijn"
        }
        ],
        correct: 3,
        explanation: {
