  ...
  const level3 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Highly detailed maps with centimeter-level precision including lane markings, signs, and 3D road features", es: "Mapas altamente detallados con precisión a nivel de centímetro incluyendo marcas de carril, señales y características 3D de carretera", de: "Hochdetaillierte Karten mit zentimeterpräzision einschließlich Fahrbahnmarkierungen, Schilder und 3D-Straßenmerkmale", nl: "Zeer gedetailleerde kaarten met centimeter-niveau precisie inclusief rijstrookmarkeringen, borden en 3D-wegkenmerken" },
          { en: "High-definition video recording of routes", es: "Grabación de video de alta definición de rutas", de: "Hochauflösende Videoaufnahme von Routen", nl: "High-definition video-opname van routes" },
          { en: "Maps displayed on HD screens only", es: "Mapas mostrados solo en pantallas HD", de: "Nur auf HD-Bildschirmen angezeigte Karten", nl: "Kaarten alleen weergegeven op HD-schermen" },
          { en: "Hard drive storage of standard maps", es: "Almacenamiento en disco duro de mapas estándar", de: "Festplattenspeicherung von Standardkarten", nl: "Harde schijf opslag van standaard kaarten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Continuously monitoring detected objects across multiple frames to predict their future trajectories", es: "Monitorear continuamente objetos detectados a través de múltiples fotogramas para predecir sus trayectorias futuras", de: "Kontinuierliche Überwachung erkannter Objekte über mehrere Frames um ihre zukünftigen Trajektorien vorherzusagen", nl: "Continu gedetecteerde objecten monitoren over meerdere frames om hun toekomstige trajecten te voorspellen" },
          { en: "GPS tracking of the vehicle only", es: "Solo rastreo GPS del vehículo", de: "Nur GPS-Verfolgung des Fahrzeugs", nl: "Alleen GPS-tracking van het voertuig" },
          { en: "Tracking vehicle maintenance schedules", es: "Rastrear horarios de mantenimiento de vehículos", de: "Fahrzeugwartungspläne verfolgen", nl: "Voertuig onderhoudsschema's volgen" },
          { en: "Recording object colors and shapes", es: "Registrar colores y formas de objetos", de: "Objektfarben und -formen aufzeichnen", nl: "Object kleuren en vormen registreren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Identifying not just what objects are but understanding their relationships and context", es: "Identificar no solo qué son los objetos sino entender sus relaciones y contexto", de: "Nicht nur identifizieren was Objekte sind sondern ihre Beziehungen und Kontext verstehen", nl: "Niet alleen identificeren wat objecten zijn maar hun relaties en context begrijpen" },
          { en: "Understanding only traffic signs meanings", es: "Entender solo significados de señales de tráfico", de: "Nur Verkehrsschildbedeutungen verstehen", nl: "Alleen verkeersbord betekenissen begrijpen" },
          { en: "Scene detection for photography", es: "Detección de escena para fotografía", de: "Szenenerkennung für Fotografie", nl: "Scène detectie voor fotografie" },
          { en: "Semantic web browsing in vehicles", es: "Navegación web semántica en vehículos", de: "Semantisches Webbrowsing in Fahrzeugen", nl: "Semantisch web browsen in voertuigen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Detecting and tracking partially hidden objects behind other objects or obstacles", es: "Detectar y rastrear objetos parcialmente ocultos detrás de otros objetos u obstáculos", de: "Teilweise verdeckte Objekte hinter anderen Objekten oder Hindernissen erkennen und verfolgen", nl: "Gedeeltelijk verborgen objecten achter andere objecten of obstakels detecteren en volgen" },
          { en: "Blocking unwanted sensor data", es: "Bloquear datos no deseados de sensores", de: "Unerwünschte Sensordaten blockieren", nl: "Ongewenste sensordata blokkeren" },
          { en: "Handling vehicle occlusion in parking", es: "Manejar oclusión de vehículo al estacionar", de: "Fahrzeug-Okklusion beim Parken handhaben", nl: "Voertuig occlusie bij parkeren afhandelen" },
          { en: "Closing sensor covers when not in use", es: "Cerrar cubiertas de sensores cuando no están en uso", de: "Sensorabdeckungen schließen wenn nicht in Gebrauch", nl: "Sensorafdekkingen sluiten wanneer niet in gebruik" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Combining visual detail from cameras with precise distance and velocity data from radar", es: "Combinar detalle visual de cámaras con datos precisos de distancia y velocidad de radar", de: "Visuelle Details von Kameras mit präzisen Entfernungs- und Geschwindigkeitsdaten von Radar kombinieren", nl: "Visueel detail van camera's combineren met precieze afstand en snelheidsdata van radar" },
          { en: "Physically attaching cameras to radar units", es: "Adjuntar físicamente cámaras a unidades de radar", de: "Kameras physisch an Radareinheiten befestigen", nl: "Camera's fysiek aan radareenheden bevestigen" },
          { en: "Using camera and radar separately", es: "Usar cámara y radar por separado", de: "Kamera und Radar separat verwenden", nl: "Camera en radar afzonderlijk gebruiken" },
          { en: "Radar controlling camera settings", es: "Radar controlando configuraciones de cámara", de: "Radar steuert Kameraeinstellungen", nl: "Radar regelt camera instellingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Monitoring sensor performance to detect dirt, damage, or malfunction affecting data quality", es: "Monitorear rendimiento de sensores para detectar suciedad, daño o mal funcionamiento afectando calidad de datos", de: "Sensorleistung überwachen um Schmutz, Schäden oder Fehlfunktionen zu erkennen die Datenqualität beeinflussen", nl: "Sensor prestaties monitoren om vuil, schade of storing te detecteren die datakwaliteit beïnvloedt" },
          { en: "Degrading sensor signals intentionally", es: "Degradar señales de sensores intencionalmente", de: "Sensorsignale absichtlich verschlechtern", nl: "Sensorsignalen opzettelijk verslechteren" },
          { en: "Detecting sensor age only", es: "Detectar solo edad del sensor", de: "Nur Sensoralter erkennen", nl: "Alleen sensor leeftijd detecteren" },
          { en: "Removing old sensors automatically", es: "Remover sensores viejos automáticamente", de: "Alte Sensoren automatisch entfernen", nl: "Oude sensoren automatisch verwijderen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Simultaneously tracking multiple road users and predicting their future movements for safe path planning", es: "Rastrear simultáneamente múltiples usuarios de carretera y predecir sus movimientos futuros para planificación de ruta segura", de: "Gleichzeitiges Verfolgen mehrerer Verkehrsteilnehmer und Vorhersagen ihrer zukünftigen Bewegungen für sichere Pfadplanung", nl: "Gelijktijdig meerdere weggebruikers volgen en hun toekomstige bewegingen voorspellen voor veilige pad planning" },
          { en: "Tracking only the closest object", es: "Rastrear solo el objeto más cercano", de: "Nur das nächste Objekt verfolgen", nl: "Alleen het dichtstbijzijnde object volgen" },
          { en: "Predicting object colors and shapes", es: "Predecir colores y formas de objetos", de: "Objektfarben und -formen vorhersagen", nl: "Object kleuren en vormen voorspellen" },
          { en: "Tracking vehicle parts separately", es: "Rastrear partes del vehículo por separado", de: "Fahrzeugteile separat verfolgen", nl: "Voertuigonderdelen afzonderlijk volgen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Dividing point cloud data into meaningful groups representing individual objects or surfaces", es: "Dividir datos de nube de puntos en grupos significativos representando objetos o superficies individuales", de: "Punktwolkendaten in bedeutungsvolle Gruppen unterteilen die einzelne Objekte oder Oberflächen repräsentieren", nl: "Puntenwolk data verdelen in betekenisvolle groepen die individuele objecten of oppervlakken vertegenwoordigen" },
          { en: "Storing point clouds in separate files", es: "Almacenar nubes de puntos en archivos separados", de: "Punktwolken in separaten Dateien speichern", nl: "Puntenwolken opslaan in aparte bestanden" },
          { en: "Segmenting cloud storage space", es: "Segmentar espacio de almacenamiento en nube", de: "Cloud-Speicherplatz segmentieren", nl: "Cloud opslagruimte segmenteren" },
          { en: "Breaking LiDAR into parts", es: "Romper LiDAR en partes", de: "LiDAR in Teile zerbrechen", nl: "LiDAR in delen breken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Synchronizing data from sensors with different capture rates to create coherent environmental understanding", es: "Sincronizar datos de sensores con diferentes tasas de captura para crear comprensión ambiental coherente", de: "Daten von Sensoren mit unterschiedlichen Erfassungsraten synchronisieren um kohärentes Umgebungsverständnis zu schaffen", nl: "Data van sensoren met verschillende opnamefrequenties synchroniseren om coherent omgevingsbegrip te creëren" },
          { en: "Arranging sensors in temporal order", es: "Ordenar sensores en orden temporal", de: "Sensoren in zeitlicher Reihenfolge anordnen", nl: "Sensoren in tijdelijke volgorde rangschikken" },
          { en: "Aligning sensors with time zones", es: "Alinear sensores con zonas horarias", de: "Sensoren mit Zeitzonen ausrichten", nl: "Sensoren met tijdzones uitlijnen" },
          { en: "Setting sensor clocks to correct time", es: "Ajustar relojes de sensores a tiempo correcto", de: "Sensoruhren auf richtige Zeit einstellen", nl: "Sensorklokken op juiste tijd zetten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Adjusting sensor algorithms and fusion strategies based on detected weather conditions", es: "Ajustar algoritmos de sensores y estrategias de fusión basándose en condiciones climáticas detectadas", de: "Sensoralgorithmen und Fusionsstrategien basierend auf erkannten Wetterbedingungen anpassen", nl: "Sensor algoritmes en fusie strategieën aanpassen op basis van gedetecteerde weersomstandigheden" },
          { en: "Only using sensors during good weather", es: "Solo usar sensores durante buen clima", de: "Nur Sensoren bei gutem Wetter verwenden", nl: "Alleen sensoren gebruiken bij goed weer" },
          { en: "Adapting to weather forecasts only", es: "Adaptarse solo a pronósticos del tiempo", de: "Nur an Wettervorhersagen anpassen", nl: "Alleen aanpassen aan weersvoorspellingen" },
          { en: "Processing weather data for navigation", es: "Procesar datos meteorológicos para navegación", de: "Wetterdaten für Navigation verarbeiten", nl: "Weersdata verwerken voor navigatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "3D spatial position plus velocity information for each detected point in the environment", es: "Posición espacial 3D más información de velocidad para cada punto detectado en el entorno", de: "3D-Raumposition plus Geschwindigkeitsinformationen für jeden erkannten Punkt in der Umgebung", nl: "3D ruimtelijke positie plus snelheidsinformatie voor elk gedetecteerd punt in de omgeving" },
          { en: "Four-dimensional mathematical radar calculations", es: "Cálculos matemáticos de radar de cuatro dimensiones", de: "Vierdimensionale mathematische Radarberechnungen", nl: "Vierdimensionale wiskundige radarbereke ningen" },
          { en: "Four separate radar units working together", es: "Cuatro unidades de radar separadas trabajando juntas", de: "Vier separate Radareinheiten die zusammenarbeiten", nl: "Vier aparte radareenheden die samenwerken" },
          { en: "Radar operating in four frequency bands", es: "Radar operando en cuatro bandas de frecuencia", de: "Radar das in vier Frequenzbändern arbeitet", nl: "Radar werkend in vier frequentiebanden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Automated systems using air jets, wipers, or fluid sprays to maintain sensor clarity", es: "Sistemas automatizados usando chorros de aire, limpiaparabrisas o rociadores de fluido para mantener claridad de sensores", de: "Automatisierte Systeme mit Luftstrahlen, Wischern oder Flüssigkeitssprays zur Aufrechterhaltung der Sensorklarheit", nl: "Geautomatiseerde systemen met luchtstro men, wisers of vloeistof sprays om sensor helderheid te behouden" },
          { en: "Sensors that never get dirty", es: "Sensores que nunca se ensucian", de: "Sensoren die nie schmutzig werden", nl: "Sensoren die nooit vuil worden" },
          { en: "Manual cleaning by maintenance staff", es: "Limpieza manual por personal de mantenimiento", de: "Manuelle Reinigung durch Wartungspersonal", nl: "Handmatige reiniging door onderhoudspersoneel" },
          { en: "Self-diagnostic sensor testing only", es: "Solo pruebas de autodiagnóstico de sensores", de: "Nur Sensor-Selbstdiagnose-Tests", nl: "Alleen sensor zelfdiagnose testen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cameras that detect changes in individual pixels asynchronously instead of capturing full frames", es: "Cámaras que detectan cambios en píxeles individuales asincrónicamente en lugar de capturar fotogramas completos", de: "Kameras die Änderungen in einzelnen Pixeln asynchron erkennen anstatt vollständige Frames zu erfassen", nl: "Camera's die veranderingen in individuele pixels asynchroon detecteren in plaats van volledige frames vast te leggen" },
          { en: "Cameras for recording special events only", es: "Cámaras para grabar solo eventos especiales", de: "Kameras nur für Aufnahme besonderer Ereignisse", nl: "Camera's alleen voor het opnemen van speciale gebeurtenissen" },
          { en: "Event scheduling for camera activation", es: "Programación de eventos para activación de cámara", de: "Ereignisplanung für Kameraaktivierung", nl: "Gebeurtenis planning voor camera activering" },
          { en: "Vision systems for event detection", es: "Sistemas de visión para detección de eventos", de: "Sichtsysteme für Ereigniserkennung", nl: "Visiesystemen voor gebeurtenis detectie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Information about surface material properties and reflectivity for better object classification", es: "Información sobre propiedades de material de superficie y reflectividad para mejor clasificación de objetos", de: "Informationen über Oberflächenmaterial-Eigenschaften und Reflektivität für bessere Objektklassifizierung", nl: "Informatie over oppervlaktemateriaal eigenschappen en reflectiviteit voor betere object classificatie" },
          { en: "Brightness control for LiDAR lasers", es: "Control de brillo para láseres LiDAR", de: "Helligkeitskontrolle für LiDAR-Laser", nl: "Helderheid controle voor LiDAR lasers" },
          { en: "Intensity of vehicle movement only", es: "Solo intensidad de movimiento del vehículo", de: "Nur Intensität der Fahrzeugbewegung", nl: "Alleen intensiteit van voertuigbeweging" },
          { en: "LiDAR power consumption levels", es: "Niveles de consumo de energía LiDAR", de: "LiDAR-Stromverbrauchsebenen", nl: "LiDAR stroomverbruik niveaus" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Extremely high resolution for detecting small objects and precise positioning in parking scenarios", es: "Resolución extremadamente alta para detectar objetos pequeños y posicionamiento preciso en escenarios de estacionamiento", de: "Extrem hohe Auflösung für Erkennung kleiner Objekte und präzise Positionierung in Parkszenarien", nl: "Extreem hoge resolutie voor het detecteren van kleine objecten en precieze positionering in parkeerscenario's" },
          { en: "Wide broadcast range for vehicle communication", es: "Rango de transmisión amplio para comunicación vehicular", de: "Weite Übertragungsreichweite für Fahrzeugkommunikation", nl: "Breed uitzend bereik voor voertuig communicatie" },
          { en: "Ultra-wide camera field of view", es: "Campo de visión ultra amplio de cámara", de: "Ultra-weites Kamera-Sichtfeld", nl: "Ultra-breed camera gezichtsveld" },
          { en: "Wideband radio for entertainment", es: "Radio de banda ancha para entretenimiento", de: "Breitband-Radio für Unterhaltung", nl: "Breedband radio voor entertainment" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Vehicles sharing their sensor data and detected objects with nearby vehicles to extend perception range", es: "Vehículos compartiendo sus datos de sensores y objetos detectados con vehículos cercanos para extender rango de percepción", de: "Fahrzeuge teilen ihre Sensordaten und erkannte Objekte mit nahegelegenen Fahrzeugen um Wahrnehmungsbereich zu erweitern", nl: "Voertuigen delen hun sensordata en gedetecteerde objecten met nabije voertuigen om perceptiebereik uit te breiden" },
          { en: "Vehicles cooperating in traffic only", es: "Vehículos cooperando solo en tráfico", de: "Fahrzeuge kooperieren nur im Verkehr", nl: "Voertuigen coöpereren alleen in verkeer" },
          { en: "Perception of cooperative driving behavior", es: "Percepción de comportamiento de conducción cooperativa", de: "Wahrnehmung kooperativen Fahrverhaltens", nl: "Perceptie van coöperatief rijgedrag" },
          { en: "Cooperative sensor maintenance", es: "Mantenimiento cooperativo de sensores", de: "Kooperative Sensorwartung", nl: "Coöperatief sensor onderhoud" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Improving sensor capabilities and algorithms after deployment through over-the-air updates", es: "Mejorar capacidades y algoritmos de sensores después del despliegue através actualizaciones inalámbricas", de: "Verbesserung von Sensorfähigkeiten und Algorithmen nach Bereitstellung durch Over-the-Air-Updates", nl: "Sensor capaciteiten en algoritmes verbeteren na implementatie door over-the-air updates" },
          { en: "Physically replacing sensor hardware remotely", es: "Reemplazar físicamente hardware de sensores remotamente", de: "Sensor-Hardware physisch remote ersetzen", nl: "Sensor hardware fysiek op afstand vervangen" },
          { en: "Updating only entertainment system firmware", es: "Actualizar solo firmware del sistema de entretenimiento", de: "Nur Unterhaltungssystem-Firmware aktualisieren", nl: "Alleen entertainment systeem firmware updaten" },
          { en: "Manual sensor recalibration procedures", es: "Procedimientos manuales de recalibración de sensores", de: "Manuelle Sensor-Rekalibrierungsverfahren", nl: "Handmatige sensor herkalibra tieprocedures" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Identifying rare or unusual scenarios where sensor performance may be challenged or unpredictable", es: "Identificar escenarios raros o inusuales donde rendimiento de sensores puede ser desafiado o impredecible", de: "Identifizierung seltener oder ungewöhnlicher Szenarien wo Sensorleistung herausgefordert oder unvorhersehbar sein kann", nl: "Identificeren van zeldzame of ongewone scenario's waar sensor prestaties uitgedaagd of onvoorspelbaar kunnen zijn" },
          { en: "Detecting sensors located at vehicle edges", es: "Detectar sensores ubicados en bordes del vehículo", de: "Sensoren an Fahrzeugkanten erkennen", nl: "Sensoren aan voertuigranden detecteren" },
          { en: "Testing sensors in extreme cold only", es: "Probar sensores solo en frío extremo", de: "Sensoren nur bei extremer Kälte testen", nl: "Sensoren alleen bij extreme kou testen" },
          { en: "Case studies of sensor deployments", es: "Estudios de caso de despliegues de sensores", de: "Fallstudien von Sensor-Einsätzen", nl: "Case studies van sensor implementaties" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Using multiple polarizations to better characterize object shapes and materials", es: "Usar múltiples polarizaciones para caracterizar mejor formas y materiales de objetos", de: "Verwendung mehrerer Polarisationen zur besseren Charakterisierung von Objektformen und Materialien", nl: "Gebruik van meerdere polarisaties om objectvormen en materialen beter te karakteriseren" },
          { en: "Diverse radar installation locations", es: "Ubicaciones diversas de instalación de radar", de: "Diverse Radar-Installationsorte", nl: "Diverse radar installatie locaties" },
          { en: "Political diversity in radar development teams", es: "Diversidad política en equipos de desarrollo de radar", de: "Politische Vielfalt in Radar-Entwicklungsteams", nl: "Politieke diversiteit in radar ontwikkelingsteams" },
          { en: "Different radar frequency diversities", es: "Diferentes diversidades de frecuencia de radar", de: "Verschiedene Radar-Frequenz-Diversitäten", nl: "Verschillende radar frequentie diversiteiten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Efficiently processing 3D point clouds by focusing computation only on occupied voxels", es: "Procesar eficientemente nubes de puntos 3D enfocando computación solo en vóxeles ocupados", de: "Effiziente Verarbeitung von 3D-Punktwolken durch Fokussierung der Berechnung nur auf besetzte Voxel", nl: "Efficiënt 3D puntenwolken verwerken door berekening alleen te focussen op bezette voxels" },
          { en: "Sparse data storage for neural networks", es: "Almacenamiento disperso de datos para redes neuronales", de: "Sparse Datenspeicherung für neuronale Netzwerke", nl: "Sparse data opslag voor neurale netwerken" },
          { en: "Neural networks with few connections", es: "Redes neuronales con pocas conexiones", de: "Neuronale Netzwerke mit wenigen Verbindungen", nl: "Neurale netwerken met weinig verbindingen" },
          { en: "Networks trained on limited datasets", es: "Redes entrenadas en conjuntos de datos limitados", de: "Netzwerke trainiert auf begrenzten Datensätzen", nl: "Netwerken getraind op beperkte datasets" }
        ],
        correct: 0,
        explanation: {
