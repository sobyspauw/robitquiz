  ...
  const level8 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Creating unlimited realistic training scenarios including rare and dangerous situations that are difficult to collect in real world", es: "Crear escenarios entrenamiento realistas ilimitados incluyendo situaciones raras y peligrosas difíciles de recopilar en mundo real", de: "Unbegrenzte realistische Trainingsszenarien erstellen einschließlich seltener und gefährlicher Situationen die schwer zu sammeln sind", nl: "Onbeperkte realistische trainingsscenario's creëren inclusief zeldzame en gevaarlijke situaties moeilijk te verzamelen in echte wereld" },
      ...
      },
      {
        ...
        options: [
          { en: "Clear, interpretable explanations of why AI systems made specific driving decisions for accountability and safety validation", es: "Explicaciones claras interpretables de por qué sistemas IA tomaron decisiones específicas de conducción para responsabilidad y validación seguridad", de: "Klare interpretierbare Erklärungen warum KI-Systeme spezifische Fahrentscheidungen trafen für Verantwortlichkeit und Sicherheitsvalidierung", nl: "Duidelijke interpreteerbare verklaringen waarom AI-systemen specifieke rijbeslissingen namen voor verantwoordelijkheid en veiligheidsvalidatie" },
      ...
      },
      {
        ...
        options: [
          { en: "System consensus and operation even when some vehicles behave maliciously or unpredictably", es: "Consenso y operación sistema incluso cuando algunos vehículos se comportan maliciosamente o impredeciblemente", de: "Systemkonsens und -betrieb auch wenn einige Fahrzeuge bösartig oder unvorhersagbar handeln", nl: "Systeemconsensus en werking zelfs wanneer sommige voertuigen zich kwaadaardig of onvoorspelbaar gedragen" },
      ...
      },
      {
        ...
        options: [
          { en: "AI model performance degradation, unexpected behaviors, and confidence levels to detect when systems may be operating outside safe parameters", es: "Degradación rendimiento modelos IA, comportamientos inesperados y niveles confianza para detectar cuando sistemas operan fuera de parámetros seguros", de: "KI-Modell-Leistungsabfall, unerwartete Verhaltensweisen und Vertrauensniveaus um zu erkennen wenn Systeme außerhalb sicherer Parameter operieren", nl: "AI-model prestatieverval, onverwacht gedrag en vertrouwensniveaus om te detecteren wanneer systemen buiten veilige parameters opereren" },
      ...
      },
      {
        ...
        options: [
          { en: "Malicious software injection during remote updates through cryptographic verification and secure communication channels", es: "Inyección software malicioso durante actualizaciones remotas via verificación criptográfica y canales comunicación seguros", de: "Bösartige Software-Injection während Remote-Updates durch kryptographische Verifikation und sichere Kommunikationskanäle", nl: "Kwaadaardige software-injectie tijdens externe updates door cryptografische verificatie en veilige communicatiekanalen" },
