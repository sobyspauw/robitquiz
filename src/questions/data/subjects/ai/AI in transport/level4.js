    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Deep cleaning of vehicle sensors",
                  "es": "Limpieza profunda de sensores de vehículo",
                  "de": "Tiefenreinigung von Fahrzeugsensoren",
                  "nl": "Diepe reiniging van voertuigsensoren"
        },
        {
                  "en": "Deep analysis of fuel consumption",
                  "es": "Análisis profundo de consumo de combustible",
                  "de": "Tiefe Analyse des Kraftstoffverbrauchs",
                  "nl": "Diepe analyse van brandstofverbruik"
        },
        {
                  "en": "Deep storage of transportation data",
                  "es": "Almacenamiento profundo de datos de transporte",
                  "de": "Tiefe Speicherung von Transportdaten",
                  "nl": "Diepe opslag van transportdata"
        },
        {
                  "en": "Training neural networks to recognize complex patterns in sensor data like objects, pedestrians, and road conditions",
                  "es": "Entrenar redes neuronales para reconocer patrones complejos en datos de sensores como objetos, peatones y condiciones de carretera",
                  "de": "Neuronale Netzwerke trainieren um komplexe Muster in Sensordaten wie Objekte, Fußgänger und Straßenverhältnisse zu erkennen",
                  "nl": "Neurale netwerken trainen om complexe patronen in sensordata te herkennen zoals objecten, voetgangers en wegomstandigheden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sudden stopping mechanism in vehicles",
                  "es": "Mecanismo de parada súbita en vehículos",
                  "de": "Plötzlicher Stoppmechanismus in Fahrzeugen",
                  "nl": "Plotseling stopmechanisme in voertuigen"
        },
        {
                  "en": "AI technique for building maps of unknown environments while tracking the vehicle's location within that map",
                  "es": "Técnica IA para construir mapas de entornos desconocidos mientras rastrea la ubicación del vehículo dentro de ese mapa",
                  "de": "KI-Technik zum Erstellen von Karten unbekannter Umgebungen während der Verfolgung der Fahrzeugposition innerhalb dieser Karte",
                  "nl": "AI-techniek voor het bouwen van kaarten van onbekende omgevingen terwijl de locatie van het voertuig binnen die kaart wordt gevolgd"
        },
        {
                  "en": "Safety lock and alarm mechanism",
                  "es": "Mecanismo de bloqueo y alarma de seguridad",
                  "de": "Sicherheitsschloss und Alarmmechanismus",
                  "nl": "Veiligheidsslot en alarmmechanisme"
        },
        {
                  "en": "Speed limitation and monitoring",
                  "es": "Limitación y monitoreo de velocidad",
                  "de": "Geschwindigkeitsbegrenzung und -überwachung",
                  "nl": "Snelheidsbeperking en -monitoring"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reinforcing safety equipment",
                  "es": "Reforzar equipo de seguridad",
                  "de": "Sicherheitsausrüstung verstärken",
                  "nl": "Veiligheidsuitrusting versterken"
        },
        {
                  "en": "Training AI agents to make optimal driving decisions through trial-and-error learning in simulated environments",
                  "es": "Entrenar agentes IA para tomar decisiones óptimas de conducción a través de aprendizaje de ensayo y error en entornos simulados",
                  "de": "KI-Agenten trainieren um optimale Fahrentscheidungen durch Trial-and-Error-Lernen in simulierten Umgebungen zu treffen",
                  "nl": "AI-agenten trainen om optimale rijbeslissingen te nemen door trial-and-error leren in gesimuleerde omgevingen"
        },
        {
                  "en": "Learning traffic rules by repetition",
                  "es": "Aprender reglas de tráfico por repetición",
                  "de": "Verkehrsregeln durch Wiederholung lernen",
                  "nl": "Verkeersregels leren door herhaling"
        },
        {
                  "en": "Reinforcing vehicle chassis structure",
                  "es": "Reforzar estructura del chasis del vehículo",
                  "de": "Fahrzeugchassis-Struktur verstärken",
                  "nl": "Voertuigchassis structuur versterken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Analyzing past transportation data",
                  "es": "Analizar datos de transporte pasados",
                  "de": "Vergangene Transportdaten analysieren",
                  "nl": "Verleden transportdata analyseren"
        },
        {
                  "en": "Predicting fuel prices",
                  "es": "Predecir precios de combustible",
                  "de": "Kraftstoffpreise vorhersagen",
                  "nl": "Brandstofprijzen voorspellen"
        },
        {
                  "en": "Forecasting traffic patterns, demand fluctuations, and potential system failures before they occur",
                  "es": "Pronosticar patrones de tráfico, fluctuaciones de demanda y posibles fallas del sistema antes de que ocurran",
                  "de": "Verkehrsmuster, Nachfrageschwankungen und potenzielle Systemausfälle vorhersagen bevor sie auftreten",
                  "nl": "Verkeerspatronen, vraagfluctuaties en potentiële systeemdefecten voorspellen voordat ze optreden"
        },
        {
                  "en": "Predicting weather conditions only",
                  "es": "Predecir solo condiciones climáticas",
                  "de": "Nur Wetterbedingungen vorhersagen",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Vehicle registration systems",
                  "es": "Sistemas de registro de vehículos",
                  "de": "Fahrzeug-Registrierungssysteme",
                  "nl": "Voertuigregistratiesystemen"
        },
        {
                  "en": "Direct communication between vehicles and traffic infrastructure like smart traffic lights and road sensors",
                  "es": "Comunicación directa entre vehículos e infraestructura de tráfico como semáforos inteligentes y sensores de carretera",
                  "de": "Direkte Kommunikation zwischen Fahrzeugen und Verkehrsinfrastruktur wie intelligenten Ampeln und Straßensensoren",
                  "nl": "Directe communicatie tussen voertuigen en verkeersinfrastructuur zoals slimme verkeerslichten en wegsensoren"
        },
        {
                  "en": "Infrastructure maintenance scheduling",
                  "es": "Programación de mantenimiento de infraestructura",
                  "de": "Infrastruktur-Wartungsplanung",
                  "nl": "Infrastructuur onderhoudsplanning"
        },
        {
                  "en": "Vehicle inspection procedures",
                  "es": "Procedimientos de inspección de vehículos",
                  "de": "Fahrzeuginspektion-Verfahren",
                  "nl": "Voertuiginspectieprocedures"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Detection of valuable objects",
                  "es": "Detección de objetos valiosos",
                  "de": "Erkennung wertvoller Objekte",
                  "nl": "Detectie van waardevolle objecten"
        },
        {
                  "en": "AI technique to identify and locate objects like cars, pedestrians, cyclists, and traffic signs in real-time camera feeds",
                  "es": "Técnica IA para identificar y localizar objetos como autos, peatones, ciclistas y señales de tráfico en feeds de cámara en tiempo real",
                  "de": "KI-Technik zur Identifizierung und Lokalisierung von Objekten wie Autos, Fußgängern, Radfahrern und Verkehrsschildern in Echtzeit-Kamera-Feeds",
                  "nl": "AI-techniek om objecten zoals auto's, voetgangers, fietsers en verkeersborden te identificeren en lokaliseren in realtime camera feeds"
        },
        {
                  "en": "Detection of faulty objects in vehicles",
                  "es": "Detección de objetos defectuosos en vehículos",
                  "de": "Erkennung fehlerhafter Objekte in Fahrzeugen",
                  "nl": "Detectie van defecte objecten in voertuigen"
        },
        {
                  "en": "Object storage in vehicle compartments",
                  "es": "Almacenamiento de objetos en compartimentos del vehículo",
                  "de": "Objektlagerung in Fahrzeugfächern",
                  "nl": "Objectopslag in voertuigcompartimenten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pixel-level classification of images to distinguish between road, sidewalk, buildings, vegetation, and other scene elements",
                  "es": "Clasificación a nivel de píxel de imágenes para distinguir entre carretera, acera, edificios, vegetación y otros elementos de escena",
                  "de": "Pixel-Level-Klassifizierung von Bildern zur Unterscheidung zwischen Straße, Gehweg, Gebäuden, Vegetation und anderen Szenenelementen",
                  "nl": "Pixel-niveau classificatie van beelden om onderscheid te maken tussen weg, trottoir, gebouwen, vegetatie en andere scène-elementen"
        },
        {
                  "en": "Segmenting vehicle passengers by age groups",
                  "es": "Segmentar pasajeros de vehículo por grupos de edad",
                  "de": "Fahrzeugpassagiere nach Altersgruppen segmentieren",
                  "nl": "Voertuigpassagiers segmenteren naar leeftijdsgroepen"
        },
        {
        ...
        {
                  "en": "Dividing traffic into time segments",
                  "es": "Dividir tráfico en segmentos de tiempo",
                  "de": "Verkehr in Zeitsegmente unterteilen",
                  "nl": "Verkeer verdelen in tijdsegmenten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Radar signal processing",
                  "es": "Procesamiento de señales de radar",
                  "de": "Radarsignalverarbeitung",
                  "nl": "Radar signaalverwerking"
        },
        {
                  "en": "Light detection for vehicle illumination",
                  "es": "Detección de luz para iluminación de vehículo",
                  "de": "Lichterkennung für Fahrzeugbeleuchtung",
                  "nl": "Lichtdetectie voor voertuigverlichting"
        },
        {
                  "en": "Cloud storage for vehicle data",
                  "es": "Almacenamiento en la nube para datos de vehículo",
                  "de": "Cloud-Speicher für Fahrzeugdaten",
                  "nl": "Cloud opslag voor voertuigdata"
        },
        {
                  "en": "3D environment reconstruction and precise distance measurement using laser-generated point clouds for navigation and obstacle detection",
                  "es": "Reconstrucción de entorno 3D y medición precisa de distancia usando nubes de puntos generadas por láser para navegación y detección de obstáculos",
                  "de": "3D-Umgebungsrekonstruktion und präzise Entfernungsmessung mit laser-generierten Punktwolken für Navigation und Hinderniserkennung",
                  "nl": "3D omgevingsreconstructie en precieze afstandsmeting met laser-gegenereerde puntenwolken voor navigatie en obstakeldetectie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Melting sensors for recycling",
                  "es": "Derretir sensores para reciclaje",
                  "de": "Sensoren zum Recycling schmelzen",
                  "nl": "Sensoren smelten voor recycling"
        },
        {
                  "en": "Connecting sensors with cables",
                  "es": "Conectar sensores con cables",
                  "de": "Sensoren mit Kabeln verbinden",
                  "nl": "Sensoren verbinden met kabels"
        },
        {
                  "en": "Fusing different vehicle components",
                  "es": "Fusionar diferentes componentes del vehículo",
                  "de": "Verschiedene Fahrzeugkomponenten verschmelzen",
                  "nl": "Verschillende voertuigcomponenten samenvoegen"
        },
        {
                  "en": "Combining data from cameras, LiDAR, radar, and ultrasonic sensors to create a comprehensive understanding of the environment",
                  "es": "Combinar datos de cámaras, LiDAR, radar y sensores ultrasónicos para crear comprensión integral del entorno",
                  "de": "Daten von Kameras, LiDAR, Radar und Ultraschallsensoren kombinieren um umfassendes Verständnis der Umgebung zu schaffen",
                  "nl": "Data van camera's, LiDAR, radar en ultrasone sensoren combineren om uitgebreid begrip van de omgeving te creëren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Following GPS coordinates",
                  "es": "Seguir coordenadas GPS",
                  "de": "GPS-Koordinaten folgen",
                  "nl": "GPS coördinaten volgen"
        },
        {
                  "en": "Tracking fuel consumption in real-time",
                  "es": "Rastrear consumo de combustible en tiempo real",
                  "de": "Kraftstoffverbrauch in Echtzeit verfolgen",
                  "nl": "Brandstofverbruik in realtime volgen"
        },
        {
                  "en": "Tracking stolen vehicles",
                  "es": "Rastrear vehículos robados",
                  "de": "Gestohlene Fahrzeuge verfolgen",
                  "nl": "Gestolen voertuigen volgen"
        },
        {
                  "en": "Maintaining consistent identification and prediction of moving objects like vehicles and pedestrians across video frames",
                  "es": "Mantener identificación consistente y predicción de objetos en movimiento como vehículos y peatones a través de marcos de video",
                  "de": "Konsistente Identifizierung und Vorhersage sich bewegender Objekte wie Fahrzeuge und Fußgänger über Videoframes hinweg aufrechterhalten",
                  "nl": "Consistente identificatie en voorspelling van bewegende objecten zoals voertuigen en voetgangers over video frames handhaven"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Finding sharp edges on roads",
                  "es": "Encontrar bordes afilados en carreteras",
                  "de": "Scharfe Kanten auf Straßen finden",
                  "nl": "Scherpe randen op wegen vinden"
        },
        {
                  "en": "Identifying boundaries between different objects and surfaces in camera images to define lane markings, road edges, and object outlines",
                  "es": "Identificar límites entre diferentes objetos y superficies en imágenes de cámara para definir marcas de carril, bordes de carretera y contornos de objetos",
                  "de": "Grenzen zwischen verschiedenen Objekten und Oberflächen in Kamerabildern identifizieren um Fahrbahnmarkierungen, Straßenränder und Objektkonturen zu definieren",
                  "nl": "Grenzen identificeren tussen verschillende objecten en oppervlakken in camera beelden om rijstrookmarkeringen, wegrnden en objectcontouren te definiëren"
        },
        {
                  "en": "Detecting the edge of the vehicle only",
                  "es": "Detectar solo el borde del vehículo",
                  "de": "Nur den Fahrzeugrand erkennen",
                  "nl": "Alleen de rand van het voertuig detecteren"
        },
        {
                  "en": "Detecting vehicle window edges",
                  "es": "Detectar bordes de ventanas de vehículo",
                  "de": "Fahrzeugfensterränder erkennen",
                  "nl": "Voertuigvensterranden detecteren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Depth of vehicle interior space",
                  "es": "Profundidad del espacio interior del vehículo",
                  "de": "Tiefe des Fahrzeuginnenraums",
                  "nl": "Diepte van voertuig interieur ruimte"
        },
        {
                  "en": "Deep analysis of camera quality",
                  "es": "Análisis profundo de calidad de cámara",
                  "de": "Tiefe Analyse der Kameraqualität",
                  "nl": "Diepe analyse van camerakwaliteit"
        },
        {
                  "en": "3D distance information by comparing images from two cameras to calculate how far objects are from the vehicle",
                  "es": "Información de distancia 3D comparando imágenes de dos cámaras para calcular qué tan lejos están los objetos del vehículo",
                  "de": "3D-Entfernungsinformationen durch Vergleich von Bildern zweier Kameras zur Berechnung wie weit Objekte vom Fahrzeug entfernt sind",
                  "nl": "3D afstandsinformatie door beelden van twee camera's te vergelijken om te berekenen hoe ver objecten van het voertuig zijn"
        },
        {
                  "en": "Water depth measurement for amphibious vehicles",
                  "es": "Medición de profundidad de agua para vehículos anfibios",
                  "de": "Wassertiefenmessung für Amphibienfahrzeuge",
                  "nl": "Waterdiepte meting voor amfibische voertuigen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tracking vehicle speed in different lanes",
                  "es": "Rastrear velocidad del vehículo en diferentes carriles",
                  "de": "Fahrzeuggeschwindigkeit in verschiedenen Spuren verfolgen",
                  "nl": "Voertuigsnelheid in verschillende rijstroken volgen"
        },
        {
                  "en": "Tracking the number of lanes on highways",
                  "es": "Rastrear el número de carriles en autopistas",
                  "de": "Anzahl der Spuren auf Autobahns verfolgen",
                  "nl": "Aantal rijstroken op snelwegen volgen"
        },
        {
                  "en": "Detecting lane changes by other vehicles only",
                  "es": "Detectar cambios de carril solo por otros vehículos",
                  "de": "Nur Spurwechsel anderer Fahrzeuge erkennen",
                  "nl": "Alleen rijstrookwisselingen door andere voertuigen detecteren"
        },
        {
                  "en": "Identifying road lane boundaries and maintaining vehicle position within lanes using computer vision algorithms to detect painted lines and road markings",
                  "es": "Identificar límites de carriles de carretera y mantener posición del vehículo dentro de carriles usando algoritmos de visión por computadora para detectar líneas pintadas y marcas de carretera",
                  "de": "Straßenspurgrenzen identifizieren und Fahrzeugposition innerhalb der Spuren aufrechterhalten mit Computer-Vision-Algorithmen zur Erkennung gemalter Linien und Straßenmarkierungen",
                  "nl": "Wegrijstrookgrenzen identificeren en voertuigpositie binnen rijstroken handhaven met computer vision algoritmes om geschilderde lijnen en wegmarkeringen te detecteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tracking pixel movement between consecutive frames to estimate vehicle motion and detect moving objects in the environment",
                  "es": "Rastrear movimiento de píxeles entre marcos consecutivos para estimar movimiento del vehículo y detectar objetos en movimiento en el entorno",
                  "de": "Pixelbewegung zwischen aufeinanderfolgenden Frames verfolgen um Fahrzeugbewegung zu schätzen und sich bewegende Objekte in der Umgebung zu erkennen",
                  "nl": "Pixelbeweging tussen opeenvolgende frames volgen om voertuigbeweging in te schatten en bewegende objecten in de omgeving te detecteren"
        },
        {
                  "en": "Analyzing traffic flow patterns only",
                  "es": "Analizar solo patrones de flujo de tráfico",
                  "de": "Nur Verkehrsflussmuster analysieren",
                  "nl": "Alleen verkeersstroompatronen analyseren"
        },
        {
                  "en": "Optical fiber data transmission",
                  "es": "Transmisión de datos por fibra óptica",
                  "de": "Optische Glasfaser-Datenübertragung",
                  "nl": "Optische vezel datatransmissie"
        },
        {
                  "en": "Measuring airflow around the vehicle",
                  "es": "Medir flujo de aire alrededor del vehículo",
                  "de": "Luftstrom um das Fahrzeug messen",
                  "nl": "Luchtstroom rond het voertuig meten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Extracting vehicle features for marketing",
                  "es": "Extraer características del vehículo para marketing",
                  "de": "Fahrzeugmerkmale für Marketing extrahieren",
                  "nl": "Voertuigkenmerken extraheren voor marketing"
        },
        {
                  "en": "Feature-based vehicle pricing",
                  "es": "Precios de vehículo basados en características",
                  "de": "Merkmalbasierte Fahrzeugpreisgestaltung",
                  "nl": "Feature-gebaseerde voertuigprijsstelling"
        },
        {
                  "en": "Removing unnecessary vehicle components",
                  "es": "Remover componentes innecesarios del vehículo",
                  "de": "Unnötige Fahrzeugkomponenten entfernen",
                  "nl": "Onnodige voertuigcomponenten verwijderen"
        },
        {
                  "en": "Identifying distinctive visual patterns and characteristics in images that can be used for object recognition and scene understanding",
                  "es": "Identificar patrones visuales distintivos y características en imágenes que pueden usarse para reconocimiento de objetos y comprensión de escena",
                  "de": "Identifizierung charakteristischer visueller Muster und Merkmale in Bildern die für Objekterkennung und Szenenverständnis verwendet werden können",
                  "nl": "Identificatie van onderscheidende visuele patronen en kenmerken in beelden die gebruikt kunnen worden voor objectherkenning en scènebegrip"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enhancing image quality by adjusting brightness, contrast, noise reduction, and distortion correction to improve computer vision algorithm performance",
                  "es": "Mejorar calidad de imagen ajustando brillo, contraste, reducción de ruido y corrección de distorsión para mejorar rendimiento de algoritmos de visión por computadora",
                  "de": "Bildqualität verbessern durch Anpassung von Helligkeit, Kontrast, Rauschreduzierung und Verzerrungskorrektur zur Verbesserung der Computer-Vision-Algorithmus-Leistung",
                  "nl": "Beeldkwaliteit verbeteren door helderheid, contrast, ruisreductie en vervormingscorrectie aan te passen om computer vision algoritme prestaties te verbeteren"
        },
        {
                  "en": "Pre-selecting images for manual review",
                  "es": "Preseleccionar imágenes para revisión manual",
                  "de": "Bilder für manuelle Überprüfung vorauswählen",
                  "nl": "Beelden voorselecteren voor handmatige beoordeling"
        },
        {
                  "en": "Preparing images for printing",
                  "es": "Preparar imágenes para impresión",
                  "de": "Bilder für den Druck vorbereiten",
                  "nl": "Beelden voorbereiden voor afdrukken"
        },
        {
                  "en": "Processing images for storage only",
                  "es": "Procesar imágenes solo para almacenamiento",
                  "de": "Bilder nur für Speicherung verarbeiten",
                  "nl": "Beelden alleen voor opslag verwerken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measuring object weight at different scales",
                  "es": "Medir peso de objetos en diferentes escalas",
                  "de": "Objektgewicht in verschiedenen Maßstäben messen",
                  "nl": "Objectgewicht meten op verschillende schalen"
        },
        {
                  "en": "Detecting objects of varying sizes from small distant pedestrians to large nearby trucks using multiple detection scales simultaneously",
                  "es": "Detectar objetos de tamaños variables desde pequeños peatones distantes hasta grandes camiones cercanos usando múltiples escalas de detección simultáneamente",
                  "de": "Objekte verschiedener Größen von kleinen entfernten Fußgängern bis zu großen nahen Lastwagen erkennen mit mehreren Erkennungsmaßstäben gleichzeitig",
                  "nl": "Objecten van verschillende groottes detecteren van kleine verre voetgangers tot grote nabije vrachtwagens met behulp van meerdere detectieschalen tegelijkertijd"
        },
        {
                  "en": "Scaling vehicle size based on road conditions",
                  "es": "Escalar tamaño del vehículo basado en condiciones de carretera",
                  "de": "Fahrzeuggröße basierend auf Straßenbedingungen skalieren",
                  "nl": "Voertuiggrootte schalen gebaseerd op wegomstandigheden"
        },
        {
                  "en": "Detecting objects at multiple time scales",
                  "es": "Detectar objetos en múltiples escalas de tiempo",
                  "de": "Objekte in mehreren Zeitskalen erkennen",
                  "nl": "Objecten detecteren op meerdere tijdschalen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Keeping vehicle temperature consistent",
                  "es": "Mantener temperatura del vehículo consistente",
                  "de": "Fahrzeugtemperatur konsistent halten",
                  "nl": "Voertuigtemperatuur consistent houden"
        },
        {
                  "en": "Ensuring consistent driving schedules",
                  "es": "Asegurar horarios de conducción consistentes",
                  "de": "Konsistente Fahrzeiten gewährleisten",
                  "nl": "Consistente rijschema's waarborgen"
        },
        {
                  "en": "Maintaining temporal database records",
                  "es": "Mantener registros de base de datos temporal",
                  "de": "Temporale Datenbankaufzeichnungen aufrechterhalten",
                  "nl": "Temporele database records onderhouden"
        },
        {
                  "en": "Maintaining stable object detection and tracking across consecutive video frames to prevent flickering identifications and ensure smooth perception",
                  "es": "Mantener detección y seguimiento estable de objetos a través de marcos de video consecutivos para prevenir identificaciones parpadeantes y asegurar percepción suave",
                  "de": "Stabile Objekterkennung und -verfolgung über aufeinanderfolgende Videoframes aufrechterhalten um flackernde Identifizierungen zu verhindern und glatte Wahrnehmung zu gewährleisten",
                  "nl": "Stabiele objectdetectie en -tracking handhaven over opeenvolgende videoframes om flikkerende identificaties te voorkomen en soepele perceptie te waarborgen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Vision enhancement for human drivers",
                  "es": "Mejora de visión para conductores humanos",
                  "de": "Sichtverbesserung für menschliche Fahrer",
                  "nl": "Zichtverbetering voor menselijke bestuurders"
        },
        {
                  "en": "Improved headlight brightness only",
                  "es": "Solo mejora del brillo de faros",
                  "de": "Nur verbesserte Scheinwerferhelligkeit",
                  "nl": "Alleen verbeterde koplampenhelderheid"
        },
        {
                  "en": "Night-time vehicle maintenance",
                  "es": "Mantenimiento nocturno de vehículos",
                  "de": "Nächtliche Fahrzeugwartung",
                  "nl": "Nachtelijk voertuigonderhoud"
        },
        {
                  "en": "Enhanced object detection and recognition in low-light conditions using thermal cameras, infrared sensors, and image enhancement algorithms",
                  "es": "Detección y reconocimiento mejorado de objetos en condiciones de poca luz usando cámaras térmicas, sensores infrarrojos y algoritmos de mejora de imagen",
                  "de": "Verbesserte Objekterkennung und -erkennung bei schlechten Lichtverhältnissen mit Wärmebildkameras, Infrarotsensoren und Bildverbesserungsalgorithmen",
                  "nl": "Verbeterde objectdetectie en -herkenning in weinig licht omstandigheden met thermische camera's, infrarood sensoren en beeldverbeteringsalgoritmes"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Compensating vehicle vibrations only",
                  "es": "Solo compensar vibraciones del vehículo",
                  "de": "Nur Fahrzeugvibrationen kompensieren",
                  "nl": "Alleen voertuigtrillingen compenseren"
        },
        {
                  "en": "Compensating for motion sickness in passengers",
                  "es": "Compensar mareo por movimiento en pasajeros",
                  "de": "Reisekrankheit bei Passagieren kompensieren",
                  "nl": "Compenseren voor bewegingsziekte bij passagiers"
        },
        {
                  "en": "Correcting image degradation caused by vehicle or object motion during camera exposure, enabling clear perception at high speeds",
                  "es": "Corregir degradación de imagen causada por movimiento del vehículo u objeto durante exposición de cámara, permitiendo percepción clara a altas velocidades",
                  "de": "Bildverschlechterung korrigieren die durch Fahrzeug- oder Objektbewegung während Kamerabelichtung verursacht wird, ermöglicht klare Wahrnehmung bei hohen Geschwindigkeiten",
                  "nl": "Beeldverslechtering corrigeren veroorzaakt door voertuig- of objectbeweging tijdens camera-exposure, waardoor heldere perceptie bij hoge snelheden mogelijk wordt"
        },
        {
                  "en": "Motion-based entertainment in vehicles",
                  "es": "Entretenimiento basado en movimiento en vehículos",
                  "de": "Bewegungsbasierte Unterhaltung in Fahrzeugen",
                  "nl": "Beweging-gebaseerd entertainment in voertuigen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning endpoints for navigation routes",
                  "es": "Aprender puntos finales para rutas de navegación",
                  "de": "Endpunkte für Navigationsrouten lernen",
                  "nl": "Eindpunten leren voor navigatieroutes"
        },
        {
                  "en": "Learning that occurs from start to finish of journey",
                  "es": "Aprendizaje que ocurre desde inicio hasta fin del viaje",
                  "de": "Lernen das vom Anfang bis Ende der Reise erfolgt",
                  "nl": "Leren dat plaatsvindt van begin tot einde van reis"
        },
        {
                  "en": "End-of-life vehicle learning systems",
                  "es": "Sistemas de aprendizaje de fin de vida del vehículo",
                  "de": "Fahrzeug-End-of-Life-Lernsysteme",
                  "nl": "Einde-levensduur voertuig leersystemen"
        },
        {
                  "en": "Neural networks that directly map sensor inputs to steering commands without explicit intermediate steps",
                  "es": "Redes neuronales que mapean directamente entradas de sensores a comandos de dirección sin pasos intermedios explícitos",
                  "de": "Neuronale Netzwerke die Sensoreingaben direkt auf Lenkbefehle abbilden ohne explizite Zwischenschritte",
                  "nl": "Neurale netwerken die sensorinputs direct naar stuurcommando's mappen zonder expliciete tussenstappen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adapting domain names for vehicle networks",
                  "es": "Adaptar nombres de dominio para redes vehiculares",
                  "de": "Domänennamen für Fahrzeugnetzwerke anpassen",
                  "nl": "Domeinnamen aanpassen voor voertuignetwerken"
        },
        {
                  "en": "Enabling AI trained in one environment to work effectively in different geographic or weather conditions",
                  "es": "Habilitar IA entrenada en un entorno para trabajar efectivamente en diferentes condiciones geográficas o climáticas",
                  "de": "KI die in einer Umgebung trainiert wurde befähigen in verschiedenen geografischen oder Wetterbedingungen effektiv zu arbeiten",
                  "nl": "AI getraind in één omgeving in staat stellen om effectief te werken in verschillende geografische of weersomstandigheden"
        },
        {
                  "en": "Adapting to different vehicle ownership domains",
                  "es": "Adaptarse a diferentes dominios de propiedad de vehículos",
                  "de": "Anpassung an verschiedene Fahrzeugeigentums-Domänen",
                  "nl": "Aanpassen aan verschillende voertuig eigendomsdomeinen"
        },
        {
                  "en": "Domain-specific language adaptation",
                  "es": "Adaptación de lenguaje específico de dominio",
                  "de": "Domänenspezifische Sprachanpassung",
                  "nl": "Domein-specifieke taaladaptatie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adversarial marketing strategies",
                  "es": "Estrategias de marketing adversarial",
                  "de": "Adversariale Marketingstrategien",
                  "nl": "Adversariale marketingstrategieën"
        },
        {
                  "en": "Resistance to adversarial attacks and edge cases by training on intentionally challenging examples",
                  "es": "Resistencia a ataques adversariales y casos extremos entrenando en ejemplos intencionalmente desafiantes",
                  "de": "Widerstand gegen adversariale Angriffe und Randfälle durch Training an absichtlich herausfordernden Beispielen",
                  "nl": "Weerstand tegen adversariale aanvallen en edge cases door te trainen op opzettelijk uitdagende voorbeelden"
        },
        {
                  "en": "Training in adverse weather only",
                  "es": "Solo entrenar en clima adverso",
                  "de": "Nur bei widrigem Wetter trainieren",
                  "nl": "Alleen trainen bij slecht weer"
        },
        {
                  "en": "Training against adversarial competitors only",
                  "es": "Solo entrenar contra competidores adversariales",
                  "de": "Nur gegen adversariale Wettbewerber trainieren",
                  "nl": "Alleen trainen tegen adversariale concurrenten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Running complex neural networks on resource-constrained vehicle hardware with minimal performance loss",
                  "es": "Ejecutar redes neuronales complejas en hardware vehicular con recursos limitados con pérdida mínima de rendimiento",
                  "de": "Ausführung komplexer neuronaler Netzwerke auf ressourcenbeschränkter Fahrzeughardware mit minimalem Leistungsverlust",
                  "nl": "Complexe neurale netwerken uitvoeren op resource-beperkte voertuig hardware met minimaal prestatieverlies"
        },
        {
                  "en": "Compressing 3D vehicle models",
                  "es": "Comprimir modelos 3D de vehículos",
                  "de": "3D-Fahrzeugmodelle komprimieren",
                  "nl": "3D voertuig modellen comprimeren"
        },
        {
                  "en": "Model car compression for storage",
                  "es": "Compresión de coches modelo para almacenamiento",
                  "de": "Modellauto-Kompression für Lagerung",
                  "nl": "Modelauto compressie voor opslag"
        },
        {
                  "en": "Compressing vehicle models into smaller sizes",
                  "es": "Comprimir modelos de vehículos en tamaños más pequeños",
                  "de": "Fahrzeugmodelle in kleinere Größen komprimieren",
                  "nl": "Voertuig modellen comprimeren in kleinere maten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Federation of vehicle manufacturers learning",
                  "es": "Aprendizaje de federación de fabricantes de vehículos",
                  "de": "Fahrzeughersteller-Föderation Lernen",
                  "nl": "Federatie van voertuigfabrikanten leren"
        },
        {
                  "en": "Training shared AI models across vehicle fleets without exposing individual vehicle data, preserving privacy",
                  "es": "Entrenar modelos IA compartidos a través de flotas de vehículos sin exponer datos de vehículos individuales, preservando privacidad",
                  "de": "Geteilte KI-Modelle über Fahrzeugflotten trainieren ohne individuelle Fahrzeugdaten offenzulegen, Privatsphäre bewahren",
                  "nl": "Gedeelde AI-modellen trainen over voertuigvloten zonder individuele voertuigdata bloot te stellen, privacy behouden"
        },
        {
                  "en": "Federal government vehicle learning programs",
                  "es": "Programas de aprendizaje de vehículos del gobierno federal",
                  "de": "Bundesregierungs-Fahrzeuglernprogramme",
                  "nl": "Federale overheids voertuig leerprogramma's"
        },
        {
                  "en": "Federated network protocols for vehicles",
                  "es": "Protocolos de red federados para vehículos",
                  "de": "Föderierte Netzwerkprotokolle für Fahrzeuge",
                  "nl": "Gefedereerde netwerk protocollen voor voertuigen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Real-time simulation transfers",
                  "es": "Transferencias de simulación en tiempo real",
                  "de": "Echtzeit-Simulationsübertragungen",
                  "nl": "Real-time simulatie overdrachten"
        },
        {
                  "en": "Bridging the gap between AI trained in simulation and real-world performance",
                  "es": "Cerrar la brecha entre IA entrenada en simulación y rendimiento en el mundo real",
                  "de": "Lücke zwischen in Simulation trainierter KI und realer Leistung überbrücken",
                  "nl": "De kloof overbruggen tussen AI getraind in simulatie en echte wereld prestaties"
        },
        {
                  "en": "Transferring SIM cards between vehicles",
                  "es": "Transferir tarjetas SIM entre vehículos",
                  "de": "SIM-Karten zwischen Fahrzeugen übertragen",
                  "nl": "SIM-kaarten overdragen tussen voertuigen"
        },
        {
                  "en": "Transferring simulation software licenses",
                  "es": "Transferir licencias de software de simulación",
                  "de": "Simulationssoftware-Lizenzen übertragen",
                  "nl": "Simulatie software licenties overdragen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uncertainty in fuel consumption estimates",
                  "es": "Incertidumbre en estimaciones de consumo de combustible",
                  "de": "Unsicherheit bei Kraftstoffverbrauchsschätzungen",
                  "nl": "Onzekerheid in brandstofverbruik schattingen"
        },
        {
                  "en": "Quantifying uncertain vehicle sales",
                  "es": "Cuantificar ventas inciertas de vehículos",
                  "de": "Unsichere Fahrzeugverkäufe quantifizieren",
                  "nl": "Onzekere voertuigverkopen kwantificeren"
        },
        {
                  "en": "Measuring AI confidence levels to know when predictions are reliable versus uncertain",
                  "es": "Medir niveles de confianza de IA para saber cuándo predicciones son confiables versus inciertas",
                  "de": "KI-Konfidenzniveaus messen um zu wissen wann Vorhersagen zuverlässig versus unsicher sind",
                  "nl": "AI-vertrouwensniveaus meten om te weten wanneer voorspellingen betrouwbaar versus onzeker zijn"
        },
        {
                  "en": "Quantifying manufacturing uncertainties",
                  "es": "Cuantificar incertidumbres de fabricación",
                  "de": "Fertigungsunsicherheiten quantifizieren",
                  "nl": "Productie onzekerheden kwantificeren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Intelligently selecting the most valuable data samples for annotation and training",
                  "es": "Seleccionar inteligentemente las muestras de datos más valiosas para anotación y entrenamiento",
                  "de": "Intelligente Auswahl der wertvollsten Datenproben für Annotation und Training",
                  "nl": "Intelligent de meest waardevolle data samples selecteren voor annotatie en training"
        },
        {
                  "en": "Active physical training for AI systems",
                  "es": "Entrenamiento físico activo para sistemas IA",
                  "de": "Aktives körperliches Training für KI-Systeme",
                  "nl": "Actieve fysieke training voor AI-systemen"
        },
        {
                  "en": "Active noise learning in vehicles",
                  "es": "Aprendizaje de ruido activo en vehículos",
                  "de": "Aktives Rauschlernen in Fahrzeugen",
                  "nl": "Actief ruisleren in voertuigen"
        },
        {
                  "en": "Learning only during active driving",
                  "es": "Aprender solo durante conducción activa",
                  "de": "Nur während aktiver Fahrt lernen",
                  "nl": "Alleen leren tijdens actief rijden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Aprender de nuevas experiencias con el tiempo sin olvidar comportamientos aprendidos previamente",
                  "de": "Aus neuen Erfahrungen über Zeit lernen ohne zuvor gelernte Verhaltensweisen zu vergessen",
                  "nl": "Leren van nieuwe ervaringen in de tijd zonder eerder geleerde gedragingen te vergeten"
        },
        {
                  "en": "Continual maintenance learning",
                  "es": "Aprendizaje de mantenimiento continuo",
                  "de": "Kontinuierliches Wartungslernen",
                  "nl": "Continu onderhoud leren"
        },
        {
                  "en": "Continuous vehicle operation learning",
                  "es": "Aprendizaje de operación continua de vehículos",
                  "de": "Kontinuierliches Fahrzeugbetriebs-Lernen",
                  "nl": "Continue voertuigoperatie leren"
        },
        {
                  "en": "Learning during continuous charging",
                  "es": "Aprender durante carga continua",
                  "de": "Lernen während kontinuierlichem Laden",
                  "nl": "Leren tijdens continu opladen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Multi-tasking by human drivers",
                  "es": "Multitarea por conductores humanos",
                  "de": "Multitasking von menschlichen Fahrern",
                  "nl": "Multitasking door menselijke bestuurders"
        },
        {
                  "en": "Training single models to perform multiple related tasks simultaneously, improving efficiency and shared representations",
                  "es": "Entrenar modelos únicos para realizar múltiples tareas relacionadas simultáneamente, mejorando eficiencia y representaciones compartidas",
                  "de": "Einzelne Modelle trainieren um mehrere verwandte Aufgaben gleichzeitig durchzuführen, verbessert Effizienz und geteilte Repräsentationen",
                  "nl": "Enkele modellen trainen om meerdere gerelateerde taken gelijktijdig uit te voeren, wat efficiëntie en gedeelde representaties verbetert"
        },
        {
                  "en": "Learning multiple vehicle tasks separately",
                  "es": "Aprender múltiples tareas de vehículos por separado",
                  "de": "Mehrere Fahrzeugaufgaben separat lernen",
                  "nl": "Meerdere voertuig taken afzonderlijk leren"
        },
        {
                  "en": "Task management for vehicle operators",
                  "es": "Gestión de tareas para operadores de vehículos",
                  "de": "Aufgabenverwaltung für Fahrzeugbetreiber",
                  "nl": "Taakbeheer voor voertuigoperators"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Focusing computational resources on the most relevant parts of sensor data for better decision-making",
                  "es": "Enfocar recursos computacionales en las partes más relevantes de datos de sensores para mejor toma de decisiones",
                  "de": "Rechenressourcen auf relevanteste Teile von Sensordaten fokussieren für bessere Entscheidungsfindung",
                  "nl": "Computationele middelen focussen op de meest relevante delen van sensordata voor betere besluitvorming"
        },
        {
                  "en": "Attention-grabbing vehicle design features",
                  "es": "Características de diseño vehicular que captan atención",
                  "de": "Aufmerksamkeitserregende Fahrzeugdesign-Merkmale",
                  "nl": "Aandacht-trekkende voertuig design kenmerken"
        },
        {
                  "en": "Attention management for passengers",
                  "es": "Gestión de atención para pasajeros",
                  "de": "Aufmerksamkeitsverwaltung für Passagiere",
                  "nl": "Aandachtbeheer voor passagiers"
        },
        {
                  "en": "Driver attention monitoring only",
                  "es": "Solo monitoreo de atención del conductor",
                  "de": "Nur Fahreraufmerksamkeitsüberwachung",
                  "nl": "Alleen bestuurder aandacht monitoring"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Data transformation protocols",
                  "es": "Protocolos de transformación de datos",
                  "de": "Datentransformations-Protokolle",
                  "nl": "Data transformatie protocollen"
        },
        {
                  "en": "Transforming vehicle shapes and designs",
                  "es": "Transformar formas y diseños de vehículos",
                  "de": "Fahrzeugformen und -designs transformieren",
                  "nl": "Voertuigvormen en -ontwerpen transformeren"
        },
        {
                  "en": "Processing sequences and spatial relationships with self-attention for superior scene understanding",
                  "es": "Procesar secuencias y relaciones espaciales con auto-atención para comprensión superior de escena",
                  "de": "Verarbeitung von Sequenzen und räumlichen Beziehungen mit Selbst-Aufmerksamkeit für überlegenes Szenenverständnis",
                  "nl": "Verwerken van sequenties en ruimtelijke relaties met zelf-aandacht voor superieur scènebegrip"
        },
        {
                  "en": "Electrical transformers for vehicle power",
                  "es": "Transformadores eléctricos para energía vehicular",
                  "de": "Elektrische Transformatoren für Fahrzeugstrom",
                  "nl": "Elektrische transformatoren voor voertuig stroom"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating photorealistic 3D scene representations from multiple camera views for simulation and training",
                  "es": "Crear representaciones de escena 3D fotorrealistas desde múltiples vistas de cámara para simulación y entrenamiento",
                  "de": "Fotorealistische 3D-Szenenrepräsentationen aus mehreren Kameraansichten für Simulation und Training erstellen",
                  "nl": "Fotorealistische 3D-scène representaties creëren vanuit meerdere cameraperspectieven voor simulatie en training"
        },
        {
                  "en": "Neural field theory for vehicle physics",
                  "es": "Teoría de campo neural para física vehicular",
                  "de": "Neurale Feldtheorie für Fahrzeugphysik",
                  "nl": "Neurale veld theorie voor voertuig fysica"
        },
        {
                  "en": "Radiance lighting for vehicle interiors",
                  "es": "Iluminación de radiancia para interiores vehiculares",
                  "de": "Radianz-Beleuchtung für Fahrzeuginnenräume",
                  "nl": "Radiance verlichting voor voertuig interieurs"
        },
        {
                  "en": "Field testing neural networks",
                  "es": "Pruebas de campo de redes neuronales",
                  "de": "Feldtests neuronaler Netzwerke",
                  "nl": "Veldtesten van neurale netwerken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning from a few driving shots only",
                  "es": "Aprender solo de unos pocos intentos de conducción",
                  "de": "Nur aus wenigen Fahrversuchen lernen",
                  "nl": "Alleen leren van een paar rijpogingen"
        },
        {
                  "en": "Learning with few sensors",
                  "es": "Aprender con pocos sensores",
                  "de": "Mit wenigen Sensoren lernen",
                  "nl": "Leren met weinig sensoren"
        },
        {
                  "en": "Few-shot photography in vehicles",
                  "es": "Fotografía de pocos disparos en vehículos",
                  "de": "Few-Shot-Fotografie in Fahrzeugen",
                  "nl": "Few-shot fotografie in voertuigen"
        },
        {
                  "en": "Quickly adapting to new object types or scenarios with minimal training examples",
                  "es": "Adaptarse rápidamente a nuevos tipos de objetos o escenarios con ejemplos mínimos de entrenamiento",
                  "de": "Schnelle Anpassung an neue Objekttypen oder Szenarien mit minimalen Trainingsbeispielen",
                  "nl": "Snel aanpassen aan nieuwe objecttypes of scenario's met minimale trainingsvoorbeelden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning about learning theory only",
                  "es": "Solo aprender sobre teoría del aprendizaje",
                  "de": "Nur über Lerntheorie lernen",
                  "nl": "Alleen leren over leertheorie"
        },
        {
                  "en": "Meta-cognitive vehicle systems",
                  "es": "Sistemas vehiculares metacognitivos",
                  "de": "Metakognitive Fahrzeugsysteme",
                  "nl": "Metacognitieve voertuig systemen"
        },
        {
                  "en": "Learning how to learn efficiently, enabling rapid adaptation to new tasks and environments",
                  "es": "Aprender cómo aprender eficientemente, habilitando adaptación rápida a nuevas tareas y entornos",
                  "de": "Lernen wie man effizient lernt, ermöglicht schnelle Anpassung an neue Aufgaben und Umgebungen",
                  "nl": "Leren hoe efficiënt te leren, wat snelle aanpassing aan nieuwe taken en omgevingen mogelijk maakt"
        },
        {
                  "en": "Meta-data management for vehicles",
                  "es": "Gestión de metadatos para vehículos",
                  "de": "Metadaten-Verwaltung für Fahrzeuge",
                  "nl": "Metadata beheer voor voertuigen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reasoning about vehicle causes of failure",
                  "es": "Razonar sobre causas de falla de vehículos",
                  "de": "Über Ursachen von Fahrzeugausfällen nachdenken",
                  "nl": "Redeneren over voertuig oorzaken van storing"
        },
        {
                  "en": "Causal analysis of vehicle accidents only",
                  "es": "Solo análisis causal de accidentes vehiculares",
                  "de": "Nur kausale Analyse von Fahrzeugunfällen",
                  "nl": "Alleen causale analyse van voertuigongevallen"
        },
        {
                  "en": "Understanding cause-effect relationships rather than just correlations for more robust decision-making",
                  "es": "Entender relaciones causa-efecto en lugar de solo correlaciones para toma de decisiones más robusta",
                  "de": "Ursache-Wirkungs-Beziehungen verstehen statt nur Korrelationen für robustere Entscheidungsfindung",
                  "nl": "Oorzaak-gevolg relaties begrijpen in plaats van alleen correlaties voor robuustere besluitvorming"
        },
        {
                  "en": "Causal relationships in vehicle sales",
                  "es": "Relaciones causales en ventas de vehículos",
                  "de": "Kausale Beziehungen bei Fahrzeugverkäufen",
                  "nl": "Causale relaties in voertuigverkoop"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Searching for neural network documentation",
                  "es": "Buscar documentación de redes neuronales",
                  "de": "Nach neuronaler Netzwerk-Dokumentation suchen",
                  "nl": "Zoeken naar neurale netwerk documentatie"
        },
        {
                  "en": "Architecture design for vehicle structures",
                  "es": "Diseño arquitectónico para estructuras vehiculares",
                  "de": "Architekturdesign für Fahrzeugstrukturen",
                  "nl": "Architectuur ontwerp voor voertuigstructuren"
        },
        {
                  "en": "Automatically discovering optimal neural network structures for specific autonomous driving tasks",
                  "es": "Descubrir automáticamente estructuras de redes neuronales óptimas para tareas específicas de conducción autónoma",
                  "de": "Automatisches Entdecken optimaler neuronaler Netzwerkstrukturen für spezifische autonome Fahraufgaben",
                  "nl": "Automatisch optimale neurale netwerkstructuren ontdekken voor specifieke autonome rijtaken"
        },
        {
                  "en": "Searching neural pathways in brains",
                  "es": "Buscar vías neuronales en cerebros",
                  "de": "Neuronale Pfade in Gehirnen suchen",
                  "nl": "Neurale paden in hersenen zoeken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Explainable vehicle manuals",
                  "es": "Manuales de vehículos explicables",
                  "de": "Erklärbare Fahrzeughandbücher",
                  "nl": "Verklaarbare voertuig handleidingen"
        },
        {
                  "en": "AI explanation interfaces",
                  "es": "Interfaces de explicación de IA",
                  "de": "KI-Erklärungsschnittstellen",
                  "nl": "AI uitleg interfaces"
        },
        {
                  "en": "Explaining AI to passengers only",
                  "es": "Solo explicar IA a pasajeros",
                  "de": "Nur KI an Passagiere erklären",
                  "nl": "Alleen AI uitleggen aan passagiers"
        },
        {
                  "en": "Interpretable insights into AI decision-making processes for debugging, validation, and legal compliance",
                  "es": "Perspectivas interpretables en procesos de toma de decisiones de IA para depuración, validación y cumplimiento legal",
                  "de": "Interpretierbare Einblicke in KI-Entscheidungsprozesse für Debugging, Validierung und rechtliche Compliance",
                  "nl": "Interpreteerbare inzichten in AI besluitvormingsprocessen voor debugging, validatie en juridische compliance"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Knowledge base distillation processes",
                  "es": "Procesos de destilación de base de conocimiento",
                  "de": "Wissensbasis-Destillationsprozesse",
                  "nl": "Kennisbasis distillatieprocessen"
        },
        {
                  "en": "Distilling fuel for knowledge engines",
                  "es": "Destilar combustible para motores de conocimiento",
                  "de": "Kraftstoff für Wissensmaschinen destillieren",
                  "nl": "Brandstof distilleren voor kennis motoren"
        },
        {
                  "en": "Transferring knowledge from large complex models to smaller, faster models suitable for vehicle deployment",
                  "es": "Transferir conocimiento de modelos grandes y complejos a modelos más pequeños y rápidos adecuados para despliegue vehicular",
                  "de": "Wissen von großen komplexen Modellen auf kleinere, schnellere Modelle übertragen geeignet für Fahrzeugbereitstellung",
                  "nl": "Kennis overdragen van grote complexe modellen naar kleinere, snellere modellen geschikt voor voertuig deployment"
        },
        {
                  "en": "Distilling training data only",
                  "es": "Solo destilar datos de entrenamiento",
                  "de": "Nur Trainingsdaten destillieren",
                  "nl": "Alleen trainingsdata distilleren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Self-driving vehicle supervision needs",
                  "es": "Necesidades de supervisión de vehículos autónomos",
                  "de": "Selbstfahr-Fahrzeug-Überwachungsbedarf",
                  "nl": "Zelfrijdende voertuig toezicht behoeften"
        },
        {
                  "en": "Self-maintenance supervision",
                  "es": "Supervisión de automantenimiento",
                  "de": "Selbstwartungs-Überwachung",
                  "nl": "Zelfonderhoud toezicht"
        },
        {
                  "en": "Dependency on expensive manual data labeling by learning from unlabeled sensor data",
                  "es": "Dependencia en etiquetado manual costoso de datos aprendiendo desde datos de sensores sin etiquetar",
                  "de": "Abhängigkeit von teurer manueller Datenkennzeichnung durch Lernen aus ungelabelten Sensordaten",
                  "nl": "Afhankelijkheid van dure handmatige data labeling door te leren van ongelabelde sensordata"
        },
        {
                  "en": "Supervised driving instruction only",
                  "es": "Solo instrucción de conducción supervisada",
                  "de": "Nur überwachte Fahranweisung",
                  "nl": "Alleen gesuperviseerde rijinstructie"
        }
        ],
        correct: 2,
        explanation: {
