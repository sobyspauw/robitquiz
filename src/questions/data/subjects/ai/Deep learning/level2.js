  ...
  const level2 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "A neuron is a single processing unit, while a layer is a collection of neurons that process data at the same level", es: "Una neurona es una unidad de procesamiento individual, mientras que una capa es una colección de neuronas que procesan datos al mismo nivel", de: "Ein Neuron ist eine Verarbeitungseinheit, eine Schicht ist eine Sammlung von Neuronen die Daten auf derselben Ebene verarbeiten", nl: "Een neuron is een enkele verwerkingseenheid, terwijl een laag een verzameling neuronen is die data op hetzelfde niveau verwerken" },
      ...
      },
      {
        ...
        options: [
          { en: "Supervised learning uses labeled data to learn mappings, while unsupervised learning finds patterns in unlabeled data", es: "Aprendizaje supervisado usa datos etiquetados para aprender mapeos, mientras aprendizaje no supervisado encuentra patrones en datos no etiquetados", de: "Überwachtes Lernen verwendet beschriftete Daten um Zuordnungen zu lernen, unüberwachtes Lernen findet Muster in unbeschrifteten Daten", nl: "Supervised learning gebruikt gelabelde data om mappings te leren, terwijl unsupervised learning patronen vindt in ongelabelde data" },
      ...
      },
      {
        ...
        options: [
          { en: "A theorem stating that neural networks with sufficient neurons can approximate any continuous function to arbitrary precision", es: "Un teorema que establece que redes neuronales con suficientes neuronas pueden aproximar cualquier función continua con precisión arbitraria", de: "Ein Theorem dass neuronale Netzwerke mit ausreichend Neuronen jede kontinuierliche Funktion mit beliebiger Genauigkeit approximieren können", nl: "Een theorema dat stelt dat neurale netwerken met voldoende neuronen elke continue functie kunnen benaderen met willekeurige precisie" },
      ...
      },
      {
        ...
        options: [
          { en: "Parameters are learned during training (weights, biases), while hyperparameters are set before training (learning rate, architecture)", es: "Parámetros se aprenden durante entrenamiento (pesos, sesgos), mientras hiperparámetros se establecen antes (tasa aprendizaje, arquitectura)", de: "Parameter werden während Trainings gelernt (Gewichte, Biases), Hyperparameter vor Training gesetzt (Lernrate, Architektur)", nl: "Parameters worden geleerd tijdens training (gewichten, biases), hyperparameters worden ingesteld voor training (learning rate, architectuur)" },
