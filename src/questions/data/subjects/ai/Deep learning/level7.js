    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Uses only momentum without adaptive rates",
                  "es": "Usa solo momentum sin tasas adaptativas",
                  "de": "Verwendet nur Momentum ohne adaptive Raten",
                  "nl": "Gebruikt alleen momentum zonder adaptieve rates"
        },
        {
                  "en": "Reduces the learning rate linearly over time",
                  "es": "Reduce la tasa de aprendizaje linealmente con el tiempo",
                  "de": "Reduziert die Lernrate linear über die Zeit",
                  "nl": "Vermindert de learning rate lineair over tijd"
        },
        {
                  "en": "Optimizes only the first layer parameters",
                  "es": "Optimiza solo los parámetros de la primera capa",
                  "de": "Optimiert nur die Parameter der ersten Schicht",
                  "nl": "Optimaliseert alleen de eerste laag parameters"
        },
        {
                  "en": "Combines momentum with adaptive learning rates for each parameter individually",
                  "es": "Combina momentum con tasas de aprendizaje adaptativas para cada parámetro individualmente",
                  "de": "Kombiniert Momentum mit adaptiven Lernraten für jeden Parameter individuell",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting deep models to shallow ones",
                  "es": "Convertir modelos profundos a superficiales",
                  "de": "Tiefe Modelle in oberflächliche umwandeln",
                  "nl": "Diepe modellen converteren naar ondiepe"
        },
        {
                  ...
                  "de": "Ein kleineres Schülermodell trainieren um das Verhalten eines größeren Lehrermodells nachzuahmen",
                  "nl": "Een kleiner studentmodel trainen om het gedrag van een groter leraarmodel na te bootsen"
        },
        {
                  "en": "Extracting knowledge from training data",
                  "es": "Extraer conocimiento de datos de entrenamiento",
                  "de": "Wissen aus Trainingsdaten extrahieren",
                  "nl": "Kennis extraheren uit trainingsdata"
        },
        {
                  "en": "Distilling model parameters to essential components",
                  "es": "Destilar parámetros de modelo a componentes esenciales",
                  "de": "Modellparameter zu wesentlichen Komponenten destillieren",
                  "nl": "Modelparameters distilleren tot essentiële componenten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training models by gradually increasing task difficulty from easy to hard examples",
                  "es": "Entrenar modelos aumentando gradualmente la dificultad de tareas de ejemplos fáciles a difíciles",
                  "de": "Modelle trainieren durch graduell steigende Aufgabenschwierigkeit von einfachen zu schweren Beispielen",
                  "nl": "Modellen trainen door geleidelijk de taakmoeilijkheid te verhogen van makkelijke naar moeilijke voorbeelden"
        },
        {
                  ...
                  "nl": "Meerdere onderwerpen tegelijkertijd leren"
        },
        {
                  "en": "Standardizing learning procedures across models",
                  "es": "Estandarizar procedimientos de aprendizaje entre modelos",
                  "de": "Lernverfahren zwischen Modellen standardisieren",
                  "nl": "Leerprocedures standaardiseren tussen modellen"
        },
        {
                  "en": "Creating educational curricula for AI courses",
                  "es": "Crear currículos educativos para cursos de IA",
                  "de": "Bildungscurricula für KI-Kurse erstellen",
                  "nl": "Onderwijscurricula maken voor AI cursussen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Über Metadaten von Trainingsdatensätzen lernen",
                  "nl": "Leren over de metadata van trainingsdatasets"
        },
        {
        ...
        {
                  "en": "Learning to optimize hyperparameters automatically",
                  "es": "Aprender a optimizar hiperparámetros automáticamente",
                  "de": "Lernen Hyperparameter automatisch zu optimieren",
                  "nl": "Leren om hyperparameters automatisch te optimaliseren"
        },
        {
                  "en": "Training models to learn faster algorithms",
                  "es": "Entrenar modelos para aprender algoritmos más rápidos",
                  "de": "Modelle trainieren um schnellere Algorithmen zu lernen",
                  "nl": "Modellen trainen om snellere algoritmes te leren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Automatically discovering optimal neural network architectures using search algorithms",
                  "es": "Descubrir automáticamente arquitecturas de redes neuronales óptimas usando algoritmos de búsqueda",
                  "de": "Automatische Entdeckung optimaler neuronaler Netzwerkarchitekturen mit Suchalgorithmen",
                  "nl": "Automatisch ontdekken van optimale neurale netwerkarchitecturen met behulp van zoekalgoritmes"
        },
        {
                  "en": "Finding the best hyperparameters for existing architectures",
                  "es": "Encontrar los mejores hiperparámetros para arquitecturas existentes",
                  "de": "Die besten Hyperparameter für bestehende Architekturen finden",
                  "nl": "De beste hyperparameters vinden voor bestaande architecturen"
        },
        {
                  "en": "Searching through research papers for new architectures",
                  "es": "Buscar a través de artículos de investigación nuevas arquitecturas",
                  "de": "Durch Forschungsarbeiten nach neuen Architekturen suchen",
                  "nl": "Door onderzoekspapers zoeken naar nieuwe architecturen"
        },
        {
                  "en": "Searching for neural networks on the internet",
                  "es": "Buscar redes neuronales en internet",
                  "de": "Nach neuronalen Netzwerken im Internet suchen",
                  "nl": "Zoeken naar neurale netwerken op internet"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A network that generates adversarial examples to fool other models",
                  "es": "Una red que genera ejemplos adversarios para engañar otros modelos",
                  "de": "Ein Netzwerk das adversariale Beispiele generiert um andere Modelle zu täuschen",
                  "nl": "Een netwerk dat adversariale voorbeelden genereert om andere modellen te misleiden"
        },
        {
                  "en": "A defensive network against adversarial attacks",
                  "es": "Una red defensiva contra ataques adversarios",
                  "de": "Ein defensives Netzwerk gegen adversariale Angriffe",
                  "nl": "Een defensief netwerk tegen adversariale aanvallen"
        },
        {
                  "en": "A network that combines multiple generators for better results",
                  "es": "Una red que combina múltiples generadores para mejores resultados",
                  "de": "Ein Netzwerk das mehrere Generatoren für bessere Ergebnisse kombiniert",
                  "nl": "Een netwerk dat meerdere generators combineert voor betere resultaten"
        },
        {
                  "en": "Two neural networks competing against each other: a generator creates fake data and a discriminator tries to detect it",
                  "es": "Dos redes neuronales compitiendo entre sí: un generador crea datos falsos y un discriminador trata de detectarlos",
                  "de": "Zwei neuronale Netzwerke die gegeneinander konkurrieren: ein Generator erstellt falsche Daten und ein Discriminator versucht sie zu erkennen",
                  "nl": "Twee neurale netwerken die tegen elkaar concurreren: een generator maakt nepdata en een discriminator probeert het te detecteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "VAEs use multiple autoencoders with different variations",
                  "es": "VAEs usan múltiples autoencoders con diferentes variaciones",
                  "de": "VAEs verwenden mehrere Autoencoder mit verschiedenen Variationen",
                  "nl": "VAEs gebruiken meerdere autoencoders met verschillende variaties"
        },
        {
                  "en": "VAEs vary the autoencoder architecture during training",
                  "es": "VAEs varían la arquitectura del autoencoder durante entrenamiento",
                  "de": "VAEs variieren die Autoencoder-Architektur während des Trainings",
                  "nl": "VAEs variëren de autoencoder architectuur tijdens training"
        },
        {
                  "en": "VAEs learn a probabilistic latent space with regularization, enabling controlled generation and interpolation",
                  "es": "VAEs aprenden un espacio latente probabilístico con regularización, permitiendo generación controlada e interpolación",
                  "de": "VAEs lernen einen probabilistischen latenten Raum mit Regularisierung, ermöglichen kontrollierte Generierung und Interpolation",
                  "nl": "VAEs leren een probabilistische latente ruimte met regularisatie, maken gecontroleerde generatie en interpolatie mogelijk"
        },
        {
                  "en": "VAEs use variable-sized encoding layers",
                  "es": "VAEs usan capas de codificación de tamaño variable",
                  "de": "VAEs verwenden variabel dimensionierte Kodierungsschichten",
                  "nl": "VAEs gebruiken variabel-grote encodeerlagen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To discriminate between different types of generators",
                  "es": "Discriminar entre diferentes tipos de generadores",
                  "de": "Zwischen verschiedenen Arten von Generatoren unterscheiden",
                  "nl": "Onderscheid maken tussen verschillende types generators"
        },
        {
                  "en": "To minimize the difference between generated and real data distributions",
                  "es": "Minimizar la diferencia entre distribuciones de datos generados y reales",
                  "de": "Den Unterschied zwischen generierten und echten Datenverteilungen minimieren",
                  "nl": "Het verschil tussen gegenereerde en echte dataverdelingen minimaliseren"
        },
        {
                  "en": "To maximize the probability of correctly classifying real vs fake data using binary cross-entropy loss",
                  "es": "Maximizar la probabilidad de clasificar correctamente datos reales vs falsos usando pérdida de entropía cruzada binaria",
                  "de": "Die Wahrscheinlichkeit maximieren echte vs falsche Daten korrekt zu klassifizieren mit binärer Kreuzentropie-Verlust",
                  "nl": "De waarschijnlijkheid maximaliseren van correct classificeren van echte vs nepdata met behulp van binaire cross-entropy verlies"
        },
        {
                  "en": "To prevent the discriminator from overfitting to the training data",
                  "es": "Prevenir que el discriminador sobreajuste a los datos de entrenamiento",
                  "de": "Verhindern dass der Discriminator zu den Trainingsdaten overfittet",
                  "nl": "Voorkomen dat de discriminator overfitting heeft naar de trainingsdata"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When the training loss suddenly drops to zero",
                  "es": "Cuando la pérdida de entrenamiento cae súbitamente a cero",
                  "de": "Wenn der Trainingsverlust plötzlich auf null fällt",
                  "nl": "Wanneer het trainingsverlies plotseling naar nul daalt"
        },
        {
                  "en": "When the discriminator network collapses during training",
                  "es": "Cuando la red discriminadora colapsa durante entrenamiento",
                  "de": "Wenn das Discriminator-Netzwerk während des Trainings kollabiert",
                  "nl": "Wanneer het discriminator netwerk instort tijdens training"
        },
        {
                  "en": "When multiple generators collapse into a single model",
                  "es": "Cuando múltiples generadores colapsan en un solo modelo",
                  "de": "Wenn mehrere Generatoren zu einem einzigen Modell kollabieren",
                  "nl": "Wanneer meerdere generators instorten tot één model"
        },
        {
                  "en": "Generator produces limited diversity by focusing on few modes of data distribution, prevented by unrolled GANs or WGAN",
                  "es": "Cuando generador produce diversidad limitada enfocándose en pocos modos, prevenido por unrolled GANs o WGAN",
                  "de": "Wenn Generator begrenzte Diversität produziert durch Fokus auf wenige Modi, verhindert durch unrolled GANs oder WGAN",
                  "nl": "Wanneer generator beperkte diversiteit produceert door zich te richten op weinig modi, voorkomen door unrolled GANs of WGAN"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It learns to reconstruct clean data from corrupted inputs, forcing the network to learn meaningful representations rather than memorizing",
                  "es": "Aprende a reconstruir datos limpios de entradas corruptas, forzando aprender representaciones significativas no memorizar",
                  "de": "Lernt saubere Daten aus beschädigten Eingaben zu rekonstruieren, zwingt das Netzwerk bedeutungsvolle Repräsentationen zu lernen",
                  "nl": "Leert schone data te reconstrueren uit beschadigde inputs, dwingt netwerk betekenisvolle representaties te leren niet memoriseren"
        },
        {
                  "en": "It uses noise reduction algorithms in the hidden layers",
                  "es": "Usa algoritmos de reducción de ruido en las capas ocultas",
                  "de": "Es verwendet Rauschreduktionsalgorithmen in den versteckten Schichten",
                  "nl": "Het gebruikt ruisreductie algoritmes in de verborgen lagen"
        },
        {
                  "en": "It has additional layers specifically for noise detection",
                  "es": "Tiene capas adicionales específicamente para detección de ruido",
                  "de": "Es hat zusätzliche Schichten speziell für Rauschenerkennung",
                  "nl": "Het heeft extra lagen specifiek voor ruisdetectie"
        },
        {
                  "en": "It automatically removes noise from any input data",
                  "es": "Automáticamente remueve ruido de cualquier dato de entrada",
                  "de": "Es entfernt automatisch Rauschen aus allen Eingabedaten",
                  "nl": "Het verwijdert automatisch ruis uit alle inputdata"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses Wasserstein distance as loss function providing more stable training and meaningful loss values",
                  "es": "Usa distancia Wasserstein como función de pérdida proporcionando entrenamiento más estable y valores de pérdida significativos",
                  "de": "Verwendet Wasserstein-Distanz als Verlustfunktion bietet stabileres Training und bedeutungsvolle Verlustwerte",
                  "nl": "Gebruikt Wasserstein afstand als verliesfunctie biedt stabielere training en betekenisvolle verlieswaarden"
        },
        {
                  "en": "Implements weight sharing between generator and discriminator",
                  "es": "Implementa compartición de pesos entre generador y discriminador",
                  "de": "Implementiert Gewichtsteilung zwischen Generator und Discriminator",
                  "nl": "Implementeert gewichtsdeling tussen generator en discriminator"
        },
        {
                  "en": "Uses water-like fluid dynamics in the generator",
                  "es": "Usa dinámica de fluidos tipo agua en el generador",
                  "de": "Verwendet wasserähnliche Fluiddynamik im Generator",
                  "nl": "Gebruikt water-achtige vloeistofdynamica in de generator"
        },
        {
                  "en": "Named after a researcher who improved GAN architectures",
                  "es": "Nombrada por un investigador que mejoró arquitecturas GAN",
                  "de": "Benannt nach einem Forscher der GAN-Architekturen verbesserte",
                  "nl": "Vernoemd naar een onderzoeker die GAN architecturen verbeterde"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Changes the model parameters to improve convergence",
                  "es": "Cambia los parámetros del modelo para mejorar convergencia",
                  "de": "Ändert die Modellparameter um Konvergenz zu verbessern",
                  "nl": "Verandert de modelparameters om convergentie te verbeteren"
        },
        {
                  "en": "Allows backpropagation through random sampling by expressing random variables as deterministic functions of noise",
                  "es": "Permite retropropagación a través de muestreo aleatorio expresando variables aleatorias como funciones determinísticas de ruido",
                  "de": "Ermöglicht Backpropagation durch zufälliges Sampling durch Ausdrücken von Zufallsvariablen als deterministische Funktionen von Rauschen",
                  "nl": "Maakt backpropagation mogelijk door willekeurige sampling door willekeurige variabelen uit te drukken als deterministische functies van ruis"
        },
        {
                  "en": "Reparameterizes the network weights during training",
                  "es": "Reparametriza los pesos de la red durante entrenamiento",
                  "de": "Reparametrisiert die Netzwerkgewichte während des Trainings",
                  "nl": "Reparametriseert de netwerkgewichten tijdens training"
        },
        {
                  "en": "Optimizes hyperparameters automatically during training",
                  "es": "Optimiza hiperparámetros automáticamente durante entrenamiento",
                  "de": "Optimiert Hyperparameter automatisch während des Trainings",
                  "nl": "Optimaliseert hyperparameters automatisch tijdens training"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Generates data only under certain computational conditions",
                  "es": "Genera datos solo bajo ciertas condiciones computacionales",
                  "de": "Generiert Daten nur unter bestimmten rechnerischen Bedingungen",
                  "nl": "Genereert data alleen onder bepaalde computationele condities"
        },
        {
                  "en": "Uses conditional probability distributions in the loss function",
                  "es": "Usa distribuciones de probabilidad condicional en la función de pérdida",
                  "de": "Verwendet bedingte Wahrscheinlichkeitsverteilungen in der Verlustfunktion",
                  "nl": "Gebruikt conditionele kansverdelingen in de verliesfunctie"
        },
        {
                  "en": "Conditions both generator and discriminator on additional information like class labels to control what type of data is generated",
                  "es": "Condiciona generador y discriminador en información adicional como etiquetas de clase para controlar tipo de datos generados",
                  "de": "Konditioniert Generator und Discriminator auf zusätzliche Informationen wie Klassenlabels um zu kontrollieren welche Daten generiert werden",
                  "nl": "Conditioneert generator en discriminator op aanvullende informatie zoals klasselabels om te controleren welk type data wordt gegenereerd"
        },
        {
                  "en": "Applies conditions to the training process to improve stability",
                  "es": "Aplica condiciones al proceso de entrenamiento para mejorar estabilidad",
                  "de": "Wendet Bedingungen auf den Trainingsprozess an um Stabilität zu verbessern",
                  "nl": "Past condities toe op het trainingsproces om stabiliteit te verbeteren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "β-VAE trains for β epochs longer than standard VAE",
                  "es": "β-VAE entrena por β épocas más que VAE estándar",
                  "de": "β-VAE trainiert β Epochen länger als Standard-VAE",
                  "nl": "β-VAE traint voor β epochs langer dan standaard VAE"
        },
        {
                  "en": "β-VAE uses weighted KL divergence term (β > 1) to encourage disentangled latent factors, trading reconstruction for interpretability",
                  "es": "β-VAE usa término KL divergencia ponderado (β > 1) para alentar factores desenredados, intercambia reconstrucción por interpretabilidad",
                  "de": "β-VAE verwendet gewichteten KL-Divergenz-Term (β > 1) für entwirrte Faktoren, tauscht Rekonstruktion gegen Interpretierbarkeit",
                  "nl": "β-VAE gebruikt gewogen KL divergentie term (β > 1) voor ontwards factoren, ruilt reconstructie voor interpreteerbaarheid"
        },
        {
                  "en": "β-VAE uses beta distribution for the prior instead of Gaussian",
                  "es": "β-VAE usa distribución beta para el prior en lugar de Gaussiana",
                  "de": "β-VAE verwendet Beta-Verteilung für den Prior anstatt Gaussian",
                  "nl": "β-VAE gebruikt beta verdeling voor de prior in plaats van Gaussiaans"
        },
        {
                  "en": "β-VAE has β times more parameters than standard VAE",
                  "es": "β-VAE tiene β veces más parámetros que VAE estándar",
                  "de": "β-VAE hat β mal mehr Parameter als Standard-VAE",
                  "nl": "β-VAE heeft β keer meer parameters dan standaard VAE"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses circular convolutions for translation tasks",
                  "es": "Usa convoluciones circulares para tareas de traducción",
                  "de": "Verwendet zirkuläre Faltungen für Übersetzungsaufgaben",
                  "nl": "Gebruikt circulaire convoluties voor vertalingstaken"
        },
        {
                  "en": "Enables unpaired image-to-image translation using cycle consistency loss to learn mappings between domains without paired training data",
                  "es": "Permite traducción no emparejada usando pérdida de consistencia cíclica para mapeos entre dominios sin datos emparejados",
                  "de": "Ermöglicht ungepaarte Übersetzung mit Zykluskonsisenzverlust für Mappings zwischen Domänen ohne gepaarte Daten",
                  "nl": "Maakt ongepaarde vertaling mogelijk met cyclus consistentie verlies voor mappings tussen domeinen zonder gepaarde data"
        },
        {
                  "en": "Cycles through different training phases automatically",
                  "es": "Cicla a través de diferentes fases de entrenamiento automáticamente",
                  "de": "Wechselt automatisch durch verschiedene Trainingsphasen",
                  "nl": "Cycleert automatisch door verschillende trainingsfases"
        },
        {
                  "en": "Creates cycles of multiple GANs for better image quality",
                  "es": "Crea ciclos de múltiples GANs para mejor calidad de imagen",
                  "de": "Erstellt Zyklen mehrerer GANs für bessere Bildqualität",
                  "nl": "Creëert cycli van meerdere GANs voor betere beeldkwaliteit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Progressively increases the dataset size during training",
                  "es": "Progresivamente aumenta el tamaño del conjunto de datos durante entrenamiento",
                  "de": "Erhöht progressiv die Datensatzgröße während des Trainings",
                  "nl": "Verhoogt progressief de datasetgrootte tijdens training"
        },
        {
                  "en": "Uses progressive training schedules with increasing difficulty",
                  "es": "Usa horarios de entrenamiento progresivos con dificultad creciente",
                  "de": "Verwendet progressive Trainingspläne mit steigender Schwierigkeit",
                  "nl": "Gebruikt progressieve trainingsschema's met toenemende moeilijkheidsgraad"
        },
        {
                  "en": "Makes progressive improvements to the loss function",
                  "es": "Hace mejoras progresivas a la función de pérdida",
                  "de": "Macht progressive Verbesserungen an der Verlustfunktion",
                  "nl": "Maakt progressieve verbeteringen aan de verliesfunctie"
        },
        {
                  "en": "Grows generator and discriminator networks from low to high resolution during training, improving stability and final image quality",
                  "es": "Hace crecer redes generador y discriminador de baja a alta resolución durante entrenamiento, mejora estabilidad y calidad",
                  "de": "Lässt Generator- und Discriminator-Netzwerke graduell von niedriger zu hoher Auflösung wachsen, verbessert Stabilität und Bildqualität",
                  "nl": "Laat generator en discriminator netwerken geleidelijk groeien van lage naar hoge resolutie, verbetert stabiliteit en kwaliteit"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Transfers style from one image to another using GANs",
                  "es": "Transfiere estilo de una imagen a otra usando GANs",
                  "de": "Überträgt Stil von einem Bild auf ein anderes mit GANs",
                  "nl": "Draagt stijl over van één beeld naar een ander met behulp van GANs"
        },
        {
                  "en": "Uses style-based generator architecture with adaptive instance normalization to enable fine-grained control over generated image attributes",
                  "es": "Usa arquitectura basada en estilo con normalización adaptativa para permitir control fino sobre atributos de imagen",
                  "de": "Verwendet stilbasierte Architektur mit adaptiver Normalisierung für feinkörnige Kontrolle über Bildattribute",
                  "nl": "Gebruikt stijl-gebaseerde architectuur met adaptieve normalisatie voor fijnmazige controle over beeldkenmerken"
        },
        {
                  "en": "Learns to copy the style of famous artists",
                  "es": "Aprende a copiar el estilo de artistas famosos",
                  "de": "Lernt den Stil berühmter Künstler zu kopieren",
                  "nl": "Leert de stijl van beroemde kunstenaars te kopiëren"
        },
        {
                  "en": "Generates images in different artistic styles automatically",
                  "es": "Genera imágenes en diferentes estilos artísticos automáticamente",
                  "de": "Generiert automatisch Bilder in verschiedenen künstlerischen Stilen",
                  "nl": "Genereert automatisch beelden in verschillende artistieke stijlen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A method for evaluating the lower bound of network performance",
                  "es": "Un método para evaluar el límite inferior de rendimiento de red",
                  "de": "Eine Methode zur Bewertung der unteren Grenze der Netzwerkleistung",
                  "nl": "Een methode voor het evalueren van de ondergrens van netwerkprestaties"
        },
        {
                  "en": "A tractable lower bound on the log-likelihood that combines reconstruction loss and KL divergence for training VAEs",
                  "es": "Un límite inferior manejable en la log-verosimilitud que combina pérdida de reconstrucción y divergencia KL para entrenar VAEs",
                  "de": "Eine handhabbare untere Grenze der Log-Likelihood die Rekonstruktionsverlust und KL-Divergenz für VAE-Training kombiniert",
                  "nl": "Een hanteerbare ondergrens op de log-likelihood die reconstructieverlies en KL divergentie combineert voor het trainen van VAEs"
        },
        {
                  "en": "A bound on the computational complexity of VAEs",
                  "es": "Un límite en la complejidad computacional de VAEs",
                  "de": "Eine Grenze der rechnerischen Komplexität von VAEs",
                  "nl": "Een grens op de computationele complexiteit van VAEs"
        },
        {
                  "en": "The minimum evidence required to validate VAE training",
                  "es": "La evidencia mínima requerida para validar entrenamiento VAE",
                  "de": "Die minimale Evidenz die für VAE-Training-Validierung erforderlich ist",
                  "nl": "Het minimale bewijs vereist om VAE training te valideren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Constrains the Lipschitz constant of the discriminator by normalizing weights with their spectral norm, ensuring stable gradients",
                  "es": "Restringe constante de Lipschitz del discriminador normalizando pesos con norma espectral, asegura gradientes estables",
                  "de": "Beschränkt Lipschitz-Konstante des Discriminators durch Normalisierung der Gewichte mit Spektralnorm, gewährleistet stabile Gradienten",
                  "nl": "Beperkt Lipschitz constante van discriminator door gewichten te normaliseren met spectrale norm, zorgt voor stabiele gradiënten"
        },
        {
                  "en": "Uses spectral decomposition for weight initialization",
                  "es": "Usa descomposición espectral para inicialización de pesos",
                  "de": "Verwendet Spektralzerlegung für Gewichtsinitialisierung",
                  "nl": "Gebruikt spectrale decompositie voor gewichtinitialisatie"
        },
        {
                  "en": "Applies spectral analysis to improve discriminator performance",
                  "es": "Aplica análisis espectral para mejorar rendimiento del discriminador",
                  "de": "Wendet Spektralanalyse an um Discriminator-Leistung zu verbessern",
                  "nl": "Past spectrale analyse toe om discriminator prestaties te verbeteren"
        },
        {
                  "en": "Normalizes the frequency spectrum of generated images",
                  "es": "Normaliza el espectro de frecuencia de imágenes generadas",
                  "de": "Normalisiert das Frequenzspektrum generierter Bilder",
                  "nl": "Normaliseert het frequentiespectrum van gegenereerde beelden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Quantizes the output to reduce memory usage",
                  "es": "Cuantiza la salida para reducir uso de memoria",
                  "de": "Quantisiert die Ausgabe um Speicherverbrauch zu reduzieren",
                  "nl": "Kwantiseert de output om geheugengebruik te verminderen"
        },
        {
                  "en": "Uses vector operations instead of scalar operations",
                  "es": "Usa operaciones vectoriales en lugar de operaciones escalares",
                  "de": "Verwendet Vektoroperationen anstatt Skalaroperationen",
                  "nl": "Gebruikt vectoroperaties in plaats van scalaire operaties"
        },
        {
                  "en": "Uses discrete latent representations through vector quantization instead of continuous latent variables, avoiding posterior collapse",
                  "es": "Usa representaciones latentes discretas a través de cuantización vectorial en lugar de variables continuas, evita colapso posterior",
                  "de": "Verwendet diskrete latente Repräsentationen durch Vektorquantisierung anstatt kontinuierlicher Variablen, vermeidet posterioren Kollaps",
                  "nl": "Gebruikt discrete latente representaties door vector kwantisatie in plaats van continue variabelen, vermijdt posterior collapse"
        },
        {
                  "en": "Quantizes the input vectors before encoding",
                  "es": "Cuantiza los vectores de entrada antes de codificar",
                  "de": "Quantisiert die Eingabevektoren vor der Kodierung",
                  "nl": "Kwantiseert de inputvectoren voor encoding"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adam uses root mean square while RMSprop uses mean square",
                  "es": "Adam usa raíz cuadrada media mientras RMSprop usa media cuadrada",
                  "de": "Adam verwendet Wurzel mittleres Quadrat während RMSprop mittleres Quadrat verwendet",
                  "nl": "Adam gebruikt wortel gemiddeld kwadraat terwijl RMSprop gemiddeld kwadraat gebruikt"
        },
        {
                  "en": "Adam adds momentum to RMSprop's adaptive learning rates and includes bias correction",
                  "es": "Adam añade momentum a las tasas de aprendizaje adaptativas de RMSprop e incluye corrección de sesgo",
                  "de": "Adam fügt Momentum zu RMSprops adaptiven Lernraten hinzu und enthält Bias-Korrektur",
                  "nl": "Adam voegt momentum toe aan RMSprop's adaptieve learning rates en bevat bias correctie"
        },
        {
                  "en": "They are identical optimizers with different names",
                  "es": "Son optimizadores idénticos con nombres diferentes",
                  "de": "Sie sind identische Optimizer mit verschiedenen Namen",
                  "nl": "Het zijn identieke optimizers met verschillende namen"
        },
        {
                  "en": "RMSprop is faster but less accurate than Adam",
                  "es": "RMSprop es más rápido pero menos preciso que Adam",
                  "de": "RMSprop ist schneller aber weniger genau als Adam",
                  "nl": "RMSprop is sneller maar minder nauwkeurig dan Adam"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Interpolates between different label categories",
                  "es": "Interpola entre diferentes categorías de etiquetas",
                  "de": "Interpoliert zwischen verschiedenen Label-Kategorien",
                  "nl": "Interpoleert tussen verschillende labelcategorieën"
        },
        {
                  "en": "Removes noise from mislabeled training examples",
                  "es": "Elimina ruido de ejemplos de entrenamiento mal etiquetados",
                  "de": "Entfernt Rauschen aus falsch beschrifteten Trainingsbeispielen",
                  "nl": "Verwijdert ruis uit verkeerd gelabelde trainingsvoorbeelden"
        },
        {
                  "en": "Replaces hard one-hot labels with soft targets to prevent overconfident predictions and improve calibration",
                  "es": "Reemplaza etiquetas one-hot duras con objetivos suaves para prevenir predicciones demasiado confiadas y mejorar calibración",
                  "de": "Ersetzt harte One-Hot-Labels durch weiche Ziele um überconfidente Vorhersagen zu verhindern und Kalibrierung zu verbessern",
                  "nl": "Vervangt harde one-hot labels met zachte targets om overconfident voorspellingen te voorkomen en kalibratie te verbeteren"
        },
        {
                  "en": "Smooths the training labels to make them easier to read",
                  "es": "Suaviza las etiquetas de entrenamiento para hacerlas más fáciles de leer",
                  "de": "Glättet die Trainingslabels um sie leichter lesbar zu machen",
                  "nl": "Maakt de trainingslabels gladder om ze gemakkelijker leesbaar te maken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mixes up the order of training examples randomly",
                  "es": "Mezcla aleatoriamente el orden de ejemplos de entrenamiento",
                  "de": "Mischt die Reihenfolge der Trainingsbeispiele zufällig",
                  "nl": "Mengt willekeurig de volgorde van trainingsvoorbeelden"
        },
        {
                  "en": "Trains on convex combinations of pairs of examples and their labels to improve generalization",
                  "es": "Entrena en combinaciones convexas de pares de ejemplos y sus etiquetas para mejorar generalización",
                  "de": "Trainiert auf konvexen Kombinationen von Beispielpaaren und ihren Labels um Generalisierung zu verbessern",
                  "nl": "Traint op convexe combinaties van paren voorbeelden en hun labels om generalisatie te verbeteren"
        },
        {
                  "en": "Combines multiple augmentation techniques simultaneously",
                  "es": "Combina múltiples técnicas de aumentación simultáneamente",
                  "de": "Kombiniert mehrere Augmentierungstechniken gleichzeitig",
                  "nl": "Combineert meerdere augmentatietechnieken tegelijkertijd"
        },
        {
                  "en": "Mixes different datasets together for training",
                  "es": "Mezcla diferentes conjuntos de datos juntos para entrenamiento",
                  "de": "Mischt verschiedene Datensätze zusammen für Training",
                  "nl": "Mengt verschillende datasets samen voor training"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding up gradients from different models",
                  "es": "Sumar gradientes de diferentes modelos",
                  "de": "Gradienten von verschiedenen Modellen addieren",
                  "nl": "Gradiënten van verschillende modellen optellen"
        },
        {
                  "en": "Storing all gradients throughout training for analysis",
                  "es": "Almacenar todos los gradientes durante entrenamiento para análisis",
                  "de": "Alle Gradienten während Training für Analyse speichern",
                  "nl": "Alle gradiënten opslaan tijdens training voor analyse"
        },
        {
                  "en": "Accumulating gradients over multiple mini-batches before updating weights, simulating larger batch sizes with limited memory",
                  "es": "Acumular gradientes sobre múltiples mini-lotes antes de actualizar pesos, simulando tamaños de lote más grandes con memoria limitada",
                  "de": "Gradienten über mehrere Mini-Batches akkumulieren vor Gewichtsaktualisierung, simuliert größere Batch-Größen mit begrenztem Speicher",
                  "nl": "Gradiënten accumuleren over meerdere mini-batches voor het updaten van gewichten, simuleert grotere batch groottes met beperkt geheugen"
        },
        {
                  "en": "Accumulating momentum for faster convergence",
                  "es": "Acumular momentum para convergencia más rápida",
                  "de": "Momentum akkumulieren für schnellere Konvergenz",
                  "nl": "Momentum accumuleren voor snellere convergentie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using a pre-trained teacher model to guide training",
                  "es": "Usar un modelo maestro pre-entrenado para guiar entrenamiento",
                  "de": "Ein vortrainiertes Lehrer-Modell verwenden um Training zu leiten",
                  "nl": "Een voorgetraind leraar model gebruiken om training te begeleiden"
        },
        {
                  "en": "Forcing the model to learn from teacher examples only",
                  "es": "Forzar al modelo a aprender solo de ejemplos del maestro",
                  "de": "Das Modell zwingen nur von Lehrer-Beispielen zu lernen",
                  "nl": "Het model dwingen om alleen van leraar voorbeelden te leren"
        },
        {
                  "en": "Enforcing strict supervision during model training",
                  "es": "Imponer supervisión estricta durante entrenamiento del modelo",
                  "de": "Strikte Überwachung während Modelltraining durchsetzen",
                  "nl": "Strikte supervisie afdwingen tijdens model training"
        },
        {
                  "en": "Using ground truth outputs as inputs for the next decoding step during training instead of model predictions",
                  "es": "Usar salidas reales como entradas para el siguiente paso de decodificación durante entrenamiento en lugar de predicciones",
                  "de": "Grundwahrheit-Ausgaben als Eingaben für den nächsten Dekodierungsschritt während Training verwenden anstatt Modellvorhersagen",
                  "nl": "Ground truth outputs gebruiken als inputs voor de volgende decoderingsstap tijdens training in plaats van modelvoorspellingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gradually increasing learning rate from small value at start to prevent instability from poor initialization",
                  "es": "Aumentar gradualmente tasa de aprendizaje de valor pequeño al inicio para prevenir inestabilidad de inicialización pobre",
                  "de": "Lernrate graduell von kleinem Wert am Anfang erhöhen um Instabilität von schlechter Initialisierung zu verhindern",
                  "nl": "Geleidelijk learning rate verhogen vanaf kleine waarde aan het begin om instabiliteit door slechte initialisatie te voorkomen"
        },
        {
                  "en": "Loading data into memory before training starts",
                  "es": "Cargar datos en memoria antes de que comience entrenamiento",
                  "de": "Daten in Speicher laden bevor Training beginnt",
                  "nl": "Data in geheugen laden voordat training begint"
        },
        {
                  "en": "Warming up the GPU before serious training begins",
                  "es": "Calentar la GPU antes de que comience el entrenamiento serio",
                  "de": "Die GPU aufwärmen bevor ernsthaftes Training beginnt",
                  "nl": "De GPU opwarmen voordat serieuze training begint"
        },
        {
                  "en": "Pre-training the model on easier examples first",
                  "es": "Pre-entrenar el modelo en ejemplos más fáciles primero",
                  "de": "Das Modell zuerst auf einfacheren Beispielen vortrainieren",
                  "nl": "Het model eerst pre-trainen op makkelijkere voorbeelden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Attention mechanism that learns automatically without supervision",
                  "es": "Mecanismo de atención que aprende automáticamente sin supervisión",
                  "de": "Aufmerksamkeitsmechanismus der automatisch ohne Überwachung lernt",
                  "nl": "Attention mechanisme dat automatisch leert zonder supervisie"
        },
        {
                  "en": "Computes attention within a single sequence by relating different positions to each other, rather than between encoder and decoder",
                  "es": "Calcula atención dentro de una secuencia relacionando diferentes posiciones entre sí, no entre codificador y decodificador",
                  "de": "Berechnet Aufmerksamkeit innerhalb einer Sequenz durch Beziehung verschiedener Positionen zueinander, nicht zwischen Encoder und Decoder",
                  "nl": "Berekent attention binnen een sequentie door verschillende posities aan elkaar te relateren, niet tussen encoder en decoder"
        },
        {
                  "en": "Attention focused on self-improvement during training",
                  "es": "Atención enfocada en auto-mejora durante entrenamiento",
                  "de": "Aufmerksamkeit auf Selbstverbesserung während Training fokussiert",
                  "nl": "Attention gericht op zelfverbetering tijdens training"
        },
        {
                  "en": "The model paying attention to its own parameters",
                  "es": "El modelo prestando atención a sus propios parámetros",
                  "de": "Das Modell achtet auf seine eigenen Parameter",
                  "nl": "Het model dat aandacht besteedt aan zijn eigen parameters"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using adversarial loss functions for better convergence",
                  "es": "Usar funciones de pérdida adversarias para mejor convergencia",
                  "de": "Adversarielle Verlustfunktionen für bessere Konvergenz verwenden",
                  "nl": "Adversariële loss functies gebruiken voor betere convergentie"
        },
        {
                  "en": "Training two models to compete against each other",
                  "es": "Entrenar dos modelos para competir entre sí",
                  "de": "Zwei Modelle trainieren um gegeneinander zu konkurrieren",
                  "nl": "Twee modellen trainen om tegen elkaar te concurreren"
        },
        {
                  "en": "Training in adversarial conditions with limited resources",
                  "es": "Entrenar en condiciones adversas con recursos limitados",
                  "de": "Training unter widrigen Bedingungen mit begrenzten Ressourcen",
                  "nl": "Trainen onder ongunstige omstandigheden met beperkte middelen"
        },
        {
                  "en": "Training on adversarial examples created by adding small perturbations designed to fool the model",
                  "es": "Entrenar en ejemplos adversarios creados añadiendo pequeñas perturbaciones diseñadas para engañar al modelo",
                  "de": "Training auf adversariellen Beispielen erstellt durch Hinzufügen kleiner Störungen entworfen um das Modell zu täuschen",
                  "nl": "Trainen op adversariële voorbeelden gemaakt door kleine verstoringen toe te voegen ontworpen om het model te misleiden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Feature extraction is faster but fine-tuning is more accurate",
                  "es": "Extracción de características es más rápida pero ajuste fino es más preciso",
                  "de": "Feature-Extraktion ist schneller aber Fine-Tuning ist genauer",
                  "nl": "Feature extractie is sneller maar fine-tuning is nauwkeuriger"
        },
        {
                  "en": "Fine-tuning requires more data than feature extraction",
                  "es": "Ajuste fino requiere más datos que extracción de características",
                  "de": "Fine-Tuning erfordert mehr Daten als Feature-Extraktion",
                  "nl": "Fine-tuning vereist meer data dan feature extractie"
        },
        {
                  "en": "Fine-tuning updates pre-trained weights while feature extraction freezes them and only trains new layers",
                  "es": "Ajuste fino actualiza pesos pre-entrenados mientras extracción de características los congela y solo entrena nuevas capas",
                  "de": "Fine-Tuning aktualisiert vortrainierte Gewichte während Feature-Extraktion sie einfriert und nur neue Schichten trainiert",
                  "nl": "Fine-tuning werkt voorgetrainde gewichten bij terwijl feature extractie ze bevriest en alleen nieuwe lagen traint"
        },
        {
                  "en": "They are the same approach with different names",
                  "es": "Son el mismo enfoque con nombres diferentes",
                  "de": "Sie sind derselbe Ansatz mit verschiedenen Namen",
                  "nl": "Het zijn dezelfde aanpak met verschillende namen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Clipping gradients to integer values for efficiency",
                  "es": "Recortar gradientes a valores enteros para eficiencia",
                  "de": "Gradienten auf ganzzahlige Werte clippen für Effizienz",
                  "nl": "Gradiënten clippen naar integer waarden voor efficiëntie"
        },
        {
                  "en": "Cutting off very small gradients to speed up training",
                  "es": "Cortar gradientes muy pequeños para acelerar entrenamiento",
                  "de": "Sehr kleine Gradienten abschneiden um Training zu beschleunigen",
                  "nl": "Zeer kleine gradiënten afkappen om training te versnellen"
        },
        {
                  "en": "Limiting gradient magnitudes to prevent exploding gradients during backpropagation, especially in RNNs",
                  "es": "Limitar magnitudes de gradiente para prevenir gradientes que explotan durante retropropagación, especialmente en RNNs",
                  "de": "Gradientenmagnitude begrenzen um explodierende Gradienten während Backpropagation zu verhindern, besonders in RNNs",
                  "nl": "Gradiënt magnitudes beperken om exploderende gradiënten tijdens backpropagation te voorkomen, vooral in RNNs"
        },
        {
                  "en": "Removing gradients that point in wrong directions",
                  "es": "Remover gradientes que apuntan en direcciones incorrectas",
                  "de": "Gradienten entfernen die in falsche Richtungen zeigen",
                  "nl": "Gradiënten verwijderen die in verkeerde richtingen wijzen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Automatically searches for the learning rate in hyperparameter space",
                  "es": "Busca automáticamente la tasa de aprendizaje en espacio de hiperparámetros",
                  "de": "Sucht automatisch nach Lernrate im Hyperparameterraum",
                  "nl": "Zoekt automatisch naar de learning rate in hyperparameter ruimte"
        },
        {
                  "en": "Finds which layers need different learning rates",
                  "es": "Encuentra qué capas necesitan diferentes tasas de aprendizaje",
                  "de": "Findet welche Schichten verschiedene Lernraten benötigen",
                  "nl": "Vindt welke lagen verschillende learning rates nodig hebben"
        },
        {
                  "en": "Determines when to change the learning rate during training",
                  "es": "Determina cuándo cambiar la tasa de aprendizaje durante entrenamiento",
                  "de": "Bestimmt wann die Lernrate während Training geändert werden soll",
                  "nl": "Bepaalt wanneer de learning rate te veranderen tijdens training"
        },
        {
                  "en": "Systematically increases learning rate during short training run to find optimal range by observing loss behavior",
                  "es": "Aumenta sistemáticamente tasa de aprendizaje durante entrenamiento corto para encontrar rango óptimo observando pérdida",
                  "de": "Erhöht systematisch Lernrate während kurzen Trainingslaufs um optimalen Bereich zu finden durch Verlustbeobachtung",
                  "nl": "Verhoogt systematisch learning rate tijdens korte trainingsrun om optimaal bereik te vinden door loss gedrag te observeren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Randomly varying the depth of the network architecture",
                  "es": "Variar aleatoriamente la profundidad de la arquitectura de red",
                  "de": "Zufällig die Tiefe der Netzwerkarchitektur variieren",
                  "nl": "Willekeurig de diepte van de netwerkarchitectuur variëren"
        },
        {
                  "en": "Adding random depth to convolutional layers",
                  "es": "Añadir profundidad aleatoria a capas convolucionales",
                  "de": "Zufällige Tiefe zu Faltungsschichten hinzufügen",
                  "nl": "Willekeurige diepte toevoegen aan convolutionele lagen"
        },
        {
                  "en": "Using stochastic processes to determine network depth",
                  "es": "Usar procesos estocásticos para determinar profundidad de red",
                  "de": "Stochastische Prozesse verwenden um Netzwerktiefe zu bestimmen",
                  "nl": "Stochastische processen gebruiken om netwerkdiepte te bepalen"
        },
        {
                  "en": "Randomly drops entire layers during training while keeping them at test time, reducing overfitting in very deep networks",
                  "es": "Descarta aleatoriamente capas enteras durante entrenamiento manteniéndolas en tiempo de prueba, reduce sobreajuste",
                  "de": "Lässt zufällig ganze Schichten während Training fallen während sie bei Testzeit behalten werden, reduziert Overfitting",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Applies cosine functions to the loss landscape",
                  "es": "Aplica funciones coseno al paisaje de pérdida",
                  "de": "Wendet Kosinusfunktionen auf die Verlustlandschaft an",
                  "nl": "Past cosinus functies toe op het verlieslandschap"
        },
        {
                  "en": "Anneals the network using cosine similarity metrics",
                  "es": "Anula la red usando métricas de similitud coseno",
                  "de": "Glüht das Netzwerk mit Kosinus-Ähnlichkeitsmetriken",
                  "nl": "Annealt het netwerk met cosinus similariteitsmetrieken"
        },
        {
                  "en": "Decreases learning rate following a cosine curve from initial to minimum value, optionally with restarts",
                  "es": "Disminuye tasa de aprendizaje siguiendo una curva coseno de valor inicial a mínimo, opcionalmente con reinicios",
                  "de": "Verringert Lernrate entlang einer Kosinuskurve von Anfangs- zu Minimalwert, optional mit Neustarts",
                  "nl": "Vermindert learning rate volgens een cosinus curve van initiële naar minimum waarde, optioneel met herstarts"
        },
        {
                  "en": "Uses cosine distance to adjust learning rates",
                  "es": "Usa distancia coseno para ajustar tasas de aprendizaje",
                  "de": "Verwendet Kosinusdistanz um Lernraten anzupassen",
                  "nl": "Gebruikt cosinus afstand om learning rates aan te passen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Instance normalization normalizes each sample independently while batch normalization uses batch statistics",
                  "es": "Normalización de instancia normaliza cada muestra independientemente mientras normalización por lotes usa estadísticas de lote",
                  "de": "Instance Normalization normalisiert jedes Sample unabhängig während Batch Normalization Batch-Statistiken verwendet",
                  "nl": "Instance normalisatie normaliseert elk sample onafhankelijk terwijl batch normalisatie batch statistieken gebruikt"
        },
        {
                  ...
                  "nl": "Het zijn dezelfde techniek met verschillende namen"
        },
        {
                  "en": "Instance normalization works only for classification tasks",
                  "es": "Normalización de instancia funciona solo para tareas de clasificación",
                  "de": "Instance Normalization funktioniert nur für Klassifikationsaufgaben",
                  "nl": "Instance normalisatie werkt alleen voor classificatietaken"
        },
        {
                  "en": "Instance normalization is faster than batch normalization",
                  "es": "Normalización de instancia es más rápida que normalización por lotes",
                  "de": "Instance Normalization ist schneller als Batch Normalization",
                  "nl": "Instance normalisatie is sneller dan batch normalisatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Searches for existing architectures in research papers",
                  "es": "Busca arquitecturas existentes en artículos de investigación",
                  "de": "Sucht nach existierenden Architekturen in Forschungsarbeiten",
                  "nl": "Zoekt naar bestaande architecturen in onderzoekspapers"
        },
        {
                  "en": "Automatically discovers architectures by searching through architecture space using RL, evolution, or gradient-based methods",
                  "es": "Descubre automáticamente arquitecturas buscando a través del espacio de arquitectura usando RL, evolución o métodos basados en gradientes",
                  "de": "Entdeckt automatisch Architekturen durch Suche im Architekturraum mit RL, Evolution oder gradientenbasierten Methoden",
                  "nl": "Ontdekt automatisch architecturen door te zoeken door architectuurruimte met RL, evolutie of gradiënt-gebaseerde methoden"
        },
        {
                  "en": "Analyzes network architectures to find optimal hyperparameters",
                  "es": "Analiza arquitecturas de red para encontrar hiperparámetros óptimos",
                  "de": "Analysiert Netzwerkarchitekturen um optimale Hyperparameter zu finden",
                  "nl": "Analyseert netwerkarchitecturen om optimale hyperparameters te vinden"
        },
        {
                  "en": "Uses neural networks to design other neural networks manually",
                  "es": "Usa redes neuronales para diseñar otras redes neuronales manualmente",
                  "de": "Verwendet neuronale Netzwerke um andere neuronale Netzwerke manuell zu entwerfen",
                  "nl": "Gebruikt neurale netwerken om andere neurale netwerken handmatig te ontwerpen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Entrenar un solo modelo en múltiples tareas relacionadas simultáneamente, permitiendo compartir conocimiento y mejorar generalización",
                  "de": "Ein einzelnes Modell auf mehreren verwandten Aufgaben gleichzeitig trainieren, ermöglicht Wissensaustausch und verbesserte Generalisierung",
                  "nl": "Een enkel model trainen op meerdere gerelateerde taken tegelijkertijd, maakt kennisdeling en verbeterde generalisatie mogelijk"
        },
        {
                  "en": "Learning to switch between different tasks during inference",
                  "es": "Aprender a cambiar entre diferentes tareas durante inferencia",
                  "de": "Lernen zwischen verschiedenen Aufgaben während Inferenz zu wechseln",
                  "nl": "Leren om te schakelen tussen verschillende taken tijdens inferentie"
        },
        {
                  "en": "Running multiple training tasks in parallel on different GPUs",
                  "es": "Ejecutar múltiples tareas de entrenamiento en paralelo en diferentes GPUs",
                  "de": "Mehrere Trainingsaufgaben parallel auf verschiedenen GPUs ausführen",
                  "nl": "Meerdere trainingstaken parallel uitvoeren op verschillende GPU's"
        },
        {
                  "en": "Training separate models for each task independently",
                  "es": "Entrenar modelos separados para cada tarea independientemente",
                  "de": "Separate Modelle für jede Aufgabe unabhängig trainieren",
                  "nl": "Aparte modellen voor elke taak onafhankelijk trainen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Initializing all weights to zero before training",
                  "es": "Inicializar todos los pesos a cero antes de entrenamiento",
                  "de": "Alle Gewichte vor Training auf null initialisieren",
                  "nl": "Alle gewichten initialiseren naar nul voor training"
        },
        {
                  "en": "Classifying or generating examples from classes never seen during training using semantic embeddings or descriptions",
                  "es": "Clasificar o generar ejemplos de clases nunca vistas durante entrenamiento usando embeddings semánticos",
                  "de": "Beispiele aus nie gesehenen Klassen klassifizieren oder generieren mit semantischen Embeddings oder Beschreibungen",
                  "nl": "Voorbeelden classificeren of genereren uit nooit geziene klassen met semantische embeddings of beschrijvingen"
        },
        {
                  "en": "Learning without any training examples at all",
                  "es": "Aprender sin ningún ejemplo de entrenamiento en absoluto",
                  "de": "Lernen ohne jegliche Trainingsbeispiele",
                  "nl": "Leren zonder enige trainingsvoorbeelden"
        },
        {
                  "en": "Training models with zero gradient updates",
                  "es": "Entrenar modelos con cero actualizaciones de gradiente",
                  "de": "Modelle mit null Gradientenaktualisierungen trainieren",
                  "nl": "Modellen trainen met nul gradiënt updates"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning throughout the entire lifetime of the application",
                  "es": "Aprender durante toda la vida de la aplicación",
                  "de": "Während der gesamten Lebensdauer der Anwendung lernen",
                  "nl": "Leren gedurende de hele levensduur van de applicatie"
        },
        {
                  "en": "Continuously updating model parameters during deployment",
                  "es": "Actualizar continuamente parámetros del modelo durante despliegue",
                  "de": "Modellparameter während Deployment kontinuierlich aktualisieren",
                  "nl": "Modelparameters continu bijwerken tijdens deployment"
        },
        {
                  "en": "Learning new tasks sequentially without forgetting previous ones, addressing catastrophic forgetting",
                  "es": "Aprender nuevas tareas secuencialmente sin olvidar las previas, abordando olvido catastrófico",
                  "de": "Neue Aufgaben sequenziell lernen ohne vorherige zu vergessen, adressiert katastrophales Vergessen",
                  "nl": "Nieuwe taken sequentieel leren zonder vorige te vergeten, pakt catastrofaal vergeten aan"
        },
        {
                  "en": "Training models continuously without stopping",
                  "es": "Entrenar modelos continuamente sin parar",
                  "de": "Modelle kontinuierlich trainieren ohne anzuhalten",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Calculates loss at focal points in the network",
                  "es": "Calcula pérdida en puntos focales de la red",
                  "de": "Berechnet Verlust an Fokuspunkten im Netzwerk",
                  "nl": "Berekent loss op focale punten in het netwerk"
        },
        {
                  "en": "Addresses class imbalance by down-weighting easy examples and focusing training on hard negatives",
                  "es": "Aborda desbalance de clases reduciendo peso de ejemplos fáciles y enfocando entrenamiento en negativos difíciles",
                  "de": "Adressiert Klassenungleichgewicht durch Heruntergewichten einfacher Beispiele und Fokussierung des Trainings auf schwere Negative",
                  "nl": "Pakt klasse onbalans aan door gemakkelijke voorbeelden minder zwaar te wegen en training te focussen op moeilijke negatieven"
        },
        {
                  "en": "Sharpens the focus of neural attention mechanisms",
                  "es": "Agudiza el enfoque de mecanismos de atención neuronal",
                  "de": "Schärft den Fokus neuronaler Aufmerksamkeitsmechanismen",
                  "nl": "Scherpt de focus van neurale attention mechanismen aan"
        },
        {
                  "en": "Focuses the loss function on specific regions of images",
                  "es": "Enfoca la función de pérdida en regiones específicas de imágenes",
                  "de": "Fokussiert die Verlustfunktion auf spezifische Bildregionen",
                  "nl": "Focust de loss functie op specifieke regio's van beelden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Scales the learning rate based on training temperature",
                  "es": "Escala la tasa de aprendizaje basada en temperatura de entrenamiento",
                  "de": "Skaliert die Lernrate basierend auf Trainingstemperatur",
                  "nl": "Schaalt de learning rate gebaseerd op trainingstemperatuur"
        },
        {
                  "en": "Prevents the network from overheating during training",
                  "es": "Previene que la red se sobrecaliente durante entrenamiento",
                  "de": "Verhindert Überhitzung des Netzwerks während Training",
                  "nl": "Voorkomt dat het netwerk oververhit raakt tijdens training"
        },
        {
                  "en": "Calibrates model confidence by dividing logits by temperature T before softmax, improving probability estimates",
                  "es": "Calibra confianza del modelo dividiendo logits por temperatura T antes de softmax, mejorando estimaciones de probabilidad",
                  "de": "Kalibriert Modellvertrauen durch Teilen von Logits durch Temperatur T vor Softmax, verbessert Wahrscheinlichkeitsschätzungen",
                  "nl": "Kalibreert modelvertrouwen door logits te delen door temperatuur T voor softmax, verbetert waarschijnlijkheidsschattingen"
        },
        {
                  "en": "Adjusts network weights based on computational temperature",
                  "es": "Ajusta pesos de red basado en temperatura computacional",
                  "de": "Passt Netzwerkgewichte basierend auf Rechentemperatur an",
                  "nl": "Past netwerkgewichten aan gebaseerd op computationele temperatuur"
        }
        ],
        correct: 2,
        explanation: {
