    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Creating convolutions in mathematical equations",
                  "es": "Crear convoluciones en ecuaciones matemáticas",
                  "de": "Faltungen in mathematischen Gleichungen erstellen",
                  "nl": "Convoluties creëren in wiskundige vergelijkingen"
        },
        {
                  "en": "Processing grid-like data such as images by detecting spatial patterns",
                  "es": "Procesar datos tipo rejilla como imágenes detectando patrones espaciales",
                  "de": "Gitterartige Daten wie Bilder durch Erkennung räumlicher Muster verarbeiten",
                  "nl": "Rasterachtige data zoals afbeeldingen verwerken door ruimtelijke patronen te detecteren"
        },
        {
                  "en": "Processing sequential text data only",
                  "es": "Procesar solo datos de texto secuencial",
                  "de": "Nur sequenzielle Textdaten verarbeiten",
                  "nl": "Alleen sequentiële tekstdata verwerken"
        },
        {
                  "en": "Converting neural networks to different formats",
                  "es": "Convertir redes neuronales a diferentes formatos",
                  "de": "Neuronale Netzwerke in verschiedene Formate konvertieren",
                  "nl": "Neurale netwerken converteren naar verschillende formaten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Add more layers to the network",
                  "es": "Agregar más capas a la red",
                  "de": "Mehr Schichten zum Netzwerk hinzufügen",
                  "nl": "Meer lagen toevoegen aan het netwerk"
        },
        {
                  "en": "Store data in memory pools",
                  "es": "Almacenar datos en pools de memoria",
                  "de": "Daten in Speicherpools speichern",
                  "nl": "Data opslaan in geheugenpools"
        },
        {
        ...
        {
                  "en": "Increase the number of parameters in the network",
                  "es": "Aumentar el número de parámetros en la red",
                  "de": "Die Anzahl der Parameter im Netzwerk erhöhen",
                  "nl": "Het aantal parameters in het netwerk verhogen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting one learning algorithm to another",
                  "es": "Convertir un algoritmo de aprendizaje a otro",
                  "de": "Einen Lernalgorithmus in einen anderen umwandeln",
                  "nl": "Een leeralgoritme converteren naar een ander"
        },
        {
                  "en": "Transferring data between different computers",
                  "es": "Transferir datos entre diferentes computadoras",
                  "de": "Daten zwischen verschiedenen Computern übertragen",
                  "nl": "Data overdragen tussen verschillende computers"
        },
        {
                  "en": "Moving neural networks to different hardware",
                  "es": "Mover redes neuronales a diferentes hardware",
                  "de": "Neuronale Netzwerke auf verschiedene Hardware verschieben",
                  "nl": "Neurale netwerken verplaatsen naar verschillende hardware"
        },
        {
                  "en": "Using pre-trained models on new tasks by adapting learned features",
                  "es": "Usar modelos pre-entrenados en nuevas tareas adaptando características aprendidas",
                  "de": "Vortrainierte Modelle für neue Aufgaben verwenden durch Anpassung gelernter Merkmale",
                  "nl": "Voorgetrainde modellen gebruiken voor nieuwe taken door geleerde kenmerken aan te passen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Overfitting uses too few parameters, underfitting uses too many",
                  "es": "Sobreajuste usa muy pocos parámetros, subajuste usa demasiados",
                  "de": "Overfitting verwendet zu wenige Parameter, Underfitting verwendet zu viele",
                  "nl": "Overfitting gebruikt te weinig parameters, underfitting gebruikt te veel"
        },
        {
                  "en": "Both terms refer to the same concept",
                  "es": "Ambos términos se refieren al mismo concepto",
                  "de": "Beide Begriffe beziehen sich auf dasselbe Konzept",
                  "nl": "Beide termen verwijzen naar hetzelfde concept"
        },
        {
                  "en": "Overfitting memorizes training data poorly generalizing, underfitting fails to learn underlying patterns",
                  "es": "Sobreajuste memoriza datos de entrenamiento generalizando mal, subajuste falla en aprender patrones subyacentes",
                  "de": "Overfitting memoriert Trainingsdaten schlecht generalisierend, Underfitting versagt zugrundeliegende Muster zu lernen",
                  "nl": "Overfitting memoriseert trainingsdata met slechte generalisatie, underfitting faalt onderliggende patronen te leren"
        },
        {
                  "en": "Overfitting trains too slowly, underfitting trains too quickly",
                  "es": "Sobreajuste entrena muy lentamente, subajuste entrena muy rápidamente",
                  "de": "Overfitting trainiert zu langsam, Underfitting trainiert zu schnell",
                  "nl": "Overfitting traint te langzaam, underfitting traint te snel"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Converts all negative values to positive",
                  "es": "Convierte todos los valores negativos a positivos",
                  "de": "Wandelt alle negativen Werte in positive um",
                  "nl": "Converteert alle negatieve waarden naar positieve"
        },
        {
                  "en": "Normalizes all outputs to between 0 and 1",
                  "es": "Normaliza todas las salidas entre 0 y 1",
                  "de": "Normalisiert alle Ausgaben zwischen 0 und 1",
                  "nl": "Normaliseert alle outputs tussen 0 en 1"
        },
        {
                  "en": "Introduces non-linearity while being computationally efficient and reducing vanishing gradient problems",
                  "es": "Introduce no linealidad siendo computacionalmente eficiente y reduciendo problemas de gradiente que desaparece",
                  "de": "Führt Nichtlinearität ein während es rechnerisch effizient ist und Probleme mit verschwindenden Gradienten reduziert",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A method for rotating images",
                  "es": "Un método para rotar imágenes",
                  "de": "Eine Methode zum Drehen von Bildern",
                  "nl": "Een methode voor het roteren van afbeeldingen"
        },
        {
                  "en": "A mathematical operation that slides a filter over input data to detect features by computing element-wise products and sums",
                  "es": "Una operación matemática que desliza filtro sobre datos para detectar características computando productos y sumas",
                  "de": "Eine mathematische Operation die Filter über Daten schiebt um Merkmale durch Berechnung elementweiser Produkte zu erkennen",
                  "nl": "Een wiskundige operatie die filter over data schuift om kenmerken te detecteren door element-gewijs producten te berekenen"
        },
        {
                  "en": "A technique for changing image colors",
                  "es": "Una técnica para cambiar colores de imagen",
                  "de": "Eine Technik zum Ändern von Bildfarben",
                  "nl": "Een techniek voor het veranderen van afbeeldingskleuren"
        },
        {
                  "en": "A process of combining multiple images together",
                  "es": "Un proceso de combinar múltiples imágenes juntas",
                  "de": "Ein Prozess zur Kombination mehrerer Bilder",
                  "nl": "Een proces van het combineren van meerdere afbeeldingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The core processing unit of the computer",
                  "es": "La unidad de procesamiento central de la computadora",
                  "de": "Die zentrale Verarbeitungseinheit des Computers",
                  "nl": "De centrale verwerkingseenheid van de computer"
        },
        {
                  "en": "A file containing the entire neural network",
                  "es": "Un archivo que contiene toda la red neuronal",
                  "de": "Eine Datei die das gesamte neuronale Netzwerk enthält",
                  "nl": "Een bestand dat het gehele neurale netwerk bevat"
        },
        {
                  "en": "A layer that filters out bad data",
                  "es": "Una capa que filtra datos malos",
                  "de": "Eine Schicht die schlechte Daten herausfiltert",
                  "nl": "Een laag die slechte data filtert"
        },
        {
                  "en": "A small matrix of weights that detects specific features when convolved with input data",
                  "es": "Una matriz pequeña de pesos que detecta características específicas cuando se convoluciona con datos de entrada",
                  "de": "Eine kleine Matrix von Gewichten die spezifische Merkmale erkennt wenn sie mit Eingabedaten gefaltet wird",
                  "nl": "Een kleine matrix van gewichten die specifieke kenmerken detecteert wanneer geconvolueerd met inputdata"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining all pooling layers together",
                  "es": "Combinar todas las capas de pooling juntas",
                  "de": "Alle Pooling-Schichten zusammenfassen",
                  "nl": "Alle pooling lagen samencombineren"
        },
        {
                  "en": "Setting the maximum size for memory pools",
                  "es": "Establecer el tamaño máximo para pools de memoria",
                  "de": "Die maximale Größe für Speicherpools festlegen",
                  "nl": "De maximale grootte instellen voor geheugenpools"
        },
        {
                  "en": "Finding the maximum number of pools in the network",
                  "es": "Encontrar el número máximo de pools en la red",
                  "de": "Die maximale Anzahl von Pools im Netzwerk finden",
                  "nl": "Het maximale aantal pools in het netwerk vinden"
        },
        {
                  "en": "A downsampling operation that takes the maximum value from each region of the feature map",
                  "es": "Una operación de submuestreo que toma el valor máximo de cada región del mapa de características",
                  "de": "Eine Downsampling-Operation die den maximalen Wert aus jeder Region der Feature-Map nimmt",
                  "nl": "Een downsampling operatie die de maximale waarde neemt uit elke regio van de feature map"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Agregar ceros alrededor de bordes de entrada para controlar tamaño de salida y preservar información de bordes",
                  "de": "Nullen um Eingaberänder hinzufügen um Ausgabegröße zu kontrollieren und Randinformationen zu bewahren",
                  "nl": "Nullen of waarden rond inputranden toevoegen om outputgrootte te controleren en randinformatie te behouden"
        },
        {
                  "en": "Extra layers added for more processing",
                  "es": "Capas extra agregadas para más procesamiento",
                  "de": "Zusätzliche Schichten für mehr Verarbeitung hinzugefügt",
                  "nl": "Extra lagen toegevoegd voor meer verwerking"
        },
        {
                  "en": "Soft material to protect the neural network",
                  "es": "Material suave para proteger la red neuronal",
                  "de": "Weiches Material zum Schutz des neuronalen Netzwerks",
                  "nl": "Zacht materiaal om het neurale netwerk te beschermen"
        },
        {
                  "en": "Empty space between network layers",
                  "es": "Espacio vacío entre capas de red",
                  "de": "Leerer Raum zwischen Netzwerkschichten",
                  "nl": "Lege ruimte tussen netwerklagen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The speed at which the network processes data",
                  "es": "La velocidad a la que la red procesa datos",
                  "de": "Die Geschwindigkeit mit der das Netzwerk Daten verarbeitet",
                  "nl": "De snelheid waarmee het netwerk data verwerkt"
        },
        {
                  "en": "The distance between layers in the network",
                  "es": "La distancia entre capas en la red",
                  "de": "Der Abstand zwischen Schichten im Netzwerk",
                  "nl": "De afstand tussen lagen in het netwerk"
        },
        {
                  "en": "The step size by which the filter moves across the input, controlling output dimensions",
                  "es": "El tamaño de paso por el cual el filtro se mueve a través de la entrada, controlando dimensiones de salida",
                  "de": "Die Schrittgröße mit der sich der Filter über die Eingabe bewegt, kontrolliert Ausgabedimensionen",
                  "nl": "De stapgrootte waarmee de filter over de input beweegt, controleert outputdimensies"
        },
        {
                  "en": "The number of steps in the training process",
                  "es": "El número de pasos en el proceso de entrenamiento",
                  "de": "Die Anzahl der Schritte im Trainingsprozess",
                  "nl": "Het aantal stappen in het trainingsproces"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Visual representations of network architecture",
                  "es": "Representaciones visuales de arquitectura de red",
                  "de": "Visuelle Darstellungen der Netzwerkarchitektur",
                  "nl": "Visuele representaties van netwerkarchitectuur"
        },
        {
                  "en": "Maps showing the geographic features of training data",
                  "es": "Mapas mostrando características geográficas de datos de entrenamiento",
                  "de": "Karten die geografische Merkmale von Trainingsdaten zeigen",
                  "nl": "Kaarten die geografische kenmerken van trainingsdata tonen"
        },
        {
                  "en": "The output of convolutional layers showing spatial locations of detected features",
                  "es": "La salida de capas convolucionales mostrando ubicaciones espaciales de características detectadas",
                  "de": "Die Ausgabe von Faltungsschichten die räumliche Positionen erkannter Merkmale zeigen",
                  "nl": "De output van convolutielagen die ruimtelijke locaties van gedetecteerde kenmerken tonen"
        },
        {
                  "en": "Documentation of all features in the network",
                  "es": "Documentación de todas las características en la red",
                  "de": "Dokumentation aller Merkmale im Netzwerk",
                  "nl": "Documentatie van alle kenmerken in het netwerk"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Same padding is for training, valid padding is for testing",
                  "es": "Same padding es para entrenamiento, valid padding es para pruebas",
                  "de": "Same Padding ist für Training, valid Padding ist für Testen",
                  "nl": "Same padding is voor training, valid padding is voor testen"
        },
        {
                  "en": "Same padding keeps output size equal to input size, valid padding reduces output size",
                  "es": "Same padding mantiene tamaño de salida igual al tamaño de entrada, valid padding reduce tamaño de salida",
                  "de": "Same Padding hält Ausgabegröße gleich Eingabegröße, valid Padding reduziert Ausgabegröße",
                  "nl": "Same padding houdt outputgrootte gelijk aan inputgrootte, valid padding vermindert outputgrootte"
        },
        {
        ...
        {
                  "en": "Same padding uses zeros, valid padding uses ones",
                  "es": "Same padding usa ceros, valid padding usa unos",
                  "de": "Same Padding verwendet Nullen, valid Padding verwendet Einsen",
                  "nl": "Same padding gebruikt nullen, valid padding gebruikt enen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using more powerful computers for training",
                  "es": "Usar computadoras más poderosas para entrenamiento",
                  "de": "Leistungsstärkere Computer für Training verwenden",
                  "nl": "Krachtigere computers gebruiken voor training"
        },
        {
                  "en": "Increasing the resolution of input images",
                  "es": "Aumentar la resolución de imágenes de entrada",
                  "de": "Die Auflösung von Eingabebildern erhöhen",
                  "nl": "De resolutie van invoerbeelden verhogen"
        },
        {
                  "en": "Adding more layers to make the network bigger",
                  "es": "Agregar más capas para hacer la red más grande",
                  "de": "Mehr Schichten hinzufügen um das Netzwerk größer zu machen",
                  "nl": "Meer lagen toevoegen om het netwerk groter te maken"
        },
        {
                  "en": "Artificially expanding the training dataset by applying transformations like rotation, scaling, or flipping to existing images",
                  "es": "Expandir dataset de entrenamiento aplicando transformaciones como rotación, escalado o volteo a imágenes",
                  "de": "Trainingsdatensatz erweitern durch Transformationen wie Rotation, Skalierung oder Spiegelung auf Bilder",
                  "nl": "Trainingsdataset uitbreiden door transformaties zoals rotatie, schaling of spiegeling op beelden toe te passen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The network's ability to receive new information",
                  "es": "La capacidad de la red para recibir nueva información",
                  "de": "Die Fähigkeit des Netzwerks neue Informationen zu empfangen",
                  "nl": "Het vermogen van het netwerk om nieuwe informatie te ontvangen"
        },
        {
                  "en": "The area of memory used for data reception",
                  "es": "El área de memoria usada para recepción de datos",
                  "de": "Der Speicherbereich für Datenempfang verwendet",
                  "nl": "Het geheugengebied gebruikt voor data-ontvangst"
        },
        {
                  "en": "A field where the network receives training data",
                  "es": "Un campo donde la red recibe datos de entrenamiento",
                  "de": "Ein Feld wo das Netzwerk Trainingsdaten empfängt",
                  "nl": "Een veld waar het netwerk trainingsdata ontvangt"
        },
        {
                  "en": "The region of the input image that influences a particular feature in the output",
                  "es": "La región de la imagen de entrada que influye en una característica particular en la salida",
                  "de": "Die Region des Eingabebildes die ein Merkmal in der Ausgabe beeinflusst",
                  "nl": "Het gebied van het invoerbeeld dat een bepaald kenmerk in de output beïnvloedt"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A layer that connects to the internet",
                  "es": "Una capa que se conecta a internet",
                  "de": "Eine Schicht die sich mit dem Internet verbindet",
                  "nl": "Een laag die verbindt met het internet"
        },
        {
                  "en": "A layer where all connections are the same strength",
                  "es": "Una capa donde todas las conexiones tienen la misma fuerza",
                  "de": "Eine Schicht wo alle Verbindungen dieselbe Stärke haben",
                  "nl": "Een laag waar alle verbindingen dezelfde sterkte hebben"
        },
        {
                  "en": "A dense layer where every neuron connects to every neuron in the previous layer, typically used for final classification",
                  "es": "Una capa densa donde cada neurona se conecta a cada neurona en la capa anterior, típicamente usada para clasificación final",
                  "de": "Dichte Schicht wo jedes Neuron mit jedem Neuron der vorherigen Schicht verbunden ist, für finale Klassifikation",
                  "nl": "Een dichte laag waar elk neuron verbonden is met elk neuron in de vorige laag, typisch gebruikt voor finale classificatie"
        },
        {
                  "en": "A convolutional layer with full coverage",
                  "es": "Una capa convolucional con cobertura completa",
                  "de": "Eine Faltungsschicht mit vollständiger Abdeckung",
                  "nl": "Een convolutielaag met volledige dekking"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To visualize what features the network has learned and which parts of the input activate specific neurons",
                  "es": "Visualizar qué características aprendió la red y qué partes de entrada activan neuronas específicas",
                  "de": "Visualisieren welche Merkmale das Netzwerk lernte und welche Eingabeteile Neuronen aktivieren",
                  "nl": "Visualiseren welke kenmerken het netwerk leerde en welke inputdelen specifieke neuronen activeren"
        },
        {
                  "en": "To show the geographical locations of data",
                  "es": "Para mostrar las ubicaciones geográficas de datos",
                  "de": "Um die geografischen Standorte von Daten zu zeigen",
                  "nl": "Om de geografische locaties van data te tonen"
        },
        {
                  "en": "To activate the network for training",
                  "es": "Para activar la red para entrenamiento",
                  "de": "Um das Netzwerk für Training zu aktivieren",
                  "nl": "Om het netwerk te activeren voor training"
        },
        {
                  "en": "To map the network topology",
                  "es": "Para mapear la topología de la red",
                  "de": "Um die Netzwerktopologie zu kartieren",
                  "nl": "Om de netwerktopologie in kaart te brengen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A network architecture used only for color image processing",
                  "es": "Una arquitectura de red usada solo para procesamiento de imágenes en color",
                  "de": "Eine Netzwerkarchitektur nur für Farbbildverarbeitung verwendet",
                  "nl": "Een netwerkarchitectuur alleen gebruikt voor kleurbeeldverwerking"
        },
        {
                  "en": "The most modern CNN architecture available today",
                  "es": "La arquitectura CNN más moderna disponible hoy",
                  "de": "Die modernste CNN-Architektur die heute verfügbar ist",
                  "nl": "De meest moderne CNN architectuur die vandaag beschikbaar is"
        },
        {
                  "en": "A network designed specifically for natural language processing",
                  "es": "Una red diseñada específicamente para procesamiento de lenguaje natural",
                  "de": "Ein Netzwerk speziell für natürliche Sprachverarbeitung entworfen",
                  "nl": "Een netwerk specifiek ontworpen voor natuurlijke taalverwerking"
        },
        {
                  "en": "One of the first successful CNN architectures, pioneering the use of convolutional layers for handwritten digit recognition",
                  "es": "Una de las primeras arquitecturas CNN exitosas, pionera en capas convolucionales para dígitos manuscritos",
                  "de": "Eine der ersten erfolgreichen CNN-Architekturen, Pionier für handgeschriebene Ziffernerkennung",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Image quality decreases through the layers",
                  "es": "La calidad de imagen disminuye a través de las capas",
                  "de": "Bildqualität nimmt durch die Schichten ab",
                  "nl": "Beeldkwaliteit neemt af door de lagen"
        },
        {
                  "en": "The network gradually forgets learned features",
                  "es": "La red gradualmente olvida características aprendidas",
                  "de": "Das Netzwerk vergisst graduell gelernte Merkmale",
                  "nl": "Het netwerk vergeet geleidelijk geleerde kenmerken"
        },
        {
                  "en": "Gradients become exponentially smaller in earlier layers during backpropagation, making deep networks hard to train effectively",
                  "es": "Gradienten se vuelven exponencialmente más pequeños en capas anteriores, haciendo difícil entrenar redes profundas",
                  "de": "Gradienten werden exponentiell kleiner in früheren Schichten, macht tiefe Netzwerke schwer trainierbar",
                  "nl": "Gradiënten worden exponentieel kleiner in eerdere lagen, maakt diepe netwerken moeilijk trainbaar"
        },
        {
                  "en": "CNNs lose their convolution properties over time",
                  "es": "Las CNNs pierden sus propiedades de convolución con el tiempo",
                  "de": "CNNs verlieren ihre Faltungseigenschaften über die Zeit",
                  "nl": "CNNs verliezen hun convolutie-eigenschappen na verloop van tijd"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "1x1 convolutions are faster but less accurate",
                  "es": "Las convoluciones 1x1 son más rápidas pero menos precisas",
                  "de": "1x1 Faltungen sind schneller aber weniger genau",
                  "nl": "1x1 convoluties zijn sneller maar minder nauwkeurig"
        },
        {
                  "en": "1x1 convolutions only work with grayscale images",
                  "es": "Las convoluciones 1x1 solo funcionan con imágenes en escala de grises",
                  "de": "1x1 Faltungen funktionieren nur mit Graustufenbildern",
                  "nl": "1x1 convoluties werken alleen met grijsschaalbeelden"
        },
        {
                  "en": "There is no practical difference between them",
                  "es": "No hay diferencia práctica entre ellas",
                  "de": "Es gibt keinen praktischen Unterschied zwischen ihnen",
                  "nl": "Er is geen praktisch verschil tussen hen"
        },
        {
                  "en": "1x1 convolutions reduce dimensions and compute linear combinations across channels, while larger kernels capture spatial patterns",
                  "es": "Convoluties 1x1 reducen dimensies y calculan combinaciones lineales, kernels grandes capturan patrones espaciales",
                  "de": "1x1 Faltungen reduzieren Dimensionen und berechnen lineare Kombinationen, größere Kernels erfassen räumliche Muster",
                  "nl": "1x1 convoluties verminderen dimensies en berekenen lineaire combinaties, grotere kernels vastleggen ruimtelijke patronen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using only convolutional layers for sequence processing",
                  "es": "Usar solo capas convolucionales para procesamiento de secuencias",
                  "de": "Nur Konvolutionsschichten für Sequenzverarbeitung verwenden",
                  "nl": "Alleen convolutionele lagen gebruiken voor sequentieverwerking"
        },
        {
                  "en": "Self-attention mechanism that processes all sequence positions simultaneously",
                  "es": "Mecanismo de auto-atención que procesa todas las posiciones de secuencia simultáneamente",
                  "de": "Selbstaufmerksamkeitsmechanismus der alle Sequenzpositionen gleichzeitig verarbeitet",
                  "nl": "Zelf-aandacht mechanisme dat alle sequentieposities tegelijkertijd verwerkt"
        },
        {
                  "en": "Eliminating all forms of neural connections",
                  "es": "Eliminar todas las formas de conexiones neuronales",
                  "de": "Alle Formen neuronaler Verbindungen eliminieren",
                  "nl": "Alle vormen van neurale verbindingen elimineren"
        },
        {
                  "en": "Processing sequences one element at a time only",
                  "es": "Procesar secuencias solo un elemento a la vez",
                  "de": "Sequenzen nur ein Element nach dem anderen verarbeiten",
                  "nl": "Sequenties slechts één element tegelijk verwerken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combine batches into single training examples",
                  "es": "Combinar lotes en ejemplos de entrenamiento únicos",
                  "de": "Batches zu einzelnen Trainingsbeispielen kombinieren",
                  "nl": "Batches combineren tot enkele trainingsvoorbeelden"
        },
        {
                  "en": "Normalize layer inputs to stabilize training and allow higher learning rates",
                  ...
                  "nl": "Laagin inputs normaliseren om training te stabiliseren en hogere learning rates mogelijk te maken"
        },
        {
                  "en": "Normalize only the output layer",
                  "es": "Normalizar solo la capa de salida",
                  "de": "Nur die Ausgabeschicht normalisieren",
                  "nl": "Alleen de outputlaag normaliseren"
        },
        {
                  "en": "Process multiple batches simultaneously",
                  "es": "Procesar múltiples lotes simultáneamente",
                  "de": "Mehrere Batches gleichzeitig verarbeiten",
                  "nl": "Meerdere batches tegelijkertijd verwerken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Being the first CNN ever created",
                  "es": "Ser la primera CNN jamás creada",
                  "de": "Das erste CNN sein das jemals erstellt wurde",
                  "nl": "Het eerste CNN zijn dat ooit is gemaakt"
        },
        {
                  "en": "Using very deep networks with small 3x3 filters consistently throughout",
                  "es": "Usar redes muy profundas con filtros pequeños 3x3 consistentemente en toda la red",
                  "de": "Sehr tiefe Netzwerke mit kleinen 3x3 Filtern durchgehend verwenden",
                  "nl": "Zeer diepe netwerken gebruiken met kleine 3x3 filters consistent door heel het netwerk"
        },
        {
                  "en": "Using only 1x1 convolutions",
                  "es": "Usar solo convoluciones 1x1",
                  "de": "Nur 1x1 Faltungen verwenden",
                  "nl": "Alleen 1x1 convoluties gebruiken"
        },
        {
                  "en": "Having the smallest number of parameters",
                  "es": "Tener el menor número de parámetros",
                  "de": "Die kleinste Anzahl von Parametern haben",
                  "nl": "Het kleinste aantal parameters hebben"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Takes the mean of values in each pooling region, often used in final layers before classification",
                  "es": "Toma la media de valores en cada región de pooling, frecuentemente usado en capas finales antes de clasificación",
                  "de": "Nimmt den Mittelwert von Werten in jeder Pooling-Region, oft in finalen Schichten vor Klassifikation verwendet",
                  "nl": "Neemt het gemiddelde van waarden in elke pooling regio, vaak gebruikt in finale lagen voor classificatie"
        },
        {
                  "en": "Uses median values instead of maximum",
                  "es": "Usa valores medianos en lugar de máximos",
                  "de": "Verwendet Medianwerte anstelle von Maximums",
                  "nl": "Gebruikt mediaan waarden in plaats van maximum"
        },
        {
                  "en": "Calculates the average network performance",
                  "es": "Calcula el rendimiento promedio de la red",
                  "de": "Berechnet die durchschnittliche Netzwerkleistung",
                  "nl": "Berekent de gemiddelde netwerkprestatie"
        },
        {
                  "en": "Pools data from average quality images only",
                  "es": "Hace pooling de datos solo de imágenes de calidad promedio",
                  "de": "Pooling von Daten nur aus durchschnittlichen Qualitätsbildern",
                  "nl": "Pool data alleen van gemiddelde kwaliteit beelden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Network crashes by backing up neurons",
                  "es": "Fallos de red respaldando neuronas",
                  "de": "Netzwerkabstürze durch Sichern von Neuronen",
                  "nl": "Netwerk crashes door neuronen te back-uppen"
        },
        {
                  "en": "Memory issues by compressing weights",
                  "es": "Problemas de memoria comprimiendo pesos",
                  "de": "Speicherprobleme durch Komprimierung von Gewichten",
                  "nl": "Geheugenproblemen door gewichten te comprimeren"
        },
        {
                  "en": "Overfitting by randomly deactivating neurons during training to prevent co-adaptation",
                  "es": "Sobreajuste desactivando aleatoriamente neuronas durante entrenamiento para prevenir co-adaptación",
                  "de": "Overfitting durch zufälliges Deaktivieren von Neuronen während Training um Ko-Adaptation zu verhindern",
                  "nl": "Overfitting door willekeurig neuronen te deactiveren tijdens training om co-adaptatie te voorkomen"
        },
        {
                  "en": "Slow training by removing unnecessary layers",
                  "es": "Entrenamiento lento removiendo capas innecesarias",
                  "de": "Langsames Training durch Entfernen unnötiger Schichten",
                  "nl": "Langzame training door onnodige lagen te verwijderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Being the smallest CNN architecture",
                  "es": "Ser la arquitectura CNN más pequeña",
                  "de": "Die kleinste CNN-Architektur sein",
                  "nl": "De kleinste CNN architectuur zijn"
        },
        {
                  "en": "Using only average pooling layers",
                  "es": "Usar solo capas de average pooling",
                  "de": "Nur Average Pooling Schichten verwenden",
                  "nl": "Alleen average pooling lagen gebruiken"
        },
        {
                  "en": "Demonstrating that deep CNNs trained on GPUs could significantly outperform traditional methods on ImageNet",
                  "es": "Demostrar que CNNs profundas entrenadas en GPUs podían superar significativamente métodos tradicionales en ImageNet",
                  "de": "Zeigen dass tiefe CNNs auf GPUs trainiert traditionelle Methoden auf ImageNet deutlich übertreffen konnten",
                  "nl": "Aantonen dat diepe CNNs getraind op GPUs traditionele methoden op ImageNet significant konden overtreffen"
        },
        {
                  "en": "Eliminating all activation functions",
                  "es": "Eliminar todas las funciones de activación",
                  "de": "Alle Aktivierungsfunktionen eliminieren",
                  "nl": "Alle activatiefuncties elimineren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Connections that activate only sometimes",
                  "es": "Conexiones que se activan solo a veces",
                  "de": "Verbindungen die nur manchmal aktivieren",
                  "nl": "Verbindingen die soms activeren"
        },
        {
                  "en": "Removing unnecessary connections permanently",
                  "es": "Remover conexiones innecesarias permanentemente",
                  "de": "Unnötige Verbindungen dauerhaft entfernen",
                  "nl": "Onnodige verbindingen permanent verwijderen"
        },
        {
                  "en": "A direct path that bypasses one or more layers, allowing gradient flow and feature reuse",
                  "es": "Un camino directo que evita una o más capas, permitiendo flujo de gradiente y reutilización de características",
                  "de": "Ein direkter Pfad der eine oder mehrere Schichten umgeht, ermöglicht Gradientenfluss und Feature-Wiederverwendung",
                  "nl": "Een direct pad dat een of meer lagen omzeilt, maakt gradiënt flow en feature hergebruik mogelijk"
        },
        {
                  "en": "Skipping training iterations to save time",
                  "es": "Saltar iteraciones de entrenamiento para ahorrar tiempo",
                  "de": "Trainingsiterationen überspringen um Zeit zu sparen",
                  "nl": "Trainingsiteraties overslaan om tijd te besparen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Eliminating all pooling operations",
                  "es": "Eliminar todas las operaciones de pooling",
                  "de": "Alle Pooling-Operationen eliminieren",
                  "nl": "Alle pooling operaties elimineren"
        },
        {
                  "en": "Processing images at the moment of inception",
                  "es": "Procesar imágenes en el momento de inicio",
                  "de": "Bilder zum Zeitpunkt des Beginns verarbeiten",
                  "nl": "Beelden verwerken op het moment van begin"
        },
        {
                  "en": "Using only the largest possible filters",
                  "es": "Usar solo los filtros más grandes posibles",
                  "de": "Nur die größtmöglichen Filter verwenden",
                  "nl": "Alleen de grootst mogelijke filters gebruiken"
        },
        {
                  "en": "Using multiple filter sizes in parallel within the same layer to capture features at different scales",
                  "es": "Usar múltiples tamaños de filtro en paralelo dentro de la misma capa para capturar características en diferentes escalas",
                  "de": "Mehrere Filtergrößen parallel in derselben Schicht verwenden um Merkmale in verschiedenen Skalen zu erfassen",
                  "nl": "Meerdere filter groottes parallel gebruiken binnen dezelfde laag om kenmerken op verschillende schalen vast te leggen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using average pooling globally across networks",
                  "es": "Usar average pooling globalmente a través de redes",
                  "de": "Average Pooling global über Netzwerke verwenden",
                  "nl": "Average pooling globaal over netwerken gebruiken"
        },
        {
                  "en": "Averaging all pooling layers together",
                  "es": "Promediar todas las capas de pooling juntas",
                  "de": "Alle Pooling-Schichten zusammen mitteln",
                  "nl": "Alle pooling lagen samen middelen"
        },
        {
                  "en": "Computing the average of each entire feature map to produce a single value per channel",
                  "es": "Calcular el promedio de cada mapa de características completo para producir un solo valor por canal",
                  "de": "Den Durchschnitt jeder gesamten Feature-Map berechnen um einen einzelnen Wert pro Kanal zu erzeugen",
                  "nl": "Het gemiddelde berekenen van elke hele feature map om een enkele waarde per kanaal te produceren"
        },
        {
                  "en": "Pooling from multiple datasets simultaneously",
                  "es": "Hacer pooling de múltiples conjuntos de datos simultáneamente",
                  "de": "Pooling aus mehreren Datensätzen gleichzeitig",
                  "nl": "Pooling van meerdere datasets tegelijkertijd"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A regularization technique that adds a penalty proportional to weight magnitudes to the loss function",
                  "es": "Una técnica de regularización que añade una penalización proporcional a magnitudes de peso a la función de pérdida",
                  "de": "Eine Regularisierungstechnik die eine Strafe proportional zu Gewichtsmagnitude zur Verlustfunktion hinzufügt",
                  "nl": "Een regularisatietechniek die een penalty proportioneel aan gewicht magnitudes toevoegt aan de loss functie"
        },
        {
                  "en": "Weights losing precision during calculations",
                  "es": "Los pesos perdiendo precisión durante cálculos",
                  "de": "Gewichte verlieren Präzision während Berechnungen",
                  "nl": "Gewichten verliezen precisie tijdens berekeningen"
        },
        {
                  "en": "Weights gradually becoming corrupt over time",
                  "es": "Los pesos gradualmente corrompiéndose con el tiempo",
                  "de": "Gewichte werden allmählich korrupt über die Zeit",
                  "nl": "Gewichten geleidelijk corrupt worden in de tijd"
        },
        {
                  "en": "Reducing the number of weights each epoch",
                  "es": "Reducir el número de pesos cada época",
                  "de": "Die Anzahl der Gewichte jede Epoche reduzieren",
                  "nl": "Het aantal gewichten elke epoch verminderen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Separating training and testing convolutions",
                  "es": "Separar convoluciones de entrenamiento y prueba",
                  "de": "Trainings- und Testfaltungen trennen",
                  "nl": "Trainings- en test convoluties scheiden"
        },
        {
                  "en": "Using different convolutions for different depths",
                  "es": "Usar diferentes convoluciones para diferentes profundidades",
                  "de": "Verschiedene Faltungen für verschiedene Tiefen verwenden",
                  "nl": "Verschillende convoluties gebruiken voor verschillende dieptes"
        },
        {
                  "en": "Convolutions that only process image depth",
                  "es": "Convoluciones que solo procesan profundidad de imagen",
                  "de": "Faltungen die nur Bildtiefe verarbeiten",
                  "nl": "Convoluties die alleen beelddiepte verwerken"
        },
        {
                  "en": "Factorizing standard convolutions into depthwise and pointwise operations to reduce parameters and computation",
                  "es": "Factorizar convoluciones estándar en operaciones depthwise y pointwise para reducir parámetros y computación",
                  "de": "Standardfaltungen in tiefenweise und punktweise Operationen faktorisieren um Parameter und Berechnung zu reduzieren",
                  "nl": "Standaard convoluties factoriseren in depthwise en pointwise operaties om parameters en berekening te verminderen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adjusting the learning rate during training to improve convergence and fine-tune the model",
                  "es": "Ajustar la tasa de aprendizaje durante entrenamiento para mejorar convergencia y afinar el modelo",
                  "de": "Die Lernrate während Training anpassen um Konvergenz zu verbessern und das Modell feinzujustieren",
                  "nl": "De learning rate aanpassen tijdens training om convergentie te verbeteren en het model fijn af te stellen"
        },
        {
                  "en": "Setting the same learning rate for all epochs",
                  "es": "Establecer la misma tasa de aprendizaje para todas las épocas",
                  "de": "Dieselbe Lernrate für alle Epochen festlegen",
                  "nl": "Dezelfde learning rate instellen voor alle epochs"
        },
        {
                  "en": "Determining how long training should take",
                  "es": "Determinar cuánto tiempo debería tomar el entrenamiento",
                  "de": "Bestimmen wie lange Training dauern sollte",
                  "nl": "Bepalen hoe lang training moet duren"
        },
        {
                  "en": "Scheduling when the network should learn",
                  "es": "Programar cuándo la red debería aprender",
                  "de": "Planen wann das Netzwerk lernen sollte",
                  "nl": "Plannen wanneer het netwerk moet leren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Semantic assigns class to each pixel, instance distinguishes individual objects of the same class",
                  "es": "Semántica asigna clase a cada píxel, instancia distingue objetos individuales de la misma clase",
                  "de": "Semantisch weist jedem Pixel eine Klasse zu, Instanz unterscheidet einzelne Objekte derselben Klasse",
                  "nl": "Semantisch wijst klasse toe aan elk pixel, instance onderscheidt individuele objecten van dezelfde klasse"
        },
        {
        ...
        {
                  "en": "Semantic uses CNNs, instance uses RNNs",
                  "es": "Semántica usa CNNs, instancia usa RNNs",
                  "de": "Semantisch verwendet CNNs, Instanz verwendet RNNs",
                  "nl": "Semantisch gebruikt CNNs, instance gebruikt RNNs"
        },
        {
                  "en": "Semantic is for images, instance is for videos",
                  "es": "Semántica es para imágenes, instancia es para videos",
                  "de": "Semantisch ist für Bilder, Instanz ist für Videos",
                  "nl": "Semantisch is voor beelden, instance is voor video's"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Copying gradients to multiple layers",
                  "es": "Copiar gradientes a múltiples capas",
                  "de": "Gradienten auf mehrere Schichten kopieren",
                  "nl": "Gradiënten kopiëren naar meerdere lagen"
        },
        {
                  "en": "Removing gradients completely from training",
                  "es": "Remover gradientes completamente del entrenamiento",
                  "de": "Gradienten vollständig aus dem Training entfernen",
                  "nl": "Gradiënten volledig verwijderen uit training"
        },
        {
                  "en": "Limiting gradient magnitudes to prevent exploding gradients during backpropagation",
                  "es": "Limitar magnitudes de gradiente para prevenir gradientes que explotan durante retropropagación",
                  "de": "Gradientenmagnitude begrenzen um explodierende Gradienten während Backpropagation zu verhindern",
                  "nl": "Gradiënt magnitudes beperken om exploderende gradiënten tijdens backpropagation te voorkomen"
        },
        {
                  "en": "Cutting training short when gradients appear",
                  "es": "Cortar entrenamiento cuando aparecen gradientes",
                  "de": "Training abbrechen wenn Gradienten erscheinen",
                  "nl": "Training afkappen wanneer gradiënten verschijnen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Blocks used only during testing phase",
                  "es": "Bloques usados solo durante fase de prueba",
                  "de": "Blöcke nur während Testphase verwendet",
                  "nl": "Blokken alleen gebruikt tijdens testfase"
        },
        {
                  "en": "Blocks with skip connections that learn residual functions F(x) added to the input x",
                  "es": "Bloques con conexiones de salto que aprenden funciones residuales F(x) añadidas a la entrada x",
                  "de": "Blöcke mit Skip-Verbindungen die Residualfunktionen F(x) lernen die zur Eingabe x addiert werden",
                  "nl": "Blokken met skip verbindingen die residual functies F(x) leren toegevoegd aan de input x"
        },
        {
                  "en": "Blocks that contain leftover unused neurons",
                  "es": "Bloques que contienen neuronas no usadas sobrantes",
                  "de": "Blöcke die übrig gebliebene ungenutzte Neuronen enthalten",
                  "nl": "Blokken die overblijvende ongebruikte neuronen bevatten"
        },
        {
                  "en": "The final layers that produce residual errors",
                  "es": "Las capas finales que producen errores residuales",
                  "de": "Die finalen Schichten die Restfehler produzieren",
                  "nl": "De finale lagen die residuele fouten produceren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Scaling input values to similar ranges improves gradient flow and convergence speed",
                  "es": "Escalar valores de entrada a rangos similares mejora flujo de gradiente y velocidad de convergencia",
                  "de": "Eingabewerte auf ähnliche Bereiche skalieren verbessert Gradientenfluss und Konvergenzgeschwindigkeit",
                  "nl": "Inputwaarden schalen naar vergelijkbare bereiken verbetert gradiënt flow en convergentiesnelheid"
        },
        {
                  "en": "Converting images to grayscale",
                  "es": "Convertir imágenes a escala de grises",
                  "de": "Bilder in Graustufen umwandeln",
                  "nl": "Beelden converteren naar grijsschaal"
        },
        {
                  "en": "Making all images the same size",
                  "es": "Hacer todas las imágenes del mismo tamaño",
                  "de": "Alle Bilder gleich groß machen",
                  "nl": "Alle beelden dezelfde grootte maken"
        },
        {
                  "en": "Removing outliers from the dataset",
                  "es": "Remover valores atípicos del conjunto de datos",
                  "de": "Ausreißer aus dem Datensatz entfernen",
                  "nl": "Uitbijters verwijderen uit de dataset"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Manually selecting important features from images",
                  "es": "Seleccionar manualmente características importantes de imágenes",
                  "de": "Wichtige Merkmale aus Bildern manuell auswählen",
                  "nl": "Handmatig belangrijke kenmerken selecteren uit beelden"
        },
        {
                  "en": "Extracting raw pixel values from images",
                  "es": "Extraer valores de píxeles crudos de imágenes",
                  "de": "Rohe Pixelwerte aus Bildern extrahieren",
                  "nl": "Ruwe pixelwaarden extraheren uit beelden"
        },
        {
                  "en": "Using pre-trained CNN layers as fixed feature extractors, training only new final layers for the target task",
                  "es": "Usar capas CNN pre-entrenadas como extractores fijos, entrenar solo capas finales para la tarea objetivo",
                  "de": "Vortrainierte CNN-Schichten als Feature-Extraktoren verwenden, nur neue finale Schichten trainieren",
                  "nl": "Voorgetrainde CNN lagen als vaste feature extractors gebruiken, alleen finale lagen trainen voor de taak"
        },
        {
                  "en": "Removing unnecessary layers from networks",
                  "es": "Remover capas innecesarias de redes",
                  "de": "Unnötige Schichten aus Netzwerken entfernen",
                  "nl": "Onnodige lagen verwijderen uit netwerken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Halting training when validation performance stops improving to prevent overfitting",
                  "es": "Detener entrenamiento cuando rendimiento de validación deja de mejorar para prevenir sobreajuste",
                  "de": "Training stoppen wenn Validierungsleistung aufhört sich zu verbessern um Overfitting zu verhindern",
                  "nl": "Training stoppen wanneer validatieprestatie stopt met verbeteren om overfitting te voorkomen"
        },
        {
        ...
        {
                  "en": "Terminating training due to errors",
                  "es": "Terminar entrenamiento debido a errores",
                  "de": "Training aufgrund von Fehlern beenden",
                  "nl": "Training beëindigen vanwege fouten"
        },
        {
                  "en": "Starting training earlier than scheduled",
                  "es": "Comenzar entrenamiento antes de lo programado",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Unfreezing and retraining some pre-trained layers with a low learning rate for the new task",
                  "es": "Descongelar y reentrenar algunas capas pre-entrenadas con una tasa de aprendizaje baja para la nueva tarea",
                  "de": "Einige vortrainierte Schichten auftauen und mit niedriger Lernrate für die neue Aufgabe neu trainieren",
                  "nl": "Sommige voorgetrainde lagen ontdooien en opnieuw trainen met een lage learning rate voor de nieuwe taak"
        },
        {
                  "en": "Training the entire network from scratch with careful tuning",
                  "es": "Entrenar toda la red desde cero con ajuste cuidadoso",
                  "de": "Das gesamte Netzwerk von Grund auf mit sorgfältiger Abstimmung trainieren",
                  "nl": "Het hele netwerk vanaf nul trainen met zorgvuldige afstemming"
        },
        {
                  "en": "Reducing model size for better performance",
                  "es": "Reducir tamaño del modelo para mejor rendimiento",
                  "de": "Modellgröße reduzieren für bessere Leistung",
                  "nl": "Modelgrootte verkleinen voor betere prestaties"
        },
        {
                  "en": "Making small adjustments to hyperparameters only",
                  "es": "Hacer solo pequeños ajustes a hiperparámetros",
                  "de": "Nur kleine Anpassungen an Hyperparametern vornehmen",
                  "nl": "Alleen kleine aanpassingen maken aan hyperparameters"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Convolution with expanded output dimensions",
                  "es": "Convolución con dimensiones de salida expandidas",
                  "de": "Faltung mit erweiterten Ausgabedimensionen",
                  "nl": "Convolutie met uitgebreide outputdimensies"
        },
        {
                  "en": "Convolution that processes diluted images",
                  "es": "Convolución que procesa imágenes diluidas",
                  "de": "Faltung die verdünnte Bilder verarbeitet",
                  "nl": "Convolutie die verdunde beelden verwerkt"
        },
        {
                  "en": "A type of pooling operation",
                  "es": "Un tipo de operación de pooling",
                  "de": "Eine Art von Pooling-Operation",
                  "nl": "Een type pooling operatie"
        },
        {
                  "en": "Convolution with gaps between kernel elements to increase receptive field without adding parameters",
                  "es": "Convolución con espacios entre elementos de kernel para aumentar campo receptivo sin agregar parámetros",
                  "de": "Faltung mit Lücken zwischen Kernel-Elementen um rezeptives Feld zu vergrößern ohne Parameter hinzuzufügen",
                  "nl": "Convolutie met gaten tussen kernel elementen om receptief veld te vergroten zonder parameters toe te voegen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reducing the maximum values in outputs",
                  "es": "Reducir los valores máximos en salidas",
                  "de": "Maximale Werte in Ausgaben reduzieren",
                  "nl": "Maximale waarden in outputs verminderen"
        },
        {
                  "en": "Converting raw output scores into a probability distribution over multiple classes that sum to 1",
                  "es": "Convertir puntuaciones de salida crudas en una distribución de probabilidad sobre múltiples clases que suman 1",
                  "de": "Rohe Ausgabescores in eine Wahrscheinlichkeitsverteilung über mehrere Klassen umwandeln die zu 1 summieren",
                  "nl": "Ruwe output scores converteren naar een waarschijnlijkheidsverdeling over meerdere klassen die optellen tot 1"
        },
        {
                  "en": "Softening hard decision boundaries",
                  "es": "Suavizar límites de decisión duros",
                  "de": "Harte Entscheidungsgrenzen weicher machen",
                  "nl": "Harde beslissingsgrenzen verzachten"
        },
        {
                  "en": "Making the network train more softly",
                  "es": "Hacer que la red entrene más suavemente",
                  "de": "Das Netzwerk weicher trainieren lassen",
                  "nl": "Het netwerk zachter laten trainen"
        }
        ],
        correct: 1,
        explanation: {
