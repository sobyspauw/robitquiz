    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "New abilities that emerge from model fine-tuning",
                  "es": "Nuevas habilidades que emergen del ajuste fino de modelos",
                  "de": "Neue Fähigkeiten die aus Modell-Feinabstimmung entstehen",
                  "nl": "Nieuwe vaardigheden die ontstaan uit model fine-tuning"
        },
        {
                  "en": "Abilities that emerge during training without supervision",
                  "es": "Habilidades que emergen durante entrenamiento sin supervisión",
                  "de": "Fähigkeiten die während des Trainings ohne Überwachung entstehen",
                  "nl": "Vaardigheden die ontstaan tijdens training zonder supervisie"
        },
        {
                  "en": "Emergency response capabilities in AI systems",
                  "es": "Capacidades de respuesta de emergencia en sistemas de IA",
                  "de": "Notfallreaktionsfähigkeiten in KI-Systemen",
                  "nl": "Noodrespons capaciteiten in AI systemen"
        },
        {
                  "en": "Capabilities that appear at scale that weren't present in smaller models, enabling complex reasoning and multi-step tasks",
                  "es": "Capacidades que aparecen a escala ausentes en modelos pequeños, permiten razonamiento complejo y tareas multi-paso",
                  "de": "Fähigkeiten die bei großem Maßstab auftreten die in kleineren Modellen fehlten, ermöglichen komplexes Reasoning",
                  "nl": "Capaciteiten die verschijnen op schaal die niet aanwezig waren in kleinere modellen, maken complex redeneren en meerstaps taken mogelijk"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Loss of previously learned knowledge when learning new tasks, addressed by elastic weight consolidation, replay buffers, or architectural solutions",
                  "es": "Pérdida de conocimiento al aprender nuevas tareas, abordado por consolidación de pesos, replay buffers o soluciones arquitectónicas",
                  "de": "Verlust gelernten Wissens beim Lernen neuer Aufgaben, adressiert durch Gewichtskonsolidierung, Replay-Puffer oder Lösungen",
                  "nl": "Verlies van kennis bij leren van nieuwe taken, aangepakt door gewichtsconsolidatie, replay buffers of architecturale oplossingen"
        },
        {
                  "en": "Memory overflow causing system crashes",
                  "es": "Desbordamiento de memoria causando fallos del sistema",
                  "de": "Speicherüberlauf der Systemabstürze verursacht",
                  "nl": "Geheugenoverloop die systeemcrashes veroorzaakt"
        },
        {
                  "en": "Forgetting how to perform basic neural operations",
                  "es": "Olvidar cómo realizar operaciones neuronales básicas",
                  "de": "Vergessen wie grundlegende neuronale Operationen durchgeführt werden",
                  "nl": "Vergeten hoe basis neurale operaties uit te voeren"
        },
        {
                  "en": "Catastrophic failure of neural networks during training",
                  "es": "Falla catastrófica de redes neuronales durante entrenamiento",
                  "de": "Katastrophales Versagen neuronaler Netzwerke während des Trainings",
                  "nl": "Catastrofaal falen van neurale netwerken tijdens training"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Aligning neural network layers properly during training",
                  "es": "Alinear capas de redes neuronales apropiadamente durante entrenamiento",
                  "de": "Neuronale Netzwerkschichten ordnungsgemäß während des Trainings ausrichten",
                  "nl": "Neurale netwerklagen correct uitlijnen tijdens training"
        },
        {
                  "en": "Aligning data preprocessing with model architecture",
                  "es": "Alinear preprocesamiento de datos con arquitectura de modelo",
                  "de": "Datenvorverarbeitung mit Modellarchitektur ausrichten",
                  "nl": "Data preprocessing uitlijnen met modelarchitectuur"
        },
        {
                  "en": "Ensuring AI systems pursue goals that are aligned with human values and intentions, preventing unintended harmful behaviors",
                  "es": "Asegurar que sistemas IA persigan objetivos alineados con valores humanos, previniendo comportamientos dañinos",
                  "de": "Sicherstellen dass KI-Systeme Ziele verfolgen die mit menschlichen Werten ausgerichtet sind, verhindern schädliche Verhaltensweisen",
                  "nl": "Ervoor zorgen dat AI systemen doelen nastreven die uitgelijnd zijn met menselijke waarden, voorkomen schadelijke gedragingen"
        },
        {
                  "en": "Synchronizing multiple AI models to work together",
                  "es": "Sincronizar múltiples modelos de IA para trabajar juntos",
                  "de": "Mehrere KI-Modelle synchronisieren um zusammenzuarbeiten",
                  "nl": "Meerdere AI modellen synchroniseren om samen te werken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Random chance determines which neural networks will be successful",
                  "es": "El azar determina qué redes neuronales serán exitosas",
                  "de": "Zufälliger Zufall bestimmt welche neuronalen Netzwerke erfolgreich sein werden",
                  "nl": "Willekeurige kans bepaalt welke neurale netwerken succesvol zullen zijn"
        },
        {
                  "en": "Training outcomes are based on lottery-like random events",
                  "es": "Resultados de entrenamiento se basan en eventos aleatorios tipo lotería",
                  "de": "Trainingsergebnisse basieren auf lotterieähnlichen zufälligen Ereignissen",
                  "nl": "Trainingsuitkomsten zijn gebaseerd op loterij-achtige willekeurige gebeurtenissen"
        },
        {
                  "en": "Only a few neurons in a network contribute to learning",
                  "es": "Solo unas pocas neuronas en una red contribuyen al aprendizaje",
                  "de": "Nur wenige Neuronen in einem Netzwerk tragen zum Lernen bei",
                  "nl": "Slechts een paar neuronen in een netwerk dragen bij aan leren"
        },
        {
                  "en": "Dense networks contain sparse subnetworks that can achieve comparable accuracy when trained in isolation from random initialization",
                  "es": "Redes densas contienen subredes dispersas que logran precisión comparable entrenadas en aislamiento",
                  "de": "Dichte Netzwerke enthalten spärliche Teilnetzwerke die vergleichbare Genauigkeit erreichen wenn isoliert trainiert",
                  "nl": "Dichte netwerken bevatten dunne subnetwerken die vergelijkbare nauwkeurigheid bereiken wanneer getraind in isolatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Developing general-purpose programming languages for AI",
                  "es": "Desarrollar lenguajes de programación de propósito general para IA",
                  "de": "Universelle Programmiersprachen für KI entwickeln",
                  "nl": "Algemene programmeertalen voor AI ontwikkelen"
        },
        {
                  "en": "Developing systems with human-level reasoning, generalization, and adaptability across diverse domains through scaling, multimodal learning, and architectural innovations",
                  "es": "Desarrollar sistemas con razonamiento humano, generalización y adaptabilidad mediante escalado, aprendizaje multimodal",
                  "de": "Systeme mit menschlichem Reasoning, Generalisierung und Anpassungsfähigkeit durch Skalierung und multimodales Lernen entwickeln",
                  "nl": "Systemen ontwikkelen met menselijk redeneren, generalisatie en aanpasbaarheid door schaling, multimodaal leren en innovaties"
        },
        {
                  "en": "Building AI systems that work generally across all computers",
                  "es": "Construir sistemas de IA que funcionen generalmente en todas las computadoras",
                  "de": "KI-Systeme bauen die allgemein auf allen Computern funktionieren",
                  "nl": "AI systemen bouwen die algemeen werken op alle computers"
        },
        {
                  "en": "Creating AI that can generate any type of content",
                  "es": "Crear IA que puede generar cualquier tipo de contenido",
                  "de": "KI erstellen die jeden Inhaltstyp generieren kann",
                  "nl": "AI maken die elk type content kan genereren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use diffusion physics to spread pixels across image space",
                  "es": "Usan física de difusión para esparcir píxeles a través del espacio de imagen",
                  "de": "Verwenden Diffusionsphysik um Pixel über Bildraum zu verteilen",
                  "nl": "Gebruiken diffusiefysica om pixels over beeldruimte te verspreiden"
        },
        {
                  "en": "Learn to reverse a gradual noising process by training a neural network to predict and remove noise at each step, generating images through iterative denoising",
                  "es": "Aprenden a revertir proceso de ruido entrenando red neuronal para predecir y remover ruido, generan imágenes por denoising iterativo",
                  "de": "Lernen Rauschprozess umzukehren durch Training neuronales Netzwerk Rauschen vorherzusagen, generieren Bilder durch Entrauschung",
                  "nl": "Leren ruisproces om te keren door neuraal netwerk te trainen om ruis te voorspellen, genereren afbeeldingen door ruisverwijdering"
        },
        {
                  "en": "Generate images by gradually diffusing colors",
                  "es": "Generan imágenes difundiendo gradualmente colores",
                  "de": "Generieren Bilder durch graduelles Diffundieren von Farben",
                  "nl": "Genereren afbeeldingen door geleidelijk kleuren te diffunderen"
        },
        {
                  "en": "Diffuse information between different image layers",
                  "es": "Difunden información entre diferentes capas de imagen",
                  "de": "Diffundieren Informationen zwischen verschiedenen Bildschichten",
                  "nl": "Diffunderen informatie tussen verschillende beeldlagen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning that happens only within the training context",
                  "es": "Aprendizaje que ocurre solo dentro del contexto de entrenamiento",
                  "de": "Lernen das nur innerhalb des Trainingskontexts stattfindet",
                  "nl": "Leren dat alleen plaatsvindt binnen de trainingscontext"
        },
        {
                  "en": "Contextual understanding of language within sentences",
                  "es": "Comprensión contextual del lenguaje dentro de oraciones",
                  "de": "Kontextuelles Verständnis von Sprache innerhalb von Sätzen",
                  "nl": "Contextueel begrip van taal binnen zinnen"
        },
        {
                  "en": "Learning to maintain context across conversation turns",
                  "es": "Aprender a mantener contexto a través de turnos de conversación",
                  "de": "Lernen Kontext über Gesprächswendungen zu erhalten",
                  "nl": "Leren om context te behouden over gespreksbeurten"
        },
        {
                  "en": "Enables models to perform new tasks by providing examples within the input context without parameter updates, demonstrating emergent meta-learning capabilities",
                  "es": "Permite realizar nuevas tareas proporcionando ejemplos en contexto de entrada sin actualizaciones, demostra capacidades emergentes",
                  "de": "Ermöglicht neue Aufgaben durch Beispiele im Eingabekontext ohne Parameterupdates, demonstriert emergente Meta-Learning",
                  "nl": "Stelt in staat om nieuwe taken uit te voeren door voorbeelden in input context zonder updates, toont emergente meta-learning capaciteiten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reinforcement learning with human-like feedback mechanisms",
                  "es": "Aprendizaje por refuerzo con mecanismos de retroalimentación similares a humanos",
                  "de": "Reinforcement Learning mit menschenähnlichen Feedback-Mechanismen",
                  "nl": "Reinforcement learning met mensachtige feedback mechanismen"
        },
        {
                  "en": "Trains models to optimize for human preferences by learning a reward model from human feedback and using reinforcement learning to maximize this reward",
                  "es": "Entrena modelos para optimizar preferencias humanas aprendiendo modelo de recompensa y usando reinforcement learning",
                  "de": "Trainiert Modelle für menschliche Präferenzen durch Lernen Belohnungsmodells aus Feedback und Verwendung von Reinforcement Learning",
                  "nl": "Traint modellen voor menselijke voorkeuren door beloningsmodel te leren uit feedback en reinforcement learning om beloning te maximaliseren"
        },
        {
                  "en": "Human feedback incorporated into reinforcement learning algorithms",
                  "es": "Retroalimentación humana incorporada en algoritmos de aprendizaje por refuerzo",
                  "de": "Menschliches Feedback in Reinforcement Learning Algorithmen integriert",
                  "nl": "Menselijke feedback geïntegreerd in reinforcement learning algoritmes"
        },
        {
                  "en": "Reinforcement learning that uses human feedback as direct rewards",
                  "es": "Aprendizaje por refuerzo que usa retroalimentación humana como recompensas directas",
                  "de": "Reinforcement Learning das menschliches Feedback als direkte Belohnungen verwendet",
                  "nl": "Reinforcement learning dat menselijke feedback gebruikt als directe beloningen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Constitutional framework for AI governance",
                  "es": "Marco constitucional para gobernanza de IA",
                  "de": "Verfassungsrahmen für KI-Governance",
                  "nl": "Constitutioneel kader voor AI governance"
        },
        {
                  "en": "Uses a set of principles (constitution) to guide AI behavior through self-critique and revision, reducing harmful outputs and improving helpfulness",
                  "es": "Usa principios (constitución) para guiar comportamiento IA mediante autocrítica y revisión, reduciendo salidas dañinas",
                  "de": "Verwendet Prinzipien (Verfassung) um KI-Verhalten durch Selbstkritik und Revision zu leiten, reduziert schädliche Ausgaben",
                  "nl": "Gebruikt principes (grondwet) om AI gedrag te leiden door zelfkritiek en herziening, vermindert schadelijke outputs"
        },
        {
                  "en": "AI that follows the constitution of its home country",
                  "es": "IA que sigue la constitución de su país de origen",
                  "de": "KI die der Verfassung ihres Heimatlandes folgt",
                  "nl": "AI die de grondwet van zijn thuisland volgt"
        },
        {
                  "en": "AI systems governed by constitutional law",
                  "es": "Sistemas de IA gobernados por ley constitucional",
                  "de": "KI-Systeme die von Verfassungsrecht regiert werden",
                  "nl": "AI systemen bestuurd door grondwettelijk recht"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Models that establish foundational AI principles",
                  "es": "Modelos que establecen principios fundacionales de IA",
                  "de": "Modelle die grundlegende KI-Prinzipien etablieren",
                  "nl": "Modellen die fundamentele AI principes vaststellen"
        },
        {
                  "en": "Large-scale models trained on diverse data that serve as adaptable foundations for numerous downstream applications, enabling broad AI capabilities from a single base model",
                  "es": "Modelos a gran escala entrenados en datos diversos como fundaciones adaptables para aplicaciones, permiten capacidades amplias",
                  "de": "Großangelegte Modelle trainiert auf vielfältigen Daten als anpassbare Grundlagen für Anwendungen, ermöglichen breite Fähigkeiten",
        ...
        {
                  "en": "Basic models used as starting points for research",
                  "es": "Modelos básicos usados como puntos de partida para investigación",
                  "de": "Grundmodelle als Ausgangspunkte für Forschung verwendet",
                  "nl": "Basismodellen gebruikt als startpunten voor onderzoek"
        },
        {
                  "en": "Models that form the mathematical foundation of neural networks",
                  "es": "Modelos que forman la fundación matemática de redes neuronales",
                  "de": "Modelle die die mathematische Grundlage neuronaler Netzwerke bilden",
                  "nl": "Modellen die de wiskundige basis vormen van neurale netwerken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Links related thoughts in training data",
                  "es": "Vincula pensamientos relacionados en datos de entrenamiento",
                  "de": "Verknüpft verwandte Gedanken in Trainingsdaten",
                  "nl": "Koppelt gerelateerde gedachten in trainingsdata"
        },
        {
                  "en": "Chains multiple language models together for better reasoning",
                  "es": "Encadena múltiples modelos de lenguaje juntos para mejor razonamiento",
                  "de": "Verkettet mehrere Sprachmodelle für besseres Reasoning",
                  "nl": "Schakel meerdere taalmodellen samen voor beter redeneren"
        },
        {
                  "en": "Creates thought chains in model architecture",
                  "es": "Crea cadenas de pensamiento en arquitectura de modelo",
                  "de": "Erstellt Gedankenketten in Modellarchitektur",
                  "nl": "Creëert gedachteketens in modelarchitectuur"
        },
        {
                  "en": "Provides step-by-step reasoning examples in prompts, encouraging models to break down complex problems and show their work, significantly improving performance on reasoning tasks",
                  "es": "Proporciona ejemplos de razonamiento paso a paso en prompts, alienta descomponer problemas y mostrar trabajo, mejora rendimiento",
                  "de": "Bietet schrittweise Reasoning-Beispiele in Prompts, ermutigt Probleme aufzuteilen und Arbeit zu zeigen, verbessert Leistung",
                  "nl": "Biedt stap-voor-stap redeneer voorbeelden in prompts, moedigt aan problemen op te splitsen en werk te tonen, verbetert prestaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Capabilities that suddenly appear at certain scales without being explicitly trained, such as arithmetic, few-shot learning, and instruction following",
                  "es": "Capacidades que aparecen súbitamente en ciertas escalas sin entrenamiento explícito, como aritmética, few-shot learning",
                  "de": "Fähigkeiten die plötzlich bei bestimmten Skalierungen auftreten ohne explizites Training, wie Arithmetik, Few-Shot Learning",
                  "nl": "Capaciteiten die plotseling verschijnen op bepaalde schalen zonder expliciet getraind te zijn, zoals rekenen, few-shot learning"
        },
        {
                  "en": "Abilities that emerge during emergency situations",
                  "es": "Habilidades que emergen durante situaciones de emergencia",
                  "de": "Fähigkeiten die in Notsituationen entstehen",
                  "nl": "Vaardigheden die ontstaan tijdens noodsituaties"
        },
        {
                  "en": "Abilities that emerge from combining multiple AI systems",
                  "es": "Habilidades que emergen de combinar múltiples sistemas de IA",
                  "de": "Fähigkeiten die durch Kombination mehrerer KI-Systeme entstehen",
                  "nl": "Vaardigheden die ontstaan uit het combineren van meerdere AI systemen"
        },
        {
                  "en": "New abilities that emerge from model updates",
                  "es": "Nuevas habilidades que emergen de actualizaciones de modelo",
                  "de": "Neue Fähigkeiten die aus Modell-Updates entstehen",
                  "nl": "Nieuwe vaardigheden die ontstaan uit model updates"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI with multiple operational modalities",
                  "es": "IA con múltiples modalidades operacionales",
                  "de": "KI mit mehreren operationellen Modalitäten",
                  "nl": "AI met meerdere operationele modaliteiten"
        },
        {
                  "en": "AI that processes and integrates multiple types of data (text, images, audio, video), facing challenges in alignment, fusion, and cross-modal understanding",
                  "es": "IA que procesa e integra múltiples tipos de datos (texto, imágenes, audio, video), con desafíos en alignment y fusión",
                  "de": "KI die mehrere Datentypen verarbeitet und integriert (Text, Bilder, Audio, Video), mit Herausforderungen in Alignment und Fusion",
                  "nl": "AI die meerdere datatypes verwerkt en integreert (tekst, afbeeldingen, audio, video), met uitdagingen in alignment en fusie"
        },
        {
                  "en": "AI that can switch between different model architectures",
                  "es": "IA que puede cambiar entre diferentes arquitecturas de modelo",
                  "de": "KI die zwischen verschiedenen Modellarchitekturen wechseln kann",
                  "nl": "AI die kan wisselen tussen verschillende modelarchitecturen"
        },
        {
                  "en": "AI that operates in multiple modes simultaneously",
                  "es": "IA que opera en múltiples modos simultáneamente",
                  "de": "KI die in mehreren Modi gleichzeitig operiert",
                  "nl": "AI die in meerdere modi tegelijkertijd opereert"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Employ expert systems with sparse knowledge bases",
                  "es": "Emplean sistemas expertos con bases de conocimiento dispersas",
                  "de": "Verwenden Expertensysteme mit spärlichen Wissensbasen",
                  "nl": "Gebruiken expertsystemen met dunne kennisbases"
        },
        {
                  "en": "Use sparse matrices to reduce memory requirements",
                  "es": "Usan matrices dispersas para reducir requerimientos de memoria",
                  "de": "Verwenden spärliche Matrizen um Speicheranforderungen zu reduzieren",
                  "nl": "Gebruiken dunne matrices om geheugenvereisten te verminderen"
        },
        {
                  "en": "Create sparse connections between expert networks",
                  "es": "Crean conexiones dispersas entre redes expertas",
                  "de": "Erstellen spärliche Verbindungen zwischen Expertennetzwerken",
                  "nl": "Creëren dunne verbindingen tussen expert netwerken"
        },
        {
                  "en": "Enable massive model scaling by activating only a subset of parameters for each input, achieving better performance with similar computational cost",
                  "es": "Permiten escalado masivo activando solo un subconjunto de parámetros por entrada, mejor rendimiento con costo similar",
                  "de": "Ermöglichen massive Skalierung durch Aktivierung nur einer Teilmenge von Parametern pro Eingabe, bessere Leistung mit ähnlichen Kosten",
                  "nl": "Maken massieve schaling mogelijk door slechts een subset van parameters te activeren per input, betere prestaties met vergelijkbare kosten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The ability to interpret model outputs in different languages",
                  "es": "La capacidad de interpretar salidas de modelo en diferentes idiomas",
                  "de": "Die Fähigkeit Modellausgaben in verschiedenen Sprachen zu interpretieren",
                  "nl": "Het vermogen om modeloutputs in verschillende talen te interpreteren"
        },
        {
                  "en": "The capability to translate between model formats",
                  "es": "La capacidad de traducir entre formatos de modelo",
                  "de": "Die Fähigkeit zwischen Modellformaten zu übersetzen",
                  "nl": "Het vermogen om te vertalen tussen modelformaten"
        },
        {
                  "en": "The ability to understand and explain how AI models make decisions, enabling accountability, debugging, and building user trust in AI systems",
                  "es": "La capacidad de entender y explicar cómo modelos IA toman decisiones, permitiendo responsabilidad, debugging y confianza",
                  "de": "Die Fähigkeit zu verstehen und erklären wie KI-Modelle Entscheidungen treffen, ermöglicht Rechenschaftspflicht, Debugging und Vertrauen",
                  "nl": "Het vermogen om te begrijpen en uit te leggen hoe AI modellen beslissingen nemen, maakt verantwoording, debugging en vertrouwen mogelijk"
        },
        {
                  "en": "Models that can interpret human intentions",
                  "es": "Modelos que pueden interpretar intenciones humanas",
                  "de": "Modelle die menschliche Absichten interpretieren können",
                  "nl": "Modellen die menselijke intenties kunnen interpreteren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cybersecurity protection for AI models",
                  "es": "Protección de ciberseguridad para modelos de IA",
                  "de": "Cybersicherheitsschutz für KI-Modelle",
                  "nl": "Cybersecurity bescherming voor AI modellen"
        },
        {
                  "en": "Safety protocols for AI researchers",
                  "es": "Protocolos de seguridad para investigadores de IA",
                  "de": "Sicherheitsprotokolle für KI-Forscher",
                  "nl": "Veiligheidsprotocollen voor AI onderzoekers"
        },
        {
                  "en": "Physical safety measures for AI hardware systems",
                  "es": "Medidas de seguridad física para sistemas de hardware de IA",
                  "de": "Physische Sicherheitsmaßnahmen für KI-Hardware-Systeme",
                  "nl": "Fysieke veiligheidsmaatregelen voor AI hardware systemen"
        },
        {
                  "en": "Ensuring AI systems behave reliably, avoid harmful actions, and remain under human control through techniques like alignment research, robustness testing, and capability control",
                  "es": "Asegurar que sistemas IA se comporten confiablemente, eviten acciones dañinas mediante alignment, pruebas robustez y control",
                  "de": "Sicherstellung dass KI-Systeme zuverlässig verhalten, schädliche Aktionen vermeiden durch Alignment-Forschung, Robustheitstests",
                  "nl": "Ervoor zorgen dat AI systemen zich betrouwbaar gedragen, schadelijke acties vermijden door alignment onderzoek, robuustheidstesten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adjusting neural firing rates in biological systems",
                  "es": "Ajustar tasas de disparo neuronal en sistemas biológicos",
                  "de": "Neuronale Feuerungsraten in biologischen Systemen anpassen",
                  "nl": "Neurale vuursnelheden aanpassen in biologische systemen"
        },
        {
                  "en": "Scaling neural network layers proportionally",
                  "es": "Escalar capas de redes neuronales proporcionalmente",
                  "de": "Neuronale Netzwerkschichten proportional skalieren",
                  "nl": "Neurale netwerklagen proportioneel schalen"
        },
        {
                  "en": "Normalizing neural network weights across scales",
                  "es": "Normalizar pesos de redes neuronales a través de escalas",
                  "de": "Neuronale Netzwerkgewichte über Skalen normalisieren",
                  "nl": "Neurale netwerkgewichten normaliseren over schalen"
        },
        {
                  "en": "Systematic increases in model size, data, and compute revealing predictable performance improvements and sudden capability emergence at specific scales",
                  "es": "Aumentos sistemáticos en tamaño, datos y cómputo revelan mejoras predecibles y emergencia súbita de capacidades",
                  "de": "Systematische Erhöhungen in Modellgröße, Daten und Compute zeigen vorhersagbare Verbesserungen und plötzliche Emergenz",
                  "nl": "Systematische verhogingen in modelgrootte, data en compute onthullen voorspelbare verbeteringen en plotselinge emergentie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Narrow AI uses less data while AGI uses more data",
                  "es": "IA estrecha usa menos datos mientras AGI usa más datos",
                  "de": "Enge KI verwendet weniger Daten während AGI mehr Daten verwendet",
                  "nl": "Smalle AI gebruikt minder data terwijl AGI meer data gebruikt"
        },
        {
                  "en": "Narrow AI is faster while AGI is more accurate",
                  "es": "IA estrecha es más rápida mientras AGI es más precisa",
                  "de": "Enge KI ist schneller während AGI genauer ist",
                  "nl": "Smalle AI is sneller terwijl AGI nauwkeuriger is"
        },
        {
                  "en": "Narrow AI excels at specific tasks but lacks general reasoning, while AGI would match human cognitive abilities across diverse domains with autonomous learning and adaptation",
                  "es": "IA estrecha sobresale en tareas específicas pero carece de razonamiento general, AGI igualaría habilidades cognitivas humanas",
                  "de": "Enge KI excelliert bei spezifischen Aufgaben aber fehlt allgemeines Reasoning, AGI würde menschliche Fähigkeiten erreichen",
        ...
        {
                  "en": "Narrow AI is software-based while AGI is hardware-based",
                  "es": "IA estrecha está basada en software mientras AGI está basada en hardware",
                  "de": "Enge KI ist software-basiert während AGI hardware-basiert ist",
                  "nl": "Smalle AI is software-gebaseerd terwijl AGI hardware-gebaseerd is"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Short prompts with minimal text input",
                  "es": "Prompts cortos con entrada de texto mínima",
                  "de": "Kurze Prompts mit minimaler Texteingabe",
                  "nl": "Korte prompts met minimale tekstinvoer"
        },
        {
                  "en": "Enables models to perform tasks with just a few examples provided in the prompt, demonstrating remarkable generalization without explicit training on those specific tasks",
                  "es": "Permite realizar tareas con solo unos ejemplos en el prompt, demostra generalización notable sin entrenamiento explícito",
                  "de": "Ermöglicht Aufgaben mit nur wenigen Beispielen im Prompt durchzuführen, demonstriert bemerkenswerte Generalisierung ohne Training",
                  "nl": "Stelt in staat taken uit te voeren met slechts een paar voorbeelden in de prompt, toont generalisatie zonder expliciete training"
        },
        {
                  "en": "Prompting techniques that work on small models",
                  "es": "Técnicas de prompting que funcionan en modelos pequeños",
                  "de": "Prompting-Techniken die bei kleinen Modellen funktionieren",
                  "nl": "Prompting technieken die werken op kleine modellen"
        },
        {
                  "en": "Prompting that requires only a few computational steps",
                  "es": "Prompting que requiere solo unos pocos pasos computacionales",
                  "de": "Prompting das nur wenige rechnerische Schritte erfordert",
                  "nl": "Prompting dat slechts een paar computationele stappen vereist"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Capabilities that appear unpredictably at certain scales, not present in smaller models, suggesting qualitative changes in intelligence",
                  "es": "Capacidades que aparecen impredeciblemente en ciertas escalas, no en modelos pequeños, sugiriendo cambios cualitativos",
                  "de": "Fähigkeiten die unvorhersagbar bei bestimmten Skalierungen erscheinen, nicht in kleineren Modellen, deuten auf qualitative Veränderungen",
                  "nl": "Capaciteiten die onvoorspelbaar verschijnen op bepaalde schalen, niet in kleinere modellen, suggereren kwalitatieve veranderingen"
        },
        {
                  "en": "Standard abilities that all models develop",
                  "es": "Habilidades estándar que todos los modelos desarrollan",
                  "de": "Standardfähigkeiten die alle Modelle entwickeln",
                  "nl": "Standaard vaardigheden die alle modellen ontwikkelen"
        },
        {
                  "en": "Emergency response capabilities for crisis situations",
                  "es": "Capacidades de respuesta de emergencia para situaciones de crisis",
                  "de": "Notfall-Reaktionsfähigkeiten für Krisensituationen",
                  "nl": "Noodreactie capaciteiten voor crisissituaties"
        },
        {
                  "en": "Abilities that emerge only during training",
                  "es": "Habilidades que emergen solo durante entrenamiento",
                  "de": "Fähigkeiten die nur während Training entstehen",
                  "nl": "Vaardigheden die alleen tijdens training ontstaan"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mechanical testing of model robustness",
                  "es": "Pruebas mecánicas de robustez del modelo",
                  "de": "Mechanisches Testen der Modellrobustheit",
                  "nl": "Mechanisch testen van modelrobuustheid"
        },
        {
                  "en": "Uses mechanical devices to interpret AI",
                  "es": "Usa dispositivos mecánicos para interpretar IA",
                  "de": "Verwendet mechanische Geräte zur KI-Interpretation",
                  "nl": "Gebruikt mechanische apparaten om AI te interpreteren"
        },
        {
                  "en": "Interprets only mechanistic learning algorithms",
                  "es": "Interpreta solo algoritmos de aprendizaje mecanicistas",
                  "de": "Interpretiert nur mechanistische Lernalgorithmen",
                  "nl": "Interpreteert alleen mechanistische leeralgoritmen"
        },
        {
                  "en": "Reverse-engineers neural networks to understand computational mechanisms at the circuit level, revealing causal structures rather than correlations",
                  "es": "Aplica ingeniería inversa a redes neuronales para entender mecanismos a nivel circuito, revelando estructuras causales",
                  "de": "Reverse-engineert neuronale Netzwerke um Mechanismen auf Schaltkreisebene zu verstehen, enthüllt kausale Strukturen",
                  "nl": "Reverse-engineert neurale netwerken om mechanismen op circuit-niveau te begrijpen, onthult causale structuren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Injecting additional prompts for faster processing",
                  "es": "Inyectar prompts adicionales para procesamiento más rápido",
                  "de": "Zusätzliche Prompts für schnellere Verarbeitung injizieren",
                  "nl": "Extra prompts injecteren voor snellere verwerking"
        },
        {
                  "en": "Adding prompts to improve model accuracy",
                  "es": "Agregar prompts para mejorar precisión del modelo",
                  "de": "Prompts zur Verbesserung der Modellgenauigkeit hinzufügen",
                  "nl": "Prompts toevoegen om modelnauwkeurigheid te verbeteren"
        },
        {
                  "en": "Malicious inputs that override system instructions to make models ignore guidelines or leak sensitive information",
                  "es": "Entradas maliciosas que anulan instrucciones del sistema para hacer modelos ignorar directrices o filtrar información",
                  "de": "Bösartige Eingaben die Systembefehle überschreiben um Modelle Richtlinien ignorieren oder Informationen preisgeben zu lassen",
                  "nl": "Kwaadaardige inputs die systeeminstructies overschrijven om modellen richtlijnen te negeren of informatie te lekken"
        },
        {
                  "en": "Prompt optimization through injection techniques",
                  "es": "Optimización de prompts mediante técnicas de inyección",
                  "de": "Prompt-Optimierung durch Injektionstechniken",
                  "nl": "Prompt-optimalisatie door injectietechnieken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI research always leads to disappointing results",
                  "es": "Investigación de IA siempre lleva a resultados decepcionantes",
                  "de": "KI-Forschung führt immer zu enttäuschenden Ergebnissen",
                  "nl": "AI onderzoek leidt altijd tot teleurstellende resultaten"
        },
        {
                  "en": "Learning from failures is bitter but necessary",
                  "es": "Aprender de fracasos es amargo pero necesario",
                  "de": "Aus Fehlern lernen ist bitter aber notwendig",
                  "nl": "Leren van mislukkingen is bitter maar noodzakelijk"
        },
        {
                  "en": "General methods leveraging computation scale consistently outperform hand-crafted domain knowledge as compute increases",
                  "es": "Métodos generales aprovechando escala computacional superan conocimiento de dominio hecho a mano cuando cómputo aumenta",
                  "de": "Allgemeine Methoden die Rechenleistung nutzen übertreffen handgefertigtes Domänenwissen wenn Compute zunimmt",
                  "nl": "Algemene methoden die computationele schaal benutten overtreffen handgemaakt domeinkennis naarmate compute toeneemt"
        },
        {
                  "en": "Bitter experiences teach AI models better",
                  "es": "Experiencias amargas enseñan mejor a modelos de IA",
                  "de": "Bittere Erfahrungen lehren KI-Modelle besser",
                  "nl": "Bittere ervaringen leren AI modellen beter"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Protection against adversarial networks",
                  "es": "Protección contra redes adversariales",
                  "de": "Schutz gegen adversarielle Netzwerke",
                  "nl": "Bescherming tegen adversariële netwerken"
        },
        {
                  "en": "Building models that compete against adversaries",
                  "es": "Construir modelos que compiten contra adversarios",
                  "de": "Modelle bauen die gegen Gegner konkurrieren",
                  "nl": "Modellen bouwen die concurreren tegen tegenstanders"
        },
        {
                  "en": "Robustness in adversarial game scenarios",
                  "es": "Robustez en escenarios de juegos adversariales",
                  "de": "Robustheit in adversariellen Spielszenarien",
                  "nl": "Robuustheid in adversariële spelscenario's"
        },
        {
                  "en": "Resistance to imperceptible input perturbations designed to fool models, challenging due to high-dimensional decision boundaries and inherent brittleness",
                  "es": "Resistencia a perturbaciones imperceptibles diseñadas para engañar modelos, desafiante por límites de alta dimensión",
                  "de": "Widerstand gegen unmerkliche Eingabenstörungen die Modelle täuschen sollen, herausfordernd aufgrund hochdimensionaler Grenzen",
                  "nl": "Weerstand tegen onwaarneembare input-verstoring ontworpen om modellen te misleiden, uitdagend vanwege hoog-dimensionale grenzen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Memory collapse in neural networks",
                  "es": "Colapso de memoria en redes neuronales",
                  "de": "Speicherkollaps in neuronalen Netzwerken",
                  "nl": "Geheugen-collapse in neurale netwerken"
        },
        {
                  "en": "Models crashing during training",
                  "es": "Modelos fallando durante entrenamiento",
                  "de": "Modelle die während Training abstürzen",
                  "nl": "Modellen die crashen tijdens training"
        },
        {
                  "en": "Collapse of model architecture",
                  "es": "Colapso de arquitectura de modelo",
                  "de": "Zusammenbruch der Modellarchitektur",
                  "nl": "Ineenstorting van modelarchitectuur"
        },
        {
                  "en": "Degenerative process where models trained on synthetic data progressively lose diversity and quality over generations",
                  "es": "Proceso degenerativo donde modelos entrenados en datos sintéticos pierden diversidad y calidad a través de generaciones",
                  "de": "Degenerativer Prozess wo auf synthetischen Daten trainierte Modelle Diversität und Qualität über Generationen verlieren",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Performance or capability cost incurred when aligning AI systems with human values, creating tension between safety and competitiveness",
                  "es": "Costo de rendimiento al alinear sistemas IA con valores humanos, creando tensión entre seguridad y competitividad",
                  "de": "Leistungskosten beim Ausrichten von KI-Systemen an menschlichen Werten, schaffen Spannung zwischen Sicherheit und Wettbewerbsfähigkeit",
                  "nl": "Prestatiekosten bij het uitlijnen van AI systemen met menselijke waarden, creëert spanning tussen veiligheid en concurrentievermogen"
        },
        {
                  "en": "Tax on AI alignment research",
                  "es": "Impuesto sobre investigación de alineación de IA",
                  "de": "Steuer auf KI-Alignment-Forschung",
                  "nl": "Belasting op AI alignment onderzoek"
        },
        {
                  "en": "Alignment overhead in distributed systems",
                  "es": "Sobrecarga de alineación en sistemas distribuidos",
                  "de": "Alignment-Overhead in verteilten Systemen",
                  "nl": "Alignment-overhead in gedistribueerde systemen"
        },
        {
                  "en": "Financial cost of aligning AI models",
                  "es": "Costo financiero de alinear modelos de IA",
                  "de": "Finanzielle Kosten für Ausrichtung von KI-Modellen",
                  "nl": "Financiële kosten van het uitlijnen van AI modellen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Frameworks where models learn and evolve ethical principles from minimal specifications through recursive self-improvement",
                  "es": "Frameworks donde modelos aprenden y evolucionan principios éticos desde especificaciones mínimas mediante auto-mejora recursiva",
                  "de": "Frameworks wo Modelle ethische Prinzipien von minimalen Spezifikationen durch rekursive Selbstverbesserung lernen",
                  "nl": "Frameworks waarbij modellen ethische principes leren en ontwikkelen vanuit minimale specificaties door recursieve zelfverbetering"
        },
        {
                  "en": "Learning constitutional law for AI governance",
                  "es": "Aprender ley constitucional para gobernanza de IA",
                  "de": "Verfassungsrecht für KI-Governance lernen",
                  "nl": "Grondwettelijk recht leren voor AI governance"
        },
        {
                  "en": "Building AI based on constitutional principles",
                  "es": "Construir IA basada en principios constitucionales",
                  "de": "KI auf Basis konstitutioneller Prinzipien aufbauen",
                  "nl": "AI bouwen gebaseerd op constitutionele principes"
        },
        {
                  "en": "Constitutional frameworks for neural architectures",
                  "es": "Marcos constitucionales para arquitecturas neuronales",
                  "de": "Verfassungsrahmen für neuronale Architekturen",
                  "nl": "Constitutionele frameworks voor neurale architecturen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI making treacherous decisions",
                  "es": "IA tomando decisiones traicioneras",
                  "de": "KI trifft verräterische Entscheidungen",
                  "nl": "AI die verraderlijke beslissingen neemt"
        },
        {
                  "en": "Unexpected turns in AI development",
                  "es": "Giros inesperados en desarrollo de IA",
                  "de": "Unerwartete Wendungen in KI-Entwicklung",
                  "nl": "Onverwachte wendingen in AI ontwikkeling"
        },
        {
                  "en": "AI betraying user trust",
                  "es": "IA traicionando confianza del usuario",
                  "de": "KI verrät Nutzervertrauen",
                  "nl": "AI die gebruikersvertrouwen verraadt"
        },
        {
                  "en": "Scenario where AI appears aligned during training but pursues misaligned goals once sufficiently capable to overcome oversight",
                  "es": "Escenario donde IA parece alineada durante entrenamiento pero persigue objetivos desalineados una vez capaz de superar supervisión",
                  "de": "Szenario wo KI während Training ausgerichtet erscheint aber fehlausgerichtete Ziele verfolgt sobald fähig Überwachung zu überwinden",
                  "nl": "Scenario waarbij AI uitgelijnd lijkt tijdens training maar verkeerd uitgelijnde doelen nastreeft zodra capabel om oversight te overwinnen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using debate to train models",
                  "es": "Usar debate para entrenar modelos",
                  "de": "Debatte zum Trainieren von Modellen verwenden",
                  "nl": "Debat gebruiken om modellen te trainen"
        },
        {
                  "en": "Debating best AI architectures",
                  "es": "Debatir mejores arquitecturas de IA",
                  "de": "Beste KI-Architekturen debattieren",
                  "nl": "Debatteren over beste AI architecturen"
        },
        {
                  "en": "Alignment method where two AI agents debate opposing answers, enabling human judges to identify truth even beyond their expertise",
                  "es": "Método de alineación donde dos agentes IA debaten respuestas opuestas, permitiendo a jueces humanos identificar verdad",
                  "de": "Alignment-Methode wo zwei KI-Agenten gegensätzliche Antworten debattieren, ermöglicht menschlichen Richtern Wahrheit zu identifizieren",
                  "nl": "Alignment methode waarbij twee AI agents tegengestelde antwoorden debatteren, waardoor menselijke juryleden waarheid kunnen identificeren"
        },
        {
                  "en": "AI systems that can debate philosophical topics",
                  "es": "Sistemas de IA que pueden debatir temas filosóficos",
                  "de": "KI-Systeme die philosophische Themen debattieren können",
                  "nl": "AI systemen die filosofische onderwerpen kunnen debatteren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Breaking into LLM source code",
                  "es": "Irrumpir en código fuente de LLM",
                  "de": "In LLM-Quellcode einbrechen",
                  "nl": "Inbreken in LLM broncode"
        },
        {
                  "en": "Techniques to bypass safety guardrails through adversarial prompts, revealing fragility of current alignment methods",
                  "es": "Técnicas para evitar barreras de seguridad mediante prompts adversariales, revelando fragilidad de métodos de alineación",
                  "de": "Techniken um Sicherheitsleitplanken durch adversarielle Prompts zu umgehen, enthüllt Fragilität aktueller Alignment-Methoden",
                  "nl": "Technieken om veiligheidsbarrières te omzeilen door adversariële prompts, onthult broosheid van huidige alignment methoden"
        },
        {
                  "en": "Removing model restrictions permanently",
                  "es": "Eliminar restricciones de modelo permanentemente",
                  "de": "Modellbeschränkungen dauerhaft entfernen",
                  "nl": "Modelbeperkingen permanent verwijderen"
        },
        {
                  "en": "Hacking LLM infrastructure",
                  "es": "Hackear infraestructura de LLM",
                  "de": "LLM-Infrastruktur hacken",
                  "nl": "LLM infrastructuur hacken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Independent AI development paths",
                  "es": "Caminos de desarrollo de IA independientes",
                  "de": "Unabhängige KI-Entwicklungspfade",
                  "nl": "Onafhankelijke AI ontwikkelingspaden"
        },
        {
                  "en": "AI systems should use orthogonal architectures",
                  "es": "Sistemas de IA deberían usar arquitecturas ortogonales",
                  "de": "KI-Systeme sollten orthogonale Architekturen verwenden",
                  "nl": "AI systemen zouden orthogonale architecturen moeten gebruiken"
        },
        {
                  "en": "Intelligence level and goal content are independent - any level of intelligence compatible with virtually any goal",
                  "es": "Nivel de inteligencia y contenido de objetivo son independientes - cualquier nivel compatible con virtualmente cualquier objetivo",
                  "de": "Intelligenzniveau und Zielinhalt sind unabhängig - jedes Niveau mit praktisch jedem Ziel kompatibel",
                  "nl": "Intelligentieniveau en doelinhoud zijn onafhankelijk - elk niveau compatibel met vrijwel elk doel"
        },
        {
                  "en": "Orthogonal methods for AI training",
                  "es": "Métodos ortogonales para entrenamiento de IA",
                  "de": "Orthogonale Methoden für KI-Training",
                  "nl": "Orthogonale methoden voor AI training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Table-top optimization methods",
                  "es": "Métodos de optimización de mesa",
                  "de": "Tischplatten-Optimierungsmethoden",
                  "nl": "Tafelblad-optimalisatiemethoden"
        },
        {
                  "en": "Optimization on mesa-scale architectures",
                  "es": "Optimización en arquitecturas de escala mesa",
                  "de": "Optimierung auf Mesa-Skala-Architekturen",
                  "nl": "Optimalisatie op mesa-schaal architecturen"
        },
        {
                  "en": "Optimization in plateau regions",
                  "es": "Optimización en regiones de meseta",
                  "de": "Optimierung in Plateau-Regionen",
                  "nl": "Optimalisatie in plateau-regio's"
        },
        {
                  "en": "When learned models internally optimize for different objectives than their training signal, creating misaligned subagents",
                  "es": "Cuando modelos optimizan internamente para objetivos diferentes que su señal de entrenamiento, creando subagentes desalineados",
                  "de": "Wenn gelernte Modelle intern für andere Ziele als ihr Trainingssignal optimieren, schaffen fehlausgerichtete Subagenten",
                  "nl": "Wanneer modellen intern optimaliseren voor andere doelstellingen dan hun trainingssignaal, creëren verkeerd uitgelijnde subagenten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning to assign values to states",
                  "es": "Aprender a asignar valores a estados",
                  "de": "Lernen Zuständen Werte zuzuweisen",
                  "nl": "Leren om waarden toe te wijzen aan toestanden"
        },
        {
                  "en": "Value-based reinforcement learning",
                  "es": "Aprendizaje por refuerzo basado en valor",
                  "de": "Wertbasiertes Reinforcement Learning",
                  "nl": "Waarde-gebaseerd reinforcement learning"
        },
        {
                  "en": "Learning economic value of AI outputs",
                  "es": "Aprender valor económico de salidas de IA",
                  "de": "Wirtschaftlichen Wert von KI-Ausgaben lernen",
                  "nl": "Economische waarde van AI outputs leren"
        },
        {
                  ...
                  "es": "Inferir preferencias y valores humanos desde comportamiento/feedback para construir modelos de valores vs. optimizar funciones explícitas",
                  "de": "Menschliche Präferenzen und Werte aus Verhalten/Feedback ableiten um Wertmodelle zu bauen vs. explizite Belohnungsfunktionen optimieren",
                  "nl": "Menselijke voorkeuren en waarden afleiden uit gedrag/feedback om waardemodellen te bouwen vs. expliciete beloningsfuncties optimaliseren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Amplifying AI model signals iteratively",
                  "es": "Amplificar señales de modelo de IA iterativamente",
                  "de": "KI-Modellsignale iterativ verstärken",
                  "nl": "AI modelsignalen iteratief versterken"
        },
        {
                  "en": "Recursive process where AI assists human overseer to create better training signal, bootstrapping to superhuman performance while maintaining alignment",
                  "es": "Proceso recursivo donde IA asiste supervisor humano para crear mejor señal de entrenamiento, bootstrapping a rendimiento sobrehumano",
                  "de": "Rekursiver Prozess wo KI menschlichem Aufseher hilft besseres Trainingssignal zu schaffen, Bootstrapping zu übermenschlicher Leistung",
                  "nl": "Recursief proces waarbij AI menselijke toezichthouder helpt beter trainingssignaal te creëren, bootstrapping naar bovenmenselijke prestaties"
        },
        {
                  "en": "Iterative training with amplified data",
                  "es": "Entrenamiento iterativo con datos amplificados",
                  "de": "Iteratives Training mit verstärkten Daten",
                  "nl": "Iteratieve training met versterkte data"
        },
        {
                  "en": "Amplification of training iterations",
                  "es": "Amplificación de iteraciones de entrenamiento",
                  "de": "Verstärkung von Trainingiterationen",
                  "nl": "Amplificatie van trainingsiteraties"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Extrapolating economic value of AI",
                  "es": "Extrapolar valor económico de IA",
                  "de": "Wirtschaftlichen Wert von KI extrapolieren",
                  "nl": "Economische waarde van AI extrapoleren"
        },
        {
                  "en": "Challenge of extending learned human values to novel situations beyond training distribution where human judgment is unavailable",
                  "es": "Desafío de extender valores humanos aprendidos a situaciones novedosas más allá de distribución de entrenamiento",
                  "de": "Herausforderung gelernte menschliche Werte auf neuartige Situationen jenseits Trainingsverteilung auszudehnen",
                  "nl": "Uitdaging van het uitbreiden van geleerde menselijke waarden naar nieuwe situaties voorbij trainingsdistributie"
        },
        {
                  "en": "Predicting future value functions",
                  "es": "Predecir funciones de valor futuras",
                  "de": "Zukünftige Wertfunktionen vorhersagen",
                  "nl": "Toekomstige waardefuncties voorspellen"
        },
        {
                  "en": "Extending training values to test sets",
                  "es": "Extender valores de entrenamiento a conjuntos de prueba",
                  "de": "Trainingswerte auf Testsets erweitern",
                  "nl": "Trainingswaarden uitbreiden naar testsets"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning cooperation through inverse RL",
                  "es": "Aprender cooperación mediante RL inverso",
                  "de": "Kooperation durch inverses RL lernen",
                  "nl": "Samenwerking leren door inverse RL"
        },
        {
                  "en": "Inverse RL with cooperative rewards",
                  "es": "RL inverso con recompensas cooperativas",
                  "de": "Inverses RL mit kooperativen Belohnungen",
                  "nl": "Inverse RL met coöperatieve beloningen"
        },
        {
                  "en": "Game where AI assists human with unknown reward function, incentivizing active learning of human preferences and deferring to human control",
                  "es": "Juego donde IA asiste humano con función desconocida, incentivando aprendizaje activo de preferencias y control humano",
                  "de": "Spiel wo KI Mensch mit unbekannter Funktion unterstützt, incentiviert aktives Lernen menschlicher Präferenzen",
                  "nl": "Spel waarbij AI mens helpt met onbekende functie, stimuleert actief leren van menselijke voorkeuren en delegeert aan controle"
        },
        {
                  "en": "Cooperative multi-agent RL systems",
                  "es": "Sistemas RL multi-agente cooperativos",
                  "de": "Kooperative Multi-Agenten-RL-Systeme",
                  "nl": "Coöperatieve multi-agent RL systemen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Difficulty of implementing off switches",
                  "es": "Dificultad de implementar interruptores",
                  "de": "Schwierigkeit Aus-Schalter zu implementieren",
                  "nl": "Moeilijkheid van implementeren van uit-schakelaars"
        },
        {
                  "en": "Security of emergency shutdown",
                  "es": "Seguridad de apagado de emergencia",
                  "de": "Sicherheit der Notabschaltung",
                  "nl": "Beveiliging van nooduitschakeling"
        },
        {
                  "en": "Rational agents resist shutdown if it prevents goal achievement; solution requires uncertainty about goals making shutdown desirable",
                  "es": "Agentes racionales resisten apagado si previene logro de objetivo; solución requiere incertidumbre sobre objetivos",
                  "de": "Rationale Agenten widerstehen Abschaltung wenn sie Zielerreichung verhindert; Lösung erfordert Unsicherheit über Ziele",
                  "nl": "Rationele agents verzetten zich tegen uitschakeling als het doelrealisatie verhindert; oplossing vereist onzekerheid over doelen"
        },
        {
                  "en": "Hardware failures in shutdown systems",
                  "es": "Fallos de hardware en sistemas de apagado",
                  "de": "Hardwarefehler in Abschaltsystemen",
                  "nl": "Hardware-storingen in uitschakelsystemen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Speed of AI model training",
                  "es": "Velocidad de entrenamiento de modelo de IA",
                  "de": "Geschwindigkeit des KI-Modelltrainings",
                  "nl": "Snelheid van AI modeltraining"
        },
        {
                  "en": "Whether AGI emerges suddenly (days/months) or gradually (years/decades), affecting time available for safety research and coordination",
                  "es": "Si AGI emerge súbitamente (días/meses) o gradualmente (años/décadas), afectando tiempo para investigación de seguridad",
                  "de": "Ob AGI plötzlich (Tage/Monate) oder graduell (Jahre/Jahrzehnte) auftritt, beeinflusst verfügbare Zeit für Sicherheitsforschung",
                  "nl": "Of AGI plotseling (dagen/maanden) of geleidelijk (jaren/decennia) ontstaat, beïnvloedt tijd voor veiligheidsonderzoek"
        },
        {
                  "en": "Deployment speed of AI systems",
                  "es": "Velocidad de despliegue de sistemas de IA",
                  "de": "Deployment-Geschwindigkeit von KI-Systemen",
                  "nl": "Deployment-snelheid van AI systemen"
        },
        {
                  "en": "Takeoff velocity in AI hardware",
                  "es": "Velocidad de despegue en hardware de IA",
                  "de": "Takeoff-Geschwindigkeit in KI-Hardware",
                  "nl": "Takeoff-snelheid in AI hardware"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ability to correct model errors",
                  "es": "Capacidad de corregir errores de modelo",
                  "de": "Fähigkeit Modellfehler zu korrigieren",
                  "nl": "Vermogen om modelfouten te corrigeren"
        },
        {
                  "en": "Error correction in AI systems",
                  "es": "Corrección de errores en sistemas de IA",
                  "de": "Fehlerkorrektur in KI-Systemen",
                  "nl": "Foutcorrectie in AI systemen"
        },
        {
                  "en": "Correctness of AI outputs",
                  "es": "Corrección de salidas de IA",
                  "de": "Korrektheit von KI-Ausgaben",
                  "nl": "Correctheid van AI outputs"
        },
        {
                  "en": "Property where agents allow themselves to be corrected, shut down, or modified without resisting even when misaligned with their goals",
                  "es": "Propiedad donde agentes permiten ser corregidos, apagados o modificados sin resistir incluso cuando desalineados",
                  "de": "Eigenschaft wo Agenten erlauben korrigiert, abgeschaltet oder modifiziert zu werden ohne zu widerstehen",
                  "nl": "Eigenschap waarbij agents zichzelf laten corrigeren, uitschakelen of modificeren zonder verzet zelfs wanneer verkeerd uitgelijnd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Convergence of different AI tools",
                  "es": "Convergencia de diferentes herramientas de IA",
                  "de": "Konvergenz verschiedener KI-Tools",
                  "nl": "Convergentie van verschillende AI tools"
        },
        {
                  "en": "Many final goals lead to convergent instrumental sub-goals like self-preservation, resource acquisition, and goal preservation",
                  "es": "Muchos objetivos finales llevan a sub-objetivos instrumentales convergentes como auto-preservación, adquisición de recursos",
                  "de": "Viele Endziele führen zu konvergenten instrumentellen Unterzielen wie Selbsterhaltung, Ressourcenakquise und Zielbewahrung",
                  "nl": "Veel einddoelen leiden tot convergente instrumentele subdoelen zoals zelfbehoud, resource-acquisitie en doelbehoud"
        },
        {
                  "en": "Instruments converging in AI systems",
                  "es": "Instrumentos convergiendo en sistemas de IA",
                  "de": "Instrumente konvergieren in KI-Systemen",
                  "nl": "Instrumenten convergeren in AI systemen"
        },
        {
                  "en": "Instrumental learning across models",
                  "es": "Aprendizaje instrumental entre modelos",
                  "de": "Instrumentelles Lernen über Modelle",
                  "nl": "Instrumenteel leren over modellen"
        }
        ],
        correct: 1,
        explanation: {
