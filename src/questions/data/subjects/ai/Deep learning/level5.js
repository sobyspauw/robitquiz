    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Sequential data where current output depends on previous inputs",
                  "es": "Datos secuenciales donde la salida actual depende de entradas previas",
                  "de": "Sequenzielle Daten wo aktuelle Ausgabe von vorherigen Eingaben abhängt",
                  "nl": "Sequentiële data waarbij huidige output afhangt van voorgaande inputs"
        },
        {
                  "en": "Only image processing tasks",
                  "es": "Solo tareas de procesamiento de imágenes",
                  "de": "Nur Bildverarbeitungsaufgaben",
                  "nl": "Alleen beeldverwerkingstaken"
        },
        {
                  "en": "Parallel processing of independent inputs",
                  "es": "Procesamiento paralelo de entradas independientes",
                  "de": "Parallele Verarbeitung unabhängiger Eingaben",
                  "nl": "Parallelle verwerking van onafhankelijke inputs"
        },
        {
                  "en": "Static data without temporal relationships",
                  "es": "Datos estáticos sin relaciones temporales",
                  "de": "Statische Daten ohne zeitliche Beziehungen",
                  "nl": "Statische data zonder temporele relaties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They can remember information for much longer sequences without forgetting",
                  "es": "Pueden recordar información por secuencias mucho más largas sin olvidar",
                  "de": "Sie können Informationen für viel längere Sequenzen ohne Vergessen behalten",
                  "nl": "Ze kunnen informatie voor veel langere sequenties onthouden zonder te vergeten"
        },
        {
                  "en": "They require less computational power",
                  "es": "Requieren menos poder computacional",
                  "de": "Sie benötigen weniger Rechenleistung",
                  "nl": "Ze hebben minder rekenkracht nodig"
        },
        {
                  "en": "They process data faster than regular RNNs",
                  "es": "Procesan datos más rápido que RNN regulares",
                  "de": "Sie verarbeiten Daten schneller als normale RNNs",
                  "nl": "Ze verwerken data sneller dan reguliere RNNs"
        },
        {
                  "en": "They work only with shorter sequences",
                  "es": "Trabajan solo con secuencias más cortas",
                  "de": "Sie arbeiten nur mit kürzeren Sequenzen",
                  "nl": "Ze werken alleen met kortere sequenties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A way to focus computational resources",
                  "es": "Una forma de enfocar recursos computacionales",
                  "de": "Ein Weg um Rechenressourcen zu fokussieren",
                  "nl": "Een manier om computationele bronnen te focussen"
        },
        {
                  "en": "A technique to make models pay attention to errors",
                  "es": "Una técnica para hacer que modelos presten atención a errores",
                  "de": "Eine Technik um Modelle auf Fehler aufmerksam zu machen",
                  "nl": "Een techniek om modellen aandacht te laten besteden aan fouten"
        },
        {
                  "en": "A way for models to focus on different parts of input when making predictions",
                  "es": "Una forma para que modelos se enfoquen en diferentes partes de entrada al hacer predicciones",
                  "de": "Ein Weg für Modelle sich auf verschiedene Teile der Eingabe beim Treffen von Vorhersagen zu konzentrieren",
                  "nl": "Een manier voor modellen om zich te focussen op verschillende delen van input bij het maken van voorspellingen"
        },
        {
                  "en": "A method to get human attention for model training",
                  "es": "Un método para obtener atención humana para entrenamiento de modelos",
                  "de": "Eine Methode um menschliche Aufmerksamkeit für Modelltraining zu erhalten",
                  "nl": "Een methode om menselijke aandacht te krijgen voor modeltraining"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Automatically encoding text into different languages",
                  "es": "Codificar automáticamente texto en diferentes idiomas",
                  "de": "Text automatisch in verschiedene Sprachen kodieren",
                  "nl": "Automatisch tekst coderen naar verschillende talen"
        },
        {
                  "en": "Learning compressed representations of data for dimensionality reduction and reconstruction",
                  "es": "Aprender representaciones comprimidas de datos para reducción de dimensionalidad y reconstrucción",
                  "de": "Komprimierte Darstellungen von Daten für Dimensionalitätsreduktion und Rekonstruktion lernen",
                  "nl": "Gecomprimeerde representaties van data leren voor dimensionaliteitsreductie en reconstructie"
        },
        {
                  "en": "Creating automatic code generators",
                  "es": "Crear generadores de código automático",
                  "de": "Automatische Code-Generatoren erstellen",
                  "nl": "Automatische codegeneratoren maken"
        },
        {
                  "en": "Encoding data for secure transmission",
                  "es": "Codificar datos para transmisión segura",
                  "de": "Daten für sichere Übertragung kodieren",
                  "nl": "Data coderen voor veilige transmissie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They provide rich semantic representations of words based on large text corpora",
                  "es": "Proporcionan representaciones semánticas ricas de palabras basadas en grandes corpus de texto",
                  "de": "Sie bieten reiche semantische Darstellungen von Wörtern basierend auf großen Textkorpora",
                  "nl": "Ze bieden rijke semantische representaties van woorden gebaseerd op grote tekstcorpora"
        },
        {
                  "en": "They convert all words to the same format",
                  "es": "Convierten todas las palabras al mismo formato",
                  "de": "Sie konvertieren alle Wörter in dasselbe Format",
                  "nl": "Ze converteren alle woorden naar hetzelfde formaat"
        },
        {
                  "en": "They make text processing faster",
                  "es": "Hacen el procesamiento de texto más rápido",
                  "de": "Sie machen Textverarbeitung schneller",
                  "nl": "Ze maken tekstverwerking sneller"
        },
        {
                  "en": "They reduce the vocabulary size",
                  "es": "Reducen el tamaño del vocabulario",
                  "de": "Sie reduzieren die Vokabulargröße",
                  "nl": "Ze verminderen de vocabulaire grootte"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "RNNs cannot process variable-length sequences",
                  "es": "Las RNNs no pueden procesar secuencias de longitud variable",
                  "de": "RNNs können keine Sequenzen variabler Länge verarbeiten",
                  "nl": "RNNs kunnen geen sequenties van variabele lengte verwerken"
        },
        {
                  "en": "RNNs require too much memory",
                  "es": "Las RNNs requieren demasiada memoria",
                  "de": "RNNs benötigen zu viel Speicher",
                  "nl": "RNNs vereisen te veel geheugen"
        },
        {
                  "en": "Vanishing gradients prevent learning of long-term dependencies in sequences",
                  "es": "Los gradientes que desaparecen previenen el aprendizaje de dependencias a largo plazo en secuencias",
                  "de": "Verschwindende Gradienten verhindern das Lernen langfristiger Abhängigkeiten in Sequenzen",
                  "nl": "Verdwijnende gradiënten voorkomen het leren van lange termijn afhankelijkheden in sequenties"
        },
        {
                  "en": "Traditional RNNs are too slow to train",
                  "es": "Las RNNs tradicionales son muy lentas para entrenar",
                  "de": "Traditionelle RNNs sind zu langsam zu trainieren",
                  "nl": "Traditionele RNNs zijn te langzaam om te trainen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Forget gate, input gate, and output gate",
                  "es": "Compuerta de olvido, compuerta de entrada y compuerta de salida",
                  "de": "Forget Gate, Input Gate und Output Gate",
                  "nl": "Forget gate, input gate en output gate"
        },
        {
                  "en": "Forward gate, backward gate, and lateral gate",
                  "es": "Compuerta hacia adelante, compuerta hacia atrás y compuerta lateral",
                  "de": "Forward Gate, Backward Gate und Lateral Gate",
                  "nl": "Forward gate, backward gate en lateral gate"
        },
        {
                  "en": "Memory gate, processing gate, and transfer gate",
                  "es": "Compuerta de memoria, compuerta de procesamiento y compuerta de transferencia",
                  "de": "Memory Gate, Processing Gate und Transfer Gate",
                  "nl": "Memory gate, processing gate en transfer gate"
        },
        {
                  "en": "Read gate, write gate, and delete gate",
                  "es": "Compuerta de lectura, compuerta de escritura y compuerta de eliminación",
                  "de": "Read Gate, Write Gate und Delete Gate",
                  "nl": "Read gate, write gate en delete gate"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "GRU cannot handle variable-length sequences",
                  "es": "GRU no puede manejar secuencias de longitud variable",
                  "de": "GRU kann keine Sequenzen variabler Länge handhaben",
                  "nl": "GRU kan geen sequenties van variabele lengte verwerken"
        },
        {
                  "en": "GRU is an older version of LSTM",
                  "es": "GRU es una versión anterior de LSTM",
                  "de": "GRU ist eine ältere Version von LSTM",
                  "nl": "GRU is een oudere versie van LSTM"
        },
        {
                  "en": "GRU has only two gates (reset and update) instead of three, making it simpler and faster while maintaining similar performance",
                  "es": "GRU tiene solo dos compuertas (reset y actualización) en lugar de tres, haciéndola más simple y rápida manteniendo rendimiento similar",
                  "de": "GRU hat nur zwei Gates (Reset und Update) anstatt drei, macht sie einfacher und schneller bei ähnlicher Leistung",
                  "nl": "GRU heeft slechts twee gates (reset en update) in plaats van drie, maakt het eenvoudiger en sneller met vergelijkbare prestaties"
        },
        {
                  "en": "GRU is designed specifically for computer vision tasks",
                  "es": "GRU está diseñada específicamente para tareas de visión computacional",
                  "de": "GRU ist speziell für Computer Vision Aufgaben entworfen",
                  "nl": "GRU is specifiek ontworpen voor computer vision taken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Processes input and output in both directions",
                  "es": "Procesa entrada y salida en ambas direcciones",
                  "de": "Verarbeitet Eingabe und Ausgabe in beide Richtungen",
                  "nl": "Verwerkt input en output in beide richtingen"
        },
        {
                  "en": "Processes sequences in both forward and backward directions to capture context from both past and future",
                  "es": "Procesa secuencias en direcciones hacia adelante y hacia atrás para capturar contexto del pasado y futuro",
                  "de": "Verarbeitet Sequenzen in Vorwärts- und Rückwärtsrichtung um Kontext aus Vergangenheit und Zukunft zu erfassen",
                  "nl": "Verwerkt sequenties in zowel voorwaartse als achterwaartse richting om context van zowel verleden als toekomst vast te leggen"
        },
        {
                  "en": "Can train on two different datasets simultaneously",
                  "es": "Puede entrenar en dos conjuntos de datos diferentes simultáneamente",
                  "de": "Kann auf zwei verschiedenen Datensätzen gleichzeitig trainieren",
                  "nl": "Kan gelijktijdig trainen op twee verschillende datasets"
        },
        {
                  "en": "Uses two different types of RNN cells",
                  "es": "Usa dos tipos diferentes de celdas RNN",
                  "de": "Verwendet zwei verschiedene Arten von RNN-Zellen",
                  "nl": "Gebruikt twee verschillende soorten RNN cellen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting sequences to fixed-length vectors",
                  "es": "Convertir secuencias a vectores de longitud fija",
                  "de": "Sequenzen in Vektoren fester Länge umwandeln",
                  "nl": "Sequenties converteren naar vectoren van vaste lengte"
        },
        {
                  "en": "Learning to recognize patterns in sequential data only",
                  "es": "Aprender a reconocer patrones solo en datos secuenciales",
                  "de": "Lernen Muster nur in sequenziellen Daten zu erkennen",
                  "nl": "Leren om patronen alleen in sequentiële data te herkennen"
        },
        {
                  "en": "Training RNNs on multiple sequences simultaneously",
                  "es": "Entrenar RNNs en múltiples secuencias simultáneamente",
                  "de": "RNNs auf mehreren Sequenzen gleichzeitig trainieren",
                  "nl": "RNNs trainen op meerdere sequenties tegelijkertijd"
        },
        {
                  "en": "A framework using encoder-decoder architecture to transform input sequences into output sequences of potentially different lengths",
                  "es": "Marco con arquitectura codificador-decodificador para transformar secuencias de entrada en salida de diferentes longitudes",
                  "de": "Framework mit Encoder-Decoder-Architektur um Eingabesequenzen in Ausgabesequenzen verschiedener Längen zu transformieren",
                  "nl": "Framework met encoder-decoder architectuur om invoersequenties te transformeren naar uitvoersequenties van verschillende lengtes"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A method where the teacher manually adjusts RNN weights",
                  "es": "Un método donde el maestro ajusta manualmente pesos de RNN",
                  "de": "Eine Methode wo der Lehrer RNN-Gewichte manuell anpasst",
                  "nl": "Een methode waarbij de leraar handmatig RNN gewichten aanpast"
        },
        {
                  "en": "Forcing the model to learn only from positive examples",
                  "es": "Forzar al modelo a aprender solo de ejemplos positivos",
                  "de": "Das Modell zwingen nur aus positiven Beispielen zu lernen",
                  "nl": "Het model dwingen om alleen van positieve voorbeelden te leren"
        },
        {
                  "en": "Using ground truth outputs as inputs during training instead of the model's own predictions to stabilize learning",
                  "es": "Usar salidas de verdad fundamental como entradas durante entrenamiento en lugar de predicciones del modelo para estabilizar",
                  "de": "Verwendung von Ground Truth Ausgaben als Eingaben während Training anstatt eigener Vorhersagen um Lernen zu stabilisieren",
                  "nl": "Gebruik van ground truth outputs als inputs tijdens training in plaats van eigen voorspellingen om leren te stabiliseren"
        },
        {
                  "en": "Training RNNs with multiple teachers simultaneously",
                  "es": "Entrenar RNNs con múltiples maestros simultáneamente",
                  "de": "RNNs mit mehreren Lehrern gleichzeitig trainieren",
                  "nl": "RNNs trainen met meerdere leraren tegelijkertijd"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The network becomes unstable and crashes",
                  "es": "La red se vuelve inestable y falla",
                  "de": "Das Netzwerk wird instabil und stürzt ab",
                  "nl": "Het netwerk wordt instabiel en crasht"
        },
        {
        ...
        {
                  "en": "RNN cells explode due to too much data",
                  "es": "Las celdas RNN explotan debido a demasiados datos",
                  "de": "RNN-Zellen explodieren wegen zu vieler Daten",
                  "nl": "RNN cellen exploderen door te veel data"
        },
        {
                  "en": "Gradients become extremely large during backpropagation, solved by gradient clipping to limit their magnitude",
                  "es": "Los gradientes se vuelven extremadamente grandes durante retropropagación, resuelto por recorte de gradientes para limitar su magnitud",
                  "de": "Gradienten werden extrem groß während Backpropagation, gelöst durch Gradient Clipping um ihre Größe zu begrenzen",
                  "nl": "Gradiënten worden extreem groot tijdens backpropagation, opgelost door gradient clipping om hun magnitude te beperken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Layers that compress input sequences",
                  "es": "Capas que comprimen secuencias de entrada",
                  "de": "Schichten die Eingabesequenzen komprimieren",
                  "nl": "Lagen die invoersequenties comprimeren"
        },
        {
                  "en": "Dense vector representations of discrete tokens that capture semantic relationships and are learned during training",
                  "es": "Representaciones vectoriales densas de tokens discretos que capturan relaciones semánticas y se aprenden durante entrenamiento",
                  "de": "Dichte Vektorrepräsentationen diskreter Token die semantische Beziehungen erfassen und während Training gelernt werden",
                  "nl": "Dichte vectorrepresentaties van discrete tokens die semantische relaties vastleggen en geleerd worden tijdens training"
        },
        {
                  "en": "Layers that embed the network into hardware",
                  "es": "Capas que embeben la red en hardware",
                  "de": "Schichten die das Netzwerk in Hardware einbetten",
                  "nl": "Lagen die het netwerk in hardware inbedden"
        },
        {
                  "en": "Hidden layers that store sequence information",
                  "es": "Capas ocultas que almacenan información de secuencia",
                  "de": "Versteckte Schichten die Sequenzinformationen speichern",
                  "nl": "Verborgen lagen die sequentie-informatie opslaan"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They describe different training strategies",
                  "es": "Describen diferentes estrategias de entrenamiento",
                  "de": "Sie beschreiben verschiedene Trainingsstrategien",
                  "nl": "Ze beschrijven verschillende trainingsstrategieën"
        },
        {
                  "en": "They refer to the number of layers in the network",
                  "es": "Se refieren al número de capas en la red",
                  "de": "Sie beziehen sich auf die Anzahl der Schichten im Netzwerk",
                  "nl": "Ze verwijzen naar het aantal lagen in het netwerk"
        },
        {
                  "en": "They indicate the size of the input data",
                  "es": "Indican el tamaño de los datos de entrada",
                  "de": "Sie zeigen die Größe der Eingabedaten an",
                  "nl": "Ze geven de grootte van de invoerdata aan"
        },
        {
                  "en": "Many-to-one: sequence to single output (sentiment), one-to-many: single to sequence (captioning), many-to-many: sequence to sequence (translation)",
                  "es": "Muchos-a-uno: secuencia a salida (sentimiento), uno-a-muchos: único a secuencia (subtítulos), muchos-a-muchos: secuencia a secuencia",
                  "de": "Viele-zu-Eins: Sequenz zu Ausgabe (Sentiment), Eins-zu-Viele: Einzel zu Sequenz (Beschriftung), Viele-zu-Viele: Sequenz zu Sequenz",
                  "nl": "Veel-naar-één: sequentie naar output (sentiment), één-naar-veel: enkel naar sequentie (bijschrift), veel-naar-veel: sequentie naar sequentie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A method for predicting future time series values",
                  "es": "Un método para predecir valores futuros de series temporales",
                  "de": "Eine Methode zur Vorhersage zukünftiger Zeitreihenwerte",
                  "nl": "Een methode voor het voorspellen van toekomstige tijdreekswaarden"
        },
        {
                  "en": "A technique for real-time RNN training",
                  "es": "Una técnica para entrenamiento de RNN en tiempo real",
                  "de": "Eine Technik für RNN-Training in Echtzeit",
                  "nl": "Een techniek voor real-time RNN training"
        },
        {
                  "en": "The algorithm for training RNNs by unfolding the network through time and applying standard backpropagation",
                  "es": "El algoritmo para entrenar RNNs desplegando la red a través del tiempo y aplicando retropropagación estándar",
                  "de": "Der Algorithmus zum Trainieren von RNNs durch Entfalten des Netzwerks durch Zeit und Anwenden von Standard-Backpropagation",
                  "nl": "Het algoritme voor het trainen van RNNs door het netwerk door tijd te ontvouwen en standaard backpropagation toe te passen"
        },
        {
                  "en": "Training RNNs backwards in time",
                  "es": "Entrenar RNNs hacia atrás en el tiempo",
                  "de": "RNNs rückwärts in der Zeit trainieren",
                  "nl": "RNNs achterwaarts in tijd trainen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A technique for finding optimal learning rates",
                  "es": "Una técnica para encontrar tasas de aprendizaje óptimas",
                  "de": "Eine Technik zum Finden optimaler Lernraten",
                  "nl": "Een techniek voor het vinden van optimale learning rates"
        },
        {
                  "en": "A method for searching through RNN architecture space",
                  "es": "Un método para buscar a través del espacio de arquitectura RNN",
                  "de": "Eine Methode zur Suche durch RNN-Architekturraum",
                  "nl": "Een methode voor het zoeken door RNN architectuurruimte"
        },
        {
                  "en": "A decoding algorithm that maintains multiple candidate sequences during generation, used for better quality outputs in text generation and translation",
                  "es": "Algoritmo de decodificación que mantiene múltiples secuencias candidatas, usado para mejor calidad en generación de texto y traducción",
                  "de": "Dekodierungsalgorithmus der mehrere Kandidatensequenzen beibehält, für bessere Qualität in Textgenerierung und Übersetzung",
                  "nl": "Decodeeralgoritme dat meerdere kandidaatsequenties behoudt, gebruikt voor betere kwaliteit in tekstgeneratie en vertaling"
        },
        {
                  "en": "A way to search for the best RNN hyperparameters",
                  "es": "Una forma de buscar los mejores hiperparámetros de RNN",
                  "de": "Ein Weg die besten RNN-Hyperparameter zu suchen",
                  "nl": "Een manier om de beste RNN hyperparameters te zoeken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hidden states contain the input data for each time step",
                  "es": "Los estados ocultos contienen los datos de entrada para cada paso temporal",
                  "de": "Versteckte Zustände enthalten die Eingabedaten für jeden Zeitschritt",
                  "nl": "Verborgen toestanden bevatten de invoerdata voor elke tijdstap"
        },
        {
                  "en": "Hidden states store the final output of the network",
                  "es": "Los estados ocultos almacenan la salida final de la red",
                  "de": "Versteckte Zustände speichern die finale Ausgabe des Netzwerks",
                  "nl": "Verborgen toestanden slaan de finale output van het netwerk op"
        },
        {
                  "en": "Hidden states control the learning rate during training",
                  "es": "Los estados ocultos controlan la tasa de aprendizaje durante entrenamiento",
                  "de": "Versteckte Zustände kontrollieren die Lernrate während Training",
                  "nl": "Verborgen toestanden controleren de learning rate tijdens training"
        },
        {
                  "en": "Hidden states carry information from previous time steps, acting as the network's memory to capture temporal dependencies",
                  "es": "Estados ocultos llevan información de pasos previos, actuando como memoria de la red para capturar dependencias temporales",
                  "de": "Versteckte Zustände tragen Informationen von vorherigen Zeitschritten, fungieren als Netzwerkgedächtnis für zeitliche Abhängigkeiten",
                  "nl": "Verborgen toestanden dragen informatie van vorige tijdstappen, fungeren als netwerkgeheugen voor temporele afhankelijkheden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using only part of the training data for efficiency",
                  "es": "Usar solo parte de los datos de entrenamiento para eficiencia",
                  "de": "Nur einen Teil der Trainingsdaten für Effizienz verwenden",
                  "nl": "Alleen een deel van de trainingsdata gebruiken voor efficiëntie"
        },
        {
                  "en": "Cutting off the RNN after a certain time to prevent overfitting",
                  "es": "Cortar la RNN después de cierto tiempo para prevenir sobreajuste",
                  "de": "Das RNN nach einer bestimmten Zeit abschneiden um Overfitting zu verhindern",
                  "nl": "Het RNN na een bepaalde tijd afkappen om overfitting te voorkomen"
        },
        {
                  "en": "Limiting backpropagation to a fixed number of time steps to reduce computational cost and memory usage while maintaining training effectiveness",
                  "es": "Limitar retropropagación a número fijo de pasos para reducir costo computacional y memoria manteniendo efectividad",
                  "de": "Backpropagation auf feste Anzahl Zeitschritte begrenzen um Rechenkosten und Speicher zu reduzieren",
                  "nl": "Backpropagation beperken tot vast aantal tijdstappen om kosten en geheugen te verminderen"
        },
        {
                  "en": "Randomly skipping time steps during training",
                  "es": "Saltear aleatoriamente pasos temporales durante entrenamiento",
                  "de": "Zufällig Zeitschritte während Training überspringen",
                  "nl": "Willekeurig tijdstappen overslaan tijdens training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "RNNs can only process fixed-length inputs while CNNs handle variable lengths",
                  "es": "Las RNNs solo pueden procesar entradas de longitud fija mientras las CNNs manejan longitudes variables",
                  "de": "RNNs können nur Eingaben fester Länge verarbeiten während CNNs variable Längen handhaben",
                  "nl": "RNNs kunnen alleen inputs van vaste lengte verwerken terwijl CNNs variabele lengtes hanteren"
        },
        {
                  "en": "CNNs use recurrent connections while RNNs use convolutions",
                  "es": "Las CNNs usan conexiones recurrentes mientras las RNNs usan convoluciones",
                  "de": "CNNs verwenden rekurrente Verbindungen während RNNs Faltungen verwenden",
                  "nl": "CNNs gebruiken recurrente verbindingen terwijl RNNs convoluties gebruiken"
        },
        {
                  "en": "CNNs excel at spatial patterns in grid data using convolution/pooling, RNNs handle sequential data with temporal dependencies via recurrent connections",
                  "es": "CNNs sobresalen en patrones espaciales con convolución/pooling, RNNs manejan datos secuenciales con dependencias temporales",
                  "de": "CNNs glänzen bei räumlichen Mustern mit Faltung/Pooling, RNNs handhaben sequenzielle Daten mit zeitlichen Abhängigkeiten",
                  "nl": "CNNs blinken uit in ruimtelijke patronen met convolutie/pooling, RNNs hanteren sequentiële data met temporele afhankelijkheden"
        },
        {
                  "en": "CNNs are faster to train than RNNs in all cases",
                  "es": "Las CNNs son más rápidas de entrenar que las RNNs en todos los casos",
                  "de": "CNNs sind in allen Fällen schneller zu trainieren als RNNs",
                  "nl": "CNNs zijn in alle gevallen sneller te trainen dan RNNs"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "By normalizing only the final layer outputs",
                  "es": "Normalizando solo las salidas de la capa final",
                  "de": "Durch Normalisierung nur der finalen Schichtausgaben",
                  "nl": "Door alleen de finale laaguitgangen te normaliseren"
        },
        {
                  "en": "By changing the batch size dynamically during training",
                  "es": "Cambiando el tamaño del lote dinámicamente durante entrenamiento",
                  "de": "Durch dynamisches Ändern der Batch-Größe während Training",
                  "nl": "Door batchgrootte dynamisch te veranderen tijdens training"
        },
        {
                  "en": "By normalizing layer inputs to have zero mean and unit variance, reducing input distribution changes during training",
                  "es": "Normalizando entradas de capa para tener media cero y varianza unitaria, reduciendo cambios de distribución de entrada durante entrenamiento",
                  "de": "Durch Normalisierung von Schichteingaben auf Null-Mittelwert und Einheitsvarianz, reduziert Eingabeverteilungsänderungen während Training",
                  "nl": "Door laaginputs te normaliseren naar nul gemiddelde en eenheidvariantie, vermindert inputdistributie veranderingen tijdens training"
        },
        {
                  "en": "By batching training examples differently",
                  "es": "Agrupando ejemplos de entrenamiento de manera diferente",
                  "de": "Durch verschiedenes Batching von Trainingsbeispielen",
                  "nl": "Door trainingsvoorbeelden anders te batchen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Encoder compresses input sequence into fixed context vector, decoder generates output sequence from this representation",
                  "es": "El codificador comprime secuencia de entrada en vector de contexto fijo, decodificador genera secuencia de salida de esta representación",
                  "de": "Encoder komprimiert Eingabesequenz in festen Kontextvektor, Decoder generiert Ausgabesequenz aus dieser Repräsentation",
                  "nl": "Encoder comprimeert invoersequentie tot vaste contextvector, decoder genereert uitvoersequentie uit deze representatie"
        },
        {
                  "en": "A method for encrypting and decrypting data",
                  "es": "Un método para cifrar y descifrar datos",
                  "de": "Eine Methode zum Verschlüsseln und Entschlüsseln von Daten",
                  "nl": "Een methode voor het versleutelen en ontsleutelen van data"
        },
        {
                  "en": "Two separate networks that work independently",
                  "es": "Dos redes separadas que trabajan independientemente",
                  "de": "Zwei separate Netzwerke die unabhängig arbeiten",
                  "nl": "Twee aparte netwerken die onafhankelijk werken"
        },
        {
                  "en": "Parallel processing of encoding and decoding",
                  "es": "Procesamiento paralelo de codificación y decodificación",
                  "de": "Parallele Verarbeitung von Kodierung und Dekodierung",
                  "nl": "Parallelle verwerking van codering en decodering"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Preventing overfitting in long sequences",
                  "es": "Prevenir sobreajuste en secuencias largas",
                  "de": "Overfitting in langen Sequenzen verhindern",
                  "nl": "Overfitting voorkomen in lange sequenties"
        },
        {
                  "en": "Making training faster by parallel processing",
                  "es": "Hacer entrenamiento más rápido con procesamiento paralelo",
                  "de": "Training schneller machen durch parallele Verarbeitung",
                  "nl": "Training sneller maken door parallelle verwerking"
        },
        {
                  "en": "Reducing the number of parameters needed",
                  "es": "Reducir el número de parámetros necesarios",
                  "de": "Die Anzahl der benötigten Parameter reduzieren",
                  "nl": "Het aantal benodigde parameters verminderen"
        },
        {
                  "en": "The bottleneck of compressing entire input into single fixed context vector, allowing decoder to focus on relevant input parts",
                  "es": "El cuello de botella de comprimir entrada en vector fijo, permitiendo al decodificador enfocarse en partes relevantes",
                  "de": "Der Flaschenhals des Komprimierens der Eingabe in festen Kontextvektor, ermöglicht Decoder-Fokus auf relevante Teile",
                  "nl": "Het knelpunt van comprimeren van invoer in vaste contextvector, stelt decoder in staat te focussen op relevante delen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Connections between different LSTM layers",
                  "es": "Conexiones entre diferentes capas LSTM",
                  "de": "Verbindungen zwischen verschiedenen LSTM-Schichten",
                  "nl": "Verbindingen tussen verschillende LSTM lagen"
        },
        {
                  "en": "Security features to prevent information leakage",
                  "es": "Características de seguridad para prevenir fuga de información",
                  "de": "Sicherheitsfunktionen um Informationslecks zu verhindern",
                  "nl": "Beveiligingsfuncties om informatielekken te voorkomen"
        },
        {
                  "en": "Connections allowing gates to inspect the cell state directly, improving timing and counting tasks",
                  "es": "Conexiones que permiten a las compuertas inspeccionar el estado celular directamente, mejorando tareas de temporización y conteo",
                  "de": "Verbindungen die Gates ermöglichen den Zellzustand direkt zu inspizieren, verbessern Timing- und Zählaufgaben",
                  "nl": "Verbindingen die gates in staat stellen de celstaat direct te inspecteren, verbeteren timing en teltaken"
        },
        {
                  "en": "Shortcuts for faster computation",
                  "es": "Atajos para computación más rápida",
                  "de": "Abkürzungen für schnellere Berechnung",
                  "nl": "Snelkoppelingen voor snellere berekening"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Randomly sampling sequences at different times",
                  "es": "Muestrear aleatoriamente secuencias en diferentes momentos",
                  "de": "Zufällig Sequenzen zu verschiedenen Zeiten sampeln",
                  "nl": "Willekeurig sequenties op verschillende tijden samplen"
        },
        {
                  "en": "Creating a sampling schedule for batch selection",
                  "es": "Crear un programa de muestreo para selección de lotes",
                  "de": "Einen Sampling-Zeitplan für Batch-Auswahl erstellen",
                  "nl": "Een samplingschema maken voor batch selectie"
        },
        {
                  "en": "Gradually transitioning from teacher forcing to using model predictions during training to reduce exposure bias",
                  "es": "Transición gradual de teacher forcing a usar predicciones del modelo durante entrenamiento para reducir sesgo de exposición",
                  "de": "Allmählicher Übergang von Teacher Forcing zur Verwendung von Modellvorhersagen während Training um Exposure Bias zu reduzieren",
                  "nl": "Geleidelijke overgang van teacher forcing naar het gebruik van modelvoorspellingen tijdens training om exposure bias te verminderen"
        },
        {
                  "en": "Scheduling when to sample from the training data",
                  "es": "Programar cuándo muestrear de los datos de entrenamiento",
                  "de": "Planen wann aus den Trainingsdaten gesampelt wird",
                  "nl": "Plannen wanneer te samplen uit de trainingsdata"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gradients disappear completely after training",
                  "es": "Los gradientes desaparecen completamente después del entrenamiento",
                  "de": "Gradienten verschwinden vollständig nach Training",
                  "nl": "Gradiënten verdwijnen volledig na training"
        },
        {
                  "en": "The network forgets all previous inputs",
                  "es": "La red olvida todas las entradas previas",
                  "de": "Das Netzwerk vergisst alle vorherigen Eingaben",
                  "nl": "Het netwerk vergeet alle vorige inputs"
        },
        {
                  "en": "Gradients decay exponentially when backpropagating through many time steps, preventing learning of long-term dependencies",
                  "es": "Gradienten decaen exponencialmente al retropropagar por muchos pasos, previniendo aprendizaje de dependencias largo plazo",
                  "de": "Gradienten verfallen exponentiell beim Backpropagation durch viele Zeitschritte, verhindert Lernen langfristiger Abhängigkeiten",
                  "nl": "Gradiënten vervallen exponentieel bij backpropagation door veel tijdstappen, voorkomt leren lange termijn afhankelijkheden"
        },
        {
                  "en": "Training becomes slower over time",
                  "es": "El entrenamiento se vuelve más lento con el tiempo",
                  "de": "Training wird langsamer über Zeit",
                  "nl": "Training wordt langzamer in de tijd"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Multiple autoencoders working together",
                  "es": "Múltiples autocodificadores trabajando juntos",
                  "de": "Mehrere Autoencoder die zusammenarbeiten",
                  "nl": "Meerdere autoencoders die samenwerken"
        },
        {
                  "en": "Generative models that learn a probabilistic latent space distribution, enabling both data reconstruction and generation of new samples",
                  "es": "Modelos generativos que aprenden distribución latente probabilística, habilitando reconstrucción de datos y generación de muestras",
                  "de": "Generative Modelle die probabilistische latente Raumverteilung lernen, ermöglichen Datenrekonstruktion und neue Sample-Generierung",
                  "nl": "Generatieve modellen die probabilistische latente ruimteverdeling leren, maken datareconstruktie en nieuwe sample generatie mogelijk"
        },
        {
                  "en": "Autoencoders with variable layer sizes",
                  "es": "Autocodificadores con tamaños de capa variables",
                  "de": "Autoencoder mit variablen Schichtgrößen",
                  "nl": "Autoencoders met variabele laaggroottes"
        },
        {
                  "en": "Autoencoders that vary their learning rate",
                  "es": "Autocodificadores que varían su tasa de aprendizaje",
                  "de": "Autoencoder die ihre Lernrate variieren",
                  "nl": "Autoencoders die hun leersnelheid variëren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The current activation state of the cell",
                  "es": "El estado de activación actual de la celda",
                  "de": "Der aktuelle Aktivierungszustand der Zelle",
                  "nl": "De huidige activatietoestand van de cel"
        },
        {
                  "en": "A separate memory path running through the cell that gates can read from and write to, enabling long-term information storage",
                  "es": "Camino de memoria separado a través de la celda que compuertas pueden leer y escribir, habilita almacenamiento largo plazo",
                  "de": "Separater Gedächtnispfad durch die Zelle den Gates lesen und schreiben können, ermöglicht langfristige Informationsspeicherung",
                  "nl": "Apart geheugenpad door de cel waarvan gates kunnen lezen en schrijven, maakt langetermijn informatieopslag mogelijk"
        },
        {
                  "en": "The final output of the LSTM",
                  "es": "La salida final del LSTM",
                  "de": "Die finale Ausgabe des LSTM",
                  "nl": "De finale output van het LSTM"
        },
        {
                  "en": "The input at the current time step",
                  "es": "La entrada en el paso temporal actual",
                  "de": "Die Eingabe beim aktuellen Zeitschritt",
                  "nl": "De input bij de huidige tijdstap"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Resets the entire network to initial state",
                  "es": "Reinicia toda la red al estado inicial",
                  "de": "Setzt das gesamte Netzwerk auf Anfangszustand zurück",
                  "nl": "Reset het hele netwerk naar initiële staat"
        },
        {
                  "en": "Controls how much past information to forget when computing new candidate state",
                  "es": "Controla cuánta información pasada olvidar al computar nuevo estado candidato",
                  "de": "Kontrolliert wie viel vergangene Informationen vergessen werden beim Berechnen neuen Kandidatenzustands",
                  "nl": "Controleert hoeveel verleden informatie te vergeten bij het berekenen van nieuwe kandidaatstaat"
        },
        {
                  "en": "Controls when to reset the learning rate",
                  "es": "Controla cuándo reiniciar la tasa de aprendizaje",
                  "de": "Kontrolliert wann die Lernrate zurückgesetzt wird",
                  "nl": "Controleert wanneer de leersnelheid te resetten"
        },
        {
                  "en": "Determines when to start a new sequence",
                  "es": "Determina cuándo iniciar una nueva secuencia",
                  "de": "Bestimmt wann eine neue Sequenz gestartet wird",
                  "nl": "Bepaalt wanneer een nieuwe sequentie te starten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Signals when new data is available",
                  "es": "Señala cuándo nuevos datos están disponibles",
                  "de": "Signalisiert wann neue Daten verfügbar sind",
                  "nl": "Signaleert wanneer nieuwe data beschikbaar is"
        },
        {
                  "en": "Controls the balance between retaining previous state and accepting new candidate state",
                  "es": "Controla el balance entre retener estado previo y aceptar nuevo estado candidato",
                  "de": "Kontrolliert die Balance zwischen Beibehaltung vorherigen Zustands und Akzeptanz neuen Kandidatenzustands",
                  "nl": "Controleert de balans tussen het behouden van vorige staat en het accepteren van nieuwe kandidaatstaat"
        },
        {
                  "en": "Determines when to update the learning rate",
                  "es": "Determina cuándo actualizar la tasa de aprendizaje",
                  "de": "Bestimmt wann die Lernrate aktualisiert wird",
                  "nl": "Bepaalt wanneer de leersnelheid bij te werken"
        },
        {
                  "en": "Updates the network weights during training",
                  "es": "Actualiza los pesos de la red durante entrenamiento",
                  "de": "Aktualisiert die Netzwerkgewichte während Training",
                  "nl": "Werkt de netwerkgewichten bij tijdens training"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The surrounding text of a word",
                  "es": "El texto circundante de una palabra",
                  "de": "Der umgebende Text eines Wortes",
                  "nl": "De omringende tekst van een woord"
        },
        {
                  "en": "A fixed-size representation summarizing the entire input sequence, passed from encoder to decoder",
                  "es": "Una representación de tamaño fijo resumiendo toda la secuencia de entrada, pasada del codificador al decodificador",
                  "de": "Eine Repräsentation fester Größe die die gesamte Eingabesequenz zusammenfasst, vom Encoder zum Decoder übergeben",
                  "nl": "Een representatie van vaste grootte die de hele invoersequentie samenvat, doorgegeven van encoder naar decoder"
        },
        {
                  "en": "The current state of the decoder",
                  "es": "El estado actual del decodificador",
                  "de": "Der aktuelle Zustand des Decoders",
                  "nl": "De huidige staat van de decoder"
        },
        {
                  "en": "Additional information about the task",
                  "es": "Información adicional sobre la tarea",
                  "de": "Zusätzliche Informationen über die Aufgabe",
                  "nl": "Aanvullende informatie over de taak"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Greedy picks highest probability token at each step, beam search maintains multiple candidate sequences to find better overall sequences",
                  "es": "Codicioso elige token de mayor probabilidad cada paso, beam search mantiene múltiples candidatas para mejores secuencias",
                  "de": "Gierig wählt Token höchster Wahrscheinlichkeit, Beam Search behält mehrere Kandidatensequenzen für bessere Gesamtsequenzen",
                  "nl": "Greedy kiest hoogste waarschijnlijkheid token, beam search behoudt meerdere kandidaten voor betere algemene sequenties"
        },
        {
                  "en": "Greedy works for all tasks, beam search only for translation",
                  "es": "Codicioso funciona para todas tareas, beam search solo para traducción",
                  "de": "Gierig funktioniert für alle Aufgaben, Beam Search nur für Übersetzung",
                  "nl": "Greedy werkt voor alle taken, beam search alleen voor vertaling"
        },
        {
                  "en": "Greedy is faster, beam search uses more memory",
                  "es": "Codicioso es más rápido, beam search usa más memoria",
                  "de": "Gierig ist schneller, Beam Search verwendet mehr Speicher",
                  "nl": "Greedy is sneller, beam search gebruikt meer geheugen"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Normalizes activations across features for each time step independently, stabilizing training in recurrent architectures",
                  "es": "Normaliza activaciones a través de características para cada paso independientemente, estabilizando entrenamiento recurrente",
                  "de": "Normalisiert Aktivierungen über Features für jeden Zeitschritt unabhängig, stabilisiert rekurrentes Training",
                  "nl": "Normaliseert activaties over features voor elke tijdstap onafhankelijk, stabiliseert recurrent training"
        },
        {
                  "en": "Reduces the number of layers needed",
                  "es": "Reduce el número de capas necesarias",
                  "de": "Reduziert die Anzahl der benötigten Schichten",
                  "nl": "Vermindert het aantal benodigde lagen"
        },
        {
                  "en": "Makes all layers the same size",
                  "es": "Hace todas las capas del mismo tamaño",
                  "de": "Macht alle Schichten gleich groß",
                  "nl": "Maakt alle lagen dezelfde grootte"
        },
        {
                  "en": "Normalizes only the output layer",
                  "es": "Normaliza solo la capa de salida",
                  "de": "Normalisiert nur die Ausgabeschicht",
                  "nl": "Normaliseert alleen de outputlaag"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Prevents the network from learning",
                  "es": "Previene que la red aprenda",
                  "de": "Verhindert dass das Netzwerk lernt",
                  "nl": "Voorkomt dat het netwerk leert"
        },
        {
                  "en": "Erases all memory after each time step",
                  "es": "Borra toda la memoria después de cada paso temporal",
                  "de": "Löscht alle Erinnerung nach jedem Zeitschritt",
                  "nl": "Wist alle geheugen na elke tijdstap"
        },
        {
                  "en": "Decides what information from the cell state should be discarded or retained based on current input and previous hidden state",
                  "es": "Decide qué información del estado celular descartar o retener basado en entrada actual y estado oculto previo",
                  "de": "Entscheidet welche Informationen aus Zellzustand verworfen oder behalten werden basierend auf aktueller Eingabe und Hidden State",
                  "nl": "Beslist welke informatie van celstaat weggegooid of behouden moet worden op basis van huidige input en vorige verborgen staat"
        },
        {
                  "en": "Controls the learning rate dynamically",
                  "es": "Controla la tasa de aprendizaje dinámicamente",
                  "de": "Kontrolliert die Lernrate dynamisch",
                  "nl": "Controleert de leersnelheid dynamisch"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Removing short sequences from training",
                  "es": "Remover secuencias cortas del entrenamiento",
                  "de": "Kurze Sequenzen aus dem Training entfernen",
                  "nl": "Korte sequenties verwijderen uit training"
        },
        {
                  "en": "Adding extra layers to the network",
                  "es": "Añadir capas extra a la red",
                  "de": "Zusätzliche Schichten zum Netzwerk hinzufügen",
                  "nl": "Extra lagen toevoegen aan het netwerk"
        },
        {
                  "en": "Adding special tokens to make sequences in a batch the same length for efficient parallel processing",
                  "es": "Añadir tokens especiales para hacer secuencias en un lote de la misma longitud para procesamiento paralelo eficiente",
                  "de": "Spezielle Tokens hinzufügen um Sequenzen in einem Batch gleich lang zu machen für effiziente parallele Verarbeitung",
                  "nl": "Speciale tokens toevoegen om sequenties in een batch dezelfde lengte te maken voor efficiënte parallelle verwerking"
        },
        {
                  "en": "Making sequences longer for better accuracy",
                  "es": "Hacer secuencias más largas para mejor precisión",
                  "de": "Sequenzen länger machen für bessere Genauigkeit",
                  "nl": "Sequenties langer maken voor betere nauwkeurigheid"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Controls what new information should be added to the cell state from the current input and previous hidden state",
                  "es": "Controla qué nueva información debería añadirse al estado celular desde la entrada actual y estado oculto previo",
                  "de": "Kontrolliert welche neuen Informationen dem Zellzustand aus aktueller Eingabe und vorherigem Hidden State hinzugefügt werden sollten",
                  "nl": "Controleert welke nieuwe informatie toegevoegd moet worden aan de celstaat vanuit de huidige input en vorige verborgen staat"
        },
        {
                  "en": "Determines the size of input sequences",
                  "es": "Determina el tamaño de secuencias de entrada",
                  "de": "Bestimmt die Größe von Eingabesequenzen",
                  "nl": "Bepaalt de grootte van invoersequenties"
        },
        {
                  "en": "Receives the initial input to the network",
                  "es": "Recibe la entrada inicial a la red",
                  "de": "Empfängt die anfängliche Eingabe zum Netzwerk",
                  "nl": "Ontvangt de initiële input aan het netwerk"
        },
        {
                  "en": "Opens and closes to control data flow",
                  "es": "Abre y cierra para controlar flujo de datos",
                  "de": "Öffnet und schließt um Datenfluss zu kontrollieren",
                  "nl": "Opent en sluit om datastroom te controleren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Determines when to stop generation",
                  "es": "Determina cuándo detener generación",
                  "de": "Bestimmt wann Generierung gestoppt wird",
                  "nl": "Bepaalt wanneer generatie te stoppen"
        },
        {
                  "en": "Determines which parts of the cell state to output as the hidden state for the next time step and for predictions",
                  "es": "Determina qué partes del estado celular producir como estado oculto para el siguiente paso temporal y para predicciones",
                  "de": "Bestimmt welche Teile des Zellzustands als Hidden State für den nächsten Zeitschritt und für Vorhersagen ausgegeben werden",
                  "nl": "Bepaalt welke delen van de celstaat uit te voeren als verborgen staat voor de volgende tijdstap en voor voorspellingen"
        },
        {
                  "en": "Sends data to external systems",
                  "es": "Envía datos a sistemas externos",
                  "de": "Sendet Daten an externe Systeme",
                  "nl": "Stuurt data naar externe systemen"
        },
        {
                  "en": "Controls the final output of the entire network",
                  "es": "Controla la salida final de toda la red",
                  "de": "Kontrolliert die finale Ausgabe des gesamten Netzwerks",
                  "nl": "Controleert de finale output van het hele netwerk"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Stateful are faster, stateless more accurate",
                  "es": "Con estado son más rápidas, sin estado más precisas",
                  "de": "Stateful sind schneller, Stateless genauer",
                  "nl": "Stateful zijn sneller, stateless nauwkeuriger"
        },
        {
                  "en": "There is no practical difference",
                  "es": "No hay diferencia práctica",
                  "de": "Es gibt keinen praktischen Unterschied",
                  "nl": "Er is geen praktisch verschil"
        },
        {
                  "en": "Stateful use LSTM cells, stateless use GRU cells",
                  "es": "Con estado usan celdas LSTM, sin estado usan celdas GRU",
                  "de": "Stateful verwenden LSTM-Zellen, Stateless verwenden GRU-Zellen",
                  "nl": "Stateful gebruiken LSTM cellen, stateless gebruiken GRU cellen"
        },
        {
                  "en": "Stateful RNNs maintain hidden state across batches, stateless reset state between batches",
                  "es": "RNNs con estado mantienen estado oculto a través de lotes, sin estado reinician estado entre lotes",
                  "de": "Stateful RNNs behalten Hidden State über Batches, Stateless setzen Zustand zwischen Batches zurück",
                  "nl": "Stateful RNNs behouden verborgen staat over batches, stateless resetten staat tussen batches"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measures how well a model predicts sequences, with lower values indicating better prediction and less uncertainty",
                  "es": "Mide qué tan bien un modelo predice secuencias, con valores más bajos indicando mejor predicción y menos incertidumbre",
                  "de": "Misst wie gut ein Modell Sequenzen vorhersagt, mit niedrigeren Werten die bessere Vorhersage und weniger Unsicherheit anzeigen",
                  "nl": "Meet hoe goed een model sequenties voorspelt, met lagere waarden die betere voorspelling en minder onzekerheid aangeven"
        },
        {
                  "en": "The training time required",
                  "es": "El tiempo de entrenamiento requerido",
                  "de": "Die benötigte Trainingszeit",
                  "nl": "De vereiste trainingstijd"
        },
        {
                  "en": "The complexity of the model architecture",
                  "es": "La complejidad de la arquitectura del modelo",
                  "de": "Die Komplexität der Modellarchitektur",
                  "nl": "De complexiteit van de modelarchitectuur"
        },
        {
                  "en": "How confused humans are by the model output",
                  "es": "Qué tan confundidos están humanos por la salida del modelo",
                  "de": "Wie verwirrt Menschen von der Modellausgabe sind",
                  "nl": "Hoe verward mensen zijn door de modeloutput"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting discrete words into continuous vector representations that capture semantic and syntactic relationships",
                  "es": "Convertir palabras discretas en representaciones vectoriales continuas que capturan relaciones semánticas y sintácticas",
                  "de": "Diskrete Wörter in kontinuierliche Vektorrepräsentationen umwandeln die semantische und syntaktische Beziehungen erfassen",
                  "nl": "Discrete woorden converteren naar continue vectorrepresentaties die semantische en syntactische relaties vastleggen"
        },
        {
                  "en": "Making text shorter for faster processing",
                  "es": "Hacer texto más corto para procesamiento más rápido",
                  "de": "Text kürzer machen für schnellere Verarbeitung",
                  "nl": "Tekst korter maken voor snellere verwerking"
        },
        {
                  "en": "Encrypting text for security",
                  "es": "Cifrar texto para seguridad",
                  "de": "Text für Sicherheit verschlüsseln",
                  "nl": "Tekst versleutelen voor beveiliging"
        },
        {
                  "en": "Translating words to different languages",
                  "es": "Traducir palabras a diferentes idiomas",
                  "de": "Wörter in verschiedene Sprachen übersetzen",
                  "nl": "Woorden vertalen naar verschillende talen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The number of shots needed for data augmentation",
                  "es": "El número de disparos necesarios para aumentación de datos",
                  "de": "Die Anzahl der Shots die für Datenaugmentation benötigt werden",
                  "nl": "Het aantal shots nodig voor data augmentatie"
        },
        {
                  "en": "Learning to perform tasks with zero, one, or a few examples respectively, leveraging pre-trained knowledge",
                  "es": "Aprender a realizar tareas con cero, uno o pocos ejemplos respectivamente, aprovechando conocimiento pre-entrenado",
                  "de": "Lernen Aufgaben mit null, einem oder wenigen Beispielen jeweils durchzuführen, nutzt vortrainiertes Wissen",
                  "nl": "Leren om taken uit te voeren met nul, één of enkele voorbeelden respectievelijk, benut voorgetrainde kennis"
        },
        {
                  "en": "Different batch sizes during training",
                  "es": "Diferentes tamaños de lote durante entrenamiento",
                  "de": "Verschiedene Batch-Größen während Training",
                  "nl": "Verschillende batch groottes tijdens training"
        },
        {
                  "en": "Different training speeds for models",
                  "es": "Diferentes velocidades de entrenamiento para modelos",
                  "de": "Verschiedene Trainingsgeschwindigkeiten für Modelle",
                  "nl": "Verschillende trainingssnelheden voor modellen"
        }
        ],
        correct: 1,
        explanation: {
