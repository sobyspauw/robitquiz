    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Large-scale pre-trained models that can be adapted for multiple downstream tasks",
                  "es": "Modelos pre-entrenados a gran escala que pueden adaptarse para múltiples tareas posteriores",
                  "de": "Groß angelegte vortrainierte Modelle die für mehrere nachgelagerte Aufgaben angepasst werden können",
                  "nl": "Grootschalige voorgetrainde modellen die aangepast kunnen worden voor meerdere downstream taken"
        },
        {
                  "en": "Models that form the foundation of neural networks",
                  "es": "Modelos que forman la fundación de redes neuronales",
                  "de": "Modelle die die Grundlage neuronaler Netzwerke bilden",
                  "nl": "Modellen die de basis vormen van neurale netwerken"
        },
        {
                  "en": "Basic models used for teaching deep learning",
                  "es": "Modelos básicos usados para enseñar aprendizaje profundo",
                  "de": "Grundmodelle für Deep Learning Lehre",
                  "nl": "Basismodellen gebruikt voor het onderwijzen van deep learning"
        },
        {
                  "en": "Models built on mathematical foundations",
                  "es": "Modelos construidos sobre fundaciones matemáticas",
                  "de": "Modelle auf mathematischen Grundlagen aufgebaut",
                  "nl": "Modellen gebouwd op wiskundige fundamenten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning opposite behaviors from training data",
                  "es": "Aprender comportamientos opuestos de datos de entrenamiento",
                  "de": "Gegensätzliche Verhaltensweisen aus Trainingsdaten lernen",
                  "nl": "Tegengestelde gedragingen leren uit trainingsdata"
        },
        {
                  "en": "Creating contrast in image brightness and color",
                  "es": "Crear contraste en brillo y color de imagen",
                  "de": "Kontrast in Bildhelligkeit und Farbe erstellen",
                  "nl": "Contrast creëren in beeldhelderheid en kleur"
        },
        {
        ...
        {
                  "en": "Learning by contrasting different neural architectures",
                  "es": "Aprender contrastando diferentes arquitecturas neuronales",
                  "de": "Lernen durch Kontrastierung verschiedener neuronaler Architekturen",
                  "nl": "Leren door verschillende neurale architecturen te contrasteren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Simple differential equations for basic neural operations",
                  "es": "Ecuaciones diferenciales simples para operaciones neuronales básicas",
                  "de": "Einfache Differentialgleichungen für grundlegende neuronale Operationen",
                  "nl": "Eenvoudige differentiaalvergelijkingen voor basis neurale operaties"
        },
        {
                  "en": "Neural networks for solving ordinary mathematical problems",
                  "es": "Redes neuronales para resolver problemas matemáticos ordinarios",
                  "de": "Neuronale Netzwerke für gewöhnliche mathematische Probleme",
                  "nl": "Neurale netwerken voor het oplossen van gewone wiskundige problemen"
        },
        {
                  "en": "Standard equations used in all neural networks",
                  "es": "Ecuaciones estándar usadas en todas las redes neuronales",
                  "de": "Standardgleichungen in allen neuronalen Netzwerken",
                  "nl": "Standaardvergelijkingen gebruikt in alle neurale netwerken"
        },
        {
                  "en": "Models that parameterize continuous dynamics of hidden states using differential equations",
                  "es": "Modelos que parametrizan dinámicas continuas de estados ocultos usando ecuaciones diferenciales",
                  "de": "Modelle die kontinuierliche Dynamiken versteckter Zustände mit Differentialgleichungen parametrisieren",
                  "nl": "Modellen die continue dynamiek van verborgen toestanden parametriseren met behulp van differentiaalvergelijkingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Taking only a few shots in photography applications",
                  "es": "Tomar solo unas pocas fotos en aplicaciones de fotografía",
                  "de": "Nur wenige Aufnahmen in Fotografie-Anwendungen machen",
                  "nl": "Slechts een paar opnames maken in fotografie applicaties"
        },
        {
                  "en": "Learning new tasks from very few examples using meta-learning, transfer learning, or data augmentation",
                  "es": "Aprender nuevas tareas de muy pocos ejemplos usando meta-aprendizaje, aprendizaje por transferencia o aumento de datos",
                  "de": "Neue Aufgaben aus sehr wenigen Beispielen lernen mit Meta-Learning, Transfer Learning oder Datenaugmentation",
                  "nl": "Nieuwe taken leren uit zeer weinig voorbeelden met behulp van meta-learning, transfer learning of data augmentatie"
        },
        {
                  "en": "Training models with few computational steps",
                  "es": "Entrenar modelos con pocos pasos computacionales",
                  "de": "Modelle mit wenigen Berechnungsschritten trainieren",
                  "nl": "Modellen trainen met weinig computationele stappen"
        },
        {
                  "en": "Learning tasks that require few resources",
                  "es": "Aprender tareas que requieren pocos recursos",
                  "de": "Aufgaben lernen die wenige Ressourcen erfordern",
                  "nl": "Taken leren die weinig bronnen vereisen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Applying transformer architecture to images by treating image patches as sequences",
                  "es": "Aplicar arquitectura transformer a imágenes tratando parches de imagen como secuencias",
                  "de": "Transformer-Architektur auf Bilder anwenden durch Behandlung von Bildpatches als Sequenzen",
                  "nl": "Transformer architectuur toepassen op afbeeldingen door beeldpatches als sequenties te behandelen"
        },
        {
                  "en": "Converting vision models to work with transformers",
                  "es": "Convertir modelos de visión para trabajar con transformers",
                  "de": "Vision-Modelle für Transformer konvertieren",
                  "nl": "Visiemodellen converteren om te werken met transformers"
        },
        {
                  "en": "Transforming visual data into different formats",
                  "es": "Transformar datos visuales en diferentes formatos",
                  "de": "Visuelle Daten in verschiedene Formate transformieren",
                  "nl": "Visuele data transformeren naar verschillende formaten"
        },
        {
                  "en": "Using electrical transformers in vision systems",
                  "es": "Usar transformadores eléctricos en sistemas de visión",
                  "de": "Elektrische Transformatoren in Vision-Systemen verwenden",
                  "nl": "Elektrische transformatoren gebruiken in visiesystemen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Attention that automatically adjusts its parameters",
                  "es": "Atención que ajusta automáticamente sus parámetros",
                  "de": "Attention die automatisch ihre Parameter anpasst",
                  "nl": "Attention die automatisch zijn parameters aanpast"
        },
        {
                  "en": "Attention mechanism that focuses only on itself without external input",
                  "es": "Mecanismo de atención que se enfoca solo en sí mismo sin entrada externa",
                  "de": "Attention-Mechanismus der sich nur auf sich selbst ohne externe Eingabe fokussiert",
                  "nl": "Attention mechanisme dat zich alleen op zichzelf richt zonder externe input"
        },
        {
                  "en": "Self-supervised attention learning without labels",
                  "es": "Aprendizaje de atención auto-supervisado sin etiquetas",
                  "de": "Selbstüberwachtes Attention-Lernen ohne Labels",
                  "nl": "Zelf-gesuperviseerd attention leren zonder labels"
        },
        {
                  "en": "Allows each position in a sequence to attend to all positions in the same sequence, computing relationships within the input itself",
                  "es": "Permite que cada posición en una secuencia atienda a todas las posiciones en la misma, computando relaciones internas",
                  "de": "Ermöglicht jeder Position in einer Sequenz alle Positionen in derselben Sequenz zu beachten, berechnet interne Beziehungen",
                  "nl": "Stelt elke positie in een sequentie in staat om te letten op alle posities in dezelfde sequentie, berekent relaties binnen de input zelf"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Attention mechanism with multiple output heads for different tasks",
                  "es": "Mecanismo de atención con múltiples cabezas de salida para diferentes tareas",
                  "de": "Attention-Mechanismus mit mehreren Ausgabeköpfen für verschiedene Aufgaben",
                  "nl": "Attention mechanisme met meerdere output heads voor verschillende taken"
        },
        {
                  "en": "Multi-headed neural network architecture for attention",
                  "es": "Arquitectura de red neuronal multi-cabeza para atención",
                  "de": "Multi-Head Neuronale Netzwerkarchitektur für Attention",
                  "nl": "Multi-head neurale netwerkarchitectuur voor attention"
        },
        {
                  "en": "Runs multiple attention mechanisms in parallel with different learned projections, focusing on different relationship types simultaneously",
                  "es": "Ejecuta múltiples mecanismos de atención en paralelo con proyecciones aprendidas, enfocándose en diferentes tipos de relaciones",
                  "de": "Führt mehrere Attention-Mechanismen parallel mit gelernten Projektionen aus, fokussiert verschiedene Beziehungstypen gleichzeitig",
                  "nl": "Voert meerdere attention mechanismen parallel uit met geleerde projecties, richt zich op verschillende relatietypes tegelijkertijd"
        },
        {
                  "en": "Uses multiple transformer heads stacked on top of each other",
                  "es": "Usa múltiples cabezas de transformer apiladas una encima de otra",
                  "de": "Verwendet mehrere Transformer-Köpfe übereinander gestapelt",
                  "nl": "Gebruikt meerdere transformer heads gestapeld op elkaar"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Encodes the position of transformers in the network architecture",
                  "es": "Codifica la posición de transformers en la arquitectura de red",
                  "de": "Kodiert die Position von Transformers in der Netzwerkarchitektur",
                  "nl": "Codeert de positie van transformers in de netwerkarchitectuur"
        },
        {
                  "en": "Encodes spatial positions for computer vision transformers",
                  "es": "Codifica posiciones espaciales para transformers de visión por computadora",
                  "de": "Kodiert räumliche Positionen für Computer Vision Transformers",
                  "nl": "Codeert ruimtelijke posities voor computer vision transformers"
        },
        {
                  "en": "Adds position information to input embeddings since self-attention is permutation invariant and doesn't inherently understand sequence order",
                  "es": "Agrega información de posición a embeddings ya que auto-atención es permutación-invariante y no entiende orden de secuencia",
                  "de": "Fügt Positionsinformationen zu Embeddings hinzu da Self-Attention permutationsinvariant ist und Sequenzreihenfolge nicht versteht",
                  "nl": "Voegt positie-informatie toe aan input embeddings omdat self-attention permutatie-invariant is en sequentievolgorde niet inherent begrijpt"
        },
        {
                  "en": "Determines the optimal position for placing attention layers",
                  "es": "Determina la posición óptima para colocar capas de atención",
                  "de": "Bestimmt die optimale Position für Attention-Schichten",
                  "nl": "Bepaalt de optimale positie voor het plaatsen van attention lagen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Database-like operations for storing and retrieving attention patterns",
                  "es": "Operaciones tipo base de datos para almacenar y recuperar patrones de atención",
                  "de": "Datenbankähnliche Operationen zum Speichern und Abrufen von Attention-Mustern",
                  "nl": "Database-achtige operaties voor het opslaan en ophalen van attention patronen"
        },
        {
                  "en": "Three types of attention: key attention, query attention, and value attention",
                  "es": "Tres tipos de atención: atención de clave, atención de consulta y atención de valor",
                  "de": "Drei Arten von Attention: Key-Attention, Query-Attention und Value-Attention",
                  "nl": "Drie soorten attention: key attention, query attention en value attention"
        },
        {
                  "en": "Queries determine what to look for, keys are what can be attended to, values are retrieved information, with attention weights from query-key similarity",
                  "es": "Queries determinan qué buscar, keys son a lo que se atiende, values son información recuperada, con pesos de similitud query-key",
                  "de": "Queries bestimmen wonach gesucht wird, Keys sind was beachtet wird, Values sind Informationen, Gewichte aus Query-Key-Ähnlichkeit",
                  "nl": "Queries bepalen waarnaar te zoeken, keys zijn waar naar gekeken wordt, values zijn opgehaalde informatie, gewichten uit query-key gelijkenis"
        },
        {
                  "en": "Three separate neural networks that process different aspects of input",
                  "es": "Tres redes neuronales separadas que procesan diferentes aspectos de entrada",
                  "de": "Drei separate neuronale Netzwerke die verschiedene Aspekte der Eingabe verarbeiten",
                  "nl": "Drie aparte neurale netwerken die verschillende aspecten van input verwerken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Different training objectives for each architecture",
                  "es": "Diferentes objetivos de entrenamiento para cada arquitectura",
                  "de": "Verschiedene Trainingsziele für jede Architektur",
                  "nl": "Verschillende trainingsdoelstellingen voor elke architectuur"
        },
        {
                  "en": "Different numbers of transformer layers in each architecture",
                  "es": "Diferentes números de capas transformer en cada arquitectura",
                  "de": "Verschiedene Anzahlen von Transformer-Schichten in jeder Architektur",
                  "nl": "Verschillende aantallen transformer lagen in elke architectuur"
        },
        {
                  "en": "Different attention mechanisms used in each type",
                  "es": "Diferentes mecanismos de atención usados en cada tipo",
                  "de": "Verschiedene Attention-Mechanismen in jedem Typ verwendet",
                  "nl": "Verschillende attention mechanismen gebruikt in elk type"
        },
        {
                  "en": "Encoder-only (BERT) for understanding, decoder-only (GPT) for generation, encoder-decoder (T5) for sequence-to-sequence tasks",
                  "es": "Encoder-only (BERT) para comprensión, decoder-only (GPT) para generación, encoder-decoder (T5) para secuencia-a-secuencia",
                  "de": "Encoder-only (BERT) für Verstehen, Decoder-only (GPT) für Generierung, Encoder-Decoder (T5) für Sequenz-zu-Sequenz-Aufgaben",
                  "nl": "Encoder-only (BERT) voor begrip, decoder-only (GPT) voor generatie, encoder-decoder (T5) voor sequentie-naar-sequentie taken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Attention that crosses between different attention heads",
                  "es": "Atención que cruza entre diferentes cabezas de atención",
                  "de": "Attention die zwischen verschiedenen Attention-Heads kreuzt",
                  "nl": "Attention dat kruist tussen verschillende attention heads"
        },
        {
                  "en": "Attention mechanism that works across multiple layers",
                  "es": "Mecanismo de atención que funciona a través de múltiples capas",
                  "de": "Attention-Mechanismus der über mehrere Schichten funktioniert",
                  "nl": "Attention mechanisme dat werkt over meerdere lagen"
        },
        {
                  "en": "Attention mechanism where queries come from one sequence and keys/values from another, used in decoder layers to attend to encoder outputs",
                  "es": "Mecanismo donde queries vienen de una secuencia y keys/values de otra, usado en decoder para atender salidas del encoder",
                  "de": "Mechanismus wo Queries aus einer Sequenz und Keys/Values aus anderer kommen, in Decoder-Schichten für Encoder-Ausgaben",
                  "nl": "Mechanisme waarbij queries uit één sequentie komen en keys/values uit andere, gebruikt in decoder lagen voor encoder outputs"
        },
        {
                  "en": "Cross-validation technique for attention weights",
                  "es": "Técnica de validación cruzada para pesos de atención",
                  "de": "Cross-Validation-Technik für Attention-Gewichte",
                  "nl": "Cross-validatie techniek voor attention gewichten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Normalizes the number of layers in the transformer",
                  "es": "Normaliza el número de capas en el transformer",
                  "de": "Normalisiert die Anzahl der Schichten im Transformer",
                  "nl": "Normaliseert het aantal lagen in de transformer"
        },
        {
                  "en": "Ensures all layers have the same computational complexity",
                  "es": "Asegura que todas las capas tengan la misma complejidad computacional",
                  "de": "Stellt sicher dass alle Schichten dieselbe rechnerische Komplexität haben",
                  "nl": "Zorgt ervoor dat alle lagen dezelfde computationele complexiteit hebben"
        },
        {
                  "en": "Stabilizes training by normalizing activations across the feature dimension, typically applied before or after each sub-layer (attention, feed-forward)",
                  "es": "Estabiliza entrenamiento normalizando activaciones en dimensión de características, aplicada antes/después de sub-capas",
                  "de": "Stabilisiert Training durch Normalisierung von Aktivierungen über Feature-Dimension, vor/nach Unter-Schichten angewendet",
                  "nl": "Stabiliseert training door activaties te normaliseren over feature dimensie, toegepast voor/na elke sub-laag"
        },
        {
                  "en": "Normalizes layer weights to prevent overfitting",
                  "es": "Normaliza pesos de capa para prevenir sobreajuste",
                  "de": "Normalisiert Schichtgewichte um Overfitting zu verhindern",
                  "nl": "Normaliseert laaggewichten om overfitting te voorkomen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses masks to hide certain attention heads during training",
                  "es": "Usa máscaras para ocultar ciertas cabezas de atención durante entrenamiento",
                  "de": "Verwendet Masken um bestimmte Attention-Heads während des Trainings zu verbergen",
                  "nl": "Gebruikt maskers om bepaalde attention heads tijdens training te verbergen"
        },
        {
                  "en": "Masks out low-attention weights to improve efficiency",
                  "es": "Enmascara pesos de atención bajos para mejorar eficiencia",
                  "de": "Maskiert niedrige Attention-Gewichte um Effizienz zu verbessern",
                  "nl": "Maskeert lage attention gewichten om efficiëntie te verbeteren"
        },
        {
                  "en": "Prevents positions from attending to future positions in the sequence, ensuring autoregressive generation during training and inference",
                  "es": "Previene que posiciones atiendan a posiciones futuras, asegurando generación autoregressiva",
                  "de": "Verhindert dass Positionen auf zukünftige Positionen achten, gewährleistet autoregressive Generierung",
        ...
        {
                  "en": "Applies attention only to masked portions of the input",
                  "es": "Aplica atención solo a porciones enmascaradas de la entrada",
                  "de": "Wendet Attention nur auf maskierte Teile der Eingabe an",
                  "nl": "Past attention alleen toe op gemaskeerde delen van de input"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Attention(Q,K,V) = softmax(QK^T/√d_k)V, where √d_k scaling prevents dot products from becoming too large and softmax from saturating",
                  "es": "Attention(Q,K,V) = softmax(QK^T/√d_k)V, donde escalado √d_k previene que productos punto se vuelvan demasiado grandes y softmax se sature",
                  "de": "Attention(Q,K,V) = softmax(QK^T/√d_k)V, wobei √d_k Skalierung verhindert dass Skalarprodukte zu groß werden und Softmax sättigt",
                  "nl": "Attention(Q,K,V) = softmax(QK^T/√d_k)V, waarbij √d_k schaling voorkomt dat dot products te groot worden en softmax verzadigd raakt"
        },
        {
                  "en": "Dot product attention with learnable scaling parameters",
                  "es": "Atención producto punto con parámetros de escala aprendibles",
                  "de": "Dot-Product Attention mit lernbaren Skalierungsparametern",
                  "nl": "Dot product attention met leerbare schalings parameters"
        },
        {
                  "en": "A scaling method to normalize attention across different layers",
                  "es": "Un método de escalado para normalizar atención entre diferentes capas",
                  "de": "Eine Skalierungsmethode um Attention über verschiedene Schichten zu normalisieren",
                  "nl": "Een schalings methode om attention te normaliseren over verschillende lagen"
        },
        {
                  "en": "A formula that scales attention weights based on input size",
                  "es": "Una fórmula que escala pesos de atención basada en tamaño de entrada",
                  "de": "Eine Formel die Attention-Gewichte basierend auf Eingabegröße skaliert",
                  "nl": "Een formule die attention gewichten schaalt gebaseerd op input grootte"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A recurrent network for processing sequential information",
                  "es": "Una red recurrente para procesar información secuencial",
                  "de": "Ein rekurrentes Netzwerk zur Verarbeitung sequenzieller Informationen",
                  "nl": "Een recurrent netwerk voor het verwerken van sequentiële informatie"
        },
        {
                  "en": "A forward propagation mechanism for gradient computation",
                  "es": "Un mecanismo de propagación hacia adelante para computación de gradientes",
                  "de": "Ein Vorwärtspropagationsmechanismus für Gradientenberechnung",
                  "nl": "Een voorwaartse propagatie mechanisme voor gradiënt berekening"
        },
        {
                  "en": "A network that feeds information forward to the next transformer layer",
                  "es": "Una red que alimenta información hacia adelante a la siguiente capa transformer",
                  "de": "Ein Netzwerk das Informationen zur nächsten Transformer-Schicht weiterleitet",
                  "nl": "Een netwerk dat informatie doorvoert naar de volgende transformer laag"
        },
        {
                  "en": "A position-wise fully connected network with ReLU activation that processes each position independently, providing non-linear transformations",
                  "es": "Red completamente conectada por posición con ReLU que procesa cada posición independientemente, da transformaciones no lineales",
                  "de": "Positionsweises vollverbundenes Netzwerk mit ReLU das jede Position unabhängig verarbeitet, bietet nichtlineare Transformationen",
                  "nl": "Positie-gewijze volledig verbonden netwerk met ReLU dat elke positie onafhankelijk verwerkt, biedt niet-lineaire transformaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Skip connections that add the input to the output of each sub-layer, enabling gradient flow and preventing vanishing gradients in deep networks",
                  "es": "Conexiones de salto que agregan entrada a salida de sub-capa, permiten flujo de gradientes y previenen gradientes desvanecientes",
                  "de": "Skip-Verbindungen die Eingabe zur Ausgabe jeder Unter-Schicht hinzufügen, ermöglichen Gradientenfluss und verhindern Gradienten-Verschwinden",
                  "nl": "Skip verbindingen die input toevoegen aan output van sub-laag, maken gradiëntenstroom mogelijk en voorkomen verdwijnende gradiënten"
        },
        {
                  "en": "Connections that store residual information for later use",
                  "es": "Conexiones que almacenan información residual para uso posterior",
                  "de": "Verbindungen die residuale Informationen für späteren Gebrauch speichern",
                  "nl": "Verbindingen die residuele informatie opslaan voor later gebruik"
        },
        {
                  "en": "Backup connections in case primary connections fail",
                  "es": "Conexiones de respaldo en caso de que fallen conexiones primarias",
                  "de": "Backup-Verbindungen falls primäre Verbindungen versagen",
                  "nl": "Backup verbindingen voor het geval primaire verbindingen falen"
        },
        {
                  "en": "Connections between residual blocks in the architecture",
                  "es": "Conexiones entre bloques residuales en la arquitectura",
                  "de": "Verbindungen zwischen residualen Blöcken in der Architektur",
                  "nl": "Verbindingen tussen residuele blokken in de architectuur"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Absolute encoding works for any sequence length while relative is limited",
                  "es": "Codificación absoluta funciona para cualquier longitud de secuencia mientras relativa está limitada",
                  "de": "Absolute Kodierung funktioniert für jede Sequenzlänge während relative begrenzt ist",
                  "nl": "Absolute encoding werkt voor elke sequentielengte terwijl relatieve beperkt is"
        },
        {
                  "en": "Absolute encoding assigns fixed positions to tokens, while relative encoding focuses on distances between tokens, often providing better generalization",
                  "es": "Codificación absoluta asigna posiciones fijas a tokens, relativa se enfoca en distancias, da mejor generalización",
                  "de": "Absolute Kodierung weist Tokens feste Positionen zu, relative fokussiert auf Abstände, bietet bessere Generalisierung",
                  "nl": "Absolute encoding wijst vaste posities toe, relatieve richt zich op afstanden tussen tokens, biedt vaak betere generalisatie"
        },
        {
                  "en": "Absolute encoding uses real numbers while relative uses integers",
                  "es": "Codificación absoluta usa números reales mientras relativa usa enteros",
                  "de": "Absolute Kodierung verwendet reelle Zahlen während relative ganze Zahlen verwendet",
                  "nl": "Absolute encoding gebruikt reële getallen terwijl relatieve gehele getallen gebruikt"
        },
        {
                  "en": "Absolute encoding is learned while relative is fixed",
                  "es": "Codificación absoluta se aprende mientras relativa es fija",
                  "de": "Absolute Kodierung wird gelernt während relative fest ist",
                  "nl": "Absolute encoding wordt geleerd terwijl relatieve vast is"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use predetermined attention patterns based on position",
                  "es": "Usar patrones de atención predeterminados basados en posición",
                  "de": "Vorbestimmte Attention-Muster basierend auf Position verwenden",
                  "nl": "Gebruik vooraf bepaalde attention patronen gebaseerd op positie"
        },
        {
                  "en": "Compute dot products between queries and keys, scale by √d_k, apply softmax to get probabilities, then use these to weight the values",
                  "es": "Computar productos punto entre queries y keys, escalar por √d_k, aplicar softmax, usar para ponderar valores",
                  "de": "Skalarprodukte zwischen Queries und Keys berechnen, durch √d_k skalieren, Softmax anwenden, verwenden um Values zu gewichten",
                  "nl": "Bereken dot products tussen queries en keys, schaal door √d_k, pas softmax toe, gebruik deze om values te wegen"
        },
        {
                  "en": "Randomly sample attention weights during training",
                  "es": "Muestrear aleatoriamente pesos de atención durante entrenamiento",
                  "de": "Attention-Gewichte während des Trainings zufällig sampeln",
                  "nl": "Willekeurig attention gewichten samplen tijdens training"
        },
        {
                  "en": "Train a separate network to learn attention weights",
                  "es": "Entrenar una red separada para aprender pesos de atención",
                  "de": "Ein separates Netzwerk trainieren um Attention-Gewichte zu lernen",
                  "nl": "Train een apart netwerk om attention gewichten te leren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses fewer attention heads to reduce computation",
                  "es": "Usa menos cabezas de atención para reducir computación",
                  "de": "Verwendet weniger Attention-Heads um Berechnung zu reduzieren",
                  "nl": "Gebruikt minder attention heads om berekening te verminderen"
        },
        {
                  "en": "Applies attention only to sparse representations of input",
                  "es": "Aplica atención solo a representaciones dispersas de entrada",
                  "de": "Wendet Attention nur auf spärliche Repräsentationen der Eingabe an",
                  "nl": "Past attention alleen toe op dunne representaties van input"
        },
        {
                  "en": "Limits attention to a subset of positions rather than all pairs, reducing complexity from O(n²) to O(n√n) or O(n log n) while maintaining performance",
                  "es": "Limita atención a subconjunto de posiciones no todos los pares, reduce complejidad de O(n²) a O(n√n) o O(n log n)",
                  "de": "Begrenzt Attention auf Teilmenge von Positionen nicht alle Paare, reduziert Komplexität von O(n²) zu O(n√n) oder O(n log n)",
                  "nl": "Beperkt attention tot subset van posities niet alle paren, vermindert complexiteit van O(n²) naar O(n√n) of O(n log n)"
        },
        {
                  "en": "Randomly drops attention connections during training",
                  "es": "Elimina aleatoriamente conexiones de atención durante entrenamiento",
                  "de": "Lässt zufällig Attention-Verbindungen während des Trainings fallen",
                  "nl": "Laat willekeurig attention verbindingen vallen tijdens training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converts attention scores into a probability distribution that sums to 1, ensuring proper weighting and enabling gradient flow through attention weights",
                  "es": "Convierte scores de atención en distribución de probabilidad que suma 1, asegura ponderación y flujo de gradientes",
                  "de": "Konvertiert Attention-Scores in Wahrscheinlichkeitsverteilung die sich zu 1 summiert, gewährleistet Gewichtung und Gradientenfluss",
                  "nl": "Converteert attention scores naar kansverdeling die optelt tot 1, zorgt voor weging en maakt gradiëntenstroom mogelijk"
        },
        {
                  "en": "Amplifies the strongest attention signals while suppressing others",
                  "es": "Amplifica las señales de atención más fuertes mientras suprime otras",
                  "de": "Verstärkt die stärksten Attention-Signale während andere unterdrückt werden",
                  "nl": "Versterkt de sterkste attention signalen terwijl andere onderdrukt worden"
        },
        {
                  "en": "Applies non-linear activation to attention computations",
                  "es": "Aplica activación no lineal a computaciones de atención",
                  "de": "Wendet nichtlineare Aktivierung auf Attention-Berechnungen an",
                  "nl": "Past niet-lineaire activatie toe op attention berekeningen"
        },
        {
                  "en": "Normalizes attention weights to prevent overflow",
                  "es": "Normaliza pesos de atención para prevenir desbordamiento",
                  "de": "Normalisiert Attention-Gewichte um Überlauf zu verhindern",
                  "nl": "Normaliseert attention gewichten om overflow te voorkomen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Compressing models by removing duplicate weights",
                  "es": "Comprimir modelos removiendo pesos duplicados",
                  "de": "Modelle durch Entfernen doppelter Gewichte komprimieren",
                  "nl": "Modellen comprimeren door dubbele gewichten te verwijderen"
        },
        {
                  "en": "Extracting essential features from models",
                  "es": "Extraer características esenciales de modelos",
                  "de": "Wesentliche Merkmale aus Modellen extrahieren",
                  "nl": "Essentiële kenmerken extraheren uit modellen"
        },
        {
                  "en": "Purifying model parameters through filtering",
                  "es": "Purificar parámetros de modelo a través de filtrado",
                  "de": "Modellparameter durch Filterung reinigen",
                  "nl": "Modelparameters zuiveren door filteren"
        },
        {
                  "en": "Transferring knowledge from large teacher models to smaller student models by training on soft probability distributions",
                  "es": "Transferir conocimiento de modelos maestros grandes a modelos estudiantes más pequeños entrenando en distribuciones de probabilidad suaves",
                  "de": "Wissen von großen Lehrer-Modellen auf kleinere Schüler-Modelle übertragen durch Training auf weichen Wahrscheinlichkeitsverteilungen",
                  "nl": "Kennis overdragen van grote leraar modellen naar kleinere student modellen door te trainen op zachte waarschijnlijkheidsverdelingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use gating mechanisms to filter graph information",
                  "es": "Usan mecanismos de compuerta para filtrar información de grafos",
                  "de": "Verwenden Gating-Mechanismen um Graph-Informationen zu filtern",
                  "nl": "Gebruiken gating mechanismen om graaf informatie te filteren"
        },
        {
                  "en": "Apply transformers directly to graph structures",
                  "es": "Aplican transformers directamente a estructuras de grafos",
                  "de": "Wenden Transformers direkt auf Graphstrukturen an",
                  "nl": "Passen transformers direct toe op graafstructuren"
        },
        {
                  "en": "Apply attention mechanisms to weigh neighbor importance dynamically rather than using fixed aggregation",
                  "es": "Aplican mecanismos de atención para ponderar importancia de vecinos dinámicamente en lugar de usar agregación fija",
                  "de": "Wenden Attention-Mechanismen an um Nachbar-Wichtigkeit dynamisch zu gewichten anstatt feste Aggregation zu verwenden",
                  "nl": "Passen attention mechanismen toe om belang van buren dynamisch te wegen in plaats van vaste aggregatie te gebruiken"
        },
        {
                  "en": "Attend to multiple graph layers simultaneously",
                  "es": "Atienden a múltiples capas de grafos simultáneamente",
                  "de": "Beachten mehrere Graph-Schichten gleichzeitig",
                  "nl": "Letten op meerdere graaflagen tegelijkertijd"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Machines that learn to translate autonomously",
                  "es": "Máquinas que aprenden a traducir autónomamente",
                  "de": "Maschinen die autonom übersetzen lernen",
                  "nl": "Machines die autonoom leren vertalen"
        },
        {
                  "en": "Uses neural networks to translate between programming languages",
                  "es": "Usa redes neuronales para traducir entre lenguajes de programación",
                  "de": "Verwendet neuronale Netzwerke um zwischen Programmiersprachen zu übersetzen",
                  "nl": "Gebruikt neurale netwerken om te vertalen tussen programmeertalen"
        },
        {
                  "en": "Evolved from RNN seq2seq models to transformer-based architectures achieving near-human translation quality",
                  "es": "Evolucionó de modelos seq2seq RNN a arquitecturas basadas en transformer logrando calidad de traducción casi humana",
                  "de": "Entwickelte sich von RNN seq2seq Modellen zu Transformer-basierten Architekturen die nahezu menschliche Übersetzungsqualität erreichen",
                  "nl": "Evolueerde van RNN seq2seq modellen naar transformer-gebaseerde architecturen die bijna menselijke vertaalkwaliteit bereiken"
        },
        {
                  "en": "Translates neural signals to text output",
                  "es": "Traduce señales neuronales a salida de texto",
                  "de": "Übersetzt neuronale Signale in Textausgabe",
                  "nl": "Vertaalt neurale signalen naar tekstoutput"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Instantaneous transfer without processing time",
                  "es": "Transferencia instantánea sin tiempo de procesamiento",
                  "de": "Sofortige Übertragung ohne Verarbeitungszeit",
                  "nl": "Onmiddellijke overdracht zonder verwerkingstijd"
        },
        {
                  "en": "Performing tasks without task-specific training by leveraging knowledge learned during pre-training on diverse data",
                  "es": "Realizar tareas sin entrenamiento específico aprovechando conocimiento de pre-entrenamiento en datos diversos",
                  "de": "Aufgaben ohne spezifisches Training durch Nutzung von Wissen aus Vortraining auf vielfältigen Daten",
                  "nl": "Taken uitvoeren zonder taak-specifieke training door kennis te benutten die geleerd is tijdens pre-training op diverse data"
        },
        {
                  "en": "Transferring models without any examples at all",
                  "es": "Transferir modelos sin ejemplos en absoluto",
                  "de": "Modelle ohne Beispiele überhaupt übertragen",
                  "nl": "Modellen overdragen zonder enige voorbeelden"
        },
        {
                  "en": "Zero-cost transfer learning techniques",
                  "es": "Técnicas de aprendizaje por transferencia de costo cero",
                  "de": "Null-Kosten Transfer Learning Techniken",
                  "nl": "Nul-kosten transfer learning technieken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Diseñar prompts de entrada efectivos para provocar comportamientos deseados de modelos sin modificar parámetros",
                  "de": "Effektive Eingabe-Prompts entwerfen um gewünschte Verhaltensweisen von Modellen hervorzurufen ohne Parameter zu modifizieren",
                  "nl": "Effectieve input prompts ontwerpen om gewenst gedrag van modellen op te roepen zonder parameters te wijzigen"
        },
        {
                  "en": "Building infrastructure for prompt processing",
                  "es": "Construir infraestructura para procesamiento de prompts",
                  "de": "Infrastruktur für Prompt-Verarbeitung aufbauen",
                  "nl": "Infrastructuur bouwen voor prompt verwerking"
        },
        {
                  "en": "Engineering systems that generate prompts automatically",
                  "es": "Ingeniar sistemas que generan prompts automáticamente",
                  "de": "Systeme konstruieren die Prompts automatisch generieren",
                  "nl": "Systemen ontwerpen die prompts automatisch genereren"
        },
        {
                  "en": "Optimizing prompt delivery speed",
                  "es": "Optimizar velocidad de entrega de prompts",
                  "de": "Prompt-Liefergeschwindigkeit optimieren",
                  "nl": "Prompt leverings snelheid optimaliseren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Examples from adversarial domains used for testing",
                  "es": "Ejemplos de dominios adversarios usados para pruebas",
                  "de": "Beispiele aus adversariellen Bereichen für Tests verwendet",
                  "nl": "Voorbeelden uit adversariële domeinen gebruikt voor testen"
        },
        {
                  "en": "Training examples that oppose each other",
                  "es": "Ejemplos de entrenamiento que se oponen entre sí",
                  "de": "Trainingsbeispiele die sich gegenseitig entgegenstehen",
                  "nl": "Trainingsvoorbeelden die tegenover elkaar staan"
        },
        {
                  "en": "Examples of adversarial network architectures",
                  "es": "Ejemplos de arquitecturas de red adversarias",
                  "de": "Beispiele für adversarielle Netzwerkarchitekturen",
                  "nl": "Voorbeelden van adversariële netwerkarchitecturen"
        },
        {
                  "en": "Carefully crafted inputs with imperceptible perturbations that cause models to make incorrect predictions",
                  "es": "Entradas cuidadosamente elaboradas con perturbaciones imperceptibles que causan que modelos hagan predicciones incorrectas",
                  "de": "Sorgfältig gestaltete Eingaben mit unmerklichen Störungen die Modelle falsche Vorhersagen machen lassen",
                  "nl": "Zorgvuldig geconstrueerde inputs met onmerkbare verstoringen die modellen verkeerde voorspellingen laten maken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Computational cost is constant regardless of sequence length",
                  "es": "Costo computacional es constante independiente de longitud de secuencia",
                  "de": "Rechnerische Kosten sind konstant unabhängig von Sequenzlänge",
                  "nl": "Computationele kosten zijn constant ongeacht sequentielengte"
        },
        {
                  "en": "Standard attention is O(n²) in sequence length, addressed by linear attention, sparse patterns, and low-rank approximations",
                  "es": "Atención estándar es O(n²) en longitud de secuencia, abordada por atención lineal, patrones dispersos y aproximaciones de bajo rango",
                  "de": "Standard-Attention ist O(n²) in Sequenzlänge, adressiert durch lineare Attention, spärliche Muster und niedrig-Rang Approximationen",
                  "nl": "Standaard attention is O(n²) in sequentielengte, aangepakt door lineaire attention, dunne patronen en lage-rang benaderingen"
        },
        {
                  "en": "Attention complexity depends only on model depth",
                  "es": "Complejidad de atención depende solo de profundidad de modelo",
                  "de": "Attention-Komplexität hängt nur von Modelltiefe ab",
                  "nl": "Attention complexiteit hangt alleen af van model diepte"
        },
        {
                  "en": "Attention complexity grows logarithmically with input size",
                  "es": "Complejidad de atención crece logarítmicamente con tamaño de entrada",
                  "de": "Attention-Komplexität wächst logarithmisch mit Eingabegröße",
                  "nl": "Attention complexiteit groeit logaritmisch met input grootte"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training on progressively harder examples, starting from easy tasks to build foundational knowledge before tackling complex ones",
                  "es": "Entrenar en ejemplos progresivamente más difíciles, de tareas fáciles a complejas construyendo conocimiento fundamental",
                  "de": "Training auf progressiv schwereren Beispielen, von einfachen zu komplexen Aufgaben um Wissen aufzubauen",
                  "nl": "Trainen op progressief moeilijkere voorbeelden, van gemakkelijke naar complexe taken om fundamentele kennis op te bouwen"
        },
        {
                  "en": "Teaching models according to academic curricula",
                  "es": "Enseñar modelos según currículos académicos",
                  "de": "Modelle nach akademischen Curricula lehren",
                  "nl": "Modellen onderwijzen volgens academische curricula"
        },
        {
                  "en": "Rotating through different training datasets",
                  "es": "Rotar a través de diferentes conjuntos de datos de entrenamiento",
                  "de": "Durch verschiedene Trainingsdatensätze rotieren",
                  "nl": "Rouleren door verschillende trainingsdatasets"
        },
        {
                  "en": "Following a curriculum of different neural architectures",
                  "es": "Seguir un currículo de diferentes arquitecturas neuronales",
                  "de": "Einem Curriculum verschiedener neuronaler Architekturen folgen",
                  "nl": "Een curriculum volgen van verschillende neurale architecturen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Makes architecture choices continuous and differentiable, enabling gradient-based optimization of network structures",
                  "es": "Hace elecciones de arquitectura continuas y diferenciables, permitiendo optimización basada en gradientes de estructuras de red",
                  "de": "Macht Architekturwahlen kontinuierlich und differenzierbar, ermöglicht gradientenbasierte Optimierung von Netzwerkstrukturen",
                  "nl": "Maakt architectuur keuzes continu en differentieerbaar, maakt gradiënt-gebaseerde optimalisatie van netwerkstructuren mogelijk"
        },
        {
                  "en": "Makes architectures adaptable during training",
                  "es": "Hace arquitecturas adaptables durante entrenamiento",
                  "de": "Macht Architekturen während des Trainings anpassbar",
                  "nl": "Maakt architecturen aanpasbaar tijdens training"
        },
        {
                  "en": "Computes derivatives of architecture parameters",
                  "es": "Calcula derivadas de parámetros de arquitectura",
                  "de": "Berechnet Ableitungen von Architekturparametern",
                  "nl": "Berekent afgeleiden van architectuurparameters"
        },
        {
                  "en": "Differentiates between different architecture types",
                  "es": "Diferencia entre diferentes tipos de arquitectura",
                  "de": "Unterscheidet zwischen verschiedenen Architekturtypen",
                  "nl": "Onderscheidt tussen verschillende architectuurtypen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Networks learn through random chance",
                  "es": "Redes aprenden por azar",
                  "de": "Netzwerke lernen durch Zufall",
                  "nl": "Netwerken leren door toeval"
        },
        {
                  "en": "Only lucky networks achieve high performance",
                  "es": "Solo redes afortunadas logran alto rendimiento",
                  "de": "Nur glückliche Netzwerke erreichen hohe Leistung",
                  "nl": "Alleen gelukkige netwerken behalen hoge prestaties"
        },
        {
                  "en": "Training outcomes depend on lottery-like randomness",
                  "es": "Resultados de entrenamiento dependen de aleatoriedad tipo lotería",
                  "de": "Trainingsergebnisse hängen von lotterieähnlicher Zufälligkeit ab",
                  "nl": "Trainingsresultaten hangen af van loterij-achtige willekeur"
        },
        {
                  "en": "Suggests initialization matters more than architecture, sparse subnetworks can match full network performance when properly initialized",
                  "es": "Sugiere que inicialización importa más que arquitectura, subredes dispersas igualan rendimiento cuando bien inicializadas",
                  "de": "Initialisierung wichtiger als Architektur, spärliche Teilnetzwerke erreichen volle Leistung wenn korrekt initialisiert",
                  "nl": "Initialisatie belangrijker dan architectuur, dunne subnetwerken evenaren volledige prestaties wanneer correct geïnitialiseerd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Changing network architectures for new domains",
                  "es": "Cambiar arquitecturas de red para nuevos dominios",
                  "de": "Netzwerkarchitekturen für neue Domains ändern",
                  "nl": "Netwerkarchitecturen veranderen voor nieuwe domeinen"
        },
        {
                  "en": "Domain-specific customization of hyperparameters",
                  "es": "Personalización específica de dominio de hiperparámetros",
                  "de": "Domain-spezifische Anpassung von Hyperparametern",
                  "nl": "Domein-specifieke aanpassing van hyperparameters"
        },
        {
                  "en": "Techniques to transfer knowledge from source domain to target domain when data distributions differ",
                  "es": "Técnicas para transferir conocimiento de dominio fuente a dominio objetivo cuando distribuciones de datos difieren",
                  "de": "Techniken um Wissen von Quell-Domain zu Ziel-Domain zu übertragen wenn Datenverteilungen unterschiedlich sind",
                  "nl": "Technieken om kennis over te dragen van bron domein naar doel domein wanneer data distributies verschillen"
        },
        {
                  "en": "Adapting models to work in different application domains",
                  "es": "Adaptar modelos para trabajar en diferentes dominios de aplicación",
                  "de": "Modelle anpassen um in verschiedenen Anwendungsbereichen zu funktionieren",
                  "nl": "Modellen aanpassen om te werken in verschillende toepassingsdomeinen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Models optimized for energy efficiency",
                  "es": "Modelos optimizados para eficiencia energética",
                  "de": "Modelle optimiert für Energieeffizienz",
                  "nl": "Modellen geoptimaliseerd voor energie-efficiëntie"
        },
        {
                  "en": "Models that predict energy consumption",
                  "es": "Modelos que predicen consumo de energía",
                  "de": "Modelle die Energieverbrauch vorhersagen",
                  "nl": "Modellen die energieverbruik voorspellen"
        },
        {
                  "en": "Learn to assign energy values to data configurations, with low energy for plausible configurations, without explicit normalization",
                  "es": "Asignan valores de energía a configuraciones, con baja energía para configuraciones plausibles, sin normalización explícita",
                  "de": "Weisen Energiewerte zu Konfigurationen zu, niedrige Energie für plausible Konfigurationen, ohne Normalisierung",
                  "nl": "Kennen energie waarden toe aan configuraties, lage energie voor plausibele configuraties, zonder expliciete normalisatie"
        },
        {
                  "en": "Neural networks powered by energy minimization",
                  "es": "Redes neuronales impulsadas por minimización de energía",
                  "de": "Neuronale Netzwerke angetrieben durch Energieminimierung",
                  "nl": "Neurale netwerken aangedreven door energie minimalisatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ensuring predicted probabilities match actual outcome frequencies, making confidence estimates trustworthy",
                  "es": "Asegurar que probabilidades predichas coincidan con frecuencias reales, haciendo estimaciones de confianza confiables",
                  "de": "Sicherstellen dass Wahrscheinlichkeiten mit tatsächlichen Frequenzen übereinstimmen, macht Schätzungen vertrauenswürdig",
                  "nl": "Ervoor zorgen dat voorspelde waarschijnlijkheden overeenkomen met werkelijke frequenties, maakt schattingen betrouwbaar"
        },
        {
                  "en": "Setting hyperparameters to calibrated settings",
                  "es": "Establecer hiperparámetros a configuraciones calibradas",
                  "de": "Hyperparameter auf kalibrierte Einstellungen setzen",
                  "nl": "Hyperparameters instellen op gekalibreerde instellingen"
        },
        {
                  "en": "Calibrating model weights to standard values",
                  "es": "Calibrar pesos de modelo a valores estándar",
                  "de": "Modellgewichte auf Standardwerte kalibrieren",
                  "nl": "Modelgewichten kalibreren naar standaardwaarden"
        },
        {
                  "en": "Adjusting models to work on calibration datasets",
                  "es": "Ajustar modelos para trabajar en conjuntos de datos de calibración",
                  "de": "Modelle anpassen um auf Kalibrierungsdatensätzen zu funktionieren",
                  "nl": "Modellen aanpassen om te werken op kalibratiedatasets"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Error descends faster in second training epoch",
                  "es": "Error desciende más rápido en segunda época de entrenamiento",
                  "de": "Fehler sinkt schneller in zweiter Trainingsepoche",
                  "nl": "Fout daalt sneller in tweede trainingsepoch"
        },
        {
                  "en": "Test error decreases, increases past interpolation threshold, then decreases again as model capacity grows",
                  "es": "Error de prueba disminuye, aumenta pasado umbral de interpolación, luego disminuye nuevamente mientras capacidad de modelo crece",
                  "de": "Testfehler sinkt, steigt nach Interpolationsschwelle, sinkt dann wieder während Modellkapazität wächst",
                  "nl": "Testfout daalt, stijgt na interpolatie drempel, daalt dan weer naarmate modelcapaciteit groeit"
        },
        {
                  "en": "Models need two descent phases for convergence",
                  "es": "Modelos necesitan dos fases de descenso para convergencia",
                  "de": "Modelle benötigen zwei Abstiegsphasen für Konvergenz",
                  "nl": "Modellen hebben twee descent fases nodig voor convergentie"
        },
        {
                  "en": "Training loss descends twice during optimization",
                  "es": "Pérdida de entrenamiento desciende dos veces durante optimización",
                  "de": "Trainingsverlust sinkt zweimal während Optimierung",
                  "nl": "Trainingsloss daalt twee keer tijdens optimalisatie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tangential connections between neural layers",
                  "es": "Conexiones tangenciales entre capas neuronales",
                  "de": "Tangentiale Verbindungen zwischen neuronalen Schichten",
                  "nl": "Tangentiële verbindingen tussen neurale lagen"
        },
        {
                  "en": "A kernel for computing tangent vectors in neural networks",
                  "es": "Un kernel para computar vectores tangentes en redes neuronales",
                  "de": "Ein Kernel zur Berechnung von Tangentvektoren in neuronalen Netzwerken",
                  "nl": "Een kernel voor het berekenen van raakvectoren in neurale netwerken"
        },
        {
                  "en": "Describes infinite-width neural networks as kernel methods, providing theoretical understanding of training dynamics and generalization",
                  "es": "Describe redes de ancho infinito como métodos kernel, da entendimiento teórico de dinámicas de entrenamiento",
                  "de": "Beschreibt unendlich-breite Netzwerke als Kernel-Methoden, bietet Verständnis von Trainingsdynamik",
                  "nl": "Beschrijft oneindig-brede netwerken als kernel methoden, biedt begrip van trainingsdynamiek en generalisatie"
        },
        {
                  "en": "Theory of neural network curvature",
                  "es": "Teoría de curvatura de redes neuronales",
                  "de": "Theorie der neuronalen Netzwerkkrümmung",
                  "nl": "Theorie van neurale netwerk kromming"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Augments the test dataset with synthetic examples",
                  "es": "Aumenta el conjunto de datos de prueba con ejemplos sintéticos",
                  "de": "Erweitert den Testdatensatz mit synthetischen Beispielen",
                  "nl": "Vergroot de testdataset met synthetische voorbeelden"
        },
        {
                  "en": "Increases test time to allow better predictions",
                  "es": "Aumenta tiempo de prueba para permitir mejores predicciones",
                  "de": "Erhöht Testzeit um bessere Vorhersagen zu ermöglichen",
                  "nl": "Verhoogt testtijd om betere voorspellingen mogelijk te maken"
        },
        {
                  "en": "Applies transformations to test inputs and averages predictions across augmented versions for more robust outputs",
                  "es": "Aplica transformaciones a entradas de prueba y promedia predicciones a través de versiones aumentadas para salidas más robustas",
                  "de": "Wendet Transformationen auf Testeingaben an und mittelt Vorhersagen über augmentierte Versionen für robustere Ausgaben",
                  "nl": "Past transformaties toe op test inputs en gemiddelt voorspellingen over geaugmenteerde versies voor robuustere outputs"
        },
        {
                  "en": "Tests model with augmented architectures",
                  "es": "Prueba modelo con arquitecturas aumentadas",
                  "de": "Testet Modell mit augmentierten Architekturen",
                  "nl": "Test model met geaugmenteerde architecturen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Solves ordinary differential equations using neural networks",
                  "es": "Resuelve ecuaciones diferenciales ordinarias usando redes neuronales",
                  "de": "Löst gewöhnliche Differentialgleichungen mit neuronalen Netzwerken",
                  "nl": "Lost gewone differentiaalvergelijkingen op met neurale netwerken"
        },
        {
                  "en": "Models continuous-depth networks as differential equations, enabling memory-efficient training and adaptive computation",
                  "es": "Modela redes de profundidad continua como ecuaciones diferenciales, permitiendo entrenamiento eficiente en memoria y computación adaptiva",
                  "de": "Modelliert kontinuierliche-Tiefe Netzwerke als Differentialgleichungen, ermöglicht speichereffizientes Training und adaptive Berechnung",
                  "nl": "Modelleert continue-diepte netwerken als differentiaalvergelijkingen, maakt geheugenefficiënte training en adaptieve berekening mogelijk"
        },
        {
                  "en": "Ordinary differential equations for neural activation",
                  "es": "Ecuaciones diferenciales ordinarias para activación neuronal",
                  "de": "Gewöhnliche Differentialgleichungen für neuronale Aktivierung",
                  "nl": "Gewone differentiaalvergelijkingen voor neurale activatie"
        },
        {
                  "en": "Neural networks with differential learning rates",
                  "es": "Redes neuronales con tasas de aprendizaje diferenciales",
                  "de": "Neuronale Netzwerke mit differentiellen Lernraten",
                  "nl": "Neurale netwerken met differentiële leersnelheden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gap in semantic segmentation accuracy",
                  "es": "Brecha en precisión de segmentación semántica",
                  "de": "Lücke in semantischer Segmentierungsgenauigkeit",
                  "nl": "Kloof in semantische segmentatie nauwkeurigheid"
        },
        {
                  "en": "Gap between low-level visual features and high-level semantic understanding, bridged by deep hierarchical representations",
                  "es": "Brecha entre características visuales de bajo nivel y comprensión semántica, puenteada por representaciones profundas",
                  "de": "Lücke zwischen niedrig-Level Features und hoch-Level Verstehen, überbrückt durch hierarchische Repräsentationen",
                  "nl": "Kloof tussen laag-niveau kenmerken en hoog-niveau begrip, overbrugd door diepe hiërarchische representaties"
        },
        {
                  "en": "Missing semantic annotations in datasets",
                  "es": "Anotaciones semánticas faltantes en conjuntos de datos",
                  "de": "Fehlende semantische Annotationen in Datensätzen",
                  "nl": "Ontbrekende semantische annotaties in datasets"
        },
        {
                  "en": "Difference between predicted and actual semantics",
                  "es": "Diferencia entre semántica predicha y real",
                  "de": "Unterschied zwischen vorhergesagter und tatsächlicher Semantik",
                  "nl": "Verschil tussen voorspelde en werkelijke semantiek"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Displaying attention computation processes",
                  "es": "Mostrar procesos de computación de atención",
                  "de": "Attention-Berechnungsprozesse anzeigen",
                  "nl": "Attention berekeningsprocessen weergeven"
        },
        {
                  "en": "Visualizing attention mechanisms in network diagrams",
                  "es": "Visualizar mecanismos de atención en diagramas de red",
                  "de": "Attention-Mechanismen in Netzwerkdiagrammen visualisieren",
                  "nl": "Attention mechanismen visualiseren in netwerkdiagrammen"
        },
        {
                  "en": "Creating visual representations of attention weights",
                  "es": "Crear representaciones visuales de pesos de atención",
                  "de": "Visuelle Darstellungen von Attention-Gewichten erstellen",
                  "nl": "Visuele representaties maken van attention gewichten"
        },
        {
                  "en": "Understanding what models attend to using heatmaps, rollout methods, and attention flow analysis",
                  "es": "Entender a qué atienden modelos usando mapas de calor, métodos de rollout y análisis de flujo de atención",
                  "de": "Verstehen worauf Modelle achten mit Heatmaps, Rollout-Methoden und Attention-Flow-Analyse",
                  "nl": "Begrijpen waar modellen naar kijken met heatmaps, rollout methoden en attention flow analyse"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pruning training data to speed up learning",
                  "es": "Podar datos de entrenamiento para acelerar aprendizaje",
                  "de": "Trainingsdaten beschneiden um Lernen zu beschleunigen",
                  "nl": "Trainingsdata snoeien om leren te versnellen"
        },
        {
                  "en": "Compresses model files for efficient storage",
                  "es": "Comprime archivos de modelo para almacenamiento eficiente",
                  "de": "Komprimiert Modelldateien für effiziente Speicherung",
                  "nl": "Comprimeert modelbestanden voor efficiënte opslag"
        },
        {
                  "en": "Systematically removes unimportant weights or neurons based on magnitude, gradient, or second-order information while fine-tuning",
                  "es": "Remueve sistemáticamente pesos o neuronas no importantes basado en magnitud, gradiente o información de segundo orden mientras afina",
                  "de": "Entfernt systematisch unwichtige Gewichte oder Neuronen basierend auf Magnitude, Gradient oder zweiter Ordnung während Fine-Tuning",
                  "nl": "Verwijdert systematisch onbelangrijke gewichten of neuronen gebaseerd op magnitude, gradiënt of tweede-orde informatie tijdens fine-tuning"
        },
        {
                  "en": "Reduces model complexity by removing layers",
                  "es": "Reduce complejidad de modelo removiendo capas",
                  "de": "Reduziert Modellkomplexität durch Entfernen von Schichten",
                  "nl": "Vermindert modelcomplexiteit door lagen te verwijderen"
        }
        ],
        correct: 2,
        explanation: {
