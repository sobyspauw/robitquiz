    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Learning representations from data without human-labeled targets by creating supervision signals from the data itself",
                  "es": "Aprender representaciones de datos sin objetivos etiquetados por humanos creando señales de supervisión de los datos mismos",
                  "de": "Repräsentationen aus Daten ohne menschlich beschriftete Ziele lernen durch Erstellung von Überwachungssignalen aus den Daten selbst",
                  "nl": "Representaties leren uit data zonder door mensen gelabelde doelen door supervisiesignalen te creëren uit de data zelf"
        },
        {
                  "en": "Models supervising themselves during training",
                  "es": "Modelos supervisándose a sí mismos durante el entrenamiento",
                  "de": "Modelle die sich während des Trainings selbst überwachen",
                  "nl": "Modellen die zichzelf superviseren tijdens training"
        },
        {
                  "en": "Automated supervision of model training",
                  "es": "Supervisión automatizada de entrenamiento de modelos",
                  "de": "Automatisierte Überwachung des Modelltrainings",
                  "nl": "Geautomatiseerde supervisie van modeltraining"
        },
        {
                  "en": "Learning that doesn't require any supervision",
                  "es": "Aprendizaje que no requiere ninguna supervisión",
                  "de": "Lernen das keine Überwachung erfordert",
                  "nl": "Leren dat geen supervisie vereist"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Networks that create visual graphs and charts",
                  "es": "Redes que crean gráficos y tablas visuales",
                  "de": "Netzwerke die visuelle Graphiken und Diagramme erstellen",
                  "nl": "Netwerken die visuele grafieken en diagrammen maken"
        },
        {
                  "en": "Networks that graph neural activity patterns",
                  "es": "Redes que grafican patrones de actividad neuronal",
                  "de": "Netzwerke die neuronale Aktivitätsmuster grafisch darstellen",
                  "nl": "Netwerken die neurale activiteitspatronen in grafieken weergeven"
        },
        {
                  "en": "Neural networks designed for graph-structured data like social networks, molecules, and knowledge graphs",
                  "es": "Redes neuronales diseñadas para datos estructurados en grafos como redes sociales, moléculas y grafos de conocimiento",
                  "de": "Neuronale Netzwerke entworfen für graphstrukturierte Daten wie soziale Netzwerke, Moleküle und Wissensgraphen",
                  "nl": "Neurale netwerken ontworpen voor graafgestructureerde data zoals sociale netwerken, moleculen en kennisgrafen"
        },
        {
                  "en": "Neural networks for processing mathematical graphs",
                  "es": "Redes neuronales para procesar gráficos matemáticos",
                  "de": "Neuronale Netzwerke für mathematische Graphen",
                  "nl": "Neurale netwerken voor het verwerken van wiskundige grafieken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Inferring what causes learning to happen",
                  "es": "Inferir qué causa que ocurra el aprendizaje",
                  "de": "Ableiten was Lernen verursacht",
                  "nl": "Afleiden wat leren veroorzaakt"
        },
        {
                  "en": "Inferring the causes of neural network failures",
                  "es": "Inferir las causas de fallas de redes neuronales",
                  "de": "Ursachen von neuronalen Netzwerkfehlern ableiten",
                  "nl": "De oorzaken van neurale netwerkfouten afleiden"
        },
        {
                  "en": "Understanding cause-and-effect relationships rather than just correlations for robust decision making",
                  "es": "Entender relaciones causa-efecto en lugar de solo correlaciones para toma de decisiones robusta",
                  "de": "Ursache-Wirkung-Beziehungen verstehen anstatt nur Korrelationen für robuste Entscheidungsfindung",
                  "nl": "Oorzaak-gevolg relaties begrijpen in plaats van alleen correlaties voor robuuste besluitvorming"
        },
        {
                  "en": "Finding causal relationships in training data",
                  "es": "Encontrar relaciones causales en datos de entrenamiento",
                  "de": "Kausale Beziehungen in Trainingsdaten finden",
                  "nl": "Causale relaties vinden in trainingsdata"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using symbols to represent neural network weights",
                  "es": "Usar símbolos para representar pesos de redes neuronales",
                  "de": "Symbole zur Darstellung von neuronalen Netzwerkgewichten verwenden",
                  "nl": "Symbolen gebruiken om neurale netwerkgewichten te representeren"
        },
        {
                  "en": "Integrating deep learning's pattern recognition with symbolic reasoning for interpretable and logical AI",
                  "es": "Integrar reconocimiento de patrones de aprendizaje profundo con razonamiento simbólico para IA interpretable y lógica",
                  "de": "Mustererkennung von Deep Learning mit symbolischem Reasoning für interpretierbare und logische KI integrieren",
                  "nl": "Patroonherkenning van deep learning integreren met symbolisch redeneren voor interpreteerbare en logische AI"
        },
        {
                  "en": "Creating neural networks that process symbolic mathematics",
                  "es": "Crear redes neuronales que procesan matemáticas simbólicas",
                  "de": "Neuronale Netzwerke erstellen die symbolische Mathematik verarbeiten",
                  "nl": "Neurale netwerken maken die symbolische wiskunde verwerken"
        },
        {
                  "en": "Symbolic representation of neural network architectures",
                  "es": "Representación simbólica de arquitecturas de redes neuronales",
                  "de": "Symbolische Darstellung neuronaler Netzwerkarchitekturen",
                  "nl": "Symbolische representatie van neurale netwerkarchitecturen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning about federal government policies",
                  "es": "Aprender sobre políticas del gobierno federal",
                  "de": "Über Bundesregierungspolitik lernen",
                  "nl": "Leren over federale overheidsbeleid"
        },
        {
                  "en": "Training models across distributed devices without centralizing data to preserve privacy and reduce communication costs",
                  "es": "Entrenar modelos a través de dispositivos distribuidos sin centralizar datos para preservar privacidad y reducir costos de comunicación",
                  "de": "Modelle über verteilte Geräte trainieren ohne Daten zu zentralisieren um Privatsphäre zu bewahren und Kommunikationskosten zu reduzieren",
                  "nl": "Modellen trainen over gedistribueerde apparaten zonder data te centraliseren om privacy te behouden en communicatiekosten te verminderen"
        },
        {
                  "en": "Federating learning resources across institutions",
                  "es": "Federar recursos de aprendizaje entre instituciones",
                  "de": "Lernressourcen zwischen Institutionen föderieren",
                  "nl": "Leerbronnen federeren tussen instellingen"
        },
        {
                  "en": "Creating federations of different AI models",
                  "es": "Crear federaciones de diferentes modelos de IA",
                  "de": "Föderationen verschiedener KI-Modelle erstellen",
                  "nl": "Federaties van verschillende AI modellen maken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "BERT processes text in both forward and backward directions sequentially",
                  "es": "BERT procesa texto en direcciones hacia adelante y hacia atrás secuencialmente",
                  "de": "BERT verarbeitet Text sowohl vorwärts als auch rückwärts sequenziell",
                  "nl": "BERT verwerkt tekst zowel voorwaarts als achterwaarts sequentieel"
        },
        {
                  "en": "BERT uses masked language modeling to learn bidirectional representations by predicting masked tokens using both left and right context",
                  "es": "BERT usa modelado enmascarado para aprender representaciones bidireccionales prediciendo tokens con contexto izquierdo y derecho",
                  "de": "BERT verwendet Masked Modeling um bidirektionale Repräsentationen zu lernen durch Vorhersage mit linkem und rechtem Kontext",
                  "nl": "BERT gebruikt masked modeling om bidirectionele representaties te leren door tokens te voorspellen met linker en rechter context"
        },
        {
                  "en": "BERT uses two separate encoders for left-to-right and right-to-left processing",
                  "es": "BERT usa dos codificadores separados para procesamiento izquierda-a-derecha y derecha-a-izquierda",
                  "de": "BERT verwendet zwei separate Encoder für Links-nach-Rechts und Rechts-nach-Links Verarbeitung",
                  "nl": "BERT gebruikt twee aparte encoders voor links-naar-rechts en rechts-naar-links verwerking"
        },
        {
                  "en": "BERT alternates between forward and backward passes during training",
                  "es": "BERT alterna entre pasadas hacia adelante y hacia atrás durante entrenamiento",
                  "de": "BERT wechselt zwischen Vorwärts- und Rückwärtsdurchläufen während des Trainings",
                  "nl": "BERT wisselt tussen voorwaartse en achterwaartse doorlopen tijdens training"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combines multiple transformer encoders in parallel",
                  "es": "Combina múltiples codificadores transformer en paralelo",
                  "de": "Kombiniert mehrere Transformer-Encoder parallel",
                  "nl": "Combineert meerdere transformer encoders parallel"
        },
        {
                  "en": "Uses generative adversarial training with transformers",
                  "es": "Usa entrenamiento generativo adversario con transformers",
                  "de": "Verwendet generatives adversariales Training mit Transformers",
                  "nl": "Gebruikt generatieve adversariale training met transformers"
        },
        {
                  "en": "Uses autoregressive language modeling with decoder architecture, enabling unsupervised pre-training followed by task-specific fine-tuning",
                  "es": "Usa modelado autoregresivo con decodificador transformer, permite pre-entrenamiento no supervisado seguido de fine-tuning",
                  "de": "Verwendet autoregressives Modeling mit Decoder-Architektur, ermöglicht unüberwachtes Vortraining gefolgt von Fine-Tuning",
                  "nl": "Gebruikt autoregressief modelleren met decoder architectuur, maakt ongesuperviseerde pre-training mogelijk gevolgd door fine-tuning"
        },
        {
                  "en": "Pre-trains on multiple languages simultaneously",
                  "es": "Pre-entrena en múltiples idiomas simultáneamente",
                  "de": "Trainiert gleichzeitig auf mehreren Sprachen vor",
                  "nl": "Pre-traint op meerdere talen tegelijkertijd"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Transfers knowledge between 5 different transformer models",
                  "es": "Transfiere conocimiento entre 5 modelos transformer diferentes",
                  "de": "Überträgt Wissen zwischen 5 verschiedenen Transformer-Modellen",
                  "nl": "Draagt kennis over tussen 5 verschillende transformer modellen"
        },
        {
                  ...
                  "es": "Trata todas las tareas NLP como texto-a-texto, usa arquitectura encoder-decoder con formato unificado y prefijos de tarea",
                  "de": "Behandelt alle NLP-Aufgaben als Text-zu-Text, verwendet Encoder-Decoder mit einheitlichem Format und Aufgabenpräfixen",
                  "nl": "Behandelt alle NLP taken als tekst-naar-tekst, gebruikt encoder-decoder architectuur met uniform formaat en taak prefixen"
        },
        {
                  "en": "Uses 5 layers of transformer blocks for better performance",
                  "es": "Usa 5 capas de bloques transformer para mejor rendimiento",
                  "de": "Verwendet 5 Schichten von Transformer-Blöcken für bessere Leistung",
                  "nl": "Gebruikt 5 lagen van transformer blokken voor betere prestaties"
        },
        {
                  "en": "Trains on text for 5 different time periods",
                  "es": "Entrena en texto por 5 períodos de tiempo diferentes",
                  "de": "Trainiert auf Text für 5 verschiedene Zeitperioden",
                  "nl": "Traint op tekst voor 5 verschillende tijdsperiodes"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Divides images into patches, linearly embeds them, adds positional encoding, and processes through standard transformer encoder layers",
                  "es": "Divide imágenes en parches, los incrusta linealmente, agrega codificación posicional y procesa a través de capas transformer",
                  "de": "Teilt Bilder in Patches, bettet sie linear ein, fügt Positionskodierung hinzu, verarbeitet durch Transformer-Schichten",
                  "nl": "Verdeelt afbeeldingen in patches, insluit ze lineair, voegt positional encoding toe, verwerkt door transformer encoder lagen"
        },
        {
                  "en": "Applies convolutional layers before transformer processing",
                  "es": "Aplica capas convolucionales antes del procesamiento transformer",
                  "de": "Wendet Faltungsschichten vor Transformer-Verarbeitung an",
                  "nl": "Past convolutionele lagen toe voor transformer verwerking"
        },
        {
                  "en": "Uses transformers to generate synthetic images",
                  "es": "Usa transformers para generar imágenes sintéticas",
                  "de": "Verwendet Transformers um synthetische Bilder zu generieren",
                  "nl": "Gebruikt transformers om synthetische afbeeldingen te genereren"
        },
        {
                  "en": "Transforms images into text descriptions for processing",
                  "es": "Transforma imágenes en descripciones de texto para procesamiento",
                  "de": "Transformiert Bilder in Textbeschreibungen für Verarbeitung",
                  "nl": "Transformeert afbeeldingen naar tekstbeschrijvingen voor verwerking"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creates clips of video content with text descriptions",
                  "es": "Crea clips de contenido de video con descripciones de texto",
                  "de": "Erstellt Clips von Videoinhalten mit Textbeschreibungen",
                  "nl": "Maakt clips van video content met tekstbeschrijvingen"
        },
        {
                  "en": "Pre-processes images by clipping them to standard sizes",
                  "es": "Pre-procesa imágenes recortándolas a tamaños estándar",
                  "de": "Vorverarbeitet Bilder durch Zuschneiden auf Standardgrößen",
                  "nl": "Pre-verwerkt afbeeldingen door ze bij te knippen naar standaardformaten"
        },
        {
                  "en": "Jointly trains image and text encoders using contrastive learning to align visual and textual representations in a shared embedding space",
                  "es": "Entrena codificadores de imagen y texto usando aprendizaje contrastivo para alinear representaciones en espacio compartido",
                  "de": "Trainiert Bild- und Text-Encoder mit kontrastivem Lernen um Repräsentationen in geteiltem Embedding-Raum auszurichten",
                  "nl": "Traint beeld- en tekst encoders met contrastief leren om representaties uit te lijnen in gedeelde embedding ruimte"
        },
        {
                  "en": "Clips images and text together for joint processing",
                  "es": "Recorta imágenes y texto juntos para procesamiento conjunto",
                  "de": "Schneidet Bilder und Text für gemeinsame Verarbeitung zusammen",
                  "nl": "Knipt afbeeldingen en tekst samen voor gezamenlijke verwerking"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They use different transformer architectures",
                  "es": "Usan diferentes arquitecturas transformer",
                  "de": "Sie verwenden verschiedene Transformer-Architekturen",
                  "nl": "Ze gebruiken verschillende transformer architecturen"
        },
        {
                  "en": "Each is trained on different types of data",
                  "es": "Cada uno se entrena en diferentes tipos de datos",
                  "de": "Jeder wird auf verschiedenen Datentypen trainiert",
                  "nl": "Elk wordt getraind op verschillende datatypes"
        },
        {
                  "en": "Each version doubles the number of parameters",
                  "es": "Cada versión duplica el número de parámetros",
                  "de": "Jede Version verdoppelt die Anzahl der Parameter",
                  "nl": "Elke versie verdubbelt het aantal parameters"
        },
        {
                  "en": "GPT-3 (175B parameters) showed emergent abilities, GPT-3.5 added instruction following via RLHF, GPT-4 became multimodal with improved reasoning",
                  "es": "GPT-3 (175B) mostró habilidades emergentes, GPT-3.5 agregó seguimiento de instrucciones via RLHF, GPT-4 multimodal con razonamiento mejorado",
                  "de": "GPT-3 (175B) zeigte emergente Fähigkeiten, GPT-3.5 fügte Instruktionsbefolgung via RLHF hinzu, GPT-4 wurde multimodal",
                  "nl": "GPT-3 (175B) toonde emergente vaardigheden, GPT-3.5 voegde instructie volgen via RLHF toe, GPT-4 werd multimodaal met verbeterd redeneren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "BERT with robotic control capabilities",
                  "es": "BERT con capacidades de control robótico",
                  "de": "BERT mit robotischen Kontrollkapazitäten",
                  "nl": "BERT met robotische besturingscapaciteiten"
        },
        {
                  "en": "BERT trained specifically for robotic applications",
                  "es": "BERT entrenado específicamente para aplicaciones robóticas",
                  "de": "BERT speziell für robotische Anwendungen trainiert",
                  "nl": "BERT getraind specifiek voor robotica toepassingen"
        },
        {
                  "en": "Robustly optimized BERT with longer training, larger batches, more data, removed NSP task, and dynamic masking",
                  "es": "BERT optimizado robustamente con entrenamiento más largo, lotes más grandes, más datos, tarea NSP removida, y enmascarado dinámico",
                  "de": "Robust optimiertes BERT mit längerem Training, größeren Batches, mehr Daten, entfernter NSP-Aufgabe und dynamischem Maskieren",
                  "nl": "Robuust geoptimaliseerde BERT met langere training, grotere batches, meer data, verwijderde NSP taak, en dynamische maskering"
        },
        {
                  "en": "BERT with robust error handling mechanisms",
                  "es": "BERT con mecanismos robustos de manejo de errores",
                  "de": "BERT mit robusten Fehlerbehandlungsmechanismen",
                  "nl": "BERT met robuuste foutafhandelingsmechanismen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses convolutional neural networks for text-to-image generation",
                  "es": "Usa redes neuronales convolucionales para generación texto-a-imagen",
                  "de": "Verwendet Faltungsneuronale Netzwerke für Text-zu-Bild-Generierung",
                  "nl": "Gebruikt convolutionele neurale netwerken voor tekst-naar-beeld generatie"
        },
        {
                  "en": "Generates images by manipulating existing image databases",
                  "es": "Genera imágenes manipulando bases de datos de imágenes existentes",
                  "de": "Generiert Bilder durch Manipulation bestehender Bilddatenbanken",
                  "nl": "Genereert afbeeldingen door bestaande beelddatabases te manipuleren"
        },
        {
                  "en": "Uses transformer decoder architecture to generate image tokens autoregressively from text prompts, treating images as sequences of discrete tokens",
                  "es": "Usa decodificador transformer para generar tokens de imagen autoregresivamente de prompts, trata imágenes como secuencias de tokens",
                  "de": "Verwendet Decoder um Bild-Tokens autoregressiv aus Prompts zu generieren, behandelt Bilder als Sequenzen diskreter Tokens",
                  "nl": "Gebruikt decoder architectuur om beeldtokens autoregressief te genereren uit prompts, behandelt afbeeldingen als sequenties tokens"
        },
        {
                  "en": "Combines DALL (a painting robot) with E (Einstein's equations)",
                  "es": "Combina DALL (un robot de pintura) con E (ecuaciones de Einstein)",
                  "de": "Kombiniert DALL (ein Malroboter) mit E (Einsteins Gleichungen)",
                  "nl": "Combineert DALL (een schilderrobot) met E (Einstein's vergelijkingen)"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses extra-large transformer models",
                  "es": "Usa modelos transformer extra-grandes",
                  "de": "Verwendet extra-große Transformer-Modelle",
                  "nl": "Gebruikt extra-grote transformer modellen"
        },
        {
                  "en": "Processes extremely long sequences by chunking",
                  "es": "Procesa secuencias extremadamente largas mediante fragmentación",
                  "de": "Verarbeitet extrem lange Sequenzen durch Chunking",
                  "nl": "Verwerkt extreem lange sequenties door chunking"
        },
        {
                  "en": "Extends transformer width rather than length",
                  "es": "Extiende ancho de transformer en lugar de longitud",
                  "de": "Erweitert Transformer-Breite anstatt Länge",
                  "nl": "Breidt transformer breedte uit in plaats van lengte"
        },
        {
                  "en": "Introduces recurrence mechanism with segment-level recurrence and relative positional encoding to capture longer dependencies",
                  "es": "Introduce mecanismo de recurrencia con recurrencia segmento y codificación posicional relativa para capturar dependencias largas",
                  "de": "Führt Rekurrenzmechanismus mit Segment-Rekurrenz und relativer Positionskodierung ein um längere Abhängigkeiten zu erfassen",
                  "nl": "Introduceert recurrentie mechanisme met segment-recurrentie en relatieve positional encoding om langere afhankelijkheden vast te leggen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses electronic circuits for faster computation",
                  "es": "Usa circuitos electrónicos para computación más rápida",
                  "de": "Verwendet elektronische Schaltkreise für schnellere Berechnung",
                  "nl": "Gebruikt elektronische circuits voor snellere berekening"
        },
        {
                  "en": "Uses electrical connections between transformer layers",
                  "es": "Usa conexiones eléctricas entre capas transformer",
                  "de": "Verwendet elektrische Verbindungen zwischen Transformer-Schichten",
                  "nl": "Gebruikt elektrische verbindingen tussen transformer lagen"
        },
        {
                  "en": "Uses replaced token detection where a generator creates plausible replacements and the discriminator learns to identify which tokens were replaced",
                  "es": "Usa detección de tokens reemplazados donde generador crea reemplazos y discriminador identifica tokens reemplazados",
                  "de": "Verwendet Ersetzt-Token-Erkennung wo Generator Ersetzungen erstellt und Discriminator lernt welche Tokens ersetzt wurden",
                  "nl": "Gebruikt vervangen token detectie waarbij generator vervangingen maakt en discriminator leert welke tokens vervangen zijn"
        },
        {
                  "en": "Generates electricity-related text content",
                  "es": "Genera contenido de texto relacionado con electricidad",
                  "de": "Generiert elektrizitätsbezogenen Textinhalt",
                  "nl": "Genereert elektriciteit-gerelateerde tekstinhoud"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reveals what linguistic patterns and relationships the model has learned, showing syntactic and semantic dependencies across different heads and layers",
                  "es": "Revela qué patrones lingüísticos y relaciones aprendió el modelo, muestra dependencias sintácticas y semánticas en capas",
                  "de": "Enthüllt welche linguistischen Muster das Modell lernte, zeigt syntaktische und semantische Abhängigkeiten über Heads",
                  "nl": "Onthult welke linguïstische patronen het model leerde, toont syntactische en semantische afhankelijkheden over heads en lagen"
        },
        {
                  "en": "Shows the visual appearance of attention mechanisms",
                  "es": "Muestra la apariencia visual de mecanismos de atención",
                  "de": "Zeigt das visuelle Erscheinungsbild von Attention-Mechanismen",
                  "nl": "Toont het visuele uiterlijk van attention mechanismen"
        },
        {
                  "en": "Provides attention-based user interfaces",
                  "es": "Proporciona interfaces de usuario basadas en atención",
                  "de": "Bietet aufmerksamkeitsbasierte Benutzeroberflächen",
                  "nl": "Biedt attention-gebaseerde gebruikersinterfaces"
        },
        {
                  "en": "Creates visual attention maps for computer vision",
                  "es": "Crea mapas de atención visual para visión por computadora",
                  "de": "Erstellt visuelle Attention-Karten für Computer Vision",
                  "nl": "Maakt visuele attention maps voor computer vision"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses encoder-decoder architecture with bidirectional encoder and autoregressive decoder, trained with denoising objective on corrupted text",
                  "es": "Usa arquitectura encoder-decoder con encoder bidireccional y decoder autoregresivo, entrenado con denoising en texto corrupto",
                  "de": "Verwendet Encoder-Decoder mit bidirektionalem Encoder und autoregressivem Decoder, trainiert mit Denoising auf beschädigtem Text",
                  "nl": "Gebruikt encoder-decoder met bidirectionele encoder en autoregressieve decoder, getraind met denoising op beschadigde tekst"
        },
        {
                  "en": "Combines BERT and GPT architectures in parallel",
                  "es": "Combina arquitecturas BERT y GPT en paralelo",
                  "de": "Kombiniert BERT- und GPT-Architekturen parallel",
                  "nl": "Combineert BERT en GPT architecturen parallel"
        },
        {
                  "en": "Alternates between bidirectional and autoregressive training",
                  "es": "Alterna entre entrenamiento bidireccional y autoregresivo",
                  "de": "Wechselt zwischen bidirektionalem und autoregressivem Training",
                  "nl": "Wisselt tussen bidirectionele en autoregressieve training"
        },
        {
                  "en": "Uses bart (a type of neural activation) for better performance",
                  "es": "Usa bart (un tipo de activación neuronal) para mejor rendimiento",
                  "de": "Verwendet bart (eine Art neuronaler Aktivierung) für bessere Leistung",
                  "nl": "Gebruikt bart (een type neurale activatie) voor betere prestaties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fine-tuning works on small models while prompts work on large models",
                  "es": "Ajuste fino funciona en modelos pequeños mientras prompts funcionan en modelos grandes",
                  "de": "Fine-Tuning funktioniert bei kleinen Modellen während Prompts bei großen Modellen funktionieren",
                  "nl": "Fine-tuning werkt op kleine modellen terwijl prompts werken op grote modellen"
        },
        {
                  "en": "Fine-tuning updates model parameters for specific tasks, while prompt-based learning uses designed prompts to elicit desired behavior without updates",
                  "es": "Fine-tuning actualiza parámetros para tareas, aprendizaje basado en prompts usa prompts para provocar comportamiento sin actualizaciones",
                  "de": "Fine-Tuning aktualisiert Parameter für Aufgaben, Prompt-Lernen verwendet Prompts um Verhalten ohne Updates hervorzurufen",
                  "nl": "Fine-tuning werkt parameters bij voor taken, prompt-leren gebruikt prompts om gedrag op te roepen zonder updates"
        },
        {
                  "en": "Fine-tuning requires more data while prompts require less data",
                  "es": "Ajuste fino requiere más datos mientras prompts requieren menos datos",
                  "de": "Fine-Tuning erfordert mehr Daten während Prompts weniger Daten erfordern",
                  "nl": "Fine-tuning vereist meer data terwijl prompts minder data vereisen"
        },
        {
                  "en": "Fine-tuning is faster while prompt-based learning is more accurate",
                  "es": "Ajuste fino es más rápido mientras aprendizaje basado en prompts es más preciso",
                  "de": "Fine-Tuning ist schneller während Prompt-basiertes Lernen genauer ist",
                  "nl": "Fine-tuning is sneller terwijl prompt-gebaseerd leren nauwkeuriger is"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mathematical laws for scaling up neural networks",
                  "es": "Leyes matemáticas para escalar redes neuronales",
                  "de": "Mathematische Gesetze für die Skalierung neuronaler Netzwerke",
                  "nl": "Wiskundige wetten voor het opschalen van neurale netwerken"
        },
        {
                  "en": "Rules for determining optimal model architectures",
                  "es": "Reglas para determinar arquitecturas de modelo óptimas",
                  "de": "Regeln zur Bestimmung optimaler Modellarchitekturen",
                  "nl": "Regels voor het bepalen van optimale modelarchitecturen"
        },
        {
                  "en": "Predict model performance based on model size, dataset size, and compute budget, showing power-law relationships between scale and capabilities",
                  "es": "Predicen rendimiento basado en tamaño de modelo, datos y cómputo, muestran relaciones de ley de potencia entre escala y capacidades",
                  "de": "Sagen Leistung basierend auf Modellgröße, Daten und Compute voraus, zeigen Potenzgesetz-Beziehungen zwischen Skala und Fähigkeiten",
                  "nl": "Voorspellen prestaties gebaseerd op modelgrootte, datasetgrootte en compute, tonen machtwet relaties tussen schaal en capaciteiten"
        },
        {
                  "en": "Legal regulations governing the scale of AI models",
                  "es": "Regulaciones legales que gobiernan la escala de modelos de IA",
                  "de": "Rechtliche Vorschriften für die Skalierung von KI-Modellen",
                  "nl": "Juridische regelgeving voor de schaal van AI modellen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Foundation models are trained on broad data to serve as adaptable bases for multiple downstream tasks through fine-tuning or prompting",
                  "es": "Los modelos fundacionales se entrenan en datos amplios para servir como bases adaptables para tareas mediante fine-tuning o prompting",
                  "de": "Foundation Models werden auf breiten Daten trainiert als anpassbare Grundlagen für Aufgaben durch Fine-Tuning oder Prompting",
                  "nl": "Foundation models worden getraind op brede data als aanpasbare basis voor downstream taken door fine-tuning of prompting"
        },
        {
                  "en": "Foundation models require less computational resources",
                  "es": "Los modelos fundacionales requieren menos recursos computacionales",
                  "de": "Foundation Models benötigen weniger Rechenressourcen",
                  "nl": "Foundation models vereisen minder computationele bronnen"
        },
        {
                  "en": "Foundation models are only used for computer vision tasks",
                  "es": "Los modelos fundacionales solo se usan para tareas de visión por computadora",
                  "de": "Foundation Models werden nur für Computer Vision Aufgaben verwendet",
                  "nl": "Foundation models worden alleen gebruikt voor computer vision taken"
        },
        {
                  "en": "Foundation models can only be trained from scratch",
                  "es": "Los modelos fundacionales solo pueden entrenarse desde cero",
                  "de": "Foundation Models können nur von Grund auf trainiert werden",
                  "nl": "Foundation models kunnen alleen vanaf nul getraind worden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Attention-based static vectors",
                  "es": "Vectores estáticos basados en atención",
                  "de": "Aufmerksamkeitsbasierte statische Vektoren",
                  "nl": "Aandacht-gebaseerde statische vectoren"
        },
        {
                  "en": "Character-level tokenization",
                  "es": "Tokenización a nivel de carácter",
                  "de": "Tokenisierung auf Zeichenebene",
                  "nl": "Tokenisatie op karakterniveau"
        },
        {
                  "en": "Transformer architecture",
                  "es": "Arquitectura Transformer",
                  "de": "Transformer-Architektur",
                  "nl": "Transformer-architectuur"
        },
        {
                  "en": "Context-dependent embeddings from bidirectional LSTM",
                  "es": "Embeddings dependientes del contexto desde LSTM bidireccional",
                  "de": "Kontextabhängige Embeddings aus bidirektionalem LSTM",
                  "nl": "Context-afhankelijke embeddings van bidirectionele LSTM"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Improves training stability",
                  "es": "Mejora estabilidad del entrenamiento",
                  "de": "Verbessert Trainingsstabilität",
                  "nl": "Verbetert trainingsstabiliteit"
        },
        {
                  "en": "Enables backpropagation through discrete sampling",
                  "es": "Permite retropropagación a través de muestreo discreto",
                  "de": "Ermöglicht Backpropagation durch diskretes Sampling",
                  "nl": "Maakt backpropagation mogelijk door discrete sampling"
        },
        {
                  "en": "Prevents mode collapse",
                  "es": "Previene colapso de modos",
                  "de": "Verhindert Moduskollaps",
                  "nl": "Voorkomt mode collapse"
        },
        {
                  "en": "Reduces model complexity",
                  "es": "Reduce complejidad del modelo",
                  "de": "Reduziert Modellkomplexität",
                  "nl": "Vermindert modelcomplexiteit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "NAS only works with CNNs",
                  "es": "NAS solo funciona con CNNs",
                  "de": "NAS funktioniert nur mit CNNs",
                  "nl": "NAS werkt alleen met CNNs"
        },
        {
                  "en": "NAS is always faster to compute",
                  "es": "NAS siempre es más rápido de calcular",
                  "de": "NAS ist immer schneller zu berechnen",
                  "nl": "NAS is altijd sneller te berekenen"
        },
        {
                  "en": "NAS requires no training data",
                  "es": "NAS no requiere datos de entrenamiento",
                  "de": "NAS benötigt keine Trainingsdaten",
                  "nl": "NAS vereist geen trainingsdata"
        },
        {
                  "en": "NAS searches over network topology, not just parameter values",
                  "es": "NAS busca sobre topología de red, no solo valores de parámetros",
                  "de": "NAS sucht über Netzwerktopologie, nicht nur Parameterwerte",
                  "nl": "NAS zoekt over netwerktopologie, niet alleen parameterwaarden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses more training data",
                  "es": "Usa más datos de entrenamiento",
                  "de": "Verwendet mehr Trainingsdaten",
                  "nl": "Gebruikt meer trainingsdata"
        },
        {
                  "en": "Permutation language modeling captures all factorization orders",
                  "es": "Modelado de lenguaje por permutación captura todos los órdenes de factorización",
                  "de": "Permutations-Sprachmodellierung erfasst alle Faktorisierungsreihenfolgen",
                  "nl": "Permutatie-taalmodellering vangt alle factorisatieorders"
        },
        {
                  "en": "Removes self-attention",
                  "es": "Elimina auto-atención",
                  "de": "Entfernt Self-Attention",
                  "nl": "Verwijdert self-attention"
        },
        {
                  "en": "Employs smaller models",
                  "es": "Emplea modelos más pequeños",
                  "de": "Verwendet kleinere Modelle",
                  "nl": "Gebruikt kleinere modellen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Faster training speed",
                  "es": "Velocidad de entrenamiento más rápida",
                  "de": "Schnellere Trainingsgeschwindigkeit",
                  "nl": "Snellere trainingssnelheid"
        },
        {
                  "en": "Continuous-depth transformations with constant memory",
                  "es": "Transformaciones de profundidad continua con memoria constante",
                  "de": "Transformationen mit kontinuierlicher Tiefe bei konstantem Speicher",
                  "nl": "Continue-diepte transformaties met constant geheugen"
        },
        {
        ...
        {
                  "en": "Better accuracy on all tasks",
                  "es": "Mejor precisión en todas las tareas",
                  "de": "Bessere Genauigkeit bei allen Aufgaben",
                  "nl": "Betere nauwkeurigheid op alle taken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "nl": "Eenvoudigere architectuur"
        },
        {
                  "en": "Exact likelihood computation via invertible transformations",
                  "es": "Cálculo de verosimilitud exacta mediante transformaciones invertibles",
                  "de": "Exakte Likelihood-Berechnung durch invertierbare Transformationen",
                  "nl": "Exacte likelihood-berekening via inverteerbare transformaties"
        },
        {
                  "en": "Lower computational cost",
                  "es": "Menor costo computacional",
                  "de": "Geringere Rechenkosten",
                  "nl": "Lagere rekenkosten"
        },
        {
                  "en": "Better sample quality always",
                  "es": "Mejor calidad de muestra siempre",
                  "de": "Immer bessere Sample-Qualität",
                  "nl": "Altijd betere sample-kwaliteit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Quantum decoherence issues",
                  "es": "Problemas de decoherencia cuántica",
                  "de": "Quantendekohärenzprobleme",
                  "nl": "Quantum-decoherentieproblemen"
        },
        {
                  "en": "Exponentially vanishing gradients in deep quantum circuits",
                  "es": "Gradientes que se desvanecen exponencialmente en circuitos cuánticos profundos",
                  "de": "Exponentiell verschwindende Gradienten in tiefen Quantenschaltkreisen",
                  "nl": "Exponentieel verdwijnende gradiënten in diepe quantum-circuits"
        },
        {
        ...
        {
                  "en": "High measurement error",
                  "es": "Alto error de medición",
                  "de": "Hoher Messfehler",
                  "nl": "Hoge meetfout"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Minimize reconstruction error",
                  "es": "Minimizar error de reconstrucción",
                  "de": "Rekonstruktionsfehler minimieren",
                  "nl": "Reconstructiefout minimaliseren"
        },
        {
                  "en": "Maximize entropy of predictions",
                  "es": "Maximizar entropía de predicciones",
                  "de": "Entropie von Vorhersagen maximieren",
                  "nl": "Entropie van voorspellingen maximaliseren"
        },
        {
                  "en": "Use adversarial training",
                  "es": "Usar entrenamiento adversarial",
                  "de": "Adversariales Training verwenden",
                  "nl": "Adversarial training gebruiken"
        },
        {
                  "en": "Maximize agreement between augmented views of same data",
                  "es": "Maximizar acuerdo entre vistas aumentadas de los mismos datos",
                  "de": "Übereinstimmung zwischen augmentierten Ansichten derselben Daten maximieren",
                  "nl": "Overeenstemming maximaliseren tussen augmented views van dezelfde data"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Faster inference speed",
                  "es": "Velocidad de inferencia más rápida",
                  "de": "Schnellere Inferenzgeschwindigkeit",
                  "nl": "Snellere inferentiesnelheid"
        },
        {
                  "en": "Flexible output queries for arbitrary task outputs",
                  "es": "Consultas de salida flexibles para salidas de tareas arbitrarias",
                  "de": "Flexible Output-Queries für beliebige Aufgabenausgaben",
                  "nl": "Flexibele output-queries voor willekeurige taakoutputs"
        },
        {
                  "en": "Larger model size only",
                  "es": "Solo tamaño de modelo más grande",
                  "de": "Nur größere Modellgröße",
                  "nl": "Alleen grotere modelgrootte"
        },
        {
                  "en": "Better data augmentation",
                  "es": "Mejor aumento de datos",
                  "de": "Bessere Datenaugmentation",
                  "nl": "Betere data-augmentatie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trains faster always",
                  "es": "Entrena más rápido siempre",
                  "de": "Trainiert immer schneller",
                  "nl": "Traint altijd sneller"
        },
        {
                  "en": "Updates only a small subset of parameters or adds adapters",
                  "es": "Actualiza solo un pequeño subconjunto de parámetros o añade adaptadores",
                  "de": "Aktualisiert nur eine kleine Teilmenge von Parametern oder fügt Adapter hinzu",
                  "nl": "Werkt alleen een kleine subset van parameters bij of voegt adapters toe"
        },
        {
                  "en": "Uses smaller datasets",
                  "es": "Usa conjuntos de datos más pequeños",
                  "de": "Verwendet kleinere Datensätze",
                  "nl": "Gebruikt kleinere datasets"
        },
        {
                  "en": "Requires no GPU",
                  "es": "No requiere GPU",
                  "de": "Benötigt keine GPU",
                  "nl": "Vereist geen GPU"
        }
        ],
        correct: 1,
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Mejor ingeniería de prompts",
                  "de": "Besseres Prompt-Engineering",
                  "nl": "Betere prompt-engineering"
        },
        {
                  "en": "Optimal balance between model size and training data",
                  "es": "Balance óptimo entre tamaño del modelo y datos de entrenamiento",
                  "de": "Optimales Gleichgewicht zwischen Modellgröße und Trainingsdaten",
                  "nl": "Optimale balans tussen modelgrootte en trainingsdata"
        },
        {
                  "en": "Reduced hallucinations",
                  "es": "Alucinaciones reducidas",
                  "de": "Reduzierte Halluzinationen",
                  "nl": "Verminderde hallucinaties"
        },
        {
                  "en": "Faster inference speed",
                  "es": "Velocidad de inferencia más rápida",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses smaller models",
                  "es": "Usa modelos más pequeños",
                  "de": "Verwendet kleinere Modelle",
                  "nl": "Gebruikt kleinere modellen"
        },
        {
                  "en": "Applies quantization only",
                  "es": "Aplica solo cuantización",
                  "de": "Wendet nur Quantisierung an",
                  "nl": "Past alleen kwantisatie toe"
        },
        {
                  "en": "IO-aware tiling reduces memory bandwidth bottleneck",
                  "es": "Mosaico consciente de IO reduce cuello de botella de ancho de banda de memoria",
                  "de": "IO-bewusstes Tiling reduziert Speicherbandbreiten-Bottleneck",
                  "nl": "IO-bewuste tiling vermindert geheugenbandbreedtebottleneck"
        },
        {
                  "en": "Removes attention mechanism entirely",
                  "es": "Elimina completamente el mecanismo de atención",
                  "de": "Entfernt Attention-Mechanismus vollständig",
                  "nl": "Verwijdert attention-mechanisme volledig"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Better hardware utilization",
                  "es": "Mejor utilización de hardware",
                  "de": "Bessere Hardware-Nutzung",
                  "nl": "Beter hardwaregebruik"
        },
        {
                  "en": "Phase transitions at critical model/data scale thresholds",
                  "es": "Transiciones de fase en umbrales críticos de escala de modelo/datos",
                  "de": "Phasenübergänge bei kritischen Modell-/Datenskalen-Schwellenwerten",
                  "nl": "Faseovergangen bij kritieke model-/dataschaaldrempels"
        },
        {
                  "en": "More training epochs",
                  "es": "Más épocas de entrenamiento",
                  "de": "Mehr Trainingsepochen",
                  "nl": "Meer trainingsepochs"
        },
        {
                  "en": "Explicit programming of abilities",
                  "es": "Programación explícita de habilidades",
                  "de": "Explizite Programmierung von Fähigkeiten",
                  "nl": "Expliciete programmering van vaardigheden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses only one expert always",
                  "es": "Usa solo un experto siempre",
                  "de": "Verwendet immer nur einen Experten",
                  "nl": "Gebruikt altijd slechts één expert"
        },
        {
                  "en": "Removes attention layers",
                  "es": "Elimina capas de atención",
                  "de": "Entfernt Attention-Schichten",
                  "nl": "Verwijdert attention-lagen"
        },
        {
                  "en": "Reduces model size permanently",
                  "es": "Reduce tamaño del modelo permanentemente",
                  "de": "Reduziert Modellgröße dauerhaft",
                  "nl": "Vermindert modelgrootte permanent"
        },
        {
                  "en": "Conditional computation activates only subset of parameters per token",
                  "es": "Computación condicional activa solo subconjunto de parámetros por token",
                  "de": "Bedingte Berechnung aktiviert nur Teilmenge von Parametern pro Token",
                  "nl": "Conditionele berekening activeert slechts subset van parameters per token"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses standard self-attention",
                  "es": "Usa auto-atención estándar",
                  "de": "Verwendet Standard-Self-Attention",
                  "nl": "Gebruikt standaard self-attention"
        },
        {
                  "en": "Only works for vision tasks",
                  "es": "Solo funciona para tareas de visión",
                  "de": "Funktioniert nur für Vision-Aufgaben",
                  "nl": "Werkt alleen voor vision-taken"
        },
        {
                  "en": "Selective state space models with linear-time inference",
                  "es": "Modelos de espacio de estado selectivos con inferencia en tiempo lineal",
                  "de": "Selektive Zustandsraummodelle mit linearer Inferenzzeit",
                  "nl": "Selectieve toestandsruimtemodellen met lineaire-tijd inferentie"
        },
        {
                  "en": "Requires larger memory",
                  "es": "Requiere más memoria",
                  "de": "Benötigt größeren Speicher",
                  "nl": "Vereist groter geheugen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All solutions are isolated",
                  "es": "Todas las soluciones están aisladas",
                  "de": "Alle Lösungen sind isoliert",
                  "nl": "Alle oplossingen zijn geïsoleerd"
        },
        {
                  "en": "Different optima often connected by low-loss paths",
                  "es": "Diferentes óptimos a menudo conectados por caminos de pérdida baja",
                  "de": "Verschiedene Optima oft durch Low-Loss-Pfade verbunden",
                  "nl": "Verschillende optima vaak verbonden door low-loss paden"
        },
        {
                  "en": "Loss surfaces are convex",
                  "es": "Superficies de pérdida son convexas",
                  "de": "Loss-Oberflächen sind konvex",
                  "nl": "Loss-oppervlakken zijn convex"
        },
        {
                  "en": "Initialization doesn't matter",
                  "es": "La inicialización no importa",
                  "de": "Initialisierung spielt keine Rolle",
                  "nl": "Initialisatie maakt niet uit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Removes attention mechanism",
                  "es": "Elimina mecanismo de atención",
                  "de": "Entfernt Attention-Mechanismus",
                  "nl": "Verwijdert attention-mechanisme"
        },
        {
                  "en": "Reduces model size permanently",
                  "es": "Reduce tamaño del modelo permanentemente",
        ...
        {
                  "en": "Uses different tokenization",
                  "es": "Usa tokenización diferente",
                  "de": "Verwendet andere Tokenisierung",
                  "nl": "Gebruikt andere tokenisatie"
        },
        {
                  "en": "Small draft model generates candidates verified by large model",
                  "es": "Modelo borrador pequeño genera candidatos verificados por modelo grande",
                  "de": "Kleines Draft-Modell generiert Kandidaten, verifiziert durch großes Modell",
                  "nl": "Klein ontwerp-model genereert kandidaten geverifieerd door groot model"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Removes need for attention",
                  "es": "Elimina necesidad de atención",
                  "de": "Entfernt Notwendigkeit für Attention",
                  "nl": "Verwijdert noodzaak voor attention"
        },
        {
                  "en": "Uses less memory always",
                  "es": "Usa menos memoria siempre",
                  "de": "Verwendet immer weniger Speicher",
                  "nl": "Gebruikt altijd minder geheugen"
        },
        {
                  "en": "Works only with small sequences",
                  "es": "Funciona solo con secuencias pequeñas",
                  "de": "Funktioniert nur mit kleinen Sequenzen",
                  "nl": "Werkt alleen met kleine sequenties"
        },
        {
                  "en": "Encodes relative position via rotation in complex plane",
                  "es": "Codifica posición relativa mediante rotación en plano complejo",
                  "de": "Kodiert relative Position durch Rotation in komplexer Ebene",
                  "nl": "Codeert relatieve positie via rotatie in complex vlak"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Context windows are limited",
                  "es": "Ventanas de contexto son limitadas",
                  "de": "Kontextfenster sind begrenzt",
                  "nl": "Context-vensters zijn beperkt"
        },
        {
                  "en": "Models fail to infer reverse relations from forward ones",
                  "es": "Modelos fallan al inferir relaciones inversas de las directas",
                  "de": "Modelle scheitern daran, umgekehrte Beziehungen aus vorwärts gerichteten zu folgern",
                  "nl": "Modellen slagen er niet in om omgekeerde relaties af te leiden uit voorwaartse"
        },
        {
                  "en": "Training is too slow",
                  "es": "El entrenamiento es demasiado lento",
                  "de": "Training ist zu langsam",
                  "nl": "Training is te langzaam"
        },
        {
                  "en": "Models hallucinate more",
                  "es": "Modelos alucinan más",
                  "de": "Modelle halluzinieren mehr",
                  "nl": "Modellen hallucineren meer"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Shares key/value heads across query groups",
                  "es": "Comparte cabezas de key/value entre grupos de query",
                  "de": "Teilt Key-/Value-Heads über Query-Gruppen",
                  "nl": "Deelt key-/value-heads over query-groepen"
        },
        {
                  "en": "Increases model parameters",
                  "es": "Aumenta parámetros del modelo",
                  "de": "Erhöht Modellparameter",
                  "nl": "Vergroot modelparameters"
        },
        {
                  "en": "Uses only one query head",
                  "es": "Usa solo una cabeza de query",
                  "de": "Verwendet nur einen Query-Head",
                  "nl": "Gebruikt slechts één query-head"
        },
        {
                  "en": "Removes all attention heads",
                  "es": "Elimina todas las cabezas de atención",
                  "de": "Entfernt alle Attention-Heads",
                  "nl": "Verwijdert alle attention-heads"
        }
        ],
        correct: 0,
        explanation: {
