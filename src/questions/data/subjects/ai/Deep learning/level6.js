  ...
  const level6 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Distinguish between real and generated samples to provide training signal to the generator", es: "Distinguir entre muestras reales y generadas para proporcionar señal de entrenamiento al generador", de: "Zwischen echten und generierten Proben unterscheiden um Trainingssignal an Generator zu liefern", nl: "Onderscheid maken tussen echte en gegenereerde samples om trainingssignaal aan de generator te geven" },
          { en: "Discriminate against poorly performing networks", es: "Discriminar contra redes de bajo rendimiento", de: "Gegen schlecht performende Netzwerke diskriminieren", nl: "Discrimineren tegen slecht presterende netwerken" },
          { en: "Filter out discriminatory biases in data", es: "Filtrar sesgos discriminatorios en datos", de: "Diskriminierende Verzerrungen in Daten herausfiltern", nl: "Discriminerende vooroordelen uit data filteren" },
          { en: "Generate discriminating features", es: "Generar características discriminantes", de: "Diskriminierende Merkmale generieren", nl: "Discriminerende kenmerken genereren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "When the generator produces limited variety, failing to capture the full diversity of the training distribution", es: "Cuando el generador produce variedad limitada, fallando en capturar la diversidad completa de la distribución de entrenamiento", de: "Wenn der Generator begrenzte Vielfalt produziert, versagt die volle Diversität der Trainingsverteilung zu erfassen", nl: "Wanneer de generator beperkte variëteit produceert, faalt om de volledige diversiteit van de trainingsdistributie vast te leggen" },
          { en: "The model collapsing due to computational errors", es: "El modelo colapsando debido a errores computacionales", de: "Das Modell kollabiert aufgrund von Rechenfehlern", nl: "Het model stort in door computationele fouten" },
          { en: "Multiple modes merging into one", es: "Múltiples modos fusionándose en uno", de: "Mehrere Modi verschmelzen zu einem", nl: "Meerdere modes fuseren tot één" },
          { en: "The training mode collapsing unexpectedly", es: "El modo de entrenamiento colapsando inesperadamente", de: "Der Trainingsmodus bricht unerwartet zusammen", nl: "De trainingsmodus stort onverwacht in" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Create realistic synthetic samples that fool the discriminator into classifying them as real", es: "Crear muestras sintéticas realistas que engañen al discriminador para clasificarlas como reales", de: "Realistische synthetische Proben erstellen die den Diskriminator täuschen sie als echt zu klassifizieren", nl: "Realistische synthetische samples creëren die de discriminator misleiden om ze als echt te classificeren" },
          { en: "Generate as many samples as possible", es: "Generar tantas muestras como sea posible", de: "So viele Proben wie möglich generieren", nl: "Zo veel mogelijk samples genereren" },
          { en: "Generate power for the discriminator", es: "Generar potencia para el discriminador", de: "Energie für den Diskriminator generieren", nl: "Energie genereren voor de discriminator" },
          { en: "Generate training data for other models", es: "Generar datos de entrenamiento para otros modelos", de: "Trainingsdaten für andere Modelle generieren", nl: "Trainingsdata genereren voor andere modellen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Adding position information to embeddings since transformers process sequences in parallel without inherent order", es: "Añadir información de posición a embeddings ya que transformers procesan secuencias en paralelo sin orden inherente", de: "Positionsinformationen zu Embeddings hinzufügen da Transformer Sequenzen parallel ohne inhärente Ordnung verarbeiten", nl: "Positie-informatie toevoegen aan embeddings omdat transformers sequenties parallel verwerken zonder inherente volgorde" },
          { en: "Encoding the physical position of data in memory", es: "Codificar la posición física de datos en memoria", de: "Physische Position von Daten im Speicher kodieren", nl: "Fysieke positie van data in geheugen coderen" },
          { en: "Positioning the encoder in the architecture", es: "Posicionar el codificador en la arquitectura", de: "Den Encoder in der Architektur positionieren", nl: "De encoder in de architectuur positioneren" },
          { en: "Encoding spatial positions in images", es: "Codificar posiciones espaciales en imágenes", de: "Räumliche Positionen in Bildern kodieren", nl: "Ruimtelijke posities in beelden coderen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Running multiple attention mechanisms in parallel to capture different representation subspaces", es: "Ejecutar múltiples mecanismos de atención en paralelo para capturar diferentes subespacios de representación", de: "Mehrere Aufmerksamkeitsmechanismen parallel laufen lassen um verschiedene Repräsentations-Unterräume zu erfassen", nl: "Meerdere attention mechanismen parallel uitvoeren om verschillende representatie subruimtes vast te leggen" },
          { en: "Attention mechanism with multiple heads in the network", es: "Mecanismo de atención con múltiples cabezas en la red", de: "Aufmerksamkeitsmechanismus mit mehreren Köpfen im Netzwerk", nl: "Attention mechanisme met meerdere koppen in het netwerk" },
          { en: "Paying attention to multiple tasks simultaneously", es: "Prestar atención a múltiples tareas simultáneamente", de: "Mehreren Aufgaben gleichzeitig Aufmerksamkeit schenken", nl: "Aandacht besteden aan meerdere taken tegelijkertijd" },
          { en: "Distributed attention across multiple devices", es: "Atención distribuida a través de múltiples dispositivos", de: "Verteilte Aufmerksamkeit über mehrere Geräte", nl: "Verdeelde aandacht over meerdere apparaten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "More stable training using Wasserstein distance instead of Jensen-Shannon divergence", es: "Entrenamiento más estable usando distancia Wasserstein en lugar de divergencia Jensen-Shannon", de: "Stabileres Training mit Wasserstein-Distanz anstatt Jensen-Shannon-Divergenz", nl: "Stabielere training met Wasserstein afstand in plaats van Jensen-Shannon divergentie" },
          { en: "Washing away gradient problems", es: "Lavar problemas de gradiente", de: "Gradientenprobleme wegwaschen", nl: "Gradiënt problemen wegwassen" },
          { en: "Using water-based cooling for GPUs", es: "Usar enfriamiento basado en agua para GPUs", de: "Wasserbasierte Kühlung für GPUs verwenden", nl: "Watergebaseerde koeling voor GPU's gebruiken" },
          { en: "Generating wavy patterns better", es: "Generar mejores patrones ondulados", de: "Wellige Muster besser generieren", nl: "Golvende patronen beter genereren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Process each position independently after attention, adding non-linear transformations", es: "Procesar cada posición independientemente después de atención, añadiendo transformaciones no lineales", de: "Jede Position unabhängig nach Aufmerksamkeit verarbeiten, fügt nichtlineare Transformationen hinzu", nl: "Elke positie onafhankelijk verwerken na attention, voegt niet-lineaire transformaties toe" },
          { en: "Feed data forward to the next layer", es: "Alimentar datos hacia adelante a la siguiente capa", de: "Daten zur nächsten Schicht vorwärts leiten", nl: "Data vooruit voeden naar de volgende laag" },
          { en: "Provide feedback to earlier layers", es: "Proporcionar retroalimentación a capas anteriores", de: "Feedback an frühere Schichten liefern", nl: "Feedback geven aan eerdere lagen" },
          { en: "Forward the network to different tasks", es: "Reenviar la red a diferentes tareas", de: "Das Netzwerk an verschiedene Aufgaben weiterleiten", nl: "Het netwerk doorsturen naar verschillende taken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Distilling essential knowledge from data", es: "Destilar conocimiento esencial de datos", de: "Wesentliches Wissen aus Daten destillieren", nl: "Essentiële kennis uit data distilleren" },
          { en: "Purifying knowledge representations", es: "Purificar representaciones de conocimiento", de: "Wissensrepräsentationen reinigen", nl: "Kennisrepresentaties zuiveren" },
          { en: "Extracting knowledge from trained models", es: "Extraer conocimiento de modelos entrenados", de: "Wissen aus trainierten Modellen extrahieren", nl: "Kennis uit getrainde modellen extraheren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Expressing random sampling as a deterministic function plus noise to enable backpropagation through stochastic nodes", es: "Expresar muestreo aleatorio como función determinística más ruido para habilitar retropropagación a través de nodos estocásticos", de: "Zufälliges Sampling als deterministische Funktion plus Rauschen ausdrücken um Backpropagation durch stochastische Knoten zu ermöglichen", nl: "Willekeurige sampling uitdrukken als deterministische functie plus ruis om backpropagation door stochastische knooppunten mogelijk te maken" },
          { en: "Re-parameterizing the model during training", es: "Re-parametrizar el modelo durante entrenamiento", de: "Das Modell während Training neu parametrisieren", nl: "Het model opnieuw parametriseren tijdens training" },
          { en: "A trick to reduce the number of parameters", es: "Un truco para reducir el número de parámetros", de: "Ein Trick um die Anzahl der Parameter zu reduzieren", nl: "Een truc om het aantal parameters te verminderen" },
          { en: "Changing parameter initialization strategies", es: "Cambiar estrategias de inicialización de parámetros", de: "Parameterinitialisierungsstrategien ändern", nl: "Parameter initialisatie strategieën veranderen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A tractable lower bound on log-likelihood that VAEs maximize, consisting of reconstruction loss and KL divergence", es: "Un límite inferior tratable en log-verosimilitud que VAEs maximizan, consistente en pérdida de reconstrucción y divergencia KL", de: "Eine handhabbare untere Grenze der Log-Likelihood die VAEs maximieren, bestehend aus Rekonstruktionsverlust und KL-Divergenz", nl: "Een hanteerbare ondergrens op log-likelihood die VAEs maximaliseren, bestaande uit reconstructie loss en KL divergentie" },
          { en: "The lower bound of evidence needed for training", es: "El límite inferior de evidencia necesaria para entrenamiento", de: "Die untere Grenze der für Training benötigten Evidenz", nl: "De ondergrens van bewijs nodig voor training" },
          { en: "Evidence-based lower boundary of the network", es: "Límite inferior basado en evidencia de la red", de: "Evidenzbasierte untere Grenze des Netzwerks", nl: "Bewijs-gebaseerde ondergrens van het netwerk" },
          { en: "The minimum amount of data required", es: "La cantidad mínima de datos requerida", de: "Die minimale Menge an benötigten Daten", nl: "De minimale hoeveelheid vereiste data" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Automated methods for discovering optimal neural network architectures for specific tasks", es: "Métodos automatizados para descubrir arquitecturas de redes neuronales óptimas para tareas específicas", de: "Automatisierte Methoden zur Entdeckung optimaler neuronaler Netzwerkarchitekturen für spezifische Aufgaben", nl: "Geautomatiseerde methoden voor het ontdekken van optimale neurale netwerkarchitecturen voor specifieke taken" },
          { en: "Searching through neural network parameters", es: "Buscar a través de parámetros de redes neuronales", de: "Durch neuronale Netzwerkparameter suchen", nl: "Zoeken door neurale netwerkparameters" },
          { en: "Finding neurons in architectural images", es: "Encontrar neuronas en imágenes arquitectónicas", de: "Neuronen in architektonischen Bildern finden", nl: "Neuronen vinden in architectonische beelden" },
          { en: "Searching for architectural patterns in data", es: "Buscar patrones arquitectónicos en datos", de: "Nach architektonischen Mustern in Daten suchen", nl: "Zoeken naar architectonische patronen in data" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Initialize deep networks by training layers sequentially before fine-tuning, historically used before better initialization methods", es: "Inicializar redes profundas entrenando capas secuencialmente antes de fine-tuning, usado antes de mejores métodos", de: "Tiefe Netzwerke initialisieren durch sequenzielles Training von Schichten vor Fine-Tuning, vor besseren Initialisierungsmethoden", nl: "Diepe netwerken initialiseren door lagen sequentieel te trainen voor fine-tuning, gebruikt voor betere initialisatiemethoden" },
          { en: "Pre-train each layer separately on different datasets", es: "Pre-entrenar cada capa por separado en diferentes conjuntos de datos", de: "Jede Schicht separat auf verschiedenen Datensätzen vortrainieren", nl: "Elke laag apart pre-trainen op verschillende datasets" },
          { en: "Train layers at different learning rates", es: "Entrenar capas a diferentes tasas de aprendizaje", de: "Schichten mit verschiedenen Lernraten trainieren", nl: "Lagen trainen met verschillende learning rates" },
          { en: "Prepare layers for deployment", es: "Preparar capas para despliegue", de: "Schichten für Deployment vorbereiten", nl: "Lagen voorbereiden voor deployment" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Training models on adversarial examples to improve robustness against attacks", es: "Entrenar modelos en ejemplos adversarios para mejorar robustez contra ataques", de: "Modelle auf adversariellen Beispielen trainieren um Robustheit gegen Angriffe zu verbessern", nl: "Modellen trainen op adversariële voorbeelden om robuustheid tegen aanvallen te verbeteren" },
          { en: "Training models to be adversarial to users", es: "Entrenar modelos para ser adversarios a usuarios", de: "Modelle trainieren um Benutzern gegenüber feindlich zu sein", nl: "Modellen trainen om vijandig te zijn tegen gebruikers" },
          { en: "Training two models to compete", es: "Entrenar dos modelos para competir", de: "Zwei Modelle zum Wettkampf trainieren", nl: "Twee modellen trainen om te concurreren" },
          { en: "Training under adverse conditions", es: "Entrenar bajo condiciones adversas", de: "Unter widrigen Bedingungen trainieren", nl: "Trainen onder ongunstige omstandigheden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "GANs that generate samples conditioned on additional information like class labels or text", es: "GANs que generan muestras condicionadas en información adicional como etiquetas de clase o texto", de: "GANs die Proben bedingt auf zusätzlichen Informationen wie Klassenlabels oder Text generieren", nl: "GANs die samples genereren geconditioneerd op aanvullende informatie zoals class labels of tekst" },
          { en: "GANs with conditional statements in code", es: "GANs con declaraciones condicionales en código", de: "GANs mit bedingten Anweisungen im Code", nl: "GANs met voorwaardelijke statements in code" },
          { en: "GANs that work under certain conditions only", es: "GANs que funcionan solo bajo ciertas condiciones", de: "GANs die nur unter bestimmten Bedingungen funktionieren", nl: "GANs die alleen onder bepaalde voorwaarden werken" },
          { en: "GANs conditioned on training success", es: "GANs condicionadas al éxito del entrenamiento", de: "GANs bedingt auf Trainingserfolg", nl: "GANs geconditioneerd op trainings succes" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Enable training of very deep networks by providing gradient highways and allowing identity mappings", es: "Habilitar entrenamiento de redes muy profundas proporcionando autopistas de gradientes y permitiendo mapeos de identidad", de: "Training sehr tiefer Netzwerke ermöglichen durch Bereitstellung von Gradienten-Highways und Ermöglichung von Identitätsabbildungen", nl: "Training van zeer diepe netwerken mogelijk maken door gradiënt highways te bieden en identiteit mappings toe te staan" },
          { en: "Connect residual errors between layers", es: "Conectar errores residuales entre capas", de: "Restfehler zwischen Schichten verbinden", nl: "Restfouten tussen lagen verbinden" },
          { en: "Reuse residual computations", es: "Reutilizar computaciones residuales", de: "Restberechnungen wiederverwenden", nl: "Restberekeningen hergebruiken" },
          { en: "Store residual information for later", es: "Almacenar información residual para después", de: "Restinformationen für später speichern", nl: "Restinformatie opslaan voor later" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Ensuring that translating from domain A to B and back to A recovers the original image", es: "Asegurar que traducir del dominio A a B y de vuelta a A recupera la imagen original", de: "Sicherstellen dass Übersetzung von Domäne A zu B und zurück zu A das Originalbild wiederherstellt", nl: "Verzekeren dat vertalen van domein A naar B en terug naar A het originele beeld herstelt" },
          { en: "Loss accumulated over training cycles", es: "Pérdida acumulada sobre ciclos de entrenamiento", de: "Verlust über Trainingszyklen akkumuliert", nl: "Loss geaccumuleerd over trainingscycli" },
          { en: "Cycling through different loss functions", es: "Ciclar a través de diferentes funciones de pérdida", de: "Durch verschiedene Verlustfunktionen zyklieren", nl: "Cycleren door verschillende loss functies" },
          { en: "Consistent loss across epochs", es: "Pérdida consistente a través de épocas", de: "Konsistenter Verlust über Epochen", nl: "Consistente loss over epochs" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Convert raw scores into a probability distribution over classes that sum to 1", es: "Convertir puntuaciones brutas en una distribución de probabilidad sobre clases que suman 1", de: "Rohe Scores in eine Wahrscheinlichkeitsverteilung über Klassen umwandeln die zu 1 summieren", nl: "Ruwe scores converteren naar een waarschijnlijkheidsverdeling over klassen die optellen tot 1" },
          { en: "Make the network softer and more flexible", es: "Hacer la red más suave y flexible", de: "Das Netzwerk weicher und flexibler machen", nl: "Het netwerk zachter en flexibeler maken" },
          { en: "Find the maximum value softly", es: "Encontrar el valor máximo suavemente", de: "Den Maximalwert sanft finden", nl: "De maximale waarde zacht vinden" },
          { en: "Soften the impact of outliers", es: "Suavizar el impacto de valores atípicos", de: "Die Auswirkung von Ausreißern mildern", nl: "De impact van uitbijters verzachten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Training models to quickly adapt to new tasks with few examples by learning good initialization or learning algorithms", es: "Entrenar modelos para adaptarse rápidamente a nuevas tareas con pocos ejemplos aprendiendo inicialización o algoritmos", de: "Modelle trainieren um sich schnell an neue Aufgaben anzupassen durch Lernen guter Initialisierung oder Lernalgorithmen", nl: "Modellen trainen om snel aan te passen aan nieuwe taken met weinig voorbeelden door goede initialisatie of leeralgoritmes" },
          { en: "Learning metadata about datasets", es: "Aprender metadatos sobre conjuntos de datos", de: "Metadaten über Datensätze lernen", nl: "Metadata over datasets leren" },
          { en: "Higher-level learning above deep learning", es: "Aprendizaje de nivel superior sobre aprendizaje profundo", de: "Höherstufiges Lernen über Deep Learning", nl: "Hoger niveau leren boven deep learning" },
          { en: "Learning about learning theory", es: "Aprender sobre teoría del aprendizaje", de: "Über Lerntheorie lernen", nl: "Leren over leertheorie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Removing unnecessary weights or neurons to reduce model size while maintaining performance", es: "Remover pesos o neuronas innecesarias para reducir tamaño de modelo manteniendo rendimiento", de: "Unnötige Gewichte oder Neuronen entfernen um Modellgröße zu reduzieren während Leistung beibehalten wird", nl: "Onnodige gewichten of neuronen verwijderen om modelgrootte te verminderen terwijl prestaties behouden blijven" },
          { en: "Trimming training data", es: "Recortar datos de entrenamiento", de: "Trainingsdaten trimmen", nl: "Trainingsdata trimmen" },
          { en: "Cutting off training early", es: "Cortar entrenamiento temprano", de: "Training früh abbrechen", nl: "Training vroeg afbreken" },
          { en: "Pruning decision trees", es: "Podar árboles de decisión", de: "Entscheidungsbäume beschneiden", nl: "Beslisbomen snoeien" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Reducing precision of weights and activations from 32-bit floats to lower bit-widths to reduce memory and computation", es: "Reducir precisión de pesos y activaciones de floats de 32 bits a anchos de bit menores para reducir memoria y computación", de: "Präzision von Gewichten und Aktivierungen von 32-Bit-Floats auf niedrigere Bit-Breiten reduzieren um Speicher und Berechnung zu reduzieren", nl: "Precisie van gewichten en activaties verminderen van 32-bit floats naar lagere bit-breedtes om geheugen en berekening te verminderen" },
          { en: "Measuring quantities in the network", es: "Medir cantidades en la red", de: "Mengen im Netzwerk messen", nl: "Hoeveelheden in het netwerk meten" },
          { en: "Converting continuous to discrete values", es: "Convertir valores continuos a discretos", de: "Kontinuierliche in diskrete Werte umwandeln", nl: "Continue naar discrete waarden converteren" },
          { en: "Quantifying network performance", es: "Cuantificar rendimiento de red", de: "Netzwerkleistung quantifizieren", nl: "Netwerkprestaties kwantificeren" }
        ],
        correct: 0,
        explanation: {
