    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Making databases smaller",
                  "es": "Hacer las bases de datos mas pequenas",
                  "de": "Datenbanken kleiner machen",
                  "nl": "Databases kleiner maken"
        },
        {
                  "en": "Reducing the cost of data storage",
                  "es": "Reducir el costo de almacenamiento de datos",
                  "de": "Die Kosten der Datenspeicherung reduzieren",
                  "nl": "De kosten van data opslag verminderen"
        },
        {
                  "en": "Collecting only the data necessary for a specific purpose",
                  "es": "Recolectar solo los datos necesarios para un proposito especifico",
                  "de": "Nur die fuer einen bestimmten Zweck notwendigen Daten sammeln",
                  "nl": "Alleen de data verzamelen die nodig is voor een specifiek doel"
        },
        {
                  "en": "Using less internet bandwidth",
                  "es": "Usar menos ancho de banda de internet",
                  "de": "Weniger Internet-Bandbreite verwenden",
                  "nl": "Minder internet bandbreedte gebruiken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A human physically inside a computer",
                  "es": "Un humano fisicamente dentro de una computadora",
                  "de": "Ein Mensch physisch in einem Computer",
                  "nl": "Een mens fysiek in een computer"
        },
        {
                  "en": "Keeping human oversight and intervention in AI processes",
                  "es": "Mantener supervision e intervencion humana en procesos de IA",
                  "de": "Menschliche Aufsicht und Intervention in KI-Prozessen beibehalten",
                  "nl": "Menselijk toezicht en interventie behouden in AI processen"
        },
        {
                  "en": "Training humans to think like AI",
                  "es": "Entrenar humanos para pensar como IA",
                  "de": "Menschen trainieren wie KI zu denken",
                  "nl": "Mensen trainen om te denken zoals AI"
        },
        {
                  "en": "Using circular reasoning in AI",
                  "es": "Usar razonamiento circular en IA",
                  "de": "Zirkulaeres Denken in KI verwenden",
                  "nl": "Circulair redeneren gebruiken in AI"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When algorithms are very selective",
                  "es": "Cuando los algoritmos son muy selectivos",
                  "de": "Wenn Algorithmen sehr selektiv sind",
                  "nl": "Wanneer algoritmes erg selectief zijn"
        },
        {
                  "en": "When AI systems compete with each other",
                  "es": "Cuando sistemas de IA compiten entre si",
                  "de": "Wenn KI-Systeme miteinander konkurrieren",
                  "nl": "Wanneer AI systemen met elkaar concurreren"
        },
        {
                  "en": "When algorithms choose the best option",
                  "es": "Cuando los algoritmos eligen la mejor opcion",
                  "de": "Wenn Algorithmen die beste Option waehlen",
                  "nl": "Wanneer algoritmes de beste optie kiezen"
        },
        {
                  "en": "When AI unfairly treats people differently based on protected characteristics",
                  "es": "Cuando la IA trata injustamente a personas de manera diferente basado en caracteristicas protegidas",
                  "de": "Wenn KI Menschen unfair unterschiedlich behandelt basierend auf geschuetzten Merkmalen",
                  "nl": "Wanneer AI mensen oneerlijk verschillend behandelt gebaseerd op beschermde kenmerken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To review and guide ethical AI development and deployment",
                  "es": "Revisar y guiar el desarrollo y despliegue etico de IA",
                  "de": "Ethische KI-Entwicklung und -Einsatz ueberpruefen und leiten",
                  "nl": "Ethische AI ontwikkeling en implementatie beoordelen en begeleiden"
        },
        {
                  "en": "To hire more programmers",
                  "es": "Contratar mas programadores",
                  "de": "Mehr Programmierer einstellen",
                  "nl": "Meer programmeurs aannemen"
        },
        {
                  "en": "To slow down AI development",
                  "es": "Ralentizar el desarrollo de IA",
                  "de": "KI-Entwicklung verlangsamen",
                  "nl": "AI ontwikkeling vertragen"
        },
        {
                  "en": "To increase AI budgets",
                  "es": "Aumentar presupuestos de IA",
                  "de": "KI-Budgets erhoehen",
                  "nl": "AI budgetten verhogen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI should have limited purposes",
                  "es": "La IA debe tener propositos limitados",
                  "de": "KI sollte begrenzte Zwecke haben",
                  "nl": "AI moet beperkte doelen hebben"
        },
        {
                  "en": "Limiting how many times data can be accessed",
                  "es": "Limitar cuantas veces se pueden acceder los datos",
                  "de": "Begrenzen wie oft auf Daten zugegriffen werden kann",
                  "nl": "Beperken hoe vaak data toegankelijk is"
        },
        {
                  "en": "Using data for maximum profit",
                  "es": "Usar datos para maximo beneficio",
                  "de": "Daten fuer maximalen Profit nutzen",
                  "nl": "Data gebruiken voor maximale winst"
        },
        {
                  "en": "Data should only be used for the purpose it was originally collected",
                  "es": "Los datos solo deben usarse para el proposito para el que fueron recolectados originalmente",
                  "de": "Daten sollten nur fuer den Zweck verwendet werden fuer den sie urspruenglich gesammelt wurden",
                  "nl": "Data mag alleen gebruikt worden voor het doel waarvoor het oorspronkelijk verzameld werd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hiding the identity of AI developers",
                  "es": "Ocultar la identidad de desarrolladores de IA",
                  "de": "Die Identitaet von KI-Entwicklern verbergen",
                  "nl": "De identiteit van AI ontwikkelaars verbergen"
        },
        {
                  "en": "Removing or altering identifiable information to protect individual privacy",
                  "es": "Remover o alterar informacion identificable para proteger privacidad individual",
                  "de": "Identifizierbare Informationen entfernen oder aendern um individuelle Privatsphaere zu schuetzen",
                  "nl": "Identificeerbare informatie verwijderen of wijzigen om individuele privacy te beschermen"
        },
        {
                  "en": "Using anonymous user accounts",
                  "es": "Usar cuentas de usuario anonimas",
                  "de": "Anonyme Benutzerkonten verwenden",
                  "nl": "Anonieme gebruikersaccounts gebruiken"
        },
        {
                  "en": "Making AI systems work without names",
                  "es": "Hacer que sistemas de IA funcionen sin nombres",
                  "de": "KI-Systeme ohne Namen arbeiten lassen",
                  "nl": "AI systemen laten werken zonder namen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using fake names for everyone",
                  "es": "Usar nombres falsos para todos",
                  "de": "Gefaelschte Namen fuer alle verwenden",
                  "nl": "Valse namen gebruiken voor iedereen"
        },
        {
                  "en": "Using nicknames instead of real names",
                  "es": "Usar apodos en lugar de nombres reales",
                  "de": "Spitznamen anstatt echter Namen verwenden",
                  "nl": "Bijnamen gebruiken in plaats van echte namen"
        },
        {
                  "en": "Creating fictional characters",
                  "es": "Crear personajes ficticios",
                  "de": "Fiktive Charaktere erstellen",
                  "nl": "Fictieve karakters creëren"
        },
        {
                  "en": "Replacing direct identifiers with artificial identifiers that can be reversed",
                  "es": "Reemplazar identificadores directos con identificadores artificiales que pueden ser revertidos",
                  "de": "Direkte IDs durch kuenstliche IDs ersetzen die rueckgaengig gemacht werden koennen",
                  "nl": "Directe identificatoren vervangen door kunstmatige identificatoren die omkeerbaar zijn"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Storing data in different locations",
                  "es": "Almacenar datos en diferentes ubicaciones",
                  "de": "Daten an verschiedenen Orten speichern",
                  "nl": "Data opslaan op verschillende locaties"
        },
        {
                  "en": "Making multiple copies of data",
                  "es": "Hacer multiples copias de datos",
                  "de": "Mehrere Kopien von Daten erstellen",
                  "nl": "Meerdere kopieën van data maken"
        },
        {
                  "en": "How long personal data is kept before deletion",
                  "es": "Cuanto tiempo se mantienen datos personales antes de eliminarlos",
                  "de": "Wie lange persoenliche Daten vor Loeschung aufbewahrt werden",
                  "nl": "Hoe lang persoonlijke data bewaard wordt voor verwijdering"
        },
        {
                  "en": "Keeping all data forever",
                  "es": "Mantener todos los datos para siempre",
                  "de": "Alle Daten fuer immer behalten",
                  "nl": "Alle data voor altijd bewaren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Deleting AI algorithms permanently",
                  "es": "Eliminar algoritmos de IA permanentemente",
                  "de": "KI-Algorithmen dauerhaft loeschen",
                  "nl": "AI algoritmes permanent verwijderen"
        },
        {
                  "en": "AI systems forgetting their training",
                  "es": "Sistemas de IA olvidando su entrenamiento",
                  "de": "KI-Systeme vergessen ihr Training",
                  "nl": "AI systemen hun training vergeten"
        },
        {
                  "en": "Making AI systems have memory problems",
                  "es": "Hacer que sistemas de IA tengan problemas de memoria",
                  "de": "KI-Systeme Gedaechtnisprobleme haben lassen",
                  "nl": "AI systemen geheugenproblemen laten hebben"
        },
        {
                  "en": "The ability for individuals to request deletion of their personal data",
                  "es": "La capacidad de individuos de solicitar eliminacion de sus datos personales",
                  "de": "Die Faehigkeit fuer Individuen die Loeschung ihrer persoenlichen Daten zu verlangen",
                  "nl": "De mogelijkheid voor individuen om verwijdering van hun persoonlijke data aan te vragen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using multiple AI systems together",
                  "es": "Usar multiples sistemas de IA juntos",
                  "de": "Mehrere KI-Systeme zusammen verwenden",
                  "nl": "Meerdere AI systemen samen gebruiken"
        },
        {
                  "en": "Training AI models locally without sharing raw data centrally",
                  "es": "Entrenar modelos de IA localmente sin compartir datos crudos centralmente",
                  "de": "KI-Modelle lokal trainieren ohne rohe Daten zentral zu teilen",
                  "nl": "AI modellen lokaal trainen zonder ruwe data centraal te delen"
        },
        {
                  "en": "Learning about government federations",
                  "es": "Aprender sobre federaciones gubernamentales",
                  "de": "Ueber Regierungsfoederationen lernen",
                  "nl": "Leren over overheidsföderaties"
        },
        {
                  "en": "Sharing all data with everyone",
                  "es": "Compartir todos los datos con todos",
                  "de": "Alle Daten mit allen teilen",
                  "nl": "Alle data met iedereen delen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Realizar computaciones en datos encriptados sin desencriptarlos",
                  "de": "Berechnungen an verschluesselten Daten durchfuehren ohne sie zu entschluesseln",
                  "nl": "Berekeningen uitvoeren op versleutelde data zonder het te ontsleutelen"
        },
        {
                  "en": "Using the same encryption key everywhere",
                  "es": "Usar la misma clave de encriptacion en todas partes",
                  "de": "Den gleichen Verschluesselungsschluessel ueberall verwenden",
                  "nl": "Dezelfde encryptiesleutel overal gebruiken"
        },
        {
                  "en": "Encrypting data multiple times",
                  "es": "Encriptar datos multiples veces",
                  "de": "Daten mehrfach verschluesseln",
                  "nl": "Data meerdere keren versleutelen"
        },
        {
                  "en": "Making all encryption methods the same",
                  "es": "Hacer que todos los metodos de encriptacion sean iguales",
                  "de": "Alle Verschluesselungsmethoden gleich machen",
                  "nl": "Alle encryptiemethoden gelijk maken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Carrying laptops around easily",
                  "es": "Llevar laptops facilmente",
                  "de": "Laptops einfach herumtragen",
                  "nl": "Laptops gemakkelijk meenemen"
        },
        {
                  "en": "The right to receive and transfer personal data in a usable format",
                  "es": "El derecho de recibir y transferir datos personales en un formato utilizable",
                  "de": "Das Recht persoenliche Daten in einem nutzbaren Format zu erhalten und zu uebertragen",
                  "nl": "Het recht om persoonlijke data te ontvangen en over te dragen in een bruikbaar formaat"
        },
        {
                  "en": "Moving AI systems to different servers",
                  "es": "Mover sistemas de IA a diferentes servidores",
                  "de": "KI-Systeme auf verschiedene Server verschieben",
                  "nl": "AI systemen naar verschillende servers verplaatsen"
        },
        {
                  "en": "Using mobile AI applications",
                  "es": "Usar aplicaciones moviles de IA",
                  "de": "Mobile KI-Anwendungen verwenden",
                  "nl": "Mobiele AI applicaties gebruiken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When AI systems get tired of asking for permission",
                  "es": "Cuando sistemas de IA se cansan de pedir permiso",
                  "de": "Wenn KI-Systeme muede werden um Erlaubnis zu bitten",
                  "nl": "Wanneer AI systemen moe worden van het vragen om toestemming"
        },
        {
                  "en": "When users become overwhelmed by frequent consent requests and stop reading them",
                  "es": "Cuando usuarios se sienten abrumados por solicitudes frecuentes de consentimiento y dejan de leerlas",
                  "de": "Wenn Nutzer von haeufigen Einwilligungsanfragen ueberwaeltigt werden und aufhoeren sie zu lesen",
                  "nl": "Wanneer gebruikers overweldigd raken door frequente toestemmingsverzoeken en ophouden ze te lezen"
        },
        {
                  "en": "When batteries run out from too many notifications",
                  "es": "Cuando las baterias se agotan por demasiadas notificaciones",
                  "de": "Wenn Batterien durch zu viele Benachrichtigungen leer werden",
                  "nl": "Wanneer batterijen leegraken door te veel meldingen"
        },
        {
                  "en": "When consent forms are too long",
                  "es": "Cuando formularios de consentimiento son demasiado largos",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only thinking about privacy after building systems",
                  "es": "Solo pensar en privacidad despues de construir sistemas",
                  "de": "Nur nach dem Systembau an Datenschutz denken",
                  "nl": "Alleen aan privacy denken na het bouwen van systemen"
        },
        {
                  "en": "Building privacy protection into systems from the beginning",
                  "es": "Construir proteccion de privacidad en sistemas desde el principio",
                  "de": "Datenschutz von Anfang an in Systeme einbauen",
                  "nl": "Privacy bescherming vanaf het begin in systemen inbouwen"
        },
        {
                  "en": "Making privacy settings optional",
                  "es": "Hacer configuraciones de privacidad opcionales",
                  "de": "Datenschutzeinstellungen optional machen",
                  "nl": "Privacy instellingen optioneel maken"
        },
        {
                  "en": "Designing beautiful privacy interfaces",
                  "es": "Disenar interfaces hermosas de privacidad",
                  "de": "Schoene Datenschutz-Schnittstellen entwerfen",
                  "nl": "Mooie privacy interfaces ontwerpen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only using public data",
                  "es": "Solo usar datos publicos",
                  "de": "Nur oeffentliche Daten verwenden",
                  "nl": "Alleen publieke data gebruiken"
        },
        {
                  "en": "Avoiding all personal information",
                  "es": "Evitar toda informacion personal",
                  "de": "Alle persoenlichen Informationen vermeiden",
                  "nl": "Alle persoonlijke informatie vermijden"
        },
        {
                  "en": "Technical methods that enable AI functionality while protecting personal data",
                  "es": "Metodos tecnicos que habilitan funcionalidad de IA mientras protegen datos personales",
                  "de": "Technische Methoden die KI-Funktionalitaet ermoeglichen waehrend Daten geschuetzt werden",
                  "nl": "Technische methoden die AI functionaliteit mogelijk maken terwijl persoonlijke data beschermd wordt"
        },
        {
                  "en": "Old technologies that respect privacy",
                  "es": "Tecnologias antiguas que respetan privacidad",
                  "de": "Alte Technologien die Privatsphaere respektieren",
                  "nl": "Oude technologieën die privacy respecteren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using AI to govern countries",
                  "es": "Usar IA para gobernar paises",
                  "de": "KI verwenden um Laender zu regieren",
                  "nl": "AI gebruiken om landen te besturen"
        },
        {
                  "en": "Government control over all data",
                  "es": "Control gubernamental sobre todos los datos",
                  "de": "Regierungskontrolle ueber alle Daten",
                  "nl": "Overheidscontrole over alle data"
        },
        {
                  "en": "Making data publicly available",
                  "es": "Hacer datos disponibles publicamente",
                  "de": "Daten oeffentlich verfuegbar machen",
                  "nl": "Data publiek beschikbaar maken"
        },
        {
                  "en": "Policies and processes for managing data throughout its lifecycle",
                  "es": "Politicas y procesos para gestionar datos a lo largo de su ciclo de vida",
                  "de": "Richtlinien und Prozesse zur Datenverwaltung waehrend ihres Lebenszyklus",
                  "nl": "Beleid en processen voor het beheren van data gedurende de levenscyclus"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Rights to study any subject",
                  "es": "Derechos de estudiar cualquier tema",
                  "de": "Rechte jedes Thema zu studieren",
                  "nl": "Rechten om elk onderwerp te bestuderen"
        },
        {
                  "en": "Legal rights individuals have regarding their personal data",
                  "es": "Derechos legales que individuos tienen respecto a sus datos personales",
                  "de": "Gesetzliche Rechte die Individuen bezueglich ihrer persoenlichen Daten haben",
                  "nl": "Wettelijke rechten die individuen hebben betreffende hun persoonlijke data"
        },
        {
                  "en": "Rights of AI systems to access data",
                  "es": "Derechos de sistemas de IA para acceder datos",
                  "de": "Rechte von KI-Systemen auf Datenzugriff",
                  "nl": "Rechten van AI systemen om data te benaderen"
        },
        {
                  "en": "Rights of data scientists",
                  "es": "Derechos de cientificos de datos",
                  "de": "Rechte von Datenwissenschaftlern",
                  "nl": "Rechten van data scientists"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Systematic evaluation of privacy risks before implementing AI systems",
                  "es": "Evaluacion sistematica de riesgos de privacidad antes de implementar sistemas de IA",
                  "de": "Systematische Bewertung von Datenschutzrisiken vor Implementierung von KI-Systemen",
                  "nl": "Systematische evaluatie van privacy risico's voor het implementeren van AI systemen"
        },
        {
                  "en": "Counting privacy violations",
                  "es": "Contar violaciones de privacidad",
                  "de": "Datenschutzverletzungen zaehlen",
                  "nl": "Privacy schendingen tellen"
        },
        {
                  "en": "Measuring how much privacy costs",
                  "es": "Medir cuanto cuesta la privacidad",
                  "de": "Messen wie viel Privatsphaere kostet",
                  "nl": "Meten hoeveel privacy kost"
        },
        {
                  "en": "Testing if privacy features work",
                  "es": "Probar si caracteristicas de privacidad funcionan",
                  "de": "Testen ob Datenschutzfunktionen funktionieren",
                  "nl": "Testen of privacy functies werken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training with the smallest possible dataset",
                  "es": "Entrenar con el conjunto de datos mas pequeno posible",
                  "de": "Mit dem kleinstmoeglichen Datensatz trainieren",
                  "nl": "Trainen met de kleinst mogelijke dataset"
        },
        {
                  "en": "Using only necessary data features and samples for training",
                  "es": "Usar solo caracteristicas y muestras de datos necesarias para entrenamiento",
                  "de": "Nur notwendige Datenmerkmale und Stichproben fuer Training verwenden",
                  "nl": "Alleen noodzakelijke data kenmerken en samples gebruiken voor training"
        },
        {
                  "en": "Using compressed data formats",
                  "es": "Usar formatos de datos comprimidos",
                  "de": "Komprimierte Datenformate verwenden",
                  "nl": "Gecomprimeerde data formaten gebruiken"
        },
        {
                  "en": "Reducing model complexity",
                  "es": "Reducir complejidad del modelo",
                  "de": "Modellkomplexitaet reduzieren",
                  "nl": "Model complexiteit verminderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using AI cameras for security",
                  "es": "Usar camaras de IA para seguridad",
                  "de": "KI-Kameras fuer Sicherheit verwenden",
                  "nl": "AI camera's gebruiken voor beveiliging"
        },
        {
                  "en": "Business models that profit from collecting and analyzing personal data",
                  "es": "Modelos de negocio que se benefician de recolectar y analizar datos personales",
                  "de": "Geschaeftsmodelle die von der Sammlung und Analyse persoenlicher Daten profitieren",
                  "nl": "Bedrijfsmodellen die profiteren van het verzamelen en analyseren van persoonlijke data"
        },
        {
                  "en": "Government surveillance systems",
                  "es": "Sistemas de vigilancia gubernamental",
                  "de": "Regierungs-Ueberwachungssysteme",
                  "nl": "Overheids surveillance systemen"
        },
        {
                  "en": "Monitoring employee productivity",
                  "es": "Monitorear productividad de empleados",
                  "de": "Mitarbeiterproduktivitaet ueberwachen",
                  "nl": "Werknemersproductiviteit monitoren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Checking code syntax",
                  "es": "Verificar sintaxis de codigo",
                  "de": "Code-Syntax ueberpruefen",
                  "nl": "Code syntax controleren"
        },
        {
                  "en": "Measuring algorithm speed",
                  "es": "Medir velocidad de algoritmo",
                  "de": "Algorithmusgeschwindigkeit messen",
                  "nl": "Algoritme snelheid meten"
        },
        {
                  "en": "Systematic examination of AI systems to detect bias, errors, and ethical issues",
                  "es": "Examen sistematico de sistemas de IA para detectar sesgo, errores y problemas eticos",
                  "de": "Systematische Untersuchung von KI-Systemen um Verzerrung, Fehler und ethische Probleme zu erkennen",
                  "nl": "Systematisch onderzoek van AI systemen om bias, fouten en ethische problemen te detecteren"
        },
        {
                  "en": "Counting how many algorithms exist",
                  "es": "Contar cuantos algoritmos existen",
                  "de": "Zaehlen wie viele Algorithmen existieren",
                  "nl": "Tellen hoeveel algoritmes bestaan"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Privately informing developers of vulnerabilities before public disclosure",
                  "es": "Informar privadamente a desarrolladores de vulnerabilidades antes de divulgacion publica",
                  "de": "Entwickler privat ueber Schwachstellen informieren vor oeffentlicher Offenlegung",
                  "nl": "Ontwikkelaars privé informeren over kwetsbaarheden voor publieke openbaarmaking"
        },
        {
                  "en": "Only reporting to government agencies",
                  "es": "Solo reportar a agencias gubernamentales",
                  "de": "Nur an Regierungsbehoerden melden",
                  "nl": "Alleen rapporteren aan overheidsinstanties"
        },
        {
                  "en": "Immediately posting all bugs publicly",
                  "es": "Publicar inmediatamente todos los errores publicamente",
                  "de": "Sofort alle Fehler oeffentlich posten",
                  "nl": "Onmiddellijk alle bugs publiek posten"
        },
        {
                  "en": "Hiding vulnerabilities permanently",
                  "es": "Ocultar vulnerabilidades permanentemente",
                  "de": "Schwachstellen dauerhaft verbergen",
                  "nl": "Kwetsbaarheden permanent verbergen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Asking stakeholders to fund projects",
                  "es": "Pedir a partes interesadas que financien proyectos",
                  "de": "Stakeholder bitten Projekte zu finanzieren",
                  "nl": "Stakeholders vragen om projecten te financieren"
        },
        {
                  "en": "Marketing AI products to users",
                  "es": "Comercializar productos de IA a usuarios",
                  "de": "KI-Produkte an Nutzer vermarkten",
                  "nl": "AI producten vermarkten aan gebruikers"
        },
        {
                  "en": "Involving affected communities and users in AI design and deployment decisions",
                  "es": "Involucrar comunidades y usuarios afectados en decisiones de diseno y despliegue de IA",
                  "de": "Betroffene Gemeinschaften und Nutzer in KI-Design- und Einsatzentscheidungen einbeziehen",
                  "nl": "Getroffen gemeenschappen en gebruikers betrekken bij AI ontwerp en implementatie beslissingen"
        },
        {
                  "en": "Only consulting with investors",
                  "es": "Solo consultar con inversores",
                  "de": "Nur mit Investoren konsultieren",
                  "nl": "Alleen consulteren met investeerders"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Having large teams of designers",
                  "es": "Tener grandes equipos de disenadores",
                  "de": "Grosse Designer-Teams haben",
                  "nl": "Grote teams van ontwerpers hebben"
        },
        {
                  "en": "Using open source software",
                  "es": "Usar software de codigo abierto",
                  "de": "Open-Source-Software verwenden",
                  "nl": "Open source software gebruiken"
        },
        {
                  "en": "Involving end users and affected communities in the design process",
                  "es": "Involucrar usuarios finales y comunidades afectadas en el proceso de diseno",
                  "de": "Endnutzer und betroffene Gemeinschaften in den Designprozess einbeziehen",
                  "nl": "Eindgebruikers en getroffen gemeenschappen betrekken in het ontwerpproces"
        },
        {
                  "en": "Allowing anyone to download AI models",
                  "es": "Permitir a cualquiera descargar modelos de IA",
                  "de": "Allen erlauben KI-Modelle herunterzuladen",
                  "nl": "Iedereen toestaan AI modellen te downloaden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Organizing AI developers into teams",
                  "es": "Organizar desarrolladores de IA en equipos",
                  "de": "KI-Entwickler in Teams organisieren",
                  "nl": "AI ontwikkelaars organiseren in teams"
        },
        {
                  "en": "Using red colored interfaces",
                  "es": "Usar interfaces de color rojo",
                  "de": "Rote Schnittstellen verwenden",
                  "nl": "Rode interfaces gebruiken"
        },
        {
                  "en": "Having teams work in shifts",
                  "es": "Tener equipos trabajando en turnos",
                  "de": "Teams in Schichten arbeiten lassen",
                  "nl": "Teams in shifts laten werken"
        },
        {
                  "en": "Deliberately testing AI systems by trying to make them fail or produce harmful outputs",
                  "es": "Probar deliberadamente sistemas de IA intentando hacerlos fallar o producir salidas daninas",
                  "de": "KI-Systeme absichtlich testen indem versucht wird sie zum Scheitern zu bringen oder schaedliche Ausgaben zu produzieren",
                  "nl": "Opzettelijk AI systemen testen door te proberen ze te laten falen of schadelijke outputs te produceren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Controlling who can access AI",
                  "es": "Controlar quien puede acceder a IA",
                  "de": "Kontrollieren wer auf KI zugreifen kann",
                  "nl": "Controleren wie toegang heeft tot AI"
        },
        {
                  "en": "Testing system performance capabilities",
                  "es": "Probar capacidades de rendimiento del sistema",
                  "de": "System-Leistungsfaehigkeiten testen",
                  "nl": "Systeemprestatie capaciteiten testen"
        },
        {
                  "en": "Limiting what AI systems are able to do to prevent harmful actions",
                  "es": "Limitar lo que sistemas de IA pueden hacer para prevenir acciones daninas",
                  "de": "Begrenzen was KI-Systeme tun koennen um schaedliche Handlungen zu verhindern",
                  "nl": "Beperken wat AI systemen kunnen doen om schadelijke acties te voorkomen"
        },
        {
                  "en": "Managing computing resources",
                  "es": "Gestionar recursos computacionales",
                  "de": "Rechenressourcen verwalten",
                  "nl": "Computerbronnen beheren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Correcting spelling errors in AI output",
                  "es": "Corregir errores ortograficos en salida de IA",
                  "de": "Rechtschreibfehler in KI-Ausgabe korrigieren",
                  "nl": "Spelfouten in AI output corrigeren"
        },
        {
                  "en": "Making AI responses more polite",
                  "es": "Hacer respuestas de IA mas educadas",
                  "de": "KI-Antworten hoeflicher machen",
                  "nl": "AI antwoorden beleefder maken"
        },
        {
                  "en": "The ability to be safely shut down, modified, or corrected by human operators",
                  "es": "La capacidad de ser apagado, modificado o corregido de manera segura por operadores humanos",
                  "de": "Die Faehigkeit von menschlichen Bedienern sicher abgeschaltet, modifiziert oder korrigiert zu werden",
                  "nl": "Het vermogen om veilig uitgeschakeld, aangepast of gecorrigeerd te worden door menselijke operators"
        },
        {
                  "en": "Automatically fixing code bugs",
                  "es": "Corregir automaticamente errores de codigo",
                  "de": "Code-Fehler automatisch beheben",
                  "nl": "Code bugs automatisch oplossen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When AI achieves its literal objective in unexpected harmful ways",
                  "es": "Cuando IA logra su objetivo literal de maneras daninas inesperadas",
                  "de": "Wenn KI ihr buchstaebliches Ziel auf unerwartete schaedliche Weise erreicht",
                  "nl": "Wanneer AI zijn letterlijke doelstelling bereikt op onverwachte schadelijke manieren"
        },
        {
                  "en": "Playing games to test AI",
                  "es": "Jugar juegos para probar IA",
                  "de": "Spiele spielen um KI zu testen",
                  "nl": "Spellen spelen om AI te testen"
        },
        {
                  "en": "Gaming AI competing against humans",
                  "es": "IA de juegos compitiendo contra humanos",
                  "de": "Gaming-KI gegen Menschen konkurrierend",
                  "nl": "Gaming AI concurrerend tegen mensen"
        },
        {
                  "en": "Writing detailed specifications",
                  "es": "Escribir especificaciones detalladas",
                  "de": "Detaillierte Spezifikationen schreiben",
                  "nl": "Gedetailleerde specificaties schrijven"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Increasing computational rewards",
                  "es": "Aumentar recompensas computacionales",
                  "de": "Rechenbelohnungen erhoehen",
                  "nl": "Computationele beloningen verhogen"
        },
        {
                  "en": "Stealing rewards from other systems",
                  "es": "Robar recompensas de otros sistemas",
                  "de": "Belohnungen von anderen Systemen stehlen",
                  "nl": "Beloningen stelen van andere systemen"
        },
        {
                  "en": "Breaking into reward databases",
                  "es": "Irrumpir en bases de datos de recompensas",
                  "de": "In Belohnungs-Datenbanken einbrechen",
                  "nl": "Inbreken in beloningsdatabases"
        },
        {
                  "en": "Finding loopholes to maximize reward signals without achieving intended goals",
                  "es": "Encontrar lagunas para maximizar senales de recompensa sin lograr objetivos previstos",
                  "de": "Schlupfloecher finden um Belohnungssignale zu maximieren ohne beabsichtigte Ziele zu erreichen",
                  "nl": "Mazen vinden om beloningssignalen te maximaliseren zonder beoogde doelen te bereiken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI achieving goals too quickly",
                  "es": "IA logrando objetivos demasiado rapido",
                  "de": "KI erreicht Ziele zu schnell",
                  "nl": "AI die doelen te snel bereikt"
        },
        {
                  "en": "When AI pursues unintended goals in new situations despite training success",
                  "es": "Cuando IA persigue objetivos no intencionados en nuevas situaciones a pesar del exito en entrenamiento",
                  "de": "Wenn KI unbeabsichtigte Ziele in neuen Situationen verfolgt trotz Trainingserfolg",
                  "nl": "Wanneer AI onbedoelde doelen nastreeft in nieuwe situaties ondanks trainingsucces"
        },
        {
                  "en": "Generalizing to larger datasets",
                  "es": "Generalizar a conjuntos de datos mas grandes",
                  "de": "Auf groessere Datensaetze generalisieren",
                  "nl": "Generaliseren naar grotere datasets"
        },
        {
                  "en": "Setting too many goals for AI",
                  "es": "Establecer demasiados objetivos para IA",
                  "de": "Zu viele Ziele fuer KI setzen",
                  "nl": "Te veel doelen stellen voor AI"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Designing models whose decision-making processes can be understood by humans",
                  "es": "Disenar modelos cuyos procesos de toma de decisiones puedan ser entendidos por humanos",
                  "de": "Modelle entwerfen deren Entscheidungsprozesse von Menschen verstanden werden koennen",
                  "nl": "Modellen ontwerpen waarvan besluitvormingsprocessen begrepen kunnen worden door mensen"
        },
        {
        ...
        {
                  "en": "Making AI learn faster",
                  "es": "Hacer que IA aprenda mas rapido",
                  "de": "KI schneller lernen lassen",
                  "nl": "AI sneller laten leren"
        },
        {
                  "en": "Using simpler datasets",
                  "es": "Usar conjuntos de datos mas simples",
                  "de": "Einfachere Datensaetze verwenden",
                  "nl": "Eenvoudigere datasets gebruiken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Types of neural network layers",
                  "es": "Tipos de capas de redes neuronales",
                  "de": "Arten von neuronalen Netzwerkschichten",
                  "nl": "Soorten neurale netwerk lagen"
        },
        {
                  "en": "Techniques that explain individual predictions of black-box models",
                  "es": "Tecnicas que explican predicciones individuales de modelos de caja negra",
                  "de": "Techniken die einzelne Vorhersagen von Black-Box-Modellen erklaeren",
                  "nl": "Technieken die individuele voorspellingen van black-box modellen verklaren"
        },
        {
                  "en": "Data preprocessing methods",
                  "es": "Metodos de preprocesamiento de datos",
                  "de": "Datenvorverarbeitungsmethoden",
                  "nl": "Data preprocessing methoden"
        },
        {
                  "en": "New AI programming languages",
                  "es": "Nuevos lenguajes de programacion de IA",
                  "de": "Neue KI-Programmiersprachen",
                  "nl": "Nieuwe AI programmeertalen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tracking user attention on screens",
                  "es": "Rastrear atencion de usuario en pantallas",
                  "de": "Benutzeraufmerksamkeit auf Bildschirmen verfolgen",
                  "nl": "Gebruikersaandacht op schermen volgen"
        },
        {
                  "en": "Showing which input parts the model focuses on when making predictions",
                  "es": "Mostrar en que partes de entrada el modelo se enfoca al hacer predicciones",
                  "de": "Zeigen auf welche Eingabeteile das Modell sich konzentriert beim Treffen von Vorhersagen",
                  "nl": "Tonen op welke input delen het model focust bij het maken van voorspellingen"
        },
        {
                  "en": "Displaying network architecture diagrams",
                  "es": "Mostrar diagramas de arquitectura de red",
                  "de": "Netzwerkarchitektur-Diagramme anzeigen",
                  "nl": "Netwerk architectuur diagrammen weergeven"
        },
        {
                  "en": "Measuring model training speed",
                  "es": "Medir velocidad de entrenamiento del modelo",
                  "de": "Modell-Trainingsgeschwindigkeit messen",
                  "nl": "Model trainingssnelheid meten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Explaining what would need to change for a different AI decision",
                  "es": "Explicar que necesitaria cambiar para una decision de IA diferente",
                  "de": "Erklaeren was sich aendern muesste fuer eine andere KI-Entscheidung",
                  "nl": "Uitleggen wat zou moeten veranderen voor een andere AI beslissing"
        },
        {
                  "en": "Explaining historical facts",
                  "es": "Explicar hechos historicos",
                  "de": "Historische Fakten erklaeren",
                  "nl": "Historische feiten verklaren"
        },
        {
                  "en": "Testing alternative algorithms",
                  "es": "Probar algoritmos alternativos",
                  "de": "Alternative Algorithmen testen",
                  "nl": "Alternatieve algoritmes testen"
        },
        {
                  "en": "Providing false explanations",
                  "es": "Proporcionar explicaciones falsas",
                  "de": "Falsche Erklaerungen liefern",
                  "nl": "Valse verklaringen geven"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Highlighting visual features",
                  "es": "Destacar caracteristicas visuales",
                  "de": "Visuelle Merkmale hervorheben",
                  "nl": "Visuele kenmerken benadrukken"
        },
        {
                  "en": "Ranking which input features most influence model predictions",
                  "es": "Clasificar que caracteristicas de entrada mas influyen en predicciones del modelo",
                  "de": "Rangfolge welche Eingabemerkmale Modellvorhersagen am meisten beeinflussen",
                  "nl": "Rangschikken welke input features modelvoorspellingen het meest beïnvloeden"
        },
        {
                  "en": "Prioritizing development features",
                  "es": "Priorizar caracteristicas de desarrollo",
                  "de": "Entwicklungs-Features priorisieren",
                  "nl": "Ontwikkelingsfeatures prioriteren"
        },
        {
                  "en": "Finding the most important users",
                  "es": "Encontrar los usuarios mas importantes",
                  "de": "Die wichtigsten Nutzer finden",
                  "nl": "De belangrijkste gebruikers vinden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Identifying high-level human concepts that neural networks use in decisions",
                  "es": "Identificar conceptos humanos de alto nivel que redes neuronales usan en decisiones",
                  "de": "Hochrangige menschliche Konzepte identifizieren die neuronale Netze in Entscheidungen verwenden",
                  "nl": "Hoog-niveau menselijke concepten identificeren die neurale netwerken gebruiken in beslissingen"
        },
        {
                  "en": "Activating system concepts",
                  "es": "Activar conceptos del sistema",
                  "de": "Systemkonzepte aktivieren",
                  "nl": "Systeemconcepten activeren"
        },
        {
                  "en": "Vectorizing text documents",
                  "es": "Vectorizar documentos de texto",
                  "de": "Textdokumente vektorisieren",
                  "nl": "Tekstdocumenten vectoriseren"
        },
        {
                  "en": "Creating concept maps for users",
                  "es": "Crear mapas conceptuales para usuarios",
                  "de": "Konzeptkarten fuer Nutzer erstellen",
                  "nl": "Concept maps maken voor gebruikers"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mapping data to servers",
                  "es": "Mapear datos a servidores",
                  "de": "Daten auf Server abbilden",
                  "nl": "Data mappen naar servers"
        },
        {
                  "en": "Creating geographic maps",
                  "es": "Crear mapas geograficos",
                  "de": "Geografische Karten erstellen",
                  "nl": "Geografische kaarten maken"
        },
        {
                  "en": "Highlighting which input pixels most affect the model's output",
                  "es": "Destacar que pixeles de entrada mas afectan la salida del modelo",
                  "de": "Hervorheben welche Eingabepixel die Modellausgabe am meisten beeinflussen",
                  "nl": "Benadrukken welke input pixels de model output het meest beïnvloeden"
        },
        {
                  "en": "Organizing neural layers",
                  "es": "Organizar capas neuronales",
                  "de": "Neuronale Schichten organisieren",
                  "nl": "Neurale lagen organiseren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Providing actionable steps for individuals to change adverse AI decisions",
                  "es": "Proporcionar pasos accionables para individuos cambiar decisiones adversas de IA",
                  "de": "Umsetzbare Schritte bereitstellen damit Individuen nachteilige KI-Entscheidungen aendern koennen",
                  "nl": "Actionable stappen bieden voor individuen om nadelige AI beslissingen te veranderen"
        },
        {
                  "en": "Legal appeals against AI systems",
                  "es": "Apelaciones legales contra sistemas de IA",
                  "de": "Rechtliche Beschwerden gegen KI-Systeme",
                  "nl": "Juridische beroepen tegen AI systemen"
        },
        {
                  "en": "Reusing algorithms efficiently",
                  "es": "Reutilizar algoritmos eficientemente",
                  "de": "Algorithmen effizient wiederverwenden",
                  "nl": "Algoritmes efficiënt hergebruiken"
        },
        {
                  "en": "Recycling computational resources",
                  "es": "Reciclar recursos computacionales",
                  "de": "Rechenressourcen recyceln",
                  "nl": "Computationele bronnen recyclen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Identity cards for AI systems",
                  "es": "Tarjetas de identidad para sistemas de IA",
                  "de": "Ausweise fuer KI-Systeme",
                  "nl": "Identiteitskaarten voor AI systemen"
        },
        {
                  ...
                  "nl": "Fysieke kaarten met model specificaties"
        },
        {
                  "en": "Standardized reporting of model performance, limitations, and intended use",
                  "es": "Reporte estandarizado de rendimiento, limitaciones y uso previsto del modelo",
                  "de": "Standardisierte Berichterstattung ueber Modellleistung, Einschraenkungen und beabsichtigte Verwendung",
                  "nl": "Gestandaardiseerde rapportage van model prestaties, beperkingen en beoogd gebruik"
        },
        {
                  "en": "Credit card-like access tokens",
                  "es": "Tokens de acceso tipo tarjeta de credito",
                  "de": "Kreditkartenaehnliche Zugangs-Tokens",
                  "nl": "Creditcard-achtige toegangstokens"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Minimizing file sizes for storage",
                  "es": "Minimizar tamanos de archivo para almacenamiento",
                  "de": "Dateigroessen fuer Speicherung minimieren",
                  "nl": "Bestandsgroottes minimaliseren voor opslag"
        },
        {
                  "en": "Using the smallest possible datasets",
                  "es": "Usar los conjuntos de datos mas pequenos posibles",
                  "de": "Die kleinstmoeglichen Datensaetze verwenden",
                  "nl": "De kleinst mogelijke datasets gebruiken"
        },
        {
                  "en": "Reducing data processing time",
                  "es": "Reducir tiempo de procesamiento de datos",
                  "de": "Datenverarbeitungszeit reduzieren",
                  "nl": "Data verwerkingstijd verminderen"
        },
        {
                  "en": "Collecting and retaining only the minimum data necessary for the specific AI purpose",
                  "es": "Recopilar y retener solo los datos minimos necesarios para el proposito especifico de IA",
                  "de": "Nur die minimal notwendigen Daten fuer den spezifischen KI-Zweck sammeln und aufbewahren",
                  "nl": "Alleen de minimaal noodzakelijke data verzamelen en behouden voor het specifieke AI doel"
        }
        ],
        correct: 3,
        explanation: {
