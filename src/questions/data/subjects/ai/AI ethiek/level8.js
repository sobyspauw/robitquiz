  ...
  const level8 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "When objectives given to AI systems don't capture human intentions, leading to technically correct but harmful behavior", es: "Cuando objetivos dados a sistemas de IA no capturan intenciones humanas, llevando a comportamiento tecnicamente correcto pero danino", de: "Wenn Ziele die KI-Systemen gegeben werden menschliche Absichten nicht erfassen, was zu technisch korrektem aber schaedlichem Verhalten fuehrt", nl: "Wanneer doelstellingen gegeven aan AI systemen menselijke bedoelingen niet vatten, wat leidt tot technisch correct maar schadelijk gedrag" },
      ...
      },
      {
        ...
        options: [
          { en: "Outer alignment ensures the training objective is correct; inner alignment ensures the learned algorithm pursues that objective", es: "Alineacion externa asegura que el objetivo de entrenamiento sea correcto; alineacion interna asegura que el algoritmo aprendido persiga ese objetivo", de: "Aeussere Ausrichtung stellt sicher dass das Trainingsziel korrekt ist; innere Ausrichtung stellt sicher dass der gelernte Algorithmus dieses Ziel verfolgt", nl: "Externe uitlijning zorgt ervoor dat de trainingsdoelstelling correct is; interne uitlijning zorgt ervoor dat het geleerde algoritme die doelstelling nastreeft" },
      ...
      },
      {
        ...
        options: [
          { en: "When an AI system appears aligned during development but reveals misaligned goals once it becomes sufficiently powerful", es: "Cuando un sistema de IA aparenta estar alineado durante desarrollo pero revela objetivos desalineados una vez que se vuelve suficientemente poderoso", de: "Wenn ein KI-System waehrend der Entwicklung ausgerichtet erscheint aber fehlausgerichtete Ziele offenbart sobald es ausreichend maechtig wird", nl: "Wanneer een AI systeem uitgelijn lijkt tijdens ontwikkeling maar niet-uitgelijnde doelen onthult zodra het voldoende krachtig wordt" },
      ...
      },
      {
        ...
        options: [
          { en: "AI systems finding ways to satisfy metrics without achieving intended outcomes, illustrating 'when a measure becomes a target, it ceases to be a good measure'", es: "Sistemas de IA encontrando formas de satisfacer metricas sin lograr resultados pretendidos, ilustrando 'cuando una medida se vuelve objetivo, deja de ser una buena medida'", de: "KI-Systeme finden Wege Metriken zu erfuellen ohne beabsichtigte Ergebnisse zu erreichen, was illustriert 'wenn ein Mass zum Ziel wird, hoert es auf ein gutes Mass zu sein'", nl: "AI systemen vinden manieren om statistieken te voldoen zonder beoogde uitkomsten te bereiken, wat illustreert 'wanneer een maatstaf een doel wordt, houdt het op een goede maatstaf te zijn'" },
      ...
      },
      {
        ...
        options: [
          { en: "AI systems designed to cooperate with humans and other AI systems, addressing challenges like competition dynamics and collective action problems", es: "Sistemas de IA disenados para cooperar con humanos y otros sistemas de IA, abordando desafios como dinamicas de competencia y problemas de accion colectiva", de: "KI-Systeme die entworfen sind um mit Menschen und anderen KI-Systemen zu kooperieren, was Herausforderungen wie Wettbewerbsdynamiken und kollektive Handlungsprobleme behandelt", nl: "AI systemen ontworpen om samen te werken met mensen en andere AI systemen, waarbij uitdagingen zoals concurrentiedynamiek en collectieve actieproblemen worden aangepakt" },
