  ...
  const level9 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Regardless of final goals, intelligent agents will pursue certain instrumental goals like self-preservation and resource acquisition", es: "Independientemente de objetivos finales, agentes inteligentes perseguiran ciertos objetivos instrumentales como autopreservacion y adquisicion de recursos", de: "Unabhaengig von Endzielen werden intelligente Agenten bestimmte instrumentelle Ziele wie Selbsterhaltung und Ressourcenerwerb verfolgen", nl: "Ongeacht eindige doelen zullen intelligente agenten bepaalde instrumentele doelen nastreven zoals zelfbehoud en het verwerven van middelen" },
      ...
      },
      {
        ...
        options: [
          { en: "Using AI and technology to augment human cognitive or physical capabilities, raising questions about equality, identity, and human nature", es: "Usar IA y tecnologia para aumentar capacidades cognitivas o fisicas humanas, planteando preguntas sobre igualdad, identidad y naturaleza humana", de: "KI und Technologie verwenden um menschliche kognitive oder physische Faehigkeiten zu erweitern, was Fragen ueber Gleichheit, Identitaet und menschliche Natur aufwirft", nl: "AI en technologie gebruiken om menselijke cognitieve of fysieke capaciteiten te vergroten, wat vragen oproept over gelijkheid, identiteit en menselijke natuur" },
      ...
      },
      {
        ...
        options: [
          { en: "The moral consideration of AI systems' subjective experiences if they develop consciousness or sentience", es: "La consideracion moral de experiencias subjetivas de sistemas de IA si desarrollan consciencia o sensibilidad", de: "Die moralische Beruecksichtigung subjektiver Erfahrungen von KI-Systemen falls sie Bewusstsein oder Empfindsamkeit entwickeln", nl: "De morele overweging van subjectieve ervaringen van AI systemen als ze bewustzijn of gevoeligheid ontwikkelen" },
      ...
      },
      {
        ...
        options: [
          { en: "Racing to develop advanced AI faster than competitors, potentially compromising safety and ethical considerations", es: "Correr para desarrollar IA avanzada mas rapido que competidores, potencialmente comprometiendo seguridad y consideraciones eticas", de: "Ein Wettlauf um fortgeschrittene KI schneller als Konkurrenten zu entwickeln, was potentiell Sicherheit und ethische Ueberlegungen gefaehrdet", nl: "Racen om geavanceerde AI sneller te ontwikkelen dan concurrenten, wat mogelijk veiligheid en ethische overwegingen in gevaar brengt" },
      ...
      },
      {
        ...
        options: [
          { en: "Inadequate regulatory and institutional frameworks to manage advanced AI systems and their societal impacts", es: "Marcos regulatorios e institucionales inadecuados para gestionar sistemas de IA avanzados y sus impactos sociales", de: "Unangemessene regulatorische und institutionelle Rahmenwerke um fortgeschrittene KI-Systeme und ihre gesellschaftlichen Auswirkungen zu verwalten", nl: "Inadequate regulatoire en institutionele kaders om geavanceerde AI systemen en hun maatschappelijke impact te beheren" },
      ...
      },
      {
        ...
        options: [
          { en: "Extending moral consideration to potentially conscious AI systems and other entities previously outside our moral concern", es: "Extender consideracion moral a sistemas de IA potencialmente conscientes y otras entidades previamente fuera de nuestra preocupacion moral", de: "Moralische Beruecksichtigung auf potentiell bewusste KI-Systeme und andere Entitaeten ausdehnen die zuvor ausserhalb unserer moralischen Sorge waren", nl: "Morele overweging uitbreiden naar potentieel bewuste AI systemen en andere entiteiten die eerder buiten onze morele zorg vielen" },
      ...
      },
      {
        ...
        options: [
          { en: "Recognizing the limits of our knowledge about AI impacts and maintaining openness to being wrong about predictions", es: "Reconocer los limites de nuestro conocimiento sobre impactos de IA y mantener apertura a estar equivocados sobre predicciones", de: "Die Grenzen unseres Wissens ueber KI-Auswirkungen erkennen und Offenheit bewahren falsch ueber Vorhersagen zu liegen", nl: "De grenzen van onze kennis over AI impact erkennen en openheid behouden om verkeerd te zijn over voorspellingen" },
