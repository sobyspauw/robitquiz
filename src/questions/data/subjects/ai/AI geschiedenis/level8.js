    ...
    questions: [
      {
        ...
        {
                  "en": "It introduced bidirectional context understanding for language models",
                  "es": "Introdujo comprensión de contexto bidireccional para modelos de lenguaje",
                  "de": "Es führte bidirektionales Kontextverständnis für Sprachmodelle ein",
                  "nl": "Het introduceerde bidirectioneel contextbegrip voor taalmodellen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It demonstrated the limitations of single-layer perceptrons",
                  "es": "Demostró las limitaciones de perceptrones de una sola capa",
                  "de": "Es demonstrierte die Begrenzungen einschichtiger Perceptrons",
                  "nl": "Het toonde de beperkingen van enkele-laags perceptrons"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They invented the microprocessor",
                  "es": "Inventaron el microprocesador",
                  "de": "Sie erfanden den Mikroprozessor",
                  "nl": "Ze vonden de microprocessor uit"
        },
        {
                  "en": "They developed the first operating system",
                  "es": "Desarrollaron el primer sistema operativo",
                  "de": "Sie entwickelten das erste Betriebssystem",
                  "nl": "Ze ontwikkelden het eerste besturingssysteem"
        },
        {
                  "en": "They developed SHAKEY, the first mobile robot with AI reasoning capabilities",
                  "es": "Desarrollaron SHAKEY, el primer robot móvil con capacidades de razonamiento de IA",
                  "de": "Sie entwickelten SHAKEY, den ersten mobilen Roboter mit KI-Denkfähigkeiten",
                  "nl": "Ze ontwikkelden SHAKEY, de eerste mobiele robot met AI redeneringscapaciteiten"
        },
        {
                  "en": "They created the first computer virus",
                  "es": "Crearon el primer virus informático",
                  "de": "Sie schufen den ersten Computervirus",
                  "nl": "Ze creëerden het eerste computervirus"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It provided a model-free method for learning optimal policies in reinforcement learning",
                  "es": "Proporcionó un método libre de modelos para aprender políticas óptimas en aprendizaje por refuerzo",
                  "de": "Es bot eine modellfreie Methode zum Lernen optimaler Strategien im Reinforcement Learning",
                  "nl": "Het bood een modelvrije methode voor het leren van optimale beleidslijnen in reinforcement learning"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They provided a powerful method for classification and regression with strong theoretical foundations",
                  "es": "Proporcionaron un método poderoso para clasificación y regresión con fundamentos teóricos sólidos",
                  "de": "Sie boten eine mächtige Methode für Klassifikation und Regression mit starken theoretischen Grundlagen",
                  "nl": "Ze boden een krachtige methode voor classificatie en regressie met sterke theoretische fundamenten"
        },
        {
                  "en": "They invented the first computer",
                  "es": "Inventaron la primera computadora",
                  "de": "Sie erfanden den ersten Computer",
                  "nl": "Ze vonden de eerste computer uit"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "It was the first time AI defeated a world champion at Go, a game more complex than chess",
                  "es": "Fue la primera vez que IA derrotó a un campeón mundial en Go, un juego más complejo que ajedrez",
                  "de": "Es war das erste Mal dass KI einen Weltmeister in Go besiegte, einem komplexeren Spiel als Schach",
                  "nl": "Het was de eerste keer dat AI een wereldkampioen versloeg in Go, een spel complexer dan schaak"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Máquinas de Vectores de Soporte",
                  "de": "Support Vector Machines",
                  "nl": "Support Vector Machines"
        },
        {
                  "en": "The Transformer architecture",
                  "es": "La arquitectura Transformer",
                  "de": "Die Transformer-Architektur",
                  "nl": "De Transformer architectuur"
        },
        {
                  "en": "Convolutional Neural Networks",
                  "es": "Redes Neuronales Convolucionales",
                  "de": "Konvolutionale Neurale Netzwerke",
                  "nl": "Convolutionele Neurale Netwerken"
        },
        {
                  "en": "Recurrent Neural Networks",
                  "es": "Redes Neuronales Recurrentes",
                  "de": "Rekurrente Neurale Netzwerke",
                  "nl": "Recurrente Neurale Netwerken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It became the first AI to defeat professional human teams at Dota 2, a complex real-time strategy game",
                  "es": "Se convirtió en la primera IA en derrotar equipos humanos profesionales en Dota 2, un juego de estrategia en tiempo real complejo",
                  "de": "Es wurde die erste KI die professionelle menschliche Teams in Dota 2 besiegte, einem komplexen Echtzeitstrategie-Spiel",
                  "nl": "Het werd de eerste AI die professionele menselijke teams versloeg in Dota 2, een complex real-time strategie spel"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It solved natural language processing completely",
                  "es": "Resolvió el procesamiento de lenguaje natural completamente",
                  "de": "Es löste natürliche Sprachverarbeitung vollständig",
                  "nl": "Het loste natuurlijke taalverwerking volledig op"
        },
        {
                  "en": "It created the first computer",
                  "es": "Creó la primera computadora",
        ...
        {
                  "en": "It solved the vanishing gradient problem, enabling training of very deep neural networks",
                  "es": "Resolvió el problema del gradiente que desaparece, permitiendo entrenamiento de redes neuronales muy profundas",
                  "de": "Es löste das Problem verschwindender Gradienten und ermöglichte Training sehr tiefer neuronaler Netzwerke",
                  "nl": "Het loste het verdwijnende gradiënt probleem op, waardoor training van zeer diepe neurale netwerken mogelijk werd"
        },
        {
                  "en": "It invented the internet",
                  "es": "Inventó internet",
      ...
      },
      {
        ...
        {
                  "en": "They enabled high-quality generation of realistic images through adversarial training",
                  "es": "Permitieron generación de alta calidad de imágenes realistas a través de entrenamiento adversarial",
                  "de": "Sie ermöglichten hochqualitative Generierung realistischer Bilder durch adversariales Training",
                  "nl": "Ze maakten hoogwaardige generatie van realistische afbeeldingen mogelijk door adversarial training"
        },
        {
        ...
        {
                  "en": "They invented time travel",
                  "es": "Inventaron el viaje en el tiempo",
                  "de": "Sie erfanden Zeitreisen",
                  "nl": "Ze vonden tijdreizen uit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It created dense vector representations of words that captured semantic relationships",
                  "es": "Creó representaciones vectoriales densas de palabras que capturaron relaciones semánticas",
                  "de": "Es schuf dichte Vektordarstellungen von Wörtern die semantische Beziehungen erfassten",
                  "nl": "Het creëerde dichte vectorrepresentaties van woorden die semantische relaties vastlegden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It achieved Grandmaster level in StarCraft II, mastering complex real-time strategy with imperfect information",
                  "es": "Alcanzó nivel Gran Maestro en StarCraft II, dominando estrategia compleja en tiempo real con información imperfecta",
                  "de": "Es erreichte Großmeister-Niveau in StarCraft II und beherrschte komplexe Echtzeitstrategie mit unvollständigen Informationen",
                  "nl": "Het behaalde Grandmaster niveau in StarCraft II, waarbij complexe real-time strategie met onvolledige informatie werd beheerst"
        },
        {
                  "en": "It invented quantum mechanics",
                  "es": "Inventó la mecánica cuántica",
                  "de": "Es erfand die Quantenmechanik",
                  "nl": "Het vond quantummechanica uit"
        },
        {
                  "en": "It solved protein folding",
                  "es": "Resolvió el plegamiento de proteínas",
                  "de": "Es löste Proteinfaltung",
                  "nl": "Het loste proteïnevouwing op"
        },
        {
                  "en": "It created the first computer",
                  "es": "Creó la primera computadora",
      ...
      },
      {
        ...
        {
                  "en": "It drove rapid improvements in deep learning for image recognition, culminating in superhuman performance",
                  "es": "Impulsó mejoras rápidas en aprendizaje profundo para reconocimiento de imágenes, culminando en rendimiento sobrehumano",
                  "de": "Es trieb schnelle Verbesserungen im Deep Learning für Bilderkennung voran und gipfelte in übermenschlicher Leistung",
                  "nl": "Het dreef snelle verbeteringen in deep learning voor beeldherkenning aan, culminerend in bovenmenselijke prestaties"
        },
        {
                  "en": "It invented quantum computing",
                  "es": "Inventó la computación cuántica",
      ...
      },
      {
        ...
        {
                  "en": "It successfully combined deep learning with reinforcement learning, achieving human-level performance on Atari games",
                  "es": "Combinó exitosamente aprendizaje profundo con aprendizaje por refuerzo, logrando rendimiento a nivel humano en juegos Atari",
                  "de": "Es kombinierte erfolgreich Deep Learning mit Reinforcement Learning und erreichte menschliche Leistung bei Atari-Spielen",
                  "nl": "Het combineerde succesvol deep learning met reinforcement learning, waarbij menselijk niveau prestaties op Atari spellen werden behaald"
        },
        {
                  "en": "It created the first computer",
                  "es": "Creó la primera computadora",
      ...
      },
      {
        ...
        {
                  "en": "It introduced contextualized word embeddings that changed meaning based on context",
                  "es": "Introdujo embeddings de palabras contextualizados que cambiaban significado basado en contexto",
                  "de": "Es führte kontextualisierte Wort-Embeddings ein die Bedeutung basierend auf Kontext änderten",
                  "nl": "Het introduceerde gecontextualiseerde woordembeddings die betekenis veranderden gebaseerd op context"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It sparked debates about AI safety and responsible disclosure by initially withholding the full model",
                  "es": "Desencadenó debates sobre seguridad de IA y divulgación responsable al retener inicialmente el modelo completo",
                  "de": "Es entfachte Debatten über KI-Sicherheit und verantwortliche Veröffentlichung indem es zunächst das vollständige Modell zurückhielt",
                  "nl": "Het ontketende debatten over AI veiligheid en verantwoordelijke openbaarmaking door aanvankelijk het volledige model achter te houden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  ...
                  "nl": "Het creëerde het eerste computer vision systeem"
        },
        {
                  "en": "It unified object detection into a single neural network, enabling real-time detection",
                  "es": "Unificó detección de objetos en una sola red neuronal, permitiendo detección en tiempo real",
                  "de": "Es vereinigte Objekterkennung in einem einzigen neuronalen Netzwerk und ermöglichte Echtzeit-Erkennung",
                  "nl": "Het verenigde objectdetectie in een enkel neuraal netwerk, waardoor real-time detectie mogelijk werd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It extended object detection to instance segmentation, providing pixel-level object boundaries",
                  "es": "Extendió detección de objetos a segmentación de instancias, proporcionando límites de objetos a nivel de píxel",
                  "de": "Es erweiterte Objekterkennung zu Instanzsegmentierung und bot Objektgrenzen auf Pixel-Ebene",
                  "nl": "Het breidde objectdetectie uit naar instantiesegmentatie, waarbij objectgrenzen op pixelniveau werden geboden"
        },
        {
                  "en": "It solved natural language processing",
                  "es": "Resolvió el procesamiento de lenguaje natural",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It provided an adaptive learning rate algorithm that became the default optimizer for deep learning",
                  "es": "Proporcionó un algoritmo de tasa de aprendizaje adaptativo que se convirtió en el optimizador por defecto para aprendizaje profundo",
                  "de": "Es bot einen adaptiven Lernraten-Algorithmus der zum Standard-Optimierer für Deep Learning wurde",
                  "nl": "Het bood een adaptief leersnelheidsalgoritme dat de standaard optimizer voor deep learning werd"
        },
        {
                  "en": "It invented the computer",
                  "es": "Inventó la computadora",
      ...
      },
      {
        ...
        {
                  "en": "It achieved superhuman performance in chess, shogi, and Go using only self-play without human knowledge",
                  "es": "Logró rendimiento sobrehumano en ajedrez, shogi y Go usando solo auto-juego sin conocimiento humano",
                  "de": "Es erreichte übermenschliche Leistung in Schach, Shogi und Go nur durch Selbstspiel ohne menschliches Wissen",
                  "nl": "Het behaalde bovenmenselijke prestaties in schaak, shogi en Go door alleen zelfspel zonder menselijke kennis"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "They enabled neural machine translation to focus on relevant input parts, improving translation quality",
                  "es": "Permitieron a traducción automática neuronal enfocarse en partes relevantes de entrada, mejorando calidad de traducción",
                  "de": "Sie ermöglichten neuronaler maschineller Übersetzung sich auf relevante Eingabeteile zu fokussieren und verbesserten Übersetzungsqualität",
        ...
        {
                  "en": "They were database indexing systems",
                  "es": "Fueron sistemas de indexación de base de datos",
                  "de": "Sie waren Datenbank-Indexierungssysteme",
                  "nl": "Ze waren database indexeringssystemen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They gave it only to governments",
                  "es": "Lo dieron solo a gobiernos",
                  "de": "Sie gaben es nur an Regierungen",
                  "nl": "Ze gaven het alleen aan regeringen"
        },
        {
                  "en": "They initially withheld the full model citing concerns about malicious use of AI-generated text",
                  "es": "Inicialmente retuvieron el modelo completo citando preocupaciones sobre uso malicioso de texto generado por IA",
                  "de": "Sie hielten das vollständige Modell zunächst zurück unter Berufung auf Bedenken bezüglich böswilliger Nutzung KI-generierter Texte",
                  "nl": "Ze hielden aanvankelijk het volledige model achter onder verwijzing naar zorgen over kwaadaardig gebruik van AI-gegenereerde tekst"
        },
        {
                  "en": "They sold it for millions of dollars",
                  "es": "Lo vendieron por millones de dólares",
                  "de": "Sie verkauften es für Millionen Dollar",
                  "nl": "Ze verkochten het voor miljoenen dollars"
        },
        {
                  "en": "They destroyed all copies",
                  "es": "Destruyeron todas las copias",
                  "de": "Sie zerstörten alle Kopien",
                  "nl": "Ze vernietigden alle kopieën"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It was a children's TV character",
                  "es": "Fue un personaje de TV infantil",
                  "de": "Es war eine Kinderfernseh-Figur",
                  "nl": "Het was een kinderTV personage"
        },
        {
        ...
        {
                  "en": "It introduced contextualized word representations that changed meaning based on context",
                  "es": "Introdujo representaciones de palabras contextualizadas que cambiaban significado según contexto",
                  "de": "Es führte kontextualisierte Wortrepräsentationen ein die Bedeutung basierend auf Kontext änderten",
                  "nl": "Het introduceerde gecontextualiseerde woordrepresentaties die betekenis veranderden op basis van context"
        },
        {
                  "en": "It invented neural networks",
                  "es": "Inventó redes neuronales",
                  "de": "Es erfand neuronale Netzwerke",
                  "nl": "Het vond neurale netwerken uit"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It was a car manufacturer",
                  "es": "Fue un fabricante de automóviles",
                  "de": "Es war ein Autohersteller",
                  "nl": "Het was een autofabrikant"
        },
        {
        ...
        {
                  "en": "It democratized deep learning by automating model design, reducing need for expert knowledge",
                  "es": "Democratizó aprendizaje profundo automatizando diseño de modelo, reduciendo necesidad de conocimiento experto",
                  "de": "Es demokratisierte Deep Learning durch Automatisierung von Modell-Design und reduzierte Bedarf an Expertenwissen",
                  "nl": "Het democratiseerde deep learning door modelontwerp te automatiseren, wat de noodzaak voor expertkennis verminderde"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They preserved spatial hierarchies and part-whole relationships better through vector outputs",
                  "es": "Preservaron jerarquías espaciales y relaciones parte-todo mejor mediante salidas vectoriales",
                  "de": "Sie erhielten räumliche Hierarchien und Teil-Ganzes-Beziehungen besser durch Vektor-Ausgaben",
                  "nl": "Ze behielden ruimtelijke hiërarchieën en deel-geheel relaties beter door vector outputs"
        },
        {
                  "en": "They were faster than all other networks",
                  "es": "Fueron más rápidas que todas las otras redes",
                  "de": "Sie waren schneller als alle anderen Netzwerke",
                  "nl": "Ze waren sneller dan alle andere netwerken"
        },
        {
                  "en": "They required no training data",
                  "es": "No requirieron datos de entrenamiento",
                  "de": "Sie benötigten keine Trainingsdaten",
                  "nl": "Ze vereisten geen trainingsdata"
        },
        {
                  "en": "They created consciousness",
                  "es": "Crearon conciencia",
                  "de": "Sie schufen Bewusstsein",
                  "nl": "Ze creëerden bewustzijn"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They created quantum computers",
                  "es": "Crearon computadoras cuánticas",
                  "de": "Sie schufen Quantencomputer",
                  "nl": "Ze creëerden quantumcomputers"
        },
        {
                  "en": "They were hardware devices",
                  "es": "Fueron dispositivos de hardware",
                  "de": "Sie waren Hardware-Geräte",
                  "nl": "Ze waren hardware apparaten"
        },
        {
        ...
        {
                  "en": "They extended neural networks with external memory and algorithmic capabilities through differentiable operations",
                  "es": "Extendieron redes neuronales con memoria externa y capacidades algorítmicas mediante operaciones diferenciables",
                  "de": "Sie erweiterten neuronale Netzwerke mit externem Speicher und algorithmischen Fähigkeiten durch differenzierbare Operationen",
                  "nl": "Ze breidden neurale netwerken uit met extern geheugen en algoritmische mogelijkheden door differentieerbare operaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It had no social impact",
                  "es": "No tuvo impacto social",
                  "de": "Es hatte keine sozialen Auswirkungen",
                  "nl": "Het had geen sociale impact"
        },
        {
        ...
        {
                  "en": "It was only used for entertainment",
                  "es": "Solo se usó para entretenimiento",
                  "de": "Es wurde nur für Unterhaltung verwendet",
                  "nl": "Het werd alleen gebruikt voor entertainment"
        },
        {
                  "en": "It raised urgent concerns about misinformation, consent, and need for AI detection/regulation",
                  "es": "Planteó preocupaciones urgentes sobre desinformación, consentimiento y necesidad de detección/regulación de IA",
                  "de": "Es warf dringende Bedenken bezüglich Fehlinformation, Einwilligung und Bedarf an KI-Erkennung/Regulierung auf",
                  "nl": "Het wekte dringende zorgen op over misinformatie, toestemming en de noodzaak voor AI detectie/regulering"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  ...
                  "nl": "Ze creëerden computergraphics"
        },
        {
                  "en": "They were data visualization tools",
                  "es": "Fueron herramientas de visualización de datos",
                  "de": "Sie waren Datenvisualisierungswerkzeuge",
                  "nl": "Ze waren datavisualisatie tools"
        },
        {
                  "en": "They enabled deep learning on graph-structured data like social networks and molecules",
                  "es": "Permitieron aprendizaje profundo en datos estructurados en grafos como redes sociales y moléculas",
                  "de": "Sie ermöglichten Deep Learning auf graphstrukturierten Daten wie sozialen Netzwerken und Molekülen",
                  "nl": "Ze maakten deep learning mogelijk op grafisch gestructureerde data zoals sociale netwerken en moleculen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It invented programming",
                  "es": "Inventó programación",
                  "de": "Es erfand Programmierung",
                  "nl": "Het vond programmeren uit"
        },
        {
        ...
        {
                  "en": "It reduced photo quality",
                  "es": "Redujo la calidad de fotos",
                  "de": "Es reduzierte Fotoqualität",
                  "nl": "Het verminderde fotokwaliteit"
        },
        {
                  "en": "It aimed to enable AI systems to learn new tasks from very few or no examples, like humans",
                  "es": "Buscó permitir a sistemas de IA aprender nuevas tareas con muy pocos o ningún ejemplo, como humanos",
                  "de": "Es zielte darauf ab KI-Systemen zu ermöglichen neue Aufgaben von sehr wenigen oder keinen Beispielen zu lernen, wie Menschen",
                  "nl": "Het streefde ernaar AI systemen in staat te stellen nieuwe taken te leren van zeer weinig of geen voorbeelden, zoals mensen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It invented quantum mechanics",
                  "es": "Inventó mecánica cuántica",
                  "de": "Es erfand Quantenmechanik",
                  "nl": "Het vond quantummechanica uit"
        },
        {
        ...
        {
                  "en": "It solved the 50-year protein folding problem, predicting 3D structures from amino acid sequences",
                  "es": "Resolvió el problema de plegamiento de proteínas de 50 años, prediciendo estructuras 3D a partir de secuencias de aminoácidos",
                  "de": "Es löste das 50-jährige Proteinfaltungsproblem und sagte 3D-Strukturen aus Aminosäuresequenzen vorher",
                  "nl": "Het loste het 50-jarige proteïnevouwings probleem op, waarbij 3D structuren voorspeld werden uit aminozuursequenties"
        },
        {
                  "en": "It created new elements",
                  "es": "Creó nuevos elementos",
                  "de": "Es schuf neue Elemente",
                  "nl": "Het creëerde nieuwe elementen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "They were mathematical textbooks",
                  "es": "Fueron libros de texto matemáticos",
                  "de": "Sie waren mathematische Lehrbücher",
                  "nl": "Ze waren wiskundige leerboeken"
        },
        {
                  "en": "They provided continuous-depth models with memory efficiency and new theoretical connections",
                  "es": "Proporcionaron modelos de profundidad continua con eficiencia de memoria y nuevas conexiones teóricas",
                  "de": "Sie boten kontinuierliche Tiefenmodelle mit Speichereffizienz und neuen theoretischen Verbindungen",
                  "nl": "Ze boden continue-diepte modellen met geheugenefficiëntie en nieuwe theoretische verbindingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They were image filters",
                  "es": "Fueron filtros de imagen",
                  "de": "Sie waren Bildfilter",
                  "nl": "Ze waren beeldfilters"
        },
        {
                  "en": "They enabled powerful self-supervised learning by contrasting augmented views of data",
                  "es": "Permitieron aprendizaje auto-supervisado poderoso contrastando vistas aumentadas de datos",
                  "de": "Sie ermöglichten mächtiges selbstüberwachtes Lernen durch Kontrastierung augmentierter Ansichten von Daten",
                  "nl": "Ze maakten krachtig zelf-gesuperviseerd leren mogelijk door versterkte weergaven van data te contrasteren"
        },
        {
                  "en": "They invented programming",
                  "es": "Inventaron programación",
                  "de": "Sie erfanden Programmierung",
                  "nl": "Ze vonden programmeren uit"
        },
        {
                  "en": "They created social media",
                  "es": "Crearon redes sociales",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It invented encryption",
                  "es": "Inventó encriptación",
                  "de": "Es erfand Verschlüsselung",
                  "nl": "Het vond encryptie uit"
        },
        {
                  "en": "It was a social movement",
                  "es": "Fue un movimiento social",
                  "de": "Es war eine soziale Bewegung",
                  "nl": "Het was een sociale beweging"
        },
        {
                  "en": "It revealed neural networks' vulnerability to imperceptible perturbations, raising security concerns",
                  "es": "Reveló vulnerabilidad de redes neuronales a perturbaciones imperceptibles, planteando preocupaciones de seguridad",
                  "de": "Es enthüllte Verwundbarkeit neuronaler Netzwerke gegenüber unmerklichen Störungen und warf Sicherheitsbedenken auf",
                  "nl": "Het onthulde de kwetsbaarheid van neurale netwerken voor onmerkbare verstoringen, wat veiligheidszorgen opriep"
        },
        {
                  "en": "It created video games",
                  "es": "Creó videojuegos",
                  "de": "Es schuf Videospiele",
                  "nl": "Het creëerde videogames"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They demonstrated transformers could match/exceed CNNs on vision tasks using patch-based attention",
                  "es": "Demostraron que transformers podían igualar/superar CNN en tareas de visión usando atención basada en parches",
                  "de": "Sie demonstrierten dass Transformers CNNs bei Vision-Aufgaben durch patch-basierte Attention erreichen/übertreffen konnten",
                  "nl": "Ze toonden aan dat transformers CNNs konden evenaren/overtreffen op vision taken met patch-gebaseerde attention"
        },
        {
                  "en": "They invented photography",
                  "es": "Inventaron fotografía",
                  "de": "Sie erfanden Fotografie",
                  "nl": "Ze vonden fotografie uit"
        },
        {
                  "en": "They created virtual reality",
                  "es": "Crearon realidad virtual",
                  "de": "Sie schufen Virtual Reality",
                  "nl": "Ze creëerden virtual reality"
        },
        {
                  "en": "They were camera lenses",
                  "es": "Fueron lentes de cámara",
                  "de": "Sie waren Kameraobjektive",
                  "nl": "Ze waren camera lenzen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It learned joint vision-language representations enabling zero-shot image classification from text",
                  "es": "Aprendió representaciones conjuntas visión-lenguaje permitiendo clasificación de imagen zero-shot desde texto",
                  "de": "Es lernte gemeinsame Vision-Sprache-Repräsentationen die Zero-Shot-Bildklassifikation aus Text ermöglichten",
                  "nl": "Het leerde gezamenlijke vision-taal representaties die zero-shot beeldclassificatie vanuit tekst mogelijk maakten"
        },
        {
                  "en": "It was a video editing tool",
                  "es": "Fue una herramienta de edición de video",
                  "de": "Es war ein Videobearbeitungswerkzeug",
                  "nl": "Het was een video bewerkingstool"
        },
        {
                  "en": "It created social media",
                  "es": "Creó redes sociales",
        ...
        {
                  "en": "It invented cameras",
                  "es": "Inventó cámaras",
                  "de": "Es erfand Kameras",
                  "nl": "Het vond camera's uit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They enabled sparsely-activated models with massive capacity but efficient inference",
                  "es": "Permitieron modelos activados escasamente con capacidad masiva pero inferencia eficiente",
                  "de": "Sie ermöglichten spärlich aktivierte Modelle mit massiver Kapazität aber effizienter Inferenz",
                  "nl": "Ze maakten schaars geactiveerde modellen mogelijk met massale capaciteit maar efficiënte inferentie"
        },
        {
                  "en": "They created expert systems from 1980s",
                  "es": "Crearon sistemas expertos de los 1980",
                  "de": "Sie schufen Expertensysteme aus den 1980ern",
                  "nl": "Ze creëerden expertsystemen uit de jaren 1980"
        },
        {
                  "en": "They were consulting firms",
                  "es": "Fueron firmas de consultoría",
                  "de": "Sie waren Beratungsfirmen",
                  "nl": "Ze waren adviesbureaus"
        },
        {
                  "en": "They invented databases",
                  "es": "Inventaron bases de datos",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They showed large language models could perform new tasks via carefully crafted prompts without retraining",
                  "es": "Mostraron que grandes modelos de lenguaje podían realizar nuevas tareas mediante prompts cuidadosamente elaborados sin reentrenamiento",
                  "de": "Sie zeigten dass große Sprachmodelle neue Aufgaben durch sorgfältig gestaltete Prompts ohne Retraining ausführen konnten",
                  "nl": "Ze toonden aan dat grote taalmodellen nieuwe taken konden uitvoeren via zorgvuldig opgestelde prompts zonder hertraining"
        },
        {
                  "en": "They created social media",
                  "es": "Crearon redes sociales",
      ...
      },
      {
        ...
        {
                  "en": "They created video games",
                  "es": "Crearon videojuegos",
                  "de": "Sie schufen Videospiele",
                  "nl": "Ze creëerden videogames"
        },
        {
                  "en": "They were camera lenses",
                  "es": "Fueron lentes de cámara",
        ...
        {
                  "en": "They synthesized novel 3D views from 2D images using neural scene representations",
                  "es": "Sintetizaron vistas 3D novedosas a partir de imágenes 2D usando representaciones de escena neuronales",
                  "de": "Sie synthetisierten neuartige 3D-Ansichten aus 2D-Bildern unter Verwendung neuraler Szenenrepräsentationen",
                  "nl": "Ze syntheseerden nieuwe 3D weergaven vanuit 2D afbeeldingen met behulp van neurale scène representaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It created government systems",
                  "es": "Creó sistemas gubernamentales",
                  "de": "Es schuf Regierungssysteme",
                  "nl": "Het creëerde overheidssystemen"
        },
        {
                  "en": "It aimed to make AI systems helpful, harmless, and honest through value alignment techniques",
                  "es": "Buscó hacer sistemas de IA útiles, inofensivos y honestos mediante técnicas de alineación de valores",
                  "de": "Es zielte darauf ab KI-Systeme durch Werte-Alignment-Techniken hilfreich, harmlos und ehrlich zu machen",
                  "nl": "Het streefde ernaar AI systemen behulpzaam, onschadelijk en eerlijk te maken door waarde alignment technieken"
        },
        {
                  "en": "It was a legal framework",
                  "es": "Fue un marco legal",
                  "de": "Es war ein rechtlicher Rahmen",
                  "nl": "Het was een juridisch kader"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "They revolutionized text-to-image generation with unprecedented quality and control",
                  "es": "Revolucionaron generación texto-a-imagen con calidad y control sin precedentes",
                  "de": "Sie revolutionierten Text-zu-Bild-Generierung mit beispielloser Qualität und Kontrolle",
                  "nl": "Ze revolutioneerden tekst-naar-beeld generatie met ongekende kwaliteit en controle"
        },
        {
        ...
        {
                  "en": "They were image compression tools",
                  "es": "Fueron herramientas de compresión de imagen",
                  "de": "Sie waren Bildkompressionswerkzeuge",
                  "nl": "Ze waren beeldcompressie tools"
        }
        ],
        correct: 1,
        explanation: {
