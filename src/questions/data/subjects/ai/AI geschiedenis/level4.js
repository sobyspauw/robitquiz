    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "The creation of expert systems",
                  "es": "La creación de sistemas expertos",
                  "de": "Die Schaffung von Expertensystemen",
                  "nl": "De creatie van expertsystemen"
        },
        {
                  "en": "The development of internet protocols",
                  "es": "El desarrollo de protocolos de internet",
                  "de": "Die Entwicklung von Internet-Protokollen",
                  "nl": "De ontwikkeling van internetprotocollen"
        },
        {
                  "en": "The renewed interest in neural networks and parallel distributed processing",
                  "es": "El renovado interés en redes neuronales y procesamiento distribuido paralelo",
                  "de": "Das erneuerte Interesse an neuronalen Netzwerken und paralleler verteilter Verarbeitung",
                  "nl": "De hernieuwde interesse in neurale netwerken en parallelle gedistribueerde verwerking"
        },
        {
                  "en": "The invention of personal computers",
                  "es": "La invención de computadoras personales",
                  "de": "Die Erfindung von Personalcomputern",
                  "nl": "De uitvinding van personal computers"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It developed the first database management system",
                  "es": "Desarrolló el primer sistema de gestión de bases de datos",
                  "de": "Es entwickelte das erste Datenbankverwaltungssystem",
                  "nl": "Het ontwikkelde het eerste database managementsysteem"
        },
        {
                  "en": "It was the first computer virus detection system",
                  "es": "Fue el primer sistema de detección de virus informáticos",
                  "de": "Es war das erste Computervirus-Erkennungssystem",
                  "nl": "Het was het eerste computervirus detectiesysteem"
        },
        {
                  "en": "It aimed to encode common sense knowledge into a massive knowledge base",
                  "es": "Tenía como objetivo codificar conocimiento de sentido común en una base de conocimiento masiva",
                  "de": "Es zielte darauf ab Allgemeinwissen in einer massiven Wissensbasis zu kodieren",
                  "nl": "Het was gericht op het coderen van gezond verstand kennis in een massieve kennisbank"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Successful handwritten digit recognition for postal systems",
                  "es": "Reconocimiento exitoso de dígitos escritos a mano para sistemas postales",
                  "de": "Erfolgreiche Erkennung handgeschriebener Ziffern für Postsysteme",
                  "nl": "Succesvolle herkenning van handgeschreven cijfers voor postsystemen"
        },
        {
                  "en": "The first speech recognition system",
                  "es": "El primer sistema de reconocimiento de voz",
                  "de": "Das erste Spracherkennungssystem",
                  "nl": "Het eerste spraakherkenningssysteem"
        },
        {
                  "en": "The first computer game",
                  "es": "El primer juego de computadora",
                  "de": "Das erste Computerspiel",
                  "nl": "Het eerste computerspel"
        },
        {
                  "en": "The invention of the internet",
                  "es": "La invención de internet",
                  "de": "Die Erfindung des Internets",
                  "nl": "De uitvinding van het internet"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It created the first artificial consciousness",
                  "es": "Creó la primera conciencia artificial",
                  "de": "Es schuf das erste künstliche Bewusstsein",
                  "nl": "Het creëerde het eerste kunstmatige bewustzijn"
        },
        {
                  "en": "It was the first AI to pass the Turing Test",
                  "es": "Fue la primera IA en pasar el Test de Turing",
                  "de": "Es war die erste KI die den Turing-Test bestand",
                  "nl": "Het was de eerste AI die de Turing Test behaalde"
        },
        {
                  "en": "It demonstrated AI's ability to understand natural language and answer complex questions",
                  "es": "Demostró la capacidad de la IA para entender lenguaje natural y responder preguntas complejas",
                  "de": "Es demonstrierte die Fähigkeit der KI natürliche Sprache zu verstehen und komplexe Fragen zu beantworten",
                  "nl": "Het toonde AI's vermogen om natuurlijke taal te begrijpen en complexe vragen te beantwoorden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The rapid improvement in AI capabilities",
                  "es": "La rápida mejora en capacidades de IA",
                  "de": "Die schnelle Verbesserung der KI-Fähigkeiten",
                  "nl": "De snelle verbetering in AI vaardigheden"
        },
        {
                  "en": "The collaboration between humans and AI",
                  "es": "La colaboración entre humanos y IA",
                  "de": "Die Zusammenarbeit zwischen Menschen und KI",
                  "nl": "De samenwerking tussen mensen en AI"
        },
        {
                  "en": "The tendency to redefine AI as 'not real AI' once a capability is achieved",
                  "es": "La tendencia a redefinir la IA como 'no IA real' una vez que se logra una capacidad",
                  "de": "Die Tendenz KI als 'nicht echte KI' neu zu definieren sobald eine Fähigkeit erreicht ist",
                  "nl": "De neiging om AI te herdefiniëren als 'geen echte AI' zodra een vaardigheid wordt bereikt"
        },
        {
                  "en": "The positive impact of AI on society",
                  "es": "El impacto positivo de la IA en la sociedad",
                  "de": "Die positive Auswirkung von KI auf die Gesellschaft",
                  "nl": "De positieve impact van AI op de samenleving"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Never occurred, AI research continued steadily",
                  "es": "Nunca ocurrió, la investigación de IA continuó constantemente",
                  "de": "Ist nie aufgetreten, KI-Forschung setzte sich stetig fort",
                  "nl": "Vond nooit plaats, AI onderzoek ging gestaag door"
        },
        {
                  "en": "2001-2005, caused by the dot-com crash",
                  "es": "2001-2005, causado por el colapso de las punto-com",
                  "de": "2001-2005, verursacht durch den Dotcom-Crash",
                  "nl": "2001-2005, veroorzaakt door de dotcom crash"
        },
        {
                  "en": "Late 1980s-early 1990s, caused by limitations of expert systems and reduced funding",
                  "es": "Finales de los 1980-principios de los 1990, causado por limitaciones de sistemas expertos y reducción de financiamiento",
                  "de": "Ende 1980er-frühe 1990er Jahre, verursacht durch Begrenzungen von Expertensystemen und reduzierte Finanzierung",
                  "nl": "Eind jaren 1980-begin jaren 1990, veroorzaakt door beperkingen van expertsystemen en verminderde financiering"
        },
        {
                  "en": "1995-2000, caused by the internet bubble",
                  "es": "1995-2000, causado por la burbuja de internet",
                  "de": "1995-2000, verursacht durch die Internet-Blase",
                  "nl": "1995-2000, veroorzaakt door de internetbubbel"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "DARPA invested $1 billion in AI research from 1983-1993, funding key projects and infrastructure",
                  "es": "DARPA invirtió $1 mil millones en investigación de IA de 1983-1993, financiando proyectos clave e infraestructura",
                  "de": "DARPA investierte $1 Milliarde in KI-Forschung von 1983-1993 und finanzierte Schlüsselprojekte und Infrastruktur",
                  "nl": "DARPA investeerde $1 miljard in AI onderzoek van 1983-1993, financierde belangrijke projecten en infrastructuur"
        },
        {
                  "en": "DARPA created the first neural networks",
                  "es": "DARPA creó las primeras redes neuronales",
                  "de": "DARPA schuf die ersten neuronalen Netzwerke",
                  "nl": "DARPA creëerde de eerste neurale netwerken"
        },
        {
                  "en": "DARPA banned AI research",
                  "es": "DARPA prohibió la investigación de IA",
                  "de": "DARPA verbot KI-Forschung",
                  "nl": "DARPA verbood AI onderzoek"
        },
        {
                  "en": "DARPA invented the personal computer",
                  "es": "DARPA inventó la computadora personal",
                  "de": "DARPA erfand den Personalcomputer",
                  "nl": "DARPA vond de personal computer uit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It enabled training of multi-layer neural networks, overcoming the limitations identified by Minsky and Papert",
                  "es": "Permitió entrenar redes neuronales multicapa, superando las limitaciones identificadas por Minsky y Papert",
                  "de": "Es ermöglichte das Training mehrschichtiger neuronaler Netzwerke und überwand die von Minsky und Papert identifizierten Begrenzungen",
                  "nl": "Het maakte training van meerlaagse neurale netwerken mogelijk, waarbij de beperkingen geïdentificeerd door Minsky en Papert werden overwonnen"
        },
        {
                  "en": "It solved the frame problem",
                  "es": "Resolvió el problema del marco",
                  "de": "Es löste das Frame-Problem",
                  "nl": "Het loste het frame probleem op"
        },
        {
        ...
        {
                  "en": "It invented symbolic logic",
                  "es": "Inventó la lógica simbólica",
                  "de": "Es erfand die symbolische Logik",
                  "nl": "Het vond symbolische logica uit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Excessive intelligence",
                  "es": "Inteligencia excesiva",
                  "de": "Übermäßige Intelligenz",
                  "nl": "Overmatige intelligentie"
        },
        {
                  "en": "Perfect reliability",
                  "es": "Confiabilidad perfecta",
                  "de": "Perfekte Zuverlässigkeit",
                  "nl": "Perfecte betrouwbaarheid"
        },
        {
                  "en": "Too fast processing speed",
                  "es": "Velocidad de procesamiento demasiado rápida",
                  "de": "Zu schnelle Verarbeitungsgeschwindigkeit",
                  "nl": "Te snelle verwerkingssnelheid"
        },
        {
                  "en": "Brittleness, difficulty in knowledge acquisition, high maintenance costs, and inability to learn",
                  "es": "Fragilidad, dificultad en adquisición de conocimiento, altos costos de mantenimiento e incapacidad de aprender",
                  "de": "Zerbrechlichkeit, Schwierigkeit bei Wissensakquisition, hohe Wartungskosten und Unfähigkeit zu lernen",
                  "nl": "Broosheid, moeilijkheid in kennisverwerving, hoge onderhoudskosten en onvermogen om te leren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They launched the connectionist revival by showing neural networks could model cognitive processes",
                  "es": "Lanzaron el resurgimiento conexionista mostrando que las redes neuronales podían modelar procesos cognitivos",
                  "de": "Sie starteten das konnektionistische Revival indem sie zeigten dass neuronale Netzwerke kognitive Prozesse modellieren konnten",
                  "nl": "Ze lanceerden de connectionistische heropleving door te tonen dat neurale netwerken cognitieve processen konden modelleren"
        },
        {
                  "en": "They disproved neural network theories",
                  "es": "Refutaron las teorías de redes neuronales",
                  "de": "Sie widerlegten neuronale Netzwerktheorien",
                  "nl": "Ze weerlegden neurale netwerk theorieën"
        },
        {
                  "en": "They created the first programming language",
                  "es": "Crearon el primer lenguaje de programación",
                  "de": "Sie schufen die erste Programmiersprache",
                  "nl": "Ze creëerden de eerste programmeertaal"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They were the first computers",
                  "es": "Fueron las primeras computadoras",
                  "de": "Sie waren die ersten Computer",
                  "nl": "Ze waren de eerste computers"
        },
        {
                  "en": "They invented artificial consciousness",
                  "es": "Inventaron conciencia artificial",
                  "de": "Sie erfanden künstliches Bewusstsein",
                  "nl": "Ze vonden kunstmatig bewustzijn uit"
        },
        {
                  "en": "They solved natural language understanding",
                  "es": "Resolvieron la comprensión de lenguaje natural",
                  "de": "Sie lösten natürliches Sprachverständnis",
                  "nl": "Ze losten natuurlijk taalbegrip op"
        },
        {
                  "en": "They showed neural networks could serve as associative memory and solve optimization problems",
                  "es": "Mostraron que las redes neuronales podían servir como memoria asociativa y resolver problemas de optimización",
                  "de": "Sie zeigten dass neuronale Netzwerke als assoziatives Gedächtnis dienen und Optimierungsprobleme lösen konnten",
                  "nl": "Ze toonden dat neurale netwerken konden dienen als associatief geheugen en optimalisatieproblemen konden oplossen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Japan only funded robotics",
                  "es": "Japón solo financió robótica",
                  "de": "Japan finanzierte nur Robotik",
                  "nl": "Japan financierde alleen robotica"
        },
        {
                  "en": "The Fifth Generation Computer Project spurred international competition and AI investment",
                  "es": "El Proyecto de Computadoras de Quinta Generación estimuló la competencia internacional e inversión en IA",
                  "de": "Das Fifth Generation Computer Project spornte internationale Konkurrenz und KI-Investition an",
                  "nl": "Het Fifth Generation Computer Project stimuleerde internationale concurrentie en AI investering"
        },
        {
                  "en": "Japan had no impact on AI development",
                  "es": "Japón no tuvo impacto en el desarrollo de IA",
                  "de": "Japan hatte keinen Einfluss auf KI-Entwicklung",
                  "nl": "Japan had geen impact op AI ontwikkeling"
        },
        {
                  "en": "Japan banned AI research",
                  "es": "Japón prohibió la investigación de IA",
                  "de": "Japan verbot KI-Forschung",
                  "nl": "Japan verbood AI onderzoek"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They invented DNA sequencing",
                  "es": "Inventaron secuenciación de ADN",
                  "de": "Sie erfanden DNA-Sequenzierung",
                  "nl": "Ze vonden DNA sequencing uit"
        },
        {
                  "en": "They solved protein folding",
                  "es": "Resolvieron el plegamiento de proteínas",
                  "de": "Sie lösten Proteinfaltung",
                  "nl": "Ze losten proteïnevouwing op"
        },
        {
                  "en": "They introduced evolutionary computation as an alternative AI approach for optimization and learning",
                  "es": "Introdujeron computación evolutiva como un enfoque alternativo de IA para optimización y aprendizaje",
                  "de": "Sie führten evolutionäre Berechnung als alternativen KI-Ansatz für Optimierung und Lernen ein",
                  "nl": "Ze introduceerden evolutionaire berekening als alternatieve AI benadering voor optimalisatie en leren"
        },
        {
                  "en": "They created actual living organisms",
                  "es": "Crearon organismos vivos reales",
                  "de": "Sie schufen tatsächlich lebende Organismen",
                  "nl": "Ze creëerden werkelijke levende organismen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "They created the first personal computers",
                  "es": "Crearon las primeras computadoras personales",
                  "de": "Sie schufen die ersten Personalcomputer",
                  "nl": "Ze creëerden de eerste personal computers"
        },
        {
                  "en": "They developed word processing software",
                  "es": "Desarrollaron software de procesamiento de texto",
                  "de": "Sie entwickelten Textverarbeitungssoftware",
                  "nl": "Ze ontwikkelden tekstverwerking software"
        },
        {
                  "en": "They pioneered massively parallel computing for AI applications in the 1980s",
                  "es": "Fueron pioneros en computación masivamente paralela para aplicaciones de IA en los años 1980",
                  "de": "Sie waren Pioniere in massiv paralleler Berechnung für KI-Anwendungen in den 1980er Jahren",
                  "nl": "Ze waren pioniers in massaal parallelle berekening voor AI toepassingen in de jaren 1980"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "VCs avoided technology investments",
                  "es": "Los VC evitaron inversiones en tecnología",
                  "de": "VCs vermieden Technologie-Investitionen",
                  "nl": "VCs vermeden technologie investeringen"
        },
        {
                  "en": "VCs invested heavily in AI startups during the boom, then pulled funding when commercialization proved difficult",
                  "es": "Los VC invirtieron fuertemente en startups de IA durante el boom, luego retiraron el financiamiento cuando la comercialización resultó difícil",
                  "de": "VCs investierten stark in KI-Startups während des Booms, zogen dann Finanzierung zurück als Kommerzialisierung sich als schwierig erwies",
                  "nl": "VCs investeerden zwaar in AI startups tijdens de boom, trokken vervolgens financiering terug toen commercialisatie moeilijk bleek"
        },
        {
                  "en": "VCs never invested in AI companies",
                  "es": "Los VC nunca invirtieron en compañías de IA",
                  "de": "VCs investierten nie in KI-Unternehmen",
                  "nl": "VCs investeerden nooit in AI bedrijven"
        },
        {
                  "en": "VCs only funded hardware companies",
                  "es": "Los VC solo financiaron compañías de hardware",
                  "de": "VCs finanzierten nur Hardware-Unternehmen",
                  "nl": "VCs financierden alleen hardware bedrijven"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It proposed that intelligence emerges from interactions of many simple, non-intelligent agents",
                  "es": "Propuso que la inteligencia emerge de interacciones de muchos agentes simples y no inteligentes",
                  "de": "Es schlug vor dass Intelligenz aus Interaktionen vieler einfacher, nicht-intelligenter Agenten entsteht",
                  "nl": "Het stelde voor dat intelligentie ontstaat uit interacties van vele eenvoudige, niet-intelligente agenten"
        },
        {
                  "en": "It proved AI was impossible",
                  "es": "Probó que la IA era imposible",
                  "de": "Es bewies dass KI unmöglich war",
                  "nl": "Het bewees dat AI onmogelijk was"
        },
        {
                  "en": "It solved consciousness",
                  "es": "Resolvió la conciencia",
                  "de": "Es löste Bewusstsein",
                  "nl": "Het loste bewustzijn op"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They made AI research purely theoretical",
                  "es": "Hicieron la investigación de IA puramente teórica",
                  "de": "Sie machten KI-Forschung rein theoretisch",
                  "nl": "Ze maakten AI onderzoek puur theoretisch"
        },
        {
                  "en": "They eliminated all previous AI methods",
                  "es": "Eliminaron todos los métodos previos de IA",
                  "de": "Sie eliminierten alle vorherigen KI-Methoden",
                  "nl": "Ze elimineerden alle voorgaande AI methoden"
        },
        {
                  "en": "They shifted AI from knowledge-based to data-driven approaches, leading to practical successes",
                  "es": "Cambiaron la IA de enfoques basados en conocimiento a enfoques impulsados por datos, llevando a éxitos prácticos",
                  "de": "Sie verlagerten KI von wissensbasierten zu datengetriebenen Ansätzen und führten zu praktischen Erfolgen",
                  "nl": "Ze verschoven AI van kennisgebaseerde naar datagedreven benaderingen, leidend tot praktische successen"
        },
        {
                  "en": "They had no significant impact",
                  "es": "No tuvieron impacto significativo",
                  "de": "Sie hatten keinen signifikanten Einfluss",
                  "nl": "Ze hadden geen significant impact"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It only affected hardware development",
                  "es": "Solo afectó el desarrollo de hardware",
                  "de": "Es beeinflusste nur Hardware-Entwicklung",
                  "nl": "Het beïnvloedde alleen hardware ontwikkeling"
        },
        {
                  "en": "It had no connection to AI",
                  "es": "No tuvo conexión con IA",
                  "de": "Es hatte keine Verbindung zur KI",
                  "nl": "Het had geen verbinding met AI"
        },
        {
                  "en": "It eliminated the need for AI research",
                  "es": "Eliminó la necesidad de investigación de IA",
                  "de": "Es eliminierte den Bedarf an KI-Forschung",
                  "nl": "Het elimineerde de behoefte aan AI onderzoek"
        },
        {
                  "en": "It created demand for intelligent systems to handle web search, recommendation, and data mining",
                  "es": "Creó demanda de sistemas inteligentes para manejar búsqueda web, recomendación y minería de datos",
                  "de": "Es schuf Nachfrage nach intelligenten Systemen für Websuche, Empfehlungen und Data Mining",
                  "nl": "Het creëerde vraag naar intelligente systemen om webzoeken, aanbevelingen en datamining te behandelen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Fue puramente para entretenimiento",
                  "de": "Es war rein zur Unterhaltung",
                  "nl": "Het was puur voor entertainment"
        },
        {
                  "en": "It had no research value",
                  "es": "No tuvo valor de investigación",
                  "de": "Es hatte keinen Forschungswert",
                  "nl": "Het had geen onderzoekswaarde"
        },
        {
                  "en": "It replaced human soccer",
                  "es": "Reemplazó el fútbol humano",
                  "de": "Es ersetzte menschlichen Fußball",
                  "nl": "Het verving menselijk voetbal"
        },
        {
                  "en": "It provided a standard benchmark for AI research in multi-agent systems and robotics",
                  "es": "Proporcionó un benchmark estándar para investigación de IA en sistemas multi-agente y robótica",
                  "de": "Es bot einen Standard-Benchmark für KI-Forschung in Multi-Agenten-Systemen und Robotik",
                  "nl": "Het bood een standaard benchmark voor AI onderzoek in multi-agent systemen en robotica"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A science fiction novel about AI",
                  "es": "Una novela de ciencia ficción sobre IA",
                  "de": "Ein Science-Fiction-Roman über KI",
                  "nl": "Een science fiction roman over AI"
        },
        {
                  "en": "A positive assessment that increased AI funding",
                  "es": "Una evaluación positiva que aumentó el financiamiento de IA",
                  "de": "Eine positive Bewertung die KI-Finanzierung erhöhte",
                  "nl": "Een positieve beoordeling die AI financiering verhoogde"
        },
        {
                  "en": "A 1973 British report criticizing AI progress that led to funding cuts and the first AI winter",
                  "es": "Un informe británico de 1973 criticando el progreso de IA que llevó a recortes de financiamiento y el primer invierno de IA",
                  "de": "Ein britischer Bericht von 1973 der KI-Fortschritt kritisierte und zu Finanzierungskürzungen und dem ersten KI-Winter führte",
                  "nl": "Een Brits rapport van 1973 dat AI vooruitgang bekritiseerde en leidde tot financieringsbesnoeiingen en de eerste AI winter"
        },
        {
                  "en": "A technical manual for building AI systems",
                  "es": "Un manual técnico para construir sistemas de IA",
                  "de": "Ein technisches Handbuch zum Bau von KI-Systemen",
                  "nl": "Een technische handleiding voor het bouwen van AI systemen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Showed deep neural networks could be trained effectively, sparking the deep learning revolution",
                  "es": "Mostró que las redes neuronales profundas podían entrenarse efectivamente, desencadenando la revolución del aprendizaje profundo",
                  "de": "Zeigte dass tiefe neuronale Netzwerke effektiv trainiert werden konnten und löste die Deep Learning Revolution aus",
                  "nl": "Toonde dat diepe neurale netwerken effectief getraind konden worden, wat de deep learning revolutie ontketende"
        },
        {
                  "en": "Created the first computer",
                  "es": "Creó la primera computadora",
                  "de": "Schuf den ersten Computer",
                  "nl": "Creëerde de eerste computer"
        },
        {
                  "en": "Invented the internet",
                  "es": "Inventó internet",
                  "de": "Erfand das Internet",
                  "nl": "Vond het internet uit"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Demonstrated convolutional neural networks vastly outperformed traditional computer vision methods",
                  "es": "Demostró que las redes neuronales convolucionales superaban vastamente los métodos tradicionales de visión por computadora",
                  "de": "Demonstrierte dass Convolutional Neural Networks traditionelle Computer Vision Methoden bei weitem übertrafen",
                  "nl": "Toonde dat convolutionele neurale netwerken traditionele computer vision methoden ver overtroffen"
        },
        {
                  "en": "Proved deep learning was useless",
                  "es": "Probó que el aprendizaje profundo era inútil",
                  "de": "Bewies dass Deep Learning nutzlos war",
                  "nl": "Bewees dat deep learning nutteloos was"
        },
        {
                  "en": "First time a computer displayed any image",
                  "es": "Primera vez que una computadora mostró cualquier imagen",
                  "de": "Erstes Mal dass ein Computer irgendein Bild anzeigte",
                  "nl": "Eerste keer dat een computer een afbeelding toonde"
        },
        {
                  "en": "Created artificial consciousness",
                  "es": "Creó conciencia artificial",
                  "de": "Schuf künstliches Bewusstsein",
                  "nl": "Creëerde kunstmatig bewustzijn"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "First neural network algorithm",
                  "es": "Primer algoritmo de red neuronal",
                  "de": "Erster neuronaler Netzwerk-Algorithmus",
                  "nl": "Eerste neurale netwerk algoritme"
        },
        {
                  "en": "Efficient pattern matching for production rules reducing redundant computations",
                  "es": "Coincidencia eficiente de patrones para reglas de producción reduciendo computaciones redundantes",
                  "de": "Effiziente Mustererkennung für Produktionsregeln die redundante Berechnungen reduzierte",
                  "nl": "Efficiënte patroonherkenning voor productieregels die redundante berekeningen verminderde"
        },
        {
                  "en": "Created genetic algorithms",
                  "es": "Creó algoritmos genéticos",
                  "de": "Schuf genetische Algorithmen",
                  "nl": "Creëerde genetische algoritmen"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Expert system for medical diagnosis",
                  "es": "Sistema experto para diagnóstico médico",
                  "de": "Expertensystem für medizinische Diagnose",
                  "nl": "Expertsysteem voor medische diagnose"
        },
        {
                  "en": "Early neural network autonomous driving system that learned to steer from human demonstrations",
                  "es": "Sistema temprano de conducción autónoma con red neuronal que aprendió a dirigir de demostraciones humanas",
                  "de": "Frühes neuronales Netzwerk autonomes Fahrsystem das aus menschlichen Demonstrationen lenken lernte",
                  "nl": "Vroeg neuraal netwerk autonoom rijsysteem dat leerde sturen van menselijke demonstraties"
        },
        {
                  "en": "Chess-playing program",
                  "es": "Programa para jugar ajedrez",
                  "de": "Schachspielprogramm",
                  "nl": "Schaakspelprogramma"
        },
        {
                  "en": "First commercial robot vacuum",
                  "es": "Primera aspiradora robot comercial",
                  "de": "Erster kommerzieller Roboterstaubsauger",
                  "nl": "Eerste commerciële robotstofzuiger"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Invented digital cameras",
                  "es": "Inventó cámaras digitales",
                  "de": "Erfand Digitalkameras",
                  "nl": "Vond digitale camera's uit"
        },
        {
                  "en": "Was the first photograph ever taken",
                  "es": "Fue la primera fotografía jamás tomada",
                  "de": "War die erste jemals aufgenommene Fotografie",
                  "nl": "Was de eerste foto ooit genomen"
        },
        {
                  "en": "Provided large-scale labeled dataset enabling training of deep neural networks for vision",
                  "es": "Proporcionó conjunto de datos etiquetado a gran escala habilitando entrenamiento de redes neuronales profundas para visión",
                  "de": "Bot großangelegten beschrifteten Datensatz der Training tiefer neuronaler Netzwerke für Vision ermöglichte",
                  "nl": "Bood grootschalige gelabelde dataset die training van diepe neurale netwerken voor vision mogelijk maakte"
        },
        {
                  "en": "Created artificial reality",
                  "es": "Creó realidad artificial",
                  "de": "Schuf künstliche Realität",
                  "nl": "Creëerde kunstmatige realiteit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Required perfect information",
                  "es": "Requirió información perfecta",
                  "de": "Erforderte perfekte Information",
                  "nl": "Vereiste perfecte informatie"
        },
        {
                  "en": "Couldn't handle randomness",
                  "es": "No podía manejar aleatoriedad",
                  "de": "Konnte keine Zufälligkeit handhaben",
                  "nl": "Kon geen willekeur aan"
        },
        {
                  "en": "Was only useful for chess",
                  "es": "Solo fue útil para ajedrez",
                  "de": "War nur für Schach nützlich",
                  "nl": "Was alleen nuttig voor schaak"
        },
        {
                  "en": "Enabled strong play in games with huge branching factors like Go before deep learning",
                  "es": "Habilitó juego fuerte en juegos con factores de ramificación enormes como Go antes del aprendizaje profundo",
                  "de": "Ermöglichte starkes Spiel in Spielen mit riesigen Verzweigungsfaktoren wie Go vor Deep Learning",
                  "nl": "Maakte sterk spel mogelijk in spellen met enorme vertakkingsfactoren zoals Go voor deep learning"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "First spell checker program",
                  "es": "Primer programa de corrección ortográfica",
                  "de": "Erstes Rechtschreibprüfprogramm",
                  "nl": "Eerste spellingcontrole programma"
        },
        {
                  "en": "Invented natural language",
                  "es": "Inventó lenguaje natural",
                  "de": "Erfand natürliche Sprache",
                  "nl": "Vond natuurlijke taal uit"
        },
        {
                  "en": "Created the first dictionary",
                  "es": "Creó el primer diccionario",
                  "de": "Schuf das erste Wörterbuch",
                  "nl": "Creëerde het eerste woordenboek"
        },
        {
                  "en": "Learned dense word embeddings capturing semantic relationships from large text corpora",
                  "es": "Aprendió incrustaciones de palabras densas capturando relaciones semánticas de grandes corpus de texto",
                  "de": "Lernte dichte Worteinbettungen die semantische Beziehungen aus großen Textkorpora erfassten",
                  "nl": "Leerde dichte woord embeddings die semantische relaties vastlegden uit grote tekstcorpora"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "First computer programming contest",
                  "es": "Primer concurso de programación de computadoras",
                  "de": "Erster Computerprogrammier-Wettbewerb",
                  "nl": "Eerste computer programmeer wedstrijd"
        },
        {
                  "en": "AI safety conference",
                  "es": "Conferencia de seguridad de IA",
                  "de": "KI-Sicherheitskonferenz",
                  "nl": "AI veiligheidsconferentie"
        },
        {
                  "en": "Robot car race that catalyzed self-driving vehicle technology development from 2004-2007",
                  "es": "Carrera de autos robot que catalizó el desarrollo de tecnología de vehículos autónomos de 2004-2007",
                  "de": "Roboter-Auto-Rennen das Selbstfahrzeug-Technologie-Entwicklung von 2004-2007 katalysierte",
                  "nl": "Robot auto race die zelfrijdende voertuig technologie ontwikkeling katalyseerde van 2004-2007"
        },
        {
                  "en": "Chess championship for computers",
                  "es": "Campeonato de ajedrez para computadoras",
                  "de": "Schachmeisterschaft für Computer",
                  "nl": "Schaakkampioenschap voor computers"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Esfuerzo para hacer datos web legibles por máquina através de ontologías y razonamiento",
                  "de": "Bemühung Webdaten durch Ontologien und Denken maschinenlesbar zu machen",
                  "nl": "Inspanning om webdata machine-leesbaar te maken door ontologieën en redeneren"
        },
        {
                  "en": "E-commerce system",
                  "es": "Sistema de comercio electrónico",
                  "de": "E-Commerce-System",
                  "nl": "E-commerce systeem"
        },
        {
                  "en": "Social media platform",
                  "es": "Plataforma de redes sociales",
                  "de": "Social Media Plattform",
                  "nl": "Social media platform"
        },
        {
                  "en": "First web browser",
                  "es": "Primer navegador web",
                  "de": "Erster Webbrowser",
                  "nl": "Eerste webbrowser"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Created symbolic AI",
                  "es": "Creó IA simbólica",
                  "de": "Schuf symbolische KI",
                  "nl": "Creëerde symbolische AI"
        },
        {
                  "en": "First classification algorithm",
                  "es": "Primer algoritmo de clasificación",
                  "de": "Erster Klassifikationsalgorithmus",
                  "nl": "Eerste classificatie algoritme"
        },
        {
                  "en": "Revolutionary approach to generating realistic synthetic data through adversarial training",
                  "es": "Enfoque revolucionario para generar datos sintéticos realistas através de entrenamiento adversarial",
                  "de": "Revolutionärer Ansatz zur Erzeugung realistischer synthetischer Daten durch adversariales Training",
                  "nl": "Revolutionaire benadering voor het genereren van realistische synthetische data door adversarial training"
        },
        {
                  "en": "Invented supervised learning",
                  "es": "Inventó aprendizaje supervisado",
                  "de": "Erfand überwachtes Lernen",
                  "nl": "Vond supervised learning uit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Created reinforcement learning",
                  "es": "Creó aprendizaje por refuerzo",
                  "de": "Schuf Verstärkungslernen",
                  "nl": "Creëerde versterkingsleren"
        },
        {
                  "en": "Skip connections enabled training of very deep networks with 100+ layers",
                  "es": "Conexiones de salto habilitaron entrenamiento de redes muy profundas con 100+ capas",
                  "de": "Skip-Verbindungen ermöglichten Training sehr tiefer Netzwerke mit 100+ Schichten",
                  "nl": "Skip verbindingen maakten training van zeer diepe netwerken met 100+ lagen mogelijk"
        },
        {
                  "en": "First use of neural networks",
                  "es": "Primer uso de redes neuronales",
                  "de": "Erste Verwendung neuronaler Netzwerke",
                  "nl": "Eerste gebruik van neurale netwerken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Genetic algorithms only",
                  "es": "Solo algoritmos genéticos",
                  "de": "Nur genetische Algorithmen",
                  "nl": "Alleen genetische algoritmen"
        },
        {
                  "en": "Crowdsourced from social media",
                  "es": "Colaboración masiva de redes sociales",
                  "de": "Crowdsourced von sozialen Medien",
                  "nl": "Crowdsourced van social media"
        },
        {
                  "en": "Manual encoding of millions of facts and rules over decades",
                  "es": "Codificación manual de millones de hechos y reglas durante décadas",
                  "de": "Manuelle Kodierung von Millionen Fakten und Regeln über Jahrzehnte",
                  "nl": "Handmatige codering van miljoenen feiten en regels over decennia"
        },
        {
                  "en": "Pure neural network learning",
                  "es": "Aprendizaje puro de redes neuronales",
                  "de": "Reines neuronales Netzwerk-Lernen",
                  "nl": "Puur neuraal netwerk leren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "First neural network ever created",
                  "es": "Primera red neuronal jamás creada",
                  "de": "Erstes jemals erstelltes neuronales Netzwerk",
                  "nl": "Eerste neurale netwerk ooit gecreëerd"
        },
        {
                  "en": "Created symbolic reasoning",
                  "es": "Creó razonamiento simbólico",
                  "de": "Schuf symbolisches Denken",
                  "nl": "Creëerde symbolisch redeneren"
        },
        {
                  "en": "Attention mechanisms replaced recurrence, enabling parallel training and better long-range dependencies",
                  "es": "Mecanismos de atención reemplazaron recurrencia, habilitando entrenamiento paralelo y mejores dependencias de largo rango",
                  "de": "Aufmerksamkeitsmechanismen ersetzten Rekurrenz, ermöglichten paralleles Training und bessere Langstreckenabhängigkeiten",
                  "nl": "Aandachtsmechanismen vervingen recurrentie, maakten parallelle training en betere lange-afstands afhankelijkheden mogelijk"
        },
        {
                  "en": "Invented computer vision",
                  "es": "Inventó visión por computadora",
                  "de": "Erfand Computer Vision",
                  "nl": "Vond computer vision uit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enabled reusing pretrained models for new tasks with limited data",
                  "es": "Habilitó reutilizar modelos preentrenados para nuevas tareas con datos limitados",
                  "de": "Ermöglichte Wiederverwendung vortrainierter Modelle für neue Aufgaben mit begrenzten Daten",
                  "nl": "Maakte hergebruik van voorgetrainde modellen mogelijk voor nieuwe taken met beperkte data"
        },
        {
                  "en": "Made training slower",
                  "es": "Hizo el entrenamiento más lento",
                  "de": "Machte Training langsamer",
                  "nl": "Maakte training langzamer"
        },
        {
                  "en": "Only worked for images",
                  "es": "Solo funcionó para imágenes",
                  "de": "Funktionierte nur für Bilder",
                  "nl": "Werkte alleen voor beelden"
        },
        {
                  "en": "Required more data",
                  "es": "Requirió más datos",
                  "de": "Erforderte mehr Daten",
                  "nl": "Vereiste meer data"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "First spell checker",
                  "es": "Primer corrector ortográfico",
                  "de": "Erster Rechtschreibprüfer",
                  "nl": "Eerste spellingcontrole"
        },
        {
                  "en": "Video game",
                  "es": "Videojuego",
        ...
        {
                  "en": "CMU system continuously learning facts from web since 2010",
                  "es": "Sistema de CMU aprendiendo continuamente hechos de la web desde 2010",
                  "de": "CMU-System das seit 2010 kontinuierlich Fakten aus dem Web lernt",
                  "nl": "CMU systeem dat continu feiten leert van het web sinds 2010"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "First computer program ever",
                  "es": "Primer programa de computadora jamás",
                  "de": "Erstes Computerprogramm überhaupt",
                  "nl": "Eerste computerprogramma ooit"
        },
        {
                  "en": "Created consciousness",
                  "es": "Creó conciencia",
                  "de": "Schuf Bewusstsein",
                  "nl": "Creëerde bewustzijn"
        },
        {
                  "en": "Bidirectional pretraining achieved state-of-the-art on multiple NLP benchmarks",
                  "es": "Preentrenamiento bidireccional logró estado del arte en múltiples benchmarks de procesamiento de lenguaje natural",
                  "de": "Bidirektionales Vortraining erreichte State-of-the-Art auf mehreren NLP-Benchmarks",
                  "nl": "Bidirectionele voortraining behaalde state-of-the-art op meerdere NLP benchmarks"
        },
        {
                  "en": "Invented language",
                  "es": "Inventó lenguaje",
                  "de": "Erfand Sprache",
                  "nl": "Vond taal uit"
        }
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Made training impossible",
                  "es": "Hizo el entrenamiento imposible",
                  "de": "Machte Training unmöglich",
                  "nl": "Maakte training onmogelijk"
        },
        {
                  "en": "Massively parallel architecture accelerated neural network training by 10-100x",
                  "es": "Arquitectura masivamente paralela aceleró entrenamiento de redes neuronales por 10-100x",
                  "de": "Massiv parallele Architektur beschleunigte neuronales Netzwerk-Training um das 10-100-fache",
                  "nl": "Massaal parallelle architectuur versnelde neurale netwerk training met 10-100x"
        },
        {
                  "en": "Slowed down computations",
                  "es": "Ralentizó las computaciones",
                  "de": "Verlangsamte Berechnungen",
                  "nl": "Vertraagde berekeningen"
        },
        {
                  "en": "Only useful for graphics",
                  "es": "Solo útil para gráficos",
                  "de": "Nur nützlich für Grafik",
                  "nl": "Alleen nuttig voor graphics"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Invented electricity",
                  "es": "Inventó la electricidad",
                  "de": "Erfand Elektrizität",
                  "nl": "Vond elektriciteit uit"
        },
        {
                  "en": "Showed unsupervised pretraining on text enabled few-shot and zero-shot learning",
                  "es": "Mostró que el preentrenamiento no supervisado en texto habilitó aprendizaje de pocos y cero ejemplos",
                  "de": "Zeigte dass unüberwachtes Vortraining auf Text Few-Shot und Zero-Shot Lernen ermöglichte",
                  "nl": "Toonde dat onbegeleid voortrainen op tekst few-shot en zero-shot leren mogelijk maakte"
        },
        {
                  "en": "First computer ever built",
                  "es": "Primera computadora jamás construida",
                  "de": "Erster jemals gebauter Computer",
                  "nl": "Eerste computer ooit gebouwd"
        },
        {
                  "en": "Created the internet",
                  "es": "Creó internet",
                  "de": "Schuf das Internet",
                  "nl": "Creëerde het internet"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI is impossible to build",
                  "es": "La IA es imposible de construir",
                  "de": "KI ist unmöglich zu bauen",
                  "nl": "AI is onmogelijk te bouwen"
        },
        {
                  "en": "Humans and AI are identical",
                  "es": "Humanos e IA son idénticos",
                  "de": "Menschen und KI sind identisch",
                  "nl": "Mensen en AI zijn identiek"
        },
        {
                  "en": "High-level reasoning is easier for AI than sensorimotor skills contrary to human experience",
                  "es": "Razonamiento de alto nivel es más fácil para IA que habilidades sensoriomotoras contrario a experiencia humana",
                  "de": "Hochrangiges Denken ist für KI einfacher als sensomotorische Fähigkeiten entgegen menschlicher Erfahrung",
                  "nl": "Hoog-niveau redeneren is makkelijker voor AI dan sensomotorische vaardigheden in tegenstelling tot menselijke ervaring"
        },
        {
                  "en": "Computers are always faster than humans",
                  "es": "Las computadoras siempre son más rápidas que los humanos",
                  "de": "Computer sind immer schneller als Menschen",
                  "nl": "Computers zijn altijd sneller dan mensen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Randomly dropping neurons during training prevented overfitting in deep networks",
                  "es": "Descartar aleatoriamente neuronas durante entrenamiento previno sobreajuste en redes profundas",
                  "de": "Zufälliges Fallenlassen von Neuronen während des Trainings verhinderte Überanpassung in tiefen Netzwerken",
                  "nl": "Willekeurig laten vallen van neuronen tijdens training voorkwam overfitting in diepe netwerken"
        },
        {
                  "en": "Made networks train slower always",
                  "es": "Hizo que las redes entrenaran más lento siempre",
                  "de": "Machte Netzwerke immer langsamer im Training",
                  "nl": "Maakte netwerken altijd langzamer trainen"
        },
        {
                  "en": "Only worked for small networks",
                  "es": "Solo funcionó para redes pequeñas",
                  "de": "Funktionierte nur für kleine Netzwerke",
                  "nl": "Werkte alleen voor kleine netwerken"
        },
        {
                  "en": "Required more data",
                  "es": "Requirió más datos",
