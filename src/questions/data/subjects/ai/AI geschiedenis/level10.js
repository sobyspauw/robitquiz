    ...
    questions: [
      {
        ...
        {
                  "en": "It solved the 50-year-old protein folding problem, demonstrating AI's potential for scientific breakthroughs",
                  "es": "Resolvió el problema de plegamiento de proteínas de 50 años, demostrando el potencial de la IA para avances científicos",
                  "de": "Es löste das 50 Jahre alte Proteinfaltungsproblem und demonstrierte das Potential der KI für wissenschaftliche Durchbrüche",
                  "nl": "Het loste het 50 jaar oude proteïnevouwingsprobleem op, wat het potentieel van AI voor wetenschappelijke doorbraken toonde"
        },
        {
        ...
        {
                  "en": "It created the first quantum computer",
                  "es": "Creó la primera computadora cuántica",
                  "de": "Es schuf den ersten Quantencomputer",
                  "nl": "Het creëerde de eerste quantumcomputer"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It enabled efficient training of multi-layer neural networks, launching the connectionist revival",
                  "es": "Permitió entrenamiento eficiente de redes neuronales multicapa, lanzando el resurgimiento conexionista",
                  "de": "Es ermöglichte effizientes Training mehrschichtiger neuronaler Netzwerke und startete das konnektionistische Wiederaufleben",
                  "nl": "Het maakte efficiënte training van meerlaagse neurale netwerken mogelijk, wat de connectionistische heropleving lanceerde"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "No tuvo impacto en el desarrollo de IA",
                  "de": "Es hatte keinen Einfluss auf KI-Entwicklung",
                  "nl": "Het had geen impact op AI ontwikkeling"
        },
        {
                  "en": "It solved all AI problems completely",
                  "es": "Resolvió todos los problemas de IA completamente",
                  "de": "Es löste alle KI-Probleme vollständig",
                  "nl": "Het loste alle AI problemen volledig op"
        },
        {
                  "en": "It enabled stored-program computing but created the von Neumann bottleneck limiting parallel processing",
                  "es": "Permitió computación de programa almacenado pero creó cuello de botella limitando procesamiento paralelo",
                  "de": "Ermöglichte gespeicherte Programmberechnung schuf aber von Neumann-Flaschenhals für parallele Verarbeitung",
                  "nl": "Maakte opgeslagen-programma computing mogelijk maar creëerde von Neumann bottleneck voor parallelle verwerking"
        },
        {
                  "en": "It made AI impossible to develop",
                  "es": "Hizo imposible desarrollar IA",
                  "de": "Es machte KI-Entwicklung unmöglich",
                  "nl": "Het maakte AI ontwikkeling onmogelijk"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It established that any computable function can be computed by a Turing machine, providing theoretical basis for AI computability",
                  "es": "Estableció que cualquier función computable puede ser computada por una máquina de Turing, proporcionando base teórica para computabilidad de IA",
                  "de": "Es etablierte dass jede berechenbare Funktion von einer Turing-Maschine berechnet werden kann und bot theoretische Grundlage für KI-Berechenbarkeit",
                  "nl": "Het stelde vast dat elke berekenbare functie kan worden berekend door een Turing machine, wat theoretische basis bood voor AI berekenbaarheid"
        },
        {
                  "en": "It proved that AI is impossible",
                  "es": "Probó que la IA es imposible",
                  "de": "Es bewies dass KI unmöglich ist",
                  "nl": "Het bewees dat AI onmogelijk is"
        },
        {
                  "en": "It created the first computer",
                  "es": "Creó la primera computadora",
        ...
        {
                  "en": "It solved consciousness completely",
                  "es": "Resolvió la conciencia completamente",
                  "de": "Es löste Bewusstsein vollständig",
                  "nl": "Het loste bewustzijn volledig op"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "It invented computer graphics",
                  "es": "Inventó gráficos por computadora",
                  "de": "Es erfand Computergrafik",
                  "nl": "Het vond computergraphics uit"
        },
        {
        ...
        {
                  "en": "It provided mathematical foundations for sequential decision-making under uncertainty",
                  "es": "Proporcionó fundamentos matemáticos para toma de decisiones secuencial bajo incertidumbre",
                  "de": "Es bot mathematische Grundlagen für sequenzielle Entscheidungsfindung unter Unsicherheit",
                  "nl": "Het bood wiskundige fundamenten voor sequentiële besluitvorming onder onzekerheid"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All experts agree it will happen in 2025",
                  "es": "Todos los expertos coinciden en que sucederá en 2025",
                  "de": "Alle Experten sind sich einig dass es 2025 passiert",
                  "nl": "Alle experts zijn het erover eens dat het in 2025 zal gebeuren"
        },
        {
                  "en": "Estimates vary widely from 2029 to beyond 2070, with significant uncertainty among experts",
                  "es": "Las estimaciones varían ampliamente desde 2029 hasta más allá de 2070, con incertidumbre significativa entre expertos",
                  "de": "Schätzungen variieren stark von 2029 bis über 2070, mit erheblicher Unsicherheit unter Experten",
                  "nl": "Schattingen variëren sterk van 2029 tot voorbij 2070, met aanzienlijke onzekerheid onder experts"
        },
        {
                  "en": "It is impossible and will never happen",
                  "es": "Es imposible y nunca sucederá",
                  "de": "Es ist unmöglich und wird nie passieren",
                  "nl": "Het is onmogelijk en zal nooit gebeuren"
        },
        {
                  "en": "It has already been achieved",
                  "es": "Ya se ha logrado",
                  "de": "Es wurde bereits erreicht",
                  "nl": "Het is al bereikt"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It's about organizing AI research teams",
                  "es": "Se trata de organizar equipos de investigación de IA",
                  "de": "Es geht um die Organisation von KI-Forschungsteams",
                  "nl": "Het gaat over het organiseren van AI onderzoeksteams"
        },
        {
                  "en": "It's about making AI systems run faster",
                  "es": "Se trata de hacer que los sistemas de IA funcionen más rápido",
                  "de": "Es geht darum KI-Systeme schneller laufen zu lassen",
                  "nl": "Het gaat over het sneller laten draaien van AI systemen"
        },
        {
                  "en": "It's the problem of AI systems being too expensive",
                  "es": "Es el problema de que los sistemas de IA sean demasiado caros",
                  "de": "Es ist das Problem dass KI-Systeme zu teuer sind",
                  "nl": "Het is het probleem dat AI systemen te duur zijn"
        },
        {
                  "en": "It's the challenge of ensuring AI systems pursue goals aligned with human values and intentions",
                  "es": "El desafío de asegurar que IA persiga objetivos alineados con valores e intenciones humanas",
                  "de": "Die Herausforderung sicherzustellen dass KI-Systeme Ziele verfolgen die mit menschlichen Werten übereinstimmen",
                  "nl": "De uitdaging ervoor te zorgen dat AI systemen doelen nastreven die overeenkomen met menselijke waarden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Power concentration, loss of human agency, existential risk from misaligned goals, and rapid societal transformation",
                  "es": "Concentración de poder, pérdida de agencia humana, riesgo existencial por objetivos mal alineados y transformación social rápida",
                  "de": "Machtkonzentration, Verlust menschlicher Handlungsfähigkeit, existenzielles Risiko durch falsch ausgerichtete Ziele und schnelle gesellschaftliche Transformation",
                  "nl": "Machtsconcentratie, verlies van menselijke agency, existentiële risico's door verkeerd uitgelijnde doelen, en snelle maatschappelijke transformatie"
        },
        {
                  "en": "Only job displacement in manual labor",
                  "es": "Solo desplazamiento laboral en trabajo manual",
                  "de": "Nur Arbeitsplatzverdrängung in manueller Arbeit",
                  "nl": "Alleen baanverplaatsing in handwerk"
        },
        {
                  "en": "Only increased electricity consumption",
                  "es": "Solo mayor consumo de electricidad",
                  "de": "Nur erhöhter Stromverbrauch",
                  "nl": "Alleen verhoogd elektriciteitsverbruik"
        },
        {
                  "en": "No significant risks at all",
                  "es": "Ningún riesgo significativo en absoluto",
                  "de": "Keine erheblichen Risiken überhaupt",
                  "nl": "Helemaal geen significante risico's"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The moment when AI systems first learn to fly",
                  "es": "El momento cuando los sistemas de IA aprenden por primera vez a volar",
                  "de": "Der Moment wenn KI-Systeme zuerst lernen zu fliegen",
                  "nl": "Het moment wanneer AI systemen voor het eerst leren vliegen"
        },
        {
                  "en": "A rapid recursive self-improvement cycle where AI systems quickly become superintelligent",
                  "es": "Un ciclo rápido de auto-mejora recursiva donde los sistemas de IA se vuelven rápidamente superinteligentes",
                  "de": "Ein schneller rekursiver Selbstverbesserungszyklus wo KI-Systeme schnell superintelligent werden",
                  "nl": "Een snelle recursieve zelfverbeterings cyclus waarbij AI systemen snel superintelligent worden"
        },
        {
                  "en": "When AI systems become popular with consumers",
                  "es": "Cuando los sistemas de IA se vuelven populares entre los consumidores",
                  "de": "Wenn KI-Systeme bei Verbrauchern populär werden",
                  "nl": "Wanneer AI systemen populair worden bij consumenten"
        },
        {
                  "en": "The launch of the first AI satellite",
                  "es": "El lanzamiento del primer satélite de IA",
                  "de": "Der Start des ersten KI-Satelliten",
                  "nl": "De lancering van de eerste AI satelliet"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No significant role in research",
                  "es": "Ningún papel significativo en investigación",
                  "de": "Keine bedeutende Rolle in der Forschung",
                  "nl": "Geen significante rol in onderzoek"
        },
        {
                  "en": "Automated hypothesis generation, experiment design, data analysis, and potentially autonomous research agents",
                  "es": "Generación automatizada de hipótesis, diseño de experimentos, análisis de datos y potencialmente agentes de investigación autónomos",
                  "de": "Automatisierte Hypothesengenerierung, Experimentdesign, Datenanalyse und möglicherweise autonome Forschungsagenten",
                  "nl": "Geautomatiseerde hypothesegeneratie, experimentontwerp, data-analyse en mogelijk autonome onderzoeksagenten"
        },
        {
                  "en": "Only organizing research papers",
                  "es": "Solo organizando artículos de investigación",
                  "de": "Nur Organisierung von Forschungsarbeiten",
                  "nl": "Alleen het organiseren van onderzoekspapers"
        },
        {
                  "en": "Only replacing laboratory equipment",
                  "es": "Solo reemplazando equipo de laboratorio",
                  "de": "Nur Ersatz von Laborausrüstung",
                  "nl": "Alleen het vervangen van laboratoriumapparatuur"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "How to control AI training speed",
                  "es": "Cómo controlar la velocidad de entrenamiento de IA",
                  "de": "Wie man die KI-Trainingsgeschwindigkeit kontrolliert",
                  "nl": "Hoe AI trainingssnelheid te controleren"
        },
        {
                  "en": "How to control the temperature of AI processors",
                  "es": "Cómo controlar la temperatura de los procesadores de IA",
                  "de": "Wie man die Temperatur von KI-Prozessoren kontrolliert",
                  "nl": "Hoe de temperatuur van AI processors te controleren"
        },
        {
                  "en": "How to control AI development costs",
                  "es": "Cómo controlar los costos de desarrollo de IA",
                  "de": "Wie man KI-Entwicklungskosten kontrolliert",
                  "nl": "Hoe AI ontwikkelingskosten te controleren"
        },
        {
                  "en": "How to maintain meaningful human control over increasingly capable AI systems",
                  "es": "Cómo mantener control humano significativo sobre sistemas de IA cada vez más capaces",
                  "de": "Wie man bedeutsame menschliche Kontrolle über zunehmend fähige KI-Systeme aufrechterhält",
                  "nl": "Hoe betekenisvolle menselijke controle te behouden over steeds capabelere AI systemen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating more jobs than it displaces with no adjustment needed",
                  "es": "Creando más empleos de los que desplaza sin necesidad de ajuste",
                  "de": "Mehr Arbeitsplätze schaffen als verdrängt ohne Anpassungsbedarf",
                  "nl": "Meer banen creëren dan het verplaatst zonder aanpassing nodig"
        },
        {
                  "en": "Only affecting manual labor jobs",
                  "es": "Solo afectando trabajos de mano de obra manual",
                  "de": "Nur Auswirkung auf manuelle Arbeitsplätze",
                  "nl": "Alleen invloed op handwerkbanen"
        },
        {
                  "en": "Widespread job displacement and creation, requiring massive reskilling and potentially new social contracts",
                  "es": "Desplazamiento y creación generalizada de empleos, requiriendo reciclaje masivo y potencialmente nuevos contratos sociales",
                  "de": "Weitreichende Arbeitsplatzverdrängung und -schaffung, die massive Umschulung und möglicherweise neue Gesellschaftsverträge erfordert",
                  "nl": "Wijdverspreide baanverplaatsing en -creatie, wat massale herscholing en mogelijk nieuwe sociale contracten vereist"
        },
        {
                  "en": "No impact on employment at all",
                  "es": "Ningún impacto en el empleo en absoluto",
                  "de": "Keine Auswirkung auf Beschäftigung überhaupt",
                  "nl": "Helemaal geen impact op werkgelegenheid"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The management of AI company finances",
                  "es": "La gestión de las finanzas de empresas de IA",
                  "de": "Die Verwaltung von KI-Unternehmensfinanzen",
                  "nl": "Het beheer van AI bedrijfsfinanciën"
        },
        {
                  "en": "The training of AI models",
                  "es": "El entrenamiento de modelos de IA",
                  "de": "Das Training von KI-Modellen",
                  "nl": "De training van AI modellen"
        },
        {
                  "en": "The organization of AI research conferences",
                  "es": "La organización de conferencias de investigación de IA",
                  "de": "Die Organisation von KI-Forschungskonferenzen",
                  "nl": "De organisatie van AI onderzoeksconferenties"
        },
        {
                  "en": "The systems and frameworks for regulating, overseeing, and ensuring responsible development of AI technologies",
                  "es": "Los sistemas y marcos para regular, supervisar y asegurar el desarrollo responsable de tecnologías de IA",
                  "de": "Die Systeme und Rahmenwerke zur Regulierung, Überwachung und Sicherstellung verantwortlicher Entwicklung von KI-Technologien",
                  "nl": "De systemen en kaders voor het reguleren, toezien en zorgen voor verantwoordelijke ontwikkeling van AI technologieën"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No significant impact on AI",
                  "es": "Ningún impacto significativo en IA",
                  "de": "Keine erhebliche Auswirkung auf KI",
                  "nl": "Geen significante impact op AI"
        },
        {
                  "en": "Exponential speedup for certain optimization problems and potentially new quantum machine learning algorithms",
                  "es": "Aceleración exponencial para problemas de optimización y nuevos algoritmos de aprendizaje automático cuántico",
                  "de": "Exponentielle Beschleunigung für Optimierungsprobleme und möglicherweise neue Quantenmaschinenlernalgorithmen",
                  "nl": "Exponentiële versnelling voor optimalisatieproblemen en mogelijk nieuwe quantum machine learning algoritmen"
        },
        {
                  "en": "Only faster data storage",
                  "es": "Solo almacenamiento de datos más rápido",
                  "de": "Nur schnellere Datenspeicherung",
                  "nl": "Alleen snellere dataopslag"
        },
        {
                  "en": "Only improved graphics processing",
                  "es": "Solo mejor procesamiento de gráficos",
                  "de": "Nur verbesserte Grafikverarbeitung",
                  "nl": "Alleen verbeterde grafische verwerking"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only improving recycling programs",
                  "es": "Solo mejorando programas de reciclaje",
                  "de": "Nur Verbesserung von Recyclingprogrammen",
                  "nl": "Alleen verbeteren van recyclingprogramma's"
        },
        {
                  "en": "No environmental benefits possible",
                  "es": "Ninguno beneficio ambiental posible",
                  "de": "Keine Umweltvorteile möglich",
                  "nl": "Geen milieuvoordelen mogelijk"
        },
        {
                  ...
                  "es": "Optimizando sistemas de energía, mejorando modelado climático, habilitando redes inteligentes y acelerando desarrollo de tecnologías limpias",
                  "de": "Optimierung von Energiesystemen, Verbesserung der Klimamodellierung, Ermöglichung intelligenter Netze und Beschleunigung der Entwicklung sauberer Technologien",
                  "nl": "Optimaliseren van energiesystemen, verbeteren van klimaatmodellering, mogelijk maken van slimme netwerken en versnellen van ontwikkeling van schone technologieën"
        },
        {
                  "en": "Only reducing paper usage in offices",
                  "es": "Solo reduciendo el uso de papel en oficinas",
                  "de": "Nur Reduzierung des Papiereinsatzes in Büros",
                  "nl": "Alleen het verminderen van papiergebruik op kantoren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only allowing governments to develop AI",
                  "es": "Solo permitir que los gobiernos desarrollen IA",
                  "de": "Nur Regierungen erlauben KI zu entwickeln",
                  "nl": "Alleen overheden toestaan AI te ontwikkelen"
        },
        {
                  "en": "Holding elections for AI development decisions",
                  "es": "Realizando elecciones para decisiones de desarrollo de IA",
                  "de": "Abhaltung von Wahlen für KI-Entwicklungsentscheidungen",
                  "nl": "Verkiezingen houden voor AI ontwikkelingsbeslissingen"
        },
        {
                  "en": "Making AI tools and capabilities accessible to everyone, not just large tech companies and experts",
                  "es": "Hacer herramientas y capacidades IA accesibles para todos, no solo grandes empresas tech y expertos",
                  "de": "KI-Tools und -Fähigkeiten für alle zugänglich machen, nicht nur für große Tech-Unternehmen",
                  "nl": "AI tools en mogelijkheden toegankelijk maken voor iedereen, niet alleen grote tech bedrijven"
        },
        {
                  "en": "Making AI systems vote on political issues",
                  "es": "Hacer que los sistemas de IA voten en temas políticos",
                  "de": "KI-Systeme über politische Themen abstimmen lassen",
                  "nl": "AI systemen laten stemmen over politieke kwesties"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No role in AI interaction",
                  "es": "Ningún papel en interacción con IA",
                  "de": "Keine Rolle in KI-Interaktion",
                  "nl": "Geen rol in AI interactie"
        },
        {
                  "en": "Direct neural communication with AI systems, potentially enabling thought-speed interaction and cognitive augmentation",
                  "es": "Comunicación neural directa con IA, habilitando interacción a velocidad del pensamiento y aumento cognitivo",
                  "de": "Direkte neuronale Kommunikation mit KI-Systemen, Interaktion in Gedankengeschwindigkeit und kognitive Erweiterung ermöglichend",
                  "nl": "Directe neurale communicatie met AI systemen, interactie op gedachtesnelheid en cognitieve versterking mogelijk makend"
        },
        {
                  "en": "Only controlling computer mice with thoughts",
                  "es": "Solo controlando ratones de computadora con pensamientos",
                  "de": "Nur Computermeuse mit Gedanken kontrollieren",
                  "nl": "Alleen computermuizen met gedachten besturen"
        },
        {
                  "en": "Only for medical applications",
                  "es": "Solo para aplicaciones médicas",
                  "de": "Nur für medizinische Anwendungen",
                  "nl": "Alleen voor medische toepassingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Impossible with any conceivable technology",
                  "es": "Imposible con cualquier tecnología concebible",
                  "de": "Unmöglich mit jeder denkbaren Technologie",
                  "nl": "Onmogelijk met enige denkbare technologie"
        },
        {
                  "en": "Only requires faster computers, no other breakthroughs needed",
                  "es": "Solo requiere computadoras más rápidas, no se necesitan otros avances",
                  "de": "Erfordert nur schnellere Computer, keine anderen Durchbrüche nötig",
                  "nl": "Vereist alleen snellere computers, geen andere doorbraken nodig"
        },
        {
                  "en": "Definitely achievable by 2025 with current technology",
                  "es": "Definitivamente alcanzable para 2025 con tecnología actual",
                  "de": "Definitiv erreichbar bis 2025 mit aktueller Technologie",
                  "nl": "Zeker haalbaar tegen 2025 met huidige technologie"
        },
        {
                  "en": "Highly uncertain timeline with major challenges in reasoning, common sense, transfer learning, and defining intelligence itself",
                  "es": "Cronología altamente incierta con desafíos importantes en razonamiento, sentido común, aprendizaje por transferencia y definir la inteligencia misma",
                  "de": "Hochgradig unsicherer Zeitplan mit großen Herausforderungen bei Denkfähigkeit, gesundem Menschenverstand, Transfer-Learning und Definition von Intelligenz selbst",
                  "nl": "Zeer onzekere tijdlijn met grote uitdagingen in redenering, gezond verstand, transfer learning en het definiëren van intelligentie zelf"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only profit maximization principles",
                  "es": "Solo principios de maximización de ganancias",
                  "de": "Nur Gewinnmaximierungsprinzipien",
                  "nl": "Alleen winstmaximalisatie principes"
        },
        {
                  "en": "No ethical frameworks are needed for AI",
                  "es": "No se necesitan marcos éticos para IA",
                  "de": "Keine ethischen Rahmenwerke für KI nötig",
                  "nl": "Geen ethische kaders nodig voor AI"
        },
        {
                  "en": "Principles like beneficence, non-maleficence, autonomy, justice, and transparency, plus new frameworks for AI-specific challenges",
                  "es": "Principios como beneficencia, no maleficencia, autonomía, justicia, transparencia, y nuevos marcos para desafíos de IA",
                  "de": "Prinzipien wie Wohltätigkeit, Schadensvermeidung, Autonomie, Gerechtigkeit, Transparenz, plus neue KI-Rahmenwerke",
                  "nl": "Principes zoals weldadigheid, niet-schadelijkheid, autonomie, rechtvaardigheid, transparantie, en nieuwe AI kaders"
        },
        {
                  "en": "Only technical performance metrics",
                  "es": "Solo métricas de rendimiento técnico",
                  "de": "Nur technische Leistungsmetriken",
                  "nl": "Alleen technische prestatiemetrieken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Highly controversial with theories ranging from impossible to inevitable, but no scientific consensus yet",
                  "es": "Altamente controvertido con teorías que van desde imposible hasta inevitable, pero aún no hay consenso científico",
                  "de": "Hochumstritten mit Theorien von unmöglich bis unvermeidlich, aber noch kein wissenschaftlicher Konsens",
                  "nl": "Zeer controversieel met theorieën variërend van onmogelijk tot onvermijdelijk, maar nog geen wetenschappelijke consensus"
        },
        {
                  "en": "Artificial consciousness has already been definitively achieved",
                  "es": "La conciencia artificial ya se ha logrado definitivamente",
                  "de": "Künstliches Bewusstsein wurde bereits definitiv erreicht",
                  "nl": "Kunstmatig bewustzijn is al definitief bereikt"
        },
        {
                  "en": "All scientists agree consciousness is impossible in machines",
                  "es": "Todos los científicos están de acuerdo en que la conciencia es imposible en máquinas",
                  "de": "Alle Wissenschaftler sind sich einig dass Bewusstsein in Maschinen unmöglich ist",
                  "nl": "Alle wetenschappers zijn het erover eens dat bewustzijn onmogelijk is in machines"
        },
        {
                  "en": "Consciousness will automatically emerge when AI systems become complex enough",
                  "es": "La conciencia emergerá automáticamente cuando los sistemas de IA se vuelvan suficientemente complejos",
                  "de": "Bewusstsein wird automatisch entstehen wenn KI-Systeme komplex genug werden",
                  "nl": "Bewustzijn zal automatisch ontstaan wanneer AI systemen complex genoeg worden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They invented digital cameras",
                  "es": "Inventaron cámaras digitales",
                  "de": "Sie erfanden Digitalkameras",
                  "nl": "Ze vonden digitale camera's uit"
        },
        {
                  "en": "They created the first color displays",
                  "es": "Crearon las primeras pantallas a color",
                  "de": "Sie schufen die ersten Farbbildschirme",
                  "nl": "Ze creëerden de eerste kleurenschermen"
        },
        {
                  "en": "They enabled computers to achieve human-level performance on visual recognition tasks for the first time",
                  "es": "Permitieron a las computadoras lograr rendimiento a nivel humano en tareas de reconocimiento visual por primera vez",
                  "de": "Sie ermöglichten Computern zum ersten Mal menschliches Niveau bei visuellen Erkennungsaufgaben zu erreichen",
                  "nl": "Ze stelden computers in staat menselijk-niveau prestaties te behalen op visuele herkenningsta ken voor het eerst"
        },
        {
                  "en": "They had no impact on computer vision",
                  "es": "No tuvieron impacto en visión por computadora",
                  "de": "Sie hatten keinen Einfluss auf Computer Vision",
                  "nl": "Ze hadden geen impact op computer vision"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Only making computers slightly faster",
                  "es": "Solo hacer computadoras ligeramente más rápidas",
                  "de": "Nur Computer etwas schneller machen",
                  "nl": "Alleen computers iets sneller maken"
        },
        {
                  "en": "Brain-inspired chips could enable vastly more energy-efficient AI with parallel processing and event-driven computation",
                  "es": "Chips inspirados en el cerebro podrían habilitar IA vastamente más eficiente en energía con procesamiento paralelo y computación impulsada por eventos",
                  "de": "Gehirninspirierte Chips könnten weitaus energieeffizientere KI mit paralleler Verarbeitung und ereignisgesteuerter Berechnung ermöglichen",
                  "nl": "Door hersenen geïnspireerde chips zouden veel energie-efficiëntere AI mogelijk kunnen maken met parallelle verwerking en event-driven computing"
        },
        {
                  "en": "Only improving gaming performance",
                  "es": "Solo mejorando rendimiento de juegos",
                  "de": "Nur Verbesserung der Spieleleistung",
                  "nl": "Alleen gaming prestaties verbeteren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No potential in healthcare applications",
                  "es": "Ningún potencial en aplicaciones de atención médica",
                  "de": "Kein Potenzial in Gesundheitsanwendungen",
                  "nl": "Geen potentieel in gezondheidszorg applicaties"
        },
        {
                  "en": "Only used for scheduling appointments",
                  "es": "Solo usado para programar citas",
                  "de": "Nur für Terminplanung verwendet",
                  "nl": "Alleen gebruikt voor het plannen van afspraken"
        },
        {
                  "en": "Only for billing and insurance",
                  "es": "Solo para facturación y seguros",
                  "de": "Nur für Abrechnung und Versicherung",
                  "nl": "Alleen voor facturering en verzekering"
        },
        {
                  "en": "Opportunities in diagnostic accuracy and drug discovery, but challenges in data privacy, liability, and trust",
                  "es": "Oportunidades en precisión diagnóstica y descubrimiento de fármacos, pero desafíos en privacidad de datos, responsabilidad y confianza",
                  "de": "Chancen bei diagnostischer Genauigkeit und Medikamentenentdeckung, aber Herausforderungen bei Datenschutz, Haftung und Vertrauen",
                  "nl": "Kansen in diagnostische nauwkeurigheid en medicijnontdekking, maar uitdagingen in dataprivacy, aansprakelijkheid en vertrouwen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They have no practical applications",
                  "es": "No tienen aplicaciones prácticas",
                  "de": "Sie haben keine praktischen Anwendungen",
                  "nl": "Ze hebben geen praktische toepassingen"
        },
        {
                  "en": "They enable models to perform new tasks with minimal or no task-specific training examples",
                  "es": "Permiten a modelos realizar tareas nuevas con ejemplos de entrenamiento específicos mínimos o nulos",
                  "de": "Sie ermöglichen Modellen neue Aufgaben mit minimalen oder keinen aufgabenspezifischen Trainingsbeispielen durchzuführen",
                  "nl": "Ze stellen modellen in staat nieuwe taken uit te voeren met minimale of geen taak-specifieke trainingsvoorbeelden"
        },
        {
                  "en": "Only reducing model size",
                  "es": "Solo reduciendo el tamaño del modelo",
                  "de": "Nur Modellgröße reduzieren",
                  "nl": "Alleen model grootte verminderen"
        },
        {
                  "en": "Only making models train faster",
                  "es": "Solo hacer que los modelos entrenen más rápido",
                  "de": "Nur Modelle schneller trainieren lassen",
                  "nl": "Alleen modellen sneller laten trainen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Early warning systems, resource optimization, accelerated research, and improved modeling and prediction",
                  "es": "Sistemas de alerta temprana, optimización de recursos, investigación acelerada y modelado y predicción mejorados",
                  "de": "Frühwarnsysteme, Ressourcenoptimierung, beschleunigte Forschung und verbesserte Modellierung und Vorhersage",
                  "nl": "Vroege waarschuwingssystemen, resource optimalisatie, versneld onderzoek en verbeterde modellering en voorspelling"
        },
        {
                  "en": "Only writing reports about these issues",
                  "es": "Solo escribiendo informes sobre estos temas",
                  "de": "Nur Berichte über diese Themen schreiben",
                  "nl": "Alleen rapporten schrijven over deze kwesties"
        },
        {
                  "en": "Only organizing conferences",
                  "es": "Solo organizando conferencias",
                  "de": "Nur Konferenzen organisieren",
                  "nl": "Alleen conferenties organiseren"
        },
        {
                  "en": "No contribution to solving global challenges",
                  "es": "Ninguna contribución a resolver desafíos globales",
                  "de": "Kein Beitrag zur Lösung globaler Herausforderungen",
                  "nl": "Geen bijdrage aan het oplossen van mondiale uitdagingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They enable more natural human-like understanding by integrating information across sensory modalities",
                  "es": "Permiten comprensión más natural similar a la humana integrando información a través de modalidades sensoriales",
                  "de": "Sie ermöglichen natürlicheres menschenähnliches Verständnis durch Integration von Informationen über sensorische Modalitäten",
                  "nl": "Ze maken meer natuurlijk menselijk-achtig begrip mogelijk door informatie over zintuiglijke modaliteiten te integreren"
        },
        {
                  "en": "Only making AI systems larger",
                  "es": "Solo hacer sistemas de IA más grandes",
                  "de": "Nur KI-Systeme größer machen",
                  "nl": "Alleen AI systemen groter maken"
        },
        {
                  "en": "They have no practical advantages",
                  "es": "No tienen ventajas prácticas",
                  "de": "Sie haben keine praktischen Vorteile",
                  "nl": "Ze hebben geen praktische voordelen"
        },
        {
                  "en": "Only for entertainment applications",
                  "es": "Solo para aplicaciones de entretenimiento",
                  "de": "Nur für Unterhaltungsanwendungen",
                  "nl": "Alleen voor entertainment applicaties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only affecting graphic designers",
                  "es": "Solo afectando diseñadores gráficos",
                  "de": "Nur Grafikdesigner beeinflussen",
                  "nl": "Alleen grafisch ontwerpers beïnvloeden"
        },
        {
                  "en": "Only making content production faster",
                  "es": "Solo haciendo producción de contenido más rápida",
                  "de": "Nur Content-Produktion schneller machen",
                  "nl": "Alleen contentproductie sneller maken"
        },
        {
                  "en": "No significant societal implications",
                  "es": "Ninguna implicación social significativa",
                  "de": "Keine erheblichen gesellschaftlichen Auswirkungen",
                  "nl": "Geen significante maatschappelijke implicaties"
        },
        {
                  "en": "Challenges to authenticity, trust in media, intellectual property, creative professions, and the concept of authorship",
                  "es": "Desafíos a autenticidad, confianza en medios, propiedad intelectual, profesiones creativas y concepto de autoría",
                  "de": "Herausforderungen für Authentizität, Medienvertrauen, geistiges Eigentum, kreative Berufe und das Konzept der Urheberschaft",
                  "nl": "Uitdagingen voor authenticiteit, vertrouwen in media, intellectueel eigendom, creatieve beroepen en het concept van auteurschap"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only improving training speed",
                  "es": "Solo mejorando velocidad de entrenamiento",
                  "de": "Nur Trainingsgeschwindigkeit verbessern",
                  "nl": "Alleen trainingssnelheid verbeteren"
        },
        {
                  "en": "Only making models use more memory",
                  "es": "Solo hacer que los modelos usen más memoria",
                  "de": "Nur Modelle mehr Speicher nutzen lassen",
                  "nl": "Alleen modellen meer geheugen laten gebruiken"
        },
        {
                  "en": "It has no theoretical significance",
                  "es": "No tiene importancia teórica",
                  "de": "Es hat keine theoretische Bedeutung",
                  "nl": "Het heeft geen theoretische betekenis"
        },
        {
                  "en": "It suggests that scaling AI systems may unlock qualitatively new capabilities unpredictably",
                  "es": "Sugiere que escalar sistemas de IA puede desbloquear capacidades cualitativamente nuevas de manera impredecible",
                  "de": "Es deutet darauf hin dass Skalierung von KI-Systemen qualitativ neue Fähigkeiten unvorhersehbar freischalten könnte",
                  "nl": "Het suggereert dat het opschalen van AI systemen kwalitatief nieuwe mogelijkheden onvoorspelbaar kan ontgrendelen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Personalized learning, AI tutors, automated grading, but challenges in equity, cheating, and redefining educational goals",
                  "es": "Aprendizaje personalizado, tutores IA, calificación automatizada, pero desafíos en equidad, trampas y redefinición de objetivos educativos",
                  "de": "Personalisiertes Lernen, KI-Tutoren, automatisierte Benotung, aber Herausforderungen bei Gleichheit, Betrug und Neudefinition von Bildungszielen",
                  "nl": "Gepersonaliseerd leren, AI tutors, geautomatiseerd cijferen, maar uitdagingen in gelijkheid, valsspelen en herdefiniëren van onderwijsdoelen"
        },
        {
                  "en": "Only replacing textbooks",
                  "es": "Solo reemplazando libros de texto",
                  "de": "Nur Lehrbücher ersetzen",
                  "nl": "Alleen tekstboeken vervangen"
        },
        {
                  "en": "Only for administrative tasks",
                  "es": "Solo para tareas administrativas",
                  "de": "Nur für administrative Aufgaben",
                  "nl": "Alleen voor administratieve taken"
        },
        {
                  "en": "No significant impact on education",
                  "es": "Ningún impacto significativo en educación",
                  "de": "Keine erhebliche Auswirkung auf Bildung",
                  "nl": "Geen significante impact op onderwijs"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only about copyright for AI-generated content",
                  "es": "Solo sobre derechos de autor para contenido generado por IA",
                  "de": "Nur über Urheberrechte für KI-generierte Inhalte",
                  "nl": "Alleen over auteursrecht voor AI-gegenereerde content"
        },
        {
                  "en": "AI systems already have full human rights",
                  "es": "Los sistemas de IA ya tienen plenos derechos humanos",
                  "de": "KI-Systeme haben bereits volle Menschenrechte",
                  "nl": "AI systemen hebben al volledige mensenrechten"
        },
        {
                  "en": "As AI systems become more sophisticated, questions arise about moral status, potential sentience, and ethical treatment",
                  "es": "A medida que los sistemas de IA se vuelven más sofisticados, surgen preguntas sobre estatus moral, posible sensibilidad y trato ético",
                  "de": "Während KI-Systeme sophistizierter werden entstehen Fragen über moralischen Status, mögliche Empfindungsfähigkeit und ethische Behandlung",
                  "nl": "Naarmate AI systemen sophisticater worden, rijzen vragen over morele status, mogelijke bewustwording en ethische behandeling"
        },
        {
                  "en": "No one discusses AI rights",
                  "es": "Nadie discute los derechos de IA",
                  "de": "Niemand diskutiert KI-Rechte",
                  "nl": "Niemand bespreekt AI rechten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only that they are too expensive",
                  "es": "Solo que son demasiado caros",
                  "de": "Nur dass sie zu teuer sind",
                  "nl": "Alleen dat ze te duur zijn"
        },
        {
                  "en": "No significant limitations remain",
                  "es": "No quedan limitaciones significativas",
                  "de": "Keine erheblichen Einschränkungen bleiben",
                  "nl": "Geen significante beperkingen blijven over"
        },
        {
                  "en": "Only that they require internet connection",
                  "es": "Solo que requieren conexión a internet",
                  "de": "Nur dass sie Internetverbindung benötigen",
                  "nl": "Alleen dat ze internetverbinding vereisen"
        },
        {
                  "en": "Hallucinations, reasoning limitations, lack of true understanding, training data biases, and inability to update knowledge easily",
                  "es": "Alucinaciones, limitaciones de razonamiento, falta de comprensión verdadera, sesgos de datos de entrenamiento e incapacidad de actualizar conocimiento fácilmente",
                  "de": "Halluzinationen, Denkbeschränkungen, Mangel an echtem Verständnis, Trainingsdatenverzerrungen und Unfähigkeit Wissen einfach zu aktualisieren",
                  "nl": "Hallucinaties, redeneringsbeperkingen, gebrek aan echt begrip, trainingsdata vooroordelen en onvermogen om kennis gemakkelijk bij te werken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No applications in space research",
                  "es": "Sin aplicaciones en investigación espacial",
                  "de": "Keine Anwendungen in Weltraumforschung",
                  "nl": "Geen toepassingen in ruimteonderzoek"
        },
        {
                  "en": "Only for satellite TV",
                  "es": "Solo para TV satelital",
                  "de": "Nur für Satelliten-TV",
                  "nl": "Alleen voor satelliet TV"
        },
        {
                  "en": "Analyzing vast telescope data, autonomous spacecraft navigation, discovering exoplanets, and simulating cosmic phenomena",
                  "es": "Analizar vastos datos de telescopio, navegación autónoma de naves espaciales, descubrir exoplanetas y simular fenómenos cósmicos",
                  "de": "Analyse gewaltiger Teleskop daten, autonome Raumfahrzeugnavigation, Entdeckung von Exoplaneten und Simulation kosmischer Phänomene",
                  "nl": "Analyseren van enorme telescoop data, autonome ruimtevaartuig navigatie, ontdekken van exoplaneten en simuleren van kosmische fenomenen"
        },
        {
                  "en": "Only launching rockets",
                  "es": "Solo lanzando cohetes",
                  "de": "Nur Raketen starten",
                  "nl": "Alleen raketten lanceren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They enable training AI models on distributed data without centralizing sensitive information",
                  "es": "Permiten entrenar modelos de IA en datos distribuidos sin centralizar información sensible",
                  "de": "Sie ermöglichen Training von KI-Modellen auf verteilten Daten ohne Zentralisierung sensibler Informationen",
                  "nl": "Ze maken training van AI modellen op gedistribueerde data mogelijk zonder gevoelige informatie te centraliseren"
        },
        {
                  "en": "Only reducing model size",
                  "es": "Solo reduciendo el tamaño del modelo",
        ...
        {
                  "en": "They have no privacy benefits",
                  "es": "No tienen beneficios de privacidad",
                  "de": "Sie haben keine Datenschutzvorteile",
                  "nl": "Ze hebben geen privacy voordelen"
        },
        {
                  "en": "Only making models train faster",
                  "es": "Solo hacer que los modelos entrenen más rápido",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only for entertainment purposes",
                  "es": "Solo para propósitos de entretenimiento",
                  "de": "Nur für Unterhaltungszwecke",
                  "nl": "Alleen voor entertainment doeleinden"
        },
        {
                  "en": "Language documentation, translation, teaching tools, and digital preservation of cultural artifacts",
                  "es": "Documentación de idiomas, traducción, herramientas de enseñanza y preservación digital de artefactos culturales",
                  "de": "Sprachdokumentation, Übersetzung, Lehrwerkzeuge und digitale Bewahrung kultureller Artefakte",
                  "nl": "Taaldocumentatie, vertaling, onderwijstools en digitale bewaring van culturele artefacten"
        },
        {
                  "en": "No role in cultural preservation",
                  "es": "Ningún papel en preservación cultural",
                  "de": "Keine Rolle in kultureller Bewahrung",
                  "nl": "Geen rol in culturele bewaring"
        },
        {
                  "en": "Only translating major languages",
                  "es": "Solo traduciendo idiomas principales",
                  "de": "Nur Übersetzung großer Sprachen",
                  "nl": "Alleen grote talen vertalen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No methods exist for interpretability",
                  "es": "No existen métodos para interpretabilidad",
                  "de": "Keine Methoden für Interpretierbarkeit existieren",
                  "nl": "Geen methoden bestaan voor interpreteerbaarheid"
        },
        {
                  "en": "Attention visualization, feature importance, model distillation, counterfactual explanations, and designing inherently interpretable architectures",
                  "es": "Visualización de atención, importancia de características, destilación de modelo, explicaciones contrafactuales y diseño de arquitecturas inherentemente interpretables",
                  "de": "Aufmerksamkeitsvisualisierung, Merkmalswichtigkeit, Modelldestillation, kontrafaktische Erklärungen und Design inhärent interpretierbarer Architekturen",
                  "nl": "Aandacht visualisatie, feature importance, model distillatie, counterfactual explanations en ontwerpen van inherent interpreteerbare architecturen"
        },
        {
                  "en": "Only making models smaller",
                  "es": "Solo hacer modelos más pequeños",
                  "de": "Nur Modelle kleiner machen",
                  "nl": "Alleen modellen kleiner maken"
        },
        {
                  "en": "Only showing model accuracy",
                  "es": "Solo mostrando precisión del modelo",
                  "de": "Nur Modellgenauigkeit zeigen",
                  "nl": "Alleen model nauwkeurigheid tonen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Guaranteed to happen safely by 2025",
                  "es": "Garantizado que suceda de manera segura para 2025",
                  "de": "Garantiert sicher bis 2025",
                  "nl": "Gegarandeerd veilig tegen 2025"
        },
        {
                  "en": "Will automatically be beneficial with no risks",
                  "es": "Será automáticamente beneficioso sin riesgos",
                  "de": "Wird automatisch vorteilhaft sein ohne Risiken",
                  "nl": "Zal automatisch voordelig zijn zonder risico's"
        },
        {
                  "en": "Highly speculative with potential for transformative benefits or existential risks, requiring careful governance",
                  "es": "Altamente especulativo con potencial para beneficios transformadores o riesgos existenciales, requiriendo gobernanza cuidadosa",
                  "de": "Hochgradig spekulativ mit Potenzial für transformative Vorteile oder existenzielle Risiken, erfordert sorgfältige Governance",
                  "nl": "Zeer speculatief met potentieel voor transformerende voordelen of existentiële risico's, wat zorgvuldig bestuur vereist"
        },
        {
                  "en": "Completely impossible under any circumstances",
                  "es": "Completamente imposible bajo cualquier circunstancia",
                  "de": "Völlig unmöglich unter allen Umständen",
                  "nl": "Volledig onmogelijk onder alle omstandigheden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI creativity is identical to human creativity",
                  "es": "La creatividad de IA es idéntica a la creatividad humana",
                  "de": "KI-Kreativität ist identisch mit menschlicher Kreativität",
                  "nl": "AI creativiteit is identiek aan menselijke creativiteit"
        },
        {
                  "en": "AI can generate impressive creative works but raises questions about authorship, originality, and the nature of creativity itself",
                  "es": "La IA puede generar obras creativas impresionantes pero plantea preguntas sobre autoría, originalidad y la naturaleza de la creatividad misma",
                  "de": "KI kann beeindruckende kreative Werke generieren wirft aber Fragen über Urheberschaft, Originalität und die Natur der Kreativität selbst auf",
                  "nl": "AI kan indrukwekkende creatieve werken genereren maar roept vragen op over auteurschap, originaliteit en de aard van creativiteit zelf"
        },
        {
                  "en": "Only humans can ever be creative",
                  "es": "Solo los humanos pueden ser creativos",
                  "de": "Nur Menschen können jemals kreativ sein",
                  "nl": "Alleen mensen kunnen ooit creatief zijn"
        },
        {
                  "en": "AI has no creative capabilities at all",
                  "es": "La IA no tiene capacidades creativas en absoluto",
                  "de": "KI hat überhaupt keine kreativen Fähigkeiten",
                  "nl": "AI heeft helemaal geen creatieve mogelijkheden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "International aspects of AI are irrelevant",
                  "es": "Los aspectos internacionales de IA son irrelevantes",
                  "de": "Internationale Aspekte von KI sind irrelevant",
                  "nl": "Internationale aspecten van AI zijn irrelevant"
        },
        {
                  "en": "AI could drive cooperation on safety and ethics but also fuel geopolitical competition and 'AI arms races'",
                  "es": "La IA podría impulsar cooperación en seguridad y ética pero también alimentar competencia geopolítica y 'carreras armamentistas de IA'",
                  "de": "KI könnte Zusammenarbeit bei Sicherheit und Ethik vorantreiben aber auch geopolitischen Wettbewerb und 'KI-Wettrüsten' befeuern",
                  "nl": "AI zou samenwerking op veiligheid en ethiek kunnen stimuleren maar ook geopolitieke competitie en 'AI wapenwedlopen' aanwakkeren"
        },
        {
                  "en": "AI development is purely domestic with no international implications",
                  "es": "El desarrollo de IA es puramente doméstico sin implicaciones internacionales",
                  "de": "KI-Entwicklung ist rein national ohne internationale Implikationen",
                  "nl": "AI ontwikkeling is puur binnenlands zonder internationale implicaties"
        },
        {
                  "en": "All countries already cooperate perfectly on AI",
                  "es": "Todos los países ya cooperan perfectamente en IA",
                  "de": "Alle Länder kooperieren bereits perfekt bei KI",
                  "nl": "Alle landen werken al perfect samen op AI"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Questions about what makes humans unique, valuable, and meaningful in a world with superintelligent AI",
                  "es": "Preguntas sobre qué hace a los humanos únicos, valiosos y significativos en un mundo con IA superinteligente",
                  "de": "Fragen darüber was Menschen einzigartig, wertvoll und bedeutsam macht in einer Welt mit superintelligenter KI",
                  "nl": "Vragen over wat mensen uniek, waardevol en betekenisvol maakt in een wereld met superintelligente AI"
        },
        {
                  "en": "These questions were already completely answered",
                  "es": "Estas preguntas ya fueron completamente respondidas",
                  "de": "Diese Fragen wurden bereits vollständig beantwortet",
                  "nl": "Deze vragen zijn al volledig beantwoord"
        },
        {
                  "en": "No philosophical implications whatsoever",
                  "es": "Ninguna implicación filosófica en absoluto",
                  "de": "Keinerlei philosophische Implikationen",
                  "nl": "Helemaal geen filosofische implicaties"
        },
        {
                  "en": "Only technical programming questions",
                  "es": "Solo preguntas técnicas de programación",
                  "de": "Nur technische Programmierfragen",
                  "nl": "Alleen technische programmeer vragen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Scaling laws show predictable improvements but with diminishing returns and unknown limits on what scale can achieve",
                  "es": "Leyes de escala muestran mejoras predecibles pero con rendimientos decrecientes y límites desconocidos sobre lo que la escala puede lograr",
                  "de": "Schalingswetten tonen voorspelbare verbeteringen maar met afnemende opbrengsten en onbekende grenzen op wat schaal kan bereiken"
        },
        {
                  "en": "We've already reached maximum possible scale",
                  "es": "Ya hemos alcanzado la escala máxima posible",
                  "de": "Wir haben bereits die maximal mögliche Skalierung erreicht",
                  "nl": "We hebben al de maximale mogelijke schaal bereikt"
        },
        {
                  "en": "Bigger models are always proportionally better",
                  "es": "Modelos más grandes son siempre proporcionalmente mejores",
                  "de": "Größere Modelle sind immer proportional besser",
                  "nl": "Grotere modellen zijn altijd proportioneel beter"
        },
        {
                  "en": "Model size has no relationship to capabilities",
                  "es": "El tamaño del modelo no tiene relación con las capacidades",
                  "de": "Modellgröße hat keine Beziehung zu Fähigkeiten",
                  "nl": "Model grootte heeft geen relatie tot mogelijkheden"
        }
        ],
        correct: 0,
        explanation: {
