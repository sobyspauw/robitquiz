// Neurale netwerken Quiz - Level 9
(function() {
  const level9 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Better performance on linear models",
                  "es": "Mejor rendimiento en modelos lineales",
                  "de": "Bessere Leistung bei linearen Modellen",
                  "nl": "Betere prestaties op lineaire modellen"
        },
        {
                  "en": "Lower memory requirements during training",
                  "es": "Menores requerimientos de memoria durante entrenamiento",
                  "de": "Geringere Speicheranforderungen während des Trainings",
                  "nl": "Lagere geheugenvereisten tijdens training"
        },
        {
                  "en": "Faster convergence for all types of problems",
                  "es": "Convergencia más rápida para todos los tipos de problemas",
                  "de": "Schnellere Konvergenz für alle Arten von Problemen",
                  "nl": "Snellere convergentie voor alle soorten problemen"
        },
        {
                  "en": "Adaptive learning rates for each parameter based on momentum and gradient variance",
                  "es": "Tasas de aprendizaje adaptativas para cada parámetro basadas en momentum y varianza del gradiente",
                  "de": "Adaptive Lernraten für jeden Parameter basierend auf Momentum und Gradientenvarianz",
                  "nl": "Adaptieve leersnelheden voor elke parameter gebaseerd op momentum en gradiëntvariantie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Increase batch size during training for better efficiency",
                  "es": "Aumentar tamaño de lote durante entrenamiento para mejor eficiencia",
                  "de": "Batch-Größe während des Trainings für bessere Effizienz erhöhen",
                  "nl": "Batch-grootte verhogen tijdens training voor betere efficiëntie"
        },
        {
                  "en": "Automatically adjust network architecture",
                  "es": "Ajustar automáticamente la arquitectura de red",
                  "de": "Netzwerkarchitektur automatisch anpassen",
                  "nl": "Netwerkarchitectuur automatisch aanpassen"
        },
        {
                  "en": "Gradually reduce learning rate to fine-tune parameters and avoid overshooting minima",
                  "es": "Reducir gradualmente la tasa de aprendizaje para afinar parámetros y evitar sobrepasar mínimos",
                  "de": "Lernrate schrittweise reduzieren um Parameter feinzustimmen und Überschießen von Minima zu vermeiden",
                  "nl": "Geleidelijk leersnelheid verminderen om parameters af te stemmen en het voorbijschieten van minima te vermijden"
        },
        {
                  "en": "Control the number of training epochs",
                  "es": "Controlar el número de épocas de entrenamiento",
                  "de": "Die Anzahl der Trainingsepochen steuern",
                  "nl": "Het aantal trainingsepochen controleren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Smaller batches always lead to better generalization",
                  "es": "Lotes más pequeños siempre llevan a mejor generalización",
                  "de": "Kleinere Batches führen immer zu besserer Generalisierung",
                  "nl": "Kleinere batches leiden altijd tot betere generalisatie"
        },
        {
                  "en": "Batch size must always equal the total dataset size",
                  "es": "El tamaño de lote debe siempre igualar el tamaño total del conjunto de datos",
                  "de": "Batch-Größe muss immer der gesamten Datensatzgröße entsprechen",
                  "nl": "Batch-grootte moet altijd gelijk zijn aan de totale datasetgrootte"
        },
        {
                  "en": "Batch size only affects training speed, not final performance",
                  "es": "El tamaño de lote solo afecta la velocidad de entrenamiento, no el rendimiento final",
                  "de": "Batch-Größe beeinflusst nur Trainingsgeschwindigkeit, nicht finale Leistung",
                  "nl": "Batch-grootte beïnvloedt alleen trainingssnelheid, niet de uiteindelijke prestaties"
        },
        {
                  "en": "Larger batches provide more stable gradients but may require lower learning rates",
                  "es": "Lotes más grandes proporcionan gradientes más estables pero pueden requerir tasas de aprendizaje menores",
                  "de": "Größere Batches bieten stabilere Gradienten können aber niedrigere Lernraten erfordern",
                  "nl": "Grotere batches bieden stabielere gradiënten maar kunnen lagere leersnelheden vereisen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reducing the number of parameters in the network",
                  "es": "Reducir el número de parámetros en la red",
                  "de": "Reduzierung der Anzahl Parameter im Netzwerk",
                  "nl": "Het aantal parameters in het netwerk verminderen"
        },
        {
                  "en": "Removing unnecessary gradients to speed up training",
                  "es": "Eliminar gradientes innecesarios para acelerar el entrenamiento",
                  "de": "Entfernung unnötiger Gradienten um Training zu beschleunigen",
                  "nl": "Onnodige gradiënten verwijderen om training te versnellen"
        },
        {
                  "en": "Clipping input data to a specific range",
                  "es": "Recortar datos de entrada a un rango específico",
                  "de": "Eingabedaten auf einen bestimmten Bereich beschneiden",
                  "nl": "Invoerdata knippen naar een specifiek bereik"
        },
        {
                  "en": "Limiting gradient magnitudes to prevent exploding gradients in deep networks",
                  "es": "Limitar magnitudes de gradiente para prevenir gradientes explosivos en redes profundas",
                  "de": "Begrenzung von Gradientenmagnituden um explodierende Gradienten in tiefen Netzwerken zu verhindern",
                  "nl": "Gradiëntmagnitudes beperken om exploderende gradiënten in diepe netwerken te voorkomen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gradually increase batch size during training",
                  "es": "Aumentar gradualmente el tamaño de lote durante entrenamiento",
                  "de": "Batch-Größe während des Trainings schrittweise erhöhen",
                  "nl": "Geleidelijk batch-grootte verhogen tijdens training"
        },
        {
                  "en": "Gradually increase learning rate at the beginning to stabilize training",
                  "es": "Aumentar gradualmente la tasa de aprendizaje al principio para estabilizar el entrenamiento",
                  "de": "Lernrate am Anfang schrittweise erhöhen um Training zu stabilisieren",
                  "nl": "Geleidelijk leersnelheid verhogen aan het begin om training te stabiliseren"
        },
        {
                  "en": "Initialize weights to better starting values",
                  "es": "Inicializar pesos a mejores valores iniciales",
                  "de": "Gewichte auf bessere Anfangswerte initialisieren",
                  "nl": "Gewichten initialiseren naar betere startwaarden"
        },
        {
                  "en": "Pre-train the model on a simpler dataset",
                  "es": "Pre-entrenar el modelo en un conjunto de datos más simple",
                  "de": "Modell auf einem einfacheren Datensatz vortrainieren",
                  "nl": "Het model voortrainen op een eenvoudigere dataset"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "L1 prevents overfitting, L2 prevents underfitting",
                  "es": "L1 previene sobreajuste, L2 previene subajuste",
                  "de": "L1 verhindert Overfitting, L2 verhindert Underfitting",
                  "nl": "L1 voorkomt overfitting, L2 voorkomt underfitting"
        },
        {
                  "en": "L1 promotes sparsity (some weights become zero), L2 shrinks all weights proportionally",
                  "es": "L1 promueve dispersión (algunos pesos se vuelven cero), L2 encoge todos los pesos proporcionalmente",
                  "de": "L1 fördert Sparsamkeit (einige Gewichte werden null), L2 schrumpft alle Gewichte proportional",
                  "nl": "L1 bevordert sparsheid (sommige gewichten worden nul), L2 krimpt alle gewichten proportioneel"
        },
        {
                  "en": "L1 is faster to compute than L2 regularization",
                  "es": "L1 es más rápido de calcular que la regularización L2",
                  "de": "L1 ist schneller zu berechnen als L2-Regularisierung",
                  "nl": "L1 is sneller te berekenen dan L2 regularisatie"
        },
        {
                  "en": "L1 works only with linear models, L2 works with all models",
                  "es": "L1 funciona solo con modelos lineales, L2 funciona con todos los modelos",
                  "de": "L1 funktioniert nur mit linearen Modellen, L2 funktioniert mit allen Modellen",
                  "nl": "L1 werkt alleen met lineaire modellen, L2 werkt met alle modellen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Stop training when validation performance stops improving to prevent overfitting",
                  "es": "Parar entrenamiento cuando el rendimiento de validación deja de mejorar para prevenir sobreajuste",
        ...
        {
                  "en": "Stop training after a fixed number of epochs",
                  "es": "Parar entrenamiento después de un número fijo de épocas",
                  "de": "Training nach einer festen Anzahl von Epochen stoppen",
                  "nl": "Training stoppen na een vast aantal epochs"
        },
        {
                  "en": "Stop training when learning rate becomes too small",
                  "es": "Parar entrenamiento cuando la tasa de aprendizaje se vuelve muy pequeña",
                  "de": "Training stoppen wenn Lernrate zu klein wird",
                  "nl": "Training stoppen wanneer leersnelheid te klein wordt"
        },
        {
                  "en": "Stop training when loss becomes zero",
                  "es": "Parar entrenamiento cuando la pérdida se vuelve cero",
                  "de": "Training stoppen wenn Verlust null wird",
                  "nl": "Training stoppen wanneer verlies nul wordt"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Convert data to a standardized format",
                  "es": "Convertir datos a un formato estandarizado",
                  "de": "Daten in ein standardisiertes Format konvertieren",
                  "nl": "Data converteren naar een gestandaardiseerd formaat"
        },
        {
                  "en": "Reduce the computational cost of training",
                  "es": "Reducir el costo computacional del entrenamiento",
                  "de": "Die rechnerischen Kosten des Trainings reduzieren",
                  "nl": "De rekenkosten van training verminderen"
        },
        {
                  "en": "Improve the quality of existing data samples",
                  "es": "Mejorar la calidad de muestras de datos existentes",
                  "de": "Die Qualität bestehender Datenproben verbessern",
                  "nl": "De kwaliteit van bestaande datasamples verbeteren"
        },
        {
                  "en": "Artificially increase dataset size and diversity to improve generalization",
                  "es": "Aumentar artificialmente el tamaño y diversidad del conjunto de datos para mejorar generalización",
                  "de": "Datensatzgröße und -vielfalt künstlich erhöhen um Generalisierung zu verbessern",
                  "nl": "Kunstmatig datasetgrootte en diversiteit verhogen om generalisatie te verbeteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Momentum controls step size, learning rate provides memory",
                  "es": "Momentum controla el tamaño del paso, tasa de aprendizaje proporciona memoria",
                  "de": "Momentum steuert Schrittgröße, Lernrate bietet Gedächtnis",
                  "nl": "Momentum controleert stapgrootte, leersnelheid biedt geheugen"
        },
        {
                  "en": "Learning rate controls step size, momentum uses previous gradients to smooth updates",
                  "es": "La tasa de aprendizaje controla el tamaño del paso, momentum usa gradientes previos para suavizar actualizaciones",
                  "de": "Lernrate steuert Schrittgröße, Momentum verwendet vorherige Gradienten um Updates zu glätten",
                  "nl": "Leersnelheid controleert stapgrootte, momentum gebruikt vorige gradiënten om updates glad te maken"
        },
        {
                  "en": "Learning rate is for classification, momentum is for regression",
                  "es": "Tasa de aprendizaje es para clasificación, momentum es para regresión",
                  "de": "Lernrate ist für Klassifikation, Momentum ist für Regression",
                  "nl": "Leersnelheid is voor classificatie, momentum is voor regressie"
        },
        {
                  "en": "Both parameters serve the same purpose in optimization",
                  "es": "Ambos parámetros sirven el mismo propósito en optimización",
                  "de": "Beide Parameter dienen demselben Zweck in der Optimierung",
                  "nl": "Beide parameters dienen hetzelfde doel in optimalisatie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Alternating between different datasets during training",
                  "es": "Alternar entre diferentes conjuntos de datos durante entrenamiento",
                  "de": "Zwischen verschiedenen Datensätzen während des Trainings wechseln",
                  "nl": "Afwisselen tussen verschillende datasets tijdens training"
        },
        {
        ...
        {
                  "en": "Using different learning rates for different layers",
                  "es": "Usar diferentes tasas de aprendizaje para diferentes capas",
                  "de": "Verschiedene Lernraten für verschiedene Schichten verwenden",
                  "nl": "Verschillende leersnelheden gebruiken voor verschillende lagen"
        },
        {
                  "en": "Training on easy examples first, then gradually increasing difficulty",
                  "es": "Entrenar en ejemplos fáciles primero, luego aumentar gradualmente la dificultad",
                  "de": "Zuerst auf einfachen Beispielen trainieren, dann schrittweise Schwierigkeit erhöhen",
                  "nl": "Eerst trainen op gemakkelijke voorbeelden, dan geleidelijk moeilijkheid verhogen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Automatically adjust learning rate based on weight magnitudes",
                  "es": "Ajustar automáticamente la tasa de aprendizaje basada en magnitudes de peso",
                  "de": "Lernrate automatisch basierend auf Gewichtsmagnituden anpassen",
                  "nl": "Automatisch leersnelheid aanpassen gebaseerd op gewichtmagnitudes"
        },
        {
                  "en": "Add L2 regularization penalty to prevent overfitting by shrinking weights",
                  "es": "Agregar penalización de regularización L2 para prevenir sobreajuste encogiendo pesos",
                  "de": "L2-Regularisierungsstrafe hinzufügen um Overfitting durch Gewichtsschrumpfung zu verhindern",
                  "nl": "L2 regularisatiestraf toevoegen om overfitting te voorkomen door gewichten te krimpen"
        },
        {
                  "en": "Remove weights that become too small during training",
                  "es": "Eliminar pesos que se vuelven muy pequeños durante entrenamiento",
                  "de": "Gewichte entfernen die während des Trainings zu klein werden",
                  "nl": "Gewichten verwijderen die te klein worden tijdens training"
        },
        {
                  "en": "Gradually reduce the number of parameters during training",
                  "es": "Reducir gradualmente el número de parámetros durante entrenamiento",
                  "de": "Die Anzahl der Parameter während des Trainings schrittweise reduzieren",
                  "nl": "Geleidelijk het aantal parameters verminderen tijdens training"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Synchronous is faster but less accurate than asynchronous",
                  "es": "Síncrono es más rápido pero menos preciso que asíncrono",
                  "de": "Synchron ist schneller aber weniger genau als asynchron",
                  "nl": "Synchroon is sneller maar minder nauwkeurig dan asynchroon"
        },
        {
                  "en": "Synchronous uses different learning rates, asynchronous uses the same rate",
                  "es": "Síncrono usa diferentes tasas de aprendizaje, asíncrono usa la misma tasa",
                  "de": "Synchron verwendet verschiedene Lernraten, asynchron verwendet dieselbe Rate",
                  "nl": "Synchroon gebruikt verschillende leersnelheden, asynchroon gebruikt dezelfde snelheid"
        },
        {
                  "en": "Synchronous waits for all workers to compute gradients, asynchronous updates immediately",
                  "es": "Síncrono espera que todos los trabajadores calculen gradientes, asíncrono actualiza inmediatamente",
                  "de": "Synchron wartet dass alle Arbeiter Gradienten berechnen, asynchron aktualisiert sofort",
                  "nl": "Synchroon wacht tot alle workers gradiënten berekenen, asynchroon update onmiddellijk"
        },
        {
                  "en": "Synchronous trains on CPUs, asynchronous trains on GPUs",
                  "es": "Síncrono entrena en CPUs, asíncrono entrena en GPUs",
                  "de": "Synchron trainiert auf CPUs, asynchron trainiert auf GPUs",
                  "nl": "Synchroon traint op CPU's, asynchroon traint op GPU's"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use both 16-bit and 32-bit floating point to speed up training while maintaining accuracy",
                  "es": "Usar punto flotante de 16 y 32 bits para acelerar entrenamiento manteniendo precisión",
                  "de": "16-Bit und 32-Bit Gleitkomma verwenden um Training zu beschleunigen bei gleichbleibender Genauigkeit",
                  "nl": "Zowel 16-bit als 32-bit floating point gebruiken om training te versnellen terwijl nauwkeurigheid behouden blijft"
        },
        {
                  "en": "Alternate between high and low precision during epochs",
                  "es": "Alternar entre alta y baja precisión durante épocas",
                  "de": "Zwischen hoher und niedriger Präzision während Epochen wechseln",
                  "nl": "Afwisselen tussen hoge en lage precisie tijdens epochs"
        },
        {
                  "en": "Train on both labeled and unlabeled data simultaneously",
                  "es": "Entrenar en datos etiquetados y no etiquetados simultáneamente",
                  "de": "Auf gelabelten und ungelabelten Daten gleichzeitig trainieren",
                  "nl": "Tegelijkertijd trainen op gelabelde en ongelabelde data"
        },
        {
                  "en": "Use different precision for different layers",
                  "es": "Usar diferente precisión para diferentes capas",
                  "de": "Verschiedene Präzision für verschiedene Schichten verwenden",
                  "nl": "Verschillende precisie gebruiken voor verschillende lagen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use different learning rates for different parameters",
                  "es": "Usar diferentes tasas de aprendizaje para diferentes parámetros",
                  "de": "Verschiedene Lernraten für verschiedene Parameter verwenden",
                  "nl": "Verschillende leersnelheden gebruiken voor verschillende parameters"
        },
        {
                  "en": "Gradually increase learning rate throughout training",
                  "es": "Aumentar gradualmente la tasa de aprendizaje durante todo el entrenamiento",
                  "de": "Lernrate während des gesamten Trainings schrittweise erhöhen",
                  "nl": "Geleidelijk leersnelheid verhogen gedurende training"
        },
        {
                  "en": "Reset learning rate to initial value after each epoch",
                  "es": "Resetear tasa de aprendizaje al valor inicial después de cada época",
                  "de": "Lernrate nach jeder Epoche auf Anfangswert zurücksetzen",
                  "nl": "Leersnelheid na elke epoch resetten naar initiële waarde"
        },
        {
                  "en": "Periodically vary learning rate between minimum and maximum bounds",
                  "es": "Variar periódicamente la tasa de aprendizaje entre límites mínimos y máximos",
                  "de": "Lernrate periodisch zwischen minimalen und maximalen Grenzen variieren",
                  "nl": "Periodiek leersnelheid variëren tussen minimum en maximum grenzen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Replace hard targets with soft probability distributions to prevent overconfidence",
                  "es": "Reemplazar objetivos duros con distribuciones de probabilidad suaves para prevenir exceso de confianza",
                  "de": "Harte Ziele durch weiche Wahrscheinlichkeitsverteilungen ersetzen um Selbstüberschätzung zu verhindern",
                  "nl": "Harde doelen vervangen door zachte waarschijnlijkheidsverdelingen om overzekerheid te voorkomen"
        },
        {
                  "en": "Smooth the loss function to avoid local minima",
                  "es": "Suavizar la función de pérdida para evitar mínimos locales",
                  "de": "Verlustfunktion glätten um lokale Minima zu vermeiden",
                  "nl": "Verliesfunctie gladstrijken om lokale minima te vermijden"
        },
        {
                  "en": "Use interpolation between different training examples",
                  "es": "Usar interpolación entre diferentes ejemplos de entrenamiento",
                  "de": "Interpolation zwischen verschiedenen Trainingsbeispielen verwenden",
                  "nl": "Interpolatie gebruiken tussen verschillende trainingsvoorbeelden"
        },
        {
                  "en": "Apply Gaussian smoothing to input images",
                  "es": "Aplicar suavizado gaussiano a imágenes de entrada",
                  "de": "Gaußsche Glättung auf Eingabebilder anwenden",
                  "nl": "Gaussiaanse smoothing toepassen op invoerbeelden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Faster convergence than all other scheduling methods",
                  "es": "Convergencia más rápida que todos los otros métodos de programación",
                  "de": "Schnellere Konvergenz als alle anderen Planungsmethoden",
                  "nl": "Snellere convergentie dan alle andere planningsmethoden"
        },
        {
                  "en": "Works only with Adam optimizer",
                  "es": "Funciona solo con optimizador Adam",
                  "de": "Funktioniert nur mit Adam-Optimierer",
                  "nl": "Werkt alleen met Adam-optimizer"
        },
        {
                  "en": "Requires no hyperparameter tuning",
                  "es": "No requiere ajuste de hiperparámetros",
                  "de": "Erfordert kein Hyperparameter-Tuning",
                  "nl": "Vereist geen hyperparameter-tuning"
        },
        {
                  "en": "Smooth gradual decay that can periodically restart to escape local minima",
                  "es": "Decaimiento gradual suave que puede reiniciarse periódicamente para escapar mínimos locales",
                  "de": "Sanfter gradueller Zerfall der periodisch neustarten kann um lokale Minima zu entkommen",
                  "nl": "Vloeiend geleidelijk verval dat periodiek kan herstarten om lokale minima te ontsnappen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Store all gradients from previous epochs for reference",
                  "es": "Almacenar todos los gradientes de épocas previas para referencia",
                  "de": "Alle Gradienten von vorherigen Epochen zur Referenz speichern",
                  "nl": "Alle gradiënten van vorige epochs opslaan voor referentie"
        },
        {
                  "en": "Prevent gradient explosion by accumulating slowly",
                  "es": "Prevenir explosión de gradientes acumulando lentamente",
                  "de": "Gradientenexplosion durch langsame Akkumulation verhindern",
                  "nl": "Gradiëntexplosie voorkomen door langzaam te accumuleren"
        },
        {
                  "en": "Average gradients across different model architectures",
                  "es": "Promediar gradientes a través de diferentes arquitecturas de modelo",
                  "de": "Gradienten über verschiedene Modellarchitekturen mitteln",
                  "nl": "Gradiënten middelen over verschillende modelarchitecturen"
        },
        {
                  "en": "Simulate larger batch sizes when memory is limited by accumulating gradients over multiple mini-batches",
                  "es": "Simular tamaños de lote más grandes cuando la memoria es limitada acumulando gradientes sobre múltiples mini-lotes",
                  "de": "Größere Batch-Größen simulieren wenn Speicher begrenzt ist durch Akkumulation von Gradienten über mehrere Mini-Batches",
                  "nl": "Grotere batch-groottes simuleren wanneer geheugen beperkt is door gradiënten te accumuleren over meerdere mini-batches"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Entrenar un modelo estudiante más pequeño para imitar el comportamiento de un modelo profesor más grande",
                  "de": "Ein kleineres Schüler-Modell trainieren um das Verhalten eines größeren Lehrer-Modells nachzuahmen",
                  "nl": "Een kleiner studentmodel trainen om het gedrag van een groter lerarenmodel na te bootsen"
        },
        {
                  "en": "Reduce the precision of model weights to compress it",
                  "es": "Reducir la precisión de pesos del modelo para comprimirlo",
                  "de": "Präzision von Modellgewichten reduzieren um es zu komprimieren",
                  "nl": "Precisie van modelgewichten verminderen om het te comprimeren"
        },
        {
                  "en": "Extract important features from trained models",
                  "es": "Extraer características importantes de modelos entrenados",
                  "de": "Wichtige Features aus trainierten Modellen extrahieren",
                  "nl": "Belangrijke features extraheren uit getrainde modellen"
        },
        {
                  "en": "Transfer learning between different domains",
                  "es": "Aprendizaje de transferencia entre diferentes dominios",
                  "de": "Transfer Learning zwischen verschiedenen Domänen",
                  "nl": "Transfer learning tussen verschillende domeinen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Test different batch sizes to find the optimal one",
                  "es": "Probar diferentes tamaños de lote para encontrar el óptimo",
                  "de": "Verschiedene Batch-Größen testen um die optimale zu finden",
                  "nl": "Verschillende batch-groottes testen om de optimale te vinden"
        },
        {
                  "en": "Find the maximum learning rate the model can handle",
                  "es": "Encontrar la tasa de aprendizaje máxima que el modelo puede manejar",
                  "de": "Maximale Lernrate finden die das Modell handhaben kann",
                  "nl": "Maximale leersnelheid vinden die het model aankan"
        },
        {
                  "en": "Find optimal learning rate by plotting loss vs learning rate across a range",
                  "es": "Encontrar tasa de aprendizaje óptima graficando pérdida vs tasa de aprendizaje en un rango",
                  "de": "Optimale Lernrate finden durch Plotting von Verlust vs Lernrate über einen Bereich",
                  "nl": "Optimale leersnelheid vinden door verlies vs leersnelheid te plotten over een bereik"
        },
        {
                  "en": "Validate model performance across different learning rates",
                  "es": "Validar rendimiento del modelo a través de diferentes tasas de aprendizaje",
                  "de": "Modellleistung über verschiedene Lernraten validieren",
                  "nl": "Modelprestaties valideren over verschillende leersnelheden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Train with high learning rates for most of training, then quickly decay to achieve fast convergence",
                  "es": "Entrenar con tasas de aprendizaje altas durante la mayor parte del entrenamiento, luego decaer rápidamente para lograr convergencia rápida",
                  "de": "Mit hohen Lernraten für den Großteil des Trainings trainieren, dann schnell zerfallen für schnelle Konvergenz",
                  "nl": "Trainen met hoge leersnelheden voor het grootste deel van training, dan snel vervallen om snelle convergentie te bereiken"
        },
        {
                  "en": "Cycle through different optimizers once during training",
                  "es": "Ciclar a través de diferentes optimizadores una vez durante entrenamiento",
                  "de": "Einmal während des Trainings durch verschiedene Optimierer zyklieren",
                  "nl": "Eenmaal door verschillende optimizers cyclen tijdens training"
        },
        {
                  "en": "Use one fixed learning rate throughout the entire training process",
                  "es": "Usar una tasa de aprendizaje fija durante todo el proceso de entrenamiento",
                  "de": "Eine feste Lernrate während des gesamten Trainingsprozesses verwenden",
                  "nl": "Eén vaste leersnelheid gebruiken gedurende het hele trainingsproces"
        },
        {
                  "en": "Complete exactly one epoch of training for optimal performance",
                  "es": "Completar exactamente una época de entrenamiento para rendimiento óptimo",
                  "de": "Genau eine Trainingsepoche für optimale Leistung absolvieren",
                  "nl": "Precies één epoch training voltooien voor optimale prestaties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Average gradients across different data batches",
                  "es": "Promediar gradientes a través de diferentes lotes de datos",
                  "de": "Gradienten über verschiedene Daten-Batches mitteln",
                  "nl": "Gradiënten middelen over verschillende databatches"
        },
        {
                  "en": "Use stochastic processes to determine weight values",
                  "es": "Usar procesos estocásticos para determinar valores de peso",
                  "de": "Stochastische Prozesse zur Bestimmung von Gewichtswerten verwenden",
                  "nl": "Stochastische processen gebruiken om gewichtswaarden te bepalen"
        },
        {
                  "en": "Average weights from multiple points along the training trajectory to improve generalization",
                  "es": "Promediar pesos de múltiples puntos a lo largo de la trayectoria de entrenamiento para mejorar generalización",
                  "de": "Gewichte von mehreren Punkten entlang der Trainingstrajektorie mitteln um Generalisierung zu verbessern",
                  "nl": "Gewichten middelen van meerdere punten langs het trainingstraject om generalisatie te verbeteren"
        },
        {
                  "en": "Randomly initialize weights multiple times and average them",
                  "es": "Inicializar aleatoriamente pesos múltiples veces y promediarlos",
                  "de": "Gewichte mehrfach zufällig initialisieren und mitteln",
                  "nl": "Gewichten meerdere keren willekeurig initialiseren en middelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Look ahead at validation performance to guide training",
                  "es": "Mirar hacia adelante al rendimiento de validación para guiar entrenamiento",
                  "de": "Auf Validierungsleistung vorausschauen um Training zu leiten",
                  "nl": "Vooruitkijken naar validatieprestaties om training te begeleiden"
        },
        {
                  "en": "Use future data batches to compute current gradients",
                  "es": "Usar lotes de datos futuros para calcular gradientes actuales",
                  "de": "Zukünftige Daten-Batches verwenden um aktuelle Gradienten zu berechnen",
                  "nl": "Toekomstige databatches gebruiken om huidige gradiënten te berekenen"
        },
        {
                  "en": "Predict future gradient directions before taking optimization steps",
                  "es": "Predecir direcciones futuras de gradiente antes de tomar pasos de optimización",
                  "de": "Zukünftige Gradientenrichtungen vorhersagen bevor Optimierungsschritte genommen werden",
                  "nl": "Toekomstige gradiëntrichtingen voorspellen voordat optimalisatiestappen worden genomen"
        },
        {
                  "en": "Maintain slow and fast weights, periodically update slow weights toward fast weights' trajectory",
                  "es": "Mantener pesos lentos y rápidos, actualizar periódicamente pesos lentos hacia trayectoria de pesos rápidos",
                  "de": "Langsame und schnelle Gewichte beibehalten, langsame Gewichte periodisch in Richtung Trajektorie schneller Gewichte aktualisieren",
                  "nl": "Langzame en snelle gewichten bijhouden, periodiek langzame gewichten bijwerken richting traject van snelle gewichten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Decouple weight decay from gradient-based updates for better regularization",
                  "es": "Desacoplar decaimiento de pesos de actualizaciones basadas en gradiente para mejor regularización",
                  "de": "Gewichtsverfall von gradientenbasierten Updates entkoppeln für bessere Regularisierung",
                  "nl": "Gewichtsverval ontkoppelen van gradiënt-gebaseerde updates voor betere regularisatie"
        },
        {
                  "en": "Add warmup automatically to Adam optimizer",
                  "es": "Agregar calentamiento automáticamente al optimizador Adam",
                  "de": "Warmup automatisch zum Adam-Optimierer hinzufügen",
                  "nl": "Warmup automatisch toevoegen aan Adam-optimizer"
        },
        {
                  "en": "Optimize weights in a windowed fashion",
                  "es": "Optimizar pesos de manera ventana",
                  "de": "Gewichte in fensterartiger Weise optimieren",
                  "nl": "Gewichten op een venster-achtige manier optimaliseren"
        },
        {
                  "en": "Use wider learning rate ranges than standard Adam",
                  "es": "Usar rangos de tasa de aprendizaje más amplios que Adam estándar",
                  "de": "Breitere Lernratenbereiche als Standard-Adam verwenden",
                  "nl": "Bredere leersnelheidsbereiken gebruiken dan standaard Adam"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reduce learning rate at specific intervals to help model settle into better local minima",
                  "es": "Reducir tasa de aprendizaje en intervalos específicos para ayudar al modelo a establecerse en mejores mínimos locales",
                  "de": "Lernrate in bestimmten Intervallen reduzieren um dem Modell zu helfen in bessere lokale Minima zu gelangen",
                  "nl": "Leersnelheid verminderen op specifieke intervallen om het model te helpen zich te vestigen in betere lokale minima"
        },
        {
                  "en": "Keep learning rate constant but reduce batch size",
                  "es": "Mantener tasa de aprendizaje constante pero reducir tamaño de lote",
                  "de": "Lernrate konstant halten aber Batch-Größe reduzieren",
                  "nl": "Leersnelheid constant houden maar batch-grootte verminderen"
        },
        {
                  "en": "Randomly vary learning rate to explore parameter space",
                  "es": "Variar aleatoriamente tasa de aprendizaje para explorar espacio de parámetros",
                  "de": "Lernrate zufällig variieren um Parameterraum zu erkunden",
                  "nl": "Leersnelheid willekeurig variëren om parameterruimte te verkennen"
        },
        {
                  "en": "Increase learning rate exponentially throughout training",
                  "es": "Aumentar tasa de aprendizaje exponencialmente durante todo el entrenamiento",
                  "de": "Lernrate während des gesamten Trainings exponentiell erhöhen",
                  "nl": "Leersnelheid exponentieel verhogen gedurende training"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Look ahead to where momentum would take you, then compute gradient there for better updates",
                  "es": "Mirar adelante a donde el momentum te llevaría, luego calcular gradiente allí para mejores actualizaciones",
                  "de": "Vorausschauen wohin Momentum führen würde, dann Gradient dort berechnen für bessere Updates",
                  "nl": "Vooruitkijken waar momentum je zou brengen, dan daar gradiënt berekenen voor betere updates"
        },
        {
                  "en": "Apply momentum only when gradients are consistent",
                  "es": "Aplicar momentum solo cuando los gradientes son consistentes",
                  "de": "Momentum nur anwenden wenn Gradienten konsistent sind",
                  "nl": "Momentum alleen toepassen wanneer gradiënten consistent zijn"
        },
        {
                  "en": "Average momentum from multiple previous steps",
                  "es": "Promediar momentum de múltiples pasos previos",
                  "de": "Momentum von mehreren vorherigen Schritten mitteln",
                  "nl": "Momentum middelen van meerdere vorige stappen"
        },
        {
                  "en": "Use adaptive momentum values based on gradient magnitude",
                  "es": "Usar valores de momentum adaptativos basados en magnitud de gradiente",
                  "de": "Adaptive Momentum-Werte basierend auf Gradientenmagnitude verwenden",
                  "nl": "Adaptieve momentumwaarden gebruiken gebaseerd op gradiëntmagnitude"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Track running estimates of gradient moments while giving more weight to recent values",
                  "es": "Rastrear estimaciones corrientes de momentos de gradiente dando más peso a valores recientes",
                  "de": "Laufende Schätzungen von Gradientenmomenten verfolgen während neueren Werten mehr Gewicht gegeben wird",
                  "nl": "Lopende schattingen van gradiëntmomenten bijhouden terwijl meer gewicht wordt gegeven aan recente waarden"
        },
        {
                  "en": "Exponentially increase learning rate over time",
                  "es": "Aumentar exponencialmente tasa de aprendizaje con el tiempo",
                  "de": "Lernrate mit der Zeit exponentiell erhöhen",
                  "nl": "Leersnelheid exponentieel verhogen in de loop van de tijd"
        },
        {
                  "en": "Average predictions from multiple model checkpoints",
                  "es": "Promediar predicciones de múltiples puntos de control del modelo",
                  "de": "Vorhersagen von mehreren Modell-Checkpoints mitteln",
                  "nl": "Voorspellingen middelen van meerdere model-checkpoints"
        },
        {
                  "en": "Store all historical gradients efficiently in compressed format",
                  "es": "Almacenar todos los gradientes históricos eficientemente en formato comprimido",
                  "de": "Alle historischen Gradienten effizient in komprimiertem Format speichern",
                  "nl": "Alle historische gradiënten efficiënt opslaan in gecomprimeerd formaat"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reduce learning rate when training loss plateaus",
                  "es": "Reducir tasa de aprendizaje cuando la pérdida de entrenamiento se estabiliza",
                  "de": "Lernrate reduzieren wenn Trainingsverlust ein Plateau erreicht",
                  "nl": "Leersnelheid verminderen wanneer trainingsverlies stabiliseert"
        },
        {
                  "en": "Gradually reduce learning rate to reach a plateau value",
                  "es": "Reducir gradualmente tasa de aprendizaje para alcanzar un valor de meseta",
                  "de": "Lernrate schrittweise reduzieren um einen Plateau-Wert zu erreichen",
                  "nl": "Geleidelijk leersnelheid verminderen om een plateau-waarde te bereiken"
        },
        {
                  "en": "Reduce learning rate when validation metric stops improving for several epochs",
                  "es": "Reducir tasa de aprendizaje cuando la métrica de validación deja de mejorar durante varias épocas",
                  "de": "Lernrate reduzieren wenn Validierungsmetrik für mehrere Epochen aufhört sich zu verbessern",
                  "nl": "Leersnelheid verminderen wanneer validatiemetriek ophoudt met verbeteren gedurende meerdere epochs"
        },
        {
                  "en": "Keep learning rate constant on plateau regions",
                  "es": "Mantener tasa de aprendizaje constante en regiones de meseta",
                  "de": "Lernrate in Plateau-Regionen konstant halten",
                  "nl": "Leersnelheid constant houden op plateau-gebieden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Compensate for GPU memory limitations",
                  "es": "Compensar las limitaciones de memoria GPU",
                  "de": "GPU-Speicherbeschränkungen kompensieren",
                  "nl": "Compenseren voor GPU-geheugenbeperkingen"
        },
        {
                  "en": "Prevent overfitting with larger batches",
                  "es": "Prevenir sobreajuste con lotes más grandes",
                  "de": "Overfitting mit größeren Batches verhindern",
                  "nl": "Overfitting voorkomen met grotere batches"
        },
        {
                  "en": "Ensure all batch sizes converge at the same speed",
                  "es": "Asegurar que todos los tamaños de lote converjan a la misma velocidad",
                  "de": "Sicherstellen dass alle Batch-Größen mit derselben Geschwindigkeit konvergieren",
                  "nl": "Ervoor zorgen dat alle batch-groottes met dezelfde snelheid convergeren"
        },
        {
                  "en": "Maintain similar optimization dynamics by scaling learning rate proportionally with batch size",
                  "es": "Mantener dinámicas de optimización similares escalando tasa de aprendizaje proporcionalmente con tamaño de lote",
                  "de": "Ähnliche Optimierungsdynamiken beibehalten durch proportionales Skalieren der Lernrate mit Batch-Größe",
                  "nl": "Vergelijkbare optimalisatiedynamiek behouden door leersnelheid proportioneel te schalen met batch-grootte"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Prevent bias terms from growing too large",
                  "es": "Prevenir que términos de sesgo crezcan demasiado",
                  "de": "Verhindern dass Bias-Terme zu groß werden",
                  "nl": "Voorkomen dat bias-termen te groot worden"
        },
        {
                  "en": "Correct for bias in model predictions",
                  "es": "Corregir sesgo en predicciones del modelo",
                  "de": "Bias in Modellvorhersagen korrigieren",
                  "nl": "Bias corrigeren in modelvoorspellingen"
        },
        {
                  "en": "Correct for initialization bias in exponential moving averages during early training",
                  "es": "Corregir sesgo de inicialización en promedios móviles exponenciales durante entrenamiento temprano",
                  "de": "Initialisierungs-Bias in exponentiellen gleitenden Durchschnitten während frühem Training korrigieren",
                  "nl": "Initialisatie-bias corrigeren in exponentiële voortschrijdende gemiddelden tijdens vroege training"
        },
        {
                  "en": "Remove bias from the training data",
                  "es": "Eliminar sesgo de los datos de entrenamiento",
                  "de": "Bias aus den Trainingsdaten entfernen",
                  "nl": "Bias verwijderen uit trainingsdata"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Scale learning rate based on validation progress",
                  "es": "Escalar tasa de aprendizaje basado en progreso de validación",
                  "de": "Lernrate basierend auf Validierungsfortschritt skalieren",
                  "nl": "Leersnelheid schalen gebaseerd op validatievoortgang"
        },
        {
                  "en": "Increase model capacity progressively during training",
                  "es": "Aumentar capacidad del modelo progresivamente durante entrenamiento",
                  "de": "Modellkapazität während des Trainings progressiv erhöhen",
                  "nl": "Modelcapaciteit progressief verhogen tijdens training"
        },
        {
                  "en": "Gradually increase batch size and learning rate during training to improve stability",
                  "es": "Aumentar gradualmente tamaño de lote y tasa de aprendizaje durante entrenamiento para mejorar estabilidad",
                  "de": "Batch-Größe und Lernrate während des Trainings schrittweise erhöhen um Stabilität zu verbessern",
                  "nl": "Geleidelijk batch-grootte en leersnelheid verhogen tijdens training om stabiliteit te verbeteren"
        },
        {
                  "en": "Progressively add more distributed workers during training",
                  "es": "Agregar progresivamente más trabajadores distribuidos durante entrenamiento",
                  "de": "Progressiv mehr verteilte Arbeiter während des Trainings hinzufügen",
                  "nl": "Progressief meer gedistribueerde workers toevoegen tijdens training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ensure all parameters converge at the same rate",
                  "es": "Asegurar que todos los parámetros converjan a la misma tasa",
                  "de": "Sicherstellen dass alle Parameter mit derselben Rate konvergieren",
                  "nl": "Ervoor zorgen dat alle parameters met dezelfde snelheid convergeren"
        },
        {
                  "en": "Balance memory usage across different layers",
                  "es": "Equilibrar uso de memoria entre diferentes capas",
                  "de": "Speicherverbrauch über verschiedene Schichten ausbalancieren",
                  "nl": "Geheugengebruik balanceren over verschillende lagen"
        },
        {
                  "en": "Allow fine-tuning pretrained layers with smaller updates while training new layers faster",
                  "es": "Permitir ajuste fino de capas preentrenadas con actualizaciones más pequeñas mientras se entrenan capas nuevas más rápido",
                  "de": "Feinabstimmung vortrainierter Schichten mit kleineren Updates ermöglichen während neue Schichten schneller trainiert werden",
                  "nl": "Fijnafstelling van voorgetrainde lagen mogelijk maken met kleinere updates terwijl nieuwe lagen sneller worden getraind"
        },
        {
                  "en": "Reduce overall training time by parallelization",
                  "es": "Reducir tiempo total de entrenamiento por paralelización",
                  "de": "Gesamte Trainingszeit durch Parallelisierung reduzieren",
                  "nl": "Totale trainingstijd verminderen door parallelisatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses rectified linear units in the optimization process",
                  "es": "Usa unidades lineales rectificadas en el proceso de optimización",
                  "de": "Verwendet rektifizierte lineare Einheiten im Optimierungsprozess",
                  "nl": "Gebruikt gerectificeerde lineaire eenheden in het optimalisatieproces"
        },
        {
                  "en": "Rectifies gradient directions to always point toward global minimum",
                  "es": "Rectifica direcciones de gradiente para siempre apuntar hacia mínimo global",
                  "de": "Korrigiert Gradientenrichtungen um immer auf globales Minimum zu zeigen",
                  "nl": "Rectificeert gradiëntrichtingen om altijd naar globaal minimum te wijzen"
        },
        {
                  "en": "Automatically adjusts variance correction to prevent bad local optima in early training",
                  "es": "Ajusta automáticamente corrección de varianza para prevenir óptimos locales malos en entrenamiento temprano",
                  "de": "Passt Varianzkorrektur automatisch an um schlechte lokale Optima im frühen Training zu verhindern",
                  "nl": "Past automatisch variantiecorrectie aan om slechte lokale optima in vroege training te voorkomen"
        },
        {
                  "en": "Rectifies learning rate based on batch statistics",
                  "es": "Rectifica tasa de aprendizaje basado en estadísticas de lote",
                  "de": "Korrigiert Lernrate basierend auf Batch-Statistiken",
                  "nl": "Rectificeert leersnelheid gebaseerd op batch-statistieken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combine gradients from different optimization algorithms",
                  "es": "Combinar gradientes de diferentes algoritmos de optimización",
                  "de": "Gradienten von verschiedenen Optimierungsalgorithmen kombinieren",
                  "nl": "Gradiënten combineren van verschillende optimalisatie-algoritmen"
        },
        {
                  "en": "Average predictions from multiple models trained on different data splits",
                  "es": "Promediar predicciones de múltiples modelos entrenados en diferentes divisiones de datos",
                  "de": "Vorhersagen von mehreren auf verschiedenen Datenaufteilungen trainierten Modellen mitteln",
                  "nl": "Voorspellingen middelen van meerdere modellen getraind op verschillende datasplitsingen"
        },
        {
                  "en": "Average learning rates across different training runs",
                  "es": "Promediar tasas de aprendizaje a través de diferentes ejecuciones de entrenamiento",
                  "de": "Lernraten über verschiedene Trainingsläufe mitteln",
                  "nl": "Leersnelheden middelen over verschillende trainingsruns"
        },
        {
                  "en": "Maintain exponential moving average of parameters to smooth model updates and improve stability",
                  "es": "Mantener promedio móvil exponencial de parámetros para suavizar actualizaciones del modelo y mejorar estabilidad",
                  "de": "Exponentiellen gleitenden Durchschnitt von Parametern beibehalten um Modell-Updates zu glätten und Stabilität zu verbessern",
                  "nl": "Exponentieel voortschrijdend gemiddelde van parameters bijhouden om model-updates glad te maken en stabiliteit te verbeteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combines multiple optimizers in a hierarchical structure",
                  "es": "Combina múltiples optimizadores en una estructura jerárquica",
                  "de": "Kombiniert mehrere Optimierer in einer hierarchischen Struktur",
                  "nl": "Combineert meerdere optimizers in een hiërarchische structuur"
        },
        {
                  "en": "Named after being strong like a lion, uses aggressive learning rates",
                  "es": "Nombrado por ser fuerte como un león, usa tasas de aprendizaje agresivas",
                  "de": "Benannt nach Stärke wie ein Löwe, verwendet aggressive Lernraten",
                  "nl": "Vernoemd naar sterk zijn als een leeuw, gebruikt agressieve leersnelheden"
        },
        {
                  "en": "Uses linear interpolation for all optimizer computations",
                  "es": "Usa interpolación lineal para todos los cálculos del optimizador",
                  "de": "Verwendet lineare Interpolation für alle Optimierer-Berechnungen",
                  "nl": "Gebruikt lineaire interpolatie voor alle optimizer-berekeningen"
        },
        {
                  "en": "Uses sign of interpolated momentum for updates with larger weight decay, more memory efficient",
                  "es": "Usa signo de momentum interpolado para actualizaciones con mayor decaimiento de pesos, más eficiente en memoria",
                  "de": "Verwendet Vorzeichen von interpoliertem Momentum für Updates mit größerem Gewichtsverfall, speichereffizienter",
                  "nl": "Gebruikt teken van geïnterpoleerd momentum voor updates met groter gewichtsverval, geheugenefficiënter"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trade computation for memory by recomputing activations during backprop instead of storing them",
                  "es": "Intercambiar computación por memoria recomputando activaciones durante retropropagación en lugar de almacenarlas",
                  "de": "Berechnung gegen Speicher tauschen durch Neuberechnung von Aktivierungen während Backprop anstatt sie zu speichern",
                  "nl": "Berekening ruilen voor geheugen door activaties te herberekenen tijdens backprop in plaats van ze op te slaan"
        },
        {
                  "en": "Save gradient values periodically to prevent loss from crashes",
                  "es": "Guardar valores de gradiente periódicamente para prevenir pérdida por caídas",
                  "de": "Gradientenwerte periodisch speichern um Verlust durch Abstürze zu verhindern",
                  "nl": "Gradiëntwaarden periodiek opslaan om verlies door crashes te voorkomen"
        },
        {
                  "en": "Create checkpoints of best gradient configurations",
                  "es": "Crear puntos de control de mejores configuraciones de gradiente",
                  "de": "Checkpoints von besten Gradientenkonfigurationen erstellen",
                  "nl": "Checkpoints creëren van beste gradiëntconfiguraties"
        },
        {
                  "en": "Check gradient magnitudes at specific points for debugging",
                  "es": "Verificar magnitudes de gradiente en puntos específicos para depuración",
                  "de": "Gradientenmagnituden an bestimmten Punkten zur Fehlersuche prüfen",
                  "nl": "Gradiëntmagnitudes controleren op specifieke punten voor debugging"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Connect different learning rate schedules together",
                  "es": "Conectar diferentes programas de tasa de aprendizaje juntos",
                  "de": "Verschiedene Lernraten-Zeitpläne miteinander verbinden",
                  "nl": "Verschillende leersnelheid-schema's met elkaar verbinden"
        },
        {
                  "en": "Skip certain optimization steps to speed up training",
                  "es": "Saltar ciertos pasos de optimización para acelerar entrenamiento",
                  "de": "Bestimmte Optimierungsschritte überspringen um Training zu beschleunigen",
                  "nl": "Bepaalde optimalisatiestappen overslaan om training te versnellen"
        },
        {
                  "en": "Create direct gradient paths to earlier layers preventing vanishing gradients in deep networks",
                  "es": "Crear caminos de gradiente directos a capas anteriores previniendo gradientes desvanecientes en redes profundas",
                  "de": "Direkte Gradientenpfade zu früheren Schichten erstellen um verschwindende Gradienten in tiefen Netzwerken zu verhindern",
                  "nl": "Directe gradiëntpaden creëren naar eerdere lagen om verdwijnende gradiënten in diepe netwerken te voorkomen"
        },
        {
                  "en": "Allow the optimizer to skip over local minima",
                  "es": "Permitir al optimizador saltar sobre mínimos locales",
                  "de": "Dem Optimierer ermöglichen über lokale Minima zu springen",
                  "nl": "De optimizer in staat stellen over lokale minima te springen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Applies aggressive learning rates uniformly across all parameters",
                  "es": "Aplica tasas de aprendizaje agresivas uniformemente en todos los parámetros",
                  "de": "Wendet aggressive Lernraten gleichmäßig über alle Parameter an",
                  "nl": "Past agressieve leersnelheden uniform toe over alle parameters"
        },
        {
                  "en": "Adapts learning rate per parameter based on historical gradient magnitudes, good for sparse data",
                  "es": "Adapta tasa de aprendizaje por parámetro basado en magnitudes históricas de gradiente, bueno para datos dispersos",
                  "de": "Passt Lernrate pro Parameter basierend auf historischen Gradientenmagnituden an, gut für spärliche Daten",
                  "nl": "Past leersnelheid per parameter aan gebaseerd op historische gradiëntmagnitudes, goed voor schaarse data"
        },
        {
                  "en": "Adds gradients from multiple sources for ensemble learning",
                  "es": "Agrega gradientes de múltiples fuentes para aprendizaje de conjunto",
                  "de": "Fügt Gradienten von mehreren Quellen für Ensemble-Lernen hinzu",
                  "nl": "Voegt gradiënten van meerdere bronnen toe voor ensemble-learning"
        },
        {
                  "en": "Uses gradient addition to speed up convergence",
                  "es": "Usa adición de gradientes para acelerar convergencia",
                  "de": "Verwendet Gradientenaddition um Konvergenz zu beschleunigen",
                  "nl": "Gebruikt gradiënttoevoeging om convergentie te versnellen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Proposes root mean square error as the loss function",
                  "es": "Propone error cuadrático medio raíz como función de pérdida",
                  "de": "Schlägt Root Mean Square Error als Verlustfunktion vor",
                  "nl": "Stelt root mean square error voor als verliesfunctie"
        },
        {
                  "en": "Removes momentum from Adagrad for faster convergence",
                  "es": "Elimina momentum de Adagrad para convergencia más rápida",
                  "de": "Entfernt Momentum von Adagrad für schnellere Konvergenz",
                  "nl": "Verwijdert momentum van Adagrad voor snellere convergentie"
        },
        {
                  "en": "Propagates gradients more efficiently through recurrent connections",
                  "es": "Propaga gradientes más eficientemente a través de conexiones recurrentes",
                  "de": "Propagiert Gradienten effizienter durch rekurrente Verbindungen",
                  "nl": "Propageert gradiënten efficiënter door recurrente verbindingen"
        },
        {
                  "en": "Uses exponential moving average of squared gradients instead of cumulative sum, preventing learning rate decay",
                  "es": "Usa promedio móvil exponencial de gradientes al cuadrado en lugar de suma acumulativa, previniendo decaimiento de tasa de aprendizaje",
                  "de": "Verwendet exponentiellen gleitenden Durchschnitt quadrierter Gradienten statt kumulativer Summe, verhindert Lernraten-Verfall",
                  "nl": "Gebruikt exponentieel voortschrijdend gemiddelde van gekwadrateerde gradiënten in plaats van cumulatieve som, voorkomt leersnelheid-verval"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Create smooth gradient approximations for non-differentiable functions",
                  "es": "Crear aproximaciones de gradiente suaves para funciones no diferenciables",
                  "de": "Glatte Gradientenapproximationen für nicht-differenzierbare Funktionen erstellen",
                  "nl": "Gladde gradiëntbenaderingen creëren voor niet-differentieerbare functies"
        },
        {
                  "en": "Synthesize multiple gradients into a single update direction",
                  "es": "Sintetizar múltiples gradientes en una dirección de actualización única",
                  "de": "Mehrere Gradienten in eine einzelne Update-Richtung synthetisieren",
                  "nl": "Meerdere gradiënten synthetiseren tot één update-richting"
        },
        {
                  "en": "Predict gradients with auxiliary networks to enable asynchronous layer updates without full backprop",
                  "es": "Predecir gradientes con redes auxiliares para permitir actualizaciones asíncronas de capas sin retropropagación completa",
                  "de": "Gradienten mit Hilfsnetzwerken vorhersagen um asynchrone Schicht-Updates ohne vollständige Backprop zu ermöglichen",
                  "nl": "Gradiënten voorspellen met hulpnetwerken om asynchrone laag-updates mogelijk te maken zonder volledige backprop"
        },
        {
                  "en": "Generate artificial training data through gradient manipulation",
                  "es": "Generar datos de entrenamiento artificiales a través de manipulación de gradiente",
                  "de": "Künstliche Trainingsdaten durch Gradientenmanipulation generieren",
                  "nl": "Kunstmatige trainingsdata genereren door gradiëntmanipulatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training models on limited hardware resources",
                  "es": "Entrenar modelos en recursos de hardware limitados",
                  "de": "Modelle auf begrenzten Hardware-Ressourcen trainieren",
                  "nl": "Modellen trainen op beperkte hardware-bronnen"
        },
        {
                  "en": "Optimizing lambda parameters in regularization",
                  "es": "Optimizar parámetros lambda en regularización",
                  "de": "Lambda-Parameter in Regularisierung optimieren",
                  "nl": "Lambda-parameters optimaliseren in regularisatie"
        },
        {
                  "en": "Batch normalization for language models",
                  "es": "Normalización de lote para modelos de lenguaje",
                  "de": "Batch-Normalisierung für Sprachmodelle",
                  "nl": "Batch-normalisatie voor taalmodellen"
        },
        {
                  "en": "Large batch training by adapting learning rate per layer based on trust ratio",
                  "es": "Entrenamiento de lotes grandes adaptando tasa de aprendizaje por capa basado en ratio de confianza",
                  "de": "Large-Batch-Training durch Anpassung der Lernrate pro Schicht basierend auf Vertrauensverhältnis",
                  "nl": "Grote batch-training door leersnelheid per laag aan te passen gebaseerd op vertrouwensratio"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reduce the magnitude of loss for stability",
                  "es": "Reducir la magnitud de pérdida para estabilidad",
                  "de": "Magnitude des Verlusts für Stabilität reduzieren",
                  "nl": "Magnitude van verlies verminderen voor stabiliteit"
        },
        {
                  "en": "Rescale losses from different tasks in multi-task learning",
                  "es": "Reescalar pérdidas de diferentes tareas en aprendizaje multi-tarea",
                  "de": "Verluste von verschiedenen Aufgaben im Multi-Task-Lernen neu skalieren",
                  "nl": "Verliezen van verschillende taken herschalen in multi-task learning"
        },
        {
                  "en": "Scale loss values to normalize across different batch sizes",
                  "es": "Escalar valores de pérdida para normalizar entre diferentes tamaños de lote",
                  "de": "Verlustwerte skalieren um über verschiedene Batch-Größen zu normalisieren",
                  "nl": "Verlieswaarden schalen om te normaliseren over verschillende batch-groottes"
        },
        {
                  "en": "Scale up gradients to prevent underflow when using 16-bit precision",
                  "es": "Escalar gradientes hacia arriba para prevenir subdesbordamiento al usar precisión de 16 bits",
                  "de": "Gradienten hochskalieren um Underflow bei Verwendung von 16-Bit-Präzision zu verhindern",
                  "nl": "Gradiënten opschalen om underflow te voorkomen bij gebruik van 16-bit precisie"
        }
        ],
        correct: 3,
        explanation: {
