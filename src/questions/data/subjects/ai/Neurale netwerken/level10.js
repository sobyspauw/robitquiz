// Neurale netwerken Quiz - Level 10
(function() {
  const level10 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Use pre-defined templates for all network designs",
                  "es": "Usar plantillas predefinidas para todos los diseños de red",
                  "de": "Vordefinierte Vorlagen für alle Netzwerkdesigns verwenden",
                  "nl": "Voorgedefinieerde sjablonen gebruiken voor alle netwerkontwerpen"
        },
        {
                  "en": "Copy architectures from successful existing models",
                  "es": "Copiar arquitecturas de modelos existentes exitosos",
                  "de": "Architekturen von erfolgreichen bestehenden Modellen kopieren",
                  "nl": "Architecturen kopiëren van succesvolle bestaande modellen"
        },
        {
                  "en": "Manually design architectures based on domain expertise",
                  "es": "Diseñar manualmente arquitecturas basadas en expertise de dominio",
                  "de": "Manuell Architekturen basierend auf Domänen-Expertise entwerfen",
                  "nl": "Handmatig architecturen ontwerpen gebaseerd op domeinexpertise"
        },
        {
                  "en": "Automatically discover optimal network architectures using machine learning",
                  "es": "Descubrir automáticamente arquitecturas de red óptimas usando aprendizaje automático",
                  "de": "Automatisch optimale Netzwerkarchitekturen mit maschinellem Lernen entdecken",
                  "nl": "Automatisch optimale netwerkarchitecturen ontdekken met machine learning"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Distribute training across multiple GPUs in a single machine",
                  "es": "Distribuir entrenamiento a través de múltiples GPUs en una sola máquina",
                  "de": "Training über mehrere GPUs in einer einzelnen Maschine verteilen",
                  "nl": "Training verdelen over meerdere GPU's in één machine"
        },
        {
                  "en": "Combine multiple pre-trained models into one ensemble",
                  "es": "Combinar múltiples modelos pre-entrenados en un ensamble",
                  "de": "Mehrere vortrainierte Modelle zu einem Ensemble kombinieren",
                  "nl": "Meerdere voorgetrainde modellen combineren tot één ensemble"
        },
        {
                  "en": "Train models across decentralized data sources without sharing raw data",
                  "es": "Entrenar modelos a través de fuentes de datos descentralizadas sin compartir datos crudos",
                  "de": "Modelle über dezentrale Datenquellen trainieren ohne Rohdaten zu teilen",
                  "nl": "Modellen trainen over gedecentraliseerde databronnen zonder ruwe data te delen"
        },
        {
                  "en": "Use federal government regulations to guide AI development",
                  "es": "Usar regulaciones del gobierno federal para guiar el desarrollo de IA",
                  "de": "Bundesregulierungen zur Anleitung der KI-Entwicklung verwenden",
                  "nl": "Federale overheidsregulaties gebruiken om AI-ontwikkeling te sturen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using reinforcement learning with self-generated rewards",
                  "es": "Usar aprendizaje por refuerzo con recompensas auto-generadas",
                  "de": "Verstärkungslernen mit selbst-generierten Belohnungen verwenden",
                  "nl": "Reinforcement learning gebruiken met zelf-gegenereerde beloningen"
        },
        {
                  "en": "Learning only from synthetic or artificially generated data",
                  "es": "Aprender solo de datos sintéticos o artificialmente generados",
                  "de": "Nur von synthetischen oder künstlich generierten Daten lernen",
                  "nl": "Alleen leren van synthetische of kunstmatig gegenereerde data"
        },
        {
                  "en": "Training models to supervise their own learning without human intervention",
                  "es": "Entrenar modelos para supervisar su propio aprendizaje sin intervención humana",
                  "de": "Modelle trainieren um ihr eigenes Lernen ohne menschliche Intervention zu überwachen",
                  "nl": "Modellen trainen om hun eigen leren te superviseren zonder menselijke interventie"
        },
        {
                  "en": "Learning representations from unlabeled data by predicting parts of the input",
                  "es": "Aprender representaciones de datos sin etiquetar prediciendo partes de la entrada",
                  "de": "Repräsentationen aus ungelabelten Daten lernen durch Vorhersage von Eingabeteilen",
                  "nl": "Representaties leren van ongelabelde data door delen van de invoer te voorspellen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Train models that never stop learning from new data",
                  "es": "Entrenar modelos que nunca dejan de aprender de nuevos datos",
                  "de": "Modelle trainieren die nie aufhören von neuen Daten zu lernen",
                  "nl": "Modellen trainen die nooit stoppen met leren van nieuwe data"
        },
        {
                  "en": "Create models that learn throughout their entire operational lifetime",
                  "es": "Crear modelos que aprendan durante toda su vida operativa",
                  "de": "Modelle erstellen die während ihrer gesamten Betriebszeit lernen",
                  "nl": "Modellen creëren die gedurende hun hele operationele levensduur leren"
        },
        {
                  "en": "Learn new tasks sequentially without forgetting previous knowledge",
                  "es": "Aprender nuevas tareas secuencialmente sin olvidar conocimiento previo",
                  "de": "Neue Aufgaben sequenziell lernen ohne vorheriges Wissen zu vergessen",
                  "nl": "Nieuwe taken sequentieel leren zonder vorige kennis te vergeten"
        },
        {
                  "en": "Continuously update the learning rate during training",
                  "es": "Actualizar continuamente la tasa de aprendizaje durante entrenamiento",
                  "de": "Lernrate während des Trainings kontinuierlich aktualisieren",
                  "nl": "Leersnelheid continu bijwerken tijdens training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use metadata to improve training efficiency",
                  "es": "Usar metadatos para mejorar eficiencia de entrenamiento",
                  "de": "Metadaten zur Verbesserung der Trainingseffizienz verwenden",
                  "nl": "Metadata gebruiken om trainingsefficiëntie te verbeteren"
        },
        {
                  "en": "Learn about the learning process itself through introspection",
                  "es": "Aprender sobre el proceso de aprendizaje mismo a través de introspección",
                  "de": "Über den Lernprozess selbst durch Introspektion lernen",
                  "nl": "Leren over het leerproces zelf door introspectie"
        },
        {
                  "en": "Combine multiple learning algorithms into one meta-algorithm",
                  "es": "Combinar múltiples algoritmos de aprendizaje en un meta-algoritmo",
                  "de": "Mehrere Lernalgorithmen zu einem Meta-Algorithmus kombinieren",
                  "nl": "Meerdere leeralgoritmen combineren tot één meta-algoritme"
        },
        {
                  "en": "Train models to quickly adapt to new tasks with minimal examples",
                  "es": "Entrenar modelos para adaptarse rápidamente a nuevas tareas con ejemplos mínimos",
                  "de": "Modelle trainieren um sich schnell an neue Aufgaben mit minimalen Beispielen anzupassen",
                  "nl": "Modellen trainen om zich snel aan te passen aan nieuwe taken met minimale voorbeelden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Train separate models for each domain expert",
                  "es": "Entrenar modelos separados para cada experto de dominio",
                  "de": "Separate Modelle für jeden Domänen-Experten trainieren",
                  "nl": "Afzonderlijke modellen trainen voor elke domeinexpert"
        },
        {
                  "en": "Scale model capacity efficiently by using only relevant expert networks for each input",
                  "es": "Escalar capacidad del modelo eficientemente usando solo redes expertas relevantes para cada entrada",
                  "de": "Modellkapazität effizient skalieren durch Verwendung nur relevanter Experten-Netzwerke für jede Eingabe",
                  "nl": "Modelcapaciteit efficiënt schalen door alleen relevante expertnetwerken te gebruiken voor elke invoer"
        },
        {
                  "en": "Combine predictions from multiple independent expert models",
                  "es": "Combinar predicciones de múltiples modelos expertos independientes",
                  "de": "Vorhersagen von mehreren unabhängigen Experten-Modellen kombinieren",
                  "nl": "Voorspellingen van meerdere onafhankelijke expertmodellen combineren"
        },
        {
                  "en": "Use expert knowledge to manually design network architectures",
                  "es": "Usar conocimiento experto para diseñar manualmente arquitecturas de red",
                  "de": "Expertenwissen zur manuellen Gestaltung von Netzwerkarchitekturen verwenden",
                  "nl": "Expertkennis gebruiken om netwerkarchitecturen handmatig te ontwerpen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Generate data by diffusing latent representations",
                  "es": "Generar datos difundiendo representaciones latentes",
                  "de": "Daten durch Diffusion latenter Repräsentationen generieren",
                  "nl": "Data genereren door latente representaties te verspreiden"
        },
        {
                  "en": "Learn to reverse a gradual noise addition process to generate data",
                  "es": "Aprender a revertir un proceso gradual de adición de ruido para generar datos",
                  "de": "Lernen einen graduellen Rausch-Hinzufügungsprozess umzukehren um Daten zu generieren",
                  "nl": "Leren om een geleidelijk ruistoevoegingsproces om te keren om data te genereren"
        },
        {
                  "en": "Use molecular diffusion principles in neural computation",
                  "es": "Usar principios de difusión molecular en computación neural",
                  "de": "Molekulare Diffusionsprinzipien in neuraler Berechnung verwenden",
                  "nl": "Moleculaire diffusieprincipes gebruiken in neurale berekening"
        },
        {
                  "en": "Diffuse information across different layers of the network",
                  "es": "Difundir información a través de diferentes capas de la red",
                  "de": "Informationen über verschiedene Schichten des Netzwerks verteilen",
                  "nl": "Informatie verspreiden over verschillende lagen van het netwerk"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Model electromagnetic radiation patterns in neural architectures",
                  "es": "Modelar patrones de radiación electromagnética en arquitecturas neurales",
                  "de": "Elektromagnetische Strahlungsmuster in neuralen Architekturen modellieren",
                  "nl": "Elektromagnetische stralingspatronen modelleren in neurale architecturen"
        },
        {
                  "en": "Compress neural networks using radiance-based techniques",
                  "es": "Comprimir redes neuronales usando técnicas basadas en radiancia",
                  "de": "Neurale Netzwerke mit radianz-basierten Techniken komprimieren",
                  "nl": "Neurale netwerken comprimeren met op straling gebaseerde technieken"
        },
        {
                  "en": "Generate photorealistic novel views of 3D scenes from limited 2D images",
                  "es": "Generar vistas nuevas fotorealistas de escenas 3D desde imágenes 2D limitadas",
                  "de": "Fotorealistische neue Ansichten von 3D-Szenen aus begrenzten 2D-Bildern generieren",
                  "nl": "Fotorealistische nieuwe weergaven van 3D-scènes genereren vanuit beperkte 2D-beelden"
        },
        {
                  "en": "Create neural networks that emit light for visualization",
                  "es": "Crear redes neuronales que emiten luz para visualización",
                  "de": "Neurale Netzwerke erstellen die Licht für Visualisierung emittieren",
                  "nl": "Neurale netwerken creëren die licht uitstralen voor visualisatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use graph theory to optimize neural network training",
                  "es": "Usar teoría de grafos para optimizar entrenamiento de redes neuronales",
                  "de": "Graphentheorie zur Optimierung des neuronalen Netzwerktrainings verwenden",
                  "nl": "Grafiektheorie gebruiken om neurale netwerktraining te optimaliseren"
        },
        {
                  "en": "Generate graph-like network topologies automatically",
                  "es": "Generar topologías de red similares a grafos automáticamente",
                  "de": "Graph-ähnliche Netzwerktopologien automatisch generieren",
                  "nl": "Grafiekachtige netwerktopologieën automatisch genereren"
        },
        {
                  "en": "Enable deep learning on non-Euclidean graph-structured data",
                  "es": "Habilitar aprendizaje profundo en datos estructurados en grafos no-euclidianos",
                  "de": "Deep Learning auf nicht-euklidischen graphstrukturierten Daten ermöglichen",
                  "nl": "Deep learning mogelijk maken op niet-Euclidische grafisch gestructureerde data"
        },
        {
                  "en": "Visualize neural network architectures as graphs",
                  "es": "Visualizar arquitecturas de redes neuronales como grafos",
                  "de": "Neurale Netzwerkarchitekturen als Graphen visualisieren",
                  "nl": "Neurale netwerkarchitecturen visualiseren als grafieken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Model continuous-time dynamics instead of discrete layer transformations",
                  "es": "Modelar dinámicas de tiempo continuo en lugar de transformaciones discretas de capas",
                  "de": "Kontinuierliche Zeitdynamiken anstatt diskreter Schichttransformationen modellieren",
                  "nl": "Continue-tijd dynamiek modelleren in plaats van discrete laagtransformaties"
        },
        {
                  "en": "Integrate calculus-based operations into neural architectures",
                  "es": "Integrar operaciones basadas en cálculo en arquitecturas neurales",
                  "de": "Kalkül-basierte Operationen in neurale Architekturen integrieren",
                  "nl": "Calculus-gebaseerde operaties integreren in neurale architecturen"
        },
        {
                  "en": "Solve ordinary differential equations using neural networks",
                  "es": "Resolver ecuaciones diferenciales ordinarias usando redes neuronales",
                  "de": "Gewöhnliche Differentialgleichungen mit neuronalen Netzwerken lösen",
                  "nl": "Gewone differentiaalvergelijkingen oplossen met neurale netwerken"
        },
        {
                  "en": "Create networks that adapt their depth dynamically",
                  "es": "Crear redes que adapten su profundidad dinámicamente",
                  "de": "Netzwerke erstellen die ihre Tiefe dynamisch anpassen",
                  "nl": "Netwerken creëren die hun diepte dynamisch aanpassen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Preserve spatial hierarchies and part-whole relationships through vector outputs",
                  "es": "Preservar jerarquías espaciales y relaciones parte-todo a través de salidas vectoriales",
                  "de": "Räumliche Hierarchien und Teil-Ganzes-Beziehungen durch Vektorausgaben erhalten",
                  "nl": "Ruimtelijke hiërarchieën en deel-geheel relaties behouden via vectoruitvoer"
        },
        {
                  "en": "Use capsules to encapsulate different types of neural networks",
                  "es": "Usar cápsulas para encapsular diferentes tipos de redes neuronales",
                  "de": "Kapseln zur Kapselung verschiedener Arten neuronaler Netzwerke verwenden",
                  "nl": "Capsules gebruiken om verschillende soorten neurale netwerken te kapselen"
        },
        {
                  "en": "Create modular networks that can be assembled dynamically",
                  "es": "Crear redes modulares que pueden ensamblarse dinámicamente",
                  "de": "Modulare Netzwerke erstellen die dynamisch zusammengebaut werden können",
                  "nl": "Modulaire netwerken creëren die dynamisch kunnen worden samengesteld"
        },
        {
                  "en": "Replace convolutional operations with capsule-based filtering",
                  "es": "Reemplazar operaciones convolucionales con filtrado basado en cápsulas",
                  "de": "Faltungsoperationen durch kapselbasierte Filterung ersetzen",
                  "nl": "Convolutionele operaties vervangen door capsule-gebaseerde filtering"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Develop machine learning for adversarial game theory",
                  "es": "Desarrollar aprendizaje automático para teoría de juegos adversaria",
                  "de": "Maschinelles Lernen für adversariale Spieltheorie entwickeln",
                  "nl": "Machine learning ontwikkelen voor adversariële speltheorie"
        },
        {
                  "en": "Understand and defend against malicious attacks on ML models",
                  "es": "Entender y defenderse contra ataques maliciosos en modelos de ML",
                  "de": "Bösartige Angriffe auf ML-Modelle verstehen und abwehren",
                  "nl": "Begrijpen en verdedigen tegen kwaadaardige aanvallen op ML-modellen"
        },
        {
                  "en": "Create adversarial networks that compete against each other",
                  "es": "Crear redes adversarias que compiten entre sí",
                  "de": "Adversariale Netzwerke erstellen die gegeneinander konkurrieren",
                  "nl": "Adversariële netwerken creëren die tegen elkaar concurreren"
        },
        {
                  "en": "Use adversarial training exclusively for model improvement",
                  "es": "Usar entrenamiento adversario exclusivamente para mejora de modelos",
                  "de": "Adversariales Training ausschließlich zur Modellverbesserung verwenden",
                  "nl": "Adversariële training uitsluitend gebruiken voor modelverbetering"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learn by contrasting predictions with ground truth labels",
                  "es": "Aprender contrastando predicciones con etiquetas de verdad fundamental",
                  "de": "Lernen durch Kontrastierung von Vorhersagen mit Ground-Truth-Labels",
                  "nl": "Leren door voorspellingen te contrasteren met ground truth labels"
        },
        {
                  "en": "Use contrasting colors and features in visual learning",
                  "es": "Usar colores y características contrastantes en aprendizaje visual",
                  "de": "Kontrastierende Farben und Merkmale im visuellen Lernen verwenden",
                  "nl": "Contrasterende kleuren en kenmerken gebruiken in visueel leren"
        },
        {
                  "en": "Learn representations by pulling similar examples together and pushing dissimilar ones apart",
                  "es": "Aprender representaciones acercando ejemplos similares y alejando los disimilares",
                  "de": "Repräsentationen lernen durch Zusammenziehen ähnlicher Beispiele und Auseinanderdrängen unähnlicher",
                  "nl": "Representaties leren door vergelijkbare voorbeelden samen te trekken en ongelijksoortige uiteen te drijven"
        },
        {
                  "en": "Create contrasting network architectures for comparison",
                  "es": "Crear arquitecturas de red contrastantes para comparación",
                  "de": "Kontrastierende Netzwerkarchitekturen für Vergleich erstellen",
                  "nl": "Contrasterende netwerkarchitecturen creëren voor vergelijking"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Retrieve and combine multiple pre-trained transformer models",
                  "es": "Recuperar y combinar múltiples modelos transformer pre-entrenados",
                  "de": "Mehrere vortrainierte Transformer-Modelle abrufen und kombinieren",
                  "nl": "Meerdere voorgetrainde transformer-modellen ophalen en combineren"
        },
        {
                  "en": "Augment model knowledge by retrieving relevant information from external databases",
                  "es": "Aumentar conocimiento del modelo recuperando información relevante de bases de datos externas",
                  "de": "Modellwissen durch Abrufen relevanter Informationen aus externen Datenbanken erweitern",
                  "nl": "Modelkennis uitbreiden door relevante informatie op te halen uit externe databases"
        },
        {
                  "en": "Automatically retrieve optimal hyperparameters during training",
                  "es": "Recuperar automáticamente hiperparámetros óptimos durante entrenamiento",
                  "de": "Optimale Hyperparameter während des Trainings automatisch abrufen",
                  "nl": "Automatisch optimale hyperparameters ophalen tijdens training"
        },
        {
                  "en": "Retrieve and reuse previously computed attention patterns",
                  "es": "Recuperar y reutilizar patrones de atención previamente computados",
                  "de": "Zuvor berechnete Aufmerksamkeitsmuster abrufen und wiederverwenden",
                  "nl": "Eerder berekende aandachtspatronen ophalen en hergebruiken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Predict optimal model size, data requirements, and compute for given performance targets",
                  "es": "Predecir tamaño óptimo del modelo, requerimientos de datos y cómputo para objetivos de rendimiento dados",
                  "de": "Optimale Modellgröße, Datenanforderungen und Rechenaufwand für gegebene Leistungsziele vorhersagen",
                  "nl": "Optimale modelgrootte, datavereisten en rekenkracht voorspellen voor gegeven prestatiedoelen"
        },
        {
                  "en": "Scale neural networks to run on different hardware architectures",
                  "es": "Escalar redes neuronales para ejecutar en diferentes arquitecturas de hardware",
                  "de": "Neurale Netzwerke zur Ausführung auf verschiedenen Hardware-Architekturen skalieren",
                  "nl": "Neurale netwerken schalen om te draaien op verschillende hardware-architecturen"
        },
        {
                  "en": "Develop mathematical laws that govern neural network behavior",
                  "es": "Desarrollar leyes matemáticas que gobiernen el comportamiento de redes neuronales",
                  "de": "Mathematische Gesetze entwickeln die das Verhalten neuronaler Netzwerke regeln",
                  "nl": "Wiskundige wetten ontwikkelen die het gedrag van neurale netwerken regeren"
        },
        {
                  "en": "Create networks that can automatically scale their complexity",
                  "es": "Crear redes que pueden escalar automáticamente su complejidad",
                  "de": "Netzwerke erstellen die ihre Komplexität automatisch skalieren können",
                  "nl": "Netwerken creëren die hun complexiteit automatisch kunnen schalen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use implicit differentiation for more efficient training",
                  "es": "Usar diferenciación implícita para entrenamiento más eficiente",
                  "de": "Implizite Differentiation für effizienteres Training verwenden",
                  "nl": "Impliciete differentiatie gebruiken voor efficiëntere training"
        },
        {
                  "en": "Represent continuous signals as neural network functions instead of discrete samples",
                  "es": "Representar señales continuas como funciones de redes neuronales en lugar de muestras discretas",
                  "de": "Kontinuierliche Signale als neuronale Netzwerkfunktionen anstatt diskrete Samples repräsentieren",
                  "nl": "Continue signalen representeren als neurale netwerkfuncties in plaats van discrete samples"
        },
        {
                  "en": "Learn representations that are implicitly encoded in network weights",
                  "es": "Aprender representaciones que están implícitamente codificadas en pesos de red",
                  "de": "Repräsentationen lernen die implizit in Netzwerkgewichten kodiert sind",
                  "nl": "Representaties leren die impliciet gecodeerd zijn in netwerkgewichten"
        },
        {
                  "en": "Create neural networks with implicit rather than explicit connections",
                  "es": "Crear redes neuronales con conexiones implícitas en lugar de explícitas",
                  "de": "Neurale Netzwerke mit impliziten anstatt expliziten Verbindungen erstellen",
                  "nl": "Neurale netwerken creëren met impliciete in plaats van expliciete verbindingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Create efficient parameter sharing across different model architectures",
                  "es": "Crear compartición eficiente de parámetros a través de diferentes arquitecturas de modelo",
                  "de": "Effiziente Parameterteilung über verschiedene Modellarchitekturen erstellen",
                  "nl": "Efficiënte parameterdeling creëren over verschillende modelarchitecturen"
        },
        {
                  "en": "Adapt large pre-trained models to new tasks while updating only a small fraction of parameters",
                  "es": "Adaptar modelos pre-entrenados grandes a nuevas tareas actualizando solo una pequeña fracción de parámetros",
                  "de": "Große vortrainierte Modelle an neue Aufgaben anpassen während nur ein kleiner Bruchteil der Parameter aktualisiert wird",
                  "nl": "Grote voorgetrainde modellen aanpassen aan nieuwe taken terwijl slechts een kleine fractie van parameters wordt bijgewerkt"
        },
        {
                  "en": "Automatically tune hyperparameters for optimal performance",
                  "es": "Ajustar automáticamente hiperparámetros para rendimiento óptimo",
                  "de": "Hyperparameter automatisch für optimale Leistung abstimmen",
                  "nl": "Automatisch hyperparameters afstemmen voor optimale prestaties"
        },
        {
                  "en": "Fine-tune models using fewer computational resources",
                  "es": "Ajustar modelos usando menos recursos computacionales",
                  "de": "Modelle mit weniger Rechenressourcen feinabstimmen",
                  "nl": "Modellen fijn afstemmen met minder computationele bronnen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Networks designed to process liquid-state data efficiently",
                  "es": "Redes diseñadas para procesar datos de estado líquido eficientemente",
                  "de": "Netzwerke entworfen um Flüssigzustandsdaten effizient zu verarbeiten",
                  "nl": "Netwerken ontworpen om vloeistofstatusdata efficiënt te verwerken"
        },
        {
                  "en": "Neural networks that can physically flow like liquids",
                  "es": "Redes neuronales que pueden fluir físicamente como líquidos",
                  "de": "Neurale Netzwerke die physisch wie Flüssigkeiten fließen können",
                  "nl": "Neurale netwerken die fysiek kunnen stromen zoals vloeistoffen"
        },
        {
                  "en": "Networks with time-varying, adaptive dynamics inspired by biological neurons",
                  "es": "Redes con dinámicas adaptativas que varían en el tiempo inspiradas en neuronas biológicas",
                  "de": "Netzwerke mit zeitveränderlichen, adaptiven Dynamiken inspiriert von biologischen Neuronen",
                  "nl": "Netwerken met tijdvariërende, adaptieve dynamiek geïnspireerd door biologische neuronen"
        },
        {
                  "en": "Fluid-based analog computers using neural network principles",
                  "es": "Computadoras analógicas basadas en fluidos usando principios de redes neuronales",
                  "de": "Flüssigkeitsbasierte Analogcomputer mit neuronalen Netzwerkprinzipien",
                  "nl": "Op vloeistof gebaseerde analoge computers met neurale netwerkprincipes"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Design emergency response systems using language models",
                  "es": "Diseñar sistemas de respuesta de emergencia usando modelos de lenguaje",
                  "de": "Notfallresponse-Systeme mit Sprachmodellen entwerfen",
                  "nl": "Noodresponsesystemen ontwerpen met behulp van taalmodellen"
        },
        {
                  "en": "Study how language models adapt to emerging trends in data",
                  "es": "Estudiar cómo los modelos de lenguaje se adaptan a tendencias emergentes en datos",
                  "de": "Studieren wie Sprachmodelle sich an aufkommende Trends in Daten anpassen",
                  "nl": "Bestuderen hoe taalmodellen zich aanpassen aan opkomende trends in data"
        },
        {
                  "en": "Create models that can emerge from distributed training automatically",
                  "es": "Crear modelos que pueden emerger de entrenamiento distribuido automáticamente",
                  "de": "Modelle erstellen die automatisch aus verteiltem Training entstehen können",
                  "nl": "Modellen creëren die automatisch kunnen ontstaan uit gedistribueerde training"
        },
        {
                  "en": "Understand how complex capabilities arise unpredictably as models scale beyond certain thresholds",
                  "es": "Entender cómo capacidades complejas surgen impredeciblemente cuando los modelos escalan más allá de ciertos umbrales",
                  "de": "Verstehen wie komplexe Fähigkeiten unvorhersagbar entstehen wenn Modelle über bestimmte Schwellwerte hinaus skalieren",
                  "nl": "Begrijpen hoe complexe mogelijkheden onvoorspelbaar ontstaan wanneer modellen schalen voorbij bepaalde drempels"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Create models with sparse, interpretable expert knowledge representations",
                  "es": "Crear modelos con representaciones de conocimiento experto dispersas e interpretables",
                  "de": "Modelle mit sparsamen, interpretierbaren Experten-Wissensrepräsentationen erstellen",
                  "nl": "Modellen creëren met schaarse, interpreteerbare expert kennisrepresentaties"
        },
        {
                  "en": "Reduce model size by removing non-essential expert components",
                  "es": "Reducir tamaño del modelo removiendo componentes expertos no esenciales",
                  "de": "Modellgröße durch Entfernung nicht-essentieller Expertenkomponenten reduzieren",
                  "nl": "Modelgrootte verminderen door niet-essentiële expertcomponenten te verwijderen"
        },
        {
                  "en": "Scale model capacity while keeping computational cost constant through selective activation",
                  "es": "Escalar capacidad del modelo manteniendo costo computacional constante a través de activación selectiva",
                  "de": "Modellkapazität skalieren während Rechenkosten konstant gehalten werden durch selektive Aktivierung",
                  "nl": "Modelcapaciteit schalen terwijl rekenkosten constant blijven door selectieve activatie"
        },
        {
                  "en": "Automatically identify and utilize domain experts during training",
                  "es": "Identificar y utilizar automáticamente expertos de dominio durante entrenamiento",
                  "de": "Domänen-Experten während des Trainings automatisch identifizieren und nutzen",
                  "nl": "Automatisch domeinexperts identificeren en gebruiken tijdens training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gradually remove layers from the network during training",
                  "es": "Eliminar gradualmente capas de la red durante entrenamiento",
                  "de": "Schichten während des Trainings schrittweise aus dem Netzwerk entfernen",
                  "nl": "Geleidelijk lagen verwijderen uit het netwerk tijdens training"
        },
        {
                  "en": "Trim training data to reduce computational requirements",
                  "es": "Recortar datos de entrenamiento para reducir requerimientos computacionales",
                  "de": "Trainingsdaten beschneiden um Rechenanforderungen zu reduzieren",
                  "nl": "Trainingsdata trimmen om rekenkundige vereisten te verminderen"
        },
        {
                  "en": "Remove redundant connections and parameters while preserving model performance",
                  "es": "Eliminar conexiones y parámetros redundantes mientras se preserva rendimiento del modelo",
                  "de": "Redundante Verbindungen und Parameter entfernen während Modellleistung erhalten bleibt",
                  "nl": "Redundante verbindingen en parameters verwijderen terwijl modelprestaties behouden blijven"
        },
        {
                  "en": "Prune decision trees within neural architectures",
                  "es": "Podar árboles de decisión dentro de arquitecturas neurales",
                  "de": "Entscheidungsbäume innerhalb neuraler Architekturen beschneiden",
                  "nl": "Beslisbomen snoeien binnen neurale architecturen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Neural networks designed to process morphological image data",
                  "es": "Redes neuronales diseñadas para procesar datos de imágenes morfológicas",
                  "de": "Neurale Netzwerke entworfen um morphologische Bilddaten zu verarbeiten",
                  "nl": "Neurale netwerken ontworpen om morfologische beelddata te verwerken"
        },
        {
                  "en": "Hardware architectures that mimic biological neural systems for energy-efficient computation",
                  "es": "Arquitecturas de hardware que imitan sistemas neurales biológicos para computación eficiente en energía",
                  "de": "Hardware-Architekturen die biologische neurale Systeme für energieeffiziente Berechnung nachahmen",
                  "nl": "Hardware-architecturen die biologische neurale systemen nabootsen voor energie-efficiënte berekening"
        },
        {
                  "en": "Software that morphs neural network architectures dynamically",
                  "es": "Software que transforma arquitecturas de redes neuronales dinámicamente",
                  "de": "Software die neurale Netzwerkarchitekturen dynamisch transformiert",
                  "nl": "Software die neurale netwerkarchitecturen dynamisch transformeert"
        },
        {
                  "en": "Algorithms that change network topology based on input morphology",
                  "es": "Algoritmos que cambian topología de red basada en morfología de entrada",
                  "de": "Algorithmen die Netzwerktopologie basierend auf Eingabemorphologie ändern",
                  "nl": "Algoritmen die netwerktopologie veranderen op basis van invoermorfologie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Develop AI that can generate natural language explanations",
                  "es": "Desarrollar IA que pueda generar explicaciones en lenguaje natural",
                  "de": "KI entwickeln die natürlichsprachige Erklärungen generieren kann",
                  "nl": "AI ontwikkelen die natuurlijke taal uitleg kan genereren"
        },
        {
                  "en": "Train AI systems to explain their training process",
                  "es": "Entrenar sistemas de IA para explicar su proceso de entrenamiento",
                  "de": "KI-Systeme trainieren um ihren Trainingsprozess zu erklären",
                  "nl": "AI-systemen trainen om hun trainingsproces uit te leggen"
        },
        {
                  "en": "Make neural network decisions transparent and interpretable to humans",
                  "es": "Hacer las decisiones de redes neuronales transparentes e interpretables para humanos",
                  "de": "Neurale Netzwerkentscheidungen für Menschen transparent und interpretierbar machen",
                  "nl": "Neurale netwerkbeslissingen transparant en interpreteerbaar maken voor mensen"
        },
        {
                  "en": "Create models that can be easily explained to non-technical users",
                  "es": "Crear modelos que puedan ser fácilmente explicados a usuarios no técnicos",
                  "de": "Modelle erstellen die einfach an nicht-technische Nutzer erklärt werden können",
                  "nl": "Modellen creëren die gemakkelijk kunnen worden uitgelegd aan niet-technische gebruikers"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Encapsulate multiple layers into reusable modules",
                  "es": "Encapsular múltiples capas en módulos reutilizables",
                  "de": "Mehrere Schichten in wiederverwendbare Module kapseln",
                  "nl": "Meerdere lagen inkapselen in herbruikbare modules"
        },
        {
                  "en": "Create isolated network components that don't share information",
                  "es": "Crear componentes de red aislados que no comparten información",
                  "de": "Isolierte Netzwerkkomponenten erstellen die keine Informationen teilen",
                  "nl": "Geïsoleerde netwerkcomponenten creëren die geen informatie delen"
        },
        {
                  "en": "Package trained models into deployable capsules",
                  "es": "Empaquetar modelos entrenados en cápsulas desplegables",
                  "de": "Trainierte Modelle in einsetzbare Kapseln verpacken",
                  "nl": "Getrainde modellen verpakken in implementeerbare capsules"
        },
        {
                  "en": "Group neurons into capsules that output vectors encoding both presence and properties of features",
                  "es": "Agrupar neuronas en cápsulas que producen vectores codificando tanto presencia como propiedades de características",
                  "de": "Neuronen in Kapseln gruppieren die Vektoren ausgeben welche sowohl Vorhandensein als auch Eigenschaften von Features kodieren",
                  "nl": "Neuronen groeperen in capsules die vectoren uitvoeren die zowel aanwezigheid als eigenschappen van features coderen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mathematical framework showing infinitely wide networks behave like kernel methods during training",
                  "es": "Marco matemático mostrando que redes infinitamente anchas se comportan como métodos de kernel durante entrenamiento",
                  "de": "Mathematischer Rahmen der zeigt dass unendlich breite Netzwerke sich während des Trainings wie Kernel-Methoden verhalten",
                  "nl": "Wiskundig kader dat aantoont dat oneindig brede netwerken zich gedragen als kernel-methoden tijdens training"
        },
        {
                  "en": "Tangent-based optimization methods for faster convergence",
                  "es": "Métodos de optimización basados en tangentes para convergencia más rápida",
                  "de": "Tangenten-basierte Optimierungsmethoden für schnellere Konvergenz",
                  "nl": "Tangent-gebaseerde optimalisatiemethoden voor snellere convergentie"
        },
        {
                  "en": "Kernel functions designed to work with neural tangent spaces",
                  "es": "Funciones de kernel diseñadas para trabajar con espacios tangentes neuronales",
                  "de": "Kernel-Funktionen entworfen um mit neuralen Tangentenräumen zu arbeiten",
                  "nl": "Kernelfuncties ontworpen om te werken met neurale tangentruimtes"
        },
        {
                  "en": "Hardware kernel design optimized for neural network computations",
                  "es": "Diseño de kernel de hardware optimizado para cálculos de redes neuronales",
                  "de": "Hardware-Kernel-Design optimiert für neuronale Netzwerkberechnungen",
                  "nl": "Hardware-kernelontwerp geoptimaliseerd voor neurale netwerkberekeningen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Test error decreases, then increases, then decreases again as model capacity grows beyond interpolation threshold",
                  "es": "Error de prueba disminuye, luego aumenta, luego disminuye nuevamente cuando capacidad del modelo crece más allá del umbral de interpolación",
                  "de": "Testfehler nimmt ab, dann zu, dann wieder ab wenn Modellkapazität über Interpolationsschwelle hinaus wächst",
                  "nl": "Testfout neemt af, neemt toe, neemt dan weer af wanneer modelcapaciteit groeit voorbij interpolatiedrempel"
        },
        {
                  "en": "Network architecture requires two descent paths for optimal performance",
                  "es": "Arquitectura de red requiere dos caminos de descenso para rendimiento óptimo",
                  "de": "Netzwerkarchitektur erfordert zwei Abstiegspfade für optimale Leistung",
                  "nl": "Netwerkarchitectuur vereist twee afnamepaden voor optimale prestaties"
        },
        {
                  "en": "Gradient descent algorithm runs twice with different learning rates",
                  "es": "Algoritmo de descenso de gradiente se ejecuta dos veces con diferentes tasas de aprendizaje",
                  "de": "Gradienten-Descent-Algorithmus läuft zweimal mit unterschiedlichen Lernraten",
                  "nl": "Gradiënt-descent algoritme draait twee keer met verschillende leersnelheden"
        },
        {
                  "en": "Loss function decreases twice during training epochs",
                  "es": "Función de pérdida disminuye dos veces durante épocas de entrenamiento",
                  "de": "Verlustfunktion nimmt während Trainingsepochen zweimal ab",
                  "nl": "Verliesfunctie neemt twee keer af tijdens trainingsepochen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only lucky training runs achieve good convergence",
                  "es": "Solo ejecuciones de entrenamiento afortunadas logran buena convergencia",
                  "de": "Nur glückliche Trainingsläufe erreichen gute Konvergenz",
                  "nl": "Alleen gelukkige trainingsruns bereiken goede convergentie"
        },
        {
                  "en": "Winning models are selected randomly from ensemble of candidates",
                  "es": "Modelos ganadores se seleccionan aleatoriamente de ensamble de candidatos",
                  "de": "Gewinnende Modelle werden zufällig aus Ensemble von Kandidaten ausgewählt",
                  "nl": "Winnende modellen worden willekeurig geselecteerd uit ensemble van kandidaten"
        },
        {
                  "en": "Dense networks contain sparse subnetworks that can match full network performance when trained from initialization",
                  "es": "Redes densas contienen subredes dispersas que pueden igualar rendimiento de red completa cuando se entrenan desde inicialización",
                  "de": "Dichte Netzwerke enthalten spärliche Subnetzwerke die vollständige Netzwerkleistung erreichen können wenn von Initialisierung trainiert",
                  "nl": "Dichte netwerken bevatten schaarse subnetwerken die volledige netwerkprestaties kunnen evenaren wanneer getraind vanaf initialisatie"
        },
        {
                  "en": "Random weight initialization has a lottery-like effect on final model performance",
                  "es": "Inicialización aleatoria de pesos tiene un efecto tipo lotería en rendimiento final del modelo",
                  "de": "Zufällige Gewichtsinitialisierung hat einen lotterieartigen Effekt auf finale Modellleistung",
                  "nl": "Willekeurige gewichtsinitialisatie heeft een loterij-achtig effect op uiteindelijke modelprestaties"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Transform visual data into text for better interpretability",
                  "es": "Transformar datos visuales en texto para mejor interpretabilidad",
                  "de": "Visuelle Daten in Text transformieren für bessere Interpretierbarkeit",
                  "nl": "Visuele data transformeren naar tekst voor betere interpreteerbaarheid"
        },
        {
                  "en": "Use transformers to generate realistic images from noise",
                  "es": "Usar transformers para generar imágenes realistas desde ruido",
                  "de": "Transformer verwenden um realistische Bilder aus Rauschen zu generieren",
                  "nl": "Transformers gebruiken om realistische beelden te genereren uit ruis"
        },
        {
                  "en": "Combine CNNs and transformers for hybrid vision models",
                  "es": "Combinar CNNs y transformers para modelos de visión híbridos",
                  "de": "CNNs und Transformer für hybride Visionsmodelle kombinieren",
                  "nl": "CNN's en transformers combineren voor hybride visiemodellen"
        },
        {
                  "en": "Apply pure transformer architecture to image patches without convolutions, achieving state-of-the-art results",
                  "es": "Aplicar arquitectura transformer pura a parches de imagen sin convoluciones, logrando resultados estado del arte",
                  "de": "Reine Transformer-Architektur auf Bild-Patches ohne Faltungen anwenden und State-of-the-Art-Ergebnisse erzielen",
                  "nl": "Pure transformer-architectuur toepassen op beeldpatches zonder convoluties, waarbij state-of-the-art resultaten worden behaald"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Solve ODEs numerically within each neural network layer",
                  "es": "Resolver ODEs numéricamente dentro de cada capa de red neuronal",
                  "de": "ODEs numerisch innerhalb jeder neuronalen Netzwerkschicht lösen",
                  "nl": "ODE's numeriek oplossen binnen elke neurale netwerklaag"
        },
        {
                  "en": "Model hidden state evolution as continuous-time differential equations instead of discrete layers",
                  "es": "Modelar evolución de estado oculto como ecuaciones diferenciales de tiempo continuo en lugar de capas discretas",
                  "de": "Versteckten Zustand als zeitkontinuierliche Differentialgleichungen statt diskrete Schichten modellieren",
                  "nl": "Verborgen toestandsevolutie modelleren als continue-tijd differentiaalvergelijkingen in plaats van discrete lagen"
        },
        {
                  "en": "Use ordinary differential equations to initialize network weights",
                  "es": "Usar ecuaciones diferenciales ordinarias para inicializar pesos de red",
        ...
        {
                  "en": "Train neural networks to approximate solutions to differential equations",
                  "es": "Entrenar redes neuronales para aproximar soluciones a ecuaciones diferenciales",
                  "de": "Neuronale Netzwerke trainieren um Lösungen zu Differentialgleichungen zu approximieren",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Train models that contrast positive and negative examples equally",
                  "es": "Entrenar modelos que contrastan ejemplos positivos y negativos por igual",
                  "de": "Modelle trainieren die positive und negative Beispiele gleichermaßen kontrastieren",
                  "nl": "Modellen trainen die positieve en negatieve voorbeelden gelijkelijk contrasteren"
        },
        {
                  "en": "Learn powerful representations by maximizing agreement between augmented views of same data",
                  "es": "Aprender representaciones poderosas maximizando acuerdo entre vistas aumentadas de los mismos datos",
                  "de": "Leistungsstarke Repräsentationen lernen durch Maximierung der Übereinstimmung zwischen augmentierten Ansichten derselben Daten",
                  "nl": "Krachtige representaties leren door overeenstemming te maximaliseren tussen geaugmenteerde weergaven van dezelfde data"
        },
        {
                  "en": "Use contrasting loss functions for different training phases",
                  "es": "Usar funciones de pérdida contrastantes para diferentes fases de entrenamiento",
                  "de": "Kontrastierende Verlustfunktionen für verschiedene Trainingsphasen verwenden",
                  "nl": "Contrasterende verliesfuncties gebruiken voor verschillende trainingsfasen"
        },
        {
                  "en": "Compare different models to select the best architecture",
                  "es": "Comparar diferentes modelos para seleccionar la mejor arquitectura",
                  "de": "Verschiedene Modelle vergleichen um die beste Architektur auszuwählen",
                  "nl": "Verschillende modellen vergelijken om de beste architectuur te selecteren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Optimal model size and training tokens should scale proportionally for compute-efficient training",
                  "es": "Tamaño de modelo óptimo y tokens de entrenamiento deben escalar proporcionalmente para entrenamiento eficiente en cómputo",
                  "de": "Optimale Modellgröße und Trainings-Tokens sollten proportional für compute-effizientes Training skalieren",
                  "nl": "Optimale modelgrootte en trainingstokens moeten proportioneel schalen voor rekenefficiënte training"
        },
        {
                  "en": "Training data should be scaled exponentially with model depth",
                  "es": "Datos de entrenamiento deben escalarse exponencialmente con profundidad del modelo",
                  "de": "Trainingsdaten sollten exponentiell mit Modelltiefe skaliert werden",
                  "nl": "Trainingsdata moet exponentieel geschaald worden met modeldiepte"
        },
        {
                  "en": "Chinchilla-sized models are most efficient for all tasks",
                  "es": "Modelos tamaño Chinchilla son más eficientes para todas las tareas",
                  "de": "Chinchilla-große Modelle sind am effizientesten für alle Aufgaben",
                  "nl": "Chinchilla-grote modellen zijn meest efficiënt voor alle taken"
        },
        {
                  "en": "Larger models always perform better regardless of data size",
                  "es": "Modelos más grandes siempre tienen mejor rendimiento independientemente del tamaño de datos",
                  "de": "Größere Modelle performen immer besser unabhängig von Datengröße",
                  "nl": "Grotere modellen presteren altijd beter ongeacht datagrootte"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Spread training signal diffusely to prevent overfitting",
                  "es": "Distribuir señal de entrenamiento difusamente para prevenir sobreajuste",
                  "de": "Trainingssignal diffus verteilen um Overfitting zu verhindern",
                  "nl": "Trainingssignaal diffuus verspreiden om overfitting te voorkomen"
        },
        {
                  "en": "Diffuse information across all network layers equally",
                  "es": "Difundir información a través de todas las capas de red por igual",
                  "de": "Informationen gleichmäßig über alle Netzwerkschichten diffundieren",
                  "nl": "Informatie gelijkmatig verspreiden over alle netwerklagen"
        },
        {
                  "en": "Learn to reverse a gradual noising process to generate high-quality samples from noise",
                  "es": "Aprender a revertir un proceso gradual de ruido para generar muestras de alta calidad desde ruido",
                  "de": "Lernen einen graduellen Rauschprozess umzukehren um hochwertige Samples aus Rauschen zu generieren",
                  "nl": "Leren een geleidelijk ruisproces om te keren om hoogwaardige samples te genereren uit ruis"
        },
        {
                  "en": "Model how concepts diffuse through semantic space",
                  "es": "Modelar cómo los conceptos se difunden a través del espacio semántico",
                  "de": "Modellieren wie Konzepte durch semantischen Raum diffundieren",
                  "nl": "Modelleren hoe concepten diffunderen door semantische ruimte"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Create ensemble of specialist networks for different tasks",
                  "es": "Crear ensamble de redes especialistas para diferentes tareas",
                  "de": "Ensemble von Spezialistennetzwerken für verschiedene Aufgaben erstellen",
                  "nl": "Ensemble van specialistennetwerken creëren voor verschillende taken"
        },
        {
                  "en": "Mix different expert models trained on separate domains",
                  "es": "Mezclar diferentes modelos expertos entrenados en dominios separados",
                  "de": "Verschiedene Expertenmodelle gemischt trainiert auf separaten Domänen",
                  "nl": "Verschillende expertmodellen mixen getraind op aparte domeinen"
        },
        {
                  "en": "Allow human experts to guide model training decisions",
                  "es": "Permitir que expertos humanos guíen decisiones de entrenamiento del modelo",
                  "de": "Menschlichen Experten erlauben Modell-Trainingsentscheidungen zu leiten",
                  "nl": "Menselijke experts toestaan modeltrainingsbeslissingen te sturen"
        },
        {
                  "en": "Scale model capacity dramatically while keeping inference cost manageable through sparse activation",
                  "es": "Escalar capacidad de modelo dramáticamente manteniendo costo de inferencia manejable a través de activación dispersa",
                  "de": "Modellkapazität dramatisch skalieren während Inferenzkosten durch spärliche Aktivierung handhabbar bleiben",
                  "nl": "Modelcapaciteit dramatisch schalen terwijl inferentiekosten beheersbaar blijven door schaarse activering"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reinforce learning through human-labeled datasets",
                  "es": "Reforzar aprendizaje a través de conjuntos de datos etiquetados por humanos",
                  "de": "Lernen durch menschlich gelabelte Datensätze verstärken",
                  "nl": "Leren versterken door menselijk gelabelde datasets"
        },
        {
                  "en": "Have humans directly provide feedback during each training iteration",
                  "es": "Tener humanos proporcionando retroalimentación directamente durante cada iteración de entrenamiento",
                  "de": "Menschen direkt Feedback während jeder Trainingsiteration geben lassen",
                  "nl": "Mensen directe feedback laten geven tijdens elke trainingiteratie"
        },
        {
                  "en": "Use reinforcement learning to optimize human-computer interaction",
                  "es": "Usar aprendizaje por refuerzo para optimizar interacción humano-computadora",
                  "de": "Verstärkungslernen zur Optimierung der Mensch-Computer-Interaktion verwenden",
                  "nl": "Reinforcement learning gebruiken om mens-computer interactie te optimaliseren"
        },
        {
                  "en": "Train reward models from human preferences to align AI behavior with human values",
                  "es": "Entrenar modelos de recompensa desde preferencias humanas para alinear comportamiento de IA con valores humanos",
                  "de": "Belohnungsmodelle aus menschlichen Präferenzen trainieren um KI-Verhalten mit menschlichen Werten auszurichten",
                  "nl": "Beloningsmodellen trainen vanuit menselijke voorkeuren om AI-gedrag af te stemmen op menselijke waarden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Models achieve perfect memorization of training data",
                  "es": "Modelos logran memorización perfecta de datos de entrenamiento",
                  "de": "Modelle erreichen perfekte Auswendiglernen von Trainingsdaten",
                  "nl": "Modellen bereiken perfecte memorisatie van trainingsdata"
        },
        {
                  "en": "Models suddenly generalize well after initially memorizing, showing delayed understanding",
                  "es": "Modelos generalizan súbitamente bien después de inicialmente memorizar, mostrando comprensión retrasada",
                  "de": "Modelle generalisieren plötzlich gut nach anfänglichem Auswendiglernen, zeigen verzögertes Verständnis",
                  "nl": "Modellen generaliseren plotseling goed na aanvankelijk memoriseren, wat vertraagd begrip toont"
        },
        {
                  "en": "Gradual improvement in training follows predictable patterns",
                  "es": "Mejora gradual en entrenamiento sigue patrones predecibles",
                  "de": "Graduelle Verbesserung im Training folgt vorhersagbaren Mustern",
                  "nl": "Geleidelijke verbetering in training volgt voorspelbare patronen"
        },
        {
                  "en": "Networks develop human-like intuition about problems",
                  "es": "Redes desarrollan intuición tipo humana sobre problemas",
                  "de": "Netzwerke entwickeln menschenähnliche Intuition über Probleme",
                  "nl": "Netwerken ontwikkelen mensachtige intuïtie over problemen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Efficiently search for optimal hyperparameters",
                  "es": "Buscar eficientemente hiperparámetros óptimos",
                  "de": "Effizient nach optimalen Hyperparametern suchen",
                  "nl": "Efficiënt zoeken naar optimale hyperparameters"
        },
        {
                  "en": "Tune parameters more precisely than standard methods",
                  "es": "Ajustar parámetros más precisamente que métodos estándar",
                  "de": "Parameter präziser als Standardmethoden tunen",
                  "nl": "Parameters nauwkeuriger afstemmen dan standaardmethoden"
        },
        {
                  "en": "Reduce the number of parameters in trained models",
                  "es": "Reducir el número de parámetros en modelos entrenados",
                  "de": "Anzahl der Parameter in trainierten Modellen reduzieren",
                  "nl": "Aantal parameters in getrainde modellen verminderen"
        },
        {
                  "en": "Adapt large pre-trained models to new tasks by training only a small fraction of parameters",
                  "es": "Adaptar grandes modelos pre-entrenados a nuevas tareas entrenando solo una pequeña fracción de parámetros",
                  "de": "Große vortrainierte Modelle auf neue Aufgaben anpassen durch Training nur eines kleinen Bruchteils der Parameter",
                  "nl": "Grote voorgetrainde modellen aanpassen aan nieuwe taken door slechts een kleine fractie van parameters te trainen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combine neural generation with retrieved external knowledge to improve factuality and reduce hallucinations",
                  "es": "Combinar generación neuronal con conocimiento externo recuperado para mejorar factualidad y reducir alucinaciones",
                  "de": "Neuronale Generierung mit abgerufenem externen Wissen kombinieren um Faktizität zu verbessern und Halluzinationen zu reduzieren",
                  "nl": "Neurale generatie combineren met opgehaalde externe kennis om feitelijkheid te verbeteren en hallucinaties te verminderen"
        },
        {
                  "en": "Generate synthetic training data through retrieval methods",
                  "es": "Generar datos de entrenamiento sintéticos a través de métodos de recuperación",
                  "de": "Synthetische Trainingsdaten durch Abrufmethoden generieren",
                  "nl": "Synthetische trainingsdata genereren via ophaalmethoden"
        },
        {
                  "en": "Retrieve and reuse previously generated outputs",
                  "es": "Recuperar y reutilizar salidas previamente generadas",
                  "de": "Zuvor generierte Ausgaben abrufen und wiederverwenden",
                  "nl": "Eerder gegenereerde outputs ophalen en hergebruiken"
        },
        {
                  "en": "Augment model capacity by retrieving additional parameters",
                  "es": "Aumentar capacidad del modelo recuperando parámetros adicionales",
                  "de": "Modellkapazität durch Abruf zusätzlicher Parameter erweitern",
                  "nl": "Modelcapaciteit vergroten door extra parameters op te halen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Create fundamental rights for AI systems",
                  "es": "Crear derechos fundamentales para sistemas de IA",
                  "de": "Grundrechte für KI-Systeme schaffen",
                  "nl": "Fundamentele rechten creëren voor AI-systemen"
        },
        {
                  "en": "Build AI governance structures like democratic constitutions",
                  "es": "Construir estructuras de gobernanza de IA como constituciones democráticas",
                  "de": "KI-Governance-Strukturen wie demokratische Verfassungen aufbauen",
                  "nl": "AI-governance structuren bouwen zoals democratische grondwetten"
        },
        {
                  "en": "Ensure AI systems follow constitutional law and regulations",
                  "es": "Asegurar que sistemas de IA sigan ley constitucional y regulaciones",
                  "de": "Sicherstellen dass KI-Systeme Verfassungsrecht und Vorschriften folgen",
                  "nl": "Ervoor zorgen dat AI-systemen grondwettelijk recht en regels volgen"
        },
        {
                  "en": "Train AI systems to be helpful, harmless, and honest using self-improvement guided by principles",
                  "es": "Entrenar sistemas de IA para ser útiles, inofensivos y honestos usando auto-mejora guiada por principios",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Engineer better prompts for human-computer interaction",
                  "es": "Ingeniar mejores prompts para interacción humano-computadora",
                  "de": "Bessere Prompts für Mensch-Computer-Interaktion entwickeln",
                  "nl": "Betere prompts ontwerpen voor mens-computer interactie"
        },
        {
                  "en": "Create prompts that train models more efficiently",
                  "es": "Crear prompts que entrenan modelos más eficientemente",
                  "de": "Prompts erstellen die Modelle effizienter trainieren",
                  "nl": "Prompts creëren die modellen efficiënter trainen"
        },
        {
                  "en": "Learn optimal prompting strategies through reinforcement learning",
                  "es": "Aprender estrategias de prompting óptimas a través de aprendizaje por refuerzo",
                  "de": "Optimale Prompting-Strategien durch Verstärkungslernen lernen",
                  "nl": "Optimale prompting-strategieën leren via reinforcement learning"
        },
        {
                  "en": "Guide model behavior through carefully designed input examples without changing model weights",
                  "es": "Guiar comportamiento del modelo a través de ejemplos de entrada cuidadosamente diseñados sin cambiar pesos del modelo",
                  "de": "Modellverhalten durch sorgfältig entworfene Eingabebeispiele leiten ohne Modellgewichte zu ändern",
                  "nl": "Modelgedrag sturen door zorgvuldig ontworpen invoervoorbeelden zonder modelgewichten te veranderen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Create ensemble predictions by mixing model outputs",
                  "es": "Crear predicciones de ensamble mezclando salidas de modelos",
                  "de": "Ensemble-Vorhersagen durch Mischen von Modellausgaben erstellen",
                  "nl": "Ensemble-voorspellingen creëren door model-outputs te mixen"
        },
        {
                  "en": "Averaging weights from multiple trained models often improves performance without additional training",
                  "es": "Promediar pesos de múltiples modelos entrenados a menudo mejora rendimiento sin entrenamiento adicional",
                  "de": "Gewichte von mehreren trainierten Modellen mitteln verbessert oft Leistung ohne zusätzliches Training",
                  "nl": "Gewichten middelen van meerdere getrainde modellen verbetert vaak prestaties zonder extra training"
        },
        {
                  "en": "Merge different architectures into hybrid models",
                  "es": "Fusionar diferentes arquitecturas en modelos híbridos",
                  "de": "Verschiedene Architekturen in Hybridmodelle verschmelzen",
                  "nl": "Verschillende architecturen samenvoegen tot hybride modellen"
        },
        {
                  "en": "Combine training datasets from multiple sources",
                  "es": "Combinar conjuntos de datos de entrenamiento de múltiples fuentes",
                  "de": "Trainingsdatensätze von mehreren Quellen kombinieren",
                  "nl": "Trainingsdatasets van meerdere bronnen combineren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Build mechanical systems that interpret neural network outputs",
                  "es": "Construir sistemas mecánicos que interpreten salidas de redes neuronales",
                  "de": "Mechanische Systeme bauen die neuronale Netzwerkausgaben interpretieren",
                  "nl": "Mechanische systemen bouwen die neurale netwerkoutputs interpreteren"
        },
        {
                  "en": "Develop mechanical analogies for neural network behavior",
                  "es": "Desarrollar analogías mecánicas para comportamiento de redes neuronales",
                  "de": "Mechanische Analogien für neuronales Netzwerkverhalten entwickeln",
                  "nl": "Mechanische analogieën ontwikkelen voor neuraal netwerkgedrag"
        },
        {
                  "en": "Create interpretable mechanisms for model training",
                  "es": "Crear mecanismos interpretables para entrenamiento de modelos",
                  "de": "Interpretierbare Mechanismen für Modelltraining erstellen",
                  "nl": "Interpreteerbare mechanismen creëren voor modeltraining"
        },
        {
                  "en": "Reverse-engineer neural networks to understand the algorithms and circuits they learn",
                  "es": "Realizar ingeniería inversa de redes neuronales para entender los algoritmos y circuitos que aprenden",
                  "de": "Neuronale Netzwerke zurück-entwickeln um die Algorithmen und Schaltungen die sie lernen zu verstehen",
                  "nl": "Neurale netwerken reverse-engineeren om de algoritmen en circuits die ze leren te begrijpen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Create sparse network architectures for efficient inference",
                  "es": "Crear arquitecturas de red dispersas para inferencia eficiente",
                  "de": "Spärliche Netzwerkarchitekturen für effiziente Inferenz erstellen",
                  "nl": "Schaarse netwerkarchitecturen creëren voor efficiënte inferentie"
        },
        {
                  "en": "Automatically encode data with minimal redundancy",
                  "es": "Codificar datos automáticamente con mínima redundancia",
                  "de": "Daten automatisch mit minimaler Redundanz kodieren",
                  "nl": "Data automatisch coderen met minimale redundantie"
        },
        {
                  "en": "Compress neural network representations with minimal information loss",
                  "es": "Comprimir representaciones de redes neuronales con mínima pérdida de información",
                  "de": "Neuronale Netzwerkrepräsentationen mit minimalem Informationsverlust komprimieren",
                  "nl": "Neurale netwerkrepresentaties comprimeren met minimaal informatieverlies"
        },
        {
                  "en": "Decompose superposed neural activations into interpretable monosemantic features",
                  "es": "Descomponer activaciones neuronales superpuestas en características monosemánticas interpretables",
                  "de": "Überlagerte neuronale Aktivierungen in interpretierbare monosemantische Features zerlegen",
                  "nl": "Gesuperponeerde neurale activeringen ontleden in interpreteerbare monosemantische features"
        }
        ],
        correct: 3,
        explanation: {
