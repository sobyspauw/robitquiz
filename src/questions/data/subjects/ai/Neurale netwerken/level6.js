// Neurale netwerken Quiz - Level 6
(function() {
  const level6 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  ...
                  "de": "Sprungverbindungen die Gradienten direkt zu früheren Schichten fließen lassen",
                  "nl": "Skip-verbindingen die gradiënten direct naar eerdere lagen laten stromen"
        },
        {
                  "en": "Adding dropout layers for regularization",
                  "es": "Agregar capas de dropout para regularización",
                  "de": "Hinzufügen von Dropout-Schichten zur Regularisierung",
                  "nl": "Het toevoegen van dropout-lagen voor regularisatie"
        },
        {
                  "en": "Using convolutional layers instead of fully connected layers",
                  "es": "Usar capas convolucionales en lugar de capas completamente conectadas",
                  "de": "Verwendung von Faltungsschichten anstelle von vollständig verbundenen Schichten",
                  "nl": "Het gebruik van convolutionele lagen in plaats van volledig verbonden lagen"
        },
        {
                  "en": "Using batch normalization between layers",
                  "es": "Usar normalización por lotes entre capas",
                  "de": "Verwendung von Batch-Normalisierung zwischen Schichten",
                  "nl": "Het gebruik van batch-normalisatie tussen lagen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All layers use dense (fully connected) connections",
                  "es": "Todas las capas usan conexiones densas (completamente conectadas)",
                  "de": "Alle Schichten verwenden dichte (vollständig verbundene) Verbindungen",
                  "nl": "Alle lagen gebruiken dichte (volledig verbonden) verbindingen"
        },
        {
                  "en": "Layers have more neurons than traditional networks",
                  "es": "Las capas tienen más neuronas que las redes tradicionales",
                  "de": "Schichten haben mehr Neuronen als traditionelle Netzwerke",
                  "nl": "Lagen hebben meer neuronen dan traditionele netwerken"
        },
        {
                  "en": "The network has a very deep architecture with many layers",
                  "es": "La red tiene una arquitectura muy profunda con muchas capas",
                  "de": "Das Netzwerk hat eine sehr tiefe Architektur mit vielen Schichten",
                  "nl": "Het netwerk heeft een zeer diepe architectuur met veel lagen"
        },
        {
                  "en": "Each layer connects to every other layer in a feed-forward fashion",
                  "es": "Cada capa se conecta a todas las demás capas de manera feed-forward",
                  "de": "Jede Schicht verbindet sich mit jeder anderen Schicht in einer Vorwärts-Weise",
                  "nl": "Elke laag verbindt zich met elke andere laag op een feed-forward manier"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To increase the depth of the network",
                  "es": "Aumentar la profundidad de la red",
                  "de": "Die Tiefe des Netzwerks zu erhöhen",
                  "nl": "De diepte van het netwerk vergroten"
        },
        {
                  "en": "To reduce overfitting through dropout",
                  "es": "Reducir el sobreajuste mediante dropout",
                  "de": "Overfitting durch Dropout zu reduzieren",
                  "nl": "Overfitting verminderen door dropout"
        },
        {
                  "en": "To apply multiple filter sizes in parallel and concatenate results",
                  "es": "Aplicar múltiples tamaños de filtro en paralelo y concatenar resultados",
                  "de": "Mehrere Filtergrößen parallel anzuwenden und Ergebnisse zu verketten",
                  "nl": "Meerdere filtergroottes parallel toepassen en resultaten samenvoegen"
        },
        {
                  "en": "To normalize inputs between layers",
                  "es": "Normalizar las entradas entre capas",
                  "de": "Eingaben zwischen Schichten zu normalisieren",
                  "nl": "Invoer tussen lagen normaliseren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dimensionality reduction and feature map transformation",
                  "es": "Reducción de dimensionalidad y transformación de mapas de características",
                  "de": "Dimensionalitätsreduktion und Feature-Map-Transformation",
                  "nl": "Dimensionaliteitsreductie en feature map transformatie"
        },
        {
                  "en": "Pooling operations to reduce feature map size",
                  "es": "Operaciones de pooling para reducir el tamaño del mapa de características",
                  "de": "Pooling-Operationen zur Reduzierung der Feature-Map-Größe",
                  "nl": "Pooling-operaties om feature map grootte te verkleinen"
        },
        {
                  "en": "Spatial feature extraction like regular convolutions",
                  "es": "Extracción de características espaciales como convoluciones regulares",
                  "de": "Räumliche Feature-Extraktion wie reguläre Faltungen",
                  "nl": "Ruimtelijke feature-extractie zoals reguliere convoluties"
        },
        {
                  "en": "Adding non-linearity without changing spatial dimensions",
                  "es": "Agregar no linealidad sin cambiar las dimensiones espaciales",
                  "de": "Nicht-Linearität hinzufügen ohne räumliche Dimensionen zu ändern",
                  "nl": "Non-lineariteit toevoegen zonder ruimtelijke dimensies te veranderen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "More dense connections between layers",
                  "es": "Más conexiones densas entre capas",
                  "de": "Mehr dichte Verbindungen zwischen Schichten",
                  "nl": "Meer dichte verbindingen tussen lagen"
        },
        {
                  "en": "Use of depthwise separable convolutions for efficiency",
                  "es": "Uso de convoluciones separables en profundidad para eficiencia",
                  "de": "Verwendung von tiefentrennbaren Faltungen für Effizienz",
                  "nl": "Gebruik van diepte-scheidbare convoluties voor efficiëntie"
        },
        {
                  "en": "Deeper networks with more layers",
                  "es": "Redes más profundas con más capas",
                  "de": "Tiefere Netzwerke mit mehr Schichten",
                  "nl": "Diepere netwerken met meer lagen"
        },
        {
                  "en": "Larger filter sizes for better feature extraction",
                  "es": "Tamaños de filtro más grandes para mejor extracción de características",
                  "de": "Größere Filtergrößen für bessere Feature-Extraktion",
                  "nl": "Grotere filtergroottes voor betere feature-extractie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Spatial attention to focus on important regions",
                  "es": "Atención espacial para enfocarse en regiones importantes",
                  "de": "Räumliche Aufmerksamkeit um sich auf wichtige Regionen zu konzentrieren",
                  "nl": "Ruimtelijke aandacht om te focussen op belangrijke gebieden"
        },
        {
                  "en": "Temporal attention for sequence modeling",
                  "es": "Atención temporal para modelado de secuencias",
                  "de": "Zeitliche Aufmerksamkeit für Sequenzmodellierung",
                  "nl": "Temporele aandacht voor sequentiemodellering"
        },
        {
                  "en": "Multi-head attention like in transformers",
                  "es": "Atención multi-cabeza como en transformers",
                  "de": "Multi-Head-Aufmerksamkeit wie in Transformers",
                  "nl": "Multi-head aandacht zoals in transformers"
        },
        {
                  "en": "Channel-wise attention to recalibrate feature importance",
                  "es": "Atención por canal para recalibrar la importancia de las características",
                  "de": "Kanalweise Aufmerksamkeit zur Neukalibrierung der Feature-Wichtigkeit",
                  "nl": "Kanaalgewijze aandacht om feature-belangrijkheid te herkaliberen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only increasing network depth for better performance",
                  "es": "Solo aumentar la profundidad de la red para mejor rendimiento",
                  "de": "Nur Netzwerktiefe für bessere Leistung erhöhen",
                  "nl": "Alleen netwerkdiepte verhogen voor betere prestaties"
        },
        {
                  "en": "Using wider layers with more channels",
                  "es": "Usar capas más anchas con más canales",
                  "de": "Breitere Schichten mit mehr Kanälen verwenden",
                  "nl": "Bredere lagen met meer kanalen gebruiken"
        },
        {
                  "en": "Higher input resolution without architectural changes",
                  "es": "Mayor resolución de entrada sin cambios arquitectónicos",
                  "de": "Höhere Eingabeauflösung ohne architektonische Änderungen",
                  "nl": "Hogere invoerresolutie zonder architecturale veranderingen"
        },
        {
                  "en": "Compound scaling of depth, width, and resolution simultaneously",
                  "es": "Escalado compuesto de profundidad, ancho y resolución simultáneamente",
                  "de": "Zusammengesetzte Skalierung von Tiefe, Breite und Auflösung gleichzeitig",
                  "nl": "Samengestelde schaling van diepte, breedte en resolutie tegelijkertijd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding more non-linear activations",
                  "es": "Agregar más activaciones no lineales",
                  "de": "Mehr nicht-lineare Aktivierungen hinzufügen",
                  "nl": "Meer niet-lineaire activeringen toevoegen"
        },
        {
                  "en": "Reducing computational complexity while maintaining performance",
                  "es": "Reducir la complejidad computacional mientras se mantiene el rendimiento",
                  "de": "Reduzierung der rechnerischen Komplexität bei gleichbleibender Leistung",
                  "nl": "Rekenkundige complexiteit verminderen terwijl prestaties behouden blijven"
        },
        {
                  "en": "Increasing the receptive field of the network",
                  "es": "Aumentar el campo receptivo de la red",
                  "de": "Vergrößerung des rezeptiven Feldes des Netzwerks",
                  "nl": "Het receptieve veld van het netwerk vergroten"
        },
        {
                  "en": "Improving gradient flow through the network",
                  "es": "Mejorar el flujo de gradientes a través de la red",
                  "de": "Verbesserung des Gradientenflusses durch das Netzwerk",
                  "nl": "Gradiëntenstroom door het netwerk verbeteren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Better performance with small batch sizes by normalizing within channel groups",
                  "es": "Mejor rendimiento con tamaños de lote pequeños normalizando dentro de grupos de canales",
                  "de": "Bessere Leistung bei kleinen Batch-Größen durch Normalisierung innerhalb von Kanalgruppen",
                  "nl": "Betere prestaties met kleine batch-groottes door normalisatie binnen kanaalgroepen"
        },
        {
                  "en": "Reducing overfitting in deep networks",
                  "es": "Reducir el sobreajuste en redes profundas",
                  "de": "Reduzierung von Overfitting in tiefen Netzwerken",
                  "nl": "Overfitting verminderen in diepe netwerken"
        },
        {
                  "en": "Faster training by reducing internal covariate shift",
                  "es": "Entrenamiento más rápido reduciendo el cambio de covarianza interna",
                  "de": "Schnelleres Training durch Reduzierung der internen Kovarianzverschiebung",
                  "nl": "Snellere training door vermindering van interne covariantieverschuiving"
        },
        {
                  "en": "Better generalization by adding regularization",
                  "es": "Mejor generalización agregando regularización",
                  "de": "Bessere Generalisierung durch Hinzufügen von Regularisierung",
                  "nl": "Betere generalisatie door regularisatie toe te voegen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Based on transformer architecture principles",
                  "es": "Basada en principios de arquitectura transformer",
                  "de": "Basiert auf Transformer-Architekturprinzipien",
                  "nl": "Gebaseerd op transformer-architectuurprincipes"
        },
        {
                  "en": "Uses only standard convolution and pooling layers",
                  "es": "Usa solo capas de convolución y pooling estándar",
                  "de": "Verwendet nur Standard-Faltungs- und Pooling-Schichten",
                  "nl": "Gebruikt alleen standaard convolutie- en pooling-lagen"
        },
        {
                  "en": "Optimized specifically for image classification tasks",
                  "es": "Optimizada específicamente para tareas de clasificación de imágenes",
                  "de": "Speziell für Bildklassifizierungsaufgaben optimiert",
                  "nl": "Specifiek geoptimaliseerd voor beeldclassificatietaken"
        },
        {
                  "en": "Architecture discovered through automated search algorithms",
                  "es": "Arquitectura descubierta a través de algoritmos de búsqueda automatizada",
                  "de": "Architektur entdeckt durch automatisierte Suchalgorithmen",
                  "nl": "Architectuur ontdekt door geautomatiseerde zoekalgoritmen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learnable gating mechanisms to control information flow",
                  "es": "Mecanismos de compuerta aprendibles para controlar el flujo de información",
                  "de": "Lernbare Gating-Mechanismen zur Steuerung des Informationsflusses",
                  "nl": "Leerbare poortvormingsmechanismen om informatiestroom te controleren"
        },
        {
                  "en": "Adaptive pooling operations",
                  "es": "Operaciones de pooling adaptativo",
                  "de": "Adaptive Pooling-Operationen",
                  "nl": "Adaptieve pooling-operaties"
        },
        {
                  "en": "Dynamic filter generation",
                  "es": "Generación de filtros dinámicos",
                  "de": "Dynamische Filter-Generierung",
                  "nl": "Dynamische filtergeneratie"
        },
        {
                  "en": "Multiple parallel pathways for feature extraction",
                  "es": "Múltiples vías paralelas para extracción de características",
                  "de": "Mehrere parallele Pfade für Feature-Extraktion",
                  "nl": "Meerdere parallelle paden voor feature-extractie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Knowledge distillation from larger models",
                  "es": "Destilación de conocimiento de modelos más grandes",
                  "de": "Wissensdestillation von größeren Modellen",
                  "nl": "Kennisdistillatie van grotere modellen"
        },
        {
                  "en": "Depthwise separable convolutions",
                  "es": "Convoluciones separables en profundidad",
                  "de": "Tiefentrennbare Faltungen",
                  "nl": "Diepte-scheidbare convoluties"
        },
        {
                  "en": "Channel shuffle operations with group convolutions",
                  "es": "Operaciones de mezcla de canales con convoluciones de grupo",
                  "de": "Kanal-Shuffle-Operationen mit Gruppenfaltungen",
                  "nl": "Kanaal-shuffle operaties met groepsconvoluties"
        },
        {
                  "en": "Pruning of redundant connections",
                  "es": "Poda de conexiones redundantes",
                  "de": "Beschneidung redundanter Verbindungen",
                  "nl": "Snoeien van redundante verbindingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Combinar características multi-escala a través de conexiones descendentes y laterales",
                  "de": "Kombination von Multi-Skala-Features durch Top-Down- und Lateral-Verbindungen",
                  "nl": "Multi-schaal features combineren via top-down en laterale verbindingen"
        },
        {
                  "en": "Progressive feature refinement through multiple stages",
                  "es": "Refinamiento progresivo de características a través de múltiples etapas",
                  "de": "Progressive Feature-Verfeinerung durch mehrere Stufen",
                  "nl": "Progressieve feature-verfijning door meerdere stadia"
        },
        {
                  "en": "Using pyramid pooling for feature extraction",
                  "es": "Usar pooling piramidal para extracción de características",
                  "de": "Verwendung von Pyramiden-Pooling für Feature-Extraktion",
                  "nl": "Pyramid pooling gebruiken voor feature-extractie"
        },
        {
                  "en": "Stacking multiple networks of different sizes",
                  "es": "Apilar múltiples redes de diferentes tamaños",
                  "de": "Stapeln mehrerer Netzwerke verschiedener Größen",
                  "nl": "Meerdere netwerken van verschillende groottes stapelen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Implements extreme inception with many parallel branches",
                  "es": "Implementa inception extremo con muchas ramas paralelas",
                  "de": "Implementiert extreme Inception mit vielen parallelen Zweigen",
                  "nl": "Implementeert extreme inception met veel parallelle takken"
        },
        {
                  "en": "Replaces Inception modules with depthwise separable convolutions",
                  "es": "Reemplaza módulos Inception con convoluciones separables en profundidad",
                  "de": "Ersetzt Inception-Module durch tiefentrennbare Faltungen",
                  "nl": "Vervangt Inception-modules door diepte-scheidbare convoluties"
        },
        {
                  "en": "Uses only 1x1 convolutions throughout the network",
                  "es": "Usa solo convoluciones 1x1 en toda la red",
                  "de": "Verwendet nur 1x1-Faltungen im gesamten Netzwerk",
                  "nl": "Gebruikt alleen 1x1 convoluties door het hele netwerk"
        },
        {
                  "en": "Adds residual connections to inception modules",
                  "es": "Agrega conexiones residuales a módulos inception",
                  "de": "Fügt residuale Verbindungen zu Inception-Modulen hinzu",
                  "nl": "Voegt residuele verbindingen toe aan inception-modules"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Remove ghost gradients during backpropagation",
                  "es": "Eliminar gradientes fantasma durante la retropropagación",
                  "de": "Ghost-Gradienten während der Rückpropagation entfernen",
                  "nl": "Ghost-gradiënten verwijderen tijdens backpropagation"
        },
        {
                  "en": "Create phantom connections between layers",
                  "es": "Crear conexiones fantasma entre capas",
                  "de": "Phantom-Verbindungen zwischen Schichten erstellen",
                  "nl": "Fantoomverbindingen tussen lagen creëren"
        },
        {
                  "en": "Generate redundant feature maps using cheap linear operations",
                  "es": "Generar mapas de características redundantes usando operaciones lineales baratas",
                  "de": "Redundante Feature-Maps mit günstigen linearen Operationen generieren",
                  "nl": "Redundante feature maps genereren met goedkope lineaire operaties"
        },
        {
                  "en": "Implement spectral normalization for stability",
                  "es": "Implementar normalización espectral para estabilidad",
                  "de": "Spektrale Normalisierung für Stabilität implementieren",
                  "nl": "Spectrale normalisatie implementeren voor stabiliteit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Progressive feature selection and elimination",
                  "es": "Selección y eliminación progresiva de características",
                  "de": "Progressive Feature-Auswahl und -Elimination",
                  "nl": "Progressieve feature-selectie en eliminatie"
        },
        {
                  "en": "Gradually increasing batch size during training",
                  "es": "Aumentar gradualmente el tamaño del lote durante el entrenamiento",
                  "de": "Schrittweise Erhöhung der Batch-Größe während des Trainings",
                  "nl": "Geleidelijk verhogen van batch-grootte tijdens training"
        },
        {
                  "en": "Progressive pruning of network connections",
                  "es": "Poda progresiva de conexiones de red",
                  "de": "Progressive Beschneidung von Netzwerkverbindungen",
                  "nl": "Progressief snoeien van netwerkverbindingen"
        },
        {
                  "en": "Gradually increasing image resolution during training",
                  "es": "Aumentar gradualmente la resolución de imagen durante el entrenamiento",
                  "de": "Schrittweise Erhöhung der Bildauflösung während des Trainings",
                  "nl": "Geleidelijk verhogen van beeldresolutie tijdens training"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Encoding spatial relationships and part-whole hierarchies explicitly",
                  "es": "Codificar relaciones espaciales y jerarquías parte-todo explícitamente",
                  "de": "Explizite Kodierung räumlicher Beziehungen und Teil-Ganzes-Hierarchien",
                  "nl": "Ruimtelijke relaties en deel-geheel hiërarchieën expliciet coderen"
        },
        {
                  "en": "Implementing deeper architectures with more layers",
                  "es": "Implementar arquitecturas más profundas con más capas",
                  "de": "Implementierung tieferer Architekturen mit mehr Schichten",
                  "nl": "Diepere architecturen implementeren met meer lagen"
        },
        {
                  "en": "Adding attention mechanisms to focus on important features",
                  "es": "Agregar mecanismos de atención para enfocarse en características importantes",
                  "de": "Hinzufügen von Aufmerksamkeitsmechanismen zur Fokussierung auf wichtige Features",
                  "nl": "Aandachtsmechanismen toevoegen om te focussen op belangrijke features"
        },
        {
                  "en": "Using larger convolutional filters for better feature extraction",
                  "es": "Usar filtros convolucionales más grandes para mejor extracción de características",
                  "de": "Verwendung größerer Faltungsfilter für bessere Feature-Extraktion",
                  "nl": "Grotere convolutiefilters gebruiken voor betere feature-extractie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Varying width throughout the network",
                  "es": "Ancho variable a través de la red",
                  "de": "Variierende Breite durch das Netzwerk",
                  "nl": "Variërende breedte door het netwerk"
        },
        {
                  "en": "Multiple parallel branches of different widths",
                  "es": "Múltiples ramas paralelas de diferentes anchos",
                  "de": "Mehrere parallele Zweige verschiedener Breiten",
                  "nl": "Meerdere parallelle takken van verschillende breedtes"
        },
        {
                  "en": "More layers with standard width",
                  "es": "Más capas con ancho estándar",
                  "de": "Mehr Schichten mit Standardbreite",
                  "nl": "Meer lagen met standaardbreedte"
        },
        {
                  "en": "Fewer layers but wider (more channels per layer)",
                  "es": "Menos capas pero más anchas (más canales por capa)",
                  "de": "Weniger Schichten aber breiter (mehr Kanäle pro Schicht)",
                  "nl": "Minder lagen maar breder (meer kanalen per laag)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using pyramid-shaped filters in convolutions",
                  "es": "Usar filtros en forma de pirámide en convoluciones",
                  "de": "Verwendung pyramidenförmiger Filter in Faltungen",
                  "nl": "Pyramid-vormige filters gebruiken in convoluties"
        },
        {
                  "en": "Gradually increasing channel dimensions throughout the network",
                  "es": "Aumentar gradualmente las dimensiones de canal a lo largo de la red",
                  "de": "Schrittweise Erhöhung der Kanaldimensionen durch das Netzwerk",
                  "nl": "Geleidelijk verhogen van kanaaldimensies door het netwerk"
        },
        {
                  "en": "Implementing hierarchical feature extraction",
                  "es": "Implementar extracción de características jerárquicas",
                  "de": "Implementierung hierarchischer Feature-Extraktion",
                  "nl": "Hiërarchische feature-extractie implementeren"
        },
        {
                  "en": "Stacking multiple resolution pyramids",
                  "es": "Apilar múltiples pirámides de resolución",
                  "de": "Stapeln mehrerer Auflösungspyramiden",
                  "nl": "Meerdere resolutie-pyramides stapelen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Designing network architectures based on empirical scaling rules and design space optimization",
                  "es": "Diseñar arquitecturas de red basadas en reglas de escalado empíricas y optimización del espacio de diseño",
                  "de": "Entwurf von Netzwerkarchitekturen basierend auf empirischen Skalierungsregeln und Design-Raum-Optimierung",
                  "nl": "Netwerkarchitecturen ontwerpen gebaseerd op empirische schalingsregels en ontwerpruimte-optimalisatie"
        },
        {
                  "en": "Creating networks with perfectly regular layer patterns",
                  "es": "Crear redes con patrones de capa perfectamente regulares",
                  "de": "Erstellung von Netzwerken mit perfekt regelmäßigen Schichtmustern",
                  "nl": "Netwerken creëren met perfect reguliere laagpatronen"
        },
        {
                  "en": "Using regular grid patterns for convolutional filters",
                  "es": "Usar patrones de cuadrícula regulares para filtros convolucionales",
                  "de": "Verwendung regelmäßiger Gittermuster für Faltungsfilter",
                  "nl": "Reguliere rasterpatronen gebruiken voor convolutiefilters"
        },
        {
                  "en": "Implementing strict regularization techniques throughout training",
                  "es": "Implementar técnicas de regularización estrictas durante todo el entrenamiento",
                  "de": "Implementierung strenger Regularisierungstechniken während des gesamten Trainings",
                  "nl": "Strikte regularisatietechnieken implementeren gedurende de training"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding next-generation skip connections",
                  "es": "Agregar conexiones de salto de próxima generación",
                  "de": "Next-Generation Skip-Verbindungen hinzufügen",
                  "nl": "Volgende generatie skip-verbindingen toevoegen"
        },
        {
                  "en": "Making ResNet even deeper with more layers",
                  "es": "Hacer ResNet aún más profunda con más capas",
                  "de": "ResNet noch tiefer machen mit mehr Schichten",
                  "nl": "ResNet nog dieper maken met meer lagen"
        },
        {
                  "en": "Extending ResNet with attention mechanisms",
                  "es": "Extender ResNet con mecanismos de atención",
                  "de": "ResNet mit Aufmerksamkeitsmechanismen erweitern",
                  "nl": "ResNet uitbreiden met aandachtmechanismen"
        },
        {
                  "en": "Aggregating transformations through multiple parallel pathways with the same topology",
                  "es": "Agregar transformaciones a través de múltiples vías paralelas con la misma topología",
                  "de": "Aggregierung von Transformationen durch mehrere parallele Pfade mit gleicher Topologie",
                  "nl": "Transformaties aggregeren via meerdere parallelle paden met dezelfde topologie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uses two separate networks for different tasks",
                  "es": "Usa dos redes separadas para diferentes tareas",
                  "de": "Verwendet zwei separate Netzwerke für verschiedene Aufgaben",
                  "nl": "Gebruikt twee aparte netwerken voor verschillende taken"
        },
        {
                  "en": "Implements bidirectional information flow",
                  "es": "Implementa flujo de información bidireccional",
                  "de": "Implementiert bidirektionalen Informationsfluss",
                  "nl": "Implementeert bidirectionele informatiestroom"
        },
        {
                  "en": "Combines ResNet's residual learning with DenseNet's dense connectivity in a unified framework",
                  "es": "Combina el aprendizaje residual de ResNet con la conectividad densa de DenseNet en un marco unificado",
                  "de": "Kombiniert ResNets residuales Lernen mit DenseNets dichter Konnektivität in einem einheitlichen Framework",
                  "nl": "Combineert ResNet's residueel leren met DenseNet's dichte connectiviteit in een uniform framework"
        },
        {
                  "en": "Creates dual pathways for training and inference",
                  "es": "Crea vías duales para entrenamiento e inferencia",
                  "de": "Erstellt duale Pfade für Training und Inferenz",
                  "nl": "Creëert dubbele paden voor training en inferentie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Knowledge distillation from larger networks",
                  "es": "Destilación de conocimiento de redes más grandes",
                  "de": "Wissensdestillation von größeren Netzwerken",
                  "nl": "Kennisdistillatie van grotere netwerken"
        },
        {
                  "en": "Fire modules that squeeze with 1x1 filters then expand with mixed 1x1 and 3x3 filters",
                  "es": "Módulos Fire que comprimen con filtros 1x1 y luego expanden con filtros mixtos 1x1 y 3x3",
                  "de": "Fire-Module die mit 1x1-Filtern komprimieren dann mit gemischten 1x1- und 3x3-Filtern erweitern",
                  "nl": "Fire modules die samenpersen met 1x1 filters en dan uitbreiden met gemengde 1x1 en 3x3 filters"
        },
        {
                  "en": "Aggressive pruning of network connections",
                  "es": "Poda agresiva de conexiones de red",
                  "de": "Aggressive Beschneidung von Netzwerkverbindungen",
                  "nl": "Agressief snoeien van netwerkverbindingen"
        },
        {
                  "en": "Quantization of all network weights",
                  "es": "Cuantización de todos los pesos de la red",
                  "de": "Quantisierung aller Netzwerkgewichte",
                  "nl": "Quantisatie van alle netwerkgewichten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Weaving multiple neural networks together",
                  "es": "Tejer múltiples redes neuronales juntas",
                  "de": "Weben mehrerer neuronaler Netzwerke zusammen",
                  "nl": "Meerdere neurale netwerken samenweven"
        },
        {
                  "en": "A trellis of interconnected layers allowing multiple path selections through the network",
                  "es": "Un enrejado de capas interconectadas que permite múltiples selecciones de ruta a través de la red",
                  "de": "Ein Gitter vernetzter Schichten das mehrere Pfadauswahlen durch das Netzwerk ermöglicht",
                  "nl": "Een trellis van onderling verbonden lagen die meerdere padselecties door het netwerk mogelijk maakt"
        },
        {
                  "en": "Using textile-inspired convolution patterns",
                  "es": "Usar patrones de convolución inspirados en textiles",
                  "de": "Verwendung textilinspi rierter Faltungsmuster",
                  "nl": "Textiel-geïnspireerde convolutiepatronen gebruiken"
        },
        {
                  "en": "Creating flexible network architectures through fabric-like connections",
                  "es": "Crear arquitecturas de red flexibles a través de conexiones tipo tela",
                  "de": "Erstellung flexibler Netzwerkarchitekturen durch stoffartige Verbindungen",
                  "nl": "Flexibele netwerkarchitecturen creëren via stofachtige verbindingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Applying temporal transformers to video frames",
                  "es": "Aplicar transformers temporales a fotogramas de video",
                  "de": "Anwendung zeitlicher Transformer auf Video-Frames",
                  "nl": "Temporele transformers toepassen op videoframes"
        },
        {
                  "en": "Treating image patches as sequences and applying transformer architecture directly to them",
                  "es": "Tratar parches de imagen como secuencias y aplicar arquitectura transformer directamente a ellos",
                  "de": "Behandeln von Bild-Patches als Sequenzen und direktes Anwenden der Transformer-Architektur darauf",
                  "nl": "Beeldpatches behandelen als sequenties en transformer-architectuur er direct op toepassen"
        },
        {
                  "en": "Using transformers only for the classification head",
                  "es": "Usar transformers solo para la cabeza de clasificación",
                  "de": "Verwendung von Transformers nur für den Klassifikationskopf",
                  "nl": "Transformers alleen gebruiken voor de classificatiekop"
        },
        {
                  "en": "Combining transformers with convolutional layers",
                  "es": "Combinar transformers con capas convolucionales",
                  "de": "Kombinieren von Transformers mit Faltungsschichten",
                  "nl": "Transformers combineren met convolutionele lagen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Modernizing ResNet architecture using design choices from Vision Transformers while keeping convolutions",
                  "es": "Modernizar arquitectura ResNet usando elecciones de diseño de Vision Transformers mientras se mantienen convoluciones",
                  "de": "Modernisierung der ResNet-Architektur unter Verwendung von Design-Entscheidungen aus Vision Transformers bei Beibehaltung von Faltungen",
                  "nl": "ResNet-architectuur moderniseren met ontwerpkeuzes van Vision Transformers terwijl convoluties behouden blijven"
        },
        {
                  "en": "Next-generation convolution operations",
                  "es": "Operaciones de convolución de próxima generación",
                  "de": "Next-Generation-Faltungsoperationen",
                  "nl": "Volgende generatie convolutie-operaties"
        },
        {
                  "en": "Using larger convolutional kernels throughout",
                  "es": "Usar kernels convolucionales más grandes en todas partes",
                  "de": "Verwendung größerer Faltungskerne durchweg",
                  "nl": "Grotere convolutionele kernels overal gebruiken"
        },
        {
                  "en": "Combining convolutions with attention mechanisms",
                  "es": "Combinar convoluciones con mecanismos de atención",
                  "de": "Kombinieren von Faltungen mit Aufmerksamkeitsmechanismen",
                  "nl": "Convoluties combineren met aandachtmechanismen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining standard and dilated convolutions",
                  "es": "Combinar convoluciones estándar y dilatadas",
                  "de": "Kombinieren von Standard- und dilatierten Faltungen",
                  "nl": "Standaard en gedilateerde convoluties combineren"
        },
        {
                  "en": "Alternating between different convolution strategies",
                  "es": "Alternar entre diferentes estrategias de convolución",
                  "de": "Alternieren zwischen verschiedenen Faltungsstrategien",
                  "nl": "Afwisselen tussen verschillende convolutiestrategieën"
        },
        {
                  "en": "Using multiple kernel sizes within a single depthwise convolution layer",
                  "es": "Usar múltiples tamaños de kernel dentro de una sola capa de convolución depthwise",
                  "de": "Verwendung mehrerer Kernel-Größen innerhalb einer einzigen Depthwise-Faltungsschicht",
                  "nl": "Meerdere kernelgroottes gebruiken binnen een enkele depthwise convolutielaag"
        },
        {
                  "en": "Mixing different types of convolutions randomly",
                  "es": "Mezclar diferentes tipos de convoluciones aleatoriamente",
                  "de": "Zufälliges Mischen verschiedener Faltungstypen",
                  "nl": "Verschillende convolutietypes willekeurig mengen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Alternating between convolution and attention randomly",
                  "es": "Alternar entre convolución y atención aleatoriamente",
                  "de": "Zufälliges Alternieren zwischen Faltung und Aufmerksamkeit",
                  "nl": "Willekeurig afwisselen tussen convolutie en aandacht"
        },
        {
                  "en": "Strategically combining convolutional and self-attention layers to leverage strengths of both",
                  "es": "Combinar estratégicamente capas convolucionales y de auto-atención para aprovechar fortalezas de ambas",
                  "de": "Strategisches Kombinieren von Faltungs- und Selbstaufmerksamkeitsschichten um Stärken beider zu nutzen",
                  "nl": "Strategisch convolutionele en self-attention lagen combineren om sterke punten van beide te benutten"
        },
        {
                  "en": "Using attention only for coarse features",
                  "es": "Usar atención solo para características gruesas",
                  "de": "Verwendung von Aufmerksamkeit nur für grobe Features",
                  "nl": "Aandacht alleen gebruiken voor grove features"
        },
        {
                  "en": "Replacing all convolutions with attention gradually",
                  "es": "Reemplazar todas las convoluciones con atención gradualmente",
                  "de": "Allmähliches Ersetzen aller Faltungen durch Aufmerksamkeit",
                  "nl": "Alle convoluties geleidelijk vervangen door aandacht"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Removing outliers from training data",
                  "es": "Eliminar valores atípicos de datos de entrenamiento",
                  "de": "Entfernen von Ausreißern aus Trainingsdaten",
                  "nl": "Uitschieters verwijderen uit trainingsdata"
        },
        {
                  "en": "Training networks on pruned datasets",
                  "es": "Entrenar redes en conjuntos de datos podados",
                  "de": "Training von Netzwerken auf beschnittenen Datensätzen",
                  "nl": "Netwerken trainen op gesnoede datasets"
        },
        {
                  "en": "Cutting branches in decision trees",
                  "es": "Cortar ramas en árboles de decisión",
                  "de": "Schneiden von Zweigen in Entscheidungsbäumen",
                  "nl": "Takken snoeien in beslisbomen"
        },
        {
                  "en": "Removing less important weights or neurons to reduce model size while maintaining performance",
                  "es": "Eliminar pesos o neuronas menos importantes para reducir tamaño de modelo mientras mantiene rendimiento",
                  "de": "Entfernen weniger wichtiger Gewichte oder Neuronen um Modellgröße zu reduzieren bei Erhalt der Leistung",
                  "nl": "Verwijderen van minder belangrijke gewichten of neuronen om modelgrootte te reduceren terwijl prestaties behouden blijven"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Quantifying model performance metrics",
                  "es": "Cuantificar métricas de rendimiento del modelo",
                  "de": "Quantifizieren von Modell-Leistungsmetriken",
                  "nl": "Modelprestatiemetrieken kwantificeren"
        },
        {
                  "en": "Reducing precision of weights and activations from float32 to lower bit representations like int8",
                  "es": "Reducir precisión de pesos y activaciones de float32 a representaciones de bits más bajas como int8",
                  "de": "Reduzieren der Präzision von Gewichten und Aktivierungen von float32 zu niedrigeren Bit-Darstellungen wie int8",
                  "nl": "Precisie van gewichten en activaties reduceren van float32 naar lagere bit representaties zoals int8"
        },
        {
                  "en": "Converting continuous outputs to discrete classes",
                  "es": "Convertir salidas continuas a clases discretas",
                  "de": "Konvertieren kontinuierlicher Ausgaben zu diskreten Klassen",
                  "nl": "Continue uitvoer converteren naar discrete klassen"
        },
        {
                  "en": "Measuring computational requirements",
                  "es": "Medir requisitos computacionales",
                  "de": "Messen von Rechenanforderungen",
                  "nl": "Rekenvereisten meten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining predictions from multiple independently trained models to improve accuracy and robustness",
                  "es": "Combinar predicciones de múltiples modelos entrenados independientemente para mejorar precisión y robustez",
                  "de": "Kombinieren von Vorhersagen mehrerer unabhängig trainierter Modelle um Genauigkeit und Robustheit zu verbessern",
                  "nl": "Voorspellingen combineren van meerdere onafhankelijk getrainde modellen om nauwkeurigheid en robuustheid te verbeteren"
        },
        {
                  "en": "Multiple layers in a single network",
                  "es": "Múltiples capas en una sola red",
                  "de": "Mehrere Schichten in einem einzigen Netzwerk",
                  "nl": "Meerdere lagen in één netwerk"
        },
        {
                  "en": "A team of researchers working on networks",
                  "es": "Equipo de investigadores trabajando en redes",
                  "de": "Team von Forschern die an Netzwerken arbeiten",
                  "nl": "Team van onderzoekers die aan netwerken werken"
        },
        {
                  "en": "A collection of training datasets",
                  "es": "Colección de conjuntos de datos de entrenamiento",
                  "de": "Sammlung von Trainingsdatensätzen",
                  "nl": "Verzameling van trainingsdatasets"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Random initialization determines training success",
                  "es": "Inicialización aleatoria determina éxito de entrenamiento",
                  "de": "Zufällige Initialisierung bestimmt Trainingserfolg",
                  "nl": "Willekeurige initialisatie bepaalt trainingsucces"
        },
        {
                  "en": "Only a few training examples are needed",
                  "es": "Solo se necesitan unos pocos ejemplos de entrenamiento",
                  "de": "Nur wenige Trainingsbeispiele werden benötigt",
                  "nl": "Slechts enkele trainingsvoorbeelden zijn nodig"
        },
        {
                  "en": "Dense networks contain sparse subnetworks that when trained in isolation can match full network performance",
                  "es": "Redes densas contienen subredes dispersas que cuando se entrenan aisladamente pueden igualar rendimiento de red completa",
                  "de": "Dichte Netzwerke enthalten sparsame Teilnetzwerke die wenn isoliert trainiert die volle Netzwerkleistung erreichen können",
                  "nl": "Dense netwerken bevatten sparse subnetwerken die wanneer geïsoleerd getraind volledige netwerkprestaties kunnen evenaren"
        },
        {
                  "en": "Winning models are determined by chance",
                  "es": "Modelos ganadores se determinan por azar",
                  "de": "Gewinnende Modelle werden durch Zufall bestimmt",
                  "nl": "Winnende modellen worden bepaald door toeval"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating architecture documentation",
                  "es": "Crear documentación de arquitectura",
                  "de": "Erstellen von Architekturdokumentation",
                  "nl": "Architectuurdocumentatie creëren"
        },
        {
                  "en": "Simplifying network design diagrams",
                  "es": "Simplificar diagramas de diseño de red",
                  "de": "Vereinfachen von Netzwerk-Entwurfsdiagrammen",
                  "nl": "Netwerkontwerp diagrammen vereenvoudigen"
        },
        {
                  "en": "Extracting the core architecture from networks",
                  "es": "Extraer arquitectura central de redes",
                  "de": "Extrahieren der Kernarchitektur aus Netzwerken",
                  "nl": "Kernarchitectuur extraheren uit netwerken"
        },
        {
                  "en": "Using knowledge distillation to transfer learning from complex to simpler architectures",
                  "es": "Usar destilación de conocimiento para transferir aprendizaje de arquitecturas complejas a más simples",
                  "de": "Verwendung von Knowledge Distillation um Lernen von komplexen zu einfacheren Architekturen zu übertragen",
                  "nl": "Knowledge distillation gebruiken om leren over te dragen van complexe naar eenvoudigere architecturen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Umbrella term for techniques reducing model size including pruning, quantization, distillation and low-rank factorization",
                  "es": "Término general para técnicas que reducen tamaño de modelo incluyendo poda, cuantización, destilación y factorización de bajo rango",
                  "de": "Oberbegriff für Techniken zur Modellgrößenreduzierung einschließlich Pruning, Quantisierung, Destillation und Low-Rank-Faktorisierung",
                  "nl": "Overkoepelende term voor technieken die modelgrootte reduceren inclusief pruning, quantisatie, distillatie en low-rank factorisatie"
        },
        {
                  "en": "Reducing training time only",
                  "es": "Reducir solo tiempo de entrenamiento",
                  "de": "Nur Trainingszeit reduzieren",
                  "nl": "Alleen trainingstijd reduceren"
        },
        {
                  "en": "Storing models in compressed file formats",
                  "es": "Almacenar modelos en formatos de archivo comprimidos",
                  "de": "Speichern von Modellen in komprimierten Dateiformaten",
                  "nl": "Modellen opslaan in gecomprimeerde bestandsformaten"
        },
        {
                  "en": "Compressing input images before processing",
                  "es": "Comprimir imágenes de entrada antes de procesar",
                  "de": "Komprimieren von Eingabebildern vor Verarbeitung",
                  "nl": "Invoerafbeeldingen comprimeren voor verwerking"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The field of view of the camera capturing images",
                  "es": "Campo de visión de cámara que captura imágenes",
                  "de": "Sichtfeld der Kamera die Bilder aufnimmt",
                  "nl": "Gezichtsveld van camera die afbeeldingen vastlegt"
        },
        {
                  "en": "The input layer dimensions",
                  "es": "Dimensiones de capa de entrada",
                  "de": "Eingabeschicht-Dimensionen",
                  "nl": "Invoerlaag dimensies"
        },
        {
                  "en": "The region in the input image that influences a particular neuron's activation in deeper layers",
                  "es": "Región en imagen de entrada que influye en activación de neurona particular en capas más profundas",
                  "de": "Region im Eingabebild die Aktivierung eines bestimmten Neurons in tieferen Schichten beeinflusst",
                  "nl": "Regio in invoerafbeelding die activatie van bepaald neuron in diepere lagen beïnvloedt"
        },
        {
                  "en": "The area where neurons receive signals",
                  "es": "Área donde neuronas reciben señales",
                  "de": "Bereich wo Neuronen Signale empfangen",
                  "nl": "Gebied waar neuronen signalen ontvangen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Visualizing the input dataset",
                  "es": "Visualizar conjunto de datos de entrada",
                  "de": "Visualisieren des Eingabedatensatzes",
                  "nl": "Invoerdataset visualiseren"
        },
        {
                  "en": "Techniques to understand what patterns or features neurons have learned to detect",
                  "es": "Técnicas para entender qué patrones o características neuronas han aprendido a detectar",
                  "de": "Techniken um zu verstehen welche Muster oder Features Neuronen gelernt haben zu erkennen",
                  "nl": "Technieken om te begrijpen welke patronen of features neuronen geleerd hebben te detecteren"
        },
        {
                  "en": "Plotting training curves and metrics",
                  "es": "Trazar curvas y métricas de entrenamiento",
                  "de": "Plotten von Trainingskurven und Metriken",
                  "nl": "Training curves en metrieken plotten"
        },
        {
                  "en": "Displaying network architecture diagrams",
                  "es": "Mostrar diagramas de arquitectura de red",
                  "de": "Anzeigen von Netzwerkarchitektur-Diagrammen",
                  "nl": "Netwerkarchitectuur diagrammen weergeven"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mapping class labels to activation functions",
                  "es": "Mapear etiquetas de clase a funciones de activación",
                  "de": "Zuordnen von Klassenbezeichnungen zu Aktivierungsfunktionen",
                  "nl": "Klasselabels mappen naar activatiefuncties"
        },
        {
                  "en": "Visualization technique showing which image regions contributed most to a classification decision",
                  "es": "Técnica de visualización que muestra qué regiones de imagen contribuyeron más a decisión de clasificación",
                  "de": "Visualisierungstechnik die zeigt welche Bildbereiche am meisten zu Klassifikationsentscheidung beitrugen",
                  "nl": "Visualisatietechniek die toont welke afbeeldingsregio's het meest bijdroegen aan classificatiebeslissing"
        },
        {
                  "en": "Creating activation heatmaps for all layers",
                  "es": "Crear mapas de calor de activación para todas las capas",
                  "de": "Erstellen von Aktivierungs-Heatmaps für alle Schichten",
                  "nl": "Activatie heatmaps maken voor alle lagen"
        },
        {
                  "en": "Categorizing different activation patterns",
                  "es": "Categorizar diferentes patrones de activación",
                  "de": "Kategorisieren verschiedener Aktivierungsmuster",
                  "nl": "Verschillende activatiepatronen categoriseren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training networks on adversarial examples to improve robustness against adversarial attacks",
                  "es": "Entrenar redes en ejemplos adversariales para mejorar robustez contra ataques adversariales",
                  "de": "Training von Netzwerken auf adversarialen Beispielen um Robustheit gegen adversariale Angriffe zu verbessern",
                  "nl": "Netwerken trainen op adversarial voorbeelden om robuustheid tegen adversarial aanvallen te verbeteren"
        },
        {
                  "en": "Training in adversarial conditions",
                  "es": "Entrenar en condiciones adversas",
                  "de": "Training unter widrigen Bedingungen",
                  "nl": "Trainen onder vijandige omstandigheden"
        },
        {
                  "en": "Training two networks to compete against each other",
                  "es": "Entrenar dos redes para competir entre sí",
                  "de": "Training von zwei Netzwerken um gegeneinander zu konkurrieren",
                  "nl": "Twee netwerken trainen om tegen elkaar te concurreren"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "High-level abstraction of learning",
                  "es": "Abstracción de alto nivel de aprendizaje",
                  "de": "Hochstufige Abstraktion von Lernen",
                  "nl": "Hoog-niveau abstractie van leren"
        },
        {
                  "en": "Learning how to learn - training models to quickly adapt to new tasks with minimal data",
                  "es": "Aprender cómo aprender - entrenar modelos para adaptarse rápidamente a nuevas tareas con datos mínimos",
                  "de": "Lernen wie man lernt - Training von Modellen um sich schnell an neue Aufgaben mit minimalen Daten anzupassen",
                  "nl": "Leren hoe te leren - modellen trainen om snel aan te passen aan nieuwe taken met minimale data"
        },
        {
                  "en": "Learning network architectures",
                  "es": "Aprender arquitecturas de red",
                  "de": "Lernen von Netzwerkarchitekturen",
                  "nl": "Netwerkarchitecturen leren"
        },
        {
                  "en": "Learning metadata about training datasets",
                  "es": "Aprender metadatos sobre conjuntos de datos de entrenamiento",
                  "de": "Lernen von Metadaten über Trainingsdatensätze",
                  "nl": "Metadata leren over trainingsdatasets"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training networks without stopping",
                  "es": "Entrenar redes sin detenerse",
                  "de": "Training von Netzwerken ohne Unterbrechung",
                  "nl": "Netwerken trainen zonder te stoppen"
        },
        {
                  "en": "Learning from streaming data only",
                  "es": "Aprender solo de datos de streaming",
                  "de": "Nur von Streaming-Daten lernen",
                  "nl": "Alleen leren van streaming data"
        },
        {
                  "en": "Continuous data augmentation during training",
                  "es": "Aumento de datos continuo durante entrenamiento",
                  "de": "Kontinuierliche Datenaugmentierung während Training",
                  "nl": "Continue data augmentatie tijdens training"
        },
        {
                  "en": "Training models sequentially on multiple tasks while avoiding catastrophic forgetting of previous tasks",
                  "es": "Entrenar modelos secuencialmente en múltiples tareas mientras evita olvido catastrófico de tareas previas",
                  "de": "Training von Modellen sequenziell auf mehreren Aufgaben während Vermeidung katastrophalen Vergessens vorheriger Aufgaben",
                  "nl": "Modellen sequentieel trainen op meerdere taken terwijl catastrofaal vergeten van eerdere taken vermeden wordt"
        }
        ],
        correct: 3,
        explanation: {
