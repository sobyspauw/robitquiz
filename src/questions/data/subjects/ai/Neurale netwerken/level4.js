  ...
  const level4 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "A type of RNN designed to remember information for long periods and solve the vanishing gradient problem", es: "Un tipo de RNN diseñado para recordar información durante largos períodos y resolver el problema del gradiente que se desvanece", de: "RNN-Art ausgelegt Informationen für lange Zeiträume zu speichern und Problem verschwindenden Gradienten zu lösen", nl: "Een type RNN ontworpen om informatie voor lange periodes te onthouden en het probleem van verdwijnende gradiënten op te lossen" },
      ...
      },
      {
        ...
        options: [
          { en: "A mechanism that weights features based on their importance before aggregating them", es: "Un mecanismo que pondera características basándose en su importancia antes de agregarlas", de: "Ein Mechanismus der Merkmale basierend auf ihrer Wichtigkeit gewichtet bevor sie aggregiert werden", nl: "Een mechanisme dat kenmerken weegt op basis van hun belang voordat ze worden geaggregeerd" },
          { en: "A type of max pooling layer", es: "Un tipo de capa de max pooling", de: "Eine Art Max-Pooling-Schicht", nl: "Een type max pooling laag" },
          { en: "A layer that requires user attention", es: "Una capa que requiere atención del usuario", de: "Eine Schicht die Benutzeraufmerksamkeit erfordert", nl: "Een laag die gebruikersaandacht vereist" },
          { en: "Standard average pooling", es: "Pooling promedio estándar", de: "Standard Average Pooling", nl: "Standaard average pooling" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A convolutional architecture adapted for sequence modeling using dilated causal convolutions", es: "Una arquitectura convolucional adaptada para modelado de secuencias usando convoluciones causales dilatadas", de: "Eine Faltungsarchitektur angepasst für Sequenzmodellierung unter Verwendung dilatierter kausaler Faltungen", nl: "Een convolutionele architectuur aangepast voor sequentiemodellering met gedilateerde causale convoluties" },
          { en: "A CNN that only processes time-based images", es: "Una CNN que solo procesa imágenes basadas en tiempo", de: "Ein CNN das nur zeitbasierte Bilder verarbeitet", nl: "Een CNN die alleen tijdgebaseerde afbeeldingen verwerkt" },
          { en: "A network for temporary data storage", es: "Una red para almacenamiento temporal de datos", de: "Ein Netzwerk für temporäre Datenspeicherung", nl: "Een netwerk voor tijdelijke dataopslag" },
          { en: "A standard RNN variant", es: "Una variante estándar de RNN", de: "Eine Standard-RNN-Variante", nl: "Een standaard RNN-variant" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A network with multiple specialized sub-networks where a gating mechanism selects which experts to use for each input", es: "Una red con múltiples sub-redes especializadas donde un mecanismo de compuerta selecciona qué expertos usar para cada entrada", de: "Ein Netzwerk mit mehreren spezialisierten Teilnetzwerken wo ein Gating-Mechanismus auswählt welche Experten für jede Eingabe verwendet werden", nl: "Een netwerk met meerdere gespecialiseerde sub-netwerken waarbij een gating-mechanisme selecteert welke experts te gebruiken voor elke invoer" },
          { en: "A network trained by multiple human experts", es: "Una red entrenada por múltiples expertos humanos", de: "Ein Netzwerk trainiert von mehreren menschlichen Experten", nl: "Een netwerk getraind door meerdere menselijke experts" },
          { en: "An ensemble of identical networks", es: "Un conjunto de redes idénticas", de: "Ein Ensemble identischer Netzwerke", nl: "Een ensemble van identieke netwerken" },
          { en: "A network for expert system applications", es: "Una red para aplicaciones de sistemas expertos", de: "Ein Netzwerk für Expertensystem-Anwendungen", nl: "Een netwerk voor expertsysteemtoepassingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A network that models neurons as firing discrete spikes over time, mimicking biological neurons more closely", es: "Una red que modela neuronas disparando picos discretos a lo largo del tiempo, imitando neuronas biológicas más cercanamente", de: "Ein Netzwerk das Neuronen als diskrete Spikes über Zeit feuernd modelliert, biologische Neuronen näher nachahmend", nl: "Een netwerk dat neuronen modelleert als het afvuren van discrete spikes over tijd, waarbij biologische neuronen nauwer worden nagebootst" },
          { en: "A network with sharp activation functions", es: "Una red con funciones de activación agudas", de: "Ein Netzwerk mit scharfen Aktivierungsfunktionen", nl: "Een netwerk met scherpe activatiefuncties" },
          { en: "A network designed for volleyball analysis", es: "Una red diseñada para análisis de voleibol", de: "Ein Netzwerk entworfen für Volleyball-Analyse", nl: "Een netwerk ontworpen voor volleybalanalyse" },
          { en: "A standard feedforward network", es: "Una red feedforward estándar", de: "Ein Standard-Feedforward-Netzwerk", nl: "Een standaard feedforward netwerk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A mechanism that allows the network to focus on relevant parts of input by learning importance weights", es: "Un mecanismo que permite a la red enfocarse en partes relevantes de la entrada aprendiendo pesos de importancia", de: "Ein Mechanismus der es dem Netzwerk ermöglicht sich auf relevante Teile der Eingabe zu fokussieren durch Lernen von Wichtigkeitsgewichten", nl: "Een mechanisme dat het netwerk toestaat te focussen op relevante delen van invoer door belanggewichten te leren" },
          { en: "A network that requires constant monitoring", es: "Una red que requiere monitoreo constante", de: "Ein Netzwerk das konstante Überwachung erfordert", nl: "Een netwerk dat constante monitoring vereist" },
          { en: "A network for detecting user attention", es: "Una red para detectar atención del usuario", de: "Ein Netzwerk zur Erkennung von Benutzeraufmerksamkeit", nl: "Een netwerk voor het detecteren van gebruikersaandacht" },
          { en: "A standard fully connected layer", es: "Una capa completamente conectada estándar", de: "Eine Standard vollständig verbundene Schicht", nl: "Een standaard volledig verbonden laag" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A neural network architecture with an external memory component that can be read from and written to during inference", es: "Una arquitectura de red neuronal con un componente de memoria externo del que se puede leer y escribir durante la inferencia", de: "Eine neuronale Netzwerkarchitektur mit einer externen Speicherkomponente die während der Inferenz gelesen und beschrieben werden kann", nl: "Een neurale netwerkarchitectuur met een externe geheugencomponent waarvan kan worden gelezen en geschreven tijdens inferentie" },
          { en: "A network optimized for computer memory usage", es: "Una red optimizada para uso de memoria de computadora", de: "Ein Netzwerk optimiert für Computer-Speichernutzung", nl: "Een netwerk geoptimaliseerd voor computergeheugengebruik" },
          { en: "A network that memorizes training data", es: "Una red que memoriza datos de entrenamiento", de: "Ein Netzwerk das Trainingsdaten auswendig lernt", nl: "Een netwerk dat trainingsdata memoriseert" },
          { en: "A standard LSTM network", es: "Una red LSTM estándar", de: "Ein Standard-LSTM-Netzwerk", nl: "Een standaard LSTM-netwerk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "An encoder-decoder architecture that transforms one sequence into another, often using RNNs or Transformers", es: "Una arquitectura codificador-decodificador que transforma una secuencia en otra, a menudo usando RNNs o Transformers", de: "Eine Encoder-Decoder-Architektur die eine Sequenz in eine andere transformiert, oft unter Verwendung von RNNs oder Transformers", nl: "Een encoder-decoder architectuur die één sequentie transformeert naar een andere, vaak met RNNs of Transformers" },
          { en: "A model that only processes sequences of length 2", es: "Un modelo que solo procesa secuencias de longitud 2", de: "Ein Modell das nur Sequenzen der Länge 2 verarbeitet", nl: "Een model dat alleen sequenties van lengte 2 verwerkt" },
          { en: "A simple linear sequence transformation", es: "Una transformación de secuencia lineal simple", de: "Eine einfache lineare Sequenztransformation", nl: "Een eenvoudige lineaire sequentietransformatie" },
          { en: "A database sequential query model", es: "Un modelo de consulta secuencial de base de datos", de: "Ein Datenbank-Sequential-Query-Modell", nl: "Een database sequentieel querymodel" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A network that uses attention to point to positions in the input sequence as output, rather than generating from a fixed vocabulary", es: "Una red que usa atención para apuntar a posiciones en la secuencia de entrada como salida, en lugar de generar desde un vocabulario fijo", de: "Ein Netzwerk das Aufmerksamkeit verwendet um auf Positionen in der Eingabesequenz als Ausgabe zu zeigen, statt aus einem festen Vokabular zu generieren", nl: "Een netwerk dat aandacht gebruikt om te wijzen naar posities in de invoersequentie als uitvoer, in plaats van te genereren uit een vast vocabulaire" },
          { en: "A network that uses pointer variables in programming", es: "Una red que usa variables puntero en programación", de: "Ein Netzwerk das Zeigervariablen in der Programmierung verwendet", nl: "Een netwerk dat pointer variabelen gebruikt in programmeren" },
          { en: "A network for cursor movement prediction", es: "Una red para predicción de movimiento de cursor", de: "Ein Netzwerk für Cursor-Bewegungsvorhersage", nl: "Een netwerk voor cursorbeweging voorspelling" },
          { en: "A standard classification network", es: "Una red de clasificación estándar", de: "Ein Standard-Klassifikationsnetzwerk", nl: "Een standaard classificatienetwerk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A deep generative model for raw audio waveforms using dilated causal convolutions", es: "Un modelo generativo profundo para formas de onda de audio crudo usando convoluciones causales dilatadas", de: "Ein tiefes generatives Modell für rohe Audio-Wellenformen unter Verwendung dilatierter kausaler Faltungen", nl: "Een diep generatief model voor ruwe audiogolfvormen met gedilateerde causale convoluties" },
          { en: "A network for analyzing ocean waves", es: "Una red para analizar olas del océano", de: "Ein Netzwerk zur Analyse von Ozeanwellen", nl: "Een netwerk voor het analyseren van oceaangolven" },
          { en: "A standard RNN for audio", es: "Una RNN estándar para audio", de: "Ein Standard-RNN für Audio", nl: "Een standaard RNN voor audio" },
          { en: "A network for WiFi signal processing", es: "Una red para procesamiento de señal WiFi", de: "Ein Netzwerk für WiFi-Signalverarbeitung", nl: "Een netwerk voor WiFi-signaalverwerking" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A type of recurrent network where internal weights are randomly initialized and fixed, only output weights are trained", es: "Un tipo de red recurrente donde pesos internos son inicializados aleatoriamente y fijados, solo pesos de salida son entrenados", de: "Eine Art rekurrentes Netzwerk wo interne Gewichte zufällig initialisiert und fixiert sind, nur Ausgabegewichte werden trainiert", nl: "Een type recurrent netwerk waarbij interne gewichten willekeurig geïnitialiseerd en gefixeerd zijn, alleen uitvoergewichten worden getraind" },
          { en: "A network that processes echo and reverb in audio", es: "Una red que procesa eco y reverberación en audio", de: "Ein Netzwerk das Echo und Hall in Audio verarbeitet", nl: "Een netwerk dat echo en nagalm in audio verwerkt" },
          { en: "A fully trainable recurrent network", es: "Una red recurrente completamente entrenable", de: "Ein vollständig trainierbares rekurrentes Netzwerk", nl: "Een volledig trainbaar recurrent netwerk" },
          { en: "A feedforward network for state prediction", es: "Una red feedforward para predicción de estado", de: "Ein Feedforward-Netzwerk für Zustandsvorhersage", nl: "Een feedforward netwerk voor toestandsvoorspelling" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Twin networks with shared weights that learn similarity between inputs through comparison", es: "Redes gemelas con pesos compartidos que aprenden similitud entre entradas mediante comparación", de: "Zwillingsnetzwerke mit gemeinsamen Gewichten die Ähnlichkeit zwischen Eingaben durch Vergleich lernen", nl: "Tweelingnetwerken met gedeelde gewichten die gelijkenis tussen invoer leren door vergelijking" },
          { en: "Networks designed specifically for Asian language processing", es: "Redes diseñadas específicamente para procesamiento de lenguaje asiático", de: "Netzwerke speziell für asiatische Sprachverarbeitung entwickelt", nl: "Netwerken speciaal ontworpen voor Aziatische taalverwerking" },
          { en: "Networks with two completely independent branches", es: "Redes con dos ramas completamente independientes", de: "Netzwerke mit zwei völlig unabhängigen Zweigen", nl: "Netwerken met twee volledig onafhankelijke takken" },
          { en: "A type of ensemble with exactly two models", es: "Tipo de ensemble con exactamente dos modelos", de: "Art von Ensemble mit genau zwei Modellen", nl: "Type ensemble met precies twee modellen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A spiking neural network reservoir computing model inspired by biological neural microcircuits", es: "Modelo de computación de reservorio de red neuronal de picos inspirado en microcircuitos neuronales biológicos", de: "Spiking neuronales Netzwerk Reservoir Computing Modell inspiriert von biologischen neuronalen Mikroschaltungen", nl: "Een spiking neuraal netwerk reservoir computing model geïnspireerd door biologische neurale microcircuits" },
          { en: "A network for modeling liquid dynamics", es: "Red para modelar dinámicas de líquidos", de: "Netzwerk zur Modellierung von Flüssigkeitsdynamik", nl: "Netwerk voor het modelleren van vloeistofdynamica" },
          { en: "A network with weights that change like liquid", es: "Red con pesos que cambian como líquido", de: "Netzwerk mit Gewichten die sich wie Flüssigkeit ändern", nl: "Netwerk met gewichten die veranderen als vloeistof" },
          { en: "A standard feedforward network", es: "Red feedforward estándar", de: "Standard-Feedforward-Netzwerk", nl: "Standaard feedforward netwerk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Automated method to design optimal neural network architectures using machine learning", es: "Método automatizado para diseñar arquitecturas de redes neuronales óptimas usando aprendizaje automático", de: "Automatisierte Methode zum Entwurf optimaler neuronaler Netzwerkarchitekturen unter Verwendung maschinellen Lernens", nl: "Geautomatiseerde methode om optimale neurale netwerkarchitecturen te ontwerpen met behulp van machine learning" },
          { en: "A search engine for finding neural network papers", es: "Motor de búsqueda para encontrar artículos de redes neuronales", de: "Suchmaschine zum Finden von Artikeln über neuronale Netzwerke", nl: "Zoekmachine voor het vinden van neurale netwerk papers" },
          { en: "Manual process of designing network layers", es: "Proceso manual de diseñar capas de red", de: "Manueller Prozess des Entwerfens von Netzwerkschichten", nl: "Handmatig proces van het ontwerpen van netwerklagen" },
          { en: "Finding the best learning rate for a network", es: "Encontrar la mejor tasa de aprendizaje para una red", de: "Finden der besten Lernrate für ein Netzwerk", nl: "Het vinden van de beste leersnelheid voor een netwerk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Convolutional networks using dilated causal convolutions for sequence modeling as alternative to RNNs", es: "Redes convolucionales usando convoluciones causales dilatadas para modelado de secuencias como alternativa a RNN", de: "Faltungsnetzwerke die dilatierte kausale Faltungen für Sequenzmodellierung als Alternative zu RNNs verwenden", nl: "Convolutionele netwerken die gedilateerde causale convoluties gebruiken voor sequentiemodellering als alternatief voor RNNs" },
          { en: "Networks that only process time-series data", es: "Redes que solo procesan datos de series temporales", de: "Netzwerke die nur Zeitreihendaten verarbeiten", nl: "Netwerken die alleen tijdreeksdata verwerken" },
          { en: "RNNs with convolutional layers added", es: "RNNs con capas convolucionales agregadas", de: "RNNs mit hinzugefügten Faltungsschichten", nl: "RNNs met toegevoegde convolutielagen" },
          { en: "Convolutional networks for image sequences", es: "Redes convolucionales para secuencias de imágenes", de: "Faltungsnetzwerke für Bildsequenzen", nl: "Convolutionele netwerken voor beeldsequenties" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Neural network with external differentiable memory that can be read from and written to", es: "Red neuronal con memoria externa diferenciable de la que se puede leer y escribir", de: "Neuronales Netzwerk mit externer differenzierbarer Speicher von dem gelesen und auf den geschrieben werden kann", nl: "Neuraal netwerk met externe differentieerbare geheugen waarvan gelezen en waarnaar geschreven kan worden" },
          { en: "A Turing machine implemented in hardware", es: "Máquina de Turing implementada en hardware", de: "In Hardware implementierte Turing-Maschine", nl: "Turing machine geïmplementeerd in hardware" },
          { en: "Neural network named after Alan Turing", es: "Red neuronal nombrada por Alan Turing", de: "Neuronales Netzwerk benannt nach Alan Turing", nl: "Neuraal netwerk vernoemd naar Alan Turing" },
          { en: "A standard RNN with more layers", es: "RNN estándar con más capas", de: "Standard-RNN mit mehr Schichten", nl: "Standaard RNN met meer lagen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Recurrent networks that function as content-addressable memory systems with stable attractors", es: "Redes recurrentes que funcionan como sistemas de memoria direccionables por contenido con atractores estables", de: "Rekurrente Netzwerke die als inhaltsadressierbare Speichersysteme mit stabilen Attraktoren funktionieren", nl: "Recurrente netwerken die functioneren als inhoud-adresseerbare geheugensystemen met stabiele attractoren" },
          { en: "Feedforward networks for classification", es: "Redes feedforward para clasificación", de: "Feedforward-Netzwerke für Klassifikation", nl: "Feedforward netwerken voor classificatie" },
          { en: "Networks designed for image generation", es: "Redes diseñadas para generación de imágenes", de: "Netzwerke für Bilderzeugung entwickelt", nl: "Netwerken ontworpen voor beeldgeneratie" },
          { en: "Modern transformer architectures", es: "Arquitecturas transformer modernas", de: "Moderne Transformer-Architekturen", nl: "Moderne transformer architecturen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Stochastic recurrent networks that learn probability distribution over inputs using energy-based model", es: "Redes recurrentes estocásticas que aprenden distribución de probabilidad sobre entradas usando modelo basado en energía", de: "Stochastische rekurrente Netzwerke die Wahrscheinlichkeitsverteilung über Eingaben unter Verwendung energiebasiertem Modell lernen", nl: "Stochastische recurrente netwerken die waarschijnlijkheidsverdeling over invoer leren met behulp van energie-gebaseerd model" },
          { en: "Networks for temperature prediction", es: "Redes para predicción de temperatura", de: "Netzwerke für Temperaturvorhersage", nl: "Netwerken voor temperatuurvoorspelling" },
          { en: "Deterministic feedforward networks", es: "Redes feedforward deterministas", de: "Deterministische Feedforward-Netzwerke", nl: "Deterministische feedforward netwerken" },
          { en: "Networks named after a physicist, used only for physics simulations", es: "Redes nombradas por físico, usadas solo para simulaciones físicas", de: "Nach Physiker benannte Netzwerke, nur für Physiksimulationen verwendet", nl: "Netwerken vernoemd naar natuurkundige, alleen gebruikt voor natuurkundesimulaties" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "GAN variant where both generator and discriminator are conditioned on additional information like class labels", es: "Variante GAN donde generador y discriminador están condicionados a información adicional como etiquetas de clase", de: "GAN-Variante wo Generator und Diskriminator auf zusätzliche Information wie Klassenbezeichnungen konditioniert sind", nl: "GAN variant waarbij zowel generator als discriminator geconditioneerd zijn op aanvullende informatie zoals klasselabels" },
          { en: "GAN that only works under specific conditions", es: "GAN que solo funciona bajo condiciones específicas", de: "GAN das nur unter spezifischen Bedingungen funktioniert", nl: "GAN dat alleen onder specifieke condities werkt" },
          { en: "GAN with conditional probability layers", es: "GAN con capas de probabilidad condicional", de: "GAN mit bedingten Wahrscheinlichkeitsschichten", nl: "GAN met conditionele waarschijnlijkheidslagen" },
          { en: "Standard GAN with better convergence", es: "GAN estándar con mejor convergencia", de: "Standard-GAN mit besserer Konvergenz", nl: "Standaard GAN met betere convergentie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Advanced NTM with more sophisticated memory addressing including temporal linking and allocation", es: "NTM avanzada con direccionamiento de memoria más sofisticado incluyendo vinculación temporal y asignación", de: "Fortgeschrittene NTM mit ausgefeilterem Speicheradressierung einschließlich zeitlicher Verknüpfung und Zuweisung", nl: "Geavanceerde NTM met meer geavanceerde geheugenadressering inclusief temporele koppeling en toewijzing" },
          { en: "Neural network that can be differentiated from other networks", es: "Red neuronal que puede diferenciarse de otras redes", de: "Neuronales Netzwerk das von anderen Netzwerken unterschieden werden kann", nl: "Neuraal netwerk dat onderscheiden kan worden van andere netwerken" },
          { en: "Computer hardware for running neural networks", es: "Hardware de computadora para ejecutar redes neuronales", de: "Computer-Hardware zum Ausführen neuronaler Netzwerke", nl: "Computer hardware voor het uitvoeren van neurale netwerken" },
          { en: "Standard neural network with differential equations", es: "Red neuronal estándar con ecuaciones diferenciales", de: "Standard neuronales Netzwerk mit Differentialgleichungen", nl: "Standaard neuraal netwerk met differentiaalvergelijkingen" }
        ],
        correct: 0,
        explanation: {
