// Neurale netwerken Quiz - Level 7
(function() {
  const level7 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Reduce computational complexity by matrix multiplication",
                  "es": "Reducir complejidad computacional mediante multiplicación de matrices",
                  "de": "Rechenaufwand durch Matrixmultiplikation reduzieren",
                  "nl": "Rekenkundige complexiteit verminderen door matrixvermenigvuldiging"
        },
        {
                  "en": "Normalize input data for better convergence",
                  "es": "Normalizar datos de entrada para mejor convergencia",
                  "de": "Eingabedaten für bessere Konvergenz normalisieren",
                  "nl": "Invoerdata normaliseren voor betere convergentie"
        },
        {
                  "en": "Extract local features while preserving spatial relationships",
                  "es": "Extraer características locales preservando relaciones espaciales",
                  "de": "Lokale Merkmale extrahieren unter Beibehaltung räumlicher Beziehungen",
                  "nl": "Lokale kenmerken extraheren terwijl ruimtelijke relaties behouden blijven"
        },
        {
                  "en": "Connect every neuron to every other neuron",
                  "es": "Conectar cada neurona con todas las demás neuronas",
                  "de": "Jedes Neuron mit jedem anderen Neuron verbinden",
                  "nl": "Elk neuron verbinden met elk ander neuron"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Valid padding is for training, same padding is for testing",
                  "es": "Padding válido es para entrenamiento, mismo padding es para pruebas",
                  "de": "Gültiges Padding ist für Training, gleiches Padding ist für Tests",
                  "nl": "Valid padding is voor training, same padding is voor testen"
        },
        {
                  "en": "Valid padding uses larger kernels, same padding uses smaller kernels",
                  "es": "Padding válido usa núcleos más grandes, mismo padding usa núcleos más pequeños",
                  "de": "Gültiges Padding verwendet größere Kernel, gleiches Padding verwendet kleinere Kernel",
                  "nl": "Valid padding gebruikt grotere kernels, same padding gebruikt kleinere kernels"
        },
        {
                  "en": "Valid padding produces smaller output, same padding preserves input dimensions",
                  "es": "Padding válido produce salida más pequeña, mismo padding preserva dimensiones de entrada",
                  "de": "Gültiges Padding erzeugt kleinere Ausgabe, gleiches Padding erhält Eingabedimensionen",
                  "nl": "Valid padding produceert kleinere output, same padding behoudt invoerdimensies"
        },
        {
                  "en": "Valid padding adds zeros, same padding adds ones",
                  "es": "Padding válido agrega ceros, mismo padding agrega unos",
                  "de": "Gültiges Padding fügt Nullen hinzu, gleiches Padding fügt Einsen hinzu",
                  "nl": "Valid padding voegt nullen toe, same padding voegt enen toe"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Normalize feature values across channels",
                  "es": "Normalizar valores de características entre canales",
                  "de": "Feature-Werte über Kanäle normalisieren",
                  "nl": "Feature-waarden normaliseren over kanalen"
        },
        {
                  "en": "Reduce spatial dimensions and provide translation invariance",
                  "es": "Reducir dimensiones espaciales y proporcionar invarianza de traslación",
                  "de": "Räumliche Dimensionen reduzieren und Translationsinvarianz bieten",
                  "nl": "Ruimtelijke dimensies verkleinen en translatie-invariantie bieden"
        },
        {
                  "en": "Increase the number of feature maps",
                  "es": "Aumentar el número de mapas de características",
                  "de": "Die Anzahl der Feature-Maps erhöhen",
                  "nl": "Het aantal feature maps verhogen"
        },
        {
                  "en": "Add non-linearity to the network",
                  "es": "Agregar no linealidad a la red",
                  "de": "Nicht-Linearität zum Netzwerk hinzufügen",
                  "nl": "Non-lineariteit toevoegen aan het netwerk"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Convolutional operations for spatial processing",
                  "es": "Operaciones convolucionales para procesamiento espacial",
                  "de": "Faltungsoperationen für räumliche Verarbeitung",
                  "nl": "Convolutionele operaties voor ruimtelijke verwerking"
        },
        {
                  "en": "Gate mechanisms that control information flow and solve vanishing gradients",
                  "es": "Mecanismos de compuerta que controlan el flujo de información y resuelven gradientes evanescentes",
                  "de": "Gate-Mechanismen die Informationsfluss steuern und verschwindende Gradienten lösen",
                  "nl": "Poortmechanismen die informatiestroom controleren en verdwijnende gradiënten oplossen"
        },
        {
                  "en": "Larger hidden state dimensions for more memory",
                  "es": "Dimensiones de estado oculto más grandes para más memoria",
                  "de": "Größere versteckte Zustandsdimensionen für mehr Speicher",
                  "nl": "Grotere verborgen toestandsdimensies voor meer geheugen"
        },
        {
                  "en": "Multiple parallel processing units",
                  "es": "Múltiples unidades de procesamiento en paralelo",
                  "de": "Mehrere parallele Verarbeitungseinheiten",
                  "nl": "Meerdere parallelle verwerkingseenheden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "GRUs use convolutional gates while LSTMs use fully connected gates",
                  "es": "GRUs usan compuertas convolucionales mientras LSTMs usan compuertas completamente conectadas",
                  "de": "GRUs verwenden Faltungs-Gates während LSTMs vollständig verbundene Gates verwenden",
                  "nl": "GRU's gebruiken convolutionele poorten terwijl LSTM's volledig verbonden poorten gebruiken"
        },
        {
                  "en": "GRUs have fewer gates (reset and update) and simpler architecture",
                  "es": "GRUs tienen menos compuertas (reset y update) y arquitectura más simple",
                  "de": "GRUs haben weniger Gates (Reset und Update) und einfachere Architektur",
                  "nl": "GRU's hebben minder poorten (reset en update) en eenvoudigere architectuur"
        },
        {
                  "en": "GRUs process sequences in parallel while LSTMs process sequentially",
                  "es": "GRUs procesan secuencias en paralelo mientras LSTMs procesan secuencialmente",
                  "de": "GRUs verarbeiten Sequenzen parallel während LSTMs sequenziell verarbeiten",
                  "nl": "GRU's verwerken sequenties parallel terwijl LSTM's sequentieel verwerken"
        },
        {
                  "en": "GRUs handle longer sequences while LSTMs handle shorter sequences",
                  "es": "GRUs manejan secuencias más largas mientras LSTMs manejan secuencias más cortas",
                  "de": "GRUs handhaben längere Sequenzen während LSTMs kürzere Sequenzen handhaben",
                  "nl": "GRU's hanteren langere sequenties terwijl LSTM's kortere sequenties hanteren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The size of the convolutional filter kernel",
                  "es": "El tamaño del núcleo del filtro convolucional",
                  "de": "Die Größe des Faltungsfilter-Kernels",
                  "nl": "De grootte van de convolutiefilterkernel"
        },
        {
                  "en": "The region of input that influences a particular output neuron",
                  "es": "La región de entrada que influye en una neurona de salida particular",
                  "de": "Der Eingabebereich der einen bestimmten Ausgabeneuron beeinflusst",
                  "nl": "Het gebied van invoer dat een bepaald uitvoerneuron beïnvloedt"
        },
        {
                  "en": "The number of channels in each layer",
                  "es": "El número de canales en cada capa",
                  "de": "Die Anzahl der Kanäle in jeder Schicht",
                  "nl": "Het aantal kanalen in elke laag"
        },
        {
                  "en": "The range of activation values in a layer",
                  "es": "El rango de valores de activación en una capa",
                  "de": "Der Bereich der Aktivierungswerte in einer Schicht",
                  "nl": "Het bereik van activatiewaarden in een laag"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Control how many pixels the filter moves at each step",
                  "es": "Controlar cuántos píxeles se mueve el filtro en cada paso",
                  "de": "Steuern wie viele Pixel der Filter bei jedem Schritt bewegt",
                  "nl": "Controleren hoeveel pixels de filter bij elke stap beweegt"
        },
        {
                  "en": "Control the depth of feature maps",
                  "es": "Controlar la profundidad de los mapas de características",
                  "de": "Die Tiefe der Feature-Maps steuern",
                  "nl": "De diepte van feature maps controleren"
        },
        {
                  "en": "Set the learning rate for filter weights",
                  "es": "Establecer la tasa de aprendizaje para los pesos del filtro",
                  "de": "Die Lernrate für Filtergewichte festlegen",
                  "nl": "De leersnelheid voor filtergewichten instellen"
        },
        {
                  "en": "Determine the number of filters applied to input",
                  "es": "Determinar el número de filtros aplicados a la entrada",
                  "de": "Die Anzahl der auf die Eingabe angewandten Filter bestimmen",
                  "nl": "Bepalen hoeveel filters op de invoer worden toegepast"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Expands receptive field without increasing parameters or losing resolution",
                  "es": "Expande el campo receptivo sin aumentar parámetros o perder resolución",
                  "de": "Erweitert rezeptives Feld ohne Parameter zu erhöhen oder Auflösung zu verlieren",
                  "nl": "Vergroot receptief veld zonder parameters te verhogen of resolutie te verliezen"
        },
        {
                  "en": "Reduces computational cost by skipping certain operations",
                  "es": "Reduce el costo computacional saltando ciertas operaciones",
                  "de": "Reduziert Rechenkosten durch Überspringen bestimmter Operationen",
                  "nl": "Vermindert rekenkosten door bepaalde operaties over te slaan"
        },
        {
                  "en": "Applies convolution multiple times to the same region",
                  "es": "Aplica convolución múltiples veces a la misma región",
                  "de": "Wendet Faltung mehrfach auf dieselbe Region an",
                  "nl": "Past convolutie meerdere keren toe op hetzelfde gebied"
        },
        {
                  "en": "Increases the number of filters by dilating kernel size",
                  "es": "Aumenta el número de filtros dilatando el tamaño del núcleo",
                  "de": "Erhöht die Anzahl der Filter durch Dilatierung der Kernel-Größe",
                  "nl": "Verhoogt het aantal filters door kernelgrootte te dilateren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The gradient calculation becomes too complex for the optimizer",
                  "es": "El cálculo del gradiente se vuelve demasiado complejo para el optimizador",
                  "de": "Die Gradientenberechnung wird zu komplex für den Optimierer",
                  "nl": "De gradiëntberekening wordt te complex voor de optimizer"
        },
        {
                  "en": "The network forgets previously learned patterns",
                  "es": "La red olvida patrones aprendidos previamente",
                  "de": "Das Netzwerk vergisst zuvor gelernte Muster",
                  "nl": "Het netwerk vergeet eerder geleerde patronen"
        },
        {
                  "en": "Gradients are lost due to numerical precision errors",
                  "es": "Los gradientes se pierden debido a errores de precisión numérica",
                  "de": "Gradienten gehen durch numerische Präzisionsfehler verloren",
                  "nl": "Gradiënten gaan verloren door numerieke precisiefouten"
        },
        {
                  "en": "Gradients become exponentially small in long sequences, preventing learning of long-term dependencies",
                  "es": "Los gradientes se vuelven exponencialmente pequeños en secuencias largas, impidiendo aprender dependencias a largo plazo",
                  "de": "Gradienten werden exponentiell klein bei langen Sequenzen und verhindern Lernen langfristiger Abhängigkeiten",
                  "nl": "Gradiënten worden exponentieel klein in lange sequenties, waardoor leren van langetermijnafhankelijkheden wordt voorkomen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enable parallel processing of convolution operations",
                  "es": "Habilitar procesamiento paralelo de operaciones de convolución",
                  "de": "Parallele Verarbeitung von Faltungsoperationen ermöglichen",
                  "nl": "Parallelle verwerking van convolutie-operaties mogelijk maken"
        },
        {
                  "en": "Apply different depths of convolution to different input channels",
                  "es": "Aplicar diferentes profundidades de convolución a diferentes canales de entrada",
                  "de": "Verschiedene Faltungstiefen auf verschiedene Eingabekanäle anwenden",
                  "nl": "Verschillende convolutiedieptes toepassen op verschillende invoerkanalen"
        },
        {
                  "en": "Reduce parameters and computations by separating spatial and channel-wise filtering",
                  "es": "Reducir parámetros y cálculos separando filtrado espacial y por canales",
                  "de": "Parameter und Berechnungen reduzieren durch Trennung räumlicher und kanalweiser Filterung",
                  "nl": "Parameters en berekeningen verminderen door ruimtelijke en kanaalgewijze filtering te scheiden"
        },
        {
                  "en": "Increase the number of learnable parameters for better accuracy",
                  "es": "Aumentar el número de parámetros aprendibles para mejor precisión",
                  "de": "Die Anzahl lernbarer Parameter für bessere Genauigkeit erhöhen",
                  "nl": "Het aantal leerbare parameters verhogen voor betere nauwkeurigheid"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bidirectional RNNs process sequences in both forward and backward directions",
                  "es": "RNNs bidireccionales procesan secuencias en direcciones hacia adelante y hacia atrás",
                  "de": "Bidirektionale RNNs verarbeiten Sequenzen in Vorwärts- und Rückwärtsrichtung",
                  "nl": "Bidirectionele RNN's verwerken sequenties in zowel voorwaartse als achterwaartse richting"
        },
        {
                  "en": "Bidirectional RNNs alternate between forward and backward processing",
                  "es": "RNNs bidireccionales alternan entre procesamiento hacia adelante y hacia atrás",
                  "de": "Bidirektionale RNNs wechseln zwischen Vorwärts- und Rückwärtsverarbeitung",
                  "nl": "Bidirectionele RNN's wisselen af tussen voorwaartse en achterwaartse verwerking"
        },
        {
                  "en": "Bidirectional RNNs can process two different sequences simultaneously",
                  "es": "RNNs bidireccionales pueden procesar dos secuencias diferentes simultáneamente",
                  "de": "Bidirektionale RNNs können zwei verschiedene Sequenzen gleichzeitig verarbeiten",
                  "nl": "Bidirectionele RNN's kunnen twee verschillende sequenties tegelijkertijd verwerken"
        },
        {
                  "en": "Bidirectional RNNs have twice as many layers as unidirectional RNNs",
                  "es": "RNNs bidireccionales tienen el doble de capas que las RNNs unidireccionales",
                  "de": "Bidirektionale RNNs haben doppelt so viele Schichten wie unidirektionale RNNs",
                  "nl": "Bidirectionele RNN's hebben twee keer zoveel lagen als unidirectionele RNN's"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Normalize layer inputs to stabilize training and enable higher learning rates",
                  "es": "Normalizar entradas de capa para estabilizar entrenamiento y permitir tasas de aprendizaje más altas",
                  "de": "Schichteingaben normalisieren um Training zu stabilisieren und höhere Lernraten zu ermöglichen",
                  "nl": "Laagtoegang normaliseren om training te stabiliseren en hogere leersnelheden mogelijk te maken"
        },
        {
                  "en": "Group input samples into batches for parallel processing",
                  "es": "Agrupar muestras de entrada en lotes para procesamiento paralelo",
                  "de": "Eingabeproben in Batches für parallele Verarbeitung gruppieren",
                  "nl": "Invoermonsters groeperen in batches voor parallelle verwerking"
        },
        {
                  "en": "Normalize the final output predictions",
                  "es": "Normalizar las predicciones de salida final",
                  "de": "Die endgültigen Ausgabevorhersagen normalisieren",
                  "nl": "De finale uitvoervoorspellingen normaliseren"
        },
        {
                  "en": "Reduce the total number of parameters in the network",
                  "es": "Reducir el número total de parámetros en la red",
                  "de": "Die Gesamtzahl der Parameter im Netzwerk reduzieren",
                  "nl": "Het totale aantal parameters in het netwerk verminderen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reduce the computational complexity of sequence processing",
                  "es": "Reducir la complejidad computacional del procesamiento de secuencias",
                  "de": "Die rechnerische Komplexität der Sequenzverarbeitung reduzieren",
                  "nl": "De rekenkundige complexiteit van sequentieverwerking verminderen"
        },
        {
                  "en": "Allow decoder to focus on different parts of input sequence for each output",
                  "es": "Permitir al decodificador enfocarse en diferentes partes de la secuencia de entrada para cada salida",
                  "de": "Ermöglichen dem Decoder sich auf verschiedene Teile der Eingabesequenz für jede Ausgabe zu konzentrieren",
                  "nl": "Stellen de decoder in staat om zich te richten op verschillende delen van de invoersequentie voor elke output"
        },
        {
                  "en": "Enable parallel processing of all sequence elements",
                  "es": "Habilitar procesamiento paralelo de todos los elementos de secuencia",
                  "de": "Parallele Verarbeitung aller Sequenzelemente ermöglichen",
                  "nl": "Parallelle verwerking van alle sequentie-elementen mogelijk maken"
        },
        {
                  "en": "Automatically determine the optimal sequence length",
                  "es": "Determinar automáticamente la longitud óptima de secuencia",
                  "de": "Automatisch die optimale Sequenzlänge bestimmen",
                  "nl": "Automatisch de optimale sequentielengte bepalen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Global pooling reduces each feature map to a single value, local pooling operates on small regions",
                  "es": "Pooling global reduce cada mapa de características a un solo valor, pooling local opera en regiones pequeñas",
                  "de": "Globales Pooling reduziert jede Feature-Map auf einen einzelnen Wert, lokales Pooling operiert auf kleinen Regionen",
                  "nl": "Globale pooling reduceert elke feature map tot één waarde, lokale pooling werkt op kleine gebieden"
        },
        {
                  "en": "Global pooling processes all channels, local pooling processes one channel",
                  "es": "Pooling global procesa todos los canales, pooling local procesa un canal",
                  "de": "Globales Pooling verarbeitet alle Kanäle, lokales Pooling verarbeitet einen Kanal",
                  "nl": "Globale pooling verwerkt alle kanalen, lokale pooling verwerkt één kanaal"
        },
        {
                  "en": "Global pooling is used in training, local pooling is used in inference",
                  "es": "Pooling global se usa en entrenamiento, pooling local se usa en inferencia",
                  "de": "Globales Pooling wird im Training verwendet, lokales Pooling wird in der Inferenz verwendet",
                  "nl": "Globale pooling wordt gebruikt bij training, lokale pooling wordt gebruikt bij inferentie"
        },
        {
                  "en": "Global pooling uses max operation, local pooling uses average operation",
                  "es": "Pooling global usa operación máximo, pooling local usa operación promedio",
                  "de": "Globales Pooling verwendet Max-Operation, lokales Pooling verwendet Durchschnittsoperation",
                  "nl": "Globale pooling gebruikt max-operatie, lokale pooling gebruikt gemiddelde operatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using ground truth tokens as inputs during training instead of model predictions",
                  "es": "Usar tokens de verdad fundamental como entradas durante entrenamiento en lugar de predicciones del modelo",
                  "de": "Verwendung von Ground-Truth-Tokens als Eingaben während des Trainings anstelle von Modellvorhersagen",
                  "nl": "Ground truth tokens gebruiken als invoer tijdens training in plaats van modelvoorspellingen"
        },
        {
                  "en": "Forcing the model to learn from expert demonstrations",
                  "es": "Forzar al modelo a aprender de demostraciones expertas",
                  "de": "Das Modell zwingen von Expertenvorführungen zu lernen",
                  "nl": "Het model dwingen om te leren van expertdemonstraties"
        },
        {
                  "en": "Using a pre-trained teacher model to guide training",
                  "es": "Usar un modelo profesor pre-entrenado para guiar el entrenamiento",
                  "de": "Ein vortrainiertes Lehrermodell zur Trainingsleitung verwenden",
                  "nl": "Een voorgetraind lerarenmodel gebruiken om training te begeleiden"
        },
        {
                  "en": "Training the model to copy the teacher network's weights",
                  "es": "Entrenar el modelo para copiar los pesos de la red del profesor",
                  "de": "Das Modell trainieren um die Gewichte des Lehrernetzwerks zu kopieren",
                  "nl": "Het model trainen om de gewichten van het lerarennetwerk te kopiëren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enable gradient flow and identity mapping for training very deep networks",
                  "es": "Habilitar flujo de gradientes y mapeo de identidad para entrenar redes muy profundas",
                  "de": "Gradientenfluss und Identitätsabbildung für Training sehr tiefer Netzwerke ermöglichen",
                  "nl": "Gradiëntenstroom en identiteitsafbeelding mogelijk maken voor training van zeer diepe netwerken"
        },
        {
                  "en": "Connect layers that are not adjacent to each other",
                  "es": "Conectar capas que no son adyacentes entre sí",
                  "de": "Schichten verbinden die nicht nebeneinander liegen",
                  "nl": "Lagen verbinden die niet naast elkaar liggen"
        },
        {
                  "en": "Reduce the number of parameters by skipping certain layers",
                  "es": "Reducir el número de parámetros saltando ciertas capas",
                  "de": "Die Anzahl der Parameter durch Überspringen bestimmter Schichten reduzieren",
                  "nl": "Het aantal parameters verminderen door bepaalde lagen over te slaan"
        },
        {
                  "en": "Enable parallel processing of different network paths",
                  "es": "Habilitar procesamiento paralelo de diferentes rutas de red",
                  "de": "Parallele Verarbeitung verschiedener Netzwerkpfade ermöglichen",
                  "nl": "Parallelle verwerking van verschillende netwerkpaden mogelijk maken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reduced memory usage compared to 2D convolutions",
                  "es": "Uso reducido de memoria comparado con convoluciones 2D",
                  "de": "Reduzierter Speicherverbrauch im Vergleich zu 2D-Faltungen",
                  "nl": "Verminderd geheugengebruik vergeleken met 2D convoluties"
        },
        {
                  "en": "Automatic feature extraction without manual engineering",
                  "es": "Extracción automática de características sin ingeniería manual",
                  "de": "Automatische Feature-Extraktion ohne manuelle Entwicklung",
                  "nl": "Automatische feature-extractie zonder handmatige engineering"
        },
        {
                  "en": "Parallel processing and local pattern detection in sequences",
                  "es": "Procesamiento paralelo y detección de patrones locales en secuencias",
                  "de": "Parallele Verarbeitung und lokale Mustererkennung in Sequenzen",
                  "nl": "Parallelle verwerking en lokale patroondetectie in sequenties"
        },
        {
                  "en": "Better handling of variable length sequences",
                  "es": "Mejor manejo de secuencias de longitud variable",
                  "de": "Bessere Handhabung von Sequenzen variabler Länge",
                  "nl": "Betere behandeling van sequenties van variabele lengte"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "CNNs use linear activations, RNNs use non-linear activations",
                  "es": "CNNs usan activaciones lineales, RNNs usan activaciones no lineales",
                  "de": "CNNs verwenden lineare Aktivierungen, RNNs verwenden nicht-lineare Aktivierungen",
                  "nl": "CNN's gebruiken lineaire activeringen, RNN's gebruiken niet-lineaire activeringen"
        },
        {
                  "en": "CNNs are unsupervised, RNNs are supervised learning methods",
                  "es": "CNNs son métodos de aprendizaje no supervisado, RNNs son supervisados",
                  "de": "CNNs sind unüberwachte, RNNs sind überwachte Lernmethoden",
                  "nl": "CNN's zijn ongesuperviseerd, RNN's zijn gesuperviseerde leermethoden"
        },
        {
                  "en": "CNNs process fixed-size inputs, RNNs process variable-size inputs",
                  "es": "CNNs procesan entradas de tamaño fijo, RNNs procesan entradas de tamaño variable",
                  "de": "CNNs verarbeiten Eingaben fester Größe, RNNs verarbeiten Eingaben variabler Größe",
                  "nl": "CNN's verwerken invoer van vaste grootte, RNN's verwerken invoer van variabele grootte"
        },
        {
                  "en": "CNNs process spatial relationships, RNNs process temporal/sequential relationships",
                  "es": "CNNs procesan relaciones espaciales, RNNs procesan relaciones temporales/secuenciales",
                  "de": "CNNs verarbeiten räumliche Beziehungen, RNNs verarbeiten zeitliche/sequenzielle Beziehungen",
                  "nl": "CNN's verwerken ruimtelijke relaties, RNN's verwerken temporele/sequentiële relaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reduce computational complexity by skipping layers",
                  "es": "Reducir complejidad computacional saltando capas",
                  "de": "Rechenaufwand durch Überspringen von Schichten reduzieren",
                  "nl": "Rekenkundige complexiteit verminderen door lagen over te slaan"
        },
        {
                  "en": "Increase the number of learnable parameters",
                  "es": "Aumentar el número de parámetros aprendibles",
                  "de": "Die Anzahl lernbarer Parameter erhöhen",
                  "nl": "Het aantal leerbare parameters verhogen"
        },
        {
                  "en": "Enable dynamic selection of network depth during inference",
                  "es": "Habilitar selección dinámica de profundidad de red durante inferencia",
                  "de": "Dynamische Auswahl der Netzwerktiefe während der Inferenz ermöglichen",
                  "nl": "Dynamische selectie van netwerkdiepte tijdens inferentie mogelijk maken"
        },
        {
                  "en": "Combat vanishing gradients and enable training of much deeper networks",
                  "es": "Combatir gradientes evanescentes y permitir entrenamiento de redes mucho más profundas",
                  "de": "Verschwindende Gradienten bekämpfen und Training viel tieferer Netzwerke ermöglichen",
                  "nl": "Verdwijnende gradiënten bestrijden en training van veel diepere netwerken mogelijk maken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Memory usage explodes with sequence length; addressed using truncated backpropagation",
                  "es": "El uso de memoria explota con la longitud de secuencia; se aborda usando retropropagación truncada",
                  "de": "Speicherverbrauch explodiert mit Sequenzlänge; wird durch abgeschnittene Rückpropagation angegangen",
                  "nl": "Geheugengebruik explodeert met sequentielengte; aangepakt met afgeknotte backpropagatie"
        },
        {
                  "en": "Computational time explodes exponentially; addressed using parallel processing",
                  "es": "El tiempo computacional explota exponencialmente; se aborda usando procesamiento paralelo",
                  "de": "Rechenzeit explodiert exponentiell; wird durch parallele Verarbeitung angegangen",
                  "nl": "Rekentijd explodeert exponentieel; aangepakt met parallelle verwerking"
        },
        {
                  "en": "Network explodes due to too many parameters; addressed by reducing network size",
                  "es": "La red explota debido a demasiados parámetros; se aborda reduciendo el tamaño de la red",
                  "de": "Netzwerk explodiert durch zu viele Parameter; wird durch Reduzierung der Netzwerkgröße angegangen",
                  "nl": "Netwerk explodeert vanwege te veel parameters; aangepakt door netwerkgrootte te verminderen"
        },
        {
                  "en": "Gradients become too large during backpropagation; addressed using gradient clipping",
                  "es": "Los gradientes se vuelven demasiado grandes durante retropropagación; se aborda usando recorte de gradientes",
                  "de": "Gradienten werden während der Rückpropagation zu groß; wird durch Gradient Clipping angegangen",
                  "nl": "Gradiënten worden te groot tijdens backpropagatie; aangepakt met gradiënt clipping"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Upsampling feature maps to increase spatial dimensions, often in image generation and segmentation",
                  "es": "Aumentar muestreo de mapas características para incrementar dimensiones espaciales, menudo en generación y segmentación imágenes",
                  "de": "Upsampling von Feature-Maps um räumliche Dimensionen zu erhöhen, oft bei Bildgenerierung und Segmentierung",
                  "nl": "Upsampling van feature maps om ruimtelijke dimensies te verhogen, vaak bij beeldgeneratie en segmentatie"
        },
        {
                  "en": "Performing dimensional reduction like pooling",
                  "es": "Realizar reducción dimensional como pooling",
                  "de": "Durchführung dimensionaler Reduktion wie Pooling",
                  "nl": "Dimensionale reductie uitvoeren zoals pooling"
        },
        {
                  "en": "Computing matrix transposes of convolution kernels",
                  "es": "Calcular transpuestas de matriz de núcleos de convolución",
                  "de": "Berechnung von Matrixtransposen von Faltungskernen",
                  "nl": "Matrixtransposes van convolutiekernels berekenen"
        },
        {
                  "en": "Reversing convolution operations to recover original input",
                  "es": "Revertir operaciones de convolución para recuperar entrada original",
                  "de": "Umkehren von Faltungsoperationen um ursprüngliche Eingabe wiederherzustellen",
                  "nl": "Convolutie-operaties omkeren om originele invoer te herstellen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training on sequences of length 2 only",
                  "es": "Entrenar solo en secuencias de longitud 2",
                  "de": "Training nur auf Sequenzen der Länge 2",
                  "nl": "Alleen trainen op sequenties van lengte 2"
        },
        {
                  "en": "Processing two sequences simultaneously in parallel",
                  "es": "Procesar dos secuencias simultáneamente en paralelo",
                  "de": "Gleichzeitige parallele Verarbeitung zweier Sequenzen",
                  "nl": "Twee sequenties tegelijkertijd parallel verwerken"
        },
        {
                  "en": "Using encoder RNN to process input sequence and decoder RNN to generate output sequence",
                  "es": "Usar RNN codificador para procesar secuencia entrada y RNN decodificador para generar secuencia salida",
                  "de": "Verwendung eines Encoder-RNN um Eingabesequenz zu verarbeiten und Decoder-RNN um Ausgabesequenz zu generieren",
                  "nl": "Een encoder RNN gebruiken om invoersequentie te verwerken en decoder RNN om uitvoersequentie te genereren"
        },
        {
                  "en": "Converting sequences from one format to another",
                  "es": "Convertir secuencias de un formato a otro",
                  "de": "Konvertierung von Sequenzen von einem Format in ein anderes",
                  "nl": "Sequenties converteren van het ene formaat naar het andere"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A visual map showing where features are located",
                  "es": "Un mapa visual mostrando dónde están ubicadas las características",
                  "de": "Eine visuelle Karte die zeigt wo Features sich befinden",
                  "nl": "Een visuele kaart die toont waar features zich bevinden"
        },
        {
                  "en": "A database of all learned features in the network",
                  "es": "Una base de datos de todas las características aprendidas en la red",
                  "de": "Eine Datenbank aller gelernten Features im Netzwerk",
                  "nl": "Een database van alle geleerde features in het netwerk"
        },
        {
                  "en": "Output activation of applying a specific filter across the input",
                  "es": "Activación salida aplicar filtro específico a través entrada",
                  "de": "Ausgabeaktivierung beim Anwenden eines spezifischen Filters über die Eingabe",
                  "nl": "Uitvoeractiv atie van het toepassen van een specifieke filter over de invoer"
        },
        {
                  "en": "The spatial dimensions of the input image",
                  "es": "Las dimensiones espaciales de la imagen de entrada",
                  "de": "Die räumlichen Dimensionen des Eingabebildes",
                  "nl": "De ruimtelijke dimensies van het invoerbeeld"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enable parallel processing of LSTM operations",
                  "es": "Habilitar procesamiento paralelo de operaciones LSTM",
                  "de": "Parallele Verarbeitung von LSTM-Operationen ermöglichen",
                  "nl": "Parallelle verwerking van LSTM-operaties mogelijk maken"
        },
        {
                  "en": "Create connections that peek at future time steps",
                  "es": "Crear conexiones que espían pasos de tiempo futuros",
                  "de": "Verbindungen erstellen die zukünftige Zeitschritte voraussehen",
                  "nl": "Verbindingen creëren die toekomstige tijdstappen inkijken"
        },
        {
                  "en": "Allow gates to access cell state directly for more precise control over information flow",
                  "es": "Permitir compuertas acceder estado celda directamente para control más preciso sobre flujo información",
                  "de": "Ermöglichen Gates direkten Zugriff auf Zellzustand für präzisere Kontrolle des Informationsflusses",
                  "nl": "Gates toestaan direct toegang tot celstaat te krijgen voor preciezere controle over informatiestroom"
        },
        {
                  "en": "Reduce the number of parameters in LSTM",
                  "es": "Reducir el número de parámetros en LSTM",
                  "de": "Reduzierung der Anzahl von Parametern in LSTM",
                  "nl": "Het aantal parameters in LSTM verminderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hierarchical pooling from coarse to fine",
                  "es": "Pooling jerárquico de grueso a fino",
                  "de": "Hierarchisches Pooling von grob zu fein",
                  "nl": "Hiërarchische pooling van grof naar fijn"
        },
        {
                  "en": "Creating pyramid-shaped pooling windows",
                  "es": "Crear ventanas de pooling en forma de pirámide",
                  "de": "Erstellung pyramidenförmiger Pooling-Fenster",
                  "nl": "Pyramide-vormige pooling-vensters creëren"
        },
        {
                  "en": "Pooling at multiple scales to create fixed-length representation regardless of input size",
                  "es": "Pooling múltiples escalas para crear representación longitud fija independiente tamaño entrada",
                  "de": "Pooling auf mehreren Skalen um Darstellung fester Länge unabhängig von Eingabegröße zu erstellen",
                  "nl": "Pooling op meerdere schalen om representatie van vaste lengte te creëren ongeacht invoergrootte"
        },
        {
                  "en": "Stacking multiple pooling layers vertically",
                  "es": "Apilar múltiples capas de pooling verticalmente",
                  "de": "Vertikales Stapeln mehrerer Pooling-Schichten",
                  "nl": "Meerdere pooling-lagen verticaal stapelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Removing parts of the sequence during training",
                  "es": "Eliminar partes de la secuencia durante el entrenamiento",
                  "de": "Entfernen von Teilen der Sequenz während des Trainings",
                  "nl": "Delen van de sequentie verwijderen tijdens training"
        },
        {
                  "en": "Limiting backpropagation to fixed number of time steps to reduce memory and computation",
                  "es": "Limitar retropropagación número fijo pasos tiempo para reducir memoria y computación",
                  "de": "Begrenzung der Rückpropagation auf feste Anzahl Zeitschritte um Speicher und Berechnung zu reduzieren",
                  "nl": "Backpropagatie beperken tot vast aantal tijdstappen om geheugen en berekening te verminderen"
        },
        {
                  "en": "Using shorter sequences for faster training",
                  "es": "Usar secuencias más cortas para entrenamiento más rápido",
                  "de": "Verwendung kürzerer Sequenzen für schnelleres Training",
                  "nl": "Kortere sequenties gebruiken voor snellere training"
        },
        {
                  "en": "Stopping backpropagation when gradients become too small",
                  "es": "Detener retropropagación cuando gradientes se vuelven demasiado pequeños",
                  "de": "Stoppen der Rückpropagation wenn Gradienten zu klein werden",
                  "nl": "Backpropagatie stoppen wanneer gradiënten te klein worden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Treating neural network layers as continuous transformations described by differential equations",
                  "es": "Tratar capas de red neuronal como transformaciones continuas descritas por ecuaciones diferenciales",
                  "de": "Behandlung neuronaler Netzwerkschichten als kontinuierliche Transformationen beschrieben durch Differentialgleichungen",
                  "nl": "Neurale netwerklagen behandelen als continue transformaties beschreven door differentiaalvergelijkingen"
        },
        {
                  "en": "Ordinary networks trained on differential data",
                  "es": "Redes ordinarias entrenadas en datos diferenciales",
                  "de": "Gewöhnliche Netzwerke trainiert auf differentiellen Daten",
                  "nl": "Gewone netwerken getraind op differentiële data"
        },
        {
                  "en": "Mathematical notation for neural networks",
                  "es": "Notación matemática para redes neuronales",
                  "de": "Mathematische Notation für neuronale Netzwerke",
                  "nl": "Wiskundige notatie voor neurale netwerken"
        },
        {
                  "en": "Networks that solve differential equations",
                  "es": "Redes que resuelven ecuaciones diferenciales",
                  "de": "Netzwerke die Differentialgleichungen lösen",
                  "nl": "Netwerken die differentiaalvergelijkingen oplossen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sharing weights between different parts of the network to reduce parameters and improve generalization",
                  "es": "Compartir pesos entre diferentes partes de la red para reducir parámetros y mejorar generalización",
                  "de": "Teilen von Gewichten zwischen verschiedenen Teilen des Netzwerks um Parameter zu reduzieren und Generalisierung zu verbessern",
                  "nl": "Gewichten delen tussen verschillende delen van het netwerk om parameters te reduceren en generalisatie te verbeteren"
        },
        {
                  "en": "Tying weights together to prevent them from changing",
                  "es": "Atar pesos juntos para evitar que cambien",
                  "de": "Gewichte zusammenbinden um zu verhindern dass sie sich ändern",
                  "nl": "Gewichten samenbinden om te voorkomen dat ze veranderen"
        },
        {
                  "en": "Constraining weight values to specific ranges",
                  "es": "Restringir valores de peso a rangos específicos",
                  "de": "Beschränken von Gewichtswerten auf bestimmte Bereiche",
                  "nl": "Gewichtswaarden beperken tot specifieke bereiken"
        },
        {
                  "en": "Initializing weights with identical values",
                  "es": "Inicializar pesos con valores idénticos",
                  "de": "Initialisieren von Gewichten mit identischen Werten",
                  "nl": "Gewichten initialiseren met identieke waarden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Training a single model simultaneously on multiple related tasks to improve generalization through shared representations",
                  "es": "Entrenar un solo modelo simultáneamente en múltiples tareas relacionadas para mejorar generalización mediante representaciones compartidas",
                  "de": "Training eines einzelnen Modells gleichzeitig auf mehreren verwandten Aufgaben um Generalisierung durch gemeinsame Repräsentationen zu verbessern",
                  "nl": "Één model gelijktijdig trainen op meerdere gerelateerde taken om generalisatie te verbeteren door gedeelde representaties"
        },
        {
                  "en": "Teaching networks to multitask efficiently",
                  "es": "Enseñar a redes a realizar múltiples tareas eficientemente",
                  "de": "Netzwerke lehren effizient Multitasking durchzuführen",
                  "nl": "Netwerken leren efficiënt te multitasken"
        },
        {
                  "en": "Training multiple separate models for different tasks",
                  "es": "Entrenar múltiples modelos separados para diferentes tareas",
                  "de": "Training mehrerer separater Modelle für verschiedene Aufgaben",
                  "nl": "Meerdere afzonderlijke modellen trainen voor verschillende taken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Network for hyperparameter optimization",
                  "es": "Red para optimización de hiperparámetros",
                  "de": "Netzwerk für Hyperparameter-Optimierung",
                  "nl": "Netwerk voor hyperparameter optimalisatie"
        },
        {
                  "en": "A very large network with many parameters",
                  "es": "Red muy grande con muchos parámetros",
                  "de": "Sehr großes Netzwerk mit vielen Parametern",
                  "nl": "Zeer groot netwerk met veel parameters"
        },
        {
                  "en": "Network with hyperbolic activation functions",
                  "es": "Red con funciones de activación hiperbólicas",
                  "de": "Netzwerk mit hyperbolischen Aktivierungsfunktionen",
                  "nl": "Netwerk met hyperbolische activatiefuncties"
        },
        {
                  "en": "A neural network that generates weights for another network, enabling dynamic architectures",
                  "es": "Red neuronal que genera pesos para otra red, permitiendo arquitecturas dinámicas",
                  "de": "Neuronales Netzwerk das Gewichte für ein anderes Netzwerk generiert, ermöglicht dynamische Architekturen",
      ...
      },
      {
        ...
        },
        {
                  ...
                  "es": "Aprendizaje en línea es más rápido que offline",
                  "de": "Online-Lernen ist schneller als Offline-Lernen",
                  "nl": "Online leren is sneller dan offline leren"
        },
        {
                  "en": "Online learning updates model incrementally as new data arrives, offline learning uses entire dataset at once",
                  "es": "Aprendizaje en línea actualiza modelo incrementalmente cuando llegan nuevos datos, offline usa todo conjunto de datos a la vez",
                  "de": "Online-Lernen aktualisiert Modell inkrementell wenn neue Daten ankommen, Offline-Lernen verwendet gesamten Datensatz auf einmal",
                  "nl": "Online leren update model incrementeel wanneer nieuwe data arriveert, offline leren gebruikt hele dataset ineens"
        },
        {
                  "en": "Online learning requires internet, offline doesn't",
                  "es": "Aprendizaje en línea requiere internet, offline no",
                  "de": "Online-Lernen erfordert Internet, Offline nicht",
                  "nl": "Online leren vereist internet, offline niet"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Theory about neural network kernels in operating systems",
                  "es": "Teoría sobre kernels de redes neuronales en sistemas operativos",
                  "de": "Theorie über neuronale Netzwerk-Kernel in Betriebssystemen",
                  "nl": "Theorie over neurale netwerk kernels in besturingssystemen"
        },
        {
                  "en": "Method for tangent plane optimization",
                  "es": "Método para optimización de plano tangente",
                  "de": "Methode für Tangentialebenenoptimierung",
                  "nl": "Methode voor tangent vlak optimalisatie"
        },
        {
                  "en": "Tangential approach to neural architecture",
                  "es": "Enfoque tangencial a arquitectura neuronal",
                  "de": "Tangentialer Ansatz zur neuronalen Architektur",
                  "nl": "Tangentiële benadering van neurale architectuur"
        },
        {
                  "en": "Mathematical framework showing wide neural networks behave like kernel methods during training",
                  "es": "Marco matemático que muestra que redes neuronales anchas se comportan como métodos de kernel durante entrenamiento",
                  "de": "Mathematischer Rahmen der zeigt dass breite neuronale Netzwerke sich wie Kernel-Methoden während Training verhalten",
                  "nl": "Wiskundig raamwerk dat toont dat brede neurale netwerken zich gedragen als kernel methoden tijdens training"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training loss decreasing twice during training",
                  "es": "Pérdida de entrenamiento disminuyendo dos veces durante entrenamiento",
                  "de": "Trainingsverlust nimmt zweimal während Training ab",
                  "nl": "Trainingsverlies twee keer afnemen tijdens training"
        },
        {
                  "en": "Using gradient descent twice on same data",
                  "es": "Usar descenso de gradiente dos veces en mismos datos",
                  "de": "Gradientenabstieg zweimal auf denselben Daten verwenden",
                  "nl": "Gradient descent twee keer gebruiken op dezelfde data"
        },
        {
                  "en": "Test error first decreases, then increases with model complexity, then decreases again in overparameterized regime",
                  "es": "Error de prueba primero disminuye, luego aumenta con complejidad de modelo, luego disminuye nuevamente en régimen sobreparametrizado",
                  "de": "Testfehler nimmt zuerst ab, dann zu mit Modellkomplexität, dann wieder ab im überparametrisierten Regime",
                  "nl": "Test error neemt eerst af, dan toe met modelcomplexiteit, dan weer af in overparametrized regime"
        },
        {
                  "en": "Two separate phases of model convergence",
                  "es": "Dos fases separadas de convergencia de modelo",
                  "de": "Zwei separate Phasen der Modellkonvergenz",
                  "nl": "Twee afzonderlijke fasen van modelconvergentie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting network predictions to probabilities",
                  "es": "Convertir predicciones de red a probabilidades",
                  "de": "Netzwerkvorhersagen zu Wahrscheinlichkeiten konvertieren",
                  "nl": "Netwerkvoorspellingen converteren naar waarschijnlijkheden"
        },
        {
                  "en": "Translating neural network outputs to human language",
                  "es": "Traducir salidas de red neuronal a lenguaje humano",
                  "de": "Übersetzen von neuronalen Netzwerk-Ausgaben in menschliche Sprache",
                  "nl": "Neurale netwerk outputs vertalen naar menselijke taal"
        },
        {
                  "en": "Methods to understand and explain how neural networks make decisions and what they learn",
                  "es": "Métodos para entender y explicar cómo redes neuronales toman decisiones y qué aprenden",
                  "de": "Methoden um zu verstehen und zu erklären wie neuronale Netzwerke Entscheidungen treffen und was sie lernen",
                  "nl": "Methoden om te begrijpen en verklaren hoe neurale netwerken beslissingen nemen en wat ze leren"
        },
        {
                  "en": "Reading neural network architecture diagrams",
                  "es": "Leer diagramas de arquitectura de red neuronal",
                  "de": "Lesen von neuronalen Netzwerkarchitektur-Diagrammen",
                  "nl": "Neurale netwerkarchitectuur diagrammen lezen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trading off bias in activation functions",
                  "es": "Compensar sesgo en funciones de activación",
                  "de": "Kompromiss bei Bias in Aktivierungsfunktionen",
                  "nl": "Afwegen van bias in activatiefuncties"
        },
        {
                  "en": "Choice between biased and unbiased datasets",
                  "es": "Elección entre conjuntos de datos sesgados y no sesgados",
                  "de": "Wahl zwischen voreingenommenen und unvoreingenommenen Datensätzen",
                  "nl": "Keuze tussen bevooroordeelde en onbevooroordeelde datasets"
        },
        {
                  "en": "Balance between model's ability to fit training data (low bias) and generalize to new data (low variance)",
                  "es": "Equilibrio entre capacidad de modelo para ajustar datos entrenamiento (bajo sesgo) y generalizar a nuevos datos (baja varianza)",
                  "de": "Balance zwischen Fähigkeit des Modells Trainingsdaten anzupassen (niedriger Bias) und auf neue Daten zu generalisieren (niedrige Varianz)",
                  "nl": "Balans tussen vermogen van model om trainingsdata te fitten (lage bias) en generaliseren naar nieuwe data (lage variantie)"
        },
        {
                  "en": "Balancing model fairness and accuracy",
                  "es": "Equilibrar equidad y precisión del modelo",
                  "de": "Ausbalancieren von Modell-Fairness und Genauigkeit",
                  "nl": "Balanceren van model eerlijkheid en nauwkeurigheid"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gradients increasing over time",
                  "es": "Gradientes aumentando con el tiempo",
                  "de": "Gradienten die im Laufe der Zeit zunehmen",
                  "nl": "Gradiënten die toenemen over tijd"
        },
        {
                  "en": "Storing all gradients throughout training",
                  "es": "Almacenar todos los gradientes durante todo el entrenamiento",
                  "de": "Speichern aller Gradienten während gesamtem Training",
                  "nl": "Alle gradiënten opslaan gedurende hele training"
        },
        {
                  "en": "Summing gradients over multiple mini-batches before updating weights to simulate larger batch sizes",
                  "es": "Sumar gradientes sobre múltiples mini-lotes antes de actualizar pesos para simular tamaños de lote más grandes",
                  "de": "Summieren von Gradienten über mehrere Mini-Batches vor Gewichtsaktualisierung um größere Batch-Größen zu simulieren",
                  "nl": "Gradiënten optellen over meerdere mini-batches voor gewicht update om grotere batchgroottes te simuleren"
        },
        {
                  "en": "Accumulating momentum in optimization",
                  "es": "Acumular momento en optimización",
                  "de": "Akkumulieren von Momentum in Optimierung",
                  "nl": "Momentum accumuleren in optimalisatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trading computation for memory by recomputing intermediate activations during backpropagation instead of storing them",
                  "es": "Intercambiar computación por memoria recomputando activaciones intermedias durante retropropagación en lugar de almacenarlas",
                  "de": "Tauschen von Berechnung gegen Speicher durch Neuberechnung intermediärer Aktivierungen während Rückpropagation statt sie zu speichern",
                  "nl": "Berekening ruilen voor geheugen door tussenactivaties opnieuw te berekenen tijdens backpropagation in plaats van ze op te slaan"
        },
        {
                  "en": "Storing gradient history for analysis",
                  "es": "Almacenar historial de gradiente para análisis",
                  "de": "Speichern von Gradientenverlauf für Analyse",
                  "nl": "Gradiëntgeschiedenis opslaan voor analyse"
        },
        {
                  "en": "Checking gradient values before updating",
                  "es": "Verificar valores de gradiente antes de actualizar",
                  "de": "Prüfen von Gradientenwerten vor Aktualisierung",
                  "nl": "Gradiëntwaarden controleren voor update"
        },
        {
                  "en": "Saving model checkpoints at gradient thresholds",
                  "es": "Guardar puntos de control de modelo en umbrales de gradiente",
                  "de": "Speichern von Modell-Checkpoints bei Gradienten-Schwellenwerten",
                  "nl": "Model checkpoints opslaan bij gradiënt drempels"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining different accuracy metrics",
                  "es": "Combinar diferentes métricas de precisión",
                  "de": "Kombinieren verschiedener Genauigkeitsmetriken",
                  "nl": "Verschillende nauwkeurigheidsmetrieken combineren"
        },
        {
                  "en": "Training with varying levels of precision across layers",
                  "es": "Entrenar con niveles variables de precisión entre capas",
                  "de": "Training mit variierenden Präzisionsniveaus über Schichten",
                  "nl": "Trainen met variërende precisieniveaus over lagen"
        },
        {
                  "en": "Using both float16 and float32 data types during training to speed up computation while maintaining accuracy",
                  "es": "Usar tipos de datos float16 y float32 durante entrenamiento para acelerar computación mientras mantiene precisión",
                  "de": "Verwendung von float16 und float32 Datentypen während Training um Berechnung zu beschleunigen bei Erhalt der Genauigkeit",
                  "nl": "Zowel float16 als float32 datatypen gebruiken tijdens training om berekening te versnellen terwijl nauwkeurigheid behouden blijft"
        },
        {
                  "en": "Using approximate and exact calculations together",
                  "es": "Usar cálculos aproximados y exactos juntos",
                  "de": "Verwendung approximativer und exakter Berechnungen zusammen",
                  "nl": "Gebruik van benaderende en exacte berekeningen samen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Technique to automatically compute gradients of functions by applying chain rule to computational graphs",
                  "es": "Técnica para computar automáticamente gradientes de funciones aplicando regla de la cadena a grafos computacionales",
                  "de": "Technik zum automatischen Berechnen von Gradienten von Funktionen durch Anwendung der Kettenregel auf Berechnungsgraphen",
                  "nl": "Techniek om automatisch gradiënten van functies te berekenen door kettingregel toe te passen op computational graphs"
        },
        {
                  "en": "Differentiation that requires no manual intervention",
                  "es": "Diferenciación que no requiere intervención manual",
                  "de": "Differenzierung die keine manuelle Intervention erfordert",
                  "nl": "Differentiatie die geen handmatige interventie vereist"
        },
        {
                  "en": "Automatically detecting differences between models",
                  "es": "Detectar automáticamente diferencias entre modelos",
                  "de": "Automatisches Erkennen von Unterschieden zwischen Modellen",
                  "nl": "Automatisch detecteren van verschillen tussen modellen"
        },
        {
                  "en": "Computing derivatives symbolically",
                  "es": "Computar derivadas simbólicamente",
                  "de": "Berechnen von Ableitungen symbolisch",
                  "nl": "Afgeleiden symbolisch berekenen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sets the total number of training examples",
                  "es": "Establece número total de ejemplos de entrenamiento",
                  "de": "Legt Gesamtzahl der Trainingsbeispiele fest",
                  "nl": "Stelt totaal aantal trainingsvoorbeelden in"
        },
        {
                  "en": "Determines number of samples processed together before updating weights, affecting training speed and stability",
                  "es": "Determina número de muestras procesadas juntas antes de actualizar pesos, afectando velocidad y estabilidad de entrenamiento",
                  "de": "Bestimmt Anzahl Proben die zusammen verarbeitet werden vor Gewichtsaktualisierung, beeinflusst Trainingsgeschwindigkeit und Stabilität",
                  "nl": "Bepaalt aantal samples verwerkt samen voor gewicht update, beïnvloedt trainingssnelheid en stabiliteit"
        },
        {
                  "en": "Controls how many epochs to train",
                  "es": "Controla cuántas épocas entrenar",
                  "de": "Steuert wie viele Epochen zu trainieren",
                  "nl": "Bepaalt hoeveel epochs te trainen"
        },
        {
                  "en": "Defines network architecture size",
                  "es": "Define tamaño de arquitectura de red",
                  "de": "Definiert Netzwerkarchitekturgröße",
                  "nl": "Definieert netwerkarchitectuur grootte"
        }
        ],
        correct: 1,
        explanation: {
