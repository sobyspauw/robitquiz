    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Creating semantic labels for images",
                  "es": "Crear etiquetas semánticas para imágenes",
                  "de": "Semantische Labels für Bilder erstellen",
                  "nl": "Semantische labels voor afbeeldingen maken"
        },
        {
                  "en": "Classifying every pixel in an image to understand scene structure",
                  "es": "Clasificar cada píxel en una imagen para entender la estructura de la escena",
                  "de": "Jeden Pixel in einem Bild klassifizieren um Szenenstruktur zu verstehen",
                  "nl": "Elke pixel in een afbeelding classificeren om scènestructuur te begrijpen"
        },
        {
                  "en": "Segmenting images by semantic meaning only",
                  "es": "Segmentar imágenes solo por significado semántico",
                  "de": "Bilder nur nach semantischer Bedeutung segmentieren",
                  "nl": "Afbeeldingen alleen segmenteren op semantische betekenis"
        },
        {
                  "en": "Segmenting text within images",
                  "es": "Segmentar texto dentro de imágenes",
                  "de": "Text in Bildern segmentieren",
                  "nl": "Tekst in afbeeldingen segmenteren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using only grayscale medical images",
                  "es": "Usar solo imágenes médicas en escala de grises",
                  "de": "Nur Graustufenbilder medizinischer Bilder verwenden",
                  "nl": "Alleen grijstinten medische afbeeldingen gebruiken"
        },
        {
                  "en": "Skip connections that combine low-level and high-level features for precise localization",
                  "es": "Conexiones de salto que combinan características de bajo y alto nivel para localización precisa",
                  "de": "Skip-Verbindungen die Low-Level und High-Level Features für präzise Lokalisierung kombinieren",
                  "nl": "Skip verbindingen die low-level en high-level features combineren voor precieze lokalisatie"
        },
        {
                  "en": "U-shaped physical design of the network",
                  "es": "Diseño físico en forma de U de la red",
                  "de": "U-förmiges physisches Design des Netzwerks",
                  "nl": "U-vormig fysiek ontwerp van het netwerk"
        },
        {
                  "en": "Using only medical datasets for training",
                  "es": "Usar solo conjuntos de datos médicos para entrenamiento",
                  "de": "Nur medizinische Datensätze für Training verwenden",
                  "nl": "Alleen medische datasets gebruiken voor training"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Focusing computational resources on the most relevant parts of an image",
                  "es": "Enfocar recursos computacionales en las partes más relevantes de una imagen",
                  "de": "Rechenressourcen auf die relevantesten Teile eines Bildes fokussieren",
                  "nl": "Computationele bronnen focussen op de meest relevante delen van een afbeelding"
        },
        {
                  "en": "Alerting users when objects are detected",
                  "es": "Alertar a usuarios cuando se detectan objetos",
                  "de": "Benutzer alarmieren wenn Objekte erkannt werden",
                  "nl": "Gebruikers waarschuwen wanneer objecten worden gedetecteerd"
        },
        {
                  "en": "Attending to image quality issues",
                  "es": "Atender problemas de calidad de imagen",
                  "de": "Bildqualitätsprobleme beachten",
                  "nl": "Aandacht besteden aan beeldkwaliteitsproblemen"
        },
        {
                  "en": "Making models pay attention to training",
                  "es": "Hacer que los modelos presten atención al entrenamiento",
                  "de": "Modelle dazu bringen dem Training Aufmerksamkeit zu schenken",
                  "nl": "Modellen aandacht laten besteden aan training"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They are faster than all CNN architectures",
                  "es": "Son más rápidos que todas las arquitecturas CNN",
                  "de": "Sie sind schneller als alle CNN-Architekturen",
                  "nl": "Ze zijn sneller dan alle CNN architecturen"
        },
        {
                  "en": "They transform vision into text",
                  "es": "Transforman visión en texto",
                  "de": "Sie transformieren Vision in Text",
                  "nl": "Ze transformeren visie naar tekst"
        },
        {
                  "en": "They work only with transformer hardware",
                  "es": "Solo funcionan con hardware transformer",
                  "de": "Sie funktionieren nur mit Transformer-Hardware",
                  "nl": "Ze werken alleen met transformer hardware"
        },
        {
                  "en": "Global self-attention captures long-range dependencies better than local convolutions",
                  "es": "La auto-atención global captura dependencias de largo alcance mejor que las convoluciones locales",
                  "de": "Globale Selbstaufmerksamkeit erfasst weitreichende Abhängigkeiten besser als lokale Faltungen",
                  "nl": "Globale self-attention vangt lange-afstand afhankelijkheden beter dan lokale convoluties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Medical images are always in black and white",
                  "es": "Las imágenes médicas siempre están en blanco y negro",
                  "de": "Medizinische Bilder sind immer schwarz-weiß",
                  "nl": "Medische afbeeldingen zijn altijd zwart-wit"
        },
        {
                  "en": "Medical equipment is incompatible with AI",
                  "es": "El equipo médico es incompatible con IA",
                  "de": "Medizinische Geräte sind inkompatibel mit KI",
                  "nl": "Medische apparatuur is incompatibel met AI"
        },
        {
                  "en": "Doctors don't understand AI technology",
                  "es": "Los doctores no entienden la tecnología IA",
                  "de": "Ärzte verstehen KI-Technologie nicht",
                  "nl": "Artsen begrijpen AI-technologie niet"
        },
        {
                  "en": "Limited labeled datasets and need for high precision to avoid misdiagnosis",
                  "es": "Conjuntos de datos etiquetados limitados y necesidad de alta precisión para evitar diagnósticos erróneos",
                  "de": "Begrenzte beschriftete Datensätze und Bedarf an hoher Präzision um Fehldiagnosen zu vermeiden",
                  "nl": "Beperkte gelabelde datasets en behoefte aan hoge precisie om verkeerde diagnoses te voorkomen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "R-CNN only uses rectangular windows",
                  "es": "R-CNN solo usa ventanas rectangulares",
                  "de": "R-CNN verwendet nur rechteckige Fenster",
                  "nl": "R-CNN gebruikt alleen rechthoekige vensters"
        },
        {
                  "en": "R-CNN processes images faster",
                  "es": "R-CNN procesa imágenes más rápido",
                  "de": "R-CNN verarbeitet Bilder schneller",
                  "nl": "R-CNN verwerkt afbeeldingen sneller"
        },
        {
                  "en": "R-CNN requires less training data",
                  "es": "R-CNN requiere menos datos de entrenamiento",
                  "de": "R-CNN benötigt weniger Trainingsdaten",
                  "nl": "R-CNN vereist minder trainingsdata"
        },
        {
                  "en": "Selective search for region proposals reduces computational cost and improves accuracy",
                  "es": "Búsqueda selectiva para propuestas de región reduce costo computacional y mejora precisión",
                  "de": "Selektive Suche für Regionsvorschläge reduziert Rechenkosten und verbessert Genauigkeit",
                  "nl": "Selectieve zoektocht voor regiovoorstellen vermindert computationele kosten en verbetert nauwkeurigheid"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Simplifying the CNN architecture",
                  "es": "Simplificar la arquitectura CNN",
                  "de": "CNN-Architektur vereinfachen",
                  "nl": "CNN architectuur vereenvoudigen"
        },
        {
                  "en": "Reducing image resolution",
                  "es": "Reducir resolución de imagen",
                  "de": "Bildauflösung reduzieren",
                  "nl": "Beeldresolutie verminderen"
        },
        {
                  "en": "Using faster processors only",
                  "es": "Usar solo procesadores más rápidos",
                  "de": "Nur schnellere Prozessoren verwenden",
                  "nl": "Alleen snellere processors gebruiken"
        },
        {
                  "en": "Sharing convolutional computations across region proposals using ROI pooling",
                  "es": "Compartir computaciones convolucionales entre propuestas de región usando pooling ROI",
                  "de": "Teilen von Faltungsberechnungen zwischen Regionsvorschlägen mittels ROI-Pooling",
                  "nl": "Convolutionele berekeningen delen tussen regiovoorstellen met behulp van ROI pooling"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reduced training time only",
                  "es": "Solo tiempo de entrenamiento reducido",
                  "de": "Nur reduzierte Trainingszeit",
                  "nl": "Alleen verminderde trainingstijd"
        },
        {
                  "en": "Region Proposal Network (RPN) that generates object proposals within the CNN",
                  "es": "Red de Propuesta de Región (RPN) que genera propuestas de objetos dentro de la CNN",
                  "de": "Region Proposal Network (RPN) das Objektvorschläge innerhalb der CNN generiert",
                  "nl": "Region Proposal Network (RPN) die objectvoorstellen genereert binnen de CNN"
        },
        {
                  "en": "Faster GPU processing",
                  "es": "Procesamiento GPU más rápido",
                  "de": "Schnellere GPU-Verarbeitung",
                  "nl": "Snellere GPU verwerking"
        },
        {
                  "en": "Smaller network architecture",
                  "es": "Arquitectura de red más pequeña",
                  "de": "Kleinere Netzwerkarchitektur",
                  "nl": "Kleinere netwerkarchitectuur"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dense optical flow computation only",
                  "es": "Solo computación de flujo óptico denso",
                  "de": "Nur dichte Optical Flow Berechnung",
                  "nl": "Alleen dichte optische flow berekening"
        },
        {
                  "en": "Computing sparse optical flow by tracking good features across frames",
                  "es": "Computar flujo óptico disperso rastreando buenas características a través de fotogramas",
                  "de": "Spärlichen Optical Flow berechnen durch Verfolgung guter Features über Frames",
                  "nl": "Schaarse optische flow berekenen door goede kenmerken te volgen over frames"
        },
        {
                  "en": "Image enhancement techniques",
                  "es": "Técnicas de mejora de imagen",
                  "de": "Bildverbesserungstechniken",
                  "nl": "Beeldverbeteringstechnieken"
        },
        {
                  "en": "Camera calibration procedures",
                  "es": "Procedimientos de calibración de cámara",
                  "de": "Kamerakalibrierungsverfahren",
                  "nl": "Camera calibratieprocedures"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Brightness constancy constraint - pixel intensities remain constant as they move",
                  "es": "Restricción de constancia de brillo - intensidades de píxel permanecen constantes mientras se mueven",
                  "de": "Helligkeitskonstanz-Beschränkung - Pixelintensitäten bleiben konstant während sie sich bewegen",
                  "nl": "Helderheidsconstantie beperking - pixelintensiteiten blijven constant terwijl ze bewegen"
        },
        {
                  "en": "Camera position never changes",
                  "es": "La posición de la cámara nunca cambia",
                  "de": "Kameraposition ändert sich nie",
                  "nl": "Camerapositie verandert nooit"
        },
        {
                  "en": "All motion is horizontal only",
                  "es": "Todo movimiento es solo horizontal",
                  "de": "Alle Bewegung ist nur horizontal",
                  "nl": "Alle beweging is alleen horizontaal"
        },
        {
                  "en": "Objects always move in straight lines",
                  "es": "Los objetos siempre se mueven en líneas rectas",
                  "de": "Objekte bewegen sich immer in geraden Linien",
                  "nl": "Objecten bewegen altijd in rechte lijnen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Ambigüedad en dirección de movimiento al observar movimiento a través de una apertura pequeña",
                  "de": "Mehrdeutigkeit in Bewegungsrichtung beim Beobachten von Bewegung durch kleine Öffnung",
                  "nl": "Dubbelzinnigheid in bewegingsrichting bij het observeren van beweging door een kleine opening"
        },
        {
                  "en": "Problems with wide-angle lenses",
                  "es": "Problemas con lentes gran angular",
                  "de": "Probleme mit Weitwinkelobjektiven",
                  "nl": "Problemen met groothoeklenzen"
        },
        {
                  "en": "Difficulties in low-light conditions",
                  "es": "Dificultades en condiciones de poca luz",
                  "de": "Schwierigkeiten bei schlechten Lichtverhältnissen",
                  "nl": "Moeilijkheden bij weinig licht"
        },
        {
                  "en": "Camera aperture settings affecting image quality",
                  "es": "Configuraciones de apertura de cámara afectando calidad de imagen",
                  "de": "Kameraapertur-Einstellungen beeinflussen Bildqualität",
                  "nl": "Camera apertuurinstellingen die beeldkwaliteit beïnvloeden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tracking objects by iteratively finding the mode of a probability distribution",
                  "es": "Rastrear objetos encontrando iterativamente el modo de una distribución de probabilidad",
                  "de": "Objekte verfolgen durch iteratives Finden des Modus einer Wahrscheinlichkeitsverteilung",
                  "nl": "Objecten volgen door iteratief de modus van een waarschijnlijkheidsverdeling te vinden"
        },
        {
                  "en": "Shifting image brightness levels",
                  "es": "Cambiar niveles de brillo de imagen",
                  "de": "Bildhelligkeit-Level verschieben",
                  "nl": "Beeldhelderheidsniveaus verschuiven"
        },
        {
                  "en": "Calculating average pixel values",
                  "es": "Calcular valores promedio de píxeles",
                  "de": "Durchschnittliche Pixelwerte berechnen",
                  "nl": "Gemiddelde pixelwaarden berekenen"
        },
        {
                  "en": "Measuring camera shake",
                  "es": "Medir vibración de cámara",
                  "de": "Kamerawackeln messen",
                  "nl": "Cameratrillingen meten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Smoothing object trajectories only",
                  "es": "Solo suavizar trayectorias de objetos",
                  "de": "Nur Objektbahnen glätten",
                  "nl": "Alleen objecttrajecten gladstrijken"
        },
        {
                  "en": "Filtering out noise from images",
                  "es": "Filtrar ruido de imágenes",
                  "de": "Rauschen aus Bildern filtern",
                  "nl": "Ruis uit afbeeldingen filteren"
        },
        {
                  "en": "Detecting object boundaries",
                  "es": "Detectar límites de objetos",
                  "de": "Objektgrenzen erkennen",
                  "nl": "Objectgrenzen detecteren"
        },
        {
                  "en": "Predicting future object states and handling uncertainty in measurements",
                  "es": "Predecir estados futuros de objetos y manejar incertidumbre en mediciones",
                  "de": "Zukünftige Objektzustände vorhersagen und Unsicherheit in Messungen handhaben",
                  "nl": "Toekomstige objecttoestanden voorspellen en onzekerheid in metingen hanteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tracking only the largest objects",
                  "es": "Rastrear solo los objetos más grandes",
                  "de": "Nur die größten Objekte verfolgen",
                  "nl": "Alleen de grootste objecten volgen"
        },
        {
                  "en": "Detecting multiple object types",
                  "es": "Detectar múltiples tipos de objetos",
                  "de": "Mehrere Objekttypen erkennen",
                  "nl": "Meerdere objecttypes detecteren"
        },
        {
                  "en": "Counting total number of objects",
                  "es": "Contar número total de objetos",
                  "de": "Gesamtzahl der Objekte zählen",
                  "nl": "Totaal aantal objecten tellen"
        },
        {
                  "en": "Maintaining consistent identities for multiple objects while tracking their movements",
                  "es": "Mantener identidades consistentes para múltiples objetos mientras rastrea sus movimientos",
                  "de": "Konsistente Identitäten für mehrere Objekte beibehalten während ihrer Bewegungsverfolgung",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cultural analysis of tracking patterns",
                  "es": "Análisis cultural de patrones de seguimiento",
                  "de": "Kulturelle Analyse von Tracking-Mustern",
                  "nl": "Culturele analyse van tracking patronen"
        },
        {
                  "en": "Solving the assignment problem to optimally match detections with existing tracks",
                  "es": "Resolver el problema de asignación para coincidir óptimamente detecciones con pistas existentes",
                  "de": "Das Zuordnungsproblem lösen um Erkennungen optimal mit bestehenden Spuren zu verknüpfen",
                  "nl": "Het toewijzingsprobleem oplossen om detecties optimaal te matchen met bestaande sporen"
        },
        {
                  "en": "Hungarian language processing",
                  "es": "Procesamiento de idioma húngaro",
                  "de": "Ungarische Sprachverarbeitung",
                  "nl": "Hongaarse taalverwerking"
        },
        {
                  "en": "Geographic tracking applications",
                  "es": "Aplicaciones de seguimiento geográfico",
                  "de": "Geografische Tracking-Anwendungen",
                  "nl": "Geografische tracking applicaties"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Better bounding box regression",
                  "es": "Mejor regresión de caja delimitadora",
                  "de": "Bessere Bounding Box Regression",
                  "nl": "Betere bounding box regressie"
        },
        {
                  "en": "Adding deep appearance features to reduce identity switches during occlusions",
                  "es": "Agregar características de apariencia profunda para reducir cambios de identidad durante oclusiones",
                  "de": "Tiefe Erscheinungsmerkmale hinzufügen um Identitätswechsel während Verdeckungen zu reduzieren",
                  "nl": "Diepe verschijningskenmerken toevoegen om identiteitswisselingen tijdens occlusies te verminderen"
        },
        {
                  "en": "Faster processing speed",
                  "es": "Velocidad de procesamiento más rápida",
                  "de": "Schnellere Verarbeitungsgeschwindigkeit",
                  "nl": "Snellere verwerkingssnelheid"
        },
        {
                  "en": "Deeper neural network architectures only",
                  "es": "Solo arquitecturas de redes neuronales más profundas",
                  "de": "Nur tiefere neuronale Netzwerkarchitekturen",
                  "nl": "Alleen diepere neurale netwerkarchitecturen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Balancing tracking accuracy with computational efficiency for real-time performance",
                  "es": "Equilibrar precisión de seguimiento con eficiencia computacional para rendimiento en tiempo real",
                  "de": "Tracking-Genauigkeit mit rechnerischer Effizienz für Echtzeit-Performance ausbalancieren",
                  "nl": "Tracking nauwkeurigheid balanceren met computationele efficiëntie voor real-time prestaties"
        },
        {
                  "en": "Working with poor lighting conditions",
                  "es": "Trabajar con condiciones de iluminación pobres",
                  "de": "Arbeiten bei schlechten Lichtverhältnissen",
                  "nl": "Werken met slechte verlichtingsomstandigheden"
        },
        {
                  "en": "Only processing high-resolution images",
                  "es": "Solo procesar imágenes de alta resolución",
                  "de": "Nur hochauflösende Bilder verarbeiten",
                  "nl": "Alleen hoogresolutie afbeeldingen verwerken"
        },
        {
                  "en": "Tracking multiple object types",
                  "es": "Rastrear múltiples tipos de objetos",
                  "de": "Mehrere Objekttypen verfolgen",
                  "nl": "Meerdere objecttypes volgen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measuring image quality",
                  "es": "Medir calidad de imagen",
                  "de": "Bildqualität messen",
                  "nl": "Beeldkwaliteit meten"
        },
        {
                  "en": "Measuring the overlap between predicted and ground truth bounding boxes",
                  "es": "Medir la superposición entre cajas delimitadoras predichas y de verdad fundamental",
                  "de": "Überlappung zwischen vorhergesagten und Ground Truth Bounding Boxes messen",
                  "nl": "Overlap meten tussen voorspelde en ground truth bounding boxes"
        },
        {
                  "en": "Calculating network training speed",
                  "es": "Calcular velocidad de entrenamiento de red",
                  "de": "Netzwerk-Trainingsgeschwindigkeit berechnen",
                  "nl": "Netwerktrainingssnelheid berekenen"
        },
        {
                  "en": "Evaluating color accuracy",
                  "es": "Evaluar precisión de color",
                  "de": "Farbgenauigkeit bewerten",
                  "nl": "Kleurnauwkeurigheid evalueren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Providing reference templates at multiple scales and aspect ratios for object localization",
                  "es": "Proporcionar plantillas de referencia en múltiples escalas y proporciones para localización de objetos",
                  "de": "Referenzvorlagen in mehreren Skalen und Seitenverhältnissen für Objektlokalisierung bereitstellen",
                  "nl": "Referentiesjablonen bieden op meerdere schalen en aspectverhoudingen voor objectlokalisatie"
        },
        {
        ...
        {
                  "en": "Anchoring images to prevent movement",
                  "es": "Anclar imágenes para prevenir movimiento",
                  "de": "Bilder verankern um Bewegung zu verhindern",
                  "nl": "Afbeeldingen verankeren om beweging te voorkomen"
        },
        {
                  "en": "Creating stable reference points only",
                  "es": "Crear solo puntos de referencia estables",
                  "de": "Nur stabile Referenzpunkte erstellen",
                  "nl": "Alleen stabiele referentiepunten maken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Instance segmentation distinguishes between individual objects of the same class",
                  "es": "La segmentación de instancias distingue entre objetos individuales de la misma clase",
                  "de": "Instanzsegmentierung unterscheidet zwischen individuellen Objekten derselben Klasse",
                  "nl": "Instantiesegmentatie onderscheidt tussen individuele objecten van dezelfde klasse"
        },
        {
                  "en": "Instance segmentation processes instances faster",
                  "es": "La segmentación de instancias procesa instancias más rápido",
                  "de": "Instanzsegmentierung verarbeitet Instanzen schneller",
                  "nl": "Instantiesegmentatie verwerkt instanties sneller"
        },
        {
                  "en": "Instance segmentation only works with single objects",
                  "es": "La segmentación de instancias solo funciona con objetos únicos",
                  "de": "Instanzsegmentierung funktioniert nur mit einzelnen Objekten",
                  "nl": "Instantiesegmentatie werkt alleen met enkele objecten"
        },
        {
                  "en": "Instance segmentation uses different color schemes",
                  "es": "La segmentación de instancias usa esquemas de color diferentes",
                  "de": "Instanzsegmentierung verwendet verschiedene Farbschemata",
                  "nl": "Instantiesegmentatie gebruikt verschillende kleurschema's"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Map of average pixel values",
                  "es": "Mapa de valores promedio de píxeles",
                  "de": "Karte durchschnittlicher Pixelwerte",
                  "nl": "Kaart van gemiddelde pixelwaarden"
        },
        {
                  "en": "Maximum achievable precision",
                  "es": "Precisión máxima alcanzable",
                  "de": "Maximal erreichbare Präzision",
                  "nl": "Maximaal haalbare precisie"
        },
        {
                  "en": "Mean accuracy percentage of predictions",
                  "es": "Porcentaje de precisión media de predicciones",
                  "de": "Mittlerer Genauigkeitsprozentsatz von Vorhersagen",
                  "nl": "Gemiddeld nauwkeurigheidspercentage van voorspellingen"
        },
        {
                  "en": "Average of precision values across different recall levels and object classes",
                  "es": "Promedio de valores de precisión en diferentes niveles de recall y clases de objetos",
                  "de": "Durchschnitt von Präzisionswerten über verschiedene Recall-Stufen und Objektklassen",
                  "nl": "Gemiddelde van precisiewaarden over verschillende recall niveaus en objectklassen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Create pyramid-shaped network architectures",
        ...
        {
                  "en": "Organize features hierarchically only",
                  "es": "Organizar características solo jerárquicamente",
                  "de": "Features nur hierarchisch organisieren",
                  "nl": "Features alleen hiërarchisch organiseren"
        },
        {
                  "en": "Build multi-scale feature representations for detecting objects at various sizes",
                  "es": "Construir representaciones de características multi-escala para detectar objetos de varios tamaños",
                  "de": "Multi-Skalen-Feature-Repräsentationen aufbauen zum Erkennen von Objekten verschiedener Größen",
                  "nl": "Multi-schaal feature representaties bouwen voor detectie van objecten van verschillende groottes"
        },
        {
                  "en": "Reduce computational costs through pyramids",
                  "es": "Reducir costos computacionales mediante pirámides",
                  "de": "Rechenkosten durch Pyramiden reduzieren",
                  "nl": "Computationele kosten verminderen door piramides"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Requires looking at images only once during training",
                  "es": "Requiere mirar imágenes solo una vez durante entrenamiento",
                  "de": "Erfordert Bilder nur einmal während Training anzusehen",
                  "nl": "Vereist afbeeldingen maar één keer te bekijken tijdens training"
        },
        {
                  "en": "Uses one neural network layer only",
                  "es": "Usa solo una capa de red neuronal",
                  "de": "Verwendet nur eine neuronale Netzwerkschicht",
                  "nl": "Gebruikt slechts één neurale netwerklaag"
        },
        {
                  "en": "Processes one object at a time",
                  "es": "Procesa un objeto a la vez",
                  "de": "Verarbeitet ein Objekt gleichzeitig",
                  "nl": "Verwerkt één object tegelijk"
        },
        {
                  "en": "Single-stage detector that predicts bounding boxes and class probabilities directly from full images",
                  "es": "Detector de una etapa que predice cajas delimitadoras y probabilidades de clase directamente de imágenes completas",
                  "de": "Einstufiger Detektor der Bounding Boxes und Klassenwahrscheinlichkeiten direkt aus vollständigen Bildern vorhersagt",
                  "nl": "Enkele-fase detector die bounding boxes en klassewaarschijnlijkheden direct voorspelt uit volledige afbeeldingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Create class activation maps for cameras",
                  "es": "Crear mapas de activación de clase para cámaras",
                  "de": "Klassen-Aktivierungskarten für Kameras erstellen",
                  "nl": "Klasse activatiekaarten maken voor camera's"
        },
        {
                  "en": "Map gradients to classes automatically",
                  "es": "Mapear gradientes a clases automáticamente",
                  "de": "Gradienten automatisch auf Klassen abbilden",
                  "nl": "Gradiënten automatisch op klassen mappen"
        },
        {
                  "en": "Activate gradient descent during training",
                  "es": "Activar descenso de gradiente durante entrenamiento",
                  "de": "Gradientenabstieg während Training aktivieren",
                  "nl": "Gradient descent activeren tijdens training"
        },
        {
                  "en": "Visualize which image regions CNN focuses on for predictions",
                  "es": "Visualizar en qué regiones de imagen se enfoca CNN para predicciones",
                  "de": "Visualisieren welche Bildbereiche CNN für Vorhersagen fokussiert",
                  "nl": "Visualiseren op welke beeldregio's CNN zich focust voor voorspellingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Region-based classification only",
                  "es": "Solo clasificación basada en región",
                  "de": "Nur regionsbasierte Klassifikation",
                  "nl": "Alleen regio-gebaseerde classificatie"
        },
        {
                  "en": "Masking regions of images during processing",
                  "es": "Enmascarar regiones de imágenes durante procesamiento",
                  "de": "Regionen von Bildern während Verarbeitung maskieren",
                  "nl": "Regio's van afbeeldingen maskeren tijdens verwerking"
        },
        {
                  "en": "Instance segmentation by adding mask prediction branch to Faster R-CNN",
                  "es": "Segmentación de instancias agregando rama de predicción de máscara a Faster R-CNN",
                  "de": "Instanzsegmentierung durch Hinzufügen eines Maskenvorhersage-Zweigs zu Faster R-CNN",
                  "nl": "Instance segmentatie door masker voorspellingstak toe te voegen aan Faster R-CNN"
        },
        {
                  "en": "Creating masks for CNN layers",
                  "es": "Crear máscaras para capas CNN",
                  "de": "Masken für CNN-Schichten erstellen",
                  "nl": "Maskers maken voor CNN lagen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using adversarial loss functions only",
                  "es": "Usar solo funciones de pérdida adversarias",
                  "de": "Nur adversariale Verlustfunktionen verwenden",
                  "nl": "Alleen adversarial verliesfuncties gebruiken"
        },
        {
                  "en": "Training models to compete in adversarial tasks",
                  "es": "Entrenar modelos para competir en tareas adversarias",
                  "de": "Modelle trainieren um in adversarialen Aufgaben zu konkurrieren",
                  "nl": "Modellen trainen om te concurreren in adversarial taken"
        },
        {
                  "en": "Training models on adversarial examples to improve robustness against perturbations",
                  "es": "Entrenar modelos en ejemplos adversarios para mejorar robustez contra perturbaciones",
                  "de": "Modelle auf adversarialen Beispielen trainieren um Robustheit gegen Störungen zu verbessern",
                  "nl": "Modellen trainen op adversarial voorbeelden om robuustheid tegen verstoringen te verbeteren"
        },
        {
                  "en": "Training two adversarial networks simultaneously",
                  "es": "Entrenar dos redes adversarias simultáneamente",
                  "de": "Zwei adversariale Netzwerke gleichzeitig trainieren",
                  "nl": "Twee adversarial netwerken gelijktijdig trainen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adapting models trained on one domain to perform well on a different domain",
                  "es": "Adaptar modelos entrenados en un dominio para funcionar bien en un dominio diferente",
                  "de": "Modelle die auf einer Domäne trainiert wurden anpassen um auf einer anderen Domäne gut zu funktionieren",
                  "nl": "Modellen getraind op één domein aanpassen om goed te presteren op een ander domein"
        },
        {
                  "en": "Changing model domains during training",
                  "es": "Cambiar dominios de modelo durante entrenamiento",
                  "de": "Modelldomänen während Training ändern",
                  "nl": "Modeldomeinen wijzigen tijdens training"
        },
        {
                  "en": "Adapting to different internet domains",
                  "es": "Adaptarse a diferentes dominios de internet",
                  "de": "Anpassung an verschiedene Internetdomänen",
                  "nl": "Aanpassen aan verschillende internetdomeinen"
        },
        {
                  "en": "Training models for domain-specific tasks only",
                  "es": "Entrenar modelos solo para tareas específicas de dominio",
                  "de": "Modelle nur für domänenspezifische Aufgaben trainieren",
                  "nl": "Modellen alleen trainen voor domein-specifieke taken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Extract fixed-size feature vectors from variable-sized region proposals",
                  "es": "Extraer vectores de características de tamaño fijo de propuestas de región de tamaño variable",
                  "de": "Feste Größe Feature-Vektoren aus variabel großen Regionsvorschlägen extrahieren",
                  "nl": "Feature vectors van vaste grootte extraheren uit variabel-grootte regiovoorstellen"
        },
        {
                  "en": "Select the most interesting image regions",
                  "es": "Seleccionar las regiones de imagen más interesantes",
                  "de": "Die interessantesten Bildbereiche auswählen",
                  "nl": "De meest interessante beeldregio's selecteren"
        },
        {
                  "en": "Pool only regions of user interest",
                  "es": "Agrupar solo regiones de interés del usuario",
                  "de": "Nur Regionen von Benutzerinteresse poolen",
                  "nl": "Alleen regio's van gebruikersinteresse poolen"
        },
        {
                  "en": "Create interest maps for visualization",
                  "es": "Crear mapas de interés para visualización",
                  "de": "Interessenkarten für Visualisierung erstellen",
                  "nl": "Interessekaarten maken voor visualisatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "ROI Align works only with aligned images",
                  "es": "ROI Align funciona solo con imágenes alineadas",
                  "de": "ROI Align funktioniert nur mit ausgerichteten Bildern",
                  "nl": "ROI Align werkt alleen met uitgelijnde afbeeldingen"
        },
        {
                  "en": "They are exactly the same operation",
                  "es": "Son exactamente la misma operación",
                  "de": "Sie sind genau dieselbe Operation",
                  "nl": "Ze zijn precies dezelfde operatie"
        },
        {
                  "en": "ROI Align is faster than ROI pooling",
                  "es": "ROI Align es más rápido que ROI pooling",
                  "de": "ROI Align ist schneller als ROI Pooling",
                  "nl": "ROI Align is sneller dan ROI pooling"
        },
        {
                  "en": "ROI Align uses bilinear interpolation to avoid quantization artifacts from rounding",
                  "es": "ROI Align usa interpolación bilineal para evitar artefactos de cuantización del redondeo",
                  "de": "ROI Align verwendet bilineare Interpolation um Quantisierungsartefakte durch Rundung zu vermeiden",
                  "nl": "ROI Align gebruikt bilineaire interpolatie om kwantisatie-artefacten van afronden te vermijden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning without any supervision at all",
                  "es": "Aprender sin ninguna supervisión en absoluto",
                  "de": "Lernen ohne jegliche Überwachung",
                  "nl": "Leren zonder enige supervisie"
        },
        {
                  "en": "Supervised learning on self-generated data",
                  "es": "Aprendizaje supervisado en datos auto-generados",
                  "de": "Überwachtes Lernen auf selbst generierten Daten",
                  "nl": "Supervised learning op zelf-gegenereerde data"
        },
        {
                  "en": "Models supervising themselves during training",
                  "es": "Modelos supervisándose a sí mismos durante entrenamiento",
                  "de": "Modelle die sich selbst während Training überwachen",
                  "nl": "Modellen die zichzelf superviseren tijdens training"
        },
        {
                  "en": "Learning representations from unlabeled data using pretext tasks",
                  "es": "Aprender representaciones de datos sin etiquetar usando tareas de pretexto",
                  "de": "Repräsentationen von unbeschrifteten Daten lernen durch Vorwand-Aufgaben",
                  "nl": "Representaties leren van ongelabelde data met behulp van pretext taken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning from contrasting colors in images",
                  "es": "Aprender de colores contrastantes en imágenes",
                  "de": "Lernen von kontrastierenden Farben in Bildern",
                  "nl": "Leren van contrasterende kleuren in afbeeldingen"
        },
        {
                  "en": "Contrasting different learning methods",
                  "es": "Contrastar diferentes métodos de aprendizaje",
                  "de": "Verschiedene Lernmethoden kontrastieren",
                  "nl": "Verschillende leermethodes contrasteren"
        },
        {
                  "en": "Increasing image contrast during training",
                  "es": "Aumentar contraste de imagen durante entrenamiento",
                  "de": "Bildkontrast während Training erhöhen",
                  "nl": "Beeldcontrast verhogen tijdens training"
        },
        {
                  "en": "Learning representations by pulling similar samples together and pushing dissimilar ones apart",
                  "es": "Aprender representaciones acercando muestras similares y alejando las diferentes",
                  "de": "Repräsentationen lernen durch Zusammenziehen ähnlicher Proben und Auseinanderschieben unähnlicher",
                  "nl": "Representaties leren door vergelijkbare samples naar elkaar toe te trekken en ongelijke uit elkaar te duwen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Visually transforming images during processing",
                  "es": "Transformar visualmente imágenes durante procesamiento",
                  "de": "Bilder während Verarbeitung visuell transformieren",
                  "nl": "Afbeeldingen visueel transformeren tijdens verwerking"
        },
        {
                  "en": "Transforming visual data into text",
                  "es": "Transformar datos visuales en texto",
                  "de": "Visuelle Daten in Text transformieren",
                  "nl": "Visuele data transformeren naar tekst"
        },
        {
                  "en": "Traditional CNN with transformer layers",
                  "es": "CNN tradicional con capas transformer",
                  "de": "Traditionelles CNN mit Transformer-Schichten",
                  "nl": "Traditioneel CNN met transformer lagen"
        },
        {
                  "en": "Applying transformer architecture directly to sequences of image patches",
                  "es": "Aplicar arquitectura transformer directamente a secuencias de parches de imagen",
                  "de": "Transformer-Architektur direkt auf Sequenzen von Bild-Patches anwenden",
                  "nl": "Transformer architectuur direct toepassen op reeksen van afbeeldingspatches"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning with few training iterations",
                  "es": "Aprender con pocas iteraciones de entrenamiento",
                  "de": "Lernen mit wenigen Trainingsiterationen",
                  "nl": "Leren met weinig trainingsiteraties"
        },
        {
                  "en": "Learning to recognize new classes from very few labeled examples",
                  "es": "Aprender a reconocer nuevas clases con muy pocos ejemplos etiquetados",
                  "de": "Lernen neue Klassen von sehr wenigen beschrifteten Beispielen zu erkennen",
                  "nl": "Leren nieuwe klassen te herkennen van zeer weinig gelabelde voorbeelden"
        },
        {
                  "en": "Using few network layers",
                  "es": "Usar pocas capas de red",
                  "de": "Wenige Netzwerkschichten verwenden",
                  "nl": "Weinig netwerklagen gebruiken"
        },
        {
                  "en": "Taking only a few shots of each scene",
                  "es": "Tomar solo unas pocas tomas de cada escena",
                  "de": "Nur wenige Aufnahmen jeder Szene machen",
                  "nl": "Slechts enkele opnames maken van elke scène"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning without any supervision",
                  "es": "Aprender sin ninguna supervisión",
                  "de": "Lernen ohne jegliche Überwachung",
                  "nl": "Leren zonder enige supervisie"
        },
        {
                  "en": "Recognizing object classes never seen during training using semantic knowledge",
                  "es": "Reconocer clases de objetos nunca vistas durante entrenamiento usando conocimiento semántico",
                  "de": "Objektklassen erkennen die nie während Training gesehen wurden unter Verwendung semantischen Wissens",
                  "nl": "Objectklassen herkennen die nooit tijdens training gezien zijn met behulp van semantische kennis"
        },
        {
                  "en": "Training with zero images",
                  "es": "Entrenar con cero imágenes",
                  "de": "Mit null Bildern trainieren",
                  "nl": "Trainen met nul afbeeldingen"
        },
        {
                  "en": "Setting all shots to zero value",
                  "es": "Configurar todas las tomas a valor cero",
                  "de": "Alle Aufnahmen auf Nullwert setzen",
                  "nl": "Alle opnames op nulwaarde zetten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Changing the style of neural network output",
                  "es": "Cambiar el estilo de salida de red neuronal",
                  "de": "Stil der neuronalen Netzwerkausgabe ändern",
                  "nl": "Stijl van neurale netwerkoutput wijzigen"
        },
        {
                  "en": "Transferring neural network styles between models",
                  "es": "Transferir estilos de red neuronal entre modelos",
                  "de": "Neuronale Netzwerkstile zwischen Modellen übertragen",
                  "nl": "Neurale netwerkstijlen overdragen tussen modellen"
        },
        {
                  "en": "Styling neurons in different layers",
                  "es": "Estilizar neuronas en diferentes capas",
                  "de": "Neuronen in verschiedenen Schichten stylen",
                  "nl": "Neuronen in verschillende lagen stylen"
        },
        {
                  "en": "Applying artistic style from one image to content of another using CNN features",
                  "es": "Aplicar estilo artístico de una imagen al contenido de otra usando características CNN",
                  "de": "Künstlerischen Stil von einem Bild auf Inhalt eines anderen anwenden unter Verwendung von CNN-Features",
                  "nl": "Artistieke stijl van één afbeelding toepassen op inhoud van een andere met behulp van CNN features"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Taking images at super high resolution",
                  "es": "Tomar imágenes a resolución súper alta",
                  "de": "Bilder in super hoher Auflösung aufnehmen",
                  "nl": "Afbeeldingen maken op super hoge resolutie"
        },
        {
                  "en": "Creating resolutions beyond display capabilities",
                  "es": "Crear resoluciones más allá de capacidades de pantalla",
                  "de": "Auflösungen jenseits Display-Fähigkeiten erstellen",
                  "nl": "Resoluties maken voorbij displaymogelijkheden"
        },
        {
                  "en": "Resolving image conflicts at super speed",
                  "es": "Resolver conflictos de imagen a súper velocidad",
                  "de": "Bildkonflikte mit Super-Geschwindigkeit auflösen",
                  "nl": "Beeldconflicten oplossen op supersnelheid"
        },
        {
                  "en": "Reconstructing high-resolution images from low-resolution inputs",
                  "es": "Reconstruir imágenes de alta resolución desde entradas de baja resolución",
                  "de": "Hochauflösende Bilder aus niedrigauflösenden Eingaben rekonstruieren",
                  "nl": "Hoge-resolutie afbeeldingen reconstrueren uit lage-resolutie inputs"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fill missing or corrupted regions in images with plausible content",
                  "es": "Llenar regiones faltantes o corruptas en imágenes con contenido plausible",
                  "de": "Fehlende oder beschädigte Regionen in Bildern mit plausiblem Inhalt füllen",
                  "nl": "Ontbrekende of beschadigde regio's in afbeeldingen vullen met plausibele inhoud"
        },
        {
                  "en": "Add paint effects to images",
                  "es": "Agregar efectos de pintura a imágenes",
                  "de": "Maleffekte zu Bildern hinzufügen",
                  "nl": "Verfeffecten toevoegen aan afbeeldingen"
        },
        {
                  "en": "Paint over entire images",
                  "es": "Pintar sobre imágenes completas",
                  "de": "Über gesamte Bilder malen",
                  "nl": "Over hele afbeeldingen schilderen"
        },
        {
                  "en": "Paint images with internal colors",
                  "es": "Pintar imágenes con colores internos",
                  "de": "Bilder mit internen Farben malen",
                  "nl": "Afbeeldingen schilderen met interne kleuren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reducing precision of weights and activations to lower bit-widths",
                  "es": "Reducir precisión de pesos y activaciones a anchos de bit menores",
                  "de": "Präzision von Gewichten und Aktivierungen auf niedrigere Bitbreiten reduzieren",
                  "nl": "Precisie van gewichten en activaties verminderen naar lagere bitbreedtes"
        },
        {
                  "en": "Dividing models into quantums",
                  "es": "Dividir modelos en cuantos",
                  "de": "Modelle in Quanten teilen",
                  "nl": "Modellen verdelen in kwanta"
        },
        {
                  "en": "Measuring quantity of model parameters",
                  "es": "Medir cantidad de parámetros de modelo",
                  "de": "Menge der Modellparameter messen",
                  "nl": "Hoeveelheid modelparameters meten"
        },
        {
                  "en": "Quantifying model performance metrics",
                  "es": "Cuantificar métricas de rendimiento de modelo",
                  "de": "Modellleistungsmetriken quantifizieren",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Removing outlier images from dataset",
                  "es": "Eliminar imágenes atípicas del conjunto de datos",
                  "de": "Ausreißer-Bilder aus Datensatz entfernen",
                  "nl": "Uitschieters verwijderen uit dataset"
        },
        {
                  "en": "Cutting training time by removing data",
                  "es": "Reducir tiempo de entrenamiento eliminando datos",
                  "de": "Trainingszeit durch Entfernen von Daten verkürzen",
                  "nl": "Trainingstijd verkorten door data te verwijderen"
        },
        {
                  "en": "Randomly masking out square regions of input images during training",
                  "es": "Enmascarar aleatoriamente regiones cuadradas de imágenes de entrada durante entrenamiento",
                  "de": "Zufällig quadratische Regionen von Eingabebildern während Training maskieren",
                  "nl": "Willekeurig vierkante regio's van invoerafbeeldingen maskeren tijdens training"
        },
        {
                  "en": "Cutting out objects from images",
                  "es": "Recortar objetos de imágenes",
                  "de": "Objekte aus Bildern ausschneiden",
                  "nl": "Objecten uit afbeeldingen knippen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating training examples by linearly interpolating between pairs of images and their labels",
                  "es": "Crear ejemplos de entrenamiento interpolando linealmente entre pares de imágenes y sus etiquetas",
                  "de": "Trainingsbeispiele erstellen durch lineare Interpolation zwischen Bildpaaren und ihren Labels",
                  "nl": "Trainingsvoorbeelden creëren door lineair te interpoleren tussen paren afbeeldingen en hun labels"
        },
        {
                  "en": "Mixing up the order of training data",
                  "es": "Mezclar el orden de datos de entrenamiento",
                  "de": "Reihenfolge der Trainingsdaten mischen",
                  "nl": "Volgorde van trainingsdata door elkaar halen"
        },
        {
                  "en": "Combining multiple augmentation techniques",
                  "es": "Combinar múltiples técnicas de aumento",
                  "de": "Mehrere Augmentationstechniken kombinieren",
                  "nl": "Meerdere augmentatietechnieken combineren"
        },
        {
                  "en": "Upsampling minority classes in dataset",
                  "es": "Sobremuestreo de clases minoritarias en conjunto de datos",
                  "de": "Minderheitsklassen im Datensatz überabtasten",
                  "nl": "Minderheidsklassen in dataset oversamplen"
        }
        ],
        correct: 0,
        explanation: {
