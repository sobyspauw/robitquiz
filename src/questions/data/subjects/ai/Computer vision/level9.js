    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Searching neural pathways in the brain",
                  "es": "Buscar vías neuronales en el cerebro",
                  "de": "Neuronale Bahnen im Gehirn suchen",
                  "nl": "Neurale banen in de hersenen zoeken"
        },
        {
                  "en": "Finding the fastest neural processing units",
                  "es": "Encontrar las unidades de procesamiento neuronal más rápidas",
                  "de": "Die schnellsten neuronalen Verarbeitungseinheiten finden",
                  "nl": "De snelste neurale verwerkingseenheden vinden"
        },
        {
                  "en": "Automatically discovering optimal network architectures for specific vision tasks",
                  "es": "Descubrir automáticamente arquitecturas de red óptimas para tareas específicas de visión",
                  "de": "Automatische Entdeckung optimaler Netzwerkarchitekturen für spezifische Vision-Aufgaben",
                  "nl": "Automatisch ontdekken van optimale netwerkarchitecturen voor specifieke vision taken"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning new visual concepts from very limited training examples",
                  "es": "Aprender nuevos conceptos visuales de ejemplos de entrenamiento muy limitados",
                  "de": "Neue visuelle Konzepte aus sehr begrenzten Trainingsbeispielen lernen",
                  "nl": "Nieuwe visuele concepten leren uit zeer beperkte trainingsvoorbeelden"
        },
        {
                  "en": "Learning photography techniques quickly",
                  "es": "Aprender técnicas de fotografía rápidamente",
                  "de": "Fotografietechniken schnell lernen",
                  "nl": "Fotografietechnieken snel leren"
        },
        {
                  "en": "Taking only a few shots with cameras",
                  "es": "Tomar solo unas pocas fotos con cámaras",
                  "de": "Nur wenige Aufnahmen mit Kameras machen",
                  "nl": "Slechts een paar opnames maken met camera's"
        },
        {
                  "en": "Short training sessions for models",
                  "es": "Sesiones de entrenamiento cortas para modelos",
                  "de": "Kurze Trainingssitzungen für Modelle",
                  "nl": "Korte trainingssessies voor modellen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reducing human supervision requirements",
                  "es": "Reducir requisitos de supervisión humana",
                  "de": "Menschliche Überwachungsanforderungen reduzieren",
                  "nl": "Menselijke supervisievevereisten verminderen"
        },
        {
                  "en": "Automatically labeling training data",
                  "es": "Etiquetar automáticamente datos de entrenamiento",
                  "de": "Trainingsdaten automatisch beschriften",
                  "nl": "Trainingsdata automatisch labelen"
        },
        {
                  "en": "Learning visual representations from unlabeled data by predicting image properties",
                  "es": "Aprender representaciones visuales de datos no etiquetados prediciendo propiedades de imagen",
                  "de": "Visuelle Repräsentationen aus unbeschrifteten Daten lernen durch Vorhersage von Bildeigenschaften",
                  "nl": "Visuele representaties leren uit ongelabelde data door beeldeigenschappen te voorspellen"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Making models more competitive",
                  "es": "Hacer modelos más competitivos",
                  "de": "Modelle wettbewerbsfähiger machen",
                  "nl": "Modellen competitiever maken"
        },
        {
                  "en": "Handling adversarial training conditions",
                  "es": "Manejar condiciones de entrenamiento adversarias",
                  "de": "Adversarielle Trainingsbedingungen handhaben",
                  "nl": "Adversariële trainingsomstandigheden hanteren"
        },
        {
                  "en": "Defending against imperceptible input perturbations designed to fool AI models",
                  "es": "Defender contra perturbaciones de entrada imperceptibles diseñadas para engañar modelos IA",
                  "de": "Verteidigung gegen unmerkliche Eingabestörungen die KI-Modelle täuschen sollen",
                  "nl": "Verdedigen tegen onmerkbare input verstoringen ontworpen om AI modellen te misleiden"
        },
        {
                  "en": "Robustness against hardware failures",
                  "es": "Robustez contra fallas de hardware",
                  "de": "Robustheit gegen Hardware-Ausfälle",
                  "nl": "Robuustheid tegen hardware storingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using multiple camera modes simultaneously",
                  "es": "Usar múltiples modos de cámara simultáneamente",
                  "de": "Mehrere Kameramodi gleichzeitig verwenden",
                  "nl": "Meerdere cameramodi tegelijkertijd gebruiken"
        },
        {
                  "en": "Learning different visual styles",
                  "es": "Aprender diferentes estilos visuales",
                  "de": "Verschiedene visuelle Stile lernen",
                  "nl": "Verschillende visuele stijlen leren"
        },
        {
                  "en": "Combining visual information with text, audio, and other data types for richer understanding",
                  "es": "Combinar información visual con texto, audio y otros tipos de datos para comprensión más rica",
                  "de": "Visuelle Informationen mit Text, Audio und anderen Datentypen für reicheres Verständnis kombinieren",
                  "nl": "Visuele informatie combineren met tekst, audio en andere datatypes voor rijker begrip"
        },
        {
                  "en": "Processing multiple image formats",
                  "es": "Procesar múltiples formatos de imagen",
                  "de": "Mehrere Bildformate verarbeiten",
                  "nl": "Meerdere beeldformaten verwerken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using only inception layers without pooling",
                  "es": "Usar solo capas inception sin pooling",
                  "de": "Nur Inception-Schichten ohne Pooling verwenden",
                  "nl": "Alleen inception lagen gebruiken zonder pooling"
        },
        {
                  "en": "Multi-scale feature extraction through parallel convolutions of different kernel sizes",
                  "es": "Extracción de características multi-escala a través de convoluciones paralelas de diferentes tamaños de kernel",
                  "de": "Multi-Skalen Feature-Extraktion durch parallele Faltungen verschiedener Kernel-Größen",
                  "nl": "Multi-schaal feature extractie door parallelle convoluties van verschillende kernel groottes"
        },
        {
                  "en": "Inception refers to dream-like image generation",
                  "es": "Inception se refiere a generación de imágenes oníricas",
                  "de": "Inception bezieht sich auf traumartige Bildgenerierung",
                  "nl": "Inception verwijst naar droomachtige beeldgeneratie"
        },
        {
                  "en": "Only using 1x1 convolutions",
                  "es": "Solo usar convoluciones 1x1",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Increasing network density physically",
                  "es": "Aumentar densidad de red físicamente",
                  "de": "Netzwerkdichte physisch erhöhen",
                  "nl": "Netwerkdichtheid fysiek verhogen"
        },
        {
                  "en": "Dense connectivity where each layer connects to all subsequent layers",
                  "es": "Conectividad densa donde cada capa se conecta a todas las capas subsiguientes",
                  "de": "Dichte Konnektivität wo jede Schicht sich mit allen nachfolgenden Schichten verbindet",
                  "nl": "Dichte connectiviteit waar elke laag verbindt met alle volgende lagen"
        },
        {
                  "en": "Using denser computational units only",
                  "es": "Usar solo unidades computacionales más densas",
                  "de": "Nur dichtere Recheneinheiten verwenden",
                  "nl": "Alleen dichtere computationele eenheden gebruiken"
        },
        {
                  "en": "Packing more layers in less space",
                  "es": "Empacar más capas en menos espacio",
                  "de": "Mehr Schichten auf weniger Raum packen",
                  "nl": "Meer lagen inpakken in minder ruimte"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Attention only to spatial dimensions of images",
                  "es": "Atención solo a dimensiones espaciales de imágenes",
                  "de": "Aufmerksamkeit nur auf räumliche Dimensionen von Bildern",
                  "nl": "Aandacht alleen voor ruimtelijke dimensies van afbeeldingen"
        },
        {
                  "en": "Focusing on space-related objects only",
                  "es": "Enfocarse solo en objetos relacionados con espacio",
                  "de": "Nur auf raumbezogene Objekte fokussieren",
                  "nl": "Alleen focussen op ruimte-gerelateerde objecten"
        },
        {
                  "en": "Mechanism that weights different spatial locations in feature maps based on relevance",
                  "es": "Mecanismo que pondera diferentes ubicaciones espaciales en mapas de características basado en relevancia",
                  "de": "Mechanismus der verschiedene räumliche Positionen in Feature Maps basierend auf Relevanz gewichtet",
                  "nl": "Mechanisme dat verschillende ruimtelijke locaties in feature maps weegt op basis van relevantie"
        },
        {
                  "en": "Spatial arrangement of attention layers",
                  "es": "Arreglo espacial de capas de atención",
                  "de": "Räumliche Anordnung von Aufmerksamkeitsschichten",
                  "nl": "Ruimtelijke regeling van aandachtslagen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Choosing optimal TV channels",
                  "es": "Elegir canales de TV óptimos",
                  "de": "Optimale TV-Kanäle auswählen",
                  "nl": "Optimale TV-kanalen kiezen"
        },
        {
                  "en": "Reweighting feature channels based on importance while spatial attention focuses on locations",
                  "es": "Reponderar canales de características basado en importancia mientras atención espacial se enfoca en ubicaciones",
                  "de": "Feature-Kanäle basierend auf Wichtigkeit neu gewichten während räumliche Aufmerksamkeit sich auf Positionen konzentriert",
                  "nl": "Feature kanalen herwegen op basis van belang terwijl ruimtelijke aandacht zich richt op locaties"
        },
        {
                  "en": "Attention to communication channels only",
                  "es": "Atención solo a canales de comunicación",
                  "de": "Aufmerksamkeit nur auf Kommunikationskanäle",
                  "nl": "Aandacht alleen voor communicatiekanalen"
        },
        {
                  "en": "Channel attention replaces spatial attention",
                  "es": "La atención de canal reemplaza la atención espacial",
                  "de": "Kanal-Aufmerksamkeit ersetzt räumliche Aufmerksamkeit",
                  "nl": "Kanaal aandacht vervangt ruimtelijke aandacht"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only reducing computational complexity",
                  "es": "Solo reducir complejidad computacional",
                  "de": "Nur rechnerische Komplexität reduzieren",
                  "nl": "Alleen computationele complexiteit verminderen"
        },
        {
                  "en": "Adaptive channel-wise feature recalibration through global context modeling",
                  "es": "Recalibración adaptativa de características por canal a través de modelado de contexto global",
                  "de": "Adaptive kanalweise Feature-Rekalibrierung durch globale Kontextmodellierung",
                  "nl": "Adaptieve kanaalgewijze feature herkalibratie door globale contextmodellering"
        },
        {
                  "en": "Exciting neurons for better performance",
                  "es": "Excitar neuronas para mejor rendimiento",
                  "de": "Neuronen für bessere Leistung anregen",
                  "nl": "Neuronen opwinden voor betere prestaties"
        },
        {
                  "en": "Squeezing images to smaller sizes",
                  "es": "Comprimir imágenes a tamaños más pequeños",
                  "de": "Bilder auf kleinere Größen komprimieren",
                  "nl": "Afbeeldingen samendrukken tot kleinere maten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Growing computational resources gradually",
                  "es": "Hacer crecer recursos computacionales gradualmente",
                  "de": "Rechenressourcen allmählich wachsen lassen",
                  "nl": "Computationele bronnen geleidelijk laten groeien"
        },
        {
                  "en": "Starting with low resolution and gradually increasing to higher resolutions for stable training",
                  "es": "Comenzar con baja resolución y aumentar gradualmente a resoluciones más altas para entrenamiento estable",
                  "de": "Mit niedriger Auflösung beginnen und allmählich zu höheren Auflösungen erhöhen für stabiles Training",
                  "nl": "Beginnen met lage resolutie en geleidelijk verhogen naar hogere resoluties voor stabiele training"
        },
        {
                  "en": "Progressively adding more training data",
                  "es": "Agregar progresivamente más datos de entrenamiento",
                  "de": "Progressiv mehr Trainingsdaten hinzufügen",
                  "nl": "Progressief meer trainingsdata toevoegen"
        },
        {
                  "en": "Growing GANs physically larger over time",
                  "es": "Hacer crecer GANs físicamente más grandes con el tiempo",
                  "de": "GANs physisch über Zeit größer wachsen lassen",
                  "nl": "GANs fysiek groter laten groeien over tijd"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Faster mobile processors only",
                  "es": "Solo procesadores móviles más rápidos",
                  "de": "Nur schnellere mobile Prozessoren",
                  "nl": "Alleen snellere mobiele processors"
        },
        {
                  "en": "Depthwise separable convolutions that dramatically reduce parameters and computations",
                  "es": "Convoluciones separables en profundidad que reducen dramáticamente parámetros y computaciones",
                  "de": "Tiefenweise trennbare Faltungen die Parameter und Berechnungen dramatisch reduzieren",
                  "nl": "Dieptegewijze scheidbare convoluties die parameters en berekeningen dramatisch verminderen"
        },
        {
                  "en": "Mobile connectivity for networks",
                  "es": "Conectividad móvil para redes",
                  "de": "Mobile Konnektivität für Netzwerke",
                  "nl": "Mobiele connectiviteit voor netwerken"
        },
        {
                  "en": "Only working on mobile phones",
                  "es": "Solo trabajar en teléfonos móviles",
                  "de": "Nur auf Mobiltelefonen funktionieren",
                  "nl": "Alleen werken op mobiele telefoons"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "NASA space applications only",
                  "es": "Solo aplicaciones espaciales de NASA",
                  "de": "Nur NASA-Weltraumanwendungen",
                  "nl": "Alleen NASA ruimtetoepassingen"
        },
        {
                  "en": "Finding optimal network architectures through algorithmic search rather than manual design",
                  "es": "Encontrar arquitecturas de red óptimas a través de búsqueda algorítmica en lugar de diseño manual",
                  "de": "Optimale Netzwerkarchitekturen durch algorithmische Suche anstatt manuelles Design finden",
                  "nl": "Optimale netwerkarchitecturen vinden door algoritmische zoektocht in plaats van handmatig ontwerp"
        },
        {
                  "en": "Finding existing architectures in literature",
                  "es": "Encontrar arquitecturas existentes en literatura",
                  "de": "Bestehende Architekturen in Literatur finden",
                  "nl": "Bestaande architecturen vinden in literatuur"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using capsule-shaped processing units",
                  "es": "Usar unidades de procesamiento en forma de cápsula",
                  "de": "Kapselförmige Verarbeitungseinheiten verwenden",
                  "nl": "Capsule-vormige verwerkingseenheden gebruiken"
        },
        {
                  "en": "Only working with medical capsule images",
                  "es": "Solo trabajar con imágenes de cápsulas médicas",
                  "de": "Nur mit medizinischen Kapselbildern arbeiten",
                  "nl": "Alleen werken met medische capsule afbeeldingen"
        },
        {
                  "en": "Encapsulating networks in containers",
                  "es": "Encapsular redes en contenedores",
                  "de": "Netzwerke in Container einkapseln",
                  "nl": "Netwerken inkapselen in containers"
        },
        {
                  "en": "Preserving spatial hierarchies and pose information through vector representations",
                  "es": "Preservar jerarquías espaciales e información de pose a través de representaciones vectoriales",
                  "de": "Räumliche Hierarchien und Pose-Informationen durch Vektorrepräsentationen bewahren",
                  "nl": "Ruimtelijke hiërarchieën en pose-informatie behouden door vectorrepresentaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Scaling only network depth",
                  "es": "Escalar solo profundidad de red",
                  "de": "Nur Netzwerktiefe skalieren",
                  "nl": "Alleen netwerkdiepte schalen"
        },
        {
                  "en": "Compound interest calculations",
                  "es": "Cálculos de interés compuesto",
                  "de": "Zinseszinsberechnungen",
                  "nl": "Samengestelde renteberekeningen"
        },
        {
                  "en": "Uniformly scaling network depth, width, and resolution together for optimal efficiency",
                  "es": "Escalar uniformemente profundidad, ancho y resolución de red juntos para eficiencia óptima",
                  "de": "Netzwerktiefe, -breite und -auflösung gleichmäßig zusammen skalieren für optimale Effizienz",
                  "nl": "Uniform schalen van netwerkdiepte, -breedte en -resolutie samen voor optimale efficiëntie"
        },
        {
                  "en": "Using compound chemical processes",
                  "es": "Usar procesos químicos compuestos",
                  "de": "Zusammengesetzte chemische Prozesse verwenden",
                  "nl": "Samengestelde chemische processen gebruiken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only organizing network layers",
                  "es": "Solo organizar capas de red",
                  "de": "Nur Netzwerkschichten organisieren",
                  "nl": "Alleen netwerklagen organiseren"
        },
        {
                  "en": "Reducing computational cost while maintaining representational capacity through parallel processing",
                  "es": "Reducir costo computacional mientras mantiene capacidad representacional a través de procesamiento paralelo",
                  "de": "Rechenkosten reduzieren während Repräsentationskapazität durch parallele Verarbeitung beibehalten wird",
                  "nl": "Computationele kosten verminderen terwijl representatiecapaciteit behouden blijft door parallelle verwerking"
        },
        {
        ...
        {
                  "en": "Creating social groups of neurons",
                  "es": "Crear grupos sociales de neuronas",
                  "de": "Soziale Gruppen von Neuronen erstellen",
                  "nl": "Sociale groepen van neuronen maken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Suppressing irrelevant background regions while highlighting target anatomical structures",
                  "es": "Suprimir regiones de fondo irrelevantes mientras resalta estructuras anatómicas objetivo",
                  "de": "Irrelevante Hintergrundregionen unterdrücken während Ziel-anatomische Strukturen hervorgehoben werden",
                  "nl": "Irrelevante achtergrondregio's onderdrukken terwijl doel anatomische structuren worden benadrukt"
        },
        {
                  "en": "Creating security gates for hospitals",
                  "es": "Crear puertas de seguridad para hospitales",
                  "de": "Sicherheitstore für Krankenhäuser erstellen",
                  "nl": "Beveiligingspoorten maken voor ziekenhuizen"
        },
        {
                  "en": "Gating access to medical databases",
                  "es": "Controlar acceso a bases de datos médicas",
                  "de": "Zugang zu medizinischen Datenbanken kontrollieren",
                  "nl": "Toegang tot medische databases controleren"
        },
        {
                  "en": "Only filtering medical images",
                  "es": "Solo filtrar imágenes médicas",
                  "de": "Nur medizinische Bilder filtern",
                  "nl": "Alleen medische afbeeldingen filteren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Shuffling between different networks",
                  "es": "Mezclar entre diferentes redes",
                  "de": "Zwischen verschiedenen Netzwerken mischen",
                  "nl": "Schudden tussen verschillende netwerken"
        },
        {
                  "en": "Channel shuffle operation to enable information flow between groups in grouped convolutions",
                  "es": "Operación de mezcla de canales para permitir flujo de información entre grupos en convoluciones agrupadas",
                  "de": "Channel Shuffle Operation um Informationsfluss zwischen Gruppen in gruppierten Faltungen zu ermöglichen",
                  "nl": "Channel shuffle operatie om informatiestroom tussen groepen in gegroepeerde convoluties mogelijk te maken"
        },
        {
                  "en": "Randomly shuffling network layers",
                  "es": "Mezclar aleatoriamente capas de red",
                  "de": "Netzwerkschichten zufällig mischen",
                  "nl": "Netwerklagen willekeurig schudden"
        },
        {
                  "en": "Shuffling training data randomly",
                  "es": "Mezclar datos de entrenamiento aleatoriamente",
                  "de": "Trainingsdaten zufällig mischen",
                  "nl": "Trainingsdata willekeurig schudden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Standardizing network naming conventions",
                  "es": "Estandarizar convenciones de nomenclatura de red",
                  "de": "Netzwerk-Benennungskonventionen standardisieren",
                  "nl": "Netwerk naamgevingsconventies standaardiseren"
        },
        {
                  "en": "Normalizing input images only",
                  "es": "Normalizar solo imágenes de entrada",
                  "de": "Nur Eingabebilder normalisieren",
                  "nl": "Alleen invoer afbeeldingen normaliseren"
        },
        {
                  "en": "Making networks appear normal",
                  "es": "Hacer que las redes parezcan normales",
                  "de": "Netzwerke normal erscheinen lassen",
                  "nl": "Netwerken normaal laten lijken"
        },
        {
                  "en": "Internal covariate shift that causes activation distributions to change during training",
                  "es": "Cambio de covariables internas que causa que las distribuciones de activación cambien durante entrenamiento",
                  "de": "Interne Kovariatenverschiebung die Aktivierungsverteilungen während Training verändert",
                  "nl": "Interne covariate shift die activatiedistributies doet veranderen tijdens training"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Spreading image features across multiple layers",
                  "es": "Esparcir características de imagen a través de múltiples capas",
                  "de": "Bildfeatures über mehrere Schichten verteilen",
                  "nl": "Beeldkenmerken verspreiden over meerdere lagen"
        },
        {
                  "en": "Learning to reverse a noise-adding process to generate high-quality images",
                  "es": "Aprender a revertir un proceso de añadir ruido para generar imágenes de alta calidad",
                  "de": "Lernen einen Rausch-hinzufügenden Prozess umzukehren um hochwertige Bilder zu generieren",
                  "nl": "Leren om een ruis-toevoegend proces om te keren om hoogwaardige afbeeldingen te genereren"
        },
        {
                  "en": "Diffusing light through optical filters",
                  "es": "Difundir luz a través de filtros ópticos",
                  "de": "Licht durch optische Filter diffundieren",
                  "nl": "Licht diffunderen door optische filters"
        },
        {
                  "en": "Creating blurred versions of images",
                  "es": "Crear versiones borrosas de imágenes",
                  "de": "Verschwommene Versionen von Bildern erstellen",
                  "nl": "Wazige versies van afbeeldingen maken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Changing network routing paths dynamically",
                  "es": "Cambiar rutas de enrutamiento de red dinámicamente",
                  "de": "Netzwerk-Routing-Pfade dynamisch ändern",
                  "nl": "Netwerk routing paden dynamisch wijzigen"
        },
        {
                  "en": "Routing capsules through different layers",
                  "es": "Enrutar cápsulas a través de diferentes capas",
                  "de": "Kapseln durch verschiedene Schichten routen",
                  "nl": "Capsules door verschillende lagen routeren"
        },
        {
                  "en": "Iterative agreement process between capsules to determine part-whole relationships",
                  "es": "Proceso iterativo de acuerdo entre cápsulas para determinar relaciones parte-todo",
                  "de": "Iterativer Zustimmungsprozess zwischen Kapseln um Teil-Ganzes-Beziehungen zu bestimmen",
                  "nl": "Iteratief overeenkomstproces tussen capsules om deel-geheel relaties te bepalen"
        },
        {
                  "en": "Dynamic traffic routing for data",
                  "es": "Enrutamiento dinámico de tráfico para datos",
                  "de": "Dynamisches Verkehrsrouting für Daten",
                  "nl": "Dynamische verkeer routing voor data"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Applying multiple augmented versions of test images and averaging predictions for robustness",
                  "es": "Aplicar múltiples versiones aumentadas de imágenes de prueba y promediar predicciones para robustez",
                  "de": "Mehrere erweiterte Versionen von Testbildern anwenden und Vorhersagen für Robustheit mitteln",
                  "nl": "Meerdere geaugmenteerde versies van testafbeeldingen toepassen en voorspellingen middelen voor robuustheid"
        },
        {
                  "en": "Augmenting during training time",
                  "es": "Aumentar durante tiempo de entrenamiento",
                  "de": "Während Trainingszeit erweitern",
                  "nl": "Augmenteren tijdens trainingstijd"
        },
        {
                  "en": "Timing how long augmentation takes",
                  "es": "Cronometrar cuánto tarda el aumento",
                  "de": "Zeit messen wie lange Augmentation dauert",
                  "nl": "Tijd meten hoe lang augmentatie duurt"
        },
        {
                  "en": "Testing augmentation strategies only",
                  "es": "Solo probar estrategias de aumento",
                  "de": "Nur Augmentationsstrategien testen",
                  "nl": "Alleen augmentatie strategieën testen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Distilling images to their essence",
                  "es": "Destilar imágenes a su esencia",
                  "de": "Bilder zu ihrer Essenz destillieren",
                  "nl": "Afbeeldingen destilleren tot hun essentie"
        },
        {
                  "en": "Transferring knowledge from large teacher networks to smaller student networks for deployment",
                  "es": "Transferir conocimiento de redes maestras grandes a redes estudiantes más pequeñas para despliegue",
                  "de": "Wissen von großen Lehrer-Netzwerken auf kleinere Schüler-Netzwerke für Bereitstellung übertragen",
                  "nl": "Kennis overdragen van grote leraar netwerken naar kleinere student netwerken voor implementatie"
        },
        {
                  "en": "Extracting pure knowledge from data",
                  "es": "Extraer conocimiento puro de datos",
                  "de": "Reines Wissen aus Daten extrahieren",
                  "nl": "Zuivere kennis uit data halen"
        },
        {
                  "en": "Removing unnecessary knowledge only",
                  "es": "Eliminar solo conocimiento innecesario",
                  "de": "Nur unnötiges Wissen entfernen",
                  "nl": "Alleen onnodige kennis verwijderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only working with vision tasks",
                  "es": "Solo trabajar con tareas de visión",
                  "de": "Nur mit Vision-Aufgaben arbeiten",
                  "nl": "Alleen werken met visie taken"
        },
        {
                  "en": "Transforming images into different formats",
                  "es": "Transformar imágenes a diferentes formatos",
                  "de": "Bilder in verschiedene Formate transformieren",
                  "nl": "Afbeeldingen transformeren naar verschillende formaten"
        },
        {
                  "en": "Using transformers from electrical engineering",
                  "es": "Usar transformadores de ingeniería eléctrica",
                  "de": "Transformatoren aus Elektrotechnik verwenden",
                  "nl": "Transformatoren uit elektrotechniek gebruiken"
        },
        {
                  "en": "Global receptive field from first layer enabling long-range dependencies without convolutions",
                  "es": "Campo receptivo global desde primera capa permitiendo dependencias de largo alcance sin convoluciones",
                  "de": "Globales rezeptives Feld von erster Schicht ermöglicht langreichende Abhängigkeiten ohne Faltungen",
                  "nl": "Globaal receptief veld vanaf eerste laag maakt langetermijn afhankelijkheden mogelijk zonder convoluties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Swinging window mechanisms for images",
                  "es": "Mecanismos de ventana oscilante para imágenes",
                  "de": "Schwingende Fenstermechanismen für Bilder",
                  "nl": "Swingende venstermechanismen voor afbeeldingen"
        },
        {
                  "en": "Hierarchical feature maps with shifted windows for efficient multi-scale representation",
                  "es": "Mapas de características jerárquicos con ventanas desplazadas para representación multi-escala eficiente",
                  "de": "Hierarchische Feature Maps mit verschobenen Fenstern für effiziente Multi-Skalen-Repräsentation",
                  "nl": "Hiërarchische feature maps met verschoven vensters voor efficiënte multi-schaal representatie"
        },
        {
                  "en": "Using windows operating system only",
                  "es": "Usar solo sistema operativo Windows",
                  "de": "Nur Windows Betriebssystem verwenden",
                  "nl": "Alleen Windows besturingssysteem gebruiken"
        },
        {
                  "en": "Transforming images through windows",
                  "es": "Transformar imágenes a través de ventanas",
                  "de": "Bilder durch Fenster transformieren",
                  "nl": "Afbeeldingen door vensters transformeren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using Egyptian pyramid knowledge",
                  "es": "Usar conocimiento de pirámides egipcias",
                  "de": "Wissen über ägyptische Pyramiden verwenden",
                  "nl": "Egyptische piramide kennis gebruiken"
        },
        {
                  "en": "Building multi-scale feature representations by combining high-resolution and semantically strong features",
                  "es": "Construir representaciones de características multi-escala combinando características de alta resolución y semánticamente fuertes",
                  "de": "Multi-Skalen-Feature-Repräsentationen durch Kombination hochauflösender und semantisch starker Features aufbauen",
                  "nl": "Multi-schaal feature representaties bouwen door hoge resolutie en semantisch sterke features te combineren"
        },
        {
                  "en": "Detecting pyramids in images only",
                  "es": "Detectar solo pirámides en imágenes",
                  "de": "Nur Pyramiden in Bildern erkennen",
                  "nl": "Alleen piramides in afbeeldingen detecteren"
        },
        {
                  "en": "Creating pyramid-shaped network architectures",
                  "es": "Crear arquitecturas de red en forma de pirámide",
                  "de": "Pyramidenförmige Netzwerkarchitekturen erstellen",
                  "nl": "Piramide-vormige netwerkarchitecturen maken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only handling deformed objects in images",
                  "es": "Solo manejar objetos deformados en imágenes",
                  "de": "Nur deformierte Objekte in Bildern handhaben",
                  "nl": "Alleen vervormde objecten in afbeeldingen hanteren"
        },
        {
                  "en": "Deforming images before convolution",
                  "es": "Deformar imágenes antes de convolución",
                  "de": "Bilder vor Faltung deformieren",
                  "nl": "Afbeeldingen vervormen voor convolutie"
        },
        {
                  "en": "Learnable offsets for sampling locations allowing adaptive receptive field shapes",
                  "es": "Desplazamientos aprendibles para ubicaciones de muestreo permitiendo formas adaptativas de campo receptivo",
                  "de": "Lernbare Verschiebungen für Sampling-Positionen ermöglichen adaptive rezeptive Feldformen",
                  "nl": "Leerbare verschuivingen voor sampling locaties maken adaptieve receptieve veldvormen mogelijk"
        },
        {
                  "en": "Convolutions that deform the network structure",
                  "es": "Convoluciones que deforman la estructura de red",
                  "de": "Faltungen die Netzwerkstruktur deformieren",
                  "nl": "Convoluties die netwerkstructuur vervormen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Continuous training without stopping",
                  "es": "Entrenamiento continuo sin parar",
                  "de": "Kontinuierliches Training ohne Stoppen",
                  "nl": "Continue training zonder stoppen"
        },
        {
                  "en": "Never finishing the learning process",
                  "es": "Nunca terminar el proceso de aprendizaje",
                  "de": "Den Lernprozess nie beenden",
                  "nl": "Het leerproces nooit voltooien"
        },
        {
                  "en": "Learning continuously from video streams",
                  "es": "Aprender continuamente de flujos de video",
                  "de": "Kontinuierlich aus Videostreams lernen",
                  "nl": "Continu leren van videostreams"
        },
        {
                  "en": "Learning new tasks sequentially without forgetting previously learned knowledge (catastrophic forgetting)",
                  "es": "Aprender nuevas tareas secuencialmente sin olvidar conocimiento previamente aprendido (olvido catastrófico)",
                  "de": "Neue Aufgaben sequenziell lernen ohne zuvor gelerntes Wissen zu vergessen (katastrophales Vergessen)",
                  "nl": "Nieuwe taken sequentieel leren zonder eerder geleerde kennis te vergeten (catastrofaal vergeten)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Free from anchor bias only",
                  "es": "Libre solo de sesgo de ancla",
                  "de": "Nur frei von Anker-Bias",
                  "nl": "Alleen vrij van anker bias"
        },
        {
                  "en": "Detecting objects as points (centers) eliminating need for anchor box design and NMS",
                  "es": "Detectar objetos como puntos (centros) eliminando necesidad de diseño de caja de ancla y NMS",
                  "de": "Objekte als Punkte (Zentren) erkennen eliminiert Bedarf für Anker-Box-Design und NMS",
                  "nl": "Objecten detecteren als punten (centra) elimineert behoefte aan ankerbox ontwerp en NMS"
        },
        {
                  "en": "Working without being anchored to hardware",
                  "es": "Trabajar sin estar anclado a hardware",
                  "de": "Ohne an Hardware verankert zu sein arbeiten",
                  "nl": "Werken zonder verankerd te zijn aan hardware"
        },
        {
                  "en": "Not needing anchors to stabilize networks",
                  "es": "No necesitar anclas para estabilizar redes",
                  "de": "Keine Anker zum Stabilisieren von Netzwerken benötigen",
                  "nl": "Geen ankers nodig om netwerken te stabiliseren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning from image contrast adjustments",
                  "es": "Aprender de ajustes de contraste de imagen",
                  "de": "Von Bildkontrastanpassungen lernen",
                  "nl": "Leren van beeldcontrastaanpassingen"
        },
        {
                  "en": "Creating contrasts between network layers",
                  "es": "Crear contrastes entre capas de red",
                  "de": "Kontraste zwischen Netzwerkschichten erstellen",
                  "nl": "Contrasten maken tussen netwerklagen"
        },
        {
                  "en": "Contrasting different image styles only",
                  "es": "Contrastar solo diferentes estilos de imagen",
                  "de": "Nur verschiedene Bildstile kontrastieren",
                  "nl": "Alleen verschillende beeldstijlen contrasteren"
        },
        {
                  "en": "Learning representations by pulling augmented views of same image together while pushing different images apart",
                  "es": "Aprender representaciones acercando vistas aumentadas de la misma imagen mientras alejan imágenes diferentes",
                  "de": "Repräsentationen lernen durch Zusammenziehen erweiterter Ansichten desselben Bildes während verschiedene Bilder auseinander gedrückt werden",
                  "nl": "Representaties leren door geaugmenteerde weergaven van dezelfde afbeelding samen te trekken terwijl verschillende afbeeldingen uit elkaar worden geduwd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Synthesizing photorealistic novel views by encoding volumetric scene in neural network weights",
                  "es": "Sintetizar vistas novedosas fotorrealistas codificando escena volumétrica en pesos de red neuronal",
                  "de": "Fotorealistische neuartige Ansichten synthetisieren durch Kodierung volumetrischer Szene in neuronalen Netzwerkgewichten",
                  "nl": "Fotorealistische nieuwe weergaven synthetiseren door volumetrische scène te coderen in neurale netwerkgewichten"
        },
        {
                  "en": "Creating radiation fields for images",
                  "es": "Crear campos de radiación para imágenes",
                  "de": "Strahlungsfelder für Bilder erstellen",
                  "nl": "Stralingsvelden maken voor afbeeldingen"
        },
        {
                  "en": "Radiating neural signals through fields",
                  "es": "Radiar señales neuronales a través de campos",
                  "de": "Neuronale Signale durch Felder strahlen",
                  "nl": "Neurale signalen uitstralen door velden"
        },
        {
                  "en": "Neural networks for radiant lighting only",
                  "es": "Redes neuronales solo para iluminación radiante",
                  "de": "Neuronale Netzwerke nur für strahlende Beleuchtung",
                  "nl": "Neurale netwerken alleen voor stralende verlichting"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Transforming detection into classification",
                  "es": "Transformar detección en clasificación",
                  "de": "Erkennung in Klassifikation transformieren",
                  "nl": "Detectie transformeren naar classificatie"
        },
        {
                  "en": "End-to-end detection using transformers and bipartite matching, eliminating hand-crafted components",
                  "es": "Detección de extremo a extremo usando transformadores y emparejamiento bipartito, eliminando componentes hechos a mano",
                  "de": "End-to-End-Erkennung mit Transformern und bipartitem Matching, eliminiert handgemachte Komponenten",
                  "nl": "End-to-end detectie met transformers en bipartite matching, elimineert handgemaakte componenten"
        },
        {
                  "en": "Detecting transformers in images",
                  "es": "Detectar transformadores en imágenes",
                  "de": "Transformatoren in Bildern erkennen",
                  "nl": "Transformers detecteren in afbeeldingen"
        },
        {
                  "en": "Using electrical transformers for detection",
                  "es": "Usar transformadores eléctricos para detección",
                  "de": "Elektrische Transformatoren für Erkennung verwenden",
                  "nl": "Elektrische transformatoren gebruiken voor detectie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Randomizing simulation parameters to create diverse training data bridging reality gap",
                  "es": "Aleatorizar parámetros de simulación para crear datos de entrenamiento diversos cerrando brecha de realidad",
                  "de": "Simulationsparameter randomisieren um vielfältige Trainingsdaten zu erstellen die Realitätslücke überbrücken",
                  "nl": "Simulatieparameters randomiseren om diverse trainingsdata te creëren die realiteitskloof overbruggen"
        },
        {
                  "en": "Randomly selecting training domains",
                  "es": "Seleccionar aleatoriamente dominios de entrenamiento",
                  "de": "Trainingsbereiche zufällig auswählen",
                  "nl": "Willekeurig trainingsdomeinen selecteren"
        },
        {
                  "en": "Randomizing only network domains",
                  "es": "Aleatorizar solo dominios de red",
                  "de": "Nur Netzwerkdomänen randomisieren",
                  "nl": "Alleen netwerkdomeinen randomiseren"
        },
        {
                  "en": "Creating random domain names",
                  "es": "Crear nombres de dominio aleatorios",
                  "de": "Zufällige Domainnamen erstellen",
                  "nl": "Willekeurige domeinnamen maken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating synthetic training samples by mixing images and labels to improve generalization and calibration",
                  "es": "Crear muestras de entrenamiento sintéticas mezclando imágenes y etiquetas para mejorar generalización y calibración",
                  "de": "Synthetische Trainingsproben durch Mischen von Bildern und Labels erstellen um Generalisierung und Kalibrierung zu verbessern",
                  "nl": "Synthetische trainingsmonsters creëren door afbeeldingen en labels te mixen om generalisatie en kalibratie te verbeteren"
        },
        {
                  "en": "Creating music mixes from images",
                  "es": "Crear mezclas musicales de imágenes",
                  "de": "Musikmixe aus Bildern erstellen",
                  "nl": "Muziek mixen maken van afbeeldingen"
        },
        {
                  "en": "Mixing different datasets together only",
                  "es": "Solo mezclar diferentes conjuntos de datos juntos",
                  "de": "Nur verschiedene Datensätze zusammenmischen",
                  "nl": "Alleen verschillende datasets samen mixen"
        },
        {
                  "en": "Cutting and mixing network architectures",
                  "es": "Cortar y mezclar arquitecturas de red",
                  "de": "Netzwerkarchitekturen schneiden und mischen",
                  "nl": "Netwerkarchitecturen knippen en mixen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Paying cross attention to multiple tasks",
                  "es": "Prestar atención cruzada a múltiples tareas",
                  "de": "Kreuzaufmerksamkeit auf mehrere Aufgaben richten",
                  "nl": "Kruisaandacht besteden aan meerdere taken"
        },
        {
                  "en": "Attention that crosses image boundaries",
                  "es": "Atención que cruza límites de imagen",
                  "de": "Aufmerksamkeit die Bildgrenzen überschreitet",
                  "nl": "Aandacht die beeldgrenzen overschrijdt"
        },
        {
                  "en": "Attention mechanism allowing one modality (text) to attend to another (vision) for alignment",
                  "es": "Mecanismo de atención permitiendo que una modalidad (texto) atienda a otra (visión) para alineación",
                  "de": "Aufmerksamkeitsmechanismus der einer Modalität (Text) ermöglicht auf eine andere (Vision) zu achten für Ausrichtung",
                  "nl": "Aandachtsmechanisme dat één modaliteit (tekst) naar een andere (visie) laat kijken voor afstemming"
        },
        {
                  "en": "Crossing attention between different network layers",
                  "es": "Cruzar atención entre diferentes capas de red",
                  "de": "Aufmerksamkeit zwischen verschiedenen Netzwerkschichten kreuzen",
                  "nl": "Aandacht kruisen tussen verschillende netwerklagen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Smoothing only incorrect labels",
                  "es": "Suavizar solo etiquetas incorrectas",
                  "de": "Nur falsche Labels glätten",
                  "nl": "Alleen incorrecte labels gladmaken"
        },
        {
                  "en": "Making label text smoother visually",
                  "es": "Hacer texto de etiqueta visualmente más suave",
                  "de": "Labeltext visuell glatter machen",
                  "nl": "Labeltekst visueel gladder maken"
        },
        {
                  "en": "Softening hard targets by assigning small probabilities to incorrect classes preventing overconfidence",
                  "es": "Suavizar objetivos duros asignando pequeñas probabilidades a clases incorrectas previniendo exceso de confianza",
                  "de": "Harte Ziele weicher machen durch Zuweisen kleiner Wahrscheinlichkeiten zu falschen Klassen verhindert Übervertrauen",
                  "nl": "Harde doelen verzachten door kleine waarschijnlijkheden toe te wijzen aan incorrecte klassen voorkomt oververtrouwen"
        },
        {
                  "en": "Smoothing labels to make them more readable",
                  "es": "Suavizar etiquetas para hacerlas más legibles",
                  "de": "Labels glätten um sie lesbarer zu machen",
                  "nl": "Labels gladmaken om ze leesbaarder te maken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning embedding spaces where similar faces are close and different faces are far apart",
                  "es": "Aprender espacios de incrustación donde caras similares están cerca y caras diferentes están lejos",
                  "de": "Embedding-Räume lernen wo ähnliche Gesichter nah und verschiedene Gesichter weit entfernt sind",
                  "nl": "Embedding ruimtes leren waar vergelijkbare gezichten dichtbij en verschillende gezichten ver weg zijn"
        },
        {
                  "en": "Learning to measure image metrics only",
                  "es": "Aprender a medir solo métricas de imagen",
                  "de": "Nur Bildmetriken messen lernen",
                  "nl": "Alleen beeldmetrieken leren meten"
        },
        {
                  "en": "Measuring learning progress only",
                  "es": "Medir solo progreso de aprendizaje",
                  "de": "Nur Lernfortschritt messen",
                  "nl": "Alleen leervoortgang meten"
        },
        {
                  "en": "Metric system conversions for images",
                  "es": "Conversiones de sistema métrico para imágenes",
                  "de": "Metrische Systemumwandlungen für Bilder",
                  "nl": "Metrische systeemconversies voor afbeeldingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating stylish-looking networks",
                  "es": "Crear redes de aspecto elegante",
                  "de": "Stylish aussehende Netzwerke erstellen",
                  "nl": "Stijlvol uitziende netwerken maken"
        },
        {
                  "en": "Generating images in different artistic styles only",
                  "es": "Generar imágenes solo en diferentes estilos artísticos",
                  "de": "Nur Bilder in verschiedenen künstlerischen Stilen generieren",
                  "nl": "Alleen afbeeldingen genereren in verschillende artistieke stijlen"
        },
        {
                  "en": "Styling images after generation",
                  "es": "Estilizar imágenes después de generación",
                  "de": "Bilder nach Generierung stylen",
                  "nl": "Afbeeldingen na generatie stylen"
        },
        {
                  "en": "Controlling specific attributes at different scales through style-based generator architecture",
                  "es": "Controlar atributos específicos a diferentes escalas a través de arquitectura generadora basada en estilo",
                  "de": "Spezifische Attribute in verschiedenen Skalen durch stilbasierte Generator-Architektur steuern",
                  "nl": "Specifieke attributen op verschillende schalen controleren door stijl-gebaseerde generator architectuur"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Matching feature dimensions only",
                  "es": "Coincidir solo dimensiones de características",
                  "de": "Nur Feature-Dimensionen anpassen",
                  "nl": "Alleen feature dimensies matchen"
        },
        {
                  "en": "Aligning network architectures between domains",
                  "es": "Alinear arquitecturas de red entre dominios",
                  "de": "Netzwerkarchitekturen zwischen Domänen ausrichten",
                  "nl": "Netwerkarchitecturen tussen domeinen uitlijnen"
        },
        {
                  "en": "Aligning features in straight lines only",
                  "es": "Alinear características solo en líneas rectas",
                  "de": "Features nur in geraden Linien ausrichten",
                  "nl": "Features alleen in rechte lijnen uitlijnen"
        },
        {
                  "en": "Minimizing distribution discrepancy between source and target domain features for transfer",
                  "es": "Minimizar discrepancia de distribución entre características de dominio fuente y objetivo para transferencia",
                  "de": "Verteilungsdiskrepanz zwischen Quell- und Ziel-Domänen-Features für Transfer minimieren",
                  "nl": "Distributieverschil tussen bron en doel domein features minimaliseren voor overdracht"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Instance is faster than panoptic",
                  "es": "Instancia es más rápida que panóptico",
                  "de": "Instanz ist schneller als panoptisch",
                  "nl": "Instantie is sneller dan panoptisch"
        },
        {
                  "en": "Panoptic provides panoramic views only",
                  "es": "Panóptico proporciona solo vistas panorámicas",
                  "de": "Panoptisch bietet nur Panoramaansichten",
                  "nl": "Panoptisch biedt alleen panoramische weergaven"
        },
        {
                  "en": "Panoptic only segments backgrounds",
                  "es": "Panóptico solo segmenta fondos",
                  "de": "Panoptisch segmentiert nur Hintergründe",
                  "nl": "Panoptisch segmenteert alleen achtergronden"
        },
        {
                  "en": "Panoptic combines instance segmentation (things) with semantic segmentation (stuff) for complete scene parsing",
                  "es": "Panóptico combina segmentación de instancia (cosas) con segmentación semántica (material) para análisis completo de escena",
                  "de": "Panoptisch kombiniert Instanzsegmentierung (Dinge) mit semantischer Segmentierung (Zeug) für vollständige Szenenanalyse",
                  "nl": "Panoptisch combineert instantie segmentatie (dingen) met semantische segmentatie (spul) voor complete scène analyse"
        }
        ],
        correct: 3,
        explanation: {
