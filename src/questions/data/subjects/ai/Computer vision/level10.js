    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Synthesizing photorealistic novel views of 3D scenes from sparse 2D observations",
                  "es": "Sintetizar vistas novedosas fotorrealistas de escenas 3D a partir de observaciones 2D dispersas",
                  "de": "Photorealistische neue Ansichten von 3D-Szenen aus spärlichen 2D-Beobachtungen synthetisieren",
                  "nl": "Fotorealistische nieuwe weergaven van 3D scènes synthetiseren uit schaarse 2D observaties"
        },
        {
                  "en": "Creating neural networks shaped like fields",
                  "es": "Crear redes neuronales con forma de campos",
                  "de": "Neuronale Netzwerke in Feldform erstellen",
                  "nl": "Neurale netwerken maken die gevormd zijn als velden"
        },
        {
                  "en": "Generating radiation patterns for medical imaging",
                  "es": "Generar patrones de radiación para imágenes médicas",
                  "de": "Strahlungsmuster für medizinische Bildgebung generieren",
                  "nl": "Stralingspatronen genereren voor medische beeldvorming"
        },
        {
                  "en": "Radiating neural signals across networks",
                  "es": "Irradiar señales neuronales a través de redes",
                  "de": "Neuronale Signale über Netzwerke ausstrahlen",
                  "nl": "Neurale signalen uitstralen over netwerken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Detecting electrical transformers specifically",
                  "es": "Detectar transformadores eléctricos específicamente",
                  "de": "Spezifisch elektrische Transformatoren erkennen",
                  "nl": "Specifiek elektrische transformatoren detecteren"
        },
        {
                  "en": "Eliminating hand-crafted components like non-maximum suppression through end-to-end learning",
                  "es": "Eliminar componentes hechos a mano como supresión no máxima a través de aprendizaje de extremo a extremo",
                  "de": "Handgemachte Komponenten wie Non-Maximum Suppression durch End-to-End-Lernen eliminieren",
                  "nl": "Handgemaakte componenten zoals non-maximum suppression elimineren door end-to-end leren"
        },
        {
                  "en": "Only detecting transformers in images",
                  "es": "Solo detectar transformadores en imágenes",
                  "de": "Nur Transformatoren in Bildern erkennen",
                  "nl": "Alleen transformatoren detecteren in afbeeldingen"
        },
        {
                  "en": "Transforming detected objects into different shapes",
                  "es": "Transformar objetos detectados en diferentes formas",
                  "de": "Erkannte Objekte in verschiedene Formen transformieren",
                  "nl": "Gedetecteerde objecten transformeren naar verschillende vormen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Diffusing light through optical systems",
                  "es": "Difundir luz a través de sistemas ópticos",
                  "de": "Licht durch optische Systeme diffundieren",
                  "nl": "Licht verspreiden door optische systemen"
        },
        {
                  "en": "Diffusing images across multiple displays",
                  "es": "Difundir imágenes a través de múltiples pantallas",
                  "de": "Bilder über mehrere Displays diffundieren",
                  "nl": "Afbeeldingen verspreiden over meerdere displays"
        },
        {
                  "en": "Spreading model parameters across networks",
                  "es": "Distribuir parámetros de modelo a través de redes",
                  "de": "Modellparameter über Netzwerke verteilen",
                  "nl": "Modelparameters verspreiden over netwerken"
        },
        {
                  "en": "Learning to reverse a gradual noise corruption process to generate high-quality images",
                  "es": "Aprender a revertir un proceso gradual de corrupción de ruido para generar imágenes de alta calidad",
                  "de": "Lernen einen graduellen Rauschkorruptionsprozess umzukehren um hochqualitative Bilder zu generieren",
                  "nl": "Leren een geleidelijk ruiscorruptieproces om te keren om hoogwaardige afbeeldingen te genereren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adapting hardware to software requirements",
                  "es": "Adaptar hardware a requisitos de software",
                  "de": "Hardware an Software-Anforderungen anpassen",
                  "nl": "Hardware aanpassen aan softwarevereisten"
        },
        {
                  "en": "Managing web domain names for vision systems",
                  "es": "Gestionar nombres de dominio web para sistemas de visión",
                  "de": "Web-Domain-Namen für Vision-Systeme verwalten",
                  "nl": "Webdomeinnamen beheren voor visiesystemen"
        },
        {
                  "en": "Transferring models trained on one dataset to perform well on different visual domains",
                  "es": "Transferir modelos entrenados en un conjunto de datos para funcionar bien en diferentes dominios visuales",
                  "de": "Modelle die auf einem Datensatz trainiert wurden auf verschiedene visuelle Domänen übertragen",
                  "nl": "Modellen getraind op één dataset overdragen om goed te presteren op verschillende visuele domeinen"
        },
        {
                  "en": "Adapting models to different computer domains",
                  "es": "Adaptar modelos a diferentes dominios de computadora",
                  "de": "Modelle an verschiedene Computer-Domänen anpassen",
                  "nl": "Modellen aanpassen aan verschillende computerdomeinen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI systems with physical robot bodies only",
                  "es": "Sistemas IA solo con cuerpos de robot físicos",
                  "de": "KI-Systeme nur mit physischen Roboterkörpern",
                  "nl": "AI-systemen alleen met fysieke robotlichamen"
        },
        {
                  "en": "AI systems that learn to interact with the physical world through visual understanding and motor control",
                  "es": "Sistemas IA que aprenden a interactuar con el mundo físico a través de comprensión visual y control motor",
                  "de": "KI-Systeme die lernen mit der physischen Welt durch visuelles Verständnis und Motorsteuerung zu interagieren",
                  "nl": "AI-systemen die leren te interacteren met de fysieke wereld door visueel begrip en motorische controle"
        },
        {
                  "en": "Physical containers for computer vision algorithms",
                  "es": "Contenedores físicos para algoritmos de visión por computadora",
                  "de": "Physische Container für Computer Vision Algorithmen",
                  "nl": "Fysieke containers voor computer vision algoritmes"
        },
        {
                  "en": "Embodying human consciousness in machines",
                  "es": "Encarnar conciencia humana en máquinas",
                  "de": "Menschliches Bewusstsein in Maschinen verkörpern",
                  "nl": "Menselijk bewustzijn belichamen in machines"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Vision transformers only work with images",
                  "es": "Los transformers de visión solo funcionan con imágenes",
                  "de": "Vision Transformer funktionieren nur mit Bildern",
                  "nl": "Vision transformers werken alleen met afbeeldingen"
        },
        {
                  "en": "They eliminate the need for training data",
                  "es": "Eliminan la necesidad de datos de entrenamiento",
                  "de": "Sie eliminieren den Bedarf für Trainingsdaten",
                  "nl": "Ze elimineren de behoefte aan trainingsdata"
        },
        {
                  "en": "Global self-attention enables modeling long-range dependencies without hierarchical inductive biases",
                  "es": "La auto-atención global permite modelar dependencias de largo alcance sin sesgos inductivos jerárquicos",
                  "de": "Globale Selbstaufmerksamkeit ermöglicht Modellierung weitreichender Abhängigkeiten ohne hierarchische induktive Verzerrungen",
                  "nl": "Globale self-attention maakt het modelleren van lange-afstand afhankelijkheden mogelijk zonder hiërarchische inductieve vertekeningen"
        },
        {
                  "en": "ViTs always require less computational resources",
                  "es": "Los ViTs siempre requieren menos recursos computacionales",
                  "de": "ViTs benötigen immer weniger Rechenressourcen",
                  "nl": "ViTs vereisen altijd minder computationele bronnen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Clipping images to standard sizes",
                  "es": "Recortar imágenes a tamaños estándar",
                  "de": "Bilder auf Standardgrößen zuschneiden",
                  "nl": "Afbeeldingen bijsnijden tot standaardformaten"
        },
        {
                  "en": "Only improving image classification accuracy",
                  "es": "Solo mejorar precisión de clasificación de imágenes",
                  "de": "Nur Bildklassifizierungsgenauigkeit verbessern",
                  "nl": "Alleen beeldclassificatie nauwkeurigheid verbeteren"
        },
        {
                  "en": "Learning visual concepts from natural language supervision without manual annotation",
                  "es": "Aprender conceptos visuales de supervisión de lenguaje natural sin anotación manual",
                  "de": "Visuelle Konzepte aus natürlichsprachlicher Supervision ohne manuelle Annotation lernen",
                  "nl": "Visuele concepten leren uit natuurlijke taalsupervisie zonder handmatige annotatie"
        },
        {
                  "en": "Creating clips from video sequences",
                  "es": "Crear clips de secuencias de video",
                  "de": "Clips aus Videosequenzen erstellen",
                  "nl": "Clips maken van videoreeksen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Generating random artistic images",
                  "es": "Generar imágenes artísticas aleatorias",
                  "de": "Zufällige künstlerische Bilder generieren",
                  "nl": "Willekeurige artistieke afbeeldingen genereren"
        },
        {
                  "en": "Text-to-image generation using transformer architectures and discrete variational autoencoders",
                  "es": "Generación de texto-a-imagen usando arquitecturas transformer y autoencoders variacionales discretos",
                  "de": "Text-zu-Bild-Generierung mit Transformer-Architekturen und diskreten Variational Autoencodern",
                  "nl": "Tekst-naar-beeld generatie met transformer architecturen en discrete variationele autoencoders"
        },
        {
                  "en": "Only improving existing image editing tools",
                  "es": "Solo mejorar herramientas de edición de imágenes existentes",
                  "de": "Nur bestehende Bildbearbeitungstools verbessern",
                  "nl": "Alleen bestaande beeldbewerkingstools verbeteren"
        },
        {
                  "en": "Creating Salvador Dalí-style surreal images only",
                  "es": "Crear solo imágenes surrealistas estilo Salvador Dalí",
                  "de": "Nur surrealistische Bilder im Salvador Dalí-Stil erstellen",
                  "nl": "Alleen surrealistische afbeeldingen in Salvador Dalí-stijl maken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Swinging the attention mechanism",
                  "es": "Balancear el mecanismo de atención",
                  "de": "Den Aufmerksamkeitsmechanismus schwingen",
                  "nl": "Het aandachtsmechanisme laten zwaaien"
        },
        {
                  "en": "Eliminating transformer blocks entirely",
                  "es": "Eliminar bloques transformer completamente",
                  "de": "Transformer-Blöcke vollständig eliminieren",
                  "nl": "Transformer blokken volledig elimineren"
        },
        {
                  "en": "Using only small input images",
                  "es": "Usar solo imágenes de entrada pequeñas",
                  "de": "Nur kleine Eingabebilder verwenden",
                  "nl": "Alleen kleine invoer afbeeldingen gebruiken"
        },
        {
                  "en": "Hierarchical structure with shifted windows that limits self-attention to local regions",
                  "es": "Estructura jerárquica con ventanas desplazadas que limita auto-atención a regiones locales",
                  "de": "Hierarchische Struktur mit verschobenen Fenstern die Selbstaufmerksamkeit auf lokale Bereiche begrenzt",
                  "nl": "Hiërarchische structuur met verschoven vensters die self-attention beperkt tot lokale regio's"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating autonomous visual systems",
                  "es": "Crear sistemas visuales autónomos",
                  "de": "Autonome visuelle Systeme erstellen",
                  "nl": "Autonome visuele systemen maken"
        },
        {
                  "en": "Reducing need for human researchers",
                  "es": "Reducir necesidad de investigadores humanos",
                  "de": "Bedarf an menschlichen Forschern reduzieren",
                  "nl": "Behoefte aan menselijke onderzoekers verminderen"
        },
        {
                  "en": "Teaching models to supervise themselves",
                  "es": "Enseñar a modelos a supervisarse a sí mismos",
                  "de": "Modelle lehren sich selbst zu überwachen",
                  "nl": "Modellen leren zichzelf te superviseren"
        },
        {
                  "en": "Learning rich visual representations from unlabeled data by solving pretext tasks",
                  "es": "Aprender representaciones visuales ricas de datos no etiquetados resolviendo tareas de pretexto",
                  "de": "Reiche visuelle Repräsentationen aus unbeschrifteten Daten durch Lösen von Pretext-Aufgaben lernen",
                  "nl": "Rijke visuele representaties leren uit ongelabelde data door pretext taken op te lossen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only improving existing specific models",
                  "es": "Solo mejorar modelos específicos existentes",
                  "de": "Nur bestehende spezifische Modelle verbessern",
                  "nl": "Alleen bestaande specifieke modellen verbeteren"
        },
        {
                  "en": "Building fundamental mathematical foundations",
                  "es": "Construir fundamentos matemáticos fundamentales",
                  "de": "Grundlegende mathematische Fundamente aufbauen",
                  "nl": "Fundamentele wiskundige fundamenten bouwen"
        },
        {
                  "en": "Creating foundation stones for buildings",
                  "es": "Crear piedras fundacionales para edificios",
                  "de": "Grundsteine für Gebäude erstellen",
                  "nl": "Funderingsstenen maken voor gebouwen"
        },
        {
                  "en": "Creating general-purpose visual representations that can adapt to diverse downstream tasks",
                  "es": "Crear representaciones visuales de propósito general que puedan adaptarse a diversas tareas posteriores",
                  "de": "Allzweck-visuelle Repräsentationen erstellen die sich an diverse nachgelagerte Aufgaben anpassen können",
                  "nl": "Algemene visuele representaties creëren die zich kunnen aanpassen aan diverse downstream taken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hiding faces in images for privacy",
                  "es": "Ocultar caras en imágenes por privacidad",
                  "de": "Gesichter in Bildern für Privatsphäre verstecken",
                  "nl": "Gezichten verbergen in afbeeldingen voor privacy"
        },
        {
                  "en": "Creating masks for image editing",
                  "es": "Crear máscaras para edición de imágenes",
                  "de": "Masken für Bildbearbeitung erstellen",
                  "nl": "Maskers maken voor beeldbewerking"
        },
        {
                  "en": "Only for medical image analysis",
                  "es": "Solo para análisis de imágenes médicas",
                  "de": "Nur für medizinische Bildanalyse",
                  "nl": "Alleen voor medische beeldanalyse"
        },
        {
                  "en": "Self-supervised pre-training by reconstructing randomly masked image patches",
                  "es": "Pre-entrenamiento auto-supervisado reconstruyendo parches de imagen enmascarados aleatoriamente",
                  "de": "Selbstüberwachtes Vor-Training durch Rekonstruktion zufällig maskierter Bild-Patches",
                  "nl": "Zelf-gesuperviseerde pre-training door willekeurig gemaskeerde beeldpatches te reconstrueren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Virtual reality applications only",
                  "es": "Solo aplicaciones de realidad virtual",
                  "de": "Nur Virtual Reality Anwendungen",
                  "nl": "Alleen virtual reality toepassingen"
        },
        {
                  "en": "Version control for AI models",
                  "es": "Control de versiones para modelos IA",
                  "de": "Versionskontrolle für KI-Modelle",
                  "nl": "Versiebeheer voor AI modellen"
        },
        {
                  "en": "Seamless integration of vision and language understanding in large language models",
                  "es": "Integración perfecta de comprensión de visión y lenguaje en modelos de lenguaje grandes",
                  "de": "Nahtlose Integration von Vision- und Sprachverständnis in großen Sprachmodellen",
                  "nl": "Naadloze integratie van visie en taalbegrip in grote taalmodellen"
        },
        {
                  "en": "Fourth version of generative pre-training",
                  "es": "Cuarta versión de pre-entrenamiento generativo",
                  "de": "Vierte Version von generativem Vor-Training",
                  "nl": "Vierde versie van generatieve pre-training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only optimizing hyperparameters",
                  "es": "Solo optimizar hiperparámetros",
                  "de": "Nur Hyperparameter optimieren",
                  "nl": "Alleen hyperparameters optimaliseren"
        },
        {
                  "en": "NASA's space exploration programs",
                  "es": "Programas de exploración espacial de NASA",
                  "de": "NASAs Weltraumerkundungsprogramme",
                  "nl": "NASA's ruimteverkenningsprogramma's"
        },
        {
                  "en": "Discovering novel architectures that outperform human-designed networks for specific constraints",
                  "es": "Descubrir arquitecturas novedosas que superan redes diseñadas por humanos para restricciones específicas",
                  "de": "Neuartige Architekturen entdecken die menschlich designte Netzwerke für spezifische Beschränkungen übertreffen",
                  "nl": "Nieuwe architecturen ontdekken die menselijk ontworpen netwerken overtreffen voor specifieke beperkingen"
        },
        {
                  "en": "Searching existing architectures in databases",
                  "es": "Buscar arquitecturas existentes en bases de datos",
                  "de": "Bestehende Architekturen in Datenbanken suchen",
                  "nl": "Bestaande architecturen zoeken in databases"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Achieving state-of-the-art image generation through iterative denoising processes",
                  "es": "Lograr generación de imágenes de vanguardia a través de procesos iterativos de reducción de ruido",
                  "de": "State-of-the-Art Bildgenerierung durch iterative Entrauschungsprozesse erreichen",
                  "nl": "State-of-the-art beeldgeneratie bereiken door iteratieve ontruis processen"
        },
        {
                  "en": "Only for data augmentation purposes",
                  "es": "Solo para propósitos de aumento de datos",
                  "de": "Nur für Datenaugmentationszwecke",
                  "nl": "Alleen voor data augmentatie doeleinden"
        },
        {
                  "en": "Diffusing light through optical systems",
                  "es": "Difundir luz a través de sistemas ópticos",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Testing models at specific times only",
                  "es": "Probar modelos solo en momentos específicos",
                  "de": "Modelle nur zu bestimmten Zeiten testen",
                  "nl": "Modellen alleen op specifieke tijden testen"
        },
        {
                  "en": "Time-based model scheduling",
                  "es": "Programación de modelos basada en tiempo",
                  "de": "Zeitbasierte Modellplanung",
                  "nl": "Tijdgebaseerde modelplanning"
        },
        {
                  "en": "Adapting test procedures to model capabilities",
                  "es": "Adaptar procedimientos de prueba a capacidades del modelo",
                  "de": "Testverfahren an Modellfähigkeiten anpassen",
                  "nl": "Testprocedures aanpassen aan modelcapaciteiten"
        },
        {
                  "en": "Adapting models to distribution shifts encountered during inference without labels",
                  "es": "Adaptar modelos a cambios de distribución encontrados durante inferencia sin etiquetas",
                  "de": "Modelle an Verteilungsverschiebungen anpassen die während Inferenz ohne Labels auftreten",
                  "nl": "Modellen aanpassen aan distributieveranderingen ondervonden tijdens inferentie zonder labels"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only improving processor architecture",
                  "es": "Solo mejorar arquitectura de procesador",
                  "de": "Nur Prozessorarchitektur verbessern",
                  "nl": "Alleen processorarchitectuur verbeteren"
        },
        {
                  "en": "Event-driven processing that mimics biological vision for ultra-low power consumption",
                  "es": "Procesamiento dirigido por eventos que imita visión biológica para consumo de energía ultra-bajo",
                  "de": "Ereignisgesteuerte Verarbeitung die biologische Vision nachahmt für ultra-niedrigen Energieverbrauch",
                  "nl": "Event-gedreven verwerking die biologische visie nabootst voor ultra-laag energieverbruik"
        },
        {
                  "en": "Neurological analysis of computer users",
                  "es": "Análisis neurológico de usuarios de computadora",
                  "de": "Neurologische Analyse von Computerbenutzern",
                  "nl": "Neurologische analyse van computergebruikers"
        },
        {
                  "en": "Making computers look like neurons",
                  "es": "Hacer que las computadoras parezcan neuronas",
                  "de": "Computer wie Neuronen aussehen lassen",
                  "nl": "Computers eruit laten zien als neuronen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enabling models to understand cause-effect relationships rather than just correlations in visual data",
                  "es": "Permitir a modelos entender relaciones causa-efecto en lugar de solo correlaciones en datos visuales",
                  "de": "Modellen ermöglichen Ursache-Wirkungs-Beziehungen zu verstehen anstatt nur Korrelationen in visuellen Daten",
                  "nl": "Modellen in staat stellen oorzaak-gevolg relaties te begrijpen in plaats van alleen correlaties in visuele data"
        },
        {
                  "en": "Only for medical diagnosis applications",
                  "es": "Solo para aplicaciones de diagnóstico médico",
                  "de": "Nur für medizinische Diagnoseanwendungen",
                  "nl": "Alleen voor medische diagnose toepassingen"
        },
        {
                  "en": "Causing computers to see better",
                  "es": "Hacer que las computadoras vean mejor",
                  "de": "Computer dazu bringen besser zu sehen",
                  "nl": "Computers beter laten zien"
        },
        {
                  "en": "Finding root causes of computer errors",
                  "es": "Encontrar causas raíz de errores de computadora",
                  "de": "Grundursachen von Computerfehlern finden",
                  "nl": "Hoofdoorzaken van computerfouten vinden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Exponential speedup for certain optimization and pattern recognition problems",
                  "es": "Aceleración exponencial para ciertos problemas de optimización y reconocimiento de patrones",
                  "de": "Exponentieller Speedup für bestimmte Optimierungs- und Mustererkennungsprobleme",
                  "nl": "Exponentiële versnelling voor bepaalde optimalisatie en patroonherkenningsproblemen"
        },
        {
                  "en": "Making computers quantum mechanical",
                  "es": "Hacer computadoras cuántico-mecánicas",
                  "de": "Computer quantenmechanisch machen",
                  "nl": "Computers kwantummechanisch maken"
        },
        {
                  "en": "Only for quantum physics applications",
                  "es": "Solo para aplicaciones de física cuántica",
                  "de": "Nur für Quantenphysik-Anwendungen",
                  "nl": "Alleen voor kwantumfysica toepassingen"
        },
        {
                  "en": "Quantum entanglement of images",
                  "es": "Entrelazamiento cuántico de imágenes",
                  "de": "Quantenverschränkung von Bildern",
                  "nl": "Kwantumverstrengeling van afbeeldingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measuring radiation fields in space",
                  "es": "Medir campos de radiación en el espacio",
                  "de": "Strahlungsfelder im Weltraum messen",
                  "nl": "Stralingsvelden in de ruimte meten"
        },
        {
                  "en": "Synthesizing photorealistic novel views of 3D scenes from sparse input images",
                  "es": "Sintetizar vistas novedosas fotorrealistas de escenas 3D de imágenes de entrada dispersas",
                  "de": "Fotorealistische neue Ansichten von 3D-Szenen aus spärlichen Eingabebildern synthetisieren",
                  "nl": "Fotorealistische nieuwe weergaven van 3D scènes synthetiseren uit schaarse invoer afbeeldingen"
        },
        {
                  "en": "Creating neural networks that emit radiation",
                  "es": "Crear redes neuronales que emiten radiación",
                  "de": "Neuronale Netzwerke erstellen die Strahlung emittieren",
                  "nl": "Neurale netwerken maken die straling uitzenden"
        },
        {
                  "en": "Analyzing neural pathway radiations",
                  "es": "Analizar radiaciones de vías neuronales",
                  "de": "Neuronale Bahnstrahlungen analysieren",
                  "nl": "Neurale baan stralingen analyseren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Multi-resolution hash encoding that accelerates NeRF training from hours to seconds",
                  "es": "Codificación hash multi-resolución que acelera entrenamiento de NeRF de horas a segundos",
                  "de": "Multi-Auflösungs-Hash-Kodierung die NeRF-Training von Stunden auf Sekunden beschleunigt",
                  "nl": "Multi-resolutie hash encoding die NeRF training versnelt van uren naar seconden"
        },
        {
                  "en": "Next-generation programming for graphics",
                  "es": "Programación de próxima generación para gráficos",
                  "de": "Next-Generation Programmierung für Grafiken",
                  "nl": "Next-generatie programmering voor graphics"
        },
        {
                  "en": "Instant neural graphics processor hardware",
                  "es": "Hardware de procesador gráfico neuronal instantáneo",
                  "de": "Instant Neural Graphics Prozessor Hardware",
                  "nl": "Instant neurale grafische processor hardware"
        },
        {
                  "en": "Neural generation protocol for images",
                  "es": "Protocolo de generación neuronal para imágenes",
                  "de": "Neurales Generierungsprotokoll für Bilder",
                  "nl": "Neuraal generatieprotocol voor afbeeldingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Statistical method for image analysis",
                  "es": "Método estadístico para análisis de imágenes",
                  "de": "Statistische Methode für Bildanalyse",
                  "nl": "Statistische methode voor beeldanalyse"
        },
        {
                  "en": "Splattering Gaussian noise on images",
                  "es": "Salpicar ruido Gaussiano en imágenes",
                  "de": "Gaußsches Rauschen auf Bilder spritzen",
                  "nl": "Gaussische ruis spatten op afbeeldingen"
        },
        {
                  "en": "3D version of normal distribution plots",
                  "es": "Versión 3D de gráficos de distribución normal",
                  "de": "3D-Version von Normalverteilungsplots",
                  "nl": "3D versie van normale distributie plots"
        },
        {
                  "en": "Explicit 3D point representation with Gaussian primitives enabling real-time rendering speeds",
                  "es": "Representación de puntos 3D explícita con primitivas Gaussianas permitiendo velocidades de renderizado en tiempo real",
                  "de": "Explizite 3D-Punkt-Repräsentation mit Gaußschen Primitiven ermöglicht Echtzeit-Rendering-Geschwindigkeiten",
                  "nl": "Expliciete 3D punt representatie met Gaussische primitieven maakt real-time rendering snelheden mogelijk"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining geometric mapping with semantic understanding of objects for robust localization",
                  "es": "Combinar mapeo geométrico con comprensión semántica de objetos para localización robusta",
                  "de": "Geometrisches Mapping mit semantischem Objektverständnis kombinieren für robuste Lokalisierung",
                  "nl": "Geometrische mapping combineren met semantisch begrip van objecten voor robuuste lokalisatie"
        },
        {
                  "en": "Slamming objects based on semantics",
                  "es": "Golpear objetos basado en semántica",
                  "de": "Objekte basierend auf Semantik schlagen",
                  "nl": "Objecten slaan op basis van semantiek"
        },
        {
                  "en": "Semantic analysis of slam poetry",
                  "es": "Análisis semántico de poesía slam",
                  "de": "Semantische Analyse von Slam-Poesie",
                  "nl": "Semantische analyse van slam poëzie"
        },
        {
                  "en": "Simultaneous language and motion tracking",
                  "es": "Seguimiento simultáneo de lenguaje y movimiento",
                  "de": "Simultanes Sprach- und Bewegungstracking",
                  "nl": "Gelijktijdige taal en beweging tracking"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning continuous implicit functions that predict occupancy probabilities at any 3D point",
                  "es": "Aprender funciones implícitas continuas que predicen probabilidades de ocupación en cualquier punto 3D",
                  "de": "Kontinuierliche implizite Funktionen lernen die Belegungswahrscheinlichkeiten an jedem 3D-Punkt vorhersagen",
                  "nl": "Continue impliciete functies leren die bezettingswaarschijnlijkheden voorspellen op elk 3D punt"
        },
        {
                  "en": "Occupying network bandwidth efficiently",
                  "es": "Ocupar ancho de banda de red eficientemente",
                  "de": "Netzwerkbandbreite effizient belegen",
                  "nl": "Netwerkbandbreedte efficiënt bezetten"
        },
        {
                  "en": "Tracking how occupied spaces are",
                  "es": "Rastrear qué tan ocupados están los espacios",
                  "de": "Verfolgen wie belegt Räume sind",
                  "nl": "Bijhouden hoe bezet ruimtes zijn"
        },
        {
                  "en": "Networks for room occupancy detection",
                  "es": "Redes para detección de ocupación de habitaciones",
                  "de": "Netzwerke für Raumbelegungserkennung",
                  "nl": "Netwerken voor kamer bezettingsdetectie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ground-level image capture",
                  "es": "Captura de imagen a nivel del suelo",
                  "de": "Bildaufnahme auf Bodenhöhe",
                  "nl": "Beeld vastleggen op grondniveau"
        },
        {
                  "en": "Grounding electrical circuits in vision systems",
                  "es": "Conectar a tierra circuitos eléctricos en sistemas de visión",
                  "de": "Elektrische Schaltkreise in Vision-Systemen erden",
                  "nl": "Elektrische circuits aarden in visiesystemen"
        },
        {
                  "en": "Localizing objects or regions in images that correspond to textual descriptions or queries",
                  "es": "Localizar objetos o regiones en imágenes que corresponden a descripciones o consultas textuales",
                  "de": "Objekte oder Regionen in Bildern lokalisieren die Textbeschreibungen oder Abfragen entsprechen",
                  "nl": "Objecten of regio's in afbeeldingen lokaliseren die overeenkomen met tekstuele beschrijvingen of queries"
        },
        {
                  "en": "Visual foundation training only",
                  "es": "Solo entrenamiento de fundación visual",
                  "de": "Nur visuelles Grundlagentraining",
                  "nl": "Alleen visuele basis training"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Scoring visual similarity only",
                  "es": "Solo puntuar similitud visual",
                  "de": "Nur visuelle Ähnlichkeit bewerten",
                  "nl": "Alleen visuele gelijkenis scoren"
        },
        {
                  "en": "Learning gradient of log-probability density to enable sampling through Langevin dynamics",
                  "es": "Aprender gradiente de densidad de log-probabilidad para permitir muestreo a través de dinámica de Langevin",
                  "de": "Gradient der Log-Wahrscheinlichkeitsdichte lernen um Sampling durch Langevin-Dynamik zu ermöglichen",
                  "nl": "Gradiënt van log-waarschijnlijkheidsdichtheid leren om sampling mogelijk te maken door Langevin dynamiek"
        },
        {
                  "en": "Scoring generated images based on quality",
                  "es": "Puntuar imágenes generadas basado en calidad",
                  "de": "Generierte Bilder basierend auf Qualität bewerten",
                  "nl": "Gegenereerde afbeeldingen scoren op kwaliteit"
        },
        {
                  "en": "Matching scores between different models",
                  "es": "Coincidir puntuaciones entre diferentes modelos",
                  "de": "Scores zwischen verschiedenen Modellen abgleichen",
                  "nl": "Scores matchen tussen verschillende modellen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bird detection for environmental awareness",
                  "es": "Detección de aves para conciencia ambiental",
                  "de": "Vogelerkennung für Umweltbewusstsein",
                  "nl": "Vogeldetectie voor milieubewustzijn"
        },
        {
                  "en": "Using beverage containers as reference points",
                  "es": "Usar contenedores de bebidas como puntos de referencia",
                  "de": "Getränkebehälter als Referenzpunkte verwenden",
                  "nl": "Drank containers gebruiken als referentiepunten"
        },
        {
                  "en": "Unified 3D spatial representation from multi-camera inputs for consistent object detection and mapping",
                  "es": "Representación espacial 3D unificada de entradas multi-cámara para detección y mapeo consistente de objetos",
                  "de": "Einheitliche 3D-Raum-Repräsentation aus Multi-Kamera-Eingaben für konsistente Objekterkennung und Kartierung",
                  "nl": "Uniforme 3D ruimtelijke representatie van multi-camera inputs voor consistente objectdetectie en mapping"
        },
        {
                  "en": "Top-down image transformation only",
                  "es": "Solo transformación de imagen de arriba hacia abajo",
                  "de": "Nur Top-Down-Bildtransformation",
                  "nl": "Alleen top-down beeldtransformatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learnable object queries that directly predict object sets without anchors or proposals",
                  "es": "Consultas de objetos aprendibles que predicen directamente conjuntos de objetos sin anclas o propuestas",
                  "de": "Lernbare Objekt-Queries die direkt Objektmengen ohne Anker oder Vorschläge vorhersagen",
                  "nl": "Leerbare object queries die direct objectsets voorspellen zonder ankers of voorstellen"
        },
        {
                  "en": "Querying databases for object information",
                  "es": "Consultar bases de datos para información de objetos",
                  "de": "Datenbanken nach Objektinformationen abfragen",
                  "nl": "Databases bevragen voor objectinformatie"
        },
        {
                  "en": "User queries for what to detect",
                  "es": "Consultas de usuario sobre qué detectar",
                  "de": "Benutzeranfragen was zu erkennen ist",
                  "nl": "Gebruikersvragen over wat te detecteren"
        },
        {
                  "en": "SQL queries for image databases",
                  "es": "Consultas SQL para bases de datos de imágenes",
                  "de": "SQL-Abfragen für Bilddatenbanken",
                  "nl": "SQL queries voor afbeeldingsdatabases"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Convolution extensions for existing models",
                  "es": "Extensiones de convolución para modelos existentes",
                  "de": "Faltungserweiterungen für bestehende Modelle",
                  "nl": "Convolutie extensies voor bestaande modellen"
        },
        {
                  "en": "Modernized CNN architecture matching Vision Transformers performance using pure convolutions",
                  "es": "Arquitectura CNN modernizada igualando rendimiento de Vision Transformers usando convoluciones puras",
                  "de": "Modernisierte CNN-Architektur die Vision Transformers Leistung mit reinen Faltungen erreicht",
                  "nl": "Gemoderniseerde CNN architectuur die Vision Transformers prestaties evenaart met pure convoluties"
        },
        {
                  "en": "Converting transformers to CNNs only",
                  "es": "Solo convertir transformers a CNNs",
                  "de": "Nur Transformer zu CNNs konvertieren",
                  "nl": "Alleen transformers converteren naar CNNs"
        },
        {
                  "en": "Next generation of convolution operations",
                  "es": "Próxima generación de operaciones de convolución",
                  "de": "Nächste Generation von Faltungsoperationen",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Prompt responses from vision systems",
                  "es": "Respuestas rápidas de sistemas de visión",
                  "de": "Schnelle Antworten von Vision-Systemen",
                  "nl": "Snelle reacties van visiesystemen"
        },
        {
                  "en": "Engineering better prompts for user interfaces",
                  "es": "Ingeniería de mejores avisos para interfaces de usuario",
                  "de": "Bessere Eingabeaufforderungen für Benutzeroberflächen entwickeln",
                  "nl": "Betere prompts ontwikkelen voor gebruikersinterfaces"
        },
        {
                  "en": "Crafting textual inputs to steer model behavior and extract capabilities without retraining",
                  "es": "Elaborar entradas textuales para dirigir comportamiento del modelo y extraer capacidades sin reentrenar",
                  "de": "Textuelle Eingaben gestalten um Modellverhalten zu steuern und Fähigkeiten ohne Neutraining zu extrahieren",
                  "nl": "Tekstuele inputs maken om modelgedrag te sturen en capaciteiten te extraheren zonder hertraining"
        },
        {
                  "en": "Only for text generation models",
                  "es": "Solo para modelos de generación de texto",
                  "de": "Nur für Textgenerierungsmodelle",
                  "nl": "Alleen voor tekstgeneratie modellen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Segmenting anything using traditional methods",
                  "es": "Segmentar cualquier cosa usando métodos tradicionales",
                  "de": "Alles mit traditionellen Methoden segmentieren",
                  "nl": "Alles segmenteren met traditionele methoden"
        },
        {
                  "en": "SAM file format for images",
                  "es": "Formato de archivo SAM para imágenes",
                  "de": "SAM-Dateiformat für Bilder",
                  "nl": "SAM bestandsformaat voor afbeeldingen"
        },
        {
                  "en": "Sampling anything in images",
                  "es": "Muestrear cualquier cosa en imágenes",
                  "de": "Alles in Bildern sampeln",
                  "nl": "Alles samplen in afbeeldingen"
        },
        {
                  "en": "Promptable segmentation foundation model trained on 1B+ masks enabling zero-shot segmentation",
                  "es": "Modelo fundacional de segmentación con prompts entrenado en 1B+ máscaras permitiendo segmentación de cero disparos",
                  "de": "Promptbares Segmentierungs-Foundation-Model trainiert auf 1B+ Masken ermöglicht Zero-Shot-Segmentierung",
                  "nl": "Promptbaar segmentatie foundation model getraind op 1B+ maskers maakt zero-shot segmentatie mogelijk"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Neural processing for faster rendering",
                  "es": "Procesamiento neuronal para renderizado más rápido",
                  "de": "Neuronale Verarbeitung für schnelleres Rendering",
                  "nl": "Neurale verwerking voor snellere rendering"
        },
        {
                  "en": "Using neural networks to synthesize images from 3D scene representations with photorealistic quality",
                  "es": "Usar redes neuronales para sintetizar imágenes de representaciones de escena 3D con calidad fotorrealista",
                  "de": "Neuronale Netzwerke verwenden um Bilder aus 3D-Szenenrepräsentationen mit fotorealistischer Qualität zu synthetisieren",
                  "nl": "Neurale netwerken gebruiken om afbeeldingen te synthetiseren uit 3D scène representaties met fotorealistische kwaliteit"
        },
        {
                  "en": "Rendering neural network architectures visually",
                  "es": "Renderizar arquitecturas de redes neuronales visualmente",
                  "de": "Neuronale Netzwerkarchitekturen visuell rendern",
                  "nl": "Neurale netwerkarchitecturen visueel renderen"
        },
        {
                  "en": "Rendering brain scans only",
                  "es": "Solo renderizar escaneos cerebrales",
                  "de": "Nur Gehirnscans rendern",
                  "nl": "Alleen hersenscanners renderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Testing while training simultaneously",
                  "es": "Probar mientras entrena simultáneamente",
                  "de": "Testen während gleichzeitigem Training",
                  "nl": "Testen tijdens gelijktijdig trainen"
        },
        {
                  "en": "Training models only during testing phase",
                  "es": "Entrenar modelos solo durante fase de prueba",
                  "de": "Modelle nur während Testphase trainieren",
                  "nl": "Modellen alleen tijdens testfase trainen"
        },
        {
                  "en": "Updating model parameters during inference using self-supervised objectives from test data",
                  "es": "Actualizar parámetros del modelo durante inferencia usando objetivos auto-supervisados de datos de prueba",
                  "de": "Modellparameter während Inferenz aktualisieren mit selbstüberwachten Zielen aus Testdaten",
                  "nl": "Modelparameters bijwerken tijdens inferentie met zelf-gesuperviseerde doelstellingen uit testdata"
        },
        {
                  "en": "Training on test datasets",
                  "es": "Entrenar en conjuntos de datos de prueba",
                  "de": "Auf Testdatensätzen trainieren",
                  "nl": "Trainen op test datasets"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Compositing visual elements in images",
                  "es": "Componer elementos visuales en imágenes",
                  "de": "Visuelle Elemente in Bildern zusammensetzen",
                  "nl": "Visuele elementen samenstellen in afbeeldingen"
        },
        {
                  "en": "Understanding complex concepts by combining simpler visual and linguistic primitives systematically",
                  "es": "Entender conceptos complejos combinando primitivas visuales y lingüísticas más simples sistemáticamente",
                  "de": "Komplexe Konzepte verstehen durch systematische Kombination einfacherer visueller und linguistischer Primitive",
                  "nl": "Complexe concepten begrijpen door eenvoudigere visuele en linguïstische primitieven systematisch te combineren"
        },
        {
                  "en": "Creating composite images only",
                  "es": "Solo crear imágenes compuestas",
                  "de": "Nur zusammengesetzte Bilder erstellen",
                  "nl": "Alleen samengestelde afbeeldingen maken"
        },
        {
                  "en": "Compositional music for vision tasks",
                  "es": "Música compositiva para tareas de visión",
                  "de": "Kompositorische Musik für Vision-Aufgaben",
                  "nl": "Compositorische muziek voor visietaken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Detecting whether vocabulary is open or closed",
                  "es": "Detectar si el vocabulario es abierto o cerrado",
                  "de": "Erkennen ob Vokabular offen oder geschlossen ist",
                  "nl": "Detecteren of vocabulaire open of gesloten is"
        },
        {
                  "en": "Vocabulary detection in text documents",
                  "es": "Detección de vocabulario en documentos de texto",
                  "de": "Vokabularerkennung in Textdokumenten",
                  "nl": "Vocabulaire detectie in tekstdocumenten"
        },
        {
                  "en": "Detecting arbitrary object categories described in text, not limited to predefined training classes",
                  "es": "Detectar categorías de objetos arbitrarias descritas en texto, no limitadas a clases de entrenamiento predefinidas",
                  "de": "Beliebige Objektkategorien erkennen die in Text beschrieben sind, nicht auf vordefinierte Trainingsklassen begrenzt",
                  "nl": "Willekeurige objectcategorieën detecteren beschreven in tekst, niet beperkt tot voorgedefinieerde trainingsklassen"
        },
        {
                  "en": "Open-ended question answering only",
                  "es": "Solo respuesta a preguntas de final abierto",
                  "de": "Nur offene Fragenbeantwortung",
                  "nl": "Alleen open-einde vraagbeantwoording"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating mesh structures with neural networks",
                  "es": "Crear estructuras de malla con redes neuronales",
                  "de": "Mesh-Strukturen mit neuronalen Netzwerken erstellen",
                  "nl": "Mesh structuren maken met neurale netwerken"
        },
        {
                  "en": "Neural analysis of mesh quality",
                  "es": "Análisis neuronal de calidad de malla",
                  "de": "Neuronale Analyse von Mesh-Qualität",
                  "nl": "Neurale analyse van mesh kwaliteit"
        },
        {
                  "en": "Rendering mesh networks visually",
                  "es": "Renderizar redes de malla visualmente",
                  "de": "Mesh-Netzwerke visuell rendern",
                  "nl": "Mesh netwerken visueel renderen"
        },
        {
                  "en": "Learning neural textures and materials on mesh surfaces for differentiable rendering pipelines",
                  "es": "Aprender texturas y materiales neuronales en superficies de malla para pipelines de renderizado diferenciable",
                  "de": "Neuronale Texturen und Materialien auf Mesh-Oberflächen lernen für differenzierbare Rendering-Pipelines",
                  "nl": "Neurale texturen en materialen leren op mesh oppervlakken voor differentieerbare rendering pipelines"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dynamic memory allocation for reconstruction",
                  "es": "Asignación dinámica de memoria para reconstrucción",
                  "de": "Dynamische Speicherzuweisung für Rekonstruktion",
                  "nl": "Dynamische geheugen toewijzing voor reconstructie"
        },
        {
                  "en": "Real-time scene updates only",
                  "es": "Solo actualizaciones de escena en tiempo real",
                  "de": "Nur Echtzeit-Szenenaktualisierungen",
                  "nl": "Alleen real-time scène updates"
        },
        {
                  "en": "Reconstructing scenes that change dynamically",
                  "es": "Reconstruir escenas que cambian dinámicamente",
                  "de": "Szenen rekonstruieren die sich dynamisch ändern",
                  "nl": "Scènes reconstrueren die dynamisch veranderen"
        },
        {
                  "en": "Modeling time-varying geometry, appearance, and motion from video requiring spatio-temporal consistency",
                  "es": "Modelar geometría, apariencia y movimiento variables en tiempo de video requiriendo consistencia espacio-temporal",
                  "de": "Zeitvariable Geometrie, Aussehen und Bewegung aus Video modellieren erfordert raum-zeitliche Konsistenz",
                  "nl": "Tijd-variërende geometrie, uiterlijk en beweging modelleren uit video vereist ruimte-tijdelijke consistentie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Global positioning for AI agents",
                  "es": "Posicionamiento global para agentes IA",
                  "de": "Globale Positionierung für KI-Agenten",
                  "nl": "Wereldwijde positionering voor AI agenten"
        },
        {
                  "en": "Modeling world geography only",
                  "es": "Solo modelar geografía mundial",
                  "de": "Nur Weltgeographie modellieren",
                  "nl": "Alleen wereldgeografie modelleren"
        },
        {
                  "en": "3D models of the entire world",
                  "es": "Modelos 3D del mundo entero",
                  "de": "3D-Modelle der gesamten Welt",
                  "nl": "3D modellen van de hele wereld"
        },
        {
                  "en": "Learning predictive models of visual environment dynamics for planning and simulation-based reasoning",
                  "es": "Aprender modelos predictivos de dinámicas de entorno visual para planificación y razonamiento basado en simulación",
                  "de": "Prädiktive Modelle visueller Umgebungsdynamiken für Planung und simulationsbasiertes Denken lernen",
                  "nl": "Predictieve modellen leren van visuele omgevingsdynamiek voor planning en simulatie-gebaseerd redeneren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Morphing sensor shapes dynamically",
                  "es": "Transformar formas de sensor dinámicamente",
                  "de": "Sensorformen dynamisch morphen",
                  "nl": "Sensor vormen dynamisch morfen"
        },
        {
                  "en": "Neurological analysis of vision only",
                  "es": "Solo análisis neurológico de visión",
                  "de": "Nur neurologische Analyse von Vision",
                  "nl": "Alleen neurologische analyse van visie"
        },
        {
                  "en": "Sensors shaped like neurons",
                  "es": "Sensores con forma de neuronas",
                  "de": "Wie Neuronen geformte Sensoren",
                  "nl": "Sensoren gevormd als neuronen"
        },
        {
                  "en": "Event-based cameras with microsecond temporal resolution and ultra-low power for dynamic scenes",
                  "es": "Cámaras basadas en eventos con resolución temporal de microsegundos y ultra-bajo consumo para escenas dinámicas",
                  "de": "Ereignisbasierte Kameras mit Mikrosekunden-Zeitauflösung und ultra-niedrigem Stromverbrauch für dynamische Szenen",
                  "nl": "Event-gebaseerde camera's met microseconde temporele resolutie en ultra-laag vermogen voor dynamische scènes"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Neural networks that work implicitly",
                  "es": "Redes neuronales que trabajan implícitamente",
                  "de": "Neuronale Netzwerke die implizit arbeiten",
                  "nl": "Neurale netwerken die impliciet werken"
        },
        {
                  "en": "Representing signals as continuous functions parameterized by neural networks instead of discrete samples",
                  "es": "Representar señales como funciones continuas parametrizadas por redes neuronales en lugar de muestras discretas",
                  "de": "Signale als kontinuierliche durch neuronale Netzwerke parametrisierte Funktionen anstatt diskrete Samples repräsentieren",
                  "nl": "Signalen representeren als continue functies geparametriseerd door neurale netwerken in plaats van discrete samples"
        },
        {
                  "en": "Implicit rather than explicit neural connections",
                  "es": "Conexiones neuronales implícitas en lugar de explícitas",
                  "de": "Implizite statt explizite neuronale Verbindungen",
                  "nl": "Impliciete in plaats van expliciete neurale verbindingen"
        },
        {
                  "en": "Representing neurons implicitly only",
                  "es": "Solo representar neuronas implícitamente",
                  "de": "Nur Neuronen implizit repräsentieren",
                  "nl": "Alleen neuronen impliciet representeren"
        }
        ],
        correct: 1,
        explanation: {
