    ...
    questions: [
      {
        ...
        },
        {
                  ...
                  "es": "Para hacer imágenes más pequeñas",
                  "de": "Um Bilder kleiner zu machen",
                  "nl": "Om afbeeldingen kleiner te maken"
        },
        {
                  "en": "To change image colors only",
                  "es": "Solo para cambiar colores de imagen",
                  "de": "Nur um Bildfarben zu ändern",
                  "nl": "Alleen om beeldkleuren te veranderen"
        },
        {
                  "en": "To reduce noise and enhance image features",
                  "es": "Para reducir ruido y mejorar características de imagen",
                  "de": "Um Rauschen zu reduzieren und Bildmerkmale zu verbessern",
                  "nl": "Om ruis te verminderen en beeldkenmerken te verbeteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Boundaries between different objects or regions",
                  "es": "Límites entre diferentes objetos o regiones",
                  "de": "Grenzen zwischen verschiedenen Objekten oder Bereichen",
                  "nl": "Grenzen tussen verschillende objecten of gebieden"
        },
        {
                  "en": "Image file size",
                  "es": "Tamaño de archivo de imagen",
                  "de": "Bilddateigröße",
                  "nl": "Beeldbestandsgrootte"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only affects the image corners",
                  "es": "Solo afecta las esquinas de la imagen",
                  "de": "Beeinflusst nur die Bildecken",
                  "nl": "Beïnvloedt alleen de beeldhoeken"
        },
        {
                  "en": "Changes the overall lightness of all pixels uniformly",
                  "es": "Cambia la luminosidad general de todos los píxeles uniformemente",
                  "de": "Ändert die Gesamthelligkeit aller Pixel gleichmäßig",
                  "nl": "Verandert de algehele lichtheid van alle pixels uniform"
        },
        {
                  "en": "Converts color to black and white",
                  "es": "Convierte color a blanco y negro",
                  "de": "Konvertiert Farbe zu Schwarz-Weiß",
                  "nl": "Converteert kleur naar zwart-wit"
        },
        {
                  "en": "Changes image dimensions",
                  "es": "Cambia las dimensiones de la imagen",
                  "de": "Ändert Bildabmessungen",
                  "nl": "Verandert beeldafmetingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Brightness only affects colors, contrast affects shapes",
                  "es": "El brillo solo afecta colores, el contraste afecta formas",
                  "de": "Helligkeit beeinflusst nur Farben, Kontrast beeinflusst Formen",
                  "nl": "Helderheid beïnvloedt alleen kleuren, contrast beïnvloedt vormen"
        },
        {
                  "en": "Brightness shifts all values equally, contrast stretches the range between light and dark",
                  "es": "El brillo desplaza todos los valores igualmente, el contraste estira el rango entre claro y oscuro",
                  "de": "Helligkeit verschiebt alle Werte gleich, Kontrast streckt den Bereich zwischen hell und dunkel",
                  "nl": "Helderheid verschuift alle waarden gelijk, contrast rekt het bereik tussen licht en donker op"
        },
        {
                  "en": "Contrast only works on black and white images",
                  "es": "El contraste solo funciona en imágenes en blanco y negro",
                  "de": "Kontrast funktioniert nur bei Schwarz-Weiß-Bildern",
                  "nl": "Contrast werkt alleen op zwart-wit afbeeldingen"
        },
        {
                  "en": "Both do exactly the same thing",
                  "es": "Ambos hacen exactamente lo mismo",
                  "de": "Beide machen genau dasselbe",
                  "nl": "Beide doen precies hetzelfde"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Thresholding to separate bright and dark regions",
                  "es": "Umbralización para separar regiones claras y oscuras",
                  "de": "Schwellenwertverfahren um helle und dunkle Bereiche zu trennen",
                  "nl": "Drempelbewerking om lichte en donkere gebieden te scheiden"
        },
        {
                  "en": "Converting to color image",
                  "es": "Convertir a imagen a color",
                  "de": "Zu Farbbild konvertieren",
                  "nl": "Converteren naar kleurafbeelding"
        },
        {
                  "en": "Reducing image resolution",
                  "es": "Reducir resolución de imagen",
                  "de": "Bildauflösung reduzieren",
                  "nl": "Beeldresolutie verlagen"
        },
        {
                  "en": "Increasing image brightness only",
                  "es": "Solo aumentar el brillo de la imagen",
                  "de": "Nur Bildhelligkeit erhöhen",
                  "nl": "Alleen beeldhelderheid verhogen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To create histograms of image data",
                  "es": "Para crear histogramas de datos de imagen",
                  "de": "Um Histogramme von Bilddaten zu erstellen",
                  "nl": "Om histogrammen van beeldgegevens te maken"
        },
        {
                  "en": "To improve image contrast by redistributing pixel intensities",
                  "es": "Para mejorar contraste de imagen redistribuyendo intensidades de píxeles",
                  "de": "Um Bildkontrast durch Umverteilung von Pixelintensitäten zu verbessern",
                  "nl": "Om beeldcontrast te verbeteren door pixelintensiteiten te herverdelen"
        },
        {
                  "en": "To compress image files",
                  "es": "Para comprimir archivos de imagen",
                  "de": "Um Bilddateien zu komprimieren",
                  "nl": "Om beeldbestanden te comprimeren"
        },
        {
                  "en": "To rotate images",
                  "es": "Para rotar imágenes",
                  "de": "Um Bilder zu drehen",
                  "nl": "Om afbeeldingen te roteren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To smooth images and reduce noise while preserving edges",
                  "es": "Para suavizar imágenes y reducir ruido mientras preserva bordes",
                  "de": "Um Bilder zu glätten und Rauschen zu reduzieren während Kanten erhalten bleiben",
                  "nl": "Om afbeeldingen glad te maken en ruis te verminderen terwijl randen behouden blijven"
        },
        {
                  "en": "To change image colors",
                  "es": "Para cambiar colores de imagen",
                  "de": "Um Bildfarben zu ändern",
                  "nl": "Om beeldkleuren te veranderen"
        },
        {
                  "en": "To increase image sharpness",
                  "es": "Para aumentar nitidez de imagen",
                  "de": "Um Bildschärfe zu erhöhen",
                  "nl": "Om beeldscherpte te verhogen"
        },
        {
                  "en": "To make images look more artistic",
                  "es": "Para hacer imágenes más artísticas",
                  "de": "Um Bilder künstlerischer aussehen zu lassen",
                  "nl": "Om afbeeldingen er artistieker uit te laten zien"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converts to color images",
                  "es": "Convierte a imágenes a color",
                  "de": "Konvertiert zu Farbbildern",
                  "nl": "Converteert naar kleurafbeeldingen"
        },
        {
                  "en": "Makes images brighter",
                  "es": "Hace imágenes más brillantes",
                  "de": "Macht Bilder heller",
                  "nl": "Maakt afbeeldingen helderder"
        },
        {
                  "en": "Removes small noise objects and separates connected components",
                  "es": "Remueve pequeños objetos de ruido y separa componentes conectados",
                  "de": "Entfernt kleine Rausch-Objekte und trennt verbundene Komponenten",
                  "nl": "Verwijdert kleine ruisobjecten en scheidt verbonden componenten"
        },
        {
                  "en": "Increases image resolution",
                  "es": "Aumenta resolución de imagen",
                  "de": "Erhöht Bildauflösung",
                  "nl": "Verhoogt beeldresolutie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It makes images bigger",
                  "es": "Hace imágenes más grandes",
                  "de": "Es macht Bilder größer",
                  "nl": "Het maakt afbeeldingen groter"
        },
        {
                  "en": "It converts images to black and white",
                  "es": "Convierte imágenes a blanco y negro",
                  "de": "Es konvertiert Bilder zu Schwarz-Weiß",
                  "nl": "Het converteert afbeeldingen naar zwart-wit"
        },
        {
                  "en": "It detects edges in both horizontal and vertical directions simultaneously",
                  "es": "Detecta bordes en direcciones horizontal y vertical simultáneamente",
                  "de": "Es erkennt Kanten sowohl in horizontaler als auch vertikaler Richtung gleichzeitig",
                  "nl": "Het detecteert randen in zowel horizontale als verticale richtingen tegelijkertijd"
        },
        {
                  "en": "It only works on color images",
                  "es": "Solo funciona en imágenes a color",
                  "de": "Es funktioniert nur bei Farbbildern",
                  "nl": "Het werkt alleen op kleurafbeeldingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Rotating images in circles",
                  "es": "Rotar imágenes en círculos",
                  "de": "Bilder in Kreisen drehen",
                  "nl": "Afbeeldingen in cirkels draaien"
        },
        {
                  "en": "Combining multiple images together",
                  "es": "Combinar múltiples imágenes juntas",
                  "de": "Mehrere Bilder zusammenfügen",
                  "nl": "Meerdere afbeeldingen samenbrengen"
        },
        {
                  "en": "A mathematical operation that applies filters to extract features from images",
                  "es": "Una operación matemática que aplica filtros para extraer características de imágenes",
                  "de": "Eine mathematische Operation die Filter anwendet um Merkmale aus Bildern zu extrahieren",
                  "nl": "Een wiskundige bewerking die filters toepast om kenmerken uit afbeeldingen te extraheren"
        },
        {
                  "en": "Making images curved",
                  "es": "Hacer imágenes curvadas",
                  "de": "Bilder gebogen machen",
                  "nl": "Afbeeldingen gebogen maken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It blurs the entire image",
                  "es": "Desenfoca toda la imagen",
                  "de": "Es verwischt das gesamte Bild",
                  "nl": "Het vervaagt de hele afbeelding"
        },
        {
                  "en": "It makes the image brighter overall",
                  "es": "Hace la imagen más brillante en general",
                  "de": "Es macht das Bild insgesamt heller",
                  "nl": "Het maakt de afbeelding over het algemeen helderder"
        },
        {
                  "en": "It enhances edges and fine details while reducing smooth areas",
                  "es": "Mejora bordes y detalles finos mientras reduce áreas suaves",
                  "de": "Es verstärkt Kanten und feine Details während glatte Bereiche reduziert werden",
                  "nl": "Het versterkt randen en fijne details terwijl gladde gebieden worden verminderd"
        },
        {
                  "en": "It removes all colors from the image",
                  "es": "Remueve todos los colores de la imagen",
                  "de": "Es entfernt alle Farben aus dem Bild",
                  "nl": "Het verwijdert alle kleuren uit de afbeelding"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To convert images to grayscale",
                  "es": "Para convertir imágenes a escala de grises",
                  "de": "Um Bilder zu Graustufen zu konvertieren",
                  "nl": "Om afbeeldingen naar grijstinten te converteren"
        },
        {
                  "en": "To make all images the same size",
                  "es": "Para hacer todas las imágenes del mismo tamaño",
                  "de": "Um alle Bilder zur gleichen Größe zu machen",
                  "nl": "Om alle afbeeldingen hetzelfde formaat te geven"
        },
        {
                  "en": "To standardize pixel value ranges for consistent processing",
                  "es": "Para estandarizar rangos de valores de píxeles para procesamiento consistente",
                  "de": "Um Pixelwertbereiche für konsistente Verarbeitung zu standardisieren",
                  "nl": "Om pixelwaardebereiken te standaardiseren voor consistente verwerking"
        },
        {
                  "en": "To remove noise from images",
                  "es": "Para remover ruido de imágenes",
                  "de": "Um Rauschen aus Bildern zu entfernen",
                  "nl": "Om ruis uit afbeeldingen te verwijderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Erosion works on color images, dilation on grayscale",
                  "es": "La erosión funciona en imágenes a color, la dilatación en escala de grises",
                  "de": "Erosion funktioniert bei Farbbildern, Dilatation bei Graustufen",
                  "nl": "Erosie werkt op kleurafbeeldingen, dilatatie op grijstinten"
        },
        {
                  "en": "Erosion makes images darker, dilation makes them brighter",
                  "es": "La erosión hace imágenes más oscuras, la dilatación las hace más brillantes",
                  "de": "Erosion macht Bilder dunkler, Dilatation macht sie heller",
                  "nl": "Erosie maakt afbeeldingen donkerder, dilatatie maakt ze helderder"
        },
        {
                  "en": "Erosion shrinks white regions, dilation expands white regions",
                  "es": "La erosión encoge regiones blancas, la dilatación expande regiones blancas",
                  "de": "Erosion schrumpft weiße Bereiche, Dilatation erweitert weiße Bereiche",
                  "nl": "Erosie krimpt witte gebieden, dilatatie breidt witte gebieden uit"
        },
        {
                  "en": "Both operations do the same thing",
                  "es": "Ambas operaciones hacen lo mismo",
                  "de": "Beide Operationen machen dasselbe",
                  "nl": "Beide bewerkingen doen hetzelfde"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To divide an image into meaningful regions or objects",
                  "es": "Para dividir una imagen en regiones u objetos significativos",
                  "de": "Um ein Bild in bedeutungsvolle Regionen oder Objekte zu unterteilen",
                  "nl": "Om een afbeelding te verdelen in betekenisvolle gebieden of objecten"
        },
        {
                  "en": "To convert images between different formats",
                  "es": "Para convertir imágenes entre diferentes formatos",
                  "de": "Um Bilder zwischen verschiedenen Formaten zu konvertieren",
                  "nl": "Om afbeeldingen tussen verschillende formaten te converteren"
        },
        {
                  "en": "To make images smaller in file size",
                  "es": "Para hacer imágenes más pequeñas en tamaño de archivo",
                  "de": "Um Bilder kleiner in Dateigröße zu machen",
                  "nl": "Om afbeeldingen kleiner te maken in bestandsgrootte"
        },
        {
                  "en": "To add special effects to images",
                  "es": "Para añadir efectos especiales a imágenes",
                  "de": "Um Spezialeffekte zu Bildern hinzuzufügen",
                  "nl": "Om speciale effecten aan afbeeldingen toe te voegen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reduces noise while maintaining thin, continuous edges",
                  "es": "Reduce ruido mientras mantiene bordes delgados y continuos",
                  "de": "Reduziert Rauschen während dünne, kontinuierliche Kanten erhalten bleiben",
                  "nl": "Vermindert ruis terwijl dunne, continue randen behouden blijven"
        },
        {
                  "en": "Works only on color images",
                  "es": "Funciona solo en imágenes a color",
                  "de": "Funktioniert nur bei Farbbildern",
                  "nl": "Werkt alleen op kleurafbeeldingen"
        },
        {
                  "en": "Only detects horizontal edges",
                  "es": "Solo detecta bordes horizontales",
                  "de": "Erkennt nur horizontale Kanten",
                  "nl": "Detecteert alleen horizontale randen"
        },
        {
                  "en": "Works faster than other methods",
                  "es": "Funciona más rápido que otros métodos",
                  "de": "Arbeitet schneller als andere Methoden",
                  "nl": "Werkt sneller dan andere methoden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It only works on grayscale images",
                  "es": "Solo funciona en imágenes en escala de grises",
                  "de": "Es funktioniert nur bei Graustufenbildern",
                  "nl": "Het werkt alleen op grijstintenafbeeldingen"
        },
        {
                  "en": "It removes salt-and-pepper noise while preserving edges",
                  "es": "Remueve ruido sal y pimienta mientras preserva bordes",
                  "de": "Es entfernt Salz-und-Pfeffer-Rauschen während Kanten erhalten bleiben",
                  "nl": "Het verwijdert zout-en-peper ruis terwijl randen behouden blijven"
        },
        {
                  "en": "It increases image brightness",
                  "es": "Aumenta el brillo de la imagen",
                  "de": "Es erhöht die Bildhelligkeit",
                  "nl": "Het verhoogt de beeldhelderheid"
        },
        {
                  "en": "It works faster than other filters",
                  "es": "Funciona más rápido que otros filtros",
                  "de": "Es arbeitet schneller als andere Filter",
                  "nl": "Het werkt sneller dan andere filters"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creates the illusion of more colors using fewer colors through pixel patterns",
                  "es": "Crea la ilusión de más colores usando menos colores a través de patrones de píxeles",
                  "de": "Erzeugt die Illusion von mehr Farben mit weniger Farben durch Pixelmuster",
                  "nl": "Creëert de illusie van meer kleuren met minder kleuren door pixelpatronen"
        },
        {
                  "en": "Makes images move or animate",
                  "es": "Hace que las imágenes se muevan o animen",
                  "de": "Lässt Bilder sich bewegen oder animieren",
                  "nl": "Laat afbeeldingen bewegen of animeren"
        },
        {
                  "en": "Reduces image file size only",
                  "es": "Solo reduce el tamaño del archivo de imagen",
                  "de": "Reduziert nur die Bilddateigröße",
                  "nl": "Vermindert alleen bestandsgrootte van afbeelding"
        },
        {
                  "en": "Converts images to 3D format",
                  "es": "Convierte imágenes a formato 3D",
                  "de": "Konvertiert Bilder zu 3D-Format",
                  "nl": "Converteert afbeeldingen naar 3D-formaat"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To remove gamma rays from images",
                  "es": "Para remover rayos gamma de imágenes",
                  "de": "Um Gammastrahlen aus Bildern zu entfernen",
                  "nl": "Om gammastralen uit afbeeldingen te verwijderen"
        },
        {
                  "en": "To adjust image brightness in a non-linear way that matches human perception",
                  "es": "Para ajustar brillo de imagen de manera no lineal que coincida con percepción humana",
                  "de": "Um Bildhelligkeit auf nichtlineare Weise anzupassen die der menschlichen Wahrnehmung entspricht",
                  "nl": "Om beeldhelderheid aan te passen op een niet-lineaire manier die overeenkomt met menselijke waarneming"
        },
        {
                  "en": "To compress image files",
                  "es": "Para comprimir archivos de imagen",
        ...
        {
                  "en": "To add watermarks to images",
                  "es": "Para añadir marcas de agua a imágenes",
                  "de": "Um Wasserzeichen zu Bildern hinzuzufügen",
                  "nl": "Om watermerken aan afbeeldingen toe te voegen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dividing an image into meaningful regions or segments",
                  "es": "Dividir una imagen en regiones o segmentos significativos",
                  "de": "Ein Bild in bedeutungsvolle Regionen oder Segmente unterteilen",
                  "nl": "Een afbeelding verdelen in betekenisvolle regio's of segmenten"
        },
        {
                  "en": "Organizing images into folders",
                  "es": "Organizar imágenes en carpetas",
                  "de": "Bilder in Ordnern organisieren",
                  "nl": "Afbeeldingen organiseren in mappen"
        },
        {
                  "en": "Cutting images into smaller file sizes",
                  "es": "Cortar imágenes en tamaños de archivo más pequeños",
                  "de": "Bilder in kleinere Dateigrößen schneiden",
                  "nl": "Afbeeldingen knippen in kleinere bestandsgroottes"
        },
        {
                  "en": "Creating segments of code for image processing",
                  "es": "Crear segmentos de código para procesamiento de imágenes",
                  "de": "Code-Segmente für Bildverarbeitung erstellen",
                  "nl": "Code-segmenten maken voor beeldverwerking"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Spatial domain is for 2D images, frequency domain is for 3D images",
                  "es": "Dominio espacial es para imágenes 2D, dominio de frecuencia es para imágenes 3D",
                  "de": "Ortsbereich ist für 2D-Bilder, Frequenzbereich ist für 3D-Bilder",
                  "nl": "Ruimtelijk domein is voor 2D-afbeeldingen, frequentiedomein is voor 3D-afbeeldingen"
        },
        {
                  "en": "Spatial domain works directly with pixel values, frequency domain analyzes image patterns and frequencies",
                  "es": "Dominio espacial trabaja directamente con valores de píxeles, dominio de frecuencia analiza patrones e imágenes y frecuencias",
                  "de": "Ortsbereich arbeitet direkt mit Pixelwerten, Frequenzbereich analysiert Bildmuster und Frequenzen",
                  "nl": "Ruimtelijk domein werkt direct met pixelwaarden, frequentiedomein analyseert beeldpatronen en frequenties"
        },
        {
                  "en": "Spatial domain is faster, frequency domain is slower",
                  "es": "Dominio espacial es más rápido, dominio de frecuencia es más lento",
                  "de": "Ortsbereich ist schneller, Frequenzbereich ist langsamer",
                  "nl": "Ruimtelijk domein is sneller, frequentiedomein is langzamer"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting color to grayscale",
                  "es": "Convertir color a escala de grises",
                  "de": "Farbe zu Graustufen konvertieren",
                  "nl": "Kleur naar grijstinten converteren"
        },
        {
                  "en": "Compressing image files",
                  "es": "Comprimir archivos de imagen",
                  "de": "Bilddateien komprimieren",
                  "nl": "Beeldbestanden comprimeren"
        },
        {
                  "en": "Detecting edges using second-order derivatives to find zero crossings",
                  "es": "Detectar bordes usando derivadas de segundo orden para encontrar cruces por cero",
                  "de": "Kanten erkennen durch Ableitungen zweiter Ordnung um Nulldurchgänge zu finden",
                  "nl": "Randen detecteren met tweede-orde afgeleiden om nuldoorgangen te vinden"
        },
        {
                  "en": "Increasing image brightness",
                  "es": "Aumentar brillo de imagen",
                  "de": "Bildhelligkeit erhöhen",
                  "nl": "Beeldhelderheid verhogen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All high-frequency details equally",
                  "es": "Todos los detalles de alta frecuencia igualmente",
                  "de": "Alle hochfrequenten Details gleichermaßen",
                  "nl": "Alle hoogfrequente details gelijk"
        },
        {
                  "en": "Edges while smoothing uniform regions",
                  "es": "Bordes mientras suaviza regiones uniformes",
                  "de": "Kanten während glatte Regionen geglättet werden",
                  "nl": "Randen terwijl uniforme gebieden worden afgevlakt"
        },
        {
                  "en": "Only color information",
                  "es": "Solo información de color",
                  "de": "Nur Farbinformationen",
                  "nl": "Alleen kleurinformatie"
        },
        {
                  "en": "File size during compression",
                  "es": "Tamaño de archivo durante compresión",
                  "de": "Dateigröße während Kompression",
                  "nl": "Bestandsgrootte tijdens compressie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Color gradients only",
                  "es": "Solo gradientes de color",
                  "de": "Nur Farbverläufe",
                  "nl": "Alleen kleurverlopen"
        },
        {
                  "en": "Noise patterns",
                  "es": "Patrones de ruido",
                  "de": "Rauschmuster",
                  "nl": "Ruispatronen"
        },
        {
                  "en": "Geometric shapes like lines, circles, and ellipses",
                  "es": "Formas geométricas como líneas, círculos y elipses",
                  "de": "Geometrische Formen wie Linien, Kreise und Ellipsen",
                  "nl": "Geometrische vormen zoals lijnen, cirkels en ellipsen"
        },
        {
                  "en": "Image file formats",
                  "es": "Formatos de archivo de imagen",
                  "de": "Bilddateiformate",
                  "nl": "Beeldbestandsformaten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only works on color images",
                  "es": "Solo funciona en imágenes a color",
                  "de": "Funktioniert nur bei Farbbildern",
                  "nl": "Werkt alleen op kleurafbeeldingen"
        },
        {
                  "en": "Always uses a threshold of 128",
                  "es": "Siempre usa un umbral de 128",
                  "de": "Verwendet immer einen Schwellenwert von 128",
                  "nl": "Gebruikt altijd een drempel van 128"
        },
        {
                  "en": "Uses different threshold values for different image regions",
                  "es": "Usa diferentes valores de umbral para diferentes regiones de imagen",
                  "de": "Verwendet verschiedene Schwellenwerte für verschiedene Bildbereiche",
                  "nl": "Gebruikt verschillende drempelwaarden voor verschillende beeldregio's"
        },
        {
                  "en": "Removes all black pixels",
                  "es": "Remueve todos los píxeles negros",
                  "de": "Entfernt alle schwarzen Pixel",
                  "nl": "Verwijdert alle zwarte pixels"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Organizing image folders",
                  "es": "Organizar carpetas de imágenes",
                  "de": "Bildordner organisieren",
                  "nl": "Afbeeldingsmappen organiseren"
        },
        {
                  "en": "Finding instances of a small reference image within a larger image",
                  "es": "Encontrar instancias de una imagen de referencia pequeña dentro de una imagen más grande",
                  "de": "Instanzen eines kleinen Referenzbildes in einem größeren Bild finden",
                  "nl": "Instanties van een kleine referentieafbeelding vinden binnen een grotere afbeelding"
        },
        {
        ...
        {
                  "en": "Matching file formats",
                  "es": "Coincidir formatos de archivo",
                  "de": "Dateiformate abgleichen",
                  "nl": "Bestandsformaten matchen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating 3D pyramid-shaped visualizations",
                  "es": "Crear visualizaciones en forma de pirámide 3D",
                  "de": "3D-pyramidenförmige Visualisierungen erstellen",
                  "nl": "3D-piramideachtige visualisaties maken"
        },
        {
                  "en": "Stacking images vertically",
                  "es": "Apilar imágenes verticalmente",
                  "de": "Bilder vertikal stapeln",
                  "nl": "Afbeeldingen verticaal stapelen"
        },
        {
                  "en": "Compressing images to save space",
                  "es": "Comprimir imágenes para ahorrar espacio",
                  "de": "Bilder komprimieren um Platz zu sparen",
                  "nl": "Afbeeldingen comprimeren om ruimte te besparen"
        },
        {
                  "en": "Representing images at multiple scales for multi-resolution processing",
                  "es": "Representar imágenes en múltiples escalas para procesamiento multi-resolución",
                  "de": "Bilder in mehreren Maßstäben für Multi-Auflösungsverarbeitung darstellen",
                  "nl": "Afbeeldingen op meerdere schalen representeren voor multi-resolutie verwerking"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Smooths images while preserving and enhancing edges",
                  "es": "Suaviza imágenes mientras preserva y mejora bordes",
                  "de": "Glättet Bilder während Kanten erhalten und verbessert werden",
                  "nl": "Vlakt afbeeldingen af terwijl randen behouden en verbeterd worden"
        },
        {
                  "en": "Rotates images in random directions",
                  "es": "Rota imágenes en direcciones aleatorias",
                  "de": "Dreht Bilder in zufällige Richtungen",
                  "nl": "Roteert afbeeldingen in willekeurige richtingen"
        },
        {
                  "en": "Spreads colors uniformly across the image",
                  "es": "Distribuye colores uniformemente a través de la imagen",
                  "de": "Verteilt Farben gleichmäßig über das Bild",
                  "nl": "Verspreidt kleuren uniform over de afbeelding"
        },
        {
                  "en": "Converts images to vector graphics",
                  "es": "Convierte imágenes a gráficos vectoriales",
                  "de": "Konvertiert Bilder zu Vektorgrafiken",
                  "nl": "Converteert afbeeldingen naar vectorafbeeldingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Identifying points where image intensity changes significantly in multiple directions",
                  "es": "Identificar puntos donde intensidad de imagen cambia significativamente en múltiples direcciones",
                  "de": "Punkte identifizieren wo Bildintensität sich signifikant in mehreren Richtungen ändert",
                  "nl": "Punten identificeren waar beeldintensiteit significant verandert in meerdere richtingen"
        },
        {
                  "en": "Detecting the four corners of the image",
                  "es": "Detectar las cuatro esquinas de la imagen",
                  "de": "Die vier Ecken des Bildes erkennen",
                  "nl": "De vier hoeken van de afbeelding detecteren"
        },
        {
                  "en": "Measuring corner angles in degrees",
                  "es": "Medir ángulos de esquinas en grados",
                  "de": "Eckenwinkel in Grad messen",
                  "nl": "Hoekhoeken meten in graden"
        },
        {
                  "en": "Finding rectangular corners in images",
                  "es": "Encontrar esquinas rectangulares en imágenes",
                  "de": "Rechteckige Ecken in Bildern finden",
                  "nl": "Rechthoekige hoeken in afbeeldingen vinden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Treating the image as a topographic surface and flooding from markers",
                  "es": "Tratar la imagen como superficie topográfica e inundar desde marcadores",
                  "de": "Das Bild als topografische Oberfläche behandeln und von Markern aus fluten",
                  "nl": "De afbeelding behandelen als topografisch oppervlak en overstromen vanaf markers"
        },
        {
                  "en": "Detecting water in images",
                  "es": "Detectar agua en imágenes",
                  "de": "Wasser in Bildern erkennen",
                  "nl": "Water detecteren in afbeeldingen"
        },
        {
                  "en": "Measuring watershed boundaries",
                  "es": "Medir límites de cuencas hidrográficas",
                  "de": "Wassereinzugsgebietsgrenzen messen",
                  "nl": "Waterscheidingsgrenzen meten"
        },
        {
                  "en": "Removing watermarks from images",
                  "es": "Remover marcas de agua de imágenes",
                  "de": "Wasserzeichen aus Bildern entfernen",
                  "nl": "Watermerken uit afbeeldingen verwijderen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All padding types produce identical results",
                  "es": "Todos los tipos de relleno producen resultados idénticos",
                  "de": "Alle Padding-Typen erzeugen identische Ergebnisse",
                  "nl": "Alle padding-types produceren identieke resultaten"
        },
        {
                  "en": "Padding only affects image file size",
                  "es": "El relleno solo afecta tamaño de archivo de imagen",
                  "de": "Padding beeinflusst nur die Bilddateigröße",
                  "nl": "Padding beïnvloedt alleen bestandsgrootte van afbeelding"
        },
        {
                  "en": "They determine how borders are handled: zero padding, replicate, reflect, or wrap",
                  "es": "Determinan cómo se manejan bordes: relleno cero, replicar, reflejar o envolver",
                  "de": "Sie bestimmen wie Ränder behandelt werden: Null-Padding, Replizieren, Reflektieren oder Umschließen",
                  "nl": "Ze bepalen hoe randen worden behandeld: nul-padding, repliceren, reflecteren of omwikkelen"
        },
        {
                  "en": "Padding is only used for color images",
                  "es": "El relleno solo se usa para imágenes a color",
                  "de": "Padding wird nur für Farbbilder verwendet",
                  "nl": "Padding wordt alleen gebruikt voor kleurafbeeldingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Urheberrecht für Bilder registrieren",
                  "nl": "Auteursrecht registreren voor afbeeldingen"
        },
        {
                  "en": "Saving images to a database",
                  "es": "Guardar imágenes en una base de datos",
                  "de": "Bilder in einer Datenbank speichern",
                  "nl": "Afbeeldingen opslaan in een database"
        },
        {
                  "en": "Aligning multiple images of the same scene into a common coordinate system",
                  "es": "Alinear múltiples imágenes de la misma escena en un sistema de coordenadas común",
                  "de": "Mehrere Bilder derselben Szene in ein gemeinsames Koordinatensystem ausrichten",
                  "nl": "Meerdere afbeeldingen van dezelfde scène uitlijnen in een gemeenschappelijk coördinatensysteem"
        },
        {
                  "en": "Creating a registry of image files",
                  "es": "Crear un registro de archivos de imagen",
                  "de": "Ein Register von Bilddateien erstellen",
                  "nl": "Een register van beeldbestanden maken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Filtering out small features from images",
                  "es": "Filtrar características pequeñas de imágenes",
                  "de": "Kleine Merkmale aus Bildern filtern",
                  "nl": "Kleine kenmerken uit afbeeldingen filteren"
        },
        {
                  "en": "Shifting images to different positions",
                  "es": "Desplazar imágenes a diferentes posiciones",
                  "de": "Bilder zu verschiedenen Positionen verschieben",
                  "nl": "Afbeeldingen verplaatsen naar verschillende posities"
        },
        {
                  "en": "Sifting through image files to find duplicates",
                  "es": "Cribar archivos de imagen para encontrar duplicados",
                  "de": "Bilddateien durchsieben um Duplikate zu finden",
                  "nl": "Beeldbestanden zeven om duplicaten te vinden"
        },
        {
                  "en": "Detecting and describing local features that are invariant to scale and rotation",
                  "es": "Detectar y describir características locales que son invariantes a escala y rotación",
                  "de": "Lokale Merkmale erkennen und beschreiben die invariant gegenüber Skalierung und Rotation sind",
                  "nl": "Lokale kenmerken detecteren en beschrijven die invariant zijn voor schaal en rotatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tracking pixel movement between consecutive video frames",
                  "es": "Rastrear movimiento de píxeles entre fotogramas de video consecutivos",
                  "de": "Pixelbewegung zwischen aufeinanderfolgenden Videoframes verfolgen",
                  "nl": "Pixelbeweging volgen tussen opeenvolgende videoframes"
        },
        {
                  "en": "Measuring light intensity in optical fibers",
                  "es": "Medir intensidad de luz en fibras ópticas",
                  "de": "Lichtintensität in Glasfasern messen",
                  "nl": "Lichtintensiteit meten in optische vezels"
        },
        {
                  "en": "Detecting optical illusions in images",
                  "es": "Detectar ilusiones ópticas en imágenes",
                  "de": "Optische Täuschungen in Bildern erkennen",
                  "nl": "Optische illusies detecteren in afbeeldingen"
        },
        {
                  "en": "Optimizing image flow through networks",
                  "es": "Optimizar flujo de imagen a través de redes",
                  "de": "Bildfluss durch Netzwerke optimieren",
                  "nl": "Beeldstroom optimaliseren door netwerken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "nl": "Alle afbeeldingen converteren naar zwart-wit"
        },
        {
                  "en": "Changing the physical color of displayed images",
                  "es": "Cambiar el color físico de imágenes mostradas",
                  "de": "Physische Farbe angezeigter Bilder ändern",
                  "nl": "Fysieke kleur van weergegeven afbeeldingen veranderen"
        },
        {
                  "en": "Transforming images between color representations like RGB, HSV, or LAB",
                  "es": "Transformar imágenes entre representaciones de color como RGB, HSV o LAB",
                  "de": "Bilder zwischen Farbdarstellungen wie RGB, HSV oder LAB transformieren",
                  "nl": "Afbeeldingen transformeren tussen kleurrepresentaties zoals RGB, HSV of LAB"
        },
        {
                  "en": "Increasing the amount of storage space for colors",
                  "es": "Aumentar cantidad de espacio de almacenamiento para colores",
                  "de": "Menge an Speicherplatz für Farben erhöhen",
                  "nl": "Hoeveelheid opslagruimte voor kleuren verhogen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating 3D images from 2D images",
                  "es": "Crear imágenes 3D desde imágenes 2D",
                  "de": "3D-Bilder aus 2D-Bildern erstellen",
                  "nl": "3D-afbeeldingen maken van 2D-afbeeldingen"
        },
        {
                  "en": "Measuring distances in perspective drawings",
                  "es": "Medir distancias en dibujos en perspectiva",
                  "de": "Entfernungen in Perspektivzeichnungen messen",
                  "nl": "Afstanden meten in perspectieftekeningen"
        },
        {
                  "en": "Changing the perspective or opinion about images",
                  "es": "Cambiar la perspectiva u opinión sobre imágenes",
                  "de": "Perspektive oder Meinung über Bilder ändern",
                  "nl": "Perspectief of mening over afbeeldingen veranderen"
        },
        {
                  "en": "Warping images to correct or simulate perspective distortions",
                  "es": "Deformar imágenes para corregir o simular distorsiones de perspectiva",
                  "de": "Bilder verzerren um Perspektivverzerrungen zu korrigieren oder zu simulieren",
                  "nl": "Afbeeldingen vervormen om perspectiefvervormingen te corrigeren of simuleren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measuring blob sizes in biology",
                  "es": "Medir tamaños de blobs en biología",
                  "de": "Blob-Größen in Biologie messen",
                  "nl": "Blob-groottes meten in biologie"
        },
        {
                  "en": "Identifying regions that differ in properties like brightness or color from surroundings",
                  "es": "Identificar regiones que difieren en propiedades como brillo o color de alrededores",
                  "de": "Regionen identifizieren die sich in Eigenschaften wie Helligkeit oder Farbe von Umgebung unterscheiden",
                  "nl": "Gebieden identificeren die verschillen in eigenschappen zoals helderheid of kleur van omgeving"
        },
        {
                  "en": "Detecting liquid drops in images",
                  "es": "Detectar gotas líquidas en imágenes",
                  "de": "Flüssigkeitstropfen in Bildern erkennen",
                  "nl": "Vloeistofdruppels detecteren in afbeeldingen"
        },
        {
                  "en": "Finding corrupted image data",
                  "es": "Encontrar datos de imagen corruptos",
                  "de": "Beschädigte Bilddaten finden",
                  "nl": "Beschadigde beeldgegevens vinden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Suppressing noise in images",
                  "es": "Suprimir ruido en imágenes",
                  "de": "Rauschen in Bildern unterdrücken",
                  "nl": "Ruis in afbeeldingen onderdrukken"
        },
        {
                  "en": "Thinning detected edges to single-pixel width by removing non-peak responses",
                  "es": "Adelgazar bordes detectados a ancho de un solo píxel removiendo respuestas no pico",
                  "de": "Erkannte Kanten auf Ein-Pixel-Breite verdünnen durch Entfernung von Nicht-Spitzen-Antworten",
                  "nl": "Gedetecteerde randen verdunnen tot enkele-pixel breedte door niet-piek reacties te verwijderen"
        },
        {
                  "en": "Maximizing the brightness of all pixels",
                  "es": "Maximizar el brillo de todos los píxeles",
                  "de": "Helligkeit aller Pixel maximieren",
                  "nl": "Helderheid van alle pixels maximaliseren"
        },
        {
                  "en": "Removing maximum values from images",
                  "es": "Remover valores máximos de imágenes",
                  "de": "Maximalwerte aus Bildern entfernen",
                  "nl": "Maximum waarden uit afbeeldingen verwijderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Finding and matching overlapping features between images, then warping and blending",
                  "es": "Encontrar y coincidir características superpuestas entre imágenes, luego deformar y mezclar",
                  "de": "Überlappende Merkmale zwischen Bildern finden und abgleichen, dann verzerren und verschmelzen",
                  "nl": "Overlappende kenmerken tussen afbeeldingen vinden en matchen, dan vervormen en mengen"
        },
        {
                  "en": "Compressing multiple images into one file",
                  "es": "Comprimir múltiples imágenes en un archivo",
                  "de": "Mehrere Bilder in eine Datei komprimieren",
                  "nl": "Meerdere afbeeldingen comprimeren in één bestand"
        },
        {
                  "en": "Sewing images together side-by-side",
                  "es": "Coser imágenes juntas lado a lado",
                  "de": "Bilder nebeneinander nähen",
                  "nl": "Afbeeldingen zij aan zij aan elkaar naaien"
        },
        {
                  "en": "Creating embroidered patterns from images",
                  "es": "Crear patrones bordados desde imágenes",
                  "de": "Gestickte Muster aus Bildern erstellen",
                  "nl": "Geborduurde patronen maken van afbeeldingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Finding related image files",
                  "es": "Encontrar archivos de imagen relacionados",
                  "de": "Verwandte Bilddateien finden",
                  "nl": "Gerelateerde beeldbestanden vinden"
        },
        {
                  "en": "Connecting electronic components in circuits",
                  "es": "Conectar componentes electrónicos en circuitos",
                  "de": "Elektronische Komponenten in Schaltungen verbinden",
                  "nl": "Elektronische componenten in circuits verbinden"
        },
        {
                  "en": "Labeling and analyzing distinct objects in binary images",
                  "es": "Etiquetar y analizar objetos distintos en imágenes binarias",
                  "de": "Unterschiedliche Objekte in Binärbildern beschriften und analysieren",
                  "nl": "Verschillende objecten in binaire afbeeldingen labelen en analyseren"
        },
        {
                  "en": "Analyzing network connectivity",
                  "es": "Analizar conectividad de red",
                  "de": "Netzwerkkonnektivität analysieren",
                  "nl": "Netwerkconnectiviteit analyseren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting images to frequency domain to analyze patterns and perform filtering",
                  "es": "Convertir imágenes a dominio de frecuencia para analizar patrones y realizar filtrado",
                  "de": "Bilder in Frequenzbereich konvertieren um Muster zu analysieren und Filterung durchzuführen",
                  "nl": "Afbeeldingen converteren naar frequentiedomein om patronen te analyseren en filtering uit te voeren"
        },
        {
                  "en": "Compressing image files",
                  "es": "Comprimir archivos de imagen",
        ...
        {
                  "en": "Rotating images by specific angles",
                  "es": "Rotar imágenes por ángulos específicos",
                  "de": "Bilder um bestimmte Winkel drehen",
                  "nl": "Afbeeldingen draaien met specifieke hoeken"
        },
        {
                  "en": "Transforming images into different file formats",
                  "es": "Transformar imágenes en diferentes formatos de archivo",
                  "de": "Bilder in verschiedene Dateiformate transformieren",
                  "nl": "Afbeeldingen transformeren naar verschillende bestandsformaten"
        }
        ],
        correct: 0,
        explanation: {
