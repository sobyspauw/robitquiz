    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Automatically learning patterns from data without manual programming",
                  "es": "Aprender automáticamente patrones de datos sin programación manual",
                  "de": "Automatisches Lernen von Mustern aus Daten ohne manuelle Programmierung",
                  "nl": "Automatisch patronen leren uit data zonder handmatige programmering"
        },
        {
                  "en": "Converting images to different formats",
                  "es": "Convertir imágenes a diferentes formatos",
                  "de": "Bilder in verschiedene Formate konvertieren",
                  "nl": "Afbeeldingen naar verschillende formaten converteren"
        },
        {
                  "en": "Making images look better",
                  "es": "Hacer que las imágenes se vean mejor",
                  "de": "Bilder besser aussehen lassen",
                  "nl": "Afbeeldingen er beter uit laten zien"
        },
        {
                  "en": "Reducing image file sizes",
                  "es": "Reducir tamaños de archivo de imagen",
                  "de": "Bilddateigrößen reduzieren",
                  "nl": "Beeldbestandsgroottes verkleinen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Reproducir archivos de música",
                  "de": "Musikdateien abspielen",
                  "nl": "Muziekbestanden afspelen"
        },
        {
                  "en": "Processing text documents",
                  "es": "Procesar documentos de texto",
                  "de": "Textdokumente verarbeiten",
                  "nl": "Tekstdocumenten verwerken"
        },
        {
                  "en": "Calculating mathematical equations",
                  "es": "Calcular ecuaciones matemáticas",
                  "de": "Mathematische Gleichungen berechnen",
                  "nl": "Wiskundige vergelijkingen berekenen"
        },
        {
                  "en": "Recognizing spatial patterns and hierarchical features in images",
                  "es": "Reconocer patrones espaciales y características jerárquicas en imágenes",
                  "de": "Räumliche Muster und hierarchische Merkmale in Bildern erkennen",
                  "nl": "Ruimtelijke patronen en hiërarchische kenmerken in afbeeldingen herkennen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating backup copies",
                  "es": "Crear copias de respaldo",
                  "de": "Backup-Kopien erstellen",
                  "nl": "Back-upkopieën maken"
        },
        {
                  "en": "Testing computer hardware",
                  "es": "Probar hardware de computadora",
                  "de": "Computer-Hardware testen",
                  "nl": "Computerhardware testen"
        },
        {
                  "en": "Storing images for future use",
                  "es": "Almacenar imágenes para uso futuro",
                  "de": "Bilder für zukünftige Nutzung speichern",
                  "nl": "Afbeeldingen opslaan voor toekomstig gebruik"
        },
        {
                  "en": "Teaching the algorithm to recognize patterns by showing examples",
                  "es": "Enseñar al algoritmo a reconocer patrones mostrando ejemplos",
                  "de": "Dem Algorithmus beibringen Muster zu erkennen indem Beispiele gezeigt werden",
                  "nl": "Het algoritme leren patronen te herkennen door voorbeelden te tonen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When images are too large for processing",
                  "es": "Cuando las imágenes son muy grandes para procesar",
                  "de": "Wenn Bilder zu groß für die Verarbeitung sind",
                  "nl": "Wanneer afbeeldingen te groot zijn voor verwerking"
        },
        {
                  "en": "When a model learns training data too specifically and fails on new images",
                  "es": "Cuando un modelo aprende datos de entrenamiento muy específicamente y falla en imágenes nuevas",
                  "de": "Wenn ein Modell Trainingsdaten zu spezifisch lernt und bei neuen Bildern versagt",
                  "nl": "Wanneer een model trainingsdata te specifiek leert en faalt bij nieuwe afbeeldingen"
        },
        {
                  "en": "When the computer runs out of memory",
                  "es": "Cuando la computadora se queda sin memoria",
                  "de": "Wenn dem Computer der Speicher ausgeht",
                  "nl": "Wanneer de computer geen geheugen meer heeft"
        },
        {
                  "en": "When there are too many pixels in an image",
                  "es": "Cuando hay demasiados píxeles en una imagen",
                  "de": "Wenn es zu viele Pixel in einem Bild gibt",
                  "nl": "Wanneer er te veel pixels in een afbeelding zijn"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using only high-resolution images",
                  "es": "Usar solo imágenes de alta resolución",
                  "de": "Nur hochauflösende Bilder verwenden",
                  "nl": "Alleen hoge resolutie afbeeldingen gebruiken"
        },
        {
                  "en": "Data augmentation through rotations, crops, and color changes",
                  "es": "Aumento de datos a través de rotaciones, recortes y cambios de color",
                  "de": "Datenaugmentation durch Rotationen, Zuschnitte und Farbveränderungen",
                  "nl": "Data augmentation door rotaties, crops en kleurveranderingen"
        },
        {
                  "en": "Converting all images to black and white",
                  "es": "Convertir todas las imágenes a blanco y negro",
                  "de": "Alle Bilder zu Schwarz-Weiß konvertieren",
                  "nl": "Alle afbeeldingen naar zwart-wit converteren"
        },
        {
                  "en": "Deleting duplicate images",
                  "es": "Eliminar imágenes duplicadas",
                  "de": "Doppelte Bilder löschen",
                  "nl": "Dubbele afbeeldingen verwijderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning without any human supervision",
                  "es": "Aprender sin supervisión humana",
                  "de": "Lernen ohne menschliche Aufsicht",
                  "nl": "Leren zonder menselijke supervisie"
        },
        {
                  "en": "Having a teacher physically present",
                  "es": "Tener un maestro físicamente presente",
                  "de": "Einen Lehrer physisch anwesend haben",
                  "nl": "Een leraar fysiek aanwezig hebben"
        },
        {
                  "en": "Watching videos to learn patterns",
                  "es": "Ver videos para aprender patrones",
                  "de": "Videos schauen um Muster zu lernen",
                  "nl": "Video's kijken om patronen te leren"
        },
        {
                  "en": "Training with labeled examples where correct answers are provided",
                  "es": "Entrenamiento con ejemplos etiquetados donde se proporcionan respuestas correctas",
                  "de": "Training mit beschrifteten Beispielen wo korrekte Antworten bereitgestellt werden",
                  "nl": "Trainen met gelabelde voorbeelden waar correcte antwoorden worden gegeven"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "SIFT (Scale-Invariant Feature Transform)",
                  "es": "SIFT (Transformada de Características Invariante a Escala)",
                  "de": "SIFT (Skalierungs-invariante Merkmalstransformation)",
                  "nl": "SIFT (Scale-Invariant Feature Transform)"
        },
        {
                  "en": "Brightness adjustment",
                  "es": "Ajuste de brillo",
                  "de": "Helligkeitsanpassung",
                  "nl": "Helderheidsaanpassing"
        },
        {
                  "en": "Color inversion",
                  "es": "Inversión de color",
                  "de": "Farbinversion",
                  "nl": "Kleuromkering"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To check if images are corrupted",
                  "es": "Verificar si las imágenes están corruptas",
                  "de": "Prüfen ob Bilder beschädigt sind",
                  "nl": "Controleren of afbeeldingen beschadigd zijn"
        },
        {
                  "en": "To store backup copies of images",
                  "es": "Almacenar copias de respaldo de imágenes",
                  "de": "Backup-Kopien von Bildern speichern",
                  "nl": "Back-upkopieën van afbeeldingen opslaan"
        },
        {
                  "en": "To evaluate model performance during training without using test data",
                  "es": "Evaluar el rendimiento del modelo durante el entrenamiento sin usar datos de prueba",
                  "de": "Modellleistung während des Trainings bewerten ohne Testdaten zu verwenden",
                  "nl": "Modelprestaties evalueren tijdens training zonder testdata te gebruiken"
        },
        {
                  "en": "To validate image file formats",
                  "es": "Validar formatos de archivo de imagen",
                  "de": "Bilddateiformate validieren",
                  "nl": "Beeldbestandsformaten valideren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Introduce non-linearity to enable learning complex patterns",
                  "es": "Introducir no linealidad para permitir el aprendizaje de patrones complejos",
                  "de": "Nichtlinearität einführen um das Lernen komplexer Muster zu ermöglichen",
                  "nl": "Non-lineariteit introduceren om het leren van complexe patronen mogelijk te maken"
        },
        {
                  "en": "Speed up image processing",
                  "es": "Acelerar el procesamiento de imágenes",
                  "de": "Bildverarbeitung beschleunigen",
                  "nl": "Beeldverwerking versnellen"
        },
        {
                  "en": "Connect neurons physically",
                  "es": "Conectar neuronas físicamente",
                  "de": "Neuronen physisch verbinden",
                  "nl": "Neuronen fysiek verbinden"
        },
        {
                  "en": "Store neuron values in memory",
                  "es": "Almacenar valores de neuronas en memoria",
                  "de": "Neuronenwerte im Speicher speichern",
                  "nl": "Neuron waarden in geheugen opslaan"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Downloads gradients from the internet",
                  "es": "Descarga gradientes de internet",
                  "de": "Lädt Gradienten aus dem Internet herunter",
                  "nl": "Downloadt gradiënten van het internet"
        },
        {
                  "en": "Iteratively adjusts weights to minimize prediction errors",
                  "es": "Ajusta iterativamente los pesos para minimizar errores de predicción",
                  "de": "Passt iterativ Gewichte an um Vorhersagefehler zu minimieren",
                  "nl": "Past iteratief gewichten aan om voorspellingsfouten te minimaliseren"
        },
        {
                  "en": "Moves data down processing pipelines",
                  "es": "Mueve datos hacia abajo en pipelines de procesamiento",
                  "de": "Bewegt Daten in Verarbeitungspipelines nach unten",
                  "nl": "Verplaatst data naar beneden in verwerkingspipelines"
        },
        {
                  "en": "Reduces image resolution gradually",
                  "es": "Reduce la resolución de imagen gradualmente",
                  "de": "Reduziert Bildauflösung allmählich",
                  "nl": "Vermindert beeldresolutie geleidelijk"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Count lost or missing data points",
                  "es": "Contar puntos de datos perdidos o faltantes",
                  "de": "Verlorene oder fehlende Datenpunkte zählen",
                  "nl": "Verloren of ontbrekende datapunten tellen"
        },
        {
                  "en": "Compress image files for storage",
                  "es": "Comprimir archivos de imagen para almacenamiento",
                  "de": "Bilddateien für Speicherung komprimieren",
                  "nl": "Beeldbestanden comprimeren voor opslag"
        },
        {
                  "en": "Reduce computational processing time",
                  "es": "Reducir tiempo de procesamiento computacional",
                  "de": "Rechnerische Verarbeitungszeit reduzieren",
                  "nl": "Computationele verwerkingstijd verminderen"
        },
        {
                  "en": "Measure the difference between predicted and actual outputs",
                  "es": "Medir la diferencia entre salidas predichas y reales",
                  "de": "Die Differenz zwischen vorhergesagten und tatsächlichen Ausgaben messen",
                  "nl": "Het verschil meten tussen voorspelde en werkelijke outputs"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Classification works with color images, regression with grayscale",
                  "es": "La clasificación funciona con imágenes a color, la regresión con escala de grises",
                  "de": "Klassifikation funktioniert mit Farbbildern, Regression mit Graustufen",
                  "nl": "Classificatie werkt met kleurenafbeeldingen, regressie met grijswaarden"
        },
        {
                  "en": "Classification is faster than regression",
                  "es": "La clasificación es más rápida que la regresión",
                  "de": "Klassifikation ist schneller als Regression",
                  "nl": "Classificatie is sneller dan regressie"
        },
        {
                  "en": "Classification predicts categories, regression predicts continuous values",
                  "es": "La clasificación predice categorías, la regresión predice valores continuos",
                  "de": "Klassifikation sagt Kategorien vorher, Regression sagt kontinuierliche Werte vorher",
                  "nl": "Classificatie voorspelt categorieën, regressie voorspelt continue waarden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Small datasets process too quickly",
                  "es": "Los conjuntos de datos pequeños se procesan muy rápido",
                  "de": "Kleine Datensätze verarbeiten zu schnell",
                  "nl": "Kleine datasets verwerken te snel"
        },
        {
                  "en": "They require more storage space",
                  "es": "Requieren más espacio de almacenamiento",
                  "de": "Sie benötigen mehr Speicherplatz",
                  "nl": "Ze hebben meer opslagruimte nodig"
        },
        {
                  "en": "They are harder to organize",
                  "es": "Son más difíciles de organizar",
                  "de": "Sie sind schwerer zu organisieren",
                  "nl": "Ze zijn moeilijker te organiseren"
        },
        {
                  "en": "Insufficient data leads to poor generalization and overfitting",
                  "es": "Datos insuficientes llevan a mala generalización y sobreajuste",
                  "de": "Unzureichende Daten führen zu schlechter Generalisierung und Overfitting",
                  "nl": "Onvoldoende data leidt tot slechte generalisatie en overfitting"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Manually designing and selecting relevant image features for the algorithm",
                  "es": "Diseñar y seleccionar manualmente características de imagen relevantes para el algoritmo",
                  "de": "Manuelles Entwerfen und Auswählen relevanter Bildmerkmale für den Algorithmus",
                  "nl": "Handmatig ontwerpen en selecteren van relevante beeldkenmerken voor het algoritme"
        },
        {
                  "en": "Programming automatic image download features",
                  "es": "Programar características de descarga automática de imágenes",
                  "de": "Automatische Bild-Download-Features programmieren",
                  "nl": "Automatische beelddownload functies programmeren"
        },
        {
                  "en": "Building hardware components for faster processing",
                  "es": "Construir componentes de hardware para procesamiento más rápido",
                  "de": "Hardware-Komponenten für schnellere Verarbeitung bauen",
                  "nl": "Hardwarecomponenten bouwen voor snellere verwerking"
        },
        {
                  "en": "Creating user interfaces for image viewers",
                  "es": "Crear interfaces de usuario para visualizadores de imágenes",
                  "de": "Benutzeroberflächen für Bildbetrachter erstellen",
                  "nl": "Gebruikersinterfaces maken voor beeldkijkers"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They are always more accurate than custom models",
                  "es": "Siempre son más precisos que modelos personalizados",
                  "de": "Sie sind immer genauer als benutzerdefinierte Modelle",
                  "nl": "Ze zijn altijd nauwkeuriger dan aangepaste modellen"
        },
        {
                  "en": "They work only with specific image formats",
                  "es": "Funcionan solo con formatos de imagen específicos",
                  "de": "Sie funktionieren nur mit spezifischen Bildformaten",
                  "nl": "Ze werken alleen met specifieke beeldformaten"
        },
        {
                  "en": "They require no additional training at all",
                  "es": "No requieren entrenamiento adicional en absoluto",
                  "de": "Sie benötigen überhaupt kein zusätzliches Training",
                  "nl": "Ze hebben helemaal geen aanvullende training nodig"
        },
        {
                  "en": "Leverage knowledge learned from large datasets to accelerate training",
                  "es": "Aprovechar conocimiento aprendido de grandes conjuntos de datos para acelerar el entrenamiento",
                  "de": "Wissen aus großen Datensätzen nutzen um Training zu beschleunigen",
                  "nl": "Kennis benut die geleerd is van grote datasets om training te versnellen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They represent different historical time periods",
                  "es": "Representan diferentes períodos históricos de tiempo",
                  "de": "Sie repräsentieren verschiedene historische Zeitperioden",
                  "nl": "Ze vertegenwoordigen verschillende historische tijdperioden"
        },
        {
                  "en": "Each epoch represents one complete pass through the entire training dataset",
                  "es": "Cada época representa un pase completo por todo el conjunto de datos de entrenamiento",
                  "de": "Jede Epoche repräsentiert einen vollständigen Durchgang durch den gesamten Trainingsdatensatz",
                  "nl": "Elke epoch vertegenwoordigt één complete doorgang door de hele trainingsdataset"
        },
        {
                  "en": "Epochs measure processing speed in milliseconds",
                  "es": "Las épocas miden velocidad de procesamiento en milisegundos",
                  "de": "Epochen messen Verarbeitungsgeschwindigkeit in Millisekunden",
                  "nl": "Epochs meten verwerkingssnelheid in milliseconden"
        },
        {
                  "en": "Epochs count the number of images in the dataset",
                  "es": "Las épocas cuentan el número de imágenes en el conjunto de datos",
                  "de": "Epochen zählen die Anzahl der Bilder im Datensatz",
                  "nl": "Epochs tellen het aantal afbeeldingen in de dataset"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measures student performance in learning",
                  "es": "Mide el rendimiento del estudiante en el aprendizaje",
                  "de": "Misst Schülerleistung beim Lernen",
                  "nl": "Meet studentenprestaties bij het leren"
        },
        {
                  "en": "Controls how much weights are adjusted during each training step",
                  "es": "Controla cuánto se ajustan los pesos durante cada paso de entrenamiento",
                  "de": "Kontrolliert wie stark Gewichte während jedem Trainingsschritt angepasst werden",
                  "nl": "Controleert hoeveel gewichten worden aangepast tijdens elke trainingsstap"
        },
        {
                  "en": "Determines how fast images are processed",
                  "es": "Determina qué tan rápido se procesan las imágenes",
                  "de": "Bestimmt wie schnell Bilder verarbeitet werden",
                  "nl": "Bepaalt hoe snel afbeeldingen worden verwerkt"
        },
        {
                  "en": "Sets the maximum number of epochs",
                  "es": "Establece el número máximo de épocas",
                  "de": "Setzt die maximale Anzahl von Epochen",
                  "nl": "Stelt het maximum aantal epochs in"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Physical size of image files in megabytes",
                  "es": "Tamaño físico de archivos de imagen en megabytes",
                  "de": "Physische Größe von Bilddateien in Megabytes",
                  "nl": "Fysieke grootte van beeldbestanden in megabytes"
        },
        {
                  "en": "Total number of images in the dataset",
                  "es": "Número total de imágenes en el conjunto de datos",
                  "de": "Gesamtzahl der Bilder im Datensatz",
                  "nl": "Totaal aantal afbeeldingen in de dataset"
        },
        {
                  "en": "Number of layers in the neural network",
                  "es": "Número de capas en la red neuronal",
                  "de": "Anzahl der Schichten im neuronalen Netzwerk",
                  "nl": "Aantal lagen in het neurale netwerk"
        },
        {
                  "en": "Number of training examples processed together before updating weights",
                  "es": "Número de ejemplos de entrenamiento procesados juntos antes de actualizar pesos",
                  "de": "Anzahl der Trainingsbeispiele die zusammen verarbeitet werden bevor Gewichte aktualisiert werden",
                  "nl": "Aantal trainingsvoorbeelden dat samen wordt verwerkt voordat gewichten worden geüpdatet"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Assess model performance more reliably by testing on multiple data splits",
                  "es": "Evaluar el rendimiento del modelo de manera más confiable probando en múltiples divisiones de datos",
                  "de": "Modellleistung zuverlässiger bewerten durch Testen auf mehreren Datenteilungen",
                  "nl": "Modelprestaties betrouwbaarder beoordelen door te testen op meerdere datasplitsingen"
        },
        {
                  "en": "Cross-reference multiple datasets simultaneously",
                  "es": "Hacer referencia cruzada de múltiples conjuntos de datos simultáneamente",
                  "de": "Mehrere Datensätze gleichzeitig querverweisen",
                  "nl": "Meerdere datasets tegelijkertijd kruislings refereren"
        },
        {
                  "en": "Validate that images are correctly formatted",
                  "es": "Validar que las imágenes estén correctamente formateadas",
                  "de": "Validieren dass Bilder korrekt formatiert sind",
                  "nl": "Valideren dat afbeeldingen correct geformatteerd zijn"
        },
        {
                  "en": "Validate network connections during training",
                  "es": "Validar conexiones de red durante el entrenamiento",
                  "de": "Netzwerkverbindungen während des Trainings validieren",
                  "nl": "Netwerkverbindingen valideren tijdens training"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Supervised learning requires more memory",
                  "es": "Aprendizaje supervisado requiere más memoria",
                  "de": "Überwachtes Lernen benötigt mehr Speicher",
                  "nl": "Supervised learning vereist meer geheugen"
        },
        {
                  "en": "Supervised learning uses labeled data, unsupervised finds hidden patterns without labels",
                  "es": "Aprendizaje supervisado usa datos etiquetados, no supervisado encuentra patrones ocultos sin etiquetas",
                  "de": "Überwachtes Lernen verwendet beschriftete Daten, unüberwachtes findet versteckte Muster ohne Labels",
                  "nl": "Supervised learning gebruikt gelabelde data, unsupervised vindt verborgen patronen zonder labels"
        },
        {
                  "en": "They are exactly the same approach",
                  "es": "Son exactamente el mismo enfoque",
                  "de": "Sie sind genau derselbe Ansatz",
                  "nl": "Ze zijn precies dezelfde benadering"
        },
        {
                  "en": "Unsupervised learning is always more accurate",
                  "es": "Aprendizaje no supervisado es siempre más preciso",
                  "de": "Unüberwachtes Lernen ist immer genauer",
                  "nl": "Unsupervised learning is altijd nauwkeuriger"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting image formats during processing",
                  "es": "Convertir formatos de imagen durante el procesamiento",
                  "de": "Bildformate während der Verarbeitung konvertieren",
                  "nl": "Beeldformaten converteren tijdens verwerking"
        },
        {
                  "en": "Transferring images from one computer to another",
                  "es": "Transferir imágenes de una computadora a otra",
                  "de": "Bilder von einem Computer zum anderen übertragen",
                  "nl": "Afbeeldingen van de ene computer naar de andere overdragen"
        },
        {
                  "en": "Using knowledge from one task to improve performance on a different but related task",
                  "es": "Usar conocimiento de una tarea para mejorar el rendimiento en una tarea diferente pero relacionada",
                  "de": "Wissen von einer Aufgabe verwenden um Leistung bei einer anderen aber verwandten Aufgabe zu verbessern",
                  "nl": "Kennis van één taak gebruiken om prestaties bij een andere maar gerelateerde taak te verbeteren"
        },
        {
                  "en": "Moving data between training and testing sets",
                  "es": "Mover datos entre conjuntos de entrenamiento y prueba",
                  "de": "Daten zwischen Trainings- und Testsätzen verschieben",
                  "nl": "Data verplaatsen tussen trainings- en testsets"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adjusting pre-trained model weights for a specific task using new data",
                  "es": "Ajustar pesos de modelo pre-entrenado para una tarea específica usando datos nuevos",
                  "de": "Anpassen vortrainierter Modellgewichte für eine spezifische Aufgabe mit neuen Daten",
                  "nl": "Aanpassen van voorgetrainde modelgewichten voor een specifieke taak met nieuwe data"
        },
        {
                  "en": "Changing the number of network layers",
                  "es": "Cambiar el número de capas de red",
                  "de": "Anzahl der Netzwerkschichten ändern",
                  "nl": "Aantal netwerklagen wijzigen"
        },
        {
                  "en": "Making minor adjustments to image brightness",
                  "es": "Hacer ajustes menores al brillo de la imagen",
                  "de": "Kleine Anpassungen an der Bildhelligkeit vornehmen",
                  "nl": "Kleine aanpassingen aan beeldhelderheid maken"
        },
        {
                  "en": "Optimizing hardware performance settings",
                  "es": "Optimizar configuraciones de rendimiento de hardware",
                  "de": "Hardware-Leistungseinstellungen optimieren",
                  "nl": "Hardware prestatie-instellingen optimaliseren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A software for creating neural networks",
                  "es": "Un software para crear redes neuronales",
                  "de": "Eine Software zum Erstellen neuronaler Netzwerke",
                  "nl": "Een software voor het maken van neurale netwerken"
        },
        {
                  "en": "A large-scale visual database with millions of labeled images across thousands of categories",
                  "es": "Una base de datos visual a gran escala con millones de imágenes etiquetadas en miles de categorías",
                  "de": "Eine großskalige visuelle Datenbank mit Millionen beschrifteter Bilder über Tausende von Kategorien",
                  "nl": "Een grootschalige visuele database met miljoenen gelabelde afbeeldingen verspreid over duizenden categorieën"
        },
        {
                  "en": "An internet service provider for images",
                  "es": "Un proveedor de servicios de internet para imágenes",
                  "de": "Ein Internet-Service-Provider für Bilder",
                  "nl": "Een internetprovider voor afbeeldingen"
        },
        {
                  "en": "A network of computers for image processing",
                  "es": "Una red de computadoras para procesamiento de imágenes",
                  "de": "Ein Netzwerk von Computern für Bildverarbeitung",
                  "nl": "Een netwerk van computers voor beeldverwerking"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating confusing test questions",
                  "es": "Crear preguntas de prueba confusas",
                  "de": "Verwirrende Testfragen erstellen",
                  "nl": "Verwarrende testvragen maken"
        },
        {
                  "en": "Identifying unclear images in datasets",
                  "es": "Identificar imágenes poco claras en conjuntos de datos",
                  "de": "Unklare Bilder in Datensätzen identifizieren",
                  "nl": "Onduidelijke afbeeldingen in datasets identificeren"
        },
        {
                  "en": "Visualizing true positives, false positives, true negatives, and false negatives",
                  "es": "Visualizar verdaderos positivos, falsos positivos, verdaderos negativos y falsos negativos",
                  "de": "Visualisierung von echten Positiven, falschen Positiven, echten Negativen und falschen Negativen",
                  "nl": "Visualiseren van ware positieven, valse positieven, ware negatieven en valse negatieven"
        },
        {
                  "en": "Measuring confusion levels in neural networks",
                  "es": "Medir niveles de confusión en redes neuronales",
                  "de": "Verwirrungsgrade in neuronalen Netzwerken messen",
                  "nl": "Verwarringsniveaus in neurale netwerken meten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "How precisely images are aligned",
                  "es": "Qué tan precisamente están alineadas las imágenes",
                  "de": "Wie präzise Bilder ausgerichtet sind",
                  "nl": "Hoe nauwkeurig afbeeldingen zijn uitgelijnd"
        },
        {
                  "en": "The image resolution in pixels",
                  "es": "La resolución de imagen en píxeles",
                  "de": "Die Bildauflösung in Pixeln",
                  "nl": "De beeldresolutie in pixels"
        },
        {
                  "en": "The overall accuracy of the model",
                  "es": "La precisión general del modelo",
                  "de": "Die Gesamtgenauigkeit des Modells",
                  "nl": "De algehele nauwkeurigheid van het model"
        },
        {
                  "en": "The proportion of correct positive predictions out of all positive predictions made",
                  "es": "La proporción de predicciones positivas correctas de todas las predicciones positivas realizadas",
                  "de": "Der Anteil korrekter positiver Vorhersagen von allen gemachten positiven Vorhersagen",
                  "nl": "De verhouding van correcte positieve voorspellingen van alle gemaakte positieve voorspellingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The ability to retrieve stored images",
                  "es": "La capacidad de recuperar imágenes almacenadas",
                  "de": "Die Fähigkeit gespeicherte Bilder abzurufen",
                  "nl": "Het vermogen om opgeslagen afbeeldingen op te halen"
        },
        {
                  "en": "Speed of processing recalled from cache",
                  "es": "Velocidad de procesamiento recordada desde caché",
                  "de": "Verarbeitungsgeschwindigkeit abgerufen aus Cache",
                  "nl": "Verwerkingssnelheid opgehaald uit cache"
        },
        {
                  "en": "The proportion of actual positives that were correctly identified",
                  "es": "La proporción de positivos reales que fueron identificados correctamente",
                  "de": "Der Anteil tatsächlicher Positive die korrekt identifiziert wurden",
                  "nl": "De verhouding van werkelijke positieven die correct werden geïdentificeerd"
        },
        {
                  "en": "How well the model remembers training data",
                  "es": "Qué tan bien el modelo recuerda datos de entrenamiento",
                  "de": "Wie gut das Modell Trainingsdaten erinnert",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The top racing category in machine learning",
                  "es": "La categoría de carreras superior en aprendizaje automático",
                  "de": "Die Top-Rennkategorie in maschinellem Lernen",
                  "nl": "De top racecategorie in machine learning"
        },
        {
                  "en": "The first level of feature extraction",
                  "es": "El primer nivel de extracción de características",
                  "de": "Die erste Ebene der Merkmalsextraktion",
                  "nl": "Het eerste niveau van feature extraction"
        },
        {
                  ...
                  "de": "Das harmonische Mittel von Präzision und Recall, ausgleichend beide Metriken",
                  "nl": "Het harmonisch gemiddelde van precisie en recall, beide metrieken balancerend"
        },
        {
                  "en": "A formula for image compression",
                  "es": "Una fórmula para compresión de imagen",
                  "de": "Eine Formel für Bildkompression",
                  "nl": "Een formule voor beeldcompressie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Desactivar aleatoriamente neuronas durante el entrenamiento para prevenir sobreajuste",
                  "de": "Zufälliges Deaktivieren von Neuronen während des Trainings um Overfitting zu verhindern",
                  "nl": "Willekeurig neuronen deactiveren tijdens training om overfitting te voorkomen"
        },
        {
                  "en": "Removing corrupted images from the dataset",
                  "es": "Eliminar imágenes corruptas del conjunto de datos",
                  "de": "Beschädigte Bilder aus dem Datensatz entfernen",
                  "nl": "Beschadigde afbeeldingen uit de dataset verwijderen"
        },
        {
                  "en": "When students quit neural network courses",
                  "es": "Cuando los estudiantes abandonan cursos de redes neuronales",
                  "de": "Wenn Studenten neuronale Netzwerkkurse abbrechen",
                  "nl": "Wanneer studenten neurale netwerk cursussen stoppen"
        },
        {
                  "en": "Network disconnections during training",
                  "es": "Desconexiones de red durante el entrenamiento",
                  "de": "Netzwerkunterbrechungen während des Trainings",
                  "nl": "Netwerkonderbrekingen tijdens training"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The region of the input image that influences a particular neuron's activation",
                  "es": "La región de la imagen de entrada que influye en la activación de una neurona particular",
                  "de": "Die Region des Eingabebildes die die Aktivierung eines bestimmten Neurons beeinflusst",
                  "nl": "De regio van de invoerafbeelding die de activatie van een bepaald neuron beïnvloedt"
        },
        {
                  "en": "The area where images are received for processing",
                  "es": "El área donde se reciben imágenes para procesamiento",
                  "de": "Der Bereich wo Bilder für Verarbeitung empfangen werden",
                  "nl": "Het gebied waar afbeeldingen worden ontvangen voor verwerking"
        },
        {
                  "en": "The physical sensor area of a camera",
                  "es": "El área del sensor físico de una cámara",
                  "de": "Der physische Sensorbereich einer Kamera",
                  "nl": "Het fysieke sensorgebied van een camera"
        },
        {
                  "en": "A field in the database storing image data",
                  "es": "Un campo en la base de datos que almacena datos de imagen",
                  "de": "Ein Feld in der Datenbank das Bilddaten speichert",
                  "nl": "Een veld in de database dat beelddata opslaat"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  ...
                  "de": "Gradienten werden in frühen Schichten extrem klein, verhindern effektives Lernen",
                  "nl": "Gradiënten worden extreem klein in vroege lagen, wat effectief leren verhindert"
        },
        {
                  "en": "Visual gradients fade in processed images",
                  "es": "Los gradientes visuales se desvanecen en imágenes procesadas",
                  "de": "Visuelle Gradienten verblassen in verarbeiteten Bildern",
                  "nl": "Visuele gradiënten vervagen in verwerkte afbeeldingen"
        },
        {
                  "en": "Color gradients are removed during training",
                  "es": "Los gradientes de color se eliminan durante el entrenamiento",
                  "de": "Farbverläufe werden während des Trainings entfernt",
                  "nl": "Kleurgradiënten worden verwijderd tijdens training"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Increasing image resolution dramatically",
                  "es": "Aumentar drásticamente la resolución de imagen",
                  "de": "Bildauflösung drastisch erhöhen",
                  "nl": "Beeldresolutie drastisch verhogen"
        },
        {
                  "en": "Converting all images to grayscale",
                  "es": "Convertir todas las imágenes a escala de grises",
                  "de": "Alle Bilder zu Graustufen konvertieren",
                  "nl": "Alle afbeeldingen naar grijswaarden converteren"
        },
        {
                  "en": "Residual connections (skip connections) as used in ResNet",
                  "es": "Conexiones residuales (conexiones de salto) como se usan en ResNet",
                  "de": "Residuale Verbindungen (Skip-Verbindungen) wie in ResNet verwendet",
                  "nl": "Residuele verbindingen (skip connections) zoals gebruikt in ResNet"
        },
        {
                  "en": "Using only shallow networks",
                  "es": "Usar solo redes superficiales",
                  "de": "Nur flache Netzwerke verwenden",
                  "nl": "Alleen ondiepe netwerken gebruiken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Alle Bilder auf dieselbe Größe bringen",
                  "nl": "Alle afbeeldingen dezelfde grootte maken"
        },
        {
                  "en": "Normalizing layer inputs to stabilize and accelerate training",
                  "es": "Normalizar entradas de capa para estabilizar y acelerar el entrenamiento",
                  "de": "Schichteingaben normalisieren um Training zu stabilisieren und beschleunigen",
                  "nl": "Laaginputs normaliseren om training te stabiliseren en versnellen"
        },
        {
                  "en": "Organizing images into batches for storage",
                  "es": "Organizar imágenes en lotes para almacenamiento",
                  "de": "Bilder in Batches für Speicherung organisieren",
                  "nl": "Afbeeldingen in batches organiseren voor opslag"
        },
        {
                  "en": "Normalizing batch processing schedules",
                  "es": "Normalizar horarios de procesamiento por lotes",
                  "de": "Batch-Verarbeitungszeitpläne normalisieren",
                  "nl": "Batch verwerkingsschema's normaliseren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Maximize the depth of the network",
                  "es": "Maximizar la profundidad de la red",
                  "de": "Die Tiefe des Netzwerks maximieren",
                  "nl": "De diepte van het netwerk maximaliseren"
        },
        {
                  "en": "Downsample feature maps by selecting maximum values from regions",
                  "es": "Submuestrear mapas de características seleccionando valores máximos de regiones",
                  "de": "Feature Maps durch Auswahl maximaler Werte aus Regionen heruntersampeln",
                  "nl": "Feature maps downsamplen door maximale waarden uit regio's te selecteren"
        },
        {
                  "en": "Pool together the maximum number of images",
                  "es": "Agrupar el número máximo de imágenes",
                  "de": "Die maximale Anzahl von Bildern zusammenführen",
                  "nl": "Het maximale aantal afbeeldingen samenvoegen"
        },
        {
                  "en": "Find the largest swimming pool in images",
                  "es": "Encontrar la piscina más grande en imágenes",
                  "de": "Den größten Pool in Bildern finden",
                  "nl": "Het grootste zwembad in afbeeldingen vinden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Add extra storage space for images",
                  "es": "Agregar espacio de almacenamiento extra para imágenes",
                  "de": "Zusätzlichen Speicherplatz für Bilder hinzufügen",
                  "nl": "Extra opslagruimte toevoegen voor afbeeldingen"
        },
        {
                  "en": "Preserve spatial dimensions and process edge pixels effectively",
                  "es": "Preservar dimensiones espaciales y procesar píxeles de borde efectivamente",
                  "de": "Räumliche Dimensionen bewahren und Randpixel effektiv verarbeiten",
                  "nl": "Ruimtelijke dimensies behouden en randpixels effectief verwerken"
        },
        {
                  "en": "Fill empty database fields",
                  "es": "Llenar campos de base de datos vacíos",
                  "de": "Leere Datenbankfelder füllen",
                  "nl": "Lege databasevelden vullen"
        },
        {
                  "en": "Create physical padding around monitors",
                  "es": "Crear relleno físico alrededor de monitores",
                  "de": "Physische Polsterung um Monitore erstellen",
                  "nl": "Fysieke opvulling rond monitoren creëren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The step size by which the filter moves across the input image",
                  "es": "El tamaño del paso por el cual el filtro se mueve a través de la imagen de entrada",
                  "de": "Die Schrittgröße mit der der Filter sich über das Eingabebild bewegt",
                  "nl": "De stapgrootte waarmee het filter over de invoerafbeelding beweegt"
        },
        {
                  "en": "The walking pattern of robots in computer vision",
                  "es": "El patrón de caminata de robots en visión por computadora",
                  "de": "Das Gehmuster von Robotern in Computer Vision",
                  "nl": "Het looppatroon van robots in computer vision"
        },
        {
                  "en": "The length of training iterations",
                  "es": "La longitud de iteraciones de entrenamiento",
                  "de": "Die Länge von Trainingsiterationen",
                  "nl": "De lengte van trainingsiteraties"
        },
        {
                  "en": "Speed of image processing",
                  "es": "Velocidad de procesamiento de imagen",
                  "de": "Geschwindigkeit der Bildverarbeitung",
                  "nl": "Snelheid van beeldverwerking"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Detect different types of features like edges, textures, and patterns simultaneously",
                  "es": "Detectar diferentes tipos de características como bordes, texturas y patrones simultáneamente",
                  "de": "Verschiedene Arten von Merkmalen wie Kanten, Texturen und Muster gleichzeitig erkennen",
                  "nl": "Verschillende soorten kenmerken zoals randen, texturen en patronen tegelijkertijd detecteren"
        },
        {
                  "en": "Backup the processing in case one filter fails",
                  "es": "Respaldar el procesamiento en caso de que falle un filtro",
                  "de": "Verarbeitung sichern falls ein Filter ausfällt",
                  "nl": "De verwerking back-uppen voor het geval één filter faalt"
        },
        {
                  "en": "Filter out noise multiple times for cleaner images",
                  "es": "Filtrar ruido múltiples veces para imágenes más limpias",
                  "de": "Rauschen mehrfach filtern für sauberere Bilder",
                  "nl": "Ruis meerdere keren filteren voor schonere afbeeldingen"
        },
        {
                  "en": "Process images in different color spaces",
                  "es": "Procesar imágenes en diferentes espacios de color",
                  "de": "Bilder in verschiedenen Farbräumen verarbeiten",
                  "nl": "Afbeeldingen in verschillende kleurruimtes verwerken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining predictions from multiple models to improve overall performance",
                  "es": "Combinar predicciones de múltiples modelos para mejorar el rendimiento general",
                  "de": "Vorhersagen von mehreren Modellen kombinieren um Gesamtleistung zu verbessern",
                  "nl": "Voorspellingen van meerdere modellen combineren om algehele prestaties te verbeteren"
        },
        {
                  "en": "Grouping similar images together",
                  "es": "Agrupar imágenes similares juntas",
                  "de": "Ähnliche Bilder zusammengruppieren",
                  "nl": "Vergelijkbare afbeeldingen samen groeperen"
        },
        {
                  "en": "Assembling computer hardware for training",
                  "es": "Ensamblar hardware de computadora para entrenamiento",
                  "de": "Computer-Hardware für Training zusammenbauen",
                  "nl": "Computerhardware assembleren voor training"
        },
        {
                  "en": "Creating ensemble casts in image recognition",
                  "es": "Crear elencos de conjunto en reconocimiento de imágenes",
                  "de": "Ensemble-Besetzungen in Bilderkennung erstellen",
                  "nl": "Ensemble casts creëren in beeldherkenning"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training only in the morning hours",
                  "es": "Entrenar solo en horas de la mañana",
                  "de": "Nur in den Morgenstunden trainieren",
                  "nl": "Alleen in de ochtenduren trainen"
        },
        {
                  "en": "Stopping training very early in the process",
                  "es": "Detener el entrenamiento muy temprano en el proceso",
                  "de": "Training sehr früh im Prozess stoppen",
                  "nl": "Training zeer vroeg in het proces stoppen"
        },
        {
                  ...
                  "nl": "Training stoppen wanneer validatieprestaties niet meer verbeteren om overfitting te voorkomen"
        },
        {
                  "en": "Stopping when the computer overheats",
                  "es": "Detener cuando la computadora se sobrecalienta",
                  "de": "Stoppen wenn der Computer überhitzt",
                  "nl": "Stoppen wanneer de computer oververhit raakt"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The gradient descent algorithm stops working",
                  "es": "El algoritmo de descenso de gradiente deja de funcionar",
                  "de": "Der Gradientenabstiegsalgorithmus hört auf zu funktionieren",
                  "nl": "Het gradiënt-descent algoritme stopt met werken"
        },
        {
                  "en": "Gradients disappear from computer memory",
                  "es": "Gradientes desaparecen de la memoria de la computadora",
                  "de": "Gradienten verschwinden aus dem Computerspeicher",
                  "nl": "Gradiënten verdwijnen uit het computergeheugen"
        },
        {
                  "en": "Gradients become very small in earlier layers making learning slow or impossible",
                  "es": "Gradientes se vuelven muy pequeños en capas anteriores haciendo el aprendizaje lento o imposible",
                  "de": "Gradienten werden in früheren Schichten sehr klein und machen Lernen langsam oder unmöglich",
                  "nl": "Gradiënten worden zeer klein in eerdere lagen waardoor leren traag of onmogelijk wordt"
        },
        {
                  "en": "Visual gradients fade in images",
                  "es": "Gradientes visuales se desvanecen en imágenes",
                  "de": "Visuelle Gradienten verblassen in Bildern",
                  "nl": "Visuele gradiënten vervagen in afbeeldingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The area where the neuron receives signals",
                  "es": "El área donde la neurona recibe señales",
                  "de": "Der Bereich wo das Neuron Signale empfängt",
                  "nl": "Het gebied waar het neuron signalen ontvangt"
        },
        {
                  "en": "The set of neurons that receive its output",
                  "es": "El conjunto de neuronas que reciben su salida",
                  "de": "Die Menge von Neuronen die seine Ausgabe empfangen",
                  "nl": "De set neuronen die zijn output ontvangen"
        },
        {
                  "en": "The physical space occupied by the neuron",
                  "es": "El espacio físico ocupado por la neurona",
                  "de": "Der physische Raum den das Neuron einnimmt",
                  "nl": "De fysieke ruimte die het neuron inneemt"
        },
        {
                  "en": "The region in the input image that affects that neuron's activation",
                  "es": "La región en la imagen de entrada que afecta la activación de esa neurona",
                  "de": "Die Region im Eingabebild die die Aktivierung dieses Neurons beeinflusst",
                  "nl": "De regio in de invoerafbeelding die de activatie van dat neuron beïnvloedt"
        }
        ],
        correct: 3,
        explanation: {
