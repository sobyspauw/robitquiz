    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Studying player genetics",
                  "es": "Estudiar genética de jugadores",
                  "de": "Spielergenetik studieren",
                  "nl": "Spelergenetica bestuderen"
        },
        {
                  "en": "Evolving and optimizing AI behaviors through simulated evolution",
                  "es": "Evolucionar y optimizar comportamientos IA a través de evolución simulada",
                  "de": "Entwicklung und Optimierung von KI-Verhaltensweisen durch simulierte Evolution",
                  "nl": "Evolueren en optimaliseren van AI-gedragingen door gesimuleerde evolutie"
        },
        {
                  "en": "Creating family trees for game characters",
                  "es": "Crear árboles genealógicos para personajes del juego",
                  "de": "Stammbäume für Spielcharaktere erstellen",
                  "nl": "Stambomen creëren voor spelkarakters"
        },
        {
                  "en": "Generating random genetic code",
                  "es": "Generar código genético aleatorio",
                  "de": "Zufälligen genetischen Code generieren",
                  "nl": "Willekeurige genetische code genereren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Useful AI tools for game development",
                  "es": "Herramientas IA útiles para desarrollo de juegos",
                  "de": "Nützliche KI-Tools für Spielentwicklung",
                  "nl": "Nuttige AI-tools voor spelontwikkeling"
        },
        {
                  "en": "AI that manages game utilities and resources",
                  "es": "IA que gestiona utilidades y recursos del juego",
                  "de": "KI die Spiel-Utilities und Ressourcen verwaltet",
                  "nl": "AI die spelunutiliteiten en bronnen beheert"
        },
        {
                  "en": "AI optimized for utility computing",
                  "es": "IA optimizada para computación de utilidad",
                  "de": "KI optimiert für Utility Computing",
                  "nl": "AI geoptimaliseerd voor utility computing"
        },
        {
                  "en": "AI that evaluates and chooses actions based on calculated utility values",
                  "es": "IA que evalúa y elige acciones basándose en valores de utilidad calculados",
                  "de": "KI die Aktionen basierend auf berechneten Nutzenwerten bewertet und wählt",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Legal reasoning system for game disputes",
                  "es": "Sistema de razonamiento legal para disputas de juegos",
                  "de": "Rechtliches Argumentationssystem für Spielstreitigkeiten",
                  "nl": "Juridisch redeneringssysteem voor spelgeschillen"
        },
        {
                  "en": "Medical case analysis in health games",
                  "es": "Análisis de casos médicos en juegos de salud",
                  "de": "Medizinische Fallanalyse in Gesundheitsspielen",
                  "nl": "Medische case-analyse in gezondheidsgames"
        },
        {
                  "en": "Reasoning about game cases and boxes",
                  "es": "Razonar sobre cajas y estuches de juegos",
                  "de": "Argumentation über Spielschachteln und -hüllen",
                  "nl": "Redeneren over speldozen en -hoezen"
        },
        {
                  "en": "AI that solves new problems by adapting solutions from similar past situations",
                  "es": "IA que resuelve problemas nuevos adaptando soluciones de situaciones pasadas similares",
                  "de": "KI die neue Probleme löst indem sie Lösungen aus ähnlichen vergangenen Situationen anpasst",
                  "nl": "AI die nieuwe problemen oplost door oplossingen aan te passen uit vergelijkbare situaties uit het verleden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Breaking complex goals into hierarchical sub-tasks for systematic execution",
                  "es": "Dividir objetivos complejos en subtareas jerárquicas para ejecución sistemática",
                  "de": "Aufbrechen komplexer Ziele in hierarchische Unteraufgaben für systematische Ausführung",
                  "nl": "Complexe doelen opdelen in hiërarchische subtaken voor systematische uitvoering"
        },
        {
                  "en": "Network topology for multiplayer games",
                  "es": "Topología de red para juegos multijugador",
                  "de": "Netzwerktopologie für Mehrspielerspiele",
                  "nl": "Netwerktopologie voor multiplayer games"
        },
        {
                  "en": "Task management for game development teams",
                  "es": "Gestión de tareas para equipos de desarrollo de juegos",
                  "de": "Aufgabenmanagement für Spielentwicklungsteams",
                  "nl": "Taakbeheer voor spelontwikkelingsteams"
        },
        {
                  "en": "Hierarchical player ranking system",
                  "es": "Sistema de clasificación jerárquica de jugadores",
                  "de": "Hierarchisches Spieler-Ranking-System",
                  "nl": "Hiërarchisch spelersrangsysteem"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Secret agents in espionage games",
                  "es": "Agentes secretos en juegos de espionaje",
                  "de": "Geheimagenten in Spionagespielen",
                  "nl": "Geheime agenten in spionagespellen"
        },
        {
                  "en": "Multiple independent AI agents working together or competing in game environments",
                  "es": "Múltiples agentes IA independientes trabajando juntos o compitiendo en entornos de juego",
                  "de": "Mehrere unabhängige KI-Agenten die in Spielumgebungen zusammenarbeiten oder konkurrieren",
                  "nl": "Meerdere onafhankelijke AI-agenten die samenwerken of concurreren in spelomgevingen"
        },
        {
                  "en": "Multiple game clients connecting to servers",
                  "es": "Múltiples clientes de juego conectándose a servidores",
                  "de": "Mehrere Spielclients die sich mit Servern verbinden",
                  "nl": "Meerdere spelclients die verbinden met servers"
        },
        {
                  "en": "Real estate agents in property simulation games",
                  "es": "Agentes inmobiliarios en juegos de simulación de propiedades",
                  "de": "Immobilienmakler in Immobilien-Simulationsspielen",
                  "nl": "Makelaars in vastgoedsimulatiespellen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Algorithm that learns optimal actions by updating action-value estimates through trial and error",
                  "es": "Algoritmo que aprende acciones óptimas actualizando estimaciones de valor de acción a través de ensayo y error",
                  "de": "Algorithmus der optimale Aktionen lernt durch Aktualisierung von Action-Value-Schätzungen durch Versuch und Irrtum",
                  "nl": "Algoritme dat optimale acties leert door actiewaarde-schattingen bij te werken via vallen en opstaan"
        },
        {
                  "en": "Quality assessment learning for game testing",
                  "es": "Aprendizaje de evaluación de calidad para pruebas de juego",
                  "de": "Qualitätsbewertungs-Lernen für Spieltests",
                  "nl": "Kwaliteitsbeoordeling leren voor speltesten"
        },
        {
                  "en": "Question-based learning system for NPCs",
                  "es": "Sistema de aprendizaje basado en preguntas para NPCs",
                  "de": "Fragenbasiertes Lernsystem für NPCs",
                  "nl": "Op vragen gebaseerd leersysteem voor NPCs"
        },
        {
                  "en": "Quick learning algorithm for fast games",
                  "es": "Algoritmo de aprendizaje rápido para juegos rápidos",
                  "de": "Schneller Lernalgorithmus für schnelle Spiele",
                  "nl": "Snel leeralgoritme voor snelle spellen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Neural networks that approximate Q-values for complex state spaces in reinforcement learning",
                  "es": "Redes neuronales que aproximan valores Q para espacios de estado complejos en aprendizaje por refuerzo",
                  "de": "Neuronale Netzwerke die Q-Werte für komplexe Zustandsräume in Verstärkungslernen approximieren",
                  "nl": "Neurale netwerken die Q-waarden benaderen voor complexe toestandsruimtes in reinforcement learning"
        },
        {
                  "en": "Quantum networks for advanced AI processing",
                  "es": "Redes cuánticas para procesamiento avanzado de IA",
                  "de": "Quantennetzwerke für fortgeschrittene KI-Verarbeitung",
                  "nl": "Quantum netwerken voor geavanceerde AI-verwerking"
        },
        {
                  "en": "Question-depth networks for game narratives",
                  "es": "Redes de profundidad de preguntas para narrativas de juego",
                  "de": "Fragentiefe-Netzwerke für Spielnarrative",
                  "nl": "Vraagdiepte netwerken voor spelverhalingen"
        },
        {
                  "en": "Deep neural networks for graphics quality",
                  "es": "Redes neuronales profundas para calidad gráfica",
                  "de": "Tiefe neuronale Netzwerke für Grafikqualität",
                  "nl": "Diepe neurale netwerken voor grafische kwaliteit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Policy documentation gradients for AI systems",
                  "es": "Gradientes de documentación de política para sistemas IA",
                  "de": "Politikdokumentations-Gradienten für KI-Systeme",
                  "nl": "Beleidsdocumentatie gradiënten voor AI-systemen"
        },
        {
                  "en": "Directly optimizing the probability distribution over actions using gradient ascent",
                  "es": "Optimizar directamente la distribución de probabilidad sobre acciones usando ascenso de gradiente",
                  "de": "Direkte Optimierung der Wahrscheinlichkeitsverteilung über Aktionen mittels Gradientenanstieg",
                  "nl": "Direct optimaliseren van de kansverdeling over acties met behulp van gradiëntenstijging"
        },
        {
                  "en": "Gradual policy changes in game difficulty",
                  "es": "Cambios graduales de política en dificultad del juego",
                  "de": "Graduelle Politikänderungen in Spielschwierigkeit",
                  "nl": "Geleidelijke beleidsveranderingen in spelmoeilijkheid"
        },
        {
                  "en": "Graph-based policy networks for game rules",
                  "es": "Redes de política basadas en grafos para reglas de juego",
                  "de": "Graphbasierte Politik-Netzwerke für Spielregeln",
                  "nl": "Op grafieken gebaseerde beleidsnetwerken voor spelregels"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Acting and critique systems for character animations",
                  "es": "Sistemas de actuación y crítica para animaciones de personajes",
                  "de": "Schauspiel- und Kritiksysteme für Charakteranimationen",
                  "nl": "Acteren en kritiek systemen voor karakteranimaties"
        },
        {
                  "en": "AI that acts as both player and critic of games",
                  "es": "IA que actúa como jugador y crítico de juegos",
                  "de": "KI die sowohl als Spieler als auch als Kritiker von Spielen agiert",
                  "nl": "AI die zowel als speler als criticus van games optreedt"
        },
        {
                  "en": "Critics that review AI actor performances",
                  "es": "Críticos que revisan actuaciones de actores IA",
                  "de": "Kritiker die KI-Schauspielerleistungen bewerten",
                  "nl": "Critici die AI-acteursprestaties beoordelen"
        },
        {
                  "en": "Combining policy-based and value-based learning with separate actor and critic networks",
                  "es": "Combinar aprendizaje basado en política y basado en valor con redes actor y crítico separadas",
                  "de": "Kombination von politikbasiertem und wertbasiertem Lernen mit separaten Actor- und Critic-Netzwerken",
                  "nl": "Combineren van beleidsgebaseerd en waardegebaseerd leren met aparte actor- en criticus-netwerken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Storing and randomly sampling past experiences to improve learning stability",
                  "es": "Almacenar y muestrear aleatoriamente experiencias pasadas para mejorar estabilidad del aprendizaje",
                  "de": "Speichern und zufälliges Sampeln vergangener Erfahrungen zur Verbesserung der Lernstabilität",
                  "nl": "Opslaan en willekeurig bemonsteren van vorige ervaringen om leerstabiliteit te verbeteren"
        },
        {
                  "en": "Replaying game experiences for players to watch",
                  "es": "Reproducir experiencias de juego para que los jugadores vean",
                  "de": "Spielerfahrungen für Spieler zum Anschauen wiedergeben",
                  "nl": "Spelervaringen afspelen voor spelers om te bekijken"
        },
        {
                  "en": "Experiencing the same game scenarios repeatedly",
                  "es": "Experimentar los mismos escenarios de juego repetidamente",
                  "de": "Dieselben Spielszenarien wiederholt erleben",
                  "nl": "Dezelfde spelscenario's herhaaldelijk ervaren"
        },
        {
                  "en": "Recording gameplay for AI training purposes",
                  "es": "Grabar jugabilidad para propósitos de entrenamiento IA",
                  "de": "Gameplay für KI-Trainingszwecke aufzeichnen",
                  "nl": "Gameplay opnemen voor AI-trainingsdoeleinden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning temporal sequences in game events",
                  "es": "Aprender secuencias temporales en eventos de juego",
                  "de": "Zeitliche Sequenzen in Spielereignissen lernen",
                  "nl": "Temporele sequenties in spelevenementen leren"
        },
        {
                  "en": "Learning differences between game time zones",
                  "es": "Aprender diferencias entre zonas horarias del juego",
                  "de": "Unterschiede zwischen Spiel-Zeitzonen lernen",
                  "nl": "Verschillen tussen speltijdzones leren"
        },
        {
                  "en": "Time-based difficulty learning systems",
                  "es": "Sistemas de aprendizaje de dificultad basados en tiempo",
                  "de": "Zeitbasierte Schwierigkeits-Lernsysteme",
                  "nl": "Op tijd gebaseerde moeilijkheidsleersystemen"
        },
        {
                  "en": "Learning from the difference between predicted and actual rewards over time",
                  "es": "Aprender de la diferencia entre recompensas predichas y reales a lo largo del tiempo",
                  "de": "Lernen aus der Differenz zwischen vorhergesagten und tatsächlichen Belohnungen über die Zeit",
                  "nl": "Leren van het verschil tussen voorspelde en werkelijke beloningen over tijd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Balancing exploration and exploitation when choosing between multiple options with unknown rewards",
                  "es": "Equilibrar exploración y explotación al elegir entre múltiples opciones con recompensas desconocidas",
                  "de": "Ausbalancierung von Exploration und Exploitation bei der Wahl zwischen mehreren Optionen mit unbekannten Belohnungen",
                  "nl": "Balanceren van verkenning en exploitatie bij het kiezen tussen meerdere opties met onbekende beloningen"
        },
        {
                  "en": "Problems with multiple AI arms in robotic games",
                  "es": "Problemas con múltiples brazos IA en juegos robóticos",
                  "de": "Probleme mit mehreren KI-Armen in Roboterspielen",
                  "nl": "Problemen met meerdere AI-armen in robotspellen"
        },
        {
                  "en": "AI bandits that steal from multiple players",
                  "es": "Bandidos IA que roban a múltiples jugadores",
                  "de": "KI-Banditen die von mehreren Spielern stehlen",
                  "nl": "AI-bandieten die van meerdere spelers stelen"
        },
        {
                  "en": "Multi-player bandit characters in games",
                  "es": "Personajes bandidos multijugador en juegos",
                  "de": "Mehrspielerbanditen-Charaktere in Spielen",
                  "nl": "Multiplayer bandiet karakters in games"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning to imitate game sound effects",
                  "es": "Aprender a imitar efectos de sonido del juego",
                  "de": "Lernen Spielsoundeffekte nachzuahmen",
                  "nl": "Leren om spelgeluidseffecten na te bootsen"
        },
        {
                  "en": "Training AI by observing and copying expert human or AI demonstrations",
                  "es": "Entrenar IA observando y copiando demostraciones expertas humanas o de IA",
                  "de": "KI-Training durch Beobachtung und Nachahmung von Experten-Demonstrationen von Menschen oder KI",
                  "nl": "AI trainen door het observeren en kopiëren van expert menselijke of AI demonstraties"
        },
        {
                  "en": "AI that imitates player emotions only",
                  "es": "IA que imita solo emociones del jugador",
                  "de": "KI die nur Spieleremotionen nachahmt",
                  "nl": "AI die alleen speleremotionaties imiteert"
        },
        {
                  "en": "Creating AI that mimics visual styles",
                  "es": "Crear IA que imita estilos visuales",
                  "de": "KI erstellen die visuelle Stile nachahmt",
                  "nl": "AI creëren die visuele stijlen nabootst"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI that explores environments by seeking novel or surprising experiences",
                  "es": "IA que explora entornos buscando experiencias novedosas o sorprendentes",
                  "de": "KI die Umgebungen durch Suche nach neuartigen oder überraschenden Erfahrungen erkundet",
                  "nl": "AI die omgevingen verkent door het zoeken naar nieuwe of verrassende ervaringen"
        },
        {
                  "en": "AI that explores only when prompted by curiosity mechanics",
                  "es": "IA que explora solo cuando es provocada por mecánicas de curiosidad",
                  "de": "KI die nur erkundet wenn von Neugier-Mechaniken angeregt",
                  "nl": "AI die alleen verkent wanneer aangezet door nieuwsgierigheidsmechanica"
        },
        {
                  "en": "Learning systems that are curious about game lore",
                  "es": "Sistemas de aprendizaje curiosos sobre la tradición del juego",
                  "de": "Lernsysteme die neugierig auf Spielhintergrund sind",
                  "nl": "Leersystemen die nieuwsgierig zijn naar spelgeschiedenis"
        },
        {
                  "en": "AI that asks questions to human players",
                  "es": "IA que hace preguntas a jugadores humanos",
                  "de": "KI die Fragen an menschliche Spieler stellt",
                  "nl": "AI die vragen stelt aan menselijke spelers"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning reinforcement schedules for different games",
                  "es": "Aprender horarios de refuerzo para diferentes juegos",
                  "de": "Verstärkungspläne für verschiedene Spiele lernen",
                  "nl": "Versterkingsschema's leren voor verschillende spellen"
        },
        {
                  "en": "Reinforcement learning for meta-gaming strategies",
                  "es": "Aprendizaje por refuerzo para estrategias meta-gaming",
                  "de": "Verstärkungslernen für Meta-Gaming-Strategien",
                  "nl": "Reinforcement learning voor meta-gaming strategieën"
        },
        {
                  "en": "Learning about game metadata and statistics",
                  "es": "Aprender sobre metadatos y estadísticas del juego",
                  "de": "Über Spiel-Metadaten und Statistiken lernen",
                  "nl": "Leren over spelmetadata en statistieken"
        },
        {
                  "en": "Learning to quickly adapt to new tasks by learning how to learn efficiently",
                  "es": "Aprender a adaptarse rápidamente a nuevas tareas aprendiendo cómo aprender eficientemente",
                  "de": "Lernen sich schnell an neue Aufgaben anzupassen durch Lernen wie man effizient lernt",
                  "nl": "Leren om snel aan te passen aan nieuwe taken door te leren hoe efficiënt te leren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning distributed gaming networks",
                  "es": "Aprender redes de juego distribuidas",
                  "de": "Verteilte Gaming-Netzwerke lernen",
                  "nl": "Gedistribueerde gaming netwerken leren"
        },
        {
                  "en": "Learning the full distribution of rewards rather than just expected values",
                  "es": "Aprender la distribución completa de recompensas en lugar de solo valores esperados",
                  "de": "Lernen der vollständigen Verteilung von Belohnungen anstatt nur erwarteter Werte",
                  "nl": "Leren van de volledige verdeling van beloningen in plaats van alleen verwachte waarden"
        },
        {
                  "en": "Distributing learning across multiple AI agents",
                  "es": "Distribuir aprendizaje a través de múltiples agentes IA",
                  "de": "Lernen über mehrere KI-Agenten verteilen",
                  "nl": "Leren verdelen over meerdere AI-agenten"
        },
        {
                  "en": "Reinforcement learning for game distribution platforms",
                  "es": "Aprendizaje por refuerzo para plataformas de distribución de juegos",
                  "de": "Verstärkungslernen für Spiel-Distributionsplattformen",
                  "nl": "Reinforcement learning voor speldistributieplatforms"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating hierarchical difficulty levels in games",
                  "es": "Crear niveles de dificultad jerárquicos en juegos",
                  "de": "Hierarchische Schwierigkeitsstufen in Spielen erstellen",
                  "nl": "Hiërarchische moeilijkheidsniveaus creëren in games"
        },
        {
                  "en": "Hierarchical organization of game AI teams",
                  "es": "Organización jerárquica de equipos de IA de juego",
                  "de": "Hierarchische Organisation von Spiele-KI-Teams",
                  "nl": "Hiërarchische organisatie van game AI teams"
        },
        {
                  "en": "Breaking complex tasks into hierarchical sub-goals and primitive actions",
                  "es": "Dividir tareas complejas en sub-objetivos jerárquicos y acciones primitivas",
                  "de": "Aufbrechen komplexer Aufgaben in hierarchische Unterziele und primitive Aktionen",
                  "nl": "Complexe taken opdelen in hiërarchische subdoelen en primitieve acties"
        },
        {
                  "en": "Learning game hierarchies and ranking systems",
                  "es": "Aprender jerarquías de juego y sistemas de clasificación",
                  "de": "Spiel-Hierarchien und Ranking-Systeme lernen",
                  "nl": "Spelhiërarchieën en rangsystemen leren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Applying knowledge learned in one game domain to improve performance in related games",
                  "es": "Aplicar conocimiento aprendido en un dominio de juego para mejorar rendimiento en juegos relacionados",
                  "de": "Anwendung von in einem Spielbereich gelerntem Wissen zur Leistungsverbesserung in verwandten Spielen",
                  "nl": "Kennis geleerd in één speldomein toepassen om prestaties in gerelateerde games te verbeteren"
        },
        {
                  "en": "Transferring AI models to different hardware",
                  "es": "Transferir modelos IA a diferente hardware",
                  "de": "KI-Modelle auf verschiedene Hardware übertragen",
                  "nl": "AI-modellen overdragen naar verschillende hardware"
        },
        {
                  "en": "Transferring game files between different platforms",
                  "es": "Transferir archivos de juego entre diferentes plataformas",
                  "de": "Übertragung von Spieldateien zwischen verschiedenen Plattformen",
                  "nl": "Spelbestanden overdragen tussen verschillende platforms"
        },
        {
                  "en": "Learning how to transfer items between players",
                  "es": "Aprender cómo transferir objetos entre jugadores",
                  "de": "Lernen wie man Gegenstände zwischen Spielern überträgt",
                  "nl": "Leren hoe items tussen spelers over te dragen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI that only plays single-player games",
                  "es": "IA que solo juega juegos de un jugador",
                  "de": "KI die nur Einzelspielerspiele spielt",
                  "nl": "AI die alleen single-player games speelt"
        },
        {
                  "en": "Playing games alone without human interaction",
                  "es": "Jugar juegos solo sin interacción humana",
                  "de": "Spiele allein ohne menschliche Interaktion spielen",
                  "nl": "Games alleen spelen zonder menselijke interactie"
        },
        {
                  "en": "Self-directed learning for game mechanics",
                  "es": "Aprendizaje autodirigido para mecánicas de juego",
                  "de": "Selbstgesteuertes Lernen für Spielmechaniken",
                  "nl": "Zelfgestuurd leren voor spelmechanica"
        },
        {
                  "en": "AI training by playing against copies or versions of itself to improve performance",
                  "es": "Entrenamiento IA jugando contra copias o versiones de sí misma para mejorar rendimiento",
                  "de": "KI-Training durch Spielen gegen Kopien oder Versionen von sich selbst zur Leistungsverbesserung",
                  "nl": "AI-training door tegen kopieën of versies van zichzelf te spelen om prestaties te verbeteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating large populations of NPCs in games",
                  "es": "Crear grandes poblaciones de NPCs en juegos",
                  "de": "Große Populationen von NPCs in Spielen erstellen",
                  "nl": "Grote populaties van NPCs creëren in games"
        },
        {
                  "en": "Training AI on population demographics data",
                  "es": "Entrenar IA en datos demográficos de población",
                  "de": "KI mit Bevölkerungsdemografiedaten trainieren",
                  "nl": "AI trainen op bevolkingsdemografische data"
        },
        {
                  "en": "Training multiple AI agents simultaneously with different hyperparameters and strategies",
                  "es": "Entrenar múltiples agentes IA simultáneamente con diferentes hiperparámetros y estrategias",
                  "de": "Training mehrerer KI-Agenten gleichzeitig mit verschiedenen Hyperparametern und Strategien",
                  "nl": "Meerdere AI-agenten gelijktijdig trainen met verschillende hyperparameters en strategieën"
        },
        {
                  "en": "Training based on player population sizes",
                  "es": "Entrenamiento basado en tamaños de población de jugadores",
                  "de": "Training basierend auf Spielerpopulationsgrößen",
                  "nl": "Training gebaseerd op spelerpopulatiegrootte"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating sample game demos efficiently",
                  "es": "Crear demos de juego de muestra eficientemente",
                  "de": "Effiziente Erstellung von Spiel-Demo-Mustern",
                  "nl": "Efficiënt sample game demo's creëren"
        },
        {
                  "en": "Efficient product sampling for game testing",
                  "es": "Muestreo eficiente de productos para pruebas de juegos",
                  "de": "Effiziente Produktprobenahme für Spieltests",
                  "nl": "Efficiënte productsampling voor game testen"
        },
        {
                  "en": "Minimizing gameplay experiences needed to achieve competent performance",
                  "es": "Minimizar experiencias de juego necesarias para lograr rendimiento competente",
                  "de": "Minimierung von Gameplay-Erfahrungen die für kompetente Leistung benötigt werden",
                  "nl": "Minimaliseren van gameplay ervaringen nodig om competente prestaties te bereiken"
        },
        {
                  "en": "Sampling audio efficiently in games",
                  "es": "Muestrear audio eficientemente en juegos",
                  "de": "Effizientes Audio-Sampling in Spielen",
                  "nl": "Efficiënt audio samplen in games"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training single AI to perform multiple different game tasks simultaneously",
                  "es": "Entrenar IA única para realizar múltiples tareas de juego diferentes simultáneamente",
                  "de": "Training einer einzelnen KI um mehrere verschiedene Spielaufgaben gleichzeitig durchzuführen",
                  "nl": "Enkele AI trainen om meerdere verschillende game taken tegelijkertijd uit te voeren"
        },
        {
                  "en": "Multiple AI doing separate tasks",
                  "es": "Múltiples IA haciendo tareas separadas",
                  "de": "Mehrere KI führen separate Aufgaben aus",
                  "nl": "Meerdere AI die afzonderlijke taken doen"
        },
        {
                  "en": "Player multitasking skills",
                  "es": "Habilidades de multitarea del jugador",
                  "de": "Spieler-Multitasking-Fähigkeiten",
                  "nl": "Speler multitasking vaardigheden"
        },
        {
                  "en": "Task management for development teams",
                  "es": "Gestión de tareas para equipos de desarrollo",
                  "de": "Aufgabenverwaltung für Entwicklungsteams",
                  "nl": "Taakbeheer voor ontwikkelteams"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning without internet connection",
                  "es": "Aprender sin conexión a internet",
                  "de": "Lernen ohne Internetverbindung",
                  "nl": "Leren zonder internetverbinding"
        },
        {
                  "en": "Single-player offline game modes",
                  "es": "Modos de juego fuera de línea de un jugador",
                  "de": "Einzelspieler-Offline-Spielmodi",
                  "nl": "Single-player offline game modes"
        },
        {
                  "en": "Training AI when game servers are offline",
                  "es": "Entrenar IA cuando servidores de juego están fuera de línea",
                  "de": "KI-Training wenn Spielserver offline sind",
                  "nl": "AI trainen wanneer game servers offline zijn"
        },
        {
                  "en": "Learning from pre-collected gameplay data without active environment interaction",
                  "es": "Aprender de datos de juego pre-recopilados sin interacción activa con el entorno",
                  "de": "Lernen aus vorgesammelten Gameplay-Daten ohne aktive Umgebungsinteraktion",
                  "nl": "Leren van vooraf verzamelde gameplay data zonder actieve omgevingsinteractie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Few rewards available to collect",
                  "es": "Pocas recompensas disponibles para recoger",
                  "de": "Wenige verfügbare Belohnungen zum Sammeln",
                  "nl": "Weinig beloningen beschikbaar om te verzamelen"
        },
        {
                  "en": "Difficulty learning when rewards occur infrequently in long gameplay sequences",
                  "es": "Dificultad de aprendizaje cuando recompensas ocurren infrecuentemente en secuencias largas de juego",
                  "de": "Lernschwierigkeit wenn Belohnungen selten in langen Gameplay-Sequenzen auftreten",
                  "nl": "Leermoeilijkheid wanneer beloningen zelden voorkomen in lange gameplay sequenties"
        },
        {
                  "en": "Sparse distribution of power-ups",
                  "es": "Distribución escasa de power-ups",
                  "de": "Spärliche Verteilung von Power-Ups",
                  "nl": "Schaarse verspreiding van power-ups"
        },
        {
                  "en": "Low reward values in games",
                  "es": "Valores de recompensa bajos en juegos",
                  "de": "Niedrige Belohnungswerte in Spielen",
                  "nl": "Lage beloningswaarden in games"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Managing in-game currency credits",
                  "es": "Gestionar créditos de moneda dentro del juego",
                  "de": "Verwaltung von In-Game-Währungskrediten",
                  "nl": "In-game valuta credits beheren"
        },
        {
                  "en": "Determining which past actions contributed to eventual success or failure",
                  "es": "Determinar qué acciones pasadas contribuyeron al eventual éxito o fracaso",
                  "de": "Bestimmung welche vergangenen Aktionen zu eventuellem Erfolg oder Misserfolg beigetragen haben",
                  "nl": "Bepalen welke eerdere acties bijdroegen aan eventueel succes of falen"
        },
        {
                  "en": "Crediting developers for AI work",
                  "es": "Acreditar desarrolladores por trabajo de IA",
                  "de": "Entwickler für KI-Arbeit akkreditieren",
                  "nl": "Ontwikkelaars crediteren voor AI-werk"
        },
        {
                  "en": "Assigning credit points to players",
                  "es": "Asignar puntos de crédito a jugadores",
                  "de": "Zuweisung von Kreditpunkten an Spieler",
                  "nl": "Creditpunten toewijzen aan spelers"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Forgetting to save training progress",
                  "es": "Olvidar guardar progreso de entrenamiento",
                  "de": "Vergessen Trainingsfortschritt zu speichern",
                  "nl": "Vergeten trainingsvoortgang op te slaan"
        },
        {
                  "en": "AI forgetting game rules catastrophically",
                  "es": "IA olvidando reglas del juego catastróficamente",
                  "de": "KI vergisst Spielregeln katastrophal",
                  "nl": "AI vergeet spelregels catastrofaal"
        },
        {
                  "en": "Loss of previously learned skills when training on new tasks",
                  "es": "Pérdida de habilidades previamente aprendidas al entrenar en nuevas tareas",
                  "de": "Verlust zuvor gelernter Fähigkeiten beim Training auf neuen Aufgaben",
                  "nl": "Verlies van eerder geleerde vaardigheden bij training op nieuwe taken"
        },
        {
                  "en": "Complete memory wipe of AI",
                  "es": "Borrado completo de memoria de IA",
                  "de": "Komplette Speicherlöschung von KI",
                  "nl": "Volledige geheugenwissing van AI"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Transferring AI from simple to realistic graphics",
                  "es": "Transferir IA de gráficos simples a realistas",
                  "de": "Transfer von KI von einfacher zu realistischer Grafik",
                  "nl": "AI overdragen van eenvoudige naar realistische graphics"
        },
        {
                  "en": "Applying AI trained in simulation to real robotics using game engine techniques",
                  "es": "Aplicar IA entrenada en simulación a robótica real usando técnicas de motor de juego",
                  "de": "Anwendung von in Simulation trainierter KI auf echte Robotik mittels Game-Engine-Techniken",
                  "nl": "AI getraind in simulatie toepassen op echte robotica met game engine technieken"
        },
        {
                  "en": "Converting simulation games to real sports",
                  "es": "Convertir juegos de simulación a deportes reales",
                  "de": "Konvertierung von Simulationsspielen zu echten Sportarten",
                  "nl": "Simulatiespellen converteren naar echte sporten"
        },
        {
                  "en": "Real-time game simulation transfer",
                  "es": "Transferencia de simulación de juego en tiempo real",
                  "de": "Echtzeit-Spielsimulations-Transfer",
                  "nl": "Real-time game simulatie transfer"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning how to learn new tasks quickly from minimal experience",
                  "es": "Aprender cómo aprender nuevas tareas rápidamente con experiencia mínima",
                  "de": "Lernen wie man neue Aufgaben schnell aus minimaler Erfahrung lernt",
                  "nl": "Leren hoe nieuwe taken snel te leren van minimale ervaring"
        },
        {
                  "en": "Reinforcing meta-data structures",
                  "es": "Reforzar estructuras de metadatos",
                  "de": "Verstärkung von Metadaten-Strukturen",
                  "nl": "Versterken van metadata structuren"
        },
        {
                  "en": "Meta-gaming strategy learning",
                  "es": "Aprendizaje de estrategia meta-gaming",
                  "de": "Meta-Gaming-Strategie-Lernen",
                  "nl": "Meta-gaming strategie leren"
        },
        {
                  "en": "Learning game metadata patterns",
                  "es": "Aprender patrones de metadatos de juego",
                  "de": "Lernen von Spiel-Metadaten-Mustern",
                  "nl": "Game metadata patronen leren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Multiple difficulty options",
                  "es": "Múltiples opciones de dificultad",
                  "de": "Mehrere Schwierigkeitsoptionen",
                  "nl": "Meerdere moeilijkheidsopties"
        },
        {
                  "en": "Player choice options in RPGs",
                  "es": "Opciones de elección del jugador en RPGs",
                  "de": "Spielerwahloptionen in RPGs",
                  "nl": "Speler keuze opties in RPGs"
        },
        {
                  "en": "Game settings configuration framework",
                  "es": "Marco de configuración de ajustes del juego",
                  "de": "Spieleinstellungs-Konfigurations-Framework",
                  "nl": "Game instellingen configuratie framework"
        },
        {
                  "en": "Temporal abstractions representing reusable multi-step behaviors",
                  "es": "Abstracciones temporales representando comportamientos reutilizables multi-paso",
                  "de": "Zeitliche Abstraktionen die wiederverwendbare Multi-Step-Verhaltensweisen repräsentieren",
                  "nl": "Temporele abstracties die herbruikbare multi-step gedragingen representeren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combining learned sub-skills to execute complex multi-stage strategies",
                  "es": "Combinar sub-habilidades aprendidas para ejecutar estrategias complejas multi-etapa",
                  "de": "Kombination gelernter Teil-Fähigkeiten um komplexe mehrstufige Strategien auszuführen",
                  "nl": "Combineren van geleerde sub-vaardigheden om complexe multi-fase strategieën uit te voeren"
        },
        {
                  "en": "Chaining combo attacks in fighting games",
                  "es": "Encadenar ataques combo en juegos de lucha",
                  "de": "Verkettung von Combo-Angriffen in Kampfspielen",
                  "nl": "Combo aanvallen koppelen in vechtgames"
        },
        {
                  "en": "Blockchain for skill verification",
                  "es": "Blockchain para verificación de habilidades",
                  "de": "Blockchain für Fähigkeitsverifizierung",
                  "nl": "Blockchain voor vaardigheidsverificatie"
        },
        {
                  "en": "Player skill progression chains",
                  "es": "Cadenas de progresión de habilidades del jugador",
                  "de": "Spieler-Fähigkeits-Progressions-Ketten",
                  "nl": "Speler vaardigheidsprogressie ketens"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Watching player behavior analytics",
                  "es": "Ver analíticas de comportamiento del jugador",
                  "de": "Beobachtung von Spielerverhalten-Analysen",
                  "nl": "Spelergedrag analytics bekijken"
        },
        {
                  "en": "Learning by watching demonstrations without access to demonstrator's actions",
                  "es": "Aprender observando demostraciones sin acceso a acciones del demostrador",
                  "de": "Lernen durch Beobachtung von Demonstrationen ohne Zugang zu Aktionen des Demonstrators",
                  "nl": "Leren door demonstraties te bekijken zonder toegang tot acties van demonstrator"
        },
        {
                  "en": "Spectator mode observation",
                  "es": "Observación en modo espectador",
                  "de": "Beobachtung im Zuschauermodus",
                  "nl": "Toeschouwer modus observatie"
        },
        {
                  "en": "Observing game graphics quality",
                  "es": "Observar calidad gráfica del juego",
                  "de": "Beobachtung von Spiel-Grafikqualität",
                  "nl": "Observeren van game graphics kwaliteit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reversing game physics dynamics",
                  "es": "Invertir dinámicas de física del juego",
                  "de": "Umkehrung von Spiel-Physik-Dynamiken",
                  "nl": "Omkeren van game fysica dynamiek"
        },
        {
                  "en": "Inverse kinematics for character animation",
                  "es": "Cinemática inversa para animación de personajes",
                  "de": "Inverse Kinematik für Charakteranimation",
                  "nl": "Inverse kinematica voor karakter animatie"
        },
        {
                  "en": "Backward time dynamics",
                  "es": "Dinámicas de tiempo hacia atrás",
                  "de": "Rückwärts-Zeit-Dynamiken",
                  "nl": "Achterwaartse tijd dynamiek"
        },
        {
                  "en": "Inferring actions needed to transition between observed states",
                  "es": "Inferir acciones necesarias para transicionar entre estados observados",
                  "de": "Ableitung von Aktionen die für Übergänge zwischen beobachteten Zuständen benötigt werden",
                  "nl": "Afleiden van acties nodig om tussen geobserveerde states over te gaan"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using discriminator networks to match expert behavior distributions",
                  "es": "Usar redes discriminadoras para igualar distribuciones de comportamiento experto",
                  "de": "Verwendung von Diskriminator-Netzwerken um Experten-Verhaltensverteilungen anzugleichen",
                  "nl": "Gebruik van discriminator netwerken om expert gedragsverdelingen te matchen"
        },
        {
                  "en": "Competitive imitation between AI",
                  "es": "Imitación competitiva entre IA",
                  "de": "Wettbewerbs-Nachahmung zwischen KI",
                  "nl": "Competitieve imitatie tussen AI"
        },
        {
                  "en": "Learning to imitate adversarial players only",
                  "es": "Aprender a imitar solo jugadores adversarios",
                  "de": "Lernen nur adversariale Spieler nachzuahmen",
                  "nl": "Leren alleen vijandelijke spelers na te bootsen"
        },
        {
                  "en": "Imitating adversarial attacks",
                  "es": "Imitar ataques adversarios",
                  "de": "Nachahmung adversarialer Angriffe",
                  "nl": "Nadoen van vijandelijke aanvallen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Perfect cloning of any behavior",
                  "es": "Clonación perfecta de cualquier comportamiento",
                  "de": "Perfektes Klonen jedes Verhaltens",
                  "nl": "Perfecte cloning van elk gedrag"
        },
        {
                  "en": "Cloning AI source code",
                  "es": "Clonar código fuente de IA",
                  "de": "Klonen von KI-Quellcode",
                  "nl": "Clonen van AI broncode"
        },
        {
                  "en": "Learning from sub-optimal human gameplay while filtering noise and errors",
                  "es": "Aprender de juego humano subóptimo mientras filtra ruido y errores",
                  "de": "Lernen aus suboptimalem menschlichem Gameplay während Rauschen und Fehler gefiltert werden",
                  "nl": "Leren van sub-optimaal menselijk gameplay terwijl ruis en fouten gefilterd worden"
        },
        {
                  "en": "Only using perfect expert demonstrations",
                  "es": "Usar solo demostraciones expertas perfectas",
                  "de": "Nur perfekte Experten-Demonstrationen verwenden",
                  "nl": "Alleen perfecte expert demonstraties gebruiken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Safe data storage during exploration",
                  "es": "Almacenamiento seguro de datos durante exploración",
                  "de": "Sichere Datenspeicherung während Erkundung",
                  "nl": "Veilige data opslag tijdens exploratie"
        },
        {
                  "en": "Exploring only safe game zones",
                  "es": "Explorar solo zonas seguras del juego",
                  "de": "Nur sichere Spielzonen erkunden",
                  "nl": "Alleen veilige game zones verkennen"
        },
        {
                  "en": "Constraining exploration to avoid catastrophic failures during learning",
                  "es": "Restringir exploración para evitar fallos catastróficos durante aprendizaje",
                  "de": "Einschränkung der Erkundung um katastrophale Ausfälle während des Lernens zu vermeiden",
                  "nl": "Exploratie beperken om catastrofale mislukkingen tijdens leren te vermijden"
        },
        {
                  "en": "Player safety features in games",
                  "es": "Características de seguridad del jugador en juegos",
                  "de": "Spielersicherheits-Funktionen in Spielen",
                  "nl": "Speler veiligheidsfeatures in games"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Player training schedule management",
                  "es": "Gestión de programación de entrenamiento de jugador",
                  "de": "Spieler-Trainingsplan-Verwaltung",
                  "nl": "Speler trainingsschema beheer"
        },
        {
                  "en": "Academic curriculum for AI courses",
                  "es": "Currículo académico para cursos de IA",
                  "de": "Akademischer Lehrplan für KI-Kurse",
                  "nl": "Academisch curriculum voor AI cursussen"
        },
        {
                  "en": "Scheduling game development curriculum",
                  "es": "Programar currículo de desarrollo de juegos",
                  "de": "Planung von Spielentwicklungs-Lehrplan",
                  "nl": "Plannen van game ontwikkelings curriculum"
        },
        {
                  "en": "Automatically sequencing training tasks from simple to complex",
                  "es": "Secuenciar automáticamente tareas de entrenamiento de simples a complejas",
                  "de": "Automatisches Sequenzieren von Trainingsaufgaben von einfach zu komplex",
                  "nl": "Automatisch sequentiëren van trainingsstaken van eenvoudig naar complex"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Updating value estimates using other learned estimates rather than final returns",
                  "es": "Actualizar estimaciones de valor usando otras estimaciones aprendidas en lugar de retornos finales",
                  "de": "Aktualisierung von Wertschätzungen unter Verwendung anderer gelernter Schätzungen anstatt finaler Rückgaben",
                  "nl": "Waarde ramingen bijwerken met andere geleerde schattingen in plaats van finale opbrengsten"
        },
        {
                  "en": "Starting AI training from scratch",
                  "es": "Comenzar entrenamiento IA desde cero",
                  "de": "KI-Training von Grund auf beginnen",
                  "nl": "AI-training vanaf nul beginnen"
        },
        {
                  "en": "Boot sequence for game AI systems",
                  "es": "Secuencia de arranque para sistemas de IA de juego",
                  "de": "Boot-Sequenz für Spiele-KI-Systeme",
                  "nl": "Boot sequentie voor game AI systemen"
        },
        {
                  "en": "Self-starting game initialization",
                  "es": "Inicialización de juego auto-iniciante",
                  "de": "Selbststartende Spiel-Initialisierung",
                  "nl": "Zelfstartende game initialisatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Offline policy documentation updates",
                  "es": "Actualizaciones de documentación de política fuera de línea",
                  "de": "Offline-Policy-Dokumentations-Updates",
                  "nl": "Offline beleidsdocumentatie updates"
        },
        {
                  "en": "Adjusting learning when training data comes from different policy than being learned",
                  "es": "Ajustar aprendizaje cuando datos de entrenamiento vienen de política diferente a la que se aprende",
                  "de": "Anpassung des Lernens wenn Trainingsdaten von anderer Richtlinie stammen als gelernt wird",
                  "nl": "Leren aanpassen wanneer trainingsdata van andere policy komt dan geleerd wordt"
        },
        {
                  "en": "Political correction in game narratives",
                  "es": "Corrección política en narrativas de juego",
                  "de": "Politische Korrektur in Spielnarrativen",
                  "nl": "Politieke correctie in game verhalen"
        },
        {
                  "en": "Correcting policy errors in game rules",
                  "es": "Corregir errores de política en reglas del juego",
                  "de": "Korrektur von Policy-Fehlern in Spielregeln",
                  "nl": "Beleidsfouten corrigeren in spelregels"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trace debugging for eligible code",
                  "es": "Depuración de rastreo para código elegible",
                  "de": "Trace-Debugging für berechtigten Code",
                  "nl": "Trace debugging voor geschikt code"
        },
        {
                  "en": "Eligibility for accessing game features",
                  "es": "Elegibilidad para acceder características del juego",
                  "de": "Berechtigung für Zugriff auf Spielfunktionen",
                  "nl": "Geschiktheid voor toegang tot game functies"
        },
        {
                  "en": "Tracing eligible players for matchmaking",
                  "es": "Rastrear jugadores elegibles para emparejamiento",
                  "de": "Verfolgung berechtigter Spieler für Matchmaking",
                  "nl": "Traceren van geschikte spelers voor matchmaking"
        },
        {
                  "en": "Tracking which states/actions are eligible for credit assignment updates",
                  "es": "Rastrear qué estados/acciones son elegibles para actualizaciones de asignación de crédito",
                  "de": "Verfolgung welche Zustände/Aktionen für Credit-Assignment-Updates berechtigt sind",
                  "nl": "Bijhouden welke states/acties in aanmerking komen voor credit assignment updates"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Making game actions more discrete visually",
                  "es": "Hacer acciones del juego más discretas visualmente",
                  "de": "Spielaktionen visuell diskreter machen",
                  "nl": "Game acties visueel discreter maken"
        },
        {
                  "en": "Converting continuous action ranges into finite discrete action choices",
                  "es": "Convertir rangos de acción continua en opciones de acción discretas finitas",
                  "de": "Konvertierung kontinuierlicher Aktionsbereiche in endliche diskrete Aktionswahlmöglichkeiten",
                  "nl": "Continue actiereeksen omzetten in eindige discrete actiekeuzes"
        },
        {
                  "en": "Privacy discretization for actions",
                  "es": "Discretización de privacidad para acciones",
                  "de": "Privatsphären-Diskretisierung für Aktionen",
                  "nl": "Privacy discretisatie voor acties"
        },
        {
                  "en": "Separating action types into categories",
                  "es": "Separar tipos de acción en categorías",
                  "de": "Trennung von Aktionstypen in Kategorien",
                  "nl": "Actietypes scheiden in categorieën"
        }
        ],
        correct: 1,
        explanation: {
