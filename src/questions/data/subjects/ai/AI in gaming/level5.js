  ...
  const level5 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Stable policy gradient method preventing destructive updates during learning", es: "Método de gradiente de política estable que previene actualizaciones destructivas durante aprendizaje", de: "Stabiles Policy-Gradient-Verfahren verhindert destruktive Updates während des Lernens", nl: "Stabiele policy gradient methode voorkomt destructieve updates tijdens leren" },
          { en: "Optimizing AI proximity to players", es: "Optimizar proximidad de IA a jugadores", de: "Optimierung der KI-Nähe zu Spielern", nl: "Optimaliseren van AI nabijheid tot spelers" },
          { en: "Policy for optimal server proximity", es: "Política para proximidad óptima de servidor", de: "Richtlinie für optimale Server-Nähe", nl: "Beleid voor optimale server nabijheid" },
          { en: "Approximate policy implementation", es: "Implementación de política aproximada", de: "Approximative Policy-Implementierung", nl: "Geschatte beleidsimplementatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Designing intermediate rewards to guide AI toward long-term goals", es: "Diseñar recompensas intermedias para guiar IA hacia objetivos a largo plazo", de: "Entwurf von Zwischenbelohnungen um KI zu langfristigen Zielen zu führen", nl: "Ontwerpen van tussentijdse beloningen om AI naar langetermijndoelen te leiden" },
          { en: "Physically shaping reward icons in games", es: "Dar forma física a íconos de recompensa en juegos", de: "Physisches Formen von Belohnungssymbolen in Spielen", nl: "Fysiek vormgeven van beloningspictogrammen in games" },
          { en: "Shaping player reward expectations", es: "Moldear expectativas de recompensa de jugador", de: "Spieler-Belohnungserwartungen formen", nl: "Speler beloningsverwachtingen vormgeven" },
          { en: "Creating shaped reward objects", es: "Crear objetos de recompensa con forma", de: "Geformte Belohnungsobjekte erstellen", nl: "Gevormde beloningsobjecten creëren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Storing and reusing past game experiences to improve learning efficiency", es: "Almacenar y reutilizar experiencias de juego pasadas para mejorar eficiencia de aprendizaje", de: "Speicherung und Wiederverwendung vergangener Spielerfahrungen zur Verbesserung der Lerneffizienz", nl: "Opslaan en hergebruiken van eerdere game ervaringen om leerefficiëntie te verbeteren" },
          { en: "Replaying game cutscenes for AI", es: "Reproducir escenas del juego para IA", de: "Wiederholung von Spielzwischensequenzen für KI", nl: "Herhalen van game cutscenes voor AI" },
          { en: "Allowing players to replay experiences", es: "Permitir a jugadores repetir experiencias", de: "Spielern ermöglichen Erfahrungen zu wiederholen", nl: "Spelers toestaan ervaringen opnieuw te beleven" },
          { en: "Replaying tutorial experiences", es: "Repetir experiencias de tutorial", de: "Wiederholung von Tutorial-Erfahrungen", nl: "Herhalen van tutorial ervaringen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Model-based learns game dynamics for planning, model-free learns policies directly from experience", es: "Basado en modelo aprende dinámicas del juego para planificar, libre de modelo aprende políticas directamente de experiencia", de: "Modellbasiert lernt Spieldynamik zur Planung, modellfrei lernt Richtlinien direkt aus Erfahrung", nl: "Model-based leert speldynamiek voor planning, model-free leert beleidslijnen direct uit ervaring" },
          { en: "Model-based uses 3D models, model-free uses 2D sprites", es: "Basado en modelo usa modelos 3D, libre de modelo usa sprites 2D", de: "Modellbasiert nutzt 3D-Modelle, modellfrei nutzt 2D-Sprites", nl: "Model-based gebruikt 3D-modellen, model-free gebruikt 2D-sprites" },
          { en: "Model-based follows templates, model-free is creative", es: "Basado en modelo sigue plantillas, libre de modelo es creativo", de: "Modellbasiert folgt Vorlagen, modellfrei ist kreativ", nl: "Model-based volgt sjablonen, model-free is creatief" },
          { en: "Both are identical approaches", es: "Ambos son enfoques idénticos", de: "Beide sind identische Ansätze", nl: "Beide zijn identieke benaderingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Learning from complete game episodes by averaging returns", es: "Aprender de episodios completos de juego promediando retornos", de: "Lernen aus vollständigen Spiel-Episoden durch Mittelwertbildung von Rückgaben", nl: "Leren van complete game episodes door gemiddeldes van opbrengsten" },
          { en: "Learning in Monte Carlo casino simulations", es: "Aprender en simulaciones de casino Monte Carlo", de: "Lernen in Monte Carlo Kasino-Simulationen", nl: "Leren in Monte Carlo casino simulaties" },
          { en: "Random learning without structure", es: "Aprendizaje aleatorio sin estructura", de: "Zufälliges Lernen ohne Struktur", nl: "Willekeurig leren zonder structuur" },
          { en: "Learning from Monte Carlo rally games", es: "Aprender de juegos de rally Monte Carlo", de: "Lernen aus Monte Carlo Rallye-Spielen", nl: "Leren van Monte Carlo rally games" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Learning by bootstrapping from current estimates without waiting for episodes to complete", es: "Aprender mediante bootstrapping de estimaciones actuales sin esperar a que episodios terminen", de: "Lernen durch Bootstrapping aus aktuellen Schätzungen ohne auf Episodenende zu warten", nl: "Leren door bootstrapping van huidige schattingen zonder te wachten tot episodes eindigen" },
          { en: "Learning time differences in gameplay", es: "Aprender diferencias de tiempo en jugabilidad", de: "Zeitunterschiede im Gameplay lernen", nl: "Tijdsverschillen in gameplay leren" },
          { en: "Temporal graphics learning", es: "Aprendizaje de gráficos temporales", de: "Temporales Grafik-Lernen", nl: "Tijdelijke graphics leren" },
          { en: "Different AI at different times", es: "IA diferente en diferentes momentos", de: "Unterschiedliche KI zu unterschiedlichen Zeiten", nl: "Verschillende AI op verschillende tijden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Off-policy learning of optimal action values without requiring environment model", es: "Aprendizaje fuera de política de valores óptimos de acción sin requerir modelo de entorno", de: "Off-Policy-Lernen optimaler Aktionswerte ohne Umgebungsmodell zu benötigen", nl: "Off-policy leren van optimale actiewaarden zonder omgevingsmodel te vereisen" },
          { en: "Queue-based learning systems", es: "Sistemas de aprendizaje basados en cola", de: "Warteschlangenbasierte Lernsysteme", nl: "Wachtrij-gebaseerde leersystemen" },
          { en: "Quality assurance learning", es: "Aprendizaje de aseguramiento de calidad", de: "Qualitätssicherungs-Lernen", nl: "Kwaliteitsborging leren" },
          { en: "Quick learning algorithms", es: "Algoritmos de aprendizaje rápido", de: "Schnelle Lernalgorithmen", nl: "Snelle leeralgoritmen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Reduces overestimation bias by using two separate value estimators", es: "Reduce sesgo de sobreestimación usando dos estimadores de valor separados", de: "Reduziert Überschätzungsbias durch Verwendung zweier separater Wertschätzer", nl: "Vermindert overschattingsbias door twee aparte waardeschattingen te gebruiken" },
          { en: "Doubles the learning speed", es: "Duplica la velocidad de aprendizaje", de: "Verdoppelt die Lerngeschwindigkeit", nl: "Verdubbelt de leersnelheid" },
          { en: "Uses two AI agents simultaneously", es: "Usa dos agentes IA simultáneamente", de: "Verwendet zwei KI-Agenten gleichzeitig", nl: "Gebruikt twee AI-agenten tegelijkertijd" },
          { en: "Double the memory usage", es: "Doble uso de memoria", de: "Doppelte Speichernutzung", nl: "Dubbel geheugengebruik" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Replaying more important experiences more frequently to accelerate learning", es: "Reproducir experiencias más importantes más frecuentemente para acelerar aprendizaje", de: "Häufigeres Wiederholen wichtigerer Erfahrungen zur Beschleunigung des Lernens", nl: "Belangrijkere ervaringen vaker herhalen om leren te versnellen" },
          { en: "Prioritizing new experiences only", es: "Priorizar solo experiencias nuevas", de: "Nur neue Erfahrungen priorisieren", nl: "Alleen nieuwe ervaringen prioriteren" },
          { en: "Replaying experiences in chronological order", es: "Reproducir experiencias en orden cronológico", de: "Erfahrungen in chronologischer Reihenfolge wiederholen", nl: "Ervaringen in chronologische volgorde herhalen" },
          { en: "Priority queue data structure", es: "Estructura de datos de cola de prioridad", de: "Priority-Queue-Datenstruktur", nl: "Prioriteitswachtrij datastructuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Separating state value and action advantage estimation in neural networks", es: "Separar valor de estado y estimación de ventaja de acción en redes neuronales", de: "Trennung von Zustandswert und Aktionsvorteils-Schätzung in neuronalen Netzen", nl: "Scheiden van toestandswaarde en actie voordeel schatting in neurale netwerken" },
          { en: "Two AI networks competing against each other", es: "Dos redes IA compitiendo entre sí", de: "Zwei KI-Netzwerke konkurrieren gegeneinander", nl: "Twee AI-netwerken concurreren tegen elkaar" },
          { en: "Network for dueling game modes", es: "Red para modos de juego de duelo", de: "Netzwerk für Duell-Spielmodi", nl: "Netwerk voor duel game modes" },
          { en: "Dual processor architecture", es: "Arquitectura de procesador dual", de: "Dual-Prozessor-Architektur", nl: "Dual processor architectuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Parallelizing experience collection and learning across multiple actors", es: "Paralelizar recolección de experiencia y aprendizaje a través de múltiples actores", de: "Parallelisierung von Erfahrungssammlung und Lernen über mehrere Akteure", nl: "Parallelliseren van ervaringsverzameling en leren over meerdere actoren" },
          { en: "Distributing AI across game servers", es: "Distribuir IA a través de servidores de juego", de: "Verteilung von KI über Spielserver", nl: "AI verdelen over game servers" },
          { en: "Learning distributed game content", es: "Aprender contenido de juego distribuido", de: "Verteilte Spielinhalte lernen", nl: "Gedistribueerde game content leren" },
          { en: "Distributed player matchmaking", es: "Emparejamiento distribuido de jugadores", de: "Verteiltes Spieler-Matchmaking", nl: "Gedistribueerde speler matchmaking" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Maximizing entropy alongside rewards for robust exploration and stability", es: "Maximizar entropía junto con recompensas para exploración y estabilidad robustas", de: "Maximierung von Entropie neben Belohnungen für robuste Erkundung und Stabilität", nl: "Maximaliseren van entropie naast beloningen voor robuuste exploratie en stabiliteit" },
          { en: "Using soft neural networks", es: "Usar redes neuronales suaves", de: "Verwendung weicher neuronaler Netze", nl: "Gebruik van zachte neurale netwerken" },
          { en: "Gentle critic feedback to actors", es: "Retroalimentación de crítico gentil a actores", de: "Sanftes Kritiker-Feedback an Akteure", nl: "Zachte criticus feedback aan actoren" },
          { en: "Soft difficulty adjustment", es: "Ajuste suave de dificultad", de: "Sanfte Schwierigkeitsanpassung", nl: "Zachte moeilijkheidsaanpassing" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Combining multiple DQN improvements into single powerful algorithm", es: "Combinar múltiples mejoras DQN en algoritmo único poderoso", de: "Kombination mehrerer DQN-Verbesserungen in einem einzigen mächtigen Algorithmus", nl: "Combineren van meerdere DQN-verbeteringen in één krachtig algoritme" },
          { en: "Using rainbow colored graphics for AI", es: "Usar gráficos de colores arcoíris para IA", de: "Verwendung regenbogenfarbiger Grafiken für KI", nl: "Gebruik van regenboog gekleurde graphics voor AI" },
          { en: "Seven different AI algorithms", es: "Siete algoritmos IA diferentes", de: "Sieben verschiedene KI-Algorithmen", nl: "Zeven verschillende AI-algoritmes" },
          { en: "Colorful reward visualization", es: "Visualización colorida de recompensas", de: "Bunte Belohnungsvisualisierung", nl: "Kleurrijke beloningsvisualisatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Internal reward signals encouraging exploration and skill acquisition", es: "Señales de recompensa internas alentando exploración y adquisición de habilidades", de: "Interne Belohnungssignale die Erkundung und Fertigkeitserwerb fördern", nl: "Interne beloningssignalen die exploratie en vaardigheidsverwerving aanmoedigen" },
          { en: "AI motivation by internal game lore", es: "Motivación IA por lore interno del juego", de: "KI-Motivation durch interne Spiel-Lore", nl: "AI-motivatie door interne game lore" },
          { en: "Motivating players intrinsically", es: "Motivar jugadores intrínsecamente", de: "Spieler intrinsisch motivieren", nl: "Spelers intrinsiek motiveren" },
          { en: "Internal processing motivation", es: "Motivación de procesamiento interno", de: "Interne Verarbeitungsmotivation", nl: "Interne verwerkingsmotivatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Training AI with different roles, abilities, or objectives in self-play", es: "Entrenar IA con diferentes roles, habilidades u objetivos en auto-juego", de: "Training von KI mit unterschiedlichen Rollen, Fähigkeiten oder Zielen im Self-Play", nl: "AI trainen met verschillende rollen, vaardigheden of doelstellingen in self-play" },
          { en: "Unbalanced neural network architectures", es: "Arquitecturas de redes neuronales desequilibradas", de: "Unausgewogene neuronale Netzwerk-Architekturen", nl: "Ongebalanceerde neurale netwerk architecturen" },
          { en: "AI playing against weaker versions", es: "IA jugando contra versiones más débiles", de: "KI spielt gegen schwächere Versionen", nl: "AI speelt tegen zwakkere versies" },
          { en: "Asymmetric game maps only", es: "Solo mapas de juego asimétricos", de: "Nur asymmetrische Spielkarten", nl: "Alleen asymmetrische spelkaarten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Evolving population of agents with different hyperparameters simultaneously", es: "Evolucionar población de agentes con diferentes hiperparámetros simultáneamente", de: "Evolution einer Population von Agenten mit unterschiedlichen Hyperparametern gleichzeitig", nl: "Evolueren van populatie agenten met verschillende hyperparameters tegelijkertijd" },
          { en: "Training on population simulation games", es: "Entrenar en juegos de simulación de población", de: "Training auf Bevölkerungssimulationsspielen", nl: "Trainen op bevolkingssimulatie games" },
          { en: "Based on player population size", es: "Basado en tamaño de población de jugadores", de: "Basierend auf Spieler-Populationsgröße", nl: "Gebaseerd op speler populatiegrootte" },
          { en: "Training many players together", es: "Entrenar muchos jugadores juntos", de: "Viele Spieler zusammen trainieren", nl: "Veel spelers samen trainen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Computing optimal strategies for imperfect information games like poker", es: "Calcular estrategias óptimas para juegos de información imperfecta como póker", de: "Berechnung optimaler Strategien für Spiele mit unvollständiger Information wie Poker", nl: "Berekenen van optimale strategieën voor imperfect information games zoals poker" },
          { en: "Minimizing AI regrets about past actions", es: "Minimizar arrepentimientos IA sobre acciones pasadas", de: "Minimierung von KI-Bedauern über vergangene Aktionen", nl: "Minimaliseren van AI-spijt over eerdere acties" },
          { en: "Counterfactual history simulations", es: "Simulaciones de historia contrafactual", de: "Kontrafaktische Geschichtssimulationen", nl: "Contrafeitelijke geschiedenis simulaties" },
          { en: "Regret-based player psychology", es: "Psicología de jugador basada en arrepentimiento", de: "Bedauern-basierte Spieler-Psychologie", nl: "Spijt-gebaseerde spelerpsychologie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Learning to plan without knowing game rules by building learned world model", es: "Aprender a planificar sin conocer reglas del juego construyendo modelo de mundo aprendido", de: "Lernen zu planen ohne Spielregeln zu kennen durch Aufbau eines erlernten Weltmodells", nl: "Leren plannen zonder spelregels te kennen door geleerd wereldmodel te bouwen" },
          { en: "Music-based AI learning", es: "Aprendizaje IA basado en música", de: "Musikbasiertes KI-Lernen", nl: "Muziek-gebaseerd AI-leren" },
          { en: "Zero-knowledge proof systems", es: "Sistemas de prueba de conocimiento cero", de: "Zero-Knowledge-Proof-Systeme", nl: "Zero-knowledge proof systemen" },
          { en: "Starting from zero always", es: "Comenzar desde cero siempre", de: "Immer von null beginnen", nl: "Altijd vanaf nul beginnen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "First AI to achieve human-level performance on all 57 Atari games", es: "Primera IA en lograr rendimiento nivel humano en los 57 juegos Atari", de: "Erste KI die menschliches Niveau auf allen 57 Atari-Spielen erreichte", nl: "Eerste AI die menselijk niveau prestaties behaalde op alle 57 Atari games" },
          { en: "AI agent number 57 in a series", es: "Agente IA número 57 en una serie", de: "KI-Agent Nummer 57 in einer Serie", nl: "AI-agent nummer 57 in een reeks" },
          { en: "57 different AI algorithms combined", es: "57 algoritmos IA diferentes combinados", de: "57 verschiedene KI-Algorithmen kombiniert", nl: "57 verschillende AI-algoritmes gecombineerd" },
          { en: "AI achieving 57% win rate", es: "IA logrando tasa de victoria de 57%", de: "KI erreicht 57% Gewinnrate", nl: "AI bereikt 57% winratio" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Automatically discovering optimal neural network structures for game tasks", es: "Descubrir automáticamente estructuras óptimas de redes neuronales para tareas de juego", de: "Automatisches Entdecken optimaler neuronaler Netzwerkstrukturen für Spielaufgaben", nl: "Automatisch ontdekken van optimale neurale netwerkstructuren voor game taken" },
          { en: "Searching for AI in neural pathways", es: "Buscar IA en vías neuronales", de: "Suche nach KI in neuronalen Pfaden", nl: "Zoeken naar AI in neurale paden" },
          { en: "Architecture design for game buildings", es: "Diseño de arquitectura para edificios de juego", de: "Architekturdesign für Spielgebäude", nl: "Architectuurontwerp voor game gebouwen" },
          { en: "NASA collaboration on game AI", es: "Colaboración NASA en IA de juegos", de: "NASA-Zusammenarbeit bei Spiele-KI", nl: "NASA samenwerking aan game AI" }
        ],
        correct: 0,
        explanation: {
