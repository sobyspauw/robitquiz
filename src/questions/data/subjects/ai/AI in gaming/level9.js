    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Evolution simulation in neural games",
                  "es": "Simulación de evolución en juegos neuronales",
                  "de": "Evolutionssimulation in neuralen Spielen",
                  "nl": "Evolutiesimulatie in neurale games"
        },
        {
                  "en": "Creating evolutionary storylines",
                  "es": "Crear líneas argumentales evolutivas",
                  "de": "Evolutionäre Handlungsstränge erstellen",
                  "nl": "Evolutionaire verhaallijnen creëren"
        },
        {
                  "en": "Evolving neural network architectures and weights using evolutionary algorithms",
                  "es": "Evolucionar arquitecturas y pesos de redes neuronales usando algoritmos evolutivos",
                  "de": "Entwicklung neuronaler Netzwerkarchitekturen und Gewichte mit evolutionären Algorithmen",
                  "nl": "Evolueren van neurale netwerkarchitecturen en gewichten met evolutionaire algoritmes"
        },
        {
                  "en": "Neural networks for evolution games",
                  "es": "Redes neuronales para juegos de evolución",
                  "de": "Neuronale Netzwerke für Evolutionsspiele",
                  "nl": "Neurale netwerken voor evolutiespellen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI that creates real-time graphics",
                  "es": "IA que crea gráficos en tiempo real",
                  "de": "KI die Echtzeitgrafiken erstellt",
                  "nl": "AI die real-time graphics creëert"
        },
        {
                  "en": "Time-based strategy games only",
                  "es": "Solo juegos de estrategia basados en tiempo",
                  "de": "Nur zeitbasierte Strategiespiele",
                  "nl": "Alleen tijd-gebaseerde strategiespellen"
        },
        {
                  "en": "Strategic planning for real-time events",
                  "es": "Planificación estratégica para eventos en tiempo real",
                  "de": "Strategische Planung für Echtzeitereignisse",
                  "nl": "Strategische planning voor real-time gebeurtenissen"
        },
        {
                  "en": "AI managing multiple units, resources, and strategies simultaneously under time pressure",
                  "es": "IA gestionando múltiples unidades, recursos y estrategias simultáneamente bajo presión temporal",
                  "de": "KI die mehrere Einheiten, Ressourcen und Strategien gleichzeitig unter Zeitdruck verwaltet",
                  "nl": "AI die meerdere eenheden, bronnen en strategieën gelijktijdig beheert onder tijdsdruk"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI that prevents player cooperation",
                  "es": "IA que previene cooperación de jugadores",
                  "de": "KI die Spielerkooperation verhindert",
                  "nl": "AI die spelerssamenwerking voorkomt"
        },
        {
                  "en": "Cooperative game modes only",
                  "es": "Solo modos de juego cooperativos",
                  "de": "Nur kooperative Spielmodi",
                  "nl": "Alleen coöperatieve spelmodi"
        },
        {
                  "en": "AI agents that can effectively collaborate with human players and other AI to achieve shared goals",
                  "es": "Agentes IA que pueden colaborar efectivamente con jugadores humanos y otra IA para lograr objetivos compartidos",
                  "de": "KI-Agenten die effektiv mit menschlichen Spielern und anderer KI zusammenarbeiten können um gemeinsame Ziele zu erreichen",
                  "nl": "AI-agenten die effectief kunnen samenwerken met menselijke spelers en andere AI om gedeelde doelen te bereiken"
        },
        {
                  "en": "AI that manages multiplayer servers",
                  "es": "IA que gestiona servidores multijugador",
                  "de": "KI die Mehrspielserver verwaltet",
                  "nl": "AI die multiplayer servers beheert"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tree search algorithms for neural training",
                  "es": "Algoritmos de búsqueda de árbol para entrenamiento neuronal",
                  "de": "Baumsuchalgorithmen für neuronales Training",
                  "nl": "Boomzoekalgoritmes voor neurale training"
        },
        {
                  "en": "Monte Carlo simulations for network topology",
                  "es": "Simulaciones Monte Carlo para topología de red",
                  "de": "Monte Carlo-Simulationen für Netzwerktopologie",
                  "nl": "Monte Carlo simulaties voor netwerktopologie"
        },
        {
                  "en": "Random tree generation with neural networks",
                  "es": "Generación aleatoria de árboles con redes neuronales",
                  "de": "Zufällige Baumgenerierung mit neuronalen Netzwerken",
                  "nl": "Willekeurige boomgeneratie met neurale netwerken"
        },
        {
                  "en": "Hybrid approach combining statistical tree search with neural network evaluation for superior game playing",
                  "es": "Enfoque híbrido combinando búsqueda estadística de árbol con evaluación de red neuronal para juego superior",
                  "de": "Hybridansatz der statistische Baumsuche mit neuronaler Netzwerk-Bewertung für überlegenes Spielen kombiniert",
                  "nl": "Hybride benadering die statistische boomzoekactie combineert met neurale netwerk evaluatie voor superieur spelen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Training against advertising algorithms",
                  "es": "Entrenar contra algoritmos publicitarios",
                  "de": "Training gegen Werbealgorithmen",
                  "nl": "Trainen tegen advertentiealgoritmes"
        },
        {
                  "en": "Training AI to be hostile to players",
                  "es": "Entrenar IA para ser hostil con jugadores",
                  "de": "KI trainieren um feindlich gegenüber Spielern zu sein",
                  "nl": "AI trainen om vijandig te zijn tegen spelers"
        },
        {
                  "en": "Training AI by having it compete against increasingly sophisticated opponents to improve performance",
                  "es": "Entrenar IA haciéndola competir contra oponentes cada vez más sofisticados para mejorar rendimiento",
                  "de": "KI trainieren indem sie gegen zunehmend raffinierte Gegner antritt um Leistung zu verbessern",
                  "nl": "AI trainen door het te laten concurreren tegen steeds geavanceerdere tegenstanders om prestaties te verbeteren"
        },
        {
                  "en": "Creating adversarial networks for graphics",
                  "es": "Crear redes adversariales para gráficos",
                  "de": "Adversariale Netzwerke für Grafiken erstellen",
                  "nl": "Adversarial netwerken creëren voor graphics"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Taking few screenshots in games",
                  "es": "Tomar pocas capturas de pantalla en juegos",
                  "de": "Wenige Screenshots in Spielen machen",
                  "nl": "Weinig screenshots nemen in games"
        },
        {
                  "en": "Learning new game mechanics or strategies from just a few examples",
                  "es": "Aprender nuevas mecánicas o estrategias del juego con solo unos pocos ejemplos",
                  "de": "Neue Spielmechaniken oder Strategien mit nur wenigen Beispielen lernen",
                  "nl": "Nieuwe spelmechanica of strategieën leren met slechts enkele voorbeelden"
        },
        {
                  "en": "Short learning sessions only",
                  "es": "Solo sesiones de aprendizaje cortas",
                  "de": "Nur kurze Lernsitzungen",
                  "nl": "Alleen korte leersessies"
        },
        {
                  "en": "Learning from few gunshots in shooter games",
                  "es": "Aprender de pocos disparos en juegos de disparos",
                  "de": "Von wenigen Schüssen in Shooter-Spielen lernen",
                  "nl": "Leren van weinig schoten in schietspellen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Processes multiple input types (voice, gesture, eye tracking, biometrics) simultaneously",
                  "es": "Procesa múltiples tipos de entrada (voz, gestos, seguimiento ocular, biométricos) simultáneamente",
                  "de": "Verarbeitet mehrere Eingabetypen (Sprache, Gesten, Eye-Tracking, Biometrie) gleichzeitig",
                  "nl": "Verwerkt meerdere invoertypes (spraak, gebaren, oogtracking, biometrie) tegelijkertijd"
        },
        {
                  "en": "Multiple game modes for different players",
                  "es": "Múltiples modos de juego para diferentes jugadores",
                  "de": "Mehrere Spielmodi für verschiedene Spieler",
                  "nl": "Meerdere spelmodi voor verschillende spelers"
        },
        {
                  "en": "Modal dialog interactions only",
                  "es": "Solo interacciones de diálogo modal",
                  "de": "Nur modale Dialog-Interaktionen",
                  "nl": "Alleen modale dialoog interacties"
        },
        {
                  "en": "Multi-platform game compatibility",
                  "es": "Compatibilidad de juegos multi-plataforma",
                  "de": "Multi-Plattform-Spielkompatibilität",
                  "nl": "Multi-platform spelcompatibiliteit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning that never stops",
                  "es": "Aprendizaje que nunca se detiene",
                  "de": "Lernen das nie aufhört",
                  "nl": "Leren dat nooit stopt"
        },
        {
                  "en": "Learning new skills without forgetting previously acquired knowledge",
                  "es": "Aprender nuevas habilidades sin olvidar conocimiento previamente adquirido",
                  "de": "Neue Fähigkeiten lernen ohne vorher erworbenes Wissen zu vergessen",
                  "nl": "Nieuwe vaardigheden leren zonder eerder verworven kennis te vergeten"
        },
        {
                  "en": "Continuous game updates only",
                  "es": "Solo actualizaciones continuas del juego",
                  "de": "Nur kontinuierliche Spiel-Updates",
                  "nl": "Alleen continue spelupdates"
        },
        {
                  "en": "Continuous internet connectivity",
                  "es": "Conectividad continua a internet",
                  "de": "Kontinuierliche Internetverbindung",
                  "nl": "Continue internetverbinding"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Search for neural network documentation",
                  "es": "Buscar documentación de redes neuronales",
                  "de": "Nach Dokumentation neuronaler Netzwerke suchen",
                  "nl": "Zoeken naar neurale netwerk documentatie"
        },
        {
                  "en": "Search through game architecture files",
                  "es": "Buscar a través de archivos de arquitectura del juego",
                  "de": "Durch Spiel-Architekturdateien suchen",
                  "nl": "Zoeken door spelarchitectuur bestanden"
        },
        {
                  "en": "Automatically discover optimal neural network architectures for specific game tasks",
                  "es": "Descubrir automáticamente arquitecturas de redes neuronales óptimas para tareas específicas del juego",
                  "de": "Automatisch optimale neuronale Netzwerkarchitekturen für spezifische Spielaufgaben entdecken",
                  "nl": "Automatisch optimale neurale netwerkarchitecturen ontdekken voor specifieke speltaken"
        },
        {
                  "en": "Find architectural blueprints for game buildings",
                  "es": "Encontrar planos arquitectónicos para edificios de juegos",
                  "de": "Architektonische Baupläne für Spielgebäude finden",
                  "nl": "Architecturale blauwdrukken vinden voor spelgebouwen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Individual player data while enabling collective AI learning from gameplay patterns",
                  "es": "Datos individuales del jugador mientras habilita aprendizaje colectivo de IA desde patrones de jugabilidad",
                  "de": "Individuelle Spielerdaten während kollektives KI-Lernen aus Gameplay-Mustern ermöglicht wird",
                  "nl": "Individuele spelerdata terwijl collectief AI-leren uit gameplay patronen mogelijk wordt gemaakt"
        },
        {
                  "en": "Different privacy settings for different players",
                  "es": "Diferentes configuraciones de privacidad para diferentes jugadores",
                  "de": "Verschiedene Privatsphäre-Einstellungen für verschiedene Spieler",
                  "nl": "Verschillende privacy-instellingen voor verschillende spelers"
        },
        {
                  "en": "Privacy differences between game modes",
                  "es": "Diferencias de privacidad entre modos de juego",
                  "de": "Privatsphäre-Unterschiede zwischen Spielmodi",
                  "nl": "Privacyverschillen tussen spelmodi"
        },
        {
                  "en": "Differential game access controls",
                  "es": "Controles diferenciales de acceso al juego",
                  "de": "Differentielle Spielzugriffskontrollen",
                  "nl": "Differentiële speltoegangcontroles"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning without any specific model",
                  "es": "Aprender sin ningún modelo específico",
                  "de": "Lernen ohne spezifisches Modell",
                  "nl": "Leren zonder specifiek model"
        },
        {
                  "en": "Learns general adaptation strategies that work across different game types and scenarios",
                  "es": "Aprende estrategias generales de adaptación que funcionan a través de diferentes tipos y escenarios de juegos",
                  "de": "Lernt allgemeine Anpassungsstrategien die über verschiedene Spieltypen und Szenarien funktionieren",
                  "nl": "Leert algemene aanpassingsstrategieën die werken over verschillende speltypes en scenario's"
        },
        {
                  "en": "Models that are agnostic to game graphics",
                  "es": "Modelos que son agnósticos a gráficos de juegos",
                  "de": "Modelle die grafik-agnostisch sind",
                  "nl": "Modellen die agnostisch zijn voor spelgraphics"
        },
        {
                  "en": "Meta-learning for model documentation",
                  "es": "Meta-aprendizaje para documentación de modelos",
                  "de": "Meta-Learning für Modelldokumentation",
                  "nl": "Meta-learning voor modeldocumentatie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Inference about game causes",
                  "es": "Inferencia sobre causas del juego",
                  "de": "Inferenz über Spielursachen",
                  "nl": "Inferentie over speloorzaken"
        },
        {
                  "en": "Causal relationships between game files",
                  "es": "Relaciones causales entre archivos del juego",
                  "de": "Kausale Beziehungen zwischen Spieldateien",
                  "nl": "Causale relaties tussen spelbestanden"
        },
        {
                  "en": "Inferring causal game storylines only",
                  "es": "Solo inferir líneas argumentales causales del juego",
                  "de": "Nur kausale Spielhandlungen ableiten",
                  "nl": "Alleen causale spelverhaallen afleiden"
        },
        {
                  "en": "Understanding cause-and-effect relationships in game mechanics and player behavior",
                  "es": "Entender relaciones de causa y efecto en mecánicas del juego y comportamiento del jugador",
                  "de": "Verstehen von Ursache-Wirkungs-Beziehungen in Spielmechaniken und Spielerverhalten",
                  "nl": "Begrijpen van oorzaak-gevolg relaties in spelmechanica en spelergedrag"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ordinary neural network equations",
                  "es": "Ecuaciones ordinarias de redes neuronales",
                  "de": "Gewöhnliche neuronale Netzwerkgleichungen",
                  "nl": "Gewone neurale netwerkvergelijkingen"
        },
        {
                  "en": "Models continuous-time processes and smooth transitions in game state evolution",
                  "es": "Modela procesos de tiempo continuo y transiciones suaves en evolución de estado del juego",
                  "de": "Modelliert kontinuierliche Zeitprozesse und sanfte Übergänge in Spielzustand-Evolution",
                  "nl": "Modelleert continue-tijd processen en soepele overgangen in spelstatus evolutie"
        },
        {
                  "en": "Neural networks for mathematical games",
                  "es": "Redes neuronales para juegos matemáticos",
                  "de": "Neuronale Netzwerke für mathematische Spiele",
                  "nl": "Neurale netwerken voor wiskundige spellen"
        },
        {
                  "en": "Solves ordinary differential equations in games",
                  "es": "Resuelve ecuaciones diferenciales ordinarias en juegos",
                  "de": "Löst gewöhnliche Differentialgleichungen in Spielen",
                  "nl": "Lost gewone differentiaalvergelijkingen op in games"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI that explains game rules to players",
                  "es": "IA que explica reglas del juego a jugadores",
                  "de": "KI die Spielregeln den Spielern erklärt",
                  "nl": "AI die spelregels uitlegt aan spelers"
        },
        {
                  "en": "AI-generated game explanations",
                  "es": "Explicaciones de juegos generadas por IA",
                  "de": "KI-generierte Spielerklärungen",
                  "nl": "AI-gegenereerde speluitleg"
        },
        {
                  "en": "Explanations of AI algorithms only",
                  "es": "Solo explicaciones de algoritmos IA",
                  "de": "Nur Erklärungen von KI-Algorithmen",
                  "nl": "Alleen uitleg van AI-algoritmes"
        },
        {
                  "en": "Transparency in AI decision-making processes and behavior reasoning",
                  "es": "Transparencia en procesos de toma de decisiones IA y razonamiento de comportamiento",
                  "de": "Transparenz in KI-Entscheidungsprozessen und Verhaltens-Argumentation",
                  "nl": "Transparantie in AI-besluitvormingsprocessen en gedragsredenering"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Machine learning on quantum computers",
                  "es": "Aprendizaje automático en computadoras cuánticas",
                  "de": "Maschinelles Lernen auf Quantencomputern",
                  "nl": "Machine learning op kwantumcomputers"
        },
        {
                  "en": "Quantum physics simulation in games only",
                  "es": "Solo simulación de física cuántica en juegos",
                  "de": "Nur Quantenphysik-Simulation in Spielen",
                  "nl": "Alleen kwantumfysica simulatie in games"
        },
        {
                  "en": "Exponentially faster optimization and pattern recognition for complex game scenarios",
                  "es": "Optimización exponencialmente más rápida y reconocimiento de patrones para escenarios complejos de juegos",
                  "de": "Exponentiell schnellere Optimierung und Mustererkennung für komplexe Spielszenarien",
                  "nl": "Exponentieel snellere optimalisatie en patroonherkenning voor complexe spelscenario's"
        },
        {
                  "en": "Quantum random number generation",
                  "es": "Generación de números aleatorios cuánticos",
                  "de": "Quantenzufallszahlengenerierung",
                  "nl": "Kwantum willekeurige nummergeneratie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning adaptation strategies from distributed players while preserving privacy",
                  "es": "Aprender estrategias de adaptación de jugadores distribuidos mientras preserva privacidad",
                  "de": "Lernens von Anpassungsstrategien von verteilten Spielern während Privatsphäre bewahrt wird",
                  "nl": "Leren van aanpassingsstrategieën van gedistribueerde spelers terwijl privacy behouden blijft"
        },
        {
                  "en": "Federated game server meta-data",
                  "es": "Meta-datos de servidores de juego federados",
                  "de": "Föderierte Spielserver-Metadaten",
                  "nl": "Gefedereerde spelserver metadata"
        },
        {
                  "en": "Meta-learning about federation protocols",
                  "es": "Meta-aprendizaje sobre protocolos de federación",
                  "de": "Meta-Learning über Föderationsprotokolle",
                  "nl": "Meta-learning over federatieprotocollen"
        },
        {
                  "en": "Learning to federate game networks",
                  "es": "Aprender a federar redes de juego",
                  "de": "Lernen Spielnetzwerke zu föderieren",
                  "nl": "Leren om spelnetwerken te federeren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Morphological neural analysis",
                  "es": "Análisis neuronal morfológico",
                  "de": "Morphologische neuronale Analyse",
                  "nl": "Morfologische neurale analyse"
        },
        {
                  "en": "Brain-inspired hardware that processes information more efficiently with lower power consumption",
                  "es": "Hardware inspirado en el cerebro que procesa información más eficientemente con menor consumo de energía",
                  "de": "Gehirn-inspirierte Hardware die Information effizienter mit geringerem Energieverbrauch verarbeitet",
                  "nl": "Brein-geïnspireerde hardware die informatie efficiënter verwerkt met lager energieverbruik"
        },
        {
                  "en": "Morphing neural network shapes only",
                  "es": "Solo morfear formas de redes neuronales",
                  "de": "Nur morphende neuronale Netzwerkformen",
                  "nl": "Alleen morphende neurale netwerkvormen"
        },
        {
                  "en": "Neural networks that change architecture",
                  "es": "Redes neuronales que cambian arquitectura",
                  "de": "Neuronale Netzwerke die Architektur ändern",
                  "nl": "Neurale netwerken die architectuur veranderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Malicious attempts to exploit or fool AI systems through crafted inputs or strategies",
                  "es": "Intentos maliciosos de explotar o engañar sistemas IA a través de entradas o estrategias diseñadas",
                  "de": "Bösartige Versuche KI-Systeme durch gestaltete Eingaben oder Strategien zu exploitieren oder zu täuschen",
                  "nl": "Kwaadaardige pogingen om AI-systemen te exploiteren of te misleiden door opgezette inputs of strategieën"
        },
        {
                  "en": "Robust advertising against adversaries",
                  "es": "Publicidad robusta contra adversarios",
                  "de": "Robuste Werbung gegen Widersacher",
                  "nl": "Robuuste reclame tegen tegenstanders"
        },
        {
                  "en": "Robust network connections in adversarial conditions",
                  "es": "Conexiones de red robustas en condiciones adversariales",
                  "de": "Robuste Netzwerkverbindungen unter widrigen Bedingungen",
                  "nl": "Robuuste netwerkverbindingen onder moeilijke omstandigheden"
        },
        {
                  "en": "Adversarial game mode robustness",
                  "es": "Robustez de modo de juego adversarial",
                  "de": "Adversarial Spielmodus-Robustheit",
                  "nl": "Adversarial spelmodus robuustheid"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learns meaningful representations by contrasting similar and dissimilar game states",
                  "es": "Aprende representaciones significativas contrastando estados similares y disimilares del juego",
                  "de": "Lernt bedeutungsvolle Repräsentationen durch Kontrastierung ähnlicher und unähnlicher Spielzustände",
                  "nl": "Leert betekenisvolle representaties door soortgelijke en verschillende speltoestanden te contrasteren"
        },
        {
                  "en": "Learning from game contrasts",
                  "es": "Aprender de contrastes del juego",
                  "de": "Von Spielkontrasten lernen",
                  "nl": "Leren van spelcontrasten"
        },
        {
                  "en": "Contrasts different game graphics only",
                  "es": "Solo contrasta diferentes gráficos del juego",
                  "de": "Kontrastiert nur verschiedene Spielgrafiken",
                  "nl": "Contrasteert alleen verschillende spelgraphics"
        },
        {
                  "en": "Contrastive game difficulty settings",
                  "es": "Configuraciones de dificultad contrastiva del juego",
                  "de": "Kontrastive Spielschwierigkeitseinstellungen",
                  "nl": "Contrastieve spelmoeilijkheidsinstellingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Aligning AI with game safety regulations only",
                  "es": "Solo alinear IA con regulaciones de seguridad del juego",
                  "de": "Nur KI mit Spielsicherheitsregulierungen ausrichten",
                  "nl": "Alleen AI uitlijnen met spelveiliheidsregulaties"
        },
        {
                  "en": "AI systems behave according to intended goals and human values without causing harm",
                  "es": "Sistemas IA se comportan según objetivos intencionados y valores humanos sin causar daño",
                  "de": "KI-Systeme verhalten sich entsprechend beabsichtigter Ziele und menschlicher Werte ohne Schaden zu verursachen",
                  "nl": "AI-systemen gedragen zich volgens beoogde doelen en menselijke waarden zonder schade te veroorzaken"
        },
        {
                  "en": "Safety alignment of game controllers",
                  "es": "Alineación de seguridad de controladores de juego",
                  "de": "Sicherheitsausrichtung von Spielcontrollern",
                  "nl": "Veiligheidsuitlijning van spelcontrollers"
        },
        {
                  "en": "AI system hardware safety alignment",
                  "es": "Alineación de seguridad de hardware del sistema IA",
                  "de": "KI-System Hardware-Sicherheitsausrichtung",
                  "nl": "AI-systeem hardware veiligheidsuitlijning"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Transferring AI trained in simulated game environments to real-world applications",
                  "es": "Transferir IA entrenada en entornos de juego simulados a aplicaciones del mundo real",
                  "de": "Transfer von in simulierten Spielumgebungen trainierter KI zu realen Anwendungen",
                  "nl": "Overdragen van AI getraind in gesimuleerde spelomgevingen naar real-world toepassingen"
        },
        {
                  "en": "Simulating real-world graphics in games",
                  "es": "Simular gráficos del mundo real en juegos",
                  "de": "Echtwelt-Grafiken in Spielen simulieren",
                  "nl": "Real-world graphics simuleren in games"
        },
        {
        ...
        {
                  "en": "Transferring games to simulation platforms",
                  "es": "Transferir juegos a plataformas de simulación",
                  "de": "Spiele auf Simulationsplattformen übertragen",
                  "nl": "Games overdragen naar simulatieplatforms"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Energy management for game servers",
                  "es": "Gestión de energía para servidores de juego",
                  "de": "Energiemanagement für Spielserver",
                  "nl": "Energiebeheer voor spelservers"
        },
        {
                  "en": "Assigns energy scores to game states to guide AI toward favorable configurations",
                  "es": "Asigna puntuaciones de energía a estados del juego para guiar IA hacia configuraciones favorables",
                  "de": "Weist Energiewerte Spielzuständen zu um KI zu günstigen Konfigurationen zu leiten",
                  "nl": "Wijst energiescores toe aan speltoestanden om AI naar gunstige configuraties te leiden"
        },
        {
                  "en": "Models only energy consumption in games",
                  "es": "Solo modela consumo de energía en juegos",
                  "de": "Modelliert nur Energieverbrauch in Spielen",
                  "nl": "Modelleert alleen energieverbruik in games"
        },
        {
                  "en": "Physical energy simulation in games",
                  "es": "Simulación de energía física en juegos",
                  "de": "Physikalische Energiesimulation in Spielen",
                  "nl": "Fysische energiesimulatie in games"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learning internal simulations of game environments to plan without actual environment interaction",
                  "es": "Aprender simulaciones internas de entornos del juego para planear sin interacción real con el entorno",
                  "de": "Lernen interner Simulationen von Spielumgebungen um ohne tatsächliche Umgebungsinteraktion zu planen",
                  "nl": "Leren van interne simulaties van spelomgevingen om te plannen zonder daadwerkelijke omgevingsinteractie"
        },
        {
                  "en": "Creating world maps for games only",
                  "es": "Solo crear mapas del mundo para juegos",
                  "de": "Nur Weltkarten für Spiele erstellen",
                  "nl": "Alleen wereldkaarten creëren voor games"
        },
        {
                  "en": "Modeling game world physics",
                  "es": "Modelar física del mundo del juego",
                  "de": "Spielweltphysik modellieren",
                  "nl": "Spelwereld fysica modelleren"
        },
        {
                  "en": "World-building tools for developers",
                  "es": "Herramientas de construcción de mundos para desarrolladores",
                  "de": "Weltbauwerkzeuge für Entwickler",
                  "nl": "Wereldbouw tools voor ontwikkelaars"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reinterprets failed attempts as successful by changing the goal retrospectively",
                  "es": "Reinterpreta intentos fallidos como exitosos cambiando el objetivo retrospectivamente",
                  "de": "Interpretiert gescheiterte Versuche als erfolgreich durch retrospektive Zieländerung",
                  "nl": "Herinterpreteert mislukte pogingen als succesvol door het doel achteraf te veranderen"
        },
        {
                  "en": "Hindsight analysis of game replays",
                  "es": "Análisis retrospectivo de repeticiones de juego",
                  "de": "Rückblickanalyse von Spiel-Replays",
                  "nl": "Terugblik analyse van spelreplays"
        },
        {
                  "en": "Only replays hindsight camera views",
                  "es": "Solo repite vistas de cámara retrospectivas",
                  "de": "Wiederholt nur Rückblick-Kamera-Ansichten",
                  "nl": "Speelt alleen terugblik camera views opnieuw af"
        },
        {
                  "en": "Replaying past experiences only",
                  "es": "Solo repetir experiencias pasadas",
                  "de": "Nur vergangene Erfahrungen wiederholen",
                  "nl": "Alleen verleden ervaringen opnieuw afspelen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Network attention for graphs",
                  "es": "Atención de red para gráficos",
                  "de": "Netzwerk-Aufmerksamkeit für Graphen",
                  "nl": "Netwerkaandacht voor grafen"
        },
        {
                  "en": "Dynamically weights importance of different entities and their relationships in complex game scenarios",
                  "es": "Pondera dinámicamente importancia de diferentes entidades y sus relaciones en escenarios complejos del juego",
                  "de": "Gewichtet dynamisch Wichtigkeit verschiedener Entitäten und ihrer Beziehungen in komplexen Spielszenarien",
                  "nl": "Weegt dynamisch het belang van verschillende entiteiten en hun relaties in complexe spelscenario's"
        },
        {
                  "en": "Attention mechanisms for graph visualizations only",
                  "es": "Solo mecanismos de atención para visualizaciones de grafos",
                  "de": "Nur Aufmerksamkeitsmechanismen für Graph-Visualisierungen",
                  "nl": "Alleen aandachtsmechanismen voor graafvisualisaties"
        },
        {
                  "en": "Graphical attention effects in games",
                  "es": "Efectos gráficos de atención en juegos",
                  "de": "Grafische Aufmerksamkeitseffekte in Spielen",
                  "nl": "Grafische aandachtseffecten in games"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Combines specialized sub-networks that each handle different aspects of game AI",
                  "es": "Combina sub-redes especializadas que cada una maneja diferentes aspectos de IA de juegos",
                  "de": "Kombiniert spezialisierte Sub-Netzwerke die jeweils verschiedene Aspekte von Spiele-KI handhaben",
                  "nl": "Combineert gespecialiseerde sub-netwerken die elk verschillende aspecten van game AI behandelen"
        },
        {
                  "en": "Mixes expert player strategies only",
                  "es": "Solo mezcla estrategias de jugadores expertos",
                  "de": "Mischt nur Expertenspielstrategien",
                  "nl": "Mengt alleen expertspelerstrategieën"
        },
        {
                  "en": "Mixing different expert opinions",
                  "es": "Mezclar diferentes opiniones de expertos",
                  "de": "Verschiedene Expertenmeinungen mischen",
                  "nl": "Verschillende expertmeningen mengen"
        },
        {
                  "en": "Expert AI consultation services",
                  "es": "Servicios de consultoría de IA experta",
                  "de": "Experten-KI-Beratungsdienste",
                  "nl": "Expert AI-adviesdiensten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bottlenecks in concept understanding only",
                  "es": "Solo cuellos de botella en comprensión de conceptos",
                  "de": "Nur Engpässe im Konzeptverständnis",
                  "nl": "Alleen knelpunten in conceptbegrip"
        },
        {
                  "en": "Conceptual design bottlenecks",
                  "es": "Cuellos de botella de diseño conceptual",
                  "de": "Konzeptionelle Designengpässe",
                  "nl": "Conceptuele ontwerpknelpunten"
        },
        {
                  "en": "Network bottleneck concepts",
                  "es": "Conceptos de cuello de botella de red",
                  "de": "Netzwerk-Engpass-Konzepte",
                  "nl": "Netwerk knelpuntconcepten"
        },
        {
                  "en": "Forces AI to make decisions through human-understandable concepts for transparency",
                  "es": "Fuerza a la IA a tomar decisiones a través de conceptos comprensibles por humanos para transparencia",
                  "de": "Zwingt KI Entscheidungen durch menschlich verständliche Konzepte zu treffen für Transparenz",
                  "nl": "Dwingt AI om beslissingen te nemen via menselijk begrijpbare concepten voor transparantie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Chain attacks in fighting games",
                  "es": "Ataques en cadena en juegos de lucha",
                  "de": "Kettenangriffe in Kampfspielen",
                  "nl": "Keten aanvallen in vechtgames"
        },
        {
                  "en": "Combines learned primitive skills into sequences to achieve complex objectives",
                  "es": "Combina habilidades primitivas aprendidas en secuencias para lograr objetivos complejos",
                  "de": "Kombiniert gelernte primitive Fähigkeiten in Sequenzen um komplexe Ziele zu erreichen",
                  "nl": "Combineert geleerde primitieve vaardigheden in sequenties om complexe doelstellingen te bereiken"
        },
        {
                  "en": "Skill tree connections",
                  "es": "Conexiones de árbol de habilidades",
                  "de": "Fähigkeitsbaum-Verbindungen",
                  "nl": "Vaardigheidsboom verbindingen"
        },
        {
                  "en": "Chaining skill points in RPGs only",
                  "es": "Solo encadenar puntos de habilidad en RPGs",
                  "de": "Nur Skill-Punkte in RPGs verketten",
                  "nl": "Alleen skill punten koppelen in RPGs"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "AI that supervises itself only",
                  "es": "Solo IA que se supervisa a sí misma",
                  "de": "Nur KI die sich selbst überwacht",
                  "nl": "Alleen AI die zichzelf superviseert"
        },
        {
                  "en": "Learns useful representations from unlabeled game data by predicting hidden information",
                  "es": "Aprende representaciones útiles de datos no etiquetados del juego prediciendo información oculta",
                  "de": "Lernt nützliche Repräsentationen aus ungelabelten Spieldaten durch Vorhersage verborgener Informationen",
                  "nl": "Leert nuttige representaties van ongelabelde speldata door verborgen informatie te voorspellen"
        },
        {
                  "en": "Self-directed learning paths",
                  "es": "Caminos de aprendizaje auto-dirigidos",
                  "de": "Selbstgesteuerte Lernpfade",
                  "nl": "Zelfgestuurde leerpaden"
        },
        {
                  "en": "Supervised learning without supervisors",
                  "es": "Aprendizaje supervisado sin supervisores",
                  "de": "Überwachtes Lernen ohne Betreuer",
                  "nl": "Supervised learning zonder supervisors"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Distilling essential game features",
                  "es": "Destilar características esenciales del juego",
                  "de": "Wesentliche Spielfunktionen destillieren",
                  "nl": "Essentiële spelkenmerken distilleren"
        },
        {
                  "en": "Transfers knowledge from large teacher models to smaller, efficient student models",
                  "es": "Transfiere conocimiento de modelos maestros grandes a modelos estudiantes más pequeños y eficientes",
                  "de": "Überträgt Wissen von großen Lehrer-Modellen zu kleineren, effizienten Schüler-Modellen",
                  "nl": "Draagt kennis over van grote leraar modellen naar kleinere, efficiënte student modellen"
        },
        {
                  "en": "Knowledge compression algorithms",
                  "es": "Algoritmos de compresión de conocimiento",
                  "de": "Wissenskompressionsalgorithmen",
                  "nl": "Kenniscompressie algoritmes"
        },
        {
                  "en": "Distills game knowledge into documentation",
                  "es": "Destila conocimiento del juego en documentación",
                  "de": "Destilliert Spielwissen in Dokumentation",
                  "nl": "Distilleert spelkennis in documentatie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Synthesizing neural network programs",
                  "es": "Sintetizar programas de redes neuronales",
                  "de": "Neuronale Netzwerk-Programme synthetisieren",
                  "nl": "Neurale netwerk programma's synthetiseren"
        },
        {
                  "en": "Neural networks for program synthesis only",
                  "es": "Solo redes neuronales para síntesis de programas",
                  "de": "Nur neuronale Netzwerke für Programmsynthese",
                  "nl": "Alleen neurale netwerken voor programmasynthese"
        },
        {
                  "en": "Program generation for neural training",
                  "es": "Generación de programas para entrenamiento neural",
                  "de": "Programmgenerierung für neuronales Training",
                  "nl": "Programma generatie voor neurale training"
        },
        {
                  "en": "Automatically generates game logic code from high-level specifications or examples",
                  "es": "Genera automáticamente código de lógica del juego desde especificaciones de alto nivel o ejemplos",
                  "de": "Generiert automatisch Spiellogik-Code aus High-Level-Spezifikationen oder Beispielen",
                  "nl": "Genereert automatisch spellogica code vanuit hoog-niveau specificaties of voorbeelden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Processes graph-structured game data like unit formations, resource networks, and territorial control",
                  "es": "Procesa datos estructurados en grafo del juego como formaciones de unidades, redes de recursos y control territorial",
                  "de": "Verarbeitet graph-strukturierte Spieldaten wie Einheitenformationen, Ressourcennetzwerke und territoriale Kontrolle",
                  "nl": "Verwerkt graaf-gestructureerde speldata zoals eenheidsformaties, bronnenetwerken en territoriale controle"
        },
        {
                  "en": "Convolutions on graph visualizations only",
                  "es": "Solo convoluciones en visualizaciones de grafos",
                  "de": "Nur Faltungen auf Graph-Visualisierungen",
                  "nl": "Alleen convoluties op graafvisualisaties"
        },
        {
                  "en": "Graphical convolution filters",
                  "es": "Filtros de convolución gráfica",
                  "de": "Grafische Faltungsfilter",
                  "nl": "Grafische convolutie filters"
        },
        {
                  "en": "Network graph convolutions",
                  "es": "Convoluciones de grafos de red",
                  "de": "Netzwerk-Graph-Faltungen",
                  "nl": "Netwerk graafconvoluties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Visual reward shaping",
                  "es": "Modelado visual de recompensas",
                  "de": "Visuelles Belohnungs-Shaping",
                  "nl": "Visuele beloning vormgeving"
        },
        {
                  "en": "Shaping physical rewards in games",
                  "es": "Dar forma a recompensas físicas en juegos",
                  "de": "Physische Belohnungen in Spielen formen",
                  "nl": "Fysieke beloningen in games vormgeven"
        },
        {
                  "en": "Reward distribution shapes",
                  "es": "Formas de distribución de recompensas",
                  "de": "Belohnungsverteilungsformen",
                  "nl": "Beloningsdistributievormen"
        },
        {
                  "en": "Designs intermediate rewards to guide learning toward desired behaviors more efficiently",
                  "es": "Diseña recompensas intermedias para guiar aprendizaje hacia comportamientos deseados más eficientemente",
                  "de": "Entwirft Zwischenbelohnungen um Lernen effizienter zu gewünschten Verhaltensweisen zu leiten",
                  "nl": "Ontwerpt tussenbeloningen om leren efficiënter naar gewenste gedragingen te leiden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Episodic game content memory",
                  "es": "Memoria de contenido de juego episódico",
                  "de": "Episodisches Spielinhalt-Gedächtnis",
                  "nl": "Episodisch spelcontent geheugen"
        },
        {
                  "en": "Stores and retrieves specific past experiences to inform current decision-making",
                  "es": "Almacena y recupera experiencias pasadas específicas para informar toma actual de decisiones",
                  "de": "Speichert und ruft spezifische vergangene Erfahrungen ab um aktuelle Entscheidungsfindung zu informieren",
                  "nl": "Slaat specifieke vorige ervaringen op en haalt ze op om huidige besluitvorming te informeren"
        },
        {
                  "en": "Memory for game episodes only",
                  "es": "Solo memoria para episodios de juego",
                  "de": "Nur Gedächtnis für Spiel-Episoden",
                  "nl": "Alleen geheugen voor spelepisodes"
        },
        {
                  "en": "Episode tracking in games",
                  "es": "Seguimiento de episodios en juegos",
                  "de": "Episoden-Tracking in Spielen",
                  "nl": "Episode tracking in games"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Motivation to play games intrinsically",
                  "es": "Motivación para jugar juegos intrínsecamente",
                  "de": "Motivation Spiele intrinsisch zu spielen",
                  "nl": "Motivatie om games intrinsiek te spelen"
        },
        {
                  "en": "Internal reward signals that encourage exploration of novel states and skills",
                  "es": "Señales de recompensa internas que alientan exploración de estados y habilidades novedosas",
                  "de": "Interne Belohnungssignale die Exploration neuartiger Zustände und Fähigkeiten fördern",
                  "nl": "Interne beloningssignalen die exploratie van nieuwe toestanden en vaardigheden aanmoedigen"
        },
        {
                  "en": "Intrinsic game difficulty",
                  "es": "Dificultad intrínseca del juego",
                  "de": "Intrinsische Spielschwierigkeit",
                  "nl": "Intrinsieke spelmoeilijkheid"
        },
        {
                  "en": "Internal game motivation systems",
                  "es": "Sistemas de motivación interna del juego",
                  "de": "Interne Spielmotivationssysteme",
                  "nl": "Interne spelmotivatiesystemen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Zero accuracy shooting in games",
                  "es": "Disparo con precisión cero en juegos",
                  "de": "Null-Genauigkeits-Schießen in Spielen",
                  "nl": "Nul nauwkeurigheid schieten in games"
        },
        {
                  "en": "Learning without any shots fired",
                  "es": "Aprender sin ningún disparo",
                  "de": "Lernen ohne Schüsse",
                  "nl": "Leren zonder shots afgevuurd"
        },
        {
                  "en": "Zero training examples only",
                  "es": "Solo cero ejemplos de entrenamiento",
                  "de": "Nur null Trainingsbeispiele",
                  "nl": "Alleen nul trainingsvoorbeelden"
        },
        {
                  "en": "Performs tasks or recognizes concepts never seen during training through semantic understanding",
                  "es": "Realiza tareas o reconoce conceptos nunca vistos durante entrenamiento a través de comprensión semántica",
                  "de": "Führt Aufgaben aus oder erkennt Konzepte die nie während des Trainings gesehen wurden durch semantisches Verständnis",
                  "nl": "Voert taken uit of herkent concepten die nooit tijdens training zijn gezien door semantisch begrip"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Learns generalizable strategic principles that transfer across different games and domains",
                  "es": "Aprende principios estratégicos generalizables que se transfieren a través de diferentes juegos y dominios",
                  "de": "Lernt verallgemeinerbare strategische Prinzipien die über verschiedene Spiele und Domänen übertragen werden",
                  "nl": "Leert generaliseerbare strategische principes die overdragen over verschillende games en domeinen"
        },
        {
                  "en": "Abstract art strategies in games",
                  "es": "Estrategias de arte abstracto en juegos",
                  "de": "Abstrakte Kunststrategien in Spielen",
                  "nl": "Abstracte kunst strategieën in games"
        },
        {
                  "en": "Abstract game theory only",
                  "es": "Solo teoría de juegos abstracta",
                  "de": "Nur abstrakte Spieltheorie",
                  "nl": "Alleen abstracte speltheorie"
        },
        {
                  "en": "Learning only abstract concepts",
                  "es": "Aprender solo conceptos abstractos",
                  "de": "Nur abstrakte Konzepte lernen",
                  "nl": "Alleen abstracte concepten leren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Educational game curriculum",
                  "es": "Currículo de juegos educativos",
                  "de": "Bildungsspiel-Curriculum",
                  "nl": "Educatief spelcurriculum"
        },
        {
                  "en": "Generates game curricula for players",
                  "es": "Genera currículos de juego para jugadores",
                  "de": "Generiert Spiel-Curricula für Spieler",
                  "nl": "Genereert spelcurricula voor spelers"
        },
        {
                  "en": "Curriculum documentation generation",
                  "es": "Generación de documentación de currículo",
                  "de": "Curriculum-Dokumentationsgenerierung",
                  "nl": "Curriculum documentatie generatie"
        },
        {
                  "en": "Automatically creates sequences of training tasks that gradually increase in difficulty",
                  "es": "Crea automáticamente secuencias de tareas de entrenamiento que aumentan gradualmente en dificultad",
                  "de": "Erstellt automatisch Sequenzen von Trainingsaufgaben die graduell schwieriger werden",
                  "nl": "Creëert automatisch sequenties van trainingstaken die geleidelijk toenemen in moeilijkheid"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Optimizing latent game variables only",
                  "es": "Solo optimizar variables latentes del juego",
                  "de": "Nur latente Spielvariablen optimieren",
                  "nl": "Alleen latente spelvariabelen optimaliseren"
        },
        {
                  "en": "Optimizes policies in compressed latent representations for more efficient search",
                  "es": "Optimiza políticas en representaciones latentes comprimidas para búsqueda más eficiente",
                  "de": "Optimiert Policies in komprimierten latenten Repräsentationen für effizientere Suche",
                  "nl": "Optimaliseert beleid in gecomprimeerde latente representaties voor efficiënter zoeken"
        },
        {
                  "en": "Latency optimization for games",
                  "es": "Optimización de latencia para juegos",
                  "de": "Latenz-Optimierung für Spiele",
                  "nl": "Latentie optimalisatie voor games"
        },
        {
                  "en": "Spatial optimization in games",
                  "es": "Optimización espacial en juegos",
                  "de": "Räumliche Optimierung in Spielen",
                  "nl": "Ruimtelijke optimalisatie in games"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Noise reduction in exploration",
                  "es": "Reducción de ruido en exploración",
                  "de": "Rauschreduzierung in Exploration",
                  "nl": "Ruisreductie in exploratie"
        },
        {
                  "en": "Adaptive network noise",
                  "es": "Ruido de red adaptativo",
                  "de": "Adaptives Netzwerkrauschen",
                  "nl": "Adaptieve netwerkruis"
        },
        {
                  "en": "Adds adaptive noise to game audio",
                  "es": "Agrega ruido adaptativo al audio del juego",
                  "de": "Fügt adaptives Rauschen zum Spiel-Audio hinzu",
                  "nl": "Voegt adaptieve ruis toe aan spelgeluid"
        },
        {
                  "en": "Dynamically adjusts exploration randomness based on learning progress and uncertainty",
                  "es": "Ajusta dinámicamente aleatoriedad de exploración basándose en progreso de aprendizaje e incertidumbre",
                  "de": "Passt Explorations-Zufälligkeit dynamisch basierend auf Lernfortschritt und Unsicherheit an",
                  "nl": "Past exploratie willekeurigheid dynamisch aan gebaseerd op leervoortgang en onzekerheid"
        }
        ],
        correct: 3,
        explanation: {
