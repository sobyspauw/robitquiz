// Egyptian Cities Quiz - Level 7: Knowledge about Egyptian Cities
(function() {
  const level7 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Large slipways and timber storage facilities near the harbor district", es: "Grandes gradas y instalaciones de almacenamiento de madera cerca del distrito portuario", de: "Große Hellingen und Holzlagereinrichtungen in der Nähe des Hafenviertels", nl: "Grote hellingen en houtopslagfaciliteiten bij de havenwijk" },
          { en: "Bronze foundries for anchor production", es: "Fundiciones de bronce para producción de anclas", de: "Bronzegießereien für Ankerproduktion", nl: "Bronzen gieterijen voor ankerproductie" },
          { en: "Specialized quarries for boat stones", es: "Canteras especializadas para piedras de barcos", de: "Spezialisierte Steinbrüche für Bootssteine", nl: "Gespecialiseerde steengroeven voor bootsstenen" },
          { en: "Maritime training schools", es: "Escuelas de entrenamiento marítimo", de: "Maritime Ausbildungsschulen", nl: "Maritime trainingsscholen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Distinct residential zones for different craftsmen and administrators with varying house sizes", es: "Zonas residenciales distintas para diferentes artesanos y administradores con tamaños de casa variables", de: "Unterschiedliche Wohnzonen für verschiedene Handwerker und Verwalter mit variierenden Hausgrößen", nl: "Verschillende woonzones voor verschillende ambachtslieden en beheerders met variërende huisgroottes" },
          { en: "Central guild hall system", es: "Sistema central de gremios", de: "Zentrales Zunfthaus-System", nl: "Centraal gilde hal systeem" },
          { en: "Rotating neighborhood workshops", es: "Talleres de barrio rotatorios", de: "Rotierende Nachbarschaftswerkstätten", nl: "Roterende buurt werkplaatsen" },
          { en: "Mixed-use residential complexes", es: "Complejos residenciales de uso mixto", de: "Gemischt genutzte Wohnkomplexe", nl: "Gemengd gebruik woon complexen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Integration of Canaanite-style architecture with Egyptian temple complexes", es: "Integración de arquitectura de estilo cananeo con complejos de templos egipcios", de: "Integration von kanaanäischer Architektur mit ägyptischen Tempelkomplexen", nl: "Integratie van Kanaänitische architectuur met Egyptische tempelcomplexen" },
          { en: "Circular fortification walls", es: "Muros de fortificación circulares", de: "Kreisförmige Befestigungsmauern", nl: "Ronde vestingmuren" },
          { en: "Underground residential quarters", es: "Barrios residenciales subterráneos", de: "Unterirdische Wohnviertel", nl: "Ondergrondse woonwijken" },
          { en: "Floating market districts", es: "Distritos de mercado flotantes", de: "Schwimmende Marktviertel", nl: "Drijvende marktwijken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Large concentrations of administrative papyri and scribal quarters near the temple", es: "Grandes concentraciones de papiros administrativos y barrios de escribas cerca del templo", de: "Große Konzentrationen von Verwaltungspapyri und Schreibvierteln in der Nähe des Tempels", nl: "Grote concentraties van administratieve papyri en schrijvers wijken bij de tempel" },
          { en: "Royal minting facilities", es: "Instalaciones reales de acuñación", de: "Königliche Münzstätten", nl: "Koninklijke muntfaciliteiten" },
          { en: "Military barracks complexes", es: "Complejos de cuarteles militares", de: "Militärische Kasernenanlagen", nl: "Militaire kazerne complexen" },
          { en: "Diplomatic embassy compounds", es: "Complejos de embajadas diplomáticas", de: "Diplomatische Botschaftsanlagen", nl: "Diplomatieke ambassade complexen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The Nile naturally divided it into East Bank (living city) and West Bank (necropolis)", es: "El Nilo naturalmente lo dividió en Orilla Este (ciudad viviente) y Orilla Oeste (necrópolis)", de: "Der Nil teilte es natürlich in Ostufer (lebende Stadt) und Westufer (Nekropole)", nl: "De Nijl verdeelde het natuurlijk in Oostelijke Oever (levende stad) en Westelijke Oever (necropolis)" },
          { en: "Mountain ranges separated commercial and residential zones", es: "Las cordilleras separaron zonas comerciales y residenciales", de: "Bergketten trennten Handels- und Wohnzonen", nl: "Bergketens scheidden commerciële en residentiële zones" },
          { en: "Desert wadis created natural districts", es: "Los wadis del desierto crearon distritos naturales", de: "Wüstenwadis schufen natürliche Bezirke", nl: "Woestijn wadi's creëerden natuurlijke wijken" },
          { en: "Seasonal lakes formed boundary markers", es: "Lagos estacionales formaron marcadores de límites", de: "Saisonale Seen bildeten Grenzmarkierungen", nl: "Seizoensgebonden meren vormden grensmarkeringen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Network of artificial lakes connected to temple complexes for ritual purification", es: "Red de lagos artificiales conectados a complejos de templos para purificación ritual", de: "Netzwerk künstlicher Seen verbunden mit Tempelkomplexen zur rituellen Reinigung", nl: "Netwerk van kunstmatige meren verbonden met tempelcomplexen voor rituele zuivering" },
          { en: "Aqueduct system from distant mountains", es: "Sistema de acueductos desde montañas distantes", de: "Aquäduktsystem von fernen Bergen", nl: "Aquaduct systeem van verre bergen" },
          { en: "Deep well irrigation network", es: "Red de riego de pozos profundos", de: "Tiefbrunnenbewässerungsnetz", nl: "Diep put irrigatie netwerk" },
          { en: "Rainwater collection reservoirs", es: "Reservorios de recolección de agua de lluvia", de: "Regenwassersammelreservoirs", nl: "Regenwater verzamel reservoirs" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Fortified palace complex with militarized administrative buildings and granaries", es: "Complejo de palacio fortificado con edificios administrativos militarizados y graneros", de: "Befestigter Palastkomplex mit militarisierten Verwaltungsgebäuden und Getreidespeichern", nl: "Versterkt paleis complex met gemilitariseerde administratieve gebouwen en graanschuren" },
          { en: "Naval shipyard installations", es: "Instalaciones de astilleros navales", de: "Marine-Werftanlagen", nl: "Marine scheepswerf installaties" },
          { en: "Border checkpoint towers", es: "Torres de control fronterizo", de: "Grenzkontrolltürme", nl: "Grenscontrole torens" },
          { en: "Signal fire beacon system", es: "Sistema de faros de señales de fuego", de: "Signalfeuer-Bakensystem", nl: "Signaalvuur baken systeem" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Specialized weaving districts with dye workshops and linen markets concentrated near water sources", es: "Distritos especializados de tejido con talleres de tinte y mercados de lino concentrados cerca de fuentes de agua", de: "Spezialisierte Webviertel mit Färberwerkstätten und Leinenmärkten konzentriert in der Nähe von Wasserquellen", nl: "Gespecialiseerde weef wijken met verfwerkplaatsen en linnen markten geconcentreerd bij waterbronnen" },
          { en: "Cotton plantation urban zones", es: "Zonas urbanas de plantaciones de algodón", de: "Baumwollplantagen-Stadtzonen", nl: "Katoen plantage stedelijke zones" },
          { en: "Silk road trading posts", es: "Puestos comerciales de la ruta de la seda", de: "Seidenstraßen-Handelsposten", nl: "Zijderoute handelsposten" },
          { en: "Wool processing facilities", es: "Instalaciones de procesamiento de lana", de: "Wollverarbeitungsanlagen", nl: "Wol verwerkingsfaciliteiten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Multiple temple enclosures dedicated to ram-god worship with extensive catacombs", es: "Múltiples recintos de templos dedicados al culto del dios carnero con extensas catacumbas", de: "Mehrere Tempelanlagen dem Widder-Gott-Kult gewidmet mit umfangreichen Katakomben", nl: "Meerdere tempel omheiningen gewijd aan ram-god aanbidding met uitgebreide catacomben" },
          { en: "Fortress wall system", es: "Sistema de murallas de fortaleza", de: "Festungsmauersystem", nl: "Vestingmuur systeem" },
          { en: "Canal port infrastructure", es: "Infraestructura de puerto de canal", de: "Kanalhafen-Infrastruktur", nl: "Kanaal haven infrastructuur" },
          { en: "Agricultural research stations", es: "Estaciones de investigación agrícola", de: "Landwirtschaftliche Forschungsstationen", nl: "Landbouw onderzoek stations" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Large caravanserais with storage warehouses and customs facilities", es: "Grandes caravasares con almacenes de almacenamiento e instalaciones aduaneras", de: "Große Karawansereien mit Lagerhäusern und Zollanlagen", nl: "Grote karavansérails met opslag pakhuizen en douane faciliteiten" },
          { en: "Mountain pass fortifications", es: "Fortificaciones de pasos de montaña", de: "Bergpass-Befestigungen", nl: "Bergpas vestingen" },
          { en: "Desert lighthouse network", es: "Red de faros del desierto", de: "Wüsten-Leuchtturmnetz", nl: "Woestijn vuurtoren netwerk" },
          { en: "Nomad settlement camps", es: "Campamentos de asentamiento nómada", de: "Nomaden-Siedlungslager", nl: "Nomaden nederzettings kampen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Built as a complete planned city with Greco-Roman grid layout rather than organic growth", es: "Construida como una ciudad planificada completa con diseño de cuadrícula greco-romano en lugar de crecimiento orgánico", de: "Als vollständig geplante Stadt mit griechisch-römischem Rasterlayout gebaut anstatt organisches Wachstum", nl: "Gebouwd als complete geplande stad met Grieks-Romeinse raster indeling in plaats van organische groei" },
          { en: "Underground city design", es: "Diseño de ciudad subterránea", de: "Unterirdisches Stadtdesign", nl: "Ondergronds stad ontwerp" },
          { en: "Floating residential platforms", es: "Plataformas residenciales flotantes", de: "Schwimmende Wohnplattformen", nl: "Drijvende residentiële platforms" },
          { en: "Nomadic tent city structure", es: "Estructura de ciudad de tiendas nómadas", de: "Nomadische Zeltstadt-Struktur", nl: "Nomadische tent stad structuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Large concentrations of imported pottery, foreign coins, and customs documents from Red Sea trade", es: "Grandes concentraciones de cerámica importada, monedas extranjeras y documentos aduaneros del comercio del Mar Rojo", de: "Große Konzentrationen importierter Keramik, ausländischer Münzen und Zolldokumente aus dem Roten Meer-Handel", nl: "Grote concentraties van geïmporteerd aardewerk, buitenlandse munten en douane documenten van Rode Zee handel" },
          { en: "Gold refining facilities", es: "Instalaciones de refinación de oro", de: "Goldraffinerie-Anlagen", nl: "Goud raffinaderij faciliteiten" },
          { en: "Textile production centers", es: "Centros de producción textil", de: "Textilproduktionszentren", nl: "Textiel productie centra" },
          { en: "Wine storage complexes", es: "Complejos de almacenamiento de vino", de: "Weinlagerkomplexe", nl: "Wijn opslag complexen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Symmetrical dual temple design with parallel sanctuaries for two deities", es: "Diseño de templo dual simétrico con santuarios paralelos para dos deidades", de: "Symmetrisches Doppeltempeldesign mit parallelen Heiligtümern für zwei Gottheiten", nl: "Symmetrisch dubbel tempel ontwerp met parallelle heiligdommen voor twee goden" },
          { en: "Spiral staircase system", es: "Sistema de escaleras en espiral", de: "Spiraaltreppen-System", nl: "Spiraalvormig trappensysteem" },
          { en: "Retractable roof mechanism", es: "Mecanismo de techo retráctil", de: "Einziehbarer Dachmechanismus", nl: "Intrekbaar dak mechanisme" },
          { en: "Rotating altar platform", es: "Plataforma de altar giratorio", de: "Rotierende Altarplattform", nl: "Roterend altaar platform" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Stratified settlement layers showing continuous occupation from Neolithic through Dynastic periods with early administrative buildings", es: "Capas de asentamiento estratificadas mostrando ocupación continua desde períodos neolíticos hasta dinásticos con edificios administrativos tempranos", de: "Geschichtete Siedlungsschichten zeigen kontinuierliche Besiedlung von der Jungsteinzeit bis zu dynastischen Perioden mit frühen Verwaltungsgebäuden", nl: "Gelaagde nederzettings lagen die continue bewoning tonen van Neolithische tot Dynastieke perioden met vroege administratieve gebouwen" },
          { en: "Pyramid complex infrastructure", es: "Infraestructura de complejo piramidal", de: "Pyramidenkomplex-Infrastruktur", nl: "Piramide complex infrastructuur" },
          { en: "Defensive moat system", es: "Sistema de foso defensivo", de: "Defensives Grabensystem", nl: "Defensief gracht systeem" },
          { en: "Royal hunting grounds", es: "Terrenos reales de caza", de: "Königliche Jagdgründe", nl: "Koninklijke jacht gronden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Concentrated glass and faience workshops in the southern suburbs near raw material sources", es: "Talleres concentrados de vidrio y loza en los suburbios del sur cerca de fuentes de materia prima", de: "Konzentrierte Glas- und Fayence-Werkstätten in den südlichen Vororten nahe Rohstoffquellen", nl: "Geconcentreerde glas en faience werkplaatsen in de zuidelijke voorsteden bij grondstoffen bronnen" },
          { en: "Stone quarrying operations", es: "Operaciones de extracción de piedra", de: "Steinbruchoperationen", nl: "Steen breek operaties" },
          { en: "Metalworking foundries", es: "Fundiciones de trabajo de metal", de: "Metallverarbeitungsgießereien", nl: "Metaalbewerking gieterijen" },
          { en: "Papyrus paper mills", es: "Molinos de papel de papiro", de: "Papyrus-Papiermühlen", nl: "Papyrus papier molens" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Fortified enclosure walls with garrison quarters and weapon storage facilities", es: "Muros de recinto fortificados con barrios de guarnición e instalaciones de almacenamiento de armas", de: "Befestigte Umfassungsmauern mit Garnisonvierteln und Waffenlagereinrichtungen", nl: "Versterkte omheining muren met garnizoen wijken en wapen opslag faciliteiten" },
          { en: "Naval academy complex", es: "Complejo de academia naval", de: "Marineakademie-Komplex", nl: "Marine academie complex" },
          { en: "Chariot racing track", es: "Pista de carreras de carros", de: "Streitwagen-Rennstrecke", nl: "Strijdwagen race baan" },
          { en: "Diplomatic meeting halls", es: "Salas de reuniones diplomáticas", de: "Diplomatische Versammlungshallen", nl: "Diplomatieke vergader zalen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Jewish temple built in Egyptian architectural style alongside traditional Egyptian temples", es: "Templo judío construido en estilo arquitectónico egipcio junto a templos egipcios tradicionales", de: "Jüdischer Tempel im ägyptischen Architekturstil neben traditionellen ägyptischen Tempeln gebaut", nl: "Joodse tempel gebouwd in Egyptische architectonische stijl naast traditionele Egyptische tempels" },
          { en: "Greek oracle centers", es: "Centros de oráculos griegos", de: "Griechische Orakelzentren", nl: "Griekse orakel centra" },
          { en: "Roman basilica complex", es: "Complejo de basílica romana", de: "Römischer Basilika-Komplex", nl: "Romeins basiliek complex" },
          { en: "Persian fire temples", es: "Templos de fuego persas", de: "Persische Feuertempel", nl: "Perzische vuur tempels" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Separate Greek sanctuaries, trading warehouses, and designated foreign merchant quarters", es: "Santuarios griegos separados, almacenes comerciales y barrios de comerciantes extranjeros designados", de: "Getrennte griechische Heiligtümer, Handelslager und ausgewiesene ausländische Händlerviertel", nl: "Aparte Griekse heiligdommen, handels pakhuizen en aangewezen buitenlandse kooplieden wijken" },
          { en: "Amphitheater entertainment complex", es: "Complejo de entretenimiento de anfiteatro", de: "Amphitheater-Unterhaltungskomplex", nl: "Amfitheater entertainment complex" },
          { en: "Olympic training facilities", es: "Instalaciones de entrenamiento olímpico", de: "Olympische Trainingseinrichtungen", nl: "Olympische trainings faciliteiten" },
          { en: "Philosophical academy buildings", es: "Edificios de academia filosófica", de: "Philosophische Akademiegebäude", nl: "Filosofische academie gebouwen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Four major temple complexes dedicated to different deities arranged in cardinal directions", es: "Cuatro complejos de templos principales dedicados a diferentes deidades dispuestos en direcciones cardinales", de: "Vier große Tempelkomplexe verschiedenen Gottheiten gewidmet in Himmelsrichtungen angeordnet", nl: "Vier grote tempelcomplexen gewijd aan verschillende goden gerangschikt in kardinale richtingen" },
          { en: "Circular sanctuary design", es: "Diseño de santuario circular", de: "Kreisförmiges Heiligtums-Design", nl: "Cirkelvormig heiligdom ontwerp" },
          { en: "Underground temple catacombs", es: "Catacumbas de templo subterráneo", de: "Unterirdische Tempelkatakomben", nl: "Ondergrondse tempel catacomben" },
          { en: "Floating temple platforms", es: "Plataformas de templo flotantes", de: "Schwimmende Tempelplattformen", nl: "Drijvende tempel platforms" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Timber storage facilities and maritime workshop remains near ancient harbor areas", es: "Instalaciones de almacenamiento de madera y restos de talleres marítimos cerca de áreas de puerto antiguo", de: "Holzlagereinrichtungen und maritime Werkstattreste in der Nähe antiker Hafengebiete", nl: "Houtopslagfaciliteiten en maritime werkplaats resten bij oude haven gebieden" },
          { en: "Bronze anchor manufacturing sites", es: "Sitios de fabricación de anclas de bronce", de: "Bronze-Anker-Herstellungsstätten", nl: "Bronzen anker productie sites" },
          { en: "Sailor training academies", es: "Academias de entrenamiento de marineros", de: "Seemann-Ausbildungsakademien", nl: "Zeeman trainings academies" },
          { en: "Lighthouse construction yards", es: "Astilleros de construcción de faros", de: "Leuchtturm-Bauwerften", nl: "Vuurtoren bouw werven" }
        ],
        correct: 0,
        explanation: {
