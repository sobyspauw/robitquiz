// Cleopatra Quiz - Level 3: Advanced Knowledge
(function() {
  const level3 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Ptolemy XII Auletes", es: "Ptolomeo XII Auletes", de: "Ptolemaios XII. Auletes", nl: "Ptolemaeus XII Auletes" },
          { en: "Ptolemy XI", es: "Ptolomeo XI", de: "Ptolemaios XI", nl: "Ptolemaeus XI" },
          { en: "Ptolemy X", es: "Ptolomeo X", de: "Ptolemaios X", nl: "Ptolemaeus X" },
          { en: "Ptolemy IX", es: "Ptolomeo IX", de: "Ptolemaios IX", nl: "Ptolemaeus IX" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Aulus Gabinius", es: "Aulo Gabinio", de: "Aulus Gabinius", nl: "Aulus Gabinius" },
          { en: "Marcus Crassus", es: "Marco Craso", de: "Marcus Crassus", nl: "Marcus Crassus" },
      ...
      },
      {
        ...
        options: [
          { en: "The Roman Senate", es: "El Senado Romano", de: "Der römische Senat", nl: "De Romeinse Senaat" },
          { en: "The Regency Council (led by Pothinus, Achillas, and Theodotus)", es: "El Consejo de Regencia (liderado por Potino, Aquilas y Teodoto)", de: "Der Regentschaftsrat (geführt von Pothinus, Achillas und Theodotus)", nl: "De Regentschapsraad (geleid door Pothinus, Achillas en Theodotus)" },
          { en: "The Egyptian Priesthood", es: "El Sacerdocio Egipcio", de: "Die ägyptische Priesterschaft", nl: "Het Egyptische Priesterschap" },
          { en: "The Alexandrian Merchants", es: "Los Mercaderes Alejandrinos", de: "Die alexandrinischen Kaufleute", nl: "De Alexandrijnse Kooplieden" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "She disguised herself as a servant", es: "Se disfrazó de sirvienta", de: "Sie verkleidete sich als Dienerin", nl: "Ze vermomde zich als dienares" },
          { en: "She was smuggled in a carpet/bedding roll", es: "Fue introducida clandestinamente en una alfombra/rollo de ropa de cama", de: "Sie wurde in einem Teppich/Bettzeug eingeschmuggelt", nl: "Ze werd gesmokkeld in een tapijt/beddenrol" },
          { en: "She arrived by boat", es: "Llegó en barco", de: "Sie kam per Boot an", nl: "Ze arriveerde per boot" },
          { en: "She walked through the front gate", es: "Entró por la puerta principal", de: "Sie ging durch das Haupttor", nl: "Ze liep door de hoofdpoort" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "He was exiled to Rome", es: "Fue exiliado a Roma", de: "Er wurde nach Rom verbannt", nl: "Hij werd verbannen naar Rome" },
          { en: "He drowned in the Nile while fleeing", es: "Se ahogó en el Nilo mientras huía", de: "Er ertrank auf der Flucht im Nil", nl: "Hij verdronk in de Nijl tijdens zijn vlucht" },
          { en: "He became Caesar's prisoner", es: "Se convirtió en prisionero de César", de: "Er wurde Cäsars Gefangener", nl: "Hij werd Caesars gevangene" },
          { en: "He ruled Cyprus", es: "Gobernó Chipre", de: "Er regierte Zypern", nl: "Hij regeerde Cyprus" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Her younger brother Ptolemy XIV", es: "Su hermano menor Ptolomeo XIV", de: "Ihren jüngeren Bruder Ptolemaios XIV", nl: "Haar jongere broer Ptolemaeus XIV" },
          { en: "Mark Antony", es: "Marco Antonio", de: "Marcus Antonius", nl: "Marcus Antonius" },
          { en: "A Roman senator", es: "Un senador romano", de: "Einen römischen Senator", nl: "Een Romeinse senator" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A Mediterranean voyage", es: "Un viaje por el Mediterráneo", de: "Eine Mittelmeerfahrt", nl: "Een Middellandse Zee reis" },
          { en: "A Nile River voyage", es: "Un viaje por el río Nilo", de: "Eine Nilflussfahrt", nl: "Een Nijlrivier reis" },
          { en: "A Red Sea expedition", es: "Una expedición por el Mar Rojo", de: "Eine Rotes-Meer-Expedition", nl: "Een Rode Zee expeditie" },
          { en: "A journey to Rome", es: "Un viaje a Roma", de: "Eine Reise nach Rom", nl: "Een reis naar Rome" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "46-44 BCE", es: "46-44 a.C.", de: "46-44 v. Chr.", nl: "46-44 v.Chr." },
          { en: "50-48 BCE", es: "50-48 a.C.", de: "50-48 v. Chr.", nl: "50-48 v.Chr." },
          { en: "42-40 BCE", es: "42-40 a.C.", de: "42-40 v. Chr.", nl: "42-40 v.Chr." },
          { en: "38-36 BCE", es: "38-36 a.C.", de: "38-36 v. Chr.", nl: "38-36 v.Chr." }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cleopatra immediately fled Rome", es: "Cleopatra huyó inmediatamente de Roma", de: "Kleopatra floh sofort aus Rom", nl: "Cleopatra vluchtte onmiddellijk uit Rome" },
          { en: "Cleopatra claimed the Roman throne", es: "Cleopatra reclamó el trono romano", de: "Kleopatra beanspruchte den römischen Thron", nl: "Cleopatra claimde de Romeinse troon" },
          { en: "Cleopatra stayed in Rome for months", es: "Cleopatra permaneció en Roma por meses", de: "Kleopatra blieb monatelang in Rom", nl: "Cleopatra bleef maanden in Rome" },
          { en: "Cleopatra joined the conspirators", es: "Cleopatra se unió a los conspiradores", de: "Kleopatra schloss sich den Verschwörern an", nl: "Cleopatra sloot zich aan bij de samenzweerders" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "He died mysteriously (possibly poisoned)", es: "Murió misteriosamente (posiblemente envenenado)", de: "Er starb unter mysteriösen Umständen (möglicherweise vergiftet)", nl: "Hij stierf mysterieus (mogelijk vergiftigd)" },
          { en: "He was exiled to Cyprus", es: "Fue exiliado a Chipre", de: "Er wurde nach Zypern verbannt", nl: "Hij werd verbannen naar Cyprus" },
          { en: "He became a Roman citizen", es: "Se convirtió en ciudadano romano", de: "Er wurde römischer Bürger", nl: "Hij werd Romeins burger" },
          { en: "He ruled jointly with Cleopatra", es: "Gobernó conjuntamente con Cleopatra", de: "Er regierte gemeinsam mit Kleopatra", nl: "Hij regeerde gezamenlijk met Cleopatra" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Plague epidemic", es: "Epidemia de peste", de: "Pestepidemie", nl: "Pestepidemie" },
          { en: "Drought and famine", es: "Sequía y hambruna", de: "Dürre und Hungersnot", nl: "Droogte en hongersnood" },
          { en: "Civil war", es: "Guerra civil", de: "Bürgerkrieg", nl: "Burgeroorlog" },
          { en: "Barbarian invasion", es: "Invasión bárbara", de: "Barbarische Invasion", nl: "Barbaarse invasie" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Her father's Roman patron who helped restore him to power", es: "El patrón romano de su padre que ayudó a restaurarlo al poder", de: "Der römische Patron ihres Vaters, der ihm half, wieder an die Macht zu kommen", nl: "Haar vaders Romeinse beschermheer die hem hielp aan de macht te komen" },
          { en: "Her uncle", es: "Su tío", de: "Ihr Onkel", nl: "Haar oom" },
          { en: "Her first husband", es: "Su primer esposo", de: "Ihr erster Ehemann", nl: "Haar eerste echtgenoot" },
          { en: "Her military enemy", es: "Su enemigo militar", de: "Ihr militärischer Feind", nl: "Haar militaire vijand" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "He was pleased and rewarded the murderers", es: "Estaba complacido y recompensó a los asesinos", de: "Er war erfreut und belohnte die Mörder", nl: "Hij was tevreden en beloonde de moordenaars" },
          { en: "He was outraged and wept", es: "Estaba indignado y lloró", de: "Er war empört und weinte", nl: "Hij was verontwaardigd en huilde" },
          { en: "He was indifferent", es: "Estaba indiferente", de: "Er war gleichgültig", nl: "Hij was onverschillig" },
          { en: "He immediately left Egypt", es: "Dejó Egipto inmediatamente", de: "Er verließ Ägypten sofort", nl: "Hij verliet Egypte onmiddellijk" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Pharaoh and Prince", es: "Faraón y Príncipe", de: "Pharao und Prinz", nl: "Farao en Prins" },
          { en: "Thea Philopator (Father-Loving Goddess) and Theos Philopator (Father-Loving God)", es: "Thea Philopator (Diosa Amante del Padre) y Theos Philopator (Dios Amante del Padre)", de: "Thea Philopator (Vaterliegende Göttin) und Theos Philopator (Vaterliebender Gott)", nl: "Thea Philopator (Vader-liefdevolle Godin) en Theos Philopator (Vader-liefdevolle God)" },
          { en: "Queen and King", es: "Reina y Rey", de: "Königin und König", nl: "Koningin en Koning" },
          { en: "Empress and Emperor", es: "Emperatriz y Emperador", de: "Kaiserin und Kaiser", nl: "Keizerin en Keizer" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "War between Octavian and Mark Antony", es: "Guerra entre Octavio y Marco Antonio", de: "Krieg zwischen Octavian und Marcus Antonius", nl: "Oorlog tussen Octavianus en Marcus Antonius" },
          { en: "War between the Liberators and the Second Triumvirate", es: "Guerra entre los Libertadores y el Segundo Triunvirato", de: "Krieg zwischen den Befreiern und dem Zweiten Triumvirat", nl: "Oorlog tussen de Bevrijders en het Tweede Triumviraat" },
          { en: "War between Pompey and Caesar", es: "Guerra entre Pompeyo y César", de: "Krieg zwischen Pompeius und Cäsar", nl: "Oorlog tussen Pompeius en Caesar" },
          { en: "War between Brutus and Cassius", es: "Guerra entre Bruto y Casio", de: "Krieg zwischen Brutus und Cassius", nl: "Oorlog tussen Brutus en Cassius" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To marry her", es: "Para casarse con ella", de: "Um sie zu heiraten", nl: "Om met haar te trouwen" },
          { en: "To question her loyalty and demand support", es: "Para cuestionar su lealtad y exigir apoyo", de: "Um ihre Loyalität zu hinterfragen und Unterstützung zu fordern", nl: "Om haar loyaliteit te bevragen en steun te eisen" },
          { en: "To declare war on Egypt", es: "Para declarar la guerra a Egipto", de: "Um Ägypten den Krieg zu erklären", nl: "Om Egypte de oorlog te verklaren" },
          { en: "To offer her a trade agreement", es: "Para ofrecerle un acuerdo comercial", de: "Um ihr ein Handelsabkommen anzubieten", nl: "Om haar een handelsovereenkomst aan te bieden" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The First Triumvirate", es: "El Primer Triunvirato", de: "Das Erste Triumvirat", nl: "Het Eerste Triumviraat" },
          { en: "The Second Triumvirate", es: "El Segundo Triunvirato", de: "Das Zweite Triumvirat", nl: "Het Tweede Triumviraat" },
          { en: "The Roman Consulship", es: "El Consulado Romano", de: "Das römische Konsulat", nl: "Het Romeinse Consulaat" },
          { en: "The Senate Coalition", es: "La Coalición del Senado", de: "Die Senatskoalition", nl: "De Senaatscoalitie" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Octavia Minor (Octavian's sister)", es: "Octavia Menor (hermana de Octavio)", de: "Octavia Minor (Octavians Schwester)", nl: "Octavia Minor (Octavianus' zus)" },
          { en: "Calpurnia", es: "Calpurnia", de: "Calpurnia", nl: "Calpurnia" },
          { en: "Livia", es: "Livia", de: "Livia", nl: "Livia" },
          { en: "Agrippina", es: "Agripina", de: "Agrippina", nl: "Agrippina" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Sun and Moon", es: "Sol y Luna", de: "Sonne und Mond", nl: "Zon en Maan" },
          { en: "East and West", es: "Este y Oeste", de: "Osten und Westen", nl: "Oost en West" },
          { en: "Land and Sea", es: "Tierra y Mar", de: "Land und Meer", nl: "Land en Zee" },
