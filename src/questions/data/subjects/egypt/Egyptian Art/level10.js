// Egyptian Art Quiz - Level 10: Knowledge about Egyptian Art
(function() {
  const level10 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Non-destructive 3D imaging shows ceramic cores made from Nile silt with organic temper, featuring engineered drainage channels and systematic partial retention for structural reinforcement", es: "La imagen 3D no destructiva muestra nucleos ceramicos hechos de limo del Nilo con temple organico, con canales de drenaje disenados y retencion parcial sistematica para refuerzo estructural", de: "Nicht-destruktive 3D-Bildgebung zeigt keramische Kerne aus Nilschlamm mit organischem Zuschlag, mit technisch gestalteten Entwaesserungskanaelen und systematischer Teilbeibehaltung fuer Strukturverstaerkung", nl: "Niet-destructieve 3D beeldvorming toont keramische kernen gemaakt van Nijl slib met organisch temperen, met geengineered drainage kanalen en systematische gedeeltelijke retentie voor structurele versterking" },
          { en: "Cores were always fully removed", es: "Los nucleos siempre se eliminaban completamente", de: "Kerne wurden immer vollstaendig entfernt", nl: "Kernen werden altijd volledig verwijderd" },
          { en: "Sand cores only were used", es: "Solo se usaron nucleos de arena", de: "Nur Sandkerne wurden verwendet", nl: "Alleen zand kernen werden gebruikt" },
          { en: "No internal cores existed", es: "No existian nucleos internos", de: "Keine internen Kerne existierten", nl: "Geen interne kernen bestonden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Mass spectrometry identifies egg proteins in Old Kingdom contexts previously assumed to lack proteinaceous binders, revealing earlier adoption of tempera techniques than previously theorized", es: "La espectrometria de masas identifica proteinas de huevo en contextos del Reino Antiguo que previamente se asumia que carecian de aglutinantes proteicos, revelando una adopcion mas temprana de tecnicas de tempera de lo que se teorizaba anteriormente", de: "Massenspektrometrie identifiziert Eiproteine in Kontexten des Alten Reiches, von denen zuvor angenommen wurde, dass sie keine proteinhaltigen Bindemittel enthalten, was eine fruehere Uebernahme von Temperatechniken offenbart als zuvor theoretisiert", nl: "Massa spectrometrie identificeert ei proteinen in Oud Koninkrijk contexten eerder verondersteld te missen proteinhoudende bindmiddelen, wat eerdere adoptie van tempera technieken onthult dan eerder getheoretiseerd" },
          { en: "No proteins were ever used", es: "Nunca se usaron proteinas", de: "Keine Proteine wurden jemals verwendet", nl: "Geen proteinen werden ooit gebruikt" },
          { en: "Traditional chronology confirmed exactly", es: "Cronologia tradicional confirmada exactamente", de: "Traditionelle Chronologie exakt bestaetigt", nl: "Traditionele chronologie exact bevestigd" },
          { en: "Only plant materials detected", es: "Solo materiales vegetales detectados", de: "Nur pflanzliche Materialien nachgewiesen", nl: "Alleen plant materialen gedetecteerd" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Self-similar scaling patterns in architectural and decorative elements demonstrate implicit understanding of logarithmic spirals, Golden Ratio approximations, and iterative geometric principles predating formal mathematical codification", es: "Patrones de escala autosimilares en elementos arquitectonicos y decorativos demuestran comprension implicita de espirales logaritmicas, aproximaciones de la Proporcion Aurea y principios geometricos iterativos que preceden la codificacion matematica formal", de: "Selbstaehnliche Skalierungsmuster in architektonischen und dekorativen Elementen demonstrieren implizites Verstaendnis logarithmischer Spiralen, Annaeherungen des Goldenen Schnitts und iterativer geometrischer Prinzipien vor formaler mathematischer Kodifizierung", nl: "Zelf-gelijkvormige schaling patronen in architectonische en decoratieve elementen tonen impliciete begrip van logaritmische spiralen, Gulden Snede benaderingen en iteratieve geometrische principes voorafgaand aan formele wiskundige codificatie" },
          { en: "Random pattern generation only", es: "Solo generacion de patrones aleatorios", de: "Nur zufaellige Mustererzeugung", nl: "Alleen willekeurige patroon generatie" },
          { en: "Simple repetition without mathematics", es: "Repeticion simple sin matematicas", de: "Einfache Wiederholung ohne Mathematik", nl: "Eenvoudige herhaling zonder wiskunde" },
          { en: "No mathematical principles detected", es: "No se detectaron principios matematicos", de: "Keine mathematischen Prinzipien nachgewiesen", nl: "Geen wiskundige principes gedetecteerd" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Nanoscale 3D mapping reveals deliberate particle size grading within paint layers: coarse particles at substrate interface for adhesion, progressively finer particles toward surface for optical brilliance and gloss", es: "El mapeo 3D a nanoescala revela gradacion deliberada del tamano de particulas dentro de las capas de pintura: particulas gruesas en la interfaz del sustrato para adhesion, particulas progresivamente mas finas hacia la superficie para brillo optico y lustre", de: "Nanoskalen-3D-Kartierung offenbart absichtliche Partikelgroessenabstufung innerhalb von Farbschichten: grobe Partikel an Substratschnittstelle fuer Haftung, progressiv feinere Partikel zur Oberflaeche fuer optische Brillanz und Glanz", nl: "Nanoschaal 3D mapping onthult opzettelijke deeltjes grootte gradering binnen verf lagen: grove deeltjes bij substraat interface voor adhesie, progressief fijnere deeltjes naar oppervlakte voor optische glans en gloss" },
          { en: "Uniform particle distribution throughout", es: "Distribucion uniforme de particulas en todo", de: "Gleichmaessige Partikelverteilung durchgehend", nl: "Uniforme deeltjes distributie doorheen" },
          { en: "Random particle placement", es: "Colocacion aleatoria de particulas", de: "Zufaellige Partikelplatzierung", nl: "Willekeurige deeltjes plaatsing" },
          { en: "Single particle size only", es: "Solo un tamano de particula", de: "Nur eine Partikelgroesse", nl: "Enkele deeltjes grootte alleen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Triple isotope fingerprinting demonstrates quarry-specific sourcing with temporal shifts: Tura limestone dominated Old Kingdom, Gebel el-Silsila sandstone increased Middle Kingdom, systematic preference for specific stratigraphic layers within quarries indicating quality-based selection", es: "La huella dactilar de triple isotopo demuestra abastecimiento especifico de canteras con cambios temporales: la piedra caliza de Tura domino el Reino Antiguo, la arenisca de Gebel el-Silsila aumento en el Reino Medio, preferencia sistematica por capas estratigraficas especificas dentro de las canteras indicando seleccion basada en calidad", de: "Dreifach-Isotop-Fingerprinting demonstriert steinbruchspezifische Beschaffung mit zeitlichen Verschiebungen: Tura-Kalkstein dominierte Altes Reich, Gebel el-Silsila-Sandstein nahm zu im Mittleren Reich, systematische Praeferenz fuer spezifische stratigraphische Schichten innerhalb von Steinbruechen zeigt qualitaetsbasierte Auswahl", nl: "Drievoudige isotoop fingerprinting toont steengroef-specifieke sourcing met temporele verschuivingen: Tura kalksteen domineerde Oud Koninkrijk, Gebel el-Silsila zandsteen toenam Middenrijk, systematische voorkeur voor specifieke stratigrafische lagen binnen steengroeven aangevend kwaliteit-gebaseerde selectie" },
          { en: "All stone from single source", es: "Toda la piedra de una sola fuente", de: "Alle Steine aus einer Quelle", nl: "Alle steen van enkele bron" },
          { en: "Random quarry selection", es: "Seleccion aleatoria de canteras", de: "Zufaellige Steinbruchauswahl", nl: "Willekeurige steengroef selectie" },
          { en: "Provenance cannot be determined", es: "La procedencia no se puede determinar", de: "Herkunft kann nicht bestimmt werden", nl: "Herkomst kan niet bepaald worden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Graph theory mapping of handwriting connections reveals fluid workshop membership with artists moving between Theban sites, collaborative multi-workshop projects, and knowledge networks transcending assumed rigid guild boundaries", es: "El mapeo de teoria de grafos de conexiones de escritura a mano revela membresia fluida de taller con artistas moviéndose entre sitios tebanos, proyectos colaborativos de multiples talleres y redes de conocimiento que trascienden los limites rigidos de gremios asumidos", de: "Graphentheorie-Kartierung von Handschriftenverbindungen offenbart fluide Werkstattmitgliedschaft mit Kuenstlern, die zwischen thebanischen Staetten wechseln, kollaborative Multi-Werkstatt-Projekte und Wissensnetzwerke, die angenommene starre Zunftgrenzen transzendieren", nl: "Grafentheorie mapping van handschrift verbindingen onthult vloeiende werkplaats lidmaatschap met kunstenaars bewegend tussen Thebaanse sites, collaboratieve multi-werkplaats projecten en kennis netwerken transcenderend veronderstelde rigide gilde grenzen" },
          { en: "Isolated individual workshops only", es: "Solo talleres individuales aislados", de: "Nur isolierte einzelne Werkstaetten", nl: "Alleen geïsoleerde individuele werkplaatsen" },
          { en: "Rigid guild structure confirmed", es: "Estructura de gremio rigida confirmada", de: "Starre Zunftstruktur bestaetigt", nl: "Rigide gilde structuur bevestigd" },
          { en: "No connections between workshops", es: "Sin conexiones entre talleres", de: "Keine Verbindungen zwischen Werkstaetten", nl: "Geen verbindingen tussen werkplaatsen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "aDNA sequencing identifies specific acacia species used for gum with temporal shifts correlating to Saharan climate oscillations, revealing adaptation to changing botanical availability and suggesting environmental drivers of technical evolution", es: "La secuenciacion de ADNa identifica especies especificas de acacia utilizadas para goma con cambios temporales correlacionando con oscilaciones climaticas del Sahara, revelando adaptacion a la disponibilidad botanica cambiante y sugiriendo impulsores ambientales de la evolucion tecnica", de: "aDNA-Sequenzierung identifiziert spezifische Akazienarten, die fuer Gummi verwendet wurden, mit zeitlichen Verschiebungen, die mit saharischen Klimaschwankungen korrelieren, was Anpassung an sich aendernde botanische Verfuegbarkeit offenbart und Umwelttreiber technischer Evolution nahelegt", nl: "aDNA sequencing identificeert specifieke acacia soorten gebruikt voor gom met temporele verschuivingen correleren met Sahara klimaat oscillaties, wat adaptatie aan veranderende botanische beschikbaarheid onthult en milieu drivers van technische evolutie suggereert" },
          { en: "No organic material survives", es: "No sobrevive ningun material organico", de: "Kein organisches Material ueberlebt", nl: "Geen organisch materiaal overleeft" },
          { en: "Single plant species throughout", es: "Una sola especie vegetal en todo momento", de: "Einzelne Pflanzenart durchgehend", nl: "Enkele plant soort doorheen" },
          { en: "DNA too degraded to analyze", es: "ADN demasiado degradado para analizar", de: "DNA zu degradiert zum Analysieren", nl: "DNA te gedegradeerd om te analyseren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Neural network clustering identifies six distinct regional proportion systems previously conflated into single 'canonical' model, with Memphis, Thebes, Abydos, Elephantine, Delta, and Nubian-influenced traditions showing systematic measurement differences", es: "La agrupacion de redes neuronales identifica seis sistemas de proporcion regionales distintos previamente fusionados en un solo modelo 'canonico', con tradiciones influenciadas por Memphis, Tebas, Abydos, Elefantina, Delta y Nubia mostrando diferencias sistematicas de medicion", de: "Neuronale Netzwerk-Clustering identifiziert sechs unterschiedliche regionale Proportionssysteme, die zuvor in ein einziges 'kanonisches' Modell zusammengefasst wurden, wobei Memphis-, Theben-, Abydos-, Elephantine-, Delta- und nubisch beeinflusste Traditionen systematische Messunterschiede zeigen", nl: "Neuraal netwerk clustering identificeert zes onderscheiden regionale verhoudingen systemen eerder samengevoegd in enkel 'canoniek' model, met Memphis, Thebe, Abydos, Elephantine, Delta en Nubische-beinvloede tradities tonend systematische meting verschillen" },
          { en: "Single universal canon confirmed", es: "Canon universal unico confirmado", de: "Einzelner universeller Kanon bestaetigt", nl: "Enkele universele canon bevestigd" },
          { en: "Random variation only", es: "Solo variacion aleatoria", de: "Nur zufaellige Variation", nl: "Alleen willekeurige variatie" },
          { en: "No measurable patterns exist", es: "No existen patrones medibles", de: "Keine messbaren Muster existieren", nl: "Geen meetbare patronen bestaan" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "3D tool mark analysis distinguishes individual artisan hands by chisel width, stroke angle, and rhythm patterns, revealing collaborative workflows with specialized tasks: roughing teams, detail carvers, and polishers working sequentially on monumental pieces", es: "El analisis de marcas de herramientas 3D distingue manos de artesanos individuales por ancho de cincel, angulo de golpe y patrones de ritmo, revelando flujos de trabajo colaborativos con tareas especializadas: equipos de desbaste, talladores de detalles y pulidores trabajando secuencialmente en piezas monumentales", de: "3D-Werkzeugspurenanalyse unterscheidet individuelle Handwerkerhaende durch Meissel breite, Schlagwinkel und Rhythmusmuster und offenbart kollaborative Arbeitsablaeufe mit spezialisierten Aufgaben: Grobbearbeitungsteams, Detailschnitzer und Polierer arbeiten sequentiell an monumentalen Stuecken", nl: "3D gereedschap markeringen analyse onderscheidt individuele ambachtsman handen door beitel breedte, slag hoek en ritme patronen, wat collaboratieve workflows onthult met gespecialiseerde taken: ruw teams, detail snijders en polijsters werkend sequentieel op monumentale stukken" },
          { en: "Single artisan per sculpture", es: "Un solo artesano por escultura", de: "Einzelner Handwerker pro Skulptur", nl: "Enkele ambachtsman per sculptuur" },
          { en: "No tool marks survive", es: "No sobreviven marcas de herramientas", de: "Keine Werkzeugspuren ueberleben", nl: "Geen gereedschap markeringen overleven" },
          { en: "Random work patterns only", es: "Solo patrones de trabajo aleatorios", de: "Nur zufaellige Arbeitsmuster", nl: "Alleen willekeurige werk patronen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Quantitative analysis of compositional elements (figure spacing, hierarchical scaling, negative space distribution) identifies distinct 'master hand' signatures across multiple sites, suggesting individual artistic directors coordinated geographically dispersed royal workshop teams", es: "El analisis cuantitativo de elementos composicionales (espaciado de figuras, escala jerarquica, distribucion de espacio negativo) identifica firmas distintas de 'mano maestra' en multiples sitios, sugiriendo que directores artisticos individuales coordinaron equipos de talleres reales geograficamente dispersos", de: "Quantitative Analyse kompositorischer Elemente (Figurenabstand, hierarchische Skalierung, Negativraumverteilung) identifiziert unterschiedliche 'Meisterhand'-Signaturen ueber mehrere Staetten hinweg, was nahelegt, dass individuelle kuenstlerische Direktoren geographisch verteilte koenigliche Werkstattteams koordinierten", nl: "Kwantitatieve analyse van compositorische elementen (figuur afstand, hierarchische schaling, negatieve ruimte distributie) identificeert onderscheiden 'meester hand' signaturen over meerdere sites, wat suggereert individuele artistieke directeurs coordineerden geografisch verspreide koninklijke werkplaats teams" },
          { en: "All royal works identical", es: "Todas las obras reales identicas", de: "Alle koeniglichen Werke identisch", nl: "Alle koninklijke werken identiek" },
          { en: "No individual styles detectable", es: "No se detectan estilos individuales", de: "Keine individuellen Stile nachweisbar", nl: "Geen individuele stijlen detecteerbaar" },
          { en: "Random compositional choices", es: "Elecciones composicionales aleatorias", de: "Zufaellige kompositorische Entscheidungen", nl: "Willekeurige compositorische keuzes" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Full-wall elemental mapping reveals extensive underpaint modifications, compositional changes, and iconographic corrections invisible to traditional examination, documenting iterative design processes and theological adjustments during construction", es: "El mapeo elemental de pared completa revela extensas modificaciones de pintura inferior, cambios composicionales y correcciones iconograficas invisibles para el examen tradicional, documentando procesos de diseno iterativos y ajustes teologicos durante la construccion", de: "Vollwand-Elementkartierung offenbart umfangreiche Untermalungsmodifikationen, kompositorische Aenderungen und ikonographische Korrekturen, die fuer traditionelle Untersuchung unsichtbar sind, dokumentiert iterative Designprozesse und theologische Anpassungen waehrend des Baus", nl: "Volledige muur elementaire mapping onthult uitgebreide onderschildering modificaties, compositorische veranderingen en iconografische correcties onzichtbaar voor traditionele onderzoek, documenterend iteratieve ontwerp processen en theologische aanpassingen tijdens constructie" },
          { en: "No changes during painting process", es: "Sin cambios durante el proceso de pintura", de: "Keine Aenderungen waehrend des Malprozesses", nl: "Geen veranderingen tijdens schilder proces" },
          { en: "Only surface layer visible", es: "Solo capa superficial visible", de: "Nur Oberflaechenschicht sichtbar", nl: "Alleen oppervlakte laag zichtbaar" },
          { en: "Perfect execution without corrections", es: "Ejecucion perfecta sin correcciones", de: "Perfekte Ausfuehrung ohne Korrekturen", nl: "Perfecte uitvoering zonder correcties" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Microfossil and mineral inclusion analysis in pigments identifies specific wadi systems and elevation zones exploited for ochre, revealing seasonal procurement patterns and landscape knowledge systems predating systematic geographical documentation", es: "El analisis de microfosiles e inclusiones minerales en pigmentos identifica sistemas de wadi especificos y zonas de elevacion explotadas para ocre, revelando patrones de adquisicion estacional y sistemas de conocimiento del paisaje anteriores a la documentacion geografica sistematica", de: "Mikrofossilien- und Mineraleinschlussanalyse in Pigmenten identifiziert spezifische Wadi-Systeme und Hoehenzone, die fuer Ocker ausgebeutet wurden, und offenbart saisonale Beschaffungsmuster und Landschaftswissenssysteme vor systematischer geographischer Dokumentation", nl: "Microfossiel en mineraal insluitsel analyse in pigmenten identificeert specifieke wadi systemen en hoogte zones geexploiteerd voor oker, wat seizoens aanschaf patronen en landschap kennis systemen onthult voorafgaand aan systematische geografische documentatie" },
          { en: "All pigments from single location", es: "Todos los pigmentos de una sola ubicacion", de: "Alle Pigmente von einem einzigen Ort", nl: "Alle pigmenten van enkele locatie" },
          { en: "Landscape information unrecoverable", es: "Informacion del paisaje irrecuperable", de: "Landschaftsinformation nicht wiederherstellbar", nl: "Landschap informatie onherstelbaar" },
          { en: "Random collection without pattern", es: "Recoleccion aleatoria sin patron", de: "Zufaellige Sammlung ohne Muster", nl: "Willekeurige verzameling zonder patroon" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Electron backscatter diffraction mapping of crystal orientation shows Egyptian sculptors systematically carved relative to stone crystallographic planes, exploiting cleavage directions and minimizing fracture risk through empirical understanding of rock microstructure", es: "El mapeo de difraccion de retrodispersion de electrones de orientacion cristalina muestra que los escultores egipcios tallaban sistematicamente en relacion con planos cristalograficos de piedra, explotando direcciones de clivaje y minimizando el riesgo de fractura a traves de la comprension empirica de la microestructura de la roca", de: "Elektronenrueckstreuungs-Beugungskartierung der Kristallorientierung zeigt, dass aegyptische Bildhauer systematisch relativ zu Steinkristallographieebenen schnitzten, Spaltungsrichtungen ausnutzten und Bruchrisiko durch empirisches Verstaendnis der Gesteinsmikrostruktur minimierten", nl: "Elektronen terugverstrooiing diffractie mapping van kristal orientatie toont Egyptische beeldhouwers systematisch sneden relatief aan steen kristallografische vlakken, exploiterend splitsing richtingen en minimaserend fractuur risico door empirisch begrip van rots microstructuur" },
          { en: "Random carving directions", es: "Direcciones de tallado aleatorias", de: "Zufaellige Schnitzrichtungen", nl: "Willekeurige snijwerk richtingen" },
          { en: "No relationship to crystal structure", es: "Sin relacion con la estructura cristalina", de: "Keine Beziehung zur Kristallstruktur", nl: "Geen relatie tot kristal structuur" },
          { en: "Stone structure irrelevant to technique", es: "Estructura de piedra irrelevante para la tecnica", de: "Steinstruktur irrelevant fuer Technik", nl: "Steen structuur irrelevant voor techniek" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Lead isotope signatures reveal earlier onset of Cypriot copper imports than historically documented, with Old Kingdom already accessing Mediterranean sources, challenging isolation models and demonstrating earlier long-distance maritime trade integration", es: "Las firmas de isotopos de plomo revelan un inicio mas temprano de importaciones de cobre chipriota de lo historicamente documentado, con el Reino Antiguo ya accediendo a fuentes mediterraneas, desafiando modelos de aislamiento y demostrando una integracion comercial maritima de larga distancia mas temprana", de: "Bleiisotopensignaturen offenbaren frueheren Beginn zypriotischer Kupferimporte als historisch dokumentiert, wobei das Alte Reich bereits auf mediterrane Quellen zugriff, was Isolationsmodelle herausfordert und frueh ere Langstrecken-Seehandelsintegration demonstriert", nl: "Lood isotoop signaturen onthullen eerdere aanvang van Cypriotische koper imports dan historisch gedocumenteerd, met Oud Koninkrijk reeds toegang hebbend tot Mediterrane bronnen, wat isolatie modellen uitdaagt en eerdere lange-afstand maritieme handel integratie toont" },
          { en: "All copper locally mined", es: "Todo el cobre extraido localmente", de: "Alles Kupfer lokal abgebaut", nl: "Alle koper lokaal gedolven" },
          { en: "Trade began only in New Kingdom", es: "El comercio comenzo solo en el Nuevo Reino", de: "Handel begann erst im Neuen Reich", nl: "Handel begon alleen in Nieuw Koninkrijk" },
          { en: "No Mediterranean connections existed", es: "No existian conexiones mediterraneas", de: "Keine mediterranen Verbindungen existierten", nl: "Geen Mediterrane verbindingen bestonden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Simulation modeling indicates specialized full-time artistic production at Deir el-Medina required minimum 200-person consumer base plus intermittent royal commissions, with production diversity (funerary goods, votive objects, private commissions) essential for economic resilience during royal project gaps", es: "El modelado de simulacion indica que la produccion artistica especializada a tiempo completo en Deir el-Medina requeria una base de consumidores minima de 200 personas mas comisiones reales intermitentes, con diversidad de produccion (bienes funerarios, objetos votivos, comisiones privadas) esencial para la resiliencia economica durante las brechas de proyectos reales", de: "Simulationsmodellierung deutet darauf hin, dass spezialisierte Vollzeit-Kunstproduktion in Deir el-Medina eine Mindestkonsumentenbasis von 200 Personen plus intermittierende koenigliche Auftraege erforderte, wobei Produktionsvielfalt (Grabbeigaben, Votivgegenstoende, private Auftraege) wesentlich fuer wirtschaftliche Widerstandsfaehigkeit waehrend koeniglicher Projektluecken war", nl: "Simulatie modellering geeft aan dat gespecialiseerde voltijd artistieke productie bij Deir el-Medina minimum 200-persoon consument basis plus intermitterende koninklijke opdrachten vereiste, met productie diversiteit (funeraire goederen, votief objecten, prive opdrachten) essentieel voor economische veerkracht tijdens koninklijke project gaten" },
          { en: "Royal commissions alone sustained workshops", es: "Solo las comisiones reales sostenian los talleres", de: "Nur koenigliche Auftraege erhielten Werkstaetten aufrecht", nl: "Alleen koninklijke opdrachten onderhielden werkplaatsen" },
          { en: "Economic factors irrelevant to production", es: "Factores economicos irrelevantes para la produccion", de: "Wirtschaftliche Faktoren irrelevant fuer Produktion", nl: "Economische factoren irrelevant voor productie" },
          { en: "Self-sufficiency without market exchange", es: "Autosuficiencia sin intercambio de mercado", de: "Selbstversorgung ohne Markttausch", nl: "Zelfvoorzienendheid zonder markt uitwisseling" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Integrated Bayesian models combining radiocarbon dates, ceramic seriation, and architectural stratigraphy constrain Amarna stylistic transition to 5-7 year window in early Akhenaten reign, revealing rapid artistic transformation rather than gradual evolution", es: "Los modelos bayesianos integrados que combinan fechas de radiocarbono, seriacion ceramica y estratigrafia arquitectonica restringen la transicion estilistica de Amarna a una ventana de 5-7 anos en el reinado temprano de Akhenaton, revelando una transformacion artistica rapida en lugar de evolucion gradual", de: "Integrierte Bayessche Modelle, die Radiokohlenstoffdaten, Keramikseriierung und architektonische Stratigraphie kombinieren, beschraenken den stilistischen Uebergang von Amarna auf ein 5-7-Jahres-Fenster in der fruehen Regierungszeit Echnatons und offenbaren schnelle kuenstlerische Transformation statt gradueller Evolution", nl: "Geintegreerde Bayesiaanse modellen combinerend radiokoolstof data, keramische seriatie en architectonische stratigrafie beperken Amarna stilistische transitie tot 5-7 jaar venster in vroege Achnaton regeerperiode, wat snelle artistieke transformatie onthult in plaats van geleidelijke evolutie" },
          { en: "Gradual 20-year transition confirmed", es: "Transicion gradual de 20 anos confirmada", de: "Gradueller 20-Jahres-Uebergang bestaetigt", nl: "Geleidelijke 20-jaar transitie bevestigd" },
          { en: "Dating too imprecise for conclusions", es: "Datacion demasiado imprecisa para conclusiones", de: "Datierung zu ungenau fuer Schlussfolgerungen", nl: "Datering te onnauwkeurig voor conclusies" },
          { en: "Single dating method sufficient", es: "Un solo metodo de datacion suficiente", de: "Einzelne Datierungsmethode ausreichend", nl: "Enkele daterings methode voldoende" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Pollen analysis and stable isotopes in organic binders track vegetation changes correlating with technical shifts: transition from plant gums to animal glues during arid phases, revealing climate-driven material substitution and technological adaptation to environmental stress", es: "El analisis de polen e isotopos estables en aglutinantes organicos rastrea cambios de vegetacion correlacionando con cambios tecnicos: transicion de gomas vegetales a colas animales durante fases aridas, revelando sustitucion de material impulsada por el clima y adaptacion tecnologica al estres ambiental", de: "Pollenanalyse und stabile Isotope in organischen Bindemitteln verfolgen Vegetationsveraenderungen, die mit technischen Verschiebungen korrelieren: Uebergang von Pflanzengummis zu Tierleimen waehrend arider Phasen offenbart klimabedingte Materialsubstitution und technologische Anpassung an Umweltstress", nl: "Pollen analyse en stabiele isotopen in organische bindmiddelen volgen vegetatie veranderingen correleren met technische verschuivingen: transitie van plantengommen naar dierlijke lijmen tijdens aride fasen, wat klimaat-gedreven materiaal substitutie en technologische adaptatie aan milieu stress onthult" },
          { en: "Climate had no effect on materials", es: "El clima no tuvo efecto en los materiales", de: "Klima hatte keinen Effekt auf Materialien", nl: "Klimaat had geen effect op materialen" },
          { en: "Constant materials throughout all periods", es: "Materiales constantes durante todos los periodos", de: "Konstante Materialien waehrend aller Perioden", nl: "Constante materialen gedurende alle periodes" },
          { en: "Environmental data unrecoverable", es: "Datos ambientales irrecuperables", de: "Umweltdaten nicht wiederherstellbar", nl: "Milieu data onherstelbaar" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Spatial distribution analysis shows cartouches positioned at mathematically determined focal points using proportional division (thirds, fifths), creating visual anchors that structure viewer attention and integrate text-image relationships through geometric composition principles", es: "El analisis de distribucion espacial muestra cartuchos posicionados en puntos focales determinados matematicamente usando division proporcional (tercios, quintos), creando anclas visuales que estructuran la atencion del espectador e integran relaciones texto-imagen a traves de principios de composicion geometrica", de: "Raeumliche Verteilungsanalyse zeigt Kartuschen an mathematisch bestimmten Brennpunkten positioniert unter Verwendung proportionaler Teilung (Drittel, Fuenftel), die visuelle Anker schaffen, die Betrachteraufmerksamkeit strukturieren und Text-Bild-Beziehungen durch geometrische Kompositionsprinzipien integrieren", nl: "Ruimtelijke distributie analyse toont cartouches gepositioneerd op wiskundig bepaalde brandpunten met proportionele deling (derden, vijfden), creeerend visuele ankers die kijker aandacht structureren en tekst-beeld relaties integreren door geometrische compositie principes" },
          { en: "Random cartouche placement", es: "Colocacion aleatoria de cartuchos", de: "Zufaellige Kartuschenplatzierung", nl: "Willekeurige cartouche plaatsing" },
          { en: "Text independent of composition", es: "Texto independiente de la composicion", de: "Text unabhaengig von Komposition", nl: "Tekst onafhankelijk van compositie" },
          { en: "No systematic placement principles", es: "Sin principios de colocacion sistematica", de: "Keine systematischen Platzierungsprinzipien", nl: "Geen systematische plaatsings principes" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Integrated multi-spectral analysis reconstructs up to five sequential decoration phases in reused tombs, revealing systematic erasure-repainting patterns with iconographic substitutions reflecting changing theological emphasis and political legitimation strategies across dynasties", es: "El analisis multiespectral integrado reconstruye hasta cinco fases de decoracion secuencial en tumbas reutilizadas, revelando patrones sistematicos de borrado-repintado con sustituciones iconograficas que reflejan el enfasis teologico cambiante y estrategias de legitimacion politica a traves de dinastias", de: "Integrierte multispektrale Analyse rekonstruiert bis zu fuenf sequentielle Dekorationsphasen in wiederverwendeten Graebern und offenbart systematische Loesch-Neumalungs-Muster mit ikonographischen Substitutionen, die sich aendernde theologische Betonung und politische Legitimationsstrategien ueber Dynastien hinweg widerspiegeln", nl: "Geintegreerde multi-spectrale analyse reconstrueert tot vijf sequentiele decoratie fasen in hergebruikte tombes, wat systematische uitwis-overschilder patronen onthult met iconografische substituties weerspiegelend veranderende theologische nadruk en politieke legitimatie strategieen over dynastieen" },
          { en: "Single decoration phase only", es: "Solo una fase de decoracion", de: "Nur eine Dekorat ionsphase", nl: "Alleen enkele decoratie fase" },
          { en: "Repainting undetectable", es: "Repintado indetectable", de: "Neumalen nicht nachweisbar", nl: "Overschilderen ondetecteerbaar" },
          { en: "No systematic reuse patterns", es: "Sin patrones de reutilizacion sistematica", de: "Keine systematischen Wiederverwendungsmuster", nl: "Geen systematische hergebruik patronen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Controlled replication experiments with motion capture analysis quantify labor requirements: life-size limestone statue required 280-320 person-hours roughing, 180-220 hours detail carving, 60-80 hours polishing, revealing specialized task division optimized workflow efficiency", es: "Los experimentos de replicacion controlados con analisis de captura de movimiento cuantifican los requisitos laborales: estatua de piedra caliza de tamano natural requeria 280-320 horas-persona de desbaste, 180-220 horas de tallado de detalles, 60-80 horas de pulido, revelando division de tareas especializadas que optimizaba la eficiencia del flujo de trabajo", de: "Kontrollierte Replikationsexperimente mit Motion-Capture-Analyse quantifizieren Arbeitserfordernisse: lebensgrosse Kalksteinstatue erforderte 280-320 Personenstunden Grobbearbeitung, 180-220 Stunden Detailschnitzen, 60-80 Stunden Polieren, was spezialisierte Aufgabenteilung offenbart, die Workflow-Effizienz optimierte", nl: "Gecontroleerde replicatie experimenten met beweging capture analyse kwantificeren arbeid vereisten: levensgroot kalksteen beeld vereiste 280-320 persoon-uren ruw werk, 180-220 uren detail snijwerk, 60-80 uren polijsten, wat gespecialiseerde taak verdeling onthult die workflow efficientie optimaliseerde" },
          { en: "Single artisan completion estimates", es: "Estimaciones de finalizacion de artesano unico", de: "Einzelne Handwerker Fertigstellungsschaetzungen", nl: "Enkele ambachtsman voltooiing schattingen" },
          { en: "Impossible to estimate labor investment", es: "Imposible estimar la inversion laboral", de: "Unmoeglich Arbeitsinvestition zu schaetzen", nl: "Onmogelijk arbeid investering te schatten" },
          { en: "Modern tools provide no insights", es: "Las herramientas modernas no proporcionan informacion", de: "Moderne Werkzeuge bieten keine Einblicke", nl: "Moderne gereedschappen bieden geen inzichten" }
        ],
        correct: 0,
        explanation: {
