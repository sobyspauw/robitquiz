// Ice Cream Desserts Quiz - Level 5
(function() {
  const level5 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Type I only for ice crystal inhibition",
                  "es": "Solo Tipo I para inhibición de cristales de hielo",
                  "de": "Nur Typ I für Eiskristallhemmung",
                  "nl": "Alleen Type I voor ijskristal inhibitie"
        },
        {
                  "en": "Type II provides better ice recrystallization inhibition",
                  "es": "Tipo II proporciona mejor inhibición de recristalización de hielo",
                  "de": "Typ II bietet bessere Eiskristall-Rekristallisationshemmung",
                  "nl": "Type II biedt betere ijs herkristallisatie inhibitie"
        },
        {
                  "en": "No antifreeze proteins are used",
                  "es": "No se usan proteínas anticongelantes",
                  "de": "Keine Frostschutzproteine werden verwendet",
                  "nl": "Geen antivries eiwitten worden gebruikt"
        },
        {
                  "en": "Both types are necessary for optimal texture",
                  "es": "Ambos tipos son necesarios para textura óptima",
                  "de": "Beide Typen sind für optimale Textur notwendig",
                  "nl": "Beide types zijn nodig voor optimale textuur"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Random protein aggregation",
                  "es": "Agregación proteica aleatoria",
                  "de": "Zufällige Proteinaggregation",
                  "nl": "Willekeurige eiwit aggregatie"
        },
        {
                  "en": "Fat crystallization only",
                  "es": "Solo cristalización de grasa",
                  "de": "Nur Fettkristallisation",
                  "nl": "Alleen vetkristallisatie"
        },
        {
                  "en": "Complete protein denaturation",
                  "es": "Desnaturalización proteica completa",
                  "de": "Vollständige Proteindenaturierung",
                  "nl": "Complete eiwitdenaturatie"
        },
        {
                  "en": "Displacement of proteins from fat surface creates network",
                  "es": "Desplazamiento de proteínas de superficie grasa crea red",
                  "de": "Verdrängung von Proteinen von Fettoberfläche schafft Netzwerk",
                  "nl": "Verplaatsing van eiwitten van vetoppervlak creëert netwerk"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Broad distribution from 50-500 mesh",
                  "es": "Distribución amplia de 50-500 malla",
                  "de": "Breite Verteilung von 50-500 Mesh",
                  "nl": "Brede distributie van 50-500 mesh"
        },
        {
                  "en": "Narrow distribution around 200-300 mesh for optimal hydration",
                  "es": "Distribución estrecha alrededor de 200-300 malla para hidratación óptima",
                  "de": "Enge Verteilung um 200-300 Mesh für optimale Hydratation",
                  "nl": "Smalle distributie rond 200-300 mesh voor optimale hydratie"
        },
        {
                  "en": "All particles must be identical size",
                  "es": "Todas las partículas deben ser de tamaño idéntico",
                  "de": "Alle Partikel müssen identische Größe haben",
                  "nl": "Alle deeltjes moeten identieke grootte hebben"
        },
        {
                  "en": "Only very fine particles below 400 mesh",
                  "es": "Solo partículas muy finas debajo de 400 malla",
                  "de": "Nur sehr feine Partikel unter 400 Mesh",
                  "nl": "Alleen zeer fijne deeltjes onder 400 mesh"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Operating above CMC ensures optimal emulsification efficiency",
                  "es": "Operar sobre CMC asegura eficiencia óptima de emulsificación",
                  "de": "Betrieb über CMC gewährleistet optimale Emulgierungseffizienz",
                  "nl": "Opereren boven CMC verzekert optimale emulgeringsefficiëntie"
        },
        {
                  "en": "CMC is irrelevant in ice cream",
                  "es": "CMC es irrelevante en helado",
                  "de": "CMC ist irrelevant in Eis",
                  "nl": "CMC is irrelevant in ijs"
        },
        {
                  "en": "CMC only affects flavor",
                  "es": "CMC solo afecta sabor",
                  "de": "CMC beeinflusst nur Geschmack",
                  "nl": "CMC beïnvloedt alleen smaak"
        },
        {
                  "en": "Must operate below CMC always",
                  "es": "Debe operar debajo de CMC siempre",
                  "de": "Muss immer unter CMC betrieben werden",
                  "nl": "Moet altijd onder CMC opereren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Solo afecta desarrollo de color",
                  "de": "Beeinflusst nur Farbentwicklung",
                  "nl": "Beïnvloedt alleen kleurontwikkeling"
        },
        {
                  "en": "Serum phase is irrelevant to texture",
                  "es": "Fase de suero es irrelevante para textura",
                  "de": "Serumphase ist irrelevant für Textur",
                  "nl": "Serum fase is irrelevant voor textuur"
        },
        {
                  "en": "Determines fat content only",
                  "es": "Determina solo contenido de grasa",
                  "de": "Bestimmt nur Fettgehalt",
                  "nl": "Bepaalt alleen vetgehalte"
        },
        {
                  "en": "Controls ice crystal size through osmotic and colligative effects",
                  "es": "Controla tamaño de cristales de hielo a través de efectos osmóticos y coligativos",
                  "de": "Kontrolliert Eiskristallgröße durch osmotische und kolligative Effekte",
                  "nl": "Controleert ijskristal grootte door osmotische en colligatieve effecten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "200,000-400,000 cP",
                  "es": "200,000-400,000 cP",
                  "de": "200,000-400,000 cP",
                  "nl": "200,000-400,000 cP"
        },
        {
                  "en": "Over 1,000,000 cP",
                  "es": "Sobre 1,000,000 cP",
                  "de": "Über 1,000,000 cP",
                  "nl": "Boven 1,000,000 cP"
        },
        {
                  "en": "50,000-100,000 cP",
                  "es": "50,000-100,000 cP",
                  "de": "50,000-100,000 cP",
                  "nl": "50,000-100,000 cP"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Monitors only temperature changes",
                  "es": "Monitorea solo cambios de temperatura",
                  "de": "Überwacht nur Temperaturänderungen",
                  "nl": "Monitort alleen temperatuurveranderingen"
        },
        {
                  "en": "Sound frequency changes correlate with ice crystal formation and overrun",
                  "es": "Cambios de frecuencia de sonido correlacionan con formación de cristales de hielo y overrun",
                  "de": "Schallfrequenzänderungen korrelieren mit Eiskristallbildung und Übergang",
                  "nl": "Geluidsfrequentie veranderingen correleren met ijskristal vorming en overrun"
        },
        {
                  "en": "Measures fat content only",
                  "es": "Mide solo contenido de grasa",
                  "de": "Misst nur Fettgehalt",
                  "nl": "Meet alleen vetgehalte"
        },
        {
                  "en": "Only detects equipment malfunctions",
                  "es": "Solo detecta fallas de equipo",
                  "de": "Erkennt nur Gerätefehlfunktionen",
                  "nl": "Detecteert alleen apparatuur storingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Hydrocolloid network entraps water and prevents weeping",
                  "es": "Red de hidrocoloide atrapa agua y previene exudación",
                  "de": "Hydrokolloid-Netzwerk fängt Wasser ein und verhindert Ausschwitzen",
                  "nl": "Hydrocolloïd netwerk vangt water en voorkomt uittreden"
        },
        {
                  "en": "pH adjustment only",
                  "es": "Solo ajuste de pH",
                  "de": "Nur pH-Einstellung",
                  "nl": "Alleen pH aanpassing"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Not relevant to ice cream",
                  "es": "No relevante para helado",
                  "de": "Nicht relevant für Eis",
                  "nl": "Niet relevant voor ijs"
        },
        {
                  "en": "Determines fat content",
                  "es": "Determina contenido de grasa",
                  "de": "Bestimmt Fettgehalt",
                  "nl": "Bepaalt vetgehalte"
        },
        {
                  "en": "Characterizes viscoelastic behavior under different time scales",
                  "es": "Caracteriza comportamiento viscoelástico bajo diferentes escalas de tiempo",
                  "de": "Charakterisiert viskoelastisches Verhalten unter verschiedenen Zeitskalen",
                  "nl": "Karakteriseert viscoelastisch gedrag onder verschillende tijdschalen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "1:3:1 (xanthan:guar:carrageenan)",
                  "es": "1:3:1 (xantana:guar:carragenina)",
                  "de": "1:3:1 (Xanthan:Guar:Carrageenan)",
                  "nl": "1:3:1 (xanthaan:guar:carrageenan)"
        },
        {
                  "en": "3:2:1 (xanthan:guar:carrageenan)",
                  "es": "3:2:1 (xantana:guar:carragenina)",
                  "de": "3:2:1 (Xanthan:Guar:Carrageenan)",
                  "nl": "3:2:1 (xanthaan:guar:carrageenan)"
        },
        {
                  "en": "1:1:1 equal ratio",
                  "es": "1:1:1 proporción igual",
                  "de": "1:1:1 gleiches Verhältnis",
                  "nl": "1:1:1 gelijke verhouding"
        },
        {
                  "en": "Only one type should be used",
                  "es": "Solo un tipo debe usarse",
                  "de": "Nur ein Typ sollte verwendet werden",
                  "nl": "Slechts één type moet gebruikt worden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only temperature control prevents drainage",
                  "es": "Solo control de temperatura previene drenaje",
                  "de": "Nur Temperaturkontrolle verhindert Drainage",
                  "nl": "Alleen temperatuur controle voorkomt drainage"
        },
        {
                  "en": "Drainage is beneficial for texture",
                  "es": "Drenaje es beneficioso para textura",
                  "de": "Drainage ist vorteilhaft für Textur",
                  "nl": "Drainage is gunstig voor textuur"
        },
        {
                  "en": "Gravity drainage cannot be prevented",
                  "es": "Drenaje por gravedad no puede prevenirse",
                  "de": "Gravitationsdrainage kann nicht verhindert werden",
                  "nl": "Zwaartekracht drainage kan niet voorkomen worden"
        },
        {
                  "en": "Protein films and fat networks resist drainage through increased viscosity",
                  "es": "Películas de proteína y redes de grasa resisten drenaje a través de viscosidad aumentada",
                  "de": "Proteinfilme und Fettnetzwerke widerstehen Drainage durch erhöhte Viskosität",
                  "nl": "Eiwit films en vet netwerken weerstaan drainage door verhoogde viscositeit"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Lower water mobility always improves texture",
                  "es": "Menor movilidad del agua siempre mejora textura",
                  "de": "Niedrigere Wassermobilität verbessert immer Textur",
                  "nl": "Lagere water mobiliteit verbetert altijd textuur"
        },
        {
                  "en": "Higher water mobility accelerates ice recrystallization",
                  "es": "Mayor movilidad del agua acelera recristalización de hielo",
                  "de": "Höhere Wassermobilität beschleunigt Eiskristall-Rekristallisation",
                  "nl": "Hogere water mobiliteit versnelt ijs herkristallisatie"
        },
        {
                  "en": "Only affects flavor release",
                  "es": "Solo afecta liberación de sabor",
                  "de": "Beeinflusst nur Geschmacksfreisetzung",
                  "nl": "Beïnvloedt alleen smaakafgifte"
        },
        {
                  "en": "Water mobility has no effect on texture",
                  "es": "Movilidad del agua no tiene efecto en textura",
                  "de": "Wassermobilität hat keine Wirkung auf Textur",
                  "nl": "Water mobiliteit heeft geen effect op textuur"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Solo afecta color",
                  "de": "Beeinflusst nur Farbe",
                  "nl": "Beïnvloedt alleen kleur"
        },
        {
                  "en": "Controls temperature only",
                  "es": "Solo controla temperatura",
                  "de": "Kontrolliert nur Temperatur",
                  "nl": "Controleert alleen temperatuur"
        },
        {
                  "en": "Not relevant to ice cream",
                  "es": "No relevante para helado",
        ...
        {
                  "en": "Interfacial elasticity and viscosity determine bubble resistance to coalescence",
                  "es": "Elasticidad interfacial y viscosidad determinan resistencia de burbuja a coalescencia",
                  "de": "Grenzflächenelastizität und -viskosität bestimmen Blasenwiderstand gegen Koaleszenz",
                  "nl": "Interface elasticiteit en viscositeit bepalen bel weerstand tegen coalescentie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only low molecular weight compounds",
                  "es": "Solo compuestos de bajo peso molecular",
                  "de": "Nur niedermolekulare Verbindungen",
                  "nl": "Alleen lage molecuulgewicht verbindingen"
        },
        {
                  "en": "Bimodal distribution with both high and medium MW components",
                  "es": "Distribución bimodal con componentes de MW alto y medio",
                  "de": "Bimodale Verteilung mit hohen und mittleren MW-Komponenten",
                  "nl": "Bimodale distributie met zowel hoge als medium MW componenten"
        },
        {
                  "en": "Molecular weight is irrelevant",
                  "es": "El peso molecular es irrelevante",
                  "de": "Molekulargewicht ist irrelevant",
                  "nl": "Molecuulgewicht is irrelevant"
        },
        {
                  "en": "Only high molecular weight compounds",
                  "es": "Solo compuestos de alto peso molecular",
                  "de": "Nur hochmolekulare Verbindungen",
                  "nl": "Alleen hoge molecuulgewicht verbindingen"
        }
        ],
        correct: 1,
        explanation: {
