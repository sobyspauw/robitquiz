// Ice Cream Desserts Quiz - Level 8
(function() {
  const level8 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Inversely proportional - lower molecular weight provides greater freezing point depression",
                  "es": "Inversamente proporcional - menor peso molecular proporciona mayor depresión del punto de congelación",
                  "de": "Umgekehrt proportional - niedrigeres Molekulargewicht bietet größere Gefrierpunktserniedrigung",
                  "nl": "Omgekeerd evenredig - lager molecuulgewicht biedt grotere vriespuntverlaging"
        },
        {
        ...
        },
        {
                  ...
                  "de": "Direkt proportional",
                  "nl": "Direct evenredig"
        },
        {
                  "en": "Exponentially related",
                  "es": "Exponencialmente relacionado",
                  "de": "Exponentiell verwandt",
                  "nl": "Exponentieel gerelateerd"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Applies only to crystallization",
                  "es": "Se aplica solo a cristalización",
                  "de": "Gilt nur für Kristallisation",
                  "nl": "Geldt alleen voor kristallisatie"
        },
        {
                  "en": "Only describes melting points",
                  "es": "Solo describe puntos de fusión",
                  "de": "Beschreibt nur Schmelzpunkte",
                  "nl": "Beschrijft alleen smeltpunten"
        },
        {
                  "en": "Only applies to pure substances",
                  "es": "Solo se aplica a sustancias puras",
                  "de": "Gilt nur für reine Substanzen",
                  "nl": "Geldt alleen voor pure stoffen"
        },
        {
                  "en": "Relates vapor pressure changes to temperature for first-order phase transitions",
                  "es": "Relaciona cambios de presión de vapor con temperatura para transiciones de fase de primer orden",
                  "de": "Bezieht Dampfdruckänderungen auf Temperatur für Phasenübergänge erster Ordnung",
                  "nl": "Relateert dampdruk veranderingen aan temperatuur voor eerste-orde fase overgangen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Has no effect on nucleation",
                  "es": "No tiene efecto en nucleación",
                  "de": "Hat keine Wirkung auf Nukleation",
                  "nl": "Heeft geen effect op nucleatie"
        },
        {
                  "en": "Creates energy barrier that must be overcome for crystal formation",
                  "es": "Crea barrera energética que debe superarse para formación de cristales",
                  "de": "Erzeugt Energiebarriere, die für Kristallbildung überwunden werden muss",
                  "nl": "Creëert energie barrière die overwonnen moet worden voor kristal vorming"
        },
        {
                  "en": "Determines only crystal size",
                  "es": "Determina solo tamaño del cristal",
                  "de": "Bestimmt nur Kristallgröße",
                  "nl": "Bepaalt alleen kristal grootte"
        },
        {
                  "en": "Only affects crystal color",
                  "es": "Solo afecta color del cristal",
                  "de": "Beeinflusst nur Kristallfarbe",
                  "nl": "Beïnvloedt alleen kristal kleur"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measures only crystal color",
                  "es": "Mide solo color de cristal",
                  "de": "Misst nur Kristallfarbe",
                  "nl": "Meet alleen kristal kleur"
        },
        {
                  "en": "Describes crystallization kinetics including nucleation and growth mechanisms",
                  "es": "Describe cinéticas de cristalización incluyendo mecanismos de nucleación y crecimiento",
                  "de": "Beschreibt Kristallisationskinetik einschließlich Nukleations- und Wachstumsmechanismen",
                  "nl": "Beschrijft kristallisatie kinetiek inclusief nucleatie en groei mechanismen"
        },
        {
                  "en": "Only measures temperature",
                  "es": "Solo mide temperatura",
                  "de": "Misst nur Temperatur",
                  "nl": "Meet alleen temperatuur"
        },
        {
                  "en": "Only applies to metal crystals",
                  "es": "Solo se aplica a cristales metálicos",
                  "de": "Gilt nur für Metallkristalle",
                  "nl": "Geldt alleen voor metaal kristallen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Has no role in phase behavior",
                  "es": "No tiene papel en comportamiento de fases",
                  "de": "Hat keine Rolle im Phasenverhalten",
                  "nl": "Heeft geen rol in fase gedrag"
        },
        {
                  "en": "Only determines crystal color",
                  "es": "Solo determina color del cristal",
                  "de": "Bestimmt nur Kristallfarbe",
                  "nl": "Bepaalt alleen kristal kleur"
        },
        {
                  "en": "Drives mass transfer between phases when μ gradients exist",
                  "es": "Impulsa transferencia de masa entre fases cuando existen gradientes μ",
                  "de": "Treibt Massentransfer zwischen Phasen an, wenn μ-Gradienten existieren",
                  "nl": "Drijft massa overdracht tussen fasen aan wanneer μ gradiënten bestaan"
        },
        {
                  "en": "Only affects flavor compounds",
                  "es": "Solo afecta compuestos de sabor",
                  "de": "Beeinflusst nur Geschmacksverbindungen",
                  "nl": "Beïnvloedt alleen smaak verbindingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  ...
                  "es": "Relación lineal",
                  "de": "Lineare Beziehung",
                  "nl": "Lineaire relatie"
        },
        {
                  "en": "Inverse linear relationship",
                  "es": "Relación lineal inversa",
                  "de": "Inverse lineare Beziehung",
                  "nl": "Omgekeerd lineaire relatie"
        },
        {
                  "en": "Exponential relationship: η = A·exp(Ea/RT)",
                  "es": "Relación exponencial: η = A·exp(Ea/RT)",
                  "de": "Exponentieller Zusammenhang: η = A·exp(Ea/RT)",
                  "nl": "Exponentiële relatie: η = A·exp(Ea/RT)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measures only pH changes",
                  "es": "Mide solo cambios de pH",
                  "de": "Misst nur pH-Änderungen",
                  "nl": "Meet alleen pH veranderingen"
        },
        {
                  "en": "Only measures color changes",
                  "es": "Solo mide cambios de color",
                  "de": "Misst nur Farbänderungen",
                  "nl": "Meet alleen kleur veranderingen"
        },
        {
                  "en": "Only measures crystal size",
                  "es": "Solo mide tamaño de cristal",
                  "de": "Misst nur Kristallgröße",
                  "nl": "Meet alleen kristal grootte"
        },
        {
                  "en": "Measures heat flow differences between sample and reference during controlled temperature changes",
                  "es": "Mide diferencias de flujo de calor entre muestra y referencia durante cambios controlados de temperatura",
                  "de": "Misst Wärmestromunterschiede zwischen Probe und Referenz während kontrollierter Temperaturänderungen",
                  "nl": "Meet warmte stroom verschillen tussen monster en referentie tijdens gecontroleerde temperatuur veranderingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Applies only to liquid systems",
                  "es": "Se aplica solo a sistemas líquidos",
                  "de": "Gilt nur für flüssige Systeme",
                  "nl": "Geldt alleen voor vloeibare systemen"
        },
        {
                  "en": "Only applies to metal alloys",
                  "es": "Solo se aplica a aleaciones metálicas",
                  "de": "Gilt nur für Metalllegierungen",
                  "nl": "Geldt alleen voor metaal legeringen"
        },
        {
                  "en": "Describes temperature dependence of relaxation times and viscosity in glassy state",
                  "es": "Describe dependencia de temperatura de tiempos de relajación y viscosidad en estado vítreo",
                  "de": "Beschreibt Temperaturabhängigkeit von Relaxationszeiten und Viskosität im glasigen Zustand",
                  "nl": "Beschrijft temperatuur afhankelijkheid van relaxatie tijden en viscositeit in glasachtige toestand"
        },
        {
                  "en": "Only measures crystal formation",
                  "es": "Solo mide formación de cristales",
                  "de": "Misst nur Kristallbildung",
                  "nl": "Meet alleen kristal vorming"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only determines water content",
                  "es": "Solo determina contenido de agua",
                  "de": "Bestimmt nur Wassergehalt",
                  "nl": "Bepaalt alleen water gehalte"
        },
        {
                  "en": "Identifies crystal structures and polymorphic forms of fats and sugars",
                  "es": "Identifica estructuras cristalinas y formas polimórficas de grasas y azúcares",
                  "de": "Identifiziert Kristallstrukturen und polymorphe Formen von Fetten und Zuckern",
                  "nl": "Identificeert kristal structuren en polymorfe vormen van vetten en suikers"
        },
        {
                  "en": "Only measures color intensity",
                  "es": "Solo mide intensidad de color",
                  "de": "Misst nur Farbintensität",
                  "nl": "Meet alleen kleur intensiteit"
        },
        {
                  "en": "Only measures temperature",
                  "es": "Solo mide temperatura",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Has no effect on crystal behavior",
                  "es": "No tiene efecto en comportamiento de cristal",
                  "de": "Hat keine Wirkung auf Kristallverhalten",
                  "nl": "Heeft geen effect op kristal gedrag"
        },
        {
                  "en": "Only affects crystal color",
                  "es": "Solo afecta color del cristal",
        ...
        {
                  "en": "Smaller crystals have higher vapor pressure and dissolve preferentially, driving Ostwald ripening",
                  "es": "Cristales menores tienen mayor presión de vapor y se disuelven preferencialmente, impulsando maduración de Ostwald",
                  "de": "Kleinere Kristalle haben höheren Dampfdruck und lösen sich bevorzugt auf, treiben Ostwald-Reifung an",
                  "nl": "Kleinere kristallen hebben hogere dampdruk en lossen bij voorkeur op, drijven Ostwald rijping aan"
        },
        {
                  "en": "Only applies to sugar crystals",
                  "es": "Solo se aplica a cristales de azúcar",
                  "de": "Gilt nur für Zuckerkristalle",
                  "nl": "Geldt alleen voor suiker kristallen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Only determines pH levels",
                  "es": "Solo determina niveles de pH",
                  "de": "Bestimmt nur pH-Werte",
                  "nl": "Bepaalt alleen pH niveaus"
        },
        {
                  "en": "Analyzes molecular mobility and water dynamics through dielectric relaxation",
                  "es": "Analiza movilidad molecular y dinámica del agua a través de relajación dieléctrica",
                  "de": "Analysiert molekulare Mobilität und Wasserdynamik durch dielektrische Relaxation",
                  "nl": "Analyseert moleculaire mobiliteit en water dynamiek door diëlektrische relaxatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Lower surface area increases melting",
                  "es": "Menor área superficial aumenta fusión",
                  "de": "Geringere Oberfläche erhöht Schmelzen",
                  "nl": "Lagere oppervlakte verhoogt smelten"
        },
        {
                  "en": "Only shape matters, not ratio",
                  "es": "Solo forma importa, no proporción",
                  "de": "Nur Form zählt, nicht Verhältnis",
                  "nl": "Alleen vorm is belangrijk, niet verhouding"
        },
        {
                  "en": "Higher surface area-to-volume ratio increases melting rate due to greater heat transfer",
                  "es": "Mayor proporción área superficial-volumen aumenta velocidad de fusión debido a mayor transferencia de calor",
                  "de": "Höheres Oberflächen-zu-Volumen-Verhältnis erhöht Schmelzrate aufgrund größerer Wärmeübertragung",
                  "nl": "Hogere oppervlakte-tot-volume verhouding verhoogt smelt snelheid door grotere warmte overdracht"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measures relaxation times (T1, T2) that reflect water mobility and environment",
                  "es": "Mide tiempos de relajación (T1, T2) que reflejan movilidad y ambiente del agua",
                  "de": "Misst Relaxationszeiten (T1, T2), die Wassermobilität und -umgebung widerspiegeln",
                  "nl": "Meet relaxatie tijden (T1, T2) die water mobiliteit en omgeving reflecteren"
        },
        {
                  "en": "Only measures pH changes",
                  "es": "Solo mide cambios de pH",
                  "de": "Misst nur pH-Änderungen",
                  "nl": "Meet alleen pH veranderingen"
        },
        {
                  "en": "Only determines crystal structure",
                  "es": "Solo determina estructura cristalina",
                  "de": "Bestimmt nur Kristallstruktur",
                  "nl": "Bepaalt alleen kristal structuur"
        },
        {
                  "en": "Only measures water temperature",
                  "es": "Solo mide temperatura del agua",
                  "de": "Misst nur Wassertemperatur",
                  "nl": "Meet alleen water temperatuur"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only measures electrical conductivity",
                  "es": "Solo mide conductividad eléctrica",
                  "de": "Misst nur elektrische Leitfähigkeit",
                  "nl": "Meet alleen elektrische geleidbaarheid"
        },
        {
                  "en": "Measures dynamic mechanical response to oscillatory deformation",
                  "es": "Mide respuesta mecánica dinámica a deformación oscilatoria",
                  "de": "Misst dynamische mechanische Antwort auf oszillierende Deformation",
                  "nl": "Meet dynamische mechanische respons op oscillerende vervorming"
        },
        {
                  "en": "Only determines melting temperature",
                  "es": "Solo determina temperatura de fusión",
                  "de": "Bestimmt nur Schmelztemperatur",
                  "nl": "Bepaalt alleen smelt temperatuur"
        },
        {
                  "en": "Only measures color properties",
                  "es": "Solo mide propiedades de color",
                  "de": "Misst nur Farbeigenschaften",
                  "nl": "Meet alleen kleur eigenschappen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only determines crystal size",
                  "es": "Solo determina tamaño de cristal",
                  "de": "Bestimmt nur Kristallgröße",
                  "nl": "Bepaalt alleen kristal grootte"
        },
        {
                  "en": "Only measures color stability",
                  "es": "Solo mide estabilidad de color",
                  "de": "Misst nur Farbstabilität",
                  "nl": "Meet alleen kleur stabiliteit"
        },
        {
                  "en": "Only measures temperature effects",
                  "es": "Solo mide efectos de temperatura",
                  "de": "Misst nur Temperatureffekte",
                  "nl": "Meet alleen temperatuur effecten"
        },
        {
                  "en": "Describes water activity-moisture content relationships for predicting chemical and physical stability",
                  "es": "Describe relaciones actividad de agua-contenido de humedad para predecir estabilidad química y física",
                  "de": "Beschreibt Wasseraktivität-Feuchtigkeitsgehalt-Beziehungen zur Vorhersage chemischer und physischer Stabilität",
                  "nl": "Beschrijft wateractiviteit-vochtgehalte relaties voor voorspellen van chemische en fysieke stabiliteit"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Real-time monitoring of protein-protein and protein-lipid binding interactions",
                  "es": "Monitoreo en tiempo real de interacciones de unión proteína-proteína y proteína-lípido",
                  "de": "Echtzeitüberwachung von Protein-Protein- und Protein-Lipid-Bindungswechselwirkungen",
                  "nl": "Real-time monitoring van eiwit-eiwit en eiwit-lipide binding interacties"
        },
        {
                  "en": "Only determines crystal structure",
                  "es": "Solo determina estructura cristalina",
        ...
        {
                  "en": "Only measures optical density",
                  "es": "Solo mide densidad óptica",
                  "de": "Misst nur optische Dichte",
                  "nl": "Meet alleen optische dichtheid"
        },
        {
                  "en": "Only measures protein concentration",
                  "es": "Solo mide concentración de proteína",
                  "de": "Misst nur Proteinkonzentration",
                  "nl": "Meet alleen eiwit concentratie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only describes heat capacity",
                  "es": "Solo describe capacidad calorífica",
                  "de": "Beschreibt nur Wärmekapazität",
                  "nl": "Beschrijft alleen warmte capaciteit"
        },
        {
                  "en": "Only applies to liquid systems",
                  "es": "Solo se aplica a sistemas líquidos",
                  "de": "Gilt nur für flüssige Systeme",
                  "nl": "Geldt alleen voor vloeibare systemen"
        },
        {
                  "en": "Only applies to temperature measurement",
                  "es": "Solo se aplica a medición de temperatura",
                  "de": "Gilt nur für Temperaturmessung",
                  "nl": "Geldt alleen voor temperatuur meting"
        },
        {
                  "en": "Relates surface curvature to vapor pressure and solubility of small particles",
                  "es": "Relaciona curvatura superficial con presión de vapor y solubilidad de partículas pequeñas",
                  "de": "Bezieht Oberflächenkrümmung auf Dampfdruck und Löslichkeit kleiner Teilchen",
                  "nl": "Relateert oppervlakte kromming aan dampdruk en oplosbaarheid van kleine deeltjes"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only measures molecular weight",
                  "es": "Solo mide peso molecular",
                  "de": "Misst nur Molekulargewicht",
                  "nl": "Meet alleen molecuul gewicht"
        },
        {
                  "en": "Only applies to metals",
                  "es": "Solo se aplica a metales",
                  "de": "Gilt nur für Metalle",
                  "nl": "Geldt alleen voor metalen"
        },
        {
                  "en": "Only describes crystal formation",
                  "es": "Solo describe formación de cristales",
                  "de": "Beschreibt nur Kristallbildung",
                  "nl": "Beschrijft alleen kristal vorming"
        },
        {
                  "en": "Describes mixing thermodynamics of polymers and solvents in stabilizer solutions",
                  "es": "Describe termodinámica de mezcla de polímeros y solventes en soluciones estabilizadoras",
                  "de": "Beschreibt Mischthermodynamik von Polymeren und Lösungsmitteln in Stabilisatorlösungen",
                  "nl": "Beschrijft mengings thermodynamica van polymeren en oplosmiddelen in stabilisator oplossingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only measures surface temperature",
                  "es": "Solo mide temperatura superficial",
                  "de": "Misst nur Oberflächentemperatur",
                  "nl": "Meet alleen oppervlakte temperatuur"
        },
        {
                  "en": "Only measures crystal hardness",
                  "es": "Solo mide dureza del cristal",
                  "de": "Misst nur Kristallhärte",
                  "nl": "Meet alleen kristal hardheid"
        },
        {
                  "en": "Provides 3D visualization of fat networks, protein matrices, and air cell distribution",
                  "es": "Proporciona visualización 3D de redes de grasa, matrices proteicas, y distribución de células de aire",
                  "de": "Bietet 3D-Visualisierung von Fettnetzwerken, Proteinmatrizen und Luftzellenverteilung",
                  "nl": "Biedt 3D visualisatie van vet netwerken, eiwit matrices, en luchtcel distributie"
        },
        {
                  "en": "Only determines chemical composition",
                  "es": "Solo determina composición química",
                  "de": "Bestimmt nur chemische Zusammensetzung",
                  "nl": "Bepaalt alleen chemische samenstelling"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Predicts polymer-solvent interactions and stabilizer effectiveness in complex ice cream systems",
                  "es": "Predice interacciones polímero-solvente y efectividad de estabilizadores en sistemas complejos de helado",
                  "de": "Sagt Polymer-Lösungsmittel-Wechselwirkungen und Stabilisatorwirksamkeit in komplexen Eissystemen voraus",
                  "nl": "Voorspelt polymeer-oplosmiddel interacties en stabilisator effectiviteit in complexe ijs systemen"
        },
        {
                  "en": "Determines only crystal size",
                  "es": "Determina solo tamaño del cristal",
        ...
        {
                  "en": "Only determines color compatibility",
                  "es": "Solo determina compatibilidad de color",
                  "de": "Bestimmt nur Farbkompatibilität",
                  "nl": "Bepaalt alleen kleur compatibiliteit"
        },
        {
                  "en": "Only measures temperature resistance",
                  "es": "Solo mide resistencia a temperatura",
                  "de": "Misst nur Temperaturbeständigkeit",
                  "nl": "Meet alleen temperatuur weerstand"
        }
        ],
        correct: 0,
        explanation: {
