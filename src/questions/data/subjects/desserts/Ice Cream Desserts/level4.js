// Ice Cream Desserts Quiz - Level 4
(function() {
  const level4 = {
    name: {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fat separation process",
                  "es": "Proceso de separación de grasa",
                  "de": "Fetttrennungsverfahren",
                  "nl": "Vetscheidingsproces"
        },
        {
                  "en": "Large crystals growing at expense of smaller ones",
                  "es": "Cristales grandes creciendo a expensas de los más pequeños",
                  "de": "Große Kristalle wachsen auf Kosten kleinerer",
                  "nl": "Grote kristallen groeien ten koste van kleinere"
        },
        {
                  "en": "Flavor development over time",
                  "es": "Desarrollo de sabor con el tiempo",
                  "de": "Geschmacksentwicklung über Zeit",
                  "nl": "Smaak ontwikkeling over tijd"
        },
        {
                  "en": "Protein coagulation",
                  "es": "Coagulación de proteínas",
                  "de": "Proteingerinnung",
                  "nl": "Eiwitcoagulatie"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It has no effect",
                  "es": "No tiene efecto",
                  "de": "Es hat keine Wirkung",
                  "nl": "Het heeft geen effect"
        },
        {
                  "en": "Lower tension improves air incorporation and stability",
                  "es": "Menor tensión mejora incorporación de aire y estabilidad",
                  "de": "Niedrigere Spannung verbessert Lufteinarbeitung und Stabilität",
                  "nl": "Lagere spanning verbetert luchtinwerking en stabiliteit"
        },
        {
                  "en": "It only affects color",
                  "es": "Solo afecta el color",
                  "de": "Es beeinflusst nur die Farbe",
                  "nl": "Het beïnvloedt alleen kleur"
        },
        {
                  "en": "Higher tension is always better",
                  "es": "Mayor tensión siempre es mejor",
                  "de": "Höhere Spannung ist immer besser",
                  "nl": "Hogere spanning is altijd beter"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Mechanical shear breaking emulsion droplets",
                  "es": "Cizallamiento mecánico rompiendo gotas de emulsión",
                  "de": "Mechanische Scherung bricht Emulsionstropfen",
                  "nl": "Mechanische schuifkracht breekt emulsiedruppels"
        },
        {
                  "en": "Temperature change only",
                  "es": "Solo cambio de temperatura",
                  "de": "Nur Temperaturänderung",
                  "nl": "Alleen temperatuurverandering"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Point of maximum sweetness",
                  "es": "Punto de máximo dulzor",
                  "de": "Punkt maximaler Süße",
                  "nl": "Punt van maximale zoetheid"
        },
        {
                  "en": "Optimal serving temperature",
                  "es": "Temperatura óptima de servicio",
                  "de": "Optimale Serviertemperatur",
                  "nl": "Optimale serveertemperatuur"
        },
        {
                  "en": "Temperature where all water freezes simultaneously",
                  "es": "Temperatura donde toda el agua se congela simultáneamente",
                  "de": "Temperatur, wo alles Wasser gleichzeitig gefriert",
                  "nl": "Temperatuur waar al het water tegelijkertijd bevriest"
        },
        {
                  "en": "Maximum overrun point",
                  "es": "Punto de máximo overrun",
                  "de": "Maximaler Übergangspunkt",
                  "nl": "Maximum overrun punt"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "aw only affects flavor",
                  "es": "aw solo afecta sabor",
                  "de": "aw beeinflusst nur Geschmack",
                  "nl": "aw beïnvloedt alleen smaak"
        },
        {
                  "en": "Higher aw always prevents crystallization",
                  "es": "Mayor aw siempre previene cristalización",
                  "de": "Höhere aw verhindert immer Kristallisation",
                  "nl": "Hogere aw voorkomt altijd kristallisatie"
        },
        {
                  "en": "Lower aw reduces ice crystal growth rate",
                  "es": "Menor aw reduce velocidad de crecimiento de cristales de hielo",
                  "de": "Niedrigere aw reduziert Eiskristallwachstumsrate",
                  "nl": "Lagere aw vermindert ijskristalgroeisnelheid"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only important for color",
                  "es": "Solo importante para color",
                  "de": "Nur wichtig für Farbe",
                  "nl": "Alleen belangrijk voor kleur"
        },
        {
                  "en": "Can affect texture through protein cross-linking",
                  "es": "Puede afectar textura a través de entrecruzamiento de proteínas",
                  "de": "Kann Textur durch Proteinvernetzung beeinflussen",
                  "nl": "Kan textuur beïnvloeden door eiwitverknopping"
        },
        {
                  "en": "No significant role",
                  "es": "Ningún papel significativo",
                  "de": "Keine bedeutende Rolle",
                  "nl": "Geen significante rol"
        },
        {
                  "en": "Only affects freezing point",
                  "es": "Solo afecta punto de congelación",
                  "de": "Beeinflusst nur Gefrierpunkt",
                  "nl": "Beïnvloedt alleen vriespunt"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Concentration of solutes in unfrozen liquid as ice forms",
                  "es": "Concentración de solutos en líquido no congelado cuando se forma hielo",
                  "de": "Konzentration von gelösten Stoffen in ungefrorenem Fluid während Eisbildung",
                  "nl": "Concentratie van opgeloste stoffen in niet-bevroren vloeistof terwijl ijs vormt"
        },
        {
                  "en": "Freezing at very low temperatures",
                  "es": "Congelación a temperaturas muy bajas",
                  "de": "Gefrieren bei sehr niedrigen Temperaturen",
                  "nl": "Bevriezen bij zeer lage temperaturen"
        },
        {
                  "en": "Addition of antifreeze compounds",
                  "es": "Adición de compuestos anticongelantes",
                  "de": "Zugabe von Frostschutzmitteln",
                  "nl": "Toevoeging van antivries verbindingen"
        },
        {
                  "en": "Rapid freezing technique",
                  "es": "Técnica de congelación rápida",
                  "de": "Schnellgefriertechnik",
                  "nl": "Snelvriezer techniek"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They have no effect on ice cream",
                  "es": "No tienen efecto en el helado",
                  "de": "Sie haben keine Wirkung auf Eis",
                  "nl": "Ze hebben geen effect op ijs"
        },
        {
                  "en": "Only affect color development",
                  "es": "Solo afectan desarrollo de color",
                  "de": "Beeinflussen nur Farbentwicklung",
                  "nl": "Beïnvloeden alleen kleurontwikkeling"
        },
        {
                  "en": "Only important in chocolate ice cream",
                  "es": "Solo importante en helado de chocolate",
                  "de": "Nur wichtig in Schokoladeneis",
                  "nl": "Alleen belangrijk in chocolade ijs"
        },
        {
                  "en": "Different crystal forms affect melting properties and mouthfeel",
                  "es": "Diferentes formas de cristal afectan propiedades de derretimiento y sensación en boca",
                  "de": "Verschiedene Kristallformen beeinflussen Schmelzeigenschaften und Mundgefühl",
                  "nl": "Verschillende kristalvormen beïnvloeden smelteigenschappen en mondgevoel"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They promote formation of many small nuclei",
                  "es": "Promueven formación de muchos núcleos pequeños",
                  "de": "Sie fördern Bildung vieler kleiner Kerne",
                  "nl": "Ze bevorderen vorming van veel kleine kernen"
        },
        {
                  "en": "They prevent all crystallization",
                  "es": "Previenen toda cristalización",
                  "de": "Sie verhindern alle Kristallisation",
                  "nl": "Ze voorkomen alle kristallisatie"
        },
        {
                  "en": "They only affect fat crystallization",
                  "es": "Solo afectan cristalización de grasa",
                  "de": "Sie beeinflussen nur Fettkristallisation",
                  "nl": "Ze beïnvloeden alleen vetkristallisatie"
        },
        {
                  "en": "They change the flavor profile",
                  "es": "Cambian el perfil de sabor",
                  "de": "Sie ändern das Geschmacksprofil",
                  "nl": "Ze veranderen het smaakprofiel"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Temperature-independent process",
                  "es": "Proceso independiente de temperatura",
                  "de": "Temperaturunabhängiger Prozess",
                  "nl": "Temperatuur-onafhankelijk proces"
        },
        {
                  "en": "Enzyme-catalyzed reaction",
                  "es": "Reacción catalizada por enzimas",
                  "de": "Enzymkatalysierte Reaktion",
                  "nl": "Enzym-gekatalyseerde reactie"
        },
        {
                  "en": "Random precipitation",
                  "es": "Precipitación aleatoria",
                  "de": "Zufällige Ausfällung",
                  "nl": "Willekeurige precipitatie"
        },
        {
                  "en": "Concentration-dependent nucleation in cryo-concentrated serum",
                  "es": "Nucleación dependiente de concentración en suero crio-concentrado",
                  "de": "Konzentrationsabhängige Nukleation in kryo-konzentriertem Serum",
                  "nl": "Concentratie-afhankelijke nucleatie in cryo-geconcentreerd serum"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Supercooling prevents freezing",
                  "es": "Superenfriamiento previene congelación",
                  "de": "Unterkühlung verhindert Gefrieren",
                  "nl": "Onderkoeling voorkomt bevriezen"
        },
        {
                  "en": "Supercooling only affects color",
                  "es": "Superenfriamiento solo afecta color",
                  "de": "Unterkühlung beeinflusst nur Farbe",
                  "nl": "Onderkoeling beïnvloedt alleen kleur"
        },
        {
                  "en": "No effect on texture",
                  "es": "Ningún efecto en textura",
                  "de": "Keine Wirkung auf Textur",
                  "nl": "Geen effect op textuur"
        },
        {
                  "en": "Higher supercooling creates finer crystal structure",
                  "es": "Mayor superenfriamiento crea estructura cristalina más fina",
                  "de": "Höhere Unterkühlung erzeugt feinere Kristallstruktur",
                  "nl": "Hogere onderkoeling creëert fijnere kristalstructuur"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No role in foam formation",
                  "es": "Ningún papel en formación de espuma",
                  "de": "Keine Rolle in Schaumbildung",
                  "nl": "Geen rol in schuimvorming"
        },
        {
                  "en": "Reduce air-water interfacial tension and stabilize bubbles",
                  "es": "Reducen tensión interfacial aire-agua y estabilizan burbujas",
                  "de": "Reduzieren Luft-Wasser-Grenzflächenspannung und stabilisieren Blasen",
                  "nl": "Verminderen lucht-water oppervlaktespanning en stabiliseren bellen"
        },
        {
                  "en": "Only affect flavor release",
                  "es": "Solo afectan liberación de sabor",
                  "de": "Beeinflussen nur Geschmacksfreisetzung",
                  "nl": "Beïnvloeden alleen smaakafgifte"
        },
        {
                  "en": "Prevent foam formation",
                  "es": "Previenen formación de espuma",
                  "de": "Verhindern Schaumbildung",
                  "nl": "Voorkomen schuimvorming"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "nl": "Chemische reacties"
        },
        {
                  "en": "Temperature gradient only",
                  "es": "Solo gradiente de temperatura",
                  "de": "Nur Temperaturgradient",
                  "nl": "Alleen temperatuur gradiënt"
        },
        {
                  "en": "Reduction in total surface energy",
                  "es": "Reducción en energía superficial total",
                  "de": "Reduzierung der gesamten Oberflächenenergie",
                  "nl": "Vermindering van totale oppervlakte-energie"
        },
        {
                  "en": "Pressure differences",
                  "es": "Diferencias de presión",
                  "de": "Druckunterschiede",
                  "nl": "Drukverschillen"
        }
        ],
        correct: 2,
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pressure required for emulsification",
                  "es": "Presión requerida para emulsificación",
                  "de": "Druck erforderlich für Emulgierung",
                  "nl": "Druk vereist voor emulgering"
        },
        {
                  "en": "Geometric parameter determining surfactant self-assembly",
                  "es": "Parámetro geométrico determinando auto-ensamblaje de surfactante",
                  "de": "Geometrischer Parameter, der Tensid-Selbstorganisation bestimmt",
                  "nl": "Geometrische parameter die oppervlakteactieve stof zelfassemblage bepaalt"
        },
        {
                  "en": "Maximum amount of product in packaging",
                  "es": "Cantidad máxima de producto en empaque",
                  "de": "Maximale Produktmenge in Verpackung",
                  "nl": "Maximale hoeveelheid product in verpakking"
        },
        {
                  "en": "Temperature for optimal mixing",
                  "es": "Temperatura para mezcla óptima",
                  "de": "Temperatur für optimales Mischen",
                  "nl": "Temperatuur voor optimale menging"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only affects melting temperature",
                  "es": "Solo afecta temperatura de derretimiento",
                  "de": "Beeinflusst nur Schmelztemperatur",
                  "nl": "Beïnvloedt alleen smelttemperatuur"
        },
        {
                  "en": "Controls flavor release only",
                  "es": "Solo controla liberación de sabor",
                  "de": "Kontrolliert nur Geschmacksfreisetzung",
                  "nl": "Controleert alleen smaakafgifte"
        },
        {
                  "en": "Creates pressure difference across curved interfaces affecting stability",
                  "es": "Crea diferencia de presión a través de interfaces curvadas afectando estabilidad",
                  "de": "Erzeugt Druckunterschied über gekrümmte Grenzflächen und beeinflusst Stabilität",
                  "nl": "Creëert drukverschil over gekromde interfaces wat stabiliteit beïnvloedt"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Controls ice crystal formation",
                  "es": "Controla formación de cristales de hielo",
                  "de": "Kontrolliert Eiskristallbildung",
                  "nl": "Controleert ijskristal vorming"
        },
        {
                  "en": "Only affects temperature distribution",
                  "es": "Solo afecta distribución de temperatura",
                  "de": "Beeinflusst nur Temperaturverteilung",
                  "nl": "Beïnvloedt alleen temperatuurverdeling"
        },
        {
                  "en": "Describes multicomponent mass transfer of aroma compounds",
                  "es": "Describe transferencia de masa multicomponente de compuestos aromáticos",
                  "de": "Beschreibt Mehrkomponenten-Stoffübertragung von Aromastoffen",
                  "nl": "Beschrijft multicomponent massaoverdracht van aromaverbindingen"
        },
        {
                  "en": "No role in flavor release",
                  "es": "Ningún papel en liberación de sabor",
                  "de": "Keine Rolle bei Geschmacksfreisetzung",
                  "nl": "Geen rol in smaakafgifte"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Not relevant to ice cream processing",
                  "es": "No relevante para procesamiento de helado",
                  "de": "Nicht relevant für Eisverarbeitung",
                  "nl": "Niet relevant voor ijsverwerking"
        },
        {
                  "en": "Only measures temperature gradients",
                  "es": "Solo mide gradientes de temperatura",
                  "de": "Misst nur Temperaturgradienten",
                  "nl": "Meet alleen temperatuurgradiënten"
        },
        {
                  "en": "Ratio of convective to diffusive transport rates",
                  "es": "Proporción de tasas de transporte convectivo a difusivo",
                  "de": "Verhältnis von konvektivem zu diffusivem Transportraten",
                  "nl": "Verhouding van convectieve tot diffusieve transportsnelheden"
        },
        {
                  "en": "Determines only fat content",
                  "es": "Determina solo contenido de grasa",
                  "de": "Bestimmt nur Fettgehalt",
                  "nl": "Bepaalt alleen vetgehalte"
        }
        ],
        correct: 2,
        explanation: {
