// Ice Cream Desserts Quiz - Level 1
(function() {
  const level1 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Water, sugar, and fruit",
                  "es": "Agua, azúcar y fruta",
                  "de": "Wasser, Zucker und Obst",
                  "nl": "Water, suiker en fruit"
        },
        {
                  "en": "Butter, cream, and chocolate",
                  "es": "Mantequilla, crema y chocolate",
                  "de": "Butter, Sahne und Schokolade",
                  "nl": "Boter, room en chocolade"
        },
        {
                  "en": "Cream, sugar, and eggs",
                  "es": "Crema, azúcar y huevos",
                  "de": "Sahne, Zucker und Eier",
                  "nl": "Room, suiker en eieren"
        },
        {
                  "en": "Milk, flour, and vanilla",
                  "es": "Leche, harina y vainilla",
                  "de": "Milch, Mehl und Vanille",
                  "nl": "Melk, meel en vanille"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Italian-style ice cream with less air and more intense flavor",
                  "es": "Helado de estilo italiano con menos aire y sabor más intenso",
                  "de": "Italienisches Eis mit weniger Luft und intensiverem Geschmack",
                  "nl": "Italiaans ijs met minder lucht en intensere smaak"
        },
        {
                  "en": "A type of sorbet",
                  "es": "Un tipo de sorbete",
                  "de": "Eine Art Sorbet",
                  "nl": "Een soort sorbet"
        },
        {
                  "en": "Ice cream with nuts",
                  "es": "Helado con nueces",
                  "de": "Eis mit Nüssen",
                  "nl": "Ijs met noten"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sherbet is frozen, sorbet is not",
                  "es": "El sherbet está congelado, el sorbete no",
                  "de": "Sherbet ist gefroren, Sorbet nicht",
                  "nl": "Sherbet is bevroren, sorbet niet"
        },
        {
        ...
        {
                  "en": "Sorbet is sweeter",
                  "es": "El sorbete es más dulce",
                  "de": "Sorbet ist süßer",
                  "nl": "Sorbet is zoeter"
        },
        {
                  "en": "Sorbet contains no dairy, sherbet contains a small amount of dairy",
                  "es": "El sorbete no contiene lácteos, el sherbet contiene una pequeña cantidad de lácteos",
                  "de": "Sorbet enthält keine Milchprodukte, Sherbet enthält eine kleine Menge Milchprodukte",
                  "nl": "Sorbet bevat geen zuivel, sherbet bevat een kleine hoeveelheid zuivel"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A banana-flavored ice cream",
                  "es": "Un helado con sabor a plátano",
                  "de": "Ein Bananen-Eis",
                  "nl": "Een banaan-gesmaakt ijs"
        },
        {
                  "en": "A dessert with sliced banana, ice cream scoops, and various toppings",
                  "es": "Un postre con plátano en rodajas, bolas de helado y varios aderezos",
                  "de": "Ein Dessert mit geschnittener Banane, Eiskugeln und verschiedenen Toppings",
                  "nl": "Een dessert met gesneden banaan, ijsbolletjes en verschillende toppings"
        },
        {
                  "en": "A type of banana bread",
                  "es": "Un tipo de pan de plátano",
                  "de": "Eine Art Bananenbrot",
                  "nl": "Een soort bananenbrood"
        },
        {
                  "en": "A way to cut bananas",
                  "es": "Una forma de cortar plátanos",
                  "de": "Eine Art, Bananen zu schneiden",
                  "nl": "Een manier om bananen te snijden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Slowly adding warm chocolate to prevent it from hardening into chunks",
                  "es": "Agregar lentamente chocolate tibio para evitar que se endurezca en trozos",
                  "de": "Langsam warme Schokolade hinzufügen, um zu verhindern, dass sie zu Stücken erstarrt",
                  "nl": "Langzaam warme chocolade toevoegen om te voorkomen dat het hard wordt in stukken"
        },
        {
                  "en": "Adding spices to chocolate",
                  "es": "Agregar especias al chocolate",
                  "de": "Gewürze zur Schokolade hinzufügen",
                  "nl": "Kruiden toevoegen aan chocolade"
        },
        {
                  "en": "Making chocolate ice cream",
                  "es": "Hacer helado de chocolate",
                  "de": "Schokoladeneis machen",
                  "nl": "Chocolade-ijs maken"
        },
        {
                  "en": "Melting chocolate completely",
                  "es": "Derretir chocolate completamente",
                  "de": "Schokolade vollständig schmelzen",
                  "nl": "Chocolade volledig smelten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ice cream served on Sunday",
                  "es": "Helado servido en domingo",
                  "de": "Eis serviert am Sonntag",
                  "nl": "Ijs geserveerd op zondag"
        },
        {
                  "en": "Ice cream served with toppings like sauce, whipped cream, and nuts",
                  "es": "Helado servido con aderezos como salsa, crema batida y nueces",
                  "de": "Eis serviert mit Toppings wie Sauce, Schlagsahne und Nüssen",
                  "nl": "Ijs geserveerd met toppings zoals saus, slagroom en noten"
        },
        {
                  "en": "Frozen ice cream",
                  "es": "Helado congelado",
        ...
        {
                  "en": "A type of ice cream flavor",
                  "es": "Un tipo de sabor de helado",
                  "de": "Eine Art Eisgeschmack",
                  "nl": "Een soort ijssmaak"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To preserve the ice cream",
                  "es": "Para preservar el helado",
                  "de": "Um das Eis zu konservieren",
                  "nl": "Om het ijs te bewaren"
        },
        {
                  "en": "To make the ice cream white",
                  "es": "Para hacer el helado blanco",
                  "de": "Um das Eis weiß zu machen",
                  "nl": "Om het ijs wit te maken"
        },
        {
                  "en": "To lower the freezing point of ice and make it colder",
                  "es": "Para reducir el punto de congelación del hielo y hacerlo más frío",
                  "de": "Um den Gefrierpunkt von Eis zu senken und es kälter zu machen",
                  "nl": "Om het vriespunt van ijs te verlagen en het kouder te maken"
        },
        {
                  "en": "To add flavor to the ice cream",
                  "es": "Para agregar sabor al helado",
                  "de": "Um dem Eis Geschmack zu verleihen",
                  "nl": "Om smaak toe te voegen aan het ijs"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Melted ice cream",
                  "es": "Helado derretido",
                  "de": "Geschmolzenes Eis",
                  "nl": "Gesmolten ijs"
        },
        {
                  "en": "Ice cream without sugar",
                  "es": "Helado sin azúcar",
                  "de": "Eis ohne Zucker",
                  "nl": "Ijs zonder suiker"
        },
        {
                  "en": "Ice cream for children",
                  "es": "Helado para niños",
                  "de": "Eis für Kinder",
                  "nl": "Ijs voor kinderen"
        },
        {
                  "en": "Ice cream served at a warmer temperature with a softer, creamier texture",
                  "es": "Helado servido a una temperatura más cálida con una textura más suave y cremosa",
                  "de": "Eis serviert bei wärmerer Temperatur mit weicherer, cremigerer Textur",
                  "nl": "Ijs geserveerd op een warmere temperatuur met een zachtere, romige textuur"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bread and ice cream",
                  "es": "Pan y helado",
                  "de": "Brot und Eis",
                  "nl": "Brood en ijs"
        },
        {
                  "en": "Two cookies or wafers with ice cream in between",
                  "es": "Dos galletas u obleas con helado en el medio",
                  "de": "Zwei Kekse oder Waffeln mit Eis dazwischen",
                  "nl": "Twee koekjes of wafels met ijs ertussen"
        },
        {
                  "en": "Cake and ice cream",
                  "es": "Pastel y helado",
                  "de": "Kuchen und Eis",
                  "nl": "Cake en ijs"
        },
        {
                  "en": "Crackers and sorbet",
                  "es": "Galletas saladas y sorbete",
                  "de": "Cracker und Sorbet",
                  "nl": "Crackers en sorbet"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Slightly warmer temperature",
                  "es": "Temperatura ligeramente más cálida",
                  "de": "Etwas wärmere Temperatur",
                  "nl": "Iets warmere temperatuur"
        },
        {
                  "en": "Room temperature",
        ...
        {
                  "en": "Exactly the same temperature",
                  "es": "Exactamente la misma temperatura",
                  "de": "Genau die gleiche Temperatur",
                  "nl": "Precies dezelfde temperatuur"
        },
        {
                  "en": "Much colder temperature",
                  "es": "Temperatura mucho más fría",
                  "de": "Viel kältere Temperatur",
                  "nl": "Veel koudere temperatuur"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Frozen yogurt cannot be flavored",
                  "es": "El yogur congelado no puede tener sabor",
                  "de": "Gefrorener Joghurt kann nicht aromatisiert werden",
                  "nl": "Bevroren yoghurt kan niet op smaak gebracht worden"
        },
        {
                  "en": "Frozen yogurt uses yogurt as a base instead of cream",
                  "es": "El yogur congelado usa yogur como base en lugar de crema",
                  "de": "Gefrorener Joghurt verwendet Joghurt als Basis anstelle von Sahne",
                  "nl": "Bevroren yoghurt gebruikt yoghurt als basis in plaats van room"
        },
        {
                  "en": "Frozen yogurt is always sugar-free",
                  "es": "El yogur congelado siempre no tiene azúcar",
                  "de": "Gefrorener Joghurt ist immer zuckerfrei",
                  "nl": "Bevroren yoghurt is altijd suikervrij"
        },
        {
                  "en": "They are exactly the same",
                  "es": "Son exactamente iguales",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using fresh ingredients",
                  "es": "Usar ingredientes frescos",
                  "de": "Frische Zutaten verwenden",
                  "nl": "Verse ingrediënten gebruiken"
        },
        {
                  "en": "Adding vanilla extract",
                  "es": "Agregar extracto de vainilla",
                  "de": "Vanilleextrakt hinzufügen",
                  "nl": "Vanille extract toevoegen"
        },
        {
                  "en": "Freezing too slowly or not churning enough",
                  "es": "Congelar demasiado lentamente o no batir lo suficiente",
                  "de": "Zu langsames Gefrieren oder nicht genügend Rühren",
                  "nl": "Te langzaam bevriezen of niet genoeg karnen"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "A type of ice cream",
                  "es": "Un tipo de helado",
                  "de": "Eine Art Eis",
                  "nl": "Een soort ijs"
        },
        {
                  "en": "A blended drink made with ice cream and milk",
                  "es": "Una bebida mezclada hecha con helado y leche",
                  "de": "Ein gemischtes Getränk aus Eis und Milch",
                  "nl": "Een gemixte drank gemaakt van ijs en melk"
        },
        {
                  "en": "Flavored milk",
                  "es": "Leche con sabor",
                  "de": "Aromatisierte Milch",
                  "nl": "Gearomatiseerde melk"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It acts as a preservative only",
                  "es": "Solo actúa como conservante",
                  "de": "Es wirkt nur als Konservierungsmittel",
                  "nl": "Het werkt alleen als conserveermiddel"
        },
        {
                  "en": "It changes the color",
                  "es": "Cambia el color",
                  "de": "Es ändert die Farbe",
                  "nl": "Het verandert de kleur"
        },
        {
                  "en": "It has no other purpose",
                  "es": "No tiene otro propósito",
                  "de": "Es hat keinen anderen Zweck",
                  "nl": "Het heeft geen ander doel"
        },
        {
                  "en": "It lowers the freezing point and affects texture",
                  "es": "Reduce el punto de congelación y afecta la textura",
                  "de": "Es senkt den Gefrierpunkt und beeinflusst die Textur",
                  "nl": "Het verlaagt het vriespunt en beïnvloedt de textuur"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ice cream shaped into a bar",
                  "es": "Helado moldeado en barra",
                  "de": "Eis geformt zu einem Riegel",
                  "nl": "Ijs gevormd tot een reep"
        },
        {
                  "en": "Frozen cake",
                  "es": "Pastel congelado",
                  "de": "Gefrorener Kuchen",
                  "nl": "Bevroren cake"
        },
        {
                  "en": "Compressed snow",
                  "es": "Nieve comprimida",
                  "de": "Gepresster Schnee",
                  "nl": "Samengeperste sneeuw"
        },
        {
                  "en": "Flavored liquid frozen on a stick",
                  "es": "Líquido con sabor congelado en un palo",
                  "de": "Aromatisierte Flüssigkeit gefroren auf einem Stiel",
                  "nl": "Gearomatiseerde vloeistof bevroren aan een stokje"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bigger container size",
                  "es": "Tamaño de contenedor más grande",
                  "de": "Größere Behältergröße",
                  "nl": "Grotere containergrootte"
        },
        {
                  "en": "More expensive ingredients only",
                  "es": "Solo ingredientes más caros",
                  "de": "Nur teurere Zutaten",
                  "nl": "Alleen duurdere ingrediënten"
        },
        {
                  "en": "Higher fat content and less air incorporated",
                  "es": "Mayor contenido de grasa y menos aire incorporado",
                  "de": "Höherer Fettgehalt und weniger eingearbeitete Luft",
                  "nl": "Hoger vetgehalte en minder lucht ingewerkt"
        },
        {
                  "en": "Special packaging",
                  "es": "Empaque especial",
                  "de": "Spezialverpackung",
                  "nl": "Speciale verpakking"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  ...
                  "de": "Vanilleeis 'ertränkt' in heißem Espresso",
                  "nl": "Vanille-ijs 'verdronken' in hete espresso"
        },
        {
                  "en": "Chocolate-covered ice cream",
                  "es": "Helado cubierto de chocolate",
                  "de": "Schokoladenüberzogenes Eis",
                  "nl": "Met chocolade bedekt ijs"
        },
        {
                  "en": "Italian ice cream cone",
                  "es": "Cono de helado italiano",
                  "de": "Italienischer Eistüte",
                  "nl": "Italiaans ijshoorntje"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Around -12°C to -15°C (6°F to 10°F)",
                  "es": "Alrededor de -12°C a -15°C (6°F a 10°F)",
                  "de": "Etwa -12°C bis -15°C (6°F bis 10°F)",
                  "nl": "Rond -12°C tot -15°C (6°F tot 10°F)"
        },
        {
                  "en": "Room temperature",
                  "es": "Temperatura ambiente",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ice cream that has melted",
                  "es": "Helado que se ha derretido",
                  "de": "Eis, das geschmolzen ist",
                  "nl": "Ijs dat gesmolten is"
        },
        {
                  "en": "Ice cream with air bubbles",
                  "es": "Helado con burbujas de aire",
                  "de": "Eis mit Luftblasen",
                  "nl": "Ijs met luchtbellen"
        },
        {
                  "en": "A type of ice cream cone",
                  "es": "Un tipo de cono de helado",
                  "de": "Eine Art Eistüte",
                  "nl": "Een soort ijshoorntje"
        },
        {
                  "en": "A scoop of ice cream floating in a soft drink",
                  "es": "Una bola de helado flotando en un refresco",
                  "de": "Eine Eiskugel, die in einem Erfrischungsgetränk schwimmt",
                  "nl": "Een bolletje ijs dat drijft in een frisdrank"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hot and cold flavors",
                  "es": "Sabores calientes y fríos",
                  "de": "Heiße und kalte Geschmäcker",
                  "nl": "Warme en koude smaken"
        },
        {
                  "en": "Vanilla, chocolate, and fruit-based flavors",
                  "es": "Vainilla, chocolate y sabores basados en frutas",
                  "de": "Vanille, Schokolade und fruchtbasierte Geschmäcker",
                  "nl": "Vanille, chocolade en fruitgebaseerde smaken"
        },
        {
                  "en": "Sweet and salty only",
                  "es": "Solo dulce y salado",
                  "de": "Nur süß und salzig",
                  "nl": "Alleen zoet en zout"
        },
        {
                  "en": "Only dairy-based flavors",
                  "es": "Solo sabores basados en lácteos",
                  "de": "Nur milchbasierte Geschmäcker",
                  "nl": "Alleen op zuivel gebaseerde smaken"
        }
        ],
        correct: 1,
        explanation: {
