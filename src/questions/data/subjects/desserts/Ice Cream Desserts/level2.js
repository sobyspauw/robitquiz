// Quiz Template - Level 2: Dessert - IJsdesserts
(function() {
  const level2 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "The amount of air incorporated during churning", es: "La cantidad de aire incorporado durante el batido", de: "Die Menge an Luft, die beim Rühren eingearbeitet wird", nl: "De hoeveelheid lucht die tijdens het karnen wordt ingewerkt" },
          { en: "Excess water in the mixture", es: "Exceso de agua en la mezcla", de: "Überschüssiges Wasser in der Mischung", nl: "Overtollig water in het mengsel" },
          { en: "The melting rate of ice cream", es: "La velocidad de derretimiento del helado", de: "Die Schmelzrate des Eises", nl: "De smeltsnelheid van het ijs" },
      ...
      },
      {
        ...
        options: [
          ...
          { en: "14-16%", es: "14-16%", de: "14-16%", nl: "14-16%" },
      ...
      },
      {
        ...
        options: [
          { en: "Add sweetness", es: "Agregar dulzura", de: "Süße hinzufügen", nl: "Zoetheid toevoegen" },
          { en: "Bind fat and water phases together", es: "Unir las fases de grasa y agua", de: "Fett- und Wasserphasen verbinden", nl: "Vet- en waterfasen samenbinden" },
          { en: "Provide color", es: "Proporcionar color", de: "Farbe bereitstellen", nl: "Kleur verschaffen" },
          { en: "Act as preservatives", es: "Actuar como conservantes", de: "Als Konservierungsmittel wirken", nl: "Fungeren als conserveermiddelen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Temperature fluctuations", es: "Fluctuaciones de temperatura", de: "Temperaturschwankungen", nl: "Temperatuurschommelingen" },
          { en: "Too much fat", es: "Demasiada grasa", de: "Zu viel Fett", nl: "Te veel vet" },
          { en: "Insufficient churning", es: "Batido insuficiente", de: "Unzureichendes Rühren", nl: "Onvoldoende karnen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Control water activity and prevent ice crystals", es: "Controlar la actividad del agua y prevenir cristales de hielo", de: "Wasseraktivität kontrollieren und Eiskristalle verhindern", nl: "Wateractiviteit controleren en ijskristallen voorkomen" },
          { en: "Increase fat content", es: "Aumentar contenido de grasa", de: "Fettgehalt erhöhen", nl: "Vetgehalte verhogen" },
          { en: "Speed up freezing", es: "Acelerar la congelación", de: "Gefrieren beschleunigen", nl: "Bevriezen versnellen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "-12°C to -10°C", es: "-12°C a -10°C", de: "-12°C bis -10°C", nl: "-12°C tot -10°C" },
          { en: "-8°C to -6°C", es: "-8°C a -6°C", de: "-8°C bis -6°C", nl: "-8°C tot -6°C" },
          { en: "0°C", es: "0°C", de: "0°C", nl: "0°C" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Higher fat content", es: "Mayor contenido de grasa", de: "Höherer Fettgehalt", nl: "Hoger vetgehalte" },
          { en: "Slower churning with less air incorporation", es: "Batido más lento con menos incorporación de aire", de: "Langsameres Rühren mit weniger Lufteinarbeitung", nl: "Langzamer karnen met minder luchtinwerking" },
          { en: "More stabilizers", es: "Más estabilizadores", de: "Mehr Stabilisatoren", nl: "Meer stabilisatoren" },
      ...
      },
      {
        ...
        options: [
          { en: "It only affects color", es: "Solo afecta el color", de: "Es beeinflusst nur die Farbe", nl: "Het beïnvloedt alleen de kleur" },
          { en: "Creates complex flavors when heating milk and sugar", es: "Crea sabores complejos al calentar leche y azúcar", de: "Erzeugt komplexe Aromen beim Erhitzen von Milch und Zucker", nl: "Creëert complexe smaken bij het verwarmen van melk en suiker" },
          { en: "It prevents crystallization", es: "Previene la cristalización", de: "Es verhindert Kristallisation", nl: "Het voorkomt kristallisatie" },
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Lower freezing point and improve scoopability", es: "Bajar el punto de congelación y mejorar la capacidad de servir", de: "Gefrierpunkt senken und Portionierbarkeit verbessern", nl: "Vriespunt verlagen en schepbaarheid verbeteren" },
          { en: "Increase fat content", es: "Aumentar contenido de grasa", de: "Fettgehalt erhöhen", nl: "Vetgehalte verhogen" },
          { en: "Act as preservative", es: "Actuar como conservante", de: "Als Konservierungsmittel wirken", nl: "Fungeren als conserveermiddel" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Philadelphia uses eggs, French doesn't", es: "Filadelfia usa huevos, francés no", de: "Philadelphia verwendet Eier, französisch nicht", nl: "Philadelphia gebruikt eieren, Frans niet" },
          { en: "French uses egg custard base, Philadelphia doesn't", es: "Francés usa base de natilla con huevo, Filadelfia no", de: "Französisch verwendet Eiercreme-Basis, Philadelphia nicht", nl: "Frans gebruikt eiercustard basis, Philadelphia niet" },
          { en: "They are exactly the same", es: "Son exactamente iguales", de: "Sie sind genau gleich", nl: "Ze zijn precies hetzelfde" },
          { en: "Philadelphia has more sugar", es: "Filadelfia tiene más azúcar", de: "Philadelphia hat mehr Zucker", nl: "Philadelphia heeft meer suiker" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Too much fat", es: "Demasiada grasa", de: "Zu viel Fett", nl: "Te veel vet" },
          { en: "Too much water and insufficient solids", es: "Demasiada agua e insuficientes sólidos", de: "Zu viel Wasser und unzureichende Feststoffe", nl: "Te veel water en onvoldoende vaste stoffen" },
          { en: "Too much sugar", es: "Demasiado azúcar", de: "Zu viel Zucker", nl: "Te veel suiker" },
          { en: "Churning too long", es: "Batir demasiado tiempo", de: "Zu lange rühren", nl: "Te lang karnen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To melt it completely", es: "Para derretirlo completamente", de: "Um es vollständig zu schmelzen", nl: "Om het volledig te laten smelten" },
          { en: "To warm it slightly for easier scooping and better flavor release", es: "Para calentarlo ligeramente para servir más fácil y mejor liberación de sabor", de: "Um es leicht zu erwärmen für leichteres Portionieren und bessere Aromafreisetzung", nl: "Om het licht op te warmen voor makkelijker scheppen en betere smaakafgifte" },
          { en: "To freeze it harder", es: "Para congelarlo más duro", de: "Um es härter zu gefrieren", nl: "Om het harder te bevriezen" },
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Lowers freezing point and affects texture", es: "Baja el punto de congelación y afecta la textura", de: "Senkt Gefrierpunkt und beeinflusst Textur", nl: "Verlaagt vriespunt en beïnvloedt textuur" },
          { en: "Increases fat content", es: "Aumenta contenido de grasa", de: "Erhöht Fettgehalt", nl: "Verhoogt vetgehalte" },
      ...
      },
      {
        ...
        options: [
          ...
          { en: "20-25 min", es: "20-25 minutos", de: "20-25 Minuten", nl: "20-25 minuten" },
          { en: "45-60 min", es: "45-60 minutos", de: "45-60 Minuten", nl: "45-60 minuten" },
      ...
      },
      {
        ...
        options: [
          { en: "Too little sugar", es: "Muy poco azúcar", de: "Zu wenig Zucker", nl: "Te weinig suiker" },
          { en: "Lactose or sugar crystallization", es: "Cristalización de lactosa o azúcar", de: "Laktose- oder Zuckerkristallisation", nl: "Lactose of suikerkristallisatie" },
      ...
      },
      {
        ...
        options: [
          { en: "To add air to the mixture", es: "Para agregar aire a la mezcla", de: "Um Luft in die Mischung zu geben", nl: "Om lucht aan het mengsel toe te voegen" },
          { en: "To rapidly freeze ice cream and minimize ice crystal formation", es: "Para congelar rápidamente el helado y minimizar la formación de cristales de hielo", de: "Um Eis schnell zu gefrieren und Eiskristallbildung zu minimieren", nl: "Om ijs snel te bevriezen en ijskristalvorming te minimaliseren" },
          { en: "To melt ingredients", es: "Para derretir ingredientes", de: "Um Zutaten zu schmelzen", nl: "Om ingrediënten te smelten" },
          { en: "To heat the mixture", es: "Para calentar la mezcla", de: "Um die Mischung zu erhitzen", nl: "Om het mengsel te verwarmen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Sherbet contains dairy, sorbet is dairy-free", es: "Sherbet contiene lácteos, sorbete no tiene lácteos", de: "Sherbet enthält Milchprodukte, Sorbet ist milchfrei", nl: "Sherbet bevat zuivel, sorbet is zuivelvrij" },
          { en: "They are exactly the same", es: "Son exactamente iguales", de: "Sie sind genau gleich", nl: "Ze zijn precies hetzelfde" },
          { en: "Sorbet contains dairy, sherbet doesn't", es: "Sorbete contiene lácteos, sherbet no", de: "Sorbet enthält Milchprodukte, Sherbet nicht", nl: "Sorbet bevat zuivel, sherbet niet" },
          { en: "Sherbet has more fruit", es: "Sherbet tiene más fruta", de: "Sherbet hat mehr Obst", nl: "Sherbet heeft meer fruit" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "20-25%", es: "20-25%", de: "20-25%", nl: "20-25%" },
          { en: "36-42%", es: "36-42%", de: "36-42%", nl: "36-42%" },
      ...
      },
      {
        ...
        options: [
          { en: "To add air to the mixture", es: "Para agregar aire a la mezcla", de: "Um Luft in die Mischung zu geben", nl: "Om lucht aan het mengsel toe te voegen" },
          { en: "To break down fat globules for smoother texture", es: "Para romper los glóbulos de grasa para una textura más suave", de: "Um Fettkügelchen für glattere Textur zu zerbrechen", nl: "Om vetbolletjes af te breken voor een gladdere textuur" },
          { en: "To heat the mixture", es: "Para calentar la mezcla", de: "Um die Mischung zu erhitzen", nl: "Om het mengsel te verwarmen" },
