    ...
    questions: [
      {
        ...
        options: [
          { en: "Creating caviar pearls; basic and reverse spherification", es: "Crear perlas de caviar; esferificación básica y reversa", de: "Kaviarperlen schaffen; grundlegende und umgekehrte Sphärifikation", nl: "Kaviaar pareltjes creëren; basis en omgekeerde sferificatie" },
          { en: "Making foam bubbles; hot and cold spherification", es: "Hacer burbujas de espuma; esferificación caliente y fría", de: "Schaumbläschen machen; heiße und kalte Sphärifikation", nl: "Schuim bellen maken; warme en koude sferificatie" },
          { en: "Gelifying liquids; internal and external spherification", es: "Gelificar líquidos; esferificación interna y externa", de: "Flüssigkeiten gelieren; interne und externe Sphärifikation", nl: "Vloeistoffen geleren; interne en externe sferificatie" },
          { en: "Creating powder textures; molecular and atomic spherification", es: "Crear texturas de polvo; esferificación molecular y atómica", de: "Pulvertexturen schaffen; molekulare und atomare Sphärifikation", nl: "Poeder texturen creëren; moleculaire en atomaire sferificatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "160-165°C; isomalt is less hygroscopic and doesn't yellow", es: "160-165°C; isomalt es menos higroscópico y no amarillea", de: "160-165°C; Isomalt ist weniger hygroskopisch und vergilbt nicht", nl: "160-165°C; isomalt is minder hygroscopisch en vergelt niet" },
          { en: "145-150°C; isomalt crystallizes slower for better workability", es: "145-150°C; isomalt cristaliza más lento para mejor trabajabilidad", de: "145-150°C; Isomalt kristallisiert langsamer für bessere Bearbeitbarkeit", nl: "145-150°C; isomalt kristalliseert langzamer voor betere bewerkbaarheid" },
          { en: "175-180°C; isomalt has higher melting point", es: "175-180°C; isomalt tiene punto de fusión más alto", de: "175-180°C; Isomalt hat höheren Schmelzpunkt", nl: "175-180°C; isomalt heeft hoger smeltpunt" },
          { en: "155-160°C; isomalt dissolves easier in water", es: "155-160°C; isomalt se disuelve más fácil en agua", de: "155-160°C; Isomalt löst sich leichter in Wasser", nl: "155-160°C; isomalt lost makkelijker op in water" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Grinding cocoa beans; creates smoother texture and removes bitterness", es: "Moler granos de cacao; crea textura más suave y remueve amargura", de: "Kakaobohnen mahlen; schafft glattere Textur und entfernt Bitterkeit", nl: "Cacaobonen malen; creëert gladdere textuur en verwijdert bitterheid" },
          { en: "Heating and mixing chocolate mass; develops flavor and reduces particle size", es: "Calentar y mezclar masa de chocolate; desarrolla sabor y reduce tamaño de partícula", de: "Schokoladenmasse erhitzen und mischen; entwickelt Geschmack und reduziert Partikelgröße", nl: "Chocolademassa verwarmen en mengen; ontwikkelt smaak en reduceert deeltjesgrootte" },
          { en: "Tempering chocolate crystals; ensures proper bloom and snap", es: "Templar cristales de chocolate; asegura florecimiento y chasquido adecuados", de: "Schokoladenkristalle temperieren; gewährleistet richtigen Reif und Knack", nl: "Chocolade kristallen tempereren; verzekert juiste bloei en knak" },
          { en: "Adding cocoa butter; increases smoothness and workability", es: "Agregar manteca de cacao; aumenta suavidad y trabajabilidad", de: "Kakaobutter hinzufügen; erhöht Glätte und Bearbeitbarkeit", nl: "Cacaoboter toevoegen; verhoogt gladheid en bewerkbaarheid" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Prevents crystallization and improves texture; glucose has different freezing properties than sucrose", es: "Previene cristalización y mejora textura; glucosa tiene propiedades de congelación diferentes que sacarosa", de: "Verhindert Kristallisation und verbessert Textur; Glukose hat andere Gefriereigenschaften als Saccharose", nl: "Voorkomt kristallisatie en verbetert textuur; glucose heeft andere bevrieseigenschappen dan sucrose" },
          { en: "Adds sweetness only; no functional difference from sucrose", es: "Solo agrega dulzura; ninguna diferencia funcional de sacarosa", de: "Fügt nur Süße hinzu; kein funktionaler Unterschied zu Saccharose", nl: "Voegt alleen zoetheid toe; geen functioneel verschil van sucrose" },
          { en: "Colors the ice cream; glucose provides golden color", es: "Colorea el helado; glucosa proporciona color dorado", de: "Färbt das Eis; Glukose bietet goldene Farbe", nl: "Kleurt het ijs; glucose geeft gouden kleur" },
          { en: "Increases melting point; makes ice cream more heat stable", es: "Aumenta punto de fusión; hace helado más estable al calor", de: "Erhöht Schmelzpunkt; macht Eis hitzestabiler", nl: "Verhoogt smeltpunt; maakt ijs hittebestendigder" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Choux: cooked paste with eggs, hollow pastries; Sucrée: sweet shortcrust, tart shells", es: "Choux: pasta cocida con huevos, pasteles huecos; Sucrée: masa quebrada dulce, bases de tartas", de: "Choux: gekochter Teig mit Eiern, hohles Gebäck; Sucrée: süßer Mürbeteig, Tartenschalen", nl: "Choux: gekookt deeg met eieren, holle gebakjes; Sucrée: zoete korte deeg, taartbodems" },
          { en: "Both are identical preparations used for different shapes", es: "Ambas son preparaciones idénticas usadas para diferentes formas", de: "Beide sind identische Zubereitungen für verschiedene Formen", nl: "Beide zijn identieke bereidingen gebruikt voor verschillende vormen" },
          { en: "Choux: cold mixing method; Sucrée: hot cooking method", es: "Choux: método de mezcla fría; Sucrée: método de cocción caliente", de: "Choux: kalte Mischmethode; Sucrée: heiße Kochmethode", nl: "Choux: koude mengmethode; Sucrée: warme kookmethode" },
          { en: "Sucrée: laminated dough; Choux: enriched bread dough", es: "Sucrée: masa laminada; Choux: masa de pan enriquecida", de: "Sucrée: laminierter Teig; Choux: angereicherter Brotteig", nl: "Sucrée: gelamineerd deeg; Choux: verrijkt brooddeeg" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Replaces gluten structure; 0.1-0.3% of flour weight", es: "Reemplaza estructura de gluten; 0.1-0.3% del peso de harina", de: "Ersetzt Glutenstruktur; 0.1-0.3% des Mehlgewichts", nl: "Vervangt gluten structuur; 0.1-0.3% van bloem gewicht" },
          { en: "Adds sweetness; 2-3% of total batter weight", es: "Agrega dulzura; 2-3% del peso total de masa", de: "Fügt Süße hinzu; 2-3% des Gesamtteiggewichts", nl: "Voegt zoetheid toe; 2-3% van totaal beslag gewicht" },
          { en: "Prevents spoilage; 0.5-1% of liquid ingredients", es: "Previene deterioro; 0.5-1% de ingredientes líquidos", de: "Verhindert Verderb; 0.5-1% der flüssigen Zutaten", nl: "Voorkomt bederf; 0.5-1% van vloeibare ingrediënten" },
          { en: "Colors the batter; 1-2% of flour weight", es: "Colorea la masa; 1-2% del peso de harina", de: "Färbt den Teig; 1-2% des Mehlgewichts", nl: "Kleurt het beslag; 1-2% van bloem gewicht" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cake flour (6-8% protein) creates tender crumb; all-purpose (10-12%) creates more structure", es: "Harina para pasteles (6-8% proteína) crea miga tierna; multiuso (10-12%) crea más estructura", de: "Kuchenmehl (6-8% Protein) schafft zarte Krume; Allzweck (10-12%) schafft mehr Struktur", nl: "Taartbloem (6-8% eiwit) creëert tere kruim; gewone bloem (10-12%) creëert meer structuur" },
          { en: "No difference in protein; cake flour is just finer ground", es: "No hay diferencia en proteína; harina para pasteles solo está molida más fina", de: "Kein Proteinunterschied; Kuchenmehl ist nur feiner gemahlen", nl: "Geen verschil in eiwit; taartbloem is alleen fijner gemalen" },
          { en: "Cake flour (12-14% protein) for structure; all-purpose (8-10%) for tenderness", es: "Harina para pasteles (12-14% proteína) para estructura; multiuso (8-10%) para terneza", de: "Kuchenmehl (12-14% Protein) für Struktur; Allzweck (8-10%) für Zartheit", nl: "Taartbloem (12-14% eiwit) voor structuur; gewone bloem (8-10%) voor tederheid" },
          { en: "Both identical; only marketing difference", es: "Ambas idénticas; solo diferencia de mercadeo", de: "Beide identisch; nur Marketingunterschied", nl: "Beide identiek; alleen marketing verschil" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Lowers pH to stabilize proteins; 1/8 teaspoon per egg white", es: "Baja pH para estabilizar proteínas; 1/8 cucharadita por clara de huevo", de: "Senkt pH um Proteine zu stabilisieren; 1/8 Teelöffel pro Eiweiß", nl: "Verlaagt pH om eiwitten te stabiliseren; 1/8 theelepel per eiwit" },
          { en: "Adds sweetness and color; 1 tablespoon per cup of egg whites", es: "Agrega dulzura y color; 1 cucharada por taza de claras", de: "Fügt Süße und Farbe hinzu; 1 Esslöffel pro Tasse Eiweiß", nl: "Voegt zoetheid en kleur toe; 1 eetlepel per kop eiwitten" },
          { en: "Increases volume through chemical reaction; 1 teaspoon per egg white", es: "Aumenta volumen por reacción química; 1 cucharadita por clara", de: "Erhöht Volumen durch chemische Reaktion; 1 Teelöffel pro Eiweiß", nl: "Verhoogt volume door chemische reactie; 1 theelepel per eiwit" },
          { en: "Prevents bacterial growth; 1/4 cup per dozen egg whites", es: "Previene crecimiento bacteriano; 1/4 taza por docena de claras", de: "Verhindert Bakterienwachstum; 1/4 Tasse pro Dutzend Eiweiß", nl: "Voorkomt bacteriegroei; 1/4 kop per dozijn eiwitten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Sugar cooked to soft crack, pulled to incorporate air and create satin finish; 130-140°C", es: "Azúcar cocido a quiebre suave, tirado para incorporar aire y crear acabado satinado; 130-140°C", de: "Zucker zu weichem Bruch gekocht, gezogen um Luft einzuarbeiten und Satinfinish zu schaffen; 130-140°C", nl: "Suiker gekookt tot zachte kraak, getrokken om lucht in te werken en satijn afwerking te creëren; 130-140°C" },
          { en: "Sugar heated to hard crack then pulled while warm; working temperature 80-90°C", es: "Azúcar calentado a quiebre duro luego tirado mientras está tibio; temperatura de trabajo 80-90°C", de: "Zucker zu hartem Bruch erhitzt dann warm gezogen; Arbeitstemperatur 80-90°C", nl: "Suiker verhit tot harde kraak dan getrokken terwijl warm; werktemperatuur 80-90°C" },
          { en: "Caramelized sugar stretched to create decorative elements; 160-170°C", es: "Azúcar caramelizado estirado para crear elementos decorativos; 160-170°C", de: "Karamelisierter Zucker gedehnt um dekorative Elemente zu schaffen; 160-170°C", nl: "Gekarameliseerde suiker uitgerekt om decoratieve elementen te creëren; 160-170°C" },
          { en: "Cold sugar paste manipulated by hand; room temperature 20-25°C", es: "Pasta de azúcar fría manipulada a mano; temperatura ambiente 20-25°C", de: "Kalte Zuckerpaste von Hand manipuliert; Raumtemperatur 20-25°C", nl: "Koude suikerpasta met de hand gemanipuleerd; kamertemperatuur 20-25°C" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Acts as emulsifier creating stable foams; thermoreversible unlike gelatin", es: "Actúa como emulsificante creando espumas estables; termorreversible a diferencia de gelatina", de: "Wirkt als Emulgator der stabile Schäume schafft; thermoreversibel anders als Gelatine", nl: "Werkt als emulgator die stabiele schuimen creëert; thermoreversibel in tegenstelling tot gelatine" },
          { en: "Provides sweetness and color; same gelling properties as gelatin", es: "Proporciona dulzura y color; mismas propiedades gelificantes que gelatina", de: "Bietet Süße und Farbe; gleiche Geliereigenschaften wie Gelatine", nl: "Biedt zoetheid en kleur; zelfde geleereigenschappen als gelatine" },
          { en: "Only used for flavoring; has no textural function", es: "Solo usado para saborizar; no tiene función textural", de: "Nur für Aromatisierung verwendet; hat keine Texturfunktion", nl: "Alleen gebruikt voor smaak; heeft geen textuur functie" },
          { en: "Prevents oxidation; identical to gelatin in all other aspects", es: "Previene oxidación; idéntico a gelatina en todos otros aspectos", de: "Verhindert Oxidation; identisch mit Gelatine in allen anderen Aspekten", nl: "Voorkomt oxidatie; identiek aan gelatine in alle andere aspecten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Agar: firm, heat-stable gels from seaweed; Carrageenan: elastic, dairy-reactive gels", es: "Agar: geles firmes y termoestables de algas; Carragenano: geles elásticos reactivos a lácteos", de: "Agar: feste, hitzestabile Gele aus Seetang; Carrageenan: elastische, milchreaktive Gele", nl: "Agar: stevige, hittestabiele gelen van zeewier; Carrageen: elastische, zuivel-reactieve gelen" },
          { en: "Both identical in properties; only differ in source", es: "Ambos idénticos en propiedades; solo difieren en fuente", de: "Beide identisch in Eigenschaften; unterscheiden sich nur in Herkunft", nl: "Beide identiek in eigenschappen; verschillen alleen in bron" },
          { en: "Agar: for cold applications; Carrageenan: for hot applications", es: "Agar: para aplicaciones frías; Carragenano: para aplicaciones calientes", de: "Agar: für kalte Anwendungen; Carrageenan: für heiße Anwendungen", nl: "Agar: voor koude toepassingen; Carrageen: voor warme toepassingen" },
          { en: "Carrageenan: creates hard brittle gels; Agar: creates soft flexible textures", es: "Carragenano: crea geles duros quebradizos; Agar: crea texturas suaves flexibles", de: "Carrageenan: schafft harte spröde Gele; Agar: schafft weiche flexible Texturen", nl: "Carrageen: creëert harde broze gelen; Agar: creëert zachte flexibele texturen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Anti-caking agent preventing clumping; can affect smooth ganache texture", es: "Agente antiaglomerante previniendo grumos; puede afectar textura suave de ganache", de: "Rieselhilfe verhindert Verklumpen; kann glatte Ganache-Textur beeinträchtigen", nl: "Anti-klontering middel voorkomt klonteren; kan gladde ganache textuur beïnvloeden" },
          { en: "Adds sweetness and extends shelf life; improves all applications", es: "Agrega dulzura y extiende vida útil; mejora todas aplicaciones", de: "Fügt Süße hinzu und verlängert Haltbarkeit; verbessert alle Anwendungen", nl: "Voegt zoetheid toe en verlengt houdbaarheid; verbetert alle toepassingen" },
          { en: "Whitening agent for color; no impact on texture or function", es: "Agente blanqueador para color; sin impacto en textura o función", de: "Bleichmittel für Farbe; kein Einfluss auf Textur oder Funktion", nl: "Blekmiddel voor kleur; geen impact op textuur of functie" },
          { en: "Preservative preventing spoilage; essential for all professional work", es: "Conservante previniendo deterioro; esencial para todo trabajo profesional", de: "Konservierungsmittel verhindert Verderb; wesentlich für alle professionelle Arbeit", nl: "Conserveermiddel voorkomt bederf; essentieel voor al het professionele werk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Mix flour with fat first, then add liquids; creates more tender, consistent texture", es: "Mezclar harina con grasa primero, luego agregar líquidos; crea textura más tierna y consistente", de: "Mehl zuerst mit Fett mischen, dann Flüssigkeiten hinzufügen; schafft zartere, konsistentere Textur", nl: "Bloem eerst met vet mengen, dan vloeistoffen toevoegen; creëert terere, consistentere textuur" },
          { en: "Cream sugar with eggs instead of butter; reduces mixing time", es: "Cremar azúcar con huevos en lugar de mantequilla; reduce tiempo de mezcla", de: "Zucker mit Eiern statt Butter aufschlagen; reduziert Mischzeit", nl: "Suiker met eieren in plaats van boter romig maken; vermindert mengtijd" },
          { en: "Add ingredients in reverse order; no functional difference", es: "Agregar ingredientes en orden reverso; ninguna diferencia funcional", de: "Zutaten in umgekehrter Reihenfolge hinzufügen; kein funktionaler Unterschied", nl: "Ingrediënten in omgekeerde volgorde toevoegen; geen functioneel verschil" },
          { en: "Mix everything cold then heat; prevents curdling", es: "Mezclar todo frío luego calentar; previene cuajado", de: "Alles kalt mischen dann erhitzen; verhindert Gerinnung", nl: "Alles koud mengen dan verwarmen; voorkomt schiften" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Inhibits mold and yeast growth; 0.1-0.2% of total weight", es: "Inhibe crecimiento de moho y levadura; 0.1-0.2% del peso total", de: "Hemmt Schimmel- und Hefewachstum; 0.1-0.2% des Gesamtgewichts", nl: "Remt schimmel- en gistgroei; 0.1-0.2% van totaal gewicht" },
          { en: "Adds sweetness and moisture; 2-3% of flour weight", es: "Agrega dulzura y humedad; 2-3% del peso de harina", de: "Fügt Süße und Feuchtigkeit hinzu; 2-3% des Mehlgewichts", nl: "Voegt zoetheid en vocht toe; 2-3% van bloem gewicht" },
          { en: "Improves texture only; 0.5-1% of liquid ingredients", es: "Solo mejora textura; 0.5-1% de ingredientes líquidos", de: "Verbessert nur Textur; 0.5-1% der flüssigen Zutaten", nl: "Verbetert alleen textuur; 0.5-1% van vloeibare ingrediënten" },
          { en: "Colors the cake; 1% of total batter weight", es: "Colorea el pastel; 1% del peso total de masa", de: "Färbt den Kuchen; 1% des Gesamtteiggewichts", nl: "Kleurt de taart; 1% van totaal beslag gewicht" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Forms I-V; Form V (β2) provides best snap, gloss, and stability", es: "Formas I-V; Forma V (β2) proporciona mejor chasquido, brillo y estabilidad", de: "Formen I-V; Form V (β2) bietet besten Knack, Glanz und Stabilität", nl: "Vormen I-V; Vorm V (β2) biedt beste knak, glans en stabiliteit" },
          { en: "Forms A-E; Form A provides the most workable texture", es: "Formas A-E; Forma A proporciona textura más trabajable", de: "Formen A-E; Form A bietet die bearbeitbarste Textur", nl: "Vormen A-E; Vorm A biedt de meest werkbare textuur" },
          { en: "Three forms only; Form III is optimal for all applications", es: "Solo tres formas; Forma III es óptima para todas aplicaciones", de: "Nur drei Formen; Form III ist optimal für alle Anwendungen", nl: "Alleen drie vormen; Vorm III is optimaal voor alle toepassingen" },
          { en: "Six forms; Form VI creates the glossiest finish", es: "Seis formas; Forma VI crea acabado más brillante", de: "Sechs Formen; Form VI schafft das glänzendste Finish", nl: "Zes vormen; Vorm VI creëert de glanzendste afwerking" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Prevents crystallization and creates smooth, pliable texture", es: "Previene cristalización y crea textura suave y maleable", de: "Verhindert Kristallisation und schafft glatte, formbare Textur", nl: "Voorkomt kristallisatie en creëert gladde, plooibare textuur" },
          { en: "Only adds sweetness; no textural benefits", es: "Solo agrega dulzura; ningún beneficio textural", de: "Fügt nur Süße hinzu; keine Texturvorteile", nl: "Voegt alleen zoetheid toe; geen textuur voordelen" },
          { en: "Creates harder, more brittle fondant", es: "Crea fondant más duro y quebradizo", de: "Schafft härteren, spröderes Fondant", nl: "Creëert hardere, brozere fondant" },
          { en: "Used only for coloring; makes fondant whiter", es: "Usado solo para colorear; hace fondant más blanco", de: "Nur für Färbung verwendet; macht Fondant weißer", nl: "Alleen gebruikt voor kleuring; maakt fondant witter" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "-196°C; requires protective equipment, ventilation, and must never touch skin directly", es: "-196°C; requiere equipo protector, ventilación, y nunca debe tocar piel directamente", de: "-196°C; erfordert Schutzausrüstung, Belüftung, und darf niemals Haut direkt berühren", nl: "-196°C; vereist beschermende uitrusting, ventilatie, en mag nooit direct huid raken" },
          { en: "-78°C; safe to handle with bare hands for brief contact", es: "-78°C; seguro manejar con manos desnudas por contacto breve", de: "-78°C; sicher mit bloßen Händen für kurzen Kontakt zu handhaben", nl: "-78°C; veilig om met blote handen aan te raken voor kort contact" },
          { en: "-100°C; only requires eye protection", es: "-100°C; solo requiere protección ocular", de: "-100°C; erfordert nur Augenschutz", nl: "-100°C; vereist alleen oogbescherming" },
          { en: "-250°C; cannot be used safely in food applications", es: "-250°C; no puede usarse seguramente en aplicaciones alimentarias", de: "-250°C; kann nicht sicher in Lebensmittelanwendungen verwendet werden", nl: "-250°C; kan niet veilig gebruikt worden in voedsel toepassingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Dutch process (pH 7-8) requires baking soda; natural (pH 5.3-5.8) works with baking powder", es: "Proceso holandés (pH 7-8) requiere bicarbonato; natural (pH 5.3-5.8) funciona con polvo de hornear", de: "Dutch Process (pH 7-8) benötigt Natron; natürlich (pH 5.3-5.8) funktioniert mit Backpulver", nl: "Nederlandse proces (pH 7-8) vereist zuiveringszout; natuurlijke (pH 5.3-5.8) werkt met bakpoeder" },
          { en: "No difference in pH or leavening interactions", es: "Sin diferencia en pH o interacciones con leudantes", de: "Kein Unterschied in pH oder Triebmittel-Wechselwirkungen", nl: "Geen verschil in pH of rijsmiddel interacties" },
          { en: "Dutch process is more acidic and requires more baking soda", es: "Proceso holandés es más ácido y requiere más bicarbonato", de: "Dutch Process ist saurer und benötigt mehr Natron", nl: "Nederlandse proces is zuurder en vereist meer zuiveringszout" },
          { en: "Natural cocoa is alkaline and works best with acid", es: "Cacao natural es alcalino y funciona mejor con ácido", de: "Natürlicher Kakao ist alkalisch und funktioniert am besten mit Säure", nl: "Natuurlijke cacao is alkalisch en werkt het best met zuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Introduces crystal structure; seed temp 5-10°C below syrup temperature", es: "Introduce estructura cristalina; temp de siembra 5-10°C bajo temperatura del jarabe", de: "Führt Kristallstruktur ein; Impftemperatur 5-10°C unter Siruptemperatur", nl: "Introduceert kristalstructuur; ent temp 5-10°C onder siroop temperatuur" },
          { en: "Only for flavoring; temperature doesn't matter", es: "Solo para saborizar; temperatura no importa", de: "Nur für Aromatisierung; Temperatur spielt keine Rolle", nl: "Alleen voor smaak; temperatuur maakt niet uit" },
          { en: "Prevents crystallization completely; use at same temperature", es: "Previene cristalización completamente; usar a misma temperatura", de: "Verhindert Kristallisation vollständig; bei gleicher Temperatur verwenden", nl: "Voorkomt kristallisatie volledig; gebruik bij zelfde temperatuur" },
          { en: "Creates colored crystals; temperature differential of 20-30°C required", es: "Crea cristales coloreados; diferencial de temperatura de 20-30°C requerido", de: "Schafft farbige Kristalle; Temperaturdifferenz von 20-30°C erforderlich", nl: "Creëert gekleurde kristallen; temperatuurverschil van 20-30°C vereist" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "It makes products sweeter only", es: "Solo hace los productos más dulces", de: "Es macht Produkte nur süßer", nl: "Het maakt producten alleen zoeter" },
          { en: "It prevents crystallization, retains moisture, and extends shelf life", es: "Previene cristalización, retiene humedad y extiende vida útil", de: "Es verhindert Kristallisation, behält Feuchtigkeit und verlängert Haltbarkeit", nl: "Het voorkomt kristallisatie, behoudt vocht en verlengt houdbaarheid" },
          { en: "It changes the color of desserts", es: "Cambia el color de los postres", de: "Es verändert die Farbe von Desserts", nl: "Het verandert de kleur van desserts" },
          { en: "It reduces cooking time", es: "Reduce el tiempo de cocción", de: "Es reduziert die Kochzeit", nl: "Het vermindert de kooktijd" }
        ],
        correct: 1,
        explanation: {
