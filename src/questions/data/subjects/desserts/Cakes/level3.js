    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Victoria sponge is baked at lower temperature",
                  "es": "El bizcocho Victoria se hornea a menor temperatura",
                  "de": "Victoria-Biskuit wird bei niedrigerer Temperatur gebacken",
                  "nl": "Victoria sponge wordt op lagere temperatuur gebakken"
        },
        {
                  "en": "Victoria sponge uses more flour",
                  "es": "El bizcocho Victoria usa más harina",
                  "de": "Victoria-Biskuit verwendet mehr Mehl",
                  "nl": "Victoria sponge gebruikt meer bloem"
        },
        {
                  "en": "Victoria sponge uses only egg whites",
                  "es": "El bizcocho Victoria usa solo claras de huevo",
                  "de": "Victoria-Biskuit verwendet nur Eiweiß",
                  "nl": "Victoria sponge gebruikt alleen eiwitten"
        },
        {
                  "en": "Victoria sponge has jam and cream filling",
                  "es": "El bizcocho Victoria tiene relleno de mermelada y crema",
                  "de": "Victoria-Biskuit hat Marmeladen- und Cremefüllung",
                  "nl": "Victoria sponge heeft jam en crème vulling"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Folding in whipped egg whites",
                  "es": "Incorporar claras batidas",
                  "de": "Geschlagenes Eiweiß unterheben",
                  "nl": "Geklopte eiwitten eronder vouwen"
        },
        {
                  "en": "Using chemical leavening agents",
                  "es": "Usar agentes leudantes químicos",
                  "de": "Chemische Triebmittel verwenden",
                  "nl": "Chemische rijsmiddelen gebruiken"
        },
        {
                  "en": "Whipping whole eggs with sugar over heat",
                  "es": "Batir huevos enteros con azúcar al calor",
                  "de": "Ganze Eier mit Zucker über Hitze schlagen",
                  "nl": "Hele eieren met suiker boven warmte kloppen"
        },
        {
                  "en": "Creaming butter and sugar",
                  "es": "Batir mantequilla y azúcar",
                  "de": "Butter und Zucker schaumig rühren",
                  "nl": "Boter en suiker romig kloppen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "For flavor and to absorb excess moisture",
                  "es": "Para sabor y absorber exceso de humedad",
                  "de": "Für Geschmack und um überschüssige Feuchtigkeit zu absorbieren",
                  "nl": "Voor smaak en om overtollig vocht te absorberen"
        },
        {
                  "en": "To make the cake rise higher",
                  "es": "Para hacer que el pastel suba más",
                  "de": "Um den Kuchen höher aufgehen zu lassen",
                  "nl": "Om de taart hoger te laten rijzen"
        },
        {
                  "en": "Only for chocolate flavor",
                  "es": "Solo para sabor a chocolate",
                  "de": "Nur für Schokoladengeschmack",
                  "nl": "Alleen voor chocoladesmaak"
        },
        {
                  "en": "To change the cake's color only",
                  "es": "Solo para cambiar el color del pastel",
                  "de": "Nur um die Farbe des Kuchens zu ändern",
                  "nl": "Alleen om de kleur van de taart te veranderen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Swiss uses cooked meringue, American uses powdered sugar",
                  "es": "La suiza usa merengue cocido, la americana azúcar en polvo",
                  "de": "Schweizer verwendet gekochte Meringue, amerikanische Puderzucker",
                  "nl": "Zwitserse gebruikt gekookte meringue, Amerikaanse poedersuiker"
        },
        {
                  "en": "Swiss uses cooked meringue, American uses raw eggs",
                  "es": "La suiza usa merengue cocido, la americana huevos crudos",
                  "de": "Schweizer verwendet gekochte Meringue, amerikanische rohe Eier",
                  "nl": "Zwitserse gebruikt gekookte meringue, Amerikaanse rauwe eieren"
        },
        {
        ...
        {
                  "en": "Swiss uses more butter",
                  "es": "La suiza usa más mantequilla",
                  "de": "Schweizer verwendet mehr Butter",
                  "nl": "Zwitserse gebruikt meer boter"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Too much vanilla",
                  "es": "Demasiada vainilla",
                  "de": "Zu viel Vanille",
                  "nl": "Te veel vanille"
        },
        {
                  "en": "Overmixing or insufficient leavening",
                  "es": "Mezclar demasiado o leudante insuficiente",
                  "de": "Übermischen oder unzureichende Lockerung",
                  "nl": "Teveel mengen of onvoldoende rijsmiddel"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Contains no eggs at all",
                  "es": "No contiene huevos",
                  "de": "Enthält gar keine Eier",
                  "nl": "Bevat helemaal geen eieren"
        },
        {
                  "en": "Contains oil instead of butter and uses separated eggs",
                  "es": "Contiene aceite en lugar de mantequilla y usa huevos separados",
                  "de": "Enthält Öl statt Butter und verwendet getrennte Eier",
                  "nl": "Bevat olie in plaats van boter en gebruikt gescheiden eieren"
        },
        {
                  "en": "Uses cream cheese",
                  "es": "Usa queso crema",
                  "de": "Verwendet Frischkäse",
                  "nl": "Gebruikt roomkaas"
        },
        {
                  "en": "Uses only egg yolks",
                  "es": "Usa solo yemas de huevo",
                  "de": "Verwendet nur Eigelb",
                  "nl": "Gebruikt alleen eidooiers"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Whipping egg whites",
                  "es": "Batir claras de huevo",
                  "de": "Eiweiß schlagen",
                  "nl": "Eiwitten kloppen"
        },
        {
                  "en": "Melting ingredients together",
                  "es": "Derretir ingredientes juntos",
                  "de": "Zutaten zusammen schmelzen",
                  "nl": "Ingrediënten samen smelten"
        },
        {
                  "en": "Adding cream to the batter",
                  "es": "Agregar crema a la masa",
                  "de": "Sahne zum Teig hinzufügen",
                  "nl": "Room toevoegen aan het beslag"
        },
        {
                  "en": "Beating butter and sugar until light and fluffy",
                  "es": "Batir mantequilla y azúcar hasta que esté ligero y esponjoso",
                  "de": "Butter und Zucker schlagen bis hell und fluffig",
                  "nl": "Boter en suiker kloppen tot licht en luchtig"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To create a pattern",
                  "es": "Para crear un patrón",
                  "de": "Um ein Muster zu erzeugen",
                  "nl": "Om een patroon te maken"
        },
        {
                  "en": "To add moisture",
        ...
        {
                  "en": "To cool faster",
                  "es": "Para enfriar más rápido",
                  "de": "Um schneller zu kühlen",
                  "nl": "Om sneller af te koelen"
        },
        {
                  "en": "To prevent the delicate structure from collapsing",
                  "es": "Para evitar que la estructura delicada colapse",
                  "de": "Um zu verhindern, dass die empfindliche Struktur zusammenfällt",
                  "nl": "Om te voorkomen dat de delicate structuur instort"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Devil's food uses more cocoa and often includes coffee",
                  "es": "Devil's food usa más cacao y a menudo incluye café",
                  "de": "Devil's Food verwendet mehr Kakao und enthält oft Kaffee",
                  "nl": "Devil's food gebruikt meer cacao en bevat vaak koffie"
        },
        {
                  "en": "They are exactly the same",
                  "es": "Son exactamente iguales",
        ...
        {
                  "en": "Devil's food is always red",
                  "es": "Devil's food es siempre rojo",
                  "de": "Devil's Food ist immer rot",
                  "nl": "Devil's food is altijd rood"
        },
        {
                  "en": "Devil's food uses white chocolate",
                  "es": "Devil's food usa chocolate blanco",
                  "de": "Devil's Food verwendet weiße Schokolade",
                  "nl": "Devil's food gebruikt witte chocolade"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Shake the cup to settle it",
                  "es": "Agitar la taza para asentarlo",
                  "de": "Den Becher schütteln um es zu setzen",
                  "nl": "De beker schudden om het te laten zakken"
        },
        {
                  "en": "Pack it tightly into the measuring cup",
                  "es": "Empacarlo firmemente en la taza medidora",
                  "de": "Fest in den Messbecher drücken",
                  "nl": "Stevig in de maatbeker drukken"
        },
        {
                  "en": "Scoop directly from the bag",
                  "es": "Sacar directamente de la bolsa",
                  "de": "Direkt aus der Tüte schöpfen",
                  "nl": "Direct uit de zak scheppen"
        },
        {
                  "en": "Spoon it lightly into the cup and level off",
                  "es": "Ponerlo ligeramente en la taza con cuchara y nivelar",
                  "de": "Leicht hineinlöffeln und glatt streichen",
                  "nl": "Licht in de beker lepelen en afstrijken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Oven temperature too high or oven rack too high",
                  "es": "Temperatura del horno muy alta o rejilla muy alta",
                  "de": "Ofentemperatur zu hoch oder Rost zu hoch",
                  "nl": "Oventemperatuur te hoog of rooster te hoog"
        },
        {
                  "en": "Too much vanilla",
                  "es": "Demasiada vainilla",
        ...
        {
                  "en": "Not enough eggs",
                  "es": "No suficientes huevos",
                  "de": "Nicht genug Eier",
                  "nl": "Niet genoeg eieren"
        },
        {
                  "en": "Too much liquid in the batter",
                  "es": "Demasiado líquido en la masa",
                  "de": "Zu viel Flüssigkeit im Teig",
                  "nl": "Te veel vloeistof in het beslag"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It's made with ground almonds (pounds)",
                  "es": "Se hace con almendras molidas",
                  "de": "Er wird mit gemahlenen Mandeln gemacht",
                  "nl": "Het wordt gemaakt met gemalen amandelen"
        },
        {
                  "en": "It's baked for one pound of time",
                  "es": "Se hornea por una libra de tiempo",
                  "de": "Er wird für ein Pfund Zeit gebacken",
                  "nl": "Het wordt voor een pond tijd gebakken"
        },
        {
                  "en": "It weighs exactly one pound",
                  "es": "Pesa exactamente una libra",
                  "de": "Er wiegt genau ein Pfund",
                  "nl": "Het weegt precies een pond"
        },
        {
                  "en": "Originally made with a pound each of butter, sugar, eggs, and flour",
                  "es": "Originalmente hecho con una libra cada uno de mantequilla, azúcar, huevos y harina",
                  "de": "Ursprünglich mit einem Pfund jeweils von Butter, Zucker, Eiern und Mehl gemacht",
                  "nl": "Oorspronkelijk gemaakt met een pond elk van boter, suiker, eieren en bloem"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "The cake will be tougher and denser",
                  "es": "El pastel será más duro y denso",
                  "de": "Der Kuchen wird zäher und dichter",
                  "nl": "De taart wordt taaier en dichter"
        },
        {
                  "en": "The cake will not bake properly",
                  "es": "El pastel no se horneará correctamente",
                  "de": "Der Kuchen wird nicht richtig backen",
                  "nl": "De taart zal niet goed bakken"
        },
        {
                  "en": "The cake will be lighter",
                  "es": "El pastel será más ligero",
                  "de": "Der Kuchen wird leichter",
                  "nl": "De taart wordt lichter"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only use cooking spray",
                  "es": "Solo usar spray de cocina",
                  "de": "Nur Kochspray verwenden",
                  "nl": "Alleen kookspray gebruiken"
        },
        {
                  "en": "Only grease the pan",
                  "es": "Solo engrasar el molde",
                  "de": "Nur die Form fetten",
                  "nl": "Alleen de pan invetten"
        },
        {
                  "en": "Dust with powdered sugar",
                  "es": "Espolvorear con azúcar en polvo",
                  "de": "Mit Puderzucker bestäuben",
                  "nl": "Bestuiven met poedersuiker"
        },
        {
                  "en": "Grease and flour the pan, or use parchment paper",
                  "es": "Engrasar y enharinar el molde, o usar papel pergamino",
                  "de": "Die Form fetten und bemehlen oder Backpapier verwenden",
                  "nl": "Pan invetten en bloemen, of bakpapier gebruiken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Baking soda needs acid to activate, baking powder contains both acid and base",
                  "es": "El bicarbonato necesita ácido para activarse, el polvo de hornear contiene tanto ácido como base",
                  "de": "Natron braucht Säure zur Aktivierung, Backpulver enthält sowohl Säure als auch Base",
                  "nl": "Zuiveringszout heeft zuur nodig om te activeren, bakpoeder bevat zowel zuur als base"
        },
        {
                  "en": "Baking soda is only for cookies",
                  "es": "El bicarbonato es solo para galletas",
                  "de": "Natron ist nur für Kekse",
                  "nl": "Zuiveringszout is alleen voor koekjes"
        },
        {
                  "en": "Baking powder is stronger",
                  "es": "El polvo de hornear es más fuerte",
                  "de": "Backpulver ist stärker",
                  "nl": "Bakpoeder is sterker"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "To help the cake rise",
                  "es": "Para ayudar al pastel a subir",
                  "de": "Um dem Kuchen beim Aufgehen zu helfen",
                  "nl": "Om de taart te helpen rijzen"
        },
        {
                  "en": "To make the cake salty",
                  "es": "Para hacer el pastel salado",
                  "de": "Um den Kuchen salzig zu machen",
                  "nl": "Om de taart zout te maken"
        },
        {
                  "en": "To enhance flavors and balance sweetness",
                  "es": "Para realzar sabores y equilibrar la dulzura",
                  "de": "Um Aromen zu verstärken und Süße zu balancieren",
                  "nl": "Om smaken te versterken en zoetheid in balans te brengen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Red velvet fabric",
                  "es": "Tela de terciopelo rojo",
                  "de": "Roter Samtstoff",
                  "nl": "Rode fluweelstof"
        },
        {
        ...
        {
                  "en": "Red food coloring and the reaction between cocoa and acid",
                  "es": "Colorante rojo y la reacción entre cacao y ácido",
                  "de": "Rote Lebensmittelfarbe und die Reaktion zwischen Kakao und Säure",
                  "nl": "Rode kleurstof en de reactie tussen cacao en zuur"
        },
        {
                  "en": "Strawberries",
                  "es": "Fresas",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Muffin method requires an electric mixer",
                  "es": "El método de muffin requiere batidora eléctrica",
                  "de": "Muffin-Methode erfordert elektrischen Mixer",
                  "nl": "Muffinmethode vereist elektrische mixer"
        },
        {
                  "en": "No difference",
                  "es": "Sin diferencia",
        ...
        {
                  "en": "Muffin method combines wet and dry ingredients separately then mixes briefly",
                  "es": "El método de muffin combina ingredientes húmedos y secos por separado luego mezcla brevemente",
                  "de": "Muffin-Methode kombiniert feuchte und trockene Zutaten separat, dann kurz mischen",
                  "nl": "Muffinmethode combineert natte en droge ingrediënten apart dan kort mengen"
        },
        {
                  "en": "Cake method uses only dry ingredients",
                  "es": "El método de pastel usa solo ingredientes secos",
                  "de": "Kuchen-Methode verwendet nur trockene Zutaten",
                  "nl": "Cakemethode gebruikt alleen droge ingrediënten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  ...
                  "de": "Temperatur ist egal",
                  "nl": "Temperatuur maakt niet uit"
        },
        {
                  "en": "Room temperature (about 20-22°C)",
                  "es": "Temperatura ambiente (cerca de 20-22°C)",
                  "de": "Zimmertemperatur (etwa 20-22°C)",
                  "nl": "Kamertemperatuur (ongeveer 20-22°C)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Whipped eggs (especially egg whites)",
                  "es": "Huevos batidos (especialmente claras)",
                  "de": "Geschlagene Eier (besonders Eiweiß)",
                  "nl": "Geklopte eieren (vooral eiwitten)"
        },
        {
                  "en": "Extra flour",
                  "es": "Harina extra",
