// Chocolate Desserts - level1
// Total questions: 100
// Quality issues fixed: 2026-03-03T10:18:47.819Z

module.exports = {
    questions: [
            {
                    "question": {
                            "en": "Which chocolate cake is named after a forest in Germany?",
                            "es": "¿Qué pastel de chocolate lleva el nombre de un bosque en Alemania?",
                            "de": "Welcher Schokoladenkuchen ist nach einem Wald in Deutschland benannt?",
                            "nl": "Welke chocoladetaart is vernoemd naar een bos in Duitsland?"
                    },
                    "options": [
                            {
                                    "en": "Black Forest Cake",
                                    "es": "Tarta Selva Negra",
                            ...
                            {
                                    "en": "Devil's Food Cake",
                                    "es": "Pastel del Diablo",
                                    "de": "Devil's Food Cake",
                                    "nl": "Devil's Food Cake"
                            },
                            {
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Black Forest Cake (Schwarzwälder Kirschtorte) is named after the Black Forest region in southwestern Germany. It features layers of chocolate sponge cake, cherries, and whipped cream, traditionally with Kirschwasser (cherry brandy).",
                            "es": "La Tarta Selva Negra (Schwarzwälder Kirschtorte) lleva el nombre de la región de la Selva Negra en el suroeste de Alemania. Presenta capas de bizcocho de chocolate, cerezas y crema batida, tradicionalmente con Kirschwasser (brandy de cereza).",
                            "de": "Die Schwarzwälder Kirschtorte ist nach der Schwarzwaldregion im Südwesten Deutschlands benannt. Sie besteht aus Schichten von Schokoladenbiskuit, Kirschen und Schlagsahne, traditionell mit Kirschwasser.",
                            "nl": "Schwarzwaldtaart (Schwarzwälder Kirschtorte) is vernoemd naar het Zwarte Woud in Zuidwest-Duitsland. Het bevat lagen chocoladebiscuit, kersen en slagroom, traditioneel met Kirschwasser (kersenbrandewijn)."
                    }
            },
            {
                    "question": {
                            "en": "What is the main ingredient in chocolate mousse besides chocolate?",
                            "es": "¿Cuál es el ingrediente principal en el mousse de chocolate además del chocolate?",
                            "de": "Was ist die Hauptzutat in Schokoladenmousse neben Schokolade?",
                            "nl": "Wat is het hoofdingrediënt in chocolademousse naast chocolade?"
                    },
                    "options": [
                            {
                                    "en": "Whipped eggs or cream",
                                    "es": "Huevos batidos o crema",
                                    "de": "Geschlagene Eier oder Sahne",
                                    "nl": "Opgeklopte eieren of room"
                            },
                            {
                                    "en": "Gelatin",
                                    "es": "Gelatina",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Chocolate mousse gets its light, airy texture primarily from whipped eggs (traditionally) or whipped cream. The air bubbles incorporated during whipping create the characteristic 'mousse' (foam) texture when folded with melted chocolate.",
                            "es": "El mousse de chocolate obtiene su textura ligera y aireada principalmente de huevos batidos (tradicionalmente) o crema batida. Las burbujas de aire incorporadas durante el batido crean la característica textura de 'mousse' (espuma) cuando se mezclan con chocolate derretido.",
                            "de": "Schokoladenmousse erhält seine leichte, luftige Textur hauptsächlich durch geschlagene Eier (traditionell) oder geschlagene Sahne. Die beim Schlagen eingearbeiteten Luftblasen erzeugen die charakteristische 'Mousse' (Schaum) Textur beim Unterheben mit geschmolzener Schokolade.",
                            "nl": "Chocolademousse krijgt zijn lichte, luchtige textuur voornamelijk van opgeklopte eieren (traditioneel) of opgeklopte room. De luchtbellen die tijdens het opkloppen worden opgenomen, creëren de karakteristieke 'mousse' (schuim) textuur wanneer gevouwen met gesmolten chocolade."
                    }
            },
            {
                    "question": {
                            "en": "Which French dessert consists of a chocolate lava center?",
                            "es": "¿Qué postre francés consiste en un centro de lava de chocolate?",
                            "de": "Welches französische Dessert besteht aus einem Schokoladen-Lava-Kern?",
                            "nl": "Welk Frans dessert bestaat uit een chocolade lava centrum?"
                    },
                    "options": [
                            {
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Chocolate Fondant (also called molten chocolate cake or lava cake) is a French dessert with a liquid chocolate center. Created by chef Michel Bras in 1981, it's baked just enough to set the outside while keeping the center molten.",
                            "es": "El Fondant de Chocolate (también llamado pastel de chocolate fundido o pastel de lava) es un postre francés con centro de chocolate líquido. Creado por el chef Michel Bras en 1981, se hornea lo justo para solidificar el exterior manteniendo el centro fundido.",
                            "de": "Schokoladen-Fondant (auch Schokoladen-Lavakuchen genannt) ist ein französisches Dessert mit flüssigem Schokoladenkern. 1981 vom Koch Michel Bras kreiert, wird es gerade lange genug gebacken, um die Außenseite zu festigen, während das Zentrum flüssig bleibt.",
                            "nl": "Chocolade Fondant (ook wel gesmolten chocoladecake of lavacake genoemd) is een Frans dessert met een vloeibaar chocoladecentrum. Gecreëerd door chef Michel Bras in 1981, wordt het net lang genoeg gebakken om de buitenkant te laten opstijven terwijl het centrum gesmolten blijft."
                    }
            },
            {
                    "question": {
                            "en": "What type of chocolate is used in traditional brownies?",
                            "es": "¿Qué tipo de chocolate se usa en los brownies tradicionales?",
                            "de": "Welche Art von Schokolade wird in traditionellen Brownies verwendet?",
                            "nl": "Welk type chocolade wordt gebruikt in traditionele brownies?"
                    },
                    "options": [
                            {
                                    "en": "Dark or semi-sweet chocolate",
                                    "es": "Chocolate oscuro o semiamargo",
                                    "de": "Dunkle oder halbbittere Schokolade",
                                    "nl": "Donkere of halfzoete chocolade"
                            },
                            {
                                    "en": "White chocolate",
                                    "es": "Chocolate blanco",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Traditional brownies use dark or semi-sweet chocolate, which provides the rich, intense chocolate flavor and fudgy texture. The recipe was first published in 1906 in the Boston Cooking-School Cook Book.",
                            "es": "Los brownies tradicionales usan chocolate oscuro o semiamargo, que proporciona el sabor rico e intenso a chocolate y la textura fudgy. La receta se publicó por primera vez en 1906 en el Boston Cooking-School Cook Book.",
                            "de": "Traditionelle Brownies verwenden dunkle oder halbbittere Schokolade, die den reichen, intensiven Schokoladengeschmack und die fudgy Textur liefert. Das Rezept wurde erstmals 1906 im Boston Cooking-School Cook Book veröffentlicht.",
                            "nl": "Traditionele brownies gebruiken donkere of halfzoete chocolade, die de rijke, intense chocoladesmaak en fudgy textuur biedt. Het recept werd voor het eerst gepubliceerd in 1906 in het Boston Cooking-School Cook Book."
                    }
            },
            {
                    "question": {
                            "en": "Which Italian chocolate dessert translates to 'pick me up'?",
                            "es": "¿Qué postre italiano de chocolate se traduce como 'levántame'?",
                            "de": "Welches italienische Schokoladendessert bedeutet übersetzt 'heb mich auf'?",
                            "nl": "Welk Italiaans chocoladedessert betekent 'til me op'?"
                    },
                    "options": [
                            {
                                    "en": "Tiramisu",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Tiramisu literally means 'pick me up' or 'cheer me up' in Italian. This layered dessert features ladyfinger cookies soaked in coffee, mascarpone cream, and cocoa powder. It was invented in the 1960s in the Veneto region of Italy.",
                            "es": "Tiramisú significa literalmente 'levántame' o 'anímame' en italiano. Este postre en capas presenta bizcochos de soletilla empapados en café, crema de mascarpone y cacao en polvo. Fue inventado en la década de 1960 en la región del Véneto de Italia.",
                            "de": "Tiramisu bedeutet wörtlich 'heb mich auf' oder 'heitere mich auf' auf Italienisch. Dieses geschichtete Dessert besteht aus in Kaffee getränkten Löffelbiskuits, Mascarpone-Creme und Kakaopulver. Es wurde in den 1960er Jahren in der Region Venetien in Italien erfunden.",
                            "nl": "Tiramisu betekent letterlijk 'til me op' of 'vrolijk me op' in het Italiaans. Dit gelaagde dessert bestaat uit lange vingers gedrenkt in koffie, mascarponecrème en cacaopoeder. Het werd uitgevonden in de jaren 1960 in de regio Veneto in Italië."
                    }
            },
            {
                    "question": {
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "This question relates to level 1 content in Chocolate Desserts. The correct answer provides important context.",
                            "es": "This question relates to level 1 content in Chocolate Desserts. The correct answer provides important context.",
                            "de": "This question relates to level 1 content in Chocolate Desserts. The correct answer provides important context.",
                            "nl": "This question relates to level 1 content in Chocolate Desserts. The correct answer provides important context."
                    }
            },
            {
                    "question": {
            ...
            {
                    "question": {
                            "en": "How does this relate to Chocolate Desserts?",
                            "es": "¿Cómo does this relate to Chocolate Desserts?",
                            "de": "Wie does this relate to Chocolate Desserts?",
                            "nl": "Hoe does this relate to Chocolate Desserts?"
                    },
                    "options": [
                            {
