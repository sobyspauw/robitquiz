// Chocolate Desserts Quiz - Level 3
(function() {
  const level3 = {
    name: {
    ...
    questions: [
      ...
      },
      {
        ...
        {
                  "en": "Direct heat only",
                  "es": "Solo calor directo",
                  "de": "Nur direkte Hitze",
                  "nl": "Alleen directe hitte"
        },
        {
                  "en": "Adding salt",
                  "es": "Agregar sal",
        ...
        },
        {
                  "en": "Freezing first",
                  "es": "Congelar primero",
                  "de": "Zuerst einfrieren",
                  "nl": "Eerst bevriezen"
        },
        {
                  "en": "Double boiler method",
                  "es": "Método de baño María",
                  "de": "Wasserbad-Methode",
                  "nl": "Au bain-marie methode"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Whipped egg whites or cream",
                  "es": "Claras de huevo batidas o crema",
                  "de": "Geschlagenes Eiweiß oder Sahne",
                  "nl": "Geklopte eiwitten of room"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Properly beaten egg whites and gentle folding",
                  "es": "Claras de huevo bien batidas y plegado suave",
                  "de": "Richtig geschlagenes Eiweiß und sanftes Falten",
                  "nl": "Goed geklopte eiwitten en voorzichtig vouwen"
        },
        {
                  "en": "Using only dark chocolate",
                  "es": "Usar solo chocolate negro",
                  "de": "Nur dunkle Schokolade verwenden",
                  "nl": "Alleen pure chocolade gebruiken"
        },
        {
                  "en": "Baking at high temperature",
                  "es": "Hornear a alta temperatura",
                  "de": "Bei hoher Temperatur backen",
                  "nl": "Bakken op hoge temperatuur"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Always frozen",
                  "es": "Siempre congelada",
                  "de": "Immer gefroren",
                  "nl": "Altijd bevroren"
        },
        {
                  "en": "Must be eaten hot",
                  "es": "Debe comerse caliente",
                  "de": "Muss heiß gegessen werden",
                  "nl": "Moet warm gegeten worden"
        },
        {
                  "en": "Contains no chocolate",
                  "es": "No contiene chocolate",
                  "de": "Enthält keine Schokolade",
                  "nl": "Bevat geen chocolade"
        },
        {
                  "en": "Dense, layered structure served in slices",
                  "es": "Estructura densa y en capas servida en rodajas",
                  "de": "Dichte, geschichtete Struktur in Scheiben serviert",
                  "nl": "Dichte, gelaagde structuur geserveerd in plakjes"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pudding is always cold",
                  "es": "El pudín siempre está frío",
                  "de": "Pudding ist immer kalt",
                  "nl": "Pudding is altijd koud"
        },
        {
                  "en": "Custard uses eggs for thickening, pudding uses starch",
                  "es": "Las natillas usan huevos para espesar, el pudín usa almidón",
                  "de": "Creme verwendet Eier zum Verdicken, Pudding verwendet Stärke",
                  "nl": "Custard gebruikt eieren om te verdikken, pudding gebruikt zetmeel"
        },
        {
                  "en": "Custard contains no chocolate",
                  "es": "Las natillas no contienen chocolate",
                  "de": "Creme enthält keine Schokolade",
                  "nl": "Custard bevat geen chocolade"
        },
        {
                  "en": "No difference",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using eggs and chocolate for structure instead of flour",
                  "es": "Usar huevos y chocolate para estructura en lugar de harina",
                  "de": "Eier und Schokolade für Struktur anstelle von Mehl verwenden",
                  "nl": "Eieren en chocolade gebruiken voor structuur in plaats van meel"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "Room temperature for better volume",
                  "es": "Temperatura ambiente para mejor volumen",
                  "de": "Zimmertemperatur für besseres Volumen",
                  "nl": "Kamertemperatuur voor beter volume"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "Enhances flavor and extends shelf life",
                  "es": "Mejora el sabor y extiende la vida útil",
                  "de": "Verstärkt Geschmack und verlängert Haltbarkeit",
                  "nl": "Verbetert smaak en verlengt houdbaarheid"
        },
        {
                  "en": "Makes it harder",
                  "es": "Lo hace más duro",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding too much cocoa",
                  "es": "Agregar demasiado cacao",
                  "de": "Zu viel Kakao hinzufügen",
                  "nl": "Te veel cacao toevoegen"
        },
        {
                  "en": "Adding small amounts of water or steam",
                  "es": "Agregar pequeñas cantidades de agua o vapor",
                  "de": "Kleine Mengen Wasser oder Dampf hinzufügen",
                  "nl": "Kleine hoeveelheden water of stoom toevoegen"
        },
        {
                  "en": "Melting too slowly",
                  "es": "Derretir demasiado lento",
                  "de": "Zu langsam schmelzen",
                  "nl": "Te langzaam smelten"
        },
        {
                  "en": "Using dark chocolate",
                  "es": "Usar chocolate negro",
                  "de": "Dunkle Schokolade verwenden",
                  "nl": "Pure chocolade gebruiken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Direct sunlight",
                  "es": "Luz solar directa",
                  "de": "Direktes Sonnenlicht",
                  "nl": "Direct zonlicht"
        },
        {
                  "en": "Warm, humid environment",
                  "es": "Ambiente cálido y húmedo",
                  "de": "Warme, feuchte Umgebung",
                  "nl": "Warme, vochtige omgeving"
        },
        {
                  "en": "Freezer only",
                  "es": "Solo congelador",
        ...
        {
                  "en": "Cool, dry place in airtight container",
                  "es": "Lugar fresco y seco en recipiente hermético",
                  "de": "Kühler, trockener Ort in luftdichtem Behälter",
                  "nl": "Koele, droge plaats in luchtdichte container"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To make chocolate harder",
                  "es": "Para hacer el chocolate más duro",
                  "de": "Um Schokolade härter zu machen",
                  "nl": "Om chocolade harder te maken"
        },
        {
        ...
        {
                  "en": "As a base for chocolate pastry cream fillings",
                  "es": "Como base para rellenos de crema pastelera de chocolate",
                  "de": "Als Basis für Schokoladen-Konditorcreme-Füllungen",
                  "nl": "Als basis voor chocolade banketbakkersroom vullingen"
        },
        {
                  "en": "To change chocolate color",
                  "es": "Para cambiar el color del chocolate",
                  "de": "Um die Schokoladenfarbe zu ändern",
                  "nl": "Om chocoladekleur te veranderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To change its flavor",
                  "es": "Para cambiar su sabor",
                  "de": "Um ihren Geschmack zu ändern",
                  "nl": "Om de smaak te veranderen"
        },
        {
                  "en": "To soften and activate it before dissolving",
                  "es": "Para ablandarla y activarla antes de disolverla",
                  "de": "Um sie vor dem Auflösen zu erweichen und zu aktivieren",
                  "nl": "Om het te verzachten en te activeren voor het oplossen"
        },
        {
                  "en": "To make it colorful",
                  "es": "Para hacerla colorida",
                  "de": "Um sie bunt zu machen",
                  "nl": "Om het kleurrijk te maken"
        },
        {
                  "en": "To remove its taste",
                  "es": "Para quitarle el sabor",
                  "de": "Um ihren Geschmack zu entfernen",
                  "nl": "Om de smaak weg te nemen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tempering creates stable crystals for shine and snap",
                  "es": "Templar crea cristales estables para brillo y chasquido",
                  "de": "Temperieren erzeugt stabile Kristalle für Glanz und Knack",
                  "nl": "Tempereren creëert stabiele kristallen voor glans en knak"
        },
        {
                  "en": "Melting requires higher temperatures",
                  "es": "Derretir requiere temperaturas más altas",
                  "de": "Schmelzen erfordert höhere Temperaturen",
                  "nl": "Smelten vereist hogere temperaturen"
        },
        {
                  "en": "Tempering only changes color",
                  "es": "Templar solo cambia el color",
                  "de": "Temperieren ändert nur die Farbe",
                  "nl": "Tempereren verandert alleen de kleur"
        },
        {
                  "en": "No difference",
                  "es": "No hay diferencia",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pies are always chocolate",
                  "es": "Los pasteles siempre son de chocolate",
                  "de": "Kuchen sind immer Schokolade",
                  "nl": "Pies zijn altijd chocolade"
        },
        {
                  "en": "No difference",
                  "es": "No hay diferencia",
        ...
        {
                  "en": "Tarts are served cold only",
                  "es": "Las tartas se sirven solo frías",
                  "de": "Tarten werden nur kalt serviert",
                  "nl": "Taarten worden alleen koud geserveerd"
        },
        {
                  "en": "Tarts have shallow sides and open tops",
                  "es": "Las tartas tienen lados poco profundos y parte superior abierta",
                  "de": "Tarten haben flache Seiten und offene Oberseiten",
                  "nl": "Taarten hebben lage randen en open bovenkanten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  "en": "It's served cold",
                  "es": "Se sirve frío",
                  "de": "Es wird kalt serviert",
                  "nl": "Het wordt koud geserveerd"
        },
        {
                  "en": "Molten chocolate center that flows when cut",
                  "es": "Centro de chocolate fundido que fluye al cortarse",
                  "de": "Geschmolzener Schokoladenkern, der beim Schneiden fließt",
                  "nl": "Gesmolten chocoladekern die vloeit wanneer gesneden"
        },
        {
                  "en": "It's very large",
                  "es": "Es muy grande",
                  "de": "Es ist sehr groß",
                  "nl": "Het is heel groot"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "To set the texture and maintain structure",
                  "es": "Para cuajar la textura y mantener la estructura",
                  "de": "Um die Textur zu festigen und die Struktur zu erhalten",
                  "nl": "Om de textuur te laten stollen en de structuur te behouden"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "60-70% for balanced flavor",
                  "es": "60-70% para sabor equilibrado",
                  "de": "60-70% für ausgewogenen Geschmack",
                  "nl": "60-70% voor gebalanceerde smaak"
        },
        {
                  "en": "30-40% only",
                  "es": "Solo 30-40%",
      ...
      },
      {
        ...
        {
                  "en": "Remove lumps and ensure even distribution",
                  "es": "Eliminar grumos y asegurar distribución uniforme",
                  "de": "Klumpen entfernen und gleichmäßige Verteilung sicherstellen",
                  "nl": "Klontjes verwijderen en gelijkmatige verdeling verzekeren"
        },
        {
                  "en": "Change the color",
                  "es": "Cambiar el color",
      ...
      },
      {
        ...
        {
                  "en": "Dark chocolate (70% or higher)",
                  "es": "Chocolate negro (70% o más)",
                  "de": "Dunkle Schokolade (70% oder höher)",
                  "nl": "Pure chocolade (70% of hoger)"
        },
        {
                  "en": "Ruby chocolate",
                  "es": "Chocolate rubí",
