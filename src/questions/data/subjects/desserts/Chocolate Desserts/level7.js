// Chocolate Desserts Quiz - Level 7: Chocolate Chemistry and Science
(function() {
  const level7 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { en: "Theobromine", es: "Teobromina", de: "Theobromin", nl: "Theobromine" },
          { en: "Tannins", es: "Taninos", de: "Tannine", nl: "Tannines" },
          { en: "Phenylethylamine", es: "Feniletilmina", de: "Phenylethylamin", nl: "Fenylethylamine" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "32-35°C (90-95°F)", es: "32-35°C (90-95°F)", de: "32-35°C (90-95°F)", nl: "32-35°C (90-95°F)" },
          { en: "37-40°C (98-104°F)", es: "37-40°C (98-104°F)", de: "37-40°C (98-104°F)", nl: "37-40°C (98-104°F)" },
      ...
      },
      {
        ...
        options: [
          { en: "Alpha, Beta, Gamma, Delta, Epsilon, Zeta", es: "Alfa, Beta, Gamma, Delta, Epsilon, Zeta", de: "Alpha, Beta, Gamma, Delta, Epsilon, Zeta", nl: "Alpha, Beta, Gamma, Delta, Epsilon, Zeta" },
          { en: "Form I, II, III, IV, V, VI", es: "Forma I, II, III, IV, V, VI", de: "Form I, II, III, IV, V, VI", nl: "Vorm I, II, III, IV, V, VI" },
          { en: "Type A, B, C, D, E, F", es: "Tipo A, B, C, D, E, F", de: "Typ A, B, C, D, E, F", nl: "Type A, B, C, D, E, F" },
          { en: "Phase 1, 2, 3, 4, 5, 6", es: "Fase 1, 2, 3, 4, 5, 6", de: "Phase 1, 2, 3, 4, 5, 6", nl: "Fase 1, 2, 3, 4, 5, 6" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "10-15%", es: "10-15%", de: "10-15%", nl: "10-15%" },
          { en: "20-25%", es: "20-25%", de: "20-25%", nl: "20-25%" },
          { en: "30-35%", es: "30-35%", de: "30-35%", nl: "30-35%" },
      ...
      },
      {
        ...
        options: [
          { en: "3.5-4.5 (acidic)", es: "3,5-4,5 (ácido)", de: "3,5-4,5 (sauer)", nl: "3,5-4,5 (zuur)" },
          { en: "5.5-6.5 (natural)", es: "5,5-6,5 (natural)", de: "5,5-6,5 (natürlich)", nl: "5,5-6,5 (natuurlijk)" },
          { en: "7.0-8.0 (Dutch-processed)", es: "7,0-8,0 (procesado holandés)", de: "7,0-8,0 (holländisch verarbeitet)", nl: "7,0-8,0 (Nederlands geprocessed)" },
          { en: "9.0-10.0 (alkaline)", es: "9,0-10,0 (alcalino)", de: "9,0-10,0 (alkalisch)", nl: "9,0-10,0 (alkalisch)" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates bitterness", es: "Crea amargura", de: "Erzeugt Bitterkeit", nl: "Creëert bitterheid" },
          { en: "Develops complex flavors and aromas", es: "Desarrolla sabores y aromas complejos", de: "Entwickelt komplexe Geschmäcker und Aromen", nl: "Ontwikkelt complexe smaken en aroma's" },
          { en: "Removes acidity", es: "Elimina acidez", de: "Entfernt Säure", nl: "Verwijdert zuurheid" },
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Mold formation", es: "Formación de moho", de: "Schimmelbildung", nl: "Schimmelvorming" },
          { en: "Fat or sugar migration", es: "Migración de grasa o azúcar", de: "Fett- oder Zuckermigration", nl: "Vet- of suikermigratie" },
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Acts as an emulsifier", es: "Actúa como emulsificante", de: "Wirkt als Emulgator", nl: "Werkt als emulgator" },
          { en: "Provides flavor", es: "Proporciona sabor", de: "Liefert Geschmack", nl: "Verschaft smaak" },
          { en: "Creates color", es: "Crea color", de: "Erzeugt Farbe", nl: "Creëert kleur" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "60-80°C (140-176°F)", es: "60-80°C (140-176°F)", de: "60-80°C (140-176°F)", nl: "60-80°C (140-176°F)" },
          { en: "90-100°C (194-212°F)", es: "90-100°C (194-212°F)", de: "90-100°C (194-212°F)", nl: "90-100°C (194-212°F)" },
          { en: "110-120°C (230-248°F)", es: "110-120°C (230-248°F)", de: "110-120°C (230-248°F)", nl: "110-120°C (230-248°F)" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Flavonoids", es: "Flavonoides", de: "Flavonoide", nl: "Flavonoïden" },
          { en: "Vitamins", es: "Vitaminas", de: "Vitamine", nl: "Vitaminen" },
          { en: "Minerals", es: "Minerales", de: "Mineralien", nl: "Mineralen" },
      ...
      },
      {
        ...
        options: [
          { en: "Air bubbles bursting", es: "Burbujas de aire explotando", de: "Platzende Luftblasen", nl: "Luchtzjebellen die barsten" },
          { en: "Stable crystal structure", es: "Estructura cristalina estable", de: "Stabile Kristallstruktur", nl: "Stabiele kristalstructuur" },
          { en: "Sugar crystallization", es: "Cristalización del azúcar", de: "Zuckerkristallisation", nl: "Suikerkristallisatie" },
          { en: "Protein bonds breaking", es: "Rotura de enlaces proteicos", de: "Brechende Proteinbindungen", nl: "Breking van eiwitbindingen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Preservative action", es: "Acción conservante", de: "Konservierungswirkung", nl: "Conserverende werking" },
          { en: "Flavor enhancement and rounding", es: "Mejora y redondeo del sabor", de: "Geschmacksverbesserung und -abrundung", nl: "Smaakverbetering en afronding" },
          { en: "Color improvement", es: "Mejora del color", de: "Farbverbesserung", nl: "Kleurverbetering" },
          { en: "Texture modification", es: "Modificación de textura", de: "Texturmodifikation", nl: "Textuurmodificatie" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Below 0.55", es: "Por debajo de 0,55", de: "Unter 0,55", nl: "Onder 0,55" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "All crystals become uniform", es: "Todos los cristales se vuelven uniformes", de: "Alle Kristalle werden einheitlich", nl: "Alle kristallen worden uniform" },
          { en: "Unstable forms convert to Form V", es: "Las formas inestables se convierten en Forma V", de: "Instabile Formen wandeln sich in Form V um", nl: "Instabiele vormen converteren naar Vorm V" },
          { en: "Crystals completely dissolve", es: "Los cristales se disuelven completamente", de: "Kristalle lösen sich vollständig auf", nl: "Kristallen lossen volledig op" },
          { en: "New crystal types are created", es: "Se crean nuevos tipos de cristal", de: "Neue Kristalltypen werden erzeugt", nl: "Nieuwe kristaltypes worden gecreëerd" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Less than 50%", es: "Menos del 50%", de: "Weniger als 50%", nl: "Minder dan 50%" },
          { en: "50-60%", es: "50-60%", de: "50-60%", nl: "50-60%" },
          { en: "60-70%", es: "60-70%", de: "60-70%", nl: "60-70%" },
          { en: "More than 70%", es: "Más del 70%", de: "Mehr als 70%", nl: "Meer dan 70%" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Grinding cocoa beans", es: "Moler granos de cacao", de: "Mahlen von Kakaobohnen", nl: "Malen van cacaobonen" },
          { en: "Developing flavor and texture", es: "Desarrollar sabor y textura", de: "Geschmack und Textur entwickeln", nl: "Ontwikkelen van smaak en textuur" },
          { en: "Adding sugar", es: "Agregar azúcar", de: "Zucker hinzufügen", nl: "Suiker toevoegen" },
          { en: "Cooling chocolate", es: "Enfriar chocolate", de: "Schokolade kühlen", nl: "Chocolade koelen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Cocoa content and processing", es: "Contenido de cacao y procesamiento", de: "Kakaogehalt und Verarbeitung", nl: "Cacaogehalte en verwerking" },
      ...
      },
      {
        ...
        options: [
          { en: "Alkalizes and neutralizes natural acids", es: "Alcaliniza y neutraliza ácidos naturales", de: "Alkalisiert und neutralisiert natürliche Säuren", nl: "Alkaliseert en neutraliseert natuurlijke zuren" },
          { en: "Adds sweetness", es: "Añade dulzura", de: "Fügt Süße hinzu", nl: "Voegt zoetheid toe" },
          { en: "Preserves the cocoa", es: "Conserva el cacao", de: "Konserviert den Kakao", nl: "Conserveert de cacao" },
