// Quiz Template - Level 2: Dessert - Puddings
(function() {
  const level2 = {
    name: {
      en: "Puddings - Level 2",
    ...
    questions: [
      {
        ...
        options: [
          { en: "1-2% by weight", es: "1-2% por peso", de: "1-2% nach Gewicht", nl: "1-2% naar gewicht" },
          { en: "3-5% by weight", es: "3-5% por peso", de: "3-5% nach Gewicht", nl: "3-5% naar gewicht" },
          { en: "8-10% by weight", es: "8-10% por peso", de: "8-10% nach Gewicht", nl: "8-10% naar gewicht" },
          { en: "15-20% by weight", es: "15-20% por peso", de: "15-20% nach Gewicht", nl: "15-20% naar gewicht" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Gelatinization and amylose leaching", es: "Gelatinización y lixiviación de amilosa", de: "Gelatinierung und Amylose-Auslaugung", nl: "Gelatinisatie en amylose uitloging" },
          { en: "Maillard reaction", es: "Reacción de Maillard", de: "Maillard-Reaktion", nl: "Maillard reactie" },
      ...
      },
      {
        ...
        options: [
          { en: "Sugar crystallization; prevented by stirring", es: "Cristalización del azúcar; prevenida por revolver", de: "Zuckerkristallisation; verhindert durch Rühren", nl: "Suikerkristallisatie; voorkomen door roeren" },
          { en: "Protein coagulation at surface; prevented by contact covering", es: "Coagulación de proteínas en superficie; prevenida por cobertura de contacto", de: "Proteinkoagulation an der Oberfläche; verhindert durch Kontaktabdeckung", nl: "Eiwitcoagulatie aan oppervlak; voorkomen door contactbedekking" },
          { en: "Fat separation; prevented by emulsifiers", es: "Separación de grasa; prevenida por emulsificantes", de: "Fetttrennung; verhindert durch Emulgatoren", nl: "Vetscheiding; voorkomen door emulgatoren" },
          { en: "Starch retrogradation; prevented by acid", es: "Retrogradación del almidón; prevenida por ácido", de: "Stärke-Retrogradation; verhindert durch Säure", nl: "Zetmeel retrogradatie; voorkomen door zuur" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Higher amylose creates firmer, more stable gels", es: "Mayor amilosa crea geles más firmes y estables", de: "Höhere Amylose erzeugt festere, stabilere Gele", nl: "Hogere amylose creëert stevigere, stabielere gels" },
          { en: "Higher amylopectin always produces better texture", es: "Mayor amilopectina siempre produce mejor textura", de: "Höhere Amylopektin produziert immer bessere Textur", nl: "Hogere amylopectine produceert altijd betere textuur" },
          { en: "The ratio has no effect on texture", es: "La proporción no tiene efecto en la textura", de: "Das Verhältnis hat keinen Einfluss auf die Textur", nl: "De verhouding heeft geen effect op textuur" },
          { en: "Only amylose contributes to thickening", es: "Solo la amilosa contribuye al espesamiento", de: "Nur Amylose trägt zur Verdickung bei", nl: "Alleen amylose draagt bij aan verdikking" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "50-60°C (122-140°F)", es: "50-60°C (122-140°F)", de: "50-60°C (122-140°F)", nl: "50-60°C (122-140°F)" },
          { en: "70-85°C (158-185°F)", es: "70-85°C (158-185°F)", de: "70-85°C (158-185°F)", nl: "70-85°C (158-185°F)" },
          { en: "90-95°C (194-203°F)", es: "90-95°C (194-203°F)", de: "90-95°C (194-203°F)", nl: "90-95°C (194-203°F)" },
          { en: "100-110°C (212-230°F)", es: "100-110°C (212-230°F)", de: "100-110°C (212-230°F)", nl: "100-110°C (212-230°F)" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To improve flavor development", es: "Para mejorar el desarrollo del sabor", de: "Um die Geschmacksentwicklung zu verbessern", nl: "Om smaakontikkeling te verbeteren" },
          { en: "To prevent egg proteins from coagulating and creating lumps", es: "Para prevenir que las proteínas del huevo coagulen y creen grumos", de: "Um zu verhindern, dass Eiproteine koagulieren und Klumpen bilden", nl: "Om te voorkomen dat eiwitten coaguleren en klontjes vormen" },
          { en: "To increase nutritional value", es: "Para aumentar el valor nutricional", de: "Um den Nährwert zu erhöhen", nl: "Om voedingswaarde te verhogen" },
          { en: "To reduce cooking time", es: "Para reducir el tiempo de cocción", de: "Um die Garzeit zu reduzieren", nl: "Om kooktijd te verminderen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "pH has no effect on starch thickening", es: "El pH no tiene efecto en el espesamiento del almidón", de: "pH hat keinen Einfluss auf Stärkeverdickung", nl: "pH heeft geen effect op zetmeel verdikking" },
          { en: "Acidic conditions enhance thickening power", es: "Condiciones ácidas mejoran el poder espesante", de: "Saure Bedingungen verstärken die Verdickungskraft", nl: "Zure omstandigheden verbeteren verdikkingskracht" },
          { en: "Very acidic conditions can break down starch and reduce thickening", es: "Condiciones muy ácidas pueden descomponer el almidón y reducir espesamiento", de: "Sehr saure Bedingungen können Stärke abbauen und Verdickung reduzieren", nl: "Zeer zure omstandigheden kunnen zetmeel afbreken en verdikking verminderen" },
          { en: "Alkaline conditions always improve texture", es: "Condiciones alcalinas siempre mejoran la textura", de: "Alkalische Bedingungen verbessern immer die Textur", nl: "Alkalische omstandigheden verbeteren altijd textuur" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Too much sugar; prevent by reducing sugar content", es: "Demasiada azúcar; prevenir reduciendo contenido de azúcar", de: "Zu viel Zucker; verhindern durch Reduzierung des Zuckergehalts", nl: "Te veel suiker; voorkomen door suikergehalte te verminderen" },
          { en: "Inadequate mixing and uneven heating; prevent with constant stirring and gradual heating", es: "Mezclado inadecuado y calentamiento desigual; prevenir con revuelto constante y calentamiento gradual", de: "Unzureichendes Mischen und ungleichmäßiges Erhitzen; verhindern durch konstantes Rühren und allmähliches Erhitzen", nl: "Onvoldoende mengen en ongelijkmatige verhitting; voorkomen met constant roeren en geleidelijke verhitting" },
          { en: "Using cold ingredients; prevent by warming everything first", es: "Usar ingredientes fríos; prevenir calentando todo primero", de: "Kalte Zutaten verwenden; verhindern durch vorheriges Erwärmen von allem", nl: "Koude ingrediënten gebruiken; voorkomen door alles eerst op te warmen" },
          { en: "Adding eggs too quickly; prevent by using fewer eggs", es: "Agregar huevos muy rápido; prevenir usando menos huevos", de: "Eier zu schnell hinzufügen; verhindern durch weniger Eier verwenden", nl: "Eieren te snel toevoegen; voorkomen door minder eieren te gebruiken" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Wheat starch; it has the lowest protein content", es: "Almidón de trigo; tiene el menor contenido de proteína", de: "Weizenstärke; sie hat den niedrigsten Proteingehalt", nl: "Tarwezetmeel; het heeft het laagste eiwitgehalte" },
          { en: "Potato starch; it forms clear, translucent gels", es: "Almidón de papa; forma geles claros y translúcidos", de: "Kartoffelstärke; sie bildet klare, durchscheinende Gele", nl: "Aardappelzetmeel; het vormt heldere, doorschijnende gels" },
          { en: "Rice starch; it has the smallest granules", es: "Almidón de arroz; tiene los gránulos más pequeños", de: "Reisstärke; sie hat die kleinsten Körner", nl: "Rijstzetmeel; het heeft de kleinste korrels" },
          { en: "Corn starch; it's the most commonly used", es: "Almidón de maíz; es el más comúnmente usado", de: "Maisstärke; sie wird am häufigsten verwendet", nl: "Maïszetmeel; het wordt het meest gebruikt" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Higher sugar raises setting temperature and creates firmer texture", es: "Mayor azúcar eleva temperatura de cuajado y crea textura más firme", de: "Höherer Zucker erhöht Abbindetemperatur und erzeugt festere Textur", nl: "Hogere suiker verhoogt zettemperatuur en creëert stevigere textuur" },
          { en: "Higher sugar lowers setting temperature and creates softer texture", es: "Mayor azúcar reduce temperatura de cuajado y crea textura más suave", de: "Höherer Zucker senkt Abbindetemperatur und erzeugt weichere Textur", nl: "Hogere suiker verlaagt zettemperatuur en creëert zachtere textuur" },
          { en: "Sugar has no effect on setting or texture", es: "El azúcar no tiene efecto en cuajado o textura", de: "Zucker hat keinen Einfluss auf Abbinden oder Textur", nl: "Suiker heeft geen effect op zetten of textuur" },
          { en: "Sugar only affects flavor, not texture", es: "El azúcar solo afecta el sabor, no la textura", de: "Zucker beeinflusst nur den Geschmack, nicht die Textur", nl: "Suiker beïnvloedt alleen smaak, niet textuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To remove excess liquid", es: "Para eliminar líquido excesivo", de: "Um überschüssige Flüssigkeit zu entfernen", nl: "Om overtollige vloeistof te verwijderen" },
          ...
          { en: "To remove lumps and ensure smooth texture", es: "Para eliminar grumos y asegurar textura suave", de: "Um Klumpen zu entfernen und glatte Textur zu gewährleisten", nl: "Om klontjes te verwijderen en gladde textuur te verzekeren" },
          { en: "To concentrate flavors", es: "Para concentrar sabores", de: "Um Aromen zu konzentrieren", nl: "Om smaken te concentreren" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Higher fat content creates lighter, airier texture", es: "Mayor contenido de grasa crea textura más ligera y aireada", de: "Höherer Fettgehalt erzeugt leichtere, luftigere Textur", nl: "Hoger vetgehalte creëert lichtere, luchtigere textuur" },
          { en: "Fat content has no impact on texture", es: "El contenido de grasa no tiene impacto en la textura", de: "Fettgehalt hat keinen Einfluss auf die Textur", nl: "Vetgehalte heeft geen impact op textuur" },
          { en: "Higher fat content creates richer, creamier mouthfeel and smoother texture", es: "Mayor contenido de grasa crea sensación bucal más rica y cremosa y textura más suave", de: "Höherer Fettgehalt erzeugt reichhaltigeres, cremigeres Mundgefühl und glattere Textur", nl: "Hoger vetgehalte creëert rijkere, romigere mondgevoel en gladdere textuur" },
          { en: "Lower fat always produces better puddings", es: "Menor grasa siempre produce mejores puddings", de: "Weniger Fett produziert immer bessere Puddings", nl: "Lager vet produceert altijd betere puddings" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Molecules become more soluble, improving texture", es: "Las moléculas se vuelven más solubles, mejorando la textura", de: "Moleküle werden löslicher, verbessern die Textur", nl: "Moleculen worden oplosbaarde, verbeteren textuur" },
          { en: "Starch molecules realign and form crystalline structures, causing firmness and syneresis", es: "Moléculas de almidón se realinean y forman estructuras cristalinas, causando firmeza y sinéresis", de: "Stärkemoleküle richten sich neu aus und bilden kristalline Strukturen, was zu Festigkeit und Synärese führt", nl: "Zetmeelmoleculen herrangschikken en vormen kristallijne structuren, wat stevigheid en synerese veroorzaakt" },
          { en: "Nothing changes during storage", es: "Nada cambia durante el almacenamiento", de: "Nichts ändert sich während der Lagerung", nl: "Niets verandert tijdens opslag" },
          { en: "Molecules break down completely", es: "Las moléculas se descomponen completamente", de: "Moleküle bauen sich vollständig ab", nl: "Moleculen breken volledig af" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Adding all chocolate at once at the end", es: "Agregar todo el chocolate de una vez al final", de: "Alle Schokolade auf einmal am Ende hinzufügen", nl: "Alle chocolade in één keer aan het eind toevoegen" },
          { en: "Gradual incorporation with constant whisking to form stable emulsion", es: "Incorporación gradual con batido constante para formar emulsión estable", de: "Allmähliche Einarbeitung mit konstantem Schlagen zur Bildung stabiler Emulsion", nl: "Geleidelijke incorporatie met constant kloppen om stabiele emulsie te vormen" },
          { en: "Melting chocolate separately and cooling before adding", es: "Derretir chocolate por separado y enfriar antes de agregar", de: "Schokolade separat schmelzen und vor Zugabe abkühlen", nl: "Chocolade apart smelten en afkoelen voor toevoegen" },
          { en: "Using only cocoa powder instead of chocolate", es: "Usar solo cacao en polvo en lugar de chocolate", de: "Nur Kakaopulver statt Schokolade verwenden", nl: "Alleen cacaopoeder gebruiken in plaats van chocolade" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Higher protein content provides additional structure and stability", es: "Mayor contenido de proteína proporciona estructura y estabilidad adicional", de: "Höherer Proteingehalt bietet zusätzliche Struktur und Stabilität", nl: "Hoger eiwitgehalte biedt extra structuur en stabiliteit" },
          { en: "Protein content has no effect on pudding structure", es: "El contenido de proteína no tiene efecto en la estructura del pudding", de: "Proteingehalt hat keinen Einfluss auf die Puddingstruktur", nl: "Eiwitgehalte heeft geen effect op puddingstructuur" },
          { en: "Lower protein content always creates better texture", es: "Menor contenido de proteína siempre crea mejor textura", de: "Niedrigerer Proteingehalt erzeugt immer bessere Textur", nl: "Lager eiwitgehalte creëert altijd betere textuur" },
          { en: "Only fat content matters for pudding texture", es: "Solo el contenido de grasa importa para la textura del pudding", de: "Nur der Fettgehalt ist wichtig für die Puddingstruktur", nl: "Alleen vetgehalte is belangrijk voor pudding textuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Room temperature (18-25°C)", es: "Temperatura ambiente (18-25°C)", de: "Raumtemperatur (18-25°C)", nl: "Kamertemperatuur (18-25°C)" },
          { en: "Refrigeration temperature (2-4°C)", es: "Temperatura de refrigeración (2-4°C)", de: "Kühlschranktemperatur (2-4°C)", nl: "Koelkast temperatuur (2-4°C)" },
          { en: "Warm temperature (40-50°C)", es: "Temperatura tibia (40-50°C)", de: "Warme Temperatur (40-50°C)", nl: "Warme temperatuur (40-50°C)" },
          { en: "Freezing temperature (-5°C)", es: "Temperatura de congelación (-5°C)", de: "Gefriertemperatur (-5°C)", nl: "Vriestemperatuur (-5°C)" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Alcohol improves gel strength significantly", es: "El alcohol mejora significativamente la fuerza del gel", de: "Alkohol verbessert die Gelstärke erheblich", nl: "Alcohol verbetert gelsterkte aanzienlijk" },
          { en: "Alcohol can interfere with starch gelatinization and soften texture", es: "El alcohol puede interferir con la gelatinización del almidón y suavizar la textura", de: "Alkohol kann die Stärkegelatinierung stören und die Textur weicher machen", nl: "Alcohol kan zetmeelgelatinisatie verstoren en textuur verzachten" },
          { en: "Alcohol has no effect on pudding properties", es: "El alcohol no tiene efecto en las propiedades del pudding", de: "Alkohol hat keinen Einfluss auf Puddingeigenschaften", nl: "Alcohol heeft geen effect op pudding eigenschappen" },
          { en: "Alcohol always improves pudding texture", es: "El alcohol siempre mejora la textura del pudding", de: "Alkohol verbessert immer die Puddingstruktur", nl: "Alcohol verbetert altijd pudding textuur" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Acts as a natural emulsifier and stabilizer", es: "Actúa como emulsificante natural y estabilizador", de: "Wirkt als natürlicher Emulgator und Stabilisator", nl: "Werkt als natuurlijke emulgator en stabilisator" },
          { en: "Provides additional sweetness", es: "Proporciona dulzura adicional", de: "Bietet zusätzliche Süße", nl: "Biedt extra zoetheid" },
          { en: "Acts as a thickening agent", es: "Actúa como agente espesante", de: "Wirkt als Verdickungsmittel", nl: "Werkt als verdikkingsmiddel" },
          { en: "Improves color development", es: "Mejora el desarrollo del color", de: "Verbessert die Farbentwicklung", nl: "Verbetert kleurontwikkeling" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Material choice has no impact on cooking results", es: "La elección del material no tiene impacto en los resultados de cocción", de: "Materialwahl hat keinen Einfluss auf Kochergebnisse", nl: "Materiaalkeuze heeft geen impact op kookresultaten" },
          { en: "Heavy-bottomed stainless steel provides even heat distribution and prevents scorching", es: "Acero inoxidable de fondo grueso proporciona distribución uniforme del calor y previene quemado", de: "Edelstahl mit schwerem Boden bietet gleichmäßige Wärmeverteilung und verhindert Anbrennen", nl: "Zwaarbodem roestvrij staal biedt gelijkmatige warmteverdeling en voorkomt aanbranden" },
          { en: "Aluminum always produces the best results", es: "El aluminio siempre produce los mejores resultados", de: "Aluminium produziert immer die besten Ergebnisse", nl: "Aluminium produceert altijd de beste resultaten" },
          { en: "Glass is the only suitable material", es: "El vidrio es el único material adecuado", de: "Glas ist das einzig geeignete Material", nl: "Glas is het enige geschikte materiaal" }
        ],
        correct: 1,
        explanation: {
