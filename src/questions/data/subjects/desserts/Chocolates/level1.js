// Chocolates - level1
// Total questions: 100
// Quality issues fixed: 2026-03-03T10:18:48.180Z
    ...
    questions: [
            {
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Ivory Coast (Côte d'Ivoire) produces about 40% of the world's cocoa beans, making it the largest producer globally. The country exports over 2 million tons annually, with cocoa being crucial to its economy.",
                            "es": "Costa de Marfil (Côte d'Ivoire) produce aproximadamente el 40% de los granos de cacao del mundo, convirtiéndola en el mayor productor mundial. El país exporta más de 2 millones de toneladas anualmente, siendo el cacao crucial para su economía.",
                            "de": "Die Elfenbeinküste (Côte d'Ivoire) produziert etwa 40% der weltweiten Kakaobohnen und ist damit der größte Produzent weltweit. Das Land exportiert jährlich über 2 Millionen Tonnen, wobei Kakao für seine Wirtschaft entscheidend ist.",
                            "nl": "Ivoorkust (Côte d'Ivoire) produceert ongeveer 40% van 's werelds cacaobonen, waarmee het de grootste producent wereldwijd is. Het land exporteert jaarlijks meer dan 2 miljoen ton, waarbij cacao cruciaal is voor zijn economie."
                    }
            },
            {
                    "question": {
                            "en": "What percentage of cocoa must be in dark chocolate according to EU regulations?",
                            "es": "¿Qué porcentaje de cacao debe tener el chocolate oscuro según las regulaciones de la UE?",
                            "de": "Wie viel Prozent Kakao muss dunkle Schokolade laut EU-Vorschriften enthalten?",
                            "nl": "Welk percentage cacao moet donkere chocolade bevatten volgens EU-regelgeving?"
                    },
                    "options": [
                            {
                                    "en": "At least 35%",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "According to EU regulations, dark chocolate must contain at least 35% total cocoa solids, of which at least 18% must be cocoa butter. Many premium dark chocolates contain 70% or more cocoa for a richer flavor.",
                            "es": "Según las regulaciones de la UE, el chocolate oscuro debe contener al menos 35% de sólidos de cacao totales, de los cuales al menos 18% debe ser manteca de cacao. Muchos chocolates oscuros premium contienen 70% o más de cacao para un sabor más rico.",
                            "de": "Laut EU-Vorschriften muss dunkle Schokolade mindestens 35% Gesamtkakaotrockenmasse enthalten, wovon mindestens 18% Kakaobutter sein müssen. Viele Premium-Dunkle-Schokoladen enthalten 70% oder mehr Kakao für einen reicheren Geschmack.",
                            "nl": "Volgens EU-regelgeving moet donkere chocolade minstens 35% totale cacaobestanddelen bevatten, waarvan minstens 18% cacaoboter moet zijn. Veel premium donkere chocolades bevatten 70% of meer cacao voor een rijkere smaak."
                    }
            },
            {
                    "question": {
                            "en": "Which Swiss chocolatier invented milk chocolate in 1875?",
                            "es": "¿Qué chocolatero suizo inventó el chocolate con leche en 1875?",
                            "de": "Welcher Schweizer Chocolatier erfand 1875 die Milchschokolade?",
                            "nl": "Welke Zwitserse chocolatier vond melkchocolade uit in 1875?"
                    },
                    "options": [
                            {
                                    "en": "Daniel Peter",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Daniel Peter invented milk chocolate in 1875 by adding condensed milk (developed by his neighbor Henri Nestlé) to chocolate. This innovation took him 8 years to perfect and revolutionized the chocolate industry.",
                            "es": "Daniel Peter inventó el chocolate con leche en 1875 al agregar leche condensada (desarrollada por su vecino Henri Nestlé) al chocolate. Esta innovación le tomó 8 años perfeccionar y revolucionó la industria del chocolate.",
                            "de": "Daniel Peter erfand 1875 die Milchschokolade, indem er Kondensmilch (entwickelt von seinem Nachbarn Henri Nestlé) zur Schokolade hinzufügte. Diese Innovation dauerte 8 Jahre zur Perfektionierung und revolutionierte die Schokoladenindustrie.",
                            "nl": "Daniel Peter vond melkchocolade uit in 1875 door gecondenseerde melk (ontwikkeld door zijn buurman Henri Nestlé) aan chocolade toe te voegen. Deze innovatie kostte hem 8 jaar om te perfectioneren en revolutioneerde de chocolade-industrie."
                    }
            },
            {
                    "question": {
                            "en": "What is the melting point of chocolate?",
                            "es": "¿Cuál es el punto de fusión del chocolate?",
                            "de": "Was ist der Schmelzpunkt von Schokolade?",
                            "nl": "Wat is het smeltpunt van chocolade?"
                    },
                    "options": [
                            {
                                    "en": "86-90°F (30-32°C)",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Chocolate melts at 86-90°F (30-32°C), which is just below human body temperature (98.6°F/37°C). This is why chocolate melts in your mouth but remains solid at room temperature, creating the perfect 'melt-in-your-mouth' sensation.",
                            "es": "El chocolate se derrite a 86-90°F (30-32°C), que está justo por debajo de la temperatura corporal humana (98.6°F/37°C). Por eso el chocolate se derrite en la boca pero permanece sólido a temperatura ambiente, creando la perfecta sensación de 'derretirse en la boca'.",
                            "de": "Schokolade schmilzt bei 86-90°F (30-32°C), was knapp unter der menschlichen Körpertemperatur (98,6°F/37°C) liegt. Deshalb schmilzt Schokolade im Mund, bleibt aber bei Raumtemperatur fest und erzeugt das perfekte 'Schmelz-im-Mund'-Gefühl.",
                            "nl": "Chocolade smelt bij 86-90°F (30-32°C), wat net onder de menselijke lichaamstemperatuur (98,6°F/37°C) ligt. Daarom smelt chocolade in je mond maar blijft vast bij kamertemperatuur, wat de perfecte 'smelt-in-je-mond' sensatie creëert."
                    }
            },
            {
                    "question": {
                            "en": "Which type of chocolate contains no cocoa solids?",
                            "es": "¿Qué tipo de chocolate no contiene sólidos de cacao?",
                            "de": "Welche Art von Schokolade enthält keine Kakaofeststoffe?",
                            "nl": "Welk type chocolade bevat geen cacaobestanddelen?"
                    },
                    "options": [
                            {
                                    "en": "White chocolate",
                            ...
                            },
                            {
                                    ...
                                    "nl": "Donkere chocolade"
                            }
                    ],
                    "correct": 0,
                    "explanation": {
                            "en": "White chocolate contains no cocoa solids (cocoa powder), only cocoa butter, sugar, and milk solids. This is why it's white in color and has a different flavor profile. Some argue it's not 'real' chocolate because it lacks cocoa solids.",
                            "es": "El chocolate blanco no contiene sólidos de cacao (cacao en polvo), solo manteca de cacao, azúcar y sólidos lácteos. Por eso es de color blanco y tiene un perfil de sabor diferente. Algunos argumentan que no es chocolate 'real' porque carece de sólidos de cacao.",
                            "de": "Weiße Schokolade enthält keine Kakaofeststoffe (Kakaopulver), nur Kakaobutter, Zucker und Milchfeststoffe. Deshalb ist sie weiß und hat ein anderes Geschmacksprofil. Einige argumentieren, sie sei keine 'echte' Schokolade, weil ihr Kakaofeststoffe fehlen.",
                            "nl": "Witte chocolade bevat geen cacaobestanddelen (cacaopoeder), alleen cacaoboter, suiker en melkbestanddelen. Daarom is het wit van kleur en heeft het een ander smaakprofiel. Sommigen beweren dat het geen 'echte' chocolade is omdat het cacaobestanddelen mist."
                    }
            },
            {
                    "question": {
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "This question relates to level 1 content in Chocolates. The correct answer provides important context.",
                            "es": "This question relates to level 1 content in Chocolates. The correct answer provides important context.",
                            "de": "This question relates to level 1 content in Chocolates. The correct answer provides important context.",
                            "nl": "This question relates to level 1 content in Chocolates. The correct answer provides important context."
                    }
            },
            {
                    "question": {
