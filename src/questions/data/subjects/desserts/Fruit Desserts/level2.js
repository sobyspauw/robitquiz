// Quiz Template - Level 2: Dessert - Fruitdesserts
(function() {
  const level2 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Polyphenol oxidase; inhibited by acid or antioxidants", es: "Polifenol oxidasa; inhibida por ácido o antioxidantes", de: "Polyphenoloxidase; gehemmt durch Säure oder Antioxidantien", nl: "Polyfenoloxidase; geremd door zuur of antioxidanten" },
          { en: "Amylase; inhibited by heat treatment", es: "Amilasa; inhibida por tratamiento térmico", de: "Amylase; gehemmt durch Wärmebehandlung", nl: "Amylase; geremd door warmtebehandeling" },
          { en: "Pectinase; inhibited by sugar", es: "Pectinasa; inhibida por azúcar", de: "Pektinase; gehemmt durch Zucker", nl: "Pectinase; geremd door suiker" },
          { en: "Catalase; inhibited by salt", es: "Catalasa; inhibida por sal", de: "Katalase; gehemmt durch Salz", nl: "Catalase; geremd door zout" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Hydrolysis of cellulose", es: "Hidrólisis de celulosa", de: "Hydrolyse von Zellulose", nl: "Hydrolyse van cellulose" },
          { en: "Maillard reaction and sugar caramelization", es: "Reacción de Maillard y caramelización del azúcar", de: "Maillard-Reaktion und Zuckerkaramelisierung", nl: "Maillard reactie en suikerkaramelisatie" },
          { en: "Protein denaturation", es: "Desnaturalización de proteínas", de: "Proteindenaturierung", nl: "Eiwitdenaturatie" },
          { en: "Lipid oxidation", es: "Oxidación de lípidos", de: "Lipidoxidation", nl: "Lipideoxidatie" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates gel structure; activated by alkaline conditions", es: "Crea estructura de gel; activada por condiciones alcalinas", de: "Erzeugt Gelstruktur; aktiviert durch alkalische Bedingungen", nl: "Creëert gelstructuur; geactiveerd door alkalische omstandigheden" },
          { en: "Creates gel structure; activated by acid, sugar, and heat", es: "Crea estructura de gel; activada por ácido, azúcar y calor", de: "Erzeugt Gelstruktur; aktiviert durch Säure, Zucker und Hitze", nl: "Creëert gelstructuur; geactiveerd door zuur, suiker en warmte" },
          { en: "Prevents browning; activated by salt", es: "Previene pardeamiento; activada por sal", de: "Verhindert Bräunung; aktiviert durch Salz", nl: "Voorkomt bruining; geactiveerd door zout" },
          { en: "Adds sweetness; activated by cold temperatures", es: "Agrega dulzura; activada por temperaturas frías", de: "Fügt Süße hinzu; aktiviert durch kalte Temperaturen", nl: "Voegt zoetheid toe; geactiveerd door koude temperaturen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Ripeness only affects flavor, not texture", es: "La madurez solo afecta el sabor, no la textura", de: "Reife beeinflusst nur den Geschmack, nicht die Textur", nl: "Rijpheid beïnvloedt alleen smaak, niet textuur" },
          { en: "Underripe fruit has higher pectin for gelling; overripe fruit is better for purees", es: "Fruta inmadura tiene mayor pectina para gelificar; fruta sobremadura es mejor para purés", de: "Unreife Früchte haben höheres Pektin zum Gelieren; überreife Früchte sind besser für Pürees", nl: "Onrijp fruit heeft hogere pectine voor geleren; overrijp fruit is beter voor purées" },
          { en: "Only fully ripe fruit should be used for desserts", es: "Solo fruta completamente madura debe usarse para postres", de: "Nur vollreife Früchte sollten für Desserts verwendet werden", nl: "Alleen volledig rijp fruit moet worden gebruikt voor desserts" },
          { en: "Ripeness has no impact on dessert quality", es: "La madurez no tiene impacto en la calidad del postre", de: "Reife hat keinen Einfluss auf die Dessertqualität", nl: "Rijpheid heeft geen impact op de dessertkwaliteit" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Steam expansion in trapped air bubbles from whipped whites", es: "Expansión de vapor en burbujas de aire atrapadas de claras batidas", de: "Dampfausdehnung in eingeschlossenen Luftblasen aus geschlagenen Eiweiß", nl: "Stoomexpansie in ingesloten luchtbellen van geklopte eiwitten" },
          { en: "Yeast fermentation producing gas", es: "Fermentación de levadura produciendo gas", de: "Hefefermentation, die Gas produziert", nl: "Gistfermentatie die gas produceert" },
          { en: "Chemical leavening agents", es: "Agentes leudantes químicos", de: "Chemische Triebmittel", nl: "Chemische rijsmiddelen" },
          { en: "Sugar crystallization providing structure", es: "Cristalización del azúcar proporcionando estructura", de: "Zuckerkristallisation, die Struktur bietet", nl: "Suikerkristallisatie die structuur biedt" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Long, slow cooking at high temperatures", es: "Cocción larga y lenta a altas temperaturas", de: "Langes, langsames Kochen bei hohen Temperaturen", nl: "Lang, langzaam koken op hoge temperaturen" },
          { en: "Quick cooking at moderate temperatures or minimal processing", es: "Cocción rápida a temperaturas moderadas o procesamiento mínimo", de: "Schnelles Kochen bei moderaten Temperaturen oder minimale Verarbeitung", nl: "Snel koken op gematigde temperaturen of minimale verwerking" },
          { en: "Multiple freezing and thawing cycles", es: "Múltiples ciclos de congelación y descongelación", de: "Mehrere Einfrier- und Auftauzyklen", nl: "Meerdere vries- en ontdooicycli" },
          { en: "Extended exposure to air and light", es: "Exposición prolongada al aire y luz", de: "Verlängerte Exposition gegenüber Luft und Licht", nl: "Langdurige blootstelling aan lucht en licht" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Different sugar types used", es: "Diferentes tipos de azúcar utilizados", de: "Verschiedene verwendete Zuckerarten", nl: "Verschillende gebruikte suikertypes" },
          { en: "Cell wall breakdown and pectin release rates", es: "Descomposición de paredes celulares y tasas de liberación de pectina", de: "Zellwandabbau und Pektinfreisetzungsraten", nl: "Celwandafbraak en pectine vrijgavesnelheden" },
          { en: "Vitamin C content variations", es: "Variaciones en contenido de vitamina C", de: "Vitamin-C-Gehalt-Variationen", nl: "Vitamine C gehalte variaties" },
          { en: "Water content differences", es: "Diferencias en contenido de agua", de: "Wassergehalt-Unterschiede", nl: "Watergehalte verschillen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "pH only affects color, not taste or texture", es: "El pH solo afecta el color, no el sabor o textura", de: "pH beeinflusst nur die Farbe, nicht Geschmack oder Textur", nl: "pH beïnvloedt alleen kleur, niet smaak of textuur" },
          { en: "Low pH enhances pectin gelling, preserves color, and balances sweetness", es: "pH bajo mejora gelificación de pectina, preserva color y equilibra dulzura", de: "Niedriger pH verbessert Pektingelung, erhält Farbe und balanciert Süße", nl: "Lage pH verbetert pectine gelering, behoudt kleur en balanceert zoetheid" },
          { en: "High pH is always preferred for fruit desserts", es: "pH alto siempre se prefiere para postres de fruta", de: "Hoher pH wird immer für Fruchtdesserts bevorzugt", nl: "Hoge pH wordt altijd verkozen voor fruitdesserts" },
          { en: "pH has no significant impact on dessert quality", es: "El pH no tiene impacto significativo en la calidad del postre", de: "pH hat keinen signifikanten Einfluss auf die Dessertqualität", nl: "pH heeft geen significante impact op de dessertkwaliteit" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cells become more rigid and tough", es: "Las células se vuelven más rígidas y duras", de: "Zellen werden starrer und zäher", nl: "Cellen worden stijver en taaier" },
          { en: "Cells remain completely unchanged", es: "Las células permanecen completamente sin cambios", de: "Zellen bleiben völlig unverändert", nl: "Cellen blijven volledig onveranderd" },
          { en: "Gentle heat softens cell walls while maintaining fruit shape", es: "El calor suave ablanda paredes celulares mientras mantiene forma de fruta", de: "Sanfte Hitze erweicht Zellwände bei Erhaltung der Fruchtform", nl: "Zachte warmte verzacht celwanden terwijl fruitvorm behouden blijft" },
          { en: "Cells completely disintegrate immediately", es: "Las células se desintegran completamente inmediatamente", de: "Zellen zerfallen sofort vollständig", nl: "Cellen desintegreren volledig onmiddellijk" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Only sweetness level matters", es: "Solo importa el nivel de dulzura", de: "Nur der Süßegrad ist wichtig", nl: "Alleen zoetheidsgraad telt" },
          { en: "Fruit must be extremely soft", es: "La fruta debe estar extremadamente blanda", de: "Früchte müssen extrem weich sein", nl: "Fruit moet extreem zacht zijn" },
          { en: "Structural integrity to hold shape during caramelization", es: "Integridad estructural para mantener forma durante caramelización", de: "Strukturelle Integrität, um Form während Karamelisierung zu halten", nl: "Structurele integriteit om vorm te behouden tijdens karamelisatie" },
          { en: "Color is the only important consideration", es: "El color es la única consideración importante", de: "Farbe ist die einzige wichtige Überlegung", nl: "Kleur is de enige belangrijke overweging" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Higher concentration always creates better texture", es: "Mayor concentración siempre crea mejor textura", de: "Höhere Konzentration erzeugt immer bessere Textur", nl: "Hogere concentratie creëert altijd betere textuur" },
          { en: "Concentration doesn't affect texture", es: "La concentración no afecta la textura", de: "Konzentration beeinflusst Textur nicht", nl: "Concentratie beïnvloedt textuur niet" },
          { en: "Optimal concentration creates tender set that melts pleasantly; too much creates rubbery texture", es: "Concentración óptima crea cuajado tierno que se derrite agradablemente; demasiado crea textura gomosa", de: "Optimale Konzentration erzeugt zarte Festigkeit, die angenehm schmilzt; zu viel erzeugt gummiartige Textur", nl: "Optimale concentratie creëert tendre zetting die aangenaam smelt; te veel creëert rubberachtige textuur" },
          { en: "Lower concentration is always preferred", es: "Menor concentración siempre se prefiere", de: "Niedrigere Konzentration wird immer bevorzugt", nl: "Lagere concentratie wordt altijd verkozen" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Adding invert sugar or glucose to interfere with crystal formation", es: "Agregar azúcar invertido o glucosa para interferir con formación de cristales", de: "Hinzufügung von Invertzucker oder Glukose zur Störung der Kristallbildung", nl: "Toevoegen van invertsuiker of glucose om kristalvorming te verstoren" },
          ...
          { en: "Stirring constantly during cooking", es: "Revolver constantemente durante la cocción", de: "Konstantes Rühren während des Kochens", nl: "Constant roeren tijdens koken" },
          { en: "Adding more water to the syrup", es: "Agregar más agua al jarabe", de: "Mehr Wasser zum Sirup hinzufügen", nl: "Meer water aan de siroop toevoegen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "They contain too much water", es: "Contienen demasiada agua", de: "Sie enthalten zu viel Wasser", nl: "Ze bevatten te veel water" },
          { en: "They contain proteolytic enzymes that break down gelatin", es: "Contienen enzimas proteolíticas que descomponen la gelatina", de: "Sie enthalten proteolytische Enzyme, die Gelatine abbauen", nl: "Ze bevatten proteolytische enzymen die gelatine afbreken" },
          { en: "They are too acidic", es: "Son demasiado ácidas", de: "Sie sind zu sauer", nl: "Ze zijn te zuur" },
          { en: "They have too much natural sugar", es: "Tienen demasiada azúcar natural", de: "Sie haben zu viel natürlichen Zucker", nl: "Ze hebben te veel natuurlijke suiker" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Ice cold (0-5°C) for all fruit desserts", es: "Helado (0-5°C) para todos los postres de fruta", de: "Eiskalt (0-5°C) für alle Fruchtdesserts", nl: "IJskoud (0-5°C) voor alle fruitdesserts" },
          { en: "Room temperature (18-25°C) enhances flavor perception; chilled for some textures", es: "Temperatura ambiente (18-25°C) mejora percepción de sabor; frío para algunas texturas", de: "Raumtemperatur (18-25°C) verbessert Geschmackswahrnehmung; gekühlt für einige Texturen", nl: "Kamertemperatuur (18-25°C) verbetert smaakperceptie; gekoeld voor sommige texturen" },
          { en: "Always serve hot (above 60°C)", es: "Siempre servir caliente (arriba de 60°C)", de: "Immer heiß servieren (über 60°C)", nl: "Altijd heet serveren (boven 60°C)" },
          { en: "Temperature doesn't affect flavor perception", es: "La temperatura no afecta la percepción del sabor", de: "Temperatur beeinflusst Geschmackswahrnehmung nicht", nl: "Temperatuur beïnvloedt smaakperceptie niet" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Fiber content has no impact on preparation", es: "El contenido de fibra no tiene impacto en la preparación", de: "Fasergehalt hat keinen Einfluss auf die Zubereitung", nl: "Vezelgehalte heeft geen impact op bereiding" },
          { en: "High-fiber fruits may need longer cooking or straining for smooth textures", es: "Frutas altas en fibra pueden necesitar cocción más larga o colado para texturas suaves", de: "Faserreiche Früchte benötigen möglicherweise längeres Kochen oder Sieben für glatte Texturen", nl: "Vezelrijke vruchten hebben mogelijk langer koken of zeven nodig voor gladde texturen" },
          { en: "Only low-fiber fruits can be used in desserts", es: "Solo frutas bajas en fibra pueden usarse en postres", de: "Nur faserarme Früchte können in Desserts verwendet werden", nl: "Alleen vezelarme vruchten kunnen worden gebruikt in desserts" },
          { en: "All fruits have identical fiber content", es: "Todas las frutas tienen contenido de fibra idéntico", de: "Alle Früchte haben identischen Fasergehalt", nl: "Alle vruchten hebben identiek vezelgehalte" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Tannins only affect color", es: "Los taninos solo afectan el color", de: "Tannine beeinflussen nur die Farbe", nl: "Tannines beïnvloeden alleen kleur" },
          { en: "Tannins create astringent, bitter flavors that require balancing with sugar or cooking", es: "Los taninos crean sabores astringentes y amargos que requieren equilibrio con azúcar o cocción", de: "Tannine erzeugen adstringierende, bittere Aromen, die Ausgleich mit Zucker oder Kochen benötigen", nl: "Tannines creëren samentrekkende, bittere smaken die balancering met suiker of koken vereisen" },
          { en: "Tannins improve dessert texture", es: "Los taninos mejoran la textura del postre", de: "Tannine verbessern die Dessert-Textur", nl: "Tannines verbeteren de desserttextuur" },
          { en: "Tannins have no effect on fruit desserts", es: "Los taninos no tienen efecto en postres de fruta", de: "Tannine haben keinen Einfluss auf Fruchtdesserts", nl: "Tannines hebben geen effect op fruitdesserts" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Rapid freezing with controlled thawing", es: "Congelación rápida con descongelación controlada", de: "Schnelles Einfrieren mit kontrolliertem Auftauen", nl: "Snel invriezen met gecontroleerd ontdooien" },
          { en: "Slow air drying at room temperature", es: "Secado lento al aire a temperatura ambiente", de: "Langsame Lufttrocknung bei Raumtemperatur", nl: "Langzaam luchtdrogen op kamertemperatuur" },
          { en: "Extended cooking at high temperatures", es: "Cocción extendida a altas temperaturas", de: "Verlängertes Kochen bei hohen Temperaturen", nl: "Verlengd koken op hoge temperaturen" },
          { en: "Multiple freeze-thaw cycles", es: "Múltiples ciclos de congelación-descongelación", de: "Mehrere Einfrier-Auftau-Zyklen", nl: "Meerdere vries-ontdooi cycli" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates browning and complex flavors when sugars and amino acids heat together", es: "Crea dorado y sabores complejos cuando azúcares y aminoácidos se calientan juntos", de: "Erzeugt Bräunung und komplexe Aromen, wenn Zucker und Aminosäuren zusammen erhitzt werden", nl: "Creëert verbruining en complexe smaken wanneer suikers en aminozuren samen verhit worden" },
          { en: "Only affects fruit color, not taste", es: "Solo afecta el color de la fruta, no el sabor", de: "Beeinflusst nur die Fruchtfarbe, nicht den Geschmack", nl: "Beïnvloedt alleen fruitkleur, niet smaak" },
          { en: "Prevents fruit from cooking properly", es: "Evita que la fruta se cocine adecuadamente", de: "Verhindert, dass Obst richtig kocht", nl: "Voorkomt dat fruit goed kookt" },
          { en: "Has no effect on fruit desserts", es: "No tiene efecto en postres de fruta", de: "Hat keinen Einfluss auf Fruchtdesserts", nl: "Heeft geen effect op fruitdesserts" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "They only provide nutritional benefits", es: "Solo proporcionan beneficios nutricionales", de: "Sie bieten nur ernährungsphysiologische Vorteile", nl: "Ze bieden alleen voedingsvoordelen" },
          { en: "They create pH-sensitive pigments that can shift from red to blue in alkaline conditions", es: "Crean pigmentos sensibles al pH que pueden cambiar de rojo a azul en condiciones alcalinas", de: "Sie erzeugen pH-empfindliche Pigmente, die sich von rot zu blau in alkalischen Bedingungen verschieben können", nl: "Ze creëren pH-gevoelige pigmenten die kunnen verschuiven van rood naar blauw onder alkalische omstandigheden" },
          { en: "They prevent any color changes", es: "Evitan cualquier cambio de color", de: "Sie verhindern jegliche Farbveränderungen", nl: "Ze voorkomen elke kleurverandering" },
          { en: "They only affect flavor, not color", es: "Solo afectan el sabor, no el color", de: "Sie beeinflussen nur den Geschmack, nicht die Farbe", nl: "Ze beïnvloeden alleen smaak, niet kleur" }
        ],
        correct: 1,
        explanation: {
