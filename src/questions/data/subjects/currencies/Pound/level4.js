    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Tail risk modeling with conditional Value-at-Risk under extreme scenarios",
                  "es": "Modelado de riesgo de cola con Valor en Riesgo condicional bajo escenarios extremos",
                  "de": "Tail-Risk-Modellierung mit bedingtem Value-at-Risk unter extremen Szenarien",
                  "nl": "Staartrisico modellering met conditionele Value-at-Risk onder extreme scenario's"
        },
        {
                  "en": "Market capitalization weighted assessments",
                  "es": "Evaluaciones ponderadas por capitalización de mercado",
                  "de": "Marktkapitalisierung-gewichtete Bewertungen",
                  "nl": "Marktkapitalisatie gewogen beoordelingen"
        },
        {
                  "en": "Static balance sheet ratio examination",
                  "es": "Examen estático de ratios de balance",
                  "de": "Statische Bilanzanalyse-Untersuchung",
                  "nl": "Statisch balans ratio onderzoek"
        },
        {
                  "en": "Simple historical correlation analysis",
                  "es": "Análisis de correlación histórica simple",
                  "de": "Einfache historische Korrelationsanalyse",
                  "nl": "Eenvoudige historische correlatieanalyse"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Directly purchases corporate bonds in secondary markets",
                  "es": "Compra directamente bonos corporativos en mercados secundarios",
                  "de": "Kauft direkt Unternehmensanleihen in Sekundärmärkten",
                  "nl": "Koopt direct bedrijfsobligaties in secundaire markten"
        },
        {
                  "en": "Provides long-term funding to banks at rates close to Bank Rate to enhance credit transmission",
                  "es": "Proporciona financiamiento a largo plazo a bancos a tasas cercanas a la Tasa Bancaria para mejorar transmisión crediticia",
                  "de": "Bietet langfristige Finanzierung für Banken zu Zinssätzen nahe dem Leitzins zur Verbesserung der Kreditübertragung",
                  "nl": "Biedt langetermijnfinanciering aan banken tegen tarieven dicht bij de Bank Rate om krediet transmissie te verbeteren"
        },
        {
                  "en": "Manages foreign exchange intervention operations",
                  "es": "Gestiona operaciones de intervención de divisas",
                  "de": "Verwaltet Deviseninterventionsoperationen",
                  "nl": "Beheert valuta interventie operaties"
        },
        {
                  "en": "Sets mandatory lending quotas for commercial banks",
                  "es": "Establece cuotas de préstamo obligatorias para bancos comerciales",
                  "de": "Setzt obligatorische Kreditquoten für Geschäftsbanken fest",
                  "nl": "Stelt verplichte leenquota's vast voor commerciële banken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Works exclusively through exchange rate channels",
                  "es": "Funciona exclusivamente a través de canales de tipo de cambio",
                  "de": "Funktioniert ausschließlich über Wechselkurskanäle",
                  "nl": "Werkt uitsluitend via wisselkoerskanalen"
        },
        {
                  "en": "Targets bank lending directly rather than portfolio balance effects through asset purchases",
                  "es": "Se dirige directamente a préstamos bancarios en lugar de efectos de equilibrio de cartera a través de compras de activos",
                  "de": "Zielt direkt auf Bankkredite ab statt auf Portfolio-Balance-Effekte durch Anleihekäufe",
                  "nl": "Richt zich direct op bankleningen in plaats van portfolio balans effecten door activaaankopen"
        },
        {
                  "en": "Only affects government bond yields",
                  "es": "Solo afecta los rendimientos de bonos gubernamentales",
                  "de": "Beeinflusst nur Staatsanleihenrenditen",
                  "nl": "Beïnvloedt alleen staatsobligatie rendementen"
        },
        {
                  "en": "Operates identical transmission mechanisms to QE",
                  "es": "Opera mecanismos de transmisión idénticos a QE",
                  "de": "Betreibt identische Übertragungsmechanismen wie QE",
                  "nl": "Hanteert identieke transmissiemechanismen als QE"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Has no measurable impact on credit conditions",
                  "es": "No tiene impacto medible en condiciones crediticias",
                  "de": "Hat keinen messbaren Einfluss auf Kreditbedingungen",
                  "nl": "Heeft geen meetbare impact op kredietcondities"
        },
        {
                  ...
                  "nl": "Beïnvloedt alleen staatsobligatie markten"
        },
        {
                  "en": "Compresses credit spreads through portfolio balance effects and reduces term premiums",
                  "es": "Comprime los spreads crediticios a través de efectos de equilibrio de cartera y reduce primas de plazo",
                  "de": "Komprimiert Kreditspreads durch Portfolio-Balance-Effekte und reduziert Laufzeitprämien",
                  "nl": "Comprimeert krediet spreads door portfolio balans effecten en reduceert looptijd premies"
        },
        {
                  "en": "Increases volatility in corporate bond markets",
                  "es": "Aumenta volatilidad en mercados de bonos corporativos",
                  "de": "Erhöht Volatilität in Unternehmensanleihenmärkten",
                  "nl": "Verhoogt volatiliteit in bedrijfsobligatie markten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sets interest rates for monetary policy",
                  "es": "Establece tasas de interés para política monetaria",
                  "de": "Setzt Zinssätze für Geldpolitik",
                  "nl": "Stelt rentetarieven vast voor monetair beleid"
        },
        {
                  "en": "Regulates individual bank capital requirements only",
                  "es": "Regula solo requisitos de capital bancario individual",
                  "de": "Reguliert nur individuelle Bankkapitalanforderungen",
                  "nl": "Reguleert alleen individuele bankkapitaalvereisten"
        },
        {
                  "en": "Identifies systemic risks and deploys tools like countercyclical capital buffers",
                  "es": "Identifica riesgos sistémicos y despliega herramientas como amortiguadores de capital contracíclicos",
                  "de": "Identifiziert systemische Risiken und setzt Instrumente wie antizyklische Kapitalpuffer ein",
                  "nl": "Identificeert systemische risico's en zet instrumenten in zoals anticyclische kapitaalbuffers"
        },
        {
                  "en": "Manages day-to-day banking supervision",
                  "es": "Gestiona supervisión bancaria día a día",
                  "de": "Verwaltet tägliche Bankenaufsicht",
                  "nl": "Beheert dagelijkse banktoezicht"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Prohibits negative rates under all circumstances",
                  "es": "Prohíbe tasas negativas bajo todas las circunstancias",
                  "de": "Verbietet negative Zinssätze unter allen Umständen",
                  "nl": "Verbiedt negatieve tarieven onder alle omstandigheden"
        },
        {
                  "en": "Applies uniform negative rates to all bank reserves",
                  "es": "Aplica tasas negativas uniformes a todas las reservas bancarias",
                  "de": "Wendet einheitliche negative Zinssätze auf alle Bankreserven an",
                  "nl": "Past uniforme negatieve tarieven toe op alle bankreserves"
        },
        {
                  "en": "Uses tiered reserve system to limit bank cost transmission while maintaining policy effectiveness",
                  "es": "Usa sistema de reservas escalonado para limitar transmisión de costos bancarios mientras mantiene efectividad política",
                  "de": "Verwendet gestuftes Reservesystem zur Begrenzung von Bankkosten-Übertragung bei Erhaltung der Politikwirksamkeit",
                  "nl": "Gebruikt getierd reservesysteem om bankkostentransmissie te beperken terwijl beleidseffectiviteit behouden blijft"
        },
        {
                  "en": "Only affects interbank lending rates",
                  "es": "Solo afecta tasas de préstamos interbancarios",
                  "de": "Beeinflusst nur Interbankenzinssätze",
                  "nl": "Beïnvloedt alleen interbancaire leenrentes"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sets collateral requirements for commercial banks",
                  "es": "Establece requisitos de colateral para bancos comerciales",
                  "de": "Setzt Sicherheitenanforderungen für Geschäftsbanken",
                  "nl": "Stelt onderpandvereisten vast voor commerciële banken"
        },
        {
                  "en": "Manages foreign exchange reserves",
                  "es": "Gestiona reservas de divisas",
                  "de": "Verwaltet Devisenreserven",
                  "nl": "Beheert valutareserves"
        },
        {
                  "en": "Provides backstop liquidity during market stress to maintain monetary policy transmission",
                  "es": "Proporciona liquidez de respaldo durante estrés de mercado para mantener transmisión de política monetaria",
                  "de": "Bietet Backstop-Liquidität während Marktstress zur Aufrechterhaltung der geldpolitischen Übertragung",
                  "nl": "Biedt backstop liquiditeit tijdens marktstress om monetaire beleidstransmissie te behouden"
        },
        {
                  "en": "Conducts regular weekly repo operations",
                  "es": "Conduce operaciones repo semanales regulares",
                  "de": "Führt regelmäßige wöchentliche Repo-Operationen durch",
                  "nl": "Voert reguliere wekelijkse repo operaties uit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Provides indexed funding linked to Bank Rate to maintain policy transmission during large balance sheet operations",
                  "es": "Proporciona financiamiento indexado vinculado a la Tasa Bancaria para mantener transmisión política durante operaciones de balance grandes",
                  "de": "Bietet indexierte Finanzierung gekoppelt an den Leitzins zur Aufrechterhaltung der Politikübertragung während großer Bilanzoperationen",
                  "nl": "Biedt geïndexeerde financiering gekoppeld aan de Bank Rate om beleidstransmissie te behouden tijdens grote balansoperaties"
        },
        {
                  "en": "Directly purchases government bonds for QE portfolio",
                  "es": "Compra directamente bonos gubernamentales para cartera QE",
                  "de": "Kauft direkt Staatsanleihen für QE-Portfolio",
                  "nl": "Koopt direct staatsobligaties voor QE portefeuille"
        },
        {
                  "en": "Manages interest payments on reserves",
                  "es": "Gestiona pagos de interés sobre reservas",
                  "de": "Verwaltet Zinszahlungen auf Reserven",
                  "nl": "Beheert rentebetalingen op reserves"
        },
        {
                  "en": "Controls inflation expectations through forward guidance",
                  "es": "Controla expectativas de inflación a través de guía prospectiva",
                  "de": "Kontrolliert Inflationserwartungen durch Forward Guidance",
                  "nl": "Controleert inflatieverwachtingen door forward guidance"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Manages government bond auctions",
                  "es": "Gestiona subastas de bonos gubernamentales",
                  "de": "Verwaltet Staatsanleihen-Auktionen",
                  "nl": "Beheert staatsobligatie veilingen"
        },
        {
                  "en": "Coordinates transition from LIBOR to SONIA across sterling markets and contracts",
                  "es": "Coordina transición de LIBOR a SONIA a través de mercados y contratos de libras esterlinas",
                  "de": "Koordiniert Übergang von LIBOR zu SONIA über Sterling-Märkte und -Verträge",
                  "nl": "Coördineert transitie van LIBOR naar SONIA over sterling markten en contracten"
        },
        {
                  "en": "Regulates derivatives trading",
                  "es": "Regula comercio de derivados",
                  "de": "Reguliert Derivatehandel",
                  "nl": "Reguleert derivatenhandel"
        },
        {
                  "en": "Sets daily SONIA rates",
                  "es": "Establece tasas SONIA diarias",
                  "de": "Setzt tägliche SONIA-Zinssätze",
                  "nl": "Stelt dagelijkse SONIA tarieven vast"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Models economic impacts of climate policy changes on bank portfolios over multiple scenarios",
                  "es": "Modela impactos económicos de cambios de política climática en carteras bancarias sobre múltiples escenarios",
                  "de": "Modelliert wirtschaftliche Auswirkungen von Klimapolitikänderungen auf Bankportfolios über mehrere Szenarien",
                  "nl": "Modelleert economische impacts van klimaatbeleidsveranderingen op bankportefeuilles over meerdere scenario's"
        },
        {
                  "en": "Focuses exclusively on carbon tax implications",
                  "es": "Se enfoca exclusivamente en implicaciones de impuestos al carbono",
                  "de": "Fokussiert ausschließlich auf Kohlenstoffsteuer-Implikationen",
                  "nl": "Richt zich uitsluitend op koolstofbelasting implicaties"
        },
        {
                  "en": "Examines only real estate exposure to sea level rise",
                  "es": "Examina solo exposición inmobiliaria al aumento del nivel del mar",
                  "de": "Untersucht nur Immobilienexposition gegenüber Meeresspiegelanstieg",
                  "nl": "Onderzoekt alleen vastgoedblootstelling aan zeespiegelstijging"
        },
        {
                  "en": "Only assesses physical climate risks",
                  "es": "Solo evalúa riesgos climáticos físicos",
                  "de": "Bewertet nur physische Klimarisiken",
                  "nl": "Beoordeelt alleen fysieke klimaatrisico's"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Simple correlation analysis between asset prices",
                  "es": "Análisis de correlación simple entre precios de activos",
                  "de": "Einfache Korrelationsanalyse zwischen Vermögenspreisen",
                  "nl": "Eenvoudige correlatieanalyse tussen activaprijzen"
        },
        {
                  "en": "Historical stress testing based on single institution failures",
                  "es": "Pruebas de estrés históricas basadas en fallas de instituciones únicas",
                  "de": "Historische Stresstests basierend auf Einzelinstitut-Ausfällen",
                  "nl": "Historische stresstests gebaseerd op enkele instelling faillissementen"
        },
        {
                  "en": "Graph theory and contagion modeling to map interconnectedness and identify systemically important nodes",
                  "es": "Teoría de grafos y modelado de contagio para mapear interconexión e identificar nodos sistémicamente importantes",
                  "de": "Graphentheorie und Ansteckungsmodellierung zur Kartierung von Vernetzung und Identifizierung systemisch wichtiger Knoten",
                  "nl": "Grafentheorie en besmettingsmodellering om onderlinge verbondenheid in kaart te brengen en systemisch belangrijke knooppunten te identificeren"
        },
        {
                  "en": "Traditional credit risk assessment methodologies",
                  "es": "Metodologías tradicionales de evaluación de riesgo crediticio",
                  "de": "Traditionelle Kreditrisikobewertungsmethodologien",
                  "nl": "Traditionele kredietrisico beoordelingsmethodologieën"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Focuses solely on labor market dynamics",
                  "es": "Se enfoca únicamente en dinámicas del mercado laboral",
                  "de": "Fokussiert ausschließlich auf Arbeitsmarktdynamik",
                  "nl": "Richt zich uitsluitend op arbeidsmarktdynamiek"
        },
        {
                  "en": "Provides microfounded framework for analyzing policy transmission and optimal responses to shocks",
                  "es": "Proporciona marco microfundamentado para analizar transmisión política y respuestas óptimas a shocks",
                  "de": "Bietet mikrofundiertes Framework zur Analyse von Politikübertragung und optimalen Antworten auf Schocks",
                  "nl": "Biedt microgefundeerd kader voor het analyseren van beleidstransmissie en optimale reacties op schokken"
        },
        {
                  "en": "Only forecasts inflation using historical data",
                  "es": "Solo pronostica inflación usando datos históricos",
                  "de": "Prognostiziert nur Inflation anhand historischer Daten",
                  "nl": "Voorspelt alleen inflatie met historische gegevens"
        },
        {
                  "en": "Determines exchange rate policy exclusively",
                  "es": "Determina política de tipo de cambio exclusivamente",
                  "de": "Bestimmt Wechselkurspolitik ausschließlich",
                  "nl": "Bepaalt wisselkoersbeleid uitsluitend"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Macroprudential tool that can complement or substitute for monetary policy in addressing credit cycles",
                  "es": "Herramienta macroprudencial que puede complementar o sustituir política monetaria al abordar ciclos crediticios",
                  "de": "Makroprudenzielles Instrument, das Geldpolitik bei der Bewältigung von Kreditzyklen ergänzen oder ersetzen kann",
                  "nl": "Macroprudentieel instrument dat monetair beleid kan aanvullen of vervangen bij het aanpakken van kredietcycli"
        },
        {
                  "en": "Direct component of interest rate setting mechanism",
                  "es": "Componente directo del mecanismo de establecimiento de tasas de interés",
                  "de": "Direkter Bestandteil des Zinssetzungsmechanismus",
                  "nl": "Direct onderdeel van rentetarief vaststelling mechanisme"
        },
        {
                  "en": "Fixed capital requirement that never changes",
                  "es": "Requisito de capital fijo que nunca cambia",
                  "de": "Feste Kapitalanforderung, die sich nie ändert",
                  "nl": "Vaste kapitaalvereiste die nooit verandert"
        },
        {
                  "en": "Tool exclusively for international capital flows",
                  "es": "Herramienta exclusivamente para flujos de capital internacional",
                  "de": "Instrument ausschließlich für internationale Kapitalströme",
                  "nl": "Instrument uitsluitend voor internationale kapitaalstromen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Focuses exclusively on bank lending channels",
                  "es": "Se enfoca exclusivamente en canales de préstamos bancarios",
                  "de": "Fokussiert ausschließlich auf Bankkreditkanäle",
                  "nl": "Richt zich uitsluitend op bankleenkanalen"
        },
        {
                  "en": "Uses identical approaches to asset purchases",
                  "es": "Usa enfoques idénticos para compras de activos",
                  "de": "Verwendet identische Ansätze für Anleihekäufe",
                  "nl": "Gebruikt identieke benaderingen voor activaaankopen"
        },
        {
                  "en": "Emphasizes market-based price discovery while ECB focuses more on yield curve control",
                  "es": "Enfatiza descubrimiento de precios basado en mercado mientras BCE se enfoca más en control de curva de rendimiento",
                  "de": "Betont marktbasierte Preisfindung während EZB sich mehr auf Zinskurvenkontrolle konzentriert",
                  "nl": "Benadrukt marktgebaseerde prijsontdekking terwijl ECB zich meer richt op opbrengstcurve controle"
        },
        {
                  "en": "Only purchases government bonds like the ECB",
                  "es": "Solo compra bonos gubernamentales como el BCE",
                  "de": "Kauft nur Staatsanleihen wie die EZB",
                  "nl": "Koopt alleen staatsobligaties zoals de ECB"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uniform capital requirements across all sectors",
                  "es": "Requisitos de capital uniformes en todos los sectores",
                  "de": "Einheitliche Kapitalanforderungen über alle Sektoren",
                  "nl": "Uniforme kapitaalvereisten over alle sectoren"
        },
        {
                  "en": "Targeted intervention to address sector-specific bubbles without affecting broader economic activity",
                  "es": "Intervención dirigida para abordar burbujas específicas de sector sin afectar actividad económica más amplia",
                  "de": "Gezielte Intervention zur Bewältigung sektorspezifischer Blasen ohne Beeinträchtigung breiterer Wirtschaftsaktivität",
                  "nl": "Gerichte interventie om sectorspecifieke bubbels aan te pakken zonder bredere economische activiteit te beïnvloeden"
        },
        {
                  "en": "Replacement for monetary policy tools",
                  "es": "Reemplazo para herramientas de política monetaria",
                  "de": "Ersatz für geldpolitische Instrumente",
                  "nl": "Vervanging voor monetaire beleidsinstrumenten"
        },
        {
                  "en": "Focus only on international banking exposures",
                  "es": "Enfoque solo en exposiciones bancarias internacionales",
                  "de": "Fokus nur auf internationale Bankenexposures",
                  "nl": "Focus alleen op internationale bankblootstellingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only applies to commercial real estate",
                  "es": "Solo se aplica a bienes raíces comerciales",
                  "de": "Gilt nur für Gewerbeimmobilien",
                  "nl": "Geldt alleen voor commercieel vastgoed"
        },
        {
                  "en": "Functions as a monetary policy transmission mechanism",
                  "es": "Funciona como mecanismo de transmisión de política monetaria",
                  "de": "Funktioniert als geldpolitischer Übertragungsmechanismus",
                  "nl": "Functioneert als monetair beleid transmissiemechanisme"
        },
        {
                  "en": "Limits high-LTV lending to contain household leverage and housing market risks",
                  "es": "Limita préstamos de alto LTV para contener apalancamiento doméstico y riesgos del mercado inmobiliario",
                  "de": "Begrenzt High-LTV-Kreditvergabe zur Eindämmung von Haushalts-Leverage und Immobilienmarktrisiken",
                  "nl": "Beperkt hoge-LTV leningen om huishoudsolvabiliteit en woningmarktrisico's te beheersen"
        },
        {
                  "en": "Sets uniform limits across all types of credit",
                  "es": "Establece límites uniformes en todos los tipos de crédito",
                  "de": "Setzt einheitliche Limits für alle Kreditarten",
                  "nl": "Stelt uniforme limieten vast voor alle kredietsoorten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sets inflation targets",
                  "es": "Establece objetivos de inflación",
                  "de": "Setzt Inflationsziele",
                  "nl": "Stelt inflatiedoelen vast"
        },
        {
                  "en": "Determines the Bank Rate directly",
                  "es": "Determina la Tasa Bancaria directamente",
                  "de": "Bestimmt den Leitzins direkt",
                  "nl": "Bepaalt de Bank Rate direct"
        },
        {
                  "en": "Only applies to corporate bond purchases",
                  "es": "Solo se aplica a compras de bonos corporativos",
                  "de": "Gilt nur für Unternehmensanleihekäufe",
                  "nl": "Geldt alleen voor bedrijfsobligatie aankopen"
        },
        {
                  "en": "Establishes fair value benchmarks to prevent market manipulation during large-scale asset purchases",
                  "es": "Establece referencias de valor justo para prevenir manipulación de mercado durante compras de activos a gran escala",
                  "de": "Etabliert Fair-Value-Benchmarks zur Verhinderung von Marktmanipulation während großangelegter Anleihekäufe",
                  "nl": "Vestigt eerlijke waarde benchmarks om marktmanipulatie te voorkomen tijdens grootschalige activaaankopen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only focuses on traditional financial risks",
                  "es": "Solo se enfoca en riesgos financieros tradicionales",
                  "de": "Fokussiert nur auf traditionelle Finanzrisiken",
                  "nl": "Richt zich alleen op traditionele financiële risico's"
        },
        {
                  "en": "Excludes environmental considerations from policy",
                  "es": "Excluye consideraciones ambientales de la política",
                  "de": "Schließt Umweltüberlegungen von der Politik aus",
                  "nl": "Sluit milieuoverwegingen uit van beleid"
        },
        {
                  "en": "Incorporates climate stress testing and disclosure requirements as systemic risk management tools",
                  "es": "Incorpora pruebas de estrés climático y requisitos de divulgación como herramientas de gestión de riesgo sistémico",
                  "de": "Integriert Klimastresstests und Offenlegungsanforderungen als systemische Risikomanagement-Instrumente",
                  "nl": "Incorporeert klimaat stresstests en openbaarmakingsvereisten als systemische risicobeheer instrumenten"
        },
        {
                  "en": "Addresses climate risks only through carbon pricing",
                  "es": "Aborda riesgos climáticos solo a través de precios de carbono",
                  "de": "Bewältigt Klimarisiken nur durch Kohlenstoffpreise",
                  "nl": "Pakt klimaatrisico's alleen aan door koolstofprijsstelling"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uniform buffer applied equally to all banks",
                  "es": "Amortiguador uniforme aplicado igualmente a todos los bancos",
                  "de": "Einheitlicher Puffer, der gleichermaßen auf alle Banken angewendet wird",
                  "nl": "Uniforme buffer gelijk toegepast op alle banken"
        },
        {
                  "en": "Buffer only for international operations",
                  "es": "Amortiguador solo para operaciones internacionales",
                  "de": "Puffer nur für internationale Operationen",
                  "nl": "Buffer alleen voor internationale operaties"
        },
        {
                  "en": "Temporary crisis response measure",
                  "es": "Medida temporal de respuesta a crisis",
                  "de": "Temporäre Krisenreaktionsmaßnahme",
                  "nl": "Tijdelijke crisisreactie maatregel"
        },
        {
                  "en": "Institution-specific buffer for systemically important financial institutions based on their individual risk profile",
                  "es": "Amortiguador específico de institución para instituciones financieras sistémicamente importantes basado en su perfil de riesgo individual",
                  "de": "Institutsspezifischer Puffer für systemisch wichtige Finanzinstitutionen basierend auf ihrem individuellen Risikoprofil",
                  "nl": "Instelling-specifieke buffer voor systemisch belangrijke financiële instellingen gebaseerd op hun individuele risicoprofiel"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only affects international banks",
                  "es": "Solo afecta bancos internacionales",
                  "de": "Betrifft nur internationale Banken",
                  "nl": "Beïnvloedt alleen internationale banken"
        },
        {
                  "en": "Eliminates the Bank's role in bank supervision",
                  "es": "Elimina el papel del Banco en supervisión bancaria",
                  "de": "Eliminiert die Rolle der Bank in der Bankenaufsicht",
                  "nl": "Elimineert de Bank's rol in banktoezicht"
        },
        {
                  "en": "Requires automatic bailouts for all failing banks",
                  "es": "Requiere rescates automáticos para todos los bancos en quiebra",
                  "de": "Erfordert automatische Rettungen für alle ausfallenden Banken",
                  "nl": "Vereist automatische reddingsoperaties voor alle falende banken"
        },
        {
                  "en": "Provides resolution tools to manage bank failures without taxpayer bailouts while maintaining financial stability",
                  "es": "Proporciona herramientas de resolución para gestionar fallas bancarias sin rescates de contribuyentes mientras mantiene estabilidad financiera",
                  "de": "Bietet Abwicklungsinstrumente zur Verwaltung von Bankausfällen ohne Steuerzahler-Rettungen bei Aufrechterhaltung der Finanzstabilität",
