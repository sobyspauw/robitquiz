    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Only purchases short-term government bonds like traditional QE",
                  "es": "Solo compra bonos gubernamentales de corto plazo como la QE tradicional",
                  "de": "Kauft nur kurzfristige Staatsanleihen wie traditionelle QE",
                  "nl": "Koopt alleen korte-termijn staatsobligaties zoals traditionele QE"
        },
        {
                  "en": "Includes purchasing of corporate bonds, ETFs, and longer-duration government bonds to influence risk premiums",
                  "es": "Incluye compra de bonos corporativos, ETFs y bonos gubernamentales de mayor duración para influir en primas de riesgo",
                  "de": "Umfasst den Kauf von Unternehmensanleihen, ETFs und längerfristigen Staatsanleihen zur Beeinflussung von Risikoprämien",
                  "nl": "Omvat aankoop van bedrijfsobligaties, ETFs en langere-looptijd staatsobligaties om risicopremies te beïnvloeden"
        },
        {
                  "en": "Uses only interest rate adjustments without asset purchases",
                  "es": "Usa solo ajustes de tasas de interés sin compras de activos",
                  "de": "Verwendet nur Zinsanpassungen ohne Anlagenkäufe",
                  "nl": "Gebruikt alleen rentetariefaanpassingen zonder activaaankopen"
        },
        {
                  "en": "Focuses exclusively on foreign currency purchases",
                  "es": "Se enfoca exclusivamente en compras de moneda extranjera",
                  "de": "Konzentriert sich ausschließlich auf Fremdwährungskäufe",
                  "nl": "Focust uitsluitend op buitenlandse valuta-aankopen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Automatically strengthens yen through increased confidence",
                  "es": "Automáticamente fortalece el yen a través de mayor confianza",
                  "de": "Stärkt automatisch den Yen durch erhöhtes Vertrauen",
                  "nl": "Versterkt automatisch de yen door verhoogd vertrouwen"
        },
        {
                  "en": "Creates direct wealth effects and portfolio rebalancing that can weaken yen through increased risk appetite",
                  "es": "Crea efectos de riqueza directos y rebalanceamiento de cartera que puede debilitar el yen a través de mayor apetito de riesgo",
                  "de": "Schafft direkte Vermögenseffekte und Portfolio-Rebalancing, die den Yen durch erhöhte Risikobereitschaft schwächen können",
                  "nl": "Creëert directe vermogenseffecten en portfolio-herbalancering die de yen kan verzwakken door verhoogde risicobereidheid"
        },
        {
                  "en": "Has no impact on currency values or monetary transmission",
                  "es": "No tiene impacto en valores de moneda o transmisión monetaria",
                  "de": "Hat keine Auswirkung auf Währungswerte oder monetäre Übertragung",
                  "nl": "Heeft geen impact op muntwaarden of monetaire overdracht"
        },
        {
                  "en": "Only affects domestic stock prices without currency implications",
                  "es": "Solo afecta precios domésticos de acciones sin implicaciones de moneda",
                  "de": "Beeinflusst nur inländische Aktienkurse ohne Währungsimplikationen",
                  "nl": "Beïnvloedt alleen binnenlandse aandelenprijzen zonder muntimplicaties"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Increases market uncertainty and yen volatility",
                  "es": "Aumenta incertidumbre del mercado y volatilidad del yen",
                  "de": "Erhöht Marktunsicherheit und Yen-Volatilität",
                  "nl": "Verhoogt marktronzekerheid en yen-volatiliteit"
        },
        {
                  "en": "Has no impact on currency markets or expectations",
                  "es": "No tiene impacto en mercados de divisas o expectativas",
                  "de": "Hat keine Auswirkung auf Währungsmärkte oder Erwartungen",
                  "nl": "Heeft geen impact op valutamarkten of verwachtingen"
        },
        {
                  "en": "Provides specific inflation and time-based commitments that can reduce yen volatility by anchoring expectations",
                  "es": "Proporciona compromisos específicos de inflación y basados en tiempo que pueden reducir volatilidad del yen al anclar expectativas",
                  "de": "Bietet spezifische Inflations- und zeitbasierte Verpflichtungen, die Yen-Volatilität durch Verankerung von Erwartungen reduzieren können",
                  "nl": "Biedt specifieke inflatie- en tijd-gebaseerde verbintenissen die yen-volatiliteit kunnen verminderen door verwachtingen te verankeren"
        },
        {
                  "en": "Only provides vague statements about future policy direction",
                  "es": "Solo proporciona declaraciones vagas sobre dirección futura de política",
                  "de": "Bietet nur vage Aussagen über zukünftige Politikrichtung",
                  "nl": "Biedt alleen vage verklaringen over toekomstige beleidsrichting"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "High interest rates that attract speculative flows",
                  "es": "Altas tasas de interés que atraen flujos especulativos",
                  "de": "Hohe Zinssätze, die spekulative Ströme anziehen",
                  "nl": "Hoge rentetarieven die speculatieve stromen aantrekken"
        },
        {
                  "en": "Limited market depth and high transaction costs",
                  "es": "Profundidad limitada del mercado y altos costos de transacción",
                  "de": "Begrenzte Markttiefe und hohe Transaktionskosten",
                  "nl": "Beperkte marktdiepte en hoge transactiekosten"
        },
        {
                  "en": "Deep liquidity, low bid-ask spreads, and automated unwinding of carry trades create systematic yen buying pressure",
                  "es": "Liquidez profunda, spreads bid-ask bajos y desenrollamiento automatizado de carry trades crean presión sistemática de compra del yen",
                  "de": "Tiefe Liquidität, niedrige Bid-Ask-Spreads und automatische Abwicklung von Carry Trades schaffen systematischen Yen-Kaufdruck",
                  "nl": "Diepe liquiditeit, lage bid-ask spreads en geautomatiseerde afwikkeling van carry trades creëren systematische yen-koopdruk"
        },
        {
                  "en": "Regulatory restrictions on foreign investment",
                  "es": "Restricciones regulatorias en inversión extranjera",
                  "de": "Regulatorische Beschränkungen für ausländische Investitionen",
                  "nl": "Regulatoire beperkingen op buitenlandse investeringen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Positive basis always indicates yen strength",
                  "es": "Base positiva siempre indica fortaleza del yen",
                  "de": "Positive Basis zeigt immer Yen-Stärke an",
                  "nl": "Positieve basis duidt altijd op yen-sterkte"
        },
        {
                  "en": "Basis swaps have no impact on currency funding markets",
                  "es": "Los swaps de base no tienen impacto en mercados de financiamiento de divisas",
                  "de": "Basis-Swaps haben keine Auswirkung auf Währungsfinanzierungsmärkte",
                  "nl": "Basis swaps hebben geen impact op valuta-financieringsmarkten"
        },
        {
                  "en": "Negative basis indicates yen funding premium, potentially signaling stress in dollar funding markets",
                  "es": "Base negativa indica prima de financiamiento del yen, potencialmente señalando estrés en mercados de financiamiento del dólar",
                  "de": "Negative Basis zeigt Yen-Finanzierungsprämie an, signalisiert potenziell Stress in Dollar-Finanzierungsmärkten",
                  "nl": "Negatieve basis duidt op yen-financieringspremie, mogelijk signalerend stress in dollar-financieringsmarkten"
        },
        {
                  "en": "Only affects domestic Japanese financial institutions",
                  "es": "Solo afecta instituciones financieras domésticas japonesas",
                  "de": "Beeinflusst nur inländische japanische Finanzinstitutionen",
                  "nl": "Beïnvloedt alleen binnenlandse Japanse financiële instellingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "GPIF only invests in domestic Japanese assets",
                  "es": "GPIF solo invierte en activos domésticos japoneses",
                  "de": "GPIF investiert nur in inländische japanische Anlagen",
                  "nl": "GPIF investeert alleen in binnenlandse Japanse activa"
        },
        {
                  "en": "GPIF activities have no currency market impact",
                  "es": "Las actividades del GPIF no tienen impacto en mercados de divisas",
                  "de": "GPIF-Aktivitäten haben keine Währungsmarktauswirkung",
                  "nl": "GPIF-activiteiten hebben geen valutamarktimpact"
        },
        {
                  "en": "As world's largest pension fund, GPIF's foreign asset allocation creates structural yen selling pressure",
                  "es": "Como el fondo de pensiones más grande del mundo, la asignación de activos extranjeros del GPIF crea presión estructural de venta del yen",
                  "de": "Als weltgrößter Pensionsfonds schafft GPIFs ausländische Vermögensallokation strukturellen Yen-Verkaufsdruck",
                  "nl": "Als 's werelds grootste pensioenfonds creëert GPIF's buitenlandse activaallocatie structurele yen-verkoopdruk"
        },
        {
                  "en": "GPIF always strengthens the yen through its operations",
                  "es": "GPIF siempre fortalece el yen a través de sus operaciones",
                  "de": "GPIF stärkt den Yen immer durch seine Operationen",
                  "nl": "GPIF versterkt altijd de yen door zijn operaties"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Traditional interest rate policy becomes more effective",
                  "es": "La política tradicional de tasas de interés se vuelve más efectiva",
                  "de": "Traditionelle Zinspolitik wird effektiver",
                  "nl": "Traditioneel rentebeleid wordt effectiever"
        },
        {
                  "en": "Near-zero rates lose effectiveness, requiring asset purchases, negative rates, and yield curve control",
                  "es": "Tasas cercanas a cero pierden efectividad, requiriendo compras de activos, tasas negativas y control de curva de rendimiento",
                  "de": "Nahe-Null-Zinsen verlieren Wirksamkeit, erfordern Anlagenkäufe, negative Zinsen und Zinskurvenkontrolle",
                  "nl": "Bijna-nul tarieven verliezen effectiviteit, vereisend activaaankopen, negatieve tarieven en rendementscurvecontrole"
        },
        {
                  "en": "Can be solved through fiscal policy alone",
                  "es": "Puede resolverse solo a través de política fiscal",
                  "de": "Kann allein durch Fiskalpolitik gelöst werden",
                  "nl": "Kan worden opgelost door alleen fiscaal beleid"
        },
        {
                  "en": "Only requires minor adjustments to conventional monetary policy",
                  "es": "Solo requiere ajustes menores a la política monetaria convencional",
                  "de": "Erfordert nur geringfügige Anpassungen der konventionellen Geldpolitik",
                  "nl": "Vereist alleen kleine aanpassingen aan conventioneel monetair beleid"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only used for Japan's domestic transactions",
                  "es": "Solo se usa para transacciones domésticas de Japón",
                  "de": "Nur für Japans inländische Transaktionen verwendet",
                  "nl": "Alleen gebruikt voor Japan's binnenlandse transacties"
        },
        {
                  "en": "Growing use in Asian trade invoicing and commodity financing reduces dollar dependency in regional trade",
                  "es": "Uso creciente en facturación comercial asiática y financiamiento de commodities reduce dependencia del dólar en comercio regional",
                  "de": "Wachsende Verwendung in asiatischer Handelsrechnungsstellung und Rohstofffinanzierung reduziert Dollar-Abhängigkeit im regionalen Handel",
                  "nl": "Groeiend gebruik in Aziatische handelsfacturering en grondstoffenfinanciering vermindert dollarafhankelijkheid in regionale handel"
        },
        {
                  "en": "Completely replaced by digital currencies in trade",
                  "es": "Completamente reemplazado por monedas digitales en comercio",
                  "de": "Vollständig durch digitale Währungen im Handel ersetzt",
                  "nl": "Volledig vervangen door digitale munten in handel"
        },
        {
                  "en": "Yen is never used in international trade finance",
                  "es": "El yen nunca se usa en finanzas comerciales internacionales",
                  "de": "Yen wird niemals in internationaler Handelsfinanzierung verwendet",
                  "nl": "Yen wordt nooit gebruikt in internationale handelsfinanciering"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only affect domestic Japanese stock markets",
                  "es": "Solo afectan mercados domésticos de valores japoneses",
                  "de": "Beeinflussen nur inländische japanische Aktienmärkte",
                  "nl": "Beïnvloeden alleen binnenlandse Japanse aandelenmarkten"
        },
        {
                  "en": "Have no impact on yen exchange rates",
                  "es": "No tienen impacto en tipos de cambio del yen",
                  "de": "Haben keine Auswirkung auf Yen-Wechselkurse",
                  "nl": "Hebben geen impact op yen-wisselkoersen"
        },
        {
                  "en": "Reduce all currency volatility to zero",
                  "es": "Reducen toda volatilidad de moneda a cero",
                  "de": "Reduzieren alle Währungsvolatilität auf null",
                  "nl": "Verminderen alle muntvolatiliteit tot nul"
        },
        {
                  "en": "Create increased volatility and momentum effects, with carry trade unwinding algorithms amplifying yen moves",
                  "es": "Crean mayor volatilidad y efectos de momentum, con algoritmos de desenrollamiento de carry trade amplificando movimientos del yen",
                  "de": "Schaffen erhöhte Volatilität und Momentum-Effekte, wobei Carry-Trade-Abwicklungsalgorithmen Yen-Bewegungen verstärken",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Demographics have no impact on currency or monetary policy",
                  "es": "Los demográficos no tienen impacto en moneda o política monetaria",
                  "de": "Demografie hat keine Auswirkung auf Währung oder Geldpolitik",
                  "nl": "Demografie heeft geen impact op munt of monetair beleid"
        },
        {
                  "en": "Only affects domestic social security systems",
                  "es": "Solo afecta sistemas domésticos de seguridad social",
                  "de": "Beeinflusst nur inländische Sozialversicherungssysteme",
                  "nl": "Beïnvloedt alleen binnenlandse sociale zekerheidssystemen"
        },
        {
                  "en": "Aging population automatically strengthens the yen",
                  "es": "Población envejeciente automáticamente fortalece el yen",
                  "de": "Alternde Bevölkerung stärkt automatisch den Yen",
                  "nl": "Vergrijzende bevolking versterkt automatisch de yen"
        },
        {
                  "en": "Declining savings rate and increased dissaving by retirees may reverse current account surplus and weaken yen structurally",
                  "es": "Tasa de ahorro declinante y mayor desahorro por jubilados puede revertir superávit de cuenta corriente y debilitar estructuralmente el yen",
                  "de": "Sinkende Sparquote und erhöhtes Entsparen durch Rentner kann Leistungsbilanzüberschuss umkehren und Yen strukturell schwächen",
                  "nl": "Dalende spaarquote en verhoogd ontsparen door gepensioneerden kan lopende rekening overschot omkeren en yen structureel verzwakken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Coordinated swap lines and synchronized policy actions help stabilize currency markets and reduce yen volatility",
                  "es": "Líneas de swap coordinadas y acciones políticas sincronizadas ayudan a estabilizar mercados de divisas y reducir volatilidad del yen",
                  "de": "Koordinierte Swap-Linien und synchronisierte Politikaktionen helfen, Währungsmärkte zu stabilisieren und Yen-Volatilität zu reduzieren",
                  "nl": "Gecoördineerde swap-lijnen en gesynchroniseerde beleidsacties helpen valutamarkten stabiliseren en yen-volatiliteit verminderen"
        },
        {
                  "en": "Central bank coordination always weakens the yen",
                  "es": "La coordinación de bancos centrales siempre debilita el yen",
                  "de": "Zentralbankkoordination schwächt den Yen immer",
                  "nl": "Centrale bank coördinatie verzwakt altijd de yen"
        },
        {
                  "en": "Only affects domestic Japanese monetary policy",
                  "es": "Solo afecta política monetaria doméstica japonesa",
                  "de": "Beeinflusst nur inländische japanische Geldpolitik",
                  "nl": "Beïnvloedt alleen binnenlands Japans monetair beleid"
        },
        {
                  "en": "No coordination exists between major central banks",
                  "es": "No existe coordinación entre bancos centrales principales",
                  "de": "Keine Koordination existiert zwischen großen Zentralbanken",
                  "nl": "Geen coördinatie bestaat tussen grote centrale banken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Twin deficits always strengthen the yen immediately",
                  "es": "Los déficits gemelos siempre fortalecen el yen inmediatamente",
                  "de": "Twin Deficits stärken den Yen immer sofort",
                  "nl": "Twin tekorten versterken altijd de yen onmiddellijk"
        },
        {
                  "en": "Fiscal deficits have no relationship with current account or currency values",
                  "es": "Los déficits fiscales no tienen relación con cuenta corriente o valores de moneda",
                  "de": "Fiskalische Defizite haben keine Beziehung zu Leistungsbilanz oder Währungswerten",
                  "nl": "Fiscale tekorten hebben geen relatie met lopende rekening of muntwaarden"
        },
        {
                  "en": "Persistent fiscal deficits could eventually erode current account surplus and weaken yen over long term",
                  "es": "Déficits fiscales persistentes podrían eventualmente erosionar superávit de cuenta corriente y debilitar yen a largo plazo",
                  "de": "Anhaltende fiskalische Defizite könnten schließlich Leistungsbilanzüberschuss erodieren und Yen langfristig schwächen",
                  "nl": "Aanhoudende fiscale tekorten zouden uiteindelijk lopende rekening overschot kunnen uitholden en yen lange termijn verzwakken"
        },
        {
                  "en": "Only affects domestic government bond markets",
                  "es": "Solo afecta mercados domésticos de bonos gubernamentales",
                  "de": "Beeinflusst nur inländische Staatsanleihemärkte",
                  "nl": "Beïnvloedt alleen binnenlandse staatsobligatie markten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only affects manufacturing employment, not currency",
                  "es": "Solo afecta empleo manufacturero, no moneda",
                  "de": "Beeinflusst nur Fertigungsbeschäftigung, nicht Währung",
                  "nl": "Beïnvloedt alleen productiewerk, niet munt"
        },
        {
                  "en": "Offshore production reduces goods exports but increases service and investment income, supporting yen through invisible trade",
                  "es": "Producción offshore reduce exportaciones de bienes pero aumenta ingresos de servicios e inversión, apoyando yen a través de comercio invisible",
                  "de": "Offshore-Produktion reduziert Warenexporte, erhöht aber Service- und Investitionseinkommen, unterstützt Yen durch unsichtbaren Handel",
                  "nl": "Offshore productie vermindert goederenexport maar verhoogt diensten- en investeringsinkomsten, ondersteunend yen door onzichtbare handel"
        },
        {
                  "en": "Supply chain changes have no impact on currency fundamentals",
                  "es": "Cambios en cadenas de suministro no tienen impacto en fundamentos de moneda",
                  "de": "Lieferkettenveränderungen haben keine Auswirkung auf Währungsfundamentaldaten",
                  "nl": "Toeleveringsketen veranderingen hebben geen impact op muntfundamentals"
        },
        {
                  "en": "Offshore production always weakens the yen permanently",
                  "es": "Producción offshore siempre debilita el yen permanentemente",
                  "de": "Offshore-Produktion schwächt den Yen immer dauerhaft",
                  "nl": "Offshore productie verzwakt altijd de yen permanent"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "MMT has no relevance to Japanese economic policy",
                  "es": "MMT no tiene relevancia para la política económica japonesa",
                  "de": "MMT hat keine Relevanz für japanische Wirtschaftspolitik",
                  "nl": "MMT heeft geen relevantie voor Japans economisch beleid"
        },
        {
                  "en": "MMT only applies to developing economies",
                  "es": "MMT solo se aplica a economías en desarrollo",
                  "de": "MMT gilt nur für Entwicklungsländer",
                  "nl": "MMT geldt alleen voor ontwikkelingseconomieën"
        },
        {
                  "en": "Japan can spend unlimited amounts without any constraints",
                  "es": "Japón puede gastar cantidades ilimitadas sin restricciones",
                  "de": "Japan kann unbegrenzte Mengen ohne Beschränkungen ausgeben",
                  "nl": "Japan kan onbeperkte hoeveelheden uitgeven zonder beperkingen"
        },
        {
                  ...
                  "es": "La experiencia de Japón apoya algunas premisas MMT pero restricciones de inflación y preocupaciones de balance externo limitan espacio fiscal",
                  "de": "Japans Erfahrung unterstützt einige MMT-Prämissen, aber Inflationsbeschränkungen und externe Balancesorgen begrenzen fiskalischen Spielraum",
                  "nl": "Japan's ervaring ondersteunt enkele MMT-uitgangspunten maar inflatiebeperkingen en externe balans zorgen beperken fiscale ruimte"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Digital currencies have no impact on yen or monetary policy",
                  "es": "Monedas digitales no tienen impacto en yen o política monetaria",
                  "de": "Digitale Währungen haben keine Auswirkung auf Yen oder Geldpolitik",
                  "nl": "Digitale munten hebben geen impact op yen of monetair beleid"
        },
        {
                  "en": "Only affects domestic payment systems",
                  "es": "Solo afecta sistemas de pago domésticos",
                  "de": "Beeinflusst nur inländische Zahlungssysteme",
                  "nl": "Beïnvloedt alleen binnenlandse betalingssystemen"
        },
        {
                  "en": "Cryptocurrencies will completely replace all traditional currencies",
                  "es": "Criptomonedas reemplazarán completamente todas las monedas tradicionales",
                  "de": "Kryptowährungen werden alle traditionellen Währungen vollständig ersetzen",
                  "nl": "Cryptocurrencies zullen alle traditionele munten volledig vervangen"
        },
        {
                  "en": "Digital yen CBDC could enhance international use while crypto adoption may reduce traditional currency demand",
                  "es": "CBDC del yen digital podría mejorar uso internacional mientras adopción crypto puede reducir demanda de moneda tradicional",
                  "de": "Digitaler Yen CBDC könnte internationale Nutzung verbessern, während Krypto-Adoption traditionelle Währungsnachfrage reduzieren kann",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Climate change has no economic or monetary policy implications",
                  "es": "El cambio climático no tiene implicaciones económicas o de política monetaria",
                  "de": "Klimawandel hat keine wirtschaftlichen oder geldpolitischen Implikationen",
                  "nl": "Klimaatverandering heeft geen economische of monetaire beleidsimplicaties"
        },
        {
                  "en": "Only affects renewable energy companies",
                  "es": "Solo afecta compañías de energía renovable",
                  "de": "Beeinflusst nur Unternehmen für erneuerbare Energien",
                  "nl": "Beïnvloedt alleen hernieuwbare energie bedrijven"
        },
        {
                  "en": "Green transition costs may strain fiscal resources while carbon border adjustments could affect trade balance",
                  "es": "Costos de transición verde pueden tensar recursos fiscales mientras ajustes fronterizos de carbono podrían afectar balanza comercial",
                  "de": "Grüne Übergangkosten können fiskalische Ressourcen belasten, während CO2-Grenzausgleiche die Handelsbilanz beeinflussen könnten",
                  "nl": "Groene transitiekosten kunnen fiscale middelen belasten terwijl koolstofgrensaanpassingen de handelsbalans zouden kunnen beïnvloeden"
        },
        {
                  "en": "Green finance automatically strengthens all currencies",
                  "es": "Finanzas verdes automáticamente fortalecen todas las monedas",
                  "de": "Grüne Finanzen stärken automatisch alle Währungen",
                  "nl": "Groene financiering versterkt automatisch alle munten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only affects defense spending, not monetary policy",
                  "es": "Solo afecta gasto de defensa, no política monetaria",
                  "de": "Beeinflusst nur Verteidigungsausgaben, nicht Geldpolitik",
                  "nl": "Beïnvloedt alleen defensie-uitgaven, niet monetair beleid"
        },
        {
                  "en": "Regional tensions can strengthen yen safe-haven demand while potentially disrupting trade flows and supply chains",
                  "es": "Tensiones regionales pueden fortalecer demanda de refugio seguro del yen mientras potencialmente interrumpen flujos comerciales y cadenas de suministro",
                  "de": "Regionale Spannungen können Yen-Sicherer-Hafen-Nachfrage stärken, während sie potenziell Handelsströme und Lieferketten stören",
                  "nl": "Regionale spanningen kunnen yen veilige haven-vraag versterken terwijl ze potentieel handelsstromen en toeleveringsketens verstoren"
        },
        {
                  "en": "Geopolitical factors have no impact on currency markets",
                  "es": "Factores geopolíticos no tienen impacto en mercados de divisas",
                  "de": "Geopolitische Faktoren haben keine Auswirkung auf Währungsmärkte",
                  "nl": "Geopolitieke factoren hebben geen impact op valutamarkten"
        },
        {
                  "en": "Regional tensions always weaken the yen permanently",
                  "es": "Tensiones regionales siempre debilitan el yen permanentemente",
                  "de": "Regionale Spannungen schwächen den Yen immer dauerhaft",
                  "nl": "Regionale spanningen verzwakken altijd de yen permanent"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Setting fixed prices for all government bonds",
                  "es": "Establecer precios fijos para todos los bonos gubernamentales",
                  "de": "Festpreise für alle Staatsanleihen festlegen",
                  "nl": "Vaste prijzen instellen voor alle staatsobligaties"
        },
        {
                  "en": "Controlling all currency exchange rates simultaneously",
                  "es": "Controlar todos los tipos de cambio de moneda simultáneamente",
                  "de": "Alle Währungswechselkurse gleichzeitig kontrollieren",
                  "nl": "Alle valutawisselkoersen tegelijkertijd controleren"
        },
        {
                  "en": "Policy targeting specific government bond yields to control longer-term interest rates",
                  "es": "Política dirigida a rendimientos específicos de bonos gubernamentales para controlar tasas de interés a largo plazo",
                  "de": "Politik, die auf spezifische Staatsanleihenrenditen abzielt, um längerfristige Zinssätze zu kontrollieren",
                  "nl": "Beleid gericht op specifieke staatsobligatierendementen om langere termijn rentetarieven te controleren"
        },
        {
                  "en": "Managing only short-term overnight rates",
                  "es": "Gestionar solo tasas nocturnas a corto plazo",
                  "de": "Nur kurzfristige Übernachtungszinsen verwalten",
                  "nl": "Alleen korte termijn overnight tarieven beheren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only affects pension systems, not monetary policy",
                  "es": "Solo afecta sistemas de pensiones, no política monetaria",
                  "de": "Beeinflusst nur Rentensysteme, nicht Geldpolitik",
                  "nl": "Beïnvloedt alleen pensioensystemen, niet monetair beleid"
        },
        {
                  "en": "Demographics have no impact on currency values",
                  "es": "La demografía no tiene impacto en valores de moneda",
                  "de": "Demografie hat keine Auswirkung auf Währungswerte",
                  "nl": "Demografie heeft geen impact op muntwaarden"
        },
        {
                  "en": "Aging population always strengthens currencies",
                  "es": "Población envejeciente siempre fortalece monedas",
                  "de": "Alternde Bevölkerung stärkt Währungen immer",
                  "nl": "Vergrijzende bevolking versterkt altijd munten"
        },
        {
                  "en": "Creates deflationary pressures and savings drawdown, potentially weakening yen long-term",
                  "es": "Crea presiones deflacionarias y retiro de ahorros, potencialmente debilitando el yen a largo plazo",
                  "de": "Schafft deflationären Druck und Sparabbau, schwächt potenziell Yen langfristig",
                  "nl": "Creëert deflatoire druk en besparingen-afname, potentieel verzwakkend yen lange termijn"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reports only on foreign exchange reserves",
                  "es": "Reporta solo sobre reservas de divisas",
                  "de": "Berichtet nur über Devisenreserven",
                  "nl": "Rapporteert alleen over valutareserves"
        },
        {
                  "en": "Only measures agricultural production levels",
                  "es": "Solo mide niveles de producción agrícola",
                  "de": "Misst nur landwirtschaftliche Produktionsniveaus",
                  "nl": "Meet alleen landbouwproductieniveaus"
        },
        {
                  "en": "Key business sentiment indicator that influences BoJ policy decisions and market expectations",
                  "es": "Indicador clave de sentimiento empresarial que influye en decisiones de política del BoJ y expectativas del mercado",
                  "de": "Wichtiger Geschäftsstimmungsindikator, der BoJ-Politikentscheidungen und Markterwartungen beeinflusst",
                  "nl": "Belangrijke bedrijfssentiment indicator die BoJ-beleidsbeslissingen en marktverwachtingen beïnvloedt"
        },
        {
                  "en": "Has no impact on currency markets",
                  "es": "No tiene impacto en mercados de divisas",
                  "de": "Hat keine Auswirkung auf Währungsmärkte",
                  "nl": "Heeft geen impact op valutamarkten"
        }
        ],
        correct: 2,
        explanation: {
