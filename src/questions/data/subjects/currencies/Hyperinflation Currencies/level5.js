// Hyperinflation Currencies Quiz - Level 5
(function() {
  const level5 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Information asymmetries prevent optimal outcomes",
                  "es": "Las asimetrías de información previenen resultados óptimos",
                  "de": "Informationsasymmetrien verhindern optimale Ergebnisse",
                  "nl": "Informatie asymmetrieën voorkomen optimale uitkomsten"
        },
        {
                  "en": "External shocks disrupt equilibrium strategies",
                  "es": "Los choques externos interrumpen las estrategias de equilibrio",
                  "de": "Externe Schocks stören Gleichgewichtsstrategien",
                  "nl": "Externe schokken verstoren evenwichtstrategieën"
        },
        {
                  "en": "Both benefit from coordination but have incentives to defect",
                  "es": "Ambos se benefician de la coordinación pero tienen incentivos para desertar",
                  "de": "Beide profitieren von Koordination, haben aber Anreize zu defektieren",
                  "nl": "Beiden profiteren van coördinatie maar hebben prikkels om af te wijken"
        },
        {
                  "en": "Political cycles misalign temporal preferences",
                  "es": "Los ciclos políticos desalinean las preferencias temporales",
                  "de": "Politische Zyklen stören zeitliche Präferenzen",
                  "nl": "Politieke cycli verstoren temporele voorkeuren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Modelos de cambio de Markov",
                  "de": "Markov-Switching-Modelle",
                  "nl": "Markov-switching modellen"
        },
        {
                  "en": "Threshold autoregression",
                  "es": "Autorregresión de umbral",
                  "de": "Schwellenwert-Autoregression",
                  "nl": "Drempel autoregression"
        },
        {
                  "en": "Kalman filtering",
                  "es": "Filtrado de Kalman",
                  "de": "Kalman-Filterung",
                  "nl": "Kalman filtering"
        },
        {
                  "en": "Smooth transition regression",
                  "es": "Regresión de transición suave",
                  "de": "Glatte Übergangsregression",
                  "nl": "Gladde overgang regressie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Inflation expectations remain elevated despite stabilization",
                  "es": "Las expectativas de inflación permanecen elevadas a pesar de la estabilización",
                  "de": "Inflationserwartungen bleiben trotz Stabilisierung erhöht",
                  "nl": "Inflatie verwachtingen blijven verhoogd ondanks stabilisatie"
        },
        {
                  "en": "Financial markets remain segmented long-term",
                  "es": "Los mercados financieros permanecen segmentados a largo plazo",
                  "de": "Finanzmärkte bleiben langfristig segmentiert",
                  "nl": "Financiële markten blijven lange termijn gesegmenteerd"
        },
        {
                  "en": "Temporary output losses become permanent through skill depreciation",
                  "es": "Las pérdidas temporales de producción se vuelven permanentes a través de la depreciación de habilidades",
                  "de": "Temporäre Produktionsverluste werden durch Kompetenzentwertung dauerhaft",
                  "nl": "Tijdelijke productie verliezen worden permanent door vaardigheids depreciatie"
        },
        {
                  "en": "Exchange rate volatility persists after crisis resolution",
                  "es": "La volatilidad del tipo de cambio persiste después de la resolución de la crisis",
                  "de": "Wechselkursvolatilität besteht nach Krisenlösung fort",
                  "nl": "Wisselkoers volatiliteit houdt aan na crisis oplossing"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Helicopter money",
                  "es": "Dinero helicóptero",
                  "de": "Helikoptergeld",
                  "nl": "Helikoptergeld"
        },
        {
                  "en": "Quasi-fiscal operations",
                  "es": "Operaciones cuasifiscales",
                  "de": "Quasi-fiskalische Operationen",
                  "nl": "Quasi-fiscale operaties"
        },
        {
                  "en": "Index-linked fiscal targets",
                  "es": "Objetivos fiscales vinculados a índices",
                  "de": "Indexgebundene Fiskaliziele",
                  "nl": "Index-gebonden fiscale doelen"
        },
        {
                  "en": "Contingent convertibility bonds",
                  "es": "Bonos de convertibilidad contingente",
                  "de": "Bedingte Konvertibilitätsanleihen",
                  "nl": "Voorwaardelijke convertibiliteit obligaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It amplifies hyperinflation by distorting savings allocation",
                  "es": "Amplifica la hiperinflación distorsionando la asignación de ahorros",
                  "de": "Sie verstärkt Hyperinflation durch Verzerrung der Sparallokation",
                  "nl": "Het versterkt hyperinflatie door spaar allocatie te vervormen"
        },
        {
                  "en": "It has no significant impact on inflation dynamics",
                  "es": "No tiene impacto significativo en las dinámicas de inflación",
                  "de": "Sie hat keinen signifikanten Einfluss auf Inflationsdynamiken",
                  "nl": "Het heeft geen significante impact op inflatie dynamiek"
        },
        {
                  "en": "It prevents hyperinflation by controlling capital flows",
                  "es": "Previene la hiperinflación controlando los flujos de capital",
                  "de": "Sie verhindert Hyperinflation durch Kontrolle der Kapitalströme",
                  "nl": "Het voorkomt hyperinflatie door kapitaalstromen te controleren"
        },
        {
                  "en": "It creates deflationary pressure through credit rationing",
                  "es": "Crea presión deflacionaria a través del racionamiento de crédito",
                  "de": "Sie schafft deflationären Druck durch Kreditrationierung",
                  "nl": "Het creëert deflatoire druk door krediet rantsoenering"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Nudge-based inflation targeting",
                  "es": "Metas de inflación basadas en empujones",
                  "de": "Nudge-basierte Inflationsziele",
                  "nl": "Nudge-gebaseerde inflatietargeting"
        },
        {
                  "en": "Adaptive expectations anchoring",
                  "es": "Anclaje de expectativas adaptativas",
                  "de": "Adaptive Erwartungsverankerung",
                  "nl": "Adaptieve verwachtingen verankering"
        },
        {
                  "en": "Rational inattention frameworks",
                  "es": "Marcos de inatención racional",
                  "de": "Rationale Unaufmerksamkeitsrahmen",
                  "nl": "Rationele onoplettendheid raamwerken"
        },
        {
                  "en": "Psychological commitment devices",
                  "es": "Dispositivos de compromiso psicológico",
                  "de": "Psychologische Verpflichtungsgeräte",
                  "nl": "Psychologische toewijdingsapparaten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Economic agents get trapped in high-velocity expectations",
                  "es": "Los agentes económicos quedan atrapados en expectativas de alta velocidad",
                  "de": "Wirtschaftsakteure werden in hohen Geschwindigkeitserwartungen gefangen",
                  "nl": "Economische agenten raken gevangen in hoge snelheid verwachtingen"
        },
        {
                  "en": "Money velocity becomes so high that monetary policy loses effectiveness",
                  "es": "La velocidad del dinero se vuelve tan alta que la política monetaria pierde efectividad",
                  "de": "Geldumlaufgeschwindigkeit wird so hoch, dass Geldpolitik ihre Wirksamkeit verliert",
                  "nl": "Geldsnelheid wordt zo hoog dat monetair beleid effectiviteit verliest"
        },
        {
                  "en": "Velocity fluctuations become unpredictable and destabilizing",
                  "es": "Las fluctuaciones de velocidad se vuelven impredecibles y desestabilizadoras",
                  "de": "Geschwindigkeitsschwankungen werden unvorhersagbar und destabilisierend",
                  "nl": "Snelheid fluctuaties worden onvoorspelbaar en destabiliserend"
        },
        {
                  "en": "The central bank cannot control velocity through interest rates",
                  "es": "El banco central no puede controlar la velocidad a través de las tasas de interés",
                  "de": "Die Zentralbank kann Geschwindigkeit nicht durch Zinssätze kontrollieren",
                  "nl": "De centrale bank kan snelheid niet controleren door rentetarieven"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Atractores extraños",
                  "de": "Seltsame Attraktoren",
                  "nl": "Vreemde attractoren"
        },
        {
                  "en": "Lyapunov exponents",
                  "es": "Exponentes de Lyapunov",
                  "de": "Lyapunov-Exponenten",
                  "nl": "Lyapunov exponenten"
        },
        {
                  "en": "Fractal dimensions",
                  "es": "Dimensiones fractales",
                  "de": "Fraktale Dimensionen",
                  "nl": "Fractale dimensies"
        },
        {
                  "en": "Bifurcation points",
                  "es": "Puntos de bifurcación",
                  "de": "Bifurkationspunkte",
                  "nl": "Bifurcatie punten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Digital payment systems expand during hyperinflation",
                  "es": "Los sistemas de pago digital se expanden durante la hiperinflación",
                  "de": "Digitale Zahlungssysteme expandieren während der Hyperinflation",
                  "nl": "Digitale betalingssystemen breiden uit tijdens hyperinflatie"
        },
        {
                  "en": "Black market networks become more efficient",
                  "es": "Las redes del mercado negro se vuelven más eficientes",
                  "de": "Schwarzmarktnetzwerke werden effizienter",
                  "nl": "Zwarte markt netwerken worden efficiënter"
        },
        {
                  "en": "Foreign banks establish local networks during crisis",
                  "es": "Los bancos extranjeros establecen redes locales durante la crisis",
                  "de": "Ausländische Banken etablieren lokale Netzwerke während der Krise",
                  "nl": "Buitenlandse banken vestigen lokale netwerken tijdens crisis"
        },
        {
                  "en": "Currency value increases with number of users accepting it",
                  "es": "El valor de la moneda aumenta con el número de usuarios que la aceptan",
                  "de": "Währungswert steigt mit der Anzahl der Nutzer, die sie akzeptieren",
                  "nl": "Valuta waarde stijgt met aantal gebruikers die het accepteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Real options valuation models",
                  "es": "Modelos de valoración de opciones reales",
                  "de": "Real-Options-Bewertungsmodelle",
                  "nl": "Reële opties waardering modellen"
        },
        {
                  "en": "Contingent claims analysis",
                  "es": "Análisis de reclamos contingentes",
                  "de": "Bedingte Anspruchsanalyse",
                  "nl": "Voorwaardelijke claims analyse"
        },
        {
                  "en": "Operational flexibility optimization",
                  "es": "Optimización de flexibilidad operacional",
                  "de": "Operative Flexibilitätsoptimierung",
                  "nl": "Operationele flexibiliteit optimalisatie"
        },
        {
                  "en": "Dynamic hedging with exotic derivatives",
                  "es": "Cobertura dinámica con derivados exóticos",
                  "de": "Dynamisches Hedging mit exotischen Derivaten",
                  "nl": "Dynamische hedging met exotische derivaten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Expectations adjust too slowly to policy changes",
                  "es": "Las expectativas se ajustan muy lentamente a los cambios de política",
                  "de": "Erwartungen passen sich zu langsam an Politikänderungen an",
                  "nl": "Verwachtingen passen te langzaam aan aan beleidsveranderingen"
        },
        {
                  "en": "Expectations become disconnected from fundamentals",
                  "es": "Las expectativas se desconectan de los fundamentos",
                  "de": "Erwartungen werden von Fundamentaldaten getrennt",
                  "nl": "Verwachtingen raken losgekoppeld van fundamenten"
        },
        {
                  "en": "Rational expectations prevent policy effectiveness",
                  "es": "Las expectativas racionales previenen la efectividad de la política",
                  "de": "Rationale Erwartungen verhindern Politikwirksamkeit",
                  "nl": "Rationele verwachtingen voorkomen beleidseffectiviteit"
        },
        {
                  "en": "Failed stabilizations make future attempts less credible",
                  "es": "Las estabilizaciones fallidas hacen que los intentos futuros sean menos creíbles",
                  "de": "Gescheiterte Stabilisierungen machen zukünftige Versuche weniger glaubwürdig",
                  "nl": "Gefaalde stabilisaties maken toekomstige pogingen minder geloofwaardig"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Contingent credit lines with automatic triggers",
                  "es": "Líneas de crédito contingentes con disparadores automáticos",
                  "de": "Bedingte Kreditlinien mit automatischen Auslösern",
                  "nl": "Voorwaardelijke kredietlijnen met automatische triggers"
        },
        {
                  "en": "Regional monetary integration frameworks",
                  "es": "Marcos de integración monetaria regional",
                  "de": "Regionale Währungsintegrations-Frameworks",
                  "nl": "Regionale monetaire integratie raamwerken"
        },
        {
                  "en": "Multicurrency stabilization funds",
                  "es": "Fondos de estabilización multidivisa",
                  "de": "Multiwährungs-Stabilisierungsfonds",
                  "nl": "Multivaluta stabilisatie fondsen"
        },
        {
                  "en": "Synchronized intervention protocols",
                  "es": "Protocolos de intervención sincronizada",
                  "de": "Synchronisierte Interventionsprotokolle",
                  "nl": "Gesynchroniseerde interventie protocollen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Financial markets develop specialized instruments",
                  "es": "Los mercados financieros desarrollan instrumentos especializados",
                  "de": "Finanzmärkte entwickeln spezialisierte Instrumente",
                  "nl": "Financiële markten ontwikkelen gespecialiseerde instrumenten"
        },
        {
                  "en": "Formal institutions embed anti-inflation mechanisms",
                  "es": "Las instituciones formales incorporan mecanismos anti-inflación",
                  "de": "Formale Institutionen betten Anti-Inflationsmechanismen ein",
                  "nl": "Formele instellingen inbedden anti-inflatie mechanismen"
        },
        {
                  "en": "Central banks maintain ultra-conservative policies decades after stabilization",
                  "es": "Los bancos centrales mantienen políticas ultraconservadoras décadas después de la estabilización",
                  "de": "Zentralbanken behalten ultra-konservative Politiken Jahrzehnte nach Stabilisierung bei",
                  "nl": "Centrale banken behouden ultra-conservatieve beleidslijnen decennia na stabilisatie"
        },
        {
                  "en": "Economic agents permanently alter risk preferences",
                  "es": "Los agentes económicos alteran permanentemente las preferencias de riesgo",
                  "de": "Wirtschaftsakteure ändern dauerhaft Risikopräferenzen",
                  "nl": "Economische agenten veranderen permanent risico voorkeuren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Neural network autoregression",
                  "es": "Autorregresión de redes neuronales",
                  "de": "Neuronale Netzwerk-Autoregression",
                  "nl": "Neurale netwerk autoregression"
        },
        {
                  "en": "Quantum economic algorithms",
                  "es": "Algoritmos económicos cuánticos",
                  "de": "Quantenökonomische Algorithmen",
                  "nl": "Quantum economische algoritmen"
        },
        {
                  "en": "Agent-based computational models",
                  "es": "Modelos computacionales basados en agentes",
                  "de": "Agentenbasierte Computermodelle",
                  "nl": "Agent-gebaseerde computermodellen"
        },
        {
                  "en": "Deep learning ensemble methods",
                  "es": "Métodos de conjunto de aprendizaje profundo",
                  "de": "Deep-Learning-Ensemble-Methoden",
                  "nl": "Deep learning ensemble methoden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It provides early warning signals",
                  "es": "Proporciona señales de alerta temprana",
                  "de": "Es bietet Frühwarnsignale",
                  "nl": "Het biedt vroege waarschuwingssignalen"
        },
        {
                  "en": "It reduces transaction costs during crisis",
                  "es": "Reduce los costos de transacción durante la crisis",
                  "de": "Es reduziert Transaktionskosten während der Krise",
                  "nl": "Het vermindert transactiekosten tijdens crisis"
        },
        {
                  "en": "It amplifies volatility through momentum trading",
                  "es": "Amplifica la volatilidad a través del trading de momentum",
                  "de": "Es verstärkt Volatilität durch Momentum-Trading",
                  "nl": "Het versterkt volatiliteit door momentum trading"
        },
        {
                  "en": "It stabilizes exchange rates through arbitrage",
                  "es": "Estabiliza los tipos de cambio a través del arbitraje",
                  "de": "Es stabilisiert Wechselkurse durch Arbitrage",
                  "nl": "Het stabiliseert wisselkoersen door arbitrage"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Smart contract fiscal enforcement mechanisms",
                  "es": "Mecanismos de cumplimiento fiscal de contratos inteligentes",
                  "de": "Smart-Contract-Fiskalvollstreckungsmechanismen",
                  "nl": "Smart contract fiscale handhaving mechanismen"
        },
        {
                  "en": "Distributed ledger inflation targeting",
                  "es": "Metas de inflación de libro mayor distribuido",
                  "de": "Verteilte Ledger-Inflationsziele",
                  "nl": "Gedistribueerd grootboek inflatietargeting"
        },
        {
                  "en": "Decentralized autonomous stabilization protocols",
                  "es": "Protocolos de estabilización autónomos descentralizados",
                  "de": "Dezentralisierte autonome Stabilisierungsprotokolle",
                  "nl": "Gedecentraliseerde autonome stabilisatie protocollen"
        },
        {
                  "en": "Central Bank Digital Currencies (CBDCs) with programmable monetary policy",
                  "es": "Monedas Digitales de Banco Central (CBDCs) con política monetaria programable",
                  "de": "Digitale Zentralbankwährungen (CBDCs) mit programmierbarer Geldpolitik",
                  "nl": "Centrale Bank Digitale Valuta's (CBDCs) met programmeerbaar monetair beleid"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Each successive country requires more complex stabilization measures",
                  "es": "Cada país sucesivo requiere medidas de estabilización más complejas",
                  "de": "Jedes nachfolgende Land erfordert komplexere Stabilisierungsmaßnahmen",
                  "nl": "Elk opeenvolgende land vereist complexere stabilisatie maatregelen"
        },
        {
                  "en": "Hyperinflation spreads through increasingly complex financial linkages",
                  "es": "La hiperinflación se propaga a través de vínculos financieros cada vez más complejos",
                  "de": "Hyperinflation breitet sich durch zunehmend komplexe finanzielle Verbindungen aus",
                  "nl": "Hyperinflatie verspreidt zich door steeds complexere financiële verbindingen"
        },
        {
                  "en": "Policy coordination becomes exponentially more difficult",
                  "es": "La coordinación de políticas se vuelve exponencialmente más difícil",
                  "de": "Politikkoordination wird exponentiell schwieriger",
                  "nl": "Beleidscoördinatie wordt exponentieel moeilijker"
        },
        {
                  "en": "Mathematical models become too complex to solve analytically",
                  "es": "Los modelos matemáticos se vuelven demasiado complejos para resolver analíticamente",
                  "de": "Mathematische Modelle werden zu komplex für analytische Lösungen",
                  "nl": "Wiskundige modellen worden te complex om analytisch op te lossen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Evolutionary stable strategies",
                  "es": "Estrategias evolutivamente estables",
                  "de": "Evolutionär stabile Strategien",
                  "nl": "Evolutionair stabiele strategieën"
        },
        {
                  "en": "Path-dependent lock-in",
                  "es": "Bloqueo dependiente de la trayectoria",
                  "de": "Pfadabhängige Einschließung",
                  "nl": "Pad-afhankelijke lock-in"
        },
        {
                  "en": "Adaptive learning equilibria",
                  "es": "Equilibrios de aprendizaje adaptativo",
                  "de": "Adaptive Lerngleichgewichte",
                  "nl": "Adaptieve leer evenwichten"
        },
        {
                  "en": "Replicator dynamics",
                  "es": "Dinámicas de replicador",
                  "de": "Replikator-Dynamiken",
                  "nl": "Replicator dynamiek"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dynamic stochastic general equilibrium with financial frictions",
                  "es": "Equilibrio general dinámico estocástico con fricciones financieras",
                  "de": "Dynamisches stochastisches allgemeines Gleichgewicht mit finanziellen Friktionen",
                  "nl": "Dynamisch stochastisch algemeen evenwicht met financiële wrijvingen"
        },
        {
                  "en": "New Open Economy Macroeconomics (NOEM)",
                  "es": "Nueva Macroeconomía de Economía Abierta (NOEM)",
                  "de": "Neue Offene Makroökonomie (NOEM)",
                  "nl": "Nieuwe Open Economie Macro-economie (NOEM)"
        },
        {
                  "en": "Network-based monetary models",
                  "es": "Modelos monetarios basados en redes",
                  "de": "Netzwerkbasierte monetäre Modelle",
                  "nl": "Netwerk-gebaseerde monetaire modellen"
        },
        {
                  "en": "Multi-agent search-theoretic models",
                  "es": "Modelos teóricos de búsqueda multi-agente",
                  "de": "Multi-Agenten-Suchtheoretische Modelle",
                  "nl": "Multi-agent zoek-theoretische modellen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fiscal multipliers exceed monetary policy effectiveness",
                  "es": "Multiplicadores fiscales exceden efectividad de política monetaria",
                  "de": "Fiskalmultiplikatoren übersteigen die Wirksamkeit der Geldpolitik",
                  "nl": "Fiscale multipliers overtreffen monetaire beleidseffectiviteit"
        },
        {
                  "en": "Tax revenues automatically finance all government spending",
                  "es": "Ingresos fiscales automáticamente financian todo el gasto gubernamental",
                  "de": "Steuereinnahmen finanzieren automatisch alle Staatsausgaben",
                  "nl": "Belastinginkomsten financieren automatisch alle overheidsuitgaven"
        },
        {
                  "en": "Central bank unable to resist fiscal pressures for monetary financing",
                  "es": "Banco central incapaz de resistir presiones fiscales para financiamiento monetario",
                  "de": "Zentralbank kann fiskalischen Drücken auf monetäre Finanzierung nicht widerstehen",
                  "nl": "Centrale bank kan niet weerstaan aan fiscale druk voor monetaire financiering"
        },
        {
                  "en": "Government controls all aspects of monetary transmission",
                  "es": "Gobierno controla todos los aspectos de la transmisión monetaria",
                  "de": "Regierung kontrolliert alle Aspekte der monetären Transmission",
                  "nl": "Regering controleert alle aspecten van monetaire transmissie"
        }
        ],
        correct: 2,
        explanation: {
