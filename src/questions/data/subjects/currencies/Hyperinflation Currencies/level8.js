// Hyperinflation Currencies Quiz - Level 8
(function() {
  const level8 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Critical mass threshold of velocity acceleration",
                  "es": "Umbral de masa crítica de aceleración de velocidad",
                  "de": "Kritische Masse-Schwelle der Geschwindigkeitsbeschleunigung",
                  "nl": "Kritische massa drempel van snelheidsversnelling"
        },
        {
                  "en": "Laffer curve peak for seigniorage revenue",
                  "es": "Pico de curva de Laffer para ingresos por señoreaje",
                  "de": "Laffer-Kurven-Spitze für Seigniorage-Einnahmen",
                  "nl": "Laffer curve piek voor seigniorage opbrengst"
        },
        {
                  "en": "Nash equilibrium of inflation expectations",
                  "es": "Equilibrio de Nash de expectativas de inflación",
                  "de": "Nash-Gleichgewicht der Inflationserwartungen",
                  "nl": "Nash evenwicht van inflatie verwachtingen"
        },
        {
                  "en": "Bifurcation point in nonlinear monetary dynamics",
                  "es": "Punto de bifurcación en dinámica monetaria no lineal",
                  "de": "Bifurkationspunkt in nichtlinearer monetärer Dynamik",
                  "nl": "Bifurcatie punt in niet-lineaire monetaire dynamiek"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Catastrophe theory bifurcation models",
                  "es": "Modelos de bifurcación de teoría de catástrofes",
                  "de": "Katastrophentheorie-Bifurkationsmodelle",
                  "nl": "Catastrofe theorie bifurcatie modellen"
        },
        {
                  "en": "Markov-switching regime models with stochastic volatility",
                  "es": "Modelos de cambio de régimen de Markov con volatilidad estocástica",
                  "de": "Markov-Regime-Wechsel-Modelle mit stochastischer Volatilität",
                  "nl": "Markov-switching regime modellen met stochastische volatiliteit"
        },
        {
                  "en": "ARCH/GARCH heteroskedasticity frameworks",
                  "es": "Marcos de heterocedasticidad ARCH/GARCH",
                  "de": "ARCH/GARCH-Heteroskedastizitäts-Rahmen",
                  "nl": "ARCH/GARCH heteroskedasticiteit kaders"
        },
        {
                  "en": "Lévy flight stochastic process simulations",
                  "es": "Simulaciones de procesos estocásticos de vuelo de Lévy",
                  "de": "Lévy-Flug stochastische Prozesssimulationen",
                  "nl": "Lévy vlucht stochastische proces simulaties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Decreased volatility in inflation rates as stability increases",
                  "es": "Disminución de volatilidad en tasas de inflación a medida que aumenta la estabilidad",
                  "de": "Verringerte Volatilität der Inflationsraten bei zunehmender Stabilität",
                  "nl": "Verminderde volatiliteit in inflatiepercentages naarmate stabiliteit toeneemt"
        },
        {
                  "en": "Rapid acceleration of price changes with no warning signs",
                  "es": "Aceleración rápida de cambios de precios sin señales de advertencia",
                  "de": "Schnelle Beschleunigung von Preisänderungen ohne Warnzeichen",
                  "nl": "Snelle versnelling van prijsveranderingen zonder waarschuwingssignalen"
        },
        {
                  "en": "Gradual decline in money supply growth rates",
                  "es": "Disminución gradual en tasas de crecimiento de oferta monetaria",
                  "de": "Allmählicher Rückgang der Geldmengenwachstumsraten",
                  "nl": "Geleidelijke daling in geldhoeveelheid groeipercentages"
        },
        {
                  "en": "Increased recovery time from perturbations signaling approaching tipping point",
                  "es": "Aumento del tiempo de recuperación de perturbaciones señalando punto de inflexión cercano",
                  "de": "Erhöhte Erholungszeit von Störungen signalisiert nahenden Kipppunkt",
                  "nl": "Verhoogde hersteltijd van verstoringen signaleert naderende kantelpunt"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Repeated prisoner's dilemma with declining cooperation",
                  "es": "Dilema del prisionero repetido con cooperación decreciente",
                  "de": "Wiederholtes Gefangenendilemma mit abnehmender Kooperation",
                  "nl": "Herhaald gevangenendilemma met afnemende samenwerking"
        },
        {
                  "en": "War of attrition with asymmetric information",
                  "es": "Guerra de desgaste con información asimétrica",
                  "de": "Zermürbungskrieg mit asymmetrischer Information",
                  "nl": "Uitputtingsoorlog met asymmetrische informatie"
        },
        {
                  "en": "Stackelberg leader-follower with time-inconsistent preferences",
                  "es": "Líder-seguidor de Stackelberg con preferencias temporalmente inconsistentes",
                  "de": "Stackelberg-Führer-Folger mit zeitinkonsistenten Präferenzen",
                  "nl": "Stackelberg leider-volger met tijdinconsistente voorkeuren"
        },
        {
                  "en": "Evolutionary dynamics with mutation and selection pressures",
                  "es": "Dinámica evolutiva con presiones de mutación y selección",
                  "de": "Evolutionäre Dynamik mit Mutations- und Selektionsdruck",
                  "nl": "Evolutionaire dynamiek met mutatie en selectiedruk"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When monetary policy dominates fiscal decisions through interest rate control",
                  "es": "Cuando la política monetaria domina decisiones fiscales a través del control de tasas de interés",
                  "de": "Wenn Geldpolitik Fiskalentscheidungen durch Zinssatzkontrolle dominiert",
                  "nl": "Wanneer monetair beleid fiscale beslissingen domineert door rentetarief controle"
        },
        {
                  "en": "When trade surplus dictates monetary expansion",
                  "es": "Cuando el superávit comercial dicta la expansión monetaria",
                  "de": "Wenn Handelsüberschuss monetäre Expansion diktiert",
                  "nl": "Wanneer handelsoverschot monetaire expansie dicteert"
        },
        {
                  "en": "When fiscal policy controls monetary policy, forcing money creation to finance deficits",
                  "es": "Cuando la política fiscal controla la política monetaria, forzando la creación de dinero para financiar déficits",
                  "de": "Wenn Fiskalpolitik Geldpolitik kontrolliert, Geldschöpfung zur Defizitfinanzierung erzwingend",
                  "nl": "Wanneer fiscaal beleid monetair beleid controleert, geldcreatie dwingend om tekorten te financieren"
        },
        {
                  "en": "When foreign exchange reserves determine domestic policy",
                  "es": "Cuando las reservas de divisas determinan la política nacional",
                  "de": "Wenn Devisenreserven die Innenpolitik bestimmen",
                  "nl": "Wanneer valutareserves binnenlands beleid bepalen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Agent-based modeling with heterogeneous expectations",
                  "es": "Modelado basado en agentes con expectativas heterogéneas",
                  "de": "Agentenbasierte Modellierung mit heterogenen Erwartungen",
                  "nl": "Agent-gebaseerde modellering met heterogene verwachtingen"
        },
        {
                  "en": "Cellular automata with threshold activation rules",
                  "es": "Autómatas celulares con reglas de activación de umbral",
                  "de": "Zelluläre Automaten mit Schwellenaktivierungsregeln",
                  "nl": "Cellulaire automata met drempel activatie regels"
        },
        {
                  "en": "Self-organized criticality and avalanche dynamics",
                  "es": "Criticidad auto-organizada y dinámica de avalancha",
                  "de": "Selbstorganisierte Kritikalität und Lawinendynamik",
                  "nl": "Zelf-georganiseerde criticaliteit en lawine dynamiek"
        },
        {
                  "en": "Percolation theory and network connectivity thresholds",
                  "es": "Teoría de percolación y umbrales de conectividad de red",
                  "de": "Perkolationstheorie und Netzwerkkonnektivitätsschwellen",
                  "nl": "Percolatie theorie en netwerk connectiviteit drempels"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When central bank independence undermines fiscal credibility",
                  "es": "Cuando la independencia del banco central socava la credibilidad fiscal",
                  "de": "Wenn Zentralbankunabhängigkeit fiskalische Glaubwürdigkeit untergräbt",
                  "nl": "Wanneer centrale bank onafhankelijkheid fiscale geloofwaardigheid ondermijnt"
        },
        {
                  "en": "When successful early reforms unexpectedly increase inflation expectations",
                  "es": "Cuando reformas tempranas exitosas inesperadamente aumentan expectativas de inflación",
                  "de": "Wenn erfolgreiche frühe Reformen unerwartet Inflationserwartungen erhöhen",
                  "nl": "Wanneer succesvolle vroege hervormingen onverwacht inflatie verwachtingen verhogen"
        },
        {
                  "en": "When harsh stabilization policies suddenly become credible through demonstrated commitment",
                  "es": "Cuando políticas de estabilización duras repentinamente se vuelven creíbles a través de compromiso demostrado",
                  "de": "Wenn harte Stabilisierungspolitiken plötzlich durch demonstriertes Engagement glaubwürdig werden",
                  "nl": "Wanneer harde stabilisatie beleidsmaatregelen plotseling geloofwaardig worden door aangetoonde toewijding"
        },
        {
                  "en": "When government credibility paradoxically decreases as reforms succeed",
                  "es": "Cuando la credibilidad del gobierno paradójicamente disminuye a medida que las reformas tienen éxito",
                  "de": "Wenn Regierungsglaubwürdigkeit paradoxerweise abnimmt, wenn Reformen erfolgreich sind",
                  "nl": "Wanneer overheidsgeloofwaardigheid paradoxaal afneemt naarmate hervormingen slagen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fisher information loss in price discovery mechanisms",
                  "es": "Pérdida de información de Fisher en mecanismos de descubrimiento de precios",
                  "de": "Fisher-Informationsverlust in Preisfindungsmechanismen",
                  "nl": "Fisher informatie verlies in prijs ontdekking mechanismen"
        },
        {
                  "en": "Shannon entropy of price signal degradation",
                  "es": "Entropía de Shannon de degradación de señal de precios",
                  "de": "Shannon-Entropie der Preissignalverschlechterung",
                  "nl": "Shannon entropie van prijs signaal degradatie"
        },
        {
                  "en": "Algorithmic randomness of currency denomination sequences",
                  "es": "Aleatoriedad algorítmica de secuencias de denominación de moneda",
                  "de": "Algorithmische Zufälligkeit von Währungsstückelungssequenzen",
                  "nl": "Algoritmische willekeur van valuta coupure sequenties"
        },
        {
                  "en": "Kolmogorov complexity of inflation time series",
                  "es": "Complejidad de Kolmogorov de series temporales de inflación",
                  "de": "Kolmogorov-Komplexität von Inflationszeitreihen",
                  "nl": "Kolmogorov complexiteit van inflatie tijdreeksen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Velocity becomes negatively correlated with money supply growth",
                  "es": "La velocidad se correlaciona negativamente con el crecimiento de oferta monetaria",
                  "de": "Umlaufgeschwindigkeit korreliert negativ mit Geldmengenwachstum",
                  "nl": "Snelheid correleert negatief met geldhoeveelheid groei"
        },
        {
                  "en": "Velocity stabilizes through currency substitution equilibrium",
                  "es": "La velocidad se estabiliza a través del equilibrio de sustitución de moneda",
                  "de": "Umlaufgeschwindigkeit stabilisiert sich durch Währungssubstitutionsgleichgewicht",
                  "nl": "Snelheid stabiliseert door valutavervanging evenwicht"
        },
        {
                  "en": "Positive feedback loop where rising velocity requires faster printing, accelerating velocity further",
                  "es": "Bucle de retroalimentación positiva donde velocidad creciente requiere impresión más rápida, acelerando velocidad aún más",
                  "de": "Positive Rückkopplungsschleife, wo steigende Umlaufgeschwindigkeit schnelleres Drucken erfordert, Geschwindigkeit weiter beschleunigend",
                  "nl": "Positieve feedback lus waar stijgende snelheid sneller drukken vereist, snelheid verder versnellend"
        },
        {
                  "en": "Velocity reaches physical maximum of transaction processing",
                  "es": "La velocidad alcanza el máximo físico de procesamiento de transacciones",
                  "de": "Umlaufgeschwindigkeit erreicht physisches Maximum der Transaktionsverarbeitung",
                  "nl": "Snelheid bereikt fysiek maximum van transactie verwerking"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Strange attractor with fractal dimension",
                  "es": "Atractor extraño con dimensión fractal",
                  "de": "Seltsamer Attraktor mit fraktaler Dimension",
                  "nl": "Vreemde attractor met fractale dimensie"
        },
        {
                  "en": "Homoclinic orbit approaching unstable equilibrium",
                  "es": "Órbita homoclínica aproximándose a equilibrio inestable",
                  "de": "Homokline Bahn nähert sich instabilem Gleichgewicht",
                  "nl": "Homoklinische baan naderend instabiel evenwicht"
        },
        {
                  "en": "Basin boundary separating attraction domains",
                  "es": "Frontera de cuenca separando dominios de atracción",
                  "de": "Beckengrenze trennt Attraktionsdomänen",
                  "nl": "Bekken grens scheidend attractie domeinen"
        },
        {
                  "en": "Saddle point with unstable manifold",
                  "es": "Punto de silla con variedad inestable",
                  "de": "Sattelpunkt mit instabiler Mannigfaltigkeit",
                  "nl": "Zadelpunt met instabiele varieteit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When a monetary measure becomes policy target, it ceases to be reliable indicator",
                  "es": "Cuando una medida monetaria se convierte en objetivo de política, deja de ser indicador confiable",
                  "de": "Wenn eine monetäre Maßgröße zum Politikziel wird, hört sie auf, zuverlässiger Indikator zu sein",
                  "nl": "Wanneer een monetaire maatstaf beleids doelwit wordt, houdt het op betrouwbare indicator te zijn"
        },
        {
                  "en": "Monetary aggregates lose economic meaning during rapid inflation",
                  "es": "Los agregados monetarios pierden significado económico durante inflación rápida",
                  "de": "Geldaggregate verlieren wirtschaftliche Bedeutung während schneller Inflation",
                  "nl": "Monetaire aggregaten verliezen economische betekenis tijdens snelle inflatie"
        },
        {
                  "en": "Monetary targets become self-fulfilling through expectation channels",
                  "es": "Los objetivos monetarios se vuelven autocumplidos a través de canales de expectativas",
                  "de": "Geldmengenziele werden durch Erwartungskanäle selbsterfüllend",
                  "nl": "Monetaire doelstellingen worden zelfvervullend door verwachting kanalen"
        },
        {
                  "en": "Multiple equilibria emerge from single monetary policy rule",
                  "es": "Múltiples equilibrios emergen de una sola regla de política monetaria",
                  "de": "Mehrere Gleichgewichte entstehen aus einer einzelnen geldpolitischen Regel",
                  "nl": "Meerdere evenwichten ontstaan uit enkele monetaire beleidsregel"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Lévy process with Poisson jumps and stochastic volatility",
                  "es": "Proceso de Lévy con saltos de Poisson y volatilidad estocástica",
                  "de": "Lévy-Prozess mit Poisson-Sprüngen und stochastischer Volatilität",
                  "nl": "Lévy proces met Poisson sprongen en stochastische volatiliteit"
        },
        {
                  "en": "Ornstein-Uhlenbeck mean-reverting process",
                  "es": "Proceso de reversión a la media de Ornstein-Uhlenbeck",
                  "de": "Ornstein-Uhlenbeck Mean-Reverting-Prozess",
                  "nl": "Ornstein-Uhlenbeck gemiddelde-reverterende proces"
        },
        {
                  "en": "Martingale representation with predictable variation",
                  "es": "Representación de martingala con variación predecible",
                  "de": "Martingal-Darstellung mit vorhersagbarer Variation",
                  "nl": "Martingale representatie met voorspelbare variatie"
        },
        {
                  "en": "Geometric Brownian motion with constant drift",
                  "es": "Movimiento browniano geométrico con deriva constante",
                  "de": "Geometrische Brownsche Bewegung mit konstantem Drift",
                  "nl": "Geometrische Brownse beweging met constante drift"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trade ceases entirely as price discovery mechanisms fail",
                  "es": "El comercio cesa completamente cuando fallan los mecanismos de descubrimiento de precios",
                  "de": "Handel hört vollständig auf, wenn Preisfindungsmechanismen versagen",
                  "nl": "Handel stopt volledig wanneer prijs ontdekking mechanismen falen"
        },
        {
                  "en": "Only insider trading persists during hyperinflation",
                  "es": "Solo persiste el comercio con información privilegiada durante la hiperinflación",
                  "de": "Nur Insiderhandel besteht während Hyperinflation fort",
                  "nl": "Alleen handel met voorkennis blijft bestaan tijdens hyperinflatie"
        },
        {
                  "en": "Rational agents with common knowledge should not trade, yet hyperinflation sees massive trading volume",
                  "es": "Agentes racionales con conocimiento común no deberían comerciar, pero la hiperinflación ve un volumen de comercio masivo",
                  "de": "Rationale Agenten mit gemeinsamen Wissen sollten nicht handeln, dennoch sieht Hyperinflation massives Handelsvolumen",
                  "nl": "Rationele agenten met gemeenschappelijke kennis zouden niet moeten handelen, toch ziet hyperinflatie massaal handelsvolume"
        },
        {
                  "en": "Trading volume becomes perfectly predictable from money supply",
                  "es": "El volumen de comercio se vuelve perfectamente predecible desde la oferta monetaria",
                  "de": "Handelsvolumen wird perfekt vorhersagbar aus Geldmenge",
                  "nl": "Handelsvolume wordt perfect voorspelbaar van geldhoeveelheid"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Recurrence theorem guarantees cyclical patterns repeat",
                  "es": "Teorema de recurrencia garantiza que patrones cíclicos se repiten",
                  "de": "Wiederkehr-Theorem garantiert, dass zyklische Muster sich wiederholen",
                  "nl": "Terugkeer theorema garandeert dat cyclische patronen herhalen"
        },
        {
                  "en": "Ergodicity allows averaging over time to equal ensemble average",
                  "es": "La ergodicidad permite promediar a lo largo del tiempo para igualar el promedio del conjunto",
                  "de": "Ergodizität ermöglicht Mittelung über Zeit gleich Ensemble-Durchschnitt",
                  "nl": "Ergodiciteit maakt middeling over tijd gelijk aan ensemble gemiddelde mogelijk"
        },
        {
                  "en": "Mixing property ensures all trajectories converge to same distribution",
                  "es": "Propiedad de mezcla asegura que todas las trayectorias convergen a la misma distribución",
                  "de": "Mischungseigenschaft stellt sicher, dass alle Trajektorien zur gleichen Verteilung konvergieren",
                  "nl": "Mengings eigenschap zorgt ervoor dat alle trajecten naar dezelfde distributie convergeren"
        },
        {
                  "en": "Non-ergodicity means time-averages diverge from ensemble averages due to path dependence",
                  "es": "La no ergodicidad significa que promedios temporales divergen de promedios de conjunto debido a dependencia del camino",
                  "de": "Nicht-Ergodizität bedeutet, dass Zeit-Durchschnitte von Ensemble-Durchschnitten aufgrund von Pfadabhängigkeit abweichen",
                  "nl": "Niet-ergodiciteit betekent dat tijd-gemiddelden divergeren van ensemble gemiddelden door pad afhankelijkheid"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Rational expectations dominate and eliminate adaptive updating",
                  "es": "Expectativas racionales dominan y eliminan actualización adaptativa",
                  "de": "Rationale Erwartungen dominieren und eliminieren adaptive Aktualisierung",
                  "nl": "Rationele verwachtingen domineren en elimineren adaptieve updating"
        },
        {
                  "en": "Adaptive expectations eventually converge to rational expectations",
                  "es": "Las expectativas adaptativas eventualmente convergen a expectativas racionales",
                  "de": "Adaptive Erwartungen konvergieren schließlich zu rationalen Erwartungen",
                  "nl": "Adaptieve verwachtingen convergeren uiteindelijk naar rationele verwachtingen"
        },
        {
                  "en": "Learning rates become heterogeneous, causing persistent expectation dispersion that never converges",
                  "es": "Tasas de aprendizaje se vuelven heterogéneas, causando dispersión persistente de expectativas que nunca converge",
                  "de": "Lernraten werden heterogen, verursachen persistente Erwartungsstreuung, die nie konvergiert",
                  "nl": "Leer percentages worden heterogeen, veroorzakend persistente verwachting spreiding die nooit convergeert"
        },
        {
                  "en": "Both expectation types produce identical inflation forecasts",
                  "es": "Ambos tipos de expectativas producen pronósticos de inflación idénticos",
                  "de": "Beide Erwartungstypen produzieren identische Inflationsprognosen",
                  "nl": "Beide verwachting types produceren identieke inflatie voorspellingen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hart-Moore incomplete contracts due to non-verifiable states and renegotiation costs",
                  "es": "Contratos incompletos de Hart-Moore debido a estados no verificables y costos de renegociación",
                  "de": "Hart-Moore-unvollständige Verträge aufgrund nicht verifizierbarer Zustände und Neuverhandlungskosten",
                  "nl": "Hart-Moore incomplete contracten door niet-verifieerbare toestanden en heronderhandeling kosten"
        },
        {
                  "en": "Modigliani-Miller irrelevance applies to hyperinflation contracts",
                  "es": "Irrelevancia de Modigliani-Miller se aplica a contratos de hiperinflación",
                  "de": "Modigliani-Miller-Irrelevanz gilt für Hyperinflationsverträge",
                  "nl": "Modigliani-Miller irrelevantie is van toepassing op hyperinflatie contracten"
        },
        {
                  "en": "Coase theorem ensures efficient contracting regardless of inflation",
                  "es": "Teorema de Coase asegura contratación eficiente independientemente de la inflación",
                  "de": "Coase-Theorem sichert effiziente Vertragsgestaltung unabhängig von Inflation",
                  "nl": "Coase theorema verzekert efficiënte contractering ongeacht inflatie"
        },
        {
                  "en": "Arrow-Debreu complete markets remain feasible with proper indexation",
                  "es": "Mercados completos de Arrow-Debreu siguen siendo factibles con indexación adecuada",
                  "de": "Arrow-Debreu-vollständige Märkte bleiben mit richtiger Indexierung machbar",
                  "nl": "Arrow-Debreu complete markten blijven haalbaar met juiste indexering"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Historical correlations remain stable across policy regimes",
                  "es": "Correlaciones históricas permanecen estables a través de regímenes de política",
                  "de": "Historische Korrelationen bleiben über Politikregime stabil",
                  "nl": "Historische correlaties blijven stabiel over beleids regimes"
        },
        {
                  "en": "Policy interventions change behavioral relationships, invalidating models based on historical data",
                  "es": "Intervenciones de política cambian relaciones de comportamiento, invalidando modelos basados en datos históricos",
                  "de": "Politikinterventionen ändern Verhaltensbeziehungen, invalidieren auf historischen Daten basierende Modelle",
                  "nl": "Beleids interventies veranderen gedrag relaties, modellen gebaseerd op historische data invaliderend"
        },
        {
                  "en": "Reduced-form relationships provide reliable policy guidance",
                  "es": "Relaciones de forma reducida proporcionan guía de política confiable",
                  "de": "Reduzierte-Form-Beziehungen bieten verlässliche Politikanleitung",
                  "nl": "Gereduceerde-vorm relaties bieden betrouwbare beleids geleiding"
        },
        {
                  "en": "Structural parameters are policy-invariant and can be estimated from any sample",
                  "es": "Parámetros estructurales son invariantes a política y pueden estimarse desde cualquier muestra",
                  "de": "Strukturparameter sind politikinvariant und können aus jeder Stichprobe geschätzt werden",
                  "nl": "Structurele parameters zijn beleids-invariant en kunnen geschat worden uit elke steekproef"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Revelation principle ensures truthful reporting makes commitment unnecessary",
                  "es": "Principio de revelación asegura que informes veraces hacen innecesario el compromiso",
                  "de": "Offenbarungsprinzip stellt sicher, dass wahrheitsgemäße Berichterstattung Commitment unnötig macht",
                  "nl": "Onthulling principe verzekert dat waarheidsgetrouwe rapportage commitment onnodig maakt"
        },
        {
                  "en": "Myerson-Satterthwaite impossibility: efficient trade requires commitment, but renegotiation undermines it",
                  "es": "Imposibilidad de Myerson-Satterthwaite: comercio eficiente requiere compromiso, pero renegociación lo socava",
                  "de": "Myerson-Satterthwaite-Unmöglichkeit: effizienter Handel erfordert Commitment, aber Neuverhandlung untergräbt es",
                  "nl": "Myerson-Satterthwaite onmogelijkheid: efficiënte handel vereist commitment, maar heronderhandeling ondermijnt het"
        },
        {
                  "en": "Vickrey auction mechanisms eliminate need for commitment",
                  "es": "Mecanismos de subasta de Vickrey eliminan necesidad de compromiso",
                  "de": "Vickrey-Auktionsmechanismen eliminieren Bedarf an Commitment",
                  "nl": "Vickrey veiling mechanismen elimineren behoefte aan commitment"
        },
        {
                  "en": "Pivotal mechanism ensures dominant strategy equilibrium without commitment",
                  "es": "Mecanismo pivote asegura equilibrio de estrategia dominante sin compromiso",
                  "de": "Pivotaler Mechanismus sichert dominantes Strategie-Gleichgewicht ohne Commitment",
                  "nl": "Pivot mechanisme verzekert dominant strategie evenwicht zonder commitment"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Equilibria are unaffected by coordination mechanisms",
                  "es": "Equilibrios no son afectados por mecanismos de coordinación",
                  "de": "Gleichgewichte sind von Koordinationsmechanismen unbeeinflusst",
                  "nl": "Evenwichten zijn onaangetast door coördinatie mechanismen"
        },
        {
                  "en": "Multiple equilibria where outcomes depend on self-fulfilling beliefs coordinated by irrelevant variables",
                  "es": "Múltiples equilibrios donde resultados dependen de creencias autocumplidas coordinadas por variables irrelevantes",
                  "de": "Multiple Gleichgewichte, wo Ergebnisse von selbsterfüllenden Überzeugungen abhängen, koordiniert durch irrelevante Variablen",
                  "nl": "Meerdere evenwichten waar uitkomsten afhangen van zelfvervullende overtuigingen gecoördineerd door irrelevante variabelen"
        },
        {
                  "en": "Unique equilibrium determined by rational expectations",
                  "es": "Equilibrio único determinado por expectativas racionales",
                  "de": "Eindeutiges Gleichgewicht bestimmt durch rationale Erwartungen",
                  "nl": "Uniek evenwicht bepaald door rationele verwachtingen"
        },
        {
                  "en": "Equilibria depend on fundamentals only, not extrinsic randomness",
                  "es": "Equilibrios dependen solo de fundamentos, no de aleatoriedad extrínseca",
                  "de": "Gleichgewichte hängen nur von Fundamentaldaten ab, nicht von extrinsischer Zufälligkeit",
                  "nl": "Evenwichten hangen alleen af van fundamenten, niet van extrinsieke willekeur"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Linear-quadratic regulator ensuring continuous control paths",
                  "es": "Regulador lineal-cuadrático asegurando trayectorias de control continuas",
                  "de": "Linear-quadratischer Regler sichert kontinuierliche Kontrollpfade",
                  "nl": "Lineair-kwadratische regulator verzekerd continue controle paden"
        },
        {
                  "en": "Bang-bang control where optimal policy jumps between extremes due to convex costs",
                  "es": "Control bang-bang donde política óptima salta entre extremos debido a costos convexos",
                  "de": "Bang-Bang-Kontrolle, wo optimale Politik zwischen Extremen springt aufgrund konvexer Kosten",
                  "nl": "Bang-bang controle waar optimaal beleid springt tussen extremen door convexe kosten"
        },
        {
                  "en": "Hamilton-Jacobi-Bellman equation prescribing gradual state transitions",
                  "es": "Ecuación de Hamilton-Jacobi-Bellman prescribiendo transiciones de estado graduales",
                  "de": "Hamilton-Jacobi-Bellman-Gleichung schreibt allmähliche Zustandsübergänge vor",
                  "nl": "Hamilton-Jacobi-Bellman vergelijking voorschrijvend geleidelijke toestand transities"
        },
        {
                  "en": "Pontryagin maximum principle showing smooth adjustment paths are optimal",
                  "es": "Principio máximo de Pontryagin mostrando que trayectorias de ajuste suaves son óptimas",
                  "de": "Pontryagin-Maximum-Prinzip zeigt, dass glatte Anpassungspfade optimal sind",
                  "nl": "Pontryagin maximum principe tonend dat soepele aanpassingspaden optimaal zijn"
        }
        ],
        correct: 1,
        explanation: {
