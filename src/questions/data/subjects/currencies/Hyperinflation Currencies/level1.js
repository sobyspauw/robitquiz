  ...
  questions: [
    {
      ...
      options: [
        ...
        { en: "Hungary", es: "Hungría", de: "Ungarn", nl: "Hongarije" },
    ...
    },
    {
      ...
      options: [
        { en: "Zimbabwe pound", es: "Libra zimbabuense", de: "Simbabwe-Pfund", nl: "Zimbabwaans pond" },
        { en: "Zimbabwe dollar", es: "Dólar zimbabuense", de: "Simbabwe-Dollar", nl: "Zimbabwaanse dollar" },
        { en: "Zimbabwe shilling", es: "Chelín zimbabuense", de: "Simbabwe-Schilling", nl: "Zimbabwaanse shilling" },
        { en: "Zimbabwe rand", es: "Rand zimbabuense", de: "Simbabwe-Rand", nl: "Zimbabwaanse rand" }
      ],
      correct: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { en: "Forint", es: "Forinto", de: "Forint", nl: "Forint" },
        { en: "Korona", es: "Corona", de: "Krone", nl: "Kroon" },
        { en: "Pengő", es: "Pengő", de: "Pengő", nl: "Pengő" },
        { en: "Gulden", es: "Gulden", de: "Gulden", nl: "Gulden" }
      ],
      correct: 2,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { en: "1 million marks", es: "1 millón de marcos", de: "1 Million Mark", nl: "1 miljoen mark" },
        { en: "1 billion marks", es: "1 mil millones de marcos", de: "1 Milliarde Mark", nl: "1 miljard mark" },
        { en: "100 trillion marks", es: "100 billones de marcos", de: "100 Billionen Mark", nl: "100 biljoen mark" },
        { en: "1 quadrillion marks", es: "1 cuatrillón de marcos", de: "1 Billiarde Mark", nl: "1 biljard mark" }
      ],
      correct: 2,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { en: "Swiss franc", es: "Franco suizo", de: "Schweizer Franken", nl: "Zwitserse frank" }
      ],
      correct: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { en: "Congo", es: "Congo", de: "Kongo", nl: "Congo" },
    ...
    },
    {
      ...
      options: [
        ...
        { en: "Austral", es: "Austral", de: "Austral", nl: "Austral" },
        { en: "Real", es: "Real", de: "Real", nl: "Real" },
        { en: "Cruzeiro", es: "Cruzeiro", de: "Cruzeiro", nl: "Cruzeiro" }
      ],
      correct: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { en: "Romania", es: "Rumania", de: "Rumänien", nl: "Roemenië" },
        { en: "Yugoslavia", es: "Yugoslavia", de: "Jugoslawien", nl: "Joegoslavië" },
        { en: "Albania", es: "Albania", de: "Albanien", nl: "Albanië" }
      ],
      correct: 2,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { en: "Cruzeiro", es: "Cruzeiro", de: "Cruzeiro", nl: "Cruzeiro" },
        { en: "Peso", es: "Peso", de: "Peso", nl: "Peso" },
        { en: "Escudo", es: "Escudo", de: "Escudo", nl: "Escudo" }
      ],
      correct: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { en: "Rentenmark", es: "Rentenmark", de: "Rentenmark", nl: "Rentenmark" },
        { en: "Euro", es: "Euro", de: "Euro", nl: "Euro" }
      ],
      correct: 2,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { en: "Sol", es: "Sol", de: "Sol", nl: "Sol" },
        { en: "Inti", es: "Inti", de: "Inti", nl: "Inti" },
        { en: "Peso", es: "Peso", de: "Peso", nl: "Peso" },
        { en: "Sucre", es: "Sucre", de: "Sucre", nl: "Sucre" }
      ],
      correct: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { en: "Czechoslovakia", es: "Checoslovaquia", de: "Tschechoslowakei", nl: "Tsjecho-Slowakije" },
        { en: "Poland", es: "Polonia", de: "Polen", nl: "Polen" },
    ...
    },
    {
      ...
      options: [
        { en: "Over 10% per month", es: "Más del 10% por mes", de: "Über 10% pro Monat", nl: "Meer dan 10% per maand" },
        { en: "Over 20% per month", es: "Más del 20% por mes", de: "Über 20% pro Monat", nl: "Meer dan 20% per maand" },
        { en: "Over 50% per month", es: "Más del 50% por mes", de: "Über 50% pro Monat", nl: "Meer dan 50% per maand" },
        { en: "Over 100% per month", es: "Más del 100% por mes", de: "Über 100% pro Monat", nl: "Meer dan 100% per maand" }
      ],
      correct: 2,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { en: "Excessive money printing", es: "Impresión excesiva de dinero", de: "Übermäßiges Gelddrucken", nl: "Overmatig geld drukken" },
        { en: "Trade deficits", es: "Déficits comerciales", de: "Handelsdefizite", nl: "Handelstekorten" },
        { en: "Population growth", es: "Crecimiento poblacional", de: "Bevölkerungswachstum", nl: "Bevolkingsgroei" }
      ],
      correct: 1,
      explanation: {
    ...
    },
    {
      ...
      options: [
        { en: "Gold standard", es: "Patrón oro", de: "Goldstandard", nl: "Gouden standaard" },
        { en: "Currency board", es: "Caja de conversión", de: "Currency Board", nl: "Currency board" },
        { en: "Land-backed currency", es: "Moneda respaldada por tierra", de: "Landgestützte Währung", nl: "Door land gedekte valuta" },
        { en: "Dollar peg", es: "Paridad con el dólar", de: "Dollar-Bindung", nl: "Dollarkoppeling" }
      ],
      correct: 2,
      explanation: {
    ...
    },
    {
      ...
      options: [
        ...
        { en: "Bolivia", es: "Bolivia", de: "Bolivien", nl: "Bolivië" },
