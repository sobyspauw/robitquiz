// Hyperinflation Currencies Quiz - Level 4
(function() {
  const level4 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Monetary policy is independent of fiscal concerns",
                  "es": "La política monetaria es independiente de las preocupaciones fiscales",
                  "de": "Geldpolitik ist unabhängig von fiskalischen Sorgen",
                  "nl": "Monetair beleid is onafhankelijk van fiscale zorgen"
        },
        {
                  "en": "Government revenues exceed expenditures",
                  "es": "Los ingresos gubernamentales exceden los gastos",
                  "de": "Regierungseinnahmen übersteigen Ausgaben",
                  "nl": "Overheidsinkomsten overschrijden uitgaven"
        },
        {
                  "en": "Fiscal policy determines monetary policy outcomes",
                  "es": "La política fiscal determina los resultados de la política monetaria",
                  "de": "Fiskalpolitik bestimmt die Ergebnisse der Geldpolitik",
                  "nl": "Fiscaal beleid bepaalt monetaire beleidsuitkomsten"
        },
        {
                  "en": "Central banks control government spending",
                  "es": "Los bancos centrales controlan el gasto gubernamental",
                  "de": "Zentralbanken kontrollieren Staatsausgaben",
                  "nl": "Centrale banken controleren overheidsuitgaven"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Cagan's semi-logarithmic model",
                  "es": "Modelo semi-logarítmico de Cagan",
                  "de": "Cagans semi-logarithmisches Modell",
                  "nl": "Cagan's semi-logaritmisch model"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Stock market speculation increases",
                  "es": "La especulación en el mercado de valores aumenta",
                  "de": "Börsenspekulationen nehmen zu",
                  "nl": "Aandelenmarkt speculatie neemt toe"
        },
        {
                  "en": "Investors seek domestic government bonds",
                  "es": "Los inversores buscan bonos gubernamentales domésticos",
                  "de": "Investoren suchen inländische Staatsanleihen",
                  "nl": "Investeerders zoeken binnenlandse staatsobligaties"
        },
        {
                  "en": "Investment increases in domestic real estate",
                  "es": "La inversión aumenta en bienes raíces domésticos",
                  "de": "Investitionen in inländische Immobilien steigen",
                  "nl": "Investeringen stijgen in binnenlandse onroerend goed"
        },
        {
                  "en": "Capital flows to safe foreign assets and hard currencies",
                  "es": "Los flujos de capital van hacia activos extranjeros seguros y monedas fuertes",
                  "de": "Kapitalströme zu sicheren ausländischen Vermögenswerten und harten Währungen",
                  "nl": "Kapitaalstromen naar veilige buitenlandse activa en harde valuta's"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Official reserves",
                  "es": "Reservas oficiales",
                  "de": "Offizielle Reserven",
                  "nl": "Officiële reserves"
        },
        {
                  "en": "Current account",
                  "es": "Cuenta corriente",
        ...
        {
                  "en": "Capital and financial account",
                  "es": "Cuenta de capital y financiera",
                  "de": "Kapital- und Finanzkonto",
                  "nl": "Kapitaal- en financiële rekening"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Lack of foreign currency reserves",
                  "es": "Falta de reservas de moneda extranjera",
                  "de": "Mangel an Devisenreserven",
                  "nl": "Gebrek aan buitenlandse valutareserves"
        },
        {
                  "en": "Small probability of large devaluation affecting expectations",
                  "es": "Pequeña probabilidad de gran devaluación afectando expectativas",
                  "de": "Geringe Wahrscheinlichkeit großer Abwertung beeinflusst Erwartungen",
                  "nl": "Kleine kans op grote devaluatie beïnvloedt verwachtingen"
        },
        {
                  "en": "Currency overvaluation relative to purchasing power",
                  "es": "Sobrevaluación de la moneda relativa al poder adquisitivo",
                  "de": "Währungsüberbewertung relativ zur Kaufkraft",
                  "nl": "Munt ovenwaardering relatief aan koopkracht"
        },
        {
                  "en": "Excessive money printing by central bank",
                  "es": "Impresión excesiva de dinero por el banco central",
                  "de": "Exzessives Gelddrucken durch die Zentralbank",
                  "nl": "Excessief geld drukken door centrale bank"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Emergency Financing Mechanism (EFM)",
                  "es": "Mecanismo de Financiamiento de Emergencia (EFM)",
                  "de": "Notfinanzierungsmechanismus (EFM)",
                  "nl": "Noodfinancieringsmechanisme (EFM)"
        },
        {
                  "en": "Extended Fund Facility (EFF)",
                  "es": "Mecanismo Ampliado de Financiamiento (EFF)",
                  "de": "Erweiterte Finanzierungsfazilität (EFF)",
                  "nl": "Uitgebreide Financieringsfaciliteit (EFF)"
        },
        {
                  "en": "Standby Arrangement (SBA)",
                  "es": "Acuerdo de Reserva (SBA)",
                  "de": "Bereitschaftskredit (SBA)",
                  "nl": "Stand-by Arrangement (SBA)"
        },
        {
                  "en": "Structural Adjustment Program (SAP)",
                  "es": "Programa de Ajuste Estructural (SAP)",
                  "de": "Strukturanpassungsprogramm (SAP)",
                  "nl": "Structureel Aanpassingsprogramma (SAP)"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cannot control inflation, unemployment, and growth simultaneously",
                  "es": "No se puede controlar inflación, desempleo y crecimiento simultáneamente",
                  "de": "Kann nicht gleichzeitig Inflation, Arbeitslosigkeit und Wachstum kontrollieren",
                  "nl": "Kan niet tegelijkertijd inflatie, werkloosheid en groei controleren"
        },
        {
                  "en": "Cannot maintain fixed exchange rate, free capital flows, and independent monetary policy simultaneously",
                  "es": "No se puede mantener tipo de cambio fijo, flujos de capital libres y política monetaria independiente simultáneamente",
                  "de": "Kann nicht gleichzeitig festen Wechselkurs, freie Kapitalströme und unabhängige Geldpolitik aufrechterhalten",
                  "nl": "Kan niet tegelijkertijd vaste wisselkoers, vrije kapitaalstromen en onafhankelijk monetair beleid handhaven"
        },
        {
                  "en": "Cannot achieve full employment, price stability, and external balance concurrently",
                  "es": "No se puede lograr pleno empleo, estabilidad de precios y equilibrio externo concurrentemente",
                  "de": "Kann nicht gleichzeitig Vollbeschäftigung, Preisstabilität und externes Gleichgewicht erreichen",
                  "nl": "Kan niet tegelijkertijd volledige werkgelegenheid, prijsstabiliteit en extern evenwicht bereiken"
        },
        {
                  "en": "Cannot maintain fiscal balance, trade balance, and price stability together",
                  "es": "No se puede mantener equilibrio fiscal, equilibrio comercial y estabilidad de precios juntos",
                  "de": "Kann nicht gleichzeitig Haushaltsgleichgewicht, Handelsgleichgewicht und Preisstabilität aufrechterhalten",
                  "nl": "Kan niet tegelijkertijd begrotingsevenwicht, handelsbalans en prijsstabiliteit handhaven"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Money growth targeting",
                  "es": "Metas de crecimiento monetario",
                  "de": "Geldwachstumsziel",
                  "nl": "Geldgroei targeting"
        },
        {
                  "en": "Exchange rate targeting",
                  "es": "Metas de tipo de cambio",
                  "de": "Wechselkursziel",
                  "nl": "Wisselkoers targeting"
        },
        {
                  "en": "Interest rate targeting",
                  "es": "Metas de tasa de interés",
                  "de": "Zinsziel",
                  "nl": "Rentetargeting"
        },
        {
                  "en": "Inflation targeting",
                  "es": "Metas de inflación",
                  "de": "Inflationsziel",
                  "nl": "Inflatietargeting"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They provide backward-looking price references",
                  "es": "Proporcionan referencias de precios retrospectivas",
                  "de": "Sie bieten rückwärtsgerichtete Preisreferenzen",
                  "nl": "Ze bieden achterwaarts kijkende prijsreferenties"
        },
        {
                  "en": "They establish forward-looking credible policy commitments",
                  "es": "Establecen compromisos de política creíbles prospectivos",
                  "de": "Sie etablieren vorausschauende glaubwürdige Politikzusagen",
                  "nl": "Ze vestigen vooruitkijkende geloofwaardige beleidsverplichtingen"
        },
        {
                  "en": "They prevent any price adjustments",
                  "es": "Previenen cualquier ajuste de precios",
                  "de": "Sie verhindern jegliche Preisanpassungen",
                  "nl": "Ze voorkomen alle prijsaanpassingen"
        },
        {
                  "en": "They eliminate all uncertainty about future prices",
                  "es": "Eliminan toda incertidumbre sobre precios futuros",
                  "de": "Sie beseitigen alle Unsicherheit über zukünftige Preise",
                  "nl": "Ze elimineren alle onzekerheid over toekomstige prijzen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Debt-to-GDP ratio exceeds 90%",
                  "es": "La relación deuda-PIB excede 90%",
                  "de": "Schulden-BIP-Verhältnis übersteigt 90%",
                  "nl": "Schuld-BBP verhouding overschrijdt 90%"
        },
        {
                  "en": "Central bank reserves fall below 3 months of imports",
                  "es": "Las reservas del banco central caen por debajo de 3 meses de importaciones",
                  "de": "Zentralbankreserven fallen unter 3 Monate Importe",
                  "nl": "Centrale bank reserves vallen onder 3 maanden import"
        },
        {
                  "en": "Seigniorage revenue equals real interest payments",
                  "es": "Los ingresos por señoreaje igualan los pagos reales de intereses",
                  "de": "Seigniorage-Einnahmen entsprechen realen Zinszahlungen",
                  "nl": "Seigniorage inkomsten gelijk aan reële rentebetalingen"
        },
        {
                  "en": "Money velocity exceeds 10 times per year",
                  "es": "La velocidad del dinero excede 10 veces por año",
                  "de": "Geldumlaufgeschwindigkeit übersteigt 10-mal pro Jahr",
                  "nl": "Geldsnelheid overschrijdt 10 keer per jaar"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Exchange rate fluctuations affect trade flows",
                  "es": "Las fluctuaciones del tipo de cambio afectan los flujos comerciales",
                  "de": "Wechselkursschwankungen beeinflussen Handelsströme",
                  "nl": "Wisselkoersfluctuaties beïnvloeden handelsstromen"
        },
        {
                  "en": "Expectations of future policy actions affect current behavior",
                  "es": "Las expectativas de acciones políticas futuras afectan el comportamiento actual",
                  "de": "Erwartungen zukünftiger Politikmaßnahmen beeinflussen aktuelles Verhalten",
                  "nl": "Verwachtingen van toekomstige beleidsacties beïnvloeden huidig gedrag"
        },
        {
                  "en": "Direct impact of money supply on prices",
                  "es": "Impacto directo de la oferta monetaria en los precios",
                  "de": "Direkter Einfluss der Geldmenge auf Preise",
                  "nl": "Directe impact van geldaanbod op prijzen"
        },
        {
                  "en": "Interest rate changes influence investment decisions",
                  "es": "Los cambios en las tasas de interés influyen en las decisiones de inversión",
                  "de": "Zinsänderungen beeinflussen Investitionsentscheidungen",
                  "nl": "Renteveranderingen beïnvloeden investeringsbeslissingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Prueba de causalidad de Granger",
                  "de": "Granger-Kausalitätstest",
                  "nl": "Granger causaliteitstest"
        },
        {
                  "en": "Johansen cointegration test",
                  "es": "Prueba de cointegración de Johansen",
                  "de": "Johansen-Kointegrationstest",
                  "nl": "Johansen cointegratie test"
        },
        {
                  "en": "Augmented Dickey-Fuller test",
                  "es": "Prueba de Dickey-Fuller aumentada",
                  "de": "Erweiterte Dickey-Fuller-Test",
                  "nl": "Augmented Dickey-Fuller test"
        },
        {
                  "en": "Chow test",
                  "es": "Prueba de Chow",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Falling real money balances reduce consumption and aggregate demand",
                  "es": "La caída de saldos reales de dinero reduce el consumo y la demanda agregada",
                  "de": "Fallende reale Geldbestände reduzieren Konsum und Gesamtnachfrage",
                  "nl": "Dalende reële geldsaldi verminderen consumptie en totale vraag"
        },
        {
                  "en": "Government spending increases to offset private sector decline",
                  "es": "El gasto gubernamental aumenta para compensar la disminución del sector privado",
                  "de": "Staatsausgaben steigen, um den Rückgang des Privatsektors auszugleichen",
                  "nl": "Overheidsuitgaven stijgen om private sector daling te compenseren"
        },
        {
                  "en": "Rising prices increase real wealth and consumption",
                  "es": "El aumento de precios incrementa la riqueza real y el consumo",
                  "de": "Steigende Preise erhöhen realen Wohlstand und Konsum",
                  "nl": "Stijgende prijzen verhogen reële welvaart en consumptie"
        },
        {
                  "en": "Interest rates automatically adjust to maintain equilibrium",
                  "es": "Las tasas de interés se ajustan automáticamente para mantener el equilibrio",
                  "de": "Zinssätze passen sich automatisch an, um Gleichgewicht zu erhalten",
                  "nl": "Rentetarieven passen automatisch aan om evenwicht te behouden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bretton Woods system",
                  "es": "Sistema de Bretton Woods",
                  "de": "Bretton-Woods-System",
                  "nl": "Bretton Woods systeem"
        },
        {
                  "en": "G7 currency intervention coordination",
                  "es": "Coordinación de intervención cambiaria del G7",
                  "de": "G7-Währungsinterventionskoordination",
                  "nl": "G7 valuta interventie coördinatie"
        },
        {
                  "en": "Plaza Accord arrangements",
                  "es": "Acuerdos del Plaza Accord",
                  "de": "Plaza-Abkommen-Vereinbarungen",
                  "nl": "Plaza Accord arrangementen"
        },
        {
                  "en": "IMF Article IV consultations",
                  "es": "Consultas del Artículo IV del FMI",
                  "de": "IWF-Artikel-IV-Konsultationen",
                  "nl": "IMF Artikel IV consultaties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Central bank assets above required levels",
                  "es": "Activos del banco central por encima de niveles requeridos",
                  "de": "Zentralbankvermögen über erforderlichen Niveaus",
                  "nl": "Centrale bank activa boven vereiste niveaus"
        },
        {
                  "en": "Excess government debt relative to GDP",
                  "es": "Deuda gubernamental excesiva relativa al PIB",
                  "de": "Exzessive Staatsschulden relativ zum BIP",
                  "nl": "Excessieve overheidsschuld relatief aan BBP"
        },
        {
                  "en": "Accumulated liquidity seeking goods in shortage economy",
                  "es": "Liquidez acumulada buscando bienes en economía de escasez",
                  "de": "Akkumulierte Liquidität sucht Güter in Mangelwirtschaft",
                  "nl": "Geaccumuleerde liquiditeit zoekt goederen in schaarste economie"
        },
        {
                  "en": "Foreign currency reserves exceeding domestic needs",
                  "es": "Reservas de moneda extranjera excediendo necesidades domésticas",
                  "de": "Devisenreserven übersteigen inländische Bedürfnisse",
                  "nl": "Buitenlandse valutareserves overschrijden binnenlandse behoeften"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tobin's q-theory model",
                  "es": "Modelo de la teoría q de Tobin",
                  "de": "Tobins q-Theorie-Modell",
                  "nl": "Tobin's q-theorie model"
        },
        {
                  "en": "Dynamic Stochastic General Equilibrium (DSGE) model",
                  "es": "Modelo de Equilibrio General Dinámico Estocástico (DSGE)",
                  "de": "Dynamisches Stochastisches Allgemeines Gleichgewichtsmodell (DSGE)",
                  "nl": "Dynamisch Stochastisch Algemeen Evenwicht (DSGE) model"
        },
        {
                  "en": "Overlapping generations model with money",
                  "es": "Modelo de generaciones superpuestas con dinero",
                  "de": "Überlappende-Generationen-Modell mit Geld",
                  "nl": "Overlappende generaties model met geld"
        },
        {
                  "en": "Mundell-Fleming model",
                  "es": "Modelo Mundell-Fleming",
                  "de": "Mundell-Fleming-Modell",
                  "nl": "Mundell-Fleming model"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Focus on short-term economic stimulation",
                  "es": "Enfoque en estimulación económica de corto plazo",
                  "de": "Fokus auf kurzfristige Wirtschaftsstimulation",
                  "nl": "Focus op korte termijn economische stimulatie"
        },
        {
                  "en": "Return to gold standard mechanisms",
                  "es": "Retorno a mecanismos del patrón oro",
                  "de": "Rückkehr zu Goldstandardmechanismen",
                  "nl": "Terugkeer naar goudstandaard mechanismen"
        },
        {
                  "en": "Elimination of central bank independence",
                  "es": "Eliminación de la independencia del banco central",
                  "de": "Beseitigung der Zentralbankunabhängigkeit",
                  "nl": "Eliminatie van centrale bank onafhankelijkheid"
        },
        {
                  "en": "Increased transparency and communication strategies",
                  "es": "Estrategias aumentadas de transparencia y comunicación",
                  "de": "Erhöhte Transparenz- und Kommunikationsstrategien",
                  "nl": "Verhoogde transparantie en communicatie strategieën"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Independent fiscal councils with enforcement powers",
                  "es": "Consejos fiscales independientes con poderes de cumplimiento",
                  "de": "Unabhängige Fiskalräte mit Durchsetzungsbefugnissen",
                  "nl": "Onafhankelijke fiscale raden met handhavingsmacht"
        },
        {
                  "en": "Constitutional balanced budget requirements",
                  "es": "Requisitos constitucionales de presupuesto equilibrado",
                  "de": "Verfassungsmäßige Haushalsausgleichsanforderungen",
                  "nl": "Constitutionele gebalanceerde begroting vereisten"
        },
        {
                  "en": "Parliamentary spending approval requirements",
                  "es": "Requisitos de aprobación parlamentaria de gastos",
                  "de": "Parlamentarische Ausgabengenehmigungsanforderungen",
                  "nl": "Parlementaire uitgaven goedkeuringsvereisten"
        },
        {
                  "en": "Automatic tax increase mechanisms",
                  "es": "Mecanismos automáticos de aumento de impuestos",
                  "de": "Automatische Steuererhöhungsmechanismen",
                  "nl": "Automatische belastingverhoging mechanismen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tax rate that maximizes government revenue",
                  "es": "Tasa impositiva que maximiza los ingresos gubernamentales",
                  "de": "Steuersatz, der Staatseinnahmen maximiert",
                  "nl": "Belastingtarief dat overheidsinkomsten maximaliseert"
        },
        {
                  "en": "Inflation rate beyond which money creation revenues decline",
                  "es": "Tasa de inflación más allá de la cual disminuyen los ingresos por creación de dinero",
                  "de": "Inflationsrate, jenseits derer Geldschöpfungseinnahmen sinken",
                  "nl": "Inflatiepercentage voorbij welke geldcreatie inkomsten dalen"
        },
        {
                  "en": "Exchange rate fluctuation band",
                  "es": "Banda de fluctuación del tipo de cambio",
                  "de": "Wechselkursschwankungsband",
                  "nl": "Wisselkoers fluctuatieband"
        },
        {
                  "en": "Interest rate differential between countries",
                  "es": "Diferencial de tasas de interés entre países",
                  "de": "Zinssatzdifferenz zwischen Ländern",
                  "nl": "Renteverschil tussen landen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Money supply contracts with inflation",
                  "es": "Oferta monetaria se contrae con inflación",
                  "de": "Geldmenge kontrahiert mit Inflation",
                  "nl": "Geldaanbod krimpt met inflatie"
        },
        {
                  "en": "Falling real money balances trigger compensatory velocity increases",
                  "es": "Saldos monetarios reales decrecientes desencadenan aumentos compensatorios de velocidad",
                  "de": "Sinkende Realkassenbestände lösen kompensatorische Geschwindigkeitserhöhungen aus",
                  "nl": "Dalende reële geldsaldi veroorzaken compenserende snelheidsstijgingen"
        },
        {
                  "en": "Exchange rates anchor domestic prices",
                  "es": "Tipos de cambio anclan precios domésticos",
                  "de": "Wechselkurse verankern inländische Preise",
                  "nl": "Wisselkoersen verankeren binnenlandse prijzen"
        },
        {
                  "en": "Real interest rates automatically stabilize inflation",
                  "es": "Tasas de interés reales estabilizan automáticamente la inflación",
                  "de": "Realzinsen stabilisieren automatisch die Inflation",
                  "nl": "Reële rentetarieven stabiliseren automatisch inflatie"
        }
        ],
        correct: 1,
        explanation: {
