    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Arbitrary political negotiations",
                  "es": "Negociaciones políticas arbitrarias",
                  "de": "Willkürliche politische Verhandlungen",
                  "nl": "Willekeurige politieke onderhandelingen"
        },
        {
                  "en": "Random market fluctuations",
                  "es": "Fluctuaciones aleatorias del mercado",
                  "de": "Zufällige Marktschwankungen",
                  "nl": "Willekeurige marktfluctuaties"
        },
        {
                  "en": "Historical exchange rate averages",
                  "es": "Promedios históricos de tipos de cambio",
                  "de": "Historische Wechselkursdurchschnitte",
                  "nl": "Historische wisselkoersgemiddelden"
        },
        {
                  "en": "Purchasing power parity adjustments based on fundamental equilibrium exchange rates reflecting underlying economic competitiveness",
                  "es": "Ajustes de paridad de poder adquisitivo basados en tipos de cambio de equilibrio fundamental que reflejan competitividad económica subyacente",
                  "de": "Kaufkraftparitätsanpassungen basierend auf fundamentalen Gleichgewichtswechselkursen, die die zugrundeliegende wirtschaftliche Wettbewerbsfähigkeit widerspiegeln",
                  "nl": "Koopkrachtpariteitsaanpassingen gebaseerd op fundamentele evenwichtswisselkoersen die onderliggende economische concurrentiekracht weerspiegelen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Elimination of all price differences",
                  "es": "Eliminación de todas las diferencias de precios",
                  "de": "Beseitigung aller Preisunterschiede",
                  "nl": "Eliminatie van alle prijsverschillen"
        },
        {
                  "en": "Requirement for identical productivity levels",
                  "es": "Requisito de niveles de productividad idénticos",
                  "de": "Anforderung identischer Produktivitätsniveaus",
                  "nl": "Vereiste van identieke productiviteitsniveaus"
        },
        {
                  "en": "Recognition that catching-up economies would naturally experience higher inflation due to productivity differentials in tradable vs non-tradable sectors",
                  "es": "Reconocimiento de que las economías en proceso de alcance experimentarían naturalmente mayor inflación debido a diferenciales de productividad en sectores comerciables vs no comerciables",
                  "de": "Anerkennung, dass aufholende Volkswirtschaften natürlich höhere Inflation aufgrund von Produktivitätsdifferenzen in handelbaren vs. nicht-handelbaren Sektoren erfahren würden",
                  "nl": "Erkenning dat inhalende economieën natuurlijk hogere inflatie zouden ervaren vanwege productiviteitsverschillen in verhandelbare vs niet-verhandelbare sectoren"
        },
        {
                  "en": "Uniform wage policies across countries",
                  "es": "Políticas salariales uniformes entre países",
                  "de": "Einheitliche Lohnpolitiken zwischen Ländern",
                  "nl": "Uniforme loonbeleid tussen landen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Preventing all government borrowing",
                  "es": "Prevenir todo endeudamiento gubernamental",
                  "de": "Verhinderung aller Staatsverschuldung",
                  "nl": "Voorkomen van alle overheidsleningen"
        },
        {
                  "en": "Eliminating sovereign debt markets",
                  "es": "Eliminar mercados de deuda soberana",
                  "de": "Beseitigung von Staatsschuldenmärkten",
                  "nl": "Elimineren van soevereine schuldenmarkten"
        },
        {
                  "en": "Guaranteeing unlimited fiscal transfers",
                  "es": "Garantizar transferencias fiscales ilimitadas",
                  "de": "Garantie unbegrenzter fiskalischer Transfers",
                  "nl": "Garanderen van onbeperkte fiscale transfers"
        },
        {
                  "en": "Creating market discipline through risk pricing to prevent moral hazard and ensure fiscal responsibility in the absence of centralized fiscal authority",
                  "es": "Crear disciplina de mercado a través de precios de riesgo para prevenir riesgo moral y asegurar responsabilidad fiscal en ausencia de autoridad fiscal centralizada",
                  "de": "Schaffung von Marktdisziplin durch Risikobepreisung zur Verhinderung von Moral Hazard und Gewährleistung fiskalischer Verantwortung in Abwesenheit zentralisierter fiskalischer Autorität",
                  "nl": "Creëren van marktdiscipline door risicoprijsstelling om moral hazard te voorkomen en fiscale verantwoordelijkheid te waarborgen bij afwezigheid van gecentraliseerde fiscale autoriteit"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Private sector control",
                  "es": "Control del sector privado",
                  "de": "Kontrolle des Privatsektors",
                  "nl": "Private sector controle"
        },
        {
                  ...
                  "es": "Estructura federal con representación de bancos centrales nacionales para equilibrar objetivos supranacionales con diversidad económica regional y asegurar efectividad del mecanismo de transmisión",
                  "de": "Föderale Struktur mit nationaler Zentralbankvertretung zum Ausgleich supranationaler Ziele mit regionaler wirtschaftlicher Vielfalt und Gewährleistung der Transmissionsmechanismus-Effektivität",
                  "nl": "Federale structuur met nationale centrale bank vertegenwoordiging om supranationale doelstellingen te balanceren met regionale economische diversiteit en transmissiemechanisme effectiviteit te waarborgen"
        },
        {
                  "en": "Purely national decision-making",
                  "es": "Toma de decisiones puramente nacional",
                  "de": "Rein nationale Entscheidungsfindung",
                  "nl": "Puur nationale besluitvorming"
        },
        {
                  "en": "Centralized autocratic decision-making",
                  "es": "Toma de decisiones autocrática centralizada",
                  "de": "Zentralisierte autokratische Entscheidungsfindung",
                  "nl": "Gecentraliseerde autocratische besluitvorming"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Historical budget averages",
                  "es": "Promedios presupuestarios históricos",
                  "de": "Historische Haushaltsdurchschnitte",
                  "nl": "Historische begrotingsgemiddelden"
        },
        {
                  "en": "Optimal taxation theory",
                  "es": "Teoría de tributación óptima",
                  "de": "Optimale Besteuerungstheorie",
                  "nl": "Optimale belastingtheorie"
        },
        {
                  "en": "Debt sustainability calculus assuming 5% nominal GDP growth and 60% debt-to-GDP ratio would stabilize with 3% deficit limit",
                  "es": "Cálculo de sostenibilidad de deuda asumiendo 5% de crecimiento nominal del PIB y ratio deuda-PIB de 60% se estabilizaría con límite de déficit del 3%",
                  "de": "Schuldentragfähigkeitsberechnung unter Annahme von 5% nominalem BIP-Wachstum und 60% Schulden-BIP-Verhältnis würde sich mit 3%-Defizitgrenze stabilisieren",
                  "nl": "Schuldhoudbaarheidsberekening aannemend 5% nominale BBP-groei en 60% schuld-BBP ratio zou stabiliseren met 3% deficitlimiet"
        },
        {
                  "en": "Random political compromise",
                  "es": "Compromiso político aleatorio",
                  "de": "Zufälliger politischer Kompromiss",
                  "nl": "Willekeurig politiek compromis"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Direct control of money printing",
                  "es": "Control directo de impresión de dinero",
                  "de": "Direkte Kontrolle des Gelddrucks",
                  "nl": "Directe controle van gelddruk"
        },
        {
                  "en": "Recognition that money supply is determined by credit demand and bank lending, leading to interest rate targeting rather than monetary aggregate control",
                  "es": "Reconocimiento de que la oferta monetaria está determinada por la demanda crediticia y préstamos bancarios, llevando a objetivos de tasas de interés en lugar de control de agregados monetarios",
                  "de": "Anerkennung, dass Geldmenge durch Kreditnachfrage und Bankkreditvergabe bestimmt wird, was zu Zinszielsteuerung statt Geldmengenkontrolle führt",
                  "nl": "Erkenning dat geldvoorraad wordt bepaald door kredietvraag en bankuitleningen, leidend tot rentetarief targeting in plaats van monetaire aggregaat controle"
        },
        {
                  "en": "Fixed money supply growth",
                  "es": "Crecimiento fijo de la oferta monetaria",
                  "de": "Festes Geldmengenwachstum",
                  "nl": "Vaste geldvoorraagroei"
        },
        {
                  "en": "Gold standard mechanisms",
                  "es": "Mecanismos del patrón oro",
                  "de": "Goldstandard-Mechanismen",
                  "nl": "Goudstandaard mechanismen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Arbitrary institutional design",
                  "es": "Diseño institucional arbitrario",
                  "de": "Willkürliches institutionelles Design",
                  "nl": "Willekeurig institutioneel ontwerp"
        },
        {
                  "en": "Copying other central bank models",
                  "es": "Copiar otros modelos de bancos centrales",
                  "de": "Kopieren anderer Zentralbankmodelle",
                  "nl": "Kopiëren van andere centrale bank modellen"
        },
        {
                  "en": "German Bundesbank influence and belief that price stability is prerequisite for sustainable employment, avoiding inflationary bias in monetary union without fiscal union",
                  "es": "Influencia del Bundesbank alemán y creencia de que la estabilidad de precios es prerequisito para empleo sostenible, evitando sesgo inflacionario en unión monetaria sin unión fiscal",
                  "de": "Bundesbank-Einfluss und Glaube, dass Preisstabilität Voraussetzung für nachhaltige Beschäftigung ist, Vermeidung inflationärer Verzerrung in Währungsunion ohne Fiskalunion",
                  "nl": "Duitse Bundesbank invloed en geloof dat prijsstabiliteit voorwaarde is voor duurzame werkgelegenheid, vermijden van inflationaire bias in monetaire unie zonder fiscale unie"
        },
        {
                  "en": "Political expedience",
                  "es": "Conveniencia política",
                  "de": "Politische Zweckmäßigkeit",
                  "nl": "Politieke opportuniteit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Managed floating within narrow bands",
                  "es": "Flotación administrada dentro de bandas estrechas",
                  "de": "Verwaltetes Floating innerhalb enger Bänder",
                  "nl": "Beheerde floating binnen smalle banden"
        },
        {
                  "en": "Full capital mobility with fixed intra-eurozone rates and floating external rates, recognizing that monetary policy effectiveness requires abandoning intermediate exchange rate targeting",
                  "es": "Movilidad de capital completa con tasas fijas intra-eurozona y tasas externas flotantes, reconociendo que la efectividad de política monetaria requiere abandonar objetivos intermedios de tipo de cambio",
                  "de": "Vollständige Kapitalmobilität mit festen Intra-Eurozone-Kursen und schwankenden externen Kursen, Anerkennung dass geldpolitische Wirksamkeit das Aufgeben intermediärer Wechselkursziele erfordert",
                  "nl": "Volledige kapitaalmobiliteit met vaste intra-eurozone koersen en zwevende externe koersen, erkennend dat monetaire beleidseffectiviteit het opgeven van intermediaire wisselkoersdoelstellingen vereist"
        },
        {
                  "en": "Capital controls on all flows",
                  "es": "Controles de capital en todos los flujos",
                  "de": "Kapitalkontrollen auf alle Ströme",
                  "nl": "Kapitaalcontroles op alle stromen"
        },
        {
                  "en": "Pegged exchange rates to dollar",
                  "es": "Tipos de cambio fijos al dólar",
                  "de": "An Dollar gekoppelte Wechselkurse",
                  "nl": "Aan dollar gekoppelde wisselkoersen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Political compromise between countries",
                  "es": "Compromiso político entre países",
                  "de": "Politischer Kompromiss zwischen Ländern",
                  "nl": "Politiek compromis tussen landen"
        },
        {
                  "en": "Bureaucratic organization",
                  "es": "Organización burocrática",
                  "de": "Bürokratische Organisation",
                  "nl": "Bureaucratische organisatie"
        },
        {
                  "en": "Arbitrary division of analytical work",
                  "es": "División arbitraria del trabajo analítico",
                  "de": "Willkürliche Aufteilung der analytischen Arbeit",
                  "nl": "Willekeurige verdeling van analytisch werk"
        },
        {
                  "en": "Synthesis of New Keynesian short-term price rigidities with monetarist long-term money-inflation relationships, providing cross-checking mechanism for policy decisions",
                  "es": "Síntesis de rigideces de precios a corto plazo Nuevas Keynesianas con relaciones monetaristas de dinero-inflación a largo plazo, proporcionando mecanismo de verificación cruzada para decisiones políticas",
                  "de": "Synthese neukeynesianischer kurzfristiger Preisrigiditäten mit monetaristischen langfristigen Geld-Inflations-Beziehungen, Bereitstellung eines Querprüfungsmechanismus für politische Entscheidungen",
                  "nl": "Synthese van Nieuwe Keynesiaanse korte termijn prijsrigiditeiten met monetaristische lange termijn geld-inflatie relaties, het verstrekken van kruiscontrolemechanisme voor beleidsbeslissingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Strong institutional independence and long terms to avoid inflationary bias from short-term political pressures and credibly commit to low inflation",
                  "es": "Fuerte independencia institucional y términos largos para evitar sesgo inflacionario de presiones políticas a corto plazo y comprometerse creíblemente con baja inflación",
                  "de": "Starke institutionelle Unabhängigkeit und lange Amtszeiten zur Vermeidung inflationärer Verzerrung durch kurzfristige politische Drücke und glaubwürdige Verpflichtung zu niedriger Inflation",
                  "nl": "Sterke institutionele onafhankelijkheid en lange termijnen om inflationaire bias van korte termijn politieke druk te vermijden en geloofwaardig te committeren aan lage inflatie"
        },
        {
                  "en": "Direct political control",
                  "es": "Control político directo",
                  "de": "Direkte politische Kontrolle",
                  "nl": "Directe politieke controle"
        },
        {
                  "en": "Rotating leadership",
                  "es": "Liderazgo rotativo",
                  "de": "Rotierende Führung",
                  "nl": "Roterend leiderschap"
        },
        {
                  "en": "Market-based appointments",
                  "es": "Nombramientos basados en el mercado",
                  "de": "Marktbasierte Ernennungen",
                  "nl": "Marktgebaseerde benoemingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Simplicity of calculation",
                  "es": "Simplicidad de cálculo",
                  "de": "Einfachheit der Berechnung",
                  "nl": "Eenvoud van berekening"
        },
        {
                  "en": "Historical precedent only",
                  "es": "Solo precedente histórico",
                  "de": "Nur historischer Präzedenzfall",
                  "nl": "Alleen historisch precedent"
        },
        {
                  "en": "Cross-country comparability and uniform methodology to measure price stability across diverse economies with different consumption patterns and statistical traditions",
                  "es": "Comparabilidad entre países y metodología uniforme para medir estabilidad de precios en economías diversas con diferentes patrones de consumo y tradiciones estadísticas",
                  "de": "Länderübergreifende Vergleichbarkeit und einheitliche Methodik zur Messung der Preisstabilität in verschiedenen Volkswirtschaften mit unterschiedlichen Konsummustern und statistischen Traditionen",
                  "nl": "Kruislandvergelijkbaarheid en uniforme methodologie om prijsstabiliteit te meten over diverse economieën met verschillende consumptiepatronen en statistische tradities"
        },
        {
                  "en": "Political convenience",
                  "es": "Conveniencia política",
                  "de": "Politische Bequemlichkeit",
                  "nl": "Politieke gemak"
        }
        ],
        correct: 2,
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Reconocimiento de que la integración del mercado financiero amplificaría la transmisión de política monetaria y reduciría choques financieros asimétricos a través de compartición de riesgos y movilidad de capital",
                  "de": "Anerkennung, dass Finanzmarktintegration die geldpolitische Transmission verstärken und asymmetrische Finanzschocks durch Risikoteilung und Kapitalmobilität reduzieren würde",
                  "nl": "Erkenning dat financiële marktintegratie monetaire beleidstransmissie zou versterken en asymmetrische financiële schokken zou verminderen door risicoverdeling en kapitaalmobiliteit"
        },
        {
                  "en": "Belief in automatic market stability",
                  "es": "Creencia en estabilidad automática del mercado",
                  "de": "Glaube an automatische Marktstabilität",
                  "nl": "Geloof in automatische marktstabiliteit"
        },
        {
                  "en": "Focus on trade integration only",
                  "es": "Enfoque solo en integración comercial",
                  "de": "Fokus nur auf Handelsintegration",
                  "nl": "Focus alleen op handelsintegratie"
        },
        {
                  "en": "Desire to eliminate all financial markets",
                  "es": "Deseo de eliminar todos los mercados financieros",
                  "de": "Wunsch, alle Finanzmärkte zu beseitigen",
                  "nl": "Verlangen om alle financiële markten te elimineren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Technical trading rules",
                  "es": "Reglas de comercio técnico",
                  "de": "Technische Handelsregeln",
                  "nl": "Technische handelsregels"
        },
        {
                  "en": "Random speculation",
                  "es": "Especulación aleatoria",
                  "de": "Zufällige Spekulation",
                  "nl": "Willekeurige speculatie"
        },
        {
                  "en": "Expectation that yield differentials would disappear as countries approached monetary union due to elimination of currency risk and convergence of credit risk perceptions",
                  "es": "Expectativa de que los diferenciales de rendimiento desaparecerían cuando los países se acercaran a la unión monetaria debido a la eliminación del riesgo de moneda y convergencia de percepciones de riesgo crediticio",
                  "de": "Erwartung, dass Renditeunterschiede verschwinden würden, wenn Länder sich der Währungsunion näherten aufgrund der Beseitigung des Währungsrisikos und Konvergenz der Kreditrisikoperzeprionen",
                  "nl": "Verwachting dat rendeverschillen zouden verdwijnen toen landen de monetaire unie naderden vanwege eliminatie van valutarisico en convergentie van kredietrisicopercepties"
        },
        {
                  "en": "Government guarantees",
                  "es": "Garantías gubernamentales",
                  "de": "Staatliche Garantien",
                  "nl": "Overheidsgaranties"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Expectation of dynamic gains through specialization, economies of scale, and innovation clusters that would exceed static comparative advantage benefits",
                  "es": "Expectativa de ganancias dinámicas a través de especialización, economías de escala y clusters de innovación que excederían beneficios estáticos de ventaja comparativa",
                  "de": "Erwartung dynamischer Gewinne durch Spezialisierung, Skalenökonomien und Innovationscluster, die statische komparative Vorteile übertreffen würden",
                  "nl": "Verwachting van dynamische winsten door specialisatie, schaalvoordelen en innovatieclusters die statische comparatieve voordelen zouden overtreffen"
        },
        {
                  "en": "Perfect competition assumptions",
                  "es": "Asunciones de competencia perfecta",
                  "de": "Annahmen perfekter Konkurrenz",
                  "nl": "Perfecte concurrentie aannames"
        },
        {
                  "en": "Focus on agricultural trade only",
                  "es": "Enfoque solo en comercio agrícola",
                  "de": "Fokus nur auf Agrarhandel",
                  "nl": "Focus alleen op landbouwhandel"
        },
        {
                  "en": "Simple tariff elimination benefits",
                  "es": "Beneficios simples de eliminación de aranceles",
                  "de": "Einfache Zollabbauvorteile",
                  "nl": "Eenvoudige tarifeliminatievoordelen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Technical inability to purchase bonds",
                  "es": "Incapacidad técnica para comprar bonos",
                  "de": "Technische Unfähigkeit, Anleihen zu kaufen",
                  "nl": "Technische onmogelijkheid om obligaties te kopen"
        },
        {
                  "en": "Insufficient financial resources",
                  "es": "Recursos financieros insuficientes",
                  "de": "Unzureichende finanzielle Ressourcen",
                  "nl": "Onvoldoende financiële middelen"
        },
        {
                  "en": "Lack of legal authority",
                  "es": "Falta de autoridad legal",
                  "de": "Mangel an rechtlicher Autorität",
                  "nl": "Gebrek aan wettelijke autoriteit"
        },
        {
                  "en": "Separation of monetary and fiscal domains to avoid moral hazard, preserve market discipline, and prevent fiscal dominance over monetary policy in accordance with Maastricht Treaty design",
                  "es": "Separación de dominios monetarios y fiscales para evitar riesgo moral, preservar disciplina de mercado, y prevenir dominancia fiscal sobre política monetaria de acuerdo con el diseño del Tratado de Maastricht",
                  "de": "Trennung monetärer und fiskalischer Bereiche zur Vermeidung von Moral Hazard, Bewahrung der Marktdisziplin und Verhinderung fiskalischer Dominanz über Geldpolitik gemäß Maastricht-Vertragsdesign",
                  "nl": "Scheiding van monetaire en fiscale domeinen om moral hazard te vermijden, marktdiscipline te behouden, en fiscale dominantie over monetair beleid te voorkomen in overeenstemming met Maastricht Verdrag ontwerp"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using only reduced-form models",
                  "es": "Usar solo modelos de forma reducida",
                  "de": "Nur reduzierte Modelle verwenden",
                  "nl": "Alleen reduced-form modellen gebruiken"
        },
        {
                  "en": "Emphasis on structural modeling with microfoundations and rational expectations to ensure policy evaluations account for behavioral responses to regime changes",
                  "es": "Énfasis en modelado estructural con microfundamentos y expectativas racionales para asegurar que evaluaciones de políticas tengan en cuenta respuestas conductuales a cambios de régimen",
                  "de": "Betonung struktureller Modellierung mit Mikrofundamenten und rationalen Erwartungen zur Sicherstellung, dass Politikbewertungen Verhaltensreaktionen auf Regimewechsel berücksichtigen",
                  "nl": "Nadruk op structurele modellering met microfunderingen en rationele verwachtingen om ervoor te zorgen dat beleidsevaluaties rekening houden met gedragsreacties op regimeveranderingen"
        },
        {
                  "en": "Reliance only on historical correlations",
                  "es": "Dependencia solo de correlaciones históricas",
                  "de": "Vertrauen nur auf historische Korrelationen",
                  "nl": "Vertrouwen alleen op historische correlaties"
        },
        {
                  "en": "Ignoring expectation formation",
                  "es": "Ignorar formación de expectativas",
                  "de": "Erwartungsbildung ignorieren",
                  "nl": "Verwachtingsvorming negeren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Replacing all national currencies",
                  "es": "Reemplazar todas las monedas nacionales",
                  "de": "Alle nationalen Währungen ersetzen",
                  "nl": "Alle nationale valuta's vervangen"
        },
        {
                  "en": "Eliminating commercial banks",
                  "es": "Eliminar bancos comerciales",
                  "de": "Geschäftsbanken eliminieren",
                  "nl": "Commerciële banken elimineren"
        },
        {
                  "en": "Reducing payment system costs only",
                  "es": "Reducir solo costos del sistema de pagos",
                  "de": "Nur Zahlungssystemkosten reduzieren",
                  "nl": "Alleen betalingssysteemkosten verminderen"
        },
        {
                  "en": "Creating unified payment infrastructure to ensure equal access to central bank money across borders, supporting monetary policy transmission and financial market integration",
                  "es": "Crear infraestructura de pagos unificada para asegurar acceso igual a dinero del banco central a través de fronteras, apoyando transmisión de política monetaria e integración de mercados financieros",
                  "de": "Schaffung einheitlicher Zahlungsinfrastruktur zur Gewährleistung gleichen Zugangs zu Zentralbankgeld grenzüberschreitend, Unterstützung geldpolitischer Transmission und Finanzmarktintegration",
                  "nl": "Creëren van uniforme betalingsinfrastructuur om gelijke toegang tot centraal bankgeld over grenzen te waarborgen, ondersteunend monetaire beleidstransmissie en financiële marktintegratie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "International fashion trends",
                  "es": "Tendencias de moda internacional",
                  "de": "Internationale Modetrends",
                  "nl": "Internationale modetrends"
        },
        {
                  "en": "Recognition that public confidence and trust in physical currency security were essential for euro acceptance and adoption as store of value and medium of exchange",
                  "es": "Reconocimiento de que la confianza pública y fe en la seguridad de moneda física eran esenciales para aceptación del euro y adopción como reserva de valor y medio de intercambio",
                  "de": "Anerkennung, dass öffentliches Vertrauen und Zuversicht in physische Währungssicherheit für Euro-Akzeptanz und Adoption als Wertaufbewahrungsmittel und Tauschmittel wesentlich waren",
                  "nl": "Erkenning dat publiek vertrouwen en geloof in fysieke valutaveiligheid essentieel waren voor euro-acceptatie en adoptie als waardeopslag en ruilmiddel"
        },
        {
                  "en": "Manufacturing cost reduction",
                  "es": "Reducción de costos de fabricación",
                  "de": "Herstellungskostenreduzierung",
                  "nl": "Productiekostenverlaging"
        },
        {
                  "en": "Artistic design preferences",
                  "es": "Preferencias de diseño artístico",
                  "de": "Künstlerische Designpräferenzen",
                  "nl": "Artistieke ontwerpvoorkeuren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Indifference to institutional arrangements",
                  "es": "Indiferencia a arreglos institucionales",
                  "de": "Gleichgültigkeit gegenüber institutionellen Arrangements",
                  "nl": "Onverschilligheid voor institutionele arrangementen"
        },
        {
                  "en": "Full support for the euro design",
                  "es": "Apoyo total para el diseño del euro",
                  "de": "Volle Unterstützung für das Euro-Design",
                  "nl": "Volledige steun voor het euro-ontwerp"
        },
        {
                  "en": "Focus only on microeconomic efficiency",
                  "es": "Enfoque solo en eficiencia microeconómica",
                  "de": "Fokus nur auf mikroökonomische Effizienz",
                  "nl": "Focus alleen op micro-economische efficiëntie"
        },
        {
                  "en": "Critical opposition arguing that monetary union without fiscal union creates artificial constraints on government spending capacity and removes essential macroeconomic stabilization tools",
                  "es": "Oposición crítica argumentando que unión monetaria sin unión fiscal crea restricciones artificiales en capacidad de gasto gubernamental y remueve herramientas esenciales de estabilización macroeconómica",
                  "de": "Kritische Opposition argumentierend, dass Währungsunion ohne Fiskalunion künstliche Beschränkungen der staatlichen Ausgabenkapazität schafft und wesentliche makroökonomische Stabilisierungstools entfernt",
                  "nl": "Kritische oppositie argumenterend dat monetaire unie zonder fiscale unie kunstmatige beperkingen op overheidsbestedingscapaciteit creëert en essentiële macro-economische stabilisatietools wegneemt"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Countries cannot simultaneously maintain fixed exchange rates, independent monetary policy, and free capital flows",
                  "es": "Los países no pueden mantener simultáneamente tipos de cambio fijos, política monetaria independiente y flujos de capital libres",
                  "de": "Länder können nicht gleichzeitig feste Wechselkurse, unabhängige Geldpolitik und freie Kapitalflüsse aufrechterhalten",
                  "nl": "Landen kunnen niet gelijktijdig vaste wisselkoersen, onafhankelijk monetair beleid en vrije kapitalstromen handhaven"
        },
        {
                  "en": "Economic integration occurs in three phases",
                  "es": "La integración económica ocurre en tres fases",
                  "de": "Wirtschaftsintegration erfolgt in drei Phasen",
                  "nl": "Economische integratie vindt plaats in drie fasen"
        },
        {
                  "en": "Monetary union requires unanimous agreement on all policies",
                  "es": "La unión monetaria requiere acuerdo unánime en todas las políticas",
                  "de": "Währungsunion erfordert einstimmige Zustimmung zu allen Politiken",
                  "nl": "Monetaire unie vereist unanieme overeenstemming over alle beleidsmaatregelen"
        },
        {
                  "en": "Three countries minimum needed for currency union",
                  "es": "Mínimo tres países necesarios para unión monetaria",
                  "de": "Mindestens drei Länder für Währungsunion erforderlich",
                  "nl": "Minimaal drie landen nodig voor valutaunie"
        }
        ],
        correct: 0,
        explanation: {
