    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Trace elements revealing ore sources and authenticity",
                  "es": "Elementos traza que revelan fuentes de mineral y autenticidad",
                  "de": "Spurenelemente, die Erzquellen und Authentizität offenbaren",
                  "nl": "Spoorelementen die ertsbronnen en authenticiteit onthullen"
        },
        {
                  "en": "Die production methods",
                  "es": "Métodos de producción de troqueles",
                  "de": "Stempelproduktionsmethoden",
                  "nl": "Stempel productie methoden"
        },
        {
                  "en": "Surface wear patterns",
                  "es": "Patrones de desgaste superficial",
                  "de": "Oberflächenverschleißmuster",
                  "nl": "Oppervlakte slijtageppatronen"
        },
        {
                  "en": "Coin circulation patterns",
                  "es": "Patrones de circulación de monedas",
                  "de": "Münzzirkulationsmuster",
                  "nl": "Munt circulatie patronen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "By revealing internal structure and core composition without damage",
                  "es": "Revelando estructura interna y composición del núcleo sin daño",
                  "de": "Durch Offenlegung der inneren Struktur und Kernzusammensetzung ohne Schäden",
                  "nl": "Door interne structuur en kernsamenstelling te onthullen zonder schade"
        },
        {
                  "en": "By analyzing color changes",
                  "es": "Analizando cambios de color",
                  "de": "Durch Analyse von Farbänderungen",
                  "nl": "Door kleurveranderingen te analyseren"
        },
        {
                  "en": "By testing magnetic properties",
                  "es": "Probando propiedades magnéticas",
                  "de": "Durch Prüfung magnetischer Eigenschaften",
                  "nl": "Door magnetische eigenschappen te testen"
        },
        {
                  "en": "By measuring surface hardness",
                  "es": "Midiendo la dureza superficial",
                  "de": "Durch Messung der Oberflächenhärte",
                  "nl": "Door oppervlakte hardheid te meten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measuring coin diameter",
                  "es": "Midiendo el diámetro de la moneda",
                  "de": "Messung des Münzdurchmessers",
                  "nl": "Meten van muntdiameter"
        },
        {
                  "en": "Analyzing microscopic samples to determine manufacturing era and techniques",
                  "es": "Analizando muestras microscópicas para determinar era y técnicas de fabricación",
                  "de": "Analyse mikroskopischer Proben zur Bestimmung von Herstellungsära und -techniken",
                  "nl": "Analyseren van microscopische monsters om productie-era en technieken te bepalen"
        },
        {
                  "en": "Testing coin weight accuracy",
                  "es": "Probando la precisión del peso de la moneda",
                  "de": "Prüfung der Münzgewichtsgenauigkeit",
                  "nl": "Testen van muntgewicht nauwkeurigheid"
        },
        {
                  "en": "Counting edge reeding",
                  "es": "Contando el estriado del borde",
                  "de": "Zählung der Randriffelung",
                  "nl": "Tellen van randribbing"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "By measuring coin thickness",
                  "es": "Midiendo el grosor de la moneda",
                  "de": "Durch Messung der Münzdicke",
                  "nl": "Door muntdikte te meten"
        },
        {
                  "en": "By analyzing surface texture",
                  "es": "Analizando textura superficial",
                  "de": "Durch Analyse der Oberflächentextur",
                  "nl": "Door oppervlakte textuur te analyseren"
        },
        {
                  "en": "By precisely identifying isotopic ratios and trace elements",
                  "es": "Identificando precisamente proporciones isotópicas y elementos traza",
                  "de": "Durch präzise Identifizierung von Isotopenverhältnissen und Spurenelementen",
                  "nl": "Door isotopenverhoudingen en spoorelementen nauwkeurig te identificeren"
        },
        {
                  "en": "By measuring magnetic fields",
                  "es": "Midiendo campos magnéticos",
                  "de": "Durch Messung magnetischer Felder",
                  "nl": "Door magnetische velden te meten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Determining mint locations",
                  "es": "Determinando ubicaciones de casas de moneda",
                  "de": "Bestimmung von Münzstättenstandorten",
                  "nl": "Bepalen van muntlocaties"
        },
        {
                  "en": "Calculating coin values",
                  "es": "Calculando valores de monedas",
                  "de": "Berechnung von Münzwerten",
                  "nl": "Berekenen van muntwaarden"
        },
        {
                  "en": "Measuring strike pressure",
                  "es": "Midiendo presión de acuñación",
                  "de": "Messung des Prägedrucks",
                  "nl": "Meten van slagdruk"
        },
        {
                  "en": "Automated detection of die varieties and links through image recognition",
                  "es": "Detección automatizada de variedades y enlaces de troquel mediante reconocimiento de imagen",
                  "de": "Automatische Erkennung von Stempelvarianten und -verbindungen durch Bilderkennung",
                  "nl": "Geautomatiseerde detectie van stempelvariëteiten en verbindingen door beeldherkenning"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Die manufacturing techniques",
                  "es": "Técnicas de fabricación de troqueles",
                  "de": "Stempelherstellungstechniken",
                  "nl": "Stempel fabricage technieken"
        },
        {
                  "en": "The exact minting date",
                  "es": "La fecha exacta de acuñación",
                  "de": "Das genaue Prägungsdatum",
                  "nl": "De exacte slagdatum"
        },
        {
                  "en": "Metal purity levels",
                  "es": "Niveles de pureza del metal",
                  "de": "Metallreinheitsgrade",
                  "nl": "Metaal zuiverheid niveaus"
        },
        {
                  "en": "Age of organic inclusions or surface deposits, providing authentication clues",
                  "es": "Edad de inclusiones orgánicas o depósitos superficiales, proporcionando pistas de autenticación",
                  "de": "Alter organischer Einschlüsse oder Oberflächenablagerungen, die Authentifizierungshinweise liefern",
                  "nl": "Leeftijd van organische insluitsels of oppervlakte afzettingen, die authenticatie aanwijzingen geven"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "By measuring coin weight",
                  "es": "Midiendo el peso de la moneda",
                  "de": "Durch Messung des Münzgewichts",
                  "nl": "Door muntgewicht te meten"
        },
        {
                  "en": "By testing coin flexibility",
                  "es": "Probando la flexibilidad de la moneda",
                  "de": "Durch Prüfung der Münzflexibilität",
                  "nl": "Door muntflexibiliteit te testen"
        },
        {
                  "en": "By analyzing sound frequencies",
                  "es": "Analizando frecuencias de sonido",
                  "de": "Durch Analyse von Schallfrequenzen",
                  "nl": "Door geluidsfrequenties te analyseren"
        },
        {
                  "en": "By revealing surface details at magnifications up to 100,000x",
                  "es": "Revelando detalles superficiales a magnificaciones de hasta 100,000x",
                  "de": "Durch Offenlegung von Oberflächendetails bei Vergrößerungen bis zu 100.000x",
                  "nl": "Door oppervlakte details te onthullen bij vergrotingen tot 100.000x"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The number of coins produced",
                  "es": "El número de monedas producidas",
                  "de": "Die Anzahl der produzierten Münzen",
                  "nl": "Het aantal geproduceerde munten"
        },
        {
                  "en": "The metal composition used",
                  "es": "La composición metálica usada",
                  "de": "Die verwendete Metallzusammensetzung",
                  "nl": "De gebruikte metaalsamenstelling"
        },
        {
        ...
        {
                  "en": "When the ceramic was last heated, indicating mold production date",
                  "es": "Cuándo se calentó por última vez la cerámica, indicando fecha de producción del molde",
                  "de": "Wann die Keramik zuletzt erhitzt wurde, was das Produktionsdatum der Form anzeigt",
                  "nl": "Wanneer de keramiek voor het laatst werd verwarmd, wat de productiedatum van de mal aangeeft"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They analyze surface wear",
                  "es": "Analizan desgaste superficial",
                  "de": "Sie analysieren Oberflächenverschleiß",
                  "nl": "Ze analyseren oppervlakte slijtage"
        },
        {
                  "en": "They determine metal composition",
                  "es": "Determinan composición metálica",
                  "de": "Sie bestimmen die Metallzusammensetzung",
                  "nl": "Ze bepalen metaalsamenstelling"
        },
        {
                  "en": "They create immutable records of ownership and transaction history",
                  "es": "Crean registros inmutables de propiedad e historia de transacciones",
                  "de": "Sie schaffen unveränderliche Aufzeichnungen von Eigentum und Transaktionsgeschichte",
                  "nl": "Ze creëren onveranderlijke records van eigendom en transactiegeschiedenis"
        },
        {
                  "en": "They measure coin dimensions",
                  "es": "Miden dimensiones de monedas",
                  "de": "Sie messen Münzdimensionen",
                  "nl": "Ze meten muntdimensies"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Precise elemental composition with minimal sample damage",
                  "es": "Composición elemental precisa con daño mínimo de muestra",
                  "de": "Präzise Elementzusammensetzung mit minimaler Probeschädigung",
                  "nl": "Nauwkeurige elementsamenstelling met minimale monster schade"
        },
        {
                  "en": "Surface scratches and wear patterns",
                  "es": "Arañazos superficiales y patrones de desgaste",
                  "de": "Oberflächenkratzer und Verschleißmuster",
                  "nl": "Oppervlakte krassen en slijtagepatronen"
        },
        {
                  "en": "Historical market prices",
                  "es": "Precios históricos del mercado",
                  "de": "Historische Marktpreise",
                  "nl": "Historische marktprijzen"
        },
        {
                  "en": "Coin production volumes",
                  "es": "Volúmenes de producción de monedas",
                  "de": "Münzproduktionsvolumen",
                  "nl": "Muntproductie volumes"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "By creating detailed 3D models from multiple photographs",
                  "es": "Creando modelos 3D detallados a partir de múltiples fotografías",
                  "de": "Durch Erstellung detaillierter 3D-Modelle aus mehreren Fotografien",
                  "nl": "Door gedetailleerde 3D-modellen te creëren uit meerdere foto's"
        },
        {
                  "en": "By measuring magnetic properties",
                  "es": "Midiendo propiedades magnéticas",
                  "de": "Durch Messung magnetischer Eigenschaften",
                  "nl": "Door magnetische eigenschappen te meten"
        },
        {
                  "en": "By testing hardness levels",
                  "es": "Probando niveles de dureza",
                  "de": "Durch Prüfung von Härtegraden",
                  "nl": "Door hardheid niveaus te testen"
        },
        {
                  "en": "By analyzing metal composition",
                  "es": "Analizando composición metálica",
                  "de": "Durch Analyse der Metallzusammensetzung",
                  "nl": "Door metaalsamenstelling te analyseren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pattern recognition for automated attribution and authentication",
                  "es": "Reconocimiento de patrones para atribución y autenticación automatizada",
                  "de": "Mustererkennung für automatisierte Zuordnung und Authentifizierung",
                  "nl": "Patroonherkenning voor geautomatiseerde toewijzing en authenticatie"
        },
        {
                  "en": "Metal extraction from ore",
                  "es": "Extracción de metal del mineral",
                  "de": "Metallextraktion aus Erz",
                  "nl": "Metaal extractie uit erts"
        },
        {
                  "en": "Physical coin handling",
                  "es": "Manejo físico de monedas",
                  "de": "Physische Münzhandhabung",
                  "nl": "Fysieke munthantering"
        },
        {
                  "en": "Coin minting processes",
                  "es": "Procesos de acuñación de monedas",
                  "de": "Münzprägeprozesse",
                  "nl": "Muntslag processen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "By providing ultra-high-resolution elemental mapping and phase identification",
                  "es": "Proporcionando mapeo elemental de ultra alta resolución e identificación de fases",
                  "de": "Durch Bereitstellung von ultra-hochauflösender Elementkartierung und Phasenidentifikation",
                  "nl": "Door ultra-hoge resolutie element mapping en fase identificatie te bieden"
        },
        {
                  "en": "By counting surface scratches",
                  "es": "Contando arañazos superficiales",
                  "de": "Durch Zählung von Oberflächenkratzern",
                  "nl": "Door oppervlakte krassen te tellen"
        },
        {
                  "en": "By measuring coin weight",
                  "es": "Midiendo peso de monedas",
                  "de": "Durch Münzgewichtsmessung",
                  "nl": "Door muntgewicht te meten"
        },
        {
                  "en": "By testing coin flexibility",
                  "es": "Probando flexibilidad de monedas",
                  "de": "Durch Prüfung der Münzflexibilität",
                  "nl": "Door muntflexibiliteit te testen"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mechanical drilling",
                  "es": "Perforación mecánica",
                  "de": "Mechanisches Bohren",
                  "nl": "Mechanisch boren"
        },
        {
                  "en": "Terahertz spectroscopy for subsurface imaging",
                  "es": "Espectroscopia de terahercios para imagen subsuperficial",
                  "de": "Terahertz-Spektroskopie für Untergrund-Bildgebung",
                  "nl": "Terahertz spectroscopie voor ondergrondse beeldvorming"
        },
        {
                  "en": "Physical sectioning",
                  "es": "Seccionamiento físico",
                  "de": "Physische Sektionierung",
                  "nl": "Fysieke doorsnede"
        },
        {
                  "en": "Chemical etching",
                  "es": "Grabado químico",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Largest ancient coin ever minted",
                  "es": "Moneda antigua más grande jamás acuñada",
                  "de": "Größte jemals geprägte antike Münze",
                  "nl": "Grootste antieke munt ooit geslagen"
        },
        {
                  "en": "Made entirely of platinum",
                  "es": "Hecha completamente de platino",
                  "de": "Vollständig aus Platin hergestellt",
                  "nl": "Volledig gemaakt van platina"
        },
        {
                  "en": "First Roman gold coin",
                  "es": "Primera moneda de oro romana",
                  "de": "Erste römische Goldmünze",
                  "nl": "Eerste Romeinse gouden munt"
        },
        {
                  "en": "Commemorates Caesar's assassination, one of history's most famous political murders",
                  "es": "Conmemora el asesinato de César, uno de los asesinatos políticos más famosos de la historia",
                  "de": "Gedenkt Caesars Ermordung, einen der berühmtesten politischen Morde der Geschichte",
                  "nl": "Herdenkt de moord op Caesar, een van de beroemdste politieke moorden uit de geschiedenis"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Made of pure gold instead of silver",
                  "es": "Hechas de oro puro en lugar de plata",
                  "de": "Aus reinem Gold statt Silber hergestellt",
                  "nl": "Gemaakt van puur goud in plaats van zilver"
        },
        {
                  "en": "Featured a misprint of the date",
                  "es": "Presentaban un error de impresión de la fecha",
                  "de": "Zeigten einen Druckfehler des Datums",
                  "nl": "Vertoonden een drukfout van de datum"
        },
        {
                  "en": "Largest US coins ever produced",
                  "es": "Monedas estadounidenses más grandes jamás producidas",
                  "de": "Größte jemals produzierte US-Münzen",
                  "nl": "Grootste Amerikaanse munten ooit geproduceerd"
        },
        {
                  "en": "Actually struck in the 1830s as diplomatic gifts, not 1804",
                  "es": "Realmente acuñadas en los años 1830 como regalos diplomáticos, no en 1804",
                  "de": "Tatsächlich in den 1830er Jahren als diplomatische Geschenke geprägt, nicht 1804",
                  "nl": "Daadwerkelijk geslagen in de jaren 1830 als diplomatieke geschenken, niet 1804"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Small bronze coin mentioned in the Bible, from Hasmonean period Judea",
                  "es": "Pequeña moneda de bronce mencionada en la Biblia, del período Hasmoneano de Judea",
                  "de": "Kleine Bronzemünze, die in der Bibel erwähnt wird, aus der hasmonäischen Periode Judäas",
                  "nl": "Kleine bronzen munt genoemd in de Bijbel, uit de Hasmoneïsche periode van Judea"
        },
        {
                  "en": "Coin used exclusively by Roman emperors",
                  "es": "Moneda usada exclusivamente por emperadores romanos",
                  "de": "Münze, die ausschließlich von römischen Kaisern verwendet wurde",
                  "nl": "Munt uitsluitend gebruikt door Romeinse keizers"
        },
        {
                  "en": "First gold coin mentioned in scripture",
                  "es": "Primera moneda de oro mencionada en las escrituras",
                  "de": "Erste in der Schrift erwähnte Goldmünze",
                  "nl": "Eerste gouden munt genoemd in de geschriften"
        },
        {
                  "en": "Largest ancient coin ever found",
                  "es": "Moneda antigua más grande jamás encontrada",
                  "de": "Größte jemals gefundene antike Münze",
                  "nl": "Grootste antieke munt ooit gevonden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Spanish trade coin",
                  "es": "Moneda comercial española",
                  "de": "Spanische Handelsmünze",
                  "nl": "Spaanse handelsmunt"
        },
        {
                  "en": "British colonial currency",
                  "es": "Moneda colonial británica",
                  "de": "Britische Kolonialwährung",
                  "nl": "Britse koloniale valuta"
        },
        {
                  "en": "French military token",
                  "es": "Ficha militar francesa",
                  "de": "Französischer Militär-Token",
                  "nl": "Franse militaire token"
        },
        {
                  "en": "First dollar-denominated coin proposed for the United States",
                  "es": "Primera moneda denominada en dólares propuesta para Estados Unidos",
                  "de": "Erste auf Dollar lautende Münze, die für die Vereinigten Staaten vorgeschlagen wurde",
                  "nl": "Eerste in dollars gedenomineerde munt voorgesteld voor de Verenigde Staten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Coins recovered from sunken ships, valued for provenance and historical context",
                  "es": "Monedas recuperadas de barcos hundidos, valoradas por procedencia y contexto histórico",
                  "de": "Münzen, die von gesunkenen Schiffen geborgen wurden, geschätzt für Herkunft und historischen Kontext",
                  "nl": "Munten geborgen van gezonken schepen, gewaardeerd om herkomst en historische context"
        },
        {
                  "en": "Naval payment certificates",
                  "es": "Certificados de pago naval",
                  "de": "Marine-Zahlungszertifikate",
                  "nl": "Marine betalingscertificaten"
        },
        {
                  "en": "Coins with ship designs",
                  "es": "Monedas con diseños de barcos",
                  "de": "Münzen mit Schiffsdesigns",
                  "nl": "Munten met scheepsontwerpen"
        },
        {
                  "en": "Commemorative maritime coins",
                  "es": "Monedas marítimas conmemorativas",
                  "de": "Maritime Gedenkmünzen",
                  "nl": "Maritieme herdenkingsmunten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "British colonial token",
                  "es": "Ficha colonial británica",
                  "de": "Britischer Kolonial-Token",
                  "nl": "Britse koloniale token"
        },
        {
                  "en": "Confederate war currency",
                  "es": "Moneda de guerra confederada",
                  "de": "Konföderierte Kriegswährung",
                  "nl": "Geconfedereerde oorlogsvaluta"
        },
        {
                  "en": "First official coin authorized by the United States Congress in 1787",
                  "es": "Primera moneda oficial autorizada por el Congreso de Estados Unidos en 1787",
                  "de": "Erste offizielle Münze, die 1787 vom US-Kongress autorisiert wurde",
                  "nl": "Eerste officiële munt geautoriseerd door het Amerikaanse Congres in 1787"
        },
        {
