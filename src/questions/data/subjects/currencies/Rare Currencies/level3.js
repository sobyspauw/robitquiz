    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Historical mint production",
                  "es": "Producción histórica de la casa de moneda",
                  "de": "Historische Münzproduktion",
                  "nl": "Historische muntproductie"
        },
        {
                  "en": "Auction sale results",
                  "es": "Resultados de ventas en subasta",
                  "de": "Auktionsverkaufsergebnisse",
                  "nl": "Veilingresultaten"
        },
        {
                  "en": "Number of coins graded at each level",
                  "es": "Número de monedas clasificadas en cada nivel",
                  "de": "Anzahl der Münzen, die auf jeder Stufe bewertet wurden",
                  "nl": "Aantal munten beoordeeld op elk niveau"
        },
        {
                  "en": "Market prices of rare coins",
                  "es": "Precios de mercado de monedas raras",
                  "de": "Marktpreise seltener Münzen",
                  "nl": "Marktprijzen van zeldzame munten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A coin with different metal composition",
                  "es": "Una moneda con diferente composición metálica",
                  "de": "Eine Münze mit unterschiedlicher Metallzusammensetzung",
                  "nl": "Een munt met verschillende metaalsamenstelling"
        },
        {
                  "en": "A coin with damage",
                  "es": "Una moneda con daños",
                  "de": "Eine beschädigte Münze",
                  "nl": "Een beschadigde munt"
        },
        {
                  "en": "A coin from a different mint",
                  "es": "Una moneda de una casa de moneda diferente",
                  "de": "Eine Münze aus einer anderen Münzstätte",
                  "nl": "Een munt van een andere munt"
        },
        {
                  "en": "A coin with distinct design differences from the standard issue",
                  "es": "Una moneda con diferencias de diseño distintas de la emisión estándar",
                  "de": "Eine Münze mit deutlichen Designunterschieden zur Standardausgabe",
                  "nl": "Een munt met verschillende ontwerpverschillen van de standaarduitgifte"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To determine market prices",
                  "es": "Para determinar precios de mercado",
                  "de": "Um Marktpreise zu bestimmen",
                  "nl": "Om marktprijzen te bepalen"
        },
        {
                  "en": "To compete in building the finest graded sets",
                  "es": "Para competir en la construcción de los mejores conjuntos clasificados",
                  "de": "Um beim Aufbau der besten bewerteten Sets zu konkurrieren",
                  "nl": "Om te concurreren in het bouwen van de beste beoordeelde sets"
        },
        {
                  "en": "To track mint production numbers",
                  "es": "Para rastrear los números de producción de la casa de moneda",
                  "de": "Um Münzproduktionszahlen zu verfolgen",
                  "nl": "Om muntproductienummers bij te houden"
        },
        {
                  "en": "To authenticate rare coins",
                  "es": "Para autenticar monedas raras",
                  "de": "Um seltene Münzen zu authentifizieren",
                  "nl": "Om zeldzame munten te authenticeren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Rise of third-party grading services",
                  "es": "Auge de los servicios de clasificación de terceros",
                  "de": "Aufstieg der Drittanbieter-Bewertungsdienste",
                  "nl": "Opkomst van derde partij beoordelingsdiensten"
        },
        {
                  "en": "Government coin buyback programs",
                  "es": "Programas gubernamentales de recompra de monedas",
                  "de": "Staatliche Münzrückkaufprogramme",
                  "nl": "Overheids munt terugkoopprogramma's"
        },
        {
                  "en": "Decrease in silver prices",
                  "es": "Disminución en los precios de la plata",
                  "de": "Rückgang der Silberpreise",
                  "nl": "Daling van zilverprijzen"
        },
        {
                  "en": "Elimination of gold standard",
                  "es": "Eliminación del patrón oro",
                  "de": "Abschaffung des Goldstandards",
                  "nl": "Afschaffing van de goudstandaard"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Premium Quality - exceptional for the grade",
                  "es": "Calidad Premium - excepcional para el grado",
                  "de": "Premium-Qualität - außergewöhnlich für den Grad",
                  "nl": "Premium Kwaliteit - uitzonderlijk voor de graad"
        },
        {
                  "en": "Poor Quality - below grade standards",
                  "es": "Calidad Pobre - por debajo de los estándares de grado",
                  "de": "Schlechte Qualität - unter Gradstandards",
                  "nl": "Slechte Kwaliteit - onder graadstandaarden"
        },
        {
                  "en": "Proof Quality - mirror-like finish",
                  "es": "Calidad Proof - acabado tipo espejo",
                  "de": "Proof-Qualität - spiegelähnlicher Abschluss",
                  "nl": "Proof Kwaliteit - spiegelachtige afwerking"
        },
        {
                  "en": "Production Quantity - mintage information",
                  "es": "Cantidad de Producción - información de acuñación",
                  "de": "Produktionsmenge - Prägeinformationen",
                  "nl": "Productie Hoeveelheid - muntslag informatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The most common coin in a series",
                  "es": "La moneda más común en una serie",
                  "de": "Die häufigste Münze in einer Serie",
                  "nl": "De meest voorkomende munt in een serie"
        },
        {
                  "en": "The first coin minted in a year",
                  "es": "La primera moneda acuñada en un año",
                  "de": "Die erste Münze, die in einem Jahr geprägt wurde",
                  "nl": "De eerste munt geslagen in een jaar"
        },
        {
                  "en": "A coin with the highest mintage",
                  "es": "Una moneda con la mayor acuñación",
                  "de": "Eine Münze mit der höchsten Auflage",
                  "nl": "Een munt met de hoogste oplage"
        },
        {
                  "en": "A coin that ranks among the highest graded examples",
                  "es": "Una moneda que se clasifica entre los ejemplos de mayor grado",
                  "de": "Eine Münze, die zu den höchstbewerteten Exemplaren gehört",
                  "nl": "Een munt die behoort tot de hoogst beoordeelde exemplaren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The coin is damaged",
                  "es": "La moneda está dañada",
                  "de": "Die Münze ist beschädigt",
                  "nl": "De munt is beschadigd"
        },
        {
                  "en": "The coin meets or exceeds grade standards",
                  "es": "La moneda cumple o supera los estándares de grado",
                  "de": "Die Münze erfüllt oder übertrifft Gradstandards",
                  "nl": "De munt voldoet aan of overtreft graadstandaarden"
        },
        {
                  "en": "The coin has been cleaned",
                  "es": "La moneda ha sido limpiada",
                  "de": "Die Münze wurde gereinigt",
                  "nl": "De munt is schoongemaakt"
        },
        {
                  "en": "The coin is counterfeit",
                  "es": "La moneda es falsa",
                  "de": "Die Münze ist gefälscht",
                  "nl": "De munt is vervalst"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It determines the coin's metal content",
                  "es": "Determina el contenido metálico de la moneda",
                  "de": "Es bestimmt den Metallgehalt der Münze",
                  "nl": "Het bepaalt het metaalgehalte van de munt"
        },
        {
                  "en": "It indicates the coin's age",
                  "es": "Indica la edad de la moneda",
                  "de": "Es zeigt das Alter der Münze an",
                  "nl": "Het geeft de leeftijd van de munt aan"
        },
        {
                  "en": "It affects the coin's overall attractiveness and market value",
                  "es": "Afecta el atractivo general de la moneda y el valor de mercado",
                  "de": "Es beeinflusst die Gesamtattraktivität und den Marktwert der Münze",
                  "nl": "Het beïnvloedt de algehele aantrekkelijkskracht en marktwaarde van de munt"
        },
        {
                  "en": "It shows the mint of origin",
                  "es": "Muestra la casa de moneda de origen",
                  "de": "Es zeigt die Herkunftsmünzstätte",
                  "nl": "Het toont de munt van herkomst"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Additional cost for coin registration",
                  "es": "Costo adicional por registro de monedas",
                  "de": "Zusätzliche Kosten für die Münzregistrierung",
                  "nl": "Extra kosten voor muntregistratie"
        },
        {
                  "en": "Higher prices paid for coins needed for competitive registry sets",
                  "es": "Precios más altos pagados por monedas necesarias para conjuntos de registro competitivos",
                  "de": "Höhere Preise für Münzen, die für wettbewerbsfähige Registry-Sets benötigt werden",
                  "nl": "Hogere prijzen betaald voor munten die nodig zijn voor competitieve registry sets"
        },
        {
                  "en": "Government tax on rare coins",
                  "es": "Impuesto gubernamental sobre monedas raras",
                  "de": "Staatliche Steuer auf seltene Münzen",
                  "nl": "Overheidsbelasting op zeldzame munten"
        },
        {
                  "en": "Discount for bulk purchases",
                  "es": "Descuento por compras al por mayor",
                  "de": "Rabatt für Großeinkäufe",
                  "nl": "Korting voor bulk aankopen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mint State with additional authentication",
                  "es": "Estado de Casa de Moneda con autenticación adicional",
                  "de": "Prägefrisch mit zusätzlicher Authentifizierung",
                  "nl": "Mint State met extra authenticatie"
        },
        {
                  "en": "Mint State from a premium mint facility",
                  "es": "Estado de Casa de Moneda de una instalación de acuñación premium",
                  "de": "Prägefrisch aus einer Premium-Münzstätte",
                  "nl": "Mint State van een premium muntfaciliteit"
        },
        {
                  "en": "Mint State quality that borders on the next higher grade",
                  "es": "Calidad de Estado de Casa de Moneda que bordea el siguiente grado más alto",
                  "de": "Prägefrisch-Qualität, die an den nächsthöheren Grad grenzt",
                  "nl": "Mint State kwaliteit die grenst aan de volgende hogere graad"
        },
        {
                  "en": "Mint State with extra silver content",
                  "es": "Estado de Casa de Moneda con contenido extra de plata",
                  "de": "Prägefrisch mit extra Silbergehalt",
                  "nl": "Mint State met extra zilvergehalte"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Rarity affected by market conditions",
                  "es": "Rareza afectada por condiciones del mercado",
                  "de": "Seltenheit, die von Marktbedingungen beeinflusst wird",
                  "nl": "Zeldzaamheid beïnvloed door marktomstandigheden"
        },
        {
                  "en": "Rarity that depends on specific grade levels",
                  "es": "Rareza que depende de niveles de grado específicos",
                  "de": "Seltenheit, die von spezifischen Gradstufen abhängt",
                  "nl": "Zeldzaamheid die afhangt van specifieke graadniveaus"
        },
        {
                  "en": "Rarity based on storage conditions",
                  "es": "Rareza basada en condiciones de almacenamiento",
                  "de": "Seltenheit basierend auf Lagerbedingungen",
                  "nl": "Zeldzaamheid gebaseerd op opslagcondities"
        },
        {
                  "en": "Rarity due to conditional sales",
                  "es": "Rareza debido a ventas condicionales",
                  "de": "Seltenheit aufgrund bedingter Verkäufe",
                  "nl": "Zeldzaamheid vanwege voorwaardelijke verkopen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They set minimum price standards",
                  "es": "Establecen estándares de precios mínimos",
                  "de": "Sie setzen Mindestpreisstandards",
                  "nl": "Ze stellen minimumprijsstandaarden vast"
        },
        {
                  "en": "They command the highest premiums and set market records",
                  "es": "Tienen las primas más altas y establecen récords de mercado",
                  "de": "Sie erzielen die höchsten Aufschläge und setzen Marktrekorde",
                  "nl": "Ze behalen de hoogste premiums en vestigen marktrecords"
        },
        {
                  "en": "They represent average market values",
                  "es": "Representan valores promedio del mercado",
                  "de": "Sie repräsentieren durchschnittliche Marktwerte",
                  "nl": "Ze vertegenwoordigen gemiddelde marktwaarden"
        },
        {
                  "en": "They are used for insurance purposes only",
                  "es": "Se usan solo para propósitos de seguro",
                  "de": "Sie werden nur für Versicherungszwecke verwendet",
                  "nl": "Ze worden alleen gebruikt voor verzekeringsdoeleinden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They have verified metal purity",
                  "es": "Tienen pureza metálica verificada",
                  "de": "Sie haben verifizierte Metallreinheit",
                  "nl": "Ze hebben geverifieerde metaalzuiverheid"
        },
        {
                  "en": "They come from government auctions",
                  "es": "Provienen de subastas gubernamentales",
                  "de": "Sie stammen aus Regierungsauktionen",
                  "nl": "Ze komen van overheidsveiling"
        },
        {
                  "en": "They are certified as investment grade",
                  "es": "Están certificadas como grado de inversión",
                  "de": "Sie sind als Anlagequalität zertifiziert",
                  "nl": "Ze zijn gecertificeerd als beleggingskwaliteit"
        },
        {
                  "en": "They have documented ownership history",
                  "es": "Tienen historia de propiedad documentada",
                  "de": "Sie haben dokumentierte Besitzgeschichte",
                  "nl": "Ze hebben gedocumenteerde eigendomsgeschiedenis"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Decreased interest in modern coins",
                  "es": "Disminución del interés en monedas modernas",
                  "de": "Verringertes Interesse an modernen Münzen",
                  "nl": "Verminderde interesse in moderne munten"
        },
        {
                  "en": "High-grade examples being rare despite high mintages",
                  "es": "Ejemplos de alto grado siendo raros a pesar de altas acuñaciones",
                  "de": "Hochgradige Exemplare sind selten trotz hoher Auflagen",
                  "nl": "Hoogwaardige exemplaren zijn zeldzaam ondanks hoge oplagen"
        },
        {
                  "en": "Limited access to modern minting facilities",
                  "es": "Acceso limitado a instalaciones de acuñación modernas",
                  "de": "Begrenzter Zugang zu modernen Prägeanlagen",
                  "nl": "Beperkte toegang tot moderne muntfaciliteiten"
        },
        {
                  "en": "Government restrictions on collecting",
                  "es": "Restricciones gubernamentales sobre la colección",
                  "de": "Regierungsbeschränkungen beim Sammeln",
                  "nl": "Overheidsbeperkingen op verzamelen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To upgrade coin storage holders",
                  "es": "Para actualizar los portadores de almacenamiento de monedas",
                  "de": "Um Münzaufbewahrungshalter zu aktualisieren",
                  "nl": "Om muntopslaghouders te upgraden"
        },
        {
                  "en": "To cross-reference market prices",
                  "es": "Para hacer referencias cruzadas de precios de mercado",
                  "de": "Um Marktpreise zu überkreuzen",
                  "nl": "Om marktprijzen kruiselings te refereren"
        },
        {
                  "en": "To move coins from one grading service to another",
                  "es": "Para mover monedas de un servicio de clasificación a otro",
                  "de": "Um Münzen von einem Bewertungsdienst zu einem anderen zu bewegen",
                  "nl": "Om munten van de ene beoordelingsdienst naar de andere te verplaatsen"
        },
        {
                  "en": "To transfer coins between different collections",
                  "es": "Para transferir monedas entre diferentes colecciones",
                  "de": "Um Münzen zwischen verschiedenen Sammlungen zu übertragen",
                  "nl": "Om munten tussen verschillende collecties over te dragen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trading through closed auctions",
                  "es": "Comercio a través de subastas cerradas",
                  "de": "Handel durch geschlossene Auktionen",
                  "nl": "Handel door gesloten veilingen"
        },
        {
                  "en": "Trading with hidden identities",
                  "es": "Comercio con identidades ocultas",
                  "de": "Handel mit versteckten Identitäten",
                  "nl": "Handel met verborgen identiteiten"
        },
        {
                  "en": "Trading based on photographs only",
                  "es": "Comercio basado solo en fotografías",
                  "de": "Handel basierend nur auf Fotografien",
                  "nl": "Handel gebaseerd alleen op foto's"
        },
        {
                  "en": "Trading based on grade and description without seeing the coin",
                  "es": "Comercio basado en grado y descripción sin ver la moneda",
                  "de": "Handel basierend auf Grad und Beschreibung ohne die Münze zu sehen",
                  "nl": "Handel gebaseerd op graad en beschrijving zonder de munt te zien"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Increased market access and price transparency",
                  "es": "Mayor acceso al mercado y transparencia de precios",
                  "de": "Erhöhter Marktzugang und Preistransparenz",
                  "nl": "Verhoogde markttoegang en prijstransparantie"
        },
        {
                  "en": "Decreased market transparency",
                  "es": "Disminución de la transparencia del mercado",
                  "de": "Verringerte Markttransparenz",
                  "nl": "Verminderde markttransparantie"
        },
        {
                  "en": "Reduced coin collecting interest",
                  "es": "Redujo el interés en la colección de monedas",
                  "de": "Reduzierte das Interesse am Münzsammeln",
                  "nl": "Verminderde interesse in muntenverzamelen"
        },
        {
                  "en": "Eliminated the need for coin shows",
                  "es": "Eliminó la necesidad de espectáculos de monedas",
                  "de": "Beseitigte die Notwendigkeit für Münzshows",
                  "nl": "Elimineerde de behoefte aan muntshows"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Seasonal price fluctuations",
                  "es": "Fluctuaciones estacionales de precios",
                  "de": "Saisonale Preisschwankungen",
                  "nl": "Seizoensgebonden prijsschommelingen"
        },
        {
                  "en": "Different price levels for the same coin grade",
                  "es": "Diferentes niveles de precios para el mismo grado de moneda",
                  "de": "Verschiedene Preisstufen für denselben Münzgrad",
                  "nl": "Verschillende prijsniveaus voor dezelfde muntgraad"
        },
        {
                  "en": "Hierarchical classification of coin rarity",
                  "es": "Clasificación jerárquica de la rareza de monedas",
                  "de": "Hierarchische Klassifizierung der Münzseltenheit",
                  "nl": "Hiërarchische classificatie van muntzeldzaamheid"
        },
        {
                  "en": "Regional market variations",
                  "es": "Variaciones regionales del mercado",
                  "de": "Regionale Marktvariationen",
                  "nl": "Regionale marktvariaties"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Collectors prefer specific coin dealers",
                  "es": "Los coleccionistas prefieren distribuidores específicos de monedas",
                  "de": "Sammler bevorzugen bestimmte Münzhändler",
                  "nl": "Verzamelaars geven de voorkeur aan specifieke munthandelaren"
        },
        {
                  "en": "Collectors prefer certain metal types",
                  "es": "Los coleccionistas prefieren ciertos tipos de metal",
                  "de": "Sammler bevorzugen bestimmte Metallarten",
                  "nl": "Verzamelaars geven de voorkeur aan bepaalde metaaltypes"
        },
        {
                  "en": "Collectors show preference for certain grading services",
                  "es": "Los coleccionistas muestran preferencia por ciertos servicios de clasificación",
                  "de": "Sammler zeigen Präferenz für bestimmte Bewertungsdienste",
                  "nl": "Verzamelaars tonen voorkeur voor bepaalde beoordelingsdiensten"
        },
        {
                  "en": "Collectors prefer specific mint facilities",
                  "es": "Los coleccionistas prefieren instalaciones de acuñación específicas",
                  "de": "Sammler bevorzugen bestimmte Münzstätten",
                  "nl": "Verzamelaars geven de voorkeur aan specifieke muntfaciliteiten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Replaced the Euro in 2002",
                  "es": "Reemplazó al Euro en 2002",
                  "de": "Ersetzte den Euro 2002",
                  "nl": "Verving de Euro in 2002"
        },
        {
                  "en": "Modern digital currency",
                  "es": "Moneda digital moderna",
                  "de": "Moderne digitale Währung",
                  "nl": "Moderne digitale valuta"
        },
        {
                  "en": "Only used within Spain",
                  "es": "Solo usado dentro de España",
                  "de": "Nur in Spanien verwendet",
                  "nl": "Alleen in Spanje gebruikt"
        },
        {
                  "en": "First truly global currency, used on multiple continents for centuries",
                  "es": "Primera moneda verdaderamente global, usada en múltiples continentes durante siglos",
                  "de": "Erste wirklich globale Währung, jahrhundertelang auf mehreren Kontinenten verwendet",
                  "nl": "Eerste echt mondiale valuta, eeuwenlang gebruikt op meerdere continenten"
        }
        ],
        correct: 3,
        explanation: {
