    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "The condition of a coin's surface",
                  "es": "La condición de la superficie de una moneda",
                  "de": "Der Zustand einer Münzoberfläche",
                  "nl": "De conditie van een muntoppervlak"
        },
        {
                  "en": "The metal composition of the die",
                  "es": "La composición metálica del troquel",
                  "de": "Die Metallzusammensetzung des Stempels",
                  "nl": "De metaalsamenstelling van de stempel"
        },
        {
                  "en": "The political region where a coin was minted",
                  "es": "La región política donde se acuñó una moneda",
                  "de": "Die politische Region, in der eine Münze geprägt wurde",
                  "nl": "De politieke regio waar een munt werd geslagen"
        },
        {
                  "en": "A specific stage in a die's deterioration showing particular characteristics",
                  "es": "Una etapa específica en el deterioro de un troquel mostrando características particulares",
                  "de": "Ein spezifisches Stadium der Verschlechterung eines Stempels mit besonderen Merkmalen",
                  "nl": "Een specifiek stadium in de achteruitgang van een stempel dat bepaalde kenmerken toont"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The combination of a specific obverse die with a specific reverse die",
                  "es": "La combinación de un troquel anverso específico con un troquel reverso específico",
                  "de": "Die Kombination eines spezifischen Vorderseiten-Stempels mit einem spezifischen Rückseiten-Stempel",
                  "nl": "De combinatie van een specifieke voorzijde stempel met een specifieke achterzijde stempel"
        },
        {
                  "en": "Two dies made from the same master hub",
                  "es": "Dos troqueles hechos del mismo cubo maestro",
                  "de": "Zwei Stempel aus demselben Hauptnabe",
                  "nl": "Twee stempels gemaakt van dezelfde hoofdnaaf"
        },
        {
                  "en": "Dies used in consecutive years",
                  "es": "Troqueles usados en años consecutivos",
                  "de": "Stempel, die in aufeinanderfolgenden Jahren verwendet wurden",
                  "nl": "Stempels gebruikt in opeenvolgende jaren"
        },
        {
                  "en": "The physical joining of two die pieces",
                  "es": "La unión física de dos piezas de troquel",
                  "de": "Die physische Verbindung zweier Stempelteile",
                  "nl": "De fysieke verbinding van twee stempeldelen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A raised line on coins caused by a crack in the die, which can increase rarity and value",
                  "es": "Una línea elevada en monedas causada por una grieta en el troquel, que puede aumentar la rareza y el valor",
                  "de": "Eine erhöhte Linie auf Münzen, verursacht durch einen Riss im Stempel, die Seltenheit und Wert erhöhen kann",
                  "nl": "Een verhoogde lijn op munten veroorzaakt door een scheur in de stempel, die zeldzaamheid en waarde kan verhogen"
        },
        {
                  "en": "A cleaning mark from improper coin care",
                  "es": "Una marca de limpieza por cuidado inadecuado de la moneda",
                  "de": "Eine Reinigungsmarke durch unsachgemäße Münzpflege",
                  "nl": "Een schoonmaak spoor van onjuiste muntverzorging"
        },
        {
                  "en": "A natural metal fault in the planchet",
                  "es": "Una falla natural del metal en el cospel",
                  "de": "Ein natürlicher Metallfehler im Rohling",
                  "nl": "Een natuurlijk metaalfout in de plaatje"
        },
        {
                  "en": "A defect that always decreases value",
                  "es": "Un defecto que siempre disminuye el valor",
                  "de": "Ein Defekt, der immer den Wert mindert",
                  "nl": "Een defect dat altijd de waarde vermindert"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Impressions from opposite die striking the coin surface without a planchet",
                  "es": "Impresiones del troquel opuesto golpeando la superficie de la moneda sin un cospel",
                  "de": "Abdrücke vom gegenüberliegenden Stempel, der die Münzoberfläche ohne Rohling trifft",
                  "nl": "Indrukken van tegenovergestelde stempel die het muntoppervlak raakt zonder plaatje"
        },
        {
                  "en": "Damage from improper storage",
                  "es": "Daño por almacenamiento inadecuado",
                  "de": "Schäden durch unsachgemäße Lagerung",
                  "nl": "Schade door onjuiste opslag"
        },
        {
                  "en": "Scratches from cleaning",
                  "es": "Arañazos por limpieza",
                  "de": "Kratzer durch Reinigung",
                  "nl": "Krassen van schoonmaken"
        },
        {
                  "en": "Natural metal stress patterns",
                  "es": "Patrones naturales de estrés del metal",
                  "de": "Natürliche Metallstressmuster",
                  "nl": "Natuurlijke metaal stress patronen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The rim of a coin",
                  "es": "El borde de una moneda",
                  "de": "Der Rand einer Münze",
                  "nl": "De rand van een munt"
        },
        {
                  "en": "A storage container for finished coins",
                  "es": "Un contenedor de almacenamiento para monedas terminadas",
                  "de": "Ein Lagerbehälter für fertige Münzen",
                  "nl": "Een opslagcontainer voor afgewerkte munten"
        },
        {
                  "en": "A master die with raised design used to create working dies",
                  "es": "Un troquel maestro con diseño en relieve usado para crear troqueles de trabajo",
                  "de": "Ein Hauptstempel mit erhabenem Design zur Erstellung von Arbeitsstempeln",
                  "nl": "Een hoofdstempel met verhoogd ontwerp gebruikt om werkende stempels te maken"
        },
        {
                  "en": "The central machinery that operates the mint",
                  "es": "La maquinaria central que opera la casa de moneda",
                  "de": "Die zentrale Maschinerie, die die Münzstätte betreibt",
                  "nl": "De centrale machinerie die de munt bedient"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Military coins used in occupied territories",
                  "es": "Monedas militares usadas en territorios ocupados",
                  "de": "Militärmünzen, die in besetzten Gebieten verwendet wurden",
                  "nl": "Militaire munten gebruikt in bezette gebieden"
        },
        {
                  "en": "Commemorative coins for territorial anniversaries",
                  "es": "Monedas conmemorativas para aniversarios territoriales",
                  "de": "Gedenkmünzen für Territoriumsjubiläen",
                  "nl": "Herdenkingsmunten voor territoriale jubilea"
        },
        {
                  "en": "Coins minted by federal territories before statehood",
                  "es": "Monedas acuñadas por territorios federales antes de la estadidad",
                  "de": "Münzen, die von Bundesterritorien vor der Staatlichkeit geprägt wurden",
                  "nl": "Munten geslagen door federale territoria voor staatschap"
        },
        {
                  "en": "Private gold coins issued in western regions during gold rushes",
                  "es": "Monedas de oro privadas emitidas en regiones occidentales durante las fiebres del oro",
                  "de": "Private Goldmünzen, die in westlichen Regionen während Goldräuschen ausgegeben wurden",
                  "nl": "Particuliere gouden munten uitgegeven in westelijke regio's tijdens goudrushes"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The alignment between obverse and reverse designs, measured in degrees",
                  "es": "La alineación entre diseños anverso y reverso, medida en grados",
                  "de": "Die Ausrichtung zwischen Vorder- und Rückseitendesigns, gemessen in Grad",
                  "nl": "De uitlijning tussen voorzijde en achterzijde ontwerpen, gemeten in graden"
        },
        {
                  "en": "The frequency of die replacement",
                  "es": "La frecuencia de reemplazo de troquel",
                  "de": "Die Häufigkeit des Stempelaustauschs",
                  "nl": "De frequentie van stempel vervanging"
        },
        {
                  "en": "The speed at which dies operate during minting",
                  "es": "La velocidad a la que operan los troqueles durante la acuñación",
                  "de": "Die Geschwindigkeit, mit der Stempel während der Prägung arbeiten",
                  "nl": "De snelheid waarmee stempels werken tijdens het slaan"
        },
        {
                  "en": "The wear pattern on a die's surface",
                  "es": "El patrón de desgaste en la superficie de un troquel",
                  "de": "Das Abnutzungsmuster auf einer Stempeloberfläche",
                  "nl": "Het slijtageppatroon op een stempeloppervlak"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A perfect example used as a grading standard",
                  "es": "Un ejemplo perfecto usado como estándar de clasificación",
                  "de": "Ein perfektes Beispiel, das als Bewertungsstandard verwendet wird",
                  "nl": "Een perfect voorbeeld gebruikt als beoordelingsstandaard"
        },
        {
                  "en": "A coin with consistent striking characteristics",
                  "es": "Una moneda con características de acuñación consistentes",
                  "de": "Eine Münze mit konsistenten Prägemerkmalen",
                  "nl": "Een munt met consistente slagkenmerken"
        },
        {
                  "en": "An experimental or proposed design that was not adopted for regular production",
                  "es": "Un diseño experimental o propuesto que no fue adoptado para producción regular",
                  "de": "Ein experimentelles oder vorgeschlagenes Design, das nicht für die reguläre Produktion übernommen wurde",
                  "nl": "Een experimenteel of voorgesteld ontwerp dat niet werd aangenomen voor reguliere productie"
        },
        {
                  "en": "A coin showing repetitive design elements",
                  "es": "Una moneda mostrando elementos de diseño repetitivos",
                  "de": "Eine Münze mit repetitiven Designelementen",
                  "nl": "Een munt die repetitieve ontwerpelementen toont"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The age of the metal",
                  "es": "La edad del metal",
                  "de": "Das Alter des Metalls",
                  "nl": "De leeftijd van het metaal"
        },
        {
                  "en": "The coin's market value",
                  "es": "El valor de mercado de la moneda",
                  "de": "Der Marktwert der Münze",
                  "nl": "De marktwaarde van de munt"
        },
        {
                  "en": "How metal behaved during the striking process, revealing manufacturing methods",
                  "es": "Cómo se comportó el metal durante el proceso de acuñación, revelando métodos de fabricación",
                  "de": "Wie sich Metall während des Prägeprozesses verhielt und Herstellungsmethoden aufdeckt",
                  "nl": "Hoe metaal zich gedroeg tijdens het slagproces, onthullend productie methoden"
        },
        {
                  "en": "Chemical composition",
                  "es": "Composición química",
                  "de": "Chemische Zusammensetzung",
                  "nl": "Chemische samenstelling"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Protecting dies from corrosion",
                  "es": "Proteger troqueles de la corrosión",
                  "de": "Stempel vor Korrosion schützen",
                  "nl": "Stempels beschermen tegen corrosie"
        },
        {
                  "en": "Polishing dies to remove surface marks, creating reflective fields on coins",
                  "es": "Pulir troqueles para remover marcas superficiales, creando campos reflectivos en monedas",
                  "de": "Stempel polieren, um Oberflächenspuren zu entfernen und reflektierende Felder auf Münzen zu schaffen",
                  "nl": "Stempels polijsten om oppervlaktesporen te verwijderen, reflecterende velden op munten creërend"
        },
        {
                  "en": "Cleaning coins after striking",
                  "es": "Limpiar monedas después de la acuñación",
                  "de": "Münzen nach dem Prägen reinigen",
                  "nl": "Munten schoonmaken na het slaan"
        },
        {
                  "en": "Adding shine to finished coins",
                  "es": "Añadir brillo a monedas terminadas",
                  "de": "Glanz zu fertigen Münzen hinzufügen",
                  "nl": "Glans toevoegen aan afgewerkte munten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Metal content",
                  "es": "Contenido metálico",
                  "de": "Metallgehalt",
                  "nl": "Metaalinhoud"
        },
        {
                  "en": "Size of the coin",
                  "es": "Tamaño de la moneda",
                  "de": "Größe der Münze",
                  "nl": "Grootte van de munt"
        },
        {
                  "en": "Significance and collectibility of the variety difference",
                  "es": "Importancia y coleccionabilidad de la diferencia de variedad",
                  "de": "Bedeutung und Sammelbarkeit des Varietätsunterschieds",
                  "nl": "Betekenis en verzamelbaarheid van het variëteitverschil"
        },
        {
                  "en": "Age of the variety",
                  "es": "Edad de la variedad",
                  "de": "Alter der Variante",
                  "nl": "Leeftijd van de variëteit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The force applied during striking, affecting detail sharpness and relief height",
                  "es": "La fuerza aplicada durante la acuñación, afectando la nitidez del detalle y la altura del relieve",
                  "de": "Die während des Prägens angewendete Kraft, die Detailschärfe und Reliefhöhe beeinflusst",
                  "nl": "De kracht toegepast tijdens het slaan, beïnvloedend detail scherpte en reliëf hoogte"
        },
        {
                  "en": "The alignment of the dies",
                  "es": "La alineación de los troqueles",
                  "de": "Die Ausrichtung der Stempel",
                  "nl": "De uitlijning van de stempels"
        },
        {
                  "en": "The temperature during minting",
                  "es": "La temperatura durante la acuñación",
                  "de": "Die Temperatur während der Prägung",
                  "nl": "De temperatuur tijdens het slaan"
        },
        {
                  "en": "The speed of die movement",
                  "es": "La velocidad del movimiento del troquel",
                  "de": "Die Geschwindigkeit der Stempelbewegung",
                  "nl": "De snelheid van stempelbeweging"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Natural metal grain patterns",
                  "es": "Patrones naturales de grano del metal",
                  "de": "Natürliche Metallkornmuster",
                  "nl": "Natuurlijke metaal korrel patronen"
        },
        {
                  "en": "File marks made to reduce planchet weight to legal standard",
                  "es": "Marcas de lima hechas para reducir el peso del cospel al estándar legal",
                  "de": "Feilspuren zur Reduzierung des Rohlinggewichts auf den gesetzlichen Standard",
                  "nl": "Vijlsporen gemaakt om plaatjegewicht te verminderen tot wettelijke standaard"
        },
        {
                  "en": "Scratches from cleaning",
                  "es": "Arañazos por limpieza",
        ...
        {
                  "en": "Marks from improper storage",
                  "es": "Marcas por almacenamiento inadecuado",
                  "de": "Spuren durch unsachgemäße Lagerung",
                  "nl": "Sporen van onjuiste opslag"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A practice coin for new workers",
                  "es": "Una moneda de práctica para nuevos trabajadores",
                  "de": "Eine Übungsmünze für neue Arbeiter",
                  "nl": "Een oefenmunt voor nieuwe werknemers"
        },
        {
                  "en": "A coin with legal issues",
                  "es": "Una moneda con problemas legales",
                  "de": "Eine Münze mit rechtlichen Problemen",
                  "nl": "Een munt met juridische problemen"
        },
        {
                  "en": "A coin struck in error",
                  "es": "Una moneda acuñada por error",
                  "de": "Eine fehlerhaft geprägte Münze",
                  "nl": "Een foutief geslagen munt"
        },
        {
                  "en": "A coin struck to test dies, equipment, or striking parameters",
                  "es": "Una moneda acuñada para probar troqueles, equipo o parámetros de acuñación",
                  "de": "Eine Münze, die zur Prüfung von Stempeln, Ausrüstung oder Prägeparametern geprägt wurde",
                  "nl": "Een munt geslagen om stempels, apparatuur of slagparameters te testen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Market value fluctuations",
                  "es": "Fluctuaciones del valor de mercado",
                  "de": "Marktwertsschwankungen",
                  "nl": "Marktwaarde schommelingen"
        },
        {
                  "en": "Chronological sequence of striking and relative rarity of different die states",
                  "es": "Secuencia cronológica de acuñación y rareza relativa de diferentes estados de troquel",
                  "de": "Chronologische Sequenz des Prägens und relative Seltenheit verschiedener Stempelzustände",
                  "nl": "Chronologische volgorde van slaan en relatieve zeldzaamheid van verschillende stempel staten"
        },
        {
                  "en": "Metal composition changes",
                  "es": "Cambios en la composición metálica",
                  "de": "Änderungen in der Metallzusammensetzung",
                  "nl": "Metaalsamenstelling veranderingen"
        },
        {
                  "en": "Only the age of the dies",
                  "es": "Solo la edad de los troqueles",
                  "de": "Nur das Alter der Stempel",
                  "nl": "Alleen de leeftijd van de stempels"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The metal content variations",
                  "es": "Las variaciones en el contenido metálico",
                  "de": "Die Variationen im Metallgehalt",
                  "nl": "De metaalinhoud variaties"
        },
        {
                  "en": "The chronological order of die production and use",
                  "es": "El orden cronológico de producción y uso de troqueles",
                  "de": "Die chronologische Reihenfolge der Stempelproduktion und -verwendung",
                  "nl": "De chronologische volgorde van stempel productie en gebruik"
        },
        {
                  "en": "The geographic distribution pattern",
                  "es": "El patrón de distribución geográfica",
                  "de": "Das geografische Verteilungsmuster",
                  "nl": "Het geografische verspreidingspatroon"
        },
        {
                  "en": "The order in which coins were released to the public",
                  "es": "El orden en el que las monedas fueron liberadas al público",
                  "de": "Die Reihenfolge, in der Münzen an die Öffentlichkeit ausgegeben wurden",
                  "nl": "De volgorde waarin munten werden uitgegeven aan het publiek"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Letters that appear backwards or mirror-image",
                  "es": "Letras que aparecen al revés o en imagen espejo",
                  "de": "Buchstaben, die rückwärts oder spiegelbildlich erscheinen",
                  "nl": "Letters die achteruit of spiegelbeeld verschijnen"
        },
        {
                  "en": "Letters moving from right to left",
                  "es": "Letras moviéndose de derecha a izquierda",
                  "de": "Buchstaben, die von rechts nach links verlaufen",
                  "nl": "Letters bewegend van rechts naar links"
        },
        {
                  "en": "Deteriorated letter forms",
                  "es": "Formas de letras deterioradas",
                  "de": "Verschlechterte Buchstabenformen",
                  "nl": "Verslechterde lettervormen"
        },
        {
                  "en": "Old-fashioned letter styles",
                  "es": "Estilos de letras anticuados",
                  "de": "Altmodische Buchstabenstile",
                  "nl": "Ouderwetse letterstijlen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Espectroscopia Raman",
                  "de": "Raman-Spektroskopie",
                  "nl": "Raman spectroscopie"
        },
        {
                  "en": "Carbon dating",
        ...
        },
        {
                  ...
                  "nl": "Magnetische resonantie beeldvorming"
        },
        {
                  "en": "DNA analysis",
                  "es": "Análisis de ADN",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "First silver dollar issued by the US federal government in 1794",
                  "es": "Primer dólar de plata emitido por el gobierno federal de EE.UU. en 1794",
                  "de": "Erster Silberdollar, der 1794 von der US-Bundesregierung ausgegeben wurde",
                  "nl": "Eerste zilveren dollar uitgegeven door de Amerikaanse federale overheid in 1794"
        },
        {
                  "en": "Ancient Greek currency",
                  "es": "Moneda griega antigua",
                  "de": "Antike griechische Währung",
                  "nl": "Antieke Griekse valuta"
        },
        {
                  "en": "British colonial coin",
                  "es": "Moneda colonial británica",
                  "de": "Britische Kolonialmünze",
                  "nl": "Britse koloniale munt"
        },
        {
                  "en": "French revolutionary currency",
                  "es": "Moneda revolucionaria francesa",
                  "de": "Französische Revolutionswährung",
                  "nl": "Franse revolutionaire valuta"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Made from a rare metal",
                  "es": "Hechas de un metal raro",
                  "de": "Aus einem seltenen Metall hergestellt",
                  "nl": "Gemaakt van een zeldzaam metaal"
        },
        {
                  "en": "Only one was ever minted",
                  "es": "Solo se acuñó una",
                  "de": "Es wurde nur eine geprägt",
                  "nl": "Er werd maar één geslagen"
        },
        {
                  "en": "All were stolen from the Royal Mint",
                  "es": "Todas fueron robadas de la Real Casa de Moneda",
                  "de": "Alle wurden von der königlichen Münzstätte gestohlen",
                  "nl": "Allemaal gestolen van de Koninklijke Munt"
        },
        {
                  "en": "He abdicated before coins could be officially released",
                  "es": "Abdicó antes de que las monedas pudieran ser oficialmente liberadas",
                  "de": "Er dankte ab, bevor die Münzen offiziell freigegeben werden konnten",
                  "nl": "Hij deed afstand van de troon voordat munten officieel konden worden vrijgegeven"
        }
        ],
        correct: 3,
        explanation: {
