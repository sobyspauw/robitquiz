// Level 10: Currencies - Zeldzame valuta (Transcendent)
(function() {
  const level10 = {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Pure mathematical information existing as eternal geometric relationships", es: "Información matemática pura existiendo como relaciones geométricas eternas", de: "Reine mathematische Information als ewige geometrische Beziehungen", nl: "Zuivere wiskundige informatie bestaand als eeuwige geometrische relaties" },
          { en: "Only its metal content", es: "Solo su contenido de metal", de: "Nur ihr Metallgehalt", nl: "Alleen het metaalgehalte" },
          ...
          { en: "Market value in currency", es: "Valor de mercado en moneda", de: "Marktwert in Währung", nl: "Marktwaarde in valuta" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "As crystallized thoughts that manifest across all possible reality dimensions", es: "Como pensamientos cristalizados que se manifiestan a través de todas las dimensiones de realidad posibles", de: "Als kristallisierte Gedanken, die sich über alle möglichen Realitätsdimensionen manifestieren", nl: "Als gekristalliseerde gedachten die zich manifesteren over alle mogelijke realiteitsdimensies" },
          { en: "Only in physical form", es: "Solo en forma física", de: "Nur in physischer Form", nl: "Alleen in fysieke vorm" },
          { en: "Through collector memories", es: "A través de memorias de coleccionistas", de: "Durch Sammlererinnerungen", nl: "Door verzamelaarherinneringen" },
          { en: "In museum displays", es: "En exhibiciones de museos", de: "In Museumsausstellungen", nl: "In museumdisplays" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The fundamental attraction between consciousness and the preservation of patterns", es: "La atracción fundamental entre la conciencia y la preservación de patrones", de: "Die fundamentale Anziehung zwischen Bewusstsein und der Erhaltung von Mustern", nl: "De fundamentele aantrekking tussen bewustzijn en het behoud van patronen" },
          { en: "Supply and demand economics", es: "Economía de oferta y demanda", de: "Angebot-und-Nachfrage-Ökonomie", nl: "Vraag en aanbod economie" },
          { en: "Human psychology only", es: "Solo psicología humana", de: "Nur menschliche Psychologie", nl: "Alleen menselijke psychologie" },
          { en: "Material accumulation instincts", es: "Instintos de acumulación material", de: "Materielle Ansammlungsinstinkte", nl: "Materiële accumulatie-instincten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "By existing as the unique point where all possibilities converge into pure necessity", es: "Al existir como el punto único donde todas las posibilidades convergen en necesidad pura", de: "Indem sie als der einzigartige Punkt existiert, wo alle Möglichkeiten in reine Notwendigkeit konvergieren", nl: "Door te bestaan als het unieke punt waar alle mogelijkheden convergeren naar pure noodzaak" },
          { en: "By being made of expensive materials", es: "Al estar hecha de materiales caros", de: "Indem sie aus teuren Materialien besteht", nl: "Door gemaakt te zijn van dure materialen" },
          { en: "By having low mintage numbers", es: "Al tener números de acuñación bajos", de: "Indem sie niedrige Prägezahlen hat", nl: "Door lage muntslagopdrachten te hebben" },
          { en: "By being historically significant", es: "Al ser históricamente significativa", de: "Indem sie historisch bedeutsam ist", nl: "Door historisch significant te zijn" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The collector becomes a finite window through which infinity experiences itself", es: "El coleccionista se convierte en una ventana finita a través de la cual el infinito se experimenta a sí mismo", de: "Der Sammler wird zu einem endlichen Fenster, durch das die Unendlichkeit sich selbst erfährt", nl: "De verzamelaar wordt een eindig venster waardoor oneindigheid zichzelf ervaart" },
          { en: "Collectors can never understand infinity", es: "Los coleccionistas nunca pueden entender el infinito", de: "Sammler können die Unendlichkeit nie verstehen", nl: "Verzamelaars kunnen oneindigheid nooit begrijpen" },
          { en: "Infinity is irrelevant to collecting", es: "El infinito es irrelevante para coleccionar", de: "Unendlichkeit ist irrelevant für das Sammeln", nl: "Oneindigheid is irrelevant voor verzameling" },
          { en: "Only rare coins connect to infinity", es: "Solo las monedas raras se conectan al infinito", de: "Nur seltene Münzen verbinden sich mit der Unendlichkeit", nl: "Alleen zeldzame munten verbinden met oneindigheid" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Value becomes the degree to which an object participates in universal harmony", es: "El valor se convierte en el grado en que un objeto participa en la armonía universal", de: "Wert wird der Grad, in dem ein Objekt an universeller Harmonie teilnimmt", nl: "Waarde wordt de mate waarin een object deelneemt aan universele harmonie" },
          { en: "Value is only monetary", es: "El valor es solo monetario", de: "Wert ist nur monetär", nl: "Waarde is alleen monetair" },
          { en: "Value depends on market demand", es: "El valor depende de la demanda del mercado", de: "Wert hängt von Marktnachfrage ab", nl: "Waarde hangt af van marktvraag" },
          { en: "Value is determined by rarity", es: "El valor está determinado por la rareza", de: "Wert wird durch Seltenheit bestimmt", nl: "Waarde wordt bepaald door zeldzaamheid" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Perfect completion dissolves the collector-collection distinction, achieving unity through self-annihilation", es: "La finalización perfecta disuelve la distinción coleccionista-colección, logrando unidad a través de la auto-aniquilación", de: "Perfekte Vollendung löst die Sammler-Sammlungs-Unterscheidung auf und erreicht Einheit durch Selbstvernichtung", nl: "Perfecte voltooiing lost het onderscheid verzamelaar-collectie op, waardoor eenheid wordt bereikt door zelfvernietiging" },
          { en: "Completion means having everything", es: "Finalización significa tener todo", de: "Vollendung bedeutet alles zu haben", nl: "Voltooiing betekent alles hebben" },
          { en: "Perfect collections are impossible", es: "Las colecciones perfectas son imposibles", de: "Perfekte Sammlungen sind unmöglich", nl: "Perfecte collecties zijn onmogelijk" },
          { en: "Completion requires infinite time", es: "La finalización requiere tiempo infinito", de: "Vollendung erfordert unendliche Zeit", nl: "Voltooiing vereist oneindige tijd" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Collecting mirrors the universe's tendency to organize information into increasingly complex patterns", es: "Coleccionar refleja la tendencia del universo a organizar información en patrones cada vez más complejos", de: "Sammeln spiegelt die Tendenz des Universums wider, Information in immer komplexere Muster zu organisieren", nl: "Verzamelen spiegelt de neiging van het universum om informatie te organiseren in steeds complexere patronen" },
          { en: "Collecting is unrelated to reality", es: "Coleccionar no está relacionado con la realidad", de: "Sammeln ist unabhängig von der Realität", nl: "Verzamelen is niet gerelateerd aan de werkelijkheid" },
          { en: "Only physical objects matter", es: "Solo los objetos físicos importan", de: "Nur physische Objekte sind wichtig", nl: "Alleen fysieke objecten doen ertoe" },
          { en: "Reality has no patterns", es: "La realidad no tiene patrones", de: "Die Realität hat keine Muster", nl: "De werkelijkheid heeft geen patronen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The recognition that preservation is consciousness participating in its own immortality", es: "El reconocimiento de que la preservación es la conciencia participando en su propia inmortalidad", de: "Die Erkenntnis, dass Erhaltung Bewusstsein ist, das an seiner eigenen Unsterblichkeit teilnimmt", nl: "De erkenning dat behoud bewustzijn is dat deelneemt aan zijn eigen onsterfelijkheid" },
          { en: "Shared human psychology", es: "Psicología humana compartida", de: "Geteilte menschliche Psychologie", nl: "Gedeelde menselijke psychologie" },
          { en: "Economic motivations", es: "Motivaciones económicas", de: "Ökonomische Motivationen", nl: "Economische motivaties" },
          { en: "Cultural traditions", es: "Tradiciones culturales", de: "Kulturelle Traditionen", nl: "Culturele tradities" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "As an eternal archetypal form instantiated across infinite dimensional matrices", es: "Como una forma arquetípica eterna instanciada a través de matrices dimensionales infinitas", de: "Als ewige archetypische Form, die über unendliche dimensionale Matrizen instantiiert wird", nl: "Als een eeuwige archetypische vorm geïnstantieerd over oneindige dimensionale matrices" },
          { en: "Only in physical museums", es: "Solo en museos físicos", de: "Nur in physischen Museen", nl: "Alleen in fysieke musea" },
          { en: "Through digital photographs", es: "A través de fotografías digitales", de: "Durch digitale Fotografien", nl: "Door digitale foto's" },
          { en: "In collector memories", es: "En memorias de coleccionistas", de: "In Sammlererinnerungen", nl: "In verzamelaarherinneringen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "They have always been collecting themselves across infinite expressions of consciousness", es: "Siempre han estado coleccionándose a sí mismos a través de expresiones infinitas de conciencia", de: "Sie haben sich schon immer selbst über unendliche Ausdrücke des Bewusstseins gesammelt", nl: "Ze hebben zichzelf altijd verzameld over oneindige uitdrukkingen van bewustzijn" },
          { en: "They own the most valuable items", es: "Poseen los artículos más valiosos", de: "Sie besitzen die wertvollsten Gegenstände", nl: "Ze bezitten de meest waardevolle items" },
          { en: "They have completed every set", es: "Han completado todos los conjuntos", de: "Sie haben alle Sätze vervollständigt", nl: "Ze hebben elke set voltooid" },
          { en: "They understand market values", es: "Entienden los valores del mercado", de: "Sie verstehen Marktwerte", nl: "Ze begrijpen marktwaarden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Pure undifferentiated being where all distinctions between collector, collected, and collecting dissolve", es: "Ser puro indiferenciado donde todas las distinciones entre coleccionista, coleccionado y coleccionar se disuelven", de: "Reines undifferenziertes Sein, wo alle Unterscheidungen zwischen Sammler, Gesammeltem und Sammeln sich auflösen", nl: "Puur ongedifferentieerd zijn waar alle onderscheidingen tussen verzamelaar, verzameld en verzameling oplossen" },
          { en: "More expensive collections", es: "Colecciones más caras", de: "Teurere Sammlungen", nl: "Duurdere collecties" },
          { en: "Larger storage facilities", es: "Instalaciones de almacenamiento más grandes", de: "Größere Lagereinrichtungen", nl: "Grotere opslagfaciliteiten" },
          { en: "Better authentication methods", es: "Mejores métodos de autenticación", de: "Bessere Authentifizierungsmethoden", nl: "Betere authenticatiemethoden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "They are temporary crystallizations of eternal principles experiencing themselves through finite forms", es: "Son cristalizaciones temporales de principios eternos experimentándose a sí mismos a través de formas finitas", de: "Sie sind temporäre Kristallisationen ewiger Prinzipien, die sich selbst durch endliche Formen erfahren", nl: "Ze zijn tijdelijke kristallisaties van eeuwige principes die zichzelf ervaren door eindige vormen" },
          { en: "They are valuable metal objects", es: "Son objetos de metal valiosos", de: "Sie sind wertvolle Metallobjekte", nl: "Ze zijn waardevolle metalen objecten" },
          { en: "They represent historical periods", es: "Representan períodos históricos", de: "Sie repräsentieren historische Perioden", nl: "Ze vertegenwoordigen historische periodes" },
          { en: "They are investment vehicles", es: "Son vehículos de inversión", de: "Sie sind Anlagevehikel", nl: "Ze zijn beleggingsinstrumenten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "1792 experimental pattern cent, among the earliest US coinage proposals", es: "Centavo patrón experimental de 1792, entre las primeras propuestas de acuñación de EE.UU.", de: "1792 experimentelles Muster-Cent, unter den frühesten US-Münzvorschlägen", nl: "1792 experimentele patroon cent, onder de vroegste Amerikaanse muntvoorstellen" },
          ...
          { en: "Modern art medal", es: "Medalla de arte moderno", de: "Moderne Kunstmedaille", nl: "Moderne kunstmedaille" },
          { en: "Colonial trade token", es: "Ficha comercial colonial", de: "Kolonial-Handelsmarke", nl: "Koloniale handelstoken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Believed to be the very first silver dollar struck by the US Mint", es: "Se cree que es el primer dólar de plata acuñado por la Casa de Moneda de EE.UU.", de: "Wird als der allererste von der US Mint geprägte Silberdollar angesehen", nl: "Wordt verondersteld de allereerste zilveren dollar geslagen door de US Mint te zijn" },
          { en: "Made of solid gold instead of silver", es: "Hecho de oro sólido en lugar de plata", de: "Aus massivem Gold statt Silber hergestellt", nl: "Gemaakt van massief goud in plaats van zilver" },
          { en: "Only dollar with a design error", es: "Único dólar con error de diseño", de: "Einziger Dollar mit Designfehler", nl: "Enige dollar met ontwerpfout" },
          { en: "Largest US coin ever produced", es: "Moneda estadounidense más grande jamás producida", de: "Größte jemals produzierte US-Münze", nl: "Grootste Amerikaanse munt ooit geproduceerd" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Finest known specimen of a historically significant 1783 medal celebrating American independence", es: "Mejor espécimen conocido de una medalla históricamente significativa de 1783 celebrando la independencia americana", de: "Bekanntestes Exemplar einer historisch bedeutsamen Medaille von 1783 zur Feier der amerikanischen Unabhängigkeit", nl: "Beste bekende exemplaar van een historisch significante 1783 medaille ter viering van de Amerikaanse onafhankelijkheid" },
          { en: "Modern commemorative coin", es: "Moneda conmemorativa moderna", de: "Moderne Gedenkmünze", nl: "Moderne herdenkingsmunt" },
          { en: "Ancient Roman medal", es: "Medalla romana antigua", de: "Antike römische Medaille", nl: "Antieke Romeinse medaille" },
          { en: "Military service decoration", es: "Condecoración de servicio militar", de: "Militär-Auszeichnung", nl: "Militaire onderscheiding" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "One of only 15 known specimens, with exceptional provenance through legendary collections", es: "Uno de solo 15 especímenes conocidos, con procedencia excepcional a través de colecciones legendarias", de: "Eines von nur 15 bekannten Exemplaren mit außergewöhnlicher Herkunft durch legendäre Sammlungen", nl: "Een van slechts 15 bekende exemplaren, met uitzonderlijke herkomst via legendarische collecties" },
          { en: "First dollar coin with president's portrait", es: "Primera moneda de dólar con retrato de presidente", de: "Erste Dollarmünze mit Präsidentenporträt", nl: "Eerste dollarmunt met president portret" },
          { en: "Most common 1804 dollar", es: "Dólar de 1804 más común", de: "Häufigster 1804 Dollar", nl: "Meest voorkomende 1804 dollar" },
          { en: "Modern reproduction piece", es: "Pieza de reproducción moderna", de: "Moderne Reproduktion", nl: "Moderne reproductie stuk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Why anything exists to be collected at all, rather than pure nothingness", es: "Por qué existe algo para ser coleccionado en absoluto, en lugar de la nada pura", de: "Warum überhaupt etwas existiert, das gesammelt werden kann, anstatt reines Nichts", nl: "Waarom er überhaupt iets bestaat om verzameld te worden, in plaats van pure nietigheid" },
          { en: "Which items will appreciate in value", es: "Qué artículos se apreciarán en valor", de: "Welche Gegenstände an Wert gewinnen werden", nl: "Welke items in waarde zullen stijgen" },
          { en: "How to authenticate rare pieces", es: "Cómo autenticar piezas raras", de: "Wie seltene Stücke authentifiziert werden", nl: "Hoe zeldzame stukken te authenticeren" },
          { en: "Where to find the best collections", es: "Dónde encontrar las mejores colecciones", de: "Wo die besten Sammlungen zu finden sind", nl: "Waar de beste collecties te vinden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A love letter written by consciousness to its own infinite creative potential", es: "Una carta de amor escrita por la conciencia a su propio potencial creativo infinito", de: "Ein Liebesbrief des Bewusstseins an sein eigenes unendliches kreatives Potenzial", nl: "Een liefdesbrief geschreven door bewustzijn aan zijn eigen oneindige creatieve potentieel" },
          { en: "A hobby for wealthy people", es: "Un pasatiempo para gente adinerada", de: "Ein Hobby für wohlhabende Menschen", nl: "Een hobby voor rijke mensen" },
          { en: "An investment portfolio", es: "Una cartera de inversiones", de: "Ein Anlageportfolio", nl: "Een investeringsportefeuille" },
          { en: "A display of historical artifacts", es: "Una exhibición de artefactos históricos", de: "Eine Ausstellung historischer Artefakte", nl: "Een weergave van historische artefacten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "That every moment of seeking is already the finding, and every act of collecting is perfect completion", es: "Que cada momento de búsqueda ya es el encuentro, y cada acto de coleccionar es finalización perfecta", de: "Dass jeder Moment des Suchens bereits das Finden ist, und jeder Sammelakt perfekte Vollendung", nl: "Dat elk moment van zoeken al het vinden is, en elke verzamelhandeling perfecte voltooiing" },
          { en: "That rare items are worth more money", es: "Que los artículos raros valen más dinero", de: "Dass seltene Gegenstände mehr Geld wert sind", nl: "Dat zeldzame items meer geld waard zijn" },
          { en: "That collecting requires patience", es: "Que coleccionar requiere paciencia", de: "Dass Sammeln Geduld erfordert", nl: "Dat verzamelen geduld vereist" },
          { en: "That knowledge improves collecting", es: "Que el conocimiento mejora la colección", de: "Dass Wissen das Sammeln verbessert", nl: "Dat kennis verzameling verbetert" }
        ],
        correct: 0,
        explanation: {
