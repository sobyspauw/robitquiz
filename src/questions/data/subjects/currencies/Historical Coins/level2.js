// Quiz Template - Level 2: Currencies - Historische munten
(function() {
  const level2 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "A gold coin", es: "Una moneda de oro", de: "Eine Goldmünze", nl: "Een gouden munt" },
          { en: "A small silver coin", es: "Una pequeña moneda de plata", de: "Eine kleine Silbermünze", nl: "Een kleine zilveren munt" },
          { en: "A bronze token", es: "Una ficha de bronce", de: "Ein Bronzetoken", nl: "Een bronzen penning" },
          { en: "A trade good", es: "Un bien de intercambio", de: "Ein Handelsgut", nl: "Een handelsproduct" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Genoa", es: "Génova", de: "Genua", nl: "Genua" },
      ...
      },
      {
        ...
        options: [
          { en: "It was made of pure gold", es: "Estaba hecho de oro puro", de: "Es war aus reinem Gold", nl: "Het was gemaakt van puur goud" },
          { en: "It featured only calligraphic inscriptions, no images", es: "Presentaba solo inscripciones caligráficas, sin imágenes", de: "Es zeigte nur kalligrafische Inschriften, keine Bilder", nl: "Het toonde alleen kalligrafische inscripties, geen afbeeldingen" },
          { en: "It was square-shaped", es: "Tenía forma cuadrada", de: "Es war quadratisch geformt", nl: "Het was vierkant gevormd" },
          { en: "It was the largest coin of its time", es: "Era la moneda más grande de su tiempo", de: "Es war die größte Münze seiner Zeit", nl: "Het was de grootste munt van zijn tijd" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A silver coin worth half a solidus", es: "Una moneda de plata que valía medio solidus", de: "Eine Silbermünze im Wert eines halben Solidus", nl: "Een zilveren munt ter waarde van een halve solidus" },
          { en: "A gold coin worth one-third of a solidus", es: "Una moneda de oro que valía un tercio de un solidus", de: "Eine Goldmünze im Wert eines Drittels eines Solidus", nl: "Een gouden munt ter waarde van een derde van een solidus" },
          { en: "A copper coin for daily transactions", es: "Una moneda de cobre para transacciones diarias", de: "Eine Kupfermünze für tägliche Transaktionen", nl: "Een koperen munt voor dagelijkse transacties" },
          { en: "A commemorative medal", es: "Una medalla conmemorativa", de: "Eine Gedenkmedaille", nl: "Een herdenkingsmedaille" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "They were made of gold", es: "Estaban hechas de oro", de: "Sie waren aus Gold", nl: "Ze waren gemaakt van goud" },
          { en: "They were extremely thin and struck on one side only", es: "Eran extremadamente delgadas y acuñadas solo en un lado", de: "Sie waren extrem dünn und nur einseitig geprägt", nl: "Ze waren extreem dun en slechts aan één kant geslagen" },
          { en: "They had square holes", es: "Tenían agujeros cuadrados", de: "Sie hatten quadratische Löcher", nl: "Ze hadden vierkante gaten" },
          { en: "They were used only for religious ceremonies", es: "Se usaban solo para ceremonias religiosas", de: "Sie wurden nur für religiöse Zeremonien verwendet", nl: "Ze werden alleen gebruikt voor religieuze ceremonies" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The Roman aureus weight standard", es: "El estándar de peso del aureus romano", de: "Der römische Aureus-Gewichtsstandard", nl: "De Romeinse aureus-gewichtsstandaard" },
          { en: "The Byzantine solidus weight standard", es: "El estándar de peso del solidus bizantino", de: "Der byzantinische Solidus-Gewichtsstandard", nl: "De Byzantijnse solidus-gewichtsstandaard" },
          { en: "A completely new weight system", es: "Un sistema de peso completamente nuevo", de: "Ein völlig neues Gewichtssystem", nl: "Een volledig nieuw gewichtssysteem" },
          { en: "The Islamic dinar standard", es: "El estándar del dinar islámico", de: "Der islamische Dinar-Standard", nl: "De islamitische dinar-standaard" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A German silver coin from Bohemia", es: "Una moneda de plata alemana de Bohemia", de: "Eine deutsche Silbermünze aus Böhmen", nl: "Een Duitse zilveren munt uit Bohemen" },
          { en: "A gold coin from Austria", es: "Una moneda de oro de Austria", de: "Eine Goldmünze aus Österreich", nl: "Een gouden munt uit Oostenrijk" },
          { en: "A copper token from Switzerland", es: "Una ficha de cobre de Suiza", de: "Ein Kupfertoken aus der Schweiz", nl: "Een koperen penning uit Zwitserland" },
          { en: "A bronze medal from France", es: "Una medalla de bronce de Francia", de: "Eine Bronzemedaille aus Frankreich", nl: "Een bronzen medaille uit Frankrijk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Serial numbers", es: "Números de serie", de: "Seriennummern", nl: "Serienummers" },
          { en: "Milled edges and intricate designs", es: "Bordes moleteados y diseños intrincados", de: "Geränderte Kanten und komplizierte Designs", nl: "Gefreesde randen en ingewikkelde ontwerpen" },
          { en: "Color-changing inks", es: "Tintas que cambian de color", de: "Farbwechselnde Tinten", nl: "Kleur-veranderende inkten" },
      ...
      },
      {
        ...
        options: [
          { en: "A gold coin", es: "Una moneda de oro", de: "Eine Goldmünze", nl: "Een gouden munt" },
          { en: "A unit of account based on silver", es: "Una unidad de cuenta basada en plata", de: "Eine Rechnungseinheit basierend auf Silber", nl: "Een rekeneenheid gebaseerd op zilver" },
          { en: "A copper token", es: "Una ficha de cobre", de: "Ein Kupfertoken", nl: "Een koperen penning" },
          { en: "A trade document", es: "Un documento comercial", de: "Ein Handelsdokument", nl: "Een handelsdocument" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "It standardized weights and silver content across multiple cities", es: "Estandarizó pesos y contenido de plata a través de múltiples ciudades", de: "Es standardisierte Gewichte und Silbergehalt über mehrere Städte hinweg", nl: "Het standaardiseerde gewichten en zilvergehalte over meerdere steden" },
          { en: "It was based on copper coins only", es: "Se basaba solo en monedas de cobre", de: "Es basierte nur auf Kupfermünzen", nl: "Het was gebaseerd op alleen koperen munten" },
          { en: "It had no physical coins", es: "No tenía monedas físicas", de: "Es hatte keine physischen Münzen", nl: "Het had geen fysieke munten" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "It was a physical gold coin", es: "Era una moneda física de oro", de: "Es war eine physische Goldmünze", nl: "Het was een fysieke gouden munt" },
          { en: "It was a weight-based unit representing a specific amount of silver", es: "Era una unidad basada en peso que representaba una cantidad específica de plata", de: "Es war eine gewichtsbasierte Einheit, die eine bestimmte Menge Silber repräsentierte", nl: "Het was een gewicht-gebaseerde eenheid die een specifieke hoeveelheid zilver vertegenwoordigde" },
          { en: "It was only used for counting purposes", es: "Solo se usaba para propósitos de conteo", de: "Es wurde nur für Zählzwecke verwendet", nl: "Het werd alleen gebruikt voor teldoeleinden" },
          { en: "It was a type of paper money", es: "Era un tipo de papel moneda", de: "Es war eine Art Papiergeld", nl: "Het was een soort papiergeld" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Government mandates", es: "Mandatos gubernamentales", de: "Regierungsmandate", nl: "Overheidsverplichtingen" },
          { en: "The growth of long-distance trade", es: "El crecimiento del comercio de larga distancia", de: "Das Wachstum des Fernhandels", nl: "De groei van handel over lange afstanden" },
          { en: "Religious influences", es: "Influencias religiosas", de: "Religiöse Einflüsse", nl: "Religieuze invloeden" },
          { en: "Technological limitations", es: "Limitaciones tecnológicas", de: "Technologische Beschränkungen", nl: "Technologische beperkingen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A large gold coin", es: "Una gran moneda de oro", de: "Eine große Goldmünze", nl: "Een grote gouden munt" },
          { en: "A small silver coin worth one-sixth of a drachma", es: "Una pequeña moneda de plata que valía un sexto de un dracma", de: "Eine kleine Silbermünze im Wert eines Sechstels einer Drachme", nl: "Een kleine zilveren munt ter waarde van een zesde van een drachme" },
          { en: "A bronze token", es: "Una ficha de bronce", de: "Ein Bronzetoken", nl: "Een bronzen penning" },
          { en: "A unit of measurement", es: "Una unidad de medida", de: "Eine Maßeinheit", nl: "Een meeteenheid" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The screw press", es: "La prensa de tornillo", de: "Die Schraubenpresse", nl: "De schroefpers" },
          { en: "Water-powered hammers", es: "Martillos hidráulicos", de: "Wasserbetriebene Hämmer", nl: "Waterkracht hamers" },
          { en: "Improved metallurgy", es: "Metalurgia mejorada", de: "Verbesserte Metallurgie", nl: "Verbeterde metallurgie" },
          { en: "Better dies and punches", es: "Mejores troqueles y punzones", de: "Bessere Matrizen und Stempel", nl: "Betere stempels en ponsen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To pay enemy troops to switch sides", es: "Para pagar a las tropas enemigas para que cambiaran de bando", de: "Um feindliche Truppen für einen Seitenwechsel zu bezahlen", nl: "Om vijandelijke troepen te betalen om van kant te wisselen" },
          { en: "To maintain commerce during extended sieges", es: "Para mantener el comercio durante asedios prolongados", de: "Um den Handel während langer Belagerungen aufrechtzuerhalten", nl: "Om handel te onderhouden tijdens langdurige belegeringen" },
          { en: "To commemorate victories", es: "Para conmemorar victorias", de: "Um Siege zu gedenken", nl: "Om overwinningen te herdenken" },
          { en: "To communicate with allies", es: "Para comunicarse con aliados", de: "Um mit Verbündeten zu kommunizieren", nl: "Om te communiceren met bondgenoten" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A copper coin for everyday use", es: "Una moneda de cobre para uso diario", de: "Eine Kupfermünze für den täglichen Gebrauch", nl: "Een koperen munt voor dagelijks gebruik" },
          { en: "A standard gold or silver coin", es: "Una moneda estándar de oro o plata", de: "Eine Standard-Gold- oder Silbermünze", nl: "Een standaard gouden of zilveren munt" },
          { en: "A commemorative medal", es: "Una medalla conmemorativa", de: "Eine Gedenkmedaille", nl: "Een herdenkingsmedaille" },
          { en: "A token for temple offerings", es: "Una ficha para ofrendas del templo", de: "Ein Token für Tempelopfer", nl: "Een penning voor tempeloffers" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Charging high taxes on coin production", es: "Cobrar altos impuestos sobre la producción de monedas", de: "Hohe Steuern auf die Münzproduktion erheben", nl: "Hoge belastingen heffen op muntproductie" },
          { en: "Debasement - reducing precious metal content", es: "Devaluación - reducir el contenido de metal precioso", de: "Entwertung - Reduzierung des Edelmetallgehalts", nl: "Verbastering - edelmetaalgehalte verlagen" },
          { en: "Monopolizing foreign trade", es: "Monopolizar el comercio exterior", de: "Außenhandel monopolisieren", nl: "Buitenlandse handel monopoliseren" },
          { en: "Restricting coin circulation", es: "Restringir la circulación de monedas", de: "Münzumlauf beschränken", nl: "Muntcirculatie beperken" }
        ],
        correct: 1,
        explanation: {
