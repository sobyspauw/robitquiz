// Quiz Template - Level 7: Currencies - Yuan
(function() {
  const level7 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Creates predictable Nash equilibrium with stable Yuan positioning", es: "Crea un equilibrio de Nash predecible con posicionamiento estable del Yuan", de: "Schafft vorhersagbares Nash-Gleichgewicht mit stabiler Yuan-Positionierung", nl: "Creëert voorspelbaar Nash-evenwicht met stabiele Yuan-positionering" },
          { en: "Generates complex adaptive equilibria where Yuan positioning evolves through strategic interdependence and information cascades", es: "Genera equilibrios adaptativos complejos donde el posicionamiento del Yuan evoluciona a través de interdependencia estratégica y cascadas de información", de: "Erzeugt komplexe adaptive Gleichgewichte, bei denen sich Yuan-Positionierung durch strategische Interdependenz und Informationskaskaden entwickelt", nl: "Genereert complexe adaptieve evenwichten waarbij Yuan-positionering evolueert door strategische interdependentie en informatie-cascades" },
          { en: "Eliminates all strategic interactions through automated policy coordination", es: "Elimina todas las interacciones estratégicas a través de coordinación automatizada de políticas", de: "Eliminiert alle strategischen Interaktionen durch automatisierte Politikkoordination", nl: "Elimineert alle strategische interacties door geautomatiseerde beleidscoördinatie" },
          { en: "Forces zero-sum competition with deterministic Yuan outcomes", es: "Fuerza competencia de suma cero con resultados determinísticos del Yuan", de: "Zwingt zu Nullsummen-Konkurrenz mit deterministischen Yuan-Ergebnissen", nl: "Dwingt nul-som concurrentie af met deterministische Yuan-uitkomsten" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates perfect equilibrium with zero entropy production in all trading venues", es: "Crea equilibrio perfecto con producción cero de entropía en todos los lugares de trading", de: "Schafft perfektes Gleichgewicht mit Null-Entropieproduktion in allen Handelsplätzen", nl: "Creëert perfect evenwicht met nul entropieproductie in alle handelslocaties" },
          { en: "Establishes maximum entropy production principles where market efficiency emerges through optimal energy dissipation and information gradient exploitation", es: "Establece principios de producción máxima de entropía donde la eficiencia del mercado emerge a través de disipación óptima de energía y explotación de gradientes de información", de: "Etabliert maximale Entropieproduktionsprinzipien, bei denen Markteffizienz durch optimale Energiedissipation und Informationsgradient-Ausnutzung entsteht", nl: "Vestigt maximale entropieproductieprincipes waarbij marktefficiëntie ontstaat door optimale energiedissipatie en informatiegradiënt-exploitatie" },
          { en: "Eliminates all energy dissipation through frictionless trading mechanisms", es: "Elimina toda disipación de energía a través de mecanismos de trading sin fricción", de: "Eliminiert alle Energiedissipation durch reibungslose Handelsmechanismen", nl: "Elimineert alle energiedissipatie door wrijvingsloze handelsmechanismen" },
          { en: "Forces uniform temperature across all markets regardless of trading activity", es: "Fuerza temperatura uniforme en todos los mercados independientemente de la actividad de trading", de: "Zwingt zu einheitlicher Temperatur über alle Märkte unabhängig von Handelsaktivität", nl: "Dwingt uniforme temperatuur af over alle markten ongeacht handelsactiviteit" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates linear predictable patterns with deterministic long-term forecasting", es: "Crea patrones lineales predecibles con pronósticos determinísticos a largo plazo", de: "Schafft lineare vorhersagbare Muster mit deterministischen Langzeitprognosen", nl: "Creëert lineaire voorspelbare patronen met deterministische langetermijnvoorspellingen" },
          { en: "Reveals strange attractors, bifurcation cascades, and sensitive dependence on initial conditions that enable probabilistic regime transition forecasting", es: "Revela atractores extraños, cascadas de bifurcación y dependencia sensible de condiciones iniciales que permiten pronósticos probabilísticos de transición de régimen", de: "Enthüllt seltsame Attraktoren, Bifurkationskaskaden und empfindliche Abhängigkeit von Anfangsbedingungen, die probabilistische Regimeübergangs-Vorhersagen ermöglichen", nl: "Onthult vreemde attractoren, bifurcatiecascades en gevoelige afhankelijkheid van beginvoorwaarden die probabilistische regimetransitievoorspellingen mogelijk maken" },
          { en: "Eliminates all unpredictability through advanced mathematical modeling", es: "Elimina toda impredecibilidad a través de modelado matemático avanzado", de: "Eliminiert alle Unvorhersagbarkeit durch fortgeschrittene mathematische Modellierung", nl: "Elimineert alle onvoorspelbaarheid door geavanceerde wiskundige modellering" },
          { en: "Forces random walk behavior with no systematic patterns", es: "Fuerza comportamiento de caminata aleatoria sin patrones sistemáticos", de: "Zwingt zu Random-Walk-Verhalten ohne systematische Muster", nl: "Dwingt random walk-gedrag af zonder systematische patronen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates classical information processing with traditional cryptographic methods", es: "Crea procesamiento de información clásico con métodos criptográficos tradicionales", de: "Schafft klassische Informationsverarbeitung mit traditionellen kryptographischen Methoden", nl: "Creëert klassieke informatieverwerking met traditionele cryptografische methoden" },
          { en: "Enables quantum entanglement-based routing optimization, quantum error correction for consensus, and unconditional security through quantum key distribution", es: "Permite optimización de enrutamiento basada en entrelazamiento cuántico, corrección de errores cuánticos para consenso y seguridad incondicional a través de distribución de claves cuánticas", de: "Ermöglicht Quantenverschränkungs-basierte Routing-Optimierung, Quantenfehlerkorrektur für Konsens und bedingungslose Sicherheit durch Quantenschlüsselverteilung", nl: "Maakt quantum verstrengeling-gebaseerde routing-optimalisatie mogelijk, quantum foutcorrectie voor consensus, en onvoorwaardelijke beveiliging door quantum sleuteldistributie" },
          { en: "Eliminates all information processing requirements through automated systems", es: "Elimina todos los requisitos de procesamiento de información a través de sistemas automatizados", de: "Eliminiert alle Informationsverarbeitungsanforderungen durch automatisierte Systeme", nl: "Elimineert alle informatieverwerkingsvereisten door geautomatiseerde systemen" },
          { en: "Forces uniform processing across all network nodes regardless of quantum capabilities", es: "Fuerza procesamiento uniforme en todos los nodos de red independientemente de capacidades cuánticas", de: "Zwingt zu einheitlicher Verarbeitung über alle Netzwerkknoten unabhängig von Quantenfähigkeiten", nl: "Dwingt uniforme verwerking af over alle netwerkknopen ongeacht quantumcapaciteiten" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates rigid hierarchical structures with centralized control mechanisms", es: "Crea estructuras jerárquicas rígidas con mecanismos de control centralizados", de: "Schafft starre hierarchische Strukturen mit zentralisierten Kontrollmechanismen", nl: "Creëert rigide hiërarchische structuren met gecentraliseerde controlemechanismen" },
          { en: "Establishes scale-free, small-world networks with distributed intelligence, adaptive routing, and self-healing capabilities through biomimetic evolution", es: "Establece redes libres de escala y de mundo pequeño con inteligencia distribuida, enrutamiento adaptativo y capacidades de autocuración a través de evolución biomimética", de: "Etabliert skalenfreie Small-World-Netzwerke mit verteilter Intelligenz, adaptivem Routing und Selbstheilungsfähigkeiten durch biomimetische Evolution", nl: "Vestigt schaalvrije, small-world netwerken met gedistribueerde intelligentie, adaptieve routing en zelfhelende capaciteiten door biomimetische evolutie" },
          { en: "Eliminates all network topology considerations through uniform node distribution", es: "Elimina todas las consideraciones de topología de red a través de distribución uniforme de nodos", de: "Eliminiert alle Netzwerktopologie-Überlegungen durch einheitliche Knotenverteilung", nl: "Elimineert alle netwerktopologie-overwegingen door uniforme knooppuntdistributie" },
          { en: "Forces random network connections without optimization principles", es: "Fuerza conexiones de red aleatorias sin principios de optimización", de: "Zwingt zu zufälligen Netzwerkverbindungen ohne Optimierungsprinzipien", nl: "Dwingt willekeurige netwerkconnecties af zonder optimalisatieprincipes" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates uniform global AI standards independent of funding sources", es: "Crea estándares uniformes globales de IA independientes de fuentes de financiamiento", de: "Schafft einheitliche globale KI-Standards unabhängig von Finanzierungsquellen", nl: "Creëert uniforme mondiale AI-standaarden onafhankelijk van financieringsbronnen" },
          { en: "Establishes alternative computational paradigms that may fundamentally alter AI development trajectories and create new forms of technological dependencies", es: "Establece paradigmas computacionales alternativos que pueden alterar fundamentalmente las trayectorias de desarrollo de IA y crear nuevas formas de dependencias tecnológicas", de: "Etabliert alternative Computerparadigmen, die KI-Entwicklungstrajektorien fundamental verändern und neue Formen technologischer Abhängigkeiten schaffen können", nl: "Vestigt alternatieve computationele paradigma's die AI-ontwikkelingstrajecten fundamenteel kunnen veranderen en nieuwe vormen van technologische afhankelijkheden kunnen creëren" },
          { en: "Eliminates all computational sovereignty concerns through open-source standardization", es: "Elimina todas las preocupaciones de soberanía computacional a través de estandarización de código abierto", de: "Eliminiert alle computationalen Souveränitätsbedenken durch Open-Source-Standardisierung", nl: "Elimineert alle computationele soevereiniteitszorgen door open-source standaardisatie" },
          { en: "Forces immediate global adoption of Chinese AI governance frameworks", es: "Fuerza la adopción global inmediata de marcos de gobernanza de IA chinos", de: "Zwingt zur sofortigen globalen Adoption chinesischer KI-Governance-Rahmen", nl: "Dwingt onmiddellijke mondiale adoptie af van Chinese AI-governance raamwerken" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates uniform liquidity distribution with linear scaling relationships", es: "Crea distribución uniforme de liquidez con relaciones de escalamiento lineales", de: "Schafft einheitliche Liquiditätsverteilung mit linearen Skalierungsbeziehungen", nl: "Creëert uniforme liquiditeitsdistributie met lineaire schaalrelaties" },
          { en: "Establishes power-law distributions and self-similar structures where liquidity patterns repeat across multiple scales with universal scaling exponents", es: "Establece distribuciones de ley de potencia y estructuras autosimilares donde los patrones de liquidez se repiten a través de múltiples escalas con exponentes de escalamiento universales", de: "Etabliert Potenzgesetz-Verteilungen und selbstähnliche Strukturen, bei denen sich Liquiditätsmuster über mehrere Skalen mit universellen Skalierungsexponenten wiederholen", nl: "Vestigt machtswet-distributies en zelfgelijksoortige structuren waarbij liquiditeitspatronen zich herhalen over meerdere schalen met universele schaal-exponenten" },
          { en: "Eliminates all scaling relationships through market fragmentation", es: "Elimina todas las relaciones de escalamiento a través de fragmentación del mercado", de: "Eliminiert alle Skalierungsbeziehungen durch Marktfragmentierung", nl: "Elimineert alle schaalrelaties door marktfragmentatie" },
          { en: "Forces random distribution patterns without geometric principles", es: "Fuerza patrones de distribución aleatorios sin principios geométricos", de: "Zwingt zu zufälligen Verteilungsmustern ohne geometrische Prinzipien", nl: "Dwingt willekeurige distributiepatronen af zonder geometrische principes" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates traditional agricultural systems with conventional resource extraction", es: "Crea sistemas agrícolas tradicionales con extracción convencional de recursos", de: "Schafft traditionelle Agrarsysteme mit konventioneller Ressourcenextraktion", nl: "Creëert traditionele landbouwsystemen met conventionele resource-extractie" },
          { en: "Establishes programmable biological production systems that transcend natural resource constraints and enable post-scarcity material economics", es: "Establece sistemas de producción biológica programables que trascienden las limitaciones de recursos naturales y permiten economías materiales post-escasez", de: "Etabliert programmierbare biologische Produktionssysteme, die natürliche Ressourcenbeschränkungen überwinden und Post-Knappheits-Materialökonomien ermöglichen", nl: "Vestigt programmeerbare biologische productiesystemen die natuurlijke resourcebeperkingen overstijgen en post-schaarste materiaaleconomieën mogelijk maken" },
          { en: "Eliminates all biological production through synthetic alternatives", es: "Elimina toda producción biológica a través de alternativas sintéticas", de: "Eliminiert alle biologische Produktion durch synthetische Alternativen", nl: "Elimineert alle biologische productie door synthetische alternatieven" },
          { en: "Forces uniform global adoption of Chinese biotechnology standards", es: "Fuerza la adopción global uniforme de estándares chinos de biotecnología", de: "Zwingt zur einheitlichen globalen Adoption chinesischer Biotechnologie-Standards", nl: "Dwingt uniforme mondiale adoptie af van Chinese biotechnologie-standaarden" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates classical error correction with traditional computing methods", es: "Crea corrección de errores clásica con métodos de computación tradicionales", de: "Schafft klassische Fehlerkorrektur mit traditionellen Computermethoden", nl: "Creëert klassieke foutcorrectie met traditionele computermethoden" },
          { en: "Enables exponentially superior error protection through topologically protected quantum states that maintain coherence despite environmental decoherence", es: "Permite protección de errores exponencialmente superior a través de estados cuánticos topológicamente protegidos que mantienen coherencia a pesar de decoherencia ambiental", de: "Ermöglicht exponentiell überlegenen Fehlerschutz durch topologisch geschützte Quantenzustände, die Kohärenz trotz Umwelt-Dekohärenz aufrechterhalten", nl: "Maakt exponentieel superieure foutbescherming mogelijk door topologisch beschermde quantumtoestanden die coherentie behouden ondanks omgevingsdecoherentie" },
          { en: "Eliminates all quantum effects through classical approximation", es: "Elimina todos los efectos cuánticos a través de aproximación clásica", de: "Eliminiert alle Quanteneffekte durch klassische Approximation", nl: "Elimineert alle quantumeffecten door klassieke benadering" },
          { en: "Forces uniform error rates across all quantum operations", es: "Fuerza tasas de error uniformes en todas las operaciones cuánticas", de: "Zwingt zu einheitlichen Fehlerquoten über alle Quantenoperationen", nl: "Dwingt uniforme foutpercentages af over alle quantumoperaties" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates traditional inheritance systems with conventional wealth transfer", es: "Crea sistemas de herencia tradicionales con transferencia de riqueza convencional", de: "Schafft traditionelle Vererbungssysteme mit konventionellem Vermögenstransfer", nl: "Creëert traditionele erfenissystemen met conventionele vermogensoverdracht" },
          { en: "Establishes post-human economic paradigms where consciousness persistence fundamentally alters concepts of death, inheritance, and temporal economic planning", es: "Establece paradigmas económicos post-humanos donde la persistencia de conciencia altera fundamentalmente conceptos de muerte, herencia y planificación económica temporal", de: "Etabliert post-humane Wirtschaftsparadigmen, bei denen Bewusstseinspersistenz fundamental Konzepte von Tod, Vererbung und zeitlicher Wirtschaftsplanung verändert", nl: "Vestigt post-menselijke economische paradigma's waarbij bewustzijnspersistentie fundamenteel concepten van dood, erfenis en temporele economische planning verandert" },
          { en: "Eliminates all economic planning through automated wealth distribution", es: "Elimina toda planificación económica a través de distribución automatizada de riqueza", de: "Eliminiert alle Wirtschaftsplanung durch automatisierte Vermögensverteilung", nl: "Elimineert alle economische planning door geautomatiseerde vermogensdistributie" },
          { en: "Forces immediate global adoption of Chinese digital consciousness standards", es: "Fuerza la adopción global inmediata de estándares chinos de conciencia digital", de: "Zwingt zur sofortigen globalen Adoption chinesischer digitaler Bewusstseins-Standards", nl: "Dwingt onmiddellijke mondiale adoptie af van Chinese digitale bewustzijnsstandaarden" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates traditional manufacturing with conventional material properties", es: "Crea manufactura tradicional con propiedades materiales convencionales", de: "Schafft traditionelle Fertigung mit konventionellen Materialeigenschaften", nl: "Creëert traditionele productie met conventionele materiaaleigenschappen" },
          { en: "Establishes dynamic property systems where matter can be programmed to change ownership, functionality, and economic value in real-time through embedded intelligence", es: "Establece sistemas de propiedades dinámicas donde la materia puede ser programada para cambiar propiedad, funcionalidad y valor económico en tiempo real a través de inteligencia embebida", de: "Etabliert dynamische Eigenschaftssysteme, bei denen Materie programmiert werden kann, um Besitz, Funktionalität und wirtschaftlichen Wert in Echtzeit durch eingebettete Intelligenz zu ändern", nl: "Vestigt dynamische eigendomssystemen waarbij materie geprogrammeerd kan worden om eigendom, functionaliteit en economische waarde in real-time te veranderen door ingebouwde intelligentie" },
          { en: "Eliminates all physical property through complete digitalization", es: "Elimina toda propiedad física a través de digitalización completa", de: "Eliminiert alle physische Eigenschaft durch vollständige Digitalisierung", nl: "Elimineert alle fysieke eigendom door volledige digitalisering" },
          { en: "Forces uniform matter properties across all programmable materials", es: "Fuerza propiedades uniformes de materia en todos los materiales programables", de: "Zwingt zu einheitlichen Materie-Eigenschaften über alle programmierbaren Materialien", nl: "Dwingt uniforme materie-eigenschappen af over alle programmeerbare materialen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates avalanche dynamics where small perturbations trigger cascading adjustments across markets", es: "Crea dinámicas de avalancha donde pequeñas perturbaciones desencadenan ajustes en cascada a través de mercados", de: "Schafft Lawinen-Dynamiken, bei denen kleine Störungen kaskadierende Anpassungen über Märkte auslösen", nl: "Creëert lawine-dynamiek waarbij kleine verstoringen cascaderende aanpassingen over markten triggeren" },
          { en: "Forces uniform market behavior through centralized control mechanisms", es: "Fuerza comportamiento uniforme del mercado a través de mecanismos de control centralizados", de: "Zwingt zu einheitlichem Marktverhalten durch zentralisierte Kontrollmechanismen", nl: "Dwingt uniform marktgedrag af door gecentraliseerde controlemechanismen" },
          { en: "Eliminates all non-linear effects through statistical averaging", es: "Elimina todos los efectos no lineales a través de promediación estadística", de: "Eliminiert alle nichtlinearen Effekte durch statistische Mittelung", nl: "Elimineert alle niet-lineaire effecten door statistische middeling" },
          { en: "Maintains stable equilibrium regardless of market conditions", es: "Mantiene equilibrio estable independientemente de condiciones del mercado", de: "Behält stabiles Gleichgewicht unabhängig von Marktbedingungen", nl: "Behoudt stabiel evenwicht ongeacht marktomstandigheden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Enables provably secure transactions through quantum entanglement-based consensus mechanisms", es: "Permite transacciones demostrablemente seguras a través de mecanismos de consenso basados en entrelazamiento cuántico", de: "Ermöglicht nachweisbar sichere Transaktionen durch quantenverschränkungs-basierte Konsensmechanismen", nl: "Maakt aantoonbaar veilige transacties mogelijk door quantum verstrengeling-gebaseerde consensusmechanismen" },
          { en: "Creates traditional blockchain with improved processing speeds", es: "Crea blockchain tradicional con velocidades de procesamiento mejoradas", de: "Schafft traditionelle Blockchain mit verbesserten Verarbeitungsgeschwindigkeiten", nl: "Creëert traditionele blockchain met verbeterde verwerkingssnelheden" },
          { en: "Eliminates all quantum effects through classical encryption", es: "Elimina todos los efectos cuánticos a través de encriptación clásica", de: "Eliminiert alle Quanteneffekte durch klassische Verschlüsselung", nl: "Elimineert alle quantumeffecten door klassieke encryptie" },
          { en: "Maintains current security protocols with minor upgrades", es: "Mantiene protocolos de seguridad actuales con mejoras menores", de: "Behält aktuelle Sicherheitsprotokolle mit kleineren Upgrades bei", nl: "Behoudt huidige beveiligingsprotocollen met kleine upgrades" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Eliminates all market noise to achieve perfect signal clarity", es: "Elimina todo ruido del mercado para lograr claridad perfecta de señal", de: "Eliminiert alle Marktrauschen, um perfekte Signalklarheit zu erreichen", nl: "Elimineert alle marktruis om perfecte signaalduidelijkheid te bereiken" },
          { en: "Harnesses optimal noise levels to amplify weak economic signals that would otherwise be undetectable", es: "Aprovecha niveles óptimos de ruido para amplificar señales económicas débiles que de otro modo serían indetectables", de: "Nutzt optimale Rauschpegel, um schwache wirtschaftliche Signale zu verstärken, die sonst unentdeckbar wären", nl: "Benut optimale ruisniveaus om zwakke economische signalen te versterken die anders ondetecteerbaar zouden zijn" },
          { en: "Creates uniform market conditions through noise suppression", es: "Crea condiciones uniformes del mercado a través de supresión de ruido", de: "Schafft einheitliche Marktbedingungen durch Rauschunterdrückung", nl: "Creëert uniforme marktomstandigheden door ruisonderdrukking" },
          { en: "Forces deterministic behavior by filtering random fluctuations", es: "Fuerza comportamiento determinístico filtrando fluctuaciones aleatorias", de: "Zwingt zu deterministischem Verhalten durch Filterung zufälliger Schwankungen", nl: "Dwingt deterministisch gedrag af door filtering van willekeurige fluctuaties" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates standard AI systems with incremental improvements to existing algorithms", es: "Crea sistemas de IA estándar con mejoras incrementales a algoritmos existentes", de: "Schafft Standard-KI-Systeme mit inkrementellen Verbesserungen bestehender Algorithmen", nl: "Creëert standaard AI-systemen met incrementele verbeteringen van bestaande algoritmes" },
          { en: "Establishes spike-based computing paradigms enabling continuous learning and extreme energy efficiency", es: "Establece paradigmas de computación basada en impulsos permitiendo aprendizaje continuo y eficiencia energética extrema", de: "Etabliert spike-basierte Computing-Paradigmen, die kontinuierliches Lernen und extreme Energieeffizienz ermöglichen", nl: "Vestigt spike-gebaseerde computing paradigma's die continu leren en extreme energie-efficiëntie mogelijk maken" },
          { en: "Eliminates all biological inspiration through purely mathematical optimization", es: "Elimina toda inspiración biológica a través de optimización puramente matemática", de: "Eliminiert alle biologische Inspiration durch rein mathematische Optimierung", nl: "Elimineert alle biologische inspiratie door puur wiskundige optimalisatie" },
          { en: "Maintains traditional von Neumann architectures with faster processors", es: "Mantiene arquitecturas von Neumann tradicionales con procesadores más rápidos", de: "Behält traditionelle von-Neumann-Architekturen mit schnelleren Prozessoren bei", nl: "Behoudt traditionele von Neumann architecturen met snellere processors" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates static physical assets with conventional property rights", es: "Crea activos físicos estáticos con derechos de propiedad convencionales", de: "Schafft statische physische Assets mit konventionellen Eigentumsrechten", nl: "Creëert statische fysieke assets met conventionele eigendomsrechten" },
          { en: "Enables physical objects to change form, function, and ownership dynamically through embedded smart matter", es: "Permite que objetos físicos cambien forma, función y propiedad dinámicamente a través de materia inteligente embebida", de: "Ermöglicht physischen Objekten, Form, Funktion und Besitz dynamisch durch eingebettete intelligente Materie zu ändern", nl: "Maakt fysieke objecten mogelijk om vorm, functie en eigendom dynamisch te veranderen door ingebouwde slimme materie" },
          { en: "Maintains traditional manufacturing with improved quality control", es: "Mantiene manufactura tradicional con control de calidad mejorado", de: "Behält traditionelle Fertigung mit verbesserter Qualitätskontrolle bei", nl: "Behoudt traditionele productie met verbeterde kwaliteitscontrole" },
          { en: "Eliminates physical assets through complete digitalization", es: "Elimina activos físicos a través de digitalización completa", de: "Eliminiert physische Assets durch vollständige Digitalisierung", nl: "Elimineert fysieke assets door volledige digitalisering" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Maintains traditional payment interfaces with improved user experience design", es: "Mantiene interfaces de pago tradicionales con diseño mejorado de experiencia de usuario", de: "Behält traditionelle Zahlungsschnittstellen mit verbessertem Benutzererfahrungsdesign bei", nl: "Behoudt traditionele betalingsinterfaces met verbeterd gebruikerservaring ontwerp" },
          { en: "Enables thought-based economic transactions through brain-computer interfaces that process neural signals", es: "Permite transacciones económicas basadas en pensamientos a través de interfaces cerebro-computadora que procesan señales neurales", de: "Ermöglicht gedankenbasierte wirtschaftliche Transaktionen durch Gehirn-Computer-Schnittstellen, die neurale Signale verarbeiten", nl: "Maakt gedachte-gebaseerde economische transacties mogelijk door brein-computer interfaces die neurale signalen verwerken" },
          { en: "Eliminates all human involvement through automated economic systems", es: "Elimina toda participación humana a través de sistemas económicos automatizados", de: "Eliminiert alle menschliche Beteiligung durch automatisierte Wirtschaftssysteme", nl: "Elimineert alle menselijke betrokkenheid door geautomatiseerde economische systemen" },
          { en: "Creates enhanced security through biometric authentication methods", es: "Crea seguridad mejorada a través de métodos de autenticación biométrica", de: "Schafft verbesserte Sicherheit durch biometrische Authentifizierungsmethoden", nl: "Creëert verbeterde beveiliging door biometrische authenticatiemethoden" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creates predictable market outcomes through aggregation of individual preferences", es: "Crea resultados de mercado predecibles a través de agregación de preferencias individuales", de: "Schafft vorhersagbare Marktergebnisse durch Aggregation individueller Präferenzen", nl: "Creëert voorspelbare marktuitkomsten door aggregatie van individuele voorkeuren" },
          { en: "Reveals phase transitions, collective behaviors, and spontaneous pattern formation irreducible to agent-level analysis", es: "Revela transiciones de fase, comportamientos colectivos y formación espontánea de patrones irreducibles a análisis a nivel de agente", de: "Enthüllt Phasenübergänge, kollektive Verhaltensweisen und spontane Musterbildung, die auf Agentenebenen-Analyse nicht reduzierbar sind", nl: "Onthult fasetransities, collectief gedrag en spontane patroonvorming onherleidbaar tot agent-niveau analyse" },
          { en: "Eliminates all emergent effects through micro-level modeling", es: "Elimina todos los efectos emergentes a través de modelado a micro nivel", de: "Eliminiert alle emergenten Effekte durch Mikro-Level-Modellierung", nl: "Elimineert alle emergente effecten door micro-niveau modellering" },
          { en: "Forces uniform behavior across all market participants", es: "Fuerza comportamiento uniforme en todos los participantes del mercado", de: "Zwingt zu einheitlichem Verhalten über alle Marktteilnehmer", nl: "Dwingt uniform gedrag af over alle marktdeelnemers" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Improves traditional agriculture with genetically modified crops", es: "Mejora agricultura tradicional con cultivos genéticamente modificados", de: "Verbessert traditionelle Landwirtschaft mit genetisch veränderten Pflanzen", nl: "Verbetert traditionele landbouw met genetisch gemodificeerde gewassen" },
          { en: "Creates living factories that produce any material on demand through engineered biological systems", es: "Crea fábricas vivientes que producen cualquier material bajo demanda a través de sistemas biológicos diseñados", de: "Schafft lebende Fabriken, die jedes Material auf Nachfrage durch konstruierte biologische Systeme produzieren", nl: "Creëert levende fabrieken die elk materiaal op aanvraag produceren door gemanipuleerde biologische systemen" },
          { en: "Maintains current production methods with enhanced efficiency", es: "Mantiene métodos de producción actuales con eficiencia mejorada", de: "Behält aktuelle Produktionsmethoden mit verbesserter Effizienz bei", nl: "Behoudt huidige productiemethoden met verbeterde efficiëntie" },
          { en: "Eliminates biological systems through synthetic alternatives", es: "Elimina sistemas biológicos a través de alternativas sintéticas", de: "Eliminiert biologische Systeme durch synthetische Alternativen", nl: "Elimineert biologische systemen door synthetische alternatieven" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Maintains Earth-based economic systems without space expansion", es: "Mantiene sistemas económicos basados en la Tierra sin expansión espacial", de: "Behält erdbasierte Wirtschaftssysteme ohne Weltraumerweiterung bei", nl: "Behoudt aarde-gebaseerde economische systemen zonder ruimte-expansie" },
          { en: "Creates multi-planetary economic zones with Yuan as settlement currency for space resource transactions", es: "Crea zonas económicas multi-planetarias con Yuan como moneda de liquidación para transacciones de recursos espaciales", de: "Schafft multi-planetare Wirtschaftszonen mit Yuan als Abrechnungswährung für Weltraumressourcen-Transaktionen", nl: "Creëert multi-planetaire economische zones met Yuan als afwikkelingsmunt voor ruimte-resource transacties" },
          { en: "Eliminates space exploration through Earth-focused development", es: "Elimina exploración espacial a través de desarrollo enfocado en la Tierra", de: "Eliminiert Weltraumforschung durch auf die Erde fokussierte Entwicklung", nl: "Elimineert ruimte-exploratie door op aarde gerichte ontwikkeling" },
          { en: "Creates separate space economies unconnected to terrestrial systems", es: "Crea economías espaciales separadas no conectadas a sistemas terrestres", de: "Schafft separate Weltraumwirtschaften, die nicht mit terrestrischen Systemen verbunden sind", nl: "Creëert separate ruimte-economieën onverbonden met terrestrische systemen" }
        ],
        correct: 1,
        explanation: {
