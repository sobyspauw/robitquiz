    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Creating stablecoins on Ethereum",
                  "es": "Crear stablecoins en Ethereum",
                  "de": "Erstellung von Stablecoins auf Ethereum",
                  "nl": "Het maken van stablecoins op Ethereum"
        },
        {
                  "en": "Creating fungible tokens on Ethereum",
                  "es": "Crear tokens fungibles en Ethereum",
                  "de": "Erstellung fungibler Token auf Ethereum",
                  "nl": "Het maken van fungible tokens op Ethereum"
        },
        {
                  "en": "Creating governance tokens on Ethereum",
                  "es": "Crear tokens de gobernanza en Ethereum",
                  "de": "Erstellung von Governance-Token auf Ethereum",
                  "nl": "Het maken van governance tokens op Ethereum"
        },
        {
                  "en": "Creating non-fungible tokens (NFTs) on Ethereum",
                  "es": "Crear tokens no fungibles (NFTs) en Ethereum",
                  "de": "Erstellung non-fungibler Token (NFTs) auf Ethereum",
                  "nl": "Het maken van non-fungible tokens (NFTs) op Ethereum"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Converting a fungible token into an NFT",
                  "es": "Convertir un token fungible en un NFT",
                  "de": "Umwandlung eines fungiblen Tokens in ein NFT",
                  "nl": "Een fungible token omzetten naar een NFT"
        },
        {
                  "en": "Creating and issuing a new unique token on the blockchain",
                  "es": "Crear y emitir un nuevo token único en la blockchain",
                  "de": "Erstellen und Ausgeben eines neuen einzigartigen Tokens auf der Blockchain",
                  "nl": "Het maken en uitgeven van een nieuwe unieke token op de blockchain"
        },
        {
                  "en": "Destroying an existing NFT permanently",
                  "es": "Destruir un NFT existente permanentemente",
                  "de": "Dauerhafte Zerstörung eines bestehenden NFTs",
                  "nl": "Een bestaande NFT permanent vernietigen"
        },
        {
                  "en": "Transferring an NFT to a new owner",
                  "es": "Transferir un NFT a un nuevo propietario",
                  "de": "Übertragung eines NFTs an einen neuen Besitzer",
                  "nl": "Een NFT overdragen aan een nieuwe eigenaar"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "ERC-721 is faster than ERC-1155",
                  "es": "ERC-721 es más rápido que ERC-1155",
                  "de": "ERC-721 ist schneller als ERC-1155",
                  "nl": "ERC-721 is sneller dan ERC-1155"
        },
        {
                  "en": "ERC-1155 allows both fungible and non-fungible tokens in one contract",
                  "es": "ERC-1155 permite tanto tokens fungibles como no fungibles en un contrato",
                  "de": "ERC-1155 ermöglicht sowohl fungible als auch non-fungible Token in einem Contract",
                  "nl": "ERC-1155 staat zowel fungible als non-fungible tokens toe in één contract"
        },
        {
                  "en": "ERC-721 has better security features",
                  "es": "ERC-721 tiene mejores características de seguridad",
                  "de": "ERC-721 hat bessere Sicherheitsfeatures",
                  "nl": "ERC-721 heeft betere beveiligingsfuncties"
        },
        {
                  "en": "ERC-1155 only works on different blockchains",
                  "es": "ERC-1155 solo funciona en blockchains diferentes",
                  "de": "ERC-1155 funktioniert nur auf verschiedenen Blockchains",
                  "nl": "ERC-1155 werkt alleen op verschillende blockchains"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "International Public File System - government-controlled storage",
                  "es": "Sistema de Archivos Públicos Internacional - almacenamiento controlado por gobierno",
                  "de": "International Public File System - staatlich kontrollierte Speicherung",
                  "nl": "International Public File System - door de overheid gecontroleerde opslag"
        },
        {
                  "en": "Internet Protocol File Sharing - a centralized database",
                  "es": "Compartición de Archivos de Protocolo de Internet - una base de datos centralizada",
                  "de": "Internet Protocol File Sharing - eine zentralisierte Datenbank",
                  "nl": "Internet Protocol File Sharing - een gecentraliseerde database"
        },
        {
                  "en": "Integrated Platform File Storage - blockchain-based storage",
                  "es": "Almacenamiento de Archivos de Plataforma Integrada - almacenamiento basado en blockchain",
                  "de": "Integrated Platform File Storage - blockchain-basierte Speicherung",
                  "nl": "Integrated Platform File Storage - blockchain-gebaseerde opslag"
        },
        {
                  "en": "InterPlanetary File System - decentralized storage for NFT data",
                  "es": "Sistema de Archivos InterPlanetario - almacenamiento descentralizado para datos NFT",
                  "de": "InterPlanetary File System - dezentrale Speicherung für NFT-Daten",
                  "nl": "InterPlanetary File System - gedecentraliseerde opslag voor NFT data"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To pay transaction fees to miners",
                  "es": "Para pagar tarifas de transacción a mineros",
                  "de": "Um Transaktionsgebühren an Miner zu zahlen",
                  "nl": "Om transactiekosten aan miners te betalen"
        },
        {
                  "en": "To prevent unauthorized copying of NFTs",
                  "es": "Para prevenir copia no autorizada de NFTs",
                  "de": "Um unbefugtes Kopieren von NFTs zu verhindern",
                  "nl": "Om ongeautoriseerde kopieën van NFTs te voorkomen"
        },
        {
                  "en": "To ensure creators receive a percentage of secondary sales",
                  "es": "Para asegurar que los creadores reciban un porcentaje de ventas secundarias",
                  "de": "Um sicherzustellen, dass Schöpfer einen Prozentsatz der Sekundärverkäufe erhalten",
                  "nl": "Om ervoor te zorgen dat makers een percentage van secundaire verkopen ontvangen"
        },
        {
                  "en": "To fund the development of new NFT standards",
                  "es": "Para financiar el desarrollo de nuevos estándares NFT",
                  "de": "Um die Entwicklung neuer NFT-Standards zu finanzieren",
                  "nl": "Om de ontwikkeling van nieuwe NFT standaarden te financieren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Government registration of NFT ownership",
                  "es": "Registro gubernamental de propiedad de NFT",
                  "de": "Staatliche Registrierung des NFT-Eigentums",
                  "nl": "Overheidsregistratie van NFT eigendom"
        },
        {
                  "en": "Legal documentation proving NFT ownership",
                  "es": "Documentación legal probando propiedad de NFT",
                  "de": "Rechtliche Dokumentation zum Nachweis des NFT-Eigentums",
                  "nl": "Juridische documentatie die NFT eigendom bewijst"
        },
        {
                  "en": "Cryptographic verification that someone owns a specific NFT",
                  "es": "Verificación criptográfica de que alguien posee un NFT específico",
                  "de": "Kryptographische Verifikation, dass jemand ein spezifisches NFT besitzt",
                  "nl": "Cryptografische verificatie dat iemand een specifieke NFT bezit"
        },
        {
                  "en": "Physical certificate associated with digital assets",
                  "es": "Certificado físico asociado con activos digitales",
                  "de": "Physisches Zertifikat, das mit digitalen Assets verbunden ist",
                  "nl": "Fysiek certificaat geassocieerd met digitale assets"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Technical issue causing NFT metadata to disappear",
                  "es": "Problema técnico causando que los metadatos de NFT desaparezcan",
                  "de": "Technisches Problem, das zum Verschwinden von NFT-Metadaten führt",
                  "nl": "Technisch probleem waardoor NFT metadata verdwijnt"
        },
        {
                  "en": "Process of removing NFTs from marketplace listings",
                  "es": "Proceso de remover NFTs de listados de marketplace",
                  "de": "Prozess der Entfernung von NFTs aus Marketplace-Listen",
                  "nl": "Proces van het verwijderen van NFTs uit marketplace listings"
        },
        {
                  "en": "A legitimate marketing strategy for NFT launches",
                  "es": "Una estrategia de marketing legítima para lanzamientos de NFT",
                  "de": "Eine legitime Marketingstrategie für NFT-Launches",
                  "nl": "Een legitieme marketingstrategie voor NFT launches"
        },
        {
                  "en": "Scam where creators abandon the project and steal funds",
                  "es": "Estafa donde los creadores abandonan el proyecto y roban fondos",
                  "de": "Betrug, bei dem Schöpfer das Projekt verlassen und Gelder stehlen",
                  "nl": "Oplichting waarbij makers het project verlaten en fondsen stelen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "On-chain is cheaper than off-chain storage",
                  "es": "On-chain es más barato que almacenamiento off-chain",
                  "de": "On-Chain ist billiger als Off-Chain-Speicherung",
                  "nl": "On-chain is goedkoper dan off-chain opslag"
        },
        {
                  "en": "On-chain is stored directly on blockchain, off-chain uses external storage",
                  "es": "On-chain se almacena directamente en blockchain, off-chain usa almacenamiento externo",
                  "de": "On-Chain wird direkt auf der Blockchain gespeichert, Off-Chain nutzt externe Speicherung",
                  "nl": "On-chain wordt direct op blockchain opgeslagen, off-chain gebruikt externe opslag"
        },
        {
        ...
        {
                  "en": "Off-chain provides better security than on-chain",
                  "es": "Off-chain proporciona mejor seguridad que on-chain",
                  "de": "Off-Chain bietet bessere Sicherheit als On-Chain",
                  "nl": "Off-chain biedt betere beveiliging dan on-chain"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "NFTs specifically designed for use as social media avatars",
                  "es": "NFTs específicamente diseñados para usar como avatares de redes sociales",
                  "de": "NFTs, die speziell für die Verwendung als Social Media-Avatare entwickelt wurden",
                  "nl": "NFTs specifiek ontworpen voor gebruik als social media avatars"
        },
        {
                  "en": "NFTs that automatically change based on market prices",
                  "es": "NFTs que cambian automáticamente basándose en precios de mercado",
                  "de": "NFTs, die sich automatisch basierend auf Marktpreisen ändern",
                  "nl": "NFTs die automatisch veranderen op basis van marktprijzen"
        },
        {
                  "en": "NFTs that can only be viewed as profile pictures",
                  "es": "NFTs que solo pueden verse como fotos de perfil",
                  "de": "NFTs, die nur als Profilbilder angezeigt werden können",
                  "nl": "NFTs die alleen als profielfotos kunnen worden bekeken"
        },
        {
                  "en": "Photographs of famous people sold as NFTs",
                  "es": "Fotografías de personas famosas vendidas como NFTs",
                  "de": "Fotografien berühmter Personen, die als NFTs verkauft werden",
                  "nl": "Foto's van beroemde mensen verkocht als NFTs"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Government-regulated exchange for digital assets",
                  "es": "Intercambio regulado por el gobierno para activos digitales",
                  "de": "Staatlich regulierte Börse für digitale Assets",
                  "nl": "Door de overheid gereguleerde exchange voor digitale assets"
        },
        {
                  "en": "Software for creating new NFT collections",
                  "es": "Software para crear nuevas colecciones NFT",
                  "de": "Software zur Erstellung neuer NFT-Sammlungen",
                  "nl": "Software voor het maken van nieuwe NFT collecties"
        },
        {
                  "en": "Platform where users can buy, sell, and trade NFTs",
                  "es": "Plataforma donde usuarios pueden comprar, vender e intercambiar NFTs",
                  "de": "Plattform, auf der Nutzer NFTs kaufen, verkaufen und handeln können",
                  "nl": "Platform waar gebruikers NFTs kunnen kopen, verkopen en verhandelen"
        },
        {
                  "en": "Physical location where NFTs are displayed",
                  "es": "Ubicación física donde se muestran NFTs",
                  "de": "Physischer Ort, an dem NFTs ausgestellt werden",
                  "nl": "Fysieke locatie waar NFTs worden tentoongesteld"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The ability to copy and paste NFT images",
                  "es": "La capacidad de copiar y pegar imágenes NFT",
                  "de": "Die Fähigkeit, NFT-Bilder zu kopieren und einzufügen",
                  "nl": "Het vermogen om NFT afbeeldingen te kopiëren en plakken"
        },
        {
                  "en": "The electricity cost of minting NFTs",
                  "es": "El costo de electricidad de mintear NFTs",
                  "de": "Die Stromkosten für das Minting von NFTs",
                  "nl": "De elektriciteitskosten van het minten van NFTs"
        },
        {
                  "en": "Additional benefits or functionality beyond just owning the NFT",
                  "es": "Beneficios adicionales o funcionalidad más allá de solo poseer el NFT",
                  "de": "Zusätzliche Vorteile oder Funktionalität über den bloßen Besitz des NFTs hinaus",
                  "nl": "Extra voordelen of functionaliteit naast het alleen bezitten van de NFT"
        },
        {
                  "en": "The technical specifications of the blockchain",
                  "es": "Las especificaciones técnicas de la blockchain",
                  "de": "Die technischen Spezifikationen der Blockchain",
                  "nl": "De technische specificaties van de blockchain"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The minimum bid accepted in auctions",
                  "es": "La oferta mínima aceptada en subastas",
                  "de": "Das Mindestgebot, das bei Auktionen akzeptiert wird",
                  "nl": "Het minimumbod geaccepteerd in veilingen"
        },
        {
                  "en": "The price at which all NFTs must be sold",
                  "es": "El precio al cual todos los NFTs deben venderse",
                  "de": "Der Preis, zu dem alle NFTs verkauft werden müssen",
                  "nl": "De prijs waarvoor alle NFTs moeten worden verkocht"
        },
        {
                  "en": "The original minting price of the NFTs",
                  "es": "El precio original de minteo de los NFTs",
                  "de": "Der ursprüngliche Minting-Preis der NFTs",
                  "nl": "De oorspronkelijke minting prijs van de NFTs"
        },
        {
                  "en": "The lowest listed price for any NFT in a collection",
                  "es": "El precio listado más bajo para cualquier NFT en una colección",
                  "de": "Der niedrigste gelistete Preis für jedes NFT in einer Sammlung",
                  "nl": "De laagste genoteerde prijs voor elke NFT in een collectie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The number of times an NFT has been traded",
                  "es": "El número de veces que un NFT ha sido comerciado",
                  "de": "Die Anzahl der Male, die ein NFT gehandelt wurde",
                  "nl": "Het aantal keren dat een NFT is verhandeld"
        },
        {
                  "en": "The age of the NFT since it was minted",
                  "es": "La edad del NFT desde que fue minteado",
                  "de": "Das Alter des NFTs seit dem Minting",
                  "nl": "De leeftijd van de NFT sinds het werd gemint"
        },
        {
                  "en": "The file size of the NFT image",
                  "es": "El tamaño de archivo de la imagen NFT",
                  "de": "Die Dateigröße des NFT-Bildes",
                  "nl": "De bestandsgrootte van de NFT afbeelding"
        },
        {
                  "en": "How few NFTs have specific traits or combinations of traits",
                  "es": "Qué tan pocos NFTs tienen rasgos específicos o combinaciones de rasgos",
                  "de": "Wie wenige NFTs spezifische Eigenschaften oder Kombinationen von Eigenschaften haben",
                  "nl": "Hoeveel NFTs specifieke eigenschappen of combinaties van eigenschappen hebben"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Destruir permanentemente un NFT enviándolo a una dirección irrecuperable",
                  "de": "Dauerhaftes Zerstören eines NFTs durch Senden an eine unwiederbringliche Adresse",
                  "nl": "Permanent vernietigen van een NFT door het naar een onherstelbaar adres te sturen"
        },
        {
                  "en": "Transferring ownership to the original creator",
                  "es": "Transferir propiedad al creador original",
                  "de": "Eigentumsübertragung an den ursprünglichen Schöpfer",
                  "nl": "Eigendom overdragen aan de oorspronkelijke maker"
        },
        {
                  "en": "Converting an NFT back to cryptocurrency",
                  "es": "Convertir un NFT de vuelta a criptomoneda",
                  "de": "Ein NFT zurück in Kryptowährung umwandeln",
                  "nl": "Een NFT terug omzetten naar cryptocurrency"
        },
        {
                  "en": "Encrypting the NFT to prevent viewing",
                  "es": "Cifrar el NFT para prevenir visualización",
                  "de": "Das NFT verschlüsseln, um das Betrachten zu verhindern",
                  "nl": "De NFT versleutelen om weergave te voorkomen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Calculate market prices for similar NFTs",
                  "es": "Calcular precios de mercado para NFTs similares",
                  "de": "Marktpreise für ähnliche NFTs berechnen",
                  "nl": "Marktprijzen berekenen voor vergelijkbare NFTs"
        },
        {
                  "en": "Automatically handle bidding, timing, and transfers without intermediaries",
                  "es": "Manejar automáticamente ofertas, tiempo y transferencias sin intermediarios",
                  "de": "Automatisches Verwalten von Geboten, Timing und Übertragungen ohne Zwischenhändler",
                  "nl": "Automatisch afhandelen van biedingen, timing en overdrachten zonder tussenpersonen"
        },
        {
                  "en": "Verify the authenticity of physical artworks",
                  "es": "Verificar la autenticidad de obras de arte físicas",
                  "de": "Die Authentizität physischer Kunstwerke verifizieren",
                  "nl": "De authenticiteit van fysieke kunstwerken verifiëren"
        },
        {
                  "en": "Store high-resolution images of NFTs",
                  "es": "Almacenar imágenes de alta resolución de NFTs",
                  "de": "Hochauflösende Bilder von NFTs speichern",
                  "nl": "Hoge resolutie afbeeldingen van NFTs opslaan"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Traditional art that is converted into digital format",
                  "es": "Arte tradicional que se convierte a formato digital",
                  "de": "Traditionelle Kunst, die in digitales Format umgewandelt wird",
                  "nl": "Traditionele kunst die wordt omgezet naar digitaal formaat"
        },
        {
                  "en": "Art created by artificial intelligence only",
                  "es": "Arte creado solo por inteligencia artificial",
                  "de": "Kunst, die nur von künstlicher Intelligenz erstellt wird",
                  "nl": "Kunst gemaakt alleen door kunstmatige intelligentie"
        },
        {
                  "en": "Art that generates cryptocurrency when viewed",
                  "es": "Arte que genera criptomoneda cuando se ve",
                  "de": "Kunst, die Kryptowährung generiert, wenn sie betrachtet wird",
                  "nl": "Kunst die cryptocurrency genereert wanneer bekeken"
        },
        {
                  "en": "Art created using algorithms and code, often with randomness",
                  "es": "Arte creado usando algoritmos y código, a menudo con aleatoriedad",
                  "de": "Kunst, die mit Algorithmen und Code erstellt wird, oft mit Zufälligkeit",
                  "nl": "Kunst gemaakt met algoritmen en code, vaak met willekeur"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Techniques to reduce transaction costs when minting or trading NFTs",
                  "es": "Técnicas para reducir costos de transacción al mintear o comerciar NFTs",
                  "de": "Techniken zur Reduzierung von Transaktionskosten beim Minting oder Handel von NFTs",
                  "nl": "Technieken om transactiekosten te verminderen bij het minten of verhandelen van NFTs"
        },
        {
                  "en": "Converting NFTs to use less storage space",
                  "es": "Convertir NFTs para usar menos espacio de almacenamiento",
                  "de": "NFTs konvertieren, um weniger Speicherplatz zu verwenden",
                  "nl": "NFTs converteren om minder opslagruimte te gebruiken"
        },
        {
                  "en": "Speeding up NFT metadata loading times",
                  "es": "Acelerar tiempos de carga de metadatos NFT",
                  "de": "Beschleunigung der NFT-Metadaten-Ladezeiten",
                  "nl": "NFT metadata laadtijden versnellen"
        },
        {
                  "en": "Reducing the file size of NFT images",
                  "es": "Reducir el tamaño de archivo de imágenes NFT",
                  "de": "Reduzierung der Dateigröße von NFT-Bildern",
                  "nl": "Bestandsgrootte van NFT afbeeldingen verkleinen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "NFTs that can be converted between different file formats",
                  "es": "NFTs que pueden convertirse entre diferentes formatos de archivo",
                  "de": "NFTs, die zwischen verschiedenen Dateiformaten konvertiert werden können",
                  "nl": "NFTs die kunnen worden geconverteerd tussen verschillende bestandsformaten"
        },
        {
                  "en": "NFTs that represent physical objects from different countries",
                  "es": "NFTs que representan objetos físicos de diferentes países",
                  "de": "NFTs, die physische Objekte aus verschiedenen Ländern repräsentieren",
                  "nl": "NFTs die fysieke objecten uit verschillende landen vertegenwoordigen"
        },
        {
                  "en": "NFTs that can exist and be transferred across multiple blockchains",
                  "es": "NFTs que pueden existir y transferirse a través de múltiples blockchains",
                  "de": "NFTs, die auf mehreren Blockchains existieren und übertragen werden können",
                  "nl": "NFTs die kunnen bestaan en worden overgedragen over meerdere blockchains"
        },
        {
                  "en": "NFTs created through collaboration between different artists",
                  "es": "NFTs creados a través de colaboración entre diferentes artistas",
                  "de": "NFTs, die durch Zusammenarbeit zwischen verschiedenen Künstlern erstellt wurden",
                  "nl": "NFTs gemaakt door samenwerking tussen verschillende kunstenaars"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "NFTs that can be copied and pasted freely",
                  "es": "NFTs que pueden copiarse y pegarse libremente",
                  "de": "NFTs, die frei kopiert und eingefügt werden können",
                  "nl": "NFTs die vrij gekopieerd en geplakt kunnen worden"
        },
        {
                  "en": "NFTs that can change properties based on external data or conditions",
                  "es": "NFTs que pueden cambiar propiedades basándose en datos externos o condiciones",
                  "de": "NFTs, die Eigenschaften basierend auf externen Daten oder Bedingungen ändern können",
                  "nl": "NFTs die eigenschappen kunnen veranderen gebaseerd op externe data of voorwaarden"
        },
        {
                  "en": "NFTs that automatically increase in value over time",
                  "es": "NFTs que aumentan automáticamente en valor con el tiempo",
                  "de": "NFTs, die automatisch über die Zeit an Wert gewinnen",
                  "nl": "NFTs die automatisch in waarde stijgen over tijd"
        },
        {
                  "en": "NFTs that require programming skills to view",
                  "es": "NFTs que requieren habilidades de programación para ver",
                  "de": "NFTs, die Programmierkenntnisse zum Betrachten erfordern",
                  "nl": "NFTs die programmeervaardigheden vereisen om te bekijken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fungible tokens are interchangeable, non-fungible tokens are unique",
                  "es": "Los tokens fungibles son intercambiables, los tokens no fungibles son únicos",
                  "de": "Fungible Token sind austauschbar, nicht-fungible Token sind einzigartig",
                  "nl": "Fungible tokens zijn uitwisselbaar, non-fungible tokens zijn uniek"
        },
        {
                  "en": "There is no real difference",
                  "es": "No hay diferencia real",
                  "de": "Es gibt keinen wirklichen Unterschied",
                  "nl": "Er is geen echt verschil"
        },
        {
                  "en": "Non-fungible tokens are always worth more",
                  "es": "Los tokens no fungibles siempre valen más",
                  "de": "Nicht-fungible Token sind immer mehr wert",
                  "nl": "Non-fungible tokens zijn altijd meer waard"
        },
        {
                  "en": "Fungible tokens are newer technology",
                  "es": "Los tokens fungibles son tecnología más nueva",
                  "de": "Fungible Token sind neuere Technologie",
                  "nl": "Fungible tokens zijn nieuwere technologie"
        }
        ],
        correct: 0,
        explanation: {
