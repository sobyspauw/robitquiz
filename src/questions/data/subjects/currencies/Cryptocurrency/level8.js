    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Complete immunity to all known quantum algorithms",
                  "es": "Inmunidad completa a todos los algoritmos cuánticos conocidos",
                  "de": "Vollständige Immunität gegen alle bekannten Quantenalgorithmen",
                  "nl": "Volledige immuniteit tegen alle bekende quantum algoritmen"
        },
        {
                  "en": "Faster signature generation than isogeny-based schemes",
                  "es": "Generación de firmas más rápida que esquemas basados en isogenia",
                  "de": "Schnellere Signaturgenerierung als isogenie-basierte Schemas",
                  "nl": "Snellere handtekening generatie dan isogenie-gebaseerde schema's"
        },
        {
                  "en": "Smaller key sizes compared to hash-based signatures",
                  "es": "Tamaños de clave más pequeños comparados con firmas basadas en hash",
                  "de": "Kleinere Schlüsselgrößen im Vergleich zu hash-basierten Signaturen",
                  "nl": "Kleinere sleutelgroottes vergeleken met hash-gebaseerde handtekeningen"
        },
        {
                  "en": "Efficient homomorphic properties enabling privacy-preserving computations",
                  "es": "Propiedades homomórficas eficientes que permiten computaciones que preservan privacidad",
                  "de": "Effiziente homomorphe Eigenschaften für datenschutzwahrende Berechnungen",
                  "nl": "Efficiënte homomorfische eigenschappen die privacy-behoudende berekeningen mogelijk maken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Pruebas de tamaño constante de pertenencia a conjunto sin revelar contenidos del conjunto",
                  "de": "Konstante Beweis-Größe für Mengenmitgliedschaft ohne Offenlegung der Mengeninhalte",
                  "nl": "Constante grootte bewijzen van set lidmaatschap zonder set inhoud te onthullen"
        },
        {
                  "en": "Energy-efficient mining through accumulated proof-of-work",
                  "es": "Minería energéticamente eficiente a través de proof-of-work acumulado",
                  "de": "Energieeffizientes Mining durch akkumulierten Proof-of-Work",
                  "nl": "Energie-efficiënte mining door geaccumuleerde proof-of-work"
        },
        {
                  "en": "Decentralized storage compression algorithms",
                  "es": "Algoritmos de compresión de almacenamiento descentralizado",
                  "de": "Dezentrale Speicher-Kompressionsalgorithmen",
                  "nl": "Gedecentraliseerde opslag compressie algoritmen"
        },
        {
                  "en": "Automatic garbage collection for unused blockchain states",
                  "es": "Recolección automática de basura para estados blockchain no utilizados",
                  "de": "Automatische Garbage Collection für ungenutzte Blockchain-Zustände",
                  "nl": "Automatische garbage collection voor ongebruikte blockchain toestanden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Block reward plus priority fees only",
                  "es": "Recompensa del bloque más tarifas prioritarias solamente",
                  "de": "Block-Belohnung plus Prioritätsgebühren nur",
                  "nl": "Blok beloning plus prioriteitsfees alleen"
        },
        {
                  "en": "Total economic value of all transactions within the block's gas limit",
                  "es": "Valor económico total de todas las transacciones dentro del límite de gas del bloque",
                  "de": "Gesamter wirtschaftlicher Wert aller Transaktionen innerhalb des Block-Gas-Limits",
                  "nl": "Totale economische waarde van alle transacties binnen de gas limiet van het blok"
        },
        {
                  "en": "Sum of all transaction fees paid by users",
                  "es": "Suma de todas las tarifas de transacción pagadas por usuarios",
                  "de": "Summe aller von Nutzern gezahlten Transaktionsgebühren",
                  "nl": "Som van alle transactiekosten betaald door gebruikers"
        },
        {
                  "en": "Value determined by proof-of-work difficulty",
                  "es": "Valor determinado por dificultad de proof-of-work",
                  "de": "Wert bestimmt durch Proof-of-Work-Schwierigkeit",
                  "nl": "Waarde bepaald door proof-of-work moeilijkheid"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Zero-knowledge proofs for all smart contract executions",
                  "es": "Pruebas de conocimiento cero para todas las ejecuciones de contratos inteligentes",
                  "de": "Zero-Knowledge-Beweise für alle Smart-Contract-Ausführungen",
                  "nl": "Zero-knowledge bewijzen voor alle smart contract uitvoeringen"
        },
        {
                  "en": "Automated compliance with international privacy laws",
                  "es": "Cumplimiento automatizado con leyes internacionales de privacidad",
                  "de": "Automatisierte Einhaltung internationaler Datenschutzgesetze",
                  "nl": "Geautomatiseerde naleving van internationale privacy wetten"
        },
        {
                  "en": "Universal encryption for all blockchain transactions",
                  "es": "Cifrado universal para todas las transacciones blockchain",
                  "de": "Universelle Verschlüsselung für alle Blockchain-Transaktionen",
                  "nl": "Universele encryptie voor alle blockchain transacties"
        },
        {
                  "en": "Application-specific privacy policies enforced at the protocol level",
                  "es": "Políticas de privacidad específicas de aplicación aplicadas a nivel de protocolo",
                  "de": "Anwendungsspezifische Datenschutzrichtlinien auf Protokollebene durchgesetzt",
                  "nl": "Applicatie-specifieke privacy beleid afgedwongen op protocol niveau"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Atomic execution of transactions spanning multiple specialized shards",
                  "es": "Ejecución atómica de transacciones que abarcan múltiples shards especializados",
                  "de": "Atomare Ausführung von Transaktionen, die mehrere spezialisierte Shards umfassen",
                  "nl": "Atomaire uitvoering van transacties die meerdere gespecialiseerde shards overspannen"
        },
        {
                  "en": "Centralized validator rotation scheduling",
                  "es": "Programación centralizada de rotación de validadores",
                  "de": "Zentralisierte Validator-Rotationsplanung",
                  "nl": "Gecentraliseerde validator rotatie planning"
        },
        {
                  "en": "Consistent block timing across heterogeneous consensus mechanisms",
                  "es": "Tiempo de bloque consistente a través de mecanismos de consenso heterogéneos",
                  "de": "Konsistente Block-Timing über heterogene Konsensmechanismen",
                  "nl": "Consistente blok timing over heterogene consensus mechanismen"
        },
        {
                  "en": "Uniform gas pricing across all network partitions",
                  "es": "Precios de gas uniformes en todas las particiones de red",
                  "de": "Einheitliche Gas-Preisgestaltung über alle Netzwerkpartitionen",
                  "nl": "Uniforme gas prijsstelling over alle netwerk partities"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Eliminating the need for expensive recursive verification within proofs",
                  "es": "Eliminar la necesidad de verificación recursiva costosa dentro de las pruebas",
                  "de": "Eliminierung der Notwendigkeit teurer rekursiver Verifikation innerhalb von Beweisen",
                  "nl": "Het elimineren van de noodzaak voor dure recursieve verificatie binnen bewijzen"
        },
        {
                  "en": "Achieving constant proof size regardless of computation length",
                  "es": "Lograr tamaño de prueba constante independientemente de la longitud de computación",
                  "de": "Konstante Beweis-Größe unabhängig von der Berechnungslänge erreichen",
                  "nl": "Constante bewijs grootte bereiken ongeacht berekeningslengte"
        },
        {
                  "en": "Enabling perfect zero-knowledge without trusted setup",
                  "es": "Permitir conocimiento cero perfecto sin configuración confiada",
                  "de": "Perfektes Zero-Knowledge ohne vertrauenswürdiges Setup ermöglichen",
                  "nl": "Perfect zero-knowledge mogelijk maken zonder vertrouwde setup"
        },
        {
                  "en": "Providing quantum resistance for all proof operations",
                  "es": "Proporcionar resistencia cuántica para todas las operaciones de prueba",
                  "de": "Quantenresistenz für alle Beweis-Operationen bereitstellen",
                  "nl": "Quantum weerstand bieden voor alle bewijs operaties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Proof-of-Physical-Work rewarding real-world infrastructure contributions",
                  "es": "Proof-of-Physical-Work recompensando contribuciones de infraestructura del mundo real",
                  "de": "Proof-of-Physical-Work zur Belohnung von realen Infrastrukturbeiträgen",
                  "nl": "Proof-of-Physical-Work dat bijdragen aan echte infrastructuur beloont"
        },
        {
                  "en": "Automated staking based on geographic location",
                  "es": "Staking automatizado basado en ubicación geográfica",
                  "de": "Automatisiertes Staking basierend auf geografischer Lage",
                  "nl": "Geautomatiseerde staking gebaseerd op geografische locatie"
        },
        {
                  "en": "Cross-chain bridge rewards for infrastructure providers",
                  "es": "Recompensas de puente entre cadenas para proveedores de infraestructura",
                  "de": "Cross-Chain-Bridge-Belohnungen für Infrastrukturanbieter",
                  "nl": "Cross-chain bridge beloningen voor infrastructuur providers"
        },
        {
                  "en": "Dynamic fee adjustment based on network congestion",
                  "es": "Ajuste dinámico de tarifas basado en congestión de red",
                  "de": "Dynamische Gebührenanpassung basierend auf Netzwerküberlastung",
                  "nl": "Dynamische kostenbestandsaanpassing gebaseerd op netwerkcongestie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Multi-party computation enabling collaborative decryption",
                  "es": "Computación multi-partidaria que permite descifrado colaborativo",
                  "de": "Mehrparteien-Berechnung für kollaborative Entschlüsselung",
                  "nl": "Multi-party berekening die collaboratieve ontsleuteling mogelijk maakt"
        },
        {
                  "en": "Quantum key distribution for secure communication channels",
                  "es": "Distribución cuántica de claves para canales de comunicación seguros",
                  "de": "Quantenschlüsselverteilung für sichere Kommunikationskanäle",
                  "nl": "Quantum sleuteldistributie voor veilige communicatiekanalen"
        },
        {
                  "en": "Encryption that can only be decrypted by providing a valid witness to an NP statement",
                  "es": "Cifrado que solo puede descifrarse proporcionando un testigo válido a una declaración NP",
                  "de": "Verschlüsselung, die nur durch Bereitstellung eines gültigen Zeugen für eine NP-Aussage entschlüsselt werden kann",
                  "nl": "Encryptie die alleen kan worden ontsleuteld door een geldige getuige te verstrekken aan een NP verklaring"
        },
        {
                  "en": "Time-locked encryption based on computational puzzles",
                  "es": "Cifrado bloqueado en tiempo basado en rompecabezas computacionales",
                  "de": "Zeitgebundene Verschlüsselung basierend auf rechnerischen Rätseln",
                  "nl": "Tijd-vergrendelde encryptie gebaseerd op computationele puzzels"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reducing transaction fees across all participating chains",
                  "es": "Reducir tarifas de transacción en todas las cadenas participantes",
                  "de": "Transaktionsgebühren über alle teilnehmenden Ketten reduzieren",
                  "nl": "Transactiekosten verminderen over alle deelnemende ketens"
        },
        {
                  "en": "Maximizing mining rewards across multiple networks",
                  "es": "Maximizar recompensas de minería a través de múltiples redes",
                  "de": "Mining-Belohnungen über mehrere Netzwerke maximieren",
                  "nl": "Mining beloningen maximaliseren over meerdere netwerken"
        },
        {
                  "en": "Achieving global state consistency across heterogeneous blockchain architectures",
                  "es": "Lograr consistencia de estado global a través de arquitecturas blockchain heterogéneas",
                  "de": "Globale Zustandskonsistenz über heterogene Blockchain-Architekturen erreichen",
                  "nl": "Globale toestand consistentie bereiken over heterogene blockchain architecturen"
        },
        {
                  "en": "Standardizing smart contract languages for interoperability",
                  "es": "Estandarizar lenguajes de contratos inteligentes para interoperabilidad",
                  "de": "Smart-Contract-Sprachen für Interoperabilität standardisieren",
                  "nl": "Smart contract talen standaardiseren voor interoperabiliteit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trading perfect soundness for practical verification efficiency with bounded error rates",
                  "es": "Intercambiar solidez perfecta por eficiencia de verificación práctica con tasas de error limitadas",
                  "de": "Perfekte Soundness gegen praktische Verifikationseffizienz mit begrenzten Fehlerraten eintauschen",
                  "nl": "Perfecte soliditeit ruilen voor praktische verificatie efficiëntie met begrensde foutpercentages"
        },
        {
                  "en": "Requiring multiple independent verifications for certainty",
                  "es": "Requerir múltiples verificaciones independientes para certeza",
                  "de": "Mehrere unabhängige Verifikationen für Gewissheit erfordern",
                  "nl": "Meerdere onafhankelijke verificaties vereisen voor zekerheid"
        },
        {
                  "en": "Using only deterministic proofs without probability",
                  "es": "Usar solo pruebas determinísticas sin probabilidad",
                  "de": "Nur deterministische Beweise ohne Wahrscheinlichkeit verwenden",
                  "nl": "Alleen deterministische bewijzen gebruiken zonder waarschijnlijkheid"
        },
        {
                  "en": "Eliminating all verification requirements for maximum speed",
                  "es": "Eliminar todos los requisitos de verificación para velocidad máxima",
                  "de": "Alle Verifikationsanforderungen für maximale Geschwindigkeit eliminieren",
                  "nl": "Alle verificatie vereisten elimineren voor maximale snelheid"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Security against adversaries who can adaptively corrupt participants based on observed behavior",
                  "es": "Seguridad contra adversarios que pueden corromper adaptativamente participantes basado en comportamiento observado",
                  "de": "Sicherheit gegen Gegner, die Teilnehmer adaptiv basierend auf beobachtetem Verhalten korrumpieren können",
                  "nl": "Beveiliging tegen tegenstanders die adaptatief deelnemers kunnen corrumperen gebaseerd op geobserveerd gedrag"
        },
        {
                  "en": "Self-healing networks that recover from node failures",
                  "es": "Redes de auto-sanación que se recuperan de fallas de nodos",
                  "de": "Selbstheilende Netzwerke, die sich von Knotenausfällen erholen",
                  "nl": "Zelfherstellende netwerken die herstellen van node storingen"
        },
        {
                  "en": "Dynamic fee structures responding to transaction demand",
                  "es": "Estructuras de tarifas dinámicas respondiendo a demanda de transacciones",
                  "de": "Dynamische Gebührenstrukturen als Reaktion auf Transaktionsnachfrage",
                  "nl": "Dynamische kostenstructuren die reageren op transactiedemand"
        },
        {
                  "en": "Automatic adjustment of consensus parameters based on network conditions",
                  "es": "Ajuste automático de parámetros de consenso basado en condiciones de red",
                  "de": "Automatische Anpassung von Konsensparametern basierend auf Netzwerkbedingungen",
                  "nl": "Automatische aanpassing van consensus parameters gebaseerd op netwerkomstandigheden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Providing quantum-resistant encryption for all data operations",
                  "es": "Proporcionar cifrado resistente a cuánticos para todas las operaciones de datos",
                  "de": "Quantenresistente Verschlüsselung für alle Datenoperationen bereitstellen",
                  "nl": "Quantum-resistente encryptie bieden voor alle data operaties"
        },
        {
                  "en": "Reducing storage requirements through advanced compression algorithms",
                  "es": "Reducir requisitos de almacenamiento a través de algoritmos de compresión avanzados",
                  "de": "Speicheranforderungen durch fortgeschrittene Kompressionsalgorithmen reduzieren",
                  "nl": "Opslagvereisten verminderen door geavanceerde compressie algoritmen"
        },
        {
                  "en": "Enabling automatic verification of smart contract correctness",
                  "es": "Permitir verificación automática de corrección de contratos inteligentes",
                  "de": "Automatische Verifikation der Smart-Contract-Korrektheit ermöglichen",
                  "nl": "Automatische verificatie van smart contract correctheid mogelijk maken"
        },
        {
                  "en": "Enabling proofs of arbitrary computations on committed data without revealing the data",
                  "es": "Permitir pruebas de computaciones arbitrarias en datos comprometidos sin revelar los datos",
                  "de": "Beweise für beliebige Berechnungen auf committed Daten ermöglichen, ohne die Daten preiszugeben",
                  "nl": "Bewijzen van willekeurige berekeningen op gecommitteerde data mogelijk maken zonder de data te onthullen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reputation-based voting weights for consensus participation",
                  "es": "Pesos de votación basados en reputación para participación en consenso",
                  "de": "Reputationsbasierte Stimmgewichte für Konsensteilnahme",
                  "nl": "Reputatie-gebaseerde stemgewichten voor consensus deelname"
        },
        {
                  "en": "Time-delayed reward distribution to prevent manipulation",
                  "es": "Distribución de recompensas con retraso temporal para prevenir manipulación",
                  "de": "Zeitverzögerte Belohnungsverteilung zur Manipulationsverhinderung",
                  "nl": "Tijd-vertraagde beloning distributie om manipulatie te voorkomen"
        },
        {
                  "en": "Economic penalties that make Byzantine behavior financially irrational",
                  "es": "Penalidades económicas que hacen comportamiento bizantino financieramente irracional",
                  "de": "Wirtschaftliche Strafen, die byzantinisches Verhalten finanziell irrational machen",
                  "nl": "Economische boetes die byzantijns gedrag financieel irrationeel maken"
        },
        {
                  "en": "Automatic slashing of all malicious validators' stakes",
                  "es": "Slashing automático de todas las apuestas de validadores maliciosos",
                  "de": "Automatisches Slashing aller Stakes böswilliger Validatoren",
                  "nl": "Automatische slashing van alle stakes van kwaadaardige validators"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Constant-size proofs for position-binding commitments regardless of vector size",
                  "es": "Pruebas de tamaño constante para compromisos de vinculación de posición independientemente del tamaño del vector",
                  "de": "Konstante Beweis-Größe für positionsbindende Commitments unabhängig von der Vektorgröße",
                  "nl": "Constante grootte bewijzen voor positie-bindende commitments ongeacht vector grootte"
        },
        {
                  "en": "Linear time complexity for all update operations",
                  "es": "Complejidad de tiempo lineal para todas las operaciones de actualización",
                  "de": "Lineare Zeitkomplexität für alle Update-Operationen",
                  "nl": "Lineaire tijd complexiteit voor alle update operaties"
        },
        {
                  "en": "Automatic compression of sparse data structures",
                  "es": "Compresión automática de estructuras de datos dispersas",
                  "de": "Automatische Kompression spärlicher Datenstrukturen",
                  "nl": "Automatische compressie van sparse datastructuren"
        },
        {
                  "en": "Built-in quantum resistance without additional overhead",
                  "es": "Resistencia cuántica incorporada sin sobrecarga adicional",
                  "de": "Eingebaute Quantenresistenz ohne zusätzlichen Overhead",
                  "nl": "Ingebouwde quantum weerstand zonder extra overhead"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Simultaneous optimization across throughput, latency, storage, and bandwidth dimensions",
                  "es": "Optimización simultánea a través de dimensiones de rendimiento, latencia, almacenamiento y ancho de banda",
                  "de": "Simultane Optimierung über Durchsatz-, Latenz-, Speicher- und Bandbreitendimensionen",
                  "nl": "Simultane optimalisatie over doorvoer, latentie, opslag, en bandbreedte dimensies"
        },
        {
                  "en": "Optimizing mining rewards across different cryptocurrency types",
                  "es": "Optimizar recompensas de minería a través de diferentes tipos de criptomonedas",
                  "de": "Mining-Belohnungen über verschiedene Kryptowährungstypen optimieren",
                  "nl": "Mining beloningen optimaliseren over verschillende cryptocurrency types"
        },
        {
                  "en": "Balancing transaction fees with network security guarantees",
                  "es": "Equilibrar tarifas de transacción con garantías de seguridad de red",
                  "de": "Transaktionsgebühren mit Netzwerksicherheitsgarantien ausbalancieren",
                  "nl": "Transactiekosten balanceren met netwerkbeveiligingsgaranties"
        },
        {
                  "en": "Trading consensus speed for decentralization levels",
                  "es": "Intercambiar velocidad de consenso por niveles de descentralización",
                  "de": "Konsensgeschwindigkeit gegen Dezentralisierungsgrade eintauschen",
                  "nl": "Consensus snelheid ruilen voor decentralisatie niveaus"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Directed acyclic graph allowing multiple parent references for enhanced data integrity",
                  "es": "Grafo acíclico dirigido que permite múltiples referencias padre para integridad de datos mejorada",
                  "de": "Gerichteter azyklischer Graph, der mehrere Elternreferenzen für verbesserte Datenintegrität ermöglicht",
                  "nl": "Gerichte acyclische graaf die meerdere ouder referenties toestaat voor verbeterde data integriteit"
        },
        {
                  "en": "Centralized database with Merkle verification",
                  "es": "Base de datos centralizada con verificación Merkle",
                  "de": "Zentralisierte Datenbank mit Merkle-Verifikation",
                  "nl": "Gecentraliseerde database met Merkle verificatie"
        },
        {
                  "en": "Encrypted version of standard Merkle trees",
                  "es": "Versión encriptada de árboles Merkle estándar",
                  "de": "Verschlüsselte Version von Standard-Merkle-Bäumen",
                  "nl": "Versleutelde versie van standaard Merkle trees"
        },
        {
                  "en": "Linear structure for faster hash computations",
                  "es": "Estructura lineal para cálculos hash más rápidos",
                  "de": "Lineare Struktur für schnellere Hash-Berechnungen",
                  "nl": "Lineaire structuur voor snellere hash berekeningen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No rewards are given to validators",
                  "es": "No se dan recompensas a los validadores",
                  "de": "Keine Belohnungen werden an Validatoren gegeben",
                  "nl": "Geen beloningen worden gegeven aan validators"
        },
        {
                  "en": "Validators can vote on multiple competing chains without penalty",
                  "es": "Los validadores pueden votar en múltiples cadenas competidoras sin penalización",
                  "de": "Validatoren können auf mehrere konkurrierende Ketten ohne Strafe abstimmen",
                  "nl": "Validators kunnen stemmen op meerdere concurrerende chains zonder boete"
        },
        {
                  "en": "Stake amounts must be exactly zero",
                  "es": "Las cantidades de stake deben ser exactamente cero",
                  "de": "Stake-Beträge müssen genau null sein",
                  "nl": "Stake bedragen moeten precies nul zijn"
        },
        {
                  "en": "Validators lose all staked tokens automatically",
                  "es": "Los validadores pierden todos los tokens apostados automáticamente",
                  "de": "Validatoren verlieren automatisch alle gestakten Token",
                  "nl": "Validators verliezen automatisch alle gestakte tokens"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Database encryption method for blockchain storage",
                  "es": "Método de encriptación de base de datos para almacenamiento blockchain",
                  "de": "Datenbank-Verschlüsselungsmethode für Blockchain-Speicherung",
                  "nl": "Database encryptie methode voor blockchain opslag"
        },
        {
                  "en": "Smart contract programming language",
                  "es": "Lenguaje de programación de contratos inteligentes",
                  "de": "Smart Contract Programmiersprache",
                  "nl": "Smart contract programmeertaal"
        },
        {
                  "en": "Consensus mechanism for private blockchains",
                  "es": "Mecanismo de consenso para blockchains privadas",
                  "de": "Konsensmechanismus für private Blockchains",
                  "nl": "Consensus mechanisme voor private blockchains"
        },
        {
                  "en": "Succinct proof system using polynomial commitment schemes and trusted setup",
                  "es": "Sistema de prueba sucinta usando esquemas de compromiso polinomial y configuración confiable",
                  "de": "Sukzinctes Beweis-System mit polynomialen Commitment-Schemata und vertrauenswürdigem Setup",
                  "nl": "Beknopt bewijs systeem met polynomiale commitment schema's en vertrouwde setup"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Balance between legitimacy, efficiency, and decentralization in decision-making",
                  "es": "Equilibrio entre legitimidad, eficiencia y descentralización en toma de decisiones",
                  "de": "Gleichgewicht zwischen Legitimität, Effizienz und Dezentralisierung bei Entscheidungsfindung",
                  "nl": "Balans tussen legitimiteit, efficiëntie en decentralisatie in besluitvorming"
        },
        {
                  "en": "Conflict between miners, developers, and users",
                  "es": "Conflicto entre mineros, desarrolladores y usuarios",
                  "de": "Konflikt zwischen Minern, Entwicklern und Nutzern",
                  "nl": "Conflict tussen miners, ontwikkelaars en gebruikers"
        },
        {
                  "en": "Choice between public, private, and consortium blockchains",
                  "es": "Elección entre blockchains públicas, privadas y de consorcio",
                  "de": "Wahl zwischen öffentlichen, privaten und Konsortium-Blockchains",
                  "nl": "Keuze tussen publieke, private en consortium blockchains"
        },
        {
                  "en": "Trade-off between speed, security, and cost",
                  "es": "Intercambio entre velocidad, seguridad y costo",
                  "de": "Trade-off zwischen Geschwindigkeit, Sicherheit und Kosten",
                  "nl": "Afweging tussen snelheid, veiligheid en kosten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Security audit process for DeFi protocols",
                  "es": "Proceso de auditoría de seguridad para protocolos DeFi",
                  "de": "Sicherheitsaudit-Prozess für DeFi-Protokolle",
                  "nl": "Beveiligingsaudit proces voor DeFi protocollen"
        },
        {
                  "en": "Security guarantees that hold when protocols interact across different blockchain networks",
                  "es": "Garantías de seguridad que se mantienen cuando los protocolos interactúan a través de diferentes redes blockchain",
                  "de": "Sicherheitsgarantien, die gelten, wenn Protokolle über verschiedene Blockchain-Netzwerke hinweg interagieren",
                  "nl": "Beveiligingsgaranties die gelden wanneer protocollen interageren over verschillende blockchain netwerken"
        },
        {
                  "en": "Modular security architecture for smart contracts",
                  "es": "Arquitectura de seguridad modular para contratos inteligentes",
                  "de": "Modulare Sicherheitsarchitektur für Smart Contracts",
                  "nl": "Modulaire beveiligingsarchitectuur voor smart contracts"
        },
        {
                  "en": "Encryption method for cross-chain transactions",
                  "es": "Método de encriptación para transacciones cross-chain",
                  "de": "Verschlüsselungsmethode für Cross-Chain-Transaktionen",
                  "nl": "Encryptie methode voor cross-chain transacties"
        }
        ],
        correct: 1,
        explanation: {
