    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "To increase filling speed",
                  "es": "Para aumentar la velocidad de llenado",
                  "de": "Um die Füllgeschwindigkeit zu erhöhen",
                  "nl": "Om de vulsnelheid te verhogen"
        },
        {
                  "en": "To filter the beverage",
                  "es": "Para filtrar la bebida",
                  "de": "Um das Getränk zu filtern",
                  "nl": "Om de drank te filteren"
        },
        {
                  "en": "To add preservatives",
                  "es": "Para añadir conservantes",
                  "de": "Um Konservierungsmittel hinzuzufügen",
                  "nl": "Om conserveermiddelen toe te voegen"
        },
        {
                  "en": "To maintain CO2 levels during filling",
                  "es": "Para mantener los niveles de CO2 durante el llenado",
                  "de": "Um CO2-Werte während des Füllens zu erhalten",
                  "nl": "Om CO2-niveaus tijdens vullen te behouden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "BHA (Butylated hydroxyanisole)",
                  "es": "BHA (Hidroxianisol butilado)",
                  "de": "BHA (Butylhydroxyanisol)",
                  "nl": "BHA (Gebutyleerd hydroxyanisol)"
        },
        {
                  "en": "Sodium chloride",
                  "es": "Cloruro de sodio",
        ...
        },
        {
                  ...
                  "es": "Ácido ascórbico (Vitamina C)",
                  "de": "Ascorbinsäure (Vitamin C)",
                  "nl": "Ascorbinezuur (Vitamine C)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "5-10 times longer",
                  "es": "5-10 veces más largo",
                  "de": "5-10 mal länger",
                  "nl": "5-10 keer langer"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Poor visual appearance",
                  "es": "Apariencia visual pobre",
                  "de": "Schlechtes visuelles Erscheinungsbild",
                  "nl": "Slechte visuele uitstraling"
        },
        {
                  "en": "Reduced carbonation retention",
                  "es": "Retención reducida de carbonatación",
                  "de": "Reduzierte Kohlensäure-Retention",
                  "nl": "Verminderde koolzuurretentie"
        },
        {
                  "en": "Higher cost",
                  "es": "Mayor costo",
        ...
        {
                  "en": "Potential migration of contaminants",
                  "es": "Posible migración de contaminantes",
                  "de": "Mögliche Migration von Schadstoffen",
                  "nl": "Mogelijke migratie van verontreinigingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To sterilize the package",
                  "es": "Para esterilizar el empaque",
                  "de": "Um die Verpackung zu sterilisieren",
                  "nl": "Om de verpakking te steriliseren"
        },
        {
                  "en": "To add flavor",
        ...
        {
                  "en": "To displace oxygen and prevent oxidation",
                  "es": "Para desplazar oxígeno y prevenir oxidación",
                  "de": "Um Sauerstoff zu verdrängen und Oxidation zu verhindern",
                  "nl": "Om zuurstof te verdringen en oxidatie te voorkomen"
        },
        {
                  "en": "To increase carbonation",
                  "es": "Para aumentar carbonatación",
                  "de": "Um Karbonisierung zu erhöhen",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Consistent pore size and reusability",
                  "es": "Tamaño de poro consistente y reutilización",
                  "de": "Konsistente Porengröße und Wiederverwendbarkeit",
                  "nl": "Consistente poriëngrootte en herbruikbaarheid"
        },
        {
                  "en": "Lower cost",
                  "es": "Menor costo",
        ...
        {
                  "en": "Faster filtration speed",
                  "es": "Velocidad de filtración más rápida",
                  "de": "Schnellere Filtrationsgeschwindigkeit",
                  "nl": "Snellere filtratiesnelheid"
        },
        {
                  "en": "Better flavor enhancement",
                  "es": "Mejor realce del sabor",
                  "de": "Bessere Geschmacksverbesserung",
                  "nl": "Betere smaakverbetering"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Color of the liquid",
                  "es": "Color del líquido",
                  "de": "Farbe der Flüssigkeit",
                  "nl": "Kleur van de vloeistof"
        },
        {
                  "en": "Brand of beverage",
                  "es": "Marca de la bebida",
                  "de": "Getränkemarke",
                  "nl": "Merk van de drank"
        },
        {
                  "en": "Temperature",
                  "es": "Temperatura",
        ...
        },
        {
                  ...
                  "es": "Material del contenedor",
                  "de": "Behältermaterial",
                  "nl": "Containermateriaal"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measuring pH levels",
                  "es": "Medir niveles de pH",
                  "de": "pH-Werte messen",
                  "nl": "pH-niveaus meten"
        },
        {
                  ...
                  "es": "Limpiar equipos",
                  "de": "Geräte reinigen",
                  "nl": "Apparatuur reinigen"
        },
        {
                  "en": "Only carbonating beverages",
                  "es": "Solo carbonatar bebidas",
                  "de": "Nur Getränke karbonisieren",
                  "nl": "Alleen dranken carbonateren"
        },
        {
                  "en": "Extracting essential oils/flavors without heat degradation or solvent residues",
                  "es": "Extraer aceites esenciales/sabores sin degradación por calor o residuos de solvente",
                  "de": "Extraktion ätherischer Öle/Aromen ohne Hitzeschädigung oder Lösungsmittelrückstände",
                  "nl": "Extractie van essentiële oliën/smaken zonder hittedegradatie of oplosmiddelresiduen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hollow fiber membranes allowing precise CO₂ transfer without bubble formation or foaming",
                  "es": "Membranas de fibra hueca permitiendo transferencia precisa CO₂ sin formación burbujas o espuma",
                  "de": "Hohlfasermembranen ermöglichen präzise CO₂-Transfer ohne Blasenbildung oder Schaumbildung",
                  "nl": "Holle vezelmembranen die precieze CO₂-overdracht mogelijk maken zonder belvorming of schuimen"
        },
        {
                  "en": "Only measures carbonation levels",
                  "es": "Solo mide niveles carbonatación",
                  "de": "Misst nur Karbonisierungsniveaus",
                  "nl": "Meet alleen carbonatieniveaus"
        },
        {
                  "en": "Removes sugar from beverages",
                  "es": "Elimina azúcar de bebidas",
                  "de": "Entfernt Zucker aus Getränken",
                  "nl": "Verwijdert suiker uit dranken"
        },
        {
                  "en": "Cleans bottles before filling",
                  "es": "Limpia botellas antes llenar",
                  "de": "Reinigt Flaschen vor dem Befüllen",
                  "nl": "Reinigt flessen voor vullen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tangential flow prevents membrane fouling, continuous operation without frequent cleaning, higher throughput",
                  "es": "Flujo tangencial previene ensuciamiento membrana, operación continua sin limpieza frecuente, mayor rendimiento",
                  "de": "Tangentialfluss verhindert Membranverschmutzung, kontinuierlicher Betrieb ohne häufige Reinigung, höherer Durchsatz",
                  "nl": "Tangentiële stroming voorkomt membraanvervuiling, continue werking zonder frequente reiniging, hogere doorvoer"
        },
        {
                  "en": "Only removes larger particles",
                  "es": "Solo elimina partículas más grandes",
                  "de": "Entfernt nur größere Partikel",
                  "nl": "Verwijdert alleen grotere deeltjes"
        },
        {
                  "en": "Only works with clear liquids",
                  "es": "Solo funciona con líquidos claros",
                  "de": "Funktioniert nur mit klaren Flüssigkeiten",
                  "nl": "Werkt alleen met heldere vloeistoffen"
        },
        {
                  "en": "Only cheaper to operate",
                  "es": "Solo más barato operar",
                  "de": "Nur billiger zu betreiben",
                  "nl": "Alleen goedkoper te bedienen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ionized gas generating reactive species (UV, ozone, radicals) destroying microbes without heat, preserving flavor/nutrients",
                  "es": "Gas ionizado generando especies reactivas (UV, ozono, radicales) destruyendo microbios sin calor, preservando sabor/nutrientes",
                  "de": "Ionisiertes Gas erzeugt reaktive Spezies (UV, Ozon, Radikale) zerstört Mikroben ohne Hitze, bewahrt Geschmack/Nährstoffe",
                  "nl": "Geïoniseerd gas genererend reactieve soorten (UV, ozon, radicalen) vernietigt microben zonder hitte, behoudt smaak/voedingsstoffen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Generating microbubbles that implode creating localized high pressure/temperature zones for microbial inactivation and mixing",
                  "es": "Generar microburbujas que implosionan creando zonas localizadas alta presión/temperatura para inactivación microbiana y mezclado",
                  "de": "Erzeugen von Mikroblasen die implodieren und lokalisierte Hochdruck/Temperaturzonen für mikrobielle Inaktivierung und Mischung schaffen",
                  "nl": "Genereren van microbellen die imploderen creërend gelokaliseerde hoge druk/temperatuurzones voor microbiële inactivatie en menging"
        },
        {
                  "en": "Only measures liquid density",
                  "es": "Solo mide densidad líquido",
                  "de": "Misst nur Flüssigkeitsdichte",
                  "nl": "Meet alleen vloeistofdichtheid"
        },
        {
                  "en": "Only carbonates beverages",
                  "es": "Solo carbonata bebidas",
                  "de": "Karbonisiert nur Getränke",
                  "nl": "Carboneert alleen dranken"
        },
        {
                  "en": "Only removes air bubbles",
                  "es": "Solo elimina burbujas aire",
                  "de": "Entfernt nur Luftblasen",
                  "nl": "Verwijdert alleen luchtbellen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only carbonates drinks",
                  "es": "Solo carbonata bebidas",
                  "de": "Karbonisiert nur Getränke",
                  "nl": "Carboneert alleen dranken"
        },
        {
                  "en": "300-600 MPa pressure inactivates microbes by protein denaturation while preserving vitamins, color, flavor at cold temperature",
                  "es": "Presión 300-600 MPa inactiva microbios por desnaturalización proteína mientras preserva vitaminas, color, sabor a temperatura fría",
                  "de": "300-600 MPa Druck inaktiviert Mikroben durch Proteindenaturierung während Vitamine, Farbe, Geschmack bei kalter Temperatur erhalten bleiben",
                  "nl": "300-600 MPa druk inactiveert microben door eiwitdenaturatie terwijl vitamines, kleur, smaak bij koude temperatuur behouden blijven"
        },
        {
                  "en": "Only removes color",
                  "es": "Solo elimina color",
                  "de": "Entfernt nur Farbe",
                  "nl": "Verwijdert alleen kleur"
        },
        {
                  "en": "Only increases shelf life slightly",
                  "es": "Solo aumenta vida útil ligeramente",
                  "de": "Erhöht nur Haltbarkeit geringfügig",
                  "nl": "Verhoogt alleen houdbaarheid lichtjes"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Only removes particles",
                  "es": "Solo elimina partículas",
                  "de": "Entfernt nur Partikel",
                  "nl": "Verwijdert alleen deeltjes"
        },
        {
                  "en": "Short high-voltage pulses (20-80 kV/cm, microseconds) create pores in microbial membranes causing cell death without heating",
                  "es": "Pulsos cortos alto voltaje (20-80 kV/cm, microsegundos) crean poros en membranas microbianas causando muerte celular sin calentamiento",
                  "de": "Kurze Hochspannungsimpulse (20-80 kV/cm, Mikrosekunden) erzeugen Poren in mikrobiellen Membranen verursachen Zelltod ohne Erhitzung",
                  "nl": "Korte hoogspanningspulsen (20-80 kV/cm, microseconden) creëren poriën in microbiële membranen veroorzakend celdood zonder verhitting"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bio-based solvent mixtures (sugars, acids, amino acids) with unique solvation power for natural compound extraction without toxic solvents",
                  "es": "Mezclas disolventes bio-basados (azúcares, ácidos, aminoácidos) con poder solvatación único para extracción compuestos naturales sin disolventes tóxicos",
                  "de": "Biobasierte Lösungsmittelgemische (Zucker, Säuren, Aminosäuren) mit einzigartiger Lösungskraft für natürliche Verbindungsextraktion ohne toxische Lösungsmittel",
                  "nl": "Bio-gebaseerde oplosmiddelmengsels (suikers, zuren, aminozuren) met uniek oplossend vermogen voor natuurlijke verbindingsextractie zonder toxische oplosmiddelen"
        },
        {
                  "en": "Only petroleum derivatives",
                  "es": "Solo derivados petróleo",
                  "de": "Nur Erdölderivate",
                  "nl": "Alleen aardolieproducten"
        },
        {
                  "en": "Only water-based solutions",
                  "es": "Solo soluciones base agua",
                  "de": "Nur wasserbasierte Lösungen",
                  "nl": "Alleen watergebaseerde oplossingen"
        },
        {
                  "en": "Only synthetic chemicals",
                  "es": "Solo químicos sintéticos",
                  "de": "Nur synthetische Chemikalien",
                  "nl": "Alleen synthetische chemicaliën"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only inventory counting",
                  "es": "Solo conteo inventario",
                  "de": "Nur Inventarzählung",
                  "nl": "Alleen voorraadtelling"
        },
        {
                  "en": "Only tracks shipping containers",
                  "es": "Solo rastrea contenedores envío",
                  "de": "Verfolgt nur Versandbehälter",
                  "nl": "Volgt alleen verzendcontainers"
        },
        {
                  "en": "Immutable distributed ledger recording ingredient origin, processing steps, quality data enabling transparency and authenticity verification",
                  "es": "Libro contable distribuido inmutable registrando origen ingredientes, pasos procesamiento, datos calidad permitiendo transparencia y verificación autenticidad",
                  "de": "Unveränderliches verteiltes Hauptbuch aufzeichnend Zutatenherkünft, Verarbeitungsschritte, Qualitätsdaten ermöglicht Transparenz und Authentizitätsprüfung",
                  "nl": "Onveranderlijk gedistribueerd grootboek registrerend ingrediënt oorsprong, verwerkingsstappen, kwaliteitsgegevens mogelijk makend transparantie en authenticiteitsverificatie"
        },
        {
                  "en": "Only cryptocurrency payment",
                  "es": "Solo pago criptomoneda",
                  "de": "Nur Kryptowährungszahlung",
                  "nl": "Alleen cryptocurrency betaling"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only counts bacteria manually",
                  "es": "Solo cuenta bacterias manualmente",
                  "de": "Zählt nur Bakterien manuell",
                  "nl": "Telt alleen bacteriën handmatig"
        },
        {
                  "en": "Only checks expiration dates",
                  "es": "Solo verifica fechas vencimiento",
                  "de": "Überprüft nur Verfallsdaten",
                  "nl": "Controleert alleen vervaldatums"
        },
        {
                  "en": "AI algorithms predicting microbial growth/inactivation rates based on formulation, processing, storage conditions optimizing safety protocols",
                  "es": "Algoritmos IA prediciendo tasas crecimiento/inactivación microbiana basadas en formulación, procesamiento, condiciones almacenamiento optimizando protocolos seguridad",
                  "de": "KI-Algorithmen vorhersagen mikrobielle Wachstums-/Inaktivierungsraten basierend auf Formulierung, Verarbeitung, Lagerbedingungen optimieren Sicherheitsprotokolle",
                  "nl": "AI algoritmen voorspellend microbiële groei/inactivatiesnelheden gebaseerd op formulering, verwerking, opslagcondities optimaliseren veiligheidsprotocollen"
        },
        {
                  "en": "Only measures pH",
                  "es": "Solo mide pH",
