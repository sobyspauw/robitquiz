    ...
    questions: [
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Para proporcionar acidez y preservar el sabor",
                  "de": "Um Säure zu liefern und Geschmack zu bewahren",
                  "nl": "Om zuurheid te geven en smaak te bewaren"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "Synthetic caffeine",
                  "es": "Cafeína sintética",
                  "de": "Synthetisches Koffein",
                  "nl": "Synthetische cafeïne"
        },
        {
                  "en": "Coffee extract",
                  "es": "Extracto de café",
      ...
      },
      {
        ...
        {
                  "en": "Sugar vs artificial sweeteners",
                  "es": "Azúcar vs edulcorantes artificiales",
                  "de": "Zucker vs künstliche Süßstoffe",
                  "nl": "Suiker vs kunstmatige zoetstoffen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Vitamin C supplements",
                  "es": "Suplementos de vitamina C",
                  "de": "Vitamin-C-Präparate",
                  "nl": "Vitamine C supplementen"
        },
        {
                  "en": "Artificial fruit flavors only",
                  "es": "Solo sabores artificiales de fruta",
                  "de": "Nur künstliche Fruchtaromen",
                  "nl": "Alleen kunstmatige fruitsmaken"
        },
        {
                  "en": "Food coloring",
        ...
        {
                  "en": "Natural citrus oils and essences",
                  "es": "Aceites y esencias cítricas naturales",
                  "de": "Natürliche Zitrusöle und -essenzen",
                  "nl": "Natuurlijke citrusoliën en -essences"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "To kill harmful bacteria and extend shelf life",
                  "es": "Para matar bacterias dañinas y extender la vida útil",
                  "de": "Um schädliche Bakterien zu töten und die Haltbarkeit zu verlängern",
                  "nl": "Om schadelijke bacteriën te doden en houdbaarheid te verlengen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tunnel pasteurizes packaged product gradually through temperature zones; flash pasteurizes bulk liquid rapidly at high temperature",
                  "es": "Túnel pasteuriza producto empaquetado gradualmente por zonas temperatura; flash pasteuriza líquido a granel rápidamente a alta temperatura",
                  "de": "Tunnel pasteurisiert verpacktes Produkt schrittweise durch Temperaturzonen; Flash pasteurisiert Flüssigkeit in großen Mengen schnell bei hoher Temperatur",
                  "nl": "Tunnel pasteuriseert verpakt product geleidelijk door temperatuurzones; flash pasteuriseert bulk vloeistof snel bij hoge temperatuur"
        },
        {
        ...
        {
                  "en": "Flash takes longer",
                  "es": "Flash toma más tiempo",
                  "de": "Flash dauert länger",
                  "nl": "Flash duurt langer"
        },
        {
                  "en": "Only tunnel uses heat",
                  "es": "Solo túnel usa calor",
                  "de": "Nur Tunnel verwendet Hitze",
                  "nl": "Alleen tunnel gebruikt warmte"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Excessive sugar crystallization",
                  "es": "Cristalización azúcar excesiva",
                  "de": "Übermäßige Zuckerkristallisation",
                  "nl": "Overmatige suikerkristallisatie"
        },
        {
                  "en": "Proteins precipitate with tannins/polyphenols; prevented by protease enzymes or filtration",
                  "es": "Proteínas precipitan con taninos/polifenoles; prevenido por enzimas proteasa o filtración",
                  "de": "Proteine präzipitieren mit Tanninen/Polyphenolen; verhindert durch Protease-Enzyme oder Filtration",
                  "nl": "Eiwitten precipiteren met tannines/polyfenolen; voorkomen door protease enzymen of filtratie"
        },
        {
                  "en": "Color additives reacting",
                  "es": "Aditivos color reaccionando",
                  "de": "Farbzusätze reagieren",
                  "nl": "Kleuradditieven reageren"
        },
        {
                  "en": "Too much carbonation",
                  "es": "Demasiada carbonatación",
                  "de": "Zu viel Kohlensäure",
                  "nl": "Te veel carbonatie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Agente carbonatación",
                  "de": "Kohlensäuremittel",
                  "nl": "Carbonatiemiddel"
        },
        {
                  "en": "Emulsifier that stabilizes citrus oils preventing separation and ring formation",
                  "es": "Emulsionante que estabiliza aceites cítricos previniendo separación y formación anillo",
                  "de": "Emulgator der Zitrusöle stabilisiert verhindert Trennung und Ringbildung",
                  "nl": "Emulgator die citrusoliën stabiliseert voorkomt scheiding en ringvorming"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Potenciador carbonatación",
                  "de": "Kohlensäureverstärker",
                  "nl": "Carbonatieversterker"
        },
        {
                  "en": "Emulsifier/weighting agent for citrus oils; controversial due to bromine accumulation health concerns",
                  "es": "Emulsionante/agente ponderación aceites cítricos; controversial por preocupaciones salud acumulación bromo",
                  "de": "Emulgator/Gewichtungsmittel für Zitrusöle; umstritten wegen Brom-Akkumulation Gesundheitsbedenken",
                  "nl": "Emulgator/wegingsmiddel voor citrusoliën; controversieel vanwege broomaccumulatie gezondheidsrisico's"
        },
        {
                  "en": "Primary flavor compound",
                  "es": "Compuesto sabor principal",
                  "de": "Hauptgeschmacksverbindung",
                  "nl": "Primaire smaakstof"
        },
        {
                  "en": "Natural colorant",
                  "es": "Colorante natural",
                  "de": "Natürlicher Farbstoff",
                  "nl": "Natuurlijke kleurstof"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sugar concentration measurement",
                  "es": "Medida concentración azúcar",
                  "de": "Zuckerkonzentrationsmessung",
                  "nl": "Suikerconcentratiemeting"
        },
        {
                  "en": "Temperature coefficient showing microbial inactivation rate doubles with every 10°C increase",
                  "es": "Coeficiente temperatura mostrando tasa inactivación microbiana duplica con cada aumento 10°C",
                  "de": "Temperaturkoeffizient zeigt mikrobielle Inaktivierungsrate verdoppelt sich bei jedem 10°C Anstieg",
                  "nl": "Temperatuurcoëfficiënt toont microbiële inactivatiesnelheid verdubbelt met elke 10°C stijging"
        },
        {
                  "en": "Carbonation level",
                  "es": "Nivel carbonatación",
      ...
      },
      {
        ...
        },
        {
                  ...
                  "es": "Fluctuación temperatura",
                  "de": "Temperaturschwankung",
                  "nl": "Temperatuurschommeling"
        },
        {
                  "en": "Oxidation of caramel color compounds forming pink chromophores; prevented by antioxidants and oxygen control",
                  "es": "Oxidación compuestos color caramelo formando cromóforos rosa; prevenido por antioxidantes y control oxígeno",
                  "de": "Oxidation von Karamellfarbverbindungen bildet rosa Chromophore; verhindert durch Antioxidantien und Sauerstoffkontrolle",
                  "nl": "Oxidatie van karamelkleurverbindingen vormend roze chromoforen; voorkomen door antioxidanten en zuurstofcontrole"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding nitrogen fertilizer",
                  "es": "Añadir fertilizante nitrógeno",
                  "de": "Hinzufügen von Stickstoffdünger",
                  "nl": "Toevoegen stikstofmeststof"
        },
        {
                  "en": "Only for carbonation",
                  "es": "Solo para carbonatación",
                  "de": "Nur für Karbonisierung",
                  "nl": "Alleen voor carbonatie"
        },
        {
                  "en": "Nitrogen injection creating creamy foam and smooth mouthfeel when opened",
                  "es": "Inyección nitrógeno creando espuma cremosa y sensación bucal suave al abrir",
                  "de": "Stickstoffinjektion erzeugt cremigen Schaum und glattes Mundgefühl beim Öffnen",
                  "nl": "Stikstof injectie creërend romig schuim en glad mondgevoel bij openen"
        },
        {
                  "en": "Removing all gases",
                  "es": "Eliminar todos gases",
                  "de": "Entfernung aller Gase",
                  "nl": "Verwijderen alle gassen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Models reaction rate temperature dependence (k = Ae^(-Ea/RT)) predicting degradation at different storage temperatures",
                  "es": "Modela dependencia temperatura tasa reacción (k = Ae^(-Ea/RT)) prediciendo degradación a diferentes temperaturas almacenamiento",
                  "de": "Modelliert Reaktionsgeschwindigkeit Temperaturabhängigkeit (k = Ae^(-Ea/RT)) vorhersagt Abbau bei verschiedenen Lagertemperaturen",
                  "nl": "Modelleert reactiesnelheid temperatuurafhankelijkheid (k = Ae^(-Ea/RT)) voorspellend degradatie bij verschillende opslagtemperaturen"
        },
        {
                  "en": "Determines bottle size",
                  "es": "Determina tamaño botella",
                  "de": "Bestimmt Flaschengröße",
                  "nl": "Bepaalt flesgrootte"
        },
        {
                  "en": "Only measures pH",
                  "es": "Solo mide pH",
        ...
        {
                  "en": "Calculates sugar content",
                  "es": "Calcula contenido azúcar",
                  "de": "Berechnet Zuckergehalt",
                  "nl": "Berekent suikergehalte"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Maillard reaction and caramelization causing color/flavor changes; accelerated by heat, high pH, metals",
                  "es": "Reacción Maillard y caramelización causando cambios color/sabor; acelerado por calor, pH alto, metales",
                  "de": "Maillard-Reaktion und Karamellisierung verursacht Farb-/Geschmacksveränderungen; beschleunigt durch Hitze, hoher pH, Metalle",
                  "nl": "Maillard reactie en karamelisatie veroorzakend kleur/smaak veranderingen; versneld door warmte, hoge pH, metalen"
        },
        {
                  "en": "Beneficial process",
                  "es": "Proceso beneficioso",
                  "de": "Vorteilhafter Prozess",
                  "nl": "Voordelig proces"
        },
        {
                  "en": "Only affects color, not flavor",
                  "es": "Solo afecta color, no sabor",
                  "de": "Betrifft nur Farbe, nicht Geschmack",
                  "nl": "Beïnvloedt alleen kleur, niet smaak"
        },
        {
                  "en": "Requires enzyme addition",
                  "es": "Requiere adición enzima",
                  "de": "Erfordert Enzymzugabe",
                  "nl": "Vereist enzymtoevoeging"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Betrifft nur Farbe",
                  "nl": "Beïnvloedt alleen kleur"
        },
        {
                  "en": "Flavor enhancement effect",
                  "es": "Efecto mejora sabor",
                  "de": "Geschmacksverstärkungseffekt",
                  "nl": "Smaakverbeterend effect"
        },
        {
                  "en": "Absorption of flavor compounds into packaging causing flavor loss; PET and HDPE most susceptible to limonene absorption",
                  "es": "Absorción compuestos sabor en empaque causando pérdida sabor; PET y HDPE más susceptibles a absorción limoneno",
                  "de": "Absorption von Geschmacksverbindungen in Verpackung verursacht Geschmacksverlust; PET und HDPE am anfälligsten für Limonen-Absorption",
                  "nl": "Absorptie van smaakstoffen in verpakking veroorzakend smaakverlies; PET en HDPE meest vatbaar voor limoneen absorptie"
        },
        {
                  "en": "Applies only to glass",
                  "es": "Aplica solo a vidrio",
                  "de": "Gilt nur für Glas",
                  "nl": "Geldt alleen voor glas"
        }
        ],
        correct: 2,
        explanation: {
