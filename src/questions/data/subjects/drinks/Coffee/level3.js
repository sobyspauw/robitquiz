...
(function() {
  const level3 = {
    ...
    },
    {
      ...
      options: [
        { en: "Espresso with chocolate and steamed milk", es: "Espresso with chocolate and steamed milk", de: "Espresso with chocolate and steamed milk", nl: "Espresso with chocolate and steamed milk" },
        { en: "Black coffee", es: "Black coffee", de: "Black coffee", nl: "Black coffee" },
        { en: "Iced coffee", es: "Iced coffee", de: "Iced coffee", nl: "Iced coffee" },
        { en: "Coffee beans from Mocha, Yemen", es: "Coffee beans from Mocha, Yemen", de: "Coffee beans from Mocha, Yemen", nl: "Coffee beans from Mocha, Yemen" }
      ],
      correct: 0,
      explanation: {
