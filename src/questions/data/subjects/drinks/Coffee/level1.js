  ...
  const level1 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Bubbling and dripping sounds", es: "Sonidos de burbujeo y goteo", de: "Blubbernde und tropfende Geräusche", nl: "Borrelende en druppelende geluiden" },
          { en: "Barking like a dog", es: "Ladridos como un perro", de: "Bellen wie ein Hund", nl: "Blaffen als een hond" },
          { en: "Singing a song", es: "Cantando una canción", de: "Ein Lied singen", nl: "Een liedje zingen" },
          { en: "Ringing like a bell", es: "Sonando como una campana", de: "Klingeln wie eine Glocke", nl: "Rinkelen als een bel" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "No, they grow on bushes above ground", es: "No, crecen en arbustos sobre el suelo", de: "Nein, sie wachsen auf Büschen über dem Boden", nl: "Nee, ze groeien op struiken boven de grond" },
          { en: "Yes, you dig them up like potatoes", es: "Sí, las desenterras como patatas", de: "Ja, man gräbt sie aus wie Kartoffeln", nl: "Ja, je graaft ze op zoals aardappels" },
          { en: "They grow on trees in the ocean", es: "Crecen en árboles en el océano", de: "Sie wachsen auf Bäumen im Ozean", nl: "Ze groeien op bomen in de oceaan" },
          { en: "They fall from the sky", es: "Caen del cielo", de: "Sie fallen vom Himmel", nl: "Ze vallen uit de lucht" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "You might feel too energetic and shaky", es: "Podrías sentirte demasiado enérgico y tembloroso", de: "Du könntest dich zu energiegeladen und zittrig fühlen", nl: "Je zou je te energiek en trillerig kunnen voelen" },
          { en: "You turn into a coffee bean", es: "Te conviertes en un grano de café", de: "Du verwandelst dich in eine Kaffeebohne", nl: "Je verandert in een koffieboon" },
          { en: "Your hair turns brown", es: "Tu cabello se vuelve marrón", de: "Deine Haare werden braun", nl: "Je haar wordt bruin" },
          { en: "Nothing happens at all", es: "No pasa nada en absoluto", de: "Es passiert überhaupt nichts", nl: "Er gebeurt helemaal niets" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Similar taste but without caffeine", es: "Sabor similar pero sin cafeína", de: "Ähnlicher Geschmack aber ohne Koffein", nl: "Vergelijkbare smaak maar zonder cafeïne" },
          { en: "Completely different drink", es: "Bebida completamente diferente", de: "Völlig anderes Getränk", nl: "Compleet ander drankje" },
          { en: "It's actually tea", es: "En realidad es té", de: "Es ist eigentlich Tee", nl: "Het is eigenlijk thee" },
          { en: "It's just water", es: "Es solo agua", de: "Es ist nur Wasser", nl: "Het is gewoon water" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Foam or froth", es: "Espuma", de: "Schaum", nl: "Schuim" },
      ...
      },
      {
        ...
        options: [
          { en: "Yes, it's called a mocha", es: "Sí, se llama mocha", de: "Ja, das nennt man Mokka", nl: "Ja, dat heet een mokka" },
          { en: "No, never mix them", es: "No, nunca los mezcles", de: "Nein, mische sie nie", nl: "Nee, mix ze nooit" },
          { en: "Only on Tuesdays", es: "Solo los martes", de: "Nur dienstags", nl: "Alleen op dinsdag" },
      ...
      },
      {
        ...
        options: [
          { en: "To help wake up and start the day", es: "Para ayudar a despertar y comenzar el día", de: "Um beim Aufwachen zu helfen und den Tag zu beginnen", nl: "Om te helpen wakker worden en de dag te beginnen" },
          { en: "Because it tastes like pancakes", es: "Porque sabe a panqueques", de: "Weil es nach Pfannkuchen schmeckt", nl: "Omdat het naar pannenkoeken smaakt" },
          { en: "To clean their teeth", es: "Para limpiar sus dientes", de: "Um ihre Zähne zu putzen", nl: "Om hun tanden te poetsen" },
          { en: "Because the sun tells them to", es: "Porque el sol se lo dice", de: "Weil die Sonne es ihnen sagt", nl: "Omdat de zon het ze vertelt" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "They are thrown away or used as compost", es: "Se tiran o se usan como compost", de: "Sie werden weggeworfen oder als Kompost verwendet", nl: "Ze worden weggegooid of gebruikt als compost" },
          { en: "They become new coffee beans", es: "Se convierten en nuevos granos de café", de: "Sie werden zu neuen Kaffeebohnen", nl: "Ze worden nieuwe koffiebonen" },
          { en: "People eat them like cereal", es: "La gente los come como cereal", de: "Die Leute essen sie wie Müsli", nl: "Mensen eten ze als ontbijtgranen" },
          { en: "They fly away", es: "Se vuelan", de: "Sie fliegen weg", nl: "Ze vliegen weg" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Usually yes, or it can be specially brewed cold", es: "Generalmente sí, o puede ser preparado especialmente frío", de: "Normalerweise ja, oder er kann speziell kalt gebrüht werden", nl: "Meestal wel, of het kan speciaal koud gezet worden" },
          { en: "No, iced coffee comes from Antarctica", es: "No, el café helado viene de la Antártida", de: "Nein, Eiskaffee kommt aus der Antarktis", nl: "Nee, ijskoffie komt uit Antarctica" },
          { en: "It's frozen solid like ice cream", es: "Está congelado sólido como helado", de: "Es ist fest gefroren wie Eiscreme", nl: "Het is bevroren zoals ijs" },
          { en: "It's made from snow", es: "Está hecho de nieve", de: "Es wird aus Schnee gemacht", nl: "Het is gemaakt van sneeuw" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A coffee grinder", es: "Un molinillo de café", de: "Eine Kaffeemühle", nl: "Een koffiemolen" },
          { en: "A hammer", es: "Un martillo", de: "Ein Hammer", nl: "Een hamer" },
          { en: "Their hands", es: "Sus manos", de: "Ihre Hände", nl: "Hun handen" },
          { en: "Scissors", es: "Tijeras", de: "Eine Schere", nl: "Een schaar" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Yes! It's called affogato", es: "¡Sí! Se llama affogato", de: "Ja! Das nennt man Affogato", nl: "Ja! Dat heet affogato" },
          { en: "No, it will explode", es: "No, explotará", de: "Nein, es wird explodieren", nl: "Nee, het zal exploderen" },
          { en: "Only on your birthday", es: "Solo en tu cumpleaños", de: "Nur an deinem Geburtstag", nl: "Alleen op je verjaardag" },
          { en: "That's impossible", es: "Eso es imposible", de: "Das ist unmöglich", nl: "Dat is onmogelijk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Yes, white fragrant flowers", es: "Sí, flores blancas fragantes", de: "Ja, weiße duftende Blüten", nl: "Ja, witte geurige bloemen" },
          { en: "No, they never bloom", es: "No, nunca florecen", de: "Nein, sie blühen nie", nl: "Nee, ze bloeien nooit" },
          { en: "Only rainbow colored flowers", es: "Solo flores de colores del arcoíris", de: "Nur regenbogenfarbene Blüten", nl: "Alleen regenboog gekleurde bloemen" },
          { en: "They have leaves but no flowers", es: "Tienen hojas pero no flores", de: "Sie haben Blätter aber keine Blüten", nl: "Ze hebben bladeren maar geen bloemen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "A person who makes coffee professionally", es: "Una persona que hace café profesionalmente", de: "Eine Person, die professionell Kaffee macht", nl: "Een persoon die professioneel koffie maakt" },
          { en: "A type of coffee bean", es: "Un tipo de grano de café", de: "Eine Art Kaffeebohne", nl: "Een soort koffieboon" },
          { en: "A coffee cup", es: "Una taza de café", de: "Eine Kaffeetasse", nl: "Een koffiekopje" },
          { en: "A coffee plant", es: "Una planta de café", de: "Eine Kaffeepflanze", nl: "Een koffieplant" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Because some coffee is very strong", es: "Porque algunos cafés son muy fuertes", de: "Weil manche Kaffees sehr stark sind", nl: "Omdat sommige koffie heel sterk is" },
          { en: "To save money on cups", es: "Para ahorrar dinero en tazas", de: "Um Geld für Tassen zu sparen", nl: "Om geld te besparen op kopjes" },
          { en: "Because big cups are too heavy", es: "Porque las tazas grandes son demasiado pesadas", de: "Weil große Tassen zu schwer sind", nl: "Omdat grote kopjes te zwaar zijn" },
          { en: "Only tiny people drink from them", es: "Solo personas pequeñas beben de ellas", de: "Nur kleine Leute trinken daraus", nl: "Alleen kleine mensen drinken eruit" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Countries like Finland and Norway", es: "Países como Finlandia y Noruega", de: "Länder wie Finnland und Norwegen", nl: "Landen zoals Finland en Noorwegen" },
          { en: "Countries near the equator only", es: "Solo países cerca del ecuador", de: "Nur Länder in der Nähe des Äquators", nl: "Alleen landen bij de evenaar" },
          { en: "Islands in the ocean", es: "Islas en el océano", de: "Inseln im Ozean", nl: "Eilanden in de oceaan" },
          { en: "Countries with no rain", es: "Países sin lluvia", de: "Länder ohne Regen", nl: "Landen zonder regen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Yes, but it takes much longer", es: "Sí, pero toma mucho más tiempo", de: "Ja, aber es dauert viel länger", nl: "Ja, maar het duurt veel langer" },
          { en: "No, it's completely impossible", es: "No, es completamente imposible", de: "Nein, es ist völlig unmöglich", nl: "Nee, het is volledig onmogelijk" },
          { en: "Only if you freeze it first", es: "Solo si lo congelas primero", de: "Nur wenn man es zuerst einfriert", nl: "Alleen als je het eerst bevriest" },
          { en: "Yes, and it's faster than hot water", es: "Sí, y es más rápido que con agua caliente", de: "Ja, und es ist schneller als mit heißem Wasser", nl: "Ja, en het is sneller dan met heet water" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Roasting the beans at high heat", es: "Tostar los granos a alta temperatura", de: "Rösten der Bohnen bei hoher Hitze", nl: "Het branden van de bonen bij hoge hitte" },
          { en: "Adding brown food coloring", es: "Añadir colorante marrón", de: "Braune Lebensmittelfarbe hinzufügen", nl: "Bruine voedselkleuring toevoegen" },
          { en: "Mixing it with chocolate", es: "Mezclarlo con chocolate", de: "Mit Schokolade mischen", nl: "Het mengen met chocolade" },
          { en: "Growing in brown soil", es: "Crecer en tierra marrón", de: "Wachsen in brauner Erde", nl: "Groeien in bruine aarde" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "No, each shop can have different coffee and recipes", es: "No, cada tienda puede tener café y recetas diferentes", de: "Nein, jedes Café kann verschiedenen Kaffee und Rezepte haben", nl: "Nee, elke shop kan verschillende koffie en recepten hebben" },
          { en: "Yes, all coffee is exactly the same everywhere", es: "Sí, todo el café es exactamente igual en todas partes", de: "Ja, aller Kaffee ist überall genau gleich", nl: "Ja, alle koffie is overal precies hetzelfde" },
          { en: "Only on Mondays they sell different coffee", es: "Solo los lunes venden café diferente", de: "Nur montags verkaufen sie anderen Kaffee", nl: "Alleen op maandag verkopen ze andere koffie" },
          { en: "Coffee shops don't actually sell coffee", es: "Las cafeterías en realidad no venden café", de: "Cafés verkaufen eigentlich keinen Kaffee", nl: "Coffeeshops verkopen eigenlijk geen koffie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To add a sweet, spicy flavor", es: "Para añadir un sabor dulce y picante", de: "Um einen süßen, würzigen Geschmack hinzuzufügen", nl: "Om een zoete, pittige smaak toe te voegen" },
          { en: "To make it turn red", es: "Para hacerlo volverse rojo", de: "Um es rot zu machen", nl: "Om het rood te maken" },
          { en: "Because it makes coffee cold", es: "Porque hace que el café esté frío", de: "Weil es Kaffee kalt macht", nl: "Omdat het koffie koud maakt" },
          { en: "It's required by law", es: "Es requerido por ley", de: "Es ist gesetzlich vorgeschrieben", nl: "Het is wettelijk verplicht" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Steam and pressure forcing water through coffee", es: "Vapor y presión forzando agua a través del café", de: "Dampf und Druck, der Wasser durch Kaffee presst", nl: "Stoom en druk die water door koffie duwt" },
          { en: "A hidden snake in the machine", es: "Una serpiente escondida en la máquina", de: "Eine versteckte Schlange in der Maschine", nl: "Een verborgen slang in de machine" },
          { en: "The machine getting angry", es: "La máquina enojándose", de: "Die Maschine wird wütend", nl: "De machine die boos wordt" },
          { en: "Radio playing static", es: "Radio reproduciendo estática", de: "Radio spielt Rauschen", nl: "Radio die ruis speelt" }
        ],
        correct: 0,
        explanation: {
