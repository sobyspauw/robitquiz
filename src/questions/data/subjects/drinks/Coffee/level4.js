    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Sweetening beans with sugar syrup",
                  "es": "Endulzar granos con jarabe de azúcar",
                  "de": "Bohnen mit Zuckersirup süßen",
                  "nl": "Bonen zoeten met suikersiroop"
        },
        {
                  "en": "Growing coffee near beehives",
                  "es": "Cultivar café cerca de colmenas",
                  "de": "Kaffee in der Nähe von Bienenstöcken anbauen",
                  "nl": "Koffie kweken bij bijenkorven"
        },
        {
                  "en": "Adding honey to the coffee",
                  "es": "Añadir miel al café",
                  "de": "Honig zum Kaffee hinzufügen",
                  "nl": "Honing toevoegen aan de koffie"
        },
        {
                  "en": "Leaving some fruit mucilage on beans during drying",
                  "es": "Dejar algo de mucílago de fruta en los granos durante el secado",
                  "de": "Etwas Fruchtschleim an den Bohnen während des Trocknens belassen",
                  "nl": "Wat fruchtmucilage op bonen laten tijdens het drogen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Different roast levels",
                  "es": "Diferentes niveles de tueste",
                  "de": "Verschiedene Röstgrade",
                  "nl": "Verschillende brandniveaus"
        },
        {
                  "en": "Types of coffee drinks",
                  "es": "Tipos de bebidas de café",
                  "de": "Arten von Kaffeegetränken",
                  "nl": "Soorten koffiedrankjes"
        },
        {
                  "en": "Coffee brewing methods",
                  "es": "Métodos de preparación de café",
                  "de": "Kaffee-Brühmethoden",
                  "nl": "Koffiezet methoden"
        },
        {
                  "en": "Distinct genetic varieties of coffee plants with unique characteristics",
                  "es": "Variedades genéticas distintas de plantas de café con características únicas",
                  "de": "Unterschiedliche genetische Varietäten von Kaffeepflanzen mit einzigartigen Eigenschaften",
                  "nl": "Verschillende genetische variëteiten van koffieplanten met unieke kenmerken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Blade grinders are more expensive",
                  "es": "Molinillos de cuchillas son más caros",
                  "de": "Klingen-Mühlen sind teurer",
                  "nl": "Messenmolens zijn duurder"
        },
        {
                  "en": "Burr grinders crush beans uniformly between two surfaces, blade grinders chop inconsistently",
                  "es": "Molinillos de fresas trituran granos uniformemente entre dos superficies, molinillos de cuchillas cortan inconsistentemente",
                  "de": "Mahlscheiben-Mühlen zerkleinern Bohnen gleichmäßig zwischen zwei Flächen, Klingen-Mühlen hacken ungleichmäßig",
                  "nl": "Maalschijvenmolens vermalen bonen uniform tussen twee oppervlakken, messenmolens hakken inconsistent"
        },
        {
        ...
        {
                  "en": "Burr grinders are for espresso only",
                  "es": "Molinillos de fresas son solo para espresso",
                  "de": "Mahlscheiben-Mühlen sind nur für Espresso",
                  "nl": "Maalschijvenmolens zijn alleen voor espresso"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using your pulse to measure timing",
                  "es": "Usar tu pulso para medir el tiempo",
                  "de": "Deinen Puls zum Zeitmessen verwenden",
                  "nl": "Je pols gebruiken om timing te meten"
        },
        {
                  "en": "Pouring very quickly",
                  "es": "Verter muy rápido",
                  "de": "Sehr schnell gießen",
                  "nl": "Heel snel gieten"
        },
        {
                  "en": "Pouring in a circular motion only",
                  "es": "Verter solo en movimiento circular",
                  "de": "Nur in kreisenden Bewegungen gießen",
                  "nl": "Alleen in cirkelvormige beweging gieten"
        },
        {
                  "en": "Adding water in multiple small, timed pours rather than continuously",
                  "es": "Añadir agua en múltiples vertidos pequeños y cronometrados en lugar de continuamente",
                  "de": "Wasser in mehreren kleinen, getakteten Güssen statt kontinuierlich hinzufügen",
                  "nl": "Water toevoegen in meerdere kleine, getimede gietsels in plaats van continu"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A grade of coffee beans",
                  "es": "Un grado de granos de café",
                  "de": "Ein Grad von Kaffeebohnen",
                  "nl": "Een graad van koffiebonen"
        },
        {
                  "en": "A type of coffee machine",
                  "es": "Un tipo de máquina de café",
                  "de": "Eine Art Kaffeemaschine",
                  "nl": "Een soort koffiemachine"
        },
        {
                  "en": "A professional certification for coffee quality assessment and cupping",
                  "es": "Una certificación profesional para evaluación de calidad de café y catación",
                  "de": "Eine professionelle Zertifizierung für Kaffeequalitätsbewertung und Cupping",
                  "nl": "Een professionele certificering voor koffiekwaliteitsbeoordeling en cupping"
        },
        {
                  "en": "A roasting certification",
                  "es": "Una certificación de tostado",
                  "de": "Eine Röst-Zertifizierung",
                  "nl": "Een brand certificering"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Grinding beans underwater",
                  "es": "Moler granos bajo el agua",
                  "de": "Bohnen unter Wasser mahlen",
                  "nl": "Bonen onder water malen"
        },
        {
                  "en": "Washing coffee with special chemicals",
                  "es": "Lavar café con químicos especiales",
                  "de": "Kaffee mit speziellen Chemikalien waschen",
                  "nl": "Koffie wassen met speciale chemicaliën"
        },
        {
                  "en": "Roasting without oxygen",
                  "es": "Tostar sin oxígeno",
                  "de": "Rösten ohne Sauerstoff",
                  "nl": "Branden zonder zuurstof"
        },
        {
                  "en": "Fermenting coffee in sealed, oxygen-free environments to develop unique flavors",
                  "es": "Fermentar café en ambientes sellados sin oxígeno para desarrollar sabores únicos",
                  "de": "Kaffee in versiegelten, sauerstofffreien Umgebungen fermentieren, um einzigartige Aromen zu entwickeln",
                  "nl": "Koffie fermenteren in verzegelde, zuurstofvrije omgevingen om unieke smaken te ontwikkelen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The first bean that breaks during roasting",
                  "es": "El primer grano que se rompe durante el tostado",
                  "de": "Die erste Bohne, die beim Rösten bricht",
                  "nl": "De eerste boon die breekt tijdens het branden"
        },
        {
                  "en": "A mistake in roasting",
                  "es": "Un error en el tostado",
                  "de": "Ein Fehler beim Rösten",
                  "nl": "Een fout in het branden"
        },
        {
                  "en": "An audible popping sound when beans expand and release moisture and CO2",
                  "es": "Un sonido audible de estallido cuando los granos se expanden y liberan humedad y CO2",
                  "de": "Ein hörbares Knallen, wenn Bohnen expandieren und Feuchtigkeit und CO2 freisetzen",
                  "nl": "Een hoorbaar knappend geluid wanneer bonen uitzetten en vocht en CO2 vrijgeven"
        },
        {
                  "en": "When the roaster's door opens",
                  "es": "Cuando se abre la puerta del tostador",
                  "de": "Wenn sich die Röstertür öffnet",
                  "nl": "Wanneer de branderdeur opent"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Measuring Total Dissolved Solids (TDS) to determine brew strength",
                  "es": "Medir Sólidos Disueltos Totales (TDS) para determinar fuerza de preparación",
                  "de": "Messung der gelösten Feststoffe (TDS) zur Bestimmung der Brühstärke",
                  "nl": "Meten van Total Dissolved Solids (TDS) om zetsterkte te bepalen"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "An espresso machine",
                  "es": "Una máquina de espresso",
                  "de": "Eine Espressomaschine",
                  "nl": "Een espressomachine"
        },
        {
                  "en": "A coffee cup from Italy",
                  "es": "Una taza de café de Italia",
                  "de": "Eine Kaffeetasse aus Italien",
                  "nl": "Een koffiekop uit Italië"
        },
        {
                  "en": "A type of French press",
                  "es": "Un tipo de prensa francesa",
                  "de": "Eine Art French Press",
                  "nl": "Een soort French press"
        },
        {
                  "en": "A stovetop brewer that uses steam pressure to push water through coffee",
                  "es": "Una cafetera de estufa que usa presión de vapor para empujar agua a través del café",
                  "de": "Ein Herdkocher, der Dampfdruck verwendet, um Wasser durch Kaffee zu drücken",
                  "nl": "Een kookplaat brouwer die stoomdruk gebruikt om water door koffie te duwen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "A brewing timer",
                  "es": "Un temporizador de preparación",
                  "de": "Ein Brüh-Timer",
                  "nl": "Een zettimer"
        },
        {
                  "en": "A standardized tool for identifying and describing coffee flavors and aromas",
                  "es": "Una herramienta estandarizada para identificar y describir sabores y aromas de café",
                  "de": "Ein standardisiertes Werkzeug zur Identifizierung und Beschreibung von Kaffeearomen und -geschmäckern",
                  "nl": "Een gestandaardiseerd hulpmiddel voor het identificeren en beschrijven van koffiesmaken en aroma's"
        },
        {
                  "en": "A coffee roasting machine",
                  "es": "Una máquina de tostado de café",
                  "de": "Eine Kaffeeröstmaschine",
                  "nl": "Een koffiebrandmachine"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Profiling customers' taste preferences",
                  "es": "Perfilar preferencias de sabor de clientes",
                  "de": "Geschmackspräferenzen von Kunden profilieren",
                  "nl": "Smaakvoorkeuren van klanten profileren"
        },
        {
                  "en": "Always using maximum pressure",
                  "es": "Siempre usar presión máxima",
                  "de": "Immer maximalen Druck verwenden",
                  "nl": "Altijd maximale druk gebruiken"
        },
        {
                  "en": "Measuring the pressure in coffee beans",
                  "es": "Medir la presión en los granos de café",
                  "de": "Den Druck in Kaffeebohnen messen",
                  "nl": "De druk in koffiebonen meten"
        },
        {
                  "en": "Varying pump pressure during extraction to control flow and flavor development",
                  "es": "Variar presión de bomba durante extracción para controlar flujo y desarrollo de sabor",
                  "de": "Pumpendruck während der Extraktion variieren, um Durchfluss und Geschmacksentwicklung zu steuern",
                  "nl": "Pompdruk variëren tijdens extractie om stroming en smaakontwikkeling te controleren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Roasting with carbon dioxide",
                  "es": "Tostar con dióxido de carbono",
                  "de": "Mit Kohlendioxid rösten",
                  "nl": "Branden met kooldioxide"
        },
        {
                  "en": "Storing green beans in CO2",
                  "es": "Almacenar granos verdes en CO2",
                  "de": "Grüne Bohnen in CO2 lagern",
                  "nl": "Groene bonen opslaan in CO2"
        },
        {
                  "en": "Adding carbonated water to coffee",
                  "es": "Añadir agua carbonatada al café",
                  "de": "Kohlensäurehaltiges Wasser zum Kaffee hinzufügen",
                  "nl": "Koolzuurhoudend water toevoegen aan koffie"
        },
        {
                  "en": "Fermenting whole cherries in CO2-rich, sealed environments borrowed from winemaking",
                  "es": "Fermentar cerezas enteras en ambientes sellados ricos en CO2 prestados de vinificación",
                  "de": "Ganze Kirschen in CO2-reichen, versiegelten Umgebungen fermentieren, übernommen aus der Weinherstellung",
                  "nl": "Hele kersen fermenteren in CO2-rijke, verzegelde omgevingen overgenomen van wijnbereiding"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "The cost per cup",
                  "es": "El costo por taza",
                  "de": "Die Kosten pro Tasse",
                  "nl": "De kosten per kopje"
        },
        {
                  "en": "The number of cups used in tasting",
                  "es": "El número de tazas usadas en la degustación",
                  "de": "Die Anzahl der beim Verkosten verwendeten Tassen",
                  "nl": "Het aantal kopjes gebruikt bij proeven"
        },
        {
                  "en": "A 100-point quality evaluation system assessing aroma, flavor, aftertaste, acidity, body, and more",
                  "es": "Un sistema de evaluación de calidad de 100 puntos evaluando aroma, sabor, regusto, acidez, cuerpo y más",
                  "de": "Ein 100-Punkte-Qualitätsbewertungssystem zur Bewertung von Aroma, Geschmack, Nachgeschmack, Säure, Körper und mehr",
                  "nl": "Een 100-punts kwaliteitsevaluatiesysteem dat aroma, smaak, nasmaak, zuurgraad, body en meer beoordeelt"
        },
        {
                  "en": "Customer satisfaction rating",
                  "es": "Calificación de satisfacción del cliente",
                  "de": "Kundenzufriedenheitsbewertung",
                  "nl": "Klanttevredenheidsbeoordeling"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only water temperature matters",
                  "es": "Solo la temperatura del agua importa",
                  "de": "Nur die Wassertemperatur zählt",
                  "nl": "Alleen watertemperatuur is belangrijk"
        },
        {
                  "en": "pH is the only important factor",
                  "es": "El pH es el único factor importante",
                  "de": "pH ist der einzige wichtige Faktor",
                  "nl": "pH is de enige belangrijke factor"
        },
        {
                  "en": "Mineral content affects extraction efficiency and flavor; calcium and magnesium extract different compounds",
                  "es": "Contenido mineral afecta eficiencia de extracción y sabor; calcio y magnesio extraen diferentes compuestos",
                  "de": "Mineralgehalt beeinflusst Extraktionseffizienz und Geschmack; Kalzium und Magnesium extrahieren verschiedene Verbindungen",
                  "nl": "Mineraalgehalte beïnvloedt extractie-efficiëntie en smaak; calcium en magnesium extraheren verschillende verbindingen"
        },
        {
                  "en": "Water chemistry has no impact on coffee",
                  "es": "La química del agua no tiene impacto en el café",
                  "de": "Wasserchemie hat keinen Einfluss auf Kaffee",
                  "nl": "Waterchemie heeft geen invloed op koffie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Exceptional tea-like, floral, jasmine characteristics with high acidity and complexity",
                  "es": "Excepcionales características florales similares al té, jazmín con alta acidez y complejidad",
                  "de": "Außergewöhnliche teeähnliche, blumige Jasmin-Eigenschaften mit hoher Säure und Komplexität",
                  "nl": "Uitzonderlijke thee-achtige, bloemige jasmijnkenmerken met hoge zuurgraad en complexiteit"
        },
        {
        ...
        {
                  "en": "Very bitter and strong flavor",
                  "es": "Sabor muy amargo y fuerte",
                  "de": "Sehr bitterer und starker Geschmack",
                  "nl": "Zeer bittere en sterke smaak"
        },
        {
                  "en": "Low price and common availability",
                  "es": "Bajo precio y disponibilidad común",
                  "de": "Niedriger Preis und allgemeine Verfügbarkeit",
                  "nl": "Lage prijs en algemene beschikbaarheid"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Flaws like black beans, sour beans, insect damage, and foreign matter that negatively affect quality",
                  "es": "Fallas como granos negros, granos agrios, daño de insectos y materia extraña que afectan negativamente la calidad",
                  "de": "Mängel wie schwarze Bohnen, saure Bohnen, Insektenschäden und Fremdkörper, die die Qualität negativ beeinflussen",
                  "nl": "Gebreken zoals zwarte bonen, zure bonen, insectenschade en vreemd materiaal dat de kwaliteit negatief beïnvloedt"
        },
        {
                  "en": "Different processing methods",
                  "es": "Diferentes métodos de procesamiento",
                  "de": "Verschiedene Verarbeitungsmethoden",
                  "nl": "Verschillende verwerkingsmethoden"
        },
        {
                  "en": "Various bean sizes",
                  "es": "Varios tamaños de grano",
                  "de": "Verschiedene Bohnengrößen",
                  "nl": "Verschillende bonengroottes"
        },
        {
                  "en": "Different roast colors",
                  "es": "Diferentes colores de tueste",
                  "de": "Verschiedene Röstfarben",
                  "nl": "Verschillende brandkleuren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Smaller drink with higher espresso-to-milk ratio and microfoam texture throughout",
                  "es": "Bebida más pequeña con mayor proporción espresso-leche y textura de microespuma en todo",
                  "de": "Kleineres Getränk mit höherem Espresso-Milch-Verhältnis und Mikroschaumtextur durchgehend",
                  "nl": "Kleinere drank met hogere espresso-melk verhouding en microschuim textuur door heel"
        },
        {
                  "en": "Iced coffee drink",
                  "es": "Bebida de café helado",
                  "de": "Eiskaffeegetränk",
                  "nl": "IJskoffie drankje"
        },
        {
                  "en": "Coffee without any milk",
                  "es": "Café sin leche",
                  "de": "Kaffee ohne Milch",
                  "nl": "Koffie zonder melk"
        },
        {
                  "en": "Exactly the same as a latte",
                  "es": "Exactamente igual que un latte",
                  "de": "Genau das Gleiche wie ein Latte",
                  "nl": "Precies hetzelfde als een latte"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Time to develop the roaster",
                  "es": "Tiempo para desarrollar el tostador",
                  "de": "Zeit zur Entwicklung des Rösters",
                  "nl": "Tijd om de brander te ontwikkelen"
        },
        {
                  "en": "Total roasting time",
                  "es": "Tiempo total de tostado",
                  "de": "Gesamte Röstzeit",
                  "nl": "Totale brandtijd"
        },
        {
                  "en": "Cooling time after roasting",
                  "es": "Tiempo de enfriamiento después del tostado",
                  "de": "Abkühlzeit nach dem Rösten",
                  "nl": "Afkoeltijd na branden"
        },
        {
                  "en": "The time between first crack and end of roast where flavor compounds fully develop",
                  "es": "El tiempo entre el primer crack y el final del tostado donde los compuestos de sabor se desarrollan completamente",
                  "de": "Die Zeit zwischen dem ersten Crack und dem Ende der Röstung, in der sich Geschmacksverbindungen vollständig entwickeln",
                  "nl": "De tijd tussen eerste crack en einde van branding waar smaakverbindingen volledig ontwikkelen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "An Ethiopian wild variety",
                  "es": "Una variedad silvestre etíope",
                  "de": "Eine äthiopische Wildsorte",
                  "nl": "Een Ethiopische wilde variëteit"
        },
        {
                  "en": "A Brazilian variety with chocolate notes",
                  "es": "Una variedad brasileña con notas de chocolate",
                  "de": "Eine brasilianische Sorte mit Schokoladennoten",
                  "nl": "Een Braziliaanse variëteit met chocolade noten"
        },
        {
                  "en": "A Kenyan cultivar known for complex fruit, wine-like acidity, and black currant notes",
                  "es": "Un cultivar keniano conocido por fruta compleja, acidez similar al vino y notas de grosella negra",
                  "de": "Eine kenianische Sorte bekannt für komplexe Früchte, weinähnliche Säure und schwarze Johannisbeernoten",
                  "nl": "Een Keniaanse cultivar bekend om complexe fruitsmaak, wijn-achtige zuurgraad en zwarte bessen noten"
        },
        {
                  "en": "A Colombian hybrid for high yield",
                  "es": "Un híbrido colombiano para alto rendimiento",
                  "de": "Ein kolumbianischer Hybrid für hohen Ertrag",
                  "nl": "Een Colombiaanse hybride voor hoge opbrengst"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adjusting grind size only",
                  "es": "Ajustar solo el tamaño de molienda",
                  "de": "Nur Mahlgrad anpassen",
                  "nl": "Alleen maalgrootte aanpassen"
        },
        {
                  "en": "Temperature control during extraction",
                  "es": "Control de temperatura durante la extracción",
                  "de": "Temperaturkontrolle während der Extraktion",
                  "nl": "Temperatuurcontrole tijdens extractie"
        },
        {
                  "en": "Manually controlling water flow rate through the puck independent of pressure",
                  "es": "Controlar manualmente la tasa de flujo de agua a través del disco independiente de la presión",
                  "de": "Manuelle Steuerung der Wasserdurchflussrate durch den Puck unabhängig vom Druck",
                  "nl": "Handmatig waterstroomsnelheid door de puck controleren onafhankelijk van druk"
        },
        {
                  "en": "Controlling milk flow when steaming",
                  "es": "Controlar flujo de leche al vaporizar",
                  "de": "Milchfluss beim Dämpfen kontrollieren",
                  "nl": "Melkstroom controleren bij stomen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Organizing coffee by type",
                  "es": "Organizar café por tipo",
                  "de": "Kaffee nach Typ organisieren",
                  "nl": "Koffie organiseren op type"
        },
        {
                  "en": "Broadcasting coffee preparation",
                  "es": "Transmitir preparación de café",
                  "de": "Kaffeezubereitung ausstrahlen",
                  "nl": "Koffiebereiding uitzenden"
        },
        {
                  "en": "Coffee flowing through special channels",
                  "es": "Café fluyendo a través de canales especiales",
                  "de": "Kaffee fließt durch spezielle Kanäle",
                  "nl": "Koffie stroomt door speciale kanalen"
        },
        {
                  "en": "Water finding paths of least resistance through the puck, causing uneven extraction",
                  "es": "El agua encuentra caminos de menor resistencia a través del disco, causando extracción desigual",
                  "de": "Wasser findet Wege des geringsten Widerstands durch den Puck und verursacht ungleichmäßige Extraktion",
                  "nl": "Water vindt paden van minste weerstand door de puck, wat ongelijkmatige extractie veroorzaakt"
        }
        ],
        correct: 3,
        explanation: {
