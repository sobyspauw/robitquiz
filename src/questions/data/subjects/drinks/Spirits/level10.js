    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "To provide liquid for vapor-liquid contact and separation efficiency",
                  "es": "Para proporcionar líquido para el contacto vapor-líquido y eficiencia de separación",
                  "de": "Um Flüssigkeit für Dampf-Flüssigkeit-Kontakt und Trennungseffizienz zu liefern",
                  "nl": "Om vloeistof te leveren voor damp-vloeistofcontact en scheidingsefficiëntie"
        },
        {
                  "en": "To increase temperature throughout the column",
                  "es": "Para aumentar la temperatura en toda la columna",
                  "de": "Um die Temperatur in der ganzen Säule zu erhöhen",
                  "nl": "Om de temperatuur in de hele kolom te verhogen"
        },
        {
                  "en": "To remove impurities from the bottom",
                  "es": "Para eliminar impurezas del fondo",
                  "de": "Um Verunreinigungen vom Boden zu entfernen",
                  "nl": "Om verontreinigingen van de bodem te verwijderen"
        },
        {
                  "en": "To cool vapor before condensation",
                  "es": "Para enfriar el vapor antes de la condensación",
                  "de": "Um den Dampf vor der Kondensation zu kühlen",
                  "nl": "Om de damp te koelen voor condensatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Congeners provide flavor complexity and can indicate production method and authenticity",
                  "es": "Los congéneres proporcionan complejidad de sabor y pueden indicar método de producción y autenticidad",
                  "de": "Kongenere bieten Geschmackskomplexität und können Produktionsmethode und Authentizität anzeigen",
                  "nl": "Congeners bieden smaakcomplexiteit en kunnen productiemethode en authenticiteit aangeven"
        },
        {
                  "en": "All spirits should have identical congener profiles",
                  "es": "Todos los licores deben tener perfiles de congéneres idénticos",
                  "de": "Alle Spirituosen sollten identische Kongenerprofile haben",
                  "nl": "Alle spirits zouden identieke congenerprofielen moeten hebben"
        },
        {
                  "en": "Congeners have no effect on flavor",
                  "es": "Los congéneres no tienen efecto en el sabor",
                  "de": "Kongenere haben keine Wirkung auf den Geschmack",
                  "nl": "Congeners hebben geen effect op smaak"
        },
        {
                  "en": "Congeners always indicate poor quality",
                  "es": "Los congéneres siempre indican mala calidad",
                  "de": "Kongenere zeigen immer schlechte Qualität an",
                  "nl": "Congeners duiden altijd op slechte kwaliteit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enzymatic activity decreases spirit quality",
                  "es": "La actividad enzimática disminuye la calidad del licor",
                  "de": "Enzymatische Aktivität verringert die Spirituosenqualität",
                  "nl": "Enzymatische activiteit vermindert spiritkwaliteit"
        },
        {
                  "en": "Different grains contribute specific enzymes that affect conversion efficiency and flavor development",
                  "es": "Diferentes granos contribuyen enzimas específicas que afectan la eficiencia de conversión y desarrollo de sabor",
                  "de": "Verschiedene Getreide tragen spezifische Enzyme bei, die Umwandlungseffizienz und Geschmacksentwicklung beeinflussen",
                  "nl": "Verschillende granen dragen specifieke enzymen bij die conversie-efficiëntie en smaakontwikkeling beïnvloeden"
        },
        {
                  "en": "All grains have identical enzymatic profiles",
                  "es": "Todos los granos tienen perfiles enzimáticos idénticos",
                  "de": "Alle Getreide haben identische enzymatische Profile",
                  "nl": "Alle granen hebben identieke enzymatische profielen"
        },
        {
                  "en": "Enzymes only matter during final filtration",
                  "es": "Las enzimas solo importan durante la filtración final",
                  "de": "Enzyme sind nur während der finalen Filtration wichtig",
                  "nl": "Enzymen zijn alleen belangrijk tijdens finale filtratie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "La profundidad de carbonización y nivel de tostado controlan la disponibilidad de compuestos extraíbles e intensidad de sabor",
                  "de": "Verkohlungstiefe und Röstgrad kontrollieren die Verfügbarkeit extrahierbarer Verbindungen und Geschmacksintensität",
                  "nl": "Verkolingdiepte en roostergraad controleren de beschikbaarheid van extraheerbare verbindingen en smaakintensiteit"
        },
        {
                  "en": "Wood treatment only affects appearance",
                  "es": "El tratamiento de madera solo afecta la apariencia",
                  "de": "Holzbehandlung beeinflusst nur das Aussehen",
                  "nl": "Houtbehandeling beïnvloedt alleen uiterlijk"
        },
        {
                  "en": "Charring prevents any flavor extraction",
                  "es": "La carbonización previene cualquier extracción de sabor",
                  "de": "Verkohlung verhindert jede Geschmacksextraktion",
                  "nl": "Verkolen voorkomt alle smaakextractie"
        },
        {
                  "en": "All barrel treatments produce identical results",
                  "es": "Todos los tratamientos de barril producen resultados idénticos",
                  "de": "Alle Fassbehandlungen produzieren identische Ergebnisse",
                  "nl": "Alle vatbehandelingen produceren identieke resultaten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "pH testing alone",
                  "es": "Solo prueba de pH",
                  "de": "Nur pH-Test",
                  "nl": "Alleen pH testen"
        },
        {
                  "en": "Simple alcohol measurement only",
                  "es": "Solo medición simple de alcohol",
                  "de": "Nur einfache Alkoholmessung",
                  "nl": "Alleen eenvoudige alcoholmeting"
        },
        {
                  "en": "Gas chromatography-mass spectrometry for congener profiling",
                  "es": "Cromatografía de gases-espectrometría de masas para perfilado de congéneres",
                  "de": "Gaschromatographie-Massenspektrometrie für Kongener-Profiling",
                  "nl": "Gaschromatografie-massaspectrometrie voor congener profilering"
        },
        {
                  "en": "Visual color comparison",
                  "es": "Comparación visual de color",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Yeast works identically at all temperatures",
                  "es": "La levadura funciona idénticamente a todas las temperaturas",
                  "de": "Hefe arbeitet bei allen Temperaturen identisch",
                  "nl": "Gist werkt identiek bij alle temperaturen"
        },
        {
                  "en": "Higher temperatures always produce better spirits",
                  "es": "Temperaturas más altas siempre producen mejores licores",
                  "de": "Höhere Temperaturen produzieren immer bessere Spirituosen",
                  "nl": "Hogere temperaturen produceren altijd betere spirits"
        },
        {
                  "en": "Temperature has no effect on final flavor",
                  "es": "La temperatura no tiene efecto en el sabor final",
                  "de": "Temperatur hat keine Wirkung auf den finalen Geschmack",
                  "nl": "Temperatuur heeft geen effect op eindspmaak"
        },
        {
                  "en": "Temperature affects yeast metabolism, ester formation, and congener development",
                  "es": "La temperatura afecta el metabolismo de levadura, formación de ésteres y desarrollo de congéneres",
                  "de": "Temperatur beeinflusst Hefemetabolismus, Esterbildung und Kongenerentwicklung",
                  "nl": "Temperatuur beïnvloedt gistmetabolisme, estervorming en congenerontwikkeling"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "More plates always mean lower quality",
                  "es": "Más platos siempre significan menor calidad",
                  "de": "Mehr Böden bedeuten immer geringere Qualität",
                  "nl": "Meer platen betekent altijd lagere kwaliteit"
        },
        {
                  "en": "They only affect column height",
                  "es": "Solo afectan la altura de la columna",
                  "de": "Sie beeinflussen nur die Säulenhöhe",
                  "nl": "Ze beïnvloeden alleen kolomhoogte"
        },
        {
                  "en": "Theoretical plates have no practical application",
                  "es": "Los platos teóricos no tienen aplicación práctica",
                  "de": "Theoretische Böden haben keine praktische Anwendung",
                  "nl": "Theoretische platen hebben geen praktische toepassing"
        },
        {
                  "en": "They determine separation efficiency and purity potential of the column",
                  "es": "Determinan la eficiencia de separación y potencial de pureza de la columna",
                  "de": "Sie bestimmen Trennungseffizienz und Reinheitspotenzial der Säule",
                  "nl": "Ze bepalen scheidingsefficiëntie en zuiverheidspotentieel van de kolom"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All water sources produce identical results",
                  "es": "Todas las fuentes de agua producen resultados idénticos",
                  "de": "Alle Wasserquellen produzieren identische Ergebnisse",
                  "nl": "Alle waterbronnen produceren identieke resultaten"
        },
        {
                  "en": "Mineral content affects enzyme activity, yeast health, and extraction during aging",
                  "es": "El contenido mineral afecta la actividad enzimática, salud de levadura y extracción durante el envejecimiento",
                  "de": "Mineralgehalt beeinflusst Enzymaktivität, Hefegesundheit und Extraktion während der Reifung",
                  "nl": "Mineraalgehalte beïnvloedt enzymactiviteit, gistgezondheid en extractie tijdens rijping"
        },
        {
                  "en": "Distillation eliminates all water effects",
                  "es": "La destilación elimina todos los efectos del agua",
                  "de": "Destillation eliminiert alle Wassereffekte",
                  "nl": "Destillatie elimineert alle watereffecten"
        },
        {
                  "en": "Water only affects color, not flavor",
                  "es": "El agua solo afecta el color, no el sabor",
                  "de": "Wasser beeinflusst nur Farbe, nicht Geschmack",
                  "nl": "Water beïnvloedt alleen kleur, niet smaak"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Barrel char directly produces ethyl carbamate",
                  "es": "El carbón del barril produce directamente carbamato de etilo",
                  "de": "Fassverkohlung produziert direkt Ethylcarbamat",
                  "nl": "Vatverkolen produceert direct ethylcarbamaat"
        },
        {
                  "en": "It's only formed by bacterial contamination",
                  "es": "Solo se forma por contaminación bacteriana",
                  "de": "Es wird nur durch bakterielle Kontamination gebildet",
                  "nl": "Het wordt alleen gevormd door bacteriële contaminatie"
        },
        {
                  "en": "Urea from yeast reacts with ethanol during aging; controlled by yeast strain selection and nitrogen management",
                  "es": "La urea de levadura reacciona con etanol durante el envejecimiento; se controla mediante selección de cepas de levadura y manejo de nitrógeno",
                  "de": "Harnstoff aus Hefe reagiert mit Ethanol während der Reifung; kontrolliert durch Hefestamm-Auswahl und Stickstoff-Management",
                  "nl": "Ureum van gist reageert met ethanol tijdens rijping; gecontroleerd door giststam selectie en stikstofbeheer"
        },
        {
                  "en": "It cannot be controlled in production",
                  "es": "No se puede controlar en la producción",
                  "de": "Es kann in der Produktion nicht kontrolliert werden",
                  "nl": "Het kan niet gecontroleerd worden in productie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Temperature and humidity gradients create varying extraction rates and flavor development patterns",
                  "es": "Los gradientes de temperatura y humedad crean tasas de extracción variables y patrones de desarrollo de sabor",
                  "de": "Temperatur- und Feuchtigkeitsgradienten schaffen unterschiedliche Extraktionsraten und Geschmacksentwicklungsmuster",
                  "nl": "Temperatuur en vochtigheidsgradiënten creëren variërende extractiesnelheden en smaakontwikkelingspatronen"
        },
        {
                  "en": "Microclimate has no measurable effect",
                  "es": "El microclima no tiene efecto medible",
                  "de": "Mikroklima hat keine messbare Wirkung",
                  "nl": "Microklimat heeft geen meetbaar effect"
        },
        {
                  "en": "Only the bottom floor affects aging",
                  "es": "Solo el piso inferior afecta el envejecimiento",
                  "de": "Nur das unterste Stockwerk beeinflusst die Reifung",
                  "nl": "Alleen de onderste verdieping beïnvloedt rijping"
        },
        {
                  "en": "All barrels age identically regardless of location",
                  "es": "Todos los barriles envejecen idénticamente independientemente de la ubicación",
                  "de": "Alle Fässer reifen identisch unabhängig vom Standort",
                  "nl": "Alle vaten rijpen identiek ongeacht locatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Maillard reactions only occur during distillation",
                  "es": "Las reacciones de Maillard solo ocurren durante la destilación",
                  "de": "Maillard-Reaktionen treten nur während der Destillation auf",
                  "nl": "Maillard reacties treden alleen tijdens destillatie op"
        },
        {
                  "en": "Amino acids and sugars react creating complex melanoidins, caramel notes, and browning",
                  "es": "Los aminoácidos y azúcares reaccionan creando melanoidinas complejas, notas de caramelo y oscurecimiento",
                  "de": "Aminosäuren und Zucker reagieren und schaffen komplexe Melanoidine, Karamellnoten und Bräunung",
                  "nl": "Aminozuren en suikers reageren en creëren complexe melanoidinen, karamelnoten en verbruining"
        },
        {
                  "en": "It only affects barrel color, not flavor",
                  "es": "Solo afecta el color del barril, no el sabor",
                  "de": "Es beeinflusst nur Fassfarbe, nicht Geschmack",
                  "nl": "Het beïnvloedt alleen vatkleur, niet smaak"
        },
        {
                  "en": "This reaction decreases spirit quality",
                  "es": "Esta reacción disminuye la calidad del licor",
                  "de": "Diese Reaktion verringert die Spirituosenqualität",
                  "nl": "Deze reactie vermindert spiritkwaliteit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "More copper always produces inferior spirits",
                  "es": "Más cobre siempre produce licores inferiores",
                  "de": "Mehr Kupfer produziert immer minderwertige Spirituosen",
                  "nl": "Meer koper produceert altijd inferieure spirits"
        },
        {
                  "en": "Copper only affects still appearance",
                  "es": "El cobre solo afecta la apariencia del alambique",
                  "de": "Kupfer beeinflusst nur Still-Aussehen",
                  "nl": "Koper beïnvloedt alleen still uiterlijk"
        },
        {
                  "en": "Copper catalyzes sulfur compound removal and promotes esterification reactions",
                  "es": "El cobre cataliza la eliminación de compuestos de azufre y promueve reacciones de esterificación",
                  "de": "Kupfer katalysiert Schwefelverbindungs-Entfernung und fördert Veresterungsreaktionen",
                  "nl": "Koper katalyseert zwavelverbinding verwijdering en bevordert esterificatie reacties"
        },
        {
                  "en": "Copper has no chemical effect on distillates",
                  "es": "El cobre no tiene efecto químico en los destilados",
                  "de": "Kupfer hat keine chemische Wirkung auf Destillate",
                  "nl": "Koper heeft geen chemisch effect op destillaten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Geographic origin cannot be analytically verified",
                  "es": "El origen geográfico no se puede verificar analíticamente",
                  "de": "Geografische Herkunft kann nicht analytisch verifiziert werden",
                  "nl": "Geografische oorsprong kan niet analytisch geverifieerd worden"
        },
        {
                  "en": "Stable isotope ratio analysis (SIRA) measuring oxygen, hydrogen, and strontium ratios",
                  "es": "Análisis de proporción de isótopos estables (SIRA) midiendo proporciones de oxígeno, hidrógeno y estroncio",
                  "de": "Stabile Isotopenverhältnis-Analyse (SIRA) zur Messung von Sauerstoff-, Wasserstoff- und Strontiumverhältnissen",
                  "nl": "Stabiele isotoop ratio analyse (SIRA) die zuurstof, waterstof en strontium verhoudingen meet"
        },
        {
                  "en": "Simple label verification only",
                  "es": "Solo verificación simple de etiqueta",
                  "de": "Nur einfache Etikettenverifizierung",
                  "nl": "Alleen eenvoudige label verificatie"
        },
        {
                  "en": "Color measurement determines origin",
                  "es": "La medición de color determina el origen",
                  "de": "Farbmessung bestimmt Herkunft",
                  "nl": "Kleurmeting bepaalt oorsprong"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bacteria have no effect on fermentation",
                  "es": "Las bacterias no tienen efecto en la fermentación",
                  "de": "Bakterien haben keine Wirkung auf Fermentation",
                  "nl": "Bacteriën hebben geen effect op fermentatie"
        },
        {
                  "en": "LAB only affects barrel aging, not fermentation",
                  "es": "LAB solo afecta el envejecimiento en barril, no la fermentación",
                  "de": "LAB beeinflusst nur Fassreifung, nicht Fermentation",
                  "nl": "LAB beïnvloedt alleen vatrijping, niet fermentatie"
        },
        {
                  "en": "LAB contamination always improves spirit quality",
                  "es": "La contaminación LAB siempre mejora la calidad del licor",
                  "de": "LAB-Kontamination verbessert immer die Spirituosenqualität",
                  "nl": "LAB contaminatie verbetert altijd spiritkwaliteit"
        },
        {
                  "en": "LAB produces lactic acid lowering pH and can create diacetyl, affecting yeast efficiency and flavor",
                  "es": "LAB produce ácido láctico bajando el pH y puede crear diacetilo, afectando eficiencia de levadura y sabor",
                  "de": "LAB produziert Milchsäure zur pH-Senkung und kann Diacetyl schaffen, was Hefeeffizienz und Geschmack beeinflusst",
                  "nl": "LAB produceert melkzuur dat pH verlaagt en kan diacetyl creëren, gistefficiëntie en smaak beïnvloedend"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dephlegmators only cool the final product",
                  "es": "Los deflegmadores solo enfrían el producto final",
                  "de": "Dephlegmatoren kühlen nur das Endprodukt",
                  "nl": "Dephlegmators koelen alleen het eindproduct"
        },
        {
                  "en": "Filters that remove all congeners completely",
                  "es": "Filtros que eliminan todos los congéneres completamente",
                  "de": "Filter, die alle Kongenere vollständig entfernen",
                  "nl": "Filters die alle congeners volledig verwijderen"
        },
        {
                  "en": "Partial condensers that increase reflux and separation efficiency while controlling congener levels",
                  "es": "Condensadores parciales que aumentan el reflujo y eficiencia de separación mientras controlan niveles de congéneres",
                  "de": "Teilkondensatoren, die Rückfluss und Trennungseffizienz erhöhen während sie Kongener-Levels kontrollieren",
                  "nl": "Gedeeltelijke condensers die reflux en scheidingsefficiëntie verhogen terwijl congener niveaus gecontroleerd worden"
        },
        {
                  "en": "Heating elements that increase boiling temperature",
                  "es": "Elementos calefactores que aumentan la temperatura de ebullición",
                  "de": "Heizelemente, die Siedetemperatur erhöhen",
                  "nl": "Verwarmingselementen die kooktemperatuur verhogen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Phenolics only develop during barrel aging",
                  "es": "Los fenólicos solo se desarrollan durante el envejecimiento en barril",
                  "de": "Phenolische Verbindungen entwickeln sich nur während der Fassreifung",
                  "nl": "Fenolen ontwikkelen alleen tijdens vatrijping"
        },
        {
                  "en": "Peat smoke introduces guaiacol, cresols, and phenol compounds absorbed during kilning, measurable as PPM",
                  "es": "El humo de turba introduce guayacol, cresoles y compuestos fenólicos absorbidos durante el secado, medibles como PPM",
                  "de": "Torfrauch führt Guajakol, Kresole und Phenolverbindungen ein, die während des Darrens absorbiert werden, messbar als PPM",
                  "nl": "Turf rook introduceert guaiacol, cresolen en fenolverbindingen geabsorbeerd tijdens drogen, meetbaar als PPM"
        },
        {
                  "en": "Unpeated malt contains more phenolic compounds",
                  "es": "La malta sin turba contiene más compuestos fenólicos",
                  "de": "Ungetorftes Malz enthält mehr phenolische Verbindungen",
                  "nl": "Ongeturfde mout bevat meer fenolische verbindingen"
        },
        {
                  "en": "Both produce identical phenolic profiles",
                  "es": "Ambos producen perfiles fenólicos idénticos",
                  "de": "Beide produzieren identische phenolische Profile",
                  "nl": "Beide produceren identieke fenolische profielen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Determines color intensity only",
                  "es": "Determina solo la intensidad del color",
                  "de": "Bestimmt nur Farbintensität",
                  "nl": "Bepaalt alleen kleurintensiteit"
        },
        {
                  "en": "Measures heat of dilution to detect adulteration and verify alcohol strength accuracy",
                  "es": "Mide el calor de dilución para detectar adulteración y verificar la precisión de la graduación alcohólica",
                  "de": "Misst Verdünnungswärme zur Erkennung von Verfälschung und Verifizierung der Alkoholstärke-Genauigkeit",
                  "nl": "Meet verdunningswarmte om vervalsing te detecteren en alcohol sterkte nauwkeurigheid te verifiëren"
        },
        {
                  "en": "Calorimetry has no application in spirits",
                  "es": "La calorimetría no tiene aplicación en licores",
                  "de": "Kalorimetrie hat keine Anwendung in Spirituosen",
                  "nl": "Calorimetrie heeft geen toepassing in spirits"
        },
        {
                  "en": "Only measures temperature for storage",
                  "es": "Solo mide la temperatura para almacenamiento",
                  "de": "Misst nur Temperatur für Lagerung",
                  "nl": "Meet alleen temperatuur voor opslag"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reduced pressure lowers boiling points, preserving delicate aromatics while reducing thermal degradation",
                  "es": "La presión reducida baja los puntos de ebullición, preservando aromáticos delicados mientras reduce la degradación térmica",
                  "de": "Reduzierter Druck senkt Siedepunkte, bewahrt empfindliche Aromen während thermische Degradation reduziert wird",
                  "nl": "Verminderde druk verlaagt kookpunten, delicate aromaten bewarend terwijl thermische degradatie verminderd wordt"
        },
        {
                  "en": "Vacuum distillation increases alcohol strength only",
                  "es": "La destilación al vacío solo aumenta la graduación alcohólica",
                  "de": "Vakuumdestillation erhöht nur Alkoholstärke",
                  "nl": "Vacuümdestillatie verhoogt alleen alcoholsterkte"
        },
        {
                  "en": "Vacuum distillation is only used for rum",
                  "es": "La destilación al vacío solo se usa para ron",
                  "de": "Vakuumdestillation wird nur für Rum verwendet",
                  "nl": "Vacuümdestillatie wordt alleen voor rum gebruikt"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Acetic acid bacteria have no effect on spirits",
                  "es": "Las bacterias de ácido acético no tienen efecto en los licores",
                  "de": "Essigsäurebakterien haben keine Wirkung auf Spirituosen",
                  "nl": "Azijnzuurbacteriën hebben geen effect op spirits"
        },
        {
                  "en": "AAB oxidizes ethanol to acetic acid creating vinegar character; usually undesirable except in controlled applications",
                  "es": "AAB oxida etanol a ácido acético creando carácter de vinagre; generalmente indeseable excepto en aplicaciones controladas",
                  "de": "AAB oxidiert Ethanol zu Essigsäure und schafft Essigcharakter; normalerweise unerwünscht außer in kontrollierten Anwendungen",
                  "nl": "AAB oxideert ethanol naar azijnzuur waardoor azijnkarakter ontstaat; meestal ongewenst behalve in gecontroleerde toepassingen"
        },
        {
                  "en": "AAB is intentionally added to all premium spirits",
                  "es": "AAB se añade intencionalmente a todos los licores premium",
                  "de": "AAB wird absichtlich zu allen Premium-Spirituosen hinzugefügt",
                  "nl": "AAB wordt opzettelijk toegevoegd aan alle premium spirits"
        },
        {
                  "en": "AAB always improves aging character",
                  "es": "AAB siempre mejora el carácter de envejecimiento",
                  "de": "AAB verbessert immer Alterungscharakter",
                  "nl": "AAB verbetert altijd rijpingskarakter"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Molecular weight only affects color, not texture",
                  "es": "El peso molecular solo afecta el color, no la textura",
                  "de": "Molekulargewicht beeinflusst nur Farbe, nicht Textur",
                  "nl": "Moleculair gewicht beïnvloedt alleen kleur, niet textuur"
        },
        {
                  "en": "Lower molecular weight creates fuller body",
                  "es": "El peso molecular más bajo crea cuerpo más pleno",
                  "de": "Niedrigeres Molekulargewicht schafft volleren Körper",
                  "nl": "Lager moleculair gewicht creëert voller body"
        },
        {
                  "en": "All congeners contribute equally to texture",
                  "es": "Todos los congéneres contribuyen igualmente a la textura",
                  "de": "Alle Kongenere tragen gleichermaßen zur Textur bei",
                  "nl": "Alle congeners dragen gelijk bij aan textuur"
        },
        {
                  "en": "Higher molecular weight compounds (long-chain esters, fatty acids) increase viscosity and oily mouthfeel",
                  "es": "Compuestos de mayor peso molecular (ésteres de cadena larga, ácidos grasos) aumentan viscosidad y sensación en boca oleosa",
                  "de": "Höheres Molekulargewicht-Verbindungen (langkettige Ester, Fettsäuren) erhöhen Viskosität und öliges Mundgefühl",
                  "nl": "Hogere moleculair gewicht verbindingen (lang-keten esters, vetzuren) verhogen viscositeit en olieachtig mondgevoel"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only needed for color measurement",
                  "es": "Solo se necesita para medición de color",
                  "de": "Nur für Farbmessung benötigt",
                  "nl": "Alleen nodig voor kleurmeting"
        },
        {
                  "en": "Calibration is unnecessary in modern distilleries",
                  "es": "La calibración es innecesaria en destilerías modernas",
                  "de": "Kalibrierung ist in modernen Destillerien unnötig",
                  "nl": "Kalibratie is onnodig in moderne distilleerderijen"
        },
        {
                  "en": "Ensures accurate ABV measurement accounting for temperature and dissolved solids effects on density",
                  "es": "Asegura medición precisa de ABV teniendo en cuenta temperatura y efectos de sólidos disueltos en densidad",
                  "de": "Stellt genaue ABV-Messung sicher unter Berücksichtigung von Temperatur- und gelösten Feststoffeffekten auf Dichte",
                  "nl": "Zorgt voor nauwkeurige ABV meting rekening houdend met temperatuur en opgeloste vaste stoffen effecten op dichtheid"
        },
        {
                  "en": "These instruments measure pH, not alcohol",
                  "es": "Estos instrumentos miden pH, no alcohol",
                  "de": "Diese Instrumente messen pH, nicht Alkohol",
                  "nl": "Deze instrumenten meten pH, niet alcohol"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Barrels never actually expand or contract",
                  "es": "Los barriles nunca se expanden o contraen realmente",
                  "de": "Fässer expandieren oder kontrahieren nie wirklich",
                  "nl": "Vaten expanderen of contracteren nooit echt"
        },
        {
                  "en": "Breathing only affects barrel lifespan, not flavor",
                  "es": "La respiración solo afecta la vida útil del barril, no el sabor",
                  "de": "Atmung beeinflusst nur Fass-Lebensdauer, nicht Geschmack",
                  "nl": "Ademhaling beïnvloedt alleen vat levensduur, niet smaak"
        },
        {
                  "en": "Temperature-driven expansion forces spirit into wood extracting compounds; contraction draws liquid back enriched",
                  "es": "La expansión impulsada por temperatura fuerza el licor hacia la madera extrayendo compuestos; la contracción devuelve el líquido enriquecido",
                  "de": "Temperaturgetriebene Expansion zwingt Spirituose in Holz zur Verbindungsextraktion; Kontraktion zieht angereicherte Flüssigkeit zurück",
                  "nl": "Temperatuur-gedreven expansie forceert spirit in hout verbindingen extracterend; contractie trekt verrijkte vloeistof terug"
        },
        {
                  "en": "Breathing prevents flavor development",
                  "es": "La respiración previene el desarrollo de sabor",
                  "de": "Atmung verhindert Geschmacksentwicklung",
                  "nl": "Ademhaling voorkomt smaakontwikkeling"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Total phenolic content measurement indicating wood extraction and oxidation levels",
                  "es": "Medición de contenido fenólico total indicando niveles de extracción de madera y oxidación",
                  "de": "Gesamtphenolgehalt-Messung zur Anzeige von Holzextraktions- und Oxidationslevels",
                  "nl": "Totale fenolische inhoud meting die hout extractie en oxidatie niveaus aangeeft"
        },
        {
                  "en": "Only measures alcohol percentage",
                  "es": "Solo mide el porcentaje de alcohol",
                  "de": "Misst nur Alkoholprozentsatz",
                  "nl": "Meet alleen alcoholpercentage"
        },
        {
                  "en": "This method is not used in spirit analysis",
                  "es": "Este método no se usa en análisis de licores",
                  "de": "Diese Methode wird nicht in Spirituosenanalyse verwendet",
                  "nl": "Deze methode wordt niet gebruikt in spirit analyse"
        },
        {
                  "en": "Determines sugar content exclusively",
                  "es": "Determina el contenido de azúcar exclusivamente",
                  "de": "Bestimmt ausschließlich Zuckergehalt",
                  "nl": "Bepaalt uitsluitend suikergehalte"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Nitrogen only affects bottle pressure",
                  "es": "El nitrógeno solo afecta la presión de la botella",
                  "de": "Stickstoff beeinflusst nur Flaschendruck",
                  "nl": "Stikstof beïnvloedt alleen flesdruk"
        },
        {
                  "en": "Inert gas purging removes dissolved oxygen preventing oxidation and stabilizing flavor profiles",
                  "es": "La purga con gas inerte elimina oxígeno disuelto previniendo oxidación y estabilizando perfiles de sabor",
                  "de": "Inertgas-Spülung entfernt gelösten Sauerstoff zur Verhinderung von Oxidation und Stabilisierung von Geschmacksprofilen",
                  "nl": "Inert gas zuivering verwijdert opgeloste zuurstof die oxidatie voorkomt en smaakprofielen stabiliseert"
        },
        {
                  "en": "Nitrogen creates undesirable flavors",
                  "es": "El nitrógeno crea sabores indeseables",
                  "de": "Stickstoff schafft unerwünschte Aromen",
                  "nl": "Stikstof creëert ongewenste smaken"
        },
        {
                  "en": "Sparging increases alcohol content directly",
                  "es": "El burbujeo aumenta directamente el contenido de alcohol",
                  "de": "Sparging erhöht Alkoholgehalt direkt",
                  "nl": "Sparging verhoogt alcoholgehalte direct"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Clarity only matters for visual appearance",
                  "es": "La claridad solo importa para la apariencia visual",
                  "de": "Klarheit ist nur für visuelle Erscheinung wichtig",
                  "nl": "Helderheid is alleen belangrijk voor visuele verschijning"
        },
        {
                  "en": "Cloudier wort always produces better whiskey",
                  "es": "El mosto más turbio siempre produce mejor whiskey",
                  "de": "Trübere Würze produziert immer besseren Whiskey",
                  "nl": "Troebeler wort produceert altijd betere whiskey"
        },
        {
                  "en": "Clarity affects yeast health, fermentation efficiency, and final congener profile by controlling lipid and protein levels",
                  "es": "La claridad afecta la salud de levadura, eficiencia de fermentación y perfil final de congéneres controlando niveles de lípidos y proteínas",
                  "de": "Klarheit beeinflusst Hefegesundheit, Fermentationseffizienz und finales Kongener-Profil durch Kontrolle von Lipid- und Proteinleveln",
                  "nl": "Helderheid beïnvloedt gistgezondheid, fermentatie-efficiëntie en finaal congener profiel door lipide en eiwit niveaus te controleren"
        },
        {
                  "en": "Wort clarity has no effect on fermentation",
                  "es": "La claridad del mosto no tiene efecto en la fermentación",
                  "de": "Würzklarheit hat keine Wirkung auf Fermentation",
                  "nl": "Wort helderheid heeft geen effect op fermentatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "This concept is unrelated to aging",
                  "es": "Este concepto no está relacionado con el envejecimiento",
                  "de": "Dieses Konzept ist nicht mit Alterung verbunden",
                  "nl": "Dit concept is niet gerelateerd aan rijping"
        },
        {
                  "en": "Cumulative temperature above a base threshold predicts maturation rate accounting for climate variations",
                  "es": "La temperatura acumulada por encima de un umbral base predice la tasa de maduración teniendo en cuenta variaciones climáticas",
                  "de": "Kumulative Temperatur über einem Basisschwellenwert sagt Reifungsrate voraus unter Berücksichtigung klimatischer Variationen",
                  "nl": "Cumulatieve temperatuur boven een basis drempel voorspelt rijpingssnelheid rekening houdend met klimaat variaties"
        },
        {
                  "en": "Degree-days only measure calendar time",
                  "es": "Los grados-día solo miden el tiempo calendario",
                  "de": "Grad-Tage messen nur Kalenderzeit",
                  "nl": "Graad-dagen meten alleen kalender tijd"
        },
        {
                  "en": "All climates accumulate degree-days identically",
                  "es": "Todos los climas acumulan grados-día idénticamente",
                  "de": "Alle Klimata akkumulieren Grad-Tage identisch",
                  "nl": "Alle klimaten accumuleren graad-dagen identiek"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enzymes only improve color, not fermentation",
                  "es": "Las enzimas solo mejoran el color, no la fermentación",
                  "de": "Enzyme verbessern nur Farbe, nicht Fermentation",
                  "nl": "Enzymen verbeteren alleen kleur, niet fermentatie"
        },
        {
                  "en": "All enzymes decrease final alcohol yield",
                  "es": "Todas las enzimas disminuyen el rendimiento final de alcohol",
                  "de": "Alle Enzyme verringern finale Alkoholausbeute",
                  "nl": "Alle enzymen verminderen finale alcohol opbrengst"
        },
        {
                  "en": "Supplemental α-amylase, glucoamylase, and proteases increase starch conversion efficiency and reduce processing time",
                  "es": "Amilasa-α, glucoamilasa y proteasas suplementarias aumentan la eficiencia de conversión de almidón y reducen el tiempo de procesamiento",
                  "de": "Ergänzende α-Amylase, Glucoamylase und Proteasen erhöhen Stärkeumwandlungseffizienz und reduzieren Verarbeitungszeit",
                  "nl": "Aanvullende α-amylase, glucoamylase en proteasen verhogen zetmeel conversie-efficiëntie en verminderen verwerkingstijd"
        },
        {
                  "en": "Enzymes are never used in spirits production",
                  "es": "Las enzimas nunca se usan en la producción de licores",
                  "de": "Enzyme werden nie in Spirituosenproduktion verwendet",
                  "nl": "Enzymen worden nooit gebruikt in spiritsproductie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Kiln-dried oak is always superior to air-dried",
                  "es": "El roble secado en horno es siempre superior al secado al aire",
                  "de": "Ofengetrocknete Eiche ist immer luftgetrockneter überlegen",
                  "nl": "Oven-gedroogd eik is altijd superieur aan lucht-gedroogd"
        },
        {
                  "en": "Extended air-drying breaks down harsh tannins, develops desirable wood sugars, and reduces astringency",
                  "es": "El secado al aire prolongado descompone taninos ásperos, desarrolla azúcares de madera deseables y reduce astringencia",
                  "de": "Verlängerte Lufttrocknung baut harte Tannine ab, entwickelt erwünschte Holzzucker und reduziert Adstringenz",
                  "nl": "Verlengd lucht-drogen breekt harde tannines af, ontwikkelt gewenste hout suikers en vermindert wrangheid"
        },
        {
                  "en": "Oak seasoning increases harsh flavors",
                  "es": "El sazonado del roble aumenta sabores ásperos",
                  "de": "Eichen-Würzung erhöht harte Aromen",
                  "nl": "Eiken seizoenering verhoogt harde smaken"
        },
        {
                  "en": "Seasoning only affects barrel weight",
                  "es": "El sazonado solo afecta el peso del barril",
                  "de": "Würzung beeinflusst nur Fassgewicht",
                  "nl": "Seizoenering beïnvloedt alleen vatgewicht"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Higher alcohols (isoamyl, isobutanol) indicate fermentation conditions and cut point precision; excess creates harsh flavors",
                  "es": "Alcoholes superiores (isoamílico, isobutanol) indican condiciones de fermentación y precisión de punto de corte; el exceso crea sabores ásperos",
                  "de": "Höhere Alkohole (Isoamyl, Isobutanol) zeigen Fermentationsbedingungen und Schnittpunkt-Präzision an; Überschuss schafft harte Aromen",
                  "nl": "Hogere alcoholen (isoamyl, isobutanol) duiden fermentatie condities en cut punt precisie aan; teveel creëert harde smaken"
        },
        {
                  "en": "Fusel oils are only found in vodka",
                  "es": "Los aceites de fusel solo se encuentran en el vodka",
                  "de": "Fuselöle werden nur in Wodka gefunden",
                  "nl": "Fuseloliën worden alleen in vodka gevonden"
        },
        {
                  "en": "Fusel oils always improve spirit quality",
                  "es": "Los aceites de fusel siempre mejoran la calidad del licor",
                  "de": "Fuselöle verbessern immer Spirituosenqualität",
                  "nl": "Fuseloliën verbeteren altijd spiritkwaliteit"
        },
        {
                  "en": "All premium spirits must have zero fusel content",
                  "es": "Todos los licores premium deben tener contenido cero de fusel",
                  "de": "Alle Premium-Spirituosen müssen null Fuselgehalt haben",
                  "nl": "Alle premium spirits moeten nul fusel gehalte hebben"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hot/dry climates lose more water (increasing ABV), humid climates lose more alcohol (decreasing ABV), affecting maturation profile",
                  "es": "Climas calurosos/secos pierden más agua (aumentando ABV), climas húmedos pierden más alcohol (disminuyendo ABV), afectando perfil de maduración",
                  "de": "Heiße/trockene Klimata verlieren mehr Wasser (ABV steigend), feuchte Klimata verlieren mehr Alkohol (ABV sinkend), was Reifungsprofil beeinflusst",
                  "nl": "Hete/droge klimaten verliezen meer water (ABV verhogend), vochtige klimaten verliezen meer alcohol (ABV verlagend), rijpingsprofiel beïnvloedend"
        },
        {
                  "en": "Climate has no effect on evaporation rates",
                  "es": "El clima no tiene efecto en las tasas de evaporación",
                  "de": "Klima hat keine Wirkung auf Verdunstungsraten",
                  "nl": "Klimaat heeft geen effect op verdampingssnelheden"
        },
        {
                  "en": "Only alcohol evaporates, never water",
                  "es": "Solo el alcohol se evapora, nunca el agua",
                  "de": "Nur Alkohol verdunstet, nie Wasser",
                  "nl": "Alleen alcohol verdampt, nooit water"
        },
        {
                  "en": "Angel's share is identical in all locations",
                  "es": "El ángel's share es idéntico en todas las ubicaciones",
                  "de": "Engelsanteil ist in allen Standorten identisch",
                  "nl": "Engelen aandeel is identiek op alle locaties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "This technique is not used in spirits analysis",
                  "es": "Esta técnica no se usa en análisis de licores",
                  "de": "Diese Technik wird nicht in Spirituosenanalyse verwendet",
                  "nl": "Deze techniek wordt niet gebruikt in spirits analyse"
        },
        {
                  "en": "Spectrophotometry only measures temperature",
                  "es": "La espectrofotometría solo mide temperatura",
                  "de": "Spektrophotometrie misst nur Temperatur",
                  "nl": "Spectrofotometrie meet alleen temperatuur"
        },
        {
                  "en": "UV-Vis absorbance measures color intensity, phenolic content, and can detect adulteration or aging discrepancies",
                  "es": "La absorbancia UV-Vis mide intensidad de color, contenido fenólico y puede detectar adulteración o discrepancias de envejecimiento",
                  "de": "UV-Vis-Absorban misst Farbintensität, Phenolgehalt und kann Verfälschung oder Alterungsdiskrepanzen erkennen",
                  "nl": "UV-Vis absorptie meet kleur intensiteit, fenolische inhoud en kan vervalsing of rijpings discrepanties detecteren"
        },
        {
                  "en": "Spectrophotometry decreases spirit value",
                  "es": "La espectrofotometría disminuye el valor del licor",
                  "de": "Spektrophotometrie verringert Spirituosenwert",
                  "nl": "Spectrofotometrie vermindert spirit waarde"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All yeast strains flocculate identically",
                  "es": "Todas las cepas de levadura floculan idénticamente",
                  "de": "Alle Hefestämme flockulieren identisch",
                  "nl": "Alle gist stammen flocculeren identiek"
        },
        {
                  "en": "Flocculation only affects beer, not spirits",
                  "es": "La floculación solo afecta la cerveza, no los licores",
                  "de": "Flockung beeinflusst nur Bier, nicht Spirituosen",
                  "nl": "Flocculatie beïnvloedt alleen bier, niet spirits"
        },
        {
                  "en": "Highly flocculent strains settle quickly enabling reuse but may under-attenuate; non-flocculent strains ferment longer creating different ester profiles",
                  "es": "Cepas altamente floculantes se asientan rápidamente permitiendo reutilización pero pueden sub-atenuar; cepas no floculantes fermentan más tiempo creando diferentes perfiles de éster",
                  "de": "Stark flockulierende Stämme setzen sich schnell ab und ermöglichen Wiederverwendung, können aber unter-attenuieren; nicht-flockulierende Stämme fermentieren länger und schaffen unterschiedliche Ester-Profile",
                  "nl": "Sterk flocculerende stammen bezinken snel hergebruik mogelijk makend maar kunnen onder-attenueren; niet-flocculerende stammen fermenteren langer verschillende ester profielen creërend"
        },
        {
                  "en": "Flocculation has no effect on fermentation",
                  "es": "La floculación no tiene efecto en la fermentación",
                  "de": "Flockung hat keine Wirkung auf Fermentation",
                  "nl": "Flocculatie heeft geen effect op fermentatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "This method is irrelevant to spirits",
                  "es": "Este método es irrelevante para los licores",
                  "de": "Diese Methode ist für Spirituosen irrelevant",
                  "nl": "Deze methode is irrelevant voor spirits"
        },
        {
                  "en": "Head space analysis destroys the sample",
                  "es": "El análisis de espacio de cabeza destruye la muestra",
                  "de": "Headspace-Analyse zerstört die Probe",
                  "nl": "Headspace analyse vernietigt het monster"
        },
        {
                  "en": "Captures and analyzes volatile aromatic compounds without solvent interference, revealing true aroma profile",
                  "es": "Captura y analiza compuestos aromáticos volátiles sin interferencia de solvente, revelando perfil de aroma verdadero",
                  "de": "Erfasst und analysiert flüchtige aromatische Verbindungen ohne Lösungsmittel-Interferenz und enthüllt wahres Aromaprofil",
                  "nl": "Vangt en analyseert vluchtige aromatische verbindingen zonder oplosmiddel interferentie, waar aroma profiel onthullend"
        },
        {
                  "en": "Head space analysis only measures bottle pressure",
                  "es": "El análisis de espacio de cabeza solo mide la presión de la botella",
                  "de": "Headspace-Analyse misst nur Flaschendruck",
                  "nl": "Headspace analyse meet alleen flesdruk"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Lower proof increases wood extraction and water-soluble compound pickup; higher proof favors alcohol-soluble extraction and slower maturation",
                  "es": "Menor graduación aumenta extracción de madera y absorción de compuestos solubles en agua; mayor graduación favorece extracción soluble en alcohol y maduración más lenta",
                  "de": "Niedrigerer Proof erhöht Holzextraktion und wasserösliche Verbindungsaufnahme; höherer Proof begünstigt alkohollösliche Extraktion und langsamere Reifung",
                  "nl": "Lagere proof verhoogt hout extractie en water-oplosbare verbinding opname; hogere proof begunstigt alcohol-oplosbare extractie en langzamere rijping"
        },
        {
                  "en": "Higher proof always produces inferior aged spirits",
                  "es": "Mayor graduación siempre produce licores envejecidos inferiores",
                  "de": "Höherer Proof produziert immer minderwertige gereifte Spirituosen",
                  "nl": "Hogere proof produceert altijd inferieure gerijpte spirits"
        },
        {
                  "en": "Entry proof has no effect on maturation",
                  "es": "La graduación de entrada no tiene efecto en la maduración",
                  "de": "Eintritts-Proof hat keine Wirkung auf Reifung",
                  "nl": "Intree proof heeft geen effect op rijping"
        },
        {
                  "en": "All spirits must enter at the same proof",
                  "es": "Todos los licores deben entrar a la misma graduación",
                  "de": "Alle Spirituosen müssen beim gleichen Proof eintreten",
                  "nl": "Alle spirits moeten bij dezelfde proof intreden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Vacuum increases boiling points for better flavor extraction",
                  "es": "Vacío aumenta puntos de ebullición para mejor extracción de sabor",
                  "de": "Vakuum erhöht Siedepunkte für bessere Geschmacksextraktion",
                  "nl": "Vacuüm verhoogt kookpunten voor betere smaakextractie"
        },
        {
                  "en": "Vacuum physically separates compounds through centrifugal force",
                  "es": "Vacío separa físicamente compuestos mediante fuerza centrífuga",
                  "de": "Vakuum trennt Verbindungen physisch durch Zentrifugalkraft",
                  "nl": "Vacuüm scheidt fysisch verbindingen door middelpuntvliedende kracht"
        },
        {
                  "en": "Reducing atmospheric pressure lowers boiling points, allowing distillation at temperatures that preserve delicate volatile aromatics",
                  "es": "Reducir presión atmosférica disminuye puntos de ebullición, permitiendo destilación a temperaturas que preservan aromáticos volátiles delicados",
                  "de": "Reduzierung des atmosphärischen Drucks senkt Siedepunkte und ermöglicht Destillation bei Temperaturen, die empfindliche flüchtige Aromastoffe bewahren",
                  "nl": "Verlaging van atmosferische druk verlaagt kookpunten, wat distillatie bij temperaturen mogelijk maakt die delicate vluchtige aromaten behouden"
        },
        {
                  "en": "Vacuum removes all oxygen preventing oxidation only",
                  "es": "Vacío elimina todo el oxígeno previniendo solo oxidación",
                  "de": "Vakuum entfernt allen Sauerstoff und verhindert nur Oxidation",
                  "nl": "Vacuüm verwijdert alle zuurstof en voorkomt alleen oxidatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Soil mineral composition, volcanic compounds, and regional microflora affect agave metabolism producing distinctive volatile and non-volatile compound profiles",
                  "es": "Composición mineral del suelo, compuestos volcánicos y microflora regional afectan metabolismo del agave produciendo perfiles distintivos de compuestos volátiles y no volátiles",
                  "de": "Bodenmineralzusammensetzung, vulkanische Verbindungen und regionale Mikroflora beeinflussen Agave-Metabolismus und produzieren charakteristische Profile flüchtiger und nicht-flüchtiger Verbindungen",
                  "nl": "Bodem mineraal samenstelling, vulkanische verbindingen en regionale microflora beïnvloeden agave metabolisme wat onderscheidende vluchtige en niet-vluchtige verbindingsprofielen produceert"
        },
        {
                  "en": "Terroir only affects agave sugar content, not flavor compounds",
                  "es": "Terroir solo afecta contenido de azúcar del agave, no compuestos de sabor",
                  "de": "Terroir beeinflusst nur Agave-Zuckergehalt, nicht Geschmacksverbindungen",
                  "nl": "Terroir beïnvloedt alleen agave suikergehalte, niet smaakverbindingen"
        },
        {
                  "en": "Terroir is purely marketing and has no chemical basis",
                  "es": "Terroir es puramente marketing y no tiene base química",
                  "de": "Terroir ist rein Marketing und hat keine chemische Basis",
                  "nl": "Terroir is puur marketing en heeft geen chemische basis"
        },
        {
                  "en": "Regional differences are artificially added after distillation",
                  "es": "Diferencias regionales son añadidas artificialmente después de destilación",
                  "de": "Regionale Unterschiede werden künstlich nach der Destillation hinzugefügt",
                  "nl": "Regionale verschillen worden kunstmatig toegevoegd na distillatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All phenolic compounds evaporate completely during distillation",
                  "es": "Todos los compuestos fenólicos se evaporan completamente durante destilación",
                  "de": "Alle phenolischen Verbindungen verdunsten vollständig während der Destillation",
                  "nl": "Alle fenolische verbindingen verdampen volledig tijdens distillatie"
        },
        {
                  "en": "PPM directly equals perceived smokiness with 1:1 correlation",
                  "es": "PPM equivale directamente al ahumado percibido con correlación 1:1",
                  "de": "PPM entspricht direkt der wahrgenommenen Rauchigkeit mit 1:1 Korrelation",
                  "nl": "PPM komt direct overeen met waargenomen rokerigheid met 1:1 correlatie"
        },
        {
                  "en": "PPM measures peat quantity added during kilning, not actual phenols",
                  "es": "PPM mide cantidad de turba añadida durante secado, no fenoles reales",
                  "de": "PPM misst während des Darrens hinzugefügte Torfmenge, nicht tatsächliche Phenole",
                  "nl": "PPM meet turf hoeveelheid toegevoegd tijdens drogen, niet werkelijke fenolen"
        },
        {
                  "en": "PPM measures phenolic compounds (guaiacol, cresol) bound to malt; roughly 30-40% survives distillation, with perception varying by individual phenol types and concentrations",
                  "es": "PPM mide compuestos fenólicos (guayacol, cresol) unidos a malta; aproximadamente 30-40% sobrevive destilación, con percepción variando por tipos y concentraciones de fenoles individuales",
                  "de": "PPM misst phenolische Verbindungen (Guajacol, Kresol), die an Malz gebunden sind; etwa 30-40% überleben Destillation, wobei Wahrnehmung durch individuelle Phenoltypen und -konzentrationen variiert",
                  "nl": "PPM meet fenolische verbindingen (guaiacol, cresol) gebonden aan mout; ongeveer 30-40% overleeft distillatie, met perceptie variërend per individuele fenol types en concentraties"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Rotovap only increases production speed without affecting chemistry",
                  "es": "Rotovap solo aumenta velocidad de producción sin afectar química",
                  "de": "Rotovap erhöht nur Produktionsgeschwindigkeit ohne Chemie zu beeinflussen",
                  "nl": "Rotovap verhoogt alleen productiesnelheid zonder chemie te beïnvloeden"
        },
        {
                  "en": "Rotovap combines vacuum, low temperature, and rotation to extract volatile compounds without thermal degradation, preserving fresh botanical character impossible in conventional stills",
                  "es": "Rotovap combina vacío, baja temperatura y rotación para extraer compuestos volátiles sin degradación térmica, preservando carácter botánico fresco imposible en alambiques convencionales",
                  "de": "Rotovap kombiniert Vakuum, niedrige Temperatur und Rotation, um flüchtige Verbindungen ohne thermische Degradation zu extrahieren und frischen botanischen Charakter zu bewahren, unmöglich in konventionellen Destillierapparaten",
                  "nl": "Rotovap combineert vacuüm, lage temperatuur en rotatie om vluchtige verbindingen te extraheren zonder thermische degradatie, behoud van vers botanisch karakter onmogelijk in conventionele ketels"
        },
        {
                  "en": "Rotary evaporation produces higher alcohol concentrations than traditional distillation",
                  "es": "Evaporación rotatoria produce concentraciones de alcohol más altas que destilación tradicional",
                  "de": "Rotationsverdampfung produziert höhere Alkoholkonzentrationen als traditionelle Destillation",
                  "nl": "Roterende verdamping produceert hogere alcohol concentraties dan traditionele distillatie"
        },
        {
                  "en": "Rotation mechanically crushes botanicals to release more oils",
                  "es": "Rotación tritura mecánicamente botánicos para liberar más aceites",
                  "de": "Rotation zerkleinert mechanisch Botanicals, um mehr Öle freizusetzen",
                  "nl": "Rotatie verbrijzelt mechanisch botanicals om meer oliën vrij te geven"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Oak chips provide rapid surface-area extraction but lack micro-oxygenation and gradual lignin breakdown from stave respiration and barrel porosity",
                  "es": "Astillas de roble proporcionan extracción rápida de área de superficie pero carecen de micro-oxigenación y descomposición gradual de lignina de respiración de duelas y porosidad del barril",
                  "de": "Eichen-Chips bieten schnelle Oberflächenextraktion, fehlen aber Mikro-Oxygenierung und schrittweiser Ligninabbau durch Daubenatmung und Fassporosität",
                  "nl": "Eiken chips bieden snelle oppervlakte-extractie maar missen micro-oxygenatie en geleidelijke lignine afbraak van duig respiratie en vat porositeit"
        },
        {
                  "en": "Chips and barrels provide chemically identical aging with no molecular differences",
                  "es": "Astillas y barriles proporcionan envejecimiento químicamente idéntico sin diferencias moleculares",
                  "de": "Chips und Fässer bieten chemisch identische Reifung ohne molekulare Unterschiede",
                  "nl": "Chips en vaten bieden chemisch identieke rijping zonder moleculaire verschillen"
        },
        {
                  "en": "Chips accelerate aging through enzymatic catalysis absent in barrels",
                  "es": "Astillas aceleran envejecimiento mediante catálisis enzimática ausente en barriles",
                  "de": "Chips beschleunigen Reifung durch enzymatische Katalyse, die in Fässern fehlt",
                  "nl": "Chips versnellen rijping door enzymatische katalyse afwezig in vaten"
        },
        {
                  "en": "Barrel staves contain special enzymes that chips cannot replicate",
                  "es": "Duelas de barril contienen enzimas especiales que astillas no pueden replicar",
                  "de": "Fassdauben enthalten spezielle Enzyme, die Chips nicht replizieren können",
                  "nl": "Vat duigen bevatten speciale enzymen die chips niet kunnen repliceren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Barrel browning is purely from wood pigments dissolving into spirit",
                  "es": "Dorado del barril es puramente de pigmentos de madera disolviéndose en licor",
                  "de": "Fass-Bräunung stammt rein von Holzpigmenten, die sich in Spirituosen auflösen",
                  "nl": "Vat bruining komt puur van hout pigmenten die oplossen in spirit"
        },
        {
                  "en": "Charring creates simple carbon that only filters impurities",
                  "es": "Carbonización crea carbono simple que solo filtra impurezas",
                  "de": "Verkohlung erzeugt einfachen Kohlenstoff, der nur Verunreinigungen filtert",
                  "nl": "Verkolen creëert simpele koolstof die alleen onzuiverheden filtert"
        },
        {
                  "en": "Maillard reactions only occur in food cooking and have no role in barrel aging",
                  "es": "Reacciones de Maillard solo ocurren en cocción de alimentos y no tienen papel en envejecimiento en barril",
                  "de": "Maillard-Reaktionen treten nur beim Kochen von Lebensmitteln auf und spielen keine Rolle bei der Fassreifung",
                  "nl": "Maillard reacties komen alleen voor bij voedselbereiding en hebben geen rol in vat rijping"
        },
        {
                  "en": "Carbonyl-amine condensation between wood sugars and amino acids creates melanoidins and Amadori products that release vanillin, furfural, and caramel compounds during aging",
                  "es": "Condensación carbonilo-amina entre azúcares de madera y aminoácidos crea melanoidinas y productos Amadori que liberan vainillina, furfural y compuestos de caramelo durante envejecimiento",
                  "de": "Carbonyl-Amin-Kondensation zwischen Holzzuckern und Aminosäuren erzeugt Melanoidine und Amadori-Produkte, die während der Reifung Vanillin, Furfural und Karamellverbindungen freisetzen",
                  "nl": "Carbonyl-amine condensatie tussen hout suikers en aminozuren creëert melanoidines en Amadori producten die vanilline, furfural en karamel verbindingen vrijgeven tijdens rijping"
        }
        ],
        correct: 3,
        explanation: {
