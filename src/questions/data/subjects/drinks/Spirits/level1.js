// Spirits - level1
// Total questions: 100
// Quality issues fixed: 2026-03-03T10:19:07.437Z
    ...
    questions: [
            {
                    ...
                    "options": [
                            {
                                    ...
                                    "es": "Granos o papas",
                                    "de": "Getreide oder Kartoffeln",
                                    "nl": "Granen of aardappelen"
                            },
                            {
                                    "en": "Grapes only",
                                    "es": "Solo uvas",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Vodka is traditionally made from fermented grains like wheat or rye, or from potatoes. It's distilled to a high proof and filtered for purity.",
                            "es": "El vodka se hace tradicionalmente de granos fermentados como trigo o centeno, o de papas. Se destila a alta graduación y se filtra para pureza.",
                            "de": "Wodka wird traditionell aus fermentierten Getreiden wie Weizen oder Roggen oder aus Kartoffeln hergestellt. Er wird hochprozentig destilliert und gefiltert.",
                            "nl": "Wodka wordt traditioneel gemaakt van gefermenteerde granen zoals tarwe of rogge, of van aardappelen. Het wordt tot hoog alcoholgehalte gedistilleerd en gefilterd."
                    }
            },
            {
                    "question": {
                            "en": "What gives whiskey its golden color?",
                            "es": "¿Qué le da al whisky su color dorado?",
                            "de": "Was verleiht Whisky seine goldene Farbe?",
                            "nl": "Wat geeft whisky zijn gouden kleur?"
                    },
                    "options": [
                            {
                                    "en": "Aging in oak barrels",
                                    "es": "Envejecimiento en barriles de roble",
                                    "de": "Reifung in Eichenfässern",
                                    "nl": "Rijping in eiken vaten"
                            },
                            {
                                    "en": "Added caramel coloring",
                                    "es": "Colorante de caramelo añadido",
                                    "de": "Zugesetzter Karamellfarbstoff",
                                    "nl": "Toegevoegde karamelkleurstof"
                            },
                            {
                                    "en": "The grain used",
                                    "es": "El grano usado",
                                    "de": "Das verwendete Getreide",
                                    "nl": "Het gebruikte graan"
                            },
                            {
                                    "en": "Natural fermentation",
                                    "es": "Fermentación natural",
                                    "de": "Natürliche Gärung",
                                    "nl": "Natuurlijke fermentatie"
                            }
                    ],
                    "correct": 0,
                    "explanation": {
                            "en": "Whiskey gets its golden color from aging in charred oak barrels. The spirit extracts color and flavor compounds from the wood over time.",
                            "es": "El whisky obtiene su color dorado del envejecimiento en barriles de roble carbonizados. El licor extrae color y compuestos de sabor de la madera con el tiempo.",
                            "de": "Whisky erhält seine goldene Farbe durch die Reifung in angekohlten Eichenfässern. Der Alkohol extrahiert Farbe und Geschmacksstoffe aus dem Holz.",
                            "nl": "Whisky krijgt zijn gouden kleur door rijping in verkoolde eiken vaten. De drank haalt kleur en smaakstoffen uit het hout."
                    }
            },
            {
                    "question": {
                            "en": "What is rum made from?",
                            "es": "¿De qué está hecho el ron?",
                            "de": "Woraus wird Rum hergestellt?",
                            "nl": "Waarvan wordt rum gemaakt?"
                    },
                    "options": [
                            {
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Rum is made from sugar cane juice or molasses, a byproduct of sugar production. It originated in the Caribbean where sugar cane grows abundantly.",
                            "es": "El ron se hace de jugo de caña de azúcar o melaza, un subproducto de la producción de azúcar. Se originó en el Caribe donde la caña de azúcar crece abundantemente.",
                            "de": "Rum wird aus Zuckerrohrsaft oder Melasse, einem Nebenprodukt der Zuckerproduktion, hergestellt. Er stammt aus der Karibik, wo Zuckerrohr reichlich wächst.",
                            "nl": "Rum wordt gemaakt van suikerrietsap of melasse, een bijproduct van suikerproductie. Het komt uit het Caribisch gebied waar suikerriet overvloedig groeit."
                    }
            },
            {
                    "question": {
                            "en": "What is the main botanical in gin?",
                            "es": "¿Cuál es el botánico principal en la ginebra?",
                            "de": "Was ist die Hauptbotanik im Gin?",
                            "nl": "Wat is de belangrijkste botanische stof in gin?"
                    },
                    "options": [
                            {
                                    "en": "Juniper berries",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Juniper berries are the defining botanical in gin, giving it its distinctive pine-like flavor. By law, gin must have juniper as its predominant flavor.",
                            "es": "Las bayas de enebro son el botánico definitorio de la ginebra, dándole su distintivo sabor a pino. Por ley, la ginebra debe tener enebro como su sabor predominante.",
                            "de": "Wacholderbeeren sind die definierende Botanik im Gin und verleihen ihm seinen charakteristischen pinienartigen Geschmack. Gesetzlich muss Gin Wacholder als vorherrschenden Geschmack haben.",
                            "nl": "Jeneverbessen zijn de bepalende botanische stof in gin, die het zijn kenmerkende dennenachtige smaak geeft. Wettelijk moet gin jeneverbes als overheersende smaak hebben."
                    }
            },
            {
                    "question": {
                            "en": "What Mexican spirit is made from agave?",
                            "es": "¿Qué licor mexicano se hace del agave?",
                            "de": "Welcher mexikanische Schnaps wird aus Agave hergestellt?",
                            "nl": "Welke Mexicaanse drank wordt van agave gemaakt?"
                    },
                    "options": [
                            {
                                    "en": "Tequila",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Tequila is made from blue agave plant, specifically from the Jalisco region of Mexico. It must contain at least 51% agave to be called tequila.",
                            "es": "El tequila se hace de la planta de agave azul, específicamente de la región de Jalisco en México. Debe contener al menos 51% de agave para llamarse tequila.",
                            "de": "Tequila wird aus der blauen Agavenpflanze hergestellt, speziell aus der Jalisco-Region in Mexiko. Er muss mindestens 51% Agave enthalten, um Tequila genannt zu werden.",
                            "nl": "Tequila wordt gemaakt van de blauwe agaveplant, specifiek uit de Jalisco-regio in Mexico. Het moet minstens 51% agave bevatten om tequila genoemd te worden."
                    }
            },
            {
                    "question": {
                    ...
                    "correct": 3,
                    "explanation": {
                            "en": "This question relates to level 1 content in Spirits. The correct answer provides important context.",
                            "es": "This question relates to level 1 content in Spirits. The correct answer provides important context.",
                            "de": "This question relates to level 1 content in Spirits. The correct answer provides important context.",
                            "nl": "This question relates to level 1 content in Spirits. The correct answer provides important context."
                    }
            },
            {
                    "question": {
