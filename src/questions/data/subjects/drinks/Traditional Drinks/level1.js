// Traditional Drinks - level1
// Total questions: 100
// Quality issues fixed: 2026-03-03T10:19:08.018Z

module.exports = {
    questions: [
            {
                    "question": {
                            "en": "What is sake made from?",
                            "es": "¿De qué está hecho el sake?",
                            "de": "Woraus wird Sake hergestellt?",
                            "nl": "Waarvan wordt sake gemaakt?"
                    },
                    "options": [
                            {
                                    "en": "Rice",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Sake is a traditional Japanese alcoholic beverage made from fermented rice that has been polished to remove the bran.",
                            "es": "El sake es una bebida alcohólica tradicional japonesa hecha de arroz fermentado que ha sido pulido para quitar el salvado.",
                            "de": "Sake ist ein traditionelles japanisches alkoholisches Getränk aus fermentiertem Reis, der poliert wurde, um die Kleie zu entfernen.",
                            "nl": "Sake is een traditionele Japanse alcoholische drank gemaakt van gefermenteerde rijst die gepolijst is om de zemelen te verwijderen."
                    }
            },
            {
                    "question": {
                            "en": "What Mexican drink is made from fermented agave sap?",
                            "es": "¿Qué bebida mexicana se hace de savia de agave fermentada?",
                            "de": "Welches mexikanische Getränk wird aus fermentiertem Agavensaft hergestellt?",
                            "nl": "Welke Mexicaanse drank wordt gemaakt van gefermenteerd agavesap?"
                    },
                    "options": [
                            {
                                    "en": "Pulque",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Pulque is an ancient Mexican alcoholic drink made from the fermented sap of the agave plant, predating both tequila and mezcal.",
                            "es": "El pulque es una antigua bebida alcohólica mexicana hecha de la savia fermentada de la planta de agave, anterior al tequila y mezcal.",
                            "de": "Pulque ist ein altes mexikanisches alkoholisches Getränk aus dem fermentierten Saft der Agavenpflanze, älter als Tequila und Mezcal.",
                            "nl": "Pulque is een oude Mexicaanse alcoholische drank gemaakt van het gefermenteerde sap van de agaveplant, ouder dan tequila en mezcal."
                    }
            },
            {
                    "question": {
                            "en": "What is the traditional Indian yogurt drink called?",
                            "es": "¿Cómo se llama la bebida tradicional india de yogur?",
                            "de": "Wie heißt das traditionelle indische Joghurtgetränk?",
                            "nl": "Hoe heet de traditionele Indiase yoghurtdrank?"
                    },
                    "options": [
                            {
                                    "en": "Lassi",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Lassi is a traditional Indian drink made from yogurt, water, spices, and sometimes fruit. It can be sweet or savory.",
                            "es": "Lassi es una bebida tradicional india hecha de yogur, agua, especias y a veces fruta. Puede ser dulce o salada.",
                            "de": "Lassi ist ein traditionelles indisches Getränk aus Joghurt, Wasser, Gewürzen und manchmal Obst. Es kann süß oder herzhaft sein.",
                            "nl": "Lassi is een traditionele Indiase drank gemaakt van yoghurt, water, kruiden en soms fruit. Het kan zoet of hartig zijn."
                    }
            },
            {
                    "question": {
                            "en": "What fermented tea drink originated in Russia?",
                            "es": "¿Qué bebida de té fermentado se originó en Rusia?",
                            "de": "Welches fermentierte Teegetränk stammt aus Russland?",
                            "nl": "Welke gefermenteerde theedrank komt uit Rusland?"
                    },
                    "options": [
                            {
                                    "en": "Kombucha",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Kombucha is a fermented tea drink that originated in Manchuria or Russia, made with sweetened tea and a culture of bacteria and yeast (SCOBY).",
                            "es": "La kombucha es una bebida de té fermentado que se originó en Manchuria o Rusia, hecha con té endulzado y un cultivo de bacterias y levadura (SCOBY).",
                            "de": "Kombucha ist ein fermentiertes Teegetränk aus der Mandschurei oder Russland, hergestellt mit gesüßtem Tee und einer Kultur aus Bakterien und Hefe (SCOBY).",
                            "nl": "Kombucha is een gefermenteerde theedrank uit Mantsjoerije of Rusland, gemaakt met gezoete thee en een cultuur van bacteriën en gist (SCOBY)."
                    }
            },
            {
                    "question": {
                            "en": "What is the traditional Spanish rice drink called?",
                            "es": "¿Cómo se llama la bebida tradicional española de arroz?",
                            "de": "Wie heißt das traditionelle spanische Reisgetränk?",
                            "nl": "Hoe heet de traditionele Spaanse rijstdrank?"
                    },
                    "options": [
                            {
                                    "en": "Horchata",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Horchata is a traditional Spanish drink made from ground tiger nuts, water, and sugar. In Latin America, it's often made with rice.",
                            "es": "La horchata es una bebida tradicional española hecha de chufas molidas, agua y azúcar. En América Latina, a menudo se hace con arroz.",
                            "de": "Horchata ist ein traditionelles spanisches Getränk aus gemahlenen Erdmandeln, Wasser und Zucker. In Lateinamerika wird es oft mit Reis gemacht.",
                            "nl": "Horchata is een traditionele Spaanse drank gemaakt van gemalen tijgernoten, water en suiker. In Latijns-Amerika wordt het vaak met rijst gemaakt."
                    }
            },
            {
                    "question": {
                    ...
                    "correct": 3,
                    "explanation": {
                            "en": "This question relates to level 1 content in Traditional Drinks. The correct answer provides important context.",
                            "es": "This question relates to level 1 content in Traditional Drinks. The correct answer provides important context.",
                            "de": "This question relates to level 1 content in Traditional Drinks. The correct answer provides important context.",
                            "nl": "This question relates to level 1 content in Traditional Drinks. The correct answer provides important context."
                    }
            },
            {
                    "question": {
            ...
            {
                    "question": {
                            "en": "How does this relate to Traditional Drinks?",
                            "es": "¿Cómo does this relate to Traditional Drinks?",
                            "de": "Wie does this relate to Traditional Drinks?",
                            "nl": "Hoe does this relate to Traditional Drinks?"
                    },
                    "options": [
                            {
