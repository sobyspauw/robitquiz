// Quiz Level 8: Drinken - Cocktails (Professional Mixology & Advanced Bartending)
(function() {
  const level8 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Clarification removes particles for transparency, fat-washing infuses flavor using fats then removes them", es: "Clarificación remueve partículas para transparencia, lavado de grasa infunde sabor usando grasas luego las remueve", de: "Klärung entfernt Partikel für Transparenz, Fett-Washing infundiert Geschmack mit Fetten und entfernt sie dann", nl: "Clarificatie verwijdert deeltjes voor transparantie, fat-washing infuseert smaak met vetten en verwijdert deze daarna" },
          { en: "They are the same technique with different names", es: "Son la misma técnica con nombres diferentes", de: "Sie sind dieselbe Technik mit verschiedenen Namen", nl: "Het zijn dezelfde technieken met verschillende namen" },
          { en: "Clarification is for spirits only, fat-washing is for mixers", es: "Clarificación es solo para licores, lavado de grasa es para mezcladores", de: "Klärung ist nur für Spirituosen, Fett-Washing ist für Mixer", nl: "Clarificatie is alleen voor sterke drank, fat-washing is voor mixers" },
          { en: "Fat-washing removes alcohol, clarification adds it", es: "Lavado de grasa remueve alcohol, clarificación lo añade", de: "Fett-Washing entfernt Alkohol, Klärung fügt ihn hinzu", nl: "Fat-washing verwijdert alcohol, clarificatie voegt het toe" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To extract citrus oils from peels using sugar, creating a concentrated flavor base", es: "Para extraer aceites cítricos de cáscaras usando azúcar, creando una base de sabor concentrada", de: "Um Zitrusöle aus Schalen mit Zucker zu extrahieren und eine konzentrierte Geschmacksbasis zu schaffen", nl: "Om citrusoliën uit schillen te extraheren met suiker, wat een geconcentreerde smaakbasis creëert" },
          { en: "To preserve spirits for longer storage", es: "Para conservar licores para almacenamiento más largo", de: "Um Spirituosen für längere Lagerung zu konservieren", nl: "Om sterke dranken te bewaren voor langere opslag" },
          { en: "To add sweetness without changing color", es: "Para añadir dulzura sin cambiar color", de: "Um Süße hinzuzufügen ohne Farbveränderung", nl: "Om zoetheid toe te voegen zonder kleur te veranderen" },
          { en: "To create foam in cocktails", es: "Para crear espuma en cócteles", de: "Um Schaum in Cocktails zu erzeugen", nl: "Om schuim in cocktails te creëren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Shake with ice first, then without ice - preferred for better foam stability and temperature control", es: "Agitar con hielo primero, luego sin hielo - preferido para mejor estabilidad de espuma y control de temperatura", de: "Zuerst mit Eis schütteln, dann ohne Eis - bevorzugt für bessere Schaumstabilität und Temperaturkontrolle", nl: "Eerst schudden met ijs, dan zonder ijs - de voorkeur voor betere schuimstabiliteit en temperatuurcontrole" },
          { en: "Adding ingredients in reverse order", es: "Añadir ingredientes en orden inverso", de: "Zutaten in umgekehrter Reihenfolge hinzufügen", nl: "Ingrediënten in omgekeerde volgorde toevoegen" },
          { en: "Shaking upside down", es: "Agitar boca abajo", de: "Kopfüber schütteln", nl: "Ondersteboven schudden" },
          { en: "Using two shakers simultaneously", es: "Usar dos cocteleras simultáneamente", de: "Zwei Shaker gleichzeitig verwenden", nl: "Twee shakers tegelijkertijd gebruiken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Precisely controlling pH levels to optimize flavor perception and balance sweetness", es: "Controlar precisamente los niveles de pH para optimizar la percepción del sabor y equilibrar la dulzura", de: "Präzise Kontrolle der pH-Werte zur Optimierung der Geschmackswahrnehmung und Balance der Süße", nl: "Nauwkeurige controle van pH-niveaus om smaakperceptie te optimaliseren en zoetheid te balanceren" },
          { en: "Adding more citrus juice to any cocktail", es: "Añadir más jugo cítrico a cualquier cóctel", de: "Mehr Zitrusaft zu jedem Cocktail hinzufügen", nl: "Meer citrusjus toevoegen aan elke cocktail" },
          { en: "Removing all acidic ingredients", es: "Remover todos los ingredientes ácidos", de: "Alle säurehaltigen Zutaten entfernen", nl: "Alle zure ingrediënten verwijderen" },
          { en: "Using only vinegar-based acids", es: "Usar solo ácidos basados en vinagre", de: "Nur essigbasierte Säuren verwenden", nl: "Alleen azijngebaseerde zuren gebruiken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Pre-mixing large quantities while accounting for dilution, ingredient stability, and temperature control", es: "Pre-mezclar grandes cantidades considerando dilución, estabilidad de ingredientes y control de temperatura", de: "Vormischen großer Mengen unter Berücksichtigung von Verdünnung, Zutatenstabilität und Temperaturkontrolle", nl: "Vooraf mengen van grote hoeveelheden met aandacht voor verdunning, ingrediënt stabiliteit en temperatuurcontrole" },
          { en: "Serving multiple cocktails at once", es: "Servir múltiples cócteles a la vez", de: "Mehrere Cocktails gleichzeitig servieren", nl: "Meerdere cocktails tegelijk serveren" },
          { en: "Using only batch-distilled spirits", es: "Usar solo licores destilados en lotes", de: "Nur chargendestillierte Spirituosen verwenden", nl: "Alleen batch-gedestilleerde sterke dranken gebruiken" },
          { en: "Grouping similar colored cocktails", es: "Agrupar cócteles de colores similares", de: "Cocktails mit ähnlichen Farben gruppieren", nl: "Cocktails met vergelijkbare kleuren groeperen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Controlling alcohol percentage to achieve optimal flavor integration and drinking experience", es: "Controlar el porcentaje de alcohol para lograr integración óptima de sabor y experiencia de bebida", de: "Alkoholprozentsatz kontrollieren für optimale Geschmacksintegration und Trinkerfahrung", nl: "Alcoholpercentage controleren voor optimale smaakintegratie en drinkervaring" },
          { en: "Making all cocktails exactly 40% alcohol", es: "Hacer todos los cócteles exactamente 40% alcohol", de: "Alle Cocktails auf genau 40% Alkohol bringen", nl: "Alle cocktails precies 40% alcohol maken" },
          { en: "Adding more proof spirits to increase strength", es: "Añadir licores de mayor graduación para aumentar fuerza", de: "Höherprozentige Spirituosen hinzufügen für mehr Stärke", nl: "Sterke dranken met hoger alcoholgehalte toevoegen voor meer kracht" },
          { en: "Proving the cocktail is authentic", es: "Probar que el cóctel es auténtico", de: "Beweisen, dass der Cocktail authentisch ist", nl: "Bewijzen dat de cocktail authentiek is" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Expressing oils over the drink then discarding the peel to avoid bitter pith flavors", es: "Expresar aceites sobre la bebida luego descartar la cáscara para evitar sabores amargos de médula", de: "Öle über das Getränk ausdrücken, dann die Schale entsorgen, um bittere Mark-Aromen zu vermeiden", nl: "Oliën uitpersen over de drank en dan de schil weggooien om bittere wit smaken te vermijden" },
          { en: "Throwing away all citrus peels", es: "Tirar todas las cáscaras cítricas", de: "Alle Zitrusschalen wegwerfen", nl: "Alle citrusschillen weggooien" },
          { en: "Using only the juice, not the peel", es: "Usar solo el jugo, no la cáscara", de: "Nur den Saft verwenden, nicht die Schale", nl: "Alleen het sap gebruiken, niet de schil" },
          { en: "Adding citrus oil directly from a bottle", es: "Añadir aceite cítrico directamente de una botella", de: "Zitrusöl direkt aus einer Flasche hinzufügen", nl: "Citrusolie direct uit een fles toevoegen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Alcohol-based extracts that add concentrated flavors in small doses without affecting texture", es: "Extractos basados en alcohol que añaden sabores concentrados en dosis pequeñas sin afectar textura", de: "Alkoholbasierte Extrakte, die konzentrierte Aromen in kleinen Dosen hinzufügen ohne Textur zu beeinflussen", nl: "Alcohol-gebaseerde extracten die geconcentreerde smaken in kleine doses toevoegen zonder textuur te beïnvloeden" },
          { en: "Coloring agents for cocktails", es: "Agentes colorantes para cócteles", de: "Farbstoffe für Cocktails", nl: "Kleurmiddelen voor cocktails" },
          { en: "Preservatives to extend shelf life", es: "Conservantes para extender vida útil", de: "Konservierungsmittel zur Verlängerung der Haltbarkeit", nl: "Conserveermiddelen om houdbaarheid te verlengen" },
          { en: "Thickening agents for texture", es: "Agentes espesantes para textura", de: "Verdickungsmittel für Textur", nl: "Verdikkingsmiddelen voor textuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Adding carbonated elements at the final stage to preserve fizz and prevent over-dilution", es: "Añadir elementos carbonatados en la etapa final para preservar efervescencia y prevenir sobre-dilución", de: "Kohlensäurehaltige Elemente in der Endphase hinzufügen um Sprudel zu bewahren und Überverdünnung zu verhindern", nl: "Koolzuurhoudende elementen in de laatste fase toevoegen om bruising te behouden en overdunning te voorkomen" },
          { en: "Shaking all ingredients with soda water", es: "Agitar todos los ingredientes con agua con gas", de: "Alle Zutaten mit Sodawasser schütteln", nl: "Alle ingrediënten schudden met sodawater" },
          { en: "Using only pre-carbonated cocktails", es: "Usar solo cócteles pre-carbonatados", de: "Nur vorkohlensäurehaltige Cocktails verwenden", nl: "Alleen vooraf gekoolzuurde cocktails gebruiken" },
          { en: "Adding carbonation during the muddling process", es: "Añadir carbonatación durante el proceso de macerado", de: "Kohlensäure während des Muddling-Prozesses hinzufügen", nl: "Koolzuur toevoegen tijdens het muddlen proces" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Different mineral profiles affect flavor, mouthfeel, and how other ingredients integrate", es: "Diferentes perfiles minerales afectan sabor, sensación en boca y cómo se integran otros ingredientes", de: "Verschiedene Mineralprofile beeinflussen Geschmack, Mundgefühl und wie sich andere Zutaten integrieren", nl: "Verschillende mineraalprofielen beïnvloeden smaak, mondgevoel en hoe andere ingrediënten integreren" },
          { en: "Only distilled water should be used", es: "Solo agua destilada debe usarse", de: "Nur destilliertes Wasser sollte verwendet werden", nl: "Alleen gedestilleerd water moet worden gebruikt" },
          { en: "Mineral content doesn't matter in cocktails", es: "El contenido mineral no importa en cócteles", de: "Mineralgehalt spielt in Cocktails keine Rolle", nl: "Mineraalgehalte doet er niet toe in cocktails" },
          { en: "Higher minerals always make better cocktails", es: "Más minerales siempre hacen mejores cócteles", de: "Höhere Mineralien machen immer bessere Cocktails", nl: "Hogere mineralen maken altijd betere cocktails" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The ratio of water added from ice melting (typically 20-25%)", es: "La proporción de agua agregada del derretimiento del hielo (típicamente 20-25%)", de: "Das Verhältnis von durch Eisschmelzen zugeführtem Wasser (typisch 20-25%)", nl: "De verhouding van toegevoegd water door ijsmelten (typisch 20-25%)" },
          { en: "How much mixer to add", es: "Cuánto mezclador agregar", de: "Wie viel Mixer hinzufügen", nl: "Hoeveel mixer toe te voegen" },
          { en: "Alcohol percentage", es: "Porcentaje de alcohol", de: "Alkoholprozentsatz", nl: "Alcoholpercentage" },
          { en: "Glass size", es: "Tamaño del vaso", de: "Glasgröße", nl: "Glas grootte" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The recipe or specification of ingredients and proportions", es: "La receta o especificación de ingredientes y proporciones", de: "Das Rezept oder die Spezifikation von Zutaten und Proportionen", nl: "Het recept of specificatie van ingrediënten en verhoudingen" },
          { en: "Type of glassware", es: "Tipo de cristalería", de: "Art der Glasware", nl: "Soort glaswerk" },
          { en: "Special garnish", es: "Guarnición especial", de: "Besondere Garnitur", nl: "Speciale garnering" },
          { en: "Spectacle presentation", es: "Presentación espectacular", de: "Spektakuläre Präsentation", nl: "Spectaculaire presentatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cocktail where spirits are primary, minimal dilution (Manhattan, Negroni)", es: "Cóctel donde los licores son primarios, dilución mínima (Manhattan, Negroni)", de: "Cocktail, wo Spirituosen primär sind, minimale Verdünnung (Manhattan, Negroni)", nl: "Cocktail waar spirits primair zijn, minimale verdunning (Manhattan, Negroni)" },
          { en: "High alcohol content only", es: "Solo alto contenido de alcohol", de: "Nur hoher Alkoholgehalt", nl: "Alleen hoog alcoholgehalte" },
          { en: "Premium spirits used", es: "Licores premium usados", de: "Premium-Spirituosen verwendet", nl: "Premium spirits gebruikt" },
          { en: "Served first", es: "Servido primero", de: "Zuerst serviert", nl: "Eerst geserveerd" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Bourbon or rye, sweet vermouth, Campari (whiskey Negroni)", es: "Bourbon o centeno, vermut dulce, Campari (Negroni de whisky)", de: "Bourbon oder Roggen, süßer Wermut, Campari (Whiskey-Negroni)", nl: "Bourbon of rogge, zoete vermouth, Campari (whiskey Negroni)" },
          { en: "French champagne cocktail", es: "Cóctel de champán francés", de: "Französischer Champagner-Cocktail", nl: "Franse champagne cocktail" },
          { en: "Gin martini variation", es: "Variación de martini de ginebra", de: "Gin-Martini-Variation", nl: "Gin martini variatie" },
          { en: "Coffee liqueur drink", es: "Bebida de licor de café", de: "Kaffeelikörgetränk", nl: "Koffielikeur drankje" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Releasing aromatic citrus oils over the drink's surface", es: "Liberar aceites aromáticos de cítricos sobre la superficie de la bebida", de: "Aromatische Zitrusöle über die Getränkeoberfläche freisetzen", nl: "Aromatische citrus oliën vrijgeven over het oppervlak van de drank" },
          { en: "Adding sweetness", es: "Agregar dulzura", de: "Süße hinzufügen", nl: "Zoetheid toevoegen" },
          { en: "Decoration only", es: "Solo decoración", de: "Nur Dekoration", nl: "Alleen decoratie" },
          { en: "Adding bitterness", es: "Agregar amargura", de: "Bitterkeit hinzufügen", nl: "Bitterheid toevoegen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Secret blend of herbs and spices (gentian root prominent)", es: "Mezcla secreta de hierbas y especias (raíz de genciana prominente)", de: "Geheime Mischung aus Kräutern und Gewürzen (Enzianwurzel prominent)", nl: "Geheime mix van kruiden en specerijen (gentiaan wortel prominent)" },
          { en: "Only angostura bark", es: "Solo corteza de angostura", de: "Nur Angostura-Rinde", nl: "Alleen angostura schors" },
          { en: "Coffee and chocolate", es: "Café y chocolate", de: "Kaffee und Schokolade", nl: "Koffie en chocolade" },
          { en: "Citrus peels only", es: "Solo cáscaras de cítricos", de: "Nur Zitrusschalen", nl: "Alleen citrusschillen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Tequila, lime, grenadine, Angostura bitters", es: "Tequila, lima, granadina, amargos Angostura", de: "Tequila, Limette, Grenadine, Angostura-Bitter", nl: "Tequila, limoen, granaatappelsiroop, Angostura bitters" },
          { en: "Mezcal shot ritual", es: "Ritual de shot de mezcal", de: "Mezcal-Shot-Ritual", nl: "Mezcal shot ritueel" },
          { en: "Spicy jalapeño margarita", es: "Margarita picante de jalapeño", de: "Scharfe Jalapeño-Margarita", nl: "Pittige jalapeño margarita" },
          { en: "Tequila sunrise variation", es: "Variación de tequila sunrise", de: "Tequila-Sunrise-Variation", nl: "Tequila sunrise variatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "2 parts sugar to 1 part water (rich simple syrup)", es: "2 partes de azúcar a 1 parte de agua (jarabe simple rico)", de: "2 Teile Zucker zu 1 Teil Wasser (reichhaltiger Einfachsirup)", nl: "2 delen suiker op 1 deel water (rijke simpele siroop)" },
          { en: "2 parts water to 1 part sugar", es: "2 partes de agua a 1 parte de azúcar", de: "2 Teile Wasser zu 1 Teil Zucker", nl: "2 delen water op 1 deel suiker" },
          { en: "2 cocktails to 1 mixer", es: "2 cócteles a 1 mezclador", de: "2 Cocktails zu 1 Mixer", nl: "2 cocktails op 1 mixer" },
          { en: "2 oz spirit to 1 oz modifier", es: "2 oz de licor a 1 oz de modificador", de: "2 oz Spirituose zu 1 oz Modifikator", nl: "2 oz spirit op 1 oz modifier" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Aquavit, dry sherry, Cynar, peach bitters, lemon", es: "Aquavit, jerez seco, Cynar, amargos de durazno, limón", de: "Aquavit, trockener Sherry, Cynar, Pfirsichbitter, Zitrone", nl: "Aquavit, droge sherry, Cynar, perzik bitters, citroen" },
          { en: "Three-rum tiki drink", es: "Bebida tiki de tres rones", de: "Drei-Rum-Tiki-Getränk", nl: "Drie-rum tiki drankje" },
          { en: "Triple sec cocktail", es: "Cóctel de triple sec", de: "Triple-Sec-Cocktail", nl: "Triple sec cocktail" },
          { en: "Vodka martini with three olives", es: "Vodka martini con tres aceitunas", de: "Wodka-Martini mit drei Oliven", nl: "Vodka martini met drie olijven" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Nick and Nora is smaller and bell-shaped, coupe is wider and shallower", es: "Nick and Nora es más pequeña y en forma de campana, coupe es más ancha y superficial", de: "Nick and Nora ist kleiner und glockenförmig, Coupe ist breiter und flacher", nl: "Nick and Nora is kleiner en klokvormig, coupe is breder en ondieper" },
          { en: "No difference", es: "Sin diferencia", de: "Kein Unterschied", nl: "Geen verschil" },
          { en: "Coupe is for champagne only", es: "Coupe es solo para champán", de: "Coupe ist nur für Champagner", nl: "Coupe is alleen voor champagne" },
          { en: "Nick and Nora has a stem, coupe doesn't", es: "Nick and Nora tiene tallo, coupe no", de: "Nick and Nora hat Stiel, Coupe nicht", nl: "Nick and Nora heeft steel, coupe niet" }
        ],
        correct: 0,
        explanation: {
