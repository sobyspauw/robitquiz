// Quiz Level 6: Drinken - Cocktails (Molecular Mixology and Modern Bartending)
(function() {
  const level6 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Instant freezing and dramatic presentation", es: "Congelación instantánea y presentación dramática", de: "Sofortiges Einfrieren und dramatische Präsentation", nl: "Onmiddellijke bevriezing en dramatische presentatie" },
          { en: "Adding flavor to cocktails", es: "Añadir sabor a cócteles", de: "Geschmack zu Cocktails hinzufügen", nl: "Smaak toevoegen aan cocktails" },
          { en: "Increasing alcohol content", es: "Aumentar contenido alcohólico", de: "Alkoholgehalt erhöhen", nl: "Alcoholgehalte verhogen" },
          { en: "Making cocktails lighter", es: "Hacer cócteles más ligeros", de: "Cocktails leichter machen", nl: "Cocktails lichter maken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Creating sphere-shaped ice cubes", es: "Crear cubitos de hielo en forma de esfera", de: "Sphärenförmige Eiswürfel erstellen", nl: "Bolvormige ijsblokjes maken" },
          { en: "Forming liquid-filled spheres using calcium chloride and sodium alginate", es: "Formar esferas llenas de líquido usando cloruro de calcio y alginato de sodio", de: "Flüssigkeitsgefüllte Kugeln mit Calciumchlorid und Natriumalginat bilden", nl: "Vloeistof-gevulde bollen vormen met calciumchloride en natriumalginaat" },
          { en: "Making perfectly round cocktail glasses", es: "Hacer copas de cóctel perfectamente redondas", de: "Perfekt runde Cocktailgläser herstellen", nl: "Perfect ronde cocktailglazen maken" },
          { en: "Arranging garnishes in a sphere", es: "Organizar guarniciones en una esfera", de: "Garnituren in einer Sphäre anordnen", nl: "Garneringen in een bol arrangeren" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Making cocktails with ice", es: "Hacer cócteles con hielo", de: "Cocktails mit Eis machen", nl: "Cocktails maken met ijs" },
          { en: "Converting liquids into gel-like substances using hydrocolloids", es: "Convertir líquidos en sustancias similares al gel usando hidrocoloides", de: "Flüssigkeiten mit Hydrokolloiden in gelartige Substanzen umwandeln", nl: "Vloeistoffen omzetten in gel-achtige stoffen met hydrocolloïden" },
          { en: "Adding gelatin to thicken drinks", es: "Añadir gelatina para espesar bebidas", de: "Gelatine hinzufügen, um Getränke zu verdicken", nl: "Gelatine toevoegen om drankjes te verdikken" },
          { en: "Freezing cocktails completely", es: "Congelar cócteles completamente", de: "Cocktails vollständig einfrieren", nl: "Cocktails volledig bevriezen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "To create stable foams and adjust viscosity", es: "Para crear espumas estables y ajustar viscosidad", de: "Um stabile Schäume zu erzeugen und Viskosität anzupassen", nl: "Om stabiele schuimen te creëren en viscositeit aan te passen" },
          { en: "To preserve cocktails longer", es: "Para conservar cócteles por más tiempo", de: "Um Cocktails länger zu konservieren", nl: "Om cocktails langer te bewaren" },
      ...
      },
      {
        ...
        options: [
          { en: "Adding real caviar to drinks", es: "Añadir caviar real a bebidas", de: "Echten Kaviar zu Getränken hinzufügen", nl: "Echte kaviaar toevoegen aan drankjes" },
          { en: "Creating small flavor-burst pearls that pop in the mouth", es: "Crear pequeñas perlas de explosión de sabor que explotan en la boca", de: "Kleine geschmacksplatzende Perlen schaffen, die im Mund platzen", nl: "Kleine smaak-barst parels maken die in de mond knappen" },
          { en: "Making black-colored cocktails", es: "Hacer cócteles de color negro", de: "Schwarze Cocktails herstellen", nl: "Zwart gekleurde cocktails maken" },
          { en: "Expensive garnish decoration", es: "Decoración de guarnición costosa", de: "Teure Garniturdekoration", nl: "Dure garnering decoratie" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To make drinks colder than regular ice", es: "Para hacer bebidas más frías que el hielo regular", de: "Um Getränke kälter als normales Eis zu machen", nl: "Om drankjes kouder te maken dan gewoon ijs" },
          { en: "To create dramatic fog effects and maintain temperature", es: "Para crear efectos dramáticos de niebla y mantener temperatura", de: "Um dramatische Nebeleffekte zu schaffen und Temperatur zu halten", nl: "Om dramatische misteffecten te creëren en temperatuur te behouden" },
          { en: "To add carbon dioxide flavor", es: "Para añadir sabor de dióxido de carbono", de: "Um Kohlendioxid-Geschmack hinzuzufügen", nl: "Om kooldioxide smaak toe te voegen" },
          { en: "To preserve cocktails for days", es: "Para conservar cócteles por días", de: "Um Cocktails tagelang zu konservieren", nl: "Om cocktails dagenlang te bewaren" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Adding soap to cocktails", es: "Añadir jabón a cócteles", de: "Seife zu Cocktails hinzufügen", nl: "Zeep toevoegen aan cocktails" },
          { en: "Using lecithin, agar, or gellan to maintain foam structure", es: "Usar lecitina, agar o gellan para mantener estructura de espuma", de: "Lecithin, Agar oder Gellan verwenden, um Schaumstruktur zu erhalten", nl: "Lecithine, agar of gellan gebruiken om schuimstructuur te behouden" },
          { en: "Whipping cream into cocktails", es: "Batir crema en cócteles", de: "Sahne in Cocktails schlagen", nl: "Room in cocktails kloppen" },
          { en: "Adding carbonated water", es: "Añadir agua carbonatada", de: "Kohlensäurehaltiges Wasser hinzufügen", nl: "Koolzuurhoudend water toevoegen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Bonding proteins to create unusual textures and combinations", es: "Unir proteínas para crear texturas y combinaciones inusuales", de: "Proteine binden, um ungewöhnliche Texturen und Kombinationen zu schaffen", nl: "Eiwitten binden om ongewone texturen en combinaties te creëren" },
          { en: "Adding sweetness to cocktails", es: "Añadir dulzura a cócteles", de: "Süße zu Cocktails hinzufügen", nl: "Zoetheid toevoegen aan cocktails" },
          { en: "Creating carbonation", es: "Crear carbonatación", de: "Kohlensäure erzeugen", nl: "Koolzuur creëren" },
          { en: "Preserving cocktail color", es: "Preservar color del cóctel", de: "Cocktailfarbe bewahren", nl: "Cocktail kleur bewaren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Using pectinase to break down fruit particles", es: "Usar pectinasa para descomponer partículas de fruta", de: "Pektinase verwenden, um Fruchtpartikel abzubauen", nl: "Pectinase gebruiken om fruitdeeltjes af te breken" },
          { en: "Adding alcohol enzymes", es: "Añadir enzimas de alcohol", de: "Alkoholenzyme hinzufügen", nl: "Alcohol enzymen toevoegen" },
          { en: "Using digestive enzymes", es: "Usar enzimas digestivas", de: "Verdauungsenzyme verwenden", nl: "Spijsverteringsenenzymen gebruiken" },
          { en: "Enzyme cleaning of glassware", es: "Limpieza enzimática de cristalería", de: "Enzymreinigung von Glaswaren", nl: "Enzym reiniging van glaswerk" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Using magnets to float garnishes", es: "Usar imanes para hacer flotar guarniciones", de: "Magnete verwenden, um Garnituren schweben zu lassen", nl: "Magneten gebruiken om garneringen te laten zweven" },
          { en: "Creating the illusion of floating elements through clever glassware design", es: "Crear la ilusión de elementos flotantes a través del diseño inteligente de cristalería", de: "Illusion schwebender Elemente durch cleveres Glaswarendesign schaffen", nl: "De illusie van zwevende elementen creëren door slim glaswerk ontwerp" },
          { en: "Using helium to make drinks float", es: "Usar helio para hacer flotar bebidas", de: "Helium verwenden, um Getränke schweben zu lassen", nl: "Helium gebruiken om drankjes te laten zweven" },
          { en: "Anti-gravity cocktail preparation", es: "Preparación de cócteles anti-gravedad", de: "Anti-Schwerkraft Cocktailzubereitung", nl: "Anti-zwaartekracht cocktail bereiding" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Shaking without liquid", es: "Agitar sin líquido", de: "Ohne Flüssigkeit schütteln", nl: "Schudden zonder vloeistof" },
          { en: "Shake with ice first, strain, then dry shake with egg white", es: "Agitar con hielo primero, colar, luego agitar en seco con clara", de: "Zuerst mit Eis schütteln, abseihen, dann trocken mit Eiweiß schütteln", nl: "Eerst met ijs schudden, zeven, dan droog schudden met eiwit" },
          { en: "Using dry ice", es: "Usar hielo seco", de: "Trockeneis verwenden", nl: "Droogijs gebruiken" },
          { en: "Shaking very gently", es: "Agitar muy suavemente", de: "Sehr sanft schütteln", nl: "Heel zachtjes schudden" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Vodka and cranberry", es: "Vodka y arándano", de: "Wodka und Preiselbeere", nl: "Vodka en cranberry" },
          { en: "Gin, Lillet, Cointreau, lemon, absinthe rinse", es: "Ginebra, Lillet, Cointreau, limón, enjuague de absenta", de: "Gin, Lillet, Cointreau, Zitrone, Absinth-Spülung", nl: "Gin, Lillet, Cointreau, citroen, absint spoeling" },
          { en: "Rum and cola", es: "Ron y cola", de: "Rum und Cola", nl: "Rum en cola" },
          { en: "Whiskey and ginger", es: "Whisky y jengibre", de: "Whiskey und Ingwer", nl: "Whiskey en gember" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Vegan egg white substitute for foam", es: "Sustituto vegano de clara de huevo para espuma", de: "Veganer Eiweißersatz für Schaum", nl: "Veganistische eiwitvervanger voor schuim" },
          { en: "Type of garnish", es: "Tipo de guarnición", de: "Art der Garnitur", nl: "Soort garnering" },
          { en: "Flavored water", es: "Agua saborizada", de: "Aromatisiertes Wasser", nl: "Gearomatiseerd water" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Equal parts gin, Green Chartreuse, maraschino, lime", es: "Partes iguales de ginebra, Chartreuse verde, marrasquino, lima", de: "Gleiche Teile Gin, grüne Chartreuse, Maraschino, Limette", nl: "Gelijke delen gin, groene Chartreuse, maraschino, limoen" },
          { en: "Whiskey and bitters", es: "Whisky y amargos", de: "Whiskey und Bitter", nl: "Whiskey en bitters" },
          { en: "Vodka martini variation", es: "Variación de vodka martini", de: "Wodka-Martini-Variation", nl: "Vodka martini variatie" },
          { en: "Rum punch", es: "Ponche de ron", de: "Rum-Punsch", nl: "Rum punch" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Type of pearl garnish", es: "Tipo de guarnición de perla", de: "Art der Perlengarnitur", nl: "Soort parelgarnering" },
          { en: "The bubbles in sparkling wine or champagne", es: "Las burbujas en vino espumoso o champán", de: "Die Blasen in Sekt oder Champagner", nl: "De bubbels in mousserende wijn of champagne" },
          { en: "French liqueur", es: "Licor francés", de: "Französischer Likör", nl: "Franse likeur" },
          { en: "Stirring technique", es: "Técnica de revolver", de: "Rührtechnik", nl: "Roertechniek" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Navy Grog", es: "Navy Grog", de: "Navy Grog", nl: "Navy Grog" },
          { en: "Blue Hawaiian", es: "Blue Hawaiian", de: "Blue Hawaiian", nl: "Blue Hawaiian" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Making cocktails in large quantities ahead of time", es: "Hacer cócteles en grandes cantidades con anticipación", de: "Cocktails in großen Mengen im Voraus zubereiten", nl: "Cocktails in grote hoeveelheden van tevoren maken" },
          { en: "Shaking multiple cocktails at once", es: "Agitar múltiples cócteles a la vez", de: "Mehrere Cocktails gleichzeitig schütteln", nl: "Meerdere cocktails tegelijk schudden" },
          { en: "Organizing bottles", es: "Organizar botellas", de: "Flaschen organisieren", nl: "Flessen organiseren" },
          { en: "Cleaning equipment", es: "Limpiar equipo", de: "Ausrüstung reinigen", nl: "Apparatuur schoonmaken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Vacuum-sealing ingredients with spirits and heating at precise low temperatures", es: "Sellar al vacío ingredientes con licores y calentar a temperaturas bajas precisas", de: "Zutaten mit Spirituosen vakuumversiegeln und bei präzisen niedrigen Temperaturen erhitzen", nl: "Ingrediënten vacuüm verzegelen met spirits en verwarmen op precieze lage temperaturen" },
          { en: "French liqueur technique", es: "Técnica de licor francés", de: "Französische Likörtechnik", nl: "Franse likeur techniek" },
          { en: "Cold extraction method", es: "Método de extracción en frío", de: "Kaltextraktionsmethode", nl: "Koude extractie methode" },
          { en: "Pressure infusion", es: "Infusión a presión", de: "Druckinfusion", nl: "Druk infusie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Papa Doble", es: "Papa Doble", de: "Papa Doble", nl: "Papa Doble" },
          { en: "Writer's Block", es: "Bloqueo del Escritor", de: "Schreibblockade", nl: "Writer's Block" },
          { en: "Old Man Cocktail", es: "Cóctel del Viejo", de: "Alter-Mann-Cocktail", nl: "Oude Man Cocktail" },
          { en: "Cuban Special", es: "Especial Cubano", de: "Kubanisches Spezial", nl: "Cubaans Speciaal" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Lighting cocktails on fire", es: "Encender cócteles en fuego", de: "Cocktails anzünden", nl: "Cocktails in brand steken" },
          { en: "Infusing cocktails with cold smoke from wood chips or herbs", es: "Infusionar cócteles con humo frío de astillas de madera o hierbas", de: "Cocktails mit kaltem Rauch von Holzspänen oder Kräutern infundieren", nl: "Cocktails infuseren met koude rook van houtsnippers of kruiden" },
          { en: "Measuring alcohol content", es: "Medir contenido de alcohol", de: "Alkoholgehalt messen", nl: "Alcoholgehalte meten" },
          { en: "Rapid chilling", es: "Enfriamiento rápido", de: "Schnelles Kühlen", nl: "Snel koelen" }
        ],
        correct: 1,
        explanation: {
