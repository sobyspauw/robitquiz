  ...
  const level7 = {
    ...
    questions: [
      ...
      },
      {
        ...
        {
                  "en": "Total viable count",
                  "es": "Recuento viable total",
                  "de": "Gesamtkeimzahl",
                  "nl": "Totaal kiemgetal"
        },
        {
                  ...
                  "nl": "Pseudomonas aeruginosa"
        },
        {
                  "en": "E. coli and coliform bacteria",
                  "es": "E. coli y bacterias coliformes",
                  "de": "E. coli und coliforme Bakterien",
                  "nl": "E. coli en colibacteriën"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Total dissolved solids content",
                  "es": "Contenido de sólidos disueltos totales",
                  "de": "Gesamtgehalt gelöster Feststoffe",
                  "nl": "Totaal opgeloste stoffen gehalte"
        },
        {
                  "en": "Dissolved oxygen concentration",
                  "es": "Concentración de oxígeno disuelto",
                  "de": "Gelöste Sauerstoffkonzentration",
                  "nl": "Opgeloste zuurstofconcentratie"
        },
        {
                  "en": "Light scattering by suspended particles",
                  "es": "Dispersión de luz por partículas suspendidas",
                  "de": "Lichtstreuung durch suspendierte Partikel",
                  "nl": "Lichtverstrooiing door zwevende deeltjes"
        },
        {
                  "en": "Chemical oxygen demand",
                  "es": "Demanda química de oxígeno",
                  "de": "Chemischer Sauerstoffbedarf",
                  "nl": "Chemische zuurstofbehoefte"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fourier transform infrared spectroscopy",
                  "es": "Espectroscopia infrarroja de transformada de Fourier",
                  "de": "Fourier-Transform-Infrarotspektroskopie",
                  "nl": "Fourier transform infrarood spectroscopie"
        },
        {
        ...
        },
        {
                  ...
                  "de": "Hochleistungsflüssigchromatographie",
                  "nl": "Hoge prestatie vloeistofchromatografie"
        },
        {
                  "en": "Inductively coupled plasma mass spectrometry (ICP-MS)",
                  "es": "Espectrometría de masas con plasma acoplado inductivamente (ICP-MS)",
                  "de": "Induktiv gekoppelte Plasma-Massenspektrometrie (ICP-MS)",
                  "nl": "Inductief gekoppeld plasma massaspectrometrie (ICP-MS)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measures bacterial activity",
                  "es": "Mide la actividad bacteriana",
                  "de": "Misst bakterielle Aktivität",
                  "nl": "Meet bacteriële activiteit"
        },
        {
                  "en": "Measures dissolved oxygen levels",
                  "es": "Mide los niveles de oxígeno disuelto",
                  "de": "Misst gelöste Sauerstoffwerte",
                  "nl": "Meet opgeloste zuurstofniveaus"
        },
        {
                  "en": "Indicates the amount of oxygen required to oxidize organic pollutants",
                  "es": "Indica la cantidad de oxígeno requerida para oxidar contaminantes orgánicos",
                  "de": "Zeigt die Menge an Sauerstoff an, die zur Oxidation organischer Schadstoffe erforderlich ist",
                  "nl": "Geeft de hoeveelheid zuurstof aan die nodig is om organische verontreinigingen te oxideren"
        },
        {
                  "en": "Indicates pH stability",
                  "es": "Indica la estabilidad del pH",
                  "de": "Zeigt pH-Stabilität an",
                  "nl": "Geeft pH-stabiliteit aan"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Leads to tooth decay",
                  "es": "Lleva a caries dental",
                  "de": "Führt zu Karies",
                  "nl": "Leidt tot tandvlees"
        },
        {
                  "en": "Causes kidney damage",
                  "es": "Causa daño renal",
                  "de": "Verursacht Nierenschäden",
                  "nl": "Veroorzaakt niereschade"
        },
        {
                  "en": "Causes immediate poisoning in adults",
                  "es": "Causa envenenamiento inmediato en adultos",
                  "de": "Verursacht sofortige Vergiftung bei Erwachsenen",
                  "nl": "Veroorzaakt onmiddellijke vergiftiging bij volwassenen"
        },
        {
                  "en": "Methemoglobinemia (blue baby syndrome) in infants",
                  "es": "Metahemoglobinemia (síndrome del bebé azul) en infantes",
                  "de": "Methämoglobinämie (Blausucht) bei Säuglingen",
                  "nl": "Methemoglobinemie (blauwe baby syndroom) bij zuigelingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  ...
                  "es": "Trihalometanos (THMs)",
                  "de": "Trihalogenmethane (THMs)",
                  "nl": "Trihalomethanen (THMs)"
        },
        {
                  "en": "Chlorite",
                  "es": "Clorito",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Total dissolved solids concentration",
                  "es": "Concentración de sólidos disueltos totales",
                  "de": "Konzentration der gelösten Feststoffe gesamt",
                  "nl": "Concentratie van totaal opgeloste stoffen"
        },
        {
                  "en": "pH buffering capacity",
                  "es": "Capacidad de amortiguación del pH",
                  "de": "pH-Pufferkapazität",
                  "nl": "pH-buffercapaciteit"
        },
        {
                  "en": "Alkalinity measurement",
                  "es": "Medición de alcalinidad",
                  "de": "Alkalinitätsmessung",
                  "nl": "Alkaliniteitsmeting"
        },
        {
                  "en": "Calcium and magnesium ion concentration",
                  "es": "Concentración de iones de calcio y magnesio",
                  "de": "Kalzium- und Magnesiumionenkonzentration",
                  "nl": "Calcium- en magnesiumionconcentratie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A measure of water temperature",
                  "es": "Medida de temperatura del agua",
                  "de": "Maß für Wassertemperatur",
                  "nl": "Maat voor watertemperatuur"
        },
        {
                  "en": "A measure of water volume",
                  "es": "Medida de volumen de agua",
                  "de": "Maß für Wasservolumen",
                  "nl": "Maat voor watervolume"
        },
        {
                  "en": "A measure of oxygen required by microorganisms to break down organic matter",
                  "es": "Medida de oxígeno requerido por microorganismos para descomponer materia orgánica",
                  "de": "Maß für von Mikroorganismen benötigten Sauerstoff zum Abbau organischer Stoffe",
                  "nl": "Maat voor zuurstof vereist door micro-organismen om organisch materiaal af te breken"
        },
        {
                  "en": "A measure of water hardness",
                  "es": "Medida de dureza del agua",
                  "de": "Maß für Wasserhärte",
                  "nl": "Maat voor waterhardheid"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To improve water taste",
                  "es": "Para mejorar el sabor del agua",
                  "de": "Um den Wassergeschmack zu verbessern",
                  "nl": "Om watersmaak te verbeteren"
        },
        {
                  "en": "As indicators of fecal contamination and water quality",
                  "es": "Como indicadores de contaminación fecal y calidad del agua",
                  "de": "Als Indikatoren für fäkale Verunreinigung und Wasserqualität",
                  "nl": "Als indicatoren van fecale besmetting en waterkwaliteit"
        },
        {
                  "en": "To add minerals to water",
                  "es": "Para añadir minerales al agua",
                  "de": "Um Mineralien zu Wasser hinzuzufügen",
                  "nl": "Om mineralen aan water toe te voegen"
        },
        {
                  "en": "To increase water pH",
                  "es": "Para aumentar el pH del agua",
                  "de": "Um den pH-Wert des Wassers zu erhöhen",
                  "nl": "Om water-pH te verhogen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Cloudiness or haziness caused by suspended particles",
                  "es": "Nubosidad u opacidad causada por partículas suspendidas",
                  "de": "Trübung oder Undurchsichtigkeit durch suspendierte Partikel",
                  "nl": "Troebeling of waasheid veroorzaakt door zwevende deeltjes"
        },
        {
                  "en": "Water pressure",
                  "es": "Presión del agua",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Per- and polyfluoroalkyl substances ('forever chemicals') that persist in environment",
                  "es": "Sustancias perfluoroalquiladas y polifluoroalquiladas ('químicos eternos') que persisten en ambiente",
                  "de": "Per- und polyfluorierte Alkylsubstanzen ('Ewigkeitschemikalien') die in Umwelt verbleiben",
                  "nl": "Per- en polyfluoralkylstoffen ('eeuwige chemicaliën') die in milieu blijven"
        },
        {
                  "en": "Beneficial minerals for health",
                  "es": "Minerales beneficiosos para salud",
                  "de": "Gesundheitsförderliche Mineralien",
                  "nl": "Gezonde mineralen"
        },
        {
                  "en": "Water treatment chemicals",
                  "es": "Químicos de tratamiento de agua",
                  "de": "Wasserbehandlungschemikalien",
                  "nl": "Waterbehandelingschemicaliën"
        },
        {
                  "en": "Natural occurring substances in water",
                  "es": "Sustancias que ocurren naturalmente en agua",
                  "de": "Natürlich vorkommende Substanzen im Wasser",
                  "nl": "Natuurlijk voorkomende stoffen in water"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Total hardness only lasts temporarily",
                  "es": "Dureza total solo dura temporalmente",
                  "de": "Gesamthärte hält nur vorübergehend an",
                  "nl": "Totale hardheid duurt alleen tijdelijk"
        },
        {
                  "en": "Temporary hardness is more severe",
                  "es": "Dureza temporal es más severa",
                  "de": "Temporäre Härte ist schwerwiegender",
                  "nl": "Tijdelijke hardheid is ernstiger"
        },
        {
                  "en": "Temporary hardness can be removed by boiling, total hardness includes permanent hardness",
                  "es": "Dureza temporal puede eliminarse hirviendo, dureza total incluye dureza permanente",
                  "de": "Temporäre Härte kann durch Kochen entfernt werden, Gesamthärte enthält permanente Härte",
                  "nl": "Tijdelijke hardheid kan worden verwijderd door koken, totale hardheid omvat permanente hardheid"
        },
        {
                  "en": "No difference, they are the same",
                  "es": "Sin diferencia, son lo mismo",
                  "de": "Kein Unterschied, sie sind dasselbe",
                  "nl": "Geen verschil, ze zijn hetzelfde"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Zero - no safe level, action level is 15 ppb",
                  "es": "Cero - sin nivel seguro, nivel de acción es 15 ppb",
                  "de": "Null - kein sicherer Wert, Aktionswert ist 15 ppb",
                  "nl": "Nul - geen veilig niveau, actieniveau is 15 ppb"
        },
        {
                  "en": "100 ppb",
                  "es": "100 ppb",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Color of water",
                  "es": "Color del agua",
                  "de": "Farbe des Wassers",
                  "nl": "Kleur van water"
        },
        {
                  "en": "Conductivity of water",
                  "es": "Conductividad del agua",
                  "de": "Leitfähigkeit des Wassers",
                  "nl": "Geleidbaarheid van water"
        },
        {
                  "en": "Cost of water treatment",
                  "es": "Costo de tratamiento de agua",
                  "de": "Kosten der Wasseraufbereitung",
                  "nl": "Kosten van waterbehandeling"
        },
        {
                  "en": "Amount of oxygen required to chemically oxidize organic and inorganic matter in water",
                  "es": "Cantidad de oxígeno requerida para oxidar químicamente materia orgánica e inorgánica en agua",
                  "de": "Menge an Sauerstoff erforderlich zur chemischen Oxidation organischer und anorganischer Stoffe im Wasser",
                  "nl": "Hoeveelheid zuurstof vereist om organisch en anorganisch materiaal in water chemisch te oxideren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To increase water pressure",
                  "es": "Aumentar presión del agua",
                  "de": "Wasserdruck erhöhen",
                  "nl": "Waterdruk verhogen"
        },
        {
                  "en": "To add minerals",
                  "es": "Añadir minerales",
                  "de": "Mineralien hinzufügen",
                  "nl": "Mineralen toevoegen"
        },
        {
                  "en": "To improve water taste",
                  "es": "Mejorar sabor del agua",
                  "de": "Wassergeschmack verbessern",
                  "nl": "Watersmaak verbeteren"
        },
        {
                  "en": "To maintain disinfection during distribution and prevent recontamination",
                  "es": "Mantener desinfección durante distribución y prevenir recontaminación",
                  "de": "Desinfektion während Verteilung aufrechterhalten und Neuverschmutzung verhindern",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "High oxygen content",
                  "es": "Alto contenido de oxígeno",
                  "de": "Hoher Sauerstoffgehalt",
                  "nl": "Hoog zuurstofgehalte"
        },
        {
                  "en": "Hydrogen sulfide gas (H₂S) from bacterial decomposition",
                  "es": "Gas sulfuro de hidrógeno (H₂S) de descomposición bacterial",
                  "de": "Schwefelwasserstoffgas (H₂S) aus bakteriellem Abbau",
                  "nl": "Waterstofsulfidegas (H₂S) van bacteriële afbraak"
        },
        {
                  "en": "Mineral content",
                  "es": "Contenido mineral",
                  "de": "Mineralgehalt",
                  "nl": "Mineraalgehalte"
        },
        {
                  "en": "Chlorine disinfection",
                  "es": "Desinfección con cloro",
                  "de": "Chlordesinfektion",
                  "nl": "Chloordesinfectie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Suspended particles and sediment",
                  "es": "Partículas suspendidas y sedimento",
                  "de": "Suspendierte Partikel und Sediment",
                  "nl": "Zwevende deeltjes en sediment"
        },
        {
                  "en": "Bacterial contamination level",
                  "es": "Nivel de contaminación bacteriana",
                  "de": "Bakterielle Kontaminationsgrad",
                  "nl": "Bacteriële besmettingsniveau"
        },
        {
                  "en": "Water temperature",
                  "es": "Temperatura del agua",
        ...
        {
                  "en": "All dissolved minerals, salts, and organic matter",
                  "es": "Todos los minerales disueltos, sales y materia orgánica",
                  "de": "Alle gelösten Mineralien, Salze und organische Stoffe",
                  "nl": "Alle opgeloste mineralen, zouten en organische stoffen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bacteria that emerge from water",
                  "es": "Bacterias que emergen del agua",
                  "de": "Bakterien, die aus Wasser auftauchen",
                  "nl": "Bacteriën die uit water opkomen"
        },
        {
                  "en": "Only radioactive materials",
                  "es": "Solo materiales radiactivos",
                  "de": "Nur radioaktive Materialien",
                  "nl": "Alleen radioactieve materialen"
        },
        {
                  "en": "New pollutants not yet regulated, including pharmaceuticals, hormones, and microplastics",
                  "es": "Nuevos contaminantes aún no regulados, incluyendo farmacéuticos, hormonas y microplásticos",
                  "de": "Neue noch nicht regulierte Schadstoffe, einschließlich Pharmazeutika, Hormone und Mikroplastik",
                  "nl": "Nieuwe nog niet gereguleerde verontreinigingen, inclusief farmaceutica, hormonen en microplastics"
        },
        {
                  "en": "Minerals forming in water",
                  "es": "Minerales formándose en agua",
                  "de": "Mineralien, die sich im Wasser bilden",
                  "nl": "Mineralen die zich in water vormen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Water conservation program",
                  "es": "Programa de conservación de agua",
                  "de": "Wasserschutzprogramm",
                  "nl": "Waterbesparingsprogramma"
        },
        {
                  "en": "International water trade agreement",
                  "es": "Acuerdo internacional de comercio de agua",
                  "de": "Internationales Wasserhandelsabkommen",
                  "nl": "Internationale waterhandelsovereenkomst"
        },
        {
                  "en": "US federal law establishing standards for drinking water quality and protecting sources",
                  "es": "Ley federal de EE.UU. que establece estándares para calidad de agua potable y protege fuentes",
                  "de": "US-Bundesgesetz zur Festlegung von Trinkwasserqualitätsstandards und Quellenschutz",
                  "nl": "Amerikaanse federale wet die normen vaststelt voor drinkwaterkwaliteit en bronnen beschermt"
        },
        {
                  "en": "Water pricing regulation",
                  "es": "Regulación de precios del agua",
                  "de": "Wasserpreisregulierung",
                  "nl": "Waterprijsregulering"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Public demand for chlorinated water",
                  "es": "Demanda pública de agua clorada",
                  "de": "Öffentliche Nachfrage nach chloriertem Wasser",
                  "nl": "Publieke vraag naar gechloreerd water"
        },
        {
                  "en": "Legal requirement for chlorine levels",
                  "es": "Requisito legal para niveles de cloro",
                  "de": "Gesetzliche Anforderung für Chlorwerte",
                  "nl": "Wettelijke vereiste voor chloorniveaus"
        },
        {
                  "en": "The amount of chlorine consumed by reactions with contaminants before residual is established",
                  "es": "La cantidad de cloro consumida por reacciones con contaminantes antes de establecer residual",
                  "de": "Die Menge an Chlor, die durch Reaktionen mit Schadstoffen verbraucht wird, bevor Restchlor entsteht",
                  "nl": "De hoeveelheid chloor verbruikt door reacties met verontreinigingen voordat residu wordt vastgesteld"
        },
        {
                  "en": "Cost of chlorine treatment",
                  "es": "Costo de tratamiento con cloro",
                  "de": "Kosten der Chlorbehandlung",
                  "nl": "Kosten van chloorbehandeling"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Point where water pipes break",
                  "es": "Punto donde tuberías de agua se rompen",
                  "de": "Punkt, an dem Wasserrohre brechen",
                  "nl": "Punt waar waterleidingen breken"
        },
        {
                  "en": "Chlorine expiration date",
                  "es": "Fecha de caducidad del cloro",
                  "de": "Chlor-Verfallsdatum",
                  "nl": "Chloor vervaldatum"
        },
        {
                  "en": "Graph showing chlorine residual vs chlorine dose, identifying breakpoint where free chlorine forms",
                  "es": "Gráfico que muestra residual de cloro vs dosis de cloro, identificando punto de ruptura donde se forma cloro libre",
                  "de": "Grafik, die Restchlor vs. Chlordosis zeigt und Breakpoint identifiziert, wo freies Chlor entsteht",
                  "nl": "Grafiek die chloorresidu vs chloordosis toont, waarbij breekpunt wordt geïdentificeerd waar vrij chloor zich vormt"
        },
        {
                  "en": "Maximum chlorine storage capacity",
                  "es": "Capacidad máxima de almacenamiento de cloro",
                  "de": "Maximale Chlorspeicherkapazität",
                  "nl": "Maximale chlooropslag capaciteit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Free chlorine is available for disinfection; total chlorine includes free + combined (chloramines)",
                  "es": "Cloro libre está disponible para desinfección; cloro total incluye libre + combinado (cloraminas)",
                  "de": "Freies Chlor ist für Desinfektion verfügbar; Gesamtchlor umfasst freies + gebundenes (Chloramine)",
                  "nl": "Vrij chloor is beschikbaar voor desinfectie; totaal chloor omvat vrij + gecombineerd (chloramines)"
        },
        {
                  "en": "Free chlorine costs nothing, total chlorine has a cost",
                  "es": "Cloro libre no cuesta nada, cloro total tiene un costo",
                  "de": "Freies Chlor kostet nichts, Gesamtchlor hat Kosten",
                  "nl": "Vrij chloor kost niets, totaal chloor heeft kosten"
        },
        {
                  "en": "No difference, they are the same",
                  "es": "Sin diferencia, son lo mismo",
        ...
        {
                  "en": "Total chlorine is for swimming pools only",
                  "es": "Cloro total es solo para piscinas",
                  "de": "Gesamtchlor ist nur für Schwimmbäder",
                  "nl": "Totaal chloor is alleen voor zwembaden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Counting of water plates",
                  "es": "Conteo de placas de agua",
                  "de": "Zählung von Wasserplatten",
                  "nl": "Telling van waterplaten"
        },
        {
                  "en": "Chlorine measurement",
                  "es": "Medición de cloro",
                  "de": "Chlormessung",
                  "nl": "Chloormeting"
        },
        {
                  "en": "Measure of general bacterial population in water, indicates treatment effectiveness",
                  "es": "Medida de población bacteriana general en agua, indica efectividad de tratamiento",
                  "de": "Maß für allgemeine Bakterienpopulation im Wasser, zeigt Behandlungswirksamkeit an",
                  "nl": "Maat voor algemene bacteriële populatie in water, geeft behandelingseffectiviteit aan"
        },
        {
                  "en": "Mineral content analysis",
                  "es": "Análisis de contenido mineral",
                  "de": "Mineralgehaltsanalyse",
                  "nl": "Mineraalgehalte analyse"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Amount of alkali metals in water",
                  "es": "Cantidad de metales alcalinos en agua",
                  "de": "Menge an Alkalimetallen im Wasser",
                  "nl": "Hoeveelheid alkalimetalen in water"
        },
        {
                  "en": "Measurement of how alkaline (basic) the water is",
                  "es": "Medida de cuán alcalino (básico) es el agua",
                  "de": "Messung, wie alkalisch (basisch) das Wasser ist",
                  "nl": "Meting van hoe alkalisch (basisch) het water is"
        },
        {
                  "en": "Water's capacity to neutralize acids (pH buffering), prevents corrosion and pH swings",
                  "es": "Capacidad del agua para neutralizar ácidos (amortiguación de pH), previene corrosión y cambios de pH",
                  "de": "Wasserfähigkeit zur Neutralisierung von Säuren (pH-Pufferung), verhindert Korrosion und pH-Schwankungen",
                  "nl": "Watervermogen om zuren te neutraliseren (pH-buffering), voorkomt corrosie en pH-schommelingen"
        },
        {
                  "en": "Water storage capacity",
                  "es": "Capacidad de almacenamiento de agua",
                  "de": "Wasserspeicherkapazität",
                  "nl": "Wateropslagcapaciteit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Water flow rate through pipes",
                  "es": "Tasa de flujo de agua a través de tuberías",
                  "de": "Wasserdurchflussrate durch Rohre",
                  "nl": "Waterstromingssnelheid door leidingen"
        },
        {
                  "en": "Water's ability to conduct electrical current, indicating dissolved ion concentration",
                  "es": "Capacidad del agua para conducir corriente eléctrica, indicando concentración de iones disueltos",
                  "de": "Wasserfähigkeit zur Leitung elektrischen Stroms, zeigt Konzentration gelöster Ionen an",
                  "nl": "Watervermogen om elektrische stroom te geleiden, wat concentratie van opgeloste ionen aangeeft"
        },
        {
                  "en": "Sound transmission through water",
                  "es": "Transmisión de sonido a través de agua",
                  "de": "Schallübertragung durch Wasser",
                  "nl": "Geluidsoverdracht door water"
        },
        {
                  "en": "Heat conductivity of water",
                  "es": "Conductividad térmica del agua",
                  "de": "Wärmeleitfähigkeit von Wasser",
                  "nl": "Warmtegeleiding van water"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Beneficial bacteria added to water",
                  "es": "Bacterias beneficiosas añadidas al agua",
                  "de": "Vorteilhafte Bakterien, die Wasser zugesetzt werden",
                  "nl": "Gunstige bacteriën toegevoegd aan water"
        },
        {
                  "en": "Organisms that produce indicators",
                  "es": "Organismos que producen indicadores",
                  "de": "Organismen, die Indikatoren produzieren",
                  "nl": "Organismen die indicatoren produceren"
        },
        {
                  "en": "Fish that indicate water quality",
                  "es": "Peces que indican calidad de agua",
                  "de": "Fische, die Wasserqualität anzeigen",
                  "nl": "Vissen die waterkwaliteit aangeven"
        },
        {
                  "en": "Organisms whose presence indicates fecal contamination and potential pathogens (e.g., E. coli)",
                  "es": "Organismos cuya presencia indica contaminación fecal y patógenos potenciales (ej., E. coli)",
                  "de": "Organismen, deren Anwesenheit fäkale Verunreinigung und potenzielle Krankheitserreger anzeigt (z.B. E. coli)",
                  "nl": "Organismen waarvan de aanwezigheid fecale besmetting en potentiële pathogenen aangeeft (bijv. E. coli)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Legally enforceable standard for maximum contaminant concentration in drinking water",
                  "es": "Estándar legalmente aplicable para concentración máxima de contaminante en agua potable",
                  "de": "Rechtlich durchsetzbarer Standard für maximale Schadstoffkonzentration im Trinkwasser",
                  "nl": "Juridisch afdwingbare norm voor maximale verontreinigingsconcentratie in drinkwater"
        },
        {
                  "en": "Recommended guideline (not mandatory)",
                  "es": "Directriz recomendada (no obligatoria)",
                  "de": "Empfohlene Richtlinie (nicht verpflichtend)",
                  "nl": "Aanbevolen richtlijn (niet verplicht)"
        },
        {
                  "en": "Average contamination level",
                  "es": "Nivel promedio de contaminación",
                  "de": "Durchschnittlicher Verschmutzungsgrad",
                  "nl": "Gemiddeld verontreinigingsniveau"
        },
        {
                  "en": "Minimum required contamination",
                  "es": "Contaminación mínima requerida",
                  "de": "Mindestens erforderliche Verschmutzung",
                  "nl": "Minimaal vereiste verontreiniging"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Chemical contaminant from industry",
                  "es": "Contaminante químico de industria",
                  "de": "Chemischer Schadstoff aus Industrie",
                  "nl": "Chemische verontreiniging uit industrie"
        },
        {
                  "en": "Type of algae in water",
                  "es": "Tipo de alga en agua",
                  "de": "Art von Algen im Wasser",
                  "nl": "Type algen in water"
        },
        {
                  "en": "Chlorine-resistant parasite causing gastrointestinal illness from contaminated water",
                  "es": "Parásito resistente al cloro que causa enfermedad gastrointestinal por agua contaminada",
                  "de": "Chlorresistenter Parasit, der durch kontaminiertes Wasser gastrointestinale Erkrankungen verursacht",
                  "nl": "Chloorresistente parasiet die gastro-intestinale ziekte veroorzaakt door besmet water"
        },
        {
                  "en": "Beneficial mineral in water",
                  "es": "Mineral beneficioso en agua",
                  "de": "Vorteilhaftes Mineral im Wasser",
                  "nl": "Gunstig mineraal in water"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Beneficial bacteria in water",
                  "es": "Bacteria beneficiosa en agua",
                  "de": "Vorteilhafte Bakterien im Wasser",
                  "nl": "Gunstige bacterie in water"
        },
        {
                  "en": "Protozoan parasite causing giardiasis ('beaver fever') from contaminated water",
                  "es": "Parásito protozoario que causa giardiasis ('fiebre del castor') por agua contaminada",
                  "de": "Protozoenparasit, der Giardiasis ('Biberfieber') durch kontaminiertes Wasser verursacht",
                  "nl": "Protozoaire parasiet die giardiasis ('beverkoorts') veroorzaakt door besmet water"
        },
        {
                  "en": "Type of water filter",
                  "es": "Tipo de filtro de agua",
                  "de": "Art von Wasserfilter",
                  "nl": "Type waterfilter"
        },
        {
                  "en": "Mineral deposit in water",
                  "es": "Depósito mineral en agua",
                  "de": "Mineralablagerung im Wasser",
                  "nl": "Mineraalafzetting in water"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Harmful algal blooms producing toxins (microcystins) that contaminate water",
                  "es": "Floraciones de algas dañinas que producen toxinas (microcistinas) que contaminan agua",
                  "de": "Schädliche Algenblüten, die Toxine (Mikrocystine) produzieren, die Wasser verunreinigen",
                  "nl": "Schadelijke algenbloei die toxines (microcystines) produceert die water verontreinigen"
        },
        {
                  "en": "Fish food supplement",
                  "es": "Suplemento alimenticio para peces",
                  "de": "Fischfutter-Ergänzung",
                  "nl": "Visvoedsel supplement"
        },
        {
                  "en": "Blue-colored minerals",
                  "es": "Minerales de color azul",
                  "de": "Blau gefärbte Mineralien",
                  "nl": "Blauw gekleurde mineralen"
        },
        {
                  "en": "Beneficial organisms that purify water",
                  "es": "Organismos beneficiosos que purifican agua",
                  "de": "Vorteilhafte Organismen, die Wasser reinigen",
                  "nl": "Gunstige organismen die water zuiveren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Building physical barriers around water sources",
                  "es": "Construir barreras físicas alrededor de fuentes de agua",
                  "de": "Bau physischer Barrieren um Wasserquellen",
                  "nl": "Bouwen van fysieke barrières rond waterbronnen"
        },
        {
                  "en": "Using multiple treatment steps to ensure water safety if one barrier fails",
                  "es": "Usar múltiples pasos de tratamiento para asegurar seguridad del agua si falla una barrera",
                  "de": "Verwendung mehrerer Behandlungsschritte zur Gewährleistung der Wassersicherheit, falls eine Barriere versagt",
                  "nl": "Gebruik van meerdere behandelingsstappen om waterveiligheid te waarborgen als één barrière faalt"
        },
        {
                  "en": "Installing multiple water pipes",
                  "es": "Instalar múltiples tuberías de agua",
                  "de": "Installation mehrerer Wasserrohre",
                  "nl": "Installeren van meerdere waterleidingen"
        },
        {
                  "en": "Creating backup water storage",
                  "es": "Crear almacenamiento de agua de respaldo",
                  "de": "Erstellen von Backup-Wasserspeicherung",
                  "nl": "Creëren van back-up wateropslag"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Chlorine Temperature measurement",
                  "es": "Medida de Temperatura de Cloro",
                  "de": "Chlor-Temperatur-Messung",
                  "nl": "Chloor Temperatuur meting"
        },
        {
                  "en": "Contamination Testing value",
                  "es": "Valor de Prueba de Contaminación",
                  "de": "Kontaminationstestwert",
                  "nl": "Contaminatie Testwaarde"
        },
        {
                  "en": "Chemical Treatment cost",
                  "es": "Costo de Tratamiento Químico",
                  "de": "Kosten chemischer Behandlung",
                  "nl": "Kosten Chemische Behandeling"
        },
        {
                  "en": "Concentration × Time: disinfectant concentration multiplied by contact time",
                  "es": "Concentración × Tiempo: concentración de desinfectante multiplicada por tiempo de contacto",
                  "de": "Konzentration × Zeit: Desinfektionsmittelkonzentration multipliziert mit Kontaktzeit",
                  "nl": "Concentratie × Tijd: desinfectiemiddel concentratie vermenigvuldigd met contacttijd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Disinfect water",
                  "es": "Desinfectar agua",
                  "de": "Wasser desinfizieren",
                  "nl": "Water desinfecteren"
        },
        {
                  "en": "Improve taste",
                  "es": "Mejorar sabor",
                  "de": "Geschmack verbessern",
                  "nl": "Smaak verbeteren"
        },
        {
                  "en": "Remove hardness",
                  "es": "Eliminar dureza",
                  "de": "Härte entfernen",
                  "nl": "Hardheid verwijderen"
        },
        {
                  "en": "Prevent tooth decay by strengthening enamel (0.7-1.2 mg/L)",
                  "es": "Prevenir caries fortaleciendo esmalte (0.7-1.2 mg/L)",
                  "de": "Kariesprävention durch Stärkung des Zahnschmelzes (0,7-1,2 mg/L)",
                  "nl": "Cariës voorkomen door glazuur te versterken (0,7-1,2 mg/L)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Program identifying potential contamination sources threatening drinking water supplies",
                  "es": "Programa que identifica fuentes potenciales de contaminación amenazando suministros de agua potable",
                  "de": "Programm zur Identifizierung potenzieller Kontaminationsquellen, die Trinkwasserversorgungen bedrohen",
                  "nl": "Programma dat potentiële verontreinigingsbronnen identificeert die drinkwatervoorraden bedreigen"
        },
        {
                  "en": "Water trading marketplace",
                  "es": "Mercado de comercio de agua",
                  "de": "Wasserhandelsmarktplatz",
                  "nl": "Waterhandelsmarktplaats"
        },
        {
                  "en": "Water conservation incentive",
                  "es": "Incentivo de conservación de agua",
                  "de": "Wassersparmaßnahmen-Anreiz",
                  "nl": "Waterbesparingsincentive"
        },
        {
                  "en": "Emergency water supply backup",
                  "es": "Respaldo de suministro de agua de emergencia",
                  "de": "Notfall-Wasserversorgung Backup",
                  "nl": "Noodwatervoorziening back-up"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Connecting different water pipes",
                  "es": "Conectar diferentes tuberías de agua",
                  "de": "Verbindung verschiedener Wasserrohre",
                  "nl": "Verbinden van verschillende waterleidingen"
        },
        {
                  "en": "Crossing water mains over roads",
                  "es": "Cruzar tuberías principales de agua sobre carreteras",
                  "de": "Kreuzung von Wasserleitungen über Straßen",
                  "nl": "Kruisen van waterleidingen over wegen"
        },
        {
                  "en": "Preventing contamination by backflow from non-potable sources into drinking water",
                  "es": "Prevenir contaminación por reflujo de fuentes no potables al agua potable",
                  "de": "Verhinderung von Kontamination durch Rückfluss aus nicht trinkbaren Quellen ins Trinkwasser",
                  "nl": "Voorkomen van verontreiniging door terugstroom van niet-drinkbare bronnen in drinkwater"
        },
        {
                  "en": "International water sharing",
                  "es": "Compartir agua internacional",
                  "de": "Internationaler Wasseraustausch",
                  "nl": "Internationaal water delen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Clock for water timing",
                  "es": "Reloj para temporización de agua",
                  "de": "Uhr für Wassertiming",
                  "nl": "Klok voor watertiming"
        },
        {
                  "en": "Wildlife monitoring near water",
                  "es": "Monitoreo de vida silvestre cerca de agua",
                  "de": "Wildtierüberwachung in der Nähe von Wasser",
                  "nl": "Wildliefmonitoring nabij water"
        },
        {
                  "en": "Security cameras at water plants",
                  "es": "Cámaras de seguridad en plantas de agua",
                  "de": "Sicherheitskameras in Wasserwerken",
                  "nl": "Beveiligingscamera's bij waterfabrieken"
        },
        {
                  "en": "EPA database providing public access to water quality violation reports and compliance data",
                  "es": "Base de datos de EPA que proporciona acceso público a informes de violación de calidad de agua y datos de cumplimiento",
                  "de": "EPA-Datenbank, die öffentlichen Zugang zu Wasserqualitätsverletzungsberichten und Konformitätsdaten bietet",
                  "nl": "EPA-database die publieke toegang biedt tot waterkwaliteitsschendingsrapporten en nalevingsgegevens"
        }
        ],
        correct: 3,
        explanation: {
