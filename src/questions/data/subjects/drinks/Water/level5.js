    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "500 mg/L total dissolved solids",
                  "es": "500 mg/L de sólidos disueltos totales",
                  "de": "500 mg/L gelöste Feststoffe gesamt",
                  "nl": "500 mg/L totaal opgeloste stoffen"
        },
        {
                  "en": "100 mg/L total dissolved solids",
                  "es": "100 mg/L de sólidos disueltos totales",
                  "de": "100 mg/L gelöste Feststoffe gesamt",
                  "nl": "100 mg/L totaal opgeloste stoffen"
        },
        {
                  "en": "250 mg/L total dissolved solids",
                  "es": "250 mg/L de sólidos disueltos totales",
                  "de": "250 mg/L gelöste Feststoffe gesamt",
                  "nl": "250 mg/L totaal opgeloste stoffen"
        },
        {
                  "en": "1000 mg/L total dissolved solids",
                  "es": "1000 mg/L de sólidos disueltos totales",
                  "de": "1000 mg/L gelöste Feststoffe gesamt",
                  "nl": "1000 mg/L totaal opgeloste stoffen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Temperature Dependent Solubility",
                  "es": "Solubilidad Dependiente de Temperatura",
                  "de": "Temperaturabhängige Löslichkeit",
                  "nl": "Temperatuurafhankelijke Oplosbaarheid"
        },
        {
                  "en": "Total Daily Supplements",
                  "es": "Suplementos Diarios Totales",
                  "de": "Tägliche Nahrungsergänzungen Gesamt",
                  "nl": "Totale Dagelijkse Supplementen"
        },
        {
                  "en": "Taste Determination Scale",
                  "es": "Escala de Determinación de Sabor",
                  "de": "Geschmacksbestimmungsskala",
                  "nl": "Smaakbepalingschaal"
        },
        {
                  "en": "Total Dissolved Solids",
                  "es": "Sólidos Disueltos Totales",
                  "de": "Gelöste Feststoffe Gesamt",
                  "nl": "Totaal Opgeloste Stoffen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Tierras Altas Escocesas",
                  "de": "Schottisches Hochland",
                  "nl": "Schotse Hooglanden"
        },
        {
                  "en": "Italian Dolomites",
                  "es": "Dolomitas Italianas",
                  "de": "Italienische Dolomiten",
                  "nl": "Italiaanse Dolomieten"
        },
        {
                  "en": "French Vosges Mountains",
                  "es": "Montañas Vosgos Francesas",
                  "de": "Französische Vogesen",
                  "nl": "Franse Vogezen"
        },
        {
                  "en": "Bavarian Alps",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Source depth requirements",
                  "es": "Requisitos de profundidad de fuente",
                  "de": "Anforderungen an die Quelltiefe",
                  "nl": "Vereisten voor brondiepte"
        },
        {
                  "en": "Treatment processing methods",
                  "es": "Métodos de procesamiento de tratamiento",
                  "de": "Behandlungsverarbeitungsmethoden",
                  "nl": "Behandelingsverwerkingsmethoden"
        },
        {
                  "en": "Geographic origin restrictions",
                  "es": "Restricciones de origen geográfico",
                  "de": "Geografische Herkunftsbeschränkungen",
                  "nl": "Geografische oorsprongsbeperkingen"
        },
        {
                  "en": "Consistent mineral composition and proven purity",
                  "es": "Composición mineral consistente y pureza comprobada",
                  "de": "Konsistente Mineralzusammensetzung und bewiesene Reinheit",
                  "nl": "Consistente minerale samenstelling en bewezen zuiverheid"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Espectroscopia de Absorción Atómica (AAS)",
                  "de": "Atomabsorptionsspektroskopie (AAS)",
                  "nl": "Atomaire Absorptie Spectroscopie (AAS)"
        },
        {
                  "en": "Nuclear Magnetic Resonance (NMR)",
                  "es": "Resonancia Magnética Nuclear (RMN)",
                  "de": "Kernspinresonanz (NMR)",
                  "nl": "Nucleaire Magnetische Resonantie (NMR)"
        },
        {
                  "en": "Inductively Coupled Plasma (ICP)",
                  "es": "Plasma Acoplado Inductivamente (ICP)",
                  "de": "Induktiv gekoppeltes Plasma (ICP)",
                  "nl": "Inductief Gekoppeld Plasma (ICP)"
        },
        {
                  "en": "High Performance Liquid Chromatography (HPLC)",
                  "es": "Cromatografía Líquida de Alta Resolución (HPLC)",
                  "de": "Hochleistungsflüssigchromatographie (HPLC)",
                  "nl": "Hoge Prestatie Vloeistofchromatografie (HPLC)"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It affects taste and acts as a natural buffer",
                  "es": "Afecta el sabor y actúa como amortiguador natural",
                  "de": "Es beeinflusst den Geschmack und wirkt als natürlicher Puffer",
                  "nl": "Het beïnvloedt de smaak en werkt als natuurlijke buffer"
        },
        {
                  "en": "It increases shelf life",
                  "es": "Aumenta la vida útil",
                  "de": "Es erhöht die Haltbarkeit",
                  "nl": "Het verhoogt de houdbaarheid"
        },
        {
                  "en": "It determines the water's color",
                  "es": "Determina el color del agua",
                  "de": "Es bestimmt die Farbe des Wassers",
                  "nl": "Het bepaalt de kleur van het water"
        },
        {
                  "en": "It prevents bacterial growth",
                  "es": "Previene el crecimiento bacteriano",
                  "de": "Es verhindert Bakterienwachstum",
                  "nl": "Het voorkomt bacteriegroei"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "EU Directive 2009/54/EC on Natural Mineral Waters",
                  "es": "Directiva UE 2009/54/EC sobre Aguas Minerales Naturales",
                  "de": "EU-Richtlinie 2009/54/EG über natürliche Mineralwässer",
                  "nl": "EU-Richtlijn 2009/54/EG betreffende Natuurlijke Mineraalwaters"
        },
        {
                  "en": "WHO International Health Regulations",
                  "es": "Regulaciones Internacionales de Salud de la OMS",
                  "de": "WHO Internationale Gesundheitsvorschriften",
                  "nl": "WHO Internationale Gezondheidsreglementen"
        },
        {
                  "en": "Codex Alimentarius Food Standards",
                  "es": "Estándares Alimentarios del Codex Alimentarius",
                  "de": "Codex Alimentarius Lebensmittelstandards",
                  "nl": "Codex Alimentarius Voedselstandaarden"
        },
        {
                  "en": "ISO 9001 Quality Management Standards",
                  "es": "Estándares de Gestión de Calidad ISO 9001",
                  "de": "ISO 9001 Qualitätsmanagementsystem",
                  "nl": "ISO 9001 Kwaliteitsmanagementsystemen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Improves taste only",
                  "es": "Solo mejora el sabor",
                  "de": "Verbessert nur den Geschmack",
                  "nl": "Verbetert alleen de smaak"
        },
        {
                  "en": "Supports bone and teeth health",
                  "es": "Apoya la salud de huesos y dientes",
                  "de": "Unterstützt Knochen- und Zahngesundheit",
                  "nl": "Ondersteunt bot- en tandgezondheid"
        },
        {
                  "en": "Changes water color",
                  "es": "Cambia el color del agua",
                  "de": "Ändert die Wasserfarbe",
                  "nl": "Verandert waterkleur"
        },
        {
                  "en": "Increases water temperature",
                  "es": "Aumenta la temperatura del agua",
                  "de": "Erhöht die Wassertemperatur",
                  "nl": "Verhoogt watertemperatuur"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Temperature During Storage",
                  "es": "Temperatura Durante Almacenamiento",
                  "de": "Temperatur Während Lagerung",
                  "nl": "Temperatuur Tijdens Opslag"
        },
        {
                  "en": "Tested Disinfection System",
                  "es": "Sistema de Desinfección Probado",
                  "de": "Getestetes Desinfektionssystem",
                  "nl": "Getest Desinfectiesysteem"
        },
        {
                  "en": "Total Drinking Standard",
                  "es": "Estándar Total de Bebida",
                  "de": "Totaler Trinkstandard",
                  "nl": "Totale Drinkstandaard"
        },
        {
                  "en": "Total Dissolved Solids",
                  "es": "Sólidos Disueltos Totales",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A type of plastic bottle material",
                  "es": "Un tipo de material de botella de plástico",
                  "de": "Eine Art Plastikflaschenmaterial",
                  "nl": "Een soort plastic flesmaterialiaal"
        },
        {
                  "en": "A carbonation process",
                  "es": "Un proceso de carbonatación",
                  "de": "Ein Karbonisierungsprozess",
                  "nl": "Een carbonatieproces"
        },
        {
                  "en": "A filtration method",
                  "es": "Un método de filtración",
                  "de": "Eine Filtrationsmethode",
                  "nl": "Een filtratiemethode"
        },
        {
                  "en": "A mineral compound (HCO₃⁻) that neutralizes acidity",
                  "es": "Un compuesto mineral (HCO₃⁻) que neutraliza la acidez",
                  "de": "Eine Mineralverbindung (HCO₃⁻), die Säure neutralisiert",
                  "nl": "Een mineraalverbinding (HCO₃⁻) die zuurgraad neutraliseert"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Natural mineral water is artificially enhanced",
                  "es": "Agua mineral natural está artificialmente mejorada",
                  "de": "Natürliches Mineralwasser ist künstlich angereichert",
                  "nl": "Natuurlijk mineraalwater is kunstmatig verrijkt"
        },
        {
                  "en": "Spring water is always carbonated",
                  "es": "Agua de manantial siempre está carbonatada",
                  "de": "Quellwasser ist immer karbonisiert",
                  "nl": "Bronwater is altijd gecarboneerd"
        },
        {
                  "en": "Natural mineral water must have consistent mineral composition and health benefits",
                  "es": "Agua mineral natural debe tener composición mineral consistente y beneficios para salud",
                  "de": "Natürliches Mineralwasser muss konsistente Mineralzusammensetzung und Gesundheitsvorteile haben",
                  "nl": "Natuurlijk mineraalwater moet consistente mineraalsamenstelling en gezondheidsvoordelen hebben"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Less than 50 mg/L TDS",
                  "es": "Menos de 50 mg/L TDS",
                  "de": "Weniger als 50 mg/L TDS",
                  "nl": "Minder dan 50 mg/L TDS"
        },
        {
                  "en": "Less than 1500 mg/L TDS",
                  "es": "Menos de 1500 mg/L TDS",
                  "de": "Weniger als 1500 mg/L TDS",
                  "nl": "Minder dan 1500 mg/L TDS"
        },
        {
                  "en": "Less than 500 mg/L TDS",
                  "es": "Menos de 500 mg/L TDS",
                  "de": "Weniger als 500 mg/L TDS",
                  "nl": "Minder dan 500 mg/L TDS"
        },
        {
                  "en": "Less than 1000 mg/L TDS",
                  "es": "Menos de 1000 mg/L TDS",
                  "de": "Weniger als 1000 mg/L TDS",
                  "nl": "Minder dan 1000 mg/L TDS"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Prevents water freezing",
                  "es": "Previene congelación del agua",
                  "de": "Verhindert Wassergefrieren",
                  "nl": "Voorkomt waterbevriezen"
        },
        {
                  "en": "Only affects water taste",
                  "es": "Solo afecta el sabor del agua",
                  "de": "Beeinflusst nur den Wassergeschmack",
                  "nl": "Beïnvloedt alleen de watersmaak"
        },
        {
                  "en": "Increases water alkalinity only",
                  "es": "Solo aumenta la alcalinidad del agua",
                  "de": "Erhöht nur die Wasseralkalität",
                  "nl": "Verhoogt alleen wateralkaliniteit"
        },
        {
                  "en": "Supports muscle function, nerve transmission, and energy production",
                  "es": "Apoya función muscular, transmisión nerviosa y producción de energía",
                  "de": "Unterstützt Muskelfunktion, Nervenübertragung und Energieproduktion",
                  "nl": "Ondersteunt spierfunctie, zenuwoverdracht en energieproductie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Natural mineral compound (SO₄²⁻) that may aid digestion",
                  "es": "Compuesto mineral natural (SO₄²⁻) que puede ayudar a digestión",
                  "de": "Natürliche Mineralverbindung (SO₄²⁻), die die Verdauung unterstützen kann",
                  "nl": "Natuurlijke mineraalverbinding (SO₄²⁻) die spijsvertering kan helpen"
        },
        {
                  "en": "Preservation chemical",
                  "es": "Químico de conservación",
                  "de": "Konservierungschemikalie",
                  "nl": "Conserveringschemicalie"
        },
        {
                  "en": "Water contamination",
                  "es": "Contaminación del agua",
                  "de": "Wasserverschmutzung",
                  "nl": "Waterverontreiniging"
        },
        {
                  "en": "Artificial additive",
                  "es": "Aditivo artificial",
                  "de": "Künstlicher Zusatzstoff",
                  "nl": "Kunstmatige toevoeging"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Any temperature is acceptable",
                  "es": "Cualquier temperatura es aceptable",
                  "de": "Jede Temperatur ist akzeptabel",
                  "nl": "Elke temperatuur is acceptabel"
        },
        {
                  "en": "Must be heated to 100°C first",
                  "es": "Debe calentarse primero a 100°C",
                  "de": "Muss zuerst auf 100°C erhitzt werden",
                  "nl": "Moet eerst tot 100°C worden verwarmd"
        },
        {
                  "en": "At the source temperature without heating or cooling",
                  "es": "A la temperatura de la fuente sin calentar ni enfriar",
                  "de": "Bei der Quelltemperatur ohne Erhitzen oder Kühlen",
                  "nl": "Op brontemperatuur zonder verwarmen of koelen"
        },
        {
                  "en": "Must be cooled to 4°C",
                  "es": "Debe enfriarse a 4°C",
                  "de": "Muss auf 4°C gekühlt werden",
                  "nl": "Moet tot 4°C worden gekoeld"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A plastic component from bottles",
                  "es": "Un componente plástico de botellas",
                  "de": "Eine Plastikkomponente aus Flaschen",
                  "nl": "Een plastic component van flessen"
        },
        {
                  "en": "A chemical preservative",
                  "es": "Un conservante químico",
                  "de": "Ein chemisches Konservierungsmittel",
                  "nl": "Een chemisch conserveermiddel"
        },
        {
                  "en": "An artificial flavor enhancer",
                  "es": "Un potenciador de sabor artificial",
                  "de": "Ein künstlicher Geschmacksverstärker",
                  "nl": "Een kunstmatige smaakversterker"
        },
        {
                  "en": "A naturally occurring mineral (SiO₂) beneficial for skin, hair, and connective tissue",
                  "es": "Un mineral natural (SiO₂) beneficioso para piel, cabello y tejido conectivo",
                  "de": "Ein natürlich vorkommendes Mineral (SiO₂), vorteilhaft für Haut, Haare und Bindegewebe",
                  "nl": "Een natuurlijk voorkomend mineraal (SiO₂) gunstig voor huid, haar en bindweefsel"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Chemical treatment in factories",
                  "es": "Tratamiento químico en fábricas",
                  "de": "Chemische Behandlung in Fabriken",
                  "nl": "Chemische behandeling in fabrieken"
        },
        {
                  "en": "Evaporation and condensation cycles",
                  "es": "Ciclos de evaporación y condensación",
                  "de": "Verdunstungs- und Kondensationszyklen",
                  "nl": "Verdampings- en condensatiecycli"
        },
        {
                  "en": "Water filtering through rock layers over time, dissolving minerals",
                  "es": "Agua filtrándose a través de capas de roca con el tiempo, disolviendo minerales",
                  "de": "Wasser, das im Laufe der Zeit durch Gesteinsschichten filtert und Mineralien auflöst",
                  "nl": "Water dat in de loop van de tijd door steenlagen filtert en mineralen oplost"
        },
        {
                  "en": "Artificial mineral injection",
                  "es": "Inyección artificial de minerales",
                  "de": "Künstliche Mineralinjektion",
                  "nl": "Kunstmatige mineraalinjectie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Water with very high mineral content (>1500 mg/L)",
                  "es": "Agua con contenido mineral muy alto (>1500 mg/L)",
                  "de": "Wasser mit sehr hohem Mineralgehalt (>1500 mg/L)",
                  "nl": "Water met zeer hoog mineralengehalte (>1500 mg/L)"
        },
        {
                  "en": "Artificially mineralized water",
                  "es": "Agua mineralizada artificialmente",
                  "de": "Künstlich mineralisiertes Wasser",
                  "nl": "Kunstmatig gemineraliseerd water"
        },
        {
                  "en": "Water with low mineral content (<500 mg/L)",
                  "es": "Agua con bajo contenido mineral (<500 mg/L)",
                  "de": "Wasser mit niedrigem Mineralgehalt (<500 mg/L)",
                  "nl": "Water met laag mineralengehalte (<500 mg/L)"
        },
        {
                  "en": "Water from volcanic sources",
                  "es": "Agua de fuentes volcánicas",
                  "de": "Wasser aus vulkanischen Quellen",
                  "nl": "Water van vulkanische bronnen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To prevent contamination and preserve natural purity",
                  "es": "Para prevenir contaminación y preservar pureza natural",
                  "de": "Um Verschmutzung zu verhindern und natürliche Reinheit zu bewahren",
                  "nl": "Om vervuiling te voorkomen en natuurlijke zuiverheid te behouden"
        },
        {
                  "en": "To increase mineral content",
                  "es": "Para aumentar el contenido mineral",
                  "de": "Um den Mineralgehalt zu erhöhen",
                  "nl": "Om het mineralengehalte te verhogen"
        },
        {
                  "en": "To regulate water temperature",
                  "es": "Para regular la temperatura del agua",
                  "de": "Um die Wassertemperatur zu regulieren",
                  "nl": "Om de watertemperatuur te reguleren"
        },
        {
                  "en": "To control production volume",
                  "es": "Para controlar el volumen de producción",
                  "de": "Um das Produktionsvolumen zu kontrollieren",
                  "nl": "Om het productievolume te regelen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Vision improvement",
                  "es": "Mejora de la visión",
                  "de": "Sehverbesserung",
                  "nl": "Verbetering van het zicht"
        },
        {
                  "en": "Muscle growth",
        ...
        {
                  "en": "Dental health and cavity prevention",
                  "es": "Salud dental y prevención de caries",
                  "de": "Zahngesundheit und Kariesprävention",
                  "nl": "Tandgezondheid en cariëspreventie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Total dissolved solids (TDS)",
                  "es": "Sólidos disueltos totales (TDS)",
                  "de": "Gelöste Feststoffe gesamt (TDS)",
                  "nl": "Totaal opgeloste stoffen (TDS)"
        },
        {
                  "en": "Bacterial content",
                  "es": "Contenido bacteriano",
                  "de": "Bakteriengehalt",
                  "nl": "Bacterieel gehalte"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A naturally occurring radioactive gas",
                  "es": "Un gas radiactivo natural",
                  "de": "Ein natürlich vorkommendes radioaktives Gas",
                  "nl": "Een natuurlijk voorkomend radioactief gas"
        },
        {
                  "en": "A type of bacteria",
                  "es": "Un tipo de bacteria",
                  "de": "Eine Art Bakterium",
                  "nl": "Een soort bacterie"
        },
        {
                  "en": "A beneficial mineral compound",
                  "es": "Un compuesto mineral beneficioso",
                  "de": "Eine vorteilhafte Mineralverbindung",
                  "nl": "Een gunstige mineraalverbinding"
        },
        {
                  "en": "An artificial preservative",
                  "es": "Un conservante artificial",
                  "de": "Ein künstliches Konservierungsmittel",
                  "nl": "Een kunstmatig conserveermiddel"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Improves water color",
                  "es": "Mejora el color del agua",
                  "de": "Verbessert die Wasserfarbe",
                  "nl": "Verbetert de waterkleur"
        },
        {
                  "en": "Extends shelf life",
                  "es": "Extiende la vida útil",
                  "de": "Verlängert die Haltbarkeit",
                  "nl": "Verlengt houdbaarheid"
        },
        {
                  "en": "Increases carbonation",
                  "es": "Aumenta la carbonatación",
                  "de": "Erhöht die Karbonisierung",
                  "nl": "Verhoogt carbonatatie"
        },
        {
                  "en": "May have calming effects and support mood",
                  "es": "Puede tener efectos calmantes y apoyar el estado de ánimo",
                  "de": "Kann beruhigende Wirkung haben und die Stimmung unterstützen",
                  "nl": "Kan kalmerende effecten hebben en stemming ondersteunen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Lower mineral concentration than blood plasma",
                  "es": "Menor concentración mineral que plasma sanguíneo",
                  "de": "Niedrigere Mineralkonzentration als Blutplasma",
                  "nl": "Lagere mineraalconcentratie dan bloedplasma"
        },
        {
                  "en": "Same mineral concentration as blood plasma",
                  "es": "Misma concentración mineral que plasma sanguíneo",
                  "de": "Gleiche Mineralkonzentration wie Blutplasma",
                  "nl": "Zelfde mineraalconcentratie als bloedplasma"
        },
        {
                  "en": "Higher mineral concentration than blood plasma",
                  "es": "Mayor concentración mineral que plasma sanguíneo",
                  "de": "Höhere Mineralkonzentration als Blutplasma",
                  "nl": "Hogere mineraalconcentratie dan bloedplasma"
        },
        {
                  "en": "No minerals present",
                  "es": "Sin minerales presentes",
                  "de": "Keine Mineralien vorhanden",
                  "nl": "Geen mineralen aanwezig"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Carbonated water",
                  "es": "Agua carbonatada",
                  "de": "Karbonisiertes Wasser",
                  "nl": "Gecarboneerd water"
        },
        {
                  "en": "Water with added electrolytes",
                  "es": "Agua con electrolitos añadidos",
                  "de": "Wasser mit zugesetzten Elektrolyten",
                  "nl": "Water met toegevoegde elektrolyten"
        },
        {
                  "en": "Water from ice sources",
                  "es": "Agua de fuentes de hielo",
                  "de": "Wasser aus Eisquellen",
                  "nl": "Water van ijsbronnen"
        },
        {
                  "en": "Water with the same osmotic pressure as blood",
                  "es": "Agua con la misma presión osmótica que la sangre",
                  "de": "Wasser mit dem gleichen osmotischen Druck wie Blut",
                  "nl": "Water met dezelfde osmotische druk als bloed"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Legal requirement to inform consumers of exact mineral composition",
                  "es": "Requisito legal para informar a consumidores de composición mineral exacta",
                  "de": "Gesetzliche Anforderung zur Information der Verbraucher über die genaue Mineralzusammensetzung",
                  "nl": "Wettelijke vereiste om consumenten te informeren over exacte mineraalsamenstelling"
        },
        {
                  "en": "Expiration date indicator",
                  "es": "Indicador de fecha de caducidad",
                  "de": "Ablaufdatumindikator",
                  "nl": "Vervaldatumindicator"
        },
        {
                  "en": "Quality certification symbol",
                  "es": "Símbolo de certificación de calidad",
                  "de": "Qualitätszertifizierungssymbol",
                  "nl": "Kwaliteitscertificeringssymbool"
        },
        {
                  "en": "Marketing decoration only",
                  "es": "Solo decoración de marketing",
                  "de": "Nur Marketing-Dekoration",
                  "nl": "Alleen marketingdecoratie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ability of water to conduct electrical current, indicating dissolved ion concentration",
                  "es": "Capacidad del agua para conducir corriente eléctrica, indicando concentración de iones disueltos",
                  "de": "Fähigkeit von Wasser, elektrischen Strom zu leiten, was die Konzentration gelöster Ionen anzeigt",
                  "nl": "Vermogen van water om elektrische stroom te geleiden, wat de concentratie van opgeloste ionen aangeeft"
        },
        {
                  "en": "Temperature of the water",
                  "es": "Temperatura del agua",
                  "de": "Temperatur des Wassers",
                  "nl": "Temperatuur van het water"
        },
        {
                  "en": "Clarity of the water",
                  "es": "Claridad del agua",
                  "de": "Klarheit des Wassers",
                  "nl": "Helderheid van het water"
        },
        {
                  "en": "Flow rate from the source",
                  "es": "Tasa de flujo desde la fuente",
                  "de": "Durchflussrate von der Quelle",
                  "nl": "Stromingssnelheid van de bron"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A sign of contamination",
                  "es": "Una señal de contaminación",
                  "de": "Ein Zeichen für Verschmutzung",
                  "nl": "Een teken van vervuiling"
        },
        {
                  "en": "A cleaning residue",
                  "es": "Un residuo de limpieza",
                  "de": "Ein Reinigungsrückstand",
                  "nl": "Een schoonmaakresidu"
        },
        {
                  "en": "Natural mineral deposits that can form when water conditions change",
                  "es": "Depósitos minerales naturales que pueden formarse cuando cambian las condiciones del agua",
                  "de": "Natürliche Mineralablagerungen, die sich bilden können, wenn sich die Wasserbedingungen ändern",
                  "nl": "Natuurlijke mineraalafzettingen die kunnen ontstaan wanneer watercondities veranderen"
        },
        {
                  "en": "An artificial additive",
                  "es": "Un aditivo artificial",
                  "de": "Ein künstlicher Zusatzstoff",
                  "nl": "Een kunstmatige toevoeging"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Rapid hydration during exercise",
                  "es": "Hidratación rápida durante ejercicio",
                  "de": "Schnelle Hydratation beim Sport",
                  "nl": "Snelle hydratatie tijdens inspanning"
        },
        {
                  "en": "Cooking and food preparation",
                  "es": "Cocina y preparación de alimentos",
                  "de": "Kochen und Lebensmittelzubereitung",
                  "nl": "Koken en voedselbereiding"
        },
        {
                  "en": "Mineral supplementation and recovery after intense activity",
                  "es": "Suplementación mineral y recuperación después de actividad intensa",
                  "de": "Mineralergänzung und Erholung nach intensiver Aktivität",
                  "nl": "Mineraalsuppletie en herstel na intense activiteit"
        },
        {
                  "en": "Daily drinking for children",
                  "es": "Bebida diaria para niños",
                  "de": "Tägliches Trinken für Kinder",
                  "nl": "Dagelijks drinken voor kinderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Water is sterile",
                  "es": "Agua es estéril",
                  "de": "Wasser ist steril",
                  "nl": "Water is steriel"
        },
        {
                  "en": "Water contains added vitamins",
                  "es": "Agua contiene vitaminas añadidas",
                  "de": "Wasser enthält zugesetzte Vitamine",
                  "nl": "Water bevat toegevoegde vitamines"
        },
        {
                  "en": "Water is carbonated",
                  "es": "Agua está carbonatada",
                  "de": "Wasser ist karbonisiert",
                  "nl": "Water is gecarboneerd"
        },
        {
                  "en": "Water meets strict limits for sodium, nitrate, fluoride, and other minerals safe for babies",
                  "es": "Agua cumple límites estrictos para sodio, nitrato, fluoruro y otros minerales seguros para bebés",
                  "de": "Wasser erfüllt strenge Grenzwerte für Natrium, Nitrat, Fluorid und andere für Babys sichere Mineralien",
                  "nl": "Water voldoet aan strikte limieten voor natrium, nitraat, fluoride en andere mineralen die veilig zijn voor baby's"
        }
        ],
        correct: 3,
        explanation: {
