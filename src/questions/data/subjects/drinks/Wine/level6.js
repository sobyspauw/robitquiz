// Wine - level6
// Total questions: 100
// Quality issues fixed: 2026-03-03T10:19:08.547Z
    ...
    questions: [
            {
                    "question": {
                            ...
                            "de": "Was ist die malolaktische Gärung in der Weinherstellung?",
                            "nl": "Wat is malolactische fermentatie in wijnmaken?"
                    },
                    "options": [
                            {
                                    "en": "Converting sharp malic acid to softer lactic acid",
                                    "es": "Convertir ácido málico agudo en ácido láctico más suave",
                                    "de": "Umwandlung von scharfer Apfelsäure in mildere Milchsäure",
                                    "nl": "Het omzetten van scherp appelzuur naar zachter melkzuur"
                            },
                            {
                            ...
                            {
                                    "en": "Removing sediment from wine",
                                    "es": "Eliminar sedimento del vino",
                                    "de": "Sediment aus dem Wein entfernen",
                                    "nl": "Sediment uit wijn verwijderen"
                            },
                            {
                                    "en": "Adding yeast for fermentation",
                                    "es": "Agregar levadura para fermentación",
                                    "de": "Hefe für die Gärung hinzufügen",
                                    "nl": "Gist toevoegen voor fermentatie"
                            }
                    ],
                    "correct": 0,
                    "explanation": {
                            "en": "Malolactic fermentation is a secondary fermentation where bacteria convert tart malic acid into softer lactic acid, creating a creamier, buttery texture often found in Chardonnays.",
                            "es": "La fermentación maloláctica es una fermentación secundaria donde las bacterias convierten el ácid...",
                            "de": "Die malolaktische Gärung ist eine Sekundärgärung, bei der Bakterien die scharfe Apfelsäure in mil...",
                            "nl": "Malolactische fermentatie is een secundaire fermentatie waarbij bacteriën scherp appelzuur omzett..."
                    }
            },
            {
                    "question": {
                            ...
                            "de": "Was bedeutet 'sur lie' Reifung?",
                    ...
                    "options": [
                            {
                                    ...
                                    "de": "Wein auf abgestorbenen Hefezellen reifen",
                                    "nl": "Wijn rijpen op dode gistcellen"
                            },
                            {
                                    "en": "Aging in oak barrels",
                                    "es": "Envejecer en barricas de roble",
                                    "de": "Reifung in Eichenfässern",
                                    "nl": "Rijpen in eiken vaten"
                            },
                            {
                                    "en": "Aging underground",
                                    "es": "Envejecer bajo tierra",
                                    "de": "Unterirdische Reifung",
                                    "nl": "Ondergronds rijpen"
                            },
                            {
                                    "en": "Aging at sea",
                                    "es": "Envejecer en el mar",
                                    "de": "Reifung auf See",
                                    "nl": "Rijpen op zee"
                            }
                    ],
                    "correct": 0,
                    "explanation": {
                            "en": "Sur lie ('on the lees') is aging wine on dead yeast cells after fermentation, which adds complexity, creaminess, and bread-like flavors. It's traditional in Muscadet and Champagne production.",
                            "es": "Sur lie ('sobre las lías') es envejecer el vino sobre células de levadura muertas después de la f...",
                            "de": "Sur lie ('auf der Hefe') ist die Reifung von Wein auf abgestorbenen Hefezellen nach der Gärung, w...",
                            "nl": "Sur lie ('op de lie') is het rijpen van wijn op dode gistcellen na fermentatie, wat complexiteit,..."
                    }
            },
            {
                    "question": {
                            "en": "What is the purpose of riddling (remuage) in Champagne production?",
                            "es": "¿Cuál es el propósito del removido (remuage) en la producción de Champagne?",
                            "de": "Was ist der Zweck des Rüttelns (remuage) in der Champagnerherstellung?",
                            "nl": "Wat is het doel van remuage bij Champagne productie?"
                    },
                    "options": [
                            {
                                    "en": "Moving sediment to the bottle neck for removal",
                                    "es": "Mover sedimento al cuello de la botella para su eliminación",
                                    "de": "Sediment zum Flaschenhals bewegen zur Entfernung",
                                    "nl": "Sediment naar de flessenhals verplaatsen voor verwijdering"
                            },
                            {
                                    "en": "Adding bubbles to the wine",
                                    "es": "Agregar burbujas al vino",
                                    "de": "Blasen zum Wein hinzufügen",
                                    "nl": "Bubbels aan de wijn toevoegen"
                            },
                            {
                                    "en": "Mixing the wine blend",
                                    "es": "Mezclar la mezcla de vino",
                                    "de": "Die Weinmischung vermischen",
                                    "nl": "Het wijnmengsel mengen"
                            },
                            {
                                    "en": "Testing wine quality",
                                    "es": "Probar la calidad del vino",
                                    "de": "Weinqualität testen",
                                    "nl": "Wijnkwaliteit testen"
                            }
                    ],
                    "correct": 0,
                    "explanation": {
                            "en": "Riddling involves gradually rotating and tilting bottles to consolidate sediment in the neck for removal through disgorgement, essential for creating clear sparkling wine.",
                            "es": "El removido implica rotar e inclinar gradualmente las botellas para consolidar el sedimento en el...",
                            "de": "Rütteln beinhaltet das allmähliche Drehen und Neigen von Flaschen, um Sediment im Hals zu konsoli...",
                            "nl": "Remuage houdt in dat flessen geleidelijk worden gedraaid en gekanteld om sediment in de hals te c..."
                    }
            },
            {
                    "question": {
                            "en": "What is a 'flying winemaker'?",
                            "es": "¿Qué es un 'enólogo volador'?",
                            "de": "Was ist ein 'fliegender Winzer'?",
                            "nl": "Wat is een 'vliegende wijnmaker'?"
                    },
                    "options": [
                            {
                                    "en": "A consultant who works in both Northern and Southern hemispheres",
                                    "es": "Un consultor que trabaja en ambos hemisferios norte y sur",
                                    "de": "Ein Berater, der in beiden Hemisphären arbeitet",
                                    "nl": "Een consultant die in beide halfronden werkt"
                            },
                            {
                                    "en": "A winemaker who uses drones",
                                    "es": "Un enólogo que usa drones",
                                    "de": "Ein Winzer, der Drohnen verwendet",
                                    "nl": "Een wijnmaker die drones gebruikt"
                            },
                            {
                                    "en": "A pilot who transports wine",
                                    "es": "Un piloto que transporta vino",
                                    "de": "Ein Pilot, der Wein transportiert",
                                    "nl": "Een piloot die wijn vervoert"
                            },
                            {
                                    "en": "A traveling wine salesperson",
                                    "es": "Un vendedor de vino viajero",
                                    "de": "Ein reisender Weinverkäufer",
                                    "nl": "Een reizende wijnverkoper"
                            }
                    ],
                    "correct": 0,
                    "explanation": {
                            "en": "Flying winemakers are consultants who work harvests in both hemispheres, traveling between regions to make wine year-round and bring international techniques to different wineries.",
                            "es": "Los enólogos voladores son consultores que trabajan cosechas en ambos hemisferios, viajando entre...",
                            "de": "Fliegende Winzer sind Berater, die Ernten in beiden Hemisphären bearbeiten, zwischen Regionen rei...",
                            "nl": "Vliegende wijnmakers zijn consultants die oogsten in beide halfronden werken, tussen regio's reiz..."
                    }
            },
            {
                    "question": {
                    ...
                    "options": [
                            {
                                    "en": "Fermenting whole grapes in CO2 atmosphere",
                                    "es": "Fermentar uvas enteras en atmósfera de CO2",
                                    "de": "Ganze Trauben in CO2-Atmosphäre fermentieren",
                                    "nl": "Hele druiven fermenteren in CO2 atmosfeer"
                            },
                            {
                            ...
                            {
                                    "en": "Removing carbon from wine",
                                    "es": "Eliminar carbono del vino",
                                    "de": "Kohlenstoff aus Wein entfernen",
                                    "nl": "Koolstof uit wijn verwijderen"
                            },
                            {
                                    "en": "Filtering wine through carbon",
                                    "es": "Filtrar vino a través de carbón",
                                    "de": "Wein durch Kohle filtern",
                                    "nl": "Wijn filteren door koolstof"
                            }
                    ],
                    "correct": 0,
                    "explanation": {
                            "en": "Carbonic maceration involves fermenting whole, uncrushed grapes in a carbon dioxide-rich environment, creating fruity, low-tannin wines. It's the traditional method for Beaujolais Nouveau.",
                            "es": "La maceración carbónica implica fermentar uvas enteras sin triturar en un ambiente rico en dióxid...",
                            "de": "Kohlensäuremaischung beinhaltet die Fermentation ganzer, ungepresster Trauben in einer kohlendiox...",
                            "nl": "Carbonische maceratie houdt in dat hele, ongekneusde druiven fermenteren in een kooldioxide-rijke..."
                    }
            },
            {
                    "question": {
                    ...
                    "correct": 3,
                    "explanation": {
                            "en": "This question relates to level 6 content in Wine. The correct answer provides important context.",
                            "es": "This question relates to level 6 content in Wine. The correct answer provides important context.",
                            "de": "This question relates to level 6 content in Wine. The correct answer provides important context.",
                            "nl": "This question relates to level 6 content in Wine. The correct answer provides important context."
                    }
            },
            {
                    "question": {
