  ...
  const level5 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "To ferment the beer", es: "Para fermentar la cerveza", de: "Um das Bier zu gären", nl: "Om het bier te fermenteren" },
          { en: "To convert starches to sugars", es: "Para convertir almidones en azúcares", de: "Um Stärke in Zucker umzuwandeln", nl: "Om zetmeel om te zetten in suikers" },
          { en: "To boil the wort", es: "Para hervir el mosto", de: "Um die Würze zu kochen", nl: "Om de wort te koken" },
          { en: "To store finished beer", es: "Para almacenar cerveza terminada", de: "Um fertiges Bier zu lagern", nl: "Om afgewerkt bier op te slaan" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Mashing in steps up a ladder", es: "Macerar en pasos subiendo una escalera", de: "Maischen auf einer Leiter", nl: "Maischen op een ladder" },
          { en: "Raising mash temperature in stages", es: "Elevar la temperatura del macerado en etapas", de: "Maischtemperatur stufenweise erhöhen", nl: "Maischtemperatuur stapsgewijs verhogen" },
          { en: "Adding ingredients in steps", es: "Agregar ingredientes en pasos", de: "Zutaten schrittweise hinzufügen", nl: "Ingrediënten stapsgewijs toevoegen" },
          { en: "Filtering in multiple stages", es: "Filtrar en múltiples etapas", de: "In mehreren Stufen filtern", nl: "In meerdere stappen filteren" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Adding carbonation", es: "Agregar carbonatación", de: "Kohlensäure hinzufügen", nl: "Koolzuur toevoegen" },
          { en: "Rinsing grains to extract remaining sugars", es: "Enjuagar granos para extraer azúcares restantes", de: "Körner spülen, um restliche Zucker zu extrahieren", nl: "Granen spoelen om resterende suikers te extraheren" },
          { en: "Filtering the beer", es: "Filtrar la cerveza", de: "Das Bier filtern", nl: "Het bier filteren" },
      ...
      },
      {
        ...
        options: [
          { en: "Where they are stored", es: "Dónde se almacenan", de: "Wo sie gelagert werden", nl: "Waar ze worden opgeslagen" },
          { en: "Where they work during fermentation", es: "Dónde trabajan durante la fermentación", de: "Wo sie während der Gärung arbeiten", nl: "Waar ze werken tijdens fermentatie" },
          { en: "Their color", es: "Su color", de: "Ihre Farbe", nl: "Hun kleur" },
          { en: "Their price", es: "Su precio", de: "Ihr Preis", nl: "Hun prijs" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "When equipment breaks from heat", es: "Cuando el equipo se rompe por el calor", de: "Wenn Ausrüstung durch Hitze bricht", nl: "Wanneer apparatuur kapot gaat door hitte" },
          { en: "Protein coagulation during boiling", es: "Coagulación de proteínas durante el hervido", de: "Proteinkoagulation während des Kochens", nl: "Eiwitcoagulatie tijdens het koken" },
          { en: "Adding boiling water", es: "Agregar agua hirviendo", de: "Kochendes Wasser hinzufügen", nl: "Kokend water toevoegen" },
          { en: "Stopping the boil", es: "Detener el hervido", de: "Das Kochen stoppen", nl: "Het koken stoppen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To mix ingredients", es: "Para mezclar ingredientes", de: "Um Zutaten zu mischen", nl: "Om ingrediënten te mengen" },
          { en: "To separate trub from wort", es: "Para separar el turbio del mosto", de: "Um Trub von Würze zu trennen", nl: "Om troebel van wort te scheiden" },
          { en: "To cool the beer", es: "Para enfriar la cerveza", de: "Um das Bier zu kühlen", nl: "Om het bier af te koelen" },
      ...
      },
      {
        ...
        options: [
          { en: "Adding yeast to wort", es: "Agregar levadura al mosto", de: "Hefe zur Würze hinzufügen", nl: "Gist aan wort toevoegen" },
          { en: "Throwing away bad beer", es: "Desechar cerveza mala", de: "Schlechtes Bier wegwerfen", nl: "Slecht bier weggooien" },
          { en: "Measuring alcohol content", es: "Medir el contenido de alcohol", de: "Alkoholgehalt messen", nl: "Alcoholgehalte meten" },
          { en: "Tilting fermentation vessel", es: "Inclinar recipiente de fermentación", de: "Gärgefäß kippen", nl: "Fermentatievat kantelen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To increase alcohol content", es: "Para aumentar el contenido de alcohol", de: "Um den Alkoholgehalt zu erhöhen", nl: "Om het alcoholgehalte te verhogen" },
          { en: "To condition beer at cold temperatures", es: "Para acondicionar cerveza a temperaturas frías", de: "Um Bier bei kalten Temperaturen zu konditionieren", nl: "Om bier te conditioneren bij koude temperaturen" },
          { en: "To add carbonation", es: "Para agregar carbonatación", de: "Um Kohlensäure hinzuzufügen", nl: "Om koolzuur toe te voegen" },
      ...
      },
      {
        ...
        options: [
          { en: "A desired hop flavor", es: "Un sabor de lúpulo deseado", de: "Ein erwünschtes Hopfenaroma", nl: "Een gewenste hopsmaak" },
          { en: "A buttery off-flavor compound", es: "Un compuesto de sabor a mantequilla indeseado", de: "Eine butterartige Fehlaromaverbindung", nl: "Een boterach​tige ongewenste smaakverbinding" },
          { en: "A type of yeast", es: "Un tipo de levadura", de: "Eine Art Hefe", nl: "Een type gist" },
          { en: "A brewing enzyme", es: "Una enzima de elaboración", de: "Ein Brauenzym", nl: "Een brouwenzym" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "When hops are harvested", es: "Cuando se cosechan los lúpulos", de: "Wann Hopfen geerntet wird", nl: "Wanneer hop wordt geoogst" },
          { en: "Timing of hop additions during boil", es: "Tiempo de adiciones de lúpulo durante el hervido", de: "Zeitpunkt der Hopfenzugaben während des Kochens", nl: "Timing van hoptoevoegingen tijdens het koken" },
          { en: "Hop storage temperature", es: "Temperatura de almacenamiento del lúpulo", de: "Hopfenlagertemperatur", nl: "Hopopslagtemperatuur" },
          { en: "Hop growing calendar", es: "Calendario de cultivo de lúpulo", de: "Hopfenanbaukalender", nl: "Hopteeltkalender" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To add flavor", es: "Para agregar sabor", de: "Um Geschmack hinzuzufügen", nl: "Om smaak toe te voegen" },
          { en: "To provide oxygen for yeast", es: "Para proporcionar oxígeno a la levadura", de: "Um Sauerstoff für Hefe bereitzustellen", nl: "Om zuurstof te leveren aan gist" },
          { en: "To cool the wort", es: "Para enfriar el mosto", de: "Um die Würze zu kühlen", nl: "Om de wort af te koelen" },
          { en: "To remove sediment", es: "Para remover sedimento", de: "Um Sediment zu entfernen", nl: "Om sediment te verwijderen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The weight of finished beer", es: "El peso de la cerveza terminada", de: "Das Gewicht des fertigen Bieres", nl: "Het gewicht van afgewerkt bier" },
          { en: "The density after fermentation is complete", es: "La densidad después de que la fermentación está completa", de: "Die Dichte nach Abschluss der Gärung", nl: "De dichtheid nadat fermentatie compleet is" },
          { en: "The last measurement taken", es: "La última medición tomada", de: "Die letzte genommene Messung", nl: "De laatste meting genomen" },
          { en: "The alcohol percentage", es: "El porcentaje de alcohol", de: "Der Alkoholprozentsatz", nl: "Het alcoholpercentage" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Compounds providing hop bitterness", es: "Compuestos que proporcionan amargor del lúpulo", de: "Verbindungen, die Hopfenbitterkeit liefern", nl: "Verbindingen die hopbitterheid leveren" },
          { en: "Hop preservation chemicals", es: "Químicos de preservación del lúpulo", de: "Hopfenkonservierungschemikalien", nl: "Hopconserveringschemicaliën" },
          { en: "Hop fertilizers", es: "Fertilizantes de lúpulo", de: "Hopfendünger", nl: "Hopmest" },
          { en: "Hop coloring agents", es: "Agentes colorantes del lúpulo", de: "Hopfenfärbemittel", nl: "Hopkleurmiddelen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To store wort for later use", es: "Para almacenar mosto para uso posterior", de: "Um Würze für spätere Verwendung zu lagern", nl: "Om wort op te slaan voor later gebruik" },
          { en: "To rapidly cool wort to pitching temperature", es: "Para enfriar rápidamente el mosto a temperatura de inoculación", de: "Um Würze schnell auf Anstelltemperatur zu kühlen", nl: "Om wort snel af te koelen tot gisttemperatuur" },
          { en: "To add ice to the beer", es: "Para agregar hielo a la cerveza", de: "Um Eis zum Bier hinzuzufügen", nl: "Om ijs aan bier toe te voegen" },
      ...
      },
      {
        ...
        options: [
          { en: "To measure water hardness", es: "Para medir dureza del agua", de: "Um Wasserhärte zu messen", nl: "Om waterhardheid te meten" },
          { en: "To measure specific gravity", es: "Para medir gravedad específica", de: "Um spezifisches Gewicht zu messen", nl: "Om soortelijk gewicht te meten" },
          { en: "To measure temperature", es: "Para medir temperatura", de: "Um Temperatur zu messen", nl: "Om temperatuur te meten" },
          { en: "To measure pH levels", es: "Para medir niveles de pH", de: "Um pH-Werte zu messen", nl: "Om pH-niveaus te meten" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Removing hops from beer", es: "Remover lúpulos de la cerveza", de: "Hopfen aus Bier entfernen", nl: "Hop uit bier verwijderen" },
          { en: "A vessel for hop aroma extraction", es: "Un recipiente para extracción de aroma de lúpulo", de: "Ein Gefäß zur Hopfenaromaextraktion", nl: "Een vat voor hoparoma-extractie" },
          { en: "Recycling used hops", es: "Reciclar lúpulos usados", de: "Gebrauchte Hopfen recyceln", nl: "Gebruikte hop recyclen" },
          { en: "Growing hops backwards", es: "Cultivar lúpulos al revés", de: "Hopfen rückwärts anbauen", nl: "Hop achterwaarts telen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "It affects enzyme activity and extraction", es: "Afecta la actividad enzimática y extracción", de: "Es beeinflusst Enzymaktivität und Extraktion", nl: "Het beïnvloedt enzymactiviteit en extractie" },
          { en: "It determines beer color only", es: "Solo determina el color de la cerveza", de: "Es bestimmt nur die Bierfarbe", nl: "Het bepaalt alleen bierkleur" },
          { en: "It has no effect on brewing", es: "No tiene efecto en la elaboración", de: "Es hat keine Auswirkung auf das Brauen", nl: "Het heeft geen effect op brouwen" },
          { en: "It only affects carbonation", es: "Solo afecta la carbonatación", de: "Es beeinflusst nur die Kohlensäure", nl: "Het beïnvloedt alleen koolzuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Pellets are compressed, whole leaf is natural form", es: "Pellets están comprimidos, hoja entera es forma natural", de: "Pellets sind komprimiert, Dolden sind natürliche Form", nl: "Pellets zijn gecomprimeerd, hele blad is natuurlijke vorm" },
          { en: "They come from different hop plants", es: "Vienen de diferentes plantas de lúpulo", de: "Sie stammen von verschiedenen Hopfenpflanzen", nl: "Ze komen van verschillende hopplanten" },
          { en: "Pellets are for lagers, whole leaf for ales", es: "Pellets son para lagers, hoja entera para ales", de: "Pellets für Lager, Dolden für Ales", nl: "Pellets zijn voor lagers, hele blad voor ales" },
      ...
      },
      {
        ...
        options: [
          { en: "To add oxygen to fermenting beer", es: "Para agregar oxígeno a cerveza en fermentación", de: "Um Sauerstoff zum gärenden Bier hinzuzufügen", nl: "Om zuurstof toe te voegen aan fermenterende bier" },
          { en: "To allow vigorous fermentation foam to escape", es: "Para permitir que escape espuma de fermentación vigorosa", de: "Um kräftigen Gärungsschaum entweichen zu lassen", nl: "Om krachtig fermentatieschuim te laten ontsnappen" },
          { en: "To measure fermentation temperature", es: "Para medir temperatura de fermentación", de: "Um Gärungstemperatur zu messen", nl: "Om fermentatietemperatuur te meten" },
          { en: "To filter the beer", es: "Para filtrar la cerveza", de: "Um das Bier zu filtern", nl: "Om het bier te filteren" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "To add flavor to beer", es: "Para agregar sabor a la cerveza", de: "Um Bier Geschmack zu verleihen", nl: "Om smaak aan bier toe te voegen" },
          { en: "To prevent contamination by unwanted microbes", es: "Para prevenir contaminación por microbios no deseados", de: "Um Kontamination durch unerwünschte Mikroben zu verhindern", nl: "Om besmetting door ongewenste microben te voorkomen" },
          { en: "To increase alcohol content", es: "Para aumentar el contenido de alcohol", de: "Um den Alkoholgehalt zu erhöhen", nl: "Om het alcoholgehalte te verhogen" },
          { en: "To speed up fermentation", es: "Para acelerar la fermentación", de: "Um die Gärung zu beschleunigen", nl: "Om fermentatie te versnellen" }
        ],
        correct: 1,
