// Quiz Template - Level 6: Drinken - Bier
(function() {
  const level6 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { en: "Incomplete yeast fermentation", es: "Fermentación incompleta de levadura", de: "Unvollständige Hefegärung", nl: "Onvolledige gistfermentatie" },
          { en: "Over-hopping", es: "Exceso de lúpulo", de: "Übermäßiger Hopfeneinsatz", nl: "Te veel hop" },
          { en: "High water pH", es: "pH alto del agua", de: "Hoher Wasser-pH", nl: "Hoge water pH" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Myrcene", es: "Mirceno", de: "Myrcen", nl: "Myrceen" },
          { en: "Limonene", es: "Limoneno", de: "Limonen", nl: "Limoneen" },
          { en: "Linalool", es: "Linalol", de: "Linalool", nl: "Linalool" },
          { en: "Pinene", es: "Pineno", de: "Pinen", nl: "Pineen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Astringency affects smell, bitterness affects taste", es: "La astringencia afecta el olfato, la amargura afecta el gusto", de: "Adstringenz beeinflusst den Geruch, Bitterkeit den Geschmack", nl: "Wrangheid beïnvloedt de geur, bitterheid de smaak" },
          { en: "Astringency is a mouthfeel sensation, bitterness is a taste", es: "La astringencia es una sensación en boca, la amargura es un sabor", de: "Adstringenz ist ein Mundgefühl, Bitterkeit ist ein Geschmack", nl: "Wrangheid is een mondgevoel, bitterheid is een smaak" },
          { en: "Astringency is sweet, bitterness is sour", es: "La astringencia es dulce, la amargura es agria", de: "Adstringenz ist süß, Bitterkeit ist sauer", nl: "Wrangheid is zoet, bitterheid is zuur" },
          { en: "They are the same sensation", es: "Son la misma sensación", de: "Sie sind dieselbe Empfindung", nl: "Het zijn dezelfde sensaties" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Trans-2-nonenal", es: "Trans-2-nonenal", de: "Trans-2-nonenal", nl: "Trans-2-nonenal" },
          { en: "Acetaldehyde", es: "Acetaldehído", de: "Acetaldehyd", nl: "Acetaldehyde" },
          { en: "Hydrogen sulfide", es: "Sulfuro de hidrógeno", de: "Schwefelwasserstoff", nl: "Waterstofsulfide" },
          { en: "Isoamyl acetate", es: "Acetato de isoamilo", de: "Isoamylacetat", nl: "Isoamylacetaat" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "32-35°F (0-2°C)", es: "32-35°F (0-2°C)", de: "32-35°F (0-2°C)", nl: "32-35°F (0-2°C)" },
          { en: "38-45°F (3-7°C)", es: "38-45°F (3-7°C)", de: "38-45°F (3-7°C)", nl: "38-45°F (3-7°C)" },
      ...
      },
      {
        ...
        options: [
          { en: "Tulip glass", es: "Copa tulipán", de: "Tulpenglas", nl: "Tulpglas" },
          { en: "Pilsner glass", es: "Copa pilsner", de: "Pilsnerglas", nl: "Pilsnerglas" },
          { en: "IPA glass", es: "Copa IPA", de: "IPA-Glas", nl: "IPA-glas" },
          { en: "Weizen glass", es: "Copa weizen", de: "Weizenglas", nl: "Weizenglas" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "UV light breaking down hop compounds", es: "Luz UV descomponiendo compuestos del lúpulo", de: "UV-Licht, das Hopfenverbindungen abbaut", nl: "UV-licht dat hopverbindingen afbreekt" },
          { en: "Bacterial infection", es: "Infección bacteriana", de: "Bakterielle Infektion", nl: "Bacteriële infectie" },
          { en: "Over-carbonation", es: "Exceso de carbonatación", de: "Überkohlensäure", nl: "Te veel koolzuur" },
      ...
      },
      {
        ...
        options: [
          { en: "Carbonation level", es: "Nivel de carbonatación", de: "Kohlensäuregehalt", nl: "Koolzuurniveau" },
          { en: "Body and fullness", es: "Cuerpo y plenitud", de: "Körper und Fülle", nl: "Body en volheid" },
          { en: "Alcohol warmth", es: "Calidez del alcohol", de: "Alkoholwärme", nl: "Alcoholwarmte" },
          { en: "Hop bitterness", es: "Amargura del lúpulo", de: "Hopfenbitterkeit", nl: "Hopbitterheid" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Diacetyl contamination", es: "Contaminación por diacetilo", de: "Diacetyl-Kontamination", nl: "Diacetyl besmetting" },
          { en: "Acetic acid infection", es: "Infección por ácido acético", de: "Essigsäure-Infektion", nl: "Azijnzuur infectie" },
          { en: "Phenolic off-flavor", es: "Sabor desagradable fenólico", de: "Phenolischer Fehlgeschmack", nl: "Fenolische bijsmaak" },
          { en: "Metallic contamination", es: "Contaminación metálica", de: "Metallische Kontamination", nl: "Metalen besmetting" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "4-mercapto-4-methylpentan-2-one (4MMP)", es: "4-mercapto-4-metilpentan-2-ona (4MMP)", de: "4-Mercapto-4-methylpentan-2-on (4MMP)", nl: "4-mercapto-4-methylpentan-2-on (4MMP)" },
          { en: "Geraniol", es: "Geraniol", de: "Geraniol", nl: "Geraniol" },
          { en: "Farnesene", es: "Farneseno", de: "Farnesen", nl: "Farneseen" },
          { en: "Caryophyllene", es: "Cariofileno", de: "Caryophyllen", nl: "Caryofylleen" }
        ],
        correct: 0,
        explanation: {
