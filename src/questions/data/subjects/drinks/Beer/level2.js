  ...
  const level2 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "German black lager", es: "Lager negra alemana", de: "Deutsches schwarzes Lager", nl: "Duitse zwarte lager" },
          { en: "Belgian sour beer", es: "Cerveza ácida belga", de: "Belgisches Sauerbier", nl: "Belgisch zuur bier" },
          { en: "Strong English ale", es: "Ale inglés fuerte", de: "Starkes englisches Ale", nl: "Sterk Engels ale" },
          { en: "American IPA", es: "IPA Americana", de: "Amerikanisches IPA", nl: "Amerikaanse IPA" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Amber German lager brewed in March", es: "Lager ámbar alemana elaborada en marzo", de: "Bernsteinfarbenes deutsches Lager im März gebraut", nl: "Amber Duitse lager gebrouwen in maart" },
          { en: "Dark Belgian ale", es: "Ale oscura belga", de: "Dunkles belgisches Ale", nl: "Donkere Belgische ale" },
          { en: "Light summer wheat beer", es: "Cerveza de trigo ligera de verano", de: "Leichtes Sommer-Weizenbier", nl: "Licht zomer tarwebier" },
          { en: "Strong winter porter", es: "Porter fuerte de invierno", de: "Starker Winter-Porter", nl: "Sterke winter porter" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Higher alcohol content and more intense hop character", es: "Mayor contenido de alcohol y carácter de lúpulo más intenso", de: "Höherer Alkoholgehalt und intensiverer Hopfencharakter", nl: "Hoger alcoholpercentage en intensiever hop karakter" },
          { en: "Darker color only", es: "Solo color más oscuro", de: "Nur dunklere Farbe", nl: "Alleen donkerdere kleur" },
          { en: "Less bitterness", es: "Menos amargor", de: "Weniger Bitterkeit", nl: "Minder bitterheid" },
          { en: "Wheat addition", es: "Adición de trigo", de: "Weizenzusatz", nl: "Tarwe toevoeging" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Smooth American ale, often with adjuncts", es: "Ale americana suave, a menudo con adjuntos", de: "Geschmeidiges amerikanisches Ale, oft mit Zusätzen", nl: "Soepele Amerikaanse ale, vaak met hulpstoffen" },
          { en: "Beer with dairy cream added", es: "Cerveza con crema láctea añadida", de: "Bier mit Milchcreme", nl: "Bier met zuivelroom toegevoegd" },
          { en: "Dark sweet stout", es: "Stout oscuro dulce", de: "Dunkles süßes Stout", nl: "Donkere zoete stout" },
          { en: "Belgian wheat beer", es: "Cerveza de trigo belga", de: "Belgisches Weizenbier", nl: "Belgisch tarwebier" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Dark German wheat beer", es: "Cerveza de trigo alemana oscura", de: "Dunkles deutsches Weizenbier", nl: "Donker Duits tarwebier" },
          { en: "Light Czech lager", es: "Lager checa ligera", de: "Helles tschechisches Lager", nl: "Lichte Tsjechische lager" },
          { en: "Belgian sour ale", es: "Ale ácida belga", de: "Belgisches Sauerbier", nl: "Belgische zure ale" },
          { en: "American pale ale", es: "Pale ale americana", de: "Amerikanisches Pale Ale", nl: "Amerikaanse pale ale" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Tart, low-alcohol German wheat beer", es: "Cerveza de trigo alemana ácida de bajo alcohol", de: "Säuerliches, alkoholarmes deutsches Weizenbier", nl: "Scherp, laag-alcohol Duits tarwebier" },
          { en: "Strong dark lager", es: "Lager oscura fuerte", de: "Starkes dunkles Lager", nl: "Sterke donkere lager" },
          { en: "Hoppy pale ale", es: "Pale ale lupulado", de: "Hopfiges Pale Ale", nl: "Hoppig pale ale" },
          { en: "Sweet Belgian beer", es: "Cerveza belga dulce", de: "Süßes belgisches Bier", nl: "Zoet Belgisch bier" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Lager yeast fermented at ale temperatures", es: "Levadura lager fermentada a temperaturas de ale", de: "Lagerhefe bei Ale-Temperaturen fermentiert", nl: "Lager gist gefermenteerd op ale temperaturen" },
          { en: "Beer brewed with steam power", es: "Cerveza elaborada con vapor", de: "Bier mit Dampfkraft gebraut", nl: "Bier gebrouwen met stoomkracht" },
          { en: "Hot carbonated beer", es: "Cerveza carbonatada caliente", de: "Heißes kohlensäurehaltiges Bier", nl: "Heet koolzuurhoudend bier" },
          { en: "Non-alcoholic lager", es: "Lager sin alcohol", de: "Alkoholfreies Lager", nl: "Alcoholvrije lager" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Sour Belgian oak-aged ale", es: "Ale belga ácida envejecida en roble", de: "Saures belgisches Eichenfass-gereiftes Ale", nl: "Zure Belgische eiken-gerijpte ale" },
          { en: "Hoppy American red ale", es: "Red ale americana lupulada", de: "Hopfiges amerikanisches Red Ale", nl: "Hoppig Amerikaans rood ale" },
          { en: "Sweet German lager", es: "Lager alemana dulce", de: "Süßes deutsches Lager", nl: "Zoete Duitse lager" },
          { en: "Light English bitter", es: "Bitter inglés ligero", de: "Leichtes englisches Bitter", nl: "Lichte Engelse bitter" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Blend of old and young lambics", es: "Mezcla de lambics viejos y jóvenes", de: "Mischung aus alten und jungen Lambics", nl: "Mengsel van oude en jonge lambics" },
          { en: "German wheat beer", es: "Cerveza de trigo alemana", de: "Deutsches Weizenbier", nl: "Duits tarwebier" },
          { en: "Irish dry stout", es: "Stout seco irlandés", de: "Irisches trockenes Stout", nl: "Iers droog stout" },
          { en: "American pale lager", es: "Lager pálida americana", de: "Amerikanisches helles Lager", nl: "Amerikaanse bleke lager" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Pale German lager from Munich", es: "Lager pálida alemana de Múnich", de: "Helles deutsches Lager aus München", nl: "Bleke Duitse lager uit München" },
          { en: "Dark Belgian ale", es: "Ale belga oscura", de: "Dunkles belgisches Ale", nl: "Donkere Belgische ale" },
          { en: "Hoppy American IPA", es: "IPA americana lupulada", de: "Hopfiges amerikanisches IPA", nl: "Hoppig Amerikaans IPA" },
          { en: "Sour wheat beer", es: "Cerveza de trigo ácida", de: "Saures Weizenbier", nl: "Zuur tarwebier" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Hazy, juicy IPA with low bitterness", es: "IPA turbia y jugosa con bajo amargor", de: "Trübes, saftiges IPA mit niedriger Bitterkeit", nl: "Troebel, sappig IPA met lage bitterheid" },
          { en: "Extra bitter clear IPA", es: "IPA clara extra amarga", de: "Extra bitteres klares IPA", nl: "Extra bitter helder IPA" },
          { en: "Dark malty IPA", es: "IPA oscura maltosa", de: "Dunkles malziges IPA", nl: "Donker moutig IPA" },
          { en: "Low-alcohol session IPA", es: "IPA de sesión bajo en alcohol", de: "Alkoholarmes Session-IPA", nl: "Laag-alcohol sessie IPA" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Very strong Belgian dark ale", es: "Ale belga oscura muy fuerte", de: "Sehr starkes belgisches dunkles Ale", nl: "Zeer sterke Belgische donkere ale" },
          { en: "Four-grain lager", es: "Lager de cuatro granos", de: "Vier-Korn-Lager", nl: "Vier-granen lager" },
          { en: "Quadruple-hopped IPA", es: "IPA con cuádruple lúpulo", de: "Vierfach gehopftes IPA", nl: "Viervoudig gehopt IPA" },
          { en: "Four-year aged beer", es: "Cerveza envejecida cuatro años", de: "Vier Jahre gereiftes Bier", nl: "Vier jaar gerijpt bier" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Strong Scottish ale with caramel maltiness", es: "Ale escocesa fuerte con carácter maltoso de caramelo", de: "Starkes schottisches Ale mit Karamellmalzigkeit", nl: "Sterke Schotse ale met karamel moutigheid" },
          { en: "Whisky-flavored beer", es: "Cerveza con sabor a whisky", de: "Whisky-Bier", nl: "Whisky-bier" },
          { en: "Light Scottish lager", es: "Lager escocesa ligera", de: "Leichtes schottisches Lager", nl: "Lichte Schotse lager" },
          { en: "Peated smoke beer", es: "Cerveza ahumada con turba", de: "Getorftes Rauchbier", nl: "Geturfde rook bier" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Stout brewed with lactose for sweetness", es: "Stout elaborada con lactosa para dulzura", de: "Stout mit Laktose für Süße gebraut", nl: "Stout gebrouwen met lactose voor zoetheid" },
          { en: "Stout with dairy milk added", es: "Stout con leche láctea añadida", de: "Stout mit Milch versetzt", nl: "Stout met zuivelmelk toegevoegd" },
          { en: "White-colored stout", es: "Stout de color blanco", de: "Weißes Stout", nl: "Wit gekleurde stout" },
          { en: "Low-alcohol sweet beer", es: "Cerveza dulce baja en alcohol", de: "Süßes alkoholarmes Bier", nl: "Zoet laag-alcohol bier" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Concentrated bock made by freeze distillation", es: "Bock concentrado hecho por destilación por congelación", de: "Konzentriertes Bock durch Gefrieren destilliert", nl: "Geconcentreerde bock gemaakt door vriesdestillatie" },
          { en: "Ice-cold served bock", es: "Bock servido helado", de: "Eiskalt serviertes Bock", nl: "IJskoud geserveerde bock" },
          { en: "Bock brewed in winter", es: "Bock elaborado en invierno", de: "Im Winter gebrautes Bock", nl: "Bock gebrouwen in de winter" },
          { en: "Light summer bock", es: "Bock ligero de verano", de: "Leichtes Sommer-Bock", nl: "Lichte zomer bock" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Strong lager-fermented dark beer from Baltic region", es: "Cerveza oscura fuerte fermentada con lager de la región báltica", de: "Starkes lager-fermentiertes dunkles Bier aus der Ostseeregion", nl: "Sterk lager-gefermenteerd donker bier uit de Baltische regio" },
          { en: "Light summer ale", es: "Ale ligera de verano", de: "Leichtes Sommer-Ale", nl: "Lichte zomer ale" },
          { en: "Sour wheat beer", es: "Cerveza de trigo ácida", de: "Saures Weizenbier", nl: "Zuur tarwebier" },
          { en: "Hoppy pale lager", es: "Lager pálida lupulada", de: "Hopfiges helles Lager", nl: "Hoppig bleek lager" }
        ],
        correct: 0,
        explanation: {
