  ...
  const level8 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "A vicinal diketone producing buttery/butterscotch off-flavor from incomplete fermentation, removed via diacetyl rest at 18-20°C", es: "Una dicetona vicinal que produce sabor indeseable a mantequilla/caramelo de fermentación incompleta, eliminada mediante reposo de diacetilo a 18-20°C", de: "Ein vicinales Diketon, das butterartigen/Butterscotch-Fehlgeschmack durch unvollständige Gärung erzeugt, entfernt durch Diacetyl-Rast bei 18-20°C", nl: "Een vicinaal diketon dat boter/butterscotch off-smaak produceert door onvolledige fermentatie, verwijderd via diacetyl rust bij 18-20°C" },
          { en: "A beneficial compound that enhances beer aroma", es: "Un compuesto beneficioso que mejora el aroma de la cerveza", de: "Eine vorteilhafte Verbindung, die das Bieraroma verbessert", nl: "Een gunstige verbinding die het bieraroma verbetert" },
          { en: "A preservative added to extend shelf life", es: "Un conservante agregado para extender la vida útil", de: "Ein Konservierungsmittel zur Verlängerung der Haltbarkeit", nl: "Een conserveringsmiddel toegevoegd om de houdbaarheid te verlengen" },
          { en: "A type of malt extract", es: "Un tipo de extracto de malta", de: "Eine Art Malzextrakt", nl: "Een soort moutextract" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Non-enzymatic browning reaction between amino acids and reducing sugars during kilning, creating color, flavor, and aroma compounds (melanoidins)", es: "Reacción de dorado no enzimático entre aminoácidos y azúcares reductores durante el tostado, creando compuestos de color, sabor y aroma (melanoidinas)", de: "Nicht-enzymatische Bräunungsreaktion zwischen Aminosäuren und reduzierenden Zuckern beim Darren, die Farb-, Geschmacks- und Aromaverbindungen (Melanoidine) erzeugt", nl: "Niet-enzymatische bruiningsreactie tussen aminozuren en reducerende suikers tijdens het eesten, die kleur-, smaak- en aromaverbindingen (melanoidinen) creëert" },
          { en: "A type of yeast fermentation process", es: "Un tipo de proceso de fermentación de levadura", de: "Eine Art Hefegärungsprozess", nl: "Een soort gistfermentatieproces" },
          { en: "The reaction between hops and water", es: "La reacción entre el lúpulo y el agua", de: "Die Reaktion zwischen Hopfen und Wasser", nl: "De reactie tussen hop en water" },
          { en: "A cleaning process for brewing equipment", es: "Un proceso de limpieza para equipos de elaboración", de: "Ein Reinigungsprozess für Brauausrüstung", nl: "Een schoonmaakproces voor brouwapparatuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Enzyme activity from dry hops (diastatic enzymes) continuing fermentation, increasing ABV, reducing residual sugars, potentially causing over-carbonation", es: "Actividad enzimática del dry hopping (enzimas diastásicas) continuando fermentación, aumentando ABV, reduciendo azúcares residuales, causando potencialmente sobre-carbonatación", de: "Enzymaktivität aus Trockenhopfen (diastatische Enzyme), die die Gärung fortsetzt, ABV erhöht, Restzucker reduziert, möglicherweise Überkohlensäure verursacht", nl: "Enzymactiviteit van dry hops (diastatische enzymen) die fermentatie voortzet, ABV verhoogt, restsuikers vermindert, mogelijk over-carbonatie veroorzaakt" },
          { en: "The process of adding hops to the boil", es: "El proceso de agregar lúpulo a la ebullición", de: "Der Prozess des Hopfenzusatzes zum Kochen", nl: "Het proces van hop toevoegen aan de kook" },
          { en: "A disease that affects hop plants", es: "Una enfermedad que afecta las plantas de lúpulo", de: "Eine Krankheit, die Hopfenpflanzen befällt", nl: "Een ziekte die hopplanten aantast" },
          { en: "The aging of hops during storage", es: "El envejecimiento del lúpulo durante el almacenamiento", de: "Die Alterung von Hopfen während der Lagerung", nl: "De veroudering van hop tijdens opslag" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Dissolving oxygen (8-10 ppm) into cooled wort before pitching yeast, essential for yeast cell membrane synthesis (sterols, unsaturated fatty acids) and reproduction", es: "Disolver oxígeno (8-10 ppm) en mosto enfriado antes de inocular levadura, esencial para síntesis de membrana celular de levadura (esteroles, ácidos grasos insaturados) y reproducción", de: "Sauerstoff (8-10 ppm) in gekühlte Würze vor Hefezugabe auflösen, essentiel für Hefezellmembransynthese (Sterole, ungesättigte Fettsäuren) und Reproduktion", nl: "Zuurstof (8-10 ppm) oplossen in gekoelde wort voor het toevoegen van gist, essentieel voor gistcelmembraansynthese (sterolen, onverzadigde vetzuren) en reproductie" },
          { en: "Adding air to increase beer carbonation", es: "Agregar aire para aumentar la carbonatación de la cerveza", de: "Luft hinzufügen, um die Bierkohlensäure zu erhöhen", nl: "Lucht toevoegen om bierkoolzuur te verhogen" },
          { en: "A method to cool wort faster", es: "Un método para enfriar el mosto más rápido", de: "Eine Methode, um Würze schneller zu kühlen", nl: "Een methode om wort sneller af te koelen" },
          { en: "Removing oxygen to prevent oxidation", es: "Eliminar oxígeno para prevenir oxidación", de: "Sauerstoff entfernen, um Oxidation zu verhindern", nl: "Zuurstof verwijderen om oxidatie te voorkomen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Breaking down proteins into amino acids and peptides (FAN - free amino nitrogen) for yeast nutrition and head retention", es: "Descomponer proteínas en aminoácidos y péptidos (FAN - nitrógeno amino libre) para nutrición de levadura y retención de espuma", de: "Proteine in Aminosäuren und Peptide (FAN - freier Aminostickstoff) für Hefeernährung und Schaumhaltbarkeit abbauen", nl: "Eiwitten afbreken tot aminozuren en peptiden (FAN - vrije amino-stikstof) voor gistvoeding en schuimretentie" },
          { en: "Converting starches to sugars", es: "Convertir almidones en azúcares", de: "Stärke in Zucker umwandeln", nl: "Zetmeel omzetten in suikers" },
          { en: "Reducing beer clarity", es: "Reducir la claridad de la cerveza", de: "Bierklarheit reduzieren", nl: "Bierhelderheid verminderen" },
          { en: "Increasing beer color", es: "Aumentar el color de la cerveza", de: "Bierfarbe erhöhen", nl: "Bierkleur verhogen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Volatile sulfur compound (cooked corn/cabbage aroma) from S-methylmethionine (SMM) in malt, driven off during vigorous open boil and rapid wort cooling", es: "Compuesto de azufre volátil (aroma a maíz/repollo cocido) de S-metilmetionina (SMM) en malta, eliminado durante ebullición vigorosa abierta y enfriamiento rápido del mosto", de: "Flüchtige Schwefelverbindung (gekochter Mais/Kohl-Aroma) aus S-Methylmethionin (SMM) in Malz, ausgetrieben während kräftigem offenen Kochen und schneller Würzekühlung", nl: "Vluchtige zwavelverbinding (gekookte mais/kool aroma) van S-methylmethionine (SMM) in mout, weggedreven tijdens krachtig open koken en snelle wortkoeling" },
          { en: "A beneficial flavor compound from hops", es: "Un compuesto de sabor beneficioso del lúpulo", de: "Eine vorteilhafte Geschmacksverbindung aus Hopfen", nl: "Een gunstige smaakverbinding van hop" },
          { en: "A preservative added to prevent spoilage", es: "Un conservante agregado para prevenir deterioro", de: "Ein Konservierungsmittel zur Verderbnisverhütung", nl: "Een conserveringsmiddel toegevoegd om bederf te voorkomen" },
          { en: "A type of yeast nutrient", es: "Un tipo de nutriente de levadura", de: "Eine Art Hefenährstoff", nl: "Een soort gistvoedingsstof" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Brewing concentrated wort at higher OG then diluting with deaerated water before packaging, increasing brewhouse efficiency and throughput", es: "Elaborar mosto concentrado a mayor OG luego diluir con agua desaireada antes de envasar, aumentando eficiencia de sala de cocción y rendimiento", de: "Konzentrierte Würze mit höherem OG brauen, dann mit entlüftetem Wasser vor Abfüllung verdünnen, erhöht Sudhaus-Effizienz und Durchsatz", nl: "Geconcentreerde wort brouwen bij hogere OG dan verdunnen met ontlucht water voor verpakking, verhoogt brouwerij efficiëntie en doorvoer" },
          { en: "Brewing beer in high-altitude locations", es: "Elaborar cerveza en ubicaciones de gran altitud", de: "Bier an hochgelegenen Standorten brauen", nl: "Bier brouwen op grote hoogte" },
          { en: "Using heavy malt to increase beer weight", es: "Usar malta pesada para aumentar el peso de la cerveza", de: "Schweres Malz verwenden, um Biergewicht zu erhöhen", nl: "Zware mout gebruiken om biergewicht te verhogen" },
          { en: "Fermenting at higher temperatures", es: "Fermentar a temperaturas más altas", de: "Bei höheren Temperaturen gären", nl: "Fermenteren bij hogere temperaturen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Standardized beer color measurement: SRM (USA), EBC (Europe), Lovibond (historical); EBC ≈ 1.97 × SRM; measured by spectrophotometry at 430nm wavelength", es: "Medición estandarizada de color de cerveza: SRM (EUA), EBC (Europa), Lovibond (histórico); EBC ≈ 1.97 × SRM; medido por espectrofotometría a longitud de onda de 430nm", de: "Standardisierte Bierfarbmessung: SRM (USA), EBC (Europa), Lovibond (historisch); EBC ≈ 1,97 × SRM; gemessen durch Spektrophotometrie bei 430nm Wellenlänge", nl: "Gestandaardiseerde bierkleurmeting: SRM (VS), EBC (Europa), Lovibond (historisch); EBC ≈ 1,97 × SRM; gemeten door spectrofotometrie bij 430nm golflengte" },
          { en: "Systems for measuring hop bitterness", es: "Sistemas para medir el amargor del lúpulo", de: "Systeme zur Messung von Hopfenbitterkeit", nl: "Systemen voor het meten van hopbitterheid" },
          { en: "Methods to calculate alcohol content", es: "Métodos para calcular el contenido de alcohol", de: "Methoden zur Berechnung des Alkoholgehalts", nl: "Methoden om alcoholgehalte te berekenen" },
          { en: "Scales for yeast viability testing", es: "Escalas para prueba de viabilidad de levadura", de: "Skalen für Hefelebensfähigkeitsprüfung", nl: "Schalen voor gistlevensvatbaarheidstesting" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Protein/hop debris sediment from boil and cooling; hot trub removed post-boil, cold trub separated after chilling to reduce off-flavors and improve clarity", es: "Sedimento de desechos de proteína/lúpulo del hervido y enfriamiento; trub caliente eliminado post-hervido, trub frío separado después de enfriar para reducir sabores indeseables y mejorar claridad", de: "Protein-/Hopfentrümmer-Sediment aus Kochen und Kühlung; Heißtrub nach Kochen entfernt, Kalttrub nach Kühlung getrennt, um Fehlgeschmäcker zu reduzieren und Klarheit zu verbessern", nl: "Eiwit/hop debris sediment van koken en koeling; hete trub verwijderd na koken, koude trub gescheiden na koeling om off-smaken te verminderen en helderheid te verbeteren" },
          { en: "A type of specialty malt", es: "Un tipo de malta especial", de: "Eine Art Spezialmalz", nl: "Een soort speciaalmout" },
          { en: "A beneficial yeast byproduct that improves flavor", es: "Un subproducto de levadura beneficioso que mejora el sabor", de: "Ein vorteilhaftes Hefe-Nebenprodukt, das Geschmack verbessert", nl: "Een gunstig gist bijproduct dat smaak verbetert" },
          { en: "The foam layer on fermenting beer", es: "La capa de espuma en la cerveza en fermentación", de: "Die Schaumschicht auf gärendem Bier", nl: "De schuimlaag op fermenterende bier" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Traditional method removing portion of thick mash, boiling it, returning to main mash to raise temperature; enhances melanoidin/malt flavor, used for German lagers and under-modified malts", es: "Método tradicional que remueve porción de macerado espeso, lo hierve, lo devuelve al macerado principal para elevar temperatura; mejora sabor de melanoidina/malta, usado para lagers alemanas y maltas poco modificadas", de: "Traditionelle Methode, bei der ein Teil der dicken Maische entfernt, gekocht und zur Hauptmaische zurückgeführt wird, um Temperatur zu erhöhen; verbessert Melanoidin-/Malzgeschmack, verwendet für deutsche Lager und untermodifizierte Malze", nl: "Traditionele methode die gedeelte van dikke maisch verwijdert, kookt, terugvoert naar hoofdmaisch om temperatuur te verhogen; verbetert melanoidine/moutsmaak, gebruikt voor Duitse lagers en ondergemodificeerde mouten" },
          { en: "Adding hot water to the mash to increase temperature", es: "Agregar agua caliente al macerado para aumentar la temperatura", de: "Heißes Wasser zur Maische hinzufügen, um Temperatur zu erhöhen", nl: "Heet water toevoegen aan maisch om temperatuur te verhogen" },
          { en: "A cooling method for wort", es: "Un método de enfriamiento para el mosto", de: "Eine Kühlmethode für Würze", nl: "Een koelmethode voor wort" },
          { en: "Removing proteins from the mash", es: "Eliminar proteínas del macerado", de: "Proteine aus der Maische entfernen", nl: "Eiwitten uit de maisch verwijderen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Chemical conversion of alpha acids into iso-alpha acids during boiling, making them soluble and bitter; determines IBU levels and requires heat + time (60+ min for max utilization)", es: "Conversión química de ácidos alfa en iso-ácidos alfa durante la ebullición, haciéndolos solubles y amargos; determina niveles de IBU y requiere calor + tiempo (60+ min para utilización máxima)", de: "Chemische Umwandlung von Alpha-Säuren in Iso-Alpha-Säuren während des Kochens, macht sie löslich und bitter; bestimmt IBU-Werte und erfordert Hitze + Zeit (60+ Min für maximale Ausnutzung)", nl: "Chemische conversie van alfa-zuren naar iso-alfa-zuren tijdens koken, maakt ze oplosbaar en bitter; bepaalt IBU-niveaus en vereist hitte + tijd (60+ min voor maximale benutting)" },
          { en: "The process of drying hops after harvest", es: "El proceso de secar lúpulo después de la cosecha", de: "Der Prozess des Trocknens von Hopfen nach der Ernte", nl: "Het proces van hop drogen na de oogst" },
          { en: "Mixing different hop varieties together", es: "Mezclar diferentes variedades de lúpulo", de: "Verschiedene Hopfensorten mischen", nl: "Verschillende hopvariëteiten mengen" },
          { en: "Adding hops at the end of fermentation", es: "Agregar lúpulo al final de la fermentación", de: "Hopfen am Ende der Gärung hinzufügen", nl: "Hop toevoegen aan het einde van fermentatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Recirculating first wort runnings back through grain bed to establish filter bed and clarify wort before sparging", es: "Recircular primeros escurridos de mosto a través del lecho de grano para establecer lecho filtrante y clarificar mosto antes del lavado", de: "Erste Würzeabläufe durch Getreidebett zurückführen, um Filterbett zu etablieren und Würze vor dem Anschwänzen zu klären", nl: "Eerste wort afloop recirculeren door graan bed om filterbed te vestigen en wort te helderen voor sparging" },
          { en: "The initial mashing temperature", es: "La temperatura inicial de macerado", de: "Die anfängliche Maischtemperatur", nl: "De initiële maischtemperatuur" },
          { en: "Adding yeast to the fermenter", es: "Agregar levadura al fermentador", de: "Hefe zum Gärbehälter hinzufügen", nl: "Gist toevoegen aan de fermenter" },
          { en: "Boiling the wort vigorously", es: "Hervir el mosto vigorosamente", de: "Die Würze kräftig kochen", nl: "De wort krachtig koken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Inert gas used for purging/blanketing to prevent oxidation and create smooth creamy foam (nitrogenated beers like stouts)", es: "Gas inerte usado para purgar/cubrir para prevenir oxidación y crear espuma cremosa suave (cervezas nitrogenadas como stouts)", de: "Inertgas zur Spülung/Überdeckung verwendet, um Oxidation zu verhindern und glatten cremigen Schaum zu erzeugen (stickstoffhaltige Biere wie Stouts)", nl: "Inert gas gebruikt voor spoelen/bedekken om oxidatie te voorkomen en gladde romige schuim te creëren (stikstof bieren zoals stouts)" },
          { en: "It adds bitterness to beer", es: "Añade amargor a la cerveza", de: "Es fügt dem Bier Bitterkeit hinzu", nl: "Het voegt bitterheid toe aan bier" },
          { en: "It increases alcohol content", es: "Aumenta el contenido de alcohol", de: "Es erhöht den Alkoholgehalt", nl: "Het verhoogt het alcoholgehalte" },
          { en: "It helps in fermentation", es: "Ayuda en la fermentación", de: "Es hilft bei der Gärung", nl: "Het helpt bij fermentatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Density measurement after fermentation indicating residual sugars, mouthfeel, and actual attenuation; determines ABV when compared with OG", es: "Medición de densidad después de fermentación indicando azúcares residuales, sensación en boca y atenuación real; determina ABV cuando se compara con OG", de: "Dichtemessung nach Gärung, die Restzucker, Mundgefühl und tatsächliche Vergärung anzeigt; bestimmt ABV im Vergleich mit OG", nl: "Dichtheidsmeting na fermentatie die restsuikers, mondgevoel en werkelijke attenuatie aangeeft; bepaalt ABV vergeleken met OG" },
          { en: "The weight of the finished beer package", es: "El peso del paquete de cerveza terminado", de: "Das Gewicht der fertigen Bierverpackung", nl: "Het gewicht van de afgewerkte bierverpakking" },
          { en: "The temperature at which fermentation stops", es: "La temperatura a la que se detiene la fermentación", de: "Die Temperatur, bei der die Gärung stoppt", nl: "De temperatuur waarbij fermentatie stopt" },
          { en: "The amount of hops used", es: "La cantidad de lúpulo usado", de: "Die Menge an verwendetem Hopfen", nl: "De hoeveelheid gebruikte hop" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Plant compounds from malt/hops providing antioxidant properties, astringency, and contributing to haze/stability; excess causes haze and harsh tannin flavors", es: "Compuestos vegetales de malta/lúpulo que proporcionan propiedades antioxidantes, astringencia y contribuyen a turbidez/estabilidad; exceso causa turbidez y sabores ásperos a tanino", de: "Pflanzenverbindungen aus Malz/Hopfen, die antioxidative Eigenschaften, Adstringenz bieten und zu Trübung/Stabilität beitragen; Überschuss verursacht Trübung und harsche Tanninaromen", nl: "Plantverbindingen van mout/hop die antioxidante eigenschappen, adstringentie bieden en bijdragen aan waas/stabiliteit; overschot veroorzaakt waas en harde tannine smaken" },
          { en: "A type of sugar added for fermentation", es: "Un tipo de azúcar agregado para fermentación", de: "Eine Art Zucker für Gärung hinzugefügt", nl: "Een soort suiker toegevoegd voor fermentatie" },
          { en: "Yeast nutrients for faster fermentation", es: "Nutrientes de levadura para fermentación más rápida", de: "Hefenährstoffe für schnellere Gärung", nl: "Gistvoedingsstoffen voor snellere fermentatie" },
          { en: "Enzymes that break down proteins", es: "Enzimas que descomponen proteínas", de: "Enzyme, die Proteine abbauen", nl: "Enzymen die eiwitten afbreken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Carrageenan-based additives added late in boil to coagulate proteins and improve hot break formation, enhancing wort clarity and reducing chill haze", es: "Aditivos a base de carragenina agregados tarde en la ebullición para coagular proteínas y mejorar formación de ruptura caliente, mejorando claridad del mosto y reduciendo turbidez por frío", de: "Carrageenan-basierte Zusätze spät im Kochen hinzugefügt, um Proteine zu koagulieren und Heißbruchbildung zu verbessern, Würzeklarheit zu erhöhen und Kältetrübung zu reduzieren", nl: "Carrageen-gebaseerde additieven laat in kook toegevoegd om eiwitten te coaguleren en hete breuk vorming te verbeteren, worthelderheid te verhogen en koudewaas te verminderen" },
          { en: "Hop additions for aroma", es: "Adiciones de lúpulo para aroma", de: "Hopfenzusätze für Aroma", nl: "Hop toevoegingen voor aroma" },
          { en: "Yeast nutrients for fermentation", es: "Nutrientes de levadura para fermentación", de: "Hefenährstoffe für Gärung", nl: "Gistvoedingsstoffen voor fermentatie" },
          { en: "Enzymes to break down starches", es: "Enzimas para descomponer almidones", de: "Enzyme zum Abbau von Stärke", nl: "Enzymen om zetmeel af te breken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Multi-temperature mashing process with rests at different temps (e.g., 45-55°C protein rest, 62-65°C β-amylase, 68-72°C α-amylase) optimizing enzyme activity for fermentability and body", es: "Proceso de macerado multi-temperatura con reposos a diferentes temps (ej., 45-55°C reposo de proteína, 62-65°C β-amilasa, 68-72°C α-amilasa) optimizando actividad enzimática para fermentabilidad y cuerpo", de: "Multi-Temperatur-Maischprozess mit Rasten bei verschiedenen Temps (z.B. 45-55°C Proteinrast, 62-65°C β-Amylase, 68-72°C α-Amylase), optimiert Enzymaktivität für Vergärbarkeit und Körper", nl: "Multi-temperatuur maischproces met rusten bij verschillende temps (bijv. 45-55°C eiwit rust, 62-65°C β-amylase, 68-72°C α-amylase) optimaliseren enzymactiviteit voor fermenteerbaarheid en body" },
          { en: "Adding malt in multiple stages during mashing", es: "Agregar malta en múltiples etapas durante el macerado", de: "Malz in mehreren Stufen während des Maischens hinzufügen", nl: "Mout in meerdere stadia toevoegen tijdens maischen" },
          { en: "Cooling wort in steps", es: "Enfriar mosto en pasos", de: "Würze in Schritten kühlen", nl: "Wort in stappen afkoelen" },
          { en: "Gradually adding hops during the boil", es: "Agregar gradualmente lúpulo durante la ebullición", de: "Hopfen schrittweise während des Kochens hinzufügen", nl: "Geleidelijk hop toevoegen tijdens het koken" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Pre-fermentation culture to propagate yeast cells, increase cell count, and ensure healthy vigorous fermentation with proper pitch rate", es: "Cultivo pre-fermentación para propagar células de levadura, aumentar recuento celular y asegurar fermentación vigorosa saludable con tasa de inoculación adecuada", de: "Vor-Gärungskultur zur Vermehrung von Hefezellen, Erhöhung der Zellzahl und Sicherstellung gesunder kräftiger Gärung mit richtiger Anstellrate", nl: "Pre-fermentatie cultuur om gistcellen te propageren, celtellingen te verhogen en gezonde krachtige fermentatie te verzekeren met juiste toevoegingspercentage" },
          { en: "Adding sugar to increase alcohol", es: "Agregar azúcar para aumentar alcohol", de: "Zucker hinzufügen, um Alkohol zu erhöhen", nl: "Suiker toevoegen om alcohol te verhogen" },
          { en: "A device to measure yeast viability", es: "Un dispositivo para medir viabilidad de levadura", de: "Ein Gerät zur Messung der Hefelebensfähigkeit", nl: "Een apparaat om gistlevensvatbaarheid te meten" },
          { en: "A container for storing yeast long-term", es: "Un contenedor para almacenar levadura a largo plazo", de: "Ein Behälter zur langfristigen Hefespeicherung", nl: "Een container voor langdurige gistopslag" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "UV/visible light photodegrades hop iso-alpha acids into 3-methyl-2-butene-1-thiol (MBT), creating skunk-like sulfur aroma; prevented by brown bottles, cans, or reduced hop compounds", es: "Luz UV/visible fotodegrada iso-ácidos alfa del lúpulo en 3-metil-2-buteno-1-tiol (MBT), creando aroma azufrado similar a skunk; prevenido por botellas marrones, latas o compuestos de lúpulo reducidos", de: "UV/sichtbares Licht photodegradiert Hopfen-Iso-Alpha-Säuren zu 3-Methyl-2-buten-1-thiol (MBT), erzeugt stinktierähnliches Schwefelaroma; verhindert durch braune Flaschen, Dosen oder reduzierte Hopfenverbindungen", nl: "UV/zichtbaar licht fotodegradeert hop iso-alfa-zuren tot 3-methyl-2-buteen-1-thiol (MBT), creëert skunk-achtig zwavelaroma; voorkomen door bruine flessen, blikken of gereduceerde hopverbindingen" },
          { en: "Oxidation from exposure to air", es: "Oxidación por exposición al aire", de: "Oxidation durch Luftexposition", nl: "Oxidatie door blootstelling aan lucht" },
          { en: "Bacterial contamination during fermentation", es: "Contaminación bacteriana durante fermentación", de: "Bakterielle Kontamination während Gärung", nl: "Bacteriële contaminatie tijdens fermentatie" },
          { en: "Yeast autolysis producing sulfur compounds", es: "Autólisis de levadura produciendo compuestos de azufre", de: "Hefeautolyse produziert Schwefelverbindungen", nl: "Gist autolysis producerende zwavelverbindingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Real attenuation accounts for alcohol density (true sugar consumed); apparent attenuation measures hydrometer reading (appears higher due to lighter alcohol); conversion: RA ≈ 0.814 × AA", es: "Atenuación real considera densidad del alcohol (azúcar verdadero consumido); atenuación aparente mide lectura del hidrómetro (aparece más alta debido a alcohol más ligero); conversión: AR ≈ 0.814 × AA", de: "Reale Vergärung berücksichtigt Alkoholdichte (wahrer verbrauchter Zucker); scheinbare Vergärung misst Hydrometer-Lesung (erscheint höher aufgrund leichterem Alkohol); Umrechnung: RV ≈ 0,814 × SV", nl: "Echte attenuatie houdt rekening met alcoholdichtheid (ware verbruikte suiker); schijnbare attenuatie meet hydrometer-lezing (lijkt hoger door lichter alcohol); conversie: EA ≈ 0,814 × SA" },
          { en: "They are the same measurement", es: "Son la misma medición", de: "Sie sind dieselbe Messung", nl: "Ze zijn dezelfde meting" },
          { en: "Real attenuation measures color, apparent measures clarity", es: "Atenuación real mide color, aparente mide claridad", de: "Reale Vergärung misst Farbe, scheinbare misst Klarheit", nl: "Echte attenuatie meet kleur, schijnbare meet helderheid" },
          { en: "Apparent attenuation is always lower than real attenuation", es: "Atenuación aparente siempre es más baja que atenuación real", de: "Scheinbare Vergärung ist immer niedriger als reale Vergärung", nl: "Schijnbare attenuatie is altijd lager dan echte attenuatie" }
        ],
        correct: 0,
        explanation: {
