    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Nectar contains more vitamins",
                  "es": "El néctar contiene más vitaminas",
                  "de": "Nektar enthält mehr Vitamine",
                  "nl": "Nectar bevat meer vitamines"
        },
        {
                  "en": "Nectar is always artificially flavored",
                  "es": "El néctar siempre tiene sabor artificial",
                  "de": "Nektar ist immer künstlich aromatisiert",
                  "nl": "Nectar is altijd kunstmatig gearomatiseerd"
        },
        {
                  "en": "Nectar contains less fruit and more water than juice",
                  "es": "El néctar contiene menos fruta y más agua que el jugo",
                  "de": "Nektar enthält weniger Frucht und mehr Wasser als Saft",
                  "nl": "Nectar bevat minder fruit en meer water dan sap"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Home Preparation Process",
                  "es": "Proceso de Preparación Casera",
                  "de": "Hausgemachtes Zubereitungsverfahren",
                  "nl": "Thuis Bereidingsproces"
        },
        {
                  "en": "Heat Pasteurization Process",
                  "es": "Proceso de Pasteurización por Calor",
                  "de": "Wärmepasteurisierungsverfahren",
                  "nl": "Warmte Pasteurisatie Proces"
        },
        {
                  "en": "Healthy Product Processing",
                  "es": "Procesamiento de Productos Saludables",
                  "de": "Gesunde Produktverarbeitung",
                  "nl": "Gezonde Product Verwerking"
        },
        {
                  "en": "High Pressure Processing",
                  "es": "Procesamiento de Alta Presión",
                  "de": "Hochdruckverarbeitung",
                  "nl": "Hoge Druk Verwerking"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Juices that work better than others",
                  "es": "Jugos que funcionan mejor que otros",
                  "de": "Säfte, die besser funktionieren als andere",
                  "nl": "Sappen die beter werken dan andere"
        },
        {
                  "en": "Juices for athletic performance only",
                  "es": "Jugos solo para rendimiento atlético",
                  "de": "Säfte nur für sportliche Leistung",
                  "nl": "Sappen alleen voor atletische prestaties"
        },
        {
                  "en": "Artificial juice substitutes",
                  "es": "Sustitutos artificiales de jugos",
                  "de": "Künstliche Saftersatzstoffe",
                  "nl": "Kunstmatige sapvervangers"
        },
        {
                  "en": "Juices with added health benefits beyond basic nutrition",
                  "es": "Jugos con beneficios adicionales para la salud más allá de la nutrición básica",
                  "de": "Säfte mit zusätzlichen gesundheitlichen Vorteilen über die Grundernährung hinaus",
                  "nl": "Sappen met toegevoegde gezondheidsvoordelen voorbij basisvoeding"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only Red Delicious apples",
                  "es": "Solo manzanas Red Delicious",
                  "de": "Nur Red Delicious Äpfel",
                  "nl": "Alleen Red Delicious appels"
        },
        {
                  "en": "Only Granny Smith apples",
                  "es": "Solo manzanas Granny Smith",
                  "de": "Nur Granny Smith Äpfel",
                  "nl": "Alleen Granny Smith appels"
        },
        {
                  "en": "Only Golden Delicious apples",
                  "es": "Solo manzanas Golden Delicious",
                  "de": "Nur Golden Delicious Äpfel",
                  "nl": "Alleen Golden Delicious appels"
        },
        {
                  "en": "A blend of different apple varieties",
                  "es": "Una mezcla de diferentes variedades de manzana",
                  "de": "Eine Mischung verschiedener Apfelsorten",
                  "nl": "Een mix van verschillende appelvariëteiten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Juice that has not been concentrated",
                  "es": "Jugo que no ha sido concentrado",
                  "de": "Saft, der nicht konzentriert wurde",
                  "nl": "Sap dat niet geconcentreerd is"
        },
        {
                  "en": "Juice with extra vitamins added",
                  "es": "Jugo con vitaminas extra añadidas",
                  "de": "Saft mit zugesetzten extra Vitaminen",
                  "nl": "Sap met extra vitamines toegevoegd"
        },
        {
                  "en": "Juice from one type of fruit only",
                  "es": "Jugo de solo un tipo de fruta",
                  "de": "Saft aus nur einer Fruchtart",
                  "nl": "Sap van slechts één fruittype"
        },
        {
                  "en": "The strongest flavored juice",
                  "es": "El jugo de sabor más fuerte",
                  "de": "Der geschmacksintensivste Saft",
                  "nl": "Het sterkst gearomatiseerde sap"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To make juice taste better",
                  "es": "Para hacer que el jugo sepa mejor",
                  "de": "Um den Saft besser schmecken zu lassen",
                  "nl": "Om sap beter te laten smaken"
        },
        {
                  "en": "To preserve juice longer",
                  "es": "Para preservar el jugo más tiempo",
                  "de": "Um Saft länger zu konservieren",
                  "nl": "Om sap langer te bewaren"
        },
        {
                  "en": "To provide bone health benefits",
                  "es": "Para proporcionar beneficios para la salud ósea",
                  "de": "Um Knochengesundheitsvorteile zu bieten",
                  "nl": "Om voordelen voor botgezondheid te bieden"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Apple juice that retains natural pulp and fiber",
                  "es": "Jugo de manzana que retiene pulpa y fibra naturales",
                  "de": "Apfelsaft, der natürliches Fruchtfleisch und Ballaststoffe behält",
                  "nl": "Appelsap dat natuurlijke pulp en vezels behoudt"
        },
        {
                  "en": "Apple juice stored incorrectly",
                  "es": "Jugo de manzana almacenado incorrectamente",
                  "de": "Apfelsaft, der falsch gelagert wurde",
                  "nl": "Appelsap verkeerd opgeslagen"
        },
        {
                  "en": "Apple juice that has gone bad",
                  "es": "Jugo de manzana que se ha echado a perder",
                  "de": "Apfelsaft, der schlecht geworden ist",
                  "nl": "Appelsap dat bedorven is"
        },
        {
                  "en": "Apple juice with artificial cloudiness",
                  "es": "Jugo de manzana con turbidez artificial",
                  "de": "Apfelsaft mit künstlicher Trübung",
                  "nl": "Appelsap met kunstmatige troebeling"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Summer vacation patterns",
                  "es": "Patrones de vacaciones de verano",
                  "de": "Sommerurlaubsmuster",
                  "nl": "Zomervakantie patronen"
        },
        {
                  "en": "Holiday shopping seasons",
                  "es": "Temporadas de compras navideñas",
                  "de": "Feiertagseinkaufszeiten",
                  "nl": "Feestdagen winkelseizoenen"
        },
        {
                  "en": "School calendar schedules",
                  "es": "Horarios del calendario escolar",
                  "de": "Schulkalender-Zeitpläne",
                  "nl": "Schoolkalender schema's"
        },
        {
                  "en": "Fruit harvest seasons and crop yields",
                  "es": "Temporadas de cosecha de frutas y rendimientos de cultivos",
                  "de": "Fruchterntezeiten und Ernteerträge",
                  "nl": "Fruitoogst seizoenen en gewasopbrengsten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Unfiltered juice lasts longer",
                  "es": "El jugo no filtrado dura más",
                  "de": "Ungefilterter Saft hält länger",
                  "nl": "Ongefilterd sap blijft langer goed"
        },
        {
                  "en": "Filtered juice has more vitamins",
                  "es": "El jugo filtrado tiene más vitaminas",
                  "de": "Gefilterter Saft hat mehr Vitamine",
                  "nl": "Gefilterd sap heeft meer vitamines"
        },
        {
        ...
        {
                  "en": "Filtered juice is clear, unfiltered contains particles and pulp",
                  "es": "El jugo filtrado es claro, el no filtrado contiene partículas y pulpa",
                  "de": "Gefilterter Saft ist klar, ungefilterter enthält Partikel und Fruchtfleisch",
                  "nl": "Gefilterd sap is helder, ongefilterd bevat deeltjes en pulp"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Refrigerating juice immediately after extraction",
                  "es": "Refrigerar jugo inmediatamente después de la extracción",
                  "de": "Saft unmittelbar nach der Extraktion kühlen",
                  "nl": "Sap onmiddellijk na extractie koelen"
        },
        {
                  "en": "Using only organic ingredients",
                  "es": "Usar solo ingredientes orgánicos",
                  "de": "Nur biologische Zutaten verwenden",
                  "nl": "Alleen biologische ingrediënten gebruiken"
        },
        {
                  "en": "Sterilizing juice and packaging separately, then filling in sterile environment",
                  "es": "Esterilizar jugo y empaque por separado, luego llenar en ambiente estéril",
                  "de": "Saft und Verpackung separat sterilisieren, dann in steriler Umgebung abfüllen",
                  "nl": "Sap en verpakking apart steriliseren, dan vullen in steriele omgeving"
        },
        {
                  "en": "Adding preservatives to prevent spoilage",
                  "es": "Añadir conservantes para prevenir el deterioro",
                  "de": "Konservierungsstoffe hinzufügen, um Verderb zu verhindern",
                  "nl": "Conserveermiddelen toevoegen om bederf te voorkomen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Too much water evaporation",
                  "es": "Demasiada evaporación de agua",
                  "de": "Zu viel Wasserdampfung",
                  "nl": "Te veel waterverdamping"
        },
        {
                  "en": "Bacterial contamination only",
                  "es": "Solo contaminación bacteriana",
                  "de": "Nur bakterielle Kontamination",
                  "nl": "Alleen bacteriële besmetting"
        },
        {
                  "en": "Incomplete pectin breakdown combined with calcium and sugar",
                  "es": "Descomposición incompleta de pectina combinada con calcio y azúcar",
                  "de": "Unvollständiger Pektinabbau kombiniert mit Kalzium und Zucker",
                  "nl": "Onvolledige pectineafbraak gecombineerd met calcium en suiker"
        },
        {
                  "en": "Freezing and thawing cycles",
                  "es": "Ciclos de congelación y descongelación",
                  "de": "Gefrier- und Auftauzyklen",
                  "nl": "Vries- en ontdooicycli"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Home Temperature Simplified Treatment",
                  "es": "Tratamiento Simplificado a Temperatura del Hogar",
                  "de": "Heimtemperatur-Vereinfachte Behandlung",
                  "nl": "Thuistemperatuur Vereenvoudigde Behandeling"
        },
        {
                  "en": "Hot Thermal Sterilization Treatment",
                  "es": "Tratamiento de Esterilización Térmica Caliente",
                  "de": "Heiße Thermische Sterilisationsbehandlung",
                  "nl": "Hete Thermische Sterilisatiebehandeling"
        },
        {
                  "en": "High Temperature Short Time (typically 72°C for 15 seconds)",
                  "es": "Alta Temperatura Tiempo Corto (típicamente 72°C por 15 segundos)",
                  "de": "Hohe Temperatur Kurze Zeit (typischerweise 72°C für 15 Sekunden)",
                  "nl": "Hoge Temperatuur Korte Tijd (typisch 72°C voor 15 seconden)"
        },
        {
                  "en": "Heated Tank Storage Technique",
                  "es": "Técnica de Almacenamiento en Tanque Calentado",
                  "de": "Beheizte Tanklagertechnik",
                  "nl": "Verwarmde Tank Opslagtechniek"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Making all juices taste the same",
                  "es": "Hacer que todos los jugos sepan igual",
                  "de": "Alle Säfte gleich schmecken lassen",
                  "nl": "Alle sappen dezelfde smaak geven"
        },
        {
                  "en": "Adjusting Brix, acidity, and flavor to achieve consistent product specifications",
                  "es": "Ajustar Brix, acidez y sabor para lograr especificaciones de producto consistentes",
                  "de": "Anpassung von Brix, Säure und Geschmack zur Erzielung konsistenter Produktspezifikationen",
                  "nl": "Brix, zuurgraad en smaak aanpassen om consistente productspecificaties te bereiken"
        },
        {
                  "en": "Following government regulations only",
                  "es": "Solo seguir regulaciones gubernamentales",
                  "de": "Nur staatliche Vorschriften befolgen",
                  "nl": "Alleen overheidsvoorschriften volgen"
        },
        {
                  "en": "Using standard size bottles",
                  "es": "Usar botellas de tamaño estándar",
                  "de": "Standardgrößenflaschen verwenden",
                  "nl": "Standaard maat flessen gebruiken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The color intensity of the juice",
                  "es": "La intensidad del color del jugo",
                  "de": "Die Farbintensität des Saftes",
                  "nl": "De kleurintensiteit van het sap"
        },
        {
                  "en": "The temperature stability of juice",
                  "es": "La estabilidad de temperatura del jugo",
                  "de": "Die Temperaturstabilität des Saftes",
                  "nl": "De temperatuurstabiliteit van sap"
        },
        {
                  "en": "Cloudiness from suspended particles, measured using a nephelometer or turbidimeter in NTU",
                  "es": "Turbidez por partículas suspendidas, medida usando un nefelómetro o turbidímetro en NTU",
                  "de": "Trübung durch schwebende Partikel, gemessen mit einem Nephelometer oder Trübungsmesser in NTU",
                  "nl": "Troebeling door zwevende deeltjes, gemeten met een nefelometer of troebelheidsmeter in NTU"
        },
        {
                  "en": "The speed at which juice flows",
                  "es": "La velocidad a la que fluye el jugo",
                  "de": "Die Geschwindigkeit, mit der Saft fließt",
                  "nl": "De snelheid waarmee sap stroomt"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Maintaining continuous refrigeration from production to consumer to preserve fresh juice quality",
                  "es": "Mantener refrigeración continua desde producción hasta consumidor para preservar calidad de jugo fresco",
                  "de": "Aufrechterhaltung kontinuierlicher Kühlung von Produktion bis Verbraucher zur Erhaltung frischer Saftqualität",
                  "nl": "Continue koeling handhaven van productie tot consument om verse sapkwaliteit te behouden"
        },
        {
                  "en": "Selling juice only in winter months",
                  "es": "Vender jugo solo en meses de invierno",
                  "de": "Saft nur in Wintermonaten verkaufen",
                  "nl": "Sap alleen in wintermaanden verkopen"
        },
        {
                  "en": "Freezing all juice products",
                  "es": "Congelar todos los productos de jugo",
                  "de": "Alle Saftprodukte einfrieren",
                  "nl": "Alle sapproducten bevriezen"
        },
        {
                  "en": "Using ice in shipping containers",
                  "es": "Usar hielo en contenedores de envío",
                  "de": "Eis in Versandbehältern verwenden",
                  "nl": "IJs gebruiken in verzendcontainers"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A vitamin added to fortified juices",
                  "es": "Una vitamina añadida a jugos fortificados",
                  "de": "Ein Vitamin, das angereicherten Säften zugesetzt wird",
                  "nl": "Een vitamine toegevoegd aan verrijkte sappen"
        },
        {
                  "en": "A beneficial enzyme that improves clarity",
                  "es": "Una enzima beneficiosa que mejora la claridad",
                  "de": "Ein nützliches Enzym, das die Klarheit verbessert",
                  "nl": "Een nuttig enzym dat helderheid verbetert"
        },
        {
                  "en": "A mycotoxin from moldy fruits (especially apples) that can contaminate juice",
                  "es": "Una micotoxina de frutas mohosas (especialmente manzanas) que puede contaminar el jugo",
                  "de": "Ein Mykotoxin aus schimmeligen Früchten (besonders Äpfeln), das Saft kontaminieren kann",
                  "nl": "Een mycotoxine uit beschimmeld fruit (vooral appels) dat sap kan verontreinigen"
        },
        {
                  "en": "A natural preservative found in citrus",
                  "es": "Un conservante natural encontrado en cítricos",
                  "de": "Ein natürliches Konservierungsmittel in Zitrusfrüchten",
                  "nl": "Een natuurlijk conserveermiddel gevonden in citrus"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding brown coloring to mask the change",
                  "es": "Añadir coloración marrón para enmascarar el cambio",
                  "de": "Braune Färbung hinzufügen, um die Veränderung zu maskieren",
                  "nl": "Bruine kleuring toevoegen om de verandering te maskeren"
        },
        {
                  "en": "Using only non-browning fruit varieties",
                  "es": "Usar solo variedades de frutas que no se pardean",
                  "de": "Nur nicht-bräunende Obstsorten verwenden",
                  "nl": "Alleen niet-bruinende fruitvariëteiten gebruiken"
        },
        {
                  "en": "Filtering out all brown particles",
                  "es": "Filtrar todas las partículas marrones",
                  "de": "Alle braunen Partikel herausfiltern",
                  "nl": "Alle bruine deeltjes uitfilteren"
        },
        {
                  "en": "Preventing oxidation by adding ascorbic acid or using HPP to deactivate polyphenol oxidase",
                  "es": "Prevenir oxidación añadiendo ácido ascórbico o usando HPP para desactivar polifenol oxidasa",
                  "de": "Oxidation verhindern durch Zugabe von Ascorbinsäure oder Verwendung von HPP zur Deaktivierung von Polyphenoloxidase",
                  "nl": "Oxidatie voorkomen door ascorbinezuur toe te voegen of HPP gebruiken om polyfenoloxidase te deactiveren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "How fast juice can be produced",
                  "es": "Qué tan rápido se puede producir jugo",
                  "de": "Wie schnell Saft produziert werden kann",
                  "nl": "Hoe snel sap geproduceerd kan worden"
        },
        {
                  "en": "The percentage of water in juice",
                  "es": "El porcentaje de agua en jugo",
                  "de": "Der Prozentsatz an Wasser im Saft",
                  "nl": "Het percentage water in sap"
        },
        {
                  "en": "Juice extracted per kg of fruit; affected by fruit ripeness, variety, extraction method, and enzyme treatment",
                  "es": "Jugo extraído por kg de fruta; afectado por madurez de fruta, variedad, método de extracción y tratamiento enzimático",
                  "de": "Extrahierter Saft pro kg Frucht; beeinflusst durch Fruchtreife, Sorte, Extraktionsmethode und Enzymbehandlung",
                  "nl": "Geëxtraheerd sap per kg fruit; beïnvloed door fruitrijpheid, variëteit, extractiemethode en enzymbehandeling"
        },
        {
                  "en": "The profit margin on juice sales",
                  "es": "El margen de ganancia en ventas de jugo",
                  "de": "Die Gewinnspanne beim Saftverkauf",
                  "nl": "De winstmarge op sapverkoop"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using paper filters to remove large particles",
                  "es": "Usar filtros de papel para remover partículas grandes",
                  "de": "Papierfilter verwenden, um große Partikel zu entfernen",
                  "nl": "Papieren filters gebruiken om grote deeltjes te verwijderen"
        },
        {
                  "en": "Centrifugal separation only",
                  "es": "Solo separación centrífuga",
                  "de": "Nur Zentrifugaltrennung",
                  "nl": "Alleen centrifugale scheiding"
        },
        {
                  "en": "A traditional cloth straining method",
                  "es": "Un método tradicional de colado con tela",
                  "de": "Eine traditionelle Stofffilterungsmethode",
                  "nl": "Een traditionele stoffen zeepmethode"
        },
        {
                  "en": "Using semi-permeable membranes (microfiltration, ultrafiltration, nanofiltration) for clarification and concentration without heat",
                  "es": "Usar membranas semipermeables (microfiltración, ultrafiltración, nanofiltración) para clarificación y concentración sin calor",
                  "de": "Verwendung semipermeabler Membranen (Mikrofiltration, Ultrafiltration, Nanofiltration) zur Klärung und Konzentration ohne Hitze",
                  "nl": "Semi-permeabele membranen gebruiken (microfiltratie, ultrafiltratie, nanofiltratie) voor klaring en concentratie zonder warmte"
        }
        ],
        correct: 3,
        explanation: {
