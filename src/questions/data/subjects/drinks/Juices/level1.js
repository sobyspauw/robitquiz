// Juices - level1
// Total questions: 100
// Quality issues fixed: 2026-03-03T10:19:07.129Z

module.exports = {
    questions: [
            {
                    "question": {
                            "en": "Which juice has the most vitamin C?",
                            "es": "¿Qué jugo tiene más vitamina C?",
                            "de": "Welcher Saft hat das meiste Vitamin C?",
                            "nl": "Welk sap heeft de meeste vitamine C?"
                    },
                    "options": [
                            {
                                    "en": "Orange juice",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Orange juice is famous for its high vitamin C content, with one cup providing over 100% of the daily recommended intake.",
                            "es": "El jugo de naranja es famoso por su alto contenido de vitamina C, con una taza proporcionando más del 100% de la ingesta diaria recomendada.",
                            "de": "Orangensaft ist berühmt für seinen hohen Vitamin-C-Gehalt, wobei eine Tasse über 100% der täglich empfohlenen Menge liefert.",
                            "nl": "Sinaasappelsap staat bekend om zijn hoge vitamine C-gehalte, waarbij één kopje meer dan 100% van de dagelijks aanbevolen hoeveelheid levert."
                    }
            },
            {
                    "question": {
                    ...
                    "options": [
                            {
                                    "en": "Juice extracted without heat",
                                    "es": "Jugo extraído sin calor",
                                    "de": "Saft ohne Hitze extrahiert",
                                    "nl": "Sap geëxtraheerd zonder hitte"
                            },
                            {
                                    "en": "Frozen juice",
                                    "es": "Jugo congelado",
                            ...
                            {
                                    "en": "Juice served cold",
                                    "es": "Jugo servido frío",
                                    "de": "Kalt servierter Saft",
                                    "nl": "Koud geserveerd sap"
                            },
                            {
                                    "en": "Concentrated juice",
                                    "es": "Jugo concentrado",
                                    "de": "Konzentrierter Saft",
                                    "nl": "Geconcentreerd sap"
                            }
                    ],
                    "correct": 0,
                    "explanation": {
                            "en": "Cold-pressed juice is made using hydraulic pressure to extract juice from fruits and vegetables without heat, preserving more nutrients and enzymes.",
                            "es": "El jugo prensado en frío se hace usando presión hidráulica para extraer jugo de frutas y verduras sin calor, preservando más nutrientes y enzimas.",
                            "de": "Kaltgepresster Saft wird mit hydraulischem Druck hergestellt, um Saft aus Obst und Gemüse ohne Hitze zu extrahieren, wodurch mehr Nährstoffe und Enzyme erhalten bleiben.",
                            "nl": "Koudgeperst sap wordt gemaakt met hydraulische druk om sap uit fruit en groenten te halen zonder hitte, waardoor meer voedingsstoffen en enzymen behouden blijven."
                    }
            },
            {
                    "question": {
                            "en": "Which country produces the most orange juice?",
                            "es": "¿Qué país produce más jugo de naranja?",
                            "de": "Welches Land produziert den meisten Orangensaft?",
                            "nl": "Welk land produceert het meeste sinaasappelsap?"
                    },
                    "options": [
                            {
                                    "en": "Brazil",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Brazil produces about 35% of the world's orange juice, making it the largest producer globally. Most is exported as frozen concentrated juice.",
                            "es": "Brasil produce aproximadamente el 35% del jugo de naranja del mundo, siendo el mayor productor global. La mayoría se exporta como jugo concentrado congelado.",
                            "de": "Brasilien produziert etwa 35% des weltweiten Orangensafts und ist damit der größte Produzent weltweit. Das meiste wird als gefrorenes Konzentrat exportiert.",
                            "nl": "Brazilië produceert ongeveer 35% van het wereldwijde sinaasappelsap, waarmee het de grootste producent ter wereld is. Het meeste wordt geëxporteerd als bevroren concentraat."
                    }
            },
            {
                    "question": {
                            "en": "What juice is traditionally served with breakfast?",
                            "es": "¿Qué jugo se sirve tradicionalmente con el desayuno?",
                            "de": "Welcher Saft wird traditionell zum Frühstück serviert?",
                            "nl": "Welk sap wordt traditioneel bij het ontbijt geserveerd?"
                    },
                    "options": [
                            {
                                    "en": "Orange juice",
                    ...
                    "correct": 0,
                    "explanation": {
                            "en": "Orange juice became a breakfast staple in the 20th century, especially after WWII when frozen concentrated orange juice was developed and marketed heavily.",
                            "es": "El jugo de naranja se convirtió en básico del desayuno en el siglo XX, especialmente después de la Segunda Guerra Mundial cuando se desarrolló y comercializó el jugo de naranja concentrado congelado.",
                            "de": "Orangensaft wurde im 20. Jahrhundert zum Frühstücksklassiker, besonders nach dem Zweiten Weltkrieg, als gefrorener konzentrierter Orangensaft entwickelt und stark vermarktet wurde.",
                            "nl": "Sinaasappelsap werd een ontbijtklassieker in de 20e eeuw, vooral na WOII toen bevroren geconcentreerd sinaasappelsap werd ontwikkeld en zwaar werd gemarket."
                    }
            },
            {
                    "question": {
                            "en": "What is pomegranate juice known for?",
                            "es": "¿Por qué es conocido el jugo de granada?",
                            "de": "Wofür ist Granatapfelsaft bekannt?",
                            "nl": "Waar staat granaatappelsap om bekend?"
                    },
                    "options": [
                            {
                                    "en": "High antioxidant content",
                                    "es": "Alto contenido de antioxidantes",
                                    "de": "Hoher Antioxidantiengehalt",
                                    "nl": "Hoog antioxidantgehalte"
                            },
                            {
                                    "en": "Low calorie content",
                                    "es": "Bajo contenido calórico",
                                    "de": "Niedriger Kaloriengehalt",
                                    "nl": "Laag caloriegehalte"
                            },
                            {
                                    "en": "High protein content",
                                    "es": "Alto contenido de proteína",
                                    "de": "Hoher Proteingehalt",
                                    "nl": "Hoog eiwitgehalte"
                            },
                            {
                                    "en": "Natural carbonation",
                                    "es": "Carbonatación natural",
                                    "de": "Natürliche Karbonisierung",
                                    "nl": "Natuurlijke koolzuur"
                            }
                    ],
                    "correct": 0,
                    "explanation": {
                            "en": "Pomegranate juice is renowned for its exceptionally high antioxidant content, containing three times more antioxidants than red wine or green tea.",
                            "es": "El jugo de granada es reconocido por su contenido excepcionalmente alto de antioxidantes, conteniendo tres veces más antioxidantes que el vino tinto o el té verde.",
                            "de": "Granatapfelsaft ist bekannt für seinen außergewöhnlich hohen Antioxidantiengehalt, er enthält dreimal mehr Antioxidantien als Rotwein oder grüner Tee.",
                            "nl": "Granaatappelsap staat bekend om zijn uitzonderlijk hoge antioxidantgehalte, het bevat drie keer meer antioxidanten dan rode wijn of groene thee."
                    }
            },
            {
                    "question": {
                    ...
                    "correct": 1,
                    "explanation": {
                            "en": "This question relates to level 1 content in Juices. The correct answer provides important context.",
                            "es": "This question relates to level 1 content in Juices. The correct answer provides important context.",
                            "de": "This question relates to level 1 content in Juices. The correct answer provides important context.",
                            "nl": "This question relates to level 1 content in Juices. The correct answer provides important context."
                    }
            },
            {
                    "question": {
            ...
            {
                    "question": {
                            "en": "How does this relate to Juices?",
                            "es": "¿Cómo does this relate to Juices?",
                            "de": "Wie does this relate to Juices?",
                            "nl": "Hoe does this relate to Juices?"
                    },
                    "options": [
                            {
