    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Only matters for artificial colors",
                  "es": "Solo importa para colores artificiales",
                  "de": "Ist nur für künstliche Farben wichtig",
                  "nl": "Is alleen belangrijk voor kunstmatige kleuren"
        },
        {
                  "en": "Only affects sweetness levels",
                  "es": "Solo afecta los niveles de dulzura",
                  "de": "Beeinflusst nur Süßegrade",
                  "nl": "Beïnvloedt alleen zoetheidsgraden"
        },
        {
                  "en": "Has no impact on juice quality",
                  "es": "No tiene impacto en la calidad del jugo",
                  "de": "Hat keinen Einfluss auf die Saftqualität",
                  "nl": "Heeft geen impact op sapkwaliteit"
        },
        {
                  "en": "Determines color retention and antioxidant potency",
                  "es": "Determina la retención de color y potencia antioxidante",
                  "de": "Bestimmt Farberhaltung und antioxidative Potenz",
                  "nl": "Bepaalt kleurbehoud en antioxidant potentie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Can cause precipitation and clarity loss if not controlled",
                  "es": "Puede causar precipitación y pérdida de claridad si no se controla",
                  "de": "Kann bei fehlender Kontrolle Ausfällung und Klarheitsverlust verursachen",
                  "nl": "Kan neerslag en helderheidsverlies veroorzaken indien niet gecontroleerd"
        },
        {
                  "en": "Has no effect on citrus juices",
                  "es": "No tiene efecto en jugos cítricos",
                  "de": "Hat keine Wirkung auf Zitrusäfte",
                  "nl": "Heeft geen effect op citrussappen"
        },
        {
                  "en": "Only affects taste, not appearance",
                  "es": "Solo afecta el sabor, no la apariencia",
                  "de": "Beeinflusst nur Geschmack, nicht Aussehen",
                  "nl": "Beïnvloedt alleen smaak, niet uiterlijk"
        },
        {
                  "en": "Always improves juice quality",
                  "es": "Siempre mejora la calidad del jugo",
                  "de": "Verbessert immer die Saftqualität",
                  "nl": "Verbetert altijd de sapkwaliteit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Simple pH measurement",
                  "es": "Medición simple de pH",
                  "de": "Einfache pH-Messung",
                  "nl": "Eenvoudige pH meting"
        },
        {
                  "en": "Color analysis only",
                  "es": "Solo análisis de color",
                  "de": "Nur Farbanalyse",
                  "nl": "Alleen kleuranalyse"
        },
        {
                  "en": "Stable isotope ratio mass spectrometry",
                  "es": "Espectrometría de masas de relación isotópica estable",
                  "de": "Stabile Isotopenverhältnis-Massenspektrometrie",
                  "nl": "Stabiele isotoop verhouding massaspectrometrie"
        },
        {
                  "en": "Taste testing panels",
                  "es": "Paneles de degustación",
                  "de": "Verkostungspanels",
                  "nl": "Smaaktest panels"
        }
        ],
        correct: 2,
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No specific cutoff needed",
                  "es": "No se necesita corte específico",
                  "de": "Kein spezifischer Cutoff nötig",
                  "nl": "Geen specifieke cutoff nodig"
        },
        {
                  "en": "10-30 kDa to retain oligosaccharides while removing pathogens",
                  "es": "10-30 kDa para retener oligosacáridos mientras elimina patógenos",
                  "de": "10-30 kDa zur Retention von Oligosacchariden bei gleichzeitiger Entfernung von Pathogenen",
                  "nl": "10-30 kDa om oligosachariden te behouden terwijl pathogenen worden verwijderd"
        },
        {
                  "en": "1-5 kDa for maximum filtration",
                  "es": "1-5 kDa para filtración máxima",
                  "de": "1-5 kDa für maximale Filtration",
                  "nl": "1-5 kDa voor maximale filtratie"
        },
        {
                  "en": "100+ kDa for minimal processing",
                  "es": "100+ kDa para procesamiento mínimo",
                  "de": "100+ kDa für minimale Verarbeitung",
                  "nl": "100+ kDa voor minimale verwerking"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Water activity has no effect on microbes",
                  "es": "La actividad del agua no tiene efecto en microbios",
                  "de": "Wasseraktivität hat keine Wirkung auf Mikroben",
                  "nl": "Water activiteit heeft geen effect op microben"
        },
        {
                  "en": "Only temperature matters for preservation",
                  "es": "Solo la temperatura importa para preservación",
                  "de": "Nur Temperatur ist wichtig für Konservierung",
                  "nl": "Alleen temperatuur is belangrijk voor conservering"
        },
        {
                  "en": "Below 0.85 aw prevents most pathogenic bacteria and mold growth",
                  "es": "Por debajo de 0.85 aw previene la mayoría de bacterias patógenas y crecimiento de moho",
                  "de": "Unter 0.85 aw verhindert die meisten pathogenen Bakterien und Schimmelwachstum",
                  "nl": "Onder 0.85 aw voorkomt de meeste pathogene bacteriën en schimmelgroei"
        },
        {
                  "en": "Higher water activity always prevents growth",
                  "es": "Mayor actividad del agua siempre previene crecimiento",
                  "de": "Höhere Wasseraktivität verhindert immer Wachstum",
                  "nl": "Hogere water activiteit voorkomt altijd groei"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reaction with packaging materials",
                  "es": "Reacción con materiales de empaque",
                  "de": "Reaktion mit Verpackungsmaterialien",
                  "nl": "Reactie met verpakkingsmaterialen"
        },
        {
                  "en": "Temperature-induced caramelization",
                  "es": "Caramelización inducida por temperatura",
                  "de": "Temperaturinduzierte Karamelisierung",
                  "nl": "Temperatuur-geïnduceerde karamelisatie"
        },
        {
                  "en": "Natural aging of fruit sugars",
                  "es": "Envejecimiento natural de azúcares de fruta",
                  "de": "Natürliche Alterung von Fruchtzuckern",
                  "nl": "Natuurlijke veroudering van fruitsuikers"
        },
        {
                  "en": "Polyphenol oxidase converts phenolic compounds to quinones, which polymerize into brown pigments",
                  "es": "La polifenol oxidasa convierte compuestos fenólicos en quinonas, que se polimerizan en pigmentos marrones",
                  "de": "Polyphenoloxidase wandelt phenolische Verbindungen in Chinone um, die zu braunen Pigmenten polymerisieren",
                  "nl": "Polyfenol oxidase zet fenolische verbindingen om in quinonen, die polymeriseren tot bruine pigmenten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Container material type",
                  "es": "Tipo de material del contenedor",
                  "de": "Art des Behältermaterials",
                  "nl": "Type containermaterial"
        },
        {
                  "en": "Storage temperature only",
                  "es": "Solo temperatura de almacenamiento",
                  "de": "Nur Lagertemperatur",
                  "nl": "Alleen opslagtemperatuur"
        },
        {
                  "en": "Presence of lipids and mechanical cell disruption",
                  "es": "Presencia de lípidos y disrupción celular mecánica",
                  "de": "Anwesenheit von Lipiden und mechanische Zellstörung",
                  "nl": "Aanwezigheid van lipiden en mechanische celverstoringen"
        },
        {
                  "en": "Juice pH level",
                  "es": "Nivel de pH del jugo",
                  "de": "pH-Wert des Saftes",
                  "nl": "Sap pH niveau"
        }
        ],
        correct: 2,
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Increases during thermal processing",
                  "es": "Aumenta durante procesamiento térmico",
                  "de": "Steigt während thermischer Verarbeitung",
                  "nl": "Neemt toe tijdens thermische verwerking"
        },
        {
                  "en": "Provides cloud stability and bitter taste; degrades with heat processing",
                  "es": "Proporciona estabilidad de nube y sabor amargo; se degrada con procesamiento térmico",
                  "de": "Bietet Trübungsstabilität und bitteren Geschmack; baut sich bei Wärmebehandlung ab",
                  "nl": "Biedt wolkstabiliteit en bittere smaak; breekt af bij warmtebehandeling"
        },
        {
                  "en": "Only affects sweetness levels",
                  "es": "Solo afecta niveles de dulzura",
                  "de": "Beeinflusst nur Süßegrade",
                  "nl": "Beïnvloedt alleen zoetheidsgraden"
        },
        {
                  "en": "Has no impact on juice properties",
                  "es": "No tiene impacto en propiedades del jugo",
                  "de": "Hat keinen Einfluss auf Safteigenschaften",
                  "nl": "Heeft geen impact op sapeigenschappen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Multiple heating and cooling cycles",
                  "es": "Múltiples ciclos de calentamiento y enfriamiento",
                  "de": "Mehrere Heiz- und Kühlzyklen",
                  "nl": "Meerdere verwarmings- en koelcycli"
        },
        {
                  "en": "HTST (High Temperature Short Time) at 95°C for 15 seconds",
                  "es": "HTST (Alta Temperatura Tiempo Corto) a 95°C por 15 segundos",
                  "de": "HTST (Hochtemperatur Kurzzeit) bei 95°C für 15 Sekunden",
                  "nl": "HTST (Hoge Temperatuur Korte Tijd) bij 95°C voor 15 seconden"
        },
        {
                  "en": "Low temperature extended time processing",
                  "es": "Procesamiento de baja temperatura tiempo extendido",
                  "de": "Niedrigtemperatur-Langzeitverarbeitung",
                  "nl": "Lage temperatuur verlengde tijd verwerking"
        },
        {
                  "en": "Room temperature processing only",
                  "es": "Solo procesamiento a temperatura ambiente",
                  "de": "Nur Raumtemperaturverarbeitung",
                  "nl": "Alleen kamertemperatuur verwerking"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Brix only affects taste, not costs",
                  "es": "Brix solo afecta sabor, no costos",
                  "de": "Brix beeinflusst nur Geschmack, nicht Kosten",
                  "nl": "Brix beïnvloedt alleen smaak, niet kosten"
        },
        {
                  "en": "Brix levels have no economic impact",
                  "es": "Los niveles de Brix no tienen impacto económico",
                  "de": "Brix-Werte haben keine wirtschaftlichen Auswirkungen",
                  "nl": "Brix niveaus hebben geen economische impact"
        },
        {
                  "en": "Higher Brix reduces transportation costs but requires more energy for concentration",
                  "es": "Mayor Brix reduce costos de transporte pero requiere más energía para concentración",
                  "de": "Höhere Brix reduziert Transportkosten, erfordert aber mehr Energie für Konzentration",
                  "nl": "Hogere Brix vermindert transportkosten maar vereist meer energie voor concentratie"
        },
        {
                  "en": "Lower Brix is always more profitable",
                  "es": "Menor Brix siempre es más rentable",
                  "de": "Niedrigere Brix ist immer profitabler",
                  "nl": "Lagere Brix is altijd winstgevender"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only affects financial transactions",
                  "es": "Solo afecta transacciones financieras",
                  "de": "Betrifft nur Finanztransaktionen",
                  "nl": "Beïnvloedt alleen financiële transacties"
        },
        {
                  "en": "Replaces all quality control testing",
                  "es": "Reemplaza todas pruebas de control de calidad",
                  "de": "Ersetzt alle Qualitätskontrolltests",
                  "nl": "Vervangt alle kwaliteitscontrole testen"
        },
        {
                  "en": "Only improves packaging design",
                  "es": "Solo mejora diseño de empaque",
                  "de": "Verbessert nur Verpackungsdesign",
                  "nl": "Verbetert alleen verpakkingsontwerp"
        },
        {
                  "en": "Creates immutable record from farm to consumer ensuring provenance but requires industry-wide adoption and energy-intensive consensus mechanisms",
                  "es": "Crea registro inmutable de granja a consumidor asegurando procedencia pero requiere adopción industrial amplia y mecanismos de consenso intensivos en energía",
                  "de": "Erstellt unveränderliche Aufzeichnung vom Bauernhof zum Verbraucher zur Herkunftssicherung, erfordert aber branchenweite Adoption und energieintensive Konsensmechanismen",
                  "nl": "Creëert onveranderlijk record van boerderij tot consument voor herkomstzekerheid maar vereist industrie-brede adoptie en energie-intensieve consensusmechanismen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only changes fruit color",
                  "es": "Solo cambia color de fruta",
                  "de": "Ändert nur Fruchtfarbe",
                  "nl": "Verandert alleen fruitkleur"
        },
        {
                  "en": "Creates completely synthetic organisms",
                  "es": "Crea organismos completamente sintéticos",
                  "de": "Erstellt vollständig synthetische Organismen",
                  "nl": "Creëert volledig synthetische organismen"
        },
        {
                  "en": "Has no application in agriculture",
                  "es": "No tiene aplicación en agricultura",
                  "de": "Hat keine Anwendung in der Landwirtschaft",
                  "nl": "Heeft geen toepassing in landbouw"
        },
        {
                  "en": "Precise genome editing creates fruits with higher juice yield, enhanced nutrition, reduced browning, less bitterness; regulatory status varies (EU restrictive, US/Japan more permissive)",
                  "es": "Edición genómica precisa crea frutas con mayor rendimiento jugo, nutrición mejorada, menor pardeamiento, menos amargor; estatus regulatorio varía (UE restrictiva, EEUU/Japón más permisivos)",
                  "de": "Präzise Genombearbeitung schafft Früchte mit höherer Saftausbeute, verbesserter Ernährung, reduzierter Bräunung, weniger Bitterkeit; regulatorischer Status variiert (EU restriktiv, USA/Japan permissiver)",
                  "nl": "Precieze genoombewerking creëert fruit met hogere sapopbrengst, verbeterde voeding, verminderde verkleuring, minder bitterheid; regelgevende status varieert (EU restrictief, VS/Japan meer permissief)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "SFE uses CO₂ above critical point (31°C, 73 bar) for non-polar compounds (carotenoids); SWE uses hot pressurized water (100-374°C, 10-60 bar) for polar/medium-polarity compounds (phenolics)",
                  "es": "SFE usa CO₂ sobre punto crítico (31°C, 73 bar) para compuestos no polares (carotenoides); SWE usa agua caliente presurizada (100-374°C, 10-60 bar) para compuestos polares/mediana-polaridad (fenólicos)",
                  "de": "SFE verwendet CO₂ über kritischem Punkt (31°C, 73 bar) für unpolare Verbindungen (Carotinoide); SWE verwendet heißes Druckwasser (100-374°C, 10-60 bar) für polare/mittelpolare Verbindungen (Phenole)",
                  "nl": "SFE gebruikt CO₂ boven kritisch punt (31°C, 73 bar) voor niet-polaire verbindingen (carotenoïden); SWE gebruikt heet gecomprimeerd water (100-374°C, 10-60 bar) voor polaire/middenpolariteit verbindingen (fenolische)"
        },
        {
                  "en": "Only extract sugars",
                  "es": "Solo extraen azúcares",
                  "de": "Extrahieren nur Zucker",
                  "nl": "Extracteren alleen suikers"
        },
        {
                  "en": "Work only at room temperature",
                  "es": "Funcionan solo a temperatura ambiente",
                  "de": "Funktionieren nur bei Raumtemperatur",
                  "nl": "Werken alleen bij kamertemperatuur"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only adds sugar to juice",
                  "es": "Solo añade azúcar a jugo",
                  "de": "Fügt nur Zucker zu Saft hinzu",
                  "nl": "Voegt alleen suiker toe aan sap"
        },
        {
                  "en": "Forces liquid through narrow gap creating cavitation, shear, turbulence; achieves microbial inactivation, cell disruption, nano-emulsification, enhanced bioavailability without heat",
                  "es": "Fuerza líquido a través espacio estrecho creando cavitación, cizallamiento, turbulencia; logra inactivación microbiana, disrupción celular, nano-emulsificación, biodisponibilidad mejorada sin calor",
                  "de": "Zwingt Flüssigkeit durch engen Spalt erzeugt Kavitation, Scherung, Turbulenz; erreicht mikrobielle Inaktivierung, Zellaufschluss, Nano-Emulgierung, erhöhte Bioverfügbarkeit ohne Hitze",
                  "nl": "Dwingt vloeistof door nauwe opening creërend cavitatie, afschuiving, turbulentie; bereikt microbiële inactivatie, celverbreking, nano-emulsificatie, verhoogde biobeschikbaarheid zonder warmte"
        },
        {
                  "en": "Removes all nutrients",
                  "es": "Elimina todos nutrientes",
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Réplica virtual integra datos sensores continuos (temperatura, presión, flujo, vibración, energía) habilitando detección anomalías impulsada IA, prevención fallas predictiva, optimización procesos reduciendo tiempo inactividad 30-50%",
                  "de": "Virtuelle Replik integriert kontinuierliche Sensordaten (Temperatur, Druck, Durchfluss, Vibration, Energie) ermöglicht KI-gesteuerte Anomalieerkennung, vorausschauende Fehlerprävention, Prozessoptimierung reduziert Ausfallzeit 30-50%",
                  "nl": "Virtuele replica integreert continue sensordata (temperatuur, druk, stroming, vibratie, energie) mogelijk makend AI-gedreven anomalie detectie, voorspellende storingpreventie, procesoptimalisatie verminderend stilstand 30-50%"
        },
        {
                  "en": "Only monitors temperature",
                  "es": "Solo monitorea temperatura",
                  "de": "Überwacht nur Temperatur",
                  "nl": "Monitort alleen temperatuur"
        },
        {
                  "en": "Replaces all human workers",
                  "es": "Reemplaza todos trabajadores humanos",
                  "de": "Ersetzt alle menschlichen Arbeiter",
                  "nl": "Vervangt alle menselijke werknemers"
        },
        {
                  "en": "Only tracks inventory",
                  "es": "Solo rastrea inventario",
                  "de": "Verfolgt nur Inventar",
                  "nl": "Volgt alleen voorraad"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Requires no electricity",
                  "es": "No requiere electricidad",
                  "de": "Benötigt keine Elektrizität",
                  "nl": "Vereist geen elektriciteit"
        },
        {
                  "en": "Only uses microwave radiation",
                  "es": "Solo usa radiación microondas",
                  "de": "Verwendet nur Mikrowellenstrahlung",
                  "nl": "Gebruikt alleen microgolf straling"
        },
        {
                  "en": "Alternating current (50-60 Hz) through juice generates internal volumetric heat via electrical resistance (Joule heating); rapid uniform heating preserves nutrients better than surface heat transfer methods",
                  "es": "Corriente alterna (50-60 Hz) a través jugo genera calor volumétrico interno vía resistencia eléctrica (calentamiento Joule); calentamiento rápido uniforme preserva nutrientes mejor que métodos transferencia calor superficial",
                  "de": "Wechselstrom (50-60 Hz) durch Saft erzeugt interne volumetrische Wärme via elektrischem Widerstand (Joule-Heizung); schnelle gleichmäßige Erwärmung erhält Nährstoffe besser als Oberflächenwärmeübertragungsmethoden",
                  "nl": "Wisselstroom (50-60 Hz) door sap genereert interne volumetrische warmte via elektrische weerstand (Joule verwarming); snelle uniforme verwarming behoudt voedingsstoffen beter dan oppervlaktewarmteoverdracht methoden"
        },
        {
                  "en": "Only works for carbonated beverages",
                  "es": "Solo funciona para bebidas carbonatadas",
                  "de": "Funktioniert nur für kohlensäurehaltige Getränke",
                  "nl": "Werkt alleen voor koolzuurhoudende dranken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Vacuum stripping removes volatiles before heating, condenses separately, then adds back; validated using GC-MS, GC-O (olfactometry), electronic nose matching fresh juice aroma fingerprint",
                  "es": "Extracción vacío remueve volátiles antes calentamiento, condensa separadamente, luego añade de vuelta; validado usando GC-MS, GC-O (olfatometría), nariz electrónica igualando huella aromática jugo fresco",
                  "de": "Vakuumstrippen entfernt Volatile vor Erhitzung, kondensiert separat, fügt dann zurück; validiert mit GC-MS, GC-O (Olfaktometrie), elektronischer Nase zum Abgleich frischer Saft-Aromafingerabdruck",
                  "nl": "Vacuüm strippen verwijdert vluchtige stoffen voor verhitting, condenseert apart, voegt dan terug toe; gevalideerd met GC-MS, GC-O (olfactometrie), elektronische neus matchend vers sap aroma vingerafdruk"
        },
        {
                  "en": "Removes all aroma compounds permanently",
                  "es": "Elimina todos compuestos aroma permanentemente",
                  "de": "Entfernt alle Aromaverbindungen dauerhaft",
                  "nl": "Verwijdert alle aromaverbindingen permanent"
        },
        {
                  "en": "Only adds artificial flavors",
                  "es": "Solo añade sabores artificiales",
                  "de": "Fügt nur künstliche Aromen hinzu",
                  "nl": "Voegt alleen kunstmatige smaken toe"
        },
        {
                  "en": "Only works for vegetable juices",
                  "es": "Solo funciona para jugos vegetales",
                  "de": "Funktioniert nur für Gemüsesäfte",
                  "nl": "Werkt alleen voor groentesappen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Requires high-temperature steam",
                  "es": "Requiere vapor alta temperatura",
                  "de": "Erfordert Hochtemperaturdampf",
                  "nl": "Vereist hogetemperatuur stoom"
        },
        {
                  "en": "Uses only mechanical scrubbing",
                  "es": "Usa solo fregado mecánico",
                  "de": "Verwendet nur mechanisches Schrubben",
                  "nl": "Gebruikt alleen mechanisch schrobben"
        },
        {
                  "en": "Ionized gas generates reactive species (•OH, O₃, NO, UV photons) causing oxidative damage to microbial membranes and DNA achieving 3-5 log reductions without heat or chemical residues",
                  "es": "Gas ionizado genera especies reactivas (•OH, O₃, NO, fotones UV) causando daño oxidativo a membranas microbianas y ADN logrando reducciones 3-5 log sin calor o residuos químicos",
                  "de": "Ionisiertes Gas erzeugt reaktive Spezies (•OH, O₃, NO, UV-Photonen) verursacht oxidativen Schaden an mikrobiellen Membranen und DNA erreicht 3-5 log Reduktionen ohne Hitze oder chemische Rückstände",
                  "nl": "Geïoniseerd gas genereert reactieve soorten (•OH, O₃, NO, UV fotonen) veroorzakend oxidatieve schade aan microbiële membranen en DNA bereikend 3-5 log reducties zonder warmte of chemische residuen"
        },
        {
                  "en": "Only heats surfaces to kill microbes",
                  "es": "Solo calienta superficies para matar microbios",
                  "de": "Erhitzt nur Oberflächen um Mikroben zu töten",
                  "nl": "Verwarmt alleen oppervlakken om microben te doden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cradle-to-grave analysis quantifies GHG emissions, water use, energy across agriculture, processing, packaging, distribution; mitigation via renewable energy, lightweight packaging, waste valorization, local sourcing",
                  "es": "Análisis cuna-a-tumba cuantifica emisiones GEI, uso agua, energía a través agricultura, procesamiento, empaque, distribución; mitigación vía energía renovable, empaque ligero, valorización residuos, abastecimiento local",
                  "de": "Von-Wiege-zu-Bahre-Analyse quantifiziert THG-Emissionen, Wasserverbrauch, Energie über Landwirtschaft, Verarbeitung, Verpackung, Vertrieb; Minderung via erneuerbare Energie, Leichtverpackung, Abfallvalorisierung, lokale Beschaffung",
                  "nl": "Wieg-tot-graf analyse kwantificeert BKG emissies, watergebruik, energie over landbouw, verwerking, verpakking, distributie; mitigatie via hernieuwbare energie, lichtgewicht verpakking, afval valorisatie, lokale inkoop"
        },
        {
                  "en": "Only measures juice color",
                  "es": "Solo mide color jugo",
                  "de": "Misst nur Saftfarbe",
                  "nl": "Meet alleen sapkleur"
        },
        {
                  "en": "Focuses only on packaging aesthetics",
                  "es": "Se enfoca solo en estética empaque",
                  "de": "Konzentriert sich nur auf Verpackungsästhetik",
                  "nl": "Focus alleen op verpakkingsesthetiek"
        },
        {
                  "en": "Ignores agricultural phase",
                  "es": "Ignora fase agrícola",
                  "de": "Ignoriert landwirtschaftliche Phase",
                  "nl": "Negeert landbouwfase"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "UAV/satellite multispectral imaging, hyperspectral sensors, LiDAR combined with genomic selection and CRISPR gene editing accelerate breeding drought/heat/disease-resistant varieties 5-10x faster",
                  "es": "Imágenes multispectrales UAV/satélite, sensores hiperespectrales, LiDAR combinados con selección genómica y edición genética CRISPR aceleran mejoramiento variedades resistentes sequía/calor/enfermedades 5-10x más rápido",
                  "de": "UAV/Satelliten-Multispektralbildgebung, hyperspektrale Sensoren, LiDAR kombiniert mit genomischer Selektion und CRISPR-Genbearbeitung beschleunigen Züchtung dürre-/hitze-/krankheitsresistenter Sorten 5-10x schneller",
                  "nl": "UAV/satelliet multispectrale beeldvorming, hyperspectrale sensoren, LiDAR gecombineerd met genomische selectie en CRISPR genbewerking versnellen veredeling droogte/warmte/ziekte-resistente variëteiten 5-10x sneller"
        },
        {
                  "en": "Has no impact on breeding speed",
                  "es": "No tiene impacto en velocidad mejoramiento",
                  "de": "Hat keinen Einfluss auf Züchtungsgeschwindigkeit",
                  "nl": "Heeft geen impact op veredelingssnelheid"
        },
        {
                  "en": "Only measures fruit size",
                  "es": "Solo mide tamaño fruta",
                  "de": "Misst nur Fruchtgröße",
                  "nl": "Meet alleen fruitgrootte"
        },
        {
                  "en": "Only uses visual inspection by humans",
                  "es": "Solo usa inspección visual por humanos",
                  "de": "Verwendet nur visuelle Inspektion durch Menschen",
                  "nl": "Gebruikt alleen visuele inspectie door mensen"
        }
        ],
        correct: 0,
        explanation: {
