  ...
  const level2 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Early pterosaurs had long tails, late pterosaurs had short tails",
                  "es": "Los pterosaurios tempranos tenían colas largas, los tardíos tenían colas cortas",
                  "de": "Frühe Pterosaurier hatten lange Schwänze, späte Pterosaurier hatten kurze Schwänze",
                  "nl": "Vroege pterosauriërs hadden lange staarten, late pterosauriërs hadden korte staarten"
        },
        {
                  "en": "Early pterosaurs lived in water",
                  "es": "Los pterosaurios tempranos vivían en el agua",
                  "de": "Frühe Pterosaurier lebten im Wasser",
                  "nl": "Vroege pterosauriërs leefden in water"
        },
        {
                  "en": "Early pterosaurs were bigger than late ones",
                  "es": "Los pterosaurios tempranos eran más grandes que los tardíos",
                  "de": "Frühe Pterosaurier waren größer als späte",
                  "nl": "Vroege pterosauriërs waren groter dan late"
        },
        {
                  "en": "Early pterosaurs couldn't fly",
                  "es": "Los pterosaurios tempranos no podían volar",
                  "de": "Frühe Pterosaurier konnten nicht fliegen",
                  "nl": "Vroege pterosauriërs konden niet vliegen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "By swimming through the air",
                  "es": "Nadando a través del aire",
                  "de": "Durch Schwimmen durch die Luft",
                  "nl": "Door door de lucht te zwemmen"
        },
        {
                  "en": "By using magnetic navigation only",
                  "es": "Usando solo navegación magnética",
                  "de": "Nur durch magnetische Navigation",
                  "nl": "Alleen door magnetische navigatie te gebruiken"
        },
        {
                  "en": "By breathing fire to change direction",
                  "es": "Respirando fuego para cambiar de dirección",
                  "de": "Durch Feuerspeien um die Richtung zu ändern",
                  "nl": "Door vuur te ademen om van richting te veranderen"
        },
        {
                  "en": "By adjusting their wing shape and tail position",
                  "es": "Ajustando la forma de sus alas y la posición de la cola",
                  "de": "Durch Anpassen ihrer Flügelform und Schwanzposition",
                  "nl": "Door hun vleugelvorm en staartpositie aan te passen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Long, sharp, pointed teeth for catching fish",
                  "es": "Dientes largos, afilados y puntiagudos para atrapar peces",
                  "de": "Lange, scharfe, spitze Zähne zum Fischfang",
                  "nl": "Lange, scherpe, puntige tanden voor het vangen van vis"
        },
        {
                  "en": "Flat grinding teeth",
                  "es": "Dientes planos para moler",
                  "de": "Flache Mahlzähne",
                  "nl": "Platte maaltanden"
        },
        {
                  "en": "No teeth at all",
        ...
        {
                  "en": "Saw-like cutting teeth",
                  "es": "Dientes cortantes como sierra",
                  "de": "Sägenartige Schneidezähne",
                  "nl": "Zaagachtige snijdtanden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Their bones could bend like rubber",
                  "es": "Sus huesos podían doblarse como goma",
                  "de": "Ihre Knochen konnten sich wie Gummi biegen",
                  "nl": "Hun botten konden buigen als rubber"
        },
        {
                  "en": "They had hollow, air-filled bones like birds",
                  "es": "Tenían huesos huecos llenos de aire como las aves",
                  "de": "Sie hatten hohle, luftgefüllte Knochen wie Vögel",
                  "nl": "Ze hadden holle, met lucht gevulde botten zoals vogels"
        },
        {
                  "en": "Their bones were made of metal",
                  "es": "Sus huesos estaban hechos de metal",
                  "de": "Ihre Knochen bestanden aus Metall",
                  "nl": "Hun botten waren gemaakt van metaal"
        },
        {
                  "en": "They had extra thick bones",
                  "es": "Tenían huesos extra gruesos",
                  "de": "Sie hatten extra dicke Knochen",
                  "nl": "Ze hadden extra dikke botten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Young pterosaurs never ate food",
                  "es": "Los pterosaurios jóvenes nunca comían comida",
                  "de": "Junge Pterosaurier fraßen nie Nahrung",
                  "nl": "Jonge pterosauriërs aten nooit voedsel"
        },
        {
                  "en": "By regurgitating food directly into their mouths",
                  "es": "Regurgitando comida directamente en sus bocas",
                  "de": "Durch Auswürgen von Nahrung direkt in ihre Mäuler",
                  "nl": "Door voedsel direct in hun bekken op te geven"
        },
        {
                  "en": "By producing milk like mammals",
                  "es": "Produciendo leche como los mamíferos",
                  "de": "Durch Milchproduktion wie Säugetiere",
                  "nl": "Door melk te produceren zoals zoogdieren"
        },
        {
                  "en": "By teaching them to hunt immediately",
                  "es": "Enseñándoles a cazar inmediatamente",
                  "de": "Durch sofortiges Jagdtraining",
                  "nl": "Door hen meteen te leren jagen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They were completely waterproof",
                  "es": "Eran completamente impermeables",
                  "de": "Sie waren völlig wasserdicht",
                  "nl": "Ze waren volledig waterdicht"
        },
        {
                  "en": "They could heal quickly from small tears and holes",
                  "es": "Podían sanar rápidamente de pequeños desgarros y agujeros",
                  "de": "Sie konnten schnell von kleinen Rissen und Löchern heilen",
                  "nl": "Ze konden snel genezen van kleine scheuren en gaten"
        },
        {
                  "en": "They were much heavier and stronger",
                  "es": "Eran mucho más pesadas y fuertes",
                  "de": "Sie waren viel schwerer und stärker",
                  "nl": "Ze waren veel zwaarder en sterker"
        },
        {
                  "en": "They could change color instantly",
                  "es": "Podían cambiar de color instantáneamente",
                  "de": "Sie konnten sofort ihre Farbe ändern",
                  "nl": "Ze konden onmiddellijk van kleur veranderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Their tail that dragged behind them",
                  "es": "Su cola que arrastraban detrás",
                  "de": "Ihr Schwanz, den sie hinter sich herschleiften",
                  "nl": "Hun staart die achter hen sleepte"
        },
        {
                  "en": "They never walked, only flew",
                  "es": "Nunca caminaban, solo volaban",
                  "de": "Sie liefen nie, flogen nur",
                  "nl": "Ze liepen nooit, vlogen alleen"
        },
        {
                  "en": "Special wheels on their feet",
                  "es": "Ruedas especiales en sus pies",
                  "de": "Spezielle Räder an ihren Füßen",
                  "nl": "Speciale wielen aan hun voeten"
        },
        {
                  "en": "Their wing claws (first three fingers)",
                  "es": "Las garras de sus alas (primeros tres dedos)",
                  "de": "Ihre Flügelkrallen (erste drei Finger)",
                  "nl": "Hun vleugel klauwen (eerste drie vingers)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They had relatively large brains for complex flight control",
                  "es": "Tenían cerebros relativamente grandes para control complejo del vuelo",
                  "de": "Sie hatten relativ große Gehirne für komplexe Flugkontrolle",
                  "nl": "Ze hadden relatief grote hersenen voor complexe vliegcontrole"
        },
        {
                  "en": "They had no brains at all",
                  "es": "No tenían cerebro en absoluto",
                  "de": "Sie hatten gar keine Gehirne",
                  "nl": "Ze hadden helemaal geen hersenen"
        },
        {
                  "en": "Their brains were exactly like fish brains",
                  "es": "Sus cerebros eran exactamente como cerebros de peces",
                  "de": "Ihre Gehirne waren genau wie Fischgehirne",
                  "nl": "Hun hersenen waren precies zoals vissenhersenen"
        },
        {
                  "en": "Their brains were smaller than pea-sized",
                  "es": "Sus cerebros eran más pequeños que un guisante",
                  "de": "Ihre Gehirne waren kleiner als erbsengroß",
                  "nl": "Hun hersenen waren kleiner dan erwt-grootte"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Buried underground like moles",
                  "es": "Enterrados bajo tierra como topos",
                  "de": "Unter der Erde vergraben wie Maulwürfe",
                  "nl": "Begraven ondergronds zoals mollen"
        },
        {
                  "en": "Hanging upside down from cliffs or trees like bats",
                  "es": "Colgando boca abajo de acantilados o árboles como murciélagos",
                  "de": "Kopfüber hängend von Klippen oder Bäumen wie Fledermäuse",
                  "nl": "Ondersteboven hangend aan kliffen of bomen zoals vleermuizen"
        },
        {
                  "en": "Floating on water like ducks",
                  "es": "Flotando en el agua como patos",
                  "de": "Schwimmend auf dem Wasser wie Enten",
                  "nl": "Drijvend op water zoals eenden"
        },
        {
                  "en": "They never slept at all",
                  "es": "Nunca dormían en absoluto",
                  "de": "Sie schliefen überhaupt nie",
                  "nl": "Ze sliepen helemaal nooit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Their eyes faced backwards",
                  "es": "Sus ojos miraban hacia atrás",
                  "de": "Ihre Augen schauten nach hinten",
                  "nl": "Hun ogen keken naar achteren"
        },
        {
                  "en": "They could only see in black and white",
                  "es": "Solo podían ver en blanco y negro",
                  "de": "Sie konnten nur schwarz-weiß sehen",
                  "nl": "Ze konden alleen zwart-wit zien"
        },
        {
                  "en": "They were completely blind",
                  "es": "Eran completamente ciegos",
                  "de": "Sie waren völlig blind",
                  "nl": "Ze waren volledig blind"
        },
        {
                  "en": "They had excellent vision, better than most modern birds",
                  "es": "Tenían excelente visión, mejor que la mayoría de las aves modernas",
                  "de": "Sie hatten ausgezeichnetes Sehen, besser als die meisten modernen Vögel",
                  "nl": "Ze hadden uitstekend zicht, beter dan de meeste moderne vogels"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "By spinning webs to catch prey",
                  "es": "Tejiendo telarañas para atrapar presas",
                  "de": "Durch Spinnen von Netzen zum Beutefang",
                  "nl": "Door webben te spinnen om prooi te vangen"
        },
        {
                  "en": "By walking on land and stalking prey like giant storks",
                  "es": "Caminando en tierra y acechando presas como cigüeñas gigantes",
                  "de": "Durch Gehen an Land und Anpirschen von Beute wie riesige Störche",
                  "nl": "Door op land te lopen en prooi te besluipen zoals reuze ooievaars"
        },
        {
                  "en": "By eating only tree leaves",
                  "es": "Comiendo solo hojas de árboles",
                  "de": "Durch Fressen nur von Baumblättern",
                  "nl": "Door alleen boombladeren te eten"
        },
        {
                  "en": "By diving underwater like pelicans",
                  "es": "Buceando bajo el agua como pelícanos",
                  "de": "Durch Tauchen unter Wasser wie Pelikane",
                  "nl": "Door onder water te duiken zoals pelikanen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "About 10-11 meters (33-36 feet)",
                  "es": "Unos 10-11 metros (33-36 pies)",
                  "de": "Etwa 10-11 Meter (33-36 Fuß)",
                  "nl": "Ongeveer 10-11 meter (33-36 voet)"
        },
        {
                  "en": "About 5 meters (16 feet)",
                  "es": "Unos 5 metros (16 pies)",
                  "de": "Etwa 5 Meter (16 Fuß)",
                  "nl": "Ongeveer 5 meter (16 voet)"
        },
        {
                  "en": "About 2 meters (6 feet)",
                  "es": "Unos 2 metros (6 pies)",
                  "de": "Etwa 2 Meter (6 Fuß)",
                  "nl": "Ongeveer 2 meter (6 voet)"
        },
        {
                  "en": "About 20 meters (66 feet)",
                  "es": "Unos 20 metros (66 pies)",
                  "de": "Etwa 20 Meter (66 Fuß)",
                  "nl": "Ongeveer 20 meter (66 voet)"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Through telepathic thoughts only",
                  "es": "Solo a través de pensamientos telepáticos",
                  "de": "Nur durch telepathische Gedanken",
                  "nl": "Alleen door telepathische gedachten"
        },
        {
                  "en": "They never communicated at all",
                  "es": "Nunca se comunicaban en absoluto",
                  "de": "Sie kommunizierten überhaupt nie",
                  "nl": "Ze communiceerden helemaal nooit"
        },
        {
                  "en": "By writing messages in the sand",
                  "es": "Escribiendo mensajes en la arena",
                  "de": "Durch Schreiben von Nachrichten in den Sand",
                  "nl": "Door berichten in het zand te schrijven"
        },
        {
                  "en": "Through visual displays, calls, and crest coloring",
                  "es": "A través de exhibiciones visuales, llamadas y coloración de cresta",
                  "de": "Durch visuelle Darstellungen, Rufe und Kammfärbung",
                  "nl": "Door visuele vertoningen, roepen en kamkleuring"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Soft, leathery eggs like modern reptiles",
                  "es": "Huevos suaves y correosos como los reptiles modernos",
                  "de": "Weiche, ledrige Eier wie moderne Reptilien",
                  "nl": "Zachte, leerachtige eieren zoals moderne reptielen"
        },
        {
                  "en": "No eggs - they gave birth to live young",
                  "es": "Sin huevos - daban a luz crías vivas",
                  "de": "Keine Eier - sie brachten lebende Junge zur Welt",
                  "nl": "Geen eieren - ze brachten levende jongen ter wereld"
        },
        {
                  "en": "Hard, calcified eggs like birds",
                  "es": "Huevos duros y calcificados como las aves",
                  "de": "Harte, verkalkte Eier wie Vögel",
                  "nl": "Harde, verkalkte eieren zoals vogels"
        },
        {
                  "en": "Glass eggs that were transparent",
                  "es": "Huevos de vidrio que eran transparentes",
                  "de": "Glaseier, die durchsichtig waren",
                  "nl": "Glazen eieren die doorzichtig waren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To help digest fish bones",
                  "es": "Para ayudar a digerir espinas de peces",
                  "de": "Zum Verdauen von Fischgräten",
                  "nl": "Om visgraten te verteren"
        },
        {
                  "en": "To produce sounds for communication",
                  "es": "Para producir sonidos para comunicación",
                  "de": "Zur Schallerzeugung für Kommunikation",
                  "nl": "Om geluiden te produceren voor communicatie"
        },
        {
                  "en": "To support the front edge of the wing membrane",
                  "es": "Para soportar el borde frontal de la membrana del ala",
                  "de": "Zur Stützung der Vorderkante der Flügelmembran",
                  "nl": "Om de voorrand van het vleugelmembraan te ondersteunen"
        },
        {
                  "en": "To store calcium for egg production",
                  "es": "Para almacenar calcio para la producción de huevos",
                  "de": "Zur Kalziumspeicherung für Eierproduktion",
                  "nl": "Om calcium op te slaan voor eierproductie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Using landmarks, coastlines, and possibly magnetic fields",
                  "es": "Usando puntos de referencia, costas y posiblemente campos magnéticos",
                  "de": "Mit Landmarken, Küstenlinien und möglicherweise Magnetfeldern",
                  "nl": "Met behulp van oriëntatiepunten, kustlijnen en mogelijk magnetische velden"
        },
        {
                  "en": "Using echolocation like bats",
                  "es": "Usando ecolocalización como los murciélagos",
                  "de": "Mit Echoortung wie Fledermäuse",
                  "nl": "Met echolocatie zoals vleermuizen"
        },
        {
                  "en": "They never flew long distances",
                  "es": "Nunca volaron largas distancias",
                  "de": "Sie flogen nie lange Strecken",
                  "nl": "Ze vlogen nooit lange afstanden"
        }
        ],
        correct: 1,
        explanation: {
