    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "The Solnhofen pterosaurs of Germany",
                  "es": "Los pterosaurios de Solnhofen de Alemania",
                  "de": "Die Solnhofen-Pterosaurier Deutschlands",
                  "nl": "De Solnhofen pterosauriërs van Duitsland"
        },
        {
                  "en": "The Morrison Formation finds",
                  "es": "Los hallazgos de la Formación Morrison",
                  "de": "Die Morrison-Formation-Funde",
                  "nl": "De Morrison Formatie vondsten"
        },
        {
                  "en": "Underwater cave discoveries",
                  "es": "Descubrimientos en cuevas submarinas",
                  "de": "Unterwasserhöhlen-Entdeckungen",
                  "nl": "Onderwatergrot ontdekkingen"
        },
        {
                  "en": "Antarctic pterosaur fossils",
                  "es": "Fósiles de pterosaurios antárticos",
                  "de": "Antarktische Pterosaurier-Fossilien",
                  "nl": "Antarctische pterosauriër fossielen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Specialized jaw shapes and wear patterns on teeth",
                  "es": "Formas especializadas de mandíbula y patrones de desgaste en dientes",
                  "de": "Spezialisierte Kieferformen und Abnutzungsmuster an Zähnen",
                  "nl": "Gespecialiseerde kaakvormen en slijtagepartronen op tanden"
        },
        {
                  "en": "Fossilized fishing nets found nearby",
                  "es": "Redes de pesca fosilizadas encontradas cerca",
                  "de": "Versteinerte Fischernetze in der Nähe gefunden",
                  "nl": "Gefossiliseerde visnetten gevonden in de buurt"
        },
        {
                  "en": "Ancient fish bones in their stomachs only",
                  "es": "Solo huesos de peces antiguos en sus estómagos",
                  "de": "Nur alte Fischknochen in ihren Mägen",
                  "nl": "Alleen oude visgraten in hun magen"
        },
        {
                  "en": "Written records from ancient civilizations",
                  "es": "Registros escritos de civilizaciones antiguas",
                  "de": "Schriftliche Aufzeichnungen alter Zivilisationen",
                  "nl": "Geschreven verslagen van oude beschavingen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It preserved evidence of dense fur covering the body",
                  "es": "Preservó evidencia de pelaje denso cubriendo el cuerpo",
                  "de": "Es erhielt Beweise für dichten Pelz, der den Körper bedeckte",
                  "nl": "Het bewaarde bewijs van dichte vacht die het lichaam bedekte"
        },
        {
                  "en": "It could change color like a chameleon",
                  "es": "Podía cambiar de color como un camaleón",
                  "de": "Es konnte die Farbe wie ein Chamäleon wechseln",
                  "nl": "Het kon van kleur veranderen zoals een kameleon"
        },
        {
                  "en": "It was made of metal instead of skin",
                  "es": "Estaba hecho de metal en lugar de piel",
                  "de": "Es bestand aus Metall statt aus Haut",
                  "nl": "Het was gemaakt van metaal in plaats van huid"
        },
        {
                  "en": "It was completely transparent",
                  "es": "Era completamente transparente",
                  "de": "Es war völlig durchsichtig",
                  "nl": "Het was volledig doorzichtig"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Loss of tail and development of wrist joint for wing folding",
                  "es": "Pérdida de cola y desarrollo de articulación de muñeca para plegado de ala",
                  "de": "Verlust des Schwanzes und Entwicklung des Handgelenks zum Flügelfalten",
                  "nl": "Verlies van staart en ontwikkeling van polsgewricht voor vleugelplooiing"
        },
        {
                  "en": "Developing internal combustion engines",
                  "es": "Desarrollando motores de combustión interna",
                  "de": "Entwicklung von Verbrennungsmotoren",
                  "nl": "Interne verbrandingsmotoren ontwikkelen"
        },
        {
                  "en": "Shrinking to insect size",
                  "es": "Encogiéndose a tamaño de insecto",
                  "de": "Schrumpfung auf Insektengröße",
                  "nl": "Krimpen tot insectengrootte"
        },
        {
                  "en": "Growing extra pairs of wings",
                  "es": "Creciendo pares extra de alas",
                  "de": "Wachsende zusätzliche Flügelpaare",
                  "nl": "Extra paren vleugels ontwikkelen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating music for mating calls",
                  "es": "Crear música para llamadas de apareamiento",
                  "de": "Musik für Paarungsrufe erzeugen",
                  "nl": "Muziek maken voor paringsroepen"
        },
        {
                  "en": "Storing helium to make them float",
                  "es": "Almacenar helio para hacerlos flotar",
                  "de": "Helium speichern um sie schweben zu lassen",
                  "nl": "Helium opslaan om ze te laten drijven"
        },
        {
                  "en": "Breathing underwater for diving",
                  "es": "Respirar bajo el agua para bucear",
                  "de": "Unterwasser atmen zum Tauchen",
                  "nl": "Onder water ademen voor duiken"
        },
        {
                  "en": "Weight reduction while maintaining structural strength for flight",
                  "es": "Reducción de peso manteniendo fuerza estructural para vuelo",
                  "de": "Gewichtsreduktion bei Beibehaltung der Strukturfestigkeit für den Flug",
                  "nl": "Gewichtsvermindering terwijl structurele sterkte voor vlucht behouden bleef"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They had no brains at all",
                  "es": "No tenían cerebros en absoluto",
                  "de": "Sie hatten überhaupt keine Gehirne",
                  "nl": "Ze hadden helemaal geen hersenen"
        },
        {
                  "en": "Much smaller than any living animal",
                  "es": "Mucho más pequeño que cualquier animal viviente",
                  "de": "Viel kleiner als jedes lebende Tier",
                  "nl": "Veel kleiner dan enig levend dier"
        },
        {
                  "en": "Larger than whale brains",
                  "es": "Más grande que cerebros de ballena",
                  "de": "Größer als Walgehirne",
                  "nl": "Groter dan walvishersenen"
        },
        {
                  "en": "Similar to modern birds, indicating high intelligence",
                  "es": "Similar a aves modernas, indicando alta inteligencia",
                  "de": "Ähnlich modernen Vögeln, was auf hohe Intelligenz hindeutet",
                  "nl": "Vergelijkbaar met moderne vogels, wat hoge intelligentie aangeeft"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ancient breeding manuals",
                  "es": "Manuales de cría antiguos",
                  "de": "Alte Zuchthandbücher",
                  "nl": "Oude fokhandleidingen"
        },
        {
                  "en": "Fossilized eggs with preserved embryos",
                  "es": "Huevos fosilizados con embriones preservados",
                  "de": "Versteinerte Eier mit erhaltenen Embryonen",
                  "nl": "Gefossiliseerde eieren met geconserveerde embryo's"
        },
        {
                  "en": "Time travel observations",
                  "es": "Observaciones de viajes en el tiempo",
                  "de": "Zeitreise-Beobachtungen",
                  "nl": "Tijdreizen observaties"
        },
        {
                  "en": "Live pterosaurs found in remote caves",
                  "es": "Pterosaurios vivos encontrados en cuevas remotas",
                  "de": "Lebende Pterosaurier in abgelegenen Höhlen gefunden",
                  "nl": "Levende pterosauriërs gevonden in afgelegen grotten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Maximum 2 meters wingspan",
                  "es": "Máximo 2 metros de envergadura",
                  "de": "Maximal 2 Meter Spannweite",
                  "nl": "Maximum 2 meter spanwijdte"
        },
        {
                  "en": "No limit - they could grow infinitely large",
                  "es": "Sin límite - podían crecer infinitamente grandes",
                  "de": "Keine Grenze - sie konnten unendlich groß werden",
                  "nl": "Geen limiet - ze konden oneindig groot worden"
        },
        {
                  "en": "12-15 meters due to structural and atmospheric constraints",
                  "es": "12-15 metros debido a restricciones estructurales y atmosféricas",
                  "de": "12-15 Meter aufgrund struktureller und atmosphärischer Beschränkungen",
                  "nl": "12-15 meter vanwege structurele en atmosferische beperkingen"
        },
        {
                  "en": "50 meters like commercial aircraft",
                  "es": "50 metros como aviones comerciales",
                  "de": "50 Meter wie Verkehrsflugzeuge",
                  "nl": "50 meter zoals commerciële vliegtuigen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "A cooling system for overheated flight",
                  "es": "Un sistema de enfriamiento para vuelo sobrecalentado",
                  "de": "Ein Kühlsystem für überhitzten Flug",
                  "nl": "Een koelsysteem voor oververhitte vlucht"
        },
        {
                  "en": "A special organ for producing sounds",
                  "es": "Un órgano especial para producir sonidos",
                  "de": "Ein spezielles Organ zur Schallerzeugung",
                  "nl": "Een speciaal orgaan voor het produceren van geluiden"
        },
        {
                  "en": "A storage compartment for extra food",
                  "es": "Un compartimento de almacenamiento para comida extra",
                  "de": "Ein Lagerraum für zusätzliche Nahrung",
                  "nl": "Een opslagcompartiment voor extra voedsel"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Urban construction sites",
                  "es": "Sitios de construcción urbana",
                  "de": "Städtische Baustellen",
                  "nl": "Stedelijke bouwplaatsen"
        },
        {
                  "en": "The Kem Kem beds of Morocco",
                  "es": "Los lechos Kem Kem de Marruecos",
                  "de": "Die Kem Kem-Schichten Marokkos",
                  "nl": "De Kem Kem lagen van Marokko"
        },
        {
                  "en": "The Arctic ice sheets",
                  "es": "Las capas de hielo del Ártico",
                  "de": "Die arktischen Eisschichten",
                  "nl": "De Arctische ijslagen"
        },
        {
                  "en": "Yellowstone National Park",
                  "es": "Parque Nacional Yellowstone",
                  "de": "Yellowstone-Nationalpark",
                  "nl": "Yellowstone Nationaal Park"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "60-80 km/h (similar to large modern birds)",
                  "es": "60-80 km/h (similar a aves grandes modernas)",
                  "de": "60-80 km/h (ähnlich großen modernen Vögeln)",
                  "nl": "60-80 km/h (vergelijkbaar met grote moderne vogels)"
        },
        {
                  "en": "Only 5 km/h like a walking human",
                  "es": "Solo 5 km/h como un humano caminando",
                  "de": "Nur 5 km/h wie ein gehender Mensch",
                  "nl": "Slechts 5 km/h zoals een lopend mens"
        },
        {
                  "en": "They couldn't actually fly",
                  "es": "En realidad no podían volar",
                  "de": "Sie konnten eigentlich nicht fliegen",
                  "nl": "Ze konden eigenlijk niet vliegen"
        },
        {
                  "en": "Over 500 km/h like jet aircraft",
                  "es": "Más de 500 km/h como aviones a reacción",
                  "de": "Über 500 km/h wie Düsenflugzeuge",
                  "nl": "Meer dan 500 km/h zoals straaljagers"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Large head crests for display",
                  "es": "Crestas de cabeza grandes para exhibición",
                  "de": "Große Kopfkämme zur Zurschaustellung",
                  "nl": "Grote hoofdkammen voor vertoon"
        },
        {
                  "en": "Extra pairs of eyes",
                  "es": "Pares extra de ojos",
                  "de": "Zusätzliche Augenpaare",
                  "nl": "Extra paren ogen"
        },
        {
                  "en": "Metallic scales",
                  "es": "Escamas metálicas",
                  "de": "Metallische Schuppen",
                  "nl": "Metalen schubben"
        },
        {
                  "en": "The ability to breathe fire",
                  "es": "La capacidad de respirar fuego",
                  "de": "Die Fähigkeit Feuer zu atmen",
                  "nl": "Het vermogen om vuur te ademen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They had no metabolism",
                  "es": "No tenían metabolismo",
                  "de": "Sie hatten keinen Stoffwechsel",
                  "nl": "Ze hadden geen metabolisme"
        },
        {
                  "en": "Identical to cold-blooded lizards",
                  "es": "Idéntica a lagartos de sangre fría",
                  "de": "Identisch mit kaltblütigen Echsen",
                  "nl": "Identiek aan koudbloedige hagedissen"
        },
        {
                  "en": "Lower than any known animal",
                  "es": "Más baja que cualquier animal conocido",
                  "de": "Niedriger als jedes bekannte Tier",
                  "nl": "Lager dan enig bekend dier"
        },
        {
                  "en": "Much higher, similar to modern birds and mammals",
                  "es": "Mucho más alta, similar a aves y mamíferos modernos",
                  "de": "Viel höher, ähnlich modernen Vögeln und Säugetieren",
                  "nl": "Veel hoger, vergelijkbaar met moderne vogels en zoogdieren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Vegetarian diet evidence",
                  "es": "Evidencia de dieta vegetariana",
                  "de": "Beweis für vegetarische Ernährung",
                  "nl": "Vegetarisch dieet bewijs"
        },
        {
                  "en": "Hatzegopteryx with evidence of terrestrial predation",
                  "es": "Hatzegopteryx con evidencia de depredación terrestre",
                  "de": "Hatzegopteryx mit Beweisen für terrestrische Beutejagd",
                  "nl": "Hatzegopteryx met bewijs van terrestrische predatie"
        },
        {
                  "en": "Ancient fishing equipment found nearby",
                  "es": "Equipo de pesca antiguo encontrado cerca",
                  "de": "Alte Fischereiausrüstung in der Nähe gefunden",
                  "nl": "Oude visspullen gevonden in de buurt"
        },
        {
                  "en": "Flying fish fossils in their stomachs",
                  "es": "Fósiles de peces voladores en sus estómagos",
                  "de": "Fliegende Fischfossilien in ihren Mägen",
                  "nl": "Vliegende vis fossielen in hun magen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Solitary individuals with no social contact",
                  "es": "Individuos solitarios sin contacto social",
                  "de": "Einzelgänger ohne sozialen Kontakt",
                  "nl": "Solitaire individuen zonder sociaal contact"
        },
        {
                  "en": "Underground city networks",
                  "es": "Redes de ciudades subterráneas",
                  "de": "Unterirdische Stadtnetzwerke",
                  "nl": "Ondergrondse stadsnetwerken"
        },
        {
                  "en": "Military-style hierarchical organizations",
                  "es": "Organizaciones jerárquicas de estilo militar",
                  "de": "Militärische hierarchische Organisationen",
                  "nl": "Militaire hiërarchische organisaties"
        },
        {
                  "en": "Large communal nesting colonies like modern seabirds",
                  "es": "Grandes colonias de anidación comunal como aves marinas modernas",
                  "de": "Große Gemeinschaftsnistkolonien wie moderne Seevögel",
                  "nl": "Grote gemeenschappelijke nestkolonies zoals moderne zeevogels"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Time travel capabilities",
                  "es": "Capacidades de viaje en el tiempo",
                  "de": "Zeitreisefähigkeiten",
                  "nl": "Tijdreizen mogelijkheden"
        },
        {
                  "en": "The evolution of powered flight before birds dominated the skies",
                  "es": "La evolución del vuelo motorizado antes de que las aves dominaran los cielos",
                  "de": "Die Evolution des Motorflugs bevor Vögel den Himmel dominierten",
                  "nl": "De evolutie van gemotoriseerde vlucht voordat vogels de luchten domineerden"
        },
        {
                  "en": "The ability to become invisible",
                  "es": "La capacidad de volverse invisible",
                  "de": "Die Fähigkeit unsichtbar zu werden",
                  "nl": "Het vermogen om onzichtbaar te worden"
        },
        {
                  "en": "Cooperation with dinosaurs",
                  "es": "Cooperación con dinosaurios",
                  "de": "Kooperation mit Dinosauriern",
                  "nl": "Samenwerking met dinosaurussen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Wing loading was impossible to measure",
                  "es": "La carga alar era imposible de medir",
                  "de": "Flügelbelastung war unmöglich zu messen",
                  "nl": "Vleugelbelasting was onmogelijk te meten"
        },
        {
                  "en": "They had no wings at all",
                  "es": "No tenían alas en absoluto",
                  "de": "Sie hatten überhaupt keine Flügel",
                  "nl": "Ze hadden helemaal geen vleugels"
        },
        {
                  "en": "Low wing loading enabled efficient soaring and gliding like modern albatrosses",
                  "es": "Baja carga alar permitía planeo y deslizamiento eficientes como albatros modernos",
                  "de": "Niedrige Flügelbelastung ermöglichte effizientes Segeln und Gleiten wie moderne Albatrosse",
                  "nl": "Lage vleugelbelasting maakte efficiënt zweven en glijden mogelijk zoals moderne albatrossen"
        },
        {
                  "en": "Very high wing loading required constant flapping",
                  "es": "Carga alar muy alta requería aleteo constante",
                  "de": "Sehr hohe Flügelbelastung erforderte konstantes Flügelschlagen",
                  "nl": "Zeer hoge vleugelbelasting vereiste constant klapperen"
        }
        ],
        correct: 2,
        explanation: {
