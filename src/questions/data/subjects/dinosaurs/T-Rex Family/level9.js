// T-Rex Family Quiz - Level 9: Expert/Scientific Knowledge
(function() {
  const level9 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Individual age, growth rate changes, and sexual maturity timing", es: "Edad individual, cambios en tasa de crecimiento y tiempo de madurez sexual", de: "Individuelles Alter, Wachstumsratenänderungen und Zeitpunkt der Geschlechtsreife", nl: "Individuele leeftijd, groeisnelheid veranderingen en timing van geslachtsrijpheid" },
          { en: "Only the animal's total age", es: "Solo la edad total del animal", de: "Nur das Gesamtalter des Tieres", nl: "Alleen de totale leeftijd van het dier" },
          { en: "Only diseases the animal suffered", es: "Solo enfermedades que sufrió el animal", de: "Nur Krankheiten, die das Tier erlitt", nl: "Alleen ziektes die het dier had" },
          { en: "Environmental temperature variations", es: "Variaciones de temperatura ambiental", de: "Umgebungstemperaturschwankungen", nl: "Omgevingstemperatuur variaties" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Body temperature and potential endothermy evidence", es: "Temperatura corporal y evidencia potencial de endotermia", de: "Körpertemperatur und potenzielle Endothermie-Beweise", nl: "Lichaamstemperatuur en potentieel endothermie bewijs" },
          ...
          { en: "The animal's diet composition", es: "La composición de la dieta del animal", de: "Die Nahrungszusammensetzung des Tieres", nl: "De dieetsamenstelling van het dier" },
          { en: "How fast the animal could run", es: "Qué tan rápido podía correr el animal", de: "Wie schnell das Tier laufen konnte", nl: "Hoe snel het dier kon rennen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Finite Element Analysis (FEA)", es: "Análisis de Elementos Finitos (FEA)", de: "Finite-Elemente-Analyse (FEA)", nl: "Eindige Elementen Analyse (FEA)" },
          ...
          { en: "DNA sequencing techniques", es: "Técnicas de secuenciación de ADN", de: "DNA-Sequenzierungstechniken", nl: "DNA-sequentie technieken" },
          { en: "Radiometric age determination", es: "Determinación de edad radiométrica", de: "Radiometrische Altersbestimmung", nl: "Radiometrische leeftijdsbepaling" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Large body size, robust skulls, and highly reduced forelimbs with two functional digits", es: "Gran tamaño corporal, cráneos robustos y extremidades delanteras altamente reducidas con dos dígitos funcionales", de: "Große Körpergröße, robuste Schädel und stark reduzierte Vordergliedmaßen mit zwei funktionalen Fingern", nl: "Grote lichaamsgrootte, robuuste schedels en sterk gereduceerde voorpoten met twee functionele vingers" },
          { en: "Small size and three-fingered hands", es: "Tamaño pequeño y manos de tres dedos", de: "Kleine Größe und dreifingerige Hände", nl: "Kleine omvang en drievingerde handen" },
          { en: "Herbivorous diet and long necks", es: "Dieta herbívora y cuellos largos", de: "Pflanzenfressende Ernährung und lange Hälse", nl: "Herbivoor dieet en lange nekken" },
          { en: "Aquatic lifestyle and webbed feet", es: "Estilo de vida acuático y pies palmeados", de: "Aquatischer Lebensstil und Schwimmfüße", nl: "Aquatische levensstijl en zwemvliezen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Large olfactory bulbs, well-developed optic lobes, and enhanced auditory regions", es: "Grandes bulbos olfatorios, lóbulos ópticos bien desarrollados y regiones auditivas mejoradas", de: "Große Riechkolben, gut entwickelte optische Lappen und verbesserte auditive Regionen", nl: "Grote reukbollen, goed ontwikkelde optische kwabben en verbeterde auditieve regio's" },
          { en: "Small brain with no special sensory adaptations", es: "Cerebro pequeño sin adaptaciones sensoriales especiales", de: "Kleines Gehirn ohne spezielle sensorische Anpassungen", nl: "Klein brein zonder speciale zintuiglijke aanpassingen" },
          { en: "Only visual processing areas", es: "Solo áreas de procesamiento visual", de: "Nur visuelle Verarbeitungsbereiche", nl: "Alleen visuele verwerkingsgebieden" },
          { en: "Identical brain structure to modern reptiles", es: "Estructura cerebral idéntica a reptiles modernos", de: "Identische Gehirnstruktur zu modernen Reptilien", nl: "Identieke hersenstructuur als moderne reptielen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Rapid growth spurt during adolescence, reaching adult size in late teens", es: "Brote de crecimiento rápido durante adolescencia, alcanzando tamaño adulto al final de la adolescencia", de: "Schneller Wachstumsschub während der Adoleszenz, Erreichen der Erwachsenengröße in den späten Teenagerjahren", nl: "Snelle groeispurt tijdens adolescentie, volwassen grootte bereikend in late tienerjaren" },
          { en: "Continuous slow growth throughout entire life", es: "Crecimiento lento continuo durante toda la vida", de: "Kontinuierliches langsames Wachstum während des gesamten Lebens", nl: "Continue langzame groei gedurende het hele leven" },
          { en: "Reached full size within the first year of life", es: "Alcanzaron tamaño completo dentro del primer año de vida", de: "Erreichten volle Größe innerhalb des ersten Lebensjahres", nl: "Bereikten volledige grootte binnen het eerste levensjaar" },
          { en: "No growth after hatching", es: "Sin crecimiento después de eclosionar", de: "Kein Wachstum nach dem Schlüpfen", nl: "Geen groei na het uitkomen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Healed bite marks, broken ribs, and infected bones suggesting intraspecific combat and survival of serious injuries", es: "Marcas de mordida curadas, costillas rotas y huesos infectados sugiriendo combate intraespecífico y supervivencia de lesiones graves", de: "Verheilte Bissspuren, gebrochene Rippen und infizierte Knochen deuten auf intraspezifischen Kampf und Überleben schwerer Verletzungen hin", nl: "Genezen bijtwonden, gebroken ribben en geïnfecteerde botten suggereren intraspecifieke strijd en overleving van ernstige verwondingen" },
          { en: "Perfect skeletons with no injuries", es: "Esqueletos perfectos sin lesiones", de: "Perfekte Skelette ohne Verletzungen", nl: "Perfecte skeletten zonder verwondingen" },
          { en: "Only tooth decay evidence", es: "Solo evidencia de caries dental", de: "Nur Hinweise auf Zahnfäule", nl: "Alleen tandverval bewijs" },
          { en: "Signs of fossilization damage only", es: "Solo señales de daño por fossilización", de: "Nur Anzeichen von Fossilisierungsschäden", nl: "Alleen tekenen van fossilisatie schade" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Tooth marks on prey bones, coprolites with bone fragments, and evidence of both hunting and scavenging", es: "Marcas de dientes en huesos de presas, coprolitos con fragmentos óseos y evidencia de caza y carroñeo", de: "Zahnspuren an Beuteknochen, Koprolithen mit Knochenfragmenten und Beweise für Jagd und Aasfresserei", nl: "Tandsporen op prooibotten, coprolithen met botfragmenten en bewijs van zowel jagen als aaseteren" },
          { en: "No feeding traces preserved in fossil record", es: "Sin rastros de alimentación preservados en registro fósil", de: "Keine Fressspuren im Fossilienbestand erhalten", nl: "Geen voedingssporen bewaard in fossiel record" },
          { en: "Evidence of plant consumption only", es: "Evidencia de consumo de plantas solo", de: "Nur Hinweise auf Pflanzenkonsum", nl: "Alleen bewijs van plantenconsumptie" },
          { en: "Filter-feeding adaptations", es: "Adaptaciones de alimentación por filtración", de: "Filterfütterungsanpassungen", nl: "Filtervoedings aanpassingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Thick enamel and dentin structure optimized for resisting fracture during bone-crushing", es: "Esmalte grueso y estructura de dentina optimizados para resistir fracturas durante trituración de huesos", de: "Dicker Zahnschmelz und Dentinstruktur optimiert für Bruchresistenz beim Knochenzertrümmern", nl: "Dikke glazuur en dentine structuur geoptimaliseerd voor weerstand tegen breuk tijdens botverplettering" },
          { en: "Thin enamel suitable only for soft tissue", es: "Esmalte delgado adecuado solo para tejido blando", de: "Dünner Schmelz nur für Weichgewebe geeignet", nl: "Dunne glazuur geschikt alleen voor zacht weefsel" },
          { en: "Porous structure for filter feeding", es: "Estructura porosa para alimentación por filtración", de: "Poröse Struktur für Filterfütterung", nl: "Poreuze structuur voor filtervoeding" },
          { en: "Hollow teeth for venom delivery", es: "Dientes huecos para entrega de veneno", de: "Hohle Zähne für Giftabgabe", nl: "Holle tanden voor gif afgifte" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cladistic analysis using morphological character matrices with parsimony algorithms", es: "Análisis cladístico usando matrices de caracteres morfológicos con algoritmos de parsimonia", de: "Kladistische Analyse unter Verwendung morphologischer Charaktermatrizen mit Parsimonie-Algorithmen", nl: "Cladistische analyse met morfologische karakter matrices met parsimonie algoritmen" },
          { en: "DNA sequencing and comparison", es: "Secuenciación y comparación de ADN", de: "DNA-Sequenzierung und -Vergleich", nl: "DNA sequencing en vergelijking" },
          { en: "Measuring skull length only", es: "Midiendo solo longitud del cráneo", de: "Nur Schädellänge messen", nl: "Alleen schedel lengte meten" },
          { en: "Geographic distribution patterns", es: "Patrones de distribución geográfica", de: "Geografische Verteilungsmuster", nl: "Geografische distributie patronen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Forward-facing orbits providing 55-degree binocular overlap for depth perception", es: "Órbitas orientadas hacia adelante proporcionando superposición binocular de 55 grados para percepción de profundidad", de: "Nach vorne gerichtete Augenhöhlen mit 55-Grad binokularer Überlappung für Tiefenwahrnehmung", nl: "Naar voren gerichte oogkassen met 55-graden binoculaire overlap voor diepteperceptie" },
          { en: "Eyes on sides of head like modern lizards", es: "Ojos a los lados de la cabeza como lagartos modernos", de: "Augen an den Seiten des Kopfes wie moderne Eidechsen", nl: "Ogen aan zijkanten van hoofd zoals moderne hagedissen" },
          ...
          { en: "No orbital specialization", es: "Sin especialización orbital", de: "Keine orbitale Spezialisierung", nl: "Geen orbitale specialisatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Extensive air sacs connected to respiratory system, reducing skull weight while maintaining strength", es: "Extensos sacos de aire conectados al sistema respiratorio, reduciendo peso del cráneo mientras mantienen fuerza", de: "Ausgedehnte Luftsäcke verbunden mit Atmungssystem, Reduzierung des Schädelgewichts bei Erhaltung der Stärke", nl: "Uitgebreide luchtzakken verbonden met ademhalingssysteem, schedel gewicht verminderend terwijl sterkte behouden blijft" },
          { en: "Solid bone throughout with no air spaces", es: "Hueso sólido en todo sin espacios de aire", de: "Durchgehend fester Knochen ohne Lufträume", nl: "Massief bot overal zonder luchtruimtes" },
          { en: "Water-filled cavities for aquatic life", es: "Cavidades llenas de agua para vida acuática", de: "Wassergefüllte Hohlräume für aquatisches Leben", nl: "Watergefulde holtes voor aquatisch leven" },
          { en: "Venom storage chambers", es: "Cámaras de almacenamiento de veneno", de: "Giftlagerkammern", nl: "Gif opslag kamers" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Gracile build, longer legs, and blade-like teeth in juveniles transitioning to robust build and bone-crushing teeth in adults", es: "Constitución grácil, piernas más largas y dientes en forma de cuchilla en juveniles transitando a constitución robusta y dientes trituradores de huesos en adultos", de: "Graziler Bau, längere Beine und klingenartige Zähne bei Jungtieren, Übergang zu robustem Bau und knochenzertrümmernden Zähnen bei Erwachsenen", nl: "Graciele bouw, langere benen en mesachtige tanden in juvenielen overgaand naar robuuste bouw en botverplettererende tanden in volwassenen" },
          { en: "No changes from juvenile to adult", es: "Sin cambios de juvenil a adulto", de: "Keine Veränderungen von juvenil zu erwachsen", nl: "Geen veranderingen van juveniel tot volwassen" },
          { en: "Juveniles were aquatic, adults terrestrial", es: "Juveniles eran acuáticos, adultos terrestres", de: "Jungtiere waren aquatisch, Erwachsene terrestrisch", nl: "Juvenielen waren aquatisch, volwassenen terrestrisch" },
          { en: "Adults were smaller than juveniles", es: "Adultos eran más pequeños que juveniles", de: "Erwachsene waren kleiner als Jungtiere", nl: "Volwassenen waren kleiner dan juvenielen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Muscle modeling suggests 17-25 mph maximum speed; bone stress analysis shows leg bones would fracture at higher speeds", es: "Modelado muscular sugiere velocidad máxima de 17-25 mph; análisis de estrés óseo muestra que huesos de piernas se fracturarían a velocidades mayores", de: "Muskelmodellierung deutet auf 17-25 mph Höchstgeschwindigkeit; Knochenspannungsanalyse zeigt, dass Beinknochen bei höheren Geschwindigkeiten brechen würden", nl: "Spiermodellering suggereert 17-25 mph maximum snelheid; botstress analyse toont dat beenbotten zouden breken bij hogere snelheden" },
          { en: "Evidence supports speeds over 60 mph", es: "Evidencia apoya velocidades sobre 60 mph", de: "Beweise unterstützen Geschwindigkeiten über 60 mph", nl: "Bewijs ondersteunt snelheden boven 60 mph" },
          { en: "Tyrannosaurids could not walk, only crawl", es: "Tiranosáuridos no podían caminar, solo arrastrarse", de: "Tyrannosauriden konnten nicht laufen, nur kriechen", nl: "Tyrannosauriden konden niet lopen, alleen kruipen" },
          { en: "They moved by hopping like kangaroos", es: "Se movían saltando como canguros", de: "Sie bewegten sich durch Hüpfen wie Kängurus", nl: "Ze bewogen door te hoppen zoals kangoeroes" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The individual was a reproductively active female with calcium reserves for egg production", es: "El individuo era una hembra reproductivamente activa con reservas de calcio para producción de huevos", de: "Das Individuum war ein reproduktiv aktives Weibchen mit Kalziumreserven für Eierproduktion", nl: "Het individu was een reproductief actief vrouwtje met calcium reserves voor eieren productie" },
          { en: "The dinosaur had a bone disease", es: "El dinosaurio tenía una enfermedad ósea", de: "Der Dinosaurier hatte eine Knochenkrankheit", nl: "De dinosaurus had een botziekte" },
          { en: "The specimen was a juvenile", es: "El espécimen era un juvenil", de: "Das Exemplar war ein Jungtier", nl: "Het specimen was een juveniel" },
          { en: "The fossil was contaminated during preservation", es: "El fósil fue contaminado durante preservación", de: "Das Fossil wurde während der Erhaltung kontaminiert", nl: "Het fossiel was gecontamineerd tijdens bewaring" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Rapid burial in fine sediments with specific geochemical conditions preventing complete degradation", es: "Entierro rápido en sedimentos finos con condiciones geoquímicas específicas previniendo degradación completa", de: "Schnelle Bestattung in feinen Sedimenten mit spezifischen geochemischen Bedingungen, die vollständige Degradation verhindern", nl: "Snelle begraving in fijne sedimenten met specifieke geochemische condities die volledige degradatie voorkomen" },
          { en: "All fossils contain soft tissue if examined closely", es: "Todos los fósiles contienen tejido blando si se examinan de cerca", de: "Alle Fossilien enthalten Weichgewebe, wenn sie genau untersucht werden", nl: "Alle fossielen bevatten zacht weefsel als ze nauwkeurig onderzocht worden" },
          { en: "Soft tissue preservation requires freezing conditions", es: "Preservación de tejido blando requiere condiciones de congelación", de: "Weichgewebserhaltung erfordert Gefrierbedingungen", nl: "Zacht weefsel bewaring vereist bevriezingscondities" },
          { en: "The soft tissue is actually modern contamination", es: "El tejido blando es en realidad contaminación moderna", de: "Das Weichgewebe ist tatsächlich moderne Kontamination", nl: "Het zachte weefsel is eigenlijk moderne besmetting" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Progressive fusion from snout to braincase correlates with skeletal maturity and can help age specimens", es: "Fusión progresiva desde hocico a caja craneal se correlaciona con madurez esquelética y puede ayudar a determinar edad de especímenes", de: "Progressive Fusion von Schnauze zu Gehirngehäuse korreliert mit Skelettreife und kann bei der Altersbestimmung von Exemplaren helfen", nl: "Progressieve fusie van snuit naar hersenkas correleert met skeletale rijpheid en kan helpen specimens te dateren" },
          { en: "All skull bones fuse at hatching", es: "Todos los huesos del cráneo se fusionan al eclosionar", de: "Alle Schädelknochen fusionieren beim Schlüpfen", nl: "Alle schedel botten fuseren bij het uitkomen" },
          { en: "Skull bones never fuse in tyrannosaurids", es: "Huesos del cráneo nunca se fusionan en tiranosáuridos", de: "Schädelknochen fusionieren nie bei Tyrannosauriden", nl: "Schedel botten fuseren nooit in tyrannosauriden" },
          { en: "Fusion patterns are random and unreliable", es: "Patrones de fusión son aleatorios y poco fiables", de: "Fusionsmuster sind zufällig und unzuverlässig", nl: "Fusie patronen zijn willekeurig en onbetrouwbaar" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Gait patterns, speed estimates, foot anatomy, and potential evidence of social behavior like group movement", es: "Patrones de marcha, estimaciones de velocidad, anatomía del pie y evidencia potencial de comportamiento social como movimiento grupal", de: "Gangmuster, Geschwindigkeitsschätzungen, Fußanatomie und potenzielle Hinweise auf Sozialverhalten wie Gruppenbewegung", nl: "Gang patronen, snelheidsschattingen, voet anatomie en potentieel bewijs van sociaal gedrag zoals groepsbeweging" },
          { en: "Exact species identification", es: "Identificación exacta de especies", de: "Genaue Artidentifikation", nl: "Exacte soortidentificatie" },
          { en: "Internal organ structure", es: "Estructura de órganos internos", de: "Innere Organstruktur", nl: "Interne orgaan structuur" },
          { en: "DNA sequences", es: "Secuencias de ADN", de: "DNA-Sequenzen", nl: "DNA sequenties" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Likely ingested accidentally with prey rather than for digestive purposes, as carnivores don't typically use gastroliths", es: "Probablemente ingeridos accidentalmente con presas en lugar de propósitos digestivos, ya que carnívoros típicamente no usan gastrolitos", de: "Wahrscheinlich versehentlich mit Beute verschluckt statt für Verdauungszwecke, da Fleischfresser typischerweise keine Gastrolithen verwenden", nl: "Waarschijnlijk per ongeluk ingeslikt met prooi eerder dan voor spijsverteringsdoeleinden, aangezien carnivoren typisch geen gastrolieten gebruiken" },
          { en: "Proof they were herbivores", es: "Prueba de que eran herbívoros", de: "Beweis, dass sie Pflanzenfresser waren", nl: "Bewijs dat ze herbivoren waren" },
          { en: "Evidence of ballast for swimming", es: "Evidencia de lastre para nadar", de: "Beweis für Ballast zum Schwimmen", nl: "Bewijs van ballast voor zwemmen" },
          { en: "Stones they used as tools", es: "Piedras que usaban como herramientas", de: "Steine, die sie als Werkzeuge benutzten", nl: "Stenen die ze als gereedschap gebruikten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Bayesian phylogenetic inference with probabilistic models accounting for missing data and uncertainty", es: "Inferencia filogenética bayesiana con modelos probabilísticos considerando datos faltantes e incertidumbre", de: "Bayesianische phylogenetische Inferenz mit probabilistischen Modellen zur Berücksichtigung fehlender Daten und Unsicherheit", nl: "Bayesiaanse fylogenetische inferentie met probabilistische modellen die rekening houden met ontbrekende data en onzekerheid" },
          { en: "Simple counting of shared features", es: "Simple conteo de características compartidas", de: "Einfaches Zählen gemeinsamer Merkmale", nl: "Eenvoudig tellen van gedeelde kenmerken" },
          { en: "Alphabetical ordering of species names", es: "Ordenamiento alfabético de nombres de especies", de: "Alphabetische Sortierung von Artnamen", nl: "Alfabetische ordening van soorten namen" },
          { en: "Geographic proximity analysis only", es: "Solo análisis de proximidad geográfica", de: "Nur geografische Näheanalyse", nl: "Alleen geografische nabijheid analyse" }
        ],
        correct: 0,
        explanation: {
