// Jurassic Dinosaurs Quiz - Level 5: Upper Intermediate Knowledge
(function() {
  const level5 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Stress fractures and healed bite marks on ribs", es: "Fracturas por estrés y marcas de mordida sanadas en costillas", de: "Stressfrakturen und verheilte Bissspuren an Rippen", nl: "Stressfracturen en genezen bijtwonden op ribben" },
          { en: "Enlarged brain cavities", es: "Cavidades cerebrales agrandadas", de: "Vergrößerte Gehirnhöhlen", nl: "Vergrote hersenholtes" },
          { en: "Calcium deficiency symptoms", es: "Síntomas de deficiencia de calcio", de: "Kalziummangel-Symptome", nl: "Calcium tekort symptomen" },
          { en: "Arthritic joint inflammation only", es: "Solo inflamación artrítica de articulaciones", de: "Nur arthritische Gelenkentzündung", nl: "Alleen artritische gewrichtsontstekingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Peak diversification of sauropod lineages before Cretaceous bottleneck", es: "Pico de diversificación de linajes de saurópodos antes del cuello de botella del Cretácico", de: "Höchste Diversifizierung der Sauropoden-Linien vor dem Kreide-Flaschenhals", nl: "Piek diversificatie van sauropode lijnen vóór Krijt knelpunt" },
          { en: "First appearance of flowering plants", es: "Primera aparición de plantas con flores", de: "Erstes Auftreten von Blütenpflanzen", nl: "Eerste verschijning van bloeiende planten" },
          { en: "Mass extinction event", es: "Evento de extinción masiva", de: "Massenaussterben-Ereignis", nl: "Massa-extinctie gebeurtenis" },
          { en: "Evolution of powered flight", es: "Evolución del vuelo propulsado", de: "Evolution des angetriebenen Fluges", nl: "Evolutie van aangedreven vlucht" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Optimal foraging at 2-4 meter height with minimal energy expenditure", es: "Forrajeo óptimo a 2-4 metros de altura con gasto mínimo de energía", de: "Optimale Nahrungssuche in 2-4 Meter Höhe mit minimalem Energieaufwand", nl: "Optimaal foerageren op 2-4 meter hoogte met minimale energie-uitgaven" },
          { en: "Maximum neck elevation for all feeding", es: "Elevación máxima del cuello para toda alimentación", de: "Maximale Halserhebung für alle Fütterung", nl: "Maximale nekverhoging voor alle voeding" },
          { en: "Underwater feeding adaptations", es: "Adaptaciones de alimentación submarina", de: "Unterwasser-Fütterungsanpassungen", nl: "Onderwater voedingsaanpassingen" },
          { en: "Exclusive ground-level browsing", es: "Ramoneo exclusivo a nivel del suelo", de: "Ausschließliches Bodenniveau-Fressen", nl: "Exclusief grondniveau grazen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Vertical stratification with height-based feeding preferences among sauropods", es: "Estratificación vertical con preferencias de alimentación basadas en altura entre saurópodos", de: "Vertikale Schichtung mit höhenbasierten Fütterungsvorlieben bei Sauropoden", nl: "Verticale stratificatie met hoogte-gebaseerde voedingsvoorkeuren onder sauropoden" },
          { en: "All herbivores fed at the same level", es: "Todos los herbívoros se alimentaron al mismo nivel", de: "Alle Pflanzenfresser fraßen auf derselben Ebene", nl: "Alle herbivoren voedden zich op hetzelfde niveau" },
          { en: "Random feeding patterns", es: "Patrones de alimentación aleatorios", de: "Zufällige Fütterungsmuster", nl: "Willekeurige voedingspatronen" },
          { en: "Seasonal diet switching only", es: "Solo cambio de dieta estacional", de: "Nur saisonaler Diätwechsel", nl: "Alleen seizoensgebonden dieetverandering" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "High CO2 (1200-1500 ppm) increased plant fiber content, requiring enhanced digestive efficiency", es: "Alto CO2 (1200-1500 ppm) aumentó el contenido de fibra vegetal, requiriendo mayor eficiencia digestiva", de: "Hoher CO2 (1200-1500 ppm) erhöhte Pflanzenfasergehalt, erforderte verbesserte Verdauungseffizienz", nl: "Hoge CO2 (1200-1500 ppm) verhoogde plantenvezelgehalte, vereiste verbeterde spijsverteringsefficiëntie" },
          { en: "Low CO2 limited plant growth", es: "Bajo CO2 limitó el crecimiento de plantas", de: "Niedriger CO2 begrenzte Pflanzenwachstum", nl: "Lage CO2 beperkte plantengroei" },
          { en: "CO2 had no effect on plants", es: "CO2 no tuvo efecto en las plantas", de: "CO2 hatte keinen Effekt auf Pflanzen", nl: "CO2 had geen effect op planten" },
          { en: "Only affected plant reproduction", es: "Solo afectó la reproducción de plantas", de: "Beeinflusste nur Pflanzenreproduktion", nl: "Beïnvloedde alleen plantenvoortplanting" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Fossil air sac impressions and fenestrated vertebrae consistent with avian-style respiratory anatomy", es: "Impresiones fósiles de sacos aéreos y vértebras fenestradas consistentes con anatomía respiratoria de estilo aviar", de: "Fossile Luftsack-Eindrücke und fenestrierte Wirbel konsistent mit Vogel-artiger Atmungsanatomie", nl: "Fossiele luchtzak afdrukken en gefenestreerde wervels consistent met vogel-achtige ademhalingsanatomie" },
          { en: "Solid bone construction throughout", es: "Construcción ósea sólida en todo", de: "Durchgehende massive Knochenkonstruktion", nl: "Massieve botconstructie overal" },
          { en: "Water-filled bone cavities", es: "Cavidades óseas llenas de agua", de: "Wassergefüllte Knochenhöhlen", nl: "Met water gevulde botholtes" },
          { en: "No evidence of internal bone structure", es: "Sin evidencia de estructura ósea interna", de: "Keine Belege für innere Knochenstruktur", nl: "Geen bewijs van interne botstructuur" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Mosaic of floodplains, ephemeral lakes, and meandering rivers with 200-300mm seasonal precipitation", es: "Mosaico de llanuras de inundación, lagos efímeros y ríos serpenteantes con 200-300mm precipitación estacional", de: "Mosaik aus Überschwemmungsebenen, vergänglichen Seen und mäandernden Flüssen mit 200-300mm saisonalem Niederschlag", nl: "Mozaïek van rivierdale, efemere meren en meanderende rivieren met 200-300mm seizoensgebonden neerslag" },
          { en: "Continuous desert environment", es: "Ambiente desértico continuo", de: "Kontinuierliche Wüstenumgebung", nl: "Continue woestijnomgeving" },
          { en: "Deep marine setting throughout", es: "Ambiente marino profundo en todo", de: "Durchgehend tiefmarines Setting", nl: "Diepe mariene setting overal" },
          { en: "Tropical rainforest conditions", es: "Condiciones de selva tropical", de: "Tropische Regenwald-Bedingungen", nl: "Tropische regenwoud omstandigheden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "2-4 times modern crocodilian rates with inertial homeothermy", es: "2-4 veces las tasas de cocodrilos modernos con homeotermia inercial", de: "2-4 mal moderne Krokodil-Raten mit Trägheits-Homeothermie", nl: "2-4 keer moderne krokodilachtige snelheden met inertiële homeothermie" },
          { en: "Same as modern mammals", es: "Igual que mamíferos modernos", de: "Gleich wie moderne Säugetiere", nl: "Hetzelfde als moderne zoogdieren" },
          { en: "Lower than modern reptiles", es: "Menor que reptiles modernos", de: "Niedriger als moderne Reptilien", nl: "Lager dan moderne reptielen" },
          { en: "10 times higher than any living animal", es: "10 veces mayor que cualquier animal vivo", de: "10 mal höher als jedes lebende Tier", nl: "10 keer hoger dan elk levend dier" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cyclic replacement of conifer-fern communities following disturbance events", es: "Reemplazo cíclico de comunidades de coníferas-helechos siguiendo eventos de perturbación", de: "Zyklischer Ersatz von Nadel-Farn-Gemeinschaften nach Störungsereignissen", nl: "Cyclische vervanging van naaldbooms-varengemeenschappen na verstoringsgebeurtenissen" },
          { en: "Static plant communities with no change", es: "Comunidades vegetales estáticas sin cambio", de: "Statische Pflanzengemeinschaften ohne Veränderung", nl: "Statische plantengemeenschappen zonder verandering" },
          { en: "Rapid evolution to flowering plants", es: "Evolución rápida a plantas con flores", de: "Schnelle Evolution zu Blütenpflanzen", nl: "Snelle evolutie naar bloeiende planten" },
          { en: "Grassland establishment", es: "Establecimiento de pastizales", de: "Grasland-Etablierung", nl: "Grasland vestiging" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "15-25% species replacement per million years with punctuated equilibrium patterns", es: "15-25% reemplazo de especies por millón de años con patrones de equilibrio puntuado", de: "15-25% Artenaustausch pro Million Jahre mit punktierten Gleichgewichtsmustern", nl: "15-25% soortenvervanging per miljoen jaar met gepatroneerde evenwichtspatronen" },
          { en: "100% species replacement every 100,000 years", es: "100% reemplazo de especies cada 100,000 años", de: "100% Artenaustausch alle 100,000 Jahre", nl: "100% soortenvervanging elke 100.000 jaar" },
          { en: "No species turnover", es: "Sin recambio de especies", de: "Kein Artenaustausch", nl: "Geen soortomzet" },
          { en: "Constant gradual change", es: "Cambio gradual constante", de: "Konstante graduelle Veränderung", nl: "Constante geleidelijke verandering" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Carbon isotope excursions and black shale deposition with elevated organic matter", es: "Excursiones de isótopos de carbono y deposición de esquisto negro con materia orgánica elevada", de: "Kohlenstoff-Isotopen-Exkursionen und Schwarzschiefer-Ablagerung mit erhöhter organischer Substanz", nl: "Koolstofisotopen excursies en zwarte schalie afzetting met verhoogde organische materie" },
          { en: "Increased carbonate precipitation only", es: "Solo aumento de precipitación de carbonato", de: "Nur erhöhte Karbonat-Fällung", nl: "Alleen verhoogde carbonaatprecipitatie" },
          { en: "Volcanic ash layers exclusively", es: "Exclusivamente capas de ceniza volcánica", de: "Ausschließlich vulkanische Ascheschichten", nl: "Uitsluitend vulkanische aslagen" },
          { en: "No geochemical indicators", es: "Sin indicadores geoquímicos", de: "Keine geochemischen Indikatoren", nl: "Geen geochemische indicatoren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "0.5-0.8 (intermediate between modern reptiles and birds)", es: "0.5-0.8 (intermedio entre reptiles modernos y aves)", de: "0.5-0.8 (zwischen modernen Reptilien und Vögeln)", nl: "0.5-0.8 (tussen moderne reptielen en vogels)" },
          { en: "2.0-3.0 (similar to mammals)", es: "2.0-3.0 (similar a mamíferos)", de: "2.0-3.0 (ähnlich Säugetieren)", nl: "2.0-3.0 (vergelijkbaar met zoogdieren)" },
          { en: "0.1 (lower than any living vertebrate)", es: "0.1 (menor que cualquier vertebrado vivo)", de: "0.1 (niedriger als jedes lebende Wirbeltier)", nl: "0.1 (lager dan elk levend gewervelde)" },
          { en: "5.0+ (higher than humans)", es: "5.0+ (mayor que humanos)", de: "5.0+ (höher als Menschen)", nl: "5.0+ (hoger dan mensen)" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Laterally compressed tail and webbed digits suggest semi-aquatic capabilities", es: "Cola comprimida lateralmente y dígitos palmeados sugieren capacidades semiacuáticas", de: "Seitlich komprimierter Schwanz und Schwimmhäute deuten auf semi-aquatische Fähigkeiten hin", nl: "Lateraal samengedrukte staart en zwemvliezen suggereren semi-aquatische mogelijkheden" },
          { en: "Purely terrestrial with no aquatic adaptations", es: "Puramente terrestre sin adaptaciones acuáticas", de: "Rein terrestrisch ohne aquatische Anpassungen", nl: "Puur terrestrisch zonder aquatische aanpassingen" },
          { en: "Fully aquatic like modern whales", es: "Completamente acuático como ballenas modernas", de: "Vollständig aquatisch wie moderne Wale", nl: "Volledig aquatisch zoals moderne walvissen" },
          { en: "Aerial locomotion adaptations", es: "Adaptaciones de locomoción aérea", de: "Luftfahrt-Fortbewegungsanpassungen", nl: "Luchtvaart voortbeweging aanpassingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "200-400 liters per day with water recycling adaptations", es: "200-400 litros por día con adaptaciones de reciclaje de agua", de: "200-400 Liter pro Tag mit Wasser-Recycling-Anpassungen", nl: "200-400 liter per dag met waterrecycling aanpassingen" },
          { en: "2,000-5,000 liters per day", es: "2,000-5,000 litros por día", de: "2,000-5,000 Liter pro Tag", nl: "2,000-5,000 liter per dag" },
          { en: "10-20 liters per day", es: "10-20 litros por día", de: "10-20 Liter pro Tag", nl: "10-20 liter per dag" },
          { en: "No water requirement", es: "Sin requerimiento de agua", de: "Kein Wasserbedarf", nl: "Geen waterbehoefte" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Sevier orogenic activity creating foreland basin subsidence and sediment supply", es: "Actividad orogénica de Sevier creando subsidencia de cuenca frontal y suministro de sedimentos", de: "Sevier-orogenetische Aktivität schuf Vorlandbecken-Subsidenz und Sedimentzufuhr", nl: "Sevier orogenische activiteit die voorlandsbekken subsidie en sedimentaanvoer creëerde" },
          { en: "Passive margin sedimentation only", es: "Solo sedimentación de margen pasivo", de: "Nur passive Rand-Sedimentation", nl: "Alleen passieve marge sedimentatie" },
          { en: "Volcanic rifting exclusively", es: "Exclusivamente rifting volcánico", de: "Ausschließlich vulkanisches Rifting", nl: "Uitsluitend vulkanische rifting" },
          { en: "No tectonic influence", es: "Sin influencia tectónica", de: "Kein tektonischer Einfluss", nl: "Geen tektonische invloed" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Juvenile-dominated assemblages (60-70%) with size-based mortality patterns", es: "Ensamblajes dominados por juveniles (60-70%) con patrones de mortalidad basados en tamaño", de: "Juvenil-dominierte Versammlungen (60-70%) mit größenbasierten Sterblichkeitsmustern", nl: "Juveniel-gedomineerde assemblages (60-70%) met grootte-gebaseerde sterftelijkheidpatronen" },
          { en: "Adult-dominated populations only", es: "Solo poblaciones dominadas por adultos", de: "Nur erwachsenen-dominierte Populationen", nl: "Alleen volwassen-gedomineerde populaties" },
          { en: "Equal age distribution", es: "Distribución de edad igual", de: "Gleiche Altersverteilung", nl: "Gelijke leeftijdsverdeling" },
          { en: "No juveniles preserved", es: "Sin juveniles preservados", de: "Keine Jugendlichen erhalten", nl: "Geen juvenielen bewaard" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Simple cropping without oral processing, requiring extensive gut fermentation", es: "Corte simple sin procesamiento oral, requiriendo fermentación intestinal extensa", de: "Einfaches Abschneiden ohne orale Verarbeitung, erfordert extensive Darm-Fermentation", nl: "Eenvoudig afknippen zonder orale verwerking, vereist uitgebreide darmfermentatie" },
          { en: "Extensive chewing like modern ungulates", es: "Masticación extensa como ungulados modernos", de: "Extensive Kauen wie moderne Huftiere", nl: "Uitgebreid kauwen zoals moderne hoef dieren" },
          { en: "Filter feeding mechanisms", es: "Mecanismos de alimentación por filtración", de: "Filterfütterungsmechanismen", nl: "Filter voedingsmechanismen" },
          { en: "Carnivorous adaptations", es: "Adaptaciones carnívoras", de: "Fleischfressende Anpassungen", nl: "Carnivore aanpassingen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "2-5 tons per hectare with 10-15% herbivore efficiency", es: "2-5 toneladas por hectárea con 10-15% eficiencia de herbívoros", de: "2-5 Tonnen pro Hektar mit 10-15% Pflanzenfresser-Effizienz", nl: "2-5 ton per hectare met 10-15% herbivoor efficiëntie" },
          { en: "50-100 tons per hectare", es: "50-100 toneladas por hectárea", de: "50-100 Tonnen pro Hektar", nl: "50-100 ton per hectare" },
          { en: "0.1-0.5 tons per hectare", es: "0.1-0.5 toneladas por hectárea", de: "0.1-0.5 Tonnen pro Hektar", nl: "0.1-0.5 ton per hectare" },
          { en: "200+ tons per hectare", es: "200+ toneladas por hectárea", de: "200+ Tonnen pro Hektar", nl: "200+ ton per hectare" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Created fragmented habitats leading to increased dinosaur endemism and evolutionary radiation", es: "Creó hábitats fragmentados llevando a endemismo aumentado de dinosaurios y radiación evolutiva", de: "Schuf fragmentierte Lebensräume, die zu erhöhtem Dinosaurier-Endemismus und evolutionärer Radiation führten", nl: "Creëerde gefragmenteerde habitats leidend tot verhoogd dinosaurus endemisme en evolutionaire radiatie" },
          { en: "Had no effect on terrestrial ecosystems", es: "No tuvo efecto en ecosistemas terrestres", de: "Hatte keinen Effekt auf terrestrische Ökosysteme", nl: "Had geen effect op terrestrische ecosystemen" },
          { en: "Only affected marine environments", es: "Solo afectó ambientes marinos", de: "Beeinflusste nur marine Umgebungen", nl: "Beïnvloedde alleen mariene omgevingen" },
      ...
      },
      {
        ...
        options: [
          { en: "Diverse arthropod communities indicating complex multi-trophic interactions with sophisticated pollination networks", es: "Diversas comunidades de artrópodos indicando interacciones multi-tróficas complejas con redes de polinización sofisticadas", de: "Diverse Arthropoden-Gemeinschaften zeigen komplexe multi-trophische Interaktionen mit ausgeklügelten Bestäubungsnetzwerken", nl: "Diverse artropode gemeenschappen die complexe multi-trofische interacties aangeven met geavanceerde bestuivingsnetwerken" },
          { en: "Simple food webs with only dinosaurs", es: "Redes alimentarias simples con solo dinosaurios", de: "Einfache Nahrungsnetze nur mit Dinosauriern", nl: "Eenvoudige voedselnetwerken met alleen dinosaurussen" },
          { en: "No preserved organisms", es: "Sin organismos preservados", de: "Keine konservierten Organismen", nl: "Geen bewaarde organismen" },
          { en: "Only plant material preserved", es: "Solo material vegetal preservado", de: "Nur Pflanzenmaterial konserviert", nl: "Alleen plantenmateriaal bewaard" }
        ],
        correct: 0,
        explanation: {
