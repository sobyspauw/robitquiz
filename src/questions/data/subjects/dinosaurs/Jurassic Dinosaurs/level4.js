// Jurassic Dinosaurs Quiz - Level 4: Intermediate Knowledge
(function() {
  const level4 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Early, Middle, Late Jurassic", es: "Jurásico Temprano, Medio, Tardío", de: "Früher, Mittlerer, Später Jura", nl: "Vroeg, Midden, Laat Jura" },
          { en: "Late, Middle, Early Jurassic", es: "Jurásico Tardío, Medio, Temprano", de: "Später, Mittlerer, Früher Jura", nl: "Laat, Midden, Vroeg Jura" },
          { en: "Lower, Upper, Middle Jurassic", es: "Jurásico Inferior, Superior, Medio", de: "Unterer, Oberer, Mittlerer Jura", nl: "Onder, Boven, Midden Jura" },
          { en: "Pre, Proto, Neo Jurassic", es: "Pre, Proto, Neo Jurásico", de: "Prä, Proto, Neo Jura", nl: "Pre, Proto, Neo Jura" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Similar brain-to-body ratio to crocodiles", es: "Proporción cerebro-cuerpo similar a los cocodrilos", de: "Ähnliches Gehirn-Körper-Verhältnis wie Krokodile", nl: "Vergelijkbare hersenlichaamverhouding als krokodillen" },
          { en: "Much larger brain than expected", es: "Cerebro mucho más grande de lo esperado", de: "Viel größeres Gehirn als erwartet", nl: "Veel groter brein dan verwacht" },
          { en: "No brain cavity at all", es: "Sin cavidad cerebral en absoluto", de: "Gar keine Gehirnhöhle", nl: "Helemaal geen hersenholte" },
          { en: "Same size brain as humans", es: "Cerebro del mismo tamaño que los humanos", de: "Gleich große Gehirn wie Menschen", nl: "Even groot brein als mensen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Reduced weight without sacrificing strength", es: "Peso reducido sin sacrificar resistencia", de: "Reduziertes Gewicht ohne Stärkeverlust", nl: "Verminderd gewicht zonder krachtverlies" },
          { en: "Better swimming ability", es: "Mejor capacidad de natación", de: "Bessere Schwimmfähigkeit", nl: "Beter zwemvermogen" },
          { en: "Enhanced hearing capabilities", es: "Capacidades auditivas mejoradas", de: "Verbesserte Hörfähigkeiten", nl: "Verbeterde hoorcapaciteiten" },
          { en: "Temperature regulation only", es: "Solo regulación de temperatura", de: "Nur Temperaturregulierung", nl: "Alleen temperatuurregulatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "1,500-3,000 N (similar to large crocodiles)", es: "1,500-3,000 N (similar a grandes cocodrilos)", de: "1,500-3,000 N (ähnlich großen Krokodilen)", nl: "1,500-3,000 N (vergelijkbaar met grote krokodillen)" },
          { en: "50,000 N (like T. rex)", es: "50,000 N (como T. rex)", de: "50,000 N (wie T. rex)", nl: "50,000 N (zoals T. rex)" },
          { en: "100 N (like house cats)", es: "100 N (como gatos domésticos)", de: "100 N (wie Hauskatzen)", nl: "100 N (zoals huiskatten)" },
          { en: "10,000 N (like great white sharks)", es: "10,000 N (como tiburones blancos)", de: "10,000 N (wie Weiße Haie)", nl: "10,000 N (zoals witte haaien)" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Paleosols and mudstone deposits indicating seasonal wet-dry cycles", es: "Paleosuelos y depósitos de lutita indicando ciclos estacionales húmedo-seco", de: "Paläoböden und Schlammstein-Ablagerungen zeigen saisonale Nass-Trocken-Zyklen", nl: "Paleosolen en moddersteen afzettingen die seizoensgebonden nat-droog cycli aangeven" },
          { en: "Glacial deposits and ice sheets", es: "Depósitos glaciales y capas de hielo", de: "Glaziale Ablagerungen und Eisschichten", nl: "Glaciale afzettingen en ijskappen" },
          { en: "Deep marine limestone only", es: "Solo caliza marina profunda", de: "Nur tiefmarine Kalksteine", nl: "Alleen diepzeelimesteen" },
      ...
      },
      {
        ...
        options: [
          { en: "Different theropod families (Ceratosauridae vs Allosauridae)", es: "Diferentes familias de terópodos (Ceratosauridae vs Allosauridae)", de: "Verschiedene Theropoden-Familien (Ceratosauridae vs Allosauridae)", nl: "Verschillende theropode families (Ceratosauridae vs Allosauridae)" },
          { en: "Same species, different sexes", es: "Misma especie, sexos diferentes", de: "Gleiche Art, verschiedene Geschlechter", nl: "Zelfde soort, verschillende geslachten" },
          { en: "Parent-offspring relationship", es: "Relación padre-descendiente", de: "Eltern-Nachkommen-Beziehung", nl: "Ouder-nakomelingenrelatie" },
          { en: "Same genus, different species", es: "Mismo género, especies diferentes", de: "Gleiche Gattung, verschiedene Arten", nl: "Hetzelfde geslacht, verschillende soorten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Mesothermic (intermediate between warm and cold-blooded)", es: "Mesotérmico (intermedio entre sangre caliente y fría)", de: "Mesotherm (zwischen warm- und kaltblütig)", nl: "Mesotherm (tussen warm- en koudbloedig)" },
          { en: "Fully endothermic like modern mammals", es: "Completamente endotérmico como mamíferos modernos", de: "Vollständig endotherm wie moderne Säugetiere", nl: "Volledig endotherm zoals moderne zoogdieren" },
          { en: "Fully ectothermic like modern reptiles", es: "Completamente ectotérmico como reptiles modernos", de: "Vollständig ektotherm wie moderne Reptilien", nl: "Volledig ectotherm zoals moderne reptielen" },
          { en: "No metabolic regulation", es: "Sin regulación metabólica", de: "Keine Stoffwechselregulierung", nl: "Geen metabolische regulatie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Transition from plates to spines along the back", es: "Transición de placas a espinas a lo largo de la espalda", de: "Übergang von Platten zu Stacheln entlang des Rückens", nl: "Overgang van platen naar stekels langs de rug" },
          { en: "Complete absence of plates", es: "Ausencia completa de placas", de: "Völlige Abwesenheit von Platten", nl: "Volledige afwezigheid van platen" },
          { en: "Much larger size than other stegosaurs", es: "Tamaño mucho más grande que otros estegosaurios", de: "Viel größere Größe als andere Stegosaurier", nl: "Veel grotere grootte dan andere stegosaurussen" },
          { en: "Bipedal locomotion", es: "Locomoción bípeda", de: "Zweibeinige Fortbewegung", nl: "Bipede voortbeweging" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "400-500 kg (880-1100 lbs) of plant matter", es: "400-500 kg (880-1100 lbs) de materia vegetal", de: "400-500 kg (880-1100 lbs) Pflanzenmaterial", nl: "400-500 kg (880-1100 lbs) plantenmateriaal" },
          { en: "50-100 kg (110-220 lbs)", es: "50-100 kg (110-220 lbs)", de: "50-100 kg (110-220 lbs)", nl: "50-100 kg (110-220 lbs)" },
          { en: "1000-2000 kg (2200-4400 lbs)", es: "1000-2000 kg (2200-4400 lbs)", de: "1000-2000 kg (2200-4400 lbs)", nl: "1000-2000 kg (2200-4400 lbs)" },
          { en: "10-20 kg (22-44 lbs)", es: "10-20 kg (22-44 lbs)", de: "10-20 kg (22-44 lbs)", nl: "10-20 kg (22-44 lbs)" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Rapid burial in floodplain sediments", es: "Enterramiento rápido en sedimentos de llanura de inundación", de: "Schnelle Begrabung in Überschwemmungsgebiet-Sedimenten", nl: "Snelle begraving in rivierdalafzettingen" },
          { en: "Volcanic ash preservation only", es: "Solo preservación por ceniza volcánica", de: "Nur Konservierung durch Vulkanasche", nl: "Alleen bewaring door vulkanische as" },
          { en: "Marine limestone entombment", es: "Enterramiento en caliza marina", de: "Marine Kalkstein-Einbettung", nl: "Zeelimesteen insluiting" },
          { en: "Permafrost freezing", es: "Congelación de permafrost", de: "Permafrost-Einfrierung", nl: "Permafrost bevriezing" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "40-50 km/h (25-31 mph)", es: "40-50 km/h (25-31 mph)", de: "40-50 km/h (25-31 mph)", nl: "40-50 km/h (25-31 mph)" },
          { en: "5-10 km/h (3-6 mph)", es: "5-10 km/h (3-6 mph)", de: "5-10 km/h (3-6 mph)", nl: "5-10 km/h (3-6 mph)" },
          { en: "80-100 km/h (50-62 mph)", es: "80-100 km/h (50-62 mph)", de: "80-100 km/h (50-62 mph)", nl: "80-100 km/h (50-62 mph)" },
          { en: "15-20 km/h (9-12 mph)", es: "15-20 km/h (9-12 mph)", de: "15-20 km/h (9-12 mph)", nl: "15-20 km/h (9-12 mph)" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Lateral weapon delivery system with flexible tail base", es: "Sistema de entrega de armas laterales con base de cola flexible", de: "Seitliches Waffenabgabesystem mit flexiblem Schwanzansatz", nl: "Lateraal wapenafgiftesysteem met flexibele staartbasis" },
          { en: "Vertical display structures only", es: "Solo estructuras de exhibición vertical", de: "Nur vertikale Anzeigestrukturen", nl: "Alleen verticale vertoningsstructuren" },
          { en: "Heat regulation fins", es: "Aletas de regulación de calor", de: "Wärmeregulierungsflossen", nl: "Warmteregulatie vinnen" },
          { en: "Sound production organs", es: "Órganos de producción de sonido", de: "Schallerzeugungsorgane", nl: "Geluidsproductie organen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "3,000-4,000 liters with efficient air sac system", es: "3,000-4,000 litros con sistema eficiente de sacos aéreos", de: "3,000-4,000 Liter mit effizientem Luftsacksystem", nl: "3,000-4,000 liter met efficiënt luchtzaksysteem" },
          { en: "100-200 liters like modern mammals", es: "100-200 litros como mamíferos modernos", de: "100-200 Liter wie moderne Säugetiere", nl: "100-200 liter zoals moderne zoogdieren" },
          { en: "10,000+ liters", es: "10,000+ litros", de: "10,000+ Liter", nl: "10,000+ liter" },
          { en: "No functional lungs", es: "Sin pulmones funcionales", de: "Keine funktionellen Lungen", nl: "Geen functionele longen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "30-40°N paleolatitude in subtropical zone", es: "30-40°N paleolatitud en zona subtropical", de: "30-40°N Paläobreite in subtropischer Zone", nl: "30-40°N paleobreedte in subtropische zone" },
          { en: "Equatorial 0-10°N", es: "Ecuatorial 0-10°N", de: "Äquatorial 0-10°N", nl: "Equatoriaal 0-10°N" },
          { en: "High latitude 60-70°N", es: "Alta latitud 60-70°N", de: "Hohe Breite 60-70°N", nl: "Hoge breedte 60-70°N" },
          { en: "Southern hemisphere 30-40°S", es: "Hemisferio sur 30-40°S", de: "Südhalbkugel 30-40°S", nl: "Zuidelijk halfrond 30-40°S" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Oxygen isotope ratios in tooth enamel indicating seasonal movement", es: "Proporciones de isótopos de oxígeno en el esmalte dental indicando movimiento estacional", de: "Sauerstoff-Isotopenverhältnisse im Zahnschmelz zeigen saisonale Bewegung", nl: "Zuurstofisotopenverhoudingen in tandglazuur die seizoensgebonden beweging aangeven" },
          { en: "Carbon dating of bone collagen", es: "Datación por carbono del colágeno óseo", de: "Kohlenstoffdatierung von Knochenkollagen", nl: "Koolstofdatering van botcollageen" },
          { en: "Radioactive decay measurements", es: "Mediciones de desintegración radioactiva", de: "Radioaktive Zerfallsmessungen", nl: "Radioactieve vervalmetingen" },
          { en: "DNA sequence analysis", es: "Análisis de secuencia de ADN", de: "DNA-Sequenzanalyse", nl: "DNA-sequentieanalyse" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Bimodal distribution: small (1-50kg) and large (500-2000kg) forms", es: "Distribución bimodal: formas pequeñas (1-50kg) y grandes (500-2000kg)", de: "Bimodale Verteilung: kleine (1-50kg) und große (500-2000kg) Formen", nl: "Bimodale verdeling: kleine (1-50kg) en grote (500-2000kg) vormen" },
          { en: "Normal bell curve distribution", es: "Distribución normal de curva de campana", de: "Normale Glockenkurven-Verteilung", nl: "Normale klokvormige verdeling" },
          { en: "Only large predators existed", es: "Solo existían depredadores grandes", de: "Nur große Raubtiere existierten", nl: "Alleen grote roofdieren bestonden" },
          { en: "Uniform size distribution", es: "Distribución de tamaño uniforme", de: "Gleichmäßige Größenverteilung", nl: "Uniforme grootteverdeling" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "0.1-0.5 individuals per km² (similar to large African herbivores)", es: "0.1-0.5 individuos por km² (similar a grandes herbívoros africanos)", de: "0.1-0.5 Individuen pro km² (ähnlich großen afrikanischen Pflanzenfressern)", nl: "0.1-0.5 individuen per km² (vergelijkbaar met grote Afrikaanse herbivoren)" },
          { en: "50-100 individuals per km²", es: "50-100 individuos por km²", de: "50-100 Individuen pro km²", nl: "50-100 individuen per km²" },
          { en: "1000+ individuals per km²", es: "1000+ individuos por km²", de: "1000+ Individuen pro km²", nl: "1000+ individuen per km²" },
          { en: "Only 1 individual per 1000 km²", es: "Solo 1 individuo por 1000 km²", de: "Nur 1 Individuum pro 1000 km²", nl: "Slechts 1 individu per 1000 km²" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Blood pressure requirements for brain perfusion", es: "Requisitos de presión arterial para perfusión cerebral", de: "Blutdruckanforderungen für Gehirnperfusion", nl: "Bloeddrukbehoeften voor hersenperfusie" },
          { en: "Weight of the skull only", es: "Solo el peso del cráneo", de: "Nur das Gewicht des Schädels", nl: "Alleen het gewicht van de schedel" },
          { en: "Dietary limitations", es: "Limitaciones dietéticas", de: "Ernährungsbeschränkungen", nl: "Voedingsbeperkingen" },
          { en: "Predator avoidance", es: "Evitación de depredadores", de: "Räubervermeidung", nl: "Roofdierpreventie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Major faunal turnover with extinction of many sauropod lineages", es: "Gran recambio faunístico con extinción de muchos linajes de saurópodos", de: "Großer Faunenwandel mit Aussterben vieler Sauropoden-Linien", nl: "Grote faunale omzet met uitsterven van vele sauropode lijnen" },
          { en: "No significant changes occurred", es: "No ocurrieron cambios significativos", de: "Keine bedeutenden Veränderungen traten auf", nl: "Er traden geen significante veranderingen op" },
          { en: "All dinosaurs went extinct", es: "Todos los dinosaurios se extinguieron", de: "Alle Dinosaurier starben aus", nl: "Alle dinosaurussen stierven uit" },
          { en: "First appearance of dinosaurs", es: "Primera aparición de dinosaurios", de: "Erstes Auftreten von Dinosauriern", nl: "Eerste verschijning van dinosaurussen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Alternating humid-arid cycles promoted physiological and behavioral flexibility", es: "Ciclos alternantes húmedo-áridos promovieron flexibilidad fisiológica y conductual", de: "Wechselnde feucht-trockene Zyklen förderten physiologische und Verhaltensflexibilität", nl: "Alternerende vochtig-droge cycli bevorderden fysiologische en gedragsflexibiliteit" },
          { en: "Stable climate prevented evolution", es: "Clima estable previno evolución", de: "Stabiles Klima verhinderte Evolution", nl: "Stabiel klimaat voorkwam evolutie" },
          ...
          { en: "Caused immediate extinction", es: "Causó extinción inmediata", de: "Verursachte sofortiges Aussterben", nl: "Veroorzaakte onmiddellijke extinctie" }
        ],
        correct: 0,
        explanation: {
