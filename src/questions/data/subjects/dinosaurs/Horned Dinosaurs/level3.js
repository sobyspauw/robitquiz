// Horned Dinosaurs Quiz - Level 3: Intermediate Knowledge about Horned Dinosaurs
(function() {
  const level3 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { en: "Stegosauridae", es: "Stegosauridae", de: "Stegosauridae", nl: "Stegosauridae" },
          { en: "Pterosauridae", es: "Pterosauridae", de: "Pterosauridae", nl: "Pterosauridae" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Titanoceratops", es: "Titanoceratops", de: "Titanoceratops", nl: "Titanoceratops" },
          { en: "Microceratops", es: "Microceratops", de: "Microceratops", nl: "Microceratops" },
          { en: "Leptoceratops", es: "Leptoceratops", de: "Leptoceratops", nl: "Leptoceratops" },
          { en: "Bagaceratops", es: "Bagaceratops", de: "Bagaceratops", nl: "Bagaceratops" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          ...
          { en: "Chinle Formation", es: "Formación Chinle", de: "Chinle Formation", nl: "Chinle Formatie" },
          { en: "Burgess Shale", es: "Esquisto de Burgess", de: "Burgess-Schiefer", nl: "Burgess Shale" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Efficiently cropping tough vegetation", es: "Cortar eficientemente vegetación dura", de: "Effizientes Abschneiden harter Vegetation", nl: "Efficiënt afknippen van taaie vegetatie" },
          { en: "Breathing underwater", es: "Respirar bajo el agua", de: "Unter Wasser atmen", nl: "Onder water ademen" },
          { en: "Making loud sounds", es: "Hacer sonidos fuertes", de: "Laute Geräusche machen", nl: "Harde geluiden maken" },
          { en: "Storing food", es: "Almacenar comida", de: "Nahrung speichern", nl: "Voedsel opslaan" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Continuous grinding of plant material", es: "Molienda continua de material vegetal", de: "Kontinuierliches Mahlen von Pflanzenmaterial", nl: "Continu malen van plantenmateriaal" },
          { en: "Catching fish", es: "Atrapar peces", de: "Fische fangen", nl: "Vissen vangen" },
          { en: "Display for mating", es: "Exhibición para apareamiento", de: "Zur Schau bei der Paarung", nl: "Vertoon voor paring" },
      ...
      },
      {
        ...
        options: [
          { en: "Scaly skin with hexagonal patterns", es: "Piel escamosa con patrones hexagonales", de: "Schuppige Haut mit hexagonalen Mustern", nl: "Geschubde huid met zeshoekige patronen" },
          { en: "Fur", es: "Pelaje", de: "Fell", nl: "Vacht" },
          { en: "Feathers", es: "Plumas", de: "Federn", nl: "Veren" },
          { en: "Smooth skin like dolphins", es: "Piel lisa como delfines", de: "Glatte Haut wie Delfine", nl: "Gladde huid zoals dolfijnen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "800-1200 pounds per square inch", es: "800-1200 libras por pulgada cuadrada", de: "800-1200 Pfund pro Quadratzoll", nl: "800-1200 pond per vierkante inch" },
          { en: "10 pounds per square inch", es: "10 libras por pulgada cuadrada", de: "10 Pfund pro Quadratzoll", nl: "10 pond per vierkante inch" },
          { en: "5000 pounds per square inch", es: "5000 libras por pulgada cuadrada", de: "5000 Pfund pro Quadratzoll", nl: "5000 pond per vierkante inch" },
          { en: "No bite force", es: "Sin fuerza de mordida", de: "Keine Bisskraft", nl: "Geen bijtkracht" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Blood flow through the frill helped cool or warm the body", es: "El flujo sanguíneo a través del volante ayudaba a enfriar o calentar el cuerpo", de: "Blutfluss durch den Kragen half den Körper zu kühlen oder zu wärmen", nl: "Bloedstroom door de kraag hielp het lichaam af te koelen of op te warmen" },
          { en: "The frill stored ice", es: "El volante almacenaba hielo", de: "Der Kragen speicherte Eis", nl: "De kraag sloeg ijs op" },
          { en: "They used it as a fan", es: "Lo usaban como abanico", de: "Sie nutzten ihn als Fächer", nl: "Ze gebruikten het als een waaier" },
          { en: "It produced electricity", es: "Producía electricidad", de: "Er produzierte Elektrizität", nl: "Het produceerde elektriciteit" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Achelousaurus", es: "Achelousaurus", de: "Achelousaurus", nl: "Achelousaurus" },
      ...
      },
      {
        ...
        options: [
          { en: "Juveniles found with adults and organized nesting sites", es: "Juveniles encontrados con adultos y sitios de anidación organizados", de: "Jungtiere mit Erwachsenen gefunden und organisierte Nistplätze", nl: "Jongen gevonden bij volwassenen en georganiseerde nestplaatsen" },
          { en: "Written instructions", es: "Instrucciones escritas", de: "Schriftliche Anweisungen", nl: "Geschreven instructies" },
          { en: "They didn't care for young", es: "No cuidaban a las crías", de: "Sie kümmerten sich nicht um Junge", nl: "Ze zorgden niet voor jongen" },
          { en: "Video recordings", es: "Grabaciones de video", de: "Videoaufnahmen", nl: "Video-opnames" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "The period since 2000 with many new species discoveries", es: "El período desde 2000 con muchos nuevos descubrimientos de especies", de: "Die Zeit seit 2000 mit vielen neuen Artentdeckungen", nl: "De periode sinds 2000 met veel nieuwe soortontdekkingen" },
          { en: "When dinosaurs learned to paint", es: "Cuando los dinosaurios aprendieron a pintar", de: "Als Dinosaurier lernten zu malen", nl: "Toen dinosaurussen leerden schilderen" },
          { en: "A dinosaur theme park", es: "Un parque temático de dinosaurios", de: "Ein Dinosaurier-Themenpark", nl: "Een dinosaurus themapark" },
          { en: "A TV show", es: "Un programa de TV", de: "Eine TV-Show", nl: "Een TV-show" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Side-facing eyes gave wide field of view to spot predators", es: "Ojos laterales daban amplio campo de visión para detectar depredadores", de: "Seitliche Augen gaben weites Sichtfeld um Raubtiere zu entdecken", nl: "Zijwaarts gerichte ogen gaven breed gezichtsveld om roofdieren te spotten" },
          { en: "They could see in the dark", es: "Podían ver en la oscuridad", de: "Sie konnten im Dunkeln sehen", nl: "Ze konden in het donker zien" },
          { en: "They had X-ray vision", es: "Tenían visión de rayos X", de: "Sie hatten Röntgenblick", nl: "Ze hadden röntgen zicht" },
          { en: "They couldn't see", es: "No podían ver", de: "Sie konnten nicht sehen", nl: "Ze konden niet zien" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Herding with adults protecting young on the edges", es: "Manadas con adultos protegiendo crías en los bordes", de: "Herdenbildung mit Erwachsenen die Junge am Rand schützen", nl: "Kuddevorming met volwassenen die jongen aan de randen beschermen" },
          { en: "Solitary lifestyle", es: "Estilo de vida solitario", de: "Einzelgängerisches Leben", nl: "Solitaire levensstijl" },
          { en: "Flying in formation", es: "Volando en formación", de: "In Formation fliegen", nl: "In formatie vliegen" },
          { en: "Swimming together", es: "Nadando juntos", de: "Zusammen schwimmen", nl: "Samen zwemmen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Triceratops and Torosaurus", es: "Triceratops y Torosaurus", de: "Triceratops und Torosaurus", nl: "Triceratops en Torosaurus" },
          { en: "Protoceratops only", es: "Solo Protoceratops", de: "Nur Protoceratops", nl: "Alleen Protoceratops" },
          { en: "No ceratopsians", es: "Ningún ceratopsiano", de: "Keine Ceratopsier", nl: "Geen ceratopsiërs" },
          { en: "Psittacosaurus only", es: "Solo Psittacosaurus", de: "Nur Psittacosaurus", nl: "Alleen Psittacosaurus" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Finding juveniles of both species with distinct features", es: "Encontrar juveniles de ambas especies con características distintas", de: "Finden von Jungtieren beider Arten mit unterschiedlichen Merkmalen", nl: "Het vinden van jongen van beide soorten met verschillende kenmerken" },
      ...
      },
      {
        ...
        options: [
          { en: "It's the oldest known horned dinosaur with tall nose horn", es: "Es el dinosaurio con cuernos más antiguo conocido con cuerno nasal alto", de: "Es ist der älteste bekannte gehörnte Dinosaurier mit hohem Nasenhorn", nl: "Het is de oudste bekende gehoornde dinosaurus met hoge neushoorn" },
          { en: "It could fly", es: "Podía volar", de: "Er konnte fliegen", nl: "Het kon vliegen" },
          { en: "It was found on Mars", es: "Fue encontrado en Marte", de: "Er wurde auf dem Mars gefunden", nl: "Het werd op Mars gevonden" },
          { en: "It was made of gold", es: "Estaba hecho de oro", de: "Er war aus Gold", nl: "Het was van goud gemaakt" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "They had a unique slicing motion rather than grinding", es: "Tenían un movimiento de corte único en lugar de moler", de: "Sie hatten eine einzigartige Schneidebewegung statt zu mahlen", nl: "Ze hadden een unieke snijbeweging in plaats van malen" },
          { en: "They couldn't chew", es: "No podían masticar", de: "Sie konnten nicht kauen", nl: "Ze konden niet kauwen" },
          { en: "They had rotating jaws", es: "Tenían mandíbulas rotatorias", de: "Sie hatten rotierende Kiefer", nl: "Ze hadden roterende kaken" },
          { en: "They swallowed stones", es: "Tragaban piedras", de: "Sie schluckten Steine", nl: "Ze slikten stenen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Bone chemistry showing movement between different regions", es: "Química ósea mostrando movimiento entre diferentes regiones", de: "Knochenchemie zeigt Bewegung zwischen verschiedenen Regionen", nl: "Botchemie toont beweging tussen verschillende regio's" },
          { en: "Migration maps they drew", es: "Mapas de migración que dibujaron", de: "Migrationskarten die sie zeichneten", nl: "Migratiekaarten die ze tekenden" },
          { en: "GPS tracking", es: "Rastreo GPS", de: "GPS-Verfolgung", nl: "GPS-tracking" },
          { en: "They never moved", es: "Nunca se movían", de: "Sie bewegten sich nie", nl: "Ze bewogen nooit" }
        ],
        correct: 0,
        explanation: {
