// Velociraptors Quiz - Level 7: Advanced Knowledge
(function() {
  const level7 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "Barbule hooklets with microscopic nodes", es: "Ganchos de bárbulas con nodos microscópicos", de: "Widerhäkchen mit mikroskopischen Knoten", nl: "Barbule haakjes met microscopische knooppunten" },
          { en: "Hollow shaft structures with air chambers", es: "Estructuras de eje hueco con cámaras de aire", de: "Hohle Schaftstrukturen mit Luftkammern", nl: "Holle schacht structuren met luchtkamers" },
          { en: "Melanin granules in parallel arrangement", es: "Gránulos de melanina en disposición paralela", de: "Melanin-Granula in paralleler Anordnung", nl: "Melanine korrels in parallelle rangschikking" },
          { en: "Branched rachis with asymmetrical vanes", es: "Raquis ramificado con barbas asimétricas", de: "Verzweigter Rachis mit asymmetrischen Fahnen", nl: "Vertakte rachis met asymmetrische vanen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "18-22 km/h (11-14 mph)", es: "18-22 km/h (11-14 mph)", de: "18-22 km/h (11-14 mph)", nl: "18-22 km/h (11-14 mph)" },
          { en: "35-40 km/h (22-25 mph)", es: "35-40 km/h (22-25 mph)", de: "35-40 km/h (22-25 mph)", nl: "35-40 km/h (22-25 mph)" },
          { en: "45-50 km/h (28-31 mph)", es: "45-50 km/h (28-31 mph)", de: "45-50 km/h (28-31 mph)", nl: "45-50 km/h (28-31 mph)" },
          { en: "60-65 km/h (37-40 mph)", es: "60-65 km/h (37-40 mph)", de: "60-65 km/h (37-40 mph)", nl: "60-65 km/h (37-40 mph)" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Rapid lateral head strikes during prey capture", es: "Golpes laterales rápidos de cabeza durante la captura de presas", de: "Schnelle seitliche Kopfstöße beim Beutefang", nl: "Snelle zijdelingse kopslagen tijdens prooi vangst" },
          { en: "Enhanced vertical neck flexibility for ground foraging", es: "Flexibilidad vertical del cuello mejorada para forrajeo en el suelo", de: "Verbesserte vertikale Halsflexibilität für Bodennahrungssuche", nl: "Verbeterde verticale nek flexibiliteit voor grond foerageren" },
          { en: "Stabilized head position during high-speed pursuit", es: "Posición estabilizada de la cabeza durante persecución a alta velocidad", de: "Stabilisierte Kopfposition während schneller Verfolgung", nl: "Gestabiliseerde kop positie tijdens snelle achtervolging" },
          { en: "Precision control for complex social displays", es: "Control de precisión para exhibiciones sociales complejas", de: "Präzisionskontrolle für komplexe soziale Darstellungen", nl: "Precisie controle voor complexe sociale displays" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Solitary engagement with prey significantly larger than itself", es: "Enfrentamiento solitario con presa significativamente más grande que él mismo", de: "Einzelkampf mit Beute, die deutlich größer ist als es selbst", nl: "Solitair gevecht met prooi aanzienlijk groter dan zichzelf" },
          { en: "Evidence of multiple bite marks from different individuals", es: "Evidencia de múltiples marcas de mordida de diferentes individuos", de: "Beweis für mehrere Bissspuren verschiedener Individuen", nl: "Bewijs van meerdere beetsporen van verschillende individuen" },
          { en: "Coordinated attack positions preserved in the fossil", es: "Posiciones de ataque coordinadas preservadas en el fósil", de: "Koordinierte Angriffsstellungen im Fossil erhalten", nl: "Gecoördineerde aanvals posities bewaard in het fossiel" },
          { en: "Remains of multiple prey species in the stomach region", es: "Restos de múltiples especies de presa en la región del estómago", de: "Überreste mehrerer Beutearten in der Magenregion", nl: "Overblijfselen van meerdere prooi soorten in de maag regio" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Enlarged olfactory bulbs for enhanced scent detection", es: "Bulbos olfativos agrandados para detección de olores mejorada", de: "Vergrößerte Riechkolben für verbesserte Duftdetektion", nl: "Vergrote reukbollen voor verbeterde geur detectie" },
          { en: "Specialized inner ear structures for low-frequency hearing", es: "Estructuras del oído interno especializadas para audición de baja frecuencia", de: "Spezialisierte Innenohrstrukturen für niederfrequentes Hören", nl: "Gespecialiseerde binnenoor structuren voor laagfrequent gehoor" },
          { en: "Extended semicircular canals indicating exceptional balance", es: "Canales semicirculares extendidos indicando equilibrio excepcional", de: "Erweiterte Bogengänge, die außergewöhnliches Gleichgewicht anzeigen", nl: "Uitgebreide halfcirkelvormige kanalen die uitzonderlijk evenwicht aangeven" },
          { en: "Enlarged optic lobes suggesting enhanced night vision", es: "Lóbulos ópticos agrandados sugiriendo visión nocturna mejorada", de: "Vergrößerte Sehzentren, die verbesserte Nachtsicht andeuten", nl: "Vergrote optische lobben die verbeterd nachtzicht suggereren" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Rapid early growth with periodic growth arrests", es: "Crecimiento temprano rápido con arrestos de crecimiento periódicos", de: "Schnelles frühes Wachstum mit periodischen Wachstumsstopps", nl: "Snelle vroege groei met periodieke groei onderbrekingen" },
          { en: "Continuous steady growth throughout life", es: "Crecimiento continuo y constante durante toda la vida", de: "Kontinuierliches stetiges Wachstum während des ganzen Lebens", nl: "Continue gestage groei gedurende het hele leven" },
          { en: "Seasonal growth spurts alternating with dormancy", es: "Brotes de crecimiento estacionales alternando con latencia", de: "Saisonale Wachstumsschübe im Wechsel mit Ruhephasen", nl: "Seizoensgebonden groeispurts afgewisseld met dormantie" },
          { en: "Determinate growth ceasing at sexual maturity", es: "Crecimiento determinado que cesa en la madurez sexual", de: "Determiniertes Wachstum, das bei der Geschlechtsreife endet", nl: "Bepaalde groei die stopt bij geslachtsrijpheid" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Enhanced muscle attachment for powerful jumping", es: "Unión muscular mejorada para saltos potentes", de: "Verbesserte Muskelansätze für kraftvolles Springen", nl: "Verbeterde spieraanhechting voor krachtig springen" },
          { en: "Stabilization during rapid directional changes", es: "Estabilización durante cambios direccionales rápidos", de: "Stabilisierung bei schnellen Richtungsänderungen", nl: "Stabilisatie tijdens snelle richtingsveranderingen" },
          { en: "Support for extended bipedal stance phases", es: "Soporte para fases de postura bípeda extendida", de: "Unterstützung für erweiterte bipede Standphasen", nl: "Ondersteuning voor verlengde tweevoetige houding fases" },
          { en: "Reduction of stress during prey restraint", es: "Reducción del estrés durante la sujeción de presas", de: "Stressreduktion während der Beutefixierung", nl: "Vermindering van stress tijdens prooi vasthouding" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Puncturing thick integument and bone", es: "Perforar tegumento grueso y hueso", de: "Durchstechen dicker Haut und Knochen", nl: "Doorprikken van dikke huid en bot" },
          { en: "Grasping and restraining struggling prey", es: "Agarrar y sujetar presas que luchan", de: "Greifen und Festhalten kämpfender Beute", nl: "Grijpen en vasthouden van worstelende prooi" },
          { en: "Climbing and perching on elevated surfaces", es: "Escalar y posarse en superficies elevadas", de: "Klettern und Sitzen auf erhöhten Oberflächen", nl: "Klimmen en zitten op verhoogde oppervlakken" },
          { en: "Slashing and disemboweling attacks", es: "Ataques de corte y destripamiento", de: "Schneidende und ausweidende Angriffe", nl: "Snijdende en ontweidende aanvallen" }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Colonial nesting with shared incubation duties", es: "Anidación colonial con deberes de incubación compartidos", de: "Koloniales Nisten mit geteilten Brutpflichten", nl: "Koloniale nesting met gedeelde broedzorgen" },
          { en: "Elaborate nest construction with plant materials", es: "Construcción elaborada de nidos con materiales vegetales", de: "Aufwendiger Nestbau mit Pflanzenmaterialien", nl: "Uitgebreide nest constructie met plant materialen" },
          { en: "Biparental care with alternating brooding cycles", es: "Cuidado biparental con ciclos de incubación alternos", de: "Elterliche Fürsorge mit alternierenden Brutzyklen", nl: "Ouderlijke zorg met afwisselende broedcycli" },
          { en: "Temperature-controlled incubation using body heat", es: "Incubación controlada por temperatura usando calor corporal", de: "Temperaturkontrollierte Bebrütung mit Körperwärme", nl: "Temperatuur gecontroleerde incubatie met lichaamswarmte" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Large flightless birds (ostriches, emus)", es: "Aves grandes no voladoras (avestruces, emúes)", de: "Große flugunfähige Vögel (Strauße, Emus)", nl: "Grote niet-vliegende vogels (struisvogels, emoes)" },
          { en: "Medium-sized raptorial birds (hawks, falcons)", es: "Aves rapaces de tamaño mediano (halcones, falcones)", de: "Mittelgroße Greifvögel (Habichte, Falken)", nl: "Middelgrote roofvogels (haviken, valken)" },
          { en: "Social carnivorous mammals (wolves, hyenas)", es: "Mamíferos carnívoros sociales (lobos, hienas)", de: "Soziale fleischfressende Säugetiere (Wölfe, Hyänen)", nl: "Sociale vleesetende zoogdieren (wolven, hyena's)" },
          { en: "Intelligent corvids (ravens, crows)", es: "Córvidos inteligentes (cuervos, cornejas)", de: "Intelligente Rabenvögel (Raben, Krähen)", nl: "Intelligente kraaiachtigen (raven, kraaien)" }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Primarily fish and aquatic prey consumption", es: "Consumo principalmente de peces y presas acuáticas", de: "Hauptsächlich Fisch- und Wassertierverzehr", nl: "Voornamelijk vis en aquatische prooi consumptie" },
          { en: "Seasonal migration following herbivore herds", es: "Migración estacional siguiendo manadas de herbívoros", de: "Saisonale Migration folgend Pflanzenfresserherden", nl: "Seizoensgebonden migratie volgend herbivoor kuddes" },
          { en: "Opportunistic scavenging of large carcasses", es: "Carroñeo oportunista de cadáveres grandes", de: "Opportunistisches Aasfresserverhalten bei großen Kadavern", nl: "Opportunistisch aas eten van grote karkassen" },
          { en: "Selective predation on juvenile dinosaurs", es: "Depredación selectiva de dinosaurios juveniles", de: "Selektive Beutegreifung bei juvenilen Dinosauriern", nl: "Selectieve predatie op juveniele dinosauriërs" }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Extended breeding seasons lasting multiple months", es: "Temporadas de reproducción extendidas que duran múltiples meses", de: "Erweiterte Brutzeiten von mehreren Monaten", nl: "Uitgebreide broedseizonen die meerdere maanden duren" },
          { en: "Sexual dimorphism in reproductive timing", es: "Dimorfismo sexual en el momento reproductivo", de: "Sexueller Dimorphismus in der Fortpflanzungszeit", nl: "Seksueel dimorfisme in reproductieve timing" },
          { en: "Rapid eggshell calcification similar to modern birds", es: "Calcificación rápida de cáscara de huevo similar a aves modernas", de: "Schnelle Eierschalenkalkbildung ähnlich modernen Vögeln", nl: "Snelle eierschaal calcificatie vergelijkbaar met moderne vogels" },
          { en: "Sequential egg-laying with calcium resorption cycles", es: "Puesta secuencial de huevos with ciclos de reabsorción de calcio", de: "Sequenzielle Eiablage mit Kalziumresorptionszyklen", nl: "Sequentiële ei-legging met calcium resorptie cycli" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Pneumatic skull bones with air sac extensions", es: "Huesos craneales neumáticos con extensiones de sacos aéreos", de: "Pneumatische Schädelknochen mit Luftsackerweiterungen", nl: "Pneumatische schedel botten met luchtzak uitbreidingen" },
          { en: "Unidirectional airflow through parabronchi", es: "Flujo de aire unidireccional a través de parabronquios", de: "Unidirektionaler Luftstrom durch Parabronchien", nl: "Unidirectionele luchtstroom door parabronchi" },
          { en: "Separate respiratory and vocal sound production", es: "Producción separada de sonido respiratorio y vocal", de: "Getrennte respiratorische und vokale Tonerzeugung", nl: "Gescheiden ademhalings en vocale geluid productie" },
          { en: "Counter-current heat exchange in nasal passages", es: "Intercambio de calor en contracorriente en pasajes nasales", de: "Gegenstrom-Wärmetausch in Nasengängen", nl: "Tegenstroom warmte uitwisseling in neusholtes" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Ancestral flight capability with limited gliding", es: "Capacidad de vuelo ancestral con planeo limitado", de: "Angestammte Flugfähigkeit mit begrenztem Gleiten", nl: "Voorouderlijke vliegcapaciteit met beperkt zweven" },
          { en: "Strong pectoral muscle attachment for wing-flapping", es: "Unión fuerte del músculo pectoral para aleteo", de: "Starke Brustmuskelansätze für Flügelschlag", nl: "Sterke borstspier aanhechting voor vleugel klapperen" },
          { en: "Inherited structural framework from flying ancestors", es: "Marco estructural heredado de ancestros voladores", de: "Ererbter Strukturrahmen von fliegenden Vorfahren", nl: "Geërfd structureel raamwerk van vliegende voorouders" },
          { en: "Elastic energy storage for powerful arm movements", es: "Almacenamiento de energía elástica para movimientos poderosos del brazo", de: "Elastische Energiespeicherung für kraftvolle Armbewegungen", nl: "Elastische energie opslag voor krachtige arm bewegingen" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Flash flood deposits with rapid burial", es: "Depósitos de inundación repentina con entierro rápido", de: "Sturzflutablagerungen mit schneller Einbettung", nl: "Plotselinge overstromings afzettingen met snelle begraving" },
          { en: "Volcanic ash layers preserving fine details", es: "Capas de ceniza volcánica preservando detalles finos", de: "Vulkanascheschichten mit feiner Detailerhaltung", nl: "Vulkanische as lagen die fijne details bewaren" },
          { en: "Aeolian sand dune collapse and encasement", es: "Colapso de dunas de arena eólicas y encapsulamiento", de: "Kollaps äolischer Sanddünen und Einschluss", nl: "Eolische zand duin instorting en insluiting" },
          { en: "Lacustrine mudstone with seasonal preservation", es: "Fangolita lacustre con preservación estacional", de: "Lacustrine Schlammstein mit saisonaler Erhaltung", nl: "Lacustriene moddersteen met seizoensgebonden preservatie" }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Cursorial running on various substrate types", es: "Carrera cursorial en varios tipos de sustratos", de: "Kursorisches Laufen auf verschiedenen Untergrundtypen", nl: "Cursoriaal rennen op verschillende substraat types" },
          { en: "Arboreal climbing with precision grip control", es: "Escalada arbórea con control de agarre de precisión", de: "Baum-klettern mit präziser Griffkontrolle", nl: "Boom klimmen met precisie greep controle" },
          { en: "Specialized grasping during prey subdual", es: "Agarre especializado durante sometimiento de presas", de: "Spezialisiertes Greifen während Beuteunterdrückung", nl: "Gespecialiseerd grijpen tijdens prooi onderwerping" },
          { en: "Balance maintenance during complex maneuvers", es: "Mantenimiento del equilibrio durante maniobras complejas", de: "Gleichgewichtshaltung während komplexer Manöver", nl: "Balans onderhoud tijdens complexe manoeuvres" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Velociraptorinae - derived Asian dromaeosaurids", es: "Velociraptorinae - dromeosáuridos asiáticos derivados", de: "Velociraptorinae - abgeleitete asiatische Dromaeosauriden", nl: "Velociraptorinae - afgeleide Aziatische dromaeosauriden" },
          { en: "Saurornitholestinae - small-bodied specialists", es: "Saurornitholestinae - especialistas de cuerpo pequeño", de: "Saurornitholestinae - kleine Körperspezialist", nl: "Saurornitholestinae - kleine lichaam specialisten" },
          { en: "Dromaeosaurinae - large robust predators", es: "Dromaeosaurinae - depredadores robustos grandes", de: "Dromaeosaurinae - große robuste Raubtiere", nl: "Dromaeosaurinae - grote robuuste roofdieren" },
          { en: "Microraptorinae - early feathered forms", es: "Microraptorinae - formas emplumadas tempranas", de: "Microraptorinae - frühe gefiederte Formen", nl: "Microraptorinae - vroege gevederde vormen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Semi-arid conditions with seasonal water availability", es: "Condiciones semiáridas con disponibilidad estacional de agua", de: "Semiaride Bedingungen mit saisonaler Wasserverfügbarkeit", nl: "Semi-aride condities met seizoensgebonden water beschikbaarheid" },
          { en: "Humid tropical environment with dense vegetation", es: "Ambiente tropical húmedo con vegetación densa", de: "Feuchtropische Umgebung mit dichter Vegetation", nl: "Vochtige tropische omgeving met dichte vegetatie" },
          { en: "Cold temperate climate with coniferous forests", es: "Clima templado frío con bosques de coníferas", de: "Kaltes gemäßigtes Klima mit Nadelwäldern", nl: "Koud gematigd klimaat met naaldbossen" },
          { en: "Coastal marine influence with tidal fluctuations", es: "Influencia marina costera con fluctuaciones mareales", de: "Küstenmeereseinfluss mit Gezeitenschwankungen", nl: "Kustmariene invloed met getijden fluctuaties" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Presence of large flight feathers on the arms", es: "Presencia de plumas de vuelo grandes en los brazos", de: "Vorhandensein großer Flugfedern an den Armen", nl: "Aanwezigheid van grote vliegveren op de armen" },
          { en: "Seasonal molting patterns similar to modern birds", es: "Patrones de muda estacional similares a aves modernas", de: "Saisonale Mauserungsmuster ähnlich modernen Vögeln", nl: "Seizoensgebonden rui patronen vergelijkbaar met moderne vogels" },
          { en: "Specialized preening behaviors for feather maintenance", es: "Comportamientos especializados de acicalamiento para mantenimiento de plumas", de: "Spezialisierte Putzverhalten für Federpflege", nl: "Gespecialiseerd poetsen gedrag voor veer onderhoud" },
          { en: "Display capabilities using colorful plumage patterns", es: "Capacidades de exhibición usando patrones de plumaje coloridos", de: "Darstellungsfähigkeiten mit bunten Gefiedermuster", nl: "Display capaciteiten met kleurrijke veer patronen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "High metabolic rate with selective predation on terrestrial prey based on δ13C and δ18O signatures", es: "Alta tasa metabólica con depredación selectiva en presas terrestres basada en firmas δ13C y δ18O", de: "Hohe Stoffwechselrate mit selektiver Beute terrestrischer Beute basierend auf δ13C- und δ18O-Signaturen", nl: "Hoge metabole snelheid met selectieve predatie op terrestrische prooi gebaseerd op δ13C en δ18O signaturen" },
          { en: "Low metabolic rate indicating cold-blooded physiology", es: "Baja tasa metabólica indicando fisiología de sangre fría", de: "Niedrige Stoffwechselrate zeigt kaltblütige Physiologie", nl: "Lage metabole snelheid die koudbloedige fysiologie aangeeft" },
          { en: "Aquatic feeding specialization with fish-dominated diet", es: "Especialización alimentaria acuática con dieta dominada por peces", de: "Aquatische Fütterungsspezialisierung mit fischdomominierter Ernährung", nl: "Aquatische voeding specialisatie met vis-gedomineerd dieet" },
          { en: "Omnivorous diet including significant plant material", es: "Dieta omnívora incluyendo material vegetal significativo", de: "Omnivore Ernährung einschließlich signifikanter Pflanzenmaterial", nl: "Omnivoor dieet inclusief significant plantaardig materiaal" }
        ],
        correct: 0,
        explanation: {
