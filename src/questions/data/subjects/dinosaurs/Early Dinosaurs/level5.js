// Early Dinosaurs Quiz - Level 5: Upper Intermediate Knowledge
(function() {
  const level5 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
          { en: "It provided attachment for muscles supporting upright posture", es: "Proporcionaba inserción para músculos que soportaban la postura erecta", de: "Sie bot Ansatz für Muskeln, die die aufrechte Haltung unterstützten", nl: "Het bood aanhechting voor spieren die rechtopstaande houding ondersteunden" },
          { en: "It was purely decorative", es: "Era puramente decorativa", de: "Sie war rein dekorativ", nl: "Het was puur decoratief" },
          { en: "It helped with swimming", es: "Ayudaba con la natación", de: "Sie half beim Schwimmen", nl: "Het hielp bij zwemmen" },
          { en: "It stored fat reserves", es: "Almacenaba reservas de grasa", de: "Sie speicherte Fettreserven", nl: "Het opslagde vetreserves" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Sister taxon to Dinosauria within Dinosauromorpha", es: "Taxón hermano de Dinosauria dentro de Dinosauromorpha", de: "Schwestertaxon zu Dinosauria innerhalb Dinosauromorpha", nl: "Zustertaxon van Dinosauria binnen Dinosauromorpha" },
          { en: "Basal theropod dinosaur", es: "Dinosaurio terópodo basal", de: "Basaler Theropoden-Dinosaurier", nl: "Basale theropode dinosaurus" },
          { en: "Early sauropodomorph", es: "Sauropodomorfo temprano", de: "Früher Sauropodomorph", nl: "Vroege sauropodomorph" },
          { en: "Ornithischian ancestor", es: "Ancestro ornitisquio", de: "Ornithischier-Vorfahre", nl: "Ornithischische voorouder" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Large, recurved teeth with ziphodont serrations", es: "Dientes grandes y recurvados con serraciones zifodontes", de: "Große, rückgebogene Zähne mit ziphodonten Sägezähnen", nl: "Grote, achterwaarts gebogen tanden met ziphodonte vertanding" },
          { en: "Herbivorous dental battery", es: "Batería dental herbívora", de: "Herbivore Zahnbatterie", nl: "Herbivore tandbatterij" },
          { en: "Filter-feeding apparatus", es: "Aparato de alimentación por filtración", de: "Filterfutterapparat", nl: "Filtervoedsapparaat" },
          { en: "Seed-cracking molars", es: "Molares para romper semillas", de: "Samenknackende Backenzähne", nl: "Zaadkrakende kiezen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Fibrolamellar bone tissue with high vascularity", es: "Tejido óseo fibrolamelar con alta vascularidad", de: "Fibrolamelläres Knochengewebe mit hoher Vaskularisation", nl: "Fibrolamellaire botweefsel met hoge vasculariteit" },
          { en: "Solid bone with no blood vessels", es: "Hueso sólido sin vasos sanguíneos", de: "Solider Knochen ohne Blutgefäße", nl: "Solide bot zonder bloedvaten" },
          { en: "Cancellous bone only", es: "Solo hueso esponjoso", de: "Nur schwammiger Knochen", nl: "Alleen sponsachtig bot" },
          { en: "Cartilaginous tissue", es: "Tejido cartilaginoso", de: "Knorpeliges Gewebe", nl: "Kraakbeen weefsel" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "It contains some of the earliest dinosaur fossils from the Carnian", es: "Contiene algunos de los fósiles de dinosaurios más antiguos del Carniano", de: "Sie enthält einige der frühesten Dinosaurierfossilien aus dem Carnium", nl: "Het bevat enkele van de vroegste dinosaurusfossielen uit het Carnisch" },
          { en: "It preserves only marine fossils", es: "Preserva solo fósiles marinos", de: "Sie bewahrt nur marine Fossilien", nl: "Het bewaart alleen mariene fossielen" },
          { en: "It dates to the Permian period", es: "Data del período Pérmico", de: "Sie stammt aus der Perm-Periode", nl: "Het dateert uit de Perm-periode" },
          { en: "It contains only plant fossils", es: "Contiene solo fósiles de plantas", de: "Sie enthält nur Pflanzenfossilien", nl: "Het bevat alleen plantenfossielen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Evidence of reproductive physiology similar to modern birds", es: "Evidencia de fisiología reproductiva similar a las aves modernas", de: "Belege für Fortpflanzungsphysiologie ähnlich modernen Vögeln", nl: "Bewijs van reproductieve fysiologie vergelijkbaar met moderne vogels" },
          { en: "Proof of cold-blooded metabolism", es: "Prueba de metabolismo de sangre fría", de: "Beweis für kaltblütigen Stoffwechsel", nl: "Bewijs van koudbloedig metabolisme" },
          { en: "Evidence of hibernation", es: "Evidencia de hibernación", de: "Belege für Winterschlaf", nl: "Bewijs van winterslaap" },
          { en: "Sign of dietary deficiency", es: "Signo de deficiencia dietética", de: "Zeichen von Nahrungsmangel", nl: "Teken van voedingstekort" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Powerful hindlimb retraction for efficient terrestrial locomotion", es: "Retracción poderosa de las extremidades posteriores para locomoción terrestre eficiente", de: "Kraftvolle Hintergliedmaßenretraktion für effiziente terrestrische Fortbewegung", nl: "Krachtige achterpootretractie voor efficiënte terrestrische voortbeweging" },
          { en: "Adaptation for swimming", es: "Adaptación para nadar", de: "Anpassung zum Schwimmen", nl: "Aanpassing voor zwemmen" },
          { en: "Support for quadrupedal posture only", es: "Soporte solo para postura cuadrúpeda", de: "Unterstützung nur für vierbeinige Haltung", nl: "Ondersteuning alleen voor viervoetige houding" },
          { en: "Evidence of vestigial structures", es: "Evidencia de estructuras vestigiales", de: "Belege für vestigiale Strukturen", nl: "Bewijs van vestigiale structuren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "It preserves the earliest known sauropodomorph dinosaurs", es: "Preserva los dinosaurios sauropodomorphos más antiguos conocidos", de: "Sie bewahrt die frühesten bekannten Sauropodomorph-Dinosaurier", nl: "Het bewaart de vroegst bekende sauropodomorfe dinosaurussen" },
          { en: "It contains only Cretaceous fossils", es: "Contiene solo fósiles cretácicos", de: "Sie enthält nur Kreide-Fossilien", nl: "Het bevat alleen Krijt-fossielen" },
          { en: "It represents a marine environment", es: "Representa un ambiente marino", de: "Sie repräsentiert eine marine Umgebung", nl: "Het vertegenwoordigt een mariene omgeving" },
          { en: "It has no fossil content", es: "No tiene contenido fósil", de: "Sie hat keinen fossilen Inhalt", nl: "Het heeft geen fossiele inhoud" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Monospecific bone beds with size-segregated assemblages", es: "Lechos de huesos monoespecíficos con conjuntos segregados por tamaño", de: "Monospezifische Knochenbetten mit größensegregierte Ansammlungen", nl: "Monospecifieke botbedden met grootte-gesegregeerde assemblages" },
          { en: "Solitary burial patterns", es: "Patrones de entierro solitario", de: "Einsame Begräbnismuster", nl: "Eenzame begrafenispatronen" },
          { en: "Evidence of territorial behavior", es: "Evidencia de comportamiento territorial", de: "Belege für territoriales Verhalten", nl: "Bewijs van territoriaal gedrag" },
          { en: "Nest-building structures", es: "Estructuras de construcción de nidos", de: "Nestbau-Strukturen", nl: "Nestbouwstructuren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Catastrophic drought at a water source", es: "Sequía catastrófica en una fuente de agua", de: "Katastrophale Dürre an einer Wasserquelle", nl: "Catastrofale droogte bij een waterbron" },
          { en: "Volcanic ash burial", es: "Entierro por ceniza volcánica", de: "Vulkanasche-Begräbnis", nl: "Vulkanische as-begraving" },
          { en: "Predator accumulation", es: "Acumulación de depredadores", de: "Raubtier-Ansammlung", nl: "Roofdier-accumulatie" },
          { en: "Flooding event", es: "Evento de inundación", de: "Überschwemmungsereignis", nl: "Overstromingsgebeurtenis" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Mechanical processing of plant material in the stomach", es: "Procesamiento mecánico de material vegetal en el estómago", de: "Mechanische Verarbeitung von Pflanzenmaterial im Magen", nl: "Mechanische verwerking van plantaardig materiaal in de maag" },
          { en: "Storage of excess calcium", es: "Almacenamiento de calcio excesivo", de: "Speicherung von überschüssigem Kalzium", nl: "Opslag van overtollig calcium" },
          { en: "Ballast for swimming", es: "Lastre para nadar", de: "Ballast zum Schwimmen", nl: "Ballast voor zwemmen" },
          { en: "Territorial marking behavior", es: "Comportamiento de marcaje territorial", de: "Territoriales Markierungsverhalten", nl: "Territoriaal markeringsgedrag" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "They represent some of the earliest dinosaur tracks from the Middle Triassic", es: "Representan algunas de las huellas de dinosaurios más tempranas del Triásico Medio", de: "Sie repräsentieren einige der frühesten Dinosaurierspuren aus der Mittleren Trias", nl: "Ze vertegenwoordigen enkele van de vroegste dinosaurussporen uit de Midden-Trias" },
          { en: "They show evidence of flight", es: "Muestran evidencia de vuelo", de: "Sie zeigen Belege für Flug", nl: "Ze tonen bewijs van vlucht" },
          { en: "They indicate marine habitat use", es: "Indican uso de hábitat marino", de: "Sie zeigen Nutzung mariner Lebensräume an", nl: "Ze geven mariene habitatgebruik aan" },
          { en: "They preserve egg-laying behavior", es: "Preservan comportamiento de puesta de huevos", de: "Sie bewahren Eiablage-Verhalten", nl: "Ze bewaren eileggedrag" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Elongated penultimate phalanges and recurved unguals", es: "Falanges penúltimas alargadas y ungueales recurvados", de: "Verlängerte vorletzte Phalangen und rückgebogene Krallen", nl: "Verlengde voorlaatste phalangen en achterwaarts gebogen klauwen" },
          { en: "Reduced digit count", es: "Conteo de dígitos reducido", de: "Reduzierte Fingerzahl", nl: "Verminderd aantal vingers" },
          { en: "Webbed fingers", es: "Dedos palmeados", de: "Schwimmhäute zwischen den Fingern", nl: "Zwemvliezen tussen vingers" },
          { en: "Fused metacarpals", es: "Metacarpianos fusionados", de: "Verschmolzene Mittelhandknochen", nl: "Versmolten middenhandsbeenderen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Complex crystalline structure suggesting extended incubation", es: "Estructura cristalina compleja sugiriendo incubación extendida", de: "Komplexe kristalline Struktur, die verlängerte Bebrütung nahelegt", nl: "Complexe kristallijne structuur die verlengde broeding suggereert" },
          { en: "Simple membrane-only structure", es: "Estructura simple solo de membrana", de: "Einfache Nur-Membran-Struktur", nl: "Eenvoudige alleen-membraan structuur" },
          { en: "Absence of calcium carbonate", es: "Ausencia de carbonato de calcio", de: "Abwesenheit von Kalziumkarbonat", nl: "Afwezigheid van calciumcarbonaat" },
          { en: "Identical to fish eggs", es: "Idéntico a huevos de pez", de: "Identisch mit Fischeiern", nl: "Identiek aan vis-eieren" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Magnetostratigraphic correlation of the Ischigualasto Formation", es: "Correlación magnetoestratigráfica de la Formación Ischigualasto", de: "Magnetostratigraphische Korrelation der Ischigualasto-Formation", nl: "Magnetostratigrafische correlatie van de Ischigualasto-formatie" },
          { en: "Evidence of magnetic navigation", es: "Evidencia de navegación magnética", de: "Belege für magnetische Navigation", nl: "Bewijs van magnetische navigatie" },
          { en: "Magnetic minerals in bones", es: "Minerales magnéticos en huesos", de: "Magnetische Mineralien in Knochen", nl: "Magnetische mineralen in botten" },
          { en: "Compass behavior in trackways", es: "Comportamiento de brújula en huellas", de: "Kompassverhalten in Spurwegen", nl: "Kompasgedrag in sporen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Reduced joint stress during high-impact locomotion", es: "Estrés articular reducido durante locomoción de alto impacto", de: "Reduzierter Gelenkstress bei hochbelastender Fortbewegung", nl: "Verminderde gewrichtsstress tijdens hoge-impact voortbeweging" },
          { en: "Increased swimming efficiency", es: "Mayor eficiencia de natación", de: "Erhöhte Schwimmeffizienz", nl: "Verhoogde zwemefficiëntie" },
          { en: "Better heat dissipation", es: "Mejor disipación de calor", de: "Bessere Wärmeableitung", nl: "Betere warmteafvoer" },
          { en: "Improved hearing ability", es: "Capacidad auditiva mejorada", de: "Verbesserte Hörfähigkeit", nl: "Verbeterd gehoorvermogen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Evidence for elevated and stable core body temperatures", es: "Evidencia de temperaturas corporales centrales elevadas y estables", de: "Belege für erhöhte und stabile Körperkerntemperaturen", nl: "Bewijs voor verhoogde en stabiele lichaamstemperaturen" },
          { en: "Proof of seasonal hibernation", es: "Prueba de hibernación estacional", de: "Beweis für saisonalen Winterschlaf", nl: "Bewijs van seizoenshibernatie" },
          { en: "Evidence of daily temperature cycling", es: "Evidencia de ciclos de temperatura diarios", de: "Belege für tägliche Temperaturzyklen", nl: "Bewijs van dagelijkse temperatuurcycli" },
          { en: "Indication of external heat sources", es: "Indicación de fuentes de calor externas", de: "Hinweise auf externe Wärmequellen", nl: "Indicatie van externe warmtebronnen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Early evolution of avian-style respiratory system", es: "Evolución temprana del sistema respiratorio estilo aviar", de: "Frühe Evolution des vogelartigen Atmungssystems", nl: "Vroege evolutie van vogelachtig ademhalingssysteem" },
          { en: "Evidence of aquatic adaptation", es: "Evidencia de adaptación acuática", de: "Belege für aquatische Anpassung", nl: "Bewijs van aquatische aanpassing" },
          { en: "Pathological bone conditions", es: "Condiciones óseas patológicas", de: "Pathologische Knochenzustände", nl: "Pathologische botomstandigheden" },
          { en: "Mineral deficiency symptoms", es: "Síntomas de deficiencia mineral", de: "Symptome von Mineralstoffmangel", nl: "Mineraaltekort symptomen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Enhanced stride efficiency and reduced metabolic cost", es: "Mayor eficiencia de zancada y menor costo metabólico", de: "Verbesserte Schrittstellungseffizienz und reduzierte Stoffwechselkosten", nl: "Verbeterde stap-efficiëntie en verminderde metabolische kosten" },
          { en: "Improved swimming capabilities", es: "Capacidades de natación mejoradas", de: "Verbesserte Schwimmfähigkeiten", nl: "Verbeterde zwemcapaciteiten" },
          { en: "Better branch gripping for arboreal life", es: "Mejor agarre de ramas para vida arbórea", de: "Besserer Astgriff für Baumleben", nl: "Betere takgreep voor boomlevens" },
          { en: "Enhanced digging abilities", es: "Capacidades de excavación mejoradas", de: "Verbesserte Grabfähigkeiten", nl: "Verbeterde graafvaardigheden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Larger cerebellum relative to brain size, suggesting enhanced motor coordination", es: "Cerebelo más grande relativo al tamaño del cerebro, sugiriendo coordinación motora mejorada", de: "Größeres Kleinhirn relativ zur Gehirngröße, was auf verbesserte motorische Koordination hindeutet", nl: "Groter cerebellum relatief tot hersengrootte, wat verbeterde motorische coördinatie suggereert" },
          { en: "Identical brain structure with no differences", es: "Estructura cerebral idéntica sin diferencias", de: "Identische Gehirnstruktur ohne Unterschiede", nl: "Identieke hersenstructuur zonder verschillen" },
          { en: "Smaller overall brain size indicating lower intelligence", es: "Tamaño cerebral general más pequeño indicando menor inteligencia", de: "Kleinere Gesamtgehirngröße, die auf geringere Intelligenz hindeutet", nl: "Kleinere algehele hersengrootte die lagere intelligentie aangeeft" },
          { en: "Complete absence of sensory processing areas", es: "Ausencia completa de áreas de procesamiento sensorial", de: "Völlige Abwesenheit von sensorischen Verarbeitungsbereichen", nl: "Volledige afwezigheid van sensorische verwerkingsgebieden" }
        ],
        correct: 0,
        explanation: {
