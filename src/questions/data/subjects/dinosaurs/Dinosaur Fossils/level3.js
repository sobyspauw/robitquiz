    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Highly alkaline (pH 10-11)",
                  "es": "Altamente alcalino (pH 10-11)",
                  "de": "Stark alkalisch (pH 10-11)",
                  "nl": "Zeer alkalisch (pH 10-11)"
        },
        {
                  "en": "Extremely acidic (pH 1-2)",
                  "es": "Extremadamente ácido (pH 1-2)",
                  "de": "Extrem sauer (pH 1-2)",
                  "nl": "Extreem zuur (pH 1-2)"
        },
        {
                  "en": "Highly acidic (pH 3-4)",
                  "es": "Altamente ácido (pH 3-4)",
                  "de": "Stark sauer (pH 3-4)",
                  "nl": "Zeer zuur (pH 3-4)"
        },
        {
                  "en": "Neutral to slightly alkaline (pH 7-8)",
                  "es": "Neutro a ligeramente alcalino (pH 7-8)",
                  "de": "Neutral bis leicht alkalisch (pH 7-8)",
                  "nl": "Neutraal tot licht alkalisch (pH 7-8)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They multiply and spread",
                  "es": "Se multiplican y se extienden",
                  "de": "Sie vermehren sich und breiten sich aus",
                  "nl": "Ze vermenigvuldigen zich en verspreiden zich"
        },
        {
                  "en": "They remain completely unchanged",
                  "es": "Permanecen completamente sin cambios",
                  "de": "Sie bleiben völlig unverändert",
                  "nl": "Ze blijven volledig onveranderd"
        },
        {
                  "en": "They are gradually replaced by minerals",
                  "es": "Son gradualmente reemplazados por minerales",
                  "de": "Sie werden allmählich durch Mineralien ersetzt",
                  "nl": "Ze worden geleidelijk vervangen door mineralen"
        },
        {
                  "en": "They turn into plastic",
                  "es": "Se convierten en plástico",
                  "de": "Sie verwandeln sich in Plastik",
                  "nl": "Ze veranderen in plastic"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It prevents all fossilization",
                  "es": "Previene toda fosilización",
                  "de": "Es verhindert jede Fossilisation",
                  "nl": "Het voorkomt alle fossilisatie"
        },
        {
                  "en": "It has no effect on fossils",
                  "es": "No tiene efecto en los fósiles",
                  "de": "Es hat keinen Effekt auf Fossilien",
                  "nl": "Het heeft geen effect op fossielen"
        },
        {
                  "en": "It carries dissolved minerals into bone pores",
                  "es": "Transporta minerales disueltos hacia los poros de los huesos",
                  "de": "Es trägt gelöste Mineralien in Knochenporen",
                  "nl": "Het draagt opgeloste mineralen naar botporiën"
        },
        {
                  "en": "It only dissolves bones completely",
                  "es": "Solo disuelve los huesos completamente",
                  "de": "Es löst nur Knochen vollständig auf",
                  "nl": "Het lost alleen botten volledig op"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Replacement of organic matter with iron sulfide",
                  "es": "Reemplazo de materia orgánica con sulfuro de hierro",
                  "de": "Ersatz organischer Materie durch Eisensulfid",
                  "nl": "Vervanging van organisch materiaal door ijzersulfide"
        },
        {
                  "en": "Coating fossils with gold",
                  "es": "Recubrimiento de fósiles con oro",
                  "de": "Beschichtung von Fossilien mit Gold",
                  "nl": "Bedekking van fossielen met goud"
        },
        {
                  "en": "Burning of fossils at high temperatures",
                  "es": "Quema de fósiles a altas temperaturas",
                  "de": "Verbrennung von Fossilien bei hohen Temperaturen",
                  "nl": "Verbranding van fossielen bij hoge temperaturen"
        },
        {
                  "en": "Freezing fossils in ice",
                  "es": "Congelación de fósiles en hielo",
                  "de": "Einfrieren von Fossilien in Eis",
                  "nl": "Bevriezen van fossielen in ijs"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Allochthonous fossils are better preserved",
                  "es": "Los fósiles alóctonos están mejor preservados",
                  "de": "Allochthone Fossilien sind besser erhalten",
                  "nl": "Allochtone fossielen zijn beter bewaard"
        },
        {
                  "en": "Autochthonous fossils are older",
                  "es": "Los fósiles autóctonos son más antiguos",
                  "de": "Autochthone Fossilien sind älter",
                  "nl": "Autochtone fossielen zijn ouder"
        },
        {
                  "en": "Autochthonous fossils are found where organisms lived, allochthonous are transported",
                  "es": "Los fósiles autóctonos se encuentran donde vivían los organismos, los alóctonos son transportados",
                  "de": "Autochthone Fossilien werden dort gefunden, wo Organismen lebten, allochthone sind transportiert",
                  "nl": "Autochtone fossielen worden gevonden waar organismen leefden, allochtone zijn getransporteerd"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All parts preserve equally",
                  "es": "Todas las partes se preservan igualmente",
                  "de": "Alle Teile erhalten sich gleich",
                  "nl": "Alle delen bewaren zich gelijk"
        },
        {
                  "en": "Different durability of body parts and environmental factors",
                  "es": "Diferente durabilidad de las partes del cuerpo y factores ambientales",
                  "de": "Unterschiedliche Haltbarkeit von Körperteilen und Umweltfaktoren",
                  "nl": "Verschillende duurzaamheid van lichaamsdelen en omgevingsfactoren"
        },
        {
                  "en": "Only size matters",
                  "es": "Solo el tamaño importa",
                  "de": "Nur die Größe zählt",
                  "nl": "Alleen grootte telt"
        },
        {
                  "en": "Random chance only",
                  "es": "Solo casualidad aleatoria",
                  "de": "Nur zufälliger Zufall",
                  "nl": "Alleen willekeurig toeval"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fossils become transparent",
                  "es": "Los fósiles se vuelven transparentes",
                  "de": "Fossilien werden durchsichtig",
                  "nl": "Fossielen worden transparant"
        },
        {
                  "en": "Fossils multiply in number",
                  "es": "Los fósiles se multiplican en número",
                  "de": "Fossilien vermehren sich zahlenmäßig",
                  "nl": "Fossielen vermenigvuldigen in aantal"
        },
        {
                  "en": "Original minerals reorganize into larger, more stable crystal structures",
                  "es": "Los minerales originales se reorganizan en estructuras cristalinas más grandes y estables",
                  "de": "Ursprüngliche Mineralien reorganisieren sich zu größeren, stabileren Kristallstrukturen",
                  "nl": "Oorspronkelijke mineralen reorganiseren zich tot grotere, stabielere kristalstructuren"
        },
        {
                  "en": "Fossils turn into glass",
                  "es": "Los fósiles se convierten en vidrio",
                  "de": "Fossilien verwandeln sich in Glas",
                  "nl": "Fossielen veranderen in glas"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A type of dinosaur bone",
                  "es": "Un tipo de hueso de dinosaurio",
                  "de": "Eine Art Dinosaurier-Knochen",
                  "nl": "Een type dinosaurusbot"
        },
        {
                  "en": "A rock formation",
                  "es": "Una formación rocosa",
                  "de": "Eine Gesteinsformation",
                  "nl": "Een gesteenteformatie"
        },
        {
                  "en": "A deposit with exceptionally preserved fossils including soft tissues",
                  "es": "Un depósito con fósiles excepcionalmente preservados incluyendo tejidos blandos",
                  "de": "Eine Lagerstätte mit außergewöhnlich erhaltenen Fossilien einschließlich Weichgewebe",
                  "nl": "Een afzetting met uitzonderlijk bewaarde fossielen inclusief zachte weefsels"
        },
        {
                  "en": "A fossilized plant",
                  "es": "Una planta fosilizada",
                  "de": "Eine fossile Pflanze",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "High oxygen with cold temperatures",
                  "es": "Alto oxígeno con temperaturas frías",
                  "de": "Hoher Sauerstoff mit kalten Temperaturen",
                  "nl": "Hoge zuurstof met koude temperaturen"
        },
        {
                  "en": "Underwater with high oxygen",
                  "es": "Bajo agua con alto oxígeno",
                  "de": "Unter Wasser mit hohem Sauerstoff",
                  "nl": "Onder water met hoge zuurstof"
        },
        {
                  "en": "Anoxic (oxygen-free) conditions with heat and pressure",
                  "es": "Condiciones anóxicas (sin oxígeno) con calor y presión",
                  "de": "Anoxische (sauerstofffreie) Bedingungen mit Hitze und Druck",
                  "nl": "Anoxische (zuurstofvrije) omstandigheden met hitte en druk"
        },
        {
                  "en": "Dry desert conditions",
                  "es": "Condiciones secas de desierto",
                  "de": "Trockene Wüstenbedingungen",
                  "nl": "Droge woestijnomstandigheden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They are modern animal bones",
                  "es": "Son huesos de animales modernos",
                  "de": "Sie sind moderne Tierknochen",
                  "nl": "Ze zijn moderne dierenbotten"
        },
        {
                  "en": "They represent mass mortality events or concentrated accumulations",
                  "es": "Representan eventos de mortalidad masiva o acumulaciones concentradas",
                  "de": "Sie repräsentieren Massensterben-Ereignisse oder konzentrierte Ansammlungen",
                  "nl": "Ze vertegenwoordigen massa-sterfte-gebeurtenissen of geconcentreerde ophopingen"
        },
        {
                  "en": "They are always fake fossils",
                  "es": "Siempre son fósiles falsos",
                  "de": "Sie sind immer gefälschte Fossilien",
                  "nl": "Ze zijn altijd nep-fossielen"
        },
        {
                  "en": "They only contain plant fossils",
                  "es": "Solo contienen fósiles de plantas",
                  "de": "Sie enthalten nur Pflanzenfossilien",
                  "nl": "Ze bevatten alleen plantfossielen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Burning with phosphate",
                  "es": "Quema con fosfato",
                  "de": "Verbrennung mit Phosphat",
                  "nl": "Verbranding met fosfaat"
        },
        {
                  "en": "Freezing in phosphate ice",
                  "es": "Congelación en hielo de fosfato",
                  "de": "Einfrieren in Phosphateis",
                  "nl": "Bevriezen in fosfaatijs"
        },
        {
                  "en": "Addition of artificial colors",
                  "es": "Adición de colores artificiales",
                  "de": "Zusatz künstlicher Farben",
                  "nl": "Toevoeging van kunstmatige kleuren"
        },
        {
                  "en": "Replacement of tissues with calcium phosphate minerals",
                  "es": "Reemplazo de tejidos con minerales de fosfato de calcio",
                  "de": "Ersatz von Geweben durch Kalziumphosphat-Mineralien",
                  "nl": "Vervanging van weefsels door calciumfosfaatmineralen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Natural magnetism",
                  "es": "Magnetismo natural",
                  "de": "Natürlicher Magnetismus",
                  "nl": "Natuurlijk magnetisme"
        },
        {
                  "en": "Aliens building protective shells",
                  "es": "Alienígenas construyendo caparazones protectores",
                  "de": "Außerirdische, die Schutzhüllen bauen",
                  "nl": "Buitenaardsen die beschermende schalen bouwen"
        },
        {
                  "en": "Localized cementation around decaying organic matter",
                  "es": "Cementación localizada alrededor de materia orgánica en descomposición",
                  "de": "Lokalisierte Zementierung um zerfallendes organisches Material",
                  "nl": "Gelokaliseerde cementering rond vergaan organisch materiaal"
        },
        {
                  "en": "Solar radiation",
                  "es": "Radiación solar",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Microbes have no effect on fossils",
                  "es": "Los microbios no tienen efecto en los fósiles",
                  "de": "Mikroben haben keinen Effekt auf Fossilien",
                  "nl": "Microben hebben geen effect op fossielen"
        },
        {
                  "en": "Microbes can both accelerate decay and promote mineralization",
                  "es": "Los microbios pueden acelerar la descomposición y promover la mineralización",
                  "de": "Mikroben können sowohl Verfall beschleunigen als auch Mineralisierung fördern",
                  "nl": "Microben kunnen zowel verval versnellen als mineralisatie bevorderen"
        },
        {
                  "en": "Microbes only eat fossils",
                  "es": "Los microbios solo comen fósiles",
                  "de": "Mikroben fressen nur Fossilien",
                  "nl": "Microben eten alleen fossielen"
        },
        {
                  "en": "Microbes always prevent fossilization",
                  "es": "Los microbios siempre previenen la fosilización",
                  "de": "Mikroben verhindern immer Fossilisation",
                  "nl": "Microben voorkomen altijd fossilisatie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Original material dissolved and replaced molecule by molecule",
                  "es": "Material original disuelto y reemplazado molécula por molécula",
                  "de": "Ursprüngliches Material gelöst und Molekül für Molekül ersetzt",
                  "nl": "Oorspronkelijk materiaal opgelost en molecuul voor molecuul vervangen"
        },
        {
                  "en": "Finding new fossils to replace old ones",
                  "es": "Encontrar nuevos fósiles para reemplazar los antiguos",
                  "de": "Neue Fossilien finden, um alte zu ersetzen",
                  "nl": "Nieuwe fossielen vinden om oude te vervangen"
        },
        {
                  "en": "Making copies of fossils in laboratories",
                  "es": "Hacer copias de fósiles en laboratorios",
                  "de": "Kopien von Fossilien in Labors erstellen",
                  "nl": "Kopieën van fossielen maken in laboratoria"
        },
        {
                  "en": "Trading fossils between museums",
                  "es": "Intercambiar fósiles entre museos",
                  "de": "Fossilien zwischen Museen tauschen",
                  "nl": "Fossielen ruilen tussen musea"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Exposure to air for long periods",
                  "es": "Exposición al aire por largos períodos",
                  "de": "Langzeitbelichtung an der Luft",
                  "nl": "Blootstelling aan lucht voor lange perioden"
        },
        {
                  "en": "Rapid burial, low oxygen, and specific mineral chemistry",
                  "es": "Entierro rápido, poco oxígeno y química mineral específica",
                  "de": "Schnelle Begrabung, wenig Sauerstoff und spezifische Mineralchemie",
                  "nl": "Snelle begraving, lage zuurstof en specifieke mineraalchemie"
        },
        {
                  "en": "High temperatures and bright sunlight",
                  "es": "Altas temperaturas y luz solar brillante",
                  "de": "Hohe Temperaturen und helles Sonnenlicht",
                  "nl": "Hoge temperaturen en fel zonlicht"
        },
        {
                  "en": "Regular movement by water currents",
                  "es": "Movimiento regular por corrientes de agua",
                  "de": "Regelmäßige Bewegung durch Wasserströmungen",
                  "nl": "Regelmatige beweging door waterstromingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Growth of fossils over time",
                  "es": "Crecimiento de fósiles con el tiempo",
                  "de": "Wachstum von Fossilien über die Zeit",
                  "nl": "Groei van fossielen in de tijd"
        },
        {
                  "en": "Chemical breakdown of minerals that can destroy or create molds",
                  "es": "Descomposición química de minerales que puede destruir o crear moldes",
                  "de": "Chemischer Abbau von Mineralien, der zerstören oder Formen schaffen kann",
                  "nl": "Chemische afbraak van mineralen die kan vernietigen of mallen creëren"
        },
        {
                  "en": "Physical breaking of fossils",
                  "es": "Rotura física de fósiles",
                  "de": "Physisches Brechen von Fossilien",
                  "nl": "Fysieke breking van fossielen"
        },
        {
                  "en": "Movement of fossils underground",
                  "es": "Movimiento de fósiles bajo tierra",
                  "de": "Bewegung von Fossilien unter der Erde",
                  "nl": "Beweging van fossielen ondergronds"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Measuring fossil sizes",
                  "es": "Medición de tamaños de fósiles",
                  "de": "Messung von Fossilgrößen",
                  "nl": "Meting van fossielgroottes"
        },
        {
                  "en": "Counting fossil teeth",
                  "es": "Conteo de dientes fósiles",
                  "de": "Zählung fossiler Zähne",
                  "nl": "Tellen van fossiele tanden"
        },
        {
                  "en": "Study of fossil colors only",
                  "es": "Estudio de colores de fósiles solamente",
                  "de": "Studie nur von Fossilfarben",
                  "nl": "Studie van alleen fossielkleuren"
        },
        {
                  "en": "Using characteristic fossils to correlate and date rock layers",
                  "es": "Usar fósiles característicos para correlacionar y datar capas de roca",
                  "de": "Verwendung charakteristischer Fossilien zur Korrelation und Datierung von Gesteinsschichten",
                  "nl": "Gebruik van karakteristieke fossielen om gesteentelagen te correleren en dateren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fossils become colorful",
                  "es": "Los fósiles se vuelven coloridos",
                  "de": "Fossilien werden farbenfroh",
                  "nl": "Fossielen worden kleurrijk"
        },
        {
                  "en": "Water is added to sediments",
                  "es": "Se añade agua a los sedimentos",
                  "de": "Wasser wird zu Sedimenten hinzugefügt",
                  "nl": "Water wordt toegevoegd aan sedimenten"
        },
        {
                  "en": "Sediments are pressed together, reducing pore space and flattening fossils",
                  "es": "Los sedimentos se comprimen juntos, reduciendo el espacio poroso y aplanando fósiles",
                  "de": "Sedimente werden zusammengepresst, reduzieren Porenraum und flachen Fossilien ab",
                  "nl": "Sedimenten worden samengeperst, waardoor poriënruimte vermindert en fossielen platgedrukt worden"
        },
        {
                  "en": "Fossils grow larger",
                  "es": "Los fósiles crecen más",
                  "de": "Fossilien werden größer",
                  "nl": "Fossielen worden groter"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The study of processes that affect organisms from death to fossilization",
                  "es": "El estudio de procesos que afectan organismos desde la muerte hasta la fosilización",
                  "de": "Die Studie von Prozessen, die Organismen vom Tod bis zur Fossilisation beeinflussen",
                  "nl": "De studie van processen die organismen beïnvloeden van dood tot fossilisatie"
        },
        {
                  "en": "The naming of new dinosaur species",
                  "es": "La denominación de nuevas especies de dinosaurios",
                  "de": "Die Benennung neuer Dinosaurierarten",
                  "nl": "Het benoemen van nieuwe dinosaurussoorten"
        },
        {
                  "en": "The measurement of fossil sizes",
                  "es": "La medición de tamaños de fósiles",
                  "de": "Die Messung von Fossilgrößen",
                  "nl": "Het meten van fossielgroottes"
        },
        {
