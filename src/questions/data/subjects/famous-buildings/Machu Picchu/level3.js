    ...
    questions: [
      {
        ...
        {
                  "en": "Stone hammers and bronze chisels",
                  "es": "Martillos de piedra y cinceles de bronce",
                  "de": "Steinhämmer und Bronzemeißel",
                  "nl": "Stenen hamers en bronzen beitels"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gaps of several centimeters",
                  "es": "Espacios de varios centímetros",
                  "de": "Lücken von mehreren Zentimetern",
                  "nl": "Ruimtes van verschillende centimeters"
        },
        {
                  "en": "So tight a knife blade cannot fit between stones",
                  "es": "Tan ajustado que una hoja de cuchillo no cabe entre las piedras",
                  "de": "So eng, dass eine Messerklinge nicht zwischen die Steine passt",
                  "nl": "Zo strak dat een mesblad niet tussen de stenen past"
        },
        {
                  "en": "Loosely stacked",
                  "es": "Apiladas sin orden",
                  "de": "Lose gestapelt",
                  "nl": "Los gestapeld"
        },
        {
                  "en": "Held together with cement",
                  "es": "Unidos con cemento",
                  "de": "Mit Zement zusammengehalten",
                  "nl": "Bijeengehouden met cement"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ashlar (finely cut) and fieldstone (rough)",
                  "es": "Sillar (finamente cortado) y piedra de campo (tosca)",
                  "de": "Quaderstein (fein geschnitten) und Feldstein (rau)",
                  "nl": "Ashlar (fijn gesneden) en veldst een (ruw)"
        },
        {
                  "en": "Brick and wood",
                  "es": "Ladrillo y madera",
                  "de": "Ziegel und Holz",
                  "nl": "Baksteen en hout"
        },
        {
                  "en": "Concrete and steel",
                  "es": "Concreto y acero",
                  "de": "Beton und Stahl",
                  "nl": "Beton en staal"
        },
        {
                  "en": "Gothic and Renaissance",
                  "es": "Gótico y Renacimiento",
                  "de": "Gotisch und Renaissance",
                  "nl": "Gotisch en Renaissance"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Three: Sacred, Residential, and Industrial",
                  "es": "Tres: Sagrado, Residencial e Industrial",
                  "de": "Drei: Sakral, Wohn- und Industrie-",
                  "nl": "Drie: Heilig, Residentieel en Industrieel"
        },
        {
                  "en": "Four: North, South, East, West",
                  "es": "Cuatro: Norte, Sur, Este, Oeste",
                  "de": "Vier: Nord, Süd, Ost, West",
                  "nl": "Vier: Noord, Zuid, Oost, West"
        },
        {
                  "en": "Two: Sacred and Residential",
                  "es": "Dos: Sagrado y Residencial",
                  "de": "Zwei: Sakral und Wohn-",
                  "nl": "Twee: Heilig en Residentieel"
        },
        {
                  "en": "Five: Palace, Temple, Market, Residential, Storage",
                  "es": "Cinco: Palacio, Templo, Mercado, Residencial, Almacenamiento",
                  "de": "Fünf: Palast, Tempel, Markt, Wohn-, Lager-",
                  "nl": "Vijf: Paleis, Tempel, Markt, Residentieel, Opslag"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "A main wall or plaza",
                  "es": "Un muro principal o plaza",
                  "de": "Eine Hauptmauer oder Plaza",
                  "nl": "Een hoofdmuur of plein"
        },
        {
                  "en": "A river",
                  "es": "Un río",
      ...
      },
      {
        ...
        {
                  "en": "Deep foundations",
                  "es": "Cimientos profundos",
                  "de": "Tiefe Fundamente",
                  "nl": "Diepe fundamenten"
        },
        {
                  "en": "Flexible dry-stone walls that move and resettle",
                  "es": "Muros flexibles de piedra seca que se mueven y se reacomodan",
                  "de": "Flexible Trockenmauern, die sich bewegen und neu setzen",
                  "nl": "Flexibele droge-stenen muren die bewegen en opnieuw schikken"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "Thatched roofs made of ichu grass",
                  "es": "Techos de paja hechos de pasto ichu",
                  "de": "Strohdächer aus Ichu-Gras",
                  "nl": "Rieten daken gemaakt van ichu-gras"
        },
        {
                  "en": "Metal sheets",
                  "es": "Láminas de metal",
      ...
      },
      {
        ...
        {
                  "en": "To save stone",
                  "es": "Para ahorrar piedra",
                  "de": "Um Stein zu sparen",
                  "nl": "Om steen te besparen"
        },
        {
        ...
        {
                  "en": "Better structural stability during earthquakes",
                  "es": "Mejor estabilidad estructural durante terremotos",
                  "de": "Bessere strukturelle Stabilität bei Erdbeben",
                  "nl": "Betere structurele stabiliteit tijdens aardbevingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "They were carved on site from existing rock",
                  "es": "Fueron talladas en el sitio de roca existente",
                  "de": "Sie wurden vor Ort aus bestehendem Gestein geschnitzt",
                  "nl": "Ze werden ter plaatse uit bestaand gesteente gehouwen"
        },
        {
                  "en": "Manual labor using log rollers, ropes, and ramps",
                  "es": "Trabajo manual usando rodillos de troncos, cuerdas y rampas",
                  "de": "Handarbeit unter Verwendung von Baumstammrollen, Seilen und Rampen",
                  "nl": "Handarbeid met behulp van boomstamrollen, touwen en hellingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "To tie ropes for securing thatched roofs",
                  "es": "Para atar cuerdas y asegurar techos de paja",
                  "de": "Zum Binden von Seilen zur Sicherung von Strohdächern",
                  "nl": "Om touwen vast te binden voor het beveiligen van rieten daken"
        },
        {
                  "en": "Decoration",
                  "es": "Decoración",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Layers of gravel and sand for drainage",
                  "es": "Capas de grava y arena para drenaje",
                  "de": "Schichten aus Kies und Sand zur Entwässerung",
                  "nl": "Lagen grind en zand voor drainage"
        },
        {
                  "en": "Wood pilings",
                  "es": "Pilotes de madera",
                  "de": "Holzpfähle",
                  "nl": "Houten palen"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "Waterproof paint",
                  "es": "Pintura impermeable",
                  "de": "Wasserdichte Farbe",
                  "nl": "Waterbestendige verf"
        },
        {
                  "en": "Elevated on stilts",
                  "es": "Elevado sobre pilotes",
                  "de": "Auf Stelzen erhöht",
                  "nl": "Verhoogd op palen"
        },
        {
                  "en": "Elaborate drainage system with channels",
                  "es": "Elaborado sistema de drenaje con canales",
                  "de": "Ausgeklügeltes Entwässerungssystem mit Kanälen",
                  "nl": "Uitgebreid drainagesysteem met kanalen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Straight horizontal courses",
                  "es": "Hiladas horizontales rectas",
                  "de": "Gerade horizontale Schichten",
                  "nl": "Rechte horizontale lagen"
        },
        {
                  "en": "Irregular polygonal (jigsaw-like)",
                  "es": "Poligonal irregular (como rompecabezas)",
                  "de": "Unregelmäßig polygonal (puzzleartig)",
                  "nl": "Onregelmatig veelhoekig (puzzelachtig)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "L-shaped interlocking corner stones",
                  "es": "Piedras angulares entrelazadas en forma de L",
                  "de": "L-förmige ineinandergreifende Ecksteine",
                  "nl": "L-vormige in elkaar grijpende hoekstenen"
        },
        {
                  "en": "Concrete columns",
                  "es": "Columnas de concreto",
                  "de": "Betonsäulen",
                  "nl": "Betonnen kolommen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Metal gates",
                  "es": "Portones de metal",
                  "de": "Metalltore",
                  "nl": "Metalen poorten"
        },
        {
                  "en": "Varying quality of stonework in different sectors",
                  "es": "Calidad variable del trabajo en piedra en diferentes sectores",
                  "de": "Unterschiedliche Qualität der Steinarbeit in verschiedenen Sektoren",
                  "nl": "Variërende kwaliteit van steenwerk in verschillende sectoren"
        },
        {
                  "en": "Paint colors",
        ...
        {
                  "en": "Written records",
                  "es": "Registros escritos",
                  "de": "Schriftliche Aufzeichnungen",
                  "nl": "Geschreven archieven"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Dos pisos",
                  "de": "Zweistöckig",
                  "nl": "Twee verdiepingen"
        },
        {
                  "en": "One story (single level)",
                  "es": "Un piso (nivel único)",
                  "de": "Einstöckig (eine Ebene)",
                  "nl": "Eén verdieping (enkel niveau)"
        },
        {
                  "en": "Three stories",
                  "es": "Tres pisos",
                  "de": "Dreistöckig",
                  "nl": "Drie verdiepingen"
        },
        {
                  "en": "Four or more stories",
                  "es": "Cuatro o más pisos",
                  "de": "Vier oder mehr Stockwerke",
                  "nl": "Vier of meer verdiepingen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They have fountains",
                  "es": "Tienen fuentes",
                  "de": "Sie haben Brunnen",
                  "nl": "Ze hebben fonteinen"
        },
        {
                  "en": "They have golden statues",
                  "es": "Tienen estatuas doradas",
                  "de": "Sie haben goldene Statuen",
                  "nl": "Ze hebben gouden beelden"
        },
        {
                  "en": "They are flat open spaces between sectors",
                  "es": "Son espacios abiertos planos entre sectores",
                  "de": "Sie sind flache offene Räume zwischen Sektoren",
                  "nl": "Het zijn vlakke open ruimtes tussen sectoren"
        },
        {
                  "en": "They are underground",
                  "es": "Están bajo tierra",
                  "de": "Sie sind unterirdisch",
                  "nl": "Ze zijn ondergronds"
        }
        ],
        correct: 2,
        explanation: {
