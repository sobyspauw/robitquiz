    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Always equal ships and roads",
                  "es": "Siempre igualar barcos y carreteras",
                  "de": "Schiffe und Straßen immer gleichen",
                  "nl": "Altijd gelijke schepen en wegen"
        },
        {
                  "en": "Never build ships, roads only",
                  "es": "Nunca construir barcos, solo carreteras",
                  "de": "Nie Schiffe bauen, nur Straßen",
                  "nl": "Nooit schepen bouwen, alleen wegen"
        },
        {
                  "en": "Only 1 ship per island",
                  "es": "Solo 1 barco por isla",
                  "de": "Nur 1 Schiff pro Insel",
                  "nl": "Slechts 1 schip per eiland"
        },
        {
                  "en": "3-4 ships minimum to justify island resources",
                  "es": "Mínimo 3-4 barcos para justificar recursos de isla",
                  "de": "Mindestens 3-4 Schiffe um Inselressourcen zu rechtfertigen",
                  "nl": "Minimaal 3-4 schepen om eilandbronnen te rechtvaardigen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only after losing a city",
                  "es": "Solo después de perder una ciudad",
                  "de": "Nur nach Verlust einer Stadt",
                  "nl": "Alleen na verlies van een stad"
        },
        {
                  "en": "Immediately in turn 1",
                  "es": "Inmediatamente en el turno 1",
                  "de": "Sofort in Zug 1",
                  "nl": "Direct in beurt 1"
        },
        {
                  "en": "Never upgrade, keep basic knights",
                  "es": "Nunca mejorar, mantener caballeros básicos",
                  "de": "Nie aufwerten, Basis-Ritter behalten",
                  "nl": "Nooit upgraden, behoud basisridders"
        },
        {
                  "en": "When barbarians are 3-4 turns away and you need defense",
                  "es": "Cuando los bárbaros están a 3-4 turnos y necesitas defensa",
                  "de": "Wenn Barbaren 3-4 Züge entfernt sind und Verteidigung benötigt wird",
                  "nl": "Wanneer barbaren 3-4 beurten weg zijn en je verdediging nodig hebt"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Avoid building any cities",
                  "es": "Evitar construir ciudades",
                  "de": "Vermeiden, Städte zu bauen",
                  "nl": "Vermijd het bouwen van steden"
        },
        {
                  "en": "Only collect basic resources",
                  "es": "Solo recolectar recursos básicos",
                  "de": "Nur Grundressourcen sammeln",
                  "nl": "Alleen basisbronnen verzamelen"
        },
        {
                  "en": "Trade all commodities immediately",
                  "es": "Comerciar todos los productos inmediatamente",
                  "de": "Alle Rohstoffe sofort handeln",
                  "nl": "Alle grondstoffen direct ruilen"
        },
        {
                  "en": "Control cloth/coin/paper production to dominate metropolis race",
                  "es": "Controlar la producción de tela/moneda/papel para dominar la carrera de metrópolis",
                  "de": "Stoff-/Münz-/Papierproduktion kontrollieren um Metropolen-Rennen zu dominieren",
                  "nl": "Stof/munt/papier productie controleren om metropool race te domineren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Build first, then play cards",
                  "es": "Construir primero, luego jugar cartas",
                  "de": "Erst bauen, dann Karten spielen",
                  "nl": "Eerst bouwen, dan kaarten spelen"
        },
        {
                  "en": "Play all cards simultaneously",
                  "es": "Jugar todas las cartas simultáneamente",
                  "de": "Alle Karten gleichzeitig spielen",
                  "nl": "Alle kaarten tegelijk spelen"
        },
        {
                  "en": "Never play multiple cards in one turn",
                  "es": "Nunca jugar múltiples cartas en un turno",
                  "de": "Niemals mehrere Karten in einem Zug spielen",
                  "nl": "Nooit meerdere kaarten in één beurt spelen"
        },
        {
                  "en": "Play Monopoly first, then Year of Plenty, then build with gained resources",
                  "es": "Jugar Monopolio primero, luego Año de Abundancia, luego construir con recursos ganados",
                  "de": "Monopol zuerst spielen, dann Jahr des Überflusses, dann mit gewonnenen Ressourcen bauen",
                  "nl": "Monopolie eerst spelen, dan Jaar van Overvloed, dan bouwen met verkregen bronnen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Never use progress cards",
                  "es": "Nunca usar cartas de progreso",
                  "de": "Niemals Fortschrittskarten verwenden",
                  "nl": "Nooit vooruitgangskaarten gebruiken"
        },
        {
                  "en": "Only focus on one improvement track",
                  "es": "Solo enfocarse en una pista de mejora",
                  "de": "Nur auf eine Verbesserungsspur konzentrieren",
                  "nl": "Alleen focussen op één verbeteringsspoor"
        },
        {
                  "en": "Discard all commodity cards",
                  "es": "Descartar todas las cartas de productos",
                  "de": "Alle Rohstoffkarten abwerfen",
                  "nl": "Alle grondstofkaarten weggooien"
        },
        {
                  "en": "Advance in all three improvement tracks to block opponents from flipping",
                  "es": "Avanzar en las tres pistas de mejora para bloquear a los oponentes de voltear",
                  "de": "In allen drei Verbesserungsspuren voranschreiten um Gegner am Umdrehen zu hindern",
                  "nl": "Vooruitgaan in alle drie verbeteringssporen om tegenstanders te blokkeren van omdraaien"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trade equally with all players always",
                  "es": "Comerciar por igual con todos los jugadores siempre",
                  "de": "Immer gleichmäßig mit allen Spielern handeln",
                  "nl": "Altijd gelijk handelen met alle spelers"
        },
        {
                  "en": "Focus only on your own production",
                  "es": "Enfocarse solo en tu propia producción",
                  "de": "Nur auf eigene Produktion konzentrieren",
                  "nl": "Alleen focussen op je eigen productie"
        },
        {
                  "en": "Give free resources to losing players",
                  "es": "Dar recursos gratis a jugadores perdedores",
                  "de": "Verlierende Spieler kostenlose Ressourcen geben",
                  "nl": "Gratis bronnen geven aan verliezende spelers"
        },
        {
                  "en": "Identify starved player's missing resource and refuse all trades involving it",
                  "es": "Identificar el recurso faltante del jugador hambriento y rechazar todos los intercambios que lo involucren",
                  "de": "Fehlende Ressource des ausgehungerten Spielers identifizieren und alle Geschäfte damit ablehnen",
                  "nl": "Identificeer ontbrekende bron van uitgehongerde speler en weiger alle handel ermee"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "25% probability",
                  "es": "25% de probabilidad",
                  "de": "25% Wahrscheinlichkeit",
                  "nl": "25% waarschijnlijkheid"
        },
        {
                  "en": "Approximately 72% (10/36 + 10/36 - overlap)",
                  "es": "Aproximadamente 72% (10/36 + 10/36 - superposición)",
                  "de": "Ungefähr 72% (10/36 + 10/36 - Überschneidung)",
                  "nl": "Ongeveer 72% (10/36 + 10/36 - overlap)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Discard victory point cards for resources",
                  "es": "Descartar cartas de puntos de victoria por recursos",
                  "de": "Siegpunktkarten für Ressourcen abwerfen",
                  "nl": "Overwinningspuntkaarten weggooien voor bronnen"
        },
        {
                  "en": "Hold victory point dev cards until you can win on your turn",
                  "es": "Mantener cartas de desarrollo de puntos de victoria hasta que puedas ganar en tu turno",
                  "de": "Siegpunkt-Entwicklungskarten halten bis man in seinem Zug gewinnen kann",
                  "nl": "Overwinningspunt ontwikkelingskaarten vasthouden tot je in je beurt kunt winnen"
        },
        {
                  "en": "Trade victory point cards to opponents",
                  "es": "Comerciar cartas de puntos de victoria con oponentes",
                  "de": "Siegpunktkarten an Gegner handeln",
                  "nl": "Overwinningspuntkaarten ruilen met tegenstanders"
        },
        {
                  "en": "Reveal all cards immediately when drawn",
                  "es": "Revelar todas las cartas inmediatamente cuando se roban",
                  "de": "Alle Karten sofort nach dem Ziehen aufdecken",
                  "nl": "Alle kaarten direct onthullen wanneer getrokken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "3-5 turns to accumulate 3 ore + 2 wheat safely",
                  "es": "3-5 turnos para acumular 3 minerales + 2 trigo de forma segura",
                  "de": "3-5 Züge um sicher 3 Erz + 2 Weizen zu sammeln",
                  "nl": "3-5 beurten om veilig 3 erts + 2 tarwe te verzamelen"
        },
        {
                  "en": "Build cities immediately when possible",
                  "es": "Construir ciudades inmediatamente cuando sea posible",
                  "de": "Städte sofort bauen wenn möglich",
                  "nl": "Steden direct bouwen wanneer mogelijk"
        },
        {
                  "en": "Never plan ahead, react each turn",
                  "es": "Nunca planificar con anticipación, reaccionar cada turno",
                  "de": "Nie vorausplanen, jeden Zug reagieren",
                  "nl": "Nooit vooruit plannen, elke beurt reageren"
        },
        {
                  "en": "Wait 10+ turns for perfect timing",
                  "es": "Esperar 10+ turnos para el momento perfecto",
                  "de": "10+ Züge auf perfektes Timing warten",
                  "nl": "10+ beurten wachten op perfecte timing"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Never build on any harbors",
                  "es": "Nunca construir en ningún puerto",
                  "de": "Nie auf Häfen bauen",
                  "nl": "Nooit op havens bouwen"
        },
        {
                  "en": "Only use 3:1 harbors",
                  "es": "Solo usar puertos 3:1",
                  "de": "Nur 3:1-Häfen verwenden",
                  "nl": "Alleen 3:1 havens gebruiken"
        },
        {
                  "en": "Build away from all coast",
                  "es": "Construir lejos de toda costa",
                  "de": "Fern von jeder Küste bauen",
                  "nl": "Weg van alle kust bouwen"
        },
        {
                  "en": "Build on valuable 2:1 harbors to prevent opponent access",
                  "es": "Construir en valiosos puertos 2:1 para evitar el acceso del oponente",
                  "de": "Auf wertvollen 2:1-Häfen bauen um Gegnerzugang zu verhindern",
                  "nl": "Bouwen op waardevolle 2:1 havens om tegenstander toegang te voorkomen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sacrificing long-term value for immediate board position advantage",
                  "es": "Sacrificar valor a largo plazo por ventaja inmediata de posición en el tablero",
                  "de": "Langfristigen Wert für sofortigen Brettpositionsvorteil opfern",
                  "nl": "Langetermijnwaarde opofferen voor onmiddellijk bordpositievoordeel"
        },
        {
                  "en": "Never making any trades",
                  "es": "Nunca hacer ningún intercambio",
                  "de": "Niemals Geschäfte machen",
                  "nl": "Nooit handel maken"
        },
        {
                  "en": "Waiting for perfect dice rolls",
                  "es": "Esperar tiradas de dados perfectas",
                  "de": "Auf perfekte Würfelwürfe warten",
                  "nl": "Wachten op perfecte dobbelsteenworpen"
        },
        {
                  "en": "Playing as slowly as possible",
                  "es": "Jugar lo más lento posible",
                  "de": "So langsam wie möglich spielen",
                  "nl": "Zo langzaam mogelijk spelen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Immediately when drawn",
                  "es": "Inmediatamente cuando se roba",
                  "de": "Sofort nach dem Ziehen",
                  "nl": "Direct wanneer getrokken"
        },
        {
                  "en": "Only when you roll a 7",
                  "es": "Solo cuando sacas un 7",
                  "de": "Nur wenn man eine 7 würfelt",
                  "nl": "Alleen wanneer je een 7 gooit"
        },
        {
                  "en": "Save all knights for last turn",
                  "es": "Guardar todos los caballeros para el último turno",
                  "de": "Alle Ritter für letzten Zug aufheben",
                  "nl": "Alle ridders bewaren voor laatste beurt"
        },
        {
                  "en": "Right after opponent accumulates 5-6 cards, before their build phase",
                  "es": "Justo después de que el oponente acumula 5-6 cartas, antes de su fase de construcción",
                  "de": "Direkt nachdem Gegner 5-6 Karten gesammelt hat, vor seiner Bauphase",
                  "nl": "Direct nadat tegenstander 5-6 kaarten verzamelt, voor hun bouwfase"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Rush to build 3rd settlement before spots are blocked",
                  "es": "Apresurarse a construir el 3er asentamiento antes de que los lugares sean bloqueados",
                  "de": "Zum 3. Siedlung eilen bevor Plätze blockiert werden",
                  "nl": "Haasten om 3e nederzetting te bouwen voordat plekken geblokkeerd zijn"
        },
        {
                  "en": "Wait until endgame for settlements",
                  "es": "Esperar hasta el final del juego para asentamientos",
                  "de": "Bis Endspiel auf Siedlungen warten",
                  "nl": "Wachten tot eindspel voor nederzettingen"
        },
        {
                  "en": "Only build cities, never settlements",
                  "es": "Solo construir ciudades, nunca asentamientos",
                  "de": "Nur Städte bauen, nie Siedlungen",
                  "nl": "Alleen steden bouwen, nooit nederzettingen"
        },
        {
                  "en": "Build only on initial spots",
                  "es": "Construir solo en lugares iniciales",
                  "de": "Nur auf Anfangsplätzen bauen",
                  "nl": "Alleen op initiële plekken bouwen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Worth 2+ ore equivalent when timed with city builds or knight upgrades",
                  "es": "Vale 2+ equivalente de mineral cuando se cronometra con construcciones de ciudades o mejoras de caballeros",
                  "de": "Wert von 2+ Erz-Äquivalent bei Timing mit Stadtbauten oder Ritter-Upgrades",
                  "nl": "Waard 2+ erts equivalent wanneer getimed met stadenbouw of ridderupgrades"
        },
        {
                  "en": "Discard for a different card",
                  "es": "Descartar por una carta diferente",
                  "de": "Für eine andere Karte abwerfen",
                  "nl": "Weggooien voor een andere kaart"
        },
        {
        ...
        {
                  "en": "Always use immediately when drawn",
                  "es": "Siempre usar inmediatamente cuando se roba",
                  "de": "Immer sofort nach Ziehen verwenden",
                  "nl": "Altijd direct gebruiken wanneer getrokken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Can't play newly bought dev cards same turn, must wait until next turn",
                  "es": "No se pueden jugar cartas de desarrollo recién compradas en el mismo turno, debe esperar hasta el siguiente turno",
                  "de": "Neu gekaufte Entwicklungskarten können nicht im selben Zug gespielt werden, muss bis nächsten Zug warten",
                  "nl": "Nieuw gekochte ontwikkelingskaarten kunnen niet dezelfde beurt gespeeld worden, moet wachten tot volgende beurt"
        },
        {
                  "en": "Victory point cards can be played anytime",
                  "es": "Las cartas de puntos de victoria se pueden jugar en cualquier momento",
                  "de": "Siegpunktkarten können jederzeit gespielt werden",
                  "nl": "Overwinningspuntkaarten kunnen altijd gespeeld worden"
        },
        {
                  "en": "You can play multiple knights per turn",
                  "es": "Puedes jugar múltiples caballeros por turno",
                  "de": "Man kann mehrere Ritter pro Zug spielen",
                  "nl": "Je kunt meerdere ridders per beurt spelen"
        },
        {
                  "en": "All dev cards must be played immediately",
                  "es": "Todas las cartas de desarrollo deben jugarse inmediatamente",
                  "de": "Alle Entwicklungskarten müssen sofort gespielt werden",
                  "nl": "Alle ontwikkelingskaarten moeten direct gespeeld worden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Move caravans to deliver commodities before opponents for bonus points",
                  "es": "Mover caravanas para entregar productos antes que los oponentes por puntos de bonificación",
                  "de": "Karawanen bewegen um Rohstoffe vor Gegnern zu liefern für Bonuspunkte",
                  "nl": "Karavanen verplaatsen om grondstoffen voor tegenstanders te leveren voor bonuspunten"
        },
        {
                  "en": "Build cities on caravan routes",
                  "es": "Construir ciudades en rutas de caravanas",
                  "de": "Städte auf Karawanenrouten bauen",
                  "nl": "Steden bouwen op karavaan routes"
        },
        {
                  "en": "Never move caravans",
                  "es": "Nunca mover caravanas",
                  "de": "Karawanen nie bewegen",
                  "nl": "Nooit karavanen verplaatsen"
        },
        {
                  "en": "Only use roads, ignore caravans",
                  "es": "Solo usar carreteras, ignorar caravanas",
                  "de": "Nur Straßen verwenden, Karawanen ignorieren",
                  "nl": "Alleen wegen gebruiken, karavanen negeren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Coordinate to keep robber off leader's hexes, target 2nd/3rd place",
                  "es": "Coordinar para mantener al ladrón fuera de los hexágonos del líder, apuntar al 2º/3º lugar",
                  "de": "Koordinieren um Räuber von Führenden fernzuhalten, 2./3. Platz anvisieren",
                  "nl": "Coördineren om rover van leider's hexen te houden, 2e/3e plaats targeten"
        },
        {
                  "en": "Always target the leader only",
                  "es": "Siempre apuntar solo al líder",
                  "de": "Immer nur den Führenden anvisieren",
                  "nl": "Altijd alleen de leider targeten"
        },
        {
                  "en": "Keep robber in desert permanently",
                  "es": "Mantener al ladrón en el desierto permanentemente",
                  "de": "Räuber dauerhaft in Wüste halten",
                  "nl": "Rover permanent in woestijn houden"
        },
        {
                  "en": "Random robber placement",
                  "es": "Colocación aleatoria del ladrón",
                  "de": "Zufällige Räuberplatzierung",
                  "nl": "Willekeurige roverplaatsing"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "5 resources per roll",
                  "es": "5 recursos por tirada",
                  "de": "5 Ressourcen pro Wurf",
                  "nl": "5 bronnen per worp"
        },
        {
                  "en": "0.5 resources per roll",
                  "es": "0.5 recursos por tirada",
                  "de": "0.5 Ressourcen pro Wurf",
                  "nl": "0.5 bronnen per worp"
        },
        {
                  "en": "3 resources guaranteed",
                  "es": "3 recursos garantizados",
                  "de": "3 Ressourcen garantiert",
                  "nl": "3 bronnen gegarandeerd"
        },
        {
                  "en": "1.67 resources per roll (15 pips × 1/36 per pip × 3 hexes)",
                  "es": "1.67 recursos por tirada (15 pips × 1/36 por pip × 3 hexágonos)",
                  "de": "1.67 Ressourcen pro Wurf (15 Pips × 1/36 pro Pip × 3 Hexe)",
                  "nl": "1.67 bronnen per worp (15 pips × 1/36 per pip × 3 hexen)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only count your own pip value",
                  "es": "Solo contar tu propio valor de pip",
                  "de": "Nur eigenen Pip-Wert zählen",
                  "nl": "Alleen je eigen pip waarde tellen"
        },
        {
                  "en": "Ignore opponent positions completely",
                  "es": "Ignorar completamente las posiciones del oponente",
                  "de": "Gegnerpositionen vollständig ignorieren",
                  "nl": "Tegenstander posities volledig negeren"
        },
        {
                  "en": "Your production gain + opponent's production denial value",
                  "es": "Tu ganancia de producción + valor de negación de producción del oponente",
                  "de": "Eigener Produktionsgewinn + Produktionsverweigerungswert des Gegners",
                  "nl": "Je productiewinst + productie ontzegging waarde van tegenstander"
        },
        {
                  "en": "Random placement without calculation",
                  "es": "Colocación aleatoria sin cálculo",
                  "de": "Zufällige Platzierung ohne Berechnung",
                  "nl": "Willekeurige plaatsing zonder berekening"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Track visible trades and rolls to deduce opponents' exact hand composition",
                  "es": "Rastrear intercambios y tiradas visibles para deducir la composición exacta de la mano de los oponentes",
                  "de": "Sichtbare Geschäfte und Würfe verfolgen um exakte Hand-Zusammensetzung der Gegner zu deduzieren",
                  "nl": "Zichtbare handel en worpen volgen om exacte handsamenstelling van tegenstanders te deduceren"
        },
        {
                  "en": "Only count your own resources",
                  "es": "Solo contar tus propios recursos",
                  "de": "Nur eigene Ressourcen zählen",
                  "nl": "Alleen je eigen bronnen tellen"
        },
        {
                  "en": "Never observe opponent cards",
                  "es": "Nunca observar las cartas del oponente",
                  "de": "Nie Gegnerkarten beobachten",
                  "nl": "Nooit tegenstander kaarten observeren"
        },
        {
                  "en": "Randomly guess opponent resources",
                  "es": "Adivinar aleatoriamente los recursos del oponente",
                  "de": "Ressourcen des Gegners zufällig raten",
                  "nl": "Willekeurig tegenstander bronnen raden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Activate knights only when barbarians are 2-3 ships away or to displace opponent knight",
                  "es": "Activar caballeros solo cuando los bárbaros están a 2-3 barcos o para desplazar al caballero oponente",
                  "de": "Ritter nur aktivieren wenn Barbaren 2-3 Schiffe entfernt sind oder um Gegnerritter zu verdrängen",
                  "nl": "Ridders alleen activeren wanneer barbaren 2-3 schepen weg zijn of om tegenstander ridder te verdringen"
        },
        {
                  "en": "Only activate on the final turn",
                  "es": "Solo activar en el turno final",
                  "de": "Nur im letzten Zug aktivieren",
                  "nl": "Alleen in de laatste beurt activeren"
        },
        {
                  "en": "Never activate knights to save grain",
                  "es": "Nunca activar caballeros para ahorrar grano",
                  "de": "Ritter nie aktivieren um Getreide zu sparen",
                  "nl": "Nooit ridders activeren om graan te sparen"
        },
        {
                  "en": "Activate all knights immediately when built",
                  "es": "Activar todos los caballeros inmediatamente cuando se construyen",
                  "de": "Alle Ritter sofort nach dem Bau aktivieren",
                  "nl": "Alle ridders direct activeren wanneer gebouwd"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trade only with the bank at 4:1",
                  "es": "Comerciar solo con el banco a 4:1",
                  "de": "Nur mit der Bank zu 4:1 handeln",
                  "nl": "Alleen met de bank op 4:1 handelen"
        },
        {
                  "en": "Accept only 1:1 trades always",
                  "es": "Aceptar solo intercambios 1:1 siempre",
                  "de": "Immer nur 1:1-Geschäfte akzeptieren",
                  "nl": "Alleen 1:1 handel accepteren altijd"
        },
        {
                  "en": "Announce need, let opponents compete to offer best rate",
                  "es": "Anunciar necesidad, dejar que los oponentes compitan para ofrecer la mejor tarifa",
                  "de": "Bedarf ankündigen, Gegner um bestes Angebot konkurrieren lassen",
                  "nl": "Behoefte aankondigen, tegenstanders laten concurreren om beste tarief te bieden"
        },
        {
                  "en": "Never announce your needs publicly",
                  "es": "Nunca anunciar tus necesidades públicamente",
                  "de": "Bedürfnisse nie öffentlich ankündigen",
                  "nl": "Nooit je behoeften publiekelijk aankondigen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Has no victory point value",
                  "es": "No tiene valor de puntos de victoria",
                  "de": "Hat keinen Siegpunktwert",
                  "nl": "Heeft geen overwinningspuntwaarde"
        },
        {
                  "en": "Worth 10 points automatically",
                  "es": "Vale 10 puntos automáticamente",
                  "de": "Automatisch 10 Punkte wert",
                  "nl": "Automatisch 10 punten waard"
        },
        {
                  "en": "Worth 4 points total (2 base + potential 2-point swing from opponent)",
                  "es": "Vale 4 puntos totales (2 base + potencial cambio de 2 puntos del oponente)",
                  "de": "Wert von 4 Punkten insgesamt (2 Basis + potenzielle 2-Punkte-Schwankung vom Gegner)",
                  "nl": "Waard 4 punten totaal (2 basis + potentiële 2-punten swing van tegenstander)"
        },
        {
                  "en": "Only worth 1 victory point",
                  "es": "Solo vale 1 punto de victoria",
                  "de": "Nur 1 Siegpunkt wert",
                  "nl": "Slechts 1 overwinningspunt waard"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Always place on corners of the board",
                  "es": "Siempre colocar en las esquinas del tablero",
                  "de": "Immer auf Ecken des Bretts platzieren",
                  "nl": "Altijd op hoeken van het bord plaatsen"
        },
        {
                  "en": "Place settlements to block maximum opponent expansion routes early",
                  "es": "Colocar asentamientos para bloquear máximas rutas de expansión del oponente temprano",
                  "de": "Siedlungen platzieren um maximale Gegner-Expansionsrouten früh zu blockieren",
                  "nl": "Nederzettingen plaatsen om maximale tegenstander expansie routes vroeg te blokkeren"
        },
        {
                  "en": "Place both settlements adjacent to each other",
                  "es": "Colocar ambos asentamientos adyacentes entre sí",
                  "de": "Beide Siedlungen nebeneinander platzieren",
                  "nl": "Beide nederzettingen naast elkaar plaatsen"
        },
        {
                  "en": "Only focus on your own production, ignore opponents",
                  "es": "Solo enfocarse en tu propia producción, ignorar a los oponentes",
                  "de": "Nur auf eigene Produktion konzentrieren, Gegner ignorieren",
                  "nl": "Alleen focussen op je eigen productie, tegenstanders negeren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sell all development cards back to bank",
                  "es": "Vender todas las cartas de desarrollo de vuelta al banco",
                  "de": "Alle Entwicklungskarten zurück an die Bank verkaufen",
                  "nl": "Alle ontwikkelingskaarten terug aan bank verkopen"
        },
        {
                  "en": "Never buy development cards after turn 10",
                  "es": "Nunca comprar cartas de desarrollo después del turno 10",
                  "de": "Niemals Entwicklungskarten nach Zug 10 kaufen",
                  "nl": "Nooit ontwikkelingskaarten kopen na beurt 10"
        },
        {
                  "en": "Only buy cards in first 3 turns",
                  "es": "Solo comprar cartas en los primeros 3 turnos",
                  "de": "Nur in ersten 3 Zügen Karten kaufen",
                  "nl": "Alleen kaarten kopen in eerste 3 beurten"
        },
        {
                  "en": "Buy multiple dev cards when at 7-8 points to create unpredictable winning options",
                  "es": "Comprar múltiples cartas de desarrollo cuando estás en 7-8 puntos para crear opciones de victoria impredecibles",
                  "de": "Mehrere Entwicklungskarten bei 7-8 Punkten kaufen um unvorhersehbare Gewinnoptionen zu schaffen",
                  "nl": "Meerdere ontwikkelingskaarten kopen bij 7-8 punten om onvoorspelbare winopties te creëren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Robber has no impact on pip calculations",
                  "es": "El ladrón no tiene impacto en los cálculos de pip",
                  "de": "Räuber hat keinen Einfluss auf Pip-Berechnungen",
                  "nl": "Rover heeft geen impact op pip berekeningen"
        },
        {
                  "en": "Reduce 6/8 pip value by 20-30% due to robber targeting probability",
                  "es": "Reducir valor de pip 6/8 en 20-30% debido a probabilidad de orientación del ladrón",
                  "de": "6/8-Pip-Wert um 20-30% reduzieren aufgrund Räuber-Zielwahrscheinlichkeit",
                  "nl": "6/8 pip waarde verlagen met 20-30% vanwege rover targeting waarschijnlijkheid"
        },
        {
                  "en": "Add 50% to 6/8 values for robber presence",
                  "es": "Agregar 50% a valores 6/8 por presencia del ladrón",
                  "de": "50% zu 6/8-Werten für Räuberpräsenz hinzufügen",
                  "nl": "50% toevoegen aan 6/8 waarden voor rover aanwezigheid"
        },
        {
                  "en": "All pips have identical value regardless of robber",
                  "es": "Todos los pips tienen valor idéntico independientemente del ladrón",
                  "de": "Alle Pips haben identischen Wert unabhängig vom Räuber",
                  "nl": "Alle pips hebben identieke waarde ongeacht rover"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "First player has insurmountable advantage",
                  "es": "El primer jugador tiene ventaja insuperable",
                  "de": "Erster Spieler hat unüberwindbaren Vorteil",
                  "nl": "Eerste speler heeft onoverkomelijk voordeel"
        },
        {
                  "en": "Last player always wins",
                  "es": "El último jugador siempre gana",
                  "de": "Letzter Spieler gewinnt immer",
                  "nl": "Laatste speler wint altijd"
        },
        {
                  "en": "First player gets best spot but last player gets consecutive picks and starting resources",
                  "es": "El primer jugador obtiene el mejor lugar pero el último jugador obtiene selecciones consecutivas y recursos iniciales",
                  "de": "Erster Spieler bekommt besten Platz aber letzter Spieler bekommt aufeinanderfolgende Picks und Startressourcen",
                  "nl": "Eerste speler krijgt beste plek maar laatste speler krijgt opeenvolgende keuzes en startbronnen"
        },
        {
                  "en": "All positions have identical advantage",
                  "es": "Todas las posiciones tienen ventaja idéntica",
                  "de": "Alle Positionen haben identischen Vorteil",
                  "nl": "Alle posities hebben identiek voordeel"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Never building anything to save resources",
                  "es": "Nunca construir nada para ahorrar recursos",
                  "de": "Nie etwas bauen um Ressourcen zu sparen",
                  "nl": "Nooit iets bouwen om bronnen te sparen"
        },
        {
                  "en": "Having exactly 7 cards always",
                  "es": "Tener exactamente 7 cartas siempre",
                  "de": "Immer genau 7 Karten haben",
                  "nl": "Altijd precies 7 kaarten hebben"
        },
        {
                  "en": "When cities produce enough surplus to build every 2-3 turns without trading",
                  "es": "Cuando las ciudades producen suficiente excedente para construir cada 2-3 turnos sin comerciar",
                  "de": "Wenn Städte genug Überschuss produzieren um alle 2-3 Züge ohne Handel zu bauen",
                  "nl": "Wanneer steden genoeg surplus produceren om elke 2-3 beurten te bouwen zonder handelen"
        },
        {
                  "en": "Only trading with bank at 4:1",
                  "es": "Solo comerciar con el banco a 4:1",
                  "de": "Nur mit der Bank zu 4:1 handeln",
                  "nl": "Alleen met de bank op 4:1 handelen"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Must be avoided at all costs",
                  "es": "Debe evitarse a toda costa",
                  "de": "Muss um jeden Preis vermieden werden",
                  "nl": "Moet te allen tijde vermeden worden"
        },
        {
                  "en": "Slight positive value: robber starts there, freeing other hexes early game",
                  "es": "Valor ligeramente positivo: el ladrón comienza ahí, liberando otros hexágonos al inicio del juego",
                  "de": "Leicht positiver Wert: Räuber startet dort, befreit andere Hexe im Frühspiel",
                  "nl": "Licht positieve waarde: rover begint daar, bevrijdt andere hexen vroeg spel"
        },
        {
                  "en": "Worth -5 victory points",
                  "es": "Vale -5 puntos de victoria",
                  "de": "Wert -5 Siegpunkte",
                  "nl": "Waard -5 overwinningspunten"
        },
        {
                  "en": "Extremely valuable for production",
                  "es": "Extremadamente valioso para producción",
                  "de": "Extrem wertvoll für Produktion",
                  "nl": "Extreem waardevol voor productie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cities have no strategic value",
                  "es": "Las ciudades no tienen valor estratégico",
                  "de": "Städte haben keinen strategischen Wert",
                  "nl": "Steden hebben geen strategische waarde"
        },
        {
                  "en": "With 3 cities producing double resources, you can outpace opponents' settlement builds",
                  "es": "Con 3 ciudades produciendo doble recursos, puedes superar las construcciones de asentamientos de los oponentes",
                  "de": "Mit 3 Städten die doppelte Ressourcen produzieren, kann man Gegner-Siedlungsbauten überholen",
                  "nl": "Met 3 steden die dubbele bronnen produceren, kun je tegenstanders' nederzettingsbouwsels voorbijstreven"
        },
        {
                  "en": "Never build more than 2 cities",
                  "es": "Nunca construir más de 2 ciudades",
                  "de": "Nie mehr als 2 Städte bauen",
                  "nl": "Nooit meer dan 2 steden bouwen"
        },
        {
                  "en": "Exactly 3 cities guarantees victory",
                  "es": "Exactamente 3 ciudades garantiza victoria",
                  "de": "Genau 3 Städte garantieren Sieg",
                  "nl": "Precies 3 steden garandeert overwinning"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only trade on even-numbered turns",
                  "es": "Solo comerciar en turnos de números pares",
                  "de": "Nur in geraden Zügen handeln",
                  "nl": "Alleen op even-genummerde beurten handelen"
        },
        {
                  "en": "Refuse trades that help players within 2 points of victory",
                  "es": "Rechazar intercambios que ayuden a jugadores a 2 puntos de la victoria",
                  "de": "Geschäfte ablehnen die Spielern innerhalb 2 Punkten vom Sieg helfen",
                  "nl": "Handel weigeren die spelers binnen 2 punten van overwinning helpt"
        },
        {
                  "en": "Never trade with anyone",
                  "es": "Nunca comerciar con nadie",
                  "de": "Niemals mit jemandem handeln",
                  "nl": "Nooit met iemand handelen"
        },
        {
                  "en": "Accept all trades always",
                  "es": "Aceptar todos los intercambios siempre",
                  "de": "Alle Geschäfte immer akzeptieren",
                  "nl": "Alle handel altijd accepteren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Touching 3 different resources worth +15-20% value vs touching duplicates",
                  "es": "Tocar 3 recursos diferentes vale +15-20% de valor vs tocar duplicados",
                  "de": "3 verschiedene Ressourcen berühren wert +15-20% Wert vs Duplikate berühren",
                  "nl": "3 verschillende bronnen raken waard +15-20% waarde vs duplicaten raken"
        },
        {
                  "en": "Diversity has no impact on value",
                  "es": "La diversidad no tiene impacto en el valor",
                  "de": "Diversität hat keinen Einfluss auf den Wert",
                  "nl": "Diversiteit heeft geen impact op waarde"
        },
        {
                  "en": "Only single resource types matter",
                  "es": "Solo importan los tipos de recursos únicos",
                  "de": "Nur einzelne Ressourcentypen zählen",
                  "nl": "Alleen enkele brontypes tellen"
        },
        {
                  "en": "Duplicates are always better than diversity",
                  "es": "Los duplicados son siempre mejores que la diversidad",
                  "de": "Duplikate sind immer besser als Diversität",
                  "nl": "Duplicaten zijn altijd beter dan diversiteit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Making random trade offers",
                  "es": "Hacer ofertas comerciales aleatorias",
                  "de": "Zufällige Handelsangebote machen",
                  "nl": "Willekeurige handelsaanbiedingen doen"
        },
        {
                  "en": "Tracking all visible cards to know exact opponent hands before proposing trades",
                  "es": "Rastrear todas las cartas visibles para conocer las manos exactas de los oponentes antes de proponer intercambios",
                  "de": "Alle sichtbaren Karten verfolgen um exakte Gegnerhände vor Handelsvorschlägen zu kennen",
                  "nl": "Alle zichtbare kaarten volgen om exacte tegenstander handen te kennen voor handelsvoorstellen"
        },
        {
                  "en": "Only accepting 1:1 trades blindly",
                  "es": "Solo aceptar intercambios 1:1 a ciegas",
                  "de": "Nur blind 1:1-Geschäfte akzeptieren",
                  "nl": "Alleen blindelings 1:1 handel accepteren"
        },
        {
                  "en": "Never trading under any circumstances",
                  "es": "Nunca comerciar bajo ninguna circunstancia",
                  "de": "Niemals unter keinen Umständen handeln",
                  "nl": "Nooit handelen onder enige omstandigheid"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gain 5 victory points immediately",
                  "es": "Ganar 5 puntos de victoria inmediatamente",
                  "de": "Sofort 5 Siegpunkte gewinnen",
                  "nl": "Direct 5 overwinningspunten winnen"
        },
        {
                  "en": "Steal all opponent commodities",
                  "es": "Robar todas las mercancías del oponente",
                  "de": "Alle Gegner-Rohstoffe stehlen",
                  "nl": "Alle tegenstander grondstoffen stelen"
        },
        {
                  "en": "Move robber and take 2 resource cards from any single player",
                  "es": "Mover al ladrón y tomar 2 cartas de recursos de cualquier jugador individual",
                  "de": "Räuber bewegen und 2 Ressourcenkarten von einem einzelnen Spieler nehmen",
                  "nl": "Rover verplaatsen en 2 bronkaarten van een enkele speler nemen"
        },
        {
                  "en": "Build a free city",
                  "es": "Construir una ciudad gratis",
                  "de": "Eine kostenlose Stadt bauen",
                  "nl": "Gratis stad bouwen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Each turn blocked on high-pip hex = 1-2 turns delayed on your building timeline",
                  "es": "Cada turno bloqueado en hexágono de alto pip = 1-2 turnos retrasados en tu línea de tiempo de construcción",
                  "de": "Jeder blockierte Zug auf High-Pip-Hex = 1-2 Züge verzögert auf Ihrer Bauzeitlinie",
                  "nl": "Elke beurt geblokkeerd op hoge-pip hex = 1-2 beurten vertraagd op je bouwtijdlijn"
        },
        {
                  "en": "Robber blocking has zero impact",
                  "es": "El bloqueo del ladrón tiene cero impacto",
                  "de": "Räuberblockierung hat null Auswirkung",
                  "nl": "Rover blokkering heeft nul impact"
        },
        {
                  "en": "Every blocked turn adds 10 points",
                  "es": "Cada turno bloqueado agrega 10 puntos",
                  "de": "Jeder blockierte Zug fügt 10 Punkte hinzu",
                  "nl": "Elke geblokkeerde beurt voegt 10 punten toe"
        },
        {
                  "en": "Tempo loss only applies to first player",
                  "es": "La pérdida de tempo solo se aplica al primer jugador",
                  "de": "Tempoverlust gilt nur für ersten Spieler",
                  "nl": "Tempo verlies geldt alleen voor eerste speler"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Everyone attacks everyone equally",
                  "es": "Todos atacan a todos por igual",
                  "de": "Alle greifen alle gleichmäßig an",
                  "nl": "Iedereen valt iedereen gelijk aan"
        },
        {
                  "en": "No player makes any moves",
                  "es": "Ningún jugador hace ningún movimiento",
                  "de": "Kein Spieler macht einen Zug",
                  "nl": "Geen speler maakt een zet"
        },
        {
                  "en": "Informal alliance where 2nd/3rd place agree not to trade with or robber the leader",
                  "es": "Alianza informal donde 2º/3º lugar acuerdan no comerciar ni ladronear al líder",
                  "de": "Informelle Allianz wo 2./3. Platz vereinbaren nicht mit Anführer zu handeln oder zu räubern",
                  "nl": "Informele alliantie waar 2e/3e plaats afspreken niet te handelen met of rover op leider"
        },
        {
                  "en": "Always help the leader win",
                  "es": "Siempre ayudar al líder a ganar",
                  "de": "Immer dem Anführer zum Sieg helfen",
                  "nl": "Altijd de leider helpen winnen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No risk exists at 7 cards",
                  "es": "No existe riesgo en 7 cartas",
                  "de": "Kein Risiko existiert bei 7 Karten",
                  "nl": "Geen risico bestaat bij 7 kaarten"
        },
        {
                  "en": "7 cards provides complete safety",
                  "es": "7 cartas proporciona seguridad completa",
                  "de": "7 Karten bieten vollständige Sicherheit",
                  "nl": "7 kaarten biedt complete veiligheid"
        },
        {
                  "en": "16.67% chance per turn of losing half your cards creates high-risk situation",
                  "es": "16.67% de probabilidad por turno de perder la mitad de tus cartas crea situación de alto riesgo",
                  "de": "16,67% Chance pro Zug die Hälfte Ihrer Karten zu verlieren schafft Hochrisiko-Situation",
                  "nl": "16.67% kans per beurt om de helft van je kaarten te verliezen creëert hoog-risico situatie"
        },
        {
                  "en": "Having 7 cards guarantees victory",
                  "es": "Tener 7 cartas garantiza victoria",
                  "de": "7 Karten zu haben garantiert Sieg",
                  "nl": "7 kaarten hebben garandeert overwinning"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only build on 2 and 12 hexes",
                  "es": "Solo construir en hexágonos 2 y 12",
                  "de": "Nur auf 2- und 12-Hexen bauen",
                  "nl": "Alleen bouwen op 2 en 12 hexen"
        },
        {
                  "en": "Any settlement placement is equally good",
                  "es": "Cualquier colocación de asentamiento es igualmente buena",
                  "de": "Jede Siedlungsplatzierung ist gleich gut",
                  "nl": "Elke nederzettingsplaatsing is even goed"
        },
        {
                  "en": "Build settlements randomly without calculation",
                  "es": "Construir asentamientos aleatoriamente sin cálculo",
                  "de": "Siedlungen zufällig ohne Berechnung bauen",
                  "nl": "Nederzettingen willekeurig bouwen zonder berekening"
        },
        {
                  "en": "Average 11+ pips per settlement with 4+ different resources across all settlements",
                  "es": "Promedio de 11+ pips por asentamiento con 4+ recursos diferentes en todos los asentamientos",
                  "de": "Durchschnitt 11+ Pips pro Siedlung mit 4+ verschiedenen Ressourcen über alle Siedlungen",
                  "nl": "Gemiddeld 11+ pips per nederzetting met 4+ verschillende bronnen over alle nederzettingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Early lead → more builds → better positions → faster growth → exponential advantage",
                  "es": "Ventaja temprana → más construcciones → mejores posiciones → crecimiento más rápido → ventaja exponencial",
                  "de": "Früher Vorsprung → mehr Bauten → bessere Positionen → schnelleres Wachstum → exponentieller Vorteil",
                  "nl": "Vroege voorsprong → meer bouwwerken → betere posities → snellere groei → exponentieel voordeel"
        },
        {
                  "en": "Late game players always catch up automatically",
                  "es": "Los jugadores de juego tardío siempre se ponen al día automáticamente",
                  "de": "Späte Spieler holen immer automatisch auf",
                  "nl": "Late game spelers halen altijd automatisch in"
        },
        {
                  "en": "All players maintain perfect balance always",
                  "es": "Todos los jugadores mantienen equilibrio perfecto siempre",
                  "de": "Alle Spieler halten perfekte Balance immer",
                  "nl": "Alle spelers behouden perfecte balans altijd"
        },
        {
                  "en": "No advantage compounds over time",
                  "es": "Ninguna ventaja se acumula con el tiempo",
                  "de": "Kein Vorteil kumuliert über die Zeit",
                  "nl": "Geen voordeel verergert over tijd"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Stealing from the same player repeatedly",
                  "es": "Robar del mismo jugador repetidamente",
                  "de": "Wiederholt vom selben Spieler stehlen",
                  "nl": "Herhaaldelijk van dezelfde speler stelen"
        },
        {
                  "en": "Using only knight cards",
                  "es": "Usar solo cartas de caballero",
                  "de": "Nur Ritterkarten verwenden",
                  "nl": "Alleen ridderskaarten gebruiken"
        },
        {
                  "en": "Keeping the robber on opponent's best hex",
                  "es": "Mantener al ladrón en el mejor hexágono del oponente",
                  "de": "Den Räuber auf dem besten Feld des Gegners halten",
                  "nl": "De rover op het beste hex van de tegenstander houden"
        },
        {
                  "en": "Never moving the robber",
                  "es": "Nunca mover al ladrón",
                  "de": "Den Räuber nie bewegen",
                  "nl": "De rover nooit verplaatsen"
        }
        ],
        correct: 2,
        explanation: {
