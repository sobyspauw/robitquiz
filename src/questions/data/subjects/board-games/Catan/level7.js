    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Never convert commodities",
                  "es": "Nunca convertir productos",
                  "de": "Rohstoffe nie konvertieren",
                  "nl": "Nooit grondstoffen converteren"
        },
        {
                  "en": "Convert all commodities immediately",
                  "es": "Convertir todos los productos inmediatamente",
                  "de": "Alle Rohstoffe sofort konvertieren",
                  "nl": "Alle grondstoffen direct converteren"
        },
        {
                  "en": "Convert 2:1 before opponents reach metropolis thresholds",
                  "es": "Convertir 2:1 antes de que los oponentes alcancen umbrales de metrópolis",
                  "de": "2:1 konvertieren bevor Gegner Metropolen-Schwellen erreichen",
                  "nl": "2:1 converteren voordat tegenstanders metropool drempels bereiken"
        },
        {
                  "en": "Only convert in final turn",
                  "es": "Solo convertir en turno final",
                  "de": "Nur im Endzug konvertieren",
                  "nl": "Alleen converteren in laatste beurt"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only count 6s and 8s",
                  "es": "Solo contar 6s y 8s",
                  "de": "Nur 6en und 8en zählen",
                  "nl": "Alleen 6'en en 8'en tellen"
        },
        {
                  "en": "Always choose harbor locations",
                  "es": "Siempre elegir ubicaciones de puerto",
                  "de": "Immer Hafenstandorte wählen",
                  "nl": "Altijd havenlocaties kiezen"
        },
        {
                  "en": "Place randomly for fairness",
                  "es": "Colocar aleatoriamente para justicia",
                  "de": "Zufällig für Fairness platzieren",
                  "nl": "Willekeurig plaatsen voor eerlijkheid"
        },
        {
                  "en": "Maximize pip-diversity product: (total pips) × (number of unique resources)",
                  "es": "Maximizar el producto pip-diversidad: (pips totales) × (número de recursos únicos)",
                  "de": "Pip-Diversitäts-Produkt maximieren: (Gesamt-Pips) × (Anzahl einzigartiger Ressourcen)",
                  "nl": "Maximaliseer pip-diversiteit product: (totale pips) × (aantal unieke bronnen)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use cards separately over multiple turns",
                  "es": "Usar cartas por separado en múltiples turnos",
                  "de": "Karten über mehrere Züge getrennt verwenden",
                  "nl": "Kaarten afzonderlijk gebruiken over meerdere beurten"
        },
        {
                  "en": "Never combine development cards",
                  "es": "Nunca combinar cartas de desarrollo",
                  "de": "Entwicklungskarten nie kombinieren",
                  "nl": "Ontwikkelingskaarten nooit combineren"
        },
        {
                  "en": "Only when losing badly",
                  "es": "Solo cuando se está perdiendo mucho",
                  "de": "Nur wenn man stark verliert",
                  "nl": "Alleen wanneer je flink aan het verliezen bent"
        },
        {
                  "en": "When you can claim longest road and last settlement in one turn",
                  "es": "Cuando puedes reclamar el camino más largo y el último asentamiento en un turno",
                  "de": "Wenn man längste Straße und letzte Siedlung in einem Zug beanspruchen kann",
                  "nl": "Wanneer je langste weg en laatste nederzetting in één beurt kunt claimen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Always negative trade value",
                  "es": "Siempre valor de intercambio negativo",
                  "de": "Immer negativer Tauschwert",
                  "nl": "Altijd negatieve ruilwaarde"
        },
        {
                  "en": "Positive if sheep hexes are 6+ combined pips and you need cities",
                  "es": "Positivo si los hexágonos de ovejas tienen 6+ pips combinados y necesitas ciudades",
                  "de": "Positiv wenn Schafhexe 6+ kombinierte Pips haben und man Städte braucht",
                  "nl": "Positief als schapen hexen 6+ gecombineerde pips hebben en je steden nodig hebt"
        },
        {
                  "en": "Only valuable in first 3 turns",
                  "es": "Solo valioso en los primeros 3 turnos",
                  "de": "Nur in ersten 3 Zügen wertvoll",
                  "nl": "Alleen waardevol in eerste 3 beurten"
        },
        {
                  "en": "Never use harbors for trading",
                  "es": "Nunca usar puertos para comerciar",
                  "de": "Häfen nie zum Handeln verwenden",
                  "nl": "Nooit havens gebruiken voor handelen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When 2nd place is within 2 points of leader - cooperation shifts to competition",
                  "es": "Cuando el 2do lugar está a 2 puntos del líder - la cooperación cambia a competencia",
                  "de": "Wenn 2. Platz innerhalb von 2 Punkten vom Führenden ist - Kooperation wird zu Konkurrenz",
                  "nl": "Wanneer 2e plaats binnen 2 punten van leider is - samenwerking verschuift naar competitie"
        },
        {
                  "en": "Break coalition randomly",
                  "es": "Romper coalición aleatoriamente",
                  "de": "Koalition zufällig brechen",
                  "nl": "Coalitie willekeurig verbreken"
        },
        {
                  "en": "Always maintain coalition until game ends",
                  "es": "Siempre mantener coalición hasta que termine el juego",
                  "de": "Koalition immer bis Spielende aufrechterhalten",
                  "nl": "Altijd coalitie handhaven tot spel eindigt"
        },
        {
                  "en": "Never form coalitions in tournaments",
                  "es": "Nunca formar coaliciones en torneos",
                  "de": "Nie Koalitionen in Turnieren bilden",
                  "nl": "Nooit coalities vormen in toernooien"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only embargo in first 5 turns",
                  "es": "Solo embargo en los primeros 5 turnos",
                  "de": "Nur in ersten 5 Zügen Embargo",
                  "nl": "Alleen embargo in eerste 5 beurten"
        },
        {
                  "en": "Always trade wheat freely",
                  "es": "Siempre comerciar trigo libremente",
                  "de": "Weizen immer frei handeln",
                  "nl": "Altijd tarwe vrij ruilen"
        },
        {
                  "en": "Never refuse trades",
                  "es": "Nunca rechazar intercambios",
                  "de": "Handel nie ablehnen",
                  "nl": "Nooit handel weigeren"
        },
        {
                  "en": "When opponent needs 1 wheat for city and you control 70%+ wheat production",
                  "es": "Cuando el oponente necesita 1 trigo para ciudad y controlas 70%+ de producción de trigo",
                  "de": "Wenn Gegner 1 Weizen für Stadt braucht und man 70%+ Weizenproduktion kontrolliert",
                  "nl": "Wanneer tegenstander 1 tarwe nodig heeft voor stad en je 70%+ tarweproductie controleert"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Variance is irrelevant in Catan",
                  "es": "La varianza es irrelevante en Catan",
                  "de": "Varianz ist irrelevant in Catan",
                  "nl": "Variantie is irrelevant in Catan"
        },
        {
                  "en": "Spreading settlements across multiple dice numbers reduces roll-to-roll volatility",
                  "es": "Distribuir asentamientos en múltiples números de dados reduce la volatilidad de tirada a tirada",
                  "de": "Siedlungen über mehrere Würfelzahlen verteilen reduziert Wurf-zu-Wurf-Volatilität",
                  "nl": "Nederzettingen spreiden over meerdere dobbelsteennummers vermindert worp-tot-worp volatiliteit"
        },
        {
                  "en": "Always maximize variance for excitement",
                  "es": "Siempre maximizar varianza para emoción",
                  "de": "Varianz immer für Spannung maximieren",
                  "nl": "Altijd variantie maximaliseren voor spanning"
        },
        {
                  "en": "Place all settlements on same number",
                  "es": "Colocar todos los asentamientos en el mismo número",
                  "de": "Alle Siedlungen auf gleiche Zahl setzen",
                  "nl": "Alle nederzettingen op hetzelfde nummer plaatsen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Use both monopoly cards on same resource",
                  "es": "Usar ambas cartas de monopolio en el mismo recurso",
                  "de": "Beide Monopolkarten auf gleiche Ressource verwenden",
                  "nl": "Beide monopoliekaarten op dezelfde bron gebruiken"
        },
        {
                  "en": "Play monopoly cards randomly",
                  "es": "Jugar cartas de monopolio aleatoriamente",
                  "de": "Monopolkarten zufällig spielen",
                  "nl": "Monopoliekaarten willekeurig spelen"
        },
        {
                  "en": "Monopoly resource needed for building, then monopoly resource for final city/settlement",
                  "es": "Monopolio del recurso necesario para construir, luego monopolio del recurso para ciudad/asentamiento final",
                  "de": "Monopol auf benötigte Ressource zum Bauen, dann Monopol auf Ressource für finale Stadt/Siedlung",
                  "nl": "Monopolie bron nodig voor bouwen, dan monopolie bron voor finale stad/nederzetting"
        },
        {
                  "en": "Save both cards indefinitely",
                  "es": "Guardar ambas cartas indefinidamente",
                  "de": "Beide Karten unbegrenzt aufheben",
                  "nl": "Beide kaarten onbepaald bewaren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Share all card information openly",
                  "es": "Compartir toda información de cartas abiertamente",
                  "de": "Alle Karteninformationen offen teilen",
                  "nl": "Alle kaartinformatie openlijk delen"
        },
        {
                  "en": "Ignore all opponent information",
                  "es": "Ignorar toda información del oponente",
                  "de": "Alle Gegnerinformationen ignorieren",
                  "nl": "Alle tegenstander informatie negeren"
        },
        {
                  "en": "You know opponents' exact hands while they only estimate yours",
                  "es": "Conoces las manos exactas de los oponentes mientras ellos solo estiman la tuya",
                  "de": "Man kennt exakte Hände der Gegner während sie nur schätzen",
                  "nl": "Je kent exacte handen van tegenstanders terwijl zij alleen schatten"
        },
        {
                  "en": "Hand tracking provides no advantage",
                  "es": "El seguimiento de manos no proporciona ventaja",
                  "de": "Hand-Tracking bietet keinen Vorteil",
                  "nl": "Hand volgen biedt geen voordeel"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ignore barbarian ship position",
                  "es": "Ignorar posición del barco bárbaro",
                  "de": "Barbarenschiffposition ignorieren",
                  "nl": "Barbaren schippositie negeren"
        },
        {
                  "en": "Never build knights in C&K",
                  "es": "Nunca construir caballeros en C&K",
                  "de": "Nie Ritter in S&R bauen",
                  "nl": "Nooit ridders bouwen in S&R"
        },
        {
                  "en": "Delay knight activation until barbarians are 1 turn away to deny opponents response time",
                  "es": "Retrasar activación de caballeros hasta que los bárbaros estén a 1 turno para negar tiempo de respuesta a oponentes",
                  "de": "Ritter-Aktivierung verzögern bis Barbaren 1 Zug entfernt sind um Gegnern Reaktionszeit zu nehmen",
                  "nl": "Ridder activering uitstellen tot barbaren 1 beurt weg zijn om tegenstanders reactietijd te ontzeggen"
        },
        {
                  "en": "Activate all knights immediately",
                  "es": "Activar todos los caballeros inmediatamente",
                  "de": "Alle Ritter sofort aktivieren",
                  "nl": "Alle ridders direct activeren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "After buying 8-10 cards, probability of useful cards drops below settlement value",
                  "es": "Después de comprar 8-10 cartas, la probabilidad de cartas útiles cae por debajo del valor de asentamiento",
                  "de": "Nach Kauf von 8-10 Karten sinkt Wahrscheinlichkeit nützlicher Karten unter Siedlungswert",
                  "nl": "Na aankoop van 8-10 kaarten daalt waarschijnlijkheid van nuttige kaarten onder nederzettingswaarde"
        },
        {
                  "en": "Never buy more than 2 cards total",
                  "es": "Nunca comprar más de 2 cartas en total",
                  "de": "Nie mehr als 2 Karten insgesamt kaufen",
                  "nl": "Nooit meer dan 2 kaarten totaal kopen"
        },
        {
                  "en": "Buy unlimited development cards always",
                  "es": "Comprar cartas de desarrollo ilimitadas siempre",
                  "de": "Unbegrenzt Entwicklungskarten immer kaufen",
                  "nl": "Onbeperkt ontwikkelingskaarten altijd kopen"
        },
        {
                  "en": "Development card value never declines",
                  "es": "El valor de la carta de desarrollo nunca declina",
                  "de": "Entwicklungskartenwert sinkt nie",
                  "nl": "Ontwikkelingskaart waarde daalt nooit"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Early: favor 2:1 harbors, Mid: balanced trades, Late: aggressive 3:1/4:1 for winning plays",
                  "es": "Temprano: favorecer puertos 2:1, Medio: intercambios equilibrados, Tardío: 3:1/4:1 agresivos para jugadas ganadoras",
                  "de": "Früh: 2:1-Häfen bevorzugen, Mitte: ausgewogene Geschäfte, Spät: aggressive 3:1/4:1 für Siegzüge",
                  "nl": "Vroeg: voorrang 2:1 havens, Midden: gebalanceerde handel, Laat: agressief 3:1/4:1 voor winnende zetten"
        },
        {
                  "en": "Always use 4:1 bank trades only",
                  "es": "Siempre usar solo intercambios bancarios 4:1",
                  "de": "Immer nur 4:1-Bankgeschäfte verwenden",
                  "nl": "Altijd alleen 4:1 bankruil gebruiken"
        },
        {
                  "en": "Never trade at any ratio",
                  "es": "Nunca comerciar en ninguna proporción",
                  "de": "Nie zu irgendeinem Verhältnis handeln",
                  "nl": "Nooit ruilen op enige ratio"
        },
        {
                  "en": "All trades should be 1:1 always",
                  "es": "Todos los intercambios deben ser 1:1 siempre",
                  "de": "Alle Geschäfte sollten immer 1:1 sein",
                  "nl": "Alle handel moet altijd 1:1 zijn"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Discard all knight cards",
                  "es": "Descartar todas las cartas de caballero",
                  "de": "Alle Ritterkarten abwerfen",
                  "nl": "Gooi alle ridderkaarten weg"
        },
        {
                  "en": "Never save more than 1 knight card",
                  "es": "Nunca guardar más de 1 carta de caballero",
                  "de": "Nie mehr als 1 Ritterkarte aufheben",
                  "nl": "Nooit meer dan 1 ridderkaart bewaren"
        },
        {
                  "en": "Hold 3-4 knights unplayed to threaten largest army steal on final turns",
                  "es": "Mantener 3-4 caballeros sin jugar para amenazar robo de ejército más grande en turnos finales",
                  "de": "3-4 Ritter unausgespielt halten um größte Armee-Diebstahl in Endzügen zu drohen",
                  "nl": "Houd 3-4 ridders onspeeld om grootste leger diefstal te dreigen in laatste beurten"
        },
        {
                  "en": "Play all knights immediately when drawn",
                  "es": "Jugar todos los caballeros inmediatamente cuando se roban",
                  "de": "Alle Ritter sofort nach Ziehen spielen",
                  "nl": "Speel alle ridders direct wanneer getrokken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Always expand to islands regardless of cost",
                  "es": "Siempre expandir a islas sin importar el costo",
                  "de": "Immer zu Inseln expandieren unabhängig von Kosten",
                  "nl": "Altijd uitbreiden naar eilanden ongeacht kosten"
        },
        {
                  "en": "(Island pip value) - (ship cost × 2) must exceed 8 to justify expansion",
                  "es": "(Valor pip de isla) - (costo de barco × 2) debe exceder 8 para justificar expansión",
                  "de": "(Insel-Pip-Wert) - (Schiffskosten × 2) muss 8 überschreiten um Expansion zu rechtfertigen",
                  "nl": "(Eiland pip waarde) - (schip kosten × 2) moet 8 overschrijden om expansie te rechtvaardigen"
        },
        {
                  "en": "Never build settlements on islands",
                  "es": "Nunca construir asentamientos en islas",
                  "de": "Nie Siedlungen auf Inseln bauen",
                  "nl": "Nooit nederzettingen op eilanden bouwen"
        },
        {
                  "en": "Island efficiency is unmeasurable",
                  "es": "La eficiencia de isla es inmensurable",
                  "de": "Insel-Effizienz ist unmessbar",
                  "nl": "Eiland efficiëntie is onmeetbaar"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Build all 5 settlements immediately",
                  "es": "Construir todas las 5 asentamientos inmediatamente",
                  "de": "Alle 5 Siedlungen sofort bauen",
                  "nl": "Bouw alle 5 nederzettingen direct"
        },
        {
                  "en": "Wait until turn 30 for all settlements",
                  "es": "Esperar hasta el turno 30 para todos los asentamientos",
                  "de": "Bis Zug 30 für alle Siedlungen warten",
                  "nl": "Wacht tot beurt 30 voor alle nederzettingen"
        },
        {
                  "en": "Build 3rd and 4th settlements on consecutive turns (around turn 12-16) before spots close",
                  "es": "Construir 3° y 4° asentamientos en turnos consecutivos (alrededor del turno 12-16) antes de que los lugares se cierren",
                  "de": "3. und 4. Siedlung in aufeinanderfolgenden Zügen bauen (um Zug 12-16) bevor Plätze schließen",
                  "nl": "Bouw 3e en 4e nederzettingen in opeenvolgende beurten (rond beurt 12-16) voordat plekken sluiten"
        },
        {
                  "en": "Never build more than 2 settlements",
                  "es": "Nunca construir más de 2 asentamientos",
                  "de": "Nie mehr als 2 Siedlungen bauen",
                  "nl": "Nooit meer dan 2 nederzettingen bouwen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Never move the robber",
                  "es": "Nunca mover el ladrón",
                  "de": "Räuber nie bewegen",
                  "nl": "Verplaats de rover nooit"
        },
        {
                  "en": "Place robber randomly always",
                  "es": "Colocar ladrón aleatoriamente siempre",
                  "de": "Räuber immer zufällig platzieren",
                  "nl": "Plaats rover altijd willekeurig"
        },
        {
                  "en": "Only target lowest-scoring player",
                  "es": "Solo apuntar al jugador con menor puntuación",
                  "de": "Nur Spieler mit niedrigster Punktzahl anvisieren",
                  "nl": "Alleen target laagst scorende speler"
        },
        {
                  "en": "Identify which opponent is accumulating resources without building and target with robber",
                  "es": "Identificar qué oponente está acumulando recursos sin construir y apuntar con ladrón",
                  "de": "Identifizieren welcher Gegner Ressourcen ohne Bauen sammelt und mit Räuber anvisieren",
                  "nl": "Identificeer welke tegenstander bronnen verzamelt zonder te bouwen en target met rover"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dice never follow probability patterns",
                  "es": "Los dados nunca siguen patrones de probabilidad",
                  "de": "Würfel folgen nie Wahrscheinlichkeitsmustern",
                  "nl": "Dobbelstenen volgen nooit waarschijnlijkheidspatronen"
        },
        {
                  "en": "Probability is irrelevant in Catan",
                  "es": "La probabilidad es irrelevante en Catan",
                  "de": "Wahrscheinlichkeit ist irrelevant in Catan",
                  "nl": "Waarschijnlijkheid is irrelevant in Catan"
        },
        {
                  "en": "As game progresses, actual dice distribution approaches theoretical probability (law of large numbers)",
                  "es": "A medida que el juego progresa, la distribución real de dados se acerca a la probabilidad teórica (ley de grandes números)",
                  "de": "Mit Spielfortschritt nähert sich tatsächliche Würfelverteilung theoretischer Wahrscheinlichkeit (Gesetz großer Zahlen)",
                  "nl": "Naarmate spel vordert, nadert werkelijke dobbelsteenverdeling theoretische waarschijnlijkheid (wet van grote getallen)"
        },
        {
                  "en": "All numbers hit equally often",
                  "es": "Todos los números salen igualmente a menudo",
                  "de": "Alle Zahlen treffen gleich oft",
                  "nl": "Alle nummers vallen even vaak"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Always place settlements adjacent for efficiency",
                  "es": "Siempre colocar asentamientos adyacentes para eficiencia",
                  "de": "Siedlungen immer benachbart für Effizienz platzieren",
                  "nl": "Altijd aangrenzende nederzettingen plaatsen voor efficiëntie"
        },
        {
                  "en": "Adjacency provides bonuses not penalties",
                  "es": "La adyacencia proporciona bonificaciones no penalizaciones",
                  "de": "Adjacenz bietet Boni nicht Strafen",
                  "nl": "Nabijheid biedt bonussen niet boetes"
        },
        {
                  "en": "Placement location is irrelevant",
                  "es": "La ubicación de colocación es irrelevante",
                  "de": "Platzierungsstandort ist irrelevant",
                  "nl": "Plaatsingslocatie is irrelevant"
        },
        {
                  "en": "Reduce settlement value by 20-30% if adjacent to your own settlements on same hex",
                  "es": "Reducir el valor del asentamiento en 20-30% si está adyacente a tus propios asentamientos en el mismo hexágono",
                  "de": "Siedlungswert um 20-30% reduzieren wenn benachbart zu eigenen Siedlungen auf gleichem Hex",
                  "nl": "Verminder nederzettingswaarde met 20-30% als aangrenzend aan je eigen nederzettingen op dezelfde hex"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Need 14+ wheat/ore combined pips across starting settlements",
                  "es": "Necesitar 14+ pips combinados de trigo/mineral en asentamientos iniciales",
                  "de": "14+ kombinierte Weizen/Erz-Pips über Startsiedlungen benötigen",
                  "nl": "Heb 14+ gecombineerde tarwe/erts pips nodig over start nederzettingen"
        },
        {
                  "en": "Always rush cities with any production",
                  "es": "Siempre apresurarse a ciudades con cualquier producción",
                  "de": "Immer mit jeder Produktion zu Städten eilen",
                  "nl": "Altijd haasten naar steden met elke productie"
        },
        {
                  "en": "Never build cities before turn 50",
                  "es": "Nunca construir ciudades antes del turno 50",
                  "de": "Nie Städte vor Zug 50 bauen",
                  "nl": "Nooit steden bouwen voor beurt 50"
        },
        {
                  "en": "City strategy requires no minimum production",
                  "es": "La estrategia de ciudad no requiere producción mínima",
                  "de": "Stadt-Strategie erfordert keine Mindestproduktion",
                  "nl": "Stadsstrategie vereist geen minimum productie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only trade with current leader",
                  "es": "Solo comerciar con el líder actual",
                  "de": "Nur mit aktuellem Führenden handeln",
                  "nl": "Alleen handelen met huidige leider"
        },
        {
                  "en": "Trade randomly without consideration",
                  "es": "Comerciar aleatoriamente sin consideración",
                  "de": "Zufällig ohne Überlegung handeln",
                  "nl": "Willekeurig handelen zonder overweging"
        },
        {
                  "en": "Never trade with anyone ever",
                  "es": "Nunca comerciar con nadie jamás",
                  "de": "Niemals mit jemandem handeln",
                  "nl": "Nooit met iemand handelen"
        },
        {
                  "en": "Offer trades to 3rd/4th place players at favorable ratios to build coalition against leader",
                  "es": "Ofrecer intercambios a jugadores de 3°/4° lugar en proporciones favorables para construir coalición contra el líder",
                  "de": "Geschäfte zu 3./4.-Platz-Spielern zu günstigen Verhältnissen anbieten um Koalition gegen Führenden aufzubauen",
                  "nl": "Bied handel aan 3e/4e plaats spelers op gunstige ratio's om coalitie tegen leider op te bouwen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Always maximize your own points only",
                  "es": "Siempre maximizar solo tus propios puntos",
                  "de": "Immer nur eigene Punkte maximieren",
                  "nl": "Altijd alleen je eigen punten maximaliseren"
        },
        {
                  "en": "Never make sacrificial moves",
                  "es": "Nunca hacer movimientos de sacrificio",
                  "de": "Nie Opferzüge machen",
                  "nl": "Nooit offer zetten maken"
        },
        {
                  "en": "Trading 2 development cards worth of resources to block opponent's critical settlement",
                  "es": "Intercambiar recursos por valor de 2 cartas de desarrollo para bloquear asentamiento crítico del oponente",
                  "de": "Ressourcen im Wert von 2 Entwicklungskarten tauschen um kritische Siedlung des Gegners zu blockieren",
                  "nl": "Bronnen ter waarde van 2 ontwikkelingskaarten ruilen om kritieke nederzetting van tegenstander te blokkeren"
        },
        {
                  "en": "Tempo sacrifices are always bad",
                  "es": "Los sacrificios de tempo siempre son malos",
                  "de": "Tempo-Opfer sind immer schlecht",
                  "nl": "Tempo offers zijn altijd slecht"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Place robber on desert always",
                  "es": "Colocar ladrón en desierto siempre",
                  "de": "Räuber immer auf Wüste platzieren",
                  "nl": "Plaats rover altijd op woestijn"
        },
        {
                  "en": "Always rob the same player repeatedly",
                  "es": "Siempre robar al mismo jugador repetidamente",
                  "de": "Immer denselben Spieler wiederholt berauben",
                  "nl": "Altijd dezelfde speler herhaaldelijk beroven"
        },
        {
                  "en": "Robber placement should be random",
                  "es": "La colocación del ladrón debe ser aleatoria",
                  "de": "Räuberplatzierung sollte zufällig sein",
                  "nl": "Roverplaatsing moet willekeurig zijn"
        },
        {
                  "en": "Establish unspoken pattern: each player robs next player clockwise to distribute pain equally",
                  "es": "Establecer patrón tácito: cada jugador roba al siguiente jugador en sentido horario para distribuir dolor equitativamente",
                  "de": "Unausgesprochenes Muster etablieren: jeder Spieler beraubt nächsten Spieler im Uhrzeigersinn um Schmerz gleichmäßig zu verteilen",
                  "nl": "Vestig onuitgesproken patroon: elke speler berooft volgende speler met de klok mee om pijn gelijk te verdelen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Concentration always improves consistency",
                  "es": "La concentración siempre mejora la consistencia",
                  "de": "Konzentration verbessert immer Konsistenz",
                  "nl": "Concentratie verbetert altijd consistentie"
        },
        {
                  "en": "Standard deviation increases with pip concentration - spread placements reduce volatility",
                  "es": "La desviación estándar aumenta con la concentración de pips - las colocaciones dispersas reducen la volatilidad",
                  "de": "Standardabweichung steigt mit Pip-Konzentration - verteilte Platzierungen reduzieren Volatilität",
                  "nl": "Standaardafwijking neemt toe met pip concentratie - gespreide plaatsingen verminderen volatiliteit"
        },
        {
                  "en": "Variance is unmeasurable in Catan",
                  "es": "La varianza es imposible de medir en Catan",
                  "de": "Varianz ist in Catan unmessbar",
                  "nl": "Variantie is onmeetbaar in Catan"
        },
        {
                  "en": "All placement patterns have identical variance",
                  "es": "Todos los patrones de colocación tienen varianza idéntica",
                  "de": "Alle Platzierungsmuster haben identische Varianz",
                  "nl": "Alle plaatsingspatronen hebben identieke variantie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Never buy development cards in endgame",
                  "es": "Nunca comprar cartas de desarrollo en el final del juego",
                  "de": "Nie Entwicklungskarten im Endspiel kaufen",
                  "nl": "Koop nooit ontwikkelingskaarten in eindspel"
        },
        {
                  "en": "Build only visible point structures",
                  "es": "Construir solo estructuras de puntos visibles",
                  "de": "Nur sichtbare Punktstrukturen bauen",
                  "nl": "Bouw alleen zichtbare punt structuren"
        },
        {
                  "en": "Display 7-8 visible points while holding 2 hidden VP cards to win surprise next turn",
                  "es": "Mostrar 7-8 puntos visibles mientras se mantienen 2 cartas de PV ocultas para ganar por sorpresa el próximo turno",
                  "de": "7-8 sichtbare Punkte zeigen während 2 versteckte SP-Karten gehalten werden um nächsten Zug überraschend zu gewinnen",
                  "nl": "Toon 7-8 zichtbare punten terwijl je 2 verborgen OP kaarten vasthoudt om volgende beurt verrassend te winnen"
        },
        {
                  "en": "Always reveal all victory points immediately",
                  "es": "Siempre revelar todos los puntos de victoria inmediatamente",
                  "de": "Alle Siegpunkte immer sofort offenbaren",
                  "nl": "Toon altijd alle overwinningspunten direct"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "2:1 harbor worth 3-4 extra pips of production value over 60-turn game",
                  "es": "Puerto 2:1 vale 3-4 pips extra de valor de producción durante juego de 60 turnos",
                  "de": "2:1-Hafen wert 3-4 Extra-Pips Produktionswert über 60-Züge-Spiel",
                  "nl": "2:1 haven waard 3-4 extra pips productiewaarde over 60-beurten spel"
        },
        {
                  "en": "All harbors worth exactly 1 pip",
                  "es": "Todos los puertos valen exactamente 1 pip",
                  "de": "Alle Häfen wert genau 1 Pip",
                  "nl": "Alle havens waard precies 1 pip"
        },
        {
                  "en": "Harbor value is infinite",
                  "es": "El valor del puerto es infinito",
                  "de": "Hafenwert ist unendlich",
                  "nl": "Haven waarde is oneindig"
        },
        {
                  "en": "Harbors provide no measurable advantage",
                  "es": "Los puertos no proporcionan ventaja medible",
                  "de": "Häfen bieten keinen messbaren Vorteil",
                  "nl": "Havens bieden geen meetbaar voordeel"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only buy cards in final 5 turns",
                  "es": "Solo comprar cartas en los últimos 5 turnos",
                  "de": "Nur Karten in letzten 5 Zügen kaufen",
                  "nl": "Alleen kaarten kopen in laatste 5 beurten"
        },
        {
                  "en": "Card timing makes no difference",
                  "es": "El tiempo de las cartas no hace diferencia",
                  "de": "Karten-Timing macht keinen Unterschied",
                  "nl": "Kaart timing maakt geen verschil"
        },
        {
                  "en": "Always buy development cards turn 1",
                  "es": "Siempre comprar cartas de desarrollo en turno 1",
                  "de": "Immer Entwicklungskarten in Zug 1 kaufen",
                  "nl": "Altijd ontwikkelingskaarten kopen beurt 1"
        },
        {
                  "en": "Buying cards early maximizes total cards but late buying maximizes card quality from depleted deck",
                  "es": "Comprar cartas temprano maximiza cartas totales pero comprar tarde maximiza calidad de cartas del mazo agotado",
                  "de": "Früher Kartenkauf maximiert Gesamtkarten aber später Kauf maximiert Kartenqualität aus erschöpftem Deck",
                  "nl": "Vroeg kaarten kopen maximaliseert totale kaarten maar laat kopen maximaliseert kaart kwaliteit uit uitgeput deck"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Card count provides no information",
                  "es": "El conteo de cartas no proporciona información",
                  "de": "Kartenzählung liefert keine Information",
                  "nl": "Kaart telling biedt geen informatie"
        },
        {
                  "en": "Resource count should be random",
                  "es": "El conteo de recursos debe ser aleatorio",
                  "de": "Ressourcenzählung sollte zufällig sein",
                  "nl": "Bron telling moet willekeurig zijn"
        },
        {
                  "en": "Always accumulate 10+ cards safely",
                  "es": "Siempre acumular 10+ cartas de forma segura",
                  "de": "Immer 10+ Karten sicher ansammeln",
                  "nl": "Altijd 10+ kaarten veilig verzamelen"
        },
        {
                  "en": "Opponents tracking your 7+ cards reveals your intended building project and invites robber",
                  "es": "Oponentes rastreando tus 7+ cartas revela tu proyecto de construcción previsto e invita al ladrón",
                  "de": "Gegner die Ihre 7+ Karten verfolgen enthüllen Ihr beabsichtigtes Bauprojekt und laden Räuber ein",
                  "nl": "Tegenstanders die je 7+ kaarten volgen onthullen je voorgenomen bouwproject en nodigen rover uit"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Commodities have no strategic value",
                  "es": "Los productos no tienen valor estratégico",
                  "de": "Rohstoffe haben keinen strategischen Wert",
                  "nl": "Grondstoffen hebben geen strategische waarde"
        },
        {
                  "en": "Never focus on single commodity type",
                  "es": "Nunca enfocarse en un solo tipo de producto",
                  "de": "Nie auf einzelnen Rohstofftyp fokussieren",
                  "nl": "Focus nooit op enkel grondstof type"
        },
        {
                  "en": "Build cities on random commodities",
                  "es": "Construir ciudades en productos aleatorios",
                  "de": "Städte auf zufällige Rohstoffe bauen",
                  "nl": "Bouw steden op willekeurige grondstoffen"
        },
        {
                  "en": "Control 3+ cities producing same commodity to dominate metropolis and progress card access",
                  "es": "Controlar 3+ ciudades produciendo el mismo producto para dominar metrópolis y acceso a cartas de progreso",
                  "de": "3+ Städte kontrollieren die denselben Rohstoff produzieren um Metropole und Fortschrittskartenzugang zu dominieren",
                  "nl": "Controleer 3+ steden die dezelfde grondstof produceren om metropool en voortgangskaart toegang te domineren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Never reveal specific card types in trades",
                  "es": "Nunca revelar tipos específicos de cartas en intercambios",
                  "de": "Nie spezifische Kartentypen in Geschäften offenbaren",
                  "nl": "Onthul nooit specifieke kaarttypen in handel"
        },
        {
                  "en": "Make all trades secretly",
                  "es": "Hacer todos los intercambios en secreto",
                  "de": "Alle Geschäfte heimlich machen",
                  "nl": "Maak alle handel in het geheim"
        },
        {
                  "en": "Trading provides no information advantage",
                  "es": "El comercio no proporciona ventaja de información",
                  "de": "Handel bietet keinen Informationsvorteil",
                  "nl": "Handel biedt geen informatievoordeel"
        },
        {
                  "en": "Announce exact cards when proposing trades to extract opponent hand information from responses",
                  "es": "Anunciar cartas exactas al proponer intercambios para extraer información de la mano del oponente de las respuestas",
                  "de": "Exakte Karten beim Vorschlagen von Geschäften ankündigen um Gegnerhand-Information aus Antworten zu extrahieren",
                  "nl": "Kondig exacte kaarten aan bij het voorstellen van handel om tegenstander hand informatie uit reacties te halen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Never convert more than 2 settlements to cities",
                  "es": "Nunca convertir más de 2 asentamientos a ciudades",
                  "de": "Nie mehr als 2 Siedlungen zu Städten konvertieren",
                  "nl": "Converteer nooit meer dan 2 nederzettingen naar steden"
        },
        {
                  "en": "Convert all 4-5 settlements to cities in rapid succession (3-5 turns) before opponents respond",
                  "es": "Convertir todos los 4-5 asentamientos a ciudades en rápida sucesión (3-5 turnos) antes de que los oponentes respondan",
                  "de": "Alle 4-5 Siedlungen in schneller Folge (3-5 Züge) zu Städten konvertieren bevor Gegner reagieren",
                  "nl": "Converteer alle 4-5 nederzettingen naar steden in snelle opeenvolging (3-5 beurten) voordat tegenstanders reageren"
        },
        {
                  "en": "Wait until turn 50 for city upgrades",
                  "es": "Esperar hasta el turno 50 para mejoras de ciudad",
                  "de": "Bis Zug 50 für Stadt-Upgrades warten",
                  "nl": "Wacht tot beurt 50 voor stadsupgrades"
        },
        {
                  "en": "Build cities one at a time slowly over 20 turns",
                  "es": "Construir ciudades una a la vez lentamente durante 20 turnos",
                  "de": "Städte einzeln langsam über 20 Züge bauen",
                  "nl": "Bouw steden één tegelijk langzaam over 20 beurten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Exploit opponent miscalculations by claiming 'underrated' spots they ignore (e.g., 5-9-10 combos)",
                  "es": "Explotar errores de cálculo de oponentes reclamando lugares 'subvalorados' que ignoran (ej., combos 5-9-10)",
                  "de": "Gegner-Fehlberechnungen ausnutzen indem 'unterbewertete' Plätze beansprucht werden die sie ignorieren (z.B. 5-9-10-Kombos)",
                  "nl": "Exploiteer tegenstander misrekeningen door 'ondergewaardeerde' plekken te claimen die ze negeren (bijv. 5-9-10 combo's)"
        },
        {
                  "en": "All players value settlements identically",
                  "es": "Todos los jugadores valoran los asentamientos idénticamente",
                  "de": "Alle Spieler bewerten Siedlungen identisch",
                  "nl": "Alle spelers waarderen nederzettingen identiek"
        },
        {
                  "en": "Settlement location is irrelevant",
                  "es": "La ubicación del asentamiento es irrelevante",
                  "de": "Siedlungsstandort ist irrelevant",
                  "nl": "Nederzettingslocatie is irrelevant"
        },
        {
                  "en": "Only claim obvious 6-8 spots",
                  "es": "Solo reclamar lugares obvios de 6-8",
                  "de": "Nur offensichtliche 6-8-Plätze beanspruchen",
                  "nl": "Claim alleen voor de hand liggende 6-8 plekken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Always prioritize ships over mainland",
                  "es": "Siempre priorizar barcos sobre tierra firme",
                  "de": "Schiffe immer über Festland priorisieren",
                  "nl": "Altijd schepen prioriteren boven vasteland"
        },
        {
                  "en": "Need 12+ lumber/sheep pips to justify ship-based expansion vs mainland settlement",
                  "es": "Necesitar 12+ pips de madera/oveja para justificar expansión basada en barcos vs asentamiento en tierra firme",
                  "de": "12+ Holz/Schaf-Pips benötigen um schiffbasierte Expansion vs Festland-Siedlung zu rechtfertigen",
                  "nl": "Heb 12+ hout/schaap pips nodig om schip-gebaseerde expansie te rechtvaardigen vs vasteland nederzetting"
        },
        {
                  "en": "Ship production requirements don't matter",
                  "es": "Los requisitos de producción de barcos no importan",
                  "de": "Schiffsproduktionsanforderungen sind egal",
                  "nl": "Scheepsproductie vereisten zijn niet belangrijk"
        },
        {
                  "en": "Never build ships in Seafarers",
                  "es": "Nunca construir barcos en Marineros",
                  "de": "Nie Schiffe in Seefahrer bauen",
                  "nl": "Bouw nooit schepen in Zeevaarders"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Knight timing is irrelevant",
                  "es": "El tiempo de los caballeros es irrelevante",
                  "de": "Ritter-Timing ist irrelevant",
                  "nl": "Ridder timing is irrelevant"
        },
        {
                  "en": "Activate all knights immediately when built",
                  "es": "Activar todos los caballeros inmediatamente cuando se construyen",
                  "de": "Alle Ritter sofort nach Bau aktivieren",
                  "nl": "Activeer alle ridders direct wanneer gebouwd"
        },
        {
                  "en": "Keep knights inactive until barbarian attack imminent, forcing opponents to activate first",
                  "es": "Mantener caballeros inactivos hasta que el ataque bárbaro sea inminente, forzando a los oponentes a activar primero",
                  "de": "Ritter inaktiv halten bis Barbarenangriff unmittelbar bevorsteht und Gegner zwingt zuerst zu aktivieren",
                  "nl": "Houd ridders inactief tot barbaren aanval dreigt, dwing tegenstanders als eerste te activeren"
        },
        {
                  "en": "Never build knights in C&K",
                  "es": "Nunca construir caballeros en C&K",
                  "de": "Nie Ritter in S&R bauen",
                  "nl": "Bouw nooit ridders in S&R"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Always build maximum possible roads",
                  "es": "Siempre construir el máximo de carreteras posible",
                  "de": "Immer maximal mögliche Straßen bauen",
                  "nl": "Altijd maximum mogelijke wegen bouwen"
        },
        {
                  "en": "Never compete for longest road",
                  "es": "Nunca competir por el camino más largo",
                  "de": "Nie um längste Straße konkurrieren",
                  "nl": "Concurreer nooit voor langste weg"
        },
        {
                  "en": "Build minimum roads needed (efficiency) vs maximum roads possible (longest road contest)",
                  "es": "Construir carreteras mínimas necesarias (eficiencia) vs carreteras máximas posibles (concurso de camino más largo)",
                  "de": "Minimale benötigte Straßen bauen (Effizienz) vs maximale mögliche Straßen (längste Straße Wettbewerb)",
                  "nl": "Bouw minimum benodigde wegen (efficiëntie) vs maximum mogelijke wegen (langste weg wedstrijd)"
        },
        {
                  "en": "Road strategy is irrelevant",
                  "es": "La estrategia de carreteras es irrelevante",
                  "de": "Straßenstrategie ist irrelevant",
                  "nl": "Wegstrategie is irrelevant"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "City strategy is always inferior",
                  "es": "La estrategia de ciudad siempre es inferior",
                  "de": "Stadt-Strategie ist immer unterlegen",
                  "nl": "Stadsstrategie is altijd inferieur"
        },
        {
                  "en": "Multiple cities have no compounding effect",
                  "es": "Múltiples ciudades no tienen efecto de acumulación",
                  "de": "Mehrere Städte haben keinen kumulierenden Effekt",
                  "nl": "Meerdere steden hebben geen samenstelling effect"
        },
        {
                  "en": "Cities provide linear growth only",
                  "es": "Las ciudades proporcionan solo crecimiento lineal",
                  "de": "Städte bieten nur lineares Wachstum",
                  "nl": "Steden bieden alleen lineaire groei"
        },
        {
                  "en": "Each city doubles production which accelerates next city, creating exponential growth curve",
                  "es": "Cada ciudad duplica la producción lo que acelera la próxima ciudad, creando curva de crecimiento exponencial",
                  "de": "Jede Stadt verdoppelt Produktion was nächste Stadt beschleunigt und exponentielle Wachstumskurve schafft",
                  "nl": "Elke stad verdubbelt productie wat volgende stad versnelt, creërend exponentiële groeicurve"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Monopoly targeting should be random",
                  "es": "La selección de monopolio debe ser aleatoria",
                  "de": "Monopol-Zielauswahl sollte zufällig sein",
                  "nl": "Monopolie targeting moet willekeurig zijn"
        },
        {
                  "en": "Estimate opponent holdings: (visible production - visible spending) × turns since last build",
                  "es": "Estimar tenencias del oponente: (producción visible - gasto visible) × turnos desde última construcción",
                  "de": "Gegnerbestände schätzen: (sichtbare Produktion - sichtbare Ausgaben) × Züge seit letztem Bau",
                  "nl": "Schat tegenstander bezittingen: (zichtbare productie - zichtbare uitgaven) × beurten sinds laatste bouw"
        },
        {
                  "en": "Opponent holdings cannot be calculated",
                  "es": "Las tenencias del oponente no pueden calcularse",
                  "de": "Gegnerbestände können nicht berechnet werden",
                  "nl": "Tegenstander bezittingen kunnen niet berekend worden"
        },
        {
                  "en": "Never use monopoly cards",
                  "es": "Nunca usar cartas de monopolio",
                  "de": "Nie Monopolkarten verwenden",
                  "nl": "Gebruik nooit monopoliekaarten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Spending 1 settlement to deny opponent 3-point gain (settlement + harbor/position) = net +2",
                  "es": "Gastar 1 asentamiento para negar ganancia de 3 puntos al oponente (asentamiento + puerto/posición) = neto +2",
                  "de": "1 Siedlung ausgeben um Gegner 3-Punkt-Gewinn zu verweigern (Siedlung + Hafen/Position) = netto +2",
                  "nl": "Besteed 1 nederzetting om tegenstander 3-punt winst te ontzeggen (nederzetting + haven/positie) = netto +2"
        },
        {
                  "en": "All settlements must maximize own production",
                  "es": "Todos los asentamientos deben maximizar la propia producción",
                  "de": "Alle Siedlungen müssen eigene Produktion maximieren",
                  "nl": "Alle nederzettingen moeten eigen productie maximaliseren"
        },
        {
                  "en": "Never build defensively",
                  "es": "Nunca construir defensivamente",
                  "de": "Nie defensiv bauen",
                  "nl": "Bouw nooit defensief"
        },
        {
                  "en": "Blocking settlements are always wasteful",
                  "es": "Los asentamientos de bloqueo siempre son desperdiciadores",
                  "de": "Blockierungs-Siedlungen sind immer verschwenderisch",
                  "nl": "Blokkerende nederzettingen zijn altijd verspillend"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Card count doesn't matter in endgame",
                  "es": "El conteo de cartas no importa en el final del juego",
                  "de": "Kartenzählung ist im Endspiel egal",
                  "nl": "Kaart telling is niet belangrijk in eindspel"
        },
        {
                  "en": "Always keep 0-3 cards to avoid robber",
                  "es": "Siempre mantener 0-3 cartas para evitar al ladrón",
                  "de": "Immer 0-3 Karten behalten um Räuber zu vermeiden",
                  "nl": "Houd altijd 0-3 kaarten om rover te vermijden"
        },
        {
                  "en": "At 8-9 points, accumulate exactly 7 cards (robber-proof) with winning combo ready",
                  "es": "A 8-9 puntos, acumular exactamente 7 cartas (a prueba de ladrones) con combo ganador listo",
                  "de": "Bei 8-9 Punkten exakt 7 Karten ansammeln (räubersicher) mit siegender Combo bereit",
                  "nl": "Bij 8-9 punten, verzamel precies 7 kaarten (rover-proof) met winnende combo klaar"
        },
        {
                  "en": "Accumulate 15+ cards for flexibility",
                  "es": "Acumular 15+ cartas para flexibilidad",
                  "de": "15+ Karten für Flexibilität ansammeln",
                  "nl": "Verzamel 15+ kaarten voor flexibiliteit"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "10 roads (10 lumber + 10 brick) = 2.5 settlements worth of resources for 2 points",
                  "es": "10 carreteras (10 madera + 10 ladrillo) = 2.5 asentamientos de valor de recursos para 2 puntos",
                  "de": "10 Straßen (10 Holz + 10 Ziegel) = 2,5 Siedlungen Ressourcenwert für 2 Punkte",
                  "nl": "10 wegen (10 hout + 10 baksteen) = 2,5 nederzettingen aan bronwaarde voor 2 punten"
        },
        {
                  "en": "Roads have no opportunity cost",
                  "es": "Las carreteras no tienen costo de oportunidad",
                  "de": "Straßen haben keine Opportunitätskosten",
                  "nl": "Wegen hebben geen opportunity cost"
        },
        {
                  "en": "Longest road is always optimal investment",
                  "es": "El camino más largo siempre es inversión óptima",
                  "de": "Längste Straße ist immer optimale Investition",
                  "nl": "Langste weg is altijd optimale investering"
        },
        {
                  "en": "Never consider resource alternatives",
                  "es": "Nunca considerar alternativas de recursos",
                  "de": "Ressourcenalternativen nie berücksichtigen",
                  "nl": "Overweeg nooit bron alternatieven"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only place robber on rare resources",
                  "es": "Solo colocar ladrón en recursos raros",
                  "de": "Räuber nur auf seltene Ressourcen platzieren",
                  "nl": "Plaats rover alleen op zeldzame bronnen"
        },
        {
                  "en": "Never use robber strategically",
                  "es": "Nunca usar ladrón estratégicamente",
                  "de": "Räuber nie strategisch verwenden",
                  "nl": "Gebruik rover nooit strategisch"
        },
        {
                  "en": "Robber placement should be random",
                  "es": "La colocación del ladrón debe ser aleatoria",
        ...
        {
                  "en": "Place robber on abundant resource hexes to artificially inflate value of your stockpile",
                  "es": "Colocar ladrón en hexágonos de recursos abundantes para inflar artificialmente el valor de tu reserva",
                  "de": "Räuber auf reichliche Ressourcenhexe platzieren um Wert Ihres Vorrats künstlich aufzublähen",
