  ...
  const level10 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Optimal fraction of resources to allocate to dev cards = (expected value - 1) / variance",
                  "es": "Fracción óptima de recursos para asignar a cartas de desarrollo = (valor esperado - 1) / varianza",
                  "de": "Optimaler Ressourcenanteil für Dev-Karten = (Erwartungswert - 1) / Varianz",
                  "nl": "Optimale fractie van bronnen te alloceren aan dev kaarten = (verwachte waarde - 1) / variantie"
        },
        {
                  "en": "Kelly Criterion doesn't apply to board games",
                  "es": "El Criterio de Kelly no se aplica a juegos de mesa",
                  "de": "Kelly-Kriterium gilt nicht für Brettspiele",
                  "nl": "Kelly Criterium geldt niet voor bordspellen"
        },
        {
                  "en": "Never allocate more than 10% to cards",
                  "es": "Nunca asignar más del 10% a cartas",
                  "de": "Nie mehr als 10% für Karten zuweisen",
                  "nl": "Nooit meer dan 10% toewijzen aan kaarten"
        },
        {
                  "en": "Always spend 100% on development cards",
                  "es": "Siempre gastar 100% en cartas de desarrollo",
                  "de": "Immer 100% für Entwicklungskarten ausgeben",
                  "nl": "Altijd 100% uitgeven aan ontwikkelingskaarten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "~10^15 to 10^18 unique game states (larger than chess 10^120 positions but prunable)",
                  "es": "~10^15 a 10^18 estados de juego únicos (más grande que posiciones de ajedrez 10^120 pero podable)",
                  "de": "~10^15 bis 10^18 einzigartige Spielzustände (größer als Schach 10^120 Positionen aber beschneidbar)",
                  "nl": "~10^15 tot 10^18 unieke speltoestanden (groter dan schaak 10^120 posities maar snoeibaar)"
        },
        {
                  "en": "Exactly 10^6 possible games",
                  "es": "Exactamente 10^6 juegos posibles",
                  "de": "Genau 10^6 mögliche Spiele",
                  "nl": "Precies 10^6 mogelijke spellen"
        },
        {
                  "en": "Infinite game states",
                  "es": "Estados de juego infinitos",
                  "de": "Unendliche Spielzustände",
                  "nl": "Oneindige speltoestanden"
        },
        {
                  "en": "Smaller than tic-tac-toe",
                  "es": "Más pequeño que tres en raya",
                  "de": "Kleiner als Tic-Tac-Toe",
                  "nl": "Kleiner dan boter-kaas-eieren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fair distribution of coalition gains based on marginal contribution of each player",
                  "es": "Distribución justa de ganancias de coalición basada en contribución marginal de cada jugador",
                  "de": "Faire Verteilung von Koalitionsgewinnen basierend auf Marginalbeitrag jedes Spielers",
                  "nl": "Eerlijke distributie van coalitie winsten gebaseerd op marginale bijdrage van elke speler"
        },
        {
                  "en": "Winner takes all rewards",
                  "es": "El ganador se lleva todas las recompensas",
                  "de": "Gewinner nimmt alle Belohnungen",
                  "nl": "Winnaar neemt alle beloningen"
        },
        {
                  "en": "Random distribution of benefits",
                  "es": "Distribución aleatoria de beneficios",
                  "de": "Zufällige Verteilung von Vorteilen",
                  "nl": "Willekeurige distributie van voordelen"
        },
        {
                  "en": "Equal split of all resources always",
                  "es": "División igual de todos los recursos siempre",
                  "de": "Gleichmäßige Aufteilung aller Ressourcen immer",
                  "nl": "Gelijke verdeling van alle bronnen altijd"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ignore variance completely",
                  "es": "Ignorar varianza completamente",
                  "de": "Varianz vollständig ignorieren",
                  "nl": "Negeer variantie volledig"
        },
        {
                  "en": "Select hex portfolio maximizing E(production) / σ(production) ratio (Sharpe-like metric)",
                  "es": "Seleccionar cartera de hexágonos maximizando ratio E(producción) / σ(producción) (métrica tipo Sharpe)",
                  "de": "Hex-Portfolio wählen maximiert E(Produktion) / σ(Produktion) Verhältnis (Sharpe-ähnliche Metrik)",
                  "nl": "Selecteer hex portefeuille maximaliseren E(productie) / σ(productie) ratio (Sharpe-achtig metriek)"
        },
        {
                  "en": "Only consider mean production",
                  "es": "Solo considerar producción media",
                  "de": "Nur mittlere Produktion berücksichtigen",
                  "nl": "Alleen gemiddelde productie overwegen"
        },
        {
                  "en": "Always choose maximum variance hexes",
                  "es": "Siempre elegir hexágonos de máxima varianza",
                  "de": "Immer maximale Varianz-Hexe wählen",
                  "nl": "Altijd maximum variantie hexen kiezen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All players should always maximize Gini coefficient",
                  "es": "Todos los jugadores siempre deben maximizar coeficiente de Gini",
                  "de": "Alle Spieler sollten immer Gini-Koeffizient maximieren",
                  "nl": "Alle spelers moeten altijd Gini coëfficiënt maximaliseren"
        },
        {
                  "en": "Gini coefficient irrelevant to Catan",
                  "es": "Coeficiente de Gini irrelevante para Catan",
                  "de": "Gini-Koeffizient irrelevant für Catan",
                  "nl": "Gini coëfficiënt irrelevant voor Catan"
        },
        {
                  "en": "Lower Gini always better for everyone",
                  "es": "Gini más bajo siempre mejor para todos",
                  "de": "Niedrigerer Gini immer besser für alle",
                  "nl": "Lagere Gini altijd beter voor iedereen"
        },
        {
                  "en": "Gini near 1.0 indicates extreme resource concentration; optimal strategy depends on position (leaders want low Gini, trailers want high)",
                  "es": "Gini cerca de 1.0 indica concentración extrema de recursos; estrategia óptima depende de posición (líderes quieren Gini bajo, rezagados quieren alto)",
                  "de": "Gini nahe 1,0 zeigt extreme Ressourcenkonzentration an; optimale Strategie hängt von Position ab (Anführer wollen niedrigen Gini, Zurückliegende wollen hohen)",
                  "nl": "Gini nabij 1,0 duidt op extreme bron concentratie; optimale strategie hangt af van positie (leiders willen lage Gini, achterblijvers willen hoge)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Any equilibrium in opening moves only",
                  "es": "Cualquier equilibrio solo en movimientos de apertura",
                  "de": "Jedes Gleichgewicht nur in Eröffnungszügen",
                  "nl": "Elk evenwicht alleen in openingszetten"
        },
        {
                  "en": "Perfect information game solution",
                  "es": "Solución de juego de información perfecta",
                  "de": "Perfekte Informations-Spiel-Lösung",
                  "nl": "Perfecte informatie spel oplossing"
        },
        {
                  "en": "Subgame equilibrium doesn't exist in Catan",
                  "es": "Equilibrio de subjuego no existe en Catan",
                  "de": "Teilspiel-Gleichgewicht existiert nicht in Catan",
                  "nl": "Subspel evenwicht bestaat niet in Catan"
        },
        {
                  "en": "Nash equilibrium that remains optimal in every subgame (prevents non-credible threats)",
                  "es": "Equilibrio de Nash que permanece óptimo en cada subjuego (previene amenazas no creíbles)",
                  "de": "Nash-Gleichgewicht das in jedem Teilspiel optimal bleibt (verhindert nicht glaubwürdige Drohungen)",
                  "nl": "Nash evenwicht dat optimaal blijft in elk subspel (voorkomt niet-geloofwaardige dreigingen)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ignore all opponent mistakes completely",
                  "es": "Ignorar todos los errores del oponente completamente",
                  "de": "Alle Gegnerfehler vollständig ignorieren",
                  "nl": "Negeer alle tegenstander fouten volledig"
        },
        {
                  "en": "Optimal strategy accounts for small probability opponent mistakes (ε-errors)",
                  "es": "Estrategia óptima considera pequeña probabilidad de errores del oponente (errores ε)",
                  "de": "Optimale Strategie berücksichtigt kleine Wahrscheinlichkeit Gegnerfehler (ε-Fehler)",
                  "nl": "Optimale strategie houdt rekening met kleine waarschijnlijkheid tegenstander fouten (ε-fouten)"
        },
        {
                  "en": "Only applies to perfect play games",
                  "es": "Solo se aplica a juegos de juego perfecto",
                  "de": "Gilt nur für perfekte Spiel-Spiele",
                  "nl": "Geldt alleen voor perfecte spel spellen"
        },
        {
                  "en": "Assumes opponents always blunder",
                  "es": "Asume que los oponentes siempre cometen errores",
                  "de": "Nimmt an Gegner machen immer Fehler",
                  "nl": "Neemt aan tegenstanders altijd blunderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only applies to complete information games",
                  "es": "Solo se aplica a juegos de información completa",
                  "de": "Gilt nur für Spiele vollständiger Information",
                  "nl": "Geldt alleen voor complete informatie spellen"
        },
        {
                  "en": "Nash equilibrium where players hold beliefs about hidden information (dev cards) and update via Bayes' rule",
                  "es": "Equilibrio de Nash donde jugadores tienen creencias sobre información oculta (cartas de desarrollo) y actualizan vía regla de Bayes",
                  "de": "Nash-Gleichgewicht wo Spieler Überzeugungen über versteckte Information (Dev-Karten) halten und via Bayes-Regel aktualisieren",
                  "nl": "Nash evenwicht waar spelers overtuigingen hebben over verborgen informatie (dev kaarten) en bijwerken via Bayes' regel"
        },
        {
                  "en": "Bayesian methods don't apply to board games",
                  "es": "Los métodos bayesianos no se aplican a juegos de mesa",
                  "de": "Bayesianische Methoden gelten nicht für Brettspiele",
                  "nl": "Bayesiaanse methoden gelden niet voor bordspellen"
        },
        {
                  "en": "Requires revealing all hidden cards",
                  "es": "Requiere revelar todas las cartas ocultas",
                  "de": "Erfordert Offenbaren aller versteckten Karten",
                  "nl": "Vereist onthullen alle verborgen kaarten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cooperation impossible in all repeated games",
                  "es": "Cooperación imposible en todos los juegos repetidos",
                  "de": "Kooperation unmöglich in allen wiederholten Spielen",
                  "nl": "Samenwerking onmogelijk in alle herhaalde spellen"
        },
        {
                  "en": "Only one equilibrium exists in repeated play",
                  "es": "Solo existe un equilibrio en juego repetido",
                  "de": "Nur ein Gleichgewicht existiert in wiederholtem Spiel",
                  "nl": "Slechts één evenwicht bestaat in herhaald spel"
        },
        {
                  "en": "Cooperation sustainable via trigger strategies when players value future reputation (infinite horizon)",
                  "es": "Cooperación sostenible vía estrategias de gatillo cuando jugadores valoran reputación futura (horizonte infinito)",
                  "de": "Kooperation nachhaltig via Trigger-Strategien wenn Spieler zukünftige Reputation schätzen (unendlicher Horizont)",
                  "nl": "Samenwerking duurzaam via trigger strategieën wanneer spelers toekomstige reputatie waarderen (oneindige horizon)"
        },
        {
                  "en": "Folk Theorem only applies to zero-sum games",
                  "es": "Teorema Folk solo se aplica a juegos de suma cero",
                  "de": "Folk-Theorem gilt nur für Nullsummenspiele",
                  "nl": "Folk Theorema geldt alleen voor nul-som spellen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "All players always defect independently",
                  "es": "Todos los jugadores siempre desertan independientemente",
                  "de": "Alle Spieler desertieren immer unabhängig",
                  "nl": "Alle spelers altijd deserteren onafhankelijk"
        },
        {
                  "en": "Correlation forbidden in game theory",
                  "es": "Correlación prohibida en teoría de juegos",
                  "de": "Korrelation in Spieltheorie verboten",
                  "nl": "Correlatie verboden in speltheorie"
        },
        {
                  "en": "Players coordinate via public signal (e.g., dice roll) to select joint strategies yielding better outcomes than Nash",
                  "es": "Jugadores coordinan vía señal pública (ej., tirada de dados) para seleccionar estrategias conjuntas produciendo mejores resultados que Nash",
                  "de": "Spieler koordinieren via öffentliches Signal (z.B. Würfelwurf) um gemeinsame Strategien zu wählen die bessere Ergebnisse als Nash bringen",
                  "nl": "Spelers coördineren via publiek signaal (bijv. dobbelsteenworp) om gezamenlijke strategieën te selecteren die betere uitkomsten opleveren dan Nash"
        },
        {
                  "en": "Requires private communication only",
                  "es": "Requiere solo comunicación privada",
                  "de": "Erfordert nur private Kommunikation",
                  "nl": "Vereist alleen privé communicatie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Strategies that always dominate regardless of population",
                  "es": "Estrategias que siempre dominan independientemente de población",
                  "de": "Strategien die immer unabhängig von Population dominieren",
                  "nl": "Strategieën die altijd domineren ongeacht populatie"
        },
        {
                  "en": "Strategy that resists invasion by mutant strategies in tournament meta-game evolution",
                  "es": "Estrategia que resiste invasión por estrategias mutantes en evolución de meta-juego de torneo",
                  "de": "Strategie die Invasion durch Mutantenstrategien in Turnier-Meta-Spiel-Evolution widersteht",
                  "nl": "Strategie die invasie weerstaat door mutant strategieën in toernooi meta-spel evolutie"
        },
        {
                  "en": "ESS doesn't apply to discrete games",
                  "es": "ESS no se aplica a juegos discretos",
                  "de": "ESS gilt nicht für diskrete Spiele",
                  "nl": "ESS geldt niet voor discrete spellen"
        },
        {
                  "en": "Random strategy selection over time",
                  "es": "Selección de estrategia aleatoria con el tiempo",
                  "de": "Zufällige Strategieauswahl über Zeit",
                  "nl": "Willekeurige strategie selectie over tijd"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Minimize entropy in all cases",
                  "es": "Minimizar entropía en todos los casos",
                  "de": "Entropie in allen Fällen minimieren",
                  "nl": "Minimaliseer entropie in alle gevallen"
        },
        {
                  "en": "Entropy irrelevant to game theory",
                  "es": "Entropía irrelevante para teoría de juegos",
                  "de": "Entropie irrelevant für Spieltheorie",
                  "nl": "Entropie irrelevant voor speltheorie"
        },
        {
                  "en": "Always use deterministic pure strategies",
                  "es": "Siempre usar estrategias puras determinísticas",
                  "de": "Immer deterministische reine Strategien verwenden",
                  "nl": "Altijd deterministische pure strategieën gebruiken"
        },
        {
                  "en": "Choose strategy distribution maximizing unpredictability (entropy) subject to equilibrium constraints",
                  "es": "Elegir distribución de estrategia maximizando imprevisibilidad (entropía) sujeto a restricciones de equilibrio",
                  "de": "Strategieverteilung wählen maximiert Unvorhersehbarkeit (Entropie) unter Gleichgewichtsbeschränkungen",
                  "nl": "Kies strategie distributie maximaliseren onvoorspelbaarheid (entropie) onderworpen aan evenwichtsbeperkingen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Random rule generation",
                  "es": "Generación aleatoria de reglas",
                  "de": "Zufällige Regelerzeugung",
                  "nl": "Willekeurige regel generatie"
        },
        {
                  "en": "Design rules such that self-interested play yields desired outcomes (incentive compatibility)",
                  "es": "Diseñar reglas de modo que juego de interés propio produzca resultados deseados (compatibilidad de incentivos)",
                  "de": "Regeln so entwerfen dass eigennütziges Spiel gewünschte Ergebnisse bringt (Anreizkompatibilität)",
                  "nl": "Ontwerp regels zodat eigenbelang spel gewenste uitkomsten oplevert (incentive compatibiliteit)"
        },
        {
                  "en": "Copy rules from other games directly",
                  "es": "Copiar reglas de otros juegos directamente",
                  "de": "Regeln aus anderen Spielen direkt kopieren",
                  "nl": "Kopieer regels uit andere spellen direct"
        },
        {
                  "en": "Mechanism design doesn't apply to games",
                  "es": "Diseño de mecanismos no se aplica a juegos",
                  "de": "Mechanismus-Design gilt nicht für Spiele",
                  "nl": "Mechanisme ontwerp geldt niet voor spellen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Arbitrage principle doesn't apply to Catan",
                  "es": "Principio de arbitraje no se aplica a Catan",
                  "de": "Arbitrage-Prinzip gilt nicht für Catan",
                  "nl": "Arbitrage principe geldt niet voor Catan"
        },
        {
                  "en": "In equilibrium, no profitable trading cycles exist (prevents 'money pump' exploitation)",
                  "es": "En equilibrio, no existen ciclos de comercio rentables (previene explotación de 'bomba de dinero')",
                  "de": "Im Gleichgewicht existieren keine profitablen Handelszyklen (verhindert 'Geldpumpen'-Ausbeutung)",
                  "nl": "In evenwicht bestaan geen winstgevende handels cycli (voorkomt 'geldpomp' exploitatie)"
        },
        {
                  "en": "No trading allowed in equilibrium",
                  "es": "No se permite comercio en equilibrio",
                  "de": "Kein Handel im Gleichgewicht erlaubt",
                  "nl": "Geen handel toegestaan in evenwicht"
        },
        {
                  "en": "Arbitrage opportunities should always exist",
                  "es": "Oportunidades de arbitraje siempre deben existir",
                  "de": "Arbitrage-Möglichkeiten sollten immer existieren",
                  "nl": "Arbitrage mogelijkheden moeten altijd bestaan"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only 2-3 dimensions matter in Catan",
                  "es": "Solo 2-3 dimensiones importan en Catan",
                  "de": "Nur 2-3 Dimensionen zählen in Catan",
                  "nl": "Slechts 2-3 dimensies tellen in Catan"
        },
        {
                  "en": "State space grows exponentially with features (board positions × resources × cards × trade history)",
                  "es": "Espacio de estado crece exponencialmente con características (posiciones de tablero × recursos × cartas × historial de comercio)",
                  "de": "Zustandsraum wächst exponentiell mit Merkmalen (Brettpositionen × Ressourcen × Karten × Handelshistorie)",
                  "nl": "Toestandsruimte groeit exponentieel met kenmerken (bordposities × bronnen × kaarten × handelsgeschiedenis)"
        },
        {
                  "en": "Dimensionality doesn't affect AI performance",
                  "es": "La dimensionalidad no afecta rendimiento de IA",
                  "de": "Dimensionalität beeinflusst KI-Leistung nicht",
                  "nl": "Dimensionaliteit beïnvloedt AI prestatie niet"
        },
        {
                  "en": "State space remains constant always",
                  "es": "Espacio de estado permanece constante siempre",
                  "de": "Zustandsraum bleibt immer konstant",
                  "nl": "Toestandsruimte blijft altijd constant"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bandit problem doesn't apply to card games",
                  "es": "Problema de bandido no se aplica a juegos de cartas",
                  "de": "Banditenproblem gilt nicht für Kartenspiele",
                  "nl": "Bandit probleem geldt niet voor kaartspellen"
        },
        {
                  "en": "Only explore, never exploit knowledge",
                  "es": "Solo explorar, nunca explotar conocimiento",
                  "de": "Nur erkunden, nie Wissen ausbeuten",
                  "nl": "Alleen verkennen, nooit kennis exploiteren"
        },
        {
                  "en": "Always exploit without exploration",
                  "es": "Siempre explotar sin exploración",
                  "de": "Immer ausbeuten ohne Erkundung",
                  "nl": "Altijd exploiteren zonder verkenning"
        },
        {
                  "en": "Explore-exploit tradeoff: buy cards to learn deck composition vs exploit known information",
                  "es": "Compromiso explorar-explotar: comprar cartas para aprender composición del mazo vs explotar información conocida",
                  "de": "Erkunden-Ausbeuten-Kompromiss: Karten kaufen um Deck-Zusammensetzung zu lernen vs bekannte Information ausbeuten",
                  "nl": "Verkennen-exploiteren afweging: kaarten kopen om deck compositie te leren vs bekende informatie exploiteren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No curse exists in trading games",
                  "es": "No existe maldición en juegos de comercio",
                  "de": "Kein Fluch existiert in Handelsspielen",
                  "nl": "Geen vloek bestaat in handelsspellen"
        },
        {
                  "en": "Winners always get optimal value",
                  "es": "Ganadores siempre obtienen valor óptimo",
                  "de": "Gewinner bekommen immer optimalen Wert",
                  "nl": "Winnaars krijgen altijd optimale waarde"
        },
        {
                  "en": "Winner likely overpaid because winning signals you valued resource more than all others (adverse selection)",
                  "es": "Ganador probablemente pagó de más porque ganar señala que valoraste recurso más que todos los demás (selección adversa)",
                  "de": "Gewinner hat wahrscheinlich zu viel bezahlt weil Gewinnen signalisiert man schätzte Ressource mehr als alle anderen (adverse Selektion)",
                  "nl": "Winnaar heeft waarschijnlijk teveel betaald omdat winnen signaleert je waardeerde bron meer dan alle anderen (adverse selectie)"
        },
        {
                  "en": "Losers are always worse off",
                  "es": "Perdedores siempre están peor",
                  "de": "Verlierer sind immer schlechter dran",
                  "nl": "Verliezers zijn altijd slechter af"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cyclic preferences: majority prefers A>B, B>C, C>A (no consistent group preference)",
                  "es": "Preferencias cíclicas: mayoría prefiere A>B, B>C, C>A (sin preferencia grupal consistente)",
                  "de": "Zyklische Präferenzen: Mehrheit bevorzugt A>B, B>C, C>A (keine konsistente Gruppenpräferenz)",
                  "nl": "Cyclische voorkeuren: meerderheid verkiest A>B, B>C, C>A (geen consistente groepsvoorkeur)"
        },
        {
                  "en": "Voting impossible in Catan",
                  "es": "Votación imposible en Catan",
                  "de": "Abstimmung unmöglich in Catan",
                  "nl": "Stemmen onmogelijk in Catan"
        },
        {
                  "en": "Condorcet paradox only applies to elections",
                  "es": "Paradoja de Condorcet solo se aplica a elecciones",
                  "de": "Condorcet-Paradoxon gilt nur für Wahlen",
                  "nl": "Condorcet paradox geldt alleen voor verkiezingen"
        },
        {
                  "en": "All players always agree on preferences",
                  "es": "Todos los jugadores siempre están de acuerdo en preferencias",
                  "de": "Alle Spieler stimmen immer bei Präferenzen überein",
                  "nl": "Alle spelers zijn het altijd eens over voorkeuren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Principal-agent problem doesn't exist in games",
                  "es": "Problema de principal-agente no existe en juegos",
                  "de": "Prinzipal-Agent-Problem existiert nicht in Spielen",
                  "nl": "Principaal-agent probleem bestaat niet in spellen"
        },
        {
                  "en": "All coalition members always cooperate perfectly",
                  "es": "Todos los miembros de coalición siempre cooperan perfectamente",
                  "de": "Alle Koalitionsmitglieder kooperieren immer perfekt",
                  "nl": "Alle coalitie leden werken altijd perfect samen"
        },
        {
                  "en": "Incentives always perfectly aligned",
                  "es": "Incentivos siempre perfectamente alineados",
                  "de": "Anreize immer perfekt ausgerichtet",
                  "nl": "Incentives altijd perfect uitgelijnd"
        },
        {
                  "en": "Misaligned incentives: coalition partner may pursue own victory instead of blocking leader",
                  "es": "Incentivos desalineados: socio de coalición puede perseguir propia victoria en lugar de bloquear líder",
                  "de": "Fehlausgerichtete Anreize: Koalitionspartner kann eigenen Sieg verfolgen statt Anführer zu blockieren",
                  "nl": "Verkeerd uitgelijnde incentives: coalitie partner kan eigen overwinning nastreven in plaats van leider blokkeren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Screening: offer trades to elicit opponent information; Signaling: opponent reveals info through actions",
                  "es": "Cribado: ofrecer intercambios para obtener información del oponente; Señalización: oponente revela info a través de acciones",
                  "de": "Screening: Geschäfte anbieten um Gegnerinformation zu ermitteln; Signalisierung: Gegner offenbart Info durch Aktionen",
                  "nl": "Screening: ruilen aanbieden om tegenstander informatie te verkrijgen; Signalering: tegenstander onthult info door acties"
        },
        {
                  "en": "No information exchange possible in Catan",
                  "es": "No es posible intercambio de información en Catan",
                  "de": "Kein Informationsaustausch in Catan möglich",
                  "nl": "Geen informatie uitwisseling mogelijk in Catan"
        },
        {
                  "en": "Screening and signaling are identical concepts",
                  "es": "Cribado y señalización son conceptos idénticos",
                  "de": "Screening und Signalisierung sind identische Konzepte",
                  "nl": "Screening en signalering zijn identieke concepten"
        },
        {
                  "en": "All information always hidden perfectly",
                  "es": "Toda información siempre oculta perfectamente",
                  "de": "Alle Information immer perfekt versteckt",
                  "nl": "Alle informatie altijd perfect verborgen"
        }
        ],
        correct: 0,
        explanation: {
