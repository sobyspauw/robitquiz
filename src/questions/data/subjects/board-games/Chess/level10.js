    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "A sharp system with f7-f5 and central tension",
                  "es": "Un sistema agudo con f7-f5 y tensión central",
                  "de": "Ein scharfes System mit f7-f5 und zentraler Spannung",
                  "nl": "Een scherp systeem met f7-f5 en centrale spanning"
        },
        {
                  "en": "A quiet positional setup",
                  "es": "Una configuración posicional tranquila",
                  "de": "Eine ruhige positionelle Aufstellung",
                  "nl": "Een rustige positionele opstelling"
        },
        {
        ...
        {
                  "en": "A gambit with early pawn sacrifice",
                  "es": "Un gambito con sacrificio de peón temprano",
                  "de": "Ein Gambit mit frühem Bauernopfer",
                  "nl": "Een gambiet met vroeg pionoffer"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only sacrificing with guaranteed compensation",
                  "es": "Solo sacrificar con compensación garantizada",
                  "de": "Nur mit garantierter Kompensation opfern",
                  "nl": "Alleen offeren met gegarandeerde compensatie"
        },
        {
                  "en": "Never sacrificing without calculation",
                  "es": "Nunca sacrificar sin cálculo",
                  "de": "Niemals ohne Berechnung opfern",
                  "nl": "Nooit offeren zonder berekening"
        },
        {
                  "en": "Sacrificing material based on practical complications rather than concrete calculation",
                  "es": "Sacrificar material basado en complicaciones prácticas en lugar de cálculo concreto",
                  "de": "Material opfern basierend auf praktischen Komplikationen statt konkreter Berechnung",
                  "nl": "Materiaal offeren gebaseerd op praktische complicaties in plaats van concrete berekening"
        },
        {
                  "en": "Sacrificing for positional gains only",
                  "es": "Sacrificar solo por ganancias posicionales",
                  "de": "Nur für positionelle Gewinne opfern",
                  "nl": "Alleen offeren voor positionele winst"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Control the center with pawns",
                  "es": "Controlar el centro con peones",
                  "de": "Das Zentrum mit Bauern kontrollieren",
                  "nl": "Het centrum met pionnen controleren"
        },
        {
                  "en": "Build a solid pawn chain",
                  "es": "Construir una cadena de peones sólida",
                  "de": "Eine solide Bauernkette aufbauen",
                  "nl": "Een solide pionketen bouwen"
        },
        {
                  "en": "Allow White's pawn center to attack it with pieces",
                  "es": "Permitir el centro de peones de las blancas para atacarlo con piezas",
                  "de": "Weiß' Bauernzentrum zulassen um es mit Figuren anzugreifen",
                  "nl": "Wit's pioncentrum toestaan om het met stukken aan te vallen"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using fewer pawns to attack more pawns creating weaknesses",
                  "es": "Usar menos peones para atacar más peones creando debilidades",
                  "de": "Weniger Bauern verwenden um mehr Bauern anzugreifen und Schwächen zu schaffen",
        ...
        {
                  "en": "Trading pieces when behind in material",
                  "es": "Intercambiar piezas cuando se está atrás en material",
                  "de": "Figuren tauschen wenn materiell hinten",
                  "nl": "Stukken ruilen bij materieel achterstand"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Make small moves only",
                  "es": "Hacer solo movimientos pequeños",
                  "de": "Nur kleine Züge machen",
                  "nl": "Alleen kleine zetten maken"
        },
        {
                  "en": "Win small amounts of material",
                  "es": "Ganar pequeñas cantidades de material",
                  "de": "Kleine Materialmengen gewinnen",
                  "nl": "Kleine hoeveelheden materiaal winnen"
        },
        {
                  "en": "Build multiple small positional advantages before attacking",
                  "es": "Construir múltiples ventajas posicionales pequeñas antes de atacar",
                  "de": "Mehrere kleine positionelle Vorteile aufbauen vor dem Angriff",
                  "nl": "Meerdere kleine positionele voordelen opbouwen voor aanvallen"
        },
        {
                  "en": "Attack immediately with any advantage",
                  "es": "Atacar inmediatamente con cualquier ventaja",
                  "de": "Sofort mit jedem Vorteil angreifen",
                  "nl": "Onmiddellijk aanvallen met elk voordeel"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A central pawn break",
                  "es": "Una ruptura de peón central",
                  "de": "Ein zentraler Bauerndurchbruch",
                  "nl": "Een centrale piondoorbraak"
        },
        {
                  "en": "White's aggressive setup against the Dragon with opposite-side castling",
                  "es": "Configuración agresiva de las blancas contra el Dragón con enroques en lados opuestos",
                  "de": "Weiß' aggressive Aufstellung gegen den Drachen mit gegenüberliegenden Rochaden",
                  "nl": "Wit's agressieve opstelling tegen de Draak met tegenovergestelde rokades"
        },
        {
        ...
        {
                  "en": "A kingside fianchetto",
                  "es": "Un fianchetto de rey",
                  "de": "Ein Königsseiten-Fianchetto",
                  "nl": "Een koningszijde fianchetto"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Controlling the center only",
                  "es": "Controlar solo el centro",
                  "de": "Nur das Zentrum kontrollieren",
                  "nl": "Alleen het centrum controleren"
        },
        {
                  "en": "Playing faster moves",
                  "es": "Jugar movimientos más rápidos",
                  "de": "Schnellere Züge spielen",
                  "nl": "Snellere zetten spelen"
        },
        {
                  "en": "Controlling more territory, restricting opponent's piece mobility",
                  "es": "Controlar más territorio, restringiendo la movilidad de las piezas del oponente",
                  "de": "Mehr Territorium kontrollieren, die Beweglichkeit der gegnerischen Figuren einschränken",
                  "nl": "Meer territorium controleren, mobiliteit van stukken van de tegenstander beperken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "A queen's pawn opening",
                  "es": "Una apertura de peón de dama",
                  "de": "Eine Damenbauer-Eröffnung",
                  "nl": "Een damepionopening"
        },
        {
                  "en": "A fianchetto system",
                  "es": "Un sistema de fianchetto",
                  "de": "Ein Fianchetto-System",
                  "nl": "Een fianchettosysteem"
        },
        {
                  "en": "1.e4 Nc6, developing the knight before pawns",
                  "es": "1.e4 Cc6, desarrollando el caballo antes que los peones",
                  "de": "1.e4 Sc6, Entwicklung des Springers vor den Bauern",
                  "nl": "1.e4 Pc6, het paard ontwikkelen vóór de pionnen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Multiple checks in succession",
                  "es": "Múltiples jaques en sucesión",
                  "de": "Mehrere Schachs hintereinander",
                  "nl": "Meerdere schaken achter elkaar"
        },
        {
                  "en": "Checking the king permanently",
                  "es": "Dar jaque al rey permanentemente",
                  "de": "Den König permanent schachbieten",
                  "nl": "De koning permanent schaak geven"
        },
        {
        ...
        {
                  "en": "Repeating checks forcing a draw by threefold repetition",
                  "es": "Repetir jaques forzando tablas por repetición triple",
                  "de": "Wiederholte Schachs, die ein Remis durch dreifache Stellungswiederholung erzwingen",
                  "nl": "Herhaalde schaken die remise forceren door drievoudige herhaling"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Eine geschlossene Verteidigung",
                  "nl": "Een gesloten verdediging"
        },
        {
                  "en": "An asymmetrical defense with ...c5 against d4, creating imbalanced positions",
                  "es": "Una defensa asimétrica con ...c5 contra d4, creando posiciones desequilibradas",
                  "de": "Eine asymmetrische Verteidigung mit ...c5 gegen d4, die unausgeglichene Stellungen schafft",
                  "nl": "Een asymmetrische verdediging met ...c5 tegen d4, waardoor ongebalanceerde posities ontstaan"
        },
        {
                  "en": "A gambit line",
                  "es": "Una línea de gambito",
                  "de": "Eine Gambit-Linie",
                  "nl": "Een gambietlijn"
        },
        {
                  "en": "A symmetrical defense",
                  "es": "Una defensa simétrica",
                  "de": "Eine symmetrische Verteidigung",
                  "nl": "Een symmetrische verdediging"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Capturing all opponent's pieces",
        ...
        {
                  "en": "Moving a piece away to clear a square or line for another piece",
                  "es": "Mover una pieza para despejar una casilla o línea para otra pieza",
                  "de": "Eine Figur wegbewegen, um ein Feld oder eine Linie für eine andere Figur freizumachen",
                  "nl": "Een stuk wegbewegen om een veld of rij vrij te maken voor een ander stuk"
        },
        {
                  "en": "Opening up the center",
                  "es": "Abrir el centro",
                  "de": "Das Zentrum öffnen",
                  "nl": "Het centrum openen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "An open game",
                  "es": "Un juego abierto",
                  "de": "Ein offenes Spiel",
                  "nl": "Een open spel"
        },
        {
                  "en": "A hypermodern defense",
                  "es": "Una defensa hipermoderna",
                  "de": "Eine hypermoderne Verteidigung",
                  "nl": "Een hypermoderne verdediging"
        },
        {
                  "en": "A gambit opening",
                  "es": "Una apertura de gambito",
                  "de": "Eine Gambit-Eröffnung",
                  "nl": "Een gambiet opening"
        },
        {
                  "en": "1.e4 e6, preparing ...d5 while accepting a potentially bad bishop",
                  "es": "1.e4 e6, preparando ...d5 mientras acepta un alfil potencialmente malo",
                  "de": "1.e4 e6, bereitet ...d5 vor, während ein potenziell schlechter Läufer akzeptiert wird",
                  "nl": "1.e4 e6, voorbereidend ...d5 terwijl een mogelijk slechte loper wordt geaccepteerd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Having seven or more pawns",
                  "es": "Tener siete o más peones",
                  "de": "Sieben oder mehr Bauern haben",
                  "nl": "Zeven of meer pionnen hebben"
        },
        {
                  "en": "Having more pawns on one side of the board than the opponent",
                  "es": "Tener más peones en un lado del tablero que el oponente",
                  "de": "Mehr Bauern auf einer Seite des Bretts haben als der Gegner",
                  "nl": "Meer pionnen aan één kant van het bord hebben dan de tegenstander"
        },
        {
                  "en": "Advancing all pawns",
                  "es": "Avanzar todos los peones",
                  "de": "Alle Bauern vorschieben",
                  "nl": "Alle pionnen opschuiven"
        },
        {
                  "en": "Having most pawns in the center",
                  "es": "Tener la mayoría de peones en el centro",
                  "de": "Die meisten Bauern im Zentrum haben",
                  "nl": "De meeste pionnen in het centrum hebben"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A king's pawn opening",
                  "es": "Una apertura de peón de rey",
                  "de": "Eine Königsbauer-Eröffnung",
                  "nl": "Een koningspionopening"
        },
        {
                  "en": "A solid d4 system with e3, Bd3, and Nbd2",
                  "es": "Un sistema sólido d4 con e3, Ad3 y Cbd2",
                  "de": "Ein solides d4-System mit e3, Ld3 und Sbd2",
                  "nl": "Een solide d4-systeem met e3, Ld3 en Pbd2"
        },
        {
        ...
        {
                  "en": "A hypermodern opening",
                  "es": "Una apertura hipermoderna",
                  "de": "Eine hypermoderne Eröffnung",
                  "nl": "Een hypermoderne opening"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Failing to promote",
                  "es": "No lograr promocionar",
                  "de": "Nicht umwandeln können",
                  "nl": "Niet kunnen promoveren"
        },
        {
        ...
        },
        {
                  ...
                  "es": "Promocionar un peón a una pieza que no sea dama",
      ...
      },
      {
        ...
        {
                  "en": "1.d4 Nf6 2.Bg5, challenging Black's knight early",
                  "es": "1.d4 Cf6 2.Ag5, desafiando el caballo de las negras temprano",
                  "de": "1.d4 Sf6 2.Lg5, frühes Herausfordern von Schwarz' Springer",
                  "nl": "1.d4 Pf6 2.Lg5, vroeg zwart's paard uitdagen"
        },
        {
                  "en": "A queen's gambit line",
                  "es": "Una línea del gambito de dama",
                  "de": "Eine Damengambit-Linie",
                  "nl": "Een damegambiet lijn"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Promising moves worth considering and calculating in a position",
                  "es": "Movimientos prometedores que vale la pena considerar y calcular en una posición",
                  "de": "Vielversprechende Züge, die es wert sind, in einer Stellung in Betracht gezogen und berechnet zu werden",
                  "nl": "Veelbelovende zetten die het waard zijn om te overwegen en te berekenen in een positie"
        },
        {
                  "en": "Any legal move",
                  "es": "Cualquier movimiento legal",
                  "de": "Jeder legale Zug",
                  "nl": "Elke legale zet"
        },
        {
                  "en": "A move leading to promotion",
                  "es": "Un movimiento que lleva a la promoción",
                  "de": "Ein Zug, der zur Umwandlung führt",
                  "nl": "Een zet die leidt tot promotie"
        },
        {
                  "en": "The best move in the position",
                  "es": "El mejor movimiento en la posición",
                  "de": "Der beste Zug in der Stellung",
                  "nl": "De beste zet in de positie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "A solid positional setup",
                  "es": "Una configuración posicional sólida",
                  "de": "Eine solide positionelle Aufstellung",
                  "nl": "Een solide positionele opstelling"
        },
        {
                  "en": "A queen's pawn opening",
                  "es": "Una apertura de peón de dama",
        ...
        {
                  "en": "1.d4 Nf6 2.c4 e5, sacrificing a pawn for quick development",
                  "es": "1.d4 Cf6 2.c4 e5, sacrificando un peón por desarrollo rápido",
                  "de": "1.d4 Sf6 2.c4 e5, Opfern eines Bauern für schnelle Entwicklung",
                  "nl": "1.d4 Pf6 2.c4 e5, een pion offeren voor snelle ontwikkeling"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Moving without sound",
                  "es": "Moverse sin sonido",
                  "de": "Sich ohne Geräusch bewegen",
                  "nl": "Bewegen zonder geluid"
        },
        {
                  "en": "A defensive move",
        ...
        {
                  "en": "A non-forcing move that doesn't check, capture, or threaten",
                  "es": "Un movimiento no forzado que no da jaque, captura o amenaza",
                  "de": "Ein nicht erzwingender Zug, der nicht schach bietet, schlägt oder droht",
                  "nl": "Een niet-forcerende zet die niet schaak geeft, slaat of dreigt"
        },
        {
                  "en": "A silent chess tournament",
                  "es": "Un torneo de ajedrez silencioso",
                  "de": "Ein stilles Schachturnier",
                  "nl": "Een stil schaaktoernooi"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "White trades bishop for knight with Bxc6, doubling Black's pawns",
                  "es": "Las blancas intercambian alfil por caballo con Axc6, doblando los peones de las negras",
                  "de": "Weiß tauscht Läufer gegen Springer mit Lxc6 und verdoppelt Schwarz' Bauern",
                  "nl": "Wit ruilt loper voor paard met Lxc6, waardoor zwart's pionnen worden verdubbeld"
        },
        {
                  "en": "Trading queens early",
                  "es": "Intercambiar damas temprano",
                  "de": "Früher Damentausch",
                  "nl": "Vroeg dames ruilen"
        },
        {
                  "en": "An open variation",
                  "es": "Una variación abierta",
                  "de": "Eine offene Variante",
                  "nl": "Een open variant"
        },
        {
                  "en": "A gambit line",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A fundamental rook-pawn endgame winning technique",
                  "es": "Una técnica ganadora fundamental de final de torre y peón",
                  "de": "Eine fundamentale Gewinn-Technik im Turm-Bauern-Endspiel",
                  "nl": "Een fundamentele winnende techniek in toren-pion eindspel"
        },
        {
                  "en": "A pawn structure",
        ...
        {
                  "en": "A tactical motif",
                  "es": "Un motivo táctico",
                  "de": "Ein taktisches Motiv",
                  "nl": "Een tactisch motief"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "An attacking setup",
                  "es": "Una configuración de ataque",
                  "de": "Eine Angriffs-Aufstellung",
                  "nl": "Een aanvalsopstelling"
        },
        {
                  "en": "A king maneuver",
                  "es": "Una maniobra del rey",
                  "de": "Ein König-Manöver",
                  "nl": "Een koningsmanoeuvre"
        },
        {
        ...
        {
                  "en": "A defensive rook endgame technique where the rook stays on the third rank",
                  "es": "Una técnica defensiva de final de torre donde la torre permanece en la tercera fila",
                  "de": "Eine defensive Turm-Endspiel-Technik, bei der der Turm auf der dritten Reihe bleibt",
                  "nl": "Een defensieve toren eindspel techniek waarbij de toren op de derde rij blijft"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "3...d6, the Steinitz Defense",
                  "es": "3...d6, la Defensa Steinitz",
                  "de": "3...d6, die Steinitz-Verteidigung",
                  "nl": "3...d6, de Steinitz Verdediging"
        },
        {
                  "en": "3...Bc5, the classical line",
                  "es": "3...Ac5, la línea clásica",
                  "de": "3...Lc5, die klassische Linie",
                  "nl": "3...Lc5, de klassieke lijn"
        },
        {
                  "en": "3...a6, the main line",
                  "es": "3...a6, la línea principal",
                  "de": "3...a6, die Hauptlinie",
                  "nl": "3...a6, de hoofdlijn"
        },
        {
                  "en": "3...Nf6, a solid defense often leading to an endgame",
                  "es": "3...Cf6, una defensa sólida que a menudo lleva a un final",
                  "de": "3...Sf6, eine solide Verteidigung, die oft zu einem Endspiel führt",
                  "nl": "3...Pf6, een solide verdediging die vaak leidt tot een eindspel"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Doubled bishops on a diagonal",
                  "es": "Alfiles doblados en una diagonal",
                  "de": "Verdoppelte Läufer auf einer Diagonale",
                  "nl": "Verdubbelde lopers op een diagonaal"
        },
        {
                  "en": "Queen and two rooks aligned on the same file or rank",
                  "es": "Dama y dos torres alineadas en la misma columna o fila",
                  "de": "Dame und zwei Türme auf derselben Linie oder Reihe ausgerichtet",
                  "nl": "Dame en twee torens uitgelijnd op dezelfde lijn of rij"
        },
        {
                  "en": "A pawn chain formation",
                  "es": "Una formación de cadena de peones",
                  "de": "Eine Bauernketten-Formation",
                  "nl": "Een pioncadeau formatie"
        },
        {
                  "en": "Three knights positioned together",
                  "es": "Tres caballos posicionados juntos",
                  "de": "Drei Springer zusammen positioniert",
                  "nl": "Drie paarden samen gepositioneerd"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "1.d4 d5 2.c4 e6 3.Nc3 c5, fighting for central control",
                  "es": "1.d4 d5 2.c4 e6 3.Cc3 c5, luchando por control central",
                  "de": "1.d4 d5 2.c4 e6 3.Sc3 c5, kämpft um zentrale Kontrolle",
                  "nl": "1.d4 d5 2.c4 e6 3.Pc3 c5, vechtend voor centrale controle"
        },
        {
                  "en": "A fianchetto system",
                  "es": "Un sistema de fianchetto",
        ...
        {
                  "en": "A king's gambit line",
                  "es": "Una línea del gambito de rey",
                  "de": "Eine Königsgambit-Linie",
                  "nl": "Een koningsgambiet lijn"
        },
        {
                  "en": "A Sicilian variation",
                  "es": "Una variación siciliana",
                  "de": "Eine sizilianische Variante",
                  "nl": "Een Siciliaanse variatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Preventing opponent's plans before they can be executed",
                  ...
                  "nl": "Plannen van tegenstander voorkomen voordat ze kunnen worden uitgevoerd"
        },
        {
                  "en": "Planning your own strategy",
                  "es": "Planificar tu propia estrategia",
                  "de": "Die eigene Strategie planen",
                  "nl": "Je eigen strategie plannen"
        },
        {
        ...
        {
                  "en": "Calculating variations",
                  "es": "Calcular variaciones",
                  "de": "Varianten berechnen",
                  "nl": "Variaties berekenen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "nl": "Een agressieve pionstorm"
        },
        {
                  "en": "A flexible defensive setup with pawns on a6, b6, d6, e6",
                  "es": "Una configuración defensiva flexible con peones en a6, b6, d6, e6",
                  "de": "Eine flexible defensive Aufstellung mit Bauern auf a6, b6, d6, e6",
                  "nl": "Een flexibele defensieve opstelling met pionnen op a6, b6, d6, e6"
        },
        {
                  "en": "A king's gambit line",
                  "es": "Una línea del gambito de rey",
        ...
        {
                  "en": "A rook endgame technique",
                  "es": "Una técnica de final de torre",
                  "de": "Eine Turm-Endspiel-Technik",
                  "nl": "Een toren eindspel techniek"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "1.d4 Nf6 2.c4 e6 3.Nc3 Bb4, pinning the knight",
                  "es": "1.d4 Cf6 2.c4 e6 3.Cc3 Ab4, clavando el caballo",
                  "de": "1.d4 Sf6 2.c4 e6 3.Sc3 Lb4, fesselt den Springer",
                  "nl": "1.d4 Pf6 2.c4 e6 3.Pc3 Lb4, spijkerend het paard"
        },
        {
                  "en": "A king's gambit variation",
                  "es": "Una variación del gambito de rey",
                  "de": "Eine Königsgambit-Variante",
                  "nl": "Een koningsgambiet variatie"
        },
        {
                  "en": "A closed Sicilian line",
                  "es": "Una línea siciliana cerrada",
                  "de": "Eine geschlossene sizilianische Linie",
                  "nl": "Een gesloten Siciliaanse lijn"
        },
        {
                  "en": "A rook endgame setup",
                  "es": "Una configuración de final de torre",
                  "de": "Eine Turm-Endspiel-Aufstellung",
                  "nl": "Een toren eindspel opstelling"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Protected king position",
                  "es": "Posición de rey protegida",
                  "de": "Geschützte König-Position",
                  "nl": "Beschermde koningspositie"
        },
        {
                  "en": "A strong pawn chain",
                  "es": "Una cadena de peones fuerte",
                  "de": "Eine starke Bauernkette",
                  "nl": "Een sterke pioncadeau"
        },
        {
                  "en": "Castling kingside",
                  "es": "Enroque corto",
                  "de": "Kurze Rochade",
                  "nl": "Korte rokade"
        },
        {
                  "en": "A defensive setup that prevents the opponent from winning despite material advantage",
                  "es": "Una configuración defensiva que impide que el oponente gane a pesar de ventaja material",
                  "de": "Eine defensive Aufstellung, die den Gegner trotz materiellem Vorteil am Gewinnen hindert",
                  "nl": "Een defensieve opstelling die voorkomt dat de tegenstander wint ondanks materieel voordeel"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "1.d4 Nf6 2.c4 e6 3.Nf3 b6, fianchettoing the queenside bishop",
                  "es": "1.d4 Cf6 2.c4 e6 3.Cf3 b6, fianchetto del alfil del flanco de dama",
                  "de": "1.d4 Sf6 2.c4 e6 3.Sf3 b6, Fianchetto des Damenflügel-Läufers",
                  "nl": "1.d4 Pf6 2.c4 e6 3.Pf3 b6, fianchetto van de damezijde loper"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Moving the king frequently",
                  "es": "Mover el rey frecuentemente",
                  "de": "Den König häufig bewegen",
                  "nl": "De koning vaak bewegen"
        },
        {
                  "en": "Castling the king",
                  "es": "Enrocar el rey",
                  "de": "Den König rochieren",
                  "nl": "De koning rokeren"
        },
        {
        ...
        {
                  "en": "The king's ability to participate actively in the endgame fight",
                  "es": "La capacidad del rey de participar activamente en la lucha del final",
                  "de": "Die Fähigkeit des Königs, aktiv am Endspielkampf teilzunehmen",
                  "nl": "Het vermogen van de koning om actief deel te nemen aan de eindspelstrijd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "3...Bb4, pinning the knight and creating sharp complications",
                  "es": "3...Ab4, clavando el caballo y creando complicaciones agudas",
                  "de": "3...Lb4, fesselt den Springer und schafft scharfe Komplikationen",
                  "nl": "3...Lb4, spijkerend het paard en creërend scherpe complicaties"
        },
        {
                  "en": "3...dxe4, the Rubinstein",
                  "es": "3...dxe4, el Rubinstein",
                  "de": "3...dxe4, die Rubinstein",
                  "nl": "3...dxe4, de Rubinstein"
        },
        {
                  "en": "3...Nf6, the classical variation",
                  "es": "3...Cf6, la variación clásica",
                  "de": "3...Sf6, die klassische Variante",
                  "nl": "3...Pf6, de klassieke variatie"
        },
        {
                  "en": "3...c5, the Tarrasch",
                  "es": "3...c5, el Tarrasch",
                  "de": "3...c5, die Tarrasch",
                  "nl": "3...c5, de Tarrasch"
        }
        ],
        correct: 0,
      ...
      },
      {
        ...
        {
                  "en": "When a piece traps or severely restricts an opponent's piece",
                  "es": "Cuando una pieza atrapa o restringe severamente una pieza del oponente",
                  "de": "Wenn eine Figur eine gegnerische Figur einfängt oder stark einschränkt",
                  "nl": "Wanneer een stuk een stuk van de tegenstander vasthoudt of ernstig beperkt"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "1.e4 d5, immediately challenging White's center pawn",
                  "es": "1.e4 d5, desafiando inmediatamente el peón central de las blancas",
                  "de": "1.e4 d5, fordert sofort Weiß' Zentralbauern heraus",
                  "nl": "1.e4 d5, onmiddellijk wit's centrale pion uitdagen"
        },
        {
                  "en": "A queen's pawn opening",
                  "es": "Una apertura de peón de dama",
                  "de": "Eine Damenbauern-Eröffnung",
                  "nl": "Een damepionopening"
        }
        ],
        correct: 2,
      ...
      },
      {
        ...
        {
                  "en": "An in-between move that creates a threat before the expected recapture",
                  "es": "Un movimiento intermedio que crea una amenaza antes de la recaptura esperada",
                  "de": "Ein Zwischenzug, der eine Drohung schafft vor der erwarteten Rückeroberung",
                  "nl": "Een tussenzet die een dreiging creëert voor de verwachte terugslag"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "A setup with pawns on d4, e3, f4, c3 forming a solid structure",
                  "es": "Una configuración con peones en d4, e3, f4, c3 formando una estructura sólida",
                  "de": "Eine Aufstellung mit Bauern auf d4, e3, f4, c3, die eine solide Struktur bilden",
                  "nl": "Een opstelling met pionnen op d4, e3, f4, c3 die een solide structuur vormen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Permanent weaknesses can't be fixed (bad pawns), temporary ones can be remedied",
                  "es": "Las debilidades permanentes no se pueden arreglar (peones malos), las temporales pueden remediarse",
                  "de": "Permanente Schwächen können nicht behoben werden (schlechte Bauern), temporäre schon",
                  "nl": "Permanente zwakheden kunnen niet worden verholpen (slechte pionnen), tijdelijke wel"
        },
        {
                  "en": "Temporary means one move, permanent means two",
                  "es": "Temporal significa un movimiento, permanente significa dos",
                  "de": "Temporär bedeutet ein Zug, permanent bedeutet zwei",
                  "nl": "Tijdelijk betekent één zet, permanent betekent twee"
        },
        {
                  "en": "All weaknesses are permanent",
                  "es": "Todas las debilidades son permanentes",
                  "de": "Alle Schwächen sind permanent",
                  "nl": "Alle zwakheden zijn permanent"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "1.e4 e5 2.Nf3 Nf6, counterattacking the e4-pawn",
                  "es": "1.e4 e5 2.Cf3 Cf6, contraatacando el peón e4",
                  "de": "1.e4 e5 2.Sf3 Sf6, greift den e4-Bauern an",
                  "nl": "1.e4 e5 2.Pf3 Pf6, tegenaanval op de e4-pion"
        },
        {
                  "en": "A gambit opening",
                  "es": "Una apertura de gambito",
                  "de": "Eine Gambit-Eröffnung",
                  "nl": "Een gambietopening"
        },
        {
                  "en": "A queen's pawn opening",
                  "es": "Una apertura de peón de dama",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Passed pawns only matter on the 7th rank",
                  "es": "Los peones pasados solo importan en la séptima fila",
                  "de": "Freibauern zählen nur auf der 7. Reihe",
                  "nl": "Vrijpionnen tellen alleen op de 7e rij"
        },
        {
                  "en": "Passed pawns increase in value as they advance and kings are removed",
                  "es": "Los peones pasados aumentan de valor a medida que avanzan y los reyes se alejan",
                  "de": "Freibauern steigen im Wert, je weiter sie vorrücken und Könige entfernt sind",
                  "nl": "Vrijpionnen stijgen in waarde naarmate ze oprukken en koningen verwijderd zijn"
        },
        {
                  "en": "Passed pawns are weak",
                  "es": "Los peones pasados son débiles",
                  "de": "Freibauern sind schwach",
                  "nl": "Vrijpionnen zijn zwak"
        },
        {
                  "en": "All passed pawns have equal value",
                  "es": "Todos los peones pasados tienen igual valor",
                  "de": "Alle Freibauern haben gleichen Wert",
                  "nl": "Alle vrijpionnen hebben gelijke waarde"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Preventing opponent's plans before executing your own plans",
                  "es": "Prevenir los planes del oponente antes de ejecutar tus propios planes",
                  "de": "Die Pläne des Gegners verhindern, bevor man eigene Pläne ausführt",
                  "nl": "De plannen van de tegenstander voorkomen voordat je je eigen plannen uitvoert"
        },
        {
                  "en": "Always attacking the center",
                  "es": "Siempre atacar el centro",
                  "de": "Immer das Zentrum angreifen",
                  "nl": "Altijd het centrum aanvallen"
        },
        {
                  "en": "Trading pieces when ahead",
                  "es": "Intercambiar piezas cuando se está adelante",
                  "de": "Figuren tauschen wenn vorne",
                  "nl": "Stukken ruilen wanneer vooruit"
        },
        {
                  "en": "Developing pieces quickly",
                  "es": "Desarrollar piezas rápidamente",
                  "de": "Figuren schnell entwickeln",
                  "nl": "Stukken snel ontwikkelen"
        }
        ],
        correct: 0,
        explanation: {
