    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Making duplicate points",
                  "es": "Hacer puntos duplicados",
                  "de": "Doppelte Punkte machen",
                  "nl": "Dubbele punten maken"
        },
        {
                  "en": "Double roll strategy",
                  "es": "Estrategia de doble tirada",
                  "de": "Doppelwurf-Strategie",
                  "nl": "Dubbele worp strategie"
        },
        {
                  "en": "Two checker stacks",
                  "es": "Dos pilas de fichas",
                  "de": "Zwei Steinstapel",
                  "nl": "Twee steenstapels"
        },
        {
                  "en": "Positioning so opponent needs same numbers for multiple tasks",
                  "es": "Posicionar para que el oponente necesite los mismos números para múltiples tareas",
                  "de": "Positionieren damit Gegner dieselben Zahlen für mehrere Aufgaben benötigt",
                  "nl": "Positioneren zodat tegenstander dezelfde nummers nodig heeft voor meerdere taken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "When behind",
                  "es": "Cuando estás atrás",
                  "de": "Wenn Sie hinten liegen",
                  "nl": "Wanneer achter"
        },
        {
                  "en": "When exactly equal",
                  "es": "Cuando están exactamente iguales",
                  "de": "Wenn genau gleich",
                  "nl": "Wanneer exact gelijk"
        },
        {
                  "en": "When ahead by about 8-10% in pip count",
                  "es": "Cuando estás adelante por aproximadamente 8-10% en conteo de pips",
                  "de": "Wenn Sie etwa 8-10% im Pip-Count vorne liegen",
                  "nl": "Wanneer je ongeveer 8-10% voorligt in pip count"
        },
        {
                  "en": "Never double in races",
                  "es": "Nunca doblar en carreras",
                  "de": "Niemals in Rennen verdoppeln",
                  "nl": "Nooit verdubbelen in races"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Different game variants",
                  "es": "Diferentes variantes de juego",
                  "de": "Verschiedene Spielvarianten",
                  "nl": "Verschillende spelvarianten"
        },
        {
                  "en": "Checker play: moving pieces; Cube play: doubling decisions",
                  "es": "Juego de fichas: mover piezas; Juego de cubo: decisiones de doblaje",
                  "de": "Steinspiel: Steine bewegen; Würfelspiel: Verdopplungsentscheidungen",
                  "nl": "Steenspel: stukken bewegen; Dobbelsteenspel: verdubbelbeslissingen"
        },
        {
                  "en": "Checker play: beginners; Cube play: experts",
                  "es": "Juego de fichas: principiantes; Juego de cubo: expertos",
                  "de": "Steinspiel: Anfänger; Würfelspiel: Experten",
                  "nl": "Steenspel: beginners; Dobbelsteenspel: experts"
        },
        {
                  "en": "Same thing different names",
                  "es": "Misma cosa nombres diferentes",
                  "de": "Dasselbe verschiedene Namen",
                  "nl": "Hetzelfde verschillende namen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Maintaining one strong anchor while building your board",
                  "es": "Mantener un ancla fuerte mientras construyes tu tablero",
                  "de": "Einen starken Anker halten während Sie Ihr Brett aufbauen",
                  "nl": "Eén sterk anker behouden terwijl je je bord bouwt"
        },
        {
                  "en": "Only defensive play",
                  "es": "Solo juego defensivo",
                  "de": "Nur defensives Spiel",
                  "nl": "Alleen defensief spel"
        },
        {
                  "en": "Making all points anchors",
                  "es": "Hacer todos los puntos anclas",
                  "de": "Alle Punkte zu Ankern machen",
                  "nl": "Alle punten ankers maken"
        },
        {
                  "en": "Never making anchors",
                  "es": "Nunca hacer anclas",
                  "de": "Niemals Anker machen",
                  "nl": "Nooit ankers maken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Playing in prime time",
                  "es": "Jugar en horario estelar",
                  "de": "Zur Hauptsendezeit spielen",
                  "nl": "Spelen tijdens prime time"
        },
        {
                  "en": "First move advantage",
                  "es": "Ventaja de primer movimiento",
                  "de": "Erster-Zug-Vorteil",
                  "nl": "Eerste zet voordeel"
        },
        {
                  "en": "Building consecutive points to block opponent's movement",
                  "es": "Construir puntos consecutivos para bloquear el movimiento del oponente",
                  "de": "Aufeinanderfolgende Punkte aufbauen um Bewegung des Gegners zu blockieren",
                  "nl": "Opeenvolgende punten bouwen om beweging van tegenstander te blokkeren"
        },
        {
                  "en": "Prime number strategy",
                  "es": "Estrategia de números primos",
                  "de": "Primzahl-Strategie",
                  "nl": "Priemgetal strategie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tournament speed play",
                  "es": "Juego de velocidad de torneo",
                  "de": "Turnier-Schnellspiel",
                  "nl": "Toernooi snelheid spel"
        },
        {
                  "en": "Fast dice rolling",
                  "es": "Lanzamiento rápido de dados",
                  "de": "Schnelles Würfeln",
                  "nl": "Snel dobbelstenen gooien"
        },
        {
                  "en": "Aggressive attack trying to close out opponent quickly",
                  "es": "Ataque agresivo tratando de cerrar al oponente rápidamente",
                  "de": "Aggressiver Angriff der versucht Gegner schnell auszusperren",
                  "nl": "Agressieve aanval die probeert tegenstander snel te sluiten"
        },
        {
                  "en": "Lightning quick moves",
                  "es": "Movimientos rápidos como relámpago",
                  "de": "Blitzschnelle Züge",
                  "nl": "Bliksemsnelle zetten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Physically holding the cube",
                  "es": "Sostener físicamente el cubo",
                  "de": "Den Würfel physisch halten",
                  "nl": "De dobbelsteen fysiek vasthouden"
        },
        {
                  "en": "Buying the equipment",
                  "es": "Comprar el equipo",
                  "de": "Die Ausrüstung kaufen",
                  "nl": "De uitrusting kopen"
        },
        {
                  "en": "Having exclusive right to redouble after accepting",
                  "es": "Tener derecho exclusivo de redoblar después de aceptar",
                  "de": "Exklusives Recht zum Rückverdoppeln nach Annahme haben",
                  "nl": "Exclusief recht hebben om te herverdubbelen na acceptatie"
        },
        {
                  "en": "Winning the cube auction",
                  "es": "Ganar la subasta del cubo",
                  "de": "Die Würfel-Auktion gewinnen",
                  "nl": "De dobbelsteenveiling winnen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Disconnecting from game",
                  "es": "Desconectarse del juego",
                  "de": "Vom Spiel trennen",
                  "nl": "Loskoppelen van spel"
        },
        {
                  "en": "Removing anchors",
                  "es": "Quitar anclas",
                  "de": "Anker entfernen",
                  "nl": "Ankers verwijderen"
        },
        {
                  "en": "Stopping communication",
                  "es": "Detener comunicación",
                  "de": "Kommunikation stoppen",
                  "nl": "Communicatie stoppen"
        },
        {
                  "en": "Moving all checkers past opponent to create pure race",
                  "es": "Mover todas las fichas más allá del oponente para crear una carrera pura",
                  "de": "Alle Steine am Gegner vorbeibewegen um reines Rennen zu schaffen",
                  "nl": "Alle stenen voorbij tegenstander bewegen om pure race te creëren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Risk that position improves so much opponent passes later double",
                  "es": "Riesgo de que la posición mejore tanto que el oponente pase un doble posterior",
                  "de": "Risiko dass Position sich so verbessert dass Gegner späteres Doppeln passt",
                  "nl": "Risico dat positie zoveel verbetert dat tegenstander latere verdubbeling past"
        },
        {
                  "en": "Economic downturn affecting game",
                  "es": "Recesión económica afectando juego",
                  "de": "Wirtschaftsabschwung beeinflusst Spiel",
                  "nl": "Economische neergang beïnvloedt spel"
        },
        {
                  "en": "Losing money in stock market",
                  "es": "Perder dinero en bolsa",
                  "de": "Geld am Aktienmarkt verlieren",
                  "nl": "Geld verliezen op beurs"
        },
        {
                  "en": "Cube decreasing in value",
                  "es": "Cubo disminuyendo en valor",
                  "de": "Würfel verliert an Wert",
                  "nl": "Dobbelsteen dalend in waarde"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Holding hands during play",
                  "es": "Tomarse de las manos durante el juego",
                  "de": "Händchenhalten während des Spiels",
                  "nl": "Handen vasthouden tijdens spel"
        },
        {
                  "en": "Both players have anchors in opponent's board",
                  "es": "Ambos jugadores tienen anclas en el tablero del oponente",
                  "de": "Beide Spieler haben Anker im Brett des Gegners",
                  "nl": "Beide spelers hebben ankers in bord van tegenstander"
        },
        {
                  "en": "Both players agree to hold position",
                  "es": "Ambos jugadores acuerdan mantener posición",
                  "de": "Beide Spieler stimmen zu Position zu halten",
                  "nl": "Beide spelers komen overeen positie te houden"
        },
        {
                  "en": "Sharing cube ownership",
                  "es": "Compartir propiedad del cubo",
                  "de": "Würfelbesitz teilen",
                  "nl": "Dobbelsteenbezit delen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Value of the ham in the game",
                  "es": "Valor del jamón en el juego",
                  "de": "Wert des Schinkens im Spiel",
                  "nl": "Waarde van de ham in het spel"
        },
        {
                  "en": "Gammon chances make you double earlier and opponent pass sooner",
                  "es": "Las posibilidades de gammon te hacen doblar antes y el oponente pasar antes",
                  "de": "Gammon-Chancen lassen Sie früher verdoppeln und Gegner früher passen",
                  "nl": "Gammon kansen laten je eerder verdubbelen en tegenstander sneller passen"
        },
        {
                  "en": "Gammons worth triple points",
                  "es": "Gammons valen triple puntos",
                  "de": "Gammons wert dreifache Punkte",
                  "nl": "Gammons waard drievoudige punten"
        },
        {
                  "en": "Gammon prevents doubling",
                  "es": "Gammon previene doblar",
                  "de": "Gammon verhindert Verdoppeln",
                  "nl": "Gammon voorkomt verdubbelen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Efficiency rating of game",
                  "es": "Calificación de eficiencia del juego",
                  "de": "Effizienzbewertung des Spiels",
                  "nl": "Efficiëntie beoordeling van spel"
        },
        {
                  "en": "Minimizing wasted pips by optimizing checker distribution",
                  "es": "Minimizar pips desperdiciados optimizando distribución de fichas",
                  "de": "Verschwendete Pips minimieren durch Optimierung der Steinverteilung",
                  "nl": "Verspilde pips minimaliseren door steenverdeling te optimaliseren"
        },
        {
                  "en": "Speed of pip counting",
                  "es": "Velocidad de conteo de pips",
                  "de": "Geschwindigkeit der Pip-Zählung",
                  "nl": "Snelheid van pip telling"
        },
        {
                  "en": "Pip quality measurement",
                  "es": "Medición de calidad de pips",
                  "de": "Pip-Qualitätsmessung",
                  "nl": "Pip kwaliteitsmeting"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Double-paned game board",
                  "es": "Tablero de juego de doble panel",
                  "de": "Doppelverglastes Spielbrett",
                  "nl": "Dubbelglas spelbord"
        },
        {
                  "en": "Range between too good to double and too bad to double",
                  "es": "Rango entre demasiado bueno para doblar y demasiado malo para doblar",
                  "de": "Bereich zwischen zu gut zum Verdoppeln und zu schlecht zum Verdoppeln",
                  "nl": "Bereik tussen te goed om te verdubbelen en te slecht om te verdubbelen"
        },
        {
                  "en": "Time window for doubling",
                  "es": "Ventana de tiempo para doblar",
                  "de": "Zeitfenster zum Verdoppeln",
                  "nl": "Tijdvenster voor verdubbelen"
        },
        {
                  "en": "Physical window with cube",
                  "es": "Ventana física con cubo",
                  "de": "Physisches Fenster mit Würfel",
                  "nl": "Fysiek venster met dobbelsteen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Playing card in the game",
                  "es": "Carta de juego en el juego",
                  "de": "Spielkarte im Spiel",
                  "nl": "Speelkaart in het spel"
        },
        {
                  "en": "Funny player",
                  "es": "Jugador gracioso",
        ...
        {
                  "en": "Unexpected good roll that dramatically changes position",
                  "es": "Tirada inesperadamente buena que cambia dramáticamente la posición",
                  "de": "Unerwartet guter Wurf der Position dramatisch ändert",
                  "nl": "Onverwacht goede worp die positie dramatisch verandert"
        },
        {
                  "en": "Wild dice roll",
                  "es": "Tirada de dados salvaje",
                  "de": "Wilder Würfelwurf",
                  "nl": "Wilde dobbelsteenworp"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Speed of gameplay",
                  "es": "Velocidad del juego",
                  "de": "Spielgeschwindigkeit",
                  "nl": "Spelsnelheid"
        },
        {
                  "en": "Temperature of the board",
                  "es": "Temperatura del tablero",
                  "de": "Temperatur des Bretts",
                  "nl": "Temperatuur van het bord"
        },
        {
                  "en": "Player emotion level",
                  "es": "Nivel de emoción del jugador",
                  "de": "Gefühlsstufe des Spielers",
                  "nl": "Emotieniveau van speler"
        },
        {
                  "en": "How much position can swing with single rolls",
                  "es": "Cuánto puede cambiar la posición con tiradas individuales",
                  "de": "Wie stark Position mit einzelnen Würfen schwanken kann",
                  "nl": "Hoeveel positie kan schommelen met enkele worpen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cube position on board",
                  "es": "Posición del cubo en el tablero",
                  "de": "Würfelposition auf Brett",
                  "nl": "Dobbelsteenpositie op bord"
        },
        {
                  "en": "Power gained from owning cube and threatening to redouble",
                  "es": "Poder ganado al poseer el cubo y amenazar con redoblar",
                  "de": "Macht gewonnen durch Würfelbesitz und Drohung zurückzuverdoppeln",
                  "nl": "Kracht verkregen door dobbelsteen te bezitten en te dreigen met herverdubbelen"
        },
        {
                  "en": "Cube multiplication factor",
                  "es": "Factor de multiplicación del cubo",
                  "de": "Würfel-Multiplikationsfaktor",
                  "nl": "Dobbelsteen vermenigvuldigingsfactor"
        },
        {
                  "en": "Physical tool to move cube",
                  "es": "Herramienta física para mover cubo",
                  "de": "Physisches Werkzeug um Würfel zu bewegen",
                  "nl": "Fysieke tool om dobbelsteen te bewegen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hit that improves your position beyond just sending them back",
                  "es": "Golpe que mejora tu posición más allá de solo enviarlos atrás",
                  "de": "Treffer der Ihre Position verbessert über bloßes Zurückschicken hinaus",
                  "nl": "Hit die je positie verbetert bovenop hen terugsturen"
        },
        {
                  "en": "Positive attitude hitting",
                  "es": "Golpear con actitud positiva",
                  "de": "Schlagen mit positiver Einstellung",
                  "nl": "Raken met positieve houding"
        },
        {
                  "en": "Friendly hit during practice",
                  "es": "Golpe amistoso durante práctica",
                  "de": "Freundlicher Treffer während Übung",
                  "nl": "Vriendelijke hit tijdens oefening"
        },
        {
                  "en": "Building while hitting",
                  "es": "Construir mientras golpeas",
                  "de": "Bauen während Schlagen",
                  "nl": "Bouwen terwijl raken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fairness in racing",
                  "es": "Equidad en carreras",
                  "de": "Fairness im Rennen",
                  "nl": "Eerlijkheid in racen"
        },
        {
                  "en": "Equal racing chances",
                  "es": "Posibilidades iguales de carrera",
                  "de": "Gleiche Rennchancen",
                  "nl": "Gelijke race kansen"
        },
        {
                  "en": "Your expected value in current position if it becomes pure race",
                  "es": "Tu valor esperado en la posición actual si se convierte en carrera pura",
                  "de": "Ihr erwarteter Wert in aktueller Position wenn sie reines Rennen wird",
                  "nl": "Je verwachte waarde in huidige positie als het pure race wordt"
        },
        {
                  "en": "Race finish equity",
                  "es": "Equidad de finalización de carrera",
                  "de": "Rennziel-Equity",
                  "nl": "Race finish equity"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cube position advantage",
                  "es": "Ventaja de posición del cubo",
                  "de": "Würfelpositionsvorteil",
                  "nl": "Dobbelsteenpositie voordeel"
        },
        {
                  "en": "Exclusive redoubling rights gives you control and leverage",
                  "es": "Derechos exclusivos de redoble te dan control y apalancamiento",
                  "de": "Exklusive Rückverdopplungsrechte geben Ihnen Kontrolle und Hebel",
                  "nl": "Exclusieve herverdubbel rechten geven je controle en hefboom"
        },
        {
                  "en": "Trademark on cube design",
                  "es": "Marca registrada en diseño del cubo",
                  "de": "Markenzeichen für Würfel-Design",
                  "nl": "Handelsmerk op dobbelsteenontwerp"
        },
        {
                  "en": "Owning the physical cube equipment",
                  "es": "Poseer el equipo físico del cubo",
                  "de": "Besitz der physischen Würfelausrüstung",
                  "nl": "Het fysieke dobbelsteenmateriaal bezitten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Front position anchor",
                  "es": "Ancla de posición frontal",
                  "de": "Front-Positions-Anker",
                  "nl": "Voorste positie anker"
        },
        {
                  "en": "Anchor on opponent's 4-point, 5-point, or bar point",
                  "es": "Ancla en el punto 4, 5 o punto de barra del oponente",
                  "de": "Anker auf 4-Punkt, 5-Punkt oder Bar-Punkt des Gegners",
                  "nl": "Anker op 4-punt, 5-punt of bar punt van tegenstander"
        },
        {
                  "en": "Moving anchor forward",
                  "es": "Mover ancla hacia adelante",
                  "de": "Anker vorwärts bewegen",
                  "nl": "Anker vooruit bewegen"
        },
        {
                  "en": "Future anchor position",
                  "es": "Posición de ancla futura",
                  "de": "Zukünftige Ankerposition",
                  "nl": "Toekomstige anker positie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Market crash during game",
                  "es": "Caída del mercado durante el juego",
                  "de": "Marktcrash während Spiel",
                  "nl": "Markt crash tijdens spel"
        },
        {
                  "en": "Position becomes too good so opponent passes instead of taking",
                  "es": "La posición se vuelve demasiado buena así que el oponente pasa en lugar de aceptar",
                  "de": "Position wird zu gut sodass Gegner passt statt anzunehmen",
                  "nl": "Positie wordt te goed dus tegenstander past in plaats van te accepteren"
        },
        {
                  "en": "Losing money bets",
                  "es": "Perder apuestas de dinero",
                  "de": "Wetten Geld verlieren",
                  "nl": "Weddenschap geld verliezen"
        },
        {
                  "en": "Giving up cube value",
                  "es": "Renunciar al valor del cubo",
                  "de": "Würfelwert aufgeben",
                  "nl": "Dobbelsteenwaarde opgeven"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Chess opening theory",
                  "es": "Teoría de apertura de ajedrez",
                  "de": "Schacheröffnungstheorie",
                  "nl": "Schaak openingstheorie"
        },
        {
                  "en": "New cube design",
                  "es": "Nuevo diseño de cubo",
                  "de": "Neues Würfel-Design",
                  "nl": "Nieuw dobbelsteenontwerp"
        },
        {
                  "en": "Adjusting XG rollouts using Kazaross formula for match play",
                  "es": "Ajustar rollouts de XG usando fórmula Kazaross para juego de match",
                  "de": "XG-Rollouts mit Kazaross-Formel für Match-Spiel anpassen",
                  "nl": "XG rollouts aanpassen met Kazaross formule voor wedstrijdspel"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Perfect opening position",
                  "es": "Posición de apertura perfecta",
                  "de": "Perfekte Eröffnungsposition",
                  "nl": "Perfecte openingspositie"
        },
        {
                  "en": "Only using prime numbers",
                  "es": "Solo usar números primos",
                  "de": "Nur Primzahlen verwenden",
                  "nl": "Alleen priemgetallen gebruiken"
        },
        {
                  "en": "Premium gameplay",
                  "es": "Juego premium",
        ...
        {
                  "en": "Building 6 consecutive points to completely block opponent",
                  "es": "Construir 6 puntos consecutivos para bloquear completamente al oponente",
                  "de": "6 aufeinanderfolgende Punkte bauen um Gegner komplett zu blockieren",
                  "nl": "6 opeenvolgende punten bouwen om tegenstander volledig te blokkeren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Match play: varies by score; Money play: typically 25%",
                  "es": "Juego de match: varía según puntaje; Juego de dinero: típicamente 25%",
                  "de": "Match-Spiel: variiert je nach Stand; Geld-Spiel: typisch 25%",
                  "nl": "Wedstrijdspel: varieert per score; Geldspel: typisch 25%"
        },
        {
                  "en": "Always 50% regardless",
                  "es": "Siempre 50% independientemente",
                  "de": "Immer 50% unabhängig",
                  "nl": "Altijd 50% ongeacht"
        },
        {
                  "en": "Match play: 25%; Money play: varies",
                  "es": "Juego de match: 25%; Juego de dinero: varía",
                  "de": "Match-Spiel: 25%; Geld-Spiel: variiert",
                  "nl": "Wedstrijdspel: 25%; Geldspel: varieert"
        },
        {
                  "en": "Same in both formats",
                  "es": "Igual en ambos formatos",
                  "de": "Gleich in beiden Formaten",
                  "nl": "Hetzelfde in beide formats"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hit checkers re-entering and getting hit again before escaping",
                  "es": "Fichas golpeadas volviendo a entrar y siendo golpeadas de nuevo antes de escapar",
                  "de": "Geschlagene Steine wieder eintreten und erneut geschlagen werden bevor sie entkommen",
                  "nl": "Gerakte stenen weer binnenkomen en opnieuw geraakt worden voordat ze ontsnappen"
        },
        {
                  "en": "Circling the board",
                  "es": "Dar vueltas al tablero",
                  "de": "Das Brett umkreisen",
                  "nl": "Het bord rondcirkelen"
        },
        {
                  "en": "Reusing old strategies",
                  "es": "Reutilizar viejas estrategias",
                  "de": "Alte Strategien wiederverwenden",
                  "nl": "Oude strategieën hergebruiken"
        },
        {
                  "en": "Rotating checkers clockwise",
                  "es": "Rotar fichas en sentido horario",
                  "de": "Steine im Uhrzeigersinn drehen",
                  "nl": "Stenen met de klok mee draaien"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Being too confident",
                  "es": "Ser demasiado confiado",
                  "de": "Zu selbstbewusst sein",
                  "nl": "Te zelfverzekerd zijn"
        },
        {
                  "en": "Cube value exceeds limit",
                  "es": "Valor del cubo excede límite",
                  "de": "Würfelwert überschreitet Limit",
                  "nl": "Dobbelsteenwaarde overschrijdt limiet"
        },
        {
                  "en": "Position so strong that doubling lets opponent escape by passing",
                  "es": "Posición tan fuerte que doblar deja escapar al oponente al pasar",
                  "de": "Position so stark dass Verdoppeln dem Gegner durch Passen Flucht ermöglicht",
                  "nl": "Positie zo sterk dat verdubbelen tegenstander laat ontsnappen door te passen"
        },
        {
                  "en": "Excessive doubling",
                  "es": "Doblaje excesivo",
                  "de": "Übermäßiges Verdoppeln",
                  "nl": "Overdreven verdubbelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Counting only effective pips",
                  "es": "Contar solo pips efectivos",
                  "de": "Nur effektive Pips zählen",
                  "nl": "Alleen effectieve pips tellen"
        },
        {
                  "en": "Average pip value",
                  "es": "Valor promedio de pips",
                  "de": "Durchschnittlicher Pip-Wert",
                  "nl": "Gemiddelde pip waarde"
        },
        {
                  "en": "Pip count after removal",
                  "es": "Conteo de pips después de remoción",
                  "de": "Pip-Zählung nach Entfernung",
                  "nl": "Pip count na verwijdering"
        },
        {
                  "en": "Adjusted pip count accounting for distribution and wastage",
                  "es": "Conteo de pips ajustado que considera distribución y desperdicio",
                  "de": "Angepasste Pip-Zählung unter Berücksichtigung von Verteilung und Verschwendung",
                  "nl": "Aangepaste pip count rekening houdend met verdeling en verspilling"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Money games: gammons/backgammons only count if cube was turned",
                  "es": "Juegos de dinero: gammons/backgammons solo cuentan si se giró el cubo",
                  "de": "Geldspiele: Gammons/Backgammons zählen nur wenn Würfel gedreht wurde",
                  "nl": "Geldspellen: gammons/backgammons tellen alleen als dobbelsteen werd gedraaid"
        },
        {
                  "en": "Opening move restriction",
                  "es": "Restricción de movimiento de apertura",
                  "de": "Eröffnungszug-Einschränkung",
                  "nl": "Openingszet beperking"
        },
        {
                  "en": "Cube ownership rule",
                  "es": "Regla de propiedad del cubo",
                  "de": "Würfelbesitz-Regel",
                  "nl": "Dobbelsteenbezit regel"
        },
        {
                  "en": "Match play only rule",
                  "es": "Regla solo para juego de match",
                  "de": "Nur Match-Spiel Regel",
                  "nl": "Alleen wedstrijdspel regel"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Correct to double; opponent indifferent between take and pass",
                  "es": "Correcto doblar; oponente indiferente entre aceptar y pasar",
                  "de": "Korrekt zu verdoppeln; Gegner indifferent zwischen Nehmen und Passen",
                  "nl": "Correct om te verdubbelen; tegenstander onverschillig tussen nemen en passen"
        },
        {
                  "en": "Two different positions",
                  "es": "Dos posiciones diferentes",
                  "de": "Zwei verschiedene Positionen",
                  "nl": "Twee verschillende posities"
        },
        {
                  "en": "Paradoxical cube situation",
                  "es": "Situación paradójica de cubo",
                  "de": "Paradoxe Würfelsituation",
                  "nl": "Paradoxale dobbelsteensituatie"
        },
        {
                  "en": "Alternating cube actions",
                  "es": "Acciones de cubo alternantes",
                  "de": "Abwechselnde Würfelaktionen",
                  "nl": "Afwisselende dobbelsteenacties"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Running out of moves; avoid by maintaining spare checkers/timing",
                  "es": "Quedarse sin movimientos; evitar manteniendo fichas de repuesto/timing",
                  "de": "Keine Züge mehr haben; vermeiden durch Reservesteine/Timing bewahren",
                  "nl": "Zonder zetten zitten; vermijden door reserve stenen/timing te behouden"
        },
        {
                  "en": "Physical board damage; careful handling",
                  "es": "Daño físico del tablero; manejo cuidadoso",
                  "de": "Physischer Brettschaden; vorsichtige Handhabung",
                  "nl": "Fysieke bordschade; voorzichtig hanteren"
        },
        {
                  "en": "Critical game situation; unavoidable",
                  "es": "Situación crítica de juego; inevitable",
                  "de": "Kritische Spielsituation; unvermeidbar",
                  "nl": "Kritieke spelsituatie; onvermijdelijk"
        },
        {
                  "en": "Time pressure; play faster",
                  "es": "Presión de tiempo; jugar más rápido",
                  "de": "Zeitdruck; schneller spielen",
                  "nl": "Tijdsdruk; sneller spelen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Same thing different words",
                  "es": "Misma cosa palabras diferentes",
                  "de": "Dasselbe verschiedene Worte",
                  "nl": "Hetzelfde verschillende woorden"
        },
        {
                  "en": "Tempo: clock time; Timing: game duration",
                  "es": "Tempo: tiempo de reloj; Timing: duración del juego",
                  "de": "Tempo: Uhrzeit; Timing: Spieldauer",
                  "nl": "Tempo: kloktijd; Timing: spelduur"
        },
        {
                  "en": "Tempo: speed of advance; Timing: having spare checkers to wait",
                  "es": "Tempo: velocidad de avance; Timing: tener fichas de repuesto para esperar",
                  "de": "Tempo: Vorwärtsgeschwindigkeit; Timing: Reservesteine zum Warten haben",
                  "nl": "Tempo: snelheid van vooruitgang; Timing: reserve stenen hebben om te wachten"
        },
        {
                  "en": "Tempo: beginner; Timing: expert",
                  "es": "Tempo: principiante; Timing: experto",
                  "de": "Tempo: Anfänger; Timing: Experte",
                  "nl": "Tempo: beginner; Timing: expert"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Starting position reference",
                  "es": "Referencia de posición inicial",
                  "de": "Startpositions-Referenz",
                  "nl": "Startpositie referentie"
        },
        {
                  "en": "Position documentation",
                  "es": "Documentación de posición",
                  "de": "Positionsdokumentation",
                  "nl": "Positie documentatie"
        },
        {
                  "en": "Well-known position used as benchmark for cube decisions",
                  "es": "Posición bien conocida usada como punto de referencia para decisiones de cubo",
                  "de": "Wohlbekannte Position als Maßstab für Würfelentscheidungen verwendet",
                  "nl": "Bekende positie gebruikt als benchmark voor dobbelsteenbeslissingen"
        },
        {
                  "en": "Ideal theoretical position",
                  "es": "Posición teórica ideal",
                  "de": "Ideale theoretische Position",
                  "nl": "Ideale theoretische positie"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Racing position where one side needs 2 rolls to bear off, other needs 3",
                  "es": "Posición de carrera donde un lado necesita 2 tiradas para sacar, el otro necesita 3",
                  "de": "Rennposition wo eine Seite 2 Würfe zum Auswürfeln braucht, andere 3",
                  "nl": "Race positie waar één kant 2 worpen nodig heeft om uit te gooien, andere 3"
        },
        {
                  "en": "Double vs triple stakes",
                  "es": "Apuestas dobles vs triples",
                  "de": "Doppelte vs dreifache Einsätze",
                  "nl": "Dubbele vs drievoudige inzet"
        },
        {
                  "en": "Rolling dice twice vs three times",
                  "es": "Tirar dados dos veces vs tres veces",
                  "de": "Würfel zweimal vs dreimal werfen",
                  "nl": "Dobbelstenen twee keer vs drie keer gooien"
        },
        {
                  "en": "Two players vs three players",
                  "es": "Dos jugadores vs tres jugadores",
                  "de": "Zwei Spieler vs drei Spieler",
                  "nl": "Twee spelers vs drie spelers"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Tournament scoring",
                  "es": "Puntuación de torneo",
                  "de": "Turnier-Wertung",
                  "nl": "Toernooi score"
        },
        {
                  "en": "Player rating system",
                  "es": "Sistema de calificación de jugadores",
                  "de": "Spieler-Bewertungssystem",
                  "nl": "Speler beoordelingssysteem"
        },
        {
                  "en": "Gammon counting method",
                  "es": "Método de conteo de gammon",
                  "de": "Gammon-Zählmethode",
                  "nl": "Gammon telmethode"
        },
        {
                  "en": "Formula converting money game gammon value to match equity",
                  "es": "Fórmula convirtiendo valor de gammon de juego de dinero a equity de match",
                  "de": "Formel zum Konvertieren von Geldspiel-Gammon-Wert zu Match-Equity",
                  "nl": "Formule die geldspel gammon waarde converteert naar wedstrijd equity"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Accepting double and immediately redoubling while keeping cube",
                  "es": "Aceptar doble e inmediatamente redoblar mientras se mantiene el cubo",
                  "de": "Doppeln annehmen und sofort rückverdoppeln während Würfel behalten wird",
                  "nl": "Verdubbeling accepteren en onmiddellijk herverdubbelen terwijl dobbelsteen behouden wordt"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Masked strategy",
                  "es": "Estrategia enmascarada",
                  "de": "Maskierte Strategie",
                  "nl": "Gemaskeerde strategie"
        },
        {
                  "en": "Stealing checkers",
                  "es": "Robar fichas",
                  "de": "Steine stehlen",
                  "nl": "Stenen stelen"
        },
        {
                  "en": "Re-beavering the beaver - accepting beaver and redoubling again",
                  "es": "Re-beaver el beaver - aceptar beaver y redoblar de nuevo",
                  "de": "Den Beaver re-beavern - Beaver annehmen und erneut rückverdoppeln",
                  "nl": "De beaver her-beaveren - beaver accepteren en opnieuw herverdubbelen"
        },
        {
                  "en": "Night-time playing",
                  "es": "Juego nocturno",
                  "de": "Nachtspiel",
                  "nl": "Nacht spelen"
        }
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Match equity: your probability of winning the match; Cubeless: single game winning %",
                  "es": "Match equity: tu probabilidad de ganar el match; Sin cubo: % de ganar un solo juego",
                  "de": "Match-Equity: Ihre Wahrscheinlichkeit das Match zu gewinnen; Würfellos: einzelnes Spiel-Gewinn-Prozent",
                  "nl": "Wedstrijd equity: je kans om de wedstrijd te winnen; Dobbelsteenloos: enkel spel win percentage"
        },
        {
                  "en": "Match equity: tournament only; Cubeless: money only",
                  "es": "Match equity: solo torneo; Sin cubo: solo dinero",
                  "de": "Match-Equity: nur Turnier; Würfellos: nur Geld",
                  "nl": "Wedstrijd equity: alleen toernooi; Dobbelsteenloos: alleen geld"
        },
        {
                  "en": "Same thing different names",
                  "es": "Misma cosa nombres diferentes",
        ...
        {
                  "en": "Match equity includes cube; Cubeless doesn't",
                  "es": "Match equity incluye cubo; Sin cubo no",
                  "de": "Match-Equity beinhaltet Würfel; Würfellos nicht",
                  "nl": "Wedstrijd equity omvat dobbelsteen; Dobbelsteenloos niet"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Trailing player can double more aggressively due to score",
                  "es": "Jugador que va perdiendo puede doblar más agresivamente debido al puntaje",
                  "de": "Zurückliegender Spieler kann aggressiver verdoppeln wegen Stand",
                  "nl": "Achterliggende speler kan agressiever verdubbelen vanwege score"
        },
        {
                  "en": "Moving cube towards trailer",
                  "es": "Mover cubo hacia el que va perdiendo",
                  "de": "Würfel zum Zurückliegenden bewegen",
                  "nl": "Dobbelsteen naar achterliggende bewegen"
        },
        {
                  "en": "Trailer gets extra cube",
                  "es": "El que va perdiendo obtiene cubo extra",
                  "de": "Zurückliegender bekommt Extra-Würfel",
                  "nl": "Achterliggende krijgt extra dobbelsteen"
        },
        {
                  "en": "Leader's advantage with cube",
                  "es": "Ventaja del líder con cubo",
                  "de": "Vorteil des Führenden mit Würfel",
                  "nl": "Voordeel van leider met dobbelsteen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Mobile app for playing",
                  "es": "Aplicación móvil para jugar",
                  "de": "Mobile App zum Spielen",
                  "nl": "Mobiele app voor spelen"
        },
        {
                  "en": "Quick calculation to determine if gammons matter at match score",
                  "es": "Cálculo rápido para determinar si los gammons importan en puntaje de match",
                  "de": "Schnellberechnung um zu bestimmen ob Gammons beim Match-Stand zählen",
                  "nl": "Snelle berekening om te bepalen of gammons ertoe doen bij wedstrijdscore"
        },
        {
                  "en": "Tournament format",
                  "es": "Formato de torneo",
        ...
        {
                  "en": "Gammon probability calculator",
                  "es": "Calculadora de probabilidad de gammon",
                  "de": "Gammon-Wahrscheinlichkeitsrechner",
                  "nl": "Gammon kans calculator"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Broken cube equipment",
                  "es": "Equipo de cubo roto",
                  "de": "Kaputte Würfelausrüstung",
                  "nl": "Kapotte dobbelsteenuitrusting"
        },
        {
                  "en": "Cube at maximum value",
                  "es": "Cubo en valor máximo",
                  "de": "Würfel bei Maximalwert",
                  "nl": "Dobbelsteen op maximale waarde"
        },
        {
                  "en": "Cube fell off table",
                  "es": "Cubo cayó de la mesa",
                  "de": "Würfel vom Tisch gefallen",
                  "nl": "Dobbelsteen van tafel gevallen"
        },
        {
                  "en": "Position where cube is worthless; neither player will double",
                  "es": "Posición donde el cubo no vale nada; ningún jugador doblará",
                  "de": "Position wo Würfel wertlos ist; kein Spieler wird verdoppeln",
                  "nl": "Positie waar dobbelsteen waardeloos is; geen enkele speler zal verdubbelen"
        }
        ],
        correct: 3,
        explanation: {
