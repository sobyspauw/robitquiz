  ...
  const level5 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A midgame sacrifice",
                  "es": "Un sacrificio de medio juego",
                  "de": "Ein Mittelspielopfer",
                  "nl": "Een middenspel offer"
        },
        {
                  "en": "A painful losing position",
                  "es": "Una posición perdedora dolorosa",
                  "de": "Eine schmerzhafte Verlustposition",
                  "nl": "Een pijnlijke verliezende positie"
        },
        {
                  "en": "A theoretically drawn 2v1 king endgame with specific geometry",
                  "es": "Un final teórico de tablas 2 contra 1 damas con geometría específica",
                  "de": "Ein theoretisch remises 2-gegen-1-Damen-Endspiel mit spezifischer Geometrie",
                  "nl": "Een theoretisch remise 2 tegen 1 dam eindspel met specifieke geometrie"
        },
        {
                  "en": "An opening trap",
      ...
      },
      {
        ...
        {
                  "en": "Executing the breakthrough at the precise moment opponent cannot defend",
                  "es": "Ejecutar la ruptura en el momento preciso en que el oponente no puede defender",
                  "de": "Den Durchbruch im präzisen Moment ausführen, wo der Gegner nicht verteidigen kann",
                  "nl": "De doorbraak uitvoeren op het precieze moment dat tegenstander niet kan verdedigen"
        },
        {
                  "en": "Timing piece exchanges",
                  "es": "Temporizar intercambios de piezas",
                  "de": "Steintausche zeitlich abstimmen",
                  "nl": "Stukruilen timen"
        },
        {
                  "en": "Breaking through in opening",
                  "es": "Romper en la apertura",
                  "de": "In der Eröffnung durchbrechen",
                  "nl": "Doorbreken in de opening"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sacrificing material to destroy opponent's pawn structure",
                  "es": "Sacrificar material para destruir la estructura de peones del oponente",
                  "de": "Material opfern, um die Bauernstruktur des Gegners zu zerstören",
                  "nl": "Materiaal opofferen om de pionstructuur van tegenstander te vernietigen"
        },
        {
                  "en": "A defensive maneuver",
                  "es": "Una maniobra defensiva",
                  "de": "Ein Verteidigungsmanöver",
                  "nl": "Een verdedigingsmanoeuvre"
        },
        {
                  "en": "Trading all pieces",
                  "es": "Intercambiar todas las piezas",
                  "de": "Alle Steine tauschen",
                  "nl": "Alle stukken ruilen"
        },
        {
                  "en": "A specific opening trap",
                  "es": "Una trampa de apertura específica",
                  "de": "Eine spezifische Eröffnungsfalle",
                  "nl": "Een specifieke openingsval"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Complete control of key squares restricting all opponent options",
                  "es": "Control completo de casillas clave restringiendo todas las opciones del oponente",
                  "de": "Vollständige Kontrolle von Schlüsselfeldern, die alle Gegneroptionen einschränkt",
                  "nl": "Volledige controle van sleutelvelden die alle tegenstander opties beperkt"
        },
        {
                  "en": "Having more pieces",
                  "es": "Tener más piezas",
                  "de": "Mehr Steine haben",
                  "nl": "Meer stukken hebben"
        },
        {
                  "en": "Winning material",
                  "es": "Ganar material",
                  "de": "Material gewinnen",
                  "nl": "Materiaal winnen"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A complex endgame requiring precise technique to win or draw",
                  "es": "Un final complejo que requiere técnica precisa para ganar o empatar",
                  "de": "Ein komplexes Endspiel, das präzise Technik zum Gewinnen oder Remis erfordert",
                  "nl": "Een complex eindspel dat precieze techniek vereist om te winnen of remise"
        },
        {
                  "en": "A defensive formation",
                  "es": "Una formación defensiva",
                  "de": "Eine Defensivformation",
        ...
        },
        {
                  ...
                  "nl": "Een toernooi formaat"
        },
        {
                  "en": "An opening variation",
                  "es": "Una variación de apertura",
                  "de": "Eine Eröffnungsvariante",
                  "nl": "Een opening variatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Controlling the move sequence to gain positional advantage",
                  "es": "Controlar la secuencia de movimientos para ganar ventaja posicional",
                  "de": "Die Zugfolge kontrollieren, um Positionsvorteil zu erlangen",
                  "nl": "De zetreeks controleren om positioneel voordeel te verkrijgen"
        },
        {
                  "en": "Playing faster",
                  "es": "Jugar más rápido",
        ...
        {
                  "en": "Changing game speed",
                  "es": "Cambiar la velocidad del juego",
                  "de": "Spielgeschwindigkeit ändern",
                  "nl": "Spelsnelheid veranderen"
        },
        {
                  "en": "Using time controls",
                  "es": "Usar controles de tiempo",
                  "de": "Zeitkontrollen verwenden",
                  "nl": "Tijdscontroles gebruiken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Ein Lotteriesystem",
                  "nl": "Een loterij systeem"
        },
        {
                  "en": "A defensive technique achieving draw against superior forces",
                  "es": "Una técnica defensiva logrando tablas contra fuerzas superiores",
                  "de": "Eine Verteidigungstechnik, die Remis gegen überlegene Kräfte erreicht",
                  "nl": "Een verdedigingstechniek die remise bereikt tegen superieure krachten"
        },
        {
                  "en": "Offering draws frequently",
                  "es": "Ofrecer tablas frecuentemente",
                  "de": "Häufig Remis anbieten",
                  "nl": "Vaak remises aanbieden"
        },
        {
                  "en": "Drawing the position on paper",
                  "es": "Dibujar la posición en papel",
                  "de": "Die Position auf Papier zeichnen",
                  "nl": "De positie op papier tekenen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Playing on one diagonal only",
                  "es": "Jugar solo en una diagonal",
                  "de": "Nur auf einer Diagonale spielen",
                  "nl": "Alleen op één diagonaal spelen"
        },
        {
                  "en": "Cutting off opponent pieces from key diagonals",
                  "es": "Cortar las piezas del oponente de diagonales clave",
                  "de": "Gegnerische Steine von Schlüsseldiagonalen abschneiden",
                  "nl": "Stukken van tegenstander afsnijden van sleutel diagonalen"
        },
        {
                  "en": "Avoiding diagonal moves",
                  "es": "Evitar movimientos diagonales",
                  "de": "Diagonale Züge vermeiden",
                  "nl": "Diagonale zetten vermijden"
        },
        {
                  "en": "Isolating corner pieces",
                  "es": "Aislar piezas de esquina",
                  "de": "Ecksteine isolieren",
                  "nl": "Hoek stukken isoleren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A theoretical king endgame with unique winning method",
                  "es": "Un final teórico de damas con método de victoria único",
                  "de": "Ein theoretisches Damen-Endspiel mit einzigartiger Gewinnmethode",
                  "nl": "Een theoretisch dam eindspel met unieke win methode"
        },
        {
                  "en": "Banking pieces on edge",
                  "es": "Bancando piezas en el borde",
                  "de": "Steine am Rand stapeln",
                  "nl": "Stukken op de rand opstapelen"
        },
        {
                  "en": "Financial strategy in tournaments",
                  "es": "Estrategia financiera en torneos",
                  "de": "Finanzstrategie in Turnieren",
                  "nl": "Financiële strategie in toernooien"
        },
        {
                  "en": "Reserve piece formation",
                  "es": "Formación de pieza de reserva",
                  "de": "Reserve-Steinformation",
                  "nl": "Reserve stuk formatie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Reorganizing pieces preemptively to prevent opponent threats",
                  "es": "Reorganizar piezas preventivamente para evitar amenazas del oponente",
                  "de": "Steine präventiv reorganisieren, um Gegnerdrohungen zu verhindern",
                  "nl": "Stukken preventief reorganiseren om tegenstander dreigingen te voorkomen"
        },
        {
                  "en": "Defensive fortification",
                  "es": "Fortificación defensiva",
                  "de": "Defensive Befestigung",
                  "nl": "Defensieve versterking"
        },
        {
                  "en": "Medical preparation before games",
                  "es": "Preparación médica antes de juegos",
                  "de": "Medizinische Vorbereitung vor Spielen",
                  "nl": "Medische voorbereiding voor spellen"
        },
        {
                  "en": "Changing opening repertoire",
                  "es": "Cambiar repertorio de apertura",
                  "de": "Eröffnungsrepertoire ändern",
                  "nl": "Opening repertoire veranderen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Eine Defensivaufstellung",
                  "nl": "Een defensieve opstelling"
        },
        {
                  "en": "A middlegame plan involving wing pawn storms",
                  "es": "Un plan de medio juego involucrando tormentas de peones de ala",
                  "de": "Ein Mittelspielplan mit Flügelbauernstürmen",
                  "nl": "Een middenspel plan met vleugelpion stormen"
        },
        {
                  "en": "An opening trap",
                  "es": "Una trampa de apertura",
      ...
      },
      {
        ...
        {
                  "en": "Making the game easier",
                  "es": "Hacer el juego más fácil",
                  "de": "Das Spiel einfacher machen",
                  "nl": "Het spel makkelijker maken"
        },
        {
                  "en": "Compelling opponent to trade pieces into favorable endgame",
                  "es": "Obligar al oponente a intercambiar piezas en un final favorable",
                  "de": "Den Gegner zwingen, Steine in ein günstiges Endspiel zu tauschen",
                  "nl": "Tegenstander dwingen stukken te ruilen naar gunstig eindspel"
        },
        {
                  "en": "Playing simple moves",
                  "es": "Jugar movimientos simples",
                  "de": "Einfache Züge spielen",
                  "nl": "Simpele zetten spelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Contemporary playing style",
                  "es": "Estilo de juego contemporáneo",
                  "de": "Zeitgenössischer Spielstil",
                  "nl": "Hedendaagse speelstijl"
        },
        {
                  "en": "Allowing opponent center control then undermining it",
                  "es": "Permitir control central del oponente luego socavarlo",
                  "de": "Gegnerische Zentrumskontrolle erlauben, dann untergraben",
                  "nl": "Tegenstander centrumcontrole toestaan en dan ondermijnen"
        },
        {
                  "en": "Advanced defensive tactics",
                  "es": "Tácticas defensivas avanzadas",
                  "de": "Fortgeschrittene Defensivtaktiken",
                  "nl": "Geavanceerde defensieve tactieken"
        },
        {
                  "en": "Using only modern openings",
                  "es": "Usar solo aperturas modernas",
                  "de": "Nur moderne Eröffnungen verwenden",
                  "nl": "Alleen moderne openingen gebruiken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "A named opening",
                  "es": "Una apertura con nombre",
                  "de": "Eine benannte Eröffnung",
                  "nl": "Een genoemde opening"
        },
        {
                  "en": "A specific 3v2 endgame with unique drawing technique",
                  "es": "Un final específico 3 contra 2 con técnica de tablas única",
                  "de": "Ein spezifisches 3-gegen-2-Endspiel mit einzigartiger Remistechnik",
                  "nl": "Een specifiek 3 tegen 2 eindspel met unieke remise techniek"
        },
        {
                  "en": "A tournament position",
                  "es": "Una posición de torneo",
                  "de": "Eine Turnierposition",
                  "nl": "Een toernooi positie"
        },
        {
                  "en": "A theoretical middlegame",
                  "es": "Un medio juego teórico",
                  "de": "Ein theoretisches Mittelspiel",
                  "nl": "Een theoretisch middenspel"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Playing in reverse order",
                  "es": "Jugar en orden inverso",
                  "de": "In umgekehrter Reihenfolge spielen",
                  "nl": "In omgekeerde volgorde spelen"
        },
        {
                  "en": "Using king backward moves to gain tempo advantage",
                  "es": "Usar movimientos hacia atrás de dama para ganar ventaja de tempo",
                  "de": "Rückwärtszüge der Dame nutzen, um Tempo-Vorteil zu gewinnen",
                  "nl": "Achterwaartse dam zetten gebruiken om tempo voordeel te winnen"
        },
        {
                  "en": "Moving backwards only",
                  "es": "Moverse solo hacia atrás",
                  "de": "Nur rückwärts bewegen",
                  "nl": "Alleen achteruit bewegen"
        },
        {
                  "en": "Retreating pieces defensively",
                  "es": "Retirar piezas defensivamente",
                  "de": "Steine defensiv zurückziehen",
                  "nl": "Stukken defensief terugtrekken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Transforming apparent weakness into strength through piece repositioning",
                  "es": "Transformar aparente debilidad en fortaleza mediante reposicionamiento de piezas",
                  "de": "Scheinbare Schwäche durch Steinneupositionierung in Stärke verwandeln",
                  "nl": "Schijnbare zwakte transformeren in sterkte door stuk herpositionering"
        },
        {
                  "en": "Flipping the board",
                  "es": "Voltear el tablero",
                  "de": "Das Brett umdrehen",
                  "nl": "Het bord omdraaien"
        },
        {
                  "en": "Playing from opposite side",
                  "es": "Jugar desde el lado opuesto",
                  "de": "Von der gegenüberliegenden Seite spielen",
                  "nl": "Spelen vanaf tegenovergestelde kant"
        },
        {
                  "en": "Reversing move order",
                  "es": "Invertir orden de movimientos",
                  "de": "Zugreihenfolge umkehren",
                  "nl": "Zet volgorde omkeren"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A specific drawing technique in king and men endgames",
                  "es": "Una técnica específica de tablas en finales de dama y piezas",
                  "de": "Eine spezifische Remistechnik in Damen-und-Steine-Endspielen",
                  "nl": "Een specifieke remise techniek in dam en stukken eindspelen"
        },
        {
                  "en": "A named opening draw",
                  "es": "Un empate de apertura con nombre",
                  "de": "Eine benannte Eröffnungsremis",
                  "nl": "Een genoemde opening remise"
        },
        {
                  "en": "Drawing games on purpose",
                  "es": "Empatar juegos a propósito",
                  "de": "Absichtlich remis spielen",
                  "nl": "Opzettelijk remise spelen"
        },
        {
                  "en": "Historical drawn games",
                  "es": "Juegos históricos empatados",
                  "de": "Historische remis Spiele",
                  "nl": "Historische remise spellen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Physical pressure on pieces",
                  "es": "Presión física en piezas",
                  "de": "Physischer Druck auf Steine",
                  "nl": "Fysieke druk op stukken"
        },
        {
                  "en": "Gradually increasing constraints on opponent's position",
                  "es": "Aumentar gradualmente las restricciones en la posición del oponente",
                  "de": "Allmähliche Erhöhung der Einschränkungen der Gegnerposition",
                  "nl": "Geleidelijk beperkingen op tegenstander positie verhogen"
        },
        {
                  "en": "Aggressive attacking only",
                  "es": "Solo ataque agresivo",
                  "de": "Nur aggressiver Angriff",
                  "nl": "Alleen agressieve aanval"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "Changing endgame type",
                  "es": "Cambiar tipo de final",
                  "de": "Endspieltyp wechseln",
                  "nl": "Eindspel type veranderen"
        },
        {
                  "en": "Steering positions into favorable known endgame configurations",
                  "es": "Dirigir posiciones hacia configuraciones de final conocidas favorables",
                  "de": "Positionen in günstige bekannte Endspielkonfigurationen lenken",
                  "nl": "Posities sturen naar gunstige bekende eindspel configuraties"
        },
        {
                  "en": "Moving to different endings",
                  "es": "Moverse a diferentes finales",
                  "de": "Zu verschiedenen Endungen bewegen",
                  "nl": "Naar verschillende eindingen bewegen"
        }
        ],
        correct: 2,
        explanation: {
