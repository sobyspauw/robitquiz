  ...
  const level8 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Playing maximum tiles per turn to draw fresh tiles frequently",
                  "es": "Jugar máximo de fichas por turno para sacar fichas frescas frecuentemente",
                  "de": "Maximum Steine pro Zug spielen um häufig frische Steine zu ziehen",
                  "nl": "Maximum stenen per beurt spelen om vaak verse stenen te trekken"
        },
        {
                  "en": "Rotating between offensive and defensive plays",
                  "es": "Rotar entre jugadas ofensivas y defensivas",
                  "de": "Zwischen offensiven und defensiven Zügen rotieren",
                  "nl": "Roteren tussen offensieve en defensieve zetten"
        },
        {
                  "en": "Exchanging all tiles every turn",
                  "es": "Intercambiar todas las fichas cada turno",
                  "de": "Alle Steine jeden Zug tauschen",
                  "nl": "Alle stenen elke beurt ruilen"
        },
        {
                  "en": "Flipping rack upside down",
                  "es": "Voltear rack al revés",
                  "de": "Rack umdrehen",
                  "nl": "Rek omdraaien"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pattern of premium squares",
                  "es": "Patrón de cuadrados premium",
                  "de": "Muster von Premium-Feldern",
                  "nl": "Patroon van premium vakken"
        },
        {
                  "en": "Physical board surface quality",
                  "es": "Calidad de superficie física del tablero",
                  "de": "Physische Brett-Oberflächenqualität",
                  "nl": "Fysieke bord oppervlakte kwaliteit"
        },
        {
                  "en": "Color scheme of game board",
                  "es": "Esquema de colores del tablero de juego",
                  "de": "Farbschema des Spielbretts",
                  "nl": "Kleurenschema van spelbord"
        },
        {
                  "en": "Evaluating openness vs closedness of scoring opportunities",
                  "es": "Evaluar apertura vs cierre de oportunidades de puntuación",
                  "de": "Offenheit vs Geschlossenheit von Scoring-Möglichkeiten bewerten",
                  "nl": "Openheid vs geslotenheid van score kansen evalueren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Requesting timeout to regroup",
                  "es": "Solicitar tiempo fuera para reagruparse",
                  "de": "Timeout anfordern um sich neu zu gruppieren",
                  "nl": "Timeout aanvragen om te hergroeperen"
        },
        {
                  "en": "Exchanging tiles repeatedly",
                  "es": "Intercambiar fichas repetidamente",
                  "de": "Steine wiederholt tauschen",
                  "nl": "Stenen herhaaldelijk ruilen"
        },
        {
                  "en": "Playing aggressively when behind to create bingo opportunities",
                  "es": "Jugar agresivamente cuando vas atrás para crear oportunidades de bingo",
                  "de": "Aggressiv spielen wenn zurück um Bingo-Möglichkeiten zu schaffen",
                  "nl": "Agressief spelen wanneer achter om bingo kansen te creëren"
        },
        {
                  "en": "Challenging all opponent words",
                  "es": "Desafiar todas las palabras del oponente",
                  "de": "Alle Gegner-Wörter herausfordern",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Removing duplicate tiles",
                  "es": "Eliminar fichas duplicadas",
                  "de": "Doppelte Steine entfernen",
                  "nl": "Dubbele stenen verwijderen"
        },
        {
                  "en": "Physically polishing worn tiles",
                  "es": "Pulir físicamente fichas desgastadas",
                  "de": "Abgenutzte Steine physisch polieren",
                  "nl": "Versleten stenen fysiek polijsten"
        },
        {
                  "en": "Arranging tiles neatly on rack",
                  "es": "Organizar fichas ordenadamente en rack",
                  "de": "Steine ordentlich auf Rack anordnen",
                  "nl": "Stenen netjes op rek rangschikken"
        },
        {
                  "en": "Playing tiles to achieve balanced vowel/consonant ratio",
                  "es": "Jugar fichas para lograr relación equilibrada vocal/consonante",
                  "de": "Steine spielen um ausgewogenes Vokal/Konsonant-Verhältnis zu erreichen",
                  "nl": "Stenen spelen om gebalanceerde klinker/medeklinker verhouding te bereiken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Predicting opponent's next move",
                  "es": "Predecir siguiente movimiento del oponente",
                  "de": "Nächsten Gegner-Zug vorhersagen",
                  "nl": "Volgende zet van tegenstander voorspellen"
        },
        {
                  "en": "Estimating time remaining",
                  "es": "Estimar tiempo restante",
                  "de": "Verbleibende Zeit schätzen",
                  "nl": "Resterende tijd schatten"
        },
        {
                  "en": "Using known unseen tiles to calculate exact win probability per move",
                  "es": "Usar fichas no vistas conocidas para calcular probabilidad exacta de victoria por movimiento",
                  "de": "Bekannte ungesehene Steine verwenden um exakte Gewinnwahrscheinlichkeit pro Zug zu berechnen",
                  "nl": "Bekende ongeziene stenen gebruiken om exacte winkans per zet te berekenen"
        },
        {
                  "en": "Guessing opponent's tiles randomly",
                  "es": "Adivinar fichas del oponente aleatoriamente",
                  "de": "Gegner-Steine zufällig raten",
                  "nl": "Stenen van tegenstander willekeurig raden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Finding vacant tables",
                  "es": "Encontrar mesas vacantes",
                  "de": "Freie Tische finden",
                  "nl": "Lege tafels vinden"
        },
        {
                  "en": "Observing opponent's previous games to learn their style",
                  "es": "Observar juegos previos del oponente para aprender su estilo",
                  "de": "Frühere Spiele des Gegners beobachten um seinen Stil zu lernen",
                  "nl": "Eerdere spellen van tegenstander observeren om hun stijl te leren"
        },
        {
                  "en": "Tournament venue reconnaissance",
                  "es": "Reconocimiento del lugar del torneo",
                  "de": "Turnier-Veranstaltungsort-Erkundung",
                  "nl": "Toernooi locatie verkenning"
        },
        {
                  "en": "Searching for word patterns",
                  "es": "Buscar patrones de palabras",
                  "de": "Nach Wortmustern suchen",
                  "nl": "Zoeken naar woordpatronen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Evaluating future potential of remaining tiles after each play",
                  "es": "Evaluar potencial futuro de fichas restantes después de cada jugada",
                  "de": "Zukünftiges Potential verbleibender Steine nach jedem Zug bewerten",
                  "nl": "Toekomstig potentieel van overgebleven stenen na elke zet evalueren"
        },
        {
                  "en": "Counting tiles left in bag",
                  "es": "Contar fichas restantes en bolsa",
                  "de": "Verbleibende Steine im Beutel zählen",
                  "nl": "Overgebleven stenen in zak tellen"
        },
        {
                  "en": "Reviewing mistakes after game",
                  "es": "Revisar errores después del juego",
                  "de": "Fehler nach Spiel überprüfen",
                  "nl": "Fouten na spel beoordelen"
        },
        {
                  "en": "Deciding when to leave tournament",
                  "es": "Decidir cuándo dejar torneo",
                  "de": "Entscheiden wann Turnier verlassen",
                  "nl": "Beslissen wanneer toernooi verlaten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using all remaining time to force opponent's time pressure",
                  "es": "Usar todo el tiempo restante para forzar presión de tiempo del oponente",
                  "de": "Alle verbleibende Zeit verwenden um Zeitdruck des Gegners zu erzwingen",
                  "nl": "Alle resterende tijd gebruiken om tijdsdruk van tegenstander te forceren"
        },
        {
        ...
        {
                  "en": "Calling timeout between moves",
                  "es": "Pedir tiempo fuera entre movimientos",
                  "de": "Timeout zwischen Zügen aufrufen",
                  "nl": "Timeout roepen tussen zetten"
        },
        {
                  "en": "Deliberately exceeding time limit",
                  "es": "Exceder deliberadamente límite de tiempo",
                  "de": "Zeitlimit absichtlich überschreiten",
                  "nl": "Opzettelijk tijdslimiet overschrijden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dictionary coverage percentage",
                  "es": "Porcentaje de cobertura del diccionario",
                  "de": "Wörterbuch-Abdeckungs-Prozentsatz",
                  "nl": "Woordenboek dekking percentage"
        },
        {
                  "en": "Learning words by length categories",
                  "es": "Aprender palabras por categorías de longitud",
                  "de": "Wörter nach Längen-Kategorien lernen",
                  "nl": "Woorden leren per lengte categorieën"
        },
        {
                  "en": "Knowing many obscure words vs knowing common words perfectly",
                  "es": "Conocer muchas palabras oscuras vs conocer palabras comunes perfectamente",
                  "de": "Viele obskure Wörter kennen vs häufige Wörter perfekt kennen",
                  "nl": "Veel obscure woorden kennen vs gewone woorden perfect kennen"
        },
        {
                  "en": "Multilingual vocabulary",
                  "es": "Vocabulario multilingüe",
                  "de": "Mehrsprachiger Wortschatz",
                  "nl": "Meertalige woordenschat"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Playing invalid 7-letter word",
                  "es": "Jugar palabra inválida de 7 letras",
                  "de": "Ungültiges 7-Buchstaben-Wort spielen",
                  "nl": "Ongeldig 7-letter woord spelen"
        },
        {
                  "en": "Challenging opponent's bingo word",
                  "es": "Desafiar palabra de bingo del oponente",
                  "de": "Gegner-Bingo-Wort herausfordern",
                  "nl": "Bingo woord van tegenstander uitdagen"
        },
        {
                  "en": "Scoring lower than 50 points on bingo",
                  "es": "Anotar menos de 50 puntos en bingo",
                  "de": "Weniger als 50 Punkte auf Bingo erzielen",
                  "nl": "Minder dan 50 punten scoren op bingo"
        },
        {
                  "en": "Setting up apparent bingo lane that's actually blocked",
                  "es": "Configurar carril de bingo aparente que en realidad está bloqueado",
                  "de": "Scheinbare Bingo-Bahn einrichten die tatsächlich blockiert ist",
                  "nl": "Schijnbare bingo baan opzetten die eigenlijk geblokkeerd is"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Scoring two games simultaneously",
                  "es": "Anotar dos juegos simultáneamente",
                  "de": "Zwei Spiele gleichzeitig werten",
                  "nl": "Twee spellen gelijktijdig scoren"
        },
        {
                  "en": "Using spreadsheet to track scores",
                  "es": "Usar hoja de cálculo para rastrear puntuaciones",
                  "de": "Tabelle verwenden um Punktestände zu verfolgen",
                  "nl": "Spreadsheet gebruiken om scores te volgen"
        },
        {
                  "en": "Playing word parallel to existing word to form multiple 2-letter words",
                  "es": "Jugar palabra paralela a palabra existente para formar múltiples palabras de 2 letras",
                  "de": "Wort parallel zu bestehendem Wort spielen um mehrere 2-Buchstaben-Wörter zu bilden",
                  "nl": "Woord parallel aan bestaand woord spelen om meerdere 2-letter woorden te vormen"
        },
        {
                  "en": "Comparing scores with other tables",
                  "es": "Comparar puntuaciones con otras mesas",
                  "de": "Punktestände mit anderen Tischen vergleichen",
                  "nl": "Scores vergelijken met andere tafels"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Assuming tiles are equally distributed",
                  "es": "Asumir que las fichas están distribuidas equitativamente",
                  "de": "Annehmen dass Steine gleichmäßig verteilt sind",
                  "nl": "Aannemen dat stenen gelijk verdeeld zijn"
        },
        {
                  "en": "Forgetting to shake tile bag",
                  "es": "Olvidar agitar bolsa de fichas",
                  "de": "Vergessen Steinbeutel zu schütteln",
                  "nl": "Vergeten steenzak te schudden"
        },
        {
                  "en": "Miscounting tiles in bag",
                  "es": "Contar mal fichas en bolsa",
                  "de": "Steine im Beutel falsch zählen",
                  "nl": "Stenen in zak verkeerd tellen"
        },
        {
                  "en": "Playing as if specific tiles remain without tracking proof",
                  "es": "Jugar como si fichas específicas quedan sin prueba de rastreo",
                  "de": "Spielen als ob spezifische Steine bleiben ohne Tracking-Beweis",
                  "nl": "Spelen alsof specifieke stenen blijven zonder volg bewijs"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Saving Q for last play",
                  "es": "Guardar Q para última jugada",
                  "de": "Q für letzten Zug sparen",
                  "nl": "Q sparen voor laatste zet"
        },
        {
                  "en": "Never playing Q tile",
                  "es": "Nunca jugar ficha Q",
                  "de": "Q-Stein niemals spielen",
                  "nl": "Q steen nooit spelen"
        },
        {
                  "en": "Exchanging Q immediately",
                  "es": "Intercambiar Q inmediatamente",
                  "de": "Q sofort tauschen",
                  "nl": "Q onmiddellijk ruilen"
        },
        {
                  "en": "Strategic timing of Q plays to avoid being stuck with unplayable Q in endgame",
                  "es": "Tiempo estratégico de jugadas de Q para evitar quedarse atascado con Q injugable en final",
                  "de": "Strategisches Timing von Q-Zügen um zu vermeiden mit unspielbarem Q im Endspiel stecken zu bleiben",
                  "nl": "Strategische timing van Q zetten om vast komen te zitten met onspeelbaar Q in eindspel te vermijden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Blocking or claiming key premium squares before opponent",
                  "es": "Bloquear o reclamar cuadrados premium clave antes del oponente",
                  "de": "Wichtige Premium-Felder vor Gegner blockieren oder beanspruchen",
                  "nl": "Belangrijke premium vakken blokkeren of claimen voor tegenstander"
        },
        {
                  "en": "Challenging square legality",
                  "es": "Desafiar legalidad de cuadrado",
                  "de": "Quadrat-Legalität herausfordern",
                  "nl": "Vak legaliteit uitdagen"
        },
        {
                  "en": "Fighting over tournament table seating",
                  "es": "Luchar por asientos de mesa de torneo",
                  "de": "Kämpfen um Turnier-Tisch-Sitzplätze",
                  "nl": "Vechten over toernooi tafel zitplaatsen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Setting optimal alarm times",
                  "es": "Configurar tiempos de alarma óptimos",
                  "de": "Optimale Alarm-Zeiten einstellen",
                  "nl": "Optimale alarm tijden instellen"
        },
        {
                  "en": "Analyzing clock design patterns",
                  "es": "Analizar patrones de diseño de reloj",
                  "de": "Uhren-Design-Muster analysieren",
                  "nl": "Klok ontwerp patronen analyseren"
        },
        {
                  "en": "Managing time and recognizing opponent's time pressure tendencies",
                  "es": "Gestionar tiempo y reconocer tendencias de presión de tiempo del oponente",
                  "de": "Zeit verwalten und Zeitdruck-Tendenzen des Gegners erkennen",
                  "nl": "Tijd beheren en tijdsdruk tendensen van tegenstander herkennen"
        },
        {
                  "en": "Psychological impact of visible clocks",
                  "es": "Impacto psicológico de relojes visibles",
                  "de": "Psychologische Auswirkung sichtbarer Uhren",
                  "nl": "Psychologische impact van zichtbare klokken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Minimizing score differences",
                  "es": "Minimizar diferencias de puntuación",
                  "de": "Punkte-Unterschiede minimieren",
                  "nl": "Score verschillen minimaliseren"
        },
        {
                  "en": "Playing more conservatively to close board and limit comeback chances",
                  "es": "Jugar más conservadoramente para cerrar tablero y limitar oportunidades de remontada",
                  "de": "Konservativer spielen um Brett zu schließen und Comeback-Chancen zu begrenzen",
                  "nl": "Conservatiever spelen om bord te sluiten en comeback kansen te beperken"
        },
        {
                  "en": "Reducing tile variety on rack",
                  "es": "Reducir variedad de fichas en rack",
                  "de": "Stein-Vielfalt auf Rack reduzieren",
                  "nl": "Steen variëteit op rek reduceren"
        },
        {
                  "en": "Varying play style randomly",
                  "es": "Variar estilo de juego aleatoriamente",
                  "de": "Spielstil zufällig variieren",
                  "nl": "Speelstijl willekeurig variëren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Heating tiles before play",
                  "es": "Calentar fichas antes de jugar",
                  "de": "Steine vor dem Spielen erwärmen",
                  "nl": "Stenen opwarmen voor spel"
        },
        {
                  "en": "Identifying popular word patterns",
                  "es": "Identificar patrones populares de palabras",
                  "de": "Beliebte Wort-Muster identifizieren",
                  "nl": "Populaire woord patronen identificeren"
        },
        {
                  "en": "Finding tournament venues",
                  "es": "Encontrar lugares de torneos",
                  "de": "Turnier-Veranstaltungsorte finden",
                  "nl": "Toernooi locaties vinden"
        },
        {
                  "en": "Creating board areas with multiple high-scoring opportunities",
                  "es": "Crear áreas de tablero con múltiples oportunidades de alta puntuación",
                  "de": "Brett-Bereiche mit mehreren hochscorenden Möglichkeiten schaffen",
                  "nl": "Bord gebieden creëren met meerdere hoog-scorende kansen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Balancing rack flexibility vs immediate scoring",
                  "es": "Equilibrar flexibilidad de rack vs puntuación inmediata",
                  "de": "Rack-Flexibilität vs sofortiges Scoring balancieren",
                  "nl": "Rek flexibiliteit vs directe score balanceren"
        },
        {
                  "en": "Thermal management of playing area",
                  "es": "Gestión térmica de área de juego",
                  "de": "Thermisches Management des Spielbereichs",
                  "nl": "Thermisch beheer van speelgebied"
        },
        {
                  "en": "Measuring disorder of tile arrangement",
                  "es": "Medir desorden de disposición de fichas",
                  "de": "Unordnung der Stein-Anordnung messen",
                  "nl": "Wanorde van steen rangschikking meten"
        },
        {
                  "en": "Keeping rack organized alphabetically",
                  "es": "Mantener rack organizado alfabéticamente",
                  "de": "Rack alphabetisch organisiert halten",
                  "nl": "Rek alfabetisch georganiseerd houden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Requiring 2 moves to win",
                  "es": "Requiere 2 movimientos para ganar",
                  "de": "2 Züge zum Gewinnen benötigen",
                  "nl": "2 zetten nodig om te winnen"
        },
        {
                  "en": "Two-player tournament format",
                  "es": "Formato de torneo de dos jugadores",
                  "de": "Zwei-Spieler-Turnier-Format",
                  "nl": "Twee-speler toernooi formaat"
        },
        {
                  "en": "Calculating if you can empty rack in next 2 turns to end game",
                  "es": "Calcular si puedes vaciar rack en los próximos 2 turnos para terminar juego",
                  "de": "Berechnen ob Sie Rack in nächsten 2 Zügen leeren können um Spiel zu beenden",
                  "nl": "Berekenen of je rek kunt legen in volgende 2 beurten om spel te beëindigen"
        },
        {
                  "en": "Playing exactly 2 tiles per turn",
                  "es": "Jugar exactamente 2 fichas por turno",
                  "de": "Genau 2 Steine pro Zug spielen",
                  "nl": "Precies 2 stenen per beurt spelen"
        }
        ],
        correct: 2,
        explanation: {
