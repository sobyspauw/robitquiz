    ...
    questions: [
      {
        question: {
          ...
          de: "Was ist ein 'Abzugsangriff' im Kart enspiele?",
      ...
      },
      {
        question: {
          ...
          de: "Was ist das 'Zentrum' des Kart enspielebretts?",
        ...
        explanation: {
          ...
          de: "Das Zentrum besteht aus den vier Feldern d4, d5, e4 und e5. Die Kontrolle dieser Felder ist ein grundlegendes Prinzip der Kart enspielestrategie.",
      ...
      },
      {
        question: {
          ...
          de: "Was ist eine 'Fesselung' in Kart enspieletaktiken?",
      ...
      },
      {
        question: {
          ...
          de: "Wer gilt als der größte Kart enspielespieler aller Zeiten?",
      ...
      },
      {
        question: {
          ...
          de: "Was ist eine 'Gabel' im Kart enspiele?",
      ...
      },
      {
        question: {
          ...
          de: "Was bedeutet 'Fianchetto' im Kart enspiele?",
      ...
      },
      {
        ...
        options: [
          ...
          { en: "A chess opening", es: "Una apertura de ajedrez", de: "Eine Kart enspieleeröffnung", nl: "Een schaakopening" },
      ...
      },
      {
        ...
        options: [
          ...
          { en: "A type of checkmate", es: "Un tipo de jaque mate", de: "Eine Art Kart enspielematt", nl: "Een soort schaakmat" },
      ...
      },
      {
        ...
        options: [
          { en: "Repeated checks forcing a draw", es: "Jaques repetidos que fuerzan un empate", de: "Wiederholte Kart enspieles, die ein Remis erzwingen", nl: "Herhaalde schaken die remise afdwingen" },
          { en: "Checking with all pieces", es: "Dar jaque con todas las piezas", de: "Mit allen Figuren Kart enspiele bieten", nl: "Schaak geven met alle stukken" },
        ...
        explanation: {
          ...
          de: "Dauerschach tritt auf, wenn ein Spieler dem gegnerischen König kontinuierlich Kart enspiele bieten kann und so ein Remis durch Wiederholung erzwingt.",
      ...
      },
      {
        question: {
          ...
          de: "Was ist 'Tempo' im Kart enspiele?",
      ...
      },
      {
        question: {
          ...
          de: "Was ist ein 'Spieß' im Kart enspiele?",
      ...
      },
      {
        question: {
          ...
          de: "Was bedeutet es, 'das Zentrum zu kontrollieren' im Kart enspiele?",
