// Vegetarian Dishes Quiz - Level 5
(function() {
  const level5 = {
    name: {
    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Asparagus, peas, artichokes",
                  "es": "Espárragos, guisantes, alcachofas",
                  "de": "Spargel, Erbsen, Artischocken",
                  "nl": "Asperges, erwten, artisjokken"
        },
        {
                  "en": "Pumpkin, butternut squash, sweet potatoes",
                  "es": "Calabaza, calabaza butternut, batatas",
                  "de": "Kürbis, Butternut-Kürbis, Süßkartoffeln",
                  "nl": "Pompoen, butternut squash, zoete aardappels"
        },
        {
                  "en": "Brussels sprouts, cabbage, leeks",
                  "es": "Coles de Bruselas, repollo, puerros",
                  "de": "Rosenkohl, Kohl, Lauch",
                  "nl": "Spruitjes, kool, prei"
        },
        {
                  "en": "Tomatoes, corn, zucchini",
                  "es": "Tomates, maíz, calabacín",
                  "de": "Tomaten, Mais, Zucchini",
                  "nl": "Tomaten, maïs, courgette"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dry them completely and store in plastic bags",
                  "es": "Secarlas completamente y almacenar en bolsas plásticas",
                  "de": "Vollständig trocknen und in Plastikbeuteln lagern",
                  "nl": "Volledig drogen en bewaren in plastic zakken"
        },
        {
                  "en": "Store fresh in the refrigerator",
                  "es": "Almacenar fresco en el refrigerador",
                  "de": "Frisch im Kühlschrank lagern",
                  "nl": "Vers bewaren in de koelkast"
        },
        {
                  "en": "Pickle in vinegar",
                  "es": "Encurtir en vinagre",
                  "de": "In Essig einlegen",
                  "nl": "Inmaken in azijn"
        },
        {
                  "en": "Freeze in olive oil or ice cube trays",
                  "es": "Congelar en aceite de oliva o bandejas de hielo",
                  "de": "In Olivenöl oder Eiswürfelformen einfrieren",
                  "nl": "Invriezen in olijfolie of ijsblokjesvormen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Boiling for long periods",
                  "es": "Hervir por períodos largos",
                  "de": "Lange Zeit kochen",
                  "nl": "Lang koken"
        },
        {
                  "en": "Roasting at high heat to caramelize natural sugars",
                  "es": "Asar a alta temperatura para caramelizar azúcares naturales",
                  "de": "Bei hoher Hitze rösten, um natürliche Zucker zu karamellisieren",
                  "nl": "Roosteren op hoge temperatuur om natuurlijke suikers te karameliseren"
        },
        {
                  "en": "Eating them raw only",
                  "es": "Comerlas solo crudas",
                  "de": "Nur roh essen",
                  "nl": "Alleen rauw eten"
        },
        {
                  "en": "Steaming to keep them light",
                  "es": "Cocer al vapor para mantenerlas ligeras",
                  "de": "Dämpfen, um sie leicht zu halten",
                  "nl": "Stomen om ze licht te houden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They require special cooking methods",
                  "es": "Requieren métodos especiales de cocción",
                  "de": "Sie erfordern spezielle Kochmethoden",
                  "nl": "Ze vereisen speciale kookmethoden"
        },
        {
                  "en": "Better flavor, nutrition, and environmental sustainability",
                  "es": "Mejor sabor, nutrición y sostenibilidad ambiental",
                  "de": "Besserer Geschmack, Ernährung und ökologische Nachhaltigkeit",
                  "nl": "Betere smaak, voeding en milieuduurzaamheid"
        },
        {
                  "en": "They are harder to find",
                  "es": "Son más difíciles de encontrar",
                  "de": "Sie sind schwerer zu finden",
                  "nl": "Ze zijn moeilijker te vinden"
        },
        {
                  "en": "They cost more money",
                  "es": "Cuestan más dinero",
                  "de": "Sie kosten mehr Geld",
                  "nl": "Ze kosten meer geld"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cool, dry place with good air circulation",
                  "es": "Lugar fresco y seco con buena circulación de aire",
                  "de": "Kühler, trockener Ort mit guter Luftzirkulation",
                  "nl": "Koele, droge plaats met goede luchtcirculatie"
        },
        {
                  "en": "In water to prevent drying",
                  "es": "En agua para prevenir el secado",
                  "de": "In Wasser, um Austrocknung zu verhindern",
                  "nl": "In water om uitdroging te voorkomen"
        },
        {
                  "en": "Freezer for long-term storage",
                  "es": "Congelador para almacenamiento a largo plazo",
                  "de": "Gefrierschrank für Langzeitlagerung",
                  "nl": "Vriezer voor lange termijn bewaring"
        },
        {
                  "en": "Refrigerator immediately",
                  "es": "Refrigerador inmediatamente",
                  "de": "Sofort in den Kühlschrank",
                  "nl": "Koelkast onmiddellijk"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Storing in salt water",
                  "es": "Almacenar en agua salada",
                  "de": "In Salzwasser lagern",
                  "nl": "Bewaren in zout water"
        },
        {
                  "en": "Freezing whole heads",
                  "es": "Congelar cabezas enteras",
                  "de": "Ganze Köpfe einfrieren",
                  "nl": "Hele koppen invriezen"
        },
        {
                  "en": "Drying in the sun",
                  "es": "Secar al sol",
                  "de": "In der Sonne trocknen",
                  "nl": "Drogen in de zon"
        },
        {
                  "en": "Fermentation into sauerkraut",
                  "es": "Fermentación en chucrut",
                  "de": "Fermentation zu Sauerkraut",
                  "nl": "Fermentatie tot zuurkool"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Dandelion greens",
                  "es": "Hojas de diente de león",
                  "de": "Löwenzahnblätter",
                  "nl": "Paardenbloembladeren"
        },
        {
                  "en": "Lettuce",
                  "es": "Lechuga",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When they're completely soft",
                  "es": "Cuando están completamente suaves",
                  "de": "Wenn sie völlig weich sind",
                  "nl": "Wanneer ze volledig zacht zijn"
        },
        {
                  "en": "When they're still green",
                  "es": "Cuando aún están verdes",
                  "de": "Wenn sie noch grün sind",
                  "nl": "Wanneer ze nog groen zijn"
        },
        {
                  "en": "When they're fully colored but still firm",
                  "es": "Cuando están completamente coloreados pero aún firmes",
                  "de": "Wenn sie vollständig gefärbt, aber noch fest sind",
                  "nl": "Wanneer ze volledig gekleurd maar nog stevig zijn"
        },
        {
                  "en": "Only when they fall from the vine",
                  "es": "Solo cuando caen de la planta",
                  "de": "Nur wenn sie von der Rebe fallen",
                  "nl": "Alleen wanneer ze van de plant vallen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Curry powder and turmeric",
                  "es": "Polvo de curry y cúrcuma",
                  "de": "Currypulver und Kurkuma",
                  "nl": "Currypoeder en kurkuma"
        },
        {
                  "en": "Cinnamon, nutmeg, thyme, and rosemary",
                  "es": "Canela, nuez moscada, tomillo y romero",
                  "de": "Zimt, Muskatnuss, Thymian und Rosmarin",
                  "nl": "Kaneel, nootmuskaat, tijm en rozemarijn"
        },
        {
                  "en": "Basil, oregano, and garlic",
                  "es": "Albahaca, orégano y ajo",
                  "de": "Basilikum, Oregano und Knoblauch",
                  "nl": "Basilicum, oregano en knoflook"
        },
        {
                  "en": "Soy sauce and ginger",
                  "es": "Salsa de soja y jengibre",
                  "de": "Sojasoße und Ingwer",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Roasting at high heat",
                  "es": "Asar a alta temperatura",
                  "de": "Bei hoher Hitze rösten",
                  "nl": "Roosteren op hoge temperatuur"
        },
        {
                  "en": "Long, slow braising",
                  "es": "Braseado largo y lento",
                  "de": "Langes, langsames Schmoren",
                  "nl": "Lang, langzaam sudderen"
        },
        {
                  "en": "Deep frying until crispy",
                  "es": "Freír hasta que queden crujientes",
                  "de": "Frittieren bis knusprig",
                  "nl": "Frituren tot knapperig"
        },
        {
                  "en": "Brief blanching in boiling water, then ice bath",
                  "es": "Blanqueado breve en agua hirviendo, luego baño de hielo",
                  "de": "Kurzes Blanchieren in kochendem Wasser, dann Eisbad",
                  "nl": "Kort blancheren in kokend water, dan ijsbad"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Quick stir-frying",
                  "es": "Salteado rápido",
                  "de": "Schnelles Pfannenrühren",
                  "nl": "Snel roerbakken"
        },
        {
        ...
        {
                  "en": "Steaming for 2 minutes",
                  "es": "Cocción al vapor por 2 minutos",
                  "de": "2 Minuten dämpfen",
                  "nl": "2 minuten stomen"
        },
        {
                  "en": "Slow braising with herbs and aromatics",
                  "es": "Braseado lento con hierbas y aromáticos",
                  "de": "Langsames Schmoren mit Kräutern und Aromaten",
                  "nl": "Langzaam sudderen met kruiden en aromaten"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Summer squash can only be eaten raw",
                  "es": "La calabaza de verano solo se puede comer cruda",
                  "de": "Sommerkürbis kann nur roh gegessen werden",
                  "nl": "Zomerpompoen kan alleen rauw gegeten worden"
        },
        {
                  "en": "Summer squash is always yellow",
                  "es": "La calabaza de verano siempre es amarilla",
                  "de": "Sommerkürbis ist immer gelb",
                  "nl": "Zomerpompoen is altijd geel"
        },
        {
                  "en": "Summer squash has tender, edible skin and is harvested young",
                  "es": "La calabaza de verano tiene piel tierna y comestible y se cosecha joven",
                  "de": "Sommerkürbis hat zarte, essbare Schale und wird jung geerntet",
                  "nl": "Zomerpompoen heeft zachte, eetbare schil en wordt jong geoogst"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Storing in the refrigerator immediately",
                  "es": "Almacenar en el refrigerador inmediatamente",
                  "de": "Sofort im Kühlschrank lagern",
                  "nl": "Onmiddellijk bewaren in de koelkast"
        },
        {
                  "en": "Drying in the sun for weeks",
                  "es": "Secar al sol por semanas",
                  "de": "Wochenlang in der Sonne trocknen",
                  "nl": "Weken drogen in de zon"
        },
        {
                  "en": "Canning without any processing",
                  "es": "Enlatar sin ningún procesamiento",
                  "de": "Einmachen ohne jede Verarbeitung",
                  "nl": "Inmaken zonder enige verwerking"
        },
        {
                  "en": "Freezing at peak ripeness after blanching",
                  "es": "Congelar en su punto máximo de madurez después de blanquear",
                  "de": "Einfrieren bei optimaler Reife nach dem Blanchieren",
                  "nl": "Invriezen op piekrijpheid na blancheren"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only provides calories",
                  "es": "Solo proporciona calorías",
                  "de": "Liefert nur Kalorien",
                  "nl": "Levert alleen calorieën"
        },
        {
                  "en": "No nutritional difference",
                  "es": "No hay diferencia nutricional",
                  "de": "Kein ernährungsphysiologischer Unterschied",
                  "nl": "Geen voedingsverschil"
        },
        {
                  "en": "Higher vitamin and antioxidant content when fresh and locally grown",
                  "es": "Mayor contenido de vitaminas y antioxidantes cuando son frescos y cultivados localmente",
                  "de": "Höherer Vitamin- und Antioxidansgehalt wenn frisch und lokal angebaut",
                  "nl": "Hoger vitamine- en antioxidantgehalte wanneer vers en lokaal geteeld"
        },
        {
                  "en": "Less nutritious than processed foods",
                  "es": "Menos nutritivo que los alimentos procesados",
                  "de": "Weniger nahrhaft als verarbeitete Lebensmittel",
                  "nl": "Minder voedzaam dan verwerkte voedingsmiddelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "No watering at all",
                  "es": "No regar en absoluto",
                  "de": "Überhaupt nicht gießen",
                  "nl": "Helemaal niet water geven"
        },
        {
                  "en": "Full sun exposure",
                  "es": "Exposición total al sol",
                  "de": "Volle Sonnenexposition",
                  "nl": "Volledige blootstelling aan de zon"
        },
        {
                  "en": "Shade cloth and frequent watering",
                  "es": "Tela de sombra y riego frecuente",
                  "de": "Schattentuch und häufiges Gießen",
                  "nl": "Schaduwdoek en frequent water geven"
        },
        {
                  "en": "Plastic covering",
                  "es": "Cubierta plástica",
                  "de": "Plastikabdeckung",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Understanding what's available locally each season and planning flexible menus",
                  "es": "Entender qué está disponible localmente cada temporada y planificar menús flexibles",
                  "de": "Verstehen, was lokal jede Saison verfügbar ist und flexible Menüs planen",
                  "nl": "Begrijpen wat lokaal elk seizoen beschikbaar is en flexibele menu's plannen"
        },
        {
                  "en": "Avoiding all fresh produce",
                  "es": "Evitar todos los productos frescos",
                  "de": "Alle frischen Produkte vermeiden",
                  "nl": "Alle verse producten vermijden"
        },
        {
                  "en": "Using only imported exotic ingredients",
                  "es": "Usar solo ingredientes exóticos importados",
                  "de": "Nur importierte exotische Zutaten verwenden",
                  "nl": "Alleen geïmporteerde exotische ingrediënten gebruiken"
        },
        {
                  "en": "Eating the same foods year-round",
                  "es": "Comer los mismos alimentos todo el año",
                  "de": "Das ganze Jahr über die gleichen Lebensmittel essen",
                  "nl": "Het hele jaar hetzelfde voedsel eten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Kale and Brussels sprouts",
                  "es": "Col rizada y coles de Bruselas",
                  "de": "Grünkohl und Rosenkohl",
                  "nl": "Boerenkool en spruitjes"
        },
        {
                  "en": "Cucumbers and zucchini",
                  "es": "Pepinos y calabacín",
                  "de": "Gurken und Zucchini",
                  "nl": "Komkommers en courgette"
        },
        {
                  "en": "Tomatoes and peppers",
                  "es": "Tomates y pimientos",
                  "de": "Tomaten und Paprika",
                  "nl": "Tomaten en paprika's"
        },
        {
                  "en": "Lettuce and spinach",
                  "es": "Lechuga y espinacas",
                  "de": "Salat und Spinat",
                  "nl": "Sla en spinazie"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "At room temperature on the counter",
                  "es": "A temperatura ambiente en el mostrador",
                  "de": "Bei Raumtemperatur auf der Theke",
                  "nl": "Op kamertemperatuur op het aanrecht"
        },
        {
                  "en": "Wrapped in paper towels in a drawer",
                  "es": "Envuelto en toallas de papel en un cajón",
                  "de": "In Papiertüchern in einer Schublade gewickelt",
                  "nl": "Gewikkeld in papieren handdoeken in een la"
        },
        {
                  "en": "Standing upright in water in the refrigerator",
                  "es": "De pie en agua en el refrigerador",
                  "de": "Aufrecht in Wasser im Kühlschrank",
                  "nl": "Rechtop in water in de koelkast"
        },
        {
                  "en": "In a plastic bag in the freezer",
                  "es": "En una bolsa plástica en el congelador",
                  "de": "In einem Plastikbeutel im Gefrierschrank",
                  "nl": "In een plastic zak in de vriezer"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Boiling for 30 minutes",
                  "es": "Hervir por 30 minutos",
                  "de": "30 Minuten kochen",
                  "nl": "30 minuten koken"
        },
        {
                  "en": "Quick grilling or steaming",
                  "es": "Asado rápido o cocción al vapor",
                  "de": "Schnelles Grillen oder Dämpfen",
                  "nl": "Snel grillen of stomen"
        },
        {
                  "en": "Slow cooking for hours",
                  "es": "Cocción lenta por horas",
                  "de": "Stundenlang langsam kochen",
                  "nl": "Urenlang langzaam koken"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Thin peel and sweet taste",
                  "es": "Piel delgada y sabor dulce",
                  "de": "Dünne Schale und süßer Geschmack",
                  "nl": "Dunne schil en zoete smaak"
        },
        {
                  "en": "Small size and bright color",
                  "es": "Tamaño pequeño y color brillante",
                  "de": "Kleine Größe und helle Farbe",
                  "nl": "Kleine maat en heldere kleur"
        },
        {
                  "en": "Hard outer shell and low moisture content",
                  "es": "Cáscara exterior dura y bajo contenido de humedad",
                  "de": "Harte Außenschale und niedriger Feuchtigkeitsgehalt",
                  "nl": "Harde buitenschil en laag vochtgehalte"
        },
        {
                  "en": "Soft skin and high water content",
                  "es": "Piel suave y alto contenido de agua",
                  "de": "Weiche Haut und hoher Wassergehalt",
                  "nl": "Zachte huid en hoog watergehalte"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Root vegetables like turnips and parsnips",
                  "es": "Verduras de raíz como nabos y chirivías",
                  "de": "Wurzelgemüse wie Rüben und Pastinaken",
                  "nl": "Wortelgroenten zoals rapen en pastinak"
        },
        {
                  "en": "Tropical fruits like mango",
                  "es": "Frutas tropicales como mango",
                  "de": "Tropische Früchte wie Mango",
                  "nl": "Tropisch fruit zoals mango"
        },
        {
                  "en": "Fresh corn and tomatoes",
                  "es": "Maíz fresco y tomates",
                  "de": "Frischer Mais und Tomaten",
                  "nl": "Verse maïs en tomaten"
        },
        {
                  "en": "Summer squash and cucumber",
                  "es": "Calabaza de verano y pepino",
                  "de": "Sommerkürbis und Gurke",
                  "nl": "Zomerpompoen en komkommer"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Pumpkin and sage",
                  "es": "Calabaza y salvia",
                  "de": "Kürbis und Salbei",
                  "nl": "Pompoen en salie"
        },
        {
                  "en": "Fresh peas and mint",
                  "es": "Guisantes frescos y menta",
                  "de": "Frische Erbsen und Minze",
                  "nl": "Verse erwten en munt"
        },
        {
        ...
        {
                  "en": "Root vegetables and thyme",
                  "es": "Verduras de raíz y tomillo",
                  "de": "Wurzelgemüse und Thymian",
                  "nl": "Wortelgroenten en tijm"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Salting before cooking to remove bitterness",
                  "es": "Salar antes de cocinar para eliminar el amargor",
                  "de": "Vor dem Kochen salzen, um Bitterkeit zu entfernen",
                  "nl": "Zouten voor het koken om bitterheid te verwijderen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Frying in butter only",
                  "es": "Freír solo en mantequilla",
                  "de": "Nur in Butter braten",
                  "nl": "Alleen in boter bakken"
        },
        {
                  "en": "Serving completely raw",
                  "es": "Servir completamente crudo",
                  "de": "Völlig roh servieren",
                  "nl": "Volledig rauw serveren"
        },
        {
                  "en": "Boiling in heavily salted water",
                  "es": "Hervir en agua muy salada",
                  "de": "In stark gesalzenem Wasser kochen",
                  "nl": "Koken in zwaar gezouten water"
        },
        {
                  "en": "Roasting with a touch of maple syrup or honey",
                  "es": "Asar con un toque de jarabe de arce o miel",
                  "de": "Rösten mit einem Hauch Ahornsirup oder Honig",
                  "nl": "Roosteren met een vleugje ahornsiroop of honing"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Freezing in ice blocks",
                  "es": "Congelar en bloques de hielo",
                  "de": "In Eisblöcken einfrieren",
                  "nl": "Invriezen in ijsblokken"
        },
        {
                  "en": "Root cellaring for vegetables",
                  "es": "Almacenamiento en bodega para verduras",
                  "de": "Wurzelkeller für Gemüse",
                  "nl": "Wortelkelder voor groenten"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Importing all ingredients year-round",
                  "es": "Importar todos los ingredientes todo el año",
                  "de": "Das ganze Jahr über alle Zutaten importieren",
                  "nl": "Het hele jaar alle ingrediënten importeren"
        },
        {
                  "en": "Using only canned and processed foods",
                  "es": "Usar solo alimentos enlatados y procesados",
                  "de": "Nur Dosen- und verarbeitete Lebensmittel verwenden",
                  "nl": "Alleen ingeblikt en verwerkt voedsel gebruiken"
        },
        {
                  "en": "Avoiding fresh vegetables entirely",
                  "es": "Evitar verduras frescas por completo",
                  "de": "Frisches Gemüse völlig vermeiden",
                  "nl": "Verse groenten volledig vermijden"
        },
        {
                  "en": "Cooking with what grows naturally in each season",
                  "es": "Cocinar con lo que crece naturalmente en cada temporada",
                  "de": "Mit dem kochen, was natürlich in jeder Saison wächst",
                  "nl": "Koken met wat natuurlijk groeit in elk seizoen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Ramps (wild leeks)",
                  "es": "Rampas (puerros silvestres)",
                  "de": "Bärlauch (wilde Lauch)",
                  "nl": "Daslook (wilde prei)"
        },
        {
                  "en": "Watermelon",
                  "es": "Sandía",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Shorter cooking times",
                  "es": "Tiempos de cocción más cortos",
                  "de": "Kürzere Kochzeiten",
                  "nl": "Kortere kooktijden"
        },
        {
                  "en": "Higher temperatures only",
                  "es": "Solo temperaturas más altas",
                  "de": "Nur höhere Temperaturen",
                  "nl": "Alleen hogere temperaturen"
        },
        {
                  "en": "No adjustment needed",
                  "es": "No se necesita ajuste",
                  "de": "Keine Anpassung erforderlich",
                  "nl": "Geen aanpassing nodig"
        },
        {
                  "en": "Longer cooking times due to lower boiling point",
                  "es": "Tiempos de cocción más largos debido al punto de ebullición más bajo",
                  "de": "Längere Kochzeiten aufgrund des niedrigeren Siedepunkts",
                  "nl": "Langere kooktijden vanwege lager kookpunt"
        }
        ],
        correct: 3,
        explanation: {
