...
(function() {
  ...
  const level2 = {
    ...
    questions: [
      ...
      {
        question: {
          en: "What is 'tteokbokki' and where is it from?",
          es: "¿Qué es 'tteokbokki' y de dónde es?",
          de: "Was ist 'Tteokbokki' und woher kommt es?",
          nl: "Wat is 'tteokbokki' en waar komt het vandaan?"
        },
        options: [
          { en: "Japanese tempura", es: "Tempura japonesa", de: "Japanisches Tempura", nl: "Japanse tempura" },
          { en: "Korean spicy rice cakes", es: "Pasteles de arroz picantes coreanos", de: "Koreanische würzige Reiskuchen", nl: "Koreaanse pittige rijstkoeken" },
          { en: "Chinese dim sum", es: "Dim sum chino", de: "Chinesische Dim Sum", nl: "Chinese dim sum" },
          { en: "Thai sticky rice", es: "Arroz glutinoso tailandés", de: "Thailändischer Klebreis", nl: "Thaise plakrijst" }
        ],
        correct: 1,
        explanation: {
          en: "Tteokbokki is a popular Korean street food made of chewy rice cakes cooked in a spicy-sweet gochujang sauce, often served with fish cakes and boiled eggs.",
          es: "El tteokbokki es una comida callejera coreana popular hecha de pasteles de arroz masticables cocinados en una salsa de gochujang picante-dulce, a menudo servida con pasteles de pescado y huevos hervidos.",
          de: "Tteokbokki ist ein beliebtes koreanisches Straßenessen aus zähen Reiskuchen in einer würzig-süßen Gochujang-Sauce gekocht, oft mit Fischkuchen und gekochten Eiern serviert.",
          nl: "Tteokbokki is een populair Koreaans straatvoedsel gemaakt van taaie rijstkoeken gekookt in een pittig-zoete gochujang saus, vaak geserveerd met viskoeken en gekookte eieren."
        }
      },
      {
        question: {
          en: "Which Brazilian street food consists of fried pastry with savory filling?",
          es: "¿Qué comida callejera brasileña consiste en masa frita con relleno salado?",
          de: "Welches brasilianische Straßenessen besteht aus frittiertem Gebäck mit herzhafter Füllung?",
          nl: "Welk Braziliaans straatvoedsel bestaat uit gefrituurde pastei met hartige vulling?"
        },
        options: [
          { en: "Tacos", es: "Tacos", de: "Tacos", nl: "Tacos" },
          { en: "Pastel", es: "Pastel", de: "Pastel", nl: "Pastel" },
          { en: "Empanadas", es: "Empanadas", de: "Empanadas", nl: "Empanadas" },
          { en: "Tortillas", es: "Tortillas", de: "Tortillas", nl: "Tortillas" }
        ],
        correct: 1,
        explanation: {
          en: "Pastel is a traditional Brazilian street food consisting of a thin crispy fried pastry filled with various ingredients like cheese, meat, shrimp, or hearts of palm, commonly sold at street markets.",
          es: "El pastel es una comida callejera brasileña tradicional que consiste en una masa frita delgada y crujiente rellena de varios ingredientes como queso, carne, camarones o palmito, comúnmente vendida en mercados callejeros.",
          de: "Pastel ist ein traditionelles brasilianisches Straßenessen aus dünnem knusprigem frittierten Gebäck gefüllt mit verschiedenen Zutaten wie Käse, Fleisch, Garnelen oder Palmherzen, häufig auf Straßenmärkten verkauft.",
          nl: "Pastel is een traditioneel Braziliaans straatvoedsel bestaande uit een dunne knapperige gefrituurde pastei gevuld met verschillende ingrediënten zoals kaas, vlees, garnalen of palmharten, vaak verkocht op straatmarkten."
        }
      },
      {
        question: {
          en: "What is 'satay' and in which region is it popular?",
          es: "¿Qué es 'satay' y en qué región es popular?",
          de: "Was ist 'Satay' und in welcher Region ist es beliebt?",
          nl: "Wat is 'satay' en in welke regio is het populair?"
        },
        options: [
          { en: "European sausage", es: "Salchicha europea", de: "Europäische Wurst", nl: "Europese worst" },
          { en: "Southeast Asian grilled skewers", es: "Brochetas asadas del sudeste asiático", de: "Südostasiatische gegrillte Spieße", nl: "Zuidoost-Aziatische gegrilde spiesjes" },
          { en: "Middle Eastern falafel", es: "Falafel del Medio Oriente", de: "Nahöstliche Falafel", nl: "Midden-Oosterse falafel" },
          { en: "African stew", es: "Estofado africano", de: "Afrikanischer Eintopf", nl: "Afrikaanse stoofschotel" }
        ],
        correct: 1,
        explanation: {
          en: "Satay consists of grilled meat skewers served with peanut sauce, popular throughout Southeast Asia especially in Indonesia, Malaysia, Thailand, and Singapore.",
          es: "El satay consiste en brochetas de carne asadas servidas con salsa de maní, populares en todo el sudeste asiático especialmente en Indonesia, Malasia, Tailandia y Singapur.",
          de: "Satay besteht aus gegrillten Fleischspießen serviert mit Erdnusssauce, beliebt in ganz Südostasien besonders in Indonesien, Malaysia, Thailand und Singapur.",
          nl: "Satay bestaat uit gegrilde vleesspiesjes geserveerd met pindasaus, populair in heel Zuidoost-Azië vooral in Indonesië, Maleisië, Thailand en Singapore."
        }
      },
      {
        question: {
          en: "Which Moroccan street food is a slow-cooked stew?",
          es: "¿Qué comida callejera marroquí es un guiso cocinado a fuego lento?",
          de: "Welches marokkanische Straßenessen ist ein langsam gekochter Eintopf?",
          nl: "Welk Marokkaans straatvoedsel is een langzaam gekookte stoofschotel?"
        },
        options: [
          { en: "Couscous", es: "Cuscús", de: "Couscous", nl: "Couscous" },
          { en: "Tagine", es: "Tajine", de: "Tagine", nl: "Tajine" },
          { en: "Harira", es: "Harira", de: "Harira", nl: "Harira" },
          { en: "Falafel", es: "Falafel", de: "Falafel", nl: "Falafel" }
        ],
        correct: 1,
        explanation: {
          en: "Tagine is a Moroccan slow-cooked stew named after the conical earthenware pot it's cooked in, typically containing meat, vegetables, and aromatic spices, popular in street markets.",
          es: "El tajine es un guiso marroquí cocinado a fuego lento nombrado por la olla de barro cónica en la que se cocina, típicamente contiene carne, verduras y especias aromáticas, popular en mercados callejeros.",
          de: "Tagine ist ein marokkanischer langsam gekochter Eintopf, benannt nach dem konischen Tontopf, in dem er gekocht wird, enthält typischerweise Fleisch, Gemüse und aromatische Gewürze, beliebt auf Straßenmärkten.",
          nl: "Tajine is een Marokkaanse langzaam gekookte stoofschotel vernoemd naar de conische aardewerken pot waarin het wordt gekookt, bevat meestal vlees, groenten en aromatische kruiden, populair op straatmarkten."
        }
      },
      {
        question: {
          en: "What is 'poutine' and where did it originate?",
          es: "¿Qué es 'poutine' y de dónde se originó?",
          de: "Was ist 'Poutine' und wo hat es seinen Ursprung?",
          nl: "Wat is 'poutine' en waar komt het vandaan?"
        },
        options: [
          { en: "Canadian fries with gravy and cheese curds", es: "Papas fritas canadienses con salsa y queso cuajado", de: "Kanadische Pommes mit Soße und Käsebruch", nl: "Canadese friet met jus en wrongelkaas" },
          { en: "American hot dog", es: "Hot dog americano", de: "Amerikanischer Hot Dog", nl: "Amerikaanse hotdog" },
          { en: "British fish and chips", es: "Fish and chips británico", de: "Britisches Fish and Chips", nl: "Britse fish and chips" },
          { en: "French crepes", es: "Crepes francesas", de: "Französische Crêpes", nl: "Franse crêpes" }
        ],
        correct: 0,
        explanation: {
          en: "Poutine is a Canadian dish from Quebec consisting of french fries topped with cheese curds and brown gravy, now a popular street food throughout Canada and beyond.",
          es: "La poutine es un plato canadiense de Quebec que consiste en papas fritas cubiertas con queso cuajado y salsa marrón, ahora una comida callejera popular en todo Canadá y más allá.",
          de: "Poutine ist ein kanadisches Gericht aus Quebec bestehend aus Pommes frites belegt mit Käsebruch und brauner Soße, jetzt ein beliebtes Straßenessen in ganz Kanada und darüber hinaus.",
          nl: "Poutine is een Canadees gerecht uit Quebec bestaande uit friet bedekt met wrongelkaas en bruine jus, nu een populair straatvoedsel in heel Canada en daarbuiten."
        }
      },
      {
        question: {
          en: "Which Belgian street food consists of shellfish served in paper cones?",
          es: "¿Qué comida callejera belga consiste en mariscos servidos en conos de papel?",
          de: "Welches belgische Straßenessen besteht aus Schalentieren serviert in Papiertüten?",
          nl: "Welk Belgisch straatvoedsel bestaat uit schelpdieren geserveerd in papieren zakjes?"
        },
        options: [
          { en: "Mussels in buckets", es: "Mejillones en cubos", de: "Muscheln in Eimern", nl: "Mosselen in emmers" },
          { en: "Waffles with cream", es: "Gofres con crema", de: "Waffeln mit Sahne", nl: "Wafels met room" },
          { en: "Frites with mayo", es: "Papas fritas con mayonesa", de: "Pommes mit Mayo", nl: "Friet met mayo" },
          { en: "Whelks and shrimp in paper cones", es: "Buccinos y camarones en conos de papel", de: "Wellhornschnecken und Garnelen in Papiertüten", nl: "Wulken en garnalen in papieren zakjes" }
        ],
        correct: 3,
        explanation: {
          en: "Belgian street vendors traditionally serve cooked whelks and gray shrimp in paper cones, eaten with a toothpick, a classic seaside and market snack throughout Belgium.",
          es: "Los vendedores callejeros belgas tradicionalmente sirven buccinos cocidos y camarones grises en conos de papel, comidos con un palillo, un bocadillo clásico de costa y mercado en toda Bélgica.",
          de: "Belgische Straßenhändler servieren traditionell gekochte Wellhornschnecken und Nordseegarnelen in Papiertüten, mit einem Zahnstocher gegessen, ein klassischer Küsten- und Marktsnack in ganz Belgien.",
          nl: "Belgische straatverkopers serveren traditioneel gekookte wulken en grijze garnalen in papieren zakjes, gegeten met een tandenstoker, een klassieke kust- en marktsnack in heel België."
        }
      },
      {
        question: {
          en: "What is 'anticuchos' and where are they from?",
          es: "¿Qué son los 'anticuchos' y de dónde son?",
          de: "Was sind 'Anticuchos' und woher kommen sie?",
          nl: "Wat zijn 'anticuchos' en waar komen ze vandaan?"
        },
        options: [
          { en: "Mexican tacos", es: "Tacos mexicanos", de: "Mexikanische Tacos", nl: "Mexicaanse tacos" },
          { en: "Peruvian grilled beef heart skewers", es: "Brochetas peruanas de corazón de res asado", de: "Peruanische gegrillte Rinderherz-Spieße", nl: "Peruaanse gegrilde runderhartspiesjes" },
          { en: "Argentine empanadas", es: "Empanadas argentinas", de: "Argentinische Empanadas", nl: "Argentijnse empanadas" },
          { en: "Chilean seafood", es: "Mariscos chilenos", de: "Chilenische Meeresfrüchte", nl: "Chileense zeevruchten" }
        ],
        correct: 1,
        explanation: {
          en: "Anticuchos are Peruvian grilled skewers traditionally made from marinated beef heart, seasoned with spices and served with potatoes, a popular street food with pre-Columbian origins.",
          es: "Los anticuchos son brochetas peruanas asadas tradicionalmente hechas de corazón de res marinado, condimentadas con especias y servidas con papas, una comida callejera popular con orígenes precolombinos.",
          de: "Anticuchos sind peruanische gegrillte Spieße traditionell aus mariniertem Rinderherz, mit Gewürzen gewürzt und mit Kartoffeln serviert, ein beliebtes Straßenessen mit präkolumbianischen Ursprüngen.",
          nl: "Anticuchos zijn Peruaanse gegrilde spiesjes traditioneel gemaakt van gemarineerd runderhart, gekruid met specerijen en geserveerd met aardappelen, een populair straatvoedsel met pre-Columbiaanse oorsprong."
        }
      },
      {
        question: {
          en: "Which Egyptian street food is made from fava beans?",
          es: "¿Qué comida callejera egipcia está hecha de habas?",
          de: "Welches ägyptische Straßenessen wird aus Saubohnen gemacht?",
          nl: "Welk Egyptisch straatvoedsel is gemaakt van tuinbonen?"
        },
        options: [
          { en: "Hummus", es: "Hummus", de: "Hummus", nl: "Hummus" },
          { en: "Koshari", es: "Koshari", de: "Koshari", nl: "Koshari" },
          { en: "Ful medames", es: "Ful medames", de: "Ful Medames", nl: "Ful medames" },
          { en: "Shawarma", es: "Shawarma", de: "Shawarma", nl: "Shawarma" }
        ],
        correct: 2,
        explanation: {
          en: "Ful medames is an Egyptian dish of slow-cooked fava beans seasoned with olive oil, lemon, and garlic, served as a popular breakfast street food throughout Egypt and the Middle East.",
          es: "El ful medames es un plato egipcio de habas cocidas a fuego lento condimentadas con aceite de oliva, limón y ajo, servido como comida callejera popular del desayuno en todo Egipto y el Medio Oriente.",
          de: "Ful Medames ist ein ägyptisches Gericht aus langsam gekochten Saubohnen gewürzt mit Olivenöl, Zitrone und Knoblauch, serviert als beliebtes Frühstücks-Straßenessen in ganz Ägypten und dem Nahen Osten.",
          nl: "Ful medames is een Egyptisch gerecht van langzaam gekookte tuinbonen gekruid met olijfolie, citroen en knoflook, geserveerd als populair ontbijt straatvoedsel in heel Egypte en het Midden-Oosten."
        }
      },
      {
        question: {
          en: "What is 'okonomiyaki' and where is it from?",
          es: "¿Qué es 'okonomiyaki' y de dónde es?",
          de: "Was ist 'Okonomiyaki' und woher kommt es?",
          nl: "Wat is 'okonomiyaki' en waar komt het vandaan?"
        },
        options: [
          { en: "Korean kimchi pancake", es: "Panqueque de kimchi coreano", de: "Koreanischer Kimchi-Pfannkuchen", nl: "Koreaanse kimchi pannenkoek" },
          { en: "Japanese savory pancake", es: "Panqueque salado japonés", de: "Japanischer herzhafter Pfannkuchen", nl: "Japanse hartige pannenkoek" },
          { en: "Chinese scallion pancake", es: "Panqueque de cebolleta china", de: "Chinesischer Frühlingszwiebel-Pfannkuchen", nl: "Chinese lente-uitjes pannenkoek" },
          { en: "Thai coconut crepe", es: "Crepe de coco tailandés", de: "Thailändischer Kokosnuss-Crêpe", nl: "Thaise kokoscrêpe" }
        ],
        correct: 1,
        explanation: {
          en: "Okonomiyaki is a Japanese savory pancake containing cabbage, meat or seafood, topped with sauce, mayo, and bonito flakes, popular street food from Osaka and Hiroshima regions.",
          es: "El okonomiyaki es un panqueque salado japonés que contiene repollo, carne o mariscos, cubierto con salsa, mayonesa y copos de bonito, comida callejera popular de las regiones de Osaka y Hiroshima.",
          de: "Okonomiyaki ist ein japanischer herzhafter Pfannkuchen mit Kohl, Fleisch oder Meeresfrüchten, belegt mit Sauce, Mayo und Bonito-Flocken, beliebtes Straßenessen aus den Regionen Osaka und Hiroshima.",
          nl: "Okonomiyaki is een Japanse hartige pannenkoek met kool, vlees of zeevruchten, bedekt met saus, mayo en bonitoschilfers, populair straatvoedsel uit de regio's Osaka en Hiroshima."
        }
      },
      {
        question: {
          en: "Which Polish street food is a ring-shaped bread topped with various seeds?",
          es: "¿Qué comida callejera polaca es un pan en forma de anillo cubierto con varias semillas?",
          de: "Welches polnische Straßenessen ist ein ringförmiges Brot mit verschiedenen Samen belegt?",
          nl: "Welk Pools straatvoedsel is een ringvormig brood bedekt met verschillende zaden?"
        },
        options: [
          { en: "Pierogi", es: "Pierogi", de: "Pierogi", nl: "Pierogi" },
          { en: "Kielbasa", es: "Kielbasa", de: "Kielbasa", nl: "Kielbasa" },
          { en: "Obwarzanek", es: "Obwarzanek", de: "Obwarzanek", nl: "Obwarzanek" },
          { en: "Bigos", es: "Bigos", de: "Bigos", nl: "Bigos" }
        ],
        correct: 2,
        explanation: {
          en: "Obwarzanek is a traditional Polish braided ring-shaped bread boiled then baked and topped with poppy seeds, sesame, or salt, popular street food especially in Krakow since medieval times.",
          es: "El obwarzanek es un pan polaco tradicional trenzado en forma de anillo hervido y luego horneado y cubierto con semillas de amapola, sésamo o sal, comida callejera popular especialmente en Cracovia desde tiempos medievales.",
          de: "Obwarzanek ist ein traditionelles polnisches geflochtenes ringförmiges Brot, gekocht dann gebacken und belegt mit Mohnsamen, Sesam oder Salz, beliebtes Straßenessen besonders in Krakau seit dem Mittelalter.",
          nl: "Obwarzanek is een traditioneel Pools gevlochten ringvormig brood gekookt en dan gebakken en bedekt met maanzaad, sesam of zout, populair straatvoedsel vooral in Krakau sinds de middeleeuwen."
        }
      },
      {
        question: {
          en: "What is 'empanadas' and where are they commonly found?",
          es: "¿Qué son las 'empanadas' y dónde se encuentran comúnmente?",
          de: "Was sind 'Empanadas' und wo findet man sie häufig?",
          nl: "Wat zijn 'empanadas' en waar worden ze vaak gevonden?"
        },
        options: [
          { en: "Asian dumplings", es: "Dumplings asiáticos", de: "Asiatische Dumplings", nl: "Aziatische dumplings" },
          { en: "European pastries", es: "Pasteles europeos", de: "Europäische Gebäcke", nl: "Europese gebakjes" },
          { en: "Latin American stuffed pastries", es: "Pasteles rellenos latinoamericanos", de: "Lateinamerikanische gefüllte Teigtaschen", nl: "Latijns-Amerikaanse gevulde pasteitjes" },
          { en: "African flatbreads", es: "Panes planos africanos", de: "Afrikanische Fladenbrote", nl: "Afrikaanse platbroden" }
        ],
        correct: 2,
        explanation: {
          en: "Empanadas are baked or fried pastries filled with meat, cheese, or vegetables, popular throughout Latin America and Spain, with each region having its own unique variations and fillings.",
          es: "Las empanadas son pasteles horneados o fritos rellenos de carne, queso o verduras, populares en toda América Latina y España, con cada región teniendo sus propias variaciones y rellenos únicos.",
          de: "Empanadas sind gebackene oder frittierte Teigtaschen gefüllt mit Fleisch, Käse oder Gemüse, beliebt in ganz Lateinamerika und Spanien, wobei jede Region ihre eigenen einzigartigen Variationen und Füllungen hat.",
          nl: "Empanadas zijn gebakken of gefrituurde pasteitjes gevuld met vlees, kaas of groenten, populair in heel Latijns-Amerika en Spanje, waarbij elke regio zijn eigen unieke variaties en vullingen heeft."
        }
      },
      {
        question: {
          en: "Which Singaporean street food features rice cooked in chicken broth?",
          es: "¿Qué comida callejera de Singapur presenta arroz cocinado en caldo de pollo?",
          de: "Welches singapurische Straßenessen enthält Reis gekocht in Hühnerbrühe?",
          nl: "Welk Singaporees straatvoedsel bevat rijst gekookt in kippenbouillon?"
        },
        options: [
          { en: "Laksa", es: "Laksa", de: "Laksa", nl: "Laksa" },
          { en: "Hainanese chicken rice", es: "Arroz con pollo hainanés", de: "Hainanesisches Hühnerreis", nl: "Hainanese kiprijst" },
          { en: "Char kway teow", es: "Char kway teow", de: "Char Kway Teow", nl: "Char kway teow" },
          { en: "Satay bee hoon", es: "Satay bee hoon", de: "Satay Bee Hoon", nl: "Satay bee hoon" }
        ],
        correct: 1,
        explanation: {
          en: "Hainanese chicken rice is Singapore's national dish featuring poached chicken served with fragrant rice cooked in chicken broth, accompanied by chili sauce and ginger paste, sold at hawker centers nationwide.",
          es: "El arroz con pollo hainanés es el plato nacional de Singapur que presenta pollo escalfado servido con arroz fragante cocinado en caldo de pollo, acompañado de salsa de chile y pasta de jengibre, vendido en centros de vendedores en todo el país.",
          de: "Hainanesisches Hühnerreis ist Singapurs Nationalgericht mit pochiertem Huhn serviert mit duftendem Reis gekocht in Hühnerbrühe, begleitet von Chili-Sauce und Ingwerpaste, verkauft in Hawker-Zentren landesweit.",
          nl: "Hainanese kiprijst is Singapore's nationale gerecht met gepocheerd kip geserveerd met geurige rijst gekookt in kippenbouillon, vergezeld van chilisaus en gemberpasta, verkocht bij hawker centers in het hele land."
        }
      }
    ]
  };
