  ...
  const level4 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { en: "Hot and fast (300°F+) cooks faster but may sacrifice some tenderness; low and slow (225-250°F) takes longer but breaks down connective tissue better", es: "Caliente y rápido (300°F+) cocina más rápido pero sacrifica ternura; bajo y lento (225-250°F) toma más tiempo pero descompone mejor tejido conectivo", de: "Heiß und schnell (300°F+) kocht schneller opfert Zartheit; niedrig und langsam (225-250°F) dauert länger baut Bindegewebe besser ab", nl: "Heet en snel (300°F+) kookt sneller maar kan wat malheid opofferen; laag en langzaam (225-250°F) duurt langer maar breekt bindweefsel beter af" },
      ...
      },
      {
        question: {
          ...
          nl: "Waar verwijst 'money muscle' naar in competitie pulled pork?"
        },
        options: [
          { en: "The lollipop-shaped end of pork butt, most tender and flavorful section", es: "El extremo en forma de piruleta del pork butt, la sección más tierna y sabrosa", de: "Das lutscher-förmige Ende des Schweinerückens, zartester und geschmackvollster Bereich", nl: "Het lolly-vormige uiteinde van pork butt, meest malse en smaakvolle sectie" },
          { en: "The most expensive cut of pork", es: "El corte de cerdo más caro", de: "Das teuerste Schweinefleischstück", nl: "Het duurste stuk varkensvlees" },
          { en: "The prize-winning presentation cut", es: "El corte de presentación ganador del premio", de: "Der preisgekrönte Präsentationsschnitt", nl: "De prijswinnende presentatie snede" },
          { en: "Any perfectly cooked section", es: "Cualquier sección perfectamente cocida", de: "Jeder perfekt gekochte Bereich", nl: "Elke perfect gekookte sectie" }
        ],
        correct: 0,
        explanation: {
          en: "The 'money muscle' is the teres major muscle at the end of a pork butt that separates easily into a lollipop or tear-drop shape. It's the most tender, flavorful section and highly prized in competition barbecue for its perfect presentation and taste.",
          es: "El 'money muscle' es el músculo teres major al final del pork butt que se separa fácilmente en forma de piruleta o lágrima. Es la sección más tierna y sabrosa y muy valorada en barbacoa de competencia por su perfecta presentación y sabor.",
          de: "Der 'Money Muscle' ist der Teres-Major-Muskel am Ende eines Schweinerückens, der sich leicht in Lutscher- oder Tropfenform trennt. Er ist der zarteste, geschmackvollste Bereich und bei Wettkampf-Barbecue wegen perfekter Präsentation und Geschmack hoch geschätzt.",
          nl: "De 'money muscle' is de teres major spier aan het einde van een pork butt die gemakkelijk scheidt in een lolly of traan-vorm. Het is de meest malse, smaakvolle sectie en zeer gewaardeerd in competitie barbecue voor zijn perfecte presentatie en smaak."
        }
      },
      {
        question: {
          en: "What is the purpose of 'slathering' meat before applying dry rub?",
          es: "¿Cuál es el propósito de 'untar' carne antes de aplicar dry rub?",
          de: "Was ist der Zweck des 'Bestreichens' von Fleisch vor dem Auftragen von Dry Rub?",
          nl: "Wat is het doel van 'smeren' van vlees voor het aanbrengen van dry rub?"
        },
        options: [
          { en: "Helps rub adhere to meat surface, often uses mustard or oil as binder", es: "Ayuda a que el rub se adhiera a la superficie de la carne, a menudo usa mostaza o aceite como aglutinante", de: "Hilft Rub an Fleischoberfläche zu haften, verwendet oft Senf oder Öl als Bindemittel", nl: "Helpt rub aan vlees oppervlak te hechten, gebruikt vaak mosterd of olie als bindmiddel" },
          { en: "Adds extra moisture during cooking", es: "Añade humedad extra durante la cocción", de: "Fügt zusätzliche Feuchtigkeit während des Kochens hinzu", nl: "Voegt extra vocht toe tijdens het koken" },
          { en: "Prevents the meat from sticking to the grates", es: "Previene que la carne se pegue a las rejillas", de: "Verhindert das Ankleben des Fleisches an den Rosten", nl: "Voorkomt dat vlees aan de roosters plakt" },
          { en: "Speeds up bark formation", es: "Acelera la formación de bark", de: "Beschleunigt Bark-Bildung", nl: "Versnelt bark vorming" }
        ],
        correct: 0,
        explanation: {
          en: "Slathering meat with a thin layer of mustard, oil, or other binder before applying dry rub helps the seasoning adhere to the meat surface better. The binder cooks off completely, leaving no taste, but ensures even rub coverage and better bark development.",
