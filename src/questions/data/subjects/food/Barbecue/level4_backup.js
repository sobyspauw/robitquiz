    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Ceramic egg-shaped cooker with excellent heat retention and airflow control",
                  "es": "Cocinero de cerámica en forma de huevo con excelente retención de calor y control de flujo de aire",
                  "de": "Keramischer eiförmiger Kocher mit ausgezeichneter Wärmespeicherung und Luftstromkontrolle",
                  "nl": "Keramische eivormige kooktoestel met uitstekende warmte retentie en luchtstroom controle"
        },
        {
                  "en": "Japanese grilling over open flames",
                  "es": "Asado japonés sobre llamas abiertas",
                  "de": "Japanisches Grillen über offenen Flammen",
                  "nl": "Japans grillen boven open vlammen"
        },
        {
                  "en": "Smoking with sake-soaked wood",
                  "es": "Ahumar con madera empapada en sake",
                  "de": "Räuchern mit Sake-getränktem Holz",
                  "nl": "Roken met sake-doordrenkt hout"
        },
        {
                  "en": "Using only bamboo charcoal",
                  "es": "Usar solo carbón de bambú",
                  "de": "Nur Bambuskohle verwenden",
                  "nl": "Alleen bamboe houtskool gebruiken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pork ribs with mustard-based sauce",
                  "es": "Costillas de cerdo con salsa a base de mostaza",
                  "de": "Schweinerippchen mit senfbasierter Sauce",
                  "nl": "Varkensribs met op mosterd gebaseerde saus"
        },
        {
                  "en": "Whole hog over mesquite",
                  "es": "Cerdo entero sobre mezquite",
                  "de": "Ganzes Schwein über Mesquite",
                  "nl": "Heel varken over mesquite"
        },
        {
                  "en": "Chicken smoked with fruit woods",
                  "es": "Pollo ahumado con maderas de frutas",
                  "de": "Hähnchen mit Obstholz geräuchert",
                  "nl": "Kip gerookt met fruithouten"
        },
        {
                  "en": "Tri-tip beef grilled over red oak coals with simple salt, pepper, and garlic seasoning",
                  "es": "Tri-tip de res asado sobre carbones de roble rojo con condimento simple de sal, pimienta y ajo",
                  "de": "Tri-Tip Rindfleisch über roten Eichenkohlen gegrillt mit einfacher Salz-, Pfeffer- und Knoblauch-Würzung",
                  "nl": "Tri-tip rundvlees gegrild over rode eiken kolen met eenvoudige zout, peper en knoflook kruiding"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Test flexibility of individual bones",
        ...
        {
                  "en": "Check how much the meat bends when pressed",
                  "es": "Verificar cuánto se dobla la carne al presionar",
                  "de": "Prüfen wie sehr sich das Fleisch beim Drücken biegt",
                  "nl": "Controleren hoeveel het vlees buigt bij druk"
        },
        {
                  "en": "Bend the rib rack in half",
                  "es": "Doblar la rejilla de costillas por la mitad",
                  "de": "Das Rippengestell in der Mitte biegen",
                  "nl": "Het rib rek doormidden buigen"
        },
        {
                  "en": "Pick up ribs with tongs - they should bend and crack slightly but not break",
                  "es": "Levantar costillas con pinzas - deben doblarse y agrietarse ligeramente pero no romperse",
                  "de": "Rippen mit Zange aufheben - sie sollten sich biegen und leicht reißen aber nicht brechen",
                  "nl": "Ribs oppakken met tang - ze moeten buigen en licht scheuren maar niet breken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Burnt ends are cubed point muscle, re-seasoned and smoked until caramelized",
                  "es": "Los burnt ends son músculo point en cubos, re-sazonado y ahumado hasta caramelizar",
                  "de": "Burnt Ends sind gewürfelte Point-Muskeln, neu gewürzt und geräuchert bis karamelisiert",
                  "nl": "Burnt ends zijn blokjes point spier, opnieuw gekruid en gerookt tot gekarameliseerd"
        },
        {
                  "en": "They're cooked at higher temperature",
                  "es": "Se cocinan a temperatura más alta",
                  "de": "Sie werden bei höherer Temperatur gekocht",
                  "nl": "Ze worden op hogere temperatuur gekookt"
        },
        {
                  "en": "They're just overcooked brisket pieces",
                  "es": "Son solo pedazos de brisket sobrecocidos",
                  "de": "Sie sind nur übergekochte Brisketstücke",
                  "nl": "Het zijn gewoon overbereide brisket stukken"
        },
        {
                  "en": "Burnt ends use a different cut of beef",
                  "es": "Los burnt ends usan un corte diferente de res",
                  "de": "Burnt Ends verwenden einen anderen Rindfleisch-Schnitt",
                  "nl": "Burnt ends gebruiken een andere snit rundvlees"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "White wine reduction sauce",
                  "es": "Salsa de reducción de vino blanco",
                  "de": "Weißwein-Reduktionssauce",
                  "nl": "Witte wijn reductie saus"
        },
        {
                  "en": "Buttermilk marinade",
                  "es": "Marinada de suero de leche",
                  "de": "Buttermilch-Marinade",
                  "nl": "Karnemelk marinade"
        },
        {
                  "en": "Mayonnaise-based sauce with vinegar and spices, traditionally used on chicken",
                  "es": "Salsa a base de mayonesa con vinagre y especias, tradicionalmente usada en pollo",
                  "de": "Mayonnaise-basierte Sauce mit Essig und Gewürzen, traditionell für Hähnchen verwendet",
                  "nl": "Op mayonaise gebaseerde saus met azijn en kruiden, traditioneel gebruikt voor kip"
        },
        {
                  "en": "Cream-based sauce for pork",
                  "es": "Salsa a base de crema para cerdo",
                  "de": "Sahne-basierte Sauce für Schwein",
                  "nl": "Op room gebaseerde saus voor varkensvlees"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The toothpick should come out clean",
                  "es": "El palillo debe salir limpio",
                  "de": "Der Zahnstocher sollte sauber herauskommen",
                  "nl": "De tandenstoker moet schoon uitkomen"
        },
        {
                  "en": "You should feel strong resistance",
                  "es": "Debes sentir resistencia fuerte",
                  "de": "Du solltest starken Widerstand spüren",
                  "nl": "Je moet sterke weerstand voelen"
        },
        {
                  "en": "A toothpick should slide in and out with little resistance, like probing warm butter",
                  "es": "Un palillo debe deslizarse dentro y fuera con poca resistencia, como sondear mantequilla tibia",
                  "de": "Ein Zahnstocher sollte mit geringem Widerstand hinein- und herausgleiten, wie beim Sondieren warmer Butter",
                  "nl": "Een tandenstoker moet met weinig weerstand in en uit glijden, zoals het sonderen van warme boter"
        },
        {
                  "en": "The toothpick should break when inserted",
                  "es": "El palillo debe romperse al insertarse",
                  "de": "Der Zahnstocher sollte beim Einführen brechen",
                  "nl": "De tandenstoker moet breken bij inbrengen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  "en": "Beef brisket",
                  "es": "Pecho de res",
                  "de": "Rindfleisch-Brisket",
                  "nl": "Rundvlees brisket"
        },
        {
                  "en": "Pulled pork and whole hog barbecue",
                  "es": "Pulled pork y barbacoa de cerdo entero",
                  "de": "Pulled Pork und Ganzes-Schwein-Barbecue",
                  "nl": "Pulled pork en heel varken barbecue"
        },
        {
                  "en": "Smoked fish",
                  "es": "Pescado ahumado",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cool down the meat slowly",
                  "es": "Enfriar la carne lentamente",
                  "de": "Das Fleisch langsam abkühlen",
                  "nl": "Het vlees langzaam afkoelen"
        },
        {
                  "en": "Alternate between high and low heat",
                  "es": "Alternar entre calor alto y bajo",
                  "de": "Zwischen hoher und niedriger Hitze wechseln",
                  "nl": "Afwisselen tussen hoge en lage hitte"
        },
        {
                  "en": "Gradually increase temperature to push through the stall and finish faster",
                  "es": "Aumentar gradualmente la temperatura para empujar a través del estancamiento y terminar más rápido",
                  "de": "Temperatur schrittweise erhöhen um durch den Stall zu drücken und schneller zu beenden",
                  "nl": "Geleidelijk temperatuur verhogen om door de stall heen te duwen en sneller af te werken"
        },
        {
                  "en": "Maintain exact temperature throughout",
                  "es": "Mantener temperatura exacta durante todo",
                  "de": "Genaue Temperatur durchgehend halten",
                  "nl": "Exacte temperatuur gedurende aanhouden"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The owner of a barbecue restaurant",
                  "es": "El dueño de un restaurante de barbacoa",
                  "de": "Der Besitzer eines Barbecue-Restaurants",
                  "nl": "De eigenaar van een barbecue restaurant"
        },
        {
                  "en": "Someone who judges barbecue competitions",
                  "es": "Alguien que juzga competencias de barbacoa",
                  "de": "Jemand, der Barbecue-Wettbewerbe beurteilt",
                  "nl": "Iemand die barbecue competities beoordeelt"
        },
        {
                  "en": "The experienced person responsible for managing the fire and cooking process",
                  "es": "La persona experimentada responsable de manejar el fuego y el proceso de cocción",
                  "de": "Die erfahrene Person, die für das Verwalten des Feuers und Kochprozesses verantwortlich ist",
                  "nl": "De ervaren persoon verantwoordelijk voor het beheren van het vuur en kookproces"
        },
        {
                  "en": "A type of barbecue sauce maker",
                  "es": "Un tipo de fabricante de salsa barbacoa",
                  "de": "Eine Art Barbecue-Sauce-Hersteller",
                  "nl": "Een soort barbecue saus maker"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hot and fast (300°F+) cooks faster but may sacrifice some tenderness; low and slow (225-250°F) takes longer but breaks down connective tissue better",
                  "es": "Caliente y rápido (300°F+) cocina más rápido pero puede sacrificar algo de ternura; bajo y lento (225-250°F) toma más tiempo pero descompone mejor el tejido conectivo",
                  "de": "Heiß und schnell (300°F+) kocht schneller aber kann etwas Zartheit opfern; niedrig und langsam (225-250°F) dauert länger aber baut Bindegewebe besser ab",
                  "nl": "Heet en snel (300°F+) kookt sneller maar kan wat malheid opofferen; laag en langzaam (225-250°F) duurt langer maar breekt bindweefsel beter af"
        },
        {
                  "en": "Low and slow uses more wood",
                  "es": "Bajo y lento usa más madera",
                  "de": "Niedrig und langsam verwendet mehr Holz",
                  "nl": "Laag en langzaam gebruikt meer hout"
        },
        {
                  "en": "There's no real difference in results",
                  "es": "No hay diferencia real en los resultados",
                  "de": "Es gibt keinen wirklichen Unterschied in den Ergebnissen",
                  "nl": "Er is geen echt verschil in resultaten"
        },
        {
                  "en": "Hot and fast only works for beef",
                  "es": "Caliente y rápido solo funciona para res",
                  "de": "Heiß und schnell funktioniert nur für Rindfleisch",
                  "nl": "Heet en snel werkt alleen voor rundvlees"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Wrapping meat in butcher paper; it's breathable so maintains better bark texture than foil",
                  "es": "Envolver carne en papel de carnicero; es transpirable así mantiene mejor textura de corteza que el papel aluminio",
                  "de": "Fleisch in Metzgerpapier wickeln; es ist atmungsaktiv und erhält bessere Rindentextur als Folie",
                  "nl": "Vlees inwikkelen in slagerspapier; het is ademend dus behoudt betere korst textuur dan folie"
        },
        {
                  "en": "Wrapping only with parchment paper",
                  "es": "Envolver solo con papel pergamino",
                  "de": "Nur mit Pergamentpapier wickeln",
                  "nl": "Alleen inwikkelen met bakpapier"
        },
        {
                  "en": "Using paper towels to dry the meat",
                  "es": "Usar toallas de papel para secar la carne",
                  "de": "Papiertücher zum Trocknen des Fleisches verwenden",
                  "nl": "Papieren handdoeken gebruiken om vlees te drogen"
        },
        {
                  "en": "Using newspaper instead of foil",
                  "es": "Usar periódico en lugar de papel aluminio",
                  "de": "Zeitungspapier statt Folie verwenden",
                  "nl": "Krant gebruiken in plaats van folie"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Burnt ends - cubed, caramelized pieces of brisket point",
                  "es": "Burnt ends - pedazos en cubos y caramelizados de point de brisket",
                  "de": "Burnt Ends - gewürfelte, karamelisierte Stücke von Brisket Point",
                  "nl": "Burnt ends - blokjes, gekarameliseerde stukken van brisket point"
        },
        {
                  "en": "Spicy barbecue sauce with black pepper",
                  "es": "Salsa barbacoa picante con pimienta negra",
                  "de": "Scharfe Barbecue-Sauce mit schwarzem Pfeffer",
                  "nl": "Pittige barbecue saus met zwarte peper"
        },
        {
                  "en": "A black bean salad served with barbecue",
                  "es": "Una ensalada de frijoles negros servida con barbacoa",
                  "de": "Ein schwarzer Bohnensalat, der mit Barbecue serviert wird",
                  "nl": "Een zwarte bonen salade geserveerd met barbecue"
        },
        {
                  "en": "Charred corn kernels",
                  "es": "Granos de maíz carbonizados",
                  "de": "Verkohlte Maiskörner",
                  "nl": "Verkoold maïs korrels"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "90/10 (90% lean, 10% fat)",
                  "es": "90/10 (90% magro, 10% grasa)",
                  "de": "90/10 (90% mager, 10% Fett)",
                  "nl": "90/10 (90% mager, 10% vet)"
        },
        {
                  "en": "70/30 (70% lean, 30% fat)",
                  "es": "70/30 (70% magro, 30% grasa)",
                  "de": "70/30 (70% mager, 30% Fett)",
                  "nl": "70/30 (70% mager, 30% vet)"
        },
        {
                  "en": "95/5 (95% lean, 5% fat)",
                  "es": "95/5 (95% magro, 5% grasa)",
                  "de": "95/5 (95% mager, 5% Fett)",
                  "nl": "95/5 (95% mager, 5% vet)"
        },
        {
                  "en": "80/20 (80% lean, 20% fat)",
                  "es": "80/20 (80% magro, 20% grasa)",
                  "de": "80/20 (80% mager, 20% Fett)",
                  "nl": "80/20 (80% mager, 20% vet)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cutting the brisket into competition-sized portions",
                  "es": "Cortar el brisket en porciones de tamaño de competencia",
                  "de": "Das Brisket in wettkampfgroße Portionen schneiden",
                  "nl": "De brisket snijden in competitie-grootte porties"
        },
        {
                  "en": "Precise trimming of fat to ¼ inch, removing hard fat, and shaping for optimal presentation and cooking",
                  "es": "Recorte preciso de grasa a ¼ pulgada, removiendo grasa dura, y moldeando para presentación y cocción óptimas",
                  "de": "Präzises Trimmen von Fett auf ¼ Zoll, Entfernung hartem Fett, und Formen für optimale Präsentation und Kochen",
                  "nl": "Precieze afwerking van vet tot ¼ inch, harde vet verwijderen, en vorm geven voor optimale presentatie en koken"
        },
        {
                  "en": "Marinating the brisket for competition",
                  "es": "Marinar el brisket para competencia",
                  "de": "Das Brisket für den Wettbewerb marinieren",
                  "nl": "De brisket marineren voor competitie"
        },
        {
                  "en": "Removing all fat from the brisket",
                  "es": "Quitar toda la grasa del brisket",
                  "de": "Alles Fett vom Brisket entfernen",
                  "nl": "Al het vet van de brisket verwijderen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Coleslaw and baked beans",
                  "es": "Ensalada de col y frijoles horneados",
                  "de": "Krautsalat und gebackene Bohnen",
                  "nl": "Koolsla en gebakken bonen"
        },
        {
                  "en": "Corn bread and mashed potatoes",
                  "es": "Pan de maíz y puré de papas",
                  "de": "Maisbrot und Kartoffelpüree",
                  "nl": "Maïsbrood en aardappelpuree"
        },
        {
                  "en": "French fries and salad",
                  "es": "Papas fritas y ensalada",
                  "de": "Pommes frites und Salat",
                  "nl": "Friet en salade"
        },
        {
                  "en": "White bread, pickles, and onions - sauce served on the side",
                  "es": "Pan blanco, pepinillos y cebollas - salsa servida aparte",
                  "de": "Weißbrot, Gurken und Zwiebeln - Sauce separat serviert",
                  "nl": "Wit brood, augurken en uien - saus apart geserveerd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creating a foil boat to collect juices while allowing the top to remain exposed to smoke",
                  "es": "Crear un bote de papel aluminio para recoger jugos mientras permite que la parte superior permanezca expuesta al humo",
                  "de": "Ein Foilboot erstellen um Säfte zu sammeln während die Oberseite dem Rauch ausgesetzt bleibt",
                  "nl": "Een folie boot maken om sappen te verzamelen terwijl de bovenkant blootgesteld blijft aan rook"
        },
        {
                  "en": "Wrapping meat completely in foil",
                  "es": "Envolver carne completamente en papel aluminio",
                  "de": "Fleisch vollständig in Folie wickeln",
                  "nl": "Vlees volledig inwikkelen in folie"
        },
        {
                  "en": "Covering only the bottom of the meat",
                  "es": "Cubrir solo la parte inferior de la carne",
                  "de": "Nur die Unterseite des Fleisches bedecken",
                  "nl": "Alleen de onderkant van het vlees bedekken"
        },
        {
                  "en": "Using foil to reflect heat",
                  "es": "Usar papel aluminio para reflejar calor",
                  "de": "Folie verwenden um Hitze zu reflektieren",
                  "nl": "Folie gebruiken om hitte te reflecteren"
        }
        ],
        correct: 0,
        explanation: {
