    ...
    const level6Questions = [
{
            question: {
                ...
                de: "Was ist die Schlüsseltechnik für authentisches Cacio e Pepe?",
                nl: "Wat is de belangrijkste techniek voor authentieke cacio e pepe?"
            },
            options: {
                en: [
                    "Emulsifying pasta water with pecorino without cream using temperature control",
                    "Adding heavy cream to melt the cheese smoothly",
                    "Using parmesan instead of pecorino for better melting",
                    "Cooking the cheese directly in boiling water"
                ],
                es: [
                    "Emulsionar el agua de pasta con pecorino sin nata usando control de temperatura",
                    "Añadir nata espesa para derretir el queso suavemente",
                    "Usar parmesano en lugar de pecorino para mejor fundido",
                    "Cocinar el queso directamente en agua hirviendo"
                ],
                de: [
                    "Emulgieren von Nudelwasser mit Pecorino ohne Sahne unter Temperaturkontrolle",
                    "Schwere Sahne hinzufügen, um den Käse gleichmäßig zu schmelzen",
                    "Parmesan statt Pecorino für besseres Schmelzen verwenden",
                    "Den Käse direkt in kochendem Wasser garen"
                ],
                nl: [
                    "Pasta water emulgeren met pecorino zonder room met temperatuurcontrole",
                    "Slagroom toevoegen om de kaas soepel te smelten",
                    "Parmezaan gebruiken in plaats van pecorino voor beter smelten",
                    "De kaas direct in kokend water koken"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Authentic cacio e pepe requires emulsifying starchy pasta water with grated pecorino romano at the right temperature (not too hot or the cheese will clump). No cream is ever used in the traditional Roman recipe - the creaminess comes from the emulsion itself.",
                es: "El auténtico cacio e pepe requiere emulsionar el agua almidonada de la pasta con pecorino romano rallado a la temperatura correcta (no demasiado caliente o el queso se apelmazará). Nunca se usa nata en la receta tradicional romana - la cremosidad viene de la emulsión misma.",
                de: "Authentisches Cacio e Pepe erfordert das Emulgieren von stärkehaltigem Nudelwasser mit geriebenem Pecorino Romano bei der richtigen Temperatur (nicht zu heiß, sonst klumpt der Käse). In der traditionellen römischen Rezeptur wird nie Sahne verwendet - die Cremigkeit kommt von der Emulsion selbst.",
                nl: "Authentieke cacio e pepe vereist het emulgeren van zetmeelrijk pastawater met geraspte pecorino romano op de juiste temperatuur (niet te heet anders klontert de kaas). Er wordt nooit room gebruikt in het traditionele Romeinse recept - de romigheid komt van de emulsie zelf."
            }
        },
        {
            question: {
                en: "What is the historical debate surrounding pasta all'amatriciana?",
                es: "¿Cuál es el debate histórico en torno a la pasta all'amatriciana?",
                de: "Was ist die historische Debatte um Pasta all'Amatriciana?",
                nl: "Wat is het historische debat rond pasta all'amatriciana?"
            },
            options: {
                en: [
                    "Whether to use guanciale vs pancetta and when tomatoes were added to the original recipe",
                    "Whether it originated in Naples or Rome",
                    "Whether to use penne or spaghetti",
                    "Whether to add garlic or not"
                ],
                es: [
                    "Si usar guanciale vs panceta y cuándo se añadieron tomates a la receta original",
                    "Si se originó en Nápoles o Roma",
                    "Si usar penne o espaguetis",
                    "Si añadir ajo o no"
                ],
                de: [
                    "Ob man Guanciale vs. Pancetta verwendet und wann Tomaten zum Originalrezept hinzugefügt wurden",
                    "Ob es in Neapel oder Rom entstanden ist",
                    "Ob man Penne oder Spaghetti verwendet",
                    "Ob man Knoblauch hinzufügt oder nicht"
                ],
                nl: [
                    "Of je guanciale vs pancetta gebruikt en wanneer tomaten aan het originele recept werden toegevoegd",
                    "Of het in Napels of Rome is ontstaan",
                    "Of je penne of spaghetti gebruikt",
                    "Of je knoflook toevoegt of niet"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Traditional amatriciana uses guanciale (cured pork cheek), not pancetta. The original 'gricia' from Amatrice had no tomato; tomatoes were added in the 18th-19th century after they arrived from the Americas and became popular in Italian cuisine.",
                es: "La amatriciana tradicional usa guanciale (mejilla de cerdo curada), no panceta. La 'gricia' original de Amatrice no tenía tomate; los tomates se añadieron en los siglos XVIII-XIX después de llegar de las Américas y popularizarse en la cocina italiana.",
                de: "Traditionelle Amatriciana verwendet Guanciale (gepökelte Schweinebacke), nicht Pancetta. Die ursprüngliche 'Gricia' aus Amatrice hatte keine Tomate; Tomaten wurden im 18.-19. Jahrhundert hinzugefügt, nachdem sie aus Amerika kamen und in der italienischen Küche populär wurden.",
                nl: "Traditionele amatriciana gebruikt guanciale (gezouten varkenskaak), geen pancetta. De originele 'gricia' uit Amatrice had geen tomaat; tomaten werden in de 18e-19e eeuw toegevoegd nadat ze uit Amerika kwamen en populair werden in de Italiaanse keuken."
            }
        },
        {
            question: {
                en: "What are bigoli and what is their traditional pairing?",
                es: "¿Qué son los bigoli y cuál es su combinación tradicional?",
                de: "Was sind Bigoli und was ist ihre traditionelle Kombination?",
                nl: "Wat zijn bigoli en wat is hun traditionele combinatie?"
            },
            options: {
                en: [
                    "Thick whole-wheat pasta from Veneto traditionally served with duck ragù",
                    "Thin angel hair pasta from Tuscany with seafood",
                    "Stuffed pasta from Emilia-Romagna with cream sauce",
                    "Rice-shaped pasta from Sicily with lemon"
                ],
                es: [
                    "Pasta gruesa de trigo integral del Véneto tradicionalmente servida con ragú de pato",
                    "Pasta fina cabello de ángel de Toscana con mariscos",
                    "Pasta rellena de Emilia-Romaña con salsa de nata",
                    "Pasta en forma de arroz de Sicilia con limón"
                ],
                de: [
                    "Dicke Vollkornpasta aus Venetien, traditionell mit Entenragout serviert",
                    "Dünne Engelshaar-Pasta aus der Toskana mit Meeresfrüchten",
                    "Gefüllte Pasta aus Emilia-Romagna mit Sahnesauce",
                    "Reisförmige Pasta aus Sizilien mit Zitrone"
                ],
                nl: [
                    "Dikke volkorendeegwaar uit Veneto traditioneel geserveerd met eendenragout",
                    "Dunne engelhaar pasta uit Toscane met zeevruchten",
                    "Gevulde pasta uit Emilia-Romagna met roomsaus",
                    "Rijstvormige pasta uit Sicilië met citroen"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Bigoli are thick, whole-wheat spaghetti-like pasta from the Veneto region, traditionally made with a special bronze press called a 'torchio'. They're classically paired with duck ragù (bigoli con l'arna) or anchovy sauce (bigoli in salsa).",
                es: "Los bigoli son pasta gruesa similar a espaguetis de trigo integral de la región del Véneto, tradicionalmente hechos con una prensa especial de bronce llamada 'torchio'. Se combinan clásicamente con ragú de pato (bigoli con l'arna) o salsa de anchoas (bigoli in salsa).",
                de: "Bigoli sind dicke, Vollkorn-Spaghetti-ähnliche Nudeln aus der Region Venetien, traditionell mit einer speziellen Bronzepresse namens 'Torchio' hergestellt. Sie werden klassisch mit Entenragout (Bigoli con l'arna) oder Sardellensauce (Bigoli in Salsa) kombiniert.",
                nl: "Bigoli zijn dikke, volkorendeegwaar vergelijkbaar met spaghetti uit de regio Veneto, traditioneel gemaakt met een speciale bronzen pers genaamd 'torchio'. Ze worden klassiek gecombineerd met eendenragout (bigoli con l'arna) of ansjovis saus (bigoli in salsa)."
            }
        },
        {
            question: {
                en: "What is pizzoccheri and what are its traditional ingredients?",
                es: "¿Qué son los pizzoccheri y cuáles son sus ingredientes tradicionales?",
                de: "Was ist Pizzoccheri und was sind seine traditionellen Zutaten?",
                nl: "Wat is pizzoccheri en wat zijn de traditionele ingrediënten?"
            },
            options: {
                en: [
                    "Buckwheat pasta from Valtellina served with cabbage, potatoes, and cheese",
                    "Rice pasta from Piedmont with truffle and butter",
                    "Corn pasta from Friuli with beans and pancetta",
                    "Chestnut pasta from Liguria with pesto"
                ],
                es: [
                    "Pasta de trigo sarraceno de Valtellina servida con col, patatas y queso",
                    "Pasta de arroz del Piamonte con trufa y mantequilla",
                    "Pasta de maíz de Friuli con frijoles y panceta",
                    "Pasta de castaña de Liguria con pesto"
                ],
                de: [
                    "Buchweizenpasta aus dem Valtellina mit Kohl, Kartoffeln und Käse serviert",
                    "Reispasta aus dem Piemont mit Trüffel und Butter",
                    "Maispasta aus Friaul mit Bohnen und Pancetta",
                    "Kastanienpasta aus Ligurien mit Pesto"
                ],
                nl: [
                    "Boekweitdeegwaar uit Valtellina geserveerd met kool, aardappelen en kaas",
                    "Rijstpasta uit Piemonte met truffel en boter",
                    "Maïspasta uit Friuli met bonen en pancetta",
                    "Kastanjepasta uit Ligurië met pesto"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Pizzoccheri are short, flat buckwheat pasta ribbons from Valtellina in Lombardy. The traditional dish layers the pasta with Savoy cabbage, potatoes, garlic, sage butter, and local cheeses like Bitto and Casera, creating a rich Alpine comfort food.",
                es: "Los pizzoccheri son cintas cortas y planas de pasta de trigo sarraceno de Valtellina en Lombardía. El plato tradicional alterna capas de pasta con col de Saboya, patatas, ajo, mantequilla de salvia y quesos locales como Bitto y Casera, creando un rico plato alpino reconfortante.",
                de: "Pizzoccheri sind kurze, flache Buchweizennudelbänder aus dem Valtellina in der Lombardei. Das traditionelle Gericht schichtet die Nudeln mit Wirsingkohl, Kartoffeln, Knoblauch, Salbeibutter und lokalen Käsesorten wie Bitto und Casera und schafft ein reichhaltiges alpines Wohlfühlessen.",
                nl: "Pizzoccheri zijn korte, platte boekweitdeegwaar linten uit Valtellina in Lombardije. Het traditionele gerecht bestaat uit lagen pasta met savooiekool, aardappelen, knoflook, salieboter en lokale kazen zoals Bitto en Casera, wat een rijk Alpencomfortgerecht creëert."
            }
        },
        {
            question: {
                en: "What are passatelli and how are they made?",
                es: "¿Qué son los passatelli y cómo se hacen?",
                de: "Was sind Passatelli und wie werden sie hergestellt?",
                nl: "Wat zijn passatelli en hoe worden ze gemaakt?"
            },
            options: {
                en: [
                    "Breadcrumb and Parmigiano mixture pressed through a ricer for soup",
                    "Egg noodles rolled and cut with a knife",
                    "Semolina dough extruded through bronze dies",
                    "Potato gnocchi shaped with a fork"
                ],
                es: [
                    "Mezcla de pan rallado y parmesano presionada a través de un pasapurés para sopa",
                    "Fideos de huevo enrollados y cortados con cuchillo",
                    "Masa de sémola extruida a través de matrices de bronce",
                    "Ñoquis de patata formados con tenedor"
                ],
                de: [
                    "Brösel-Parmigiano-Mischung durch eine Kartoffelpresse für Suppe gedrückt",
                    "Eiernudeln gerollt und mit einem Messer geschnitten",
                    "Grießteig durch Bronzematrizen extrudiert",
                    "Kartoffelgnocchi mit einer Gabel geformt"
                ],
                nl: [
                    "Broodkruimel en Parmigiano mengsel geperst door een passe-vite voor soep",
                    "Eiernoedels gerold en gesneden met een mes",
                    "Griesmeel deeg geëxtrudeerd door bronzen matrijzen",
                    "Aardappelgnocchi gevormd met een vork"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Passatelli are a traditional pasta from Emilia-Romagna and Marche, made from breadcrumbs, Parmigiano-Reggiano, eggs, nutmeg, and lemon zest. The mixture is pressed through a potato ricer or special passatelli press directly into simmering broth, creating irregular worm-like strands.",
                es: "Los passatelli son una pasta tradicional de Emilia-Romaña y Las Marcas, hechos de pan rallado, parmesano reggiano, huevos, nuez moscada y ralladura de limón. La mezcla se presiona a través de un pasapurés o prensa especial directamente en caldo hirviendo, creando hebras irregulares parecidas a gusanos.",
                de: "Passatelli sind eine traditionelle Pasta aus Emilia-Romagna und den Marken, hergestellt aus Semmelbröseln, Parmigiano-Reggiano, Eiern, Muskatnuss und Zitronenschale. Die Mischung wird durch eine Kartoffelpresse oder spezielle Passatelli-Presse direkt in köchelnde Brühe gedrückt und bildet unregelmäßige wurmartige Stränge.",
                nl: "Passatelli zijn traditionele pasta uit Emilia-Romagna en Marche, gemaakt van paneermeel, Parmigiano-Reggiano, eieren, nootmuskaat en citroenschil. Het mengsel wordt door een aardappelpers of speciale passatelli pers direct in zachtjes kokende bouillon geperst, wat onregelmatige wormachtige strengen creëert."
            }
        },
        {
            question: {
                en: "Which cookbook had the most significant influence on codifying Italian pasta dishes in the late 19th century?",
                es: "¿Qué libro de cocina tuvo la influencia más significativa en la codificación de platos de pasta italianos a finales del siglo XIX?",
                de: "Welches Kochbuch hatte den bedeutendsten Einfluss auf die Kodifizierung italienischer Nudelgerichte im späten 19. Jahrhundert?",
                nl: "Welk kookboek had de belangrijkste invloed op het codificeren van Italiaanse pastagerechten in de late 19e eeuw?"
            },
            options: {
                en: [
                    "Pellegrino Artusi's 'Science in the Kitchen and the Art of Eating Well' (1891)",
                    "Ada Boni's 'Il Talismano della Felicità' (1929)",
                    "Marcella Hazan's 'The Classic Italian Cookbook' (1973)",
                    "Antonio Carluccio's 'An Invitation to Italian Cooking' (1986)"
                ],
                es: [
                    "'La ciencia en la cocina y el arte de comer bien' de Pellegrino Artusi (1891)",
                    "'Il Talismano della Felicità' de Ada Boni (1929)",
                    "'The Classic Italian Cookbook' de Marcella Hazan (1973)",
                    "'An Invitation to Italian Cooking' de Antonio Carluccio (1986)"
                ],
                de: [
                    "Pellegrino Artusis 'Wissenschaft in der Küche und die Kunst des guten Essens' (1891)",
                    "Ada Bonis 'Il Talismano della Felicità' (1929)",
                    "Marcella Hazans 'The Classic Italian Cookbook' (1973)",
                    "Antonio Carluccios 'An Invitation to Italian Cooking' (1986)"
                ],
                nl: [
                    "Pellegrino Artusi's 'Wetenschap in de Keuken en de Kunst van Goed Eten' (1891)",
                    "Ada Boni's 'Il Talismano della Felicità' (1929)",
                    "Marcella Hazan's 'The Classic Italian Cookbook' (1973)",
                    "Antonio Carluccio's 'An Invitation to Italian Cooking' (1986)"
                ]
            ...
            correctAnswer: 0,
            explanation: {
                en: "Pellegrino Artusi's 'Science in the Kitchen and the Art of Eating Well' (1891) is considered the bible of Italian gastronomy. It was the first cookbook to unite regional Italian cuisines after unification, documenting hundreds of pasta recipes and cooking techniques that became the foundation for modern Italian cuisine.",
                es: "La 'Ciencia en la cocina y el arte de comer bien' de Pellegrino Artusi (1891) se considera la biblia de la gastronomía italiana. Fue el primer libro de cocina en unir las cocinas regionales italianas después de la unificación, documentando cientos de recetas de pasta y técnicas culinarias que se convirtieron en la base de la cocina italiana moderna.",
                de: "Pellegrino Artusis 'Wissenschaft in der Küche und die Kunst des guten Essens' (1891) gilt als Bibel der italienischen Gastronomie. Es war das erste Kochbuch, das nach der Vereinigung die regionalen italienischen Küchen vereinte und Hunderte von Nudelrezepten und Kochtechniken dokumentierte, die zur Grundlage der modernen italienischen Küche wurden.",
                nl: "Pellegrino Artusi's 'Wetenschap in de Keuken en de Kunst van Goed Eten' (1891) wordt beschouwd als de bijbel van de Italiaanse gastronomie. Het was het eerste kookboek dat regionale Italiaanse keukens verenigde na de eenwording, met documentatie van honderden pastarecepten en kooktechnieken die de basis vormden voor de moderne Italiaanse keuken."
            }
        },
        {
            question: {
                en: "What are lorighittas and what is their cultural significance?",
                es: "¿Qué son las lorighittas y cuál es su significado cultural?",
                de: "Was sind Lorighittas und welche kulturelle Bedeutung haben sie?",
                nl: "Wat zijn lorighittas en wat is hun culturele betekenis?"
            },
            options: {
                en: [
                    "Sardinian braided ring pasta traditionally made for weddings",
                    "Sicilian twisted pasta used for funeral meals",
                    "Calabrian bow-tie pasta for harvest festivals",
                    "Pugliese ear-shaped pasta for baptisms"
                ],
                es: [
                    "Pasta trenzada en forma de anillo de Cerdeña tradicionalmente hecha para bodas",
                    "Pasta retorcida siciliana usada en comidas fúnebres",
                    "Pasta de corbatín calabresa para festivales de cosecha",
                    "Pasta en forma de oreja de Puglia para bautizos"
                ],
                de: [
                    "Sardische geflochtene Ringpasta, traditionell für Hochzeiten hergestellt",
                    "Sizilianische verdrehte Pasta für Trauermahlzeiten",
                    "Kalabrische Schleifennudeln für Erntefeste",
                    "Apulische ohrförmige Pasta für Taufen"
                ],
                nl: [
                    "Sardijnse gevlochten ringpasta traditioneel gemaakt voor bruiloften",
                    "Siciliaanse gedraaide pasta gebruikt voor begrafenismaaltijden",
                    "Calabrische strikpasta voor oogstfestivals",
                    "Apulische oorvormige pasta voor dopen"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Lorighittas are intricate braided ring-shaped pasta from the Sardinian town of Morgongiori. Making them is extremely labor-intensive - thin strands are twisted around three fingers and braided into rings. They're traditionally prepared for weddings and special celebrations, symbolizing eternal bonds.",
                es: "Las lorighittas son pasta intrincada trenzada en forma de anillo del pueblo sardo de Morgongiori. Hacerlas es extremadamente laborioso - hebras finas se retuercen alrededor de tres dedos y se trenzan en anillos. Se preparan tradicionalmente para bodas y celebraciones especiales, simbolizando vínculos eternos.",
                de: "Lorighittas sind kompliziert geflochtene ringförmige Nudeln aus der sardischen Stadt Morgongiori. Ihre Herstellung ist äußerst arbeitsintensiv - dünne Stränge werden um drei Finger gedreht und zu Ringen geflochten. Sie werden traditionell für Hochzeiten und besondere Feiern zubereitet und symbolisieren ewige Bindungen.",
                nl: "Lorighittas zijn ingewikkeld gevlochten ringvormige pasta uit het Sardijnse stadje Morgongiori. Het maken ervan is extreem arbeidsintensief - dunne strengen worden om drie vingers gedraaid en tot ringen gevlochten. Ze worden traditioneel bereid voor bruiloften en speciale vieringen, als symbool voor eeuwige banden."
            }
        },
        {
            question: {
                en: "What is su filindeu and why is it so rare?",
                es: "¿Qué es su filindeu y por qué es tan raro?",
                de: "Was ist Su Filindeu und warum ist es so selten?",
                nl: "Wat is su filindeu en waarom is het zo zeldzaam?"
            },
            options: {
                en: [
                    "The 'threads of God' - world's rarest pasta that only 3 Sardinian women can make",
                    "A golden pasta made with saffron that costs over €1000 per kilo",
                    "A pasta made from rare sea urchin flour",
                    "An ancient Roman pasta recipe lost for centuries"
                ],
                es: [
                    "Los 'hilos de Dios' - la pasta más rara del mundo que solo 3 mujeres sardas pueden hacer",
                    "Una pasta dorada hecha con azafrán que cuesta más de €1000 por kilo",
                    "Una pasta hecha con harina rara de erizo de mar",
                    "Una receta de pasta romana antigua perdida durante siglos"
                ],
                de: [
                    "Die 'Fäden Gottes' - die seltenste Pasta der Welt, die nur 3 sardische Frauen herstellen können",
                    "Eine goldene Pasta aus Safran, die über 1000 € pro Kilo kostet",
                    "Eine Pasta aus seltenem Seeigel-Mehl",
                    "Ein altes römisches Pasta-Rezept, das jahrhundertelang verloren war"
                ],
                nl: [
                    "De 'draden van God' - 's werelds zeldzaamste pasta die slechts 3 Sardijnse vrouwen kunnen maken",
                    "Een gouden pasta gemaakt met saffraan die meer dan €1000 per kilo kost",
                    "Een pasta gemaakt van zeldzaam zee-egelmeel",
                    "Een oud Romeins pastarecept eeuwenlang verloren"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Su filindeu ('threads of God') is considered the world's rarest pasta. Made only in Nuoro, Sardinia, it requires pulling and folding semolina dough into 256 impossibly thin strands laid in three layers. The technique is so difficult that only three women in the Abraini family can make it, and they've resisted teaching it to outsiders or chefs.",
                es: "Su filindeu ('hilos de Dios') se considera la pasta más rara del mundo. Hecha solo en Nuoro, Cerdeña, requiere estirar y doblar masa de sémola en 256 hebras imposiblemente finas dispuestas en tres capas. La técnica es tan difícil que solo tres mujeres de la familia Abraini pueden hacerla, y se han resistido a enseñarla a forasteros o chefs.",
                de: "Su Filindeu ('Fäden Gottes') gilt als die seltenste Pasta der Welt. Sie wird nur in Nuoro, Sardinien, hergestellt und erfordert das Ziehen und Falten von Grießteig zu 256 unmöglich dünnen Strängen, die in drei Schichten gelegt werden. Die Technik ist so schwierig, dass nur drei Frauen aus der Familie Abraini sie herstellen können, und sie haben sich geweigert, sie Außenstehenden oder Köchen beizubringen.",
                nl: "Su filindeu ('draden van God') wordt beschouwd als 's werelds zeldzaamste pasta. Gemaakt alleen in Nuoro, Sardinië, vereist het het trekken en vouwen van griesmeel deeg in 256 onmogelijk dunne strengen gelegd in drie lagen. De techniek is zo moeilijk dat slechts drie vrouwen in de familie Abraini het kunnen maken, en ze hebben geweigerd het aan buitenstaanders of chefs te leren."
            }
        },
        {
            question: {
                en: "What are acini di pepe and how are they commonly used?",
                es: "¿Qué son los acini di pepe y cómo se usan comúnmente?",
                de: "Was sind Acini di Pepe und wie werden sie üblicherweise verwendet?",
                nl: "Wat zijn acini di pepe en hoe worden ze gewoonlijk gebruikt?"
            },
            options: {
                en: [
                    "Tiny peppercorn-shaped pasta used in soups and salads",
                    "Large tube pasta stuffed with meat",
                    "Flat ribbon pasta served with cream sauces",
                    "Bow-tie shaped pasta for baked dishes"
                ],
                es: [
                    "Pasta diminuta en forma de grano de pimienta usada en sopas y ensaladas",
                    "Pasta de tubo grande rellena de carne",
                    "Pasta de cinta plana servida con salsas de nata",
                    "Pasta en forma de corbatín para platos horneados"
                ],
                de: [
                    "Winzige pfefferkornförmige Pasta, die in Suppen und Salaten verwendet wird",
                    "Große Röhrenpasta mit Fleischfüllung",
                    "Flache Bandnudeln mit Sahnesaucen serviert",
                    "Schleifenförmige Pasta für gebackene Gerichte"
                ],
                nl: [
                    "Kleine peperkorrelvormige pasta gebruikt in soepen en salades",
                    "Grote buisvormige pasta gevuld met vlees",
                    "Platte lintpasta geserveerd met roomsauzen",
                    "Strikjesvormige pasta voor ovenschotels"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Acini di pepe means 'peppercorns' in Italian. These tiny, round pasta pieces are about the size of peppercorns and are commonly used in Italian wedding soup (minestra maritata), minestrone, cold pasta salads, and sometimes in desserts. Their small size allows them to cook quickly and absorb flavors well.",
                es: "Acini di pepe significa 'granos de pimienta' en italiano. Estas diminutas piezas redondas de pasta son del tamaño de granos de pimienta y se usan comúnmente en sopa de boda italiana (minestra maritata), minestrone, ensaladas frías de pasta y a veces en postres. Su pequeño tamaño les permite cocinarse rápidamente y absorber bien los sabores.",
                de: "Acini di Pepe bedeutet auf Italienisch 'Pfefferkörner'. Diese winzigen, runden Nudeln sind etwa so groß wie Pfefferkörner und werden häufig in italienischer Hochzeitssuppe (Minestra Maritata), Minestrone, kalten Nudelsalaten und manchmal in Desserts verwendet. Ihre geringe Größe ermöglicht schnelles Garen und gute Aromaaufnahme.",
                nl: "Acini di pepe betekent 'peperkorrels' in het Italiaans. Deze minuscule, ronde pastastukjes zijn ongeveer zo groot als peperkorrels en worden vaak gebruikt in Italiaanse bruiloftssoep (minestra maritata), minestrone, koude pastasalades en soms in desserts. Hun kleine formaat zorgt ervoor dat ze snel gaar zijn en goed smaken absorberen."
            }
        },
        {
            question: {
                en: "What is orzo also known as and what cuisine commonly uses it?",
                es: "¿Con qué otro nombre se conoce el orzo y qué cocina lo usa comúnmente?",
                de: "Wie wird Orzo noch genannt und welche Küche verwendet es häufig?",
                nl: "Hoe wordt orzo ook wel genoemd en welke keuken gebruikt het vaak?"
            },
            options: {
                en: [
                    "Risoni, rice-shaped pasta used extensively in Greek and Mediterranean cooking",
                    "Stelline, star-shaped pasta used in French cuisine",
                    "Anelli, ring-shaped pasta used in Spanish cooking",
                    "Gramigna, curved pasta used in German dishes"
                ],
                es: [
                    "Risoni, pasta con forma de arroz ampliamente usada en cocina griega y mediterránea",
                    "Stelline, pasta con forma de estrella usada en cocina francesa",
                    "Anelli, pasta en forma de anillo usada en cocina española",
                    "Gramigna, pasta curvada usada en platos alemanes"
                ],
                de: [
                    "Risoni, reisförmige Pasta, die ausgiebig in der griechischen und mediterranen Küche verwendet wird",
                    "Stelline, sternförmige Pasta, die in der französischen Küche verwendet wird",
                    "Anelli, ringförmige Pasta, die in der spanischen Küche verwendet wird",
                    "Gramigna, gebogene Pasta, die in deutschen Gerichten verwendet wird"
                ],
                nl: [
                    "Risoni, rijstvormige pasta uitgebreid gebruikt in Griekse en mediterrane gerechten",
                    "Stelline, stervormige pasta gebruikt in Franse keuken",
                    "Anelli, ringvormige pasta gebruikt in Spaanse gerechten",
                    "Gramigna, gebogen pasta gebruikt in Duitse gerechten"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Orzo (Italian for 'barley') is also called risoni (meaning 'big rice'). This rice-shaped pasta is extremely popular in Greek cuisine (where it's called kritharaki) for dishes like yiouvetsi and soups. It's also used throughout Mediterranean cooking in salads, pilaf-style dishes, and baked casseroles.",
                es: "El orzo (italiano para 'cebada') también se llama risoni (que significa 'arroz grande'). Esta pasta con forma de arroz es extremadamente popular en la cocina griega (donde se llama kritharaki) para platos como yiouvetsi y sopas. También se usa en toda la cocina mediterránea en ensaladas, platos estilo pilaf y guisos horneados.",
                de: "Orzo (Italienisch für 'Gerste') wird auch Risoni genannt (bedeutet 'großer Reis'). Diese reisförmige Pasta ist in der griechischen Küche äußerst beliebt (wo sie Kritharaki genannt wird) für Gerichte wie Yiouvetsi und Suppen. Sie wird auch in der gesamten mediterranen Küche in Salaten, Pilaf-Gerichten und gebackenen Aufläufen verwendet.",
                nl: "Orzo (Italiaans voor 'gerst') wordt ook wel risoni genoemd (betekent 'grote rijst'). Deze rijstvormige pasta is enorm populair in de Griekse keuken (waar het kritharaki wordt genoemd) voor gerechten zoals yiouvetsi en soepen. Het wordt ook in de gehele mediterrane keuken gebruikt in salades, pilaf-achtige gerechten en gebakken ovenschotels."
            }
        },
        {
            question: {
                en: "What is fregula and what makes it distinctive?",
                es: "¿Qué es la fregula y qué la hace distintiva?",
                de: "Was ist Fregula und was macht sie besonders?",
                nl: "Wat is fregula en wat maakt het onderscheidend?"
            },
            options: {
                en: [
                    "Sardinian toasted semolina pearls similar to couscous but larger",
                    "Sicilian square-cut pasta with ricotta filling",
                    "Tuscan hand-rolled long noodles",
                    "Calabrian spiral-shaped dried pasta"
                ],
                es: [
                    "Perlas tostadas de sémola de Cerdeña similares al cuscús pero más grandes",
                    "Pasta cuadrada siciliana con relleno de ricotta",
                    "Fideos largos enrollados a mano de Toscana",
                    "Pasta seca en forma de espiral de Calabria"
                ],
                de: [
                    "Sardische geröstete Grießperlen ähnlich wie Couscous, aber größer",
                    "Sizilianische quadratisch geschnittene Pasta mit Ricotta-Füllung",
                    "Toskanische handgerollte lange Nudeln",
                    "Kalabrische spiralförmige getrocknete Pasta"
                ],
                nl: [
                    "Sardijnse geroosterde griesmeel parels vergelijkbaar met couscous maar groter",
                    "Siciliaanse vierkant gesneden pasta met ricotta vulling",
                    "Toscaanse handgerolde lange noedels",
                    "Calabrische spiraalvormige gedroogde pasta"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Fregula (or fregola) is a Sardinian pasta made from semolina rubbed into small irregular balls, then toasted to give it a distinctive nutty flavor and golden color. Similar to Israeli couscous but with a rougher texture, it's traditionally served with clams (fregula con arselle) or in rich broths and stews.",
                es: "La fregula (o fregola) es una pasta sarda hecha de sémola frotada en pequeñas bolas irregulares, luego tostada para darle un distintivo sabor a nuez y color dorado. Similar al cuscús israelí pero con textura más rugosa, se sirve tradicionalmente con almejas (fregula con arselle) o en caldos ricos y guisos.",
                de: "Fregula (oder Fregola) ist eine sardische Pasta aus Grieß, der zu kleinen unregelmäßigen Kugeln gerieben und dann geröstet wird, um ihr einen charakteristischen nussigen Geschmack und eine goldene Farbe zu verleihen. Ähnlich wie israelischer Couscous, aber mit rauerer Textur, wird sie traditionell mit Venusmuscheln (Fregula con Arselle) oder in reichhaltigen Brühen und Eintöpfen serviert.",
                nl: "Fregula (of fregola) is een Sardijnse pasta gemaakt van griesmeel gewreven tot kleine onregelmatige balletjes, vervolgens geroosterd om het een kenmerkende nootachtige smaak en gouden kleur te geven. Vergelijkbaar met Israëlische couscous maar met een ruwere textuur, wordt het traditioneel geserveerd met venusschelpen (fregula con arselle) of in rijke bouillons en stoofschotels."
            }
        },
        {
            question: {
                en: "What are culurgiones and what is their distinctive feature?",
                es: "¿Qué son los culurgiones y cuál es su característica distintiva?",
                de: "Was sind Culurgiones und was ist ihr charakteristisches Merkmal?",
                nl: "Wat zijn culurgiones en wat is hun kenmerkende eigenschap?"
            },
            options: {
                en: [
                    "Sardinian ravioli with potato-mint-pecorino filling and distinctive wheat-ear crimp",
                    "Sicilian tube pasta stuffed with eggplant and ricotta",
                    "Roman ring-shaped pasta filled with meat and peas",
                    "Venetian half-moon shaped pasta with pumpkin filling"
                ],
                es: [
                    "Raviolis sardos con relleno de patata-menta-pecorino y distintivo pliegue en forma de espiga",
                    "Pasta tubular siciliana rellena de berenjena y ricotta",
                    "Pasta romana en forma de anillo rellena de carne y guisantes",
                    "Pasta veneciana en forma de media luna con relleno de calabaza"
                ],
                de: [
                    "Sardische Ravioli mit Kartoffel-Minze-Pecorino-Füllung und charakteristischer Ährenprägung",
                    "Sizilianische Röhrenpasta gefüllt mit Auberginen und Ricotta",
                    "Römische ringförmige Pasta gefüllt mit Fleisch und Erbsen",
                    "Venezianische halbmondförmige Pasta mit Kürbisfüllung"
                ],
                nl: [
                    "Sardijnse ravioli met aardappel-munt-pecorino vulling en kenmerkende korenaar vouw",
                    "Siciliaanse buispasta gevuld met aubergine en ricotta",
                    "Romeinse ringvormige pasta gevuld met vlees en erwten",
                    "Venetiaanse halvemaanvormige pasta met pompoenvulling"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Culurgiones are traditional Sardinian stuffed pasta, particularly from Ogliastra region. They're filled with potato, fresh mint, aged pecorino, and garlic. Their most distinctive feature is the intricate 'chiusura a spighitta' - a wheat-ear or braid-like crimped edge that requires great skill to execute properly and is considered an art form.",
                es: "Los culurgiones son pasta rellena tradicional sarda, particularmente de la región de Ogliastra. Se rellenan con patata, menta fresca, pecorino añejo y ajo. Su característica más distintiva es la intrincada 'chiusura a spighitta' - un borde plisado en forma de espiga o trenza que requiere gran habilidad para ejecutarse correctamente y se considera una forma de arte.",
                de: "Culurgiones sind traditionelle sardische gefüllte Nudeln, besonders aus der Region Ogliastra. Sie sind mit Kartoffeln, frischer Minze, gereiftem Pecorino und Knoblauch gefüllt. Ihr markantestes Merkmal ist die kunstvolle 'Chiusura a Spighitta' - ein ähren- oder zopfartiger geprägter Rand, der großes Geschick erfordert und als Kunstform gilt.",
                nl: "Culurgiones zijn traditionele Sardijnse gevulde pasta, met name uit de regio Ogliastra. Ze zijn gevuld met aardappel, verse munt, gerijpte pecorino en knoflook. Hun meest onderscheidende kenmerk is de ingewikkelde 'chiusura a spighitta' - een korenaar- of vlechtachtige geplooide rand die grote vaardigheid vereist om goed uit te voeren en wordt beschouwd als een kunstvorm."
            }
        },
        {
            question: {
                en: "What are testaroli and how are they traditionally prepared?",
                es: "¿Qué son los testaroli y cómo se preparan tradicionalmente?",
                de: "Was sind Testaroli und wie werden sie traditionell zubereitet?",
                nl: "Wat zijn testaroli en hoe worden ze traditioneel bereid?"
            },
            options: {
                en: [
                    "Ancient Lunigiana pancake pasta cooked on a hot testo stone then cut and boiled",
                    "Stuffed pasta tubes baked in a wood-fired oven",
                    "Long ribbon pasta dried in the sun for three days",
                    "Small dumplings fried in olive oil until crispy"
                ],
                es: [
                    "Antigua pasta tipo panqueque de Lunigiana cocida en piedra testo caliente, luego cortada y hervida",
                    "Tubos de pasta rellenos horneados en horno de leña",
                    "Pasta de cinta larga secada al sol durante tres días",
                    "Pequeños dumplings fritos en aceite de oliva hasta quedar crujientes"
                ],
                de: [
                    "Antike Lunigiana-Pfannkuchenpasta, auf heißem Testo-Stein gegart, dann geschnitten und gekocht",
                    "Gefüllte Nudelröhren im Holzofen gebacken",
                    "Lange Bandnudeln drei Tage in der Sonne getrocknet",
                    "Kleine Klöße in Olivenöl knusprig frittiert"
                ],
                nl: [
                    "Oude Lunigiana pannenkoekpasta gekookt op hete testo steen, daarna gesneden en gekookt",
                    "Gevulde pastabuizen gebakken in een houtoven",
                    "Lange lintpasta drie dagen in de zon gedroogd",
                    "Kleine dumplings gebakken in olijfolie tot knapperig"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Testaroli are considered one of Italy's most ancient pasta types, from the Lunigiana region between Tuscany and Liguria. A thin batter is poured onto a hot cast-iron testo (griddle) to create large pancakes, which are then cut into diamonds, briefly boiled, and served with pesto or olive oil and cheese. This unique cooking method predates modern pasta-making.",
                es: "Los testaroli se consideran uno de los tipos de pasta más antiguos de Italia, de la región de Lunigiana entre Toscana y Liguria. Se vierte una masa fina sobre un testo caliente de hierro fundido para crear grandes panqueques, que luego se cortan en diamantes, se hierven brevemente y se sirven con pesto o aceite de oliva y queso. Este método único de cocción es anterior a la elaboración moderna de pasta.",
                de: "Testaroli gelten als eine der ältesten Nudelarten Italiens aus der Region Lunigiana zwischen der Toskana und Ligurien. Ein dünner Teig wird auf einen heißen gusseisernen Testo (Grillplatte) gegossen, um große Pfannkuchen zu erzeugen, die dann in Rauten geschnitten, kurz gekocht und mit Pesto oder Olivenöl und Käse serviert werden. Diese einzigartige Kochmethode stammt aus der Zeit vor der modernen Nudelherstellung.",
                nl: "Testaroli worden beschouwd als een van Italië's oudste pastatypes, uit de regio Lunigiana tussen Toscane en Ligurië. Een dun beslag wordt op een hete gietijzeren testo (bakplaat) gegoten om grote pannenkoeken te maken, die vervolgens in ruiten worden gesneden, kort gekookt en geserveerd met pesto of olijfolie en kaas. Deze unieke kookmethode dateert van vóór de moderne pastaproductie."
            }
        },
        {
            question: {
                en: "What are tacconi and where do they originate?",
                es: "¿Qué son los tacconi y de dónde son originarios?",
                de: "Was sind Tacconi und woher stammen sie?",
                nl: "Wat zijn tacconi en waar komen ze vandaan?"
            },
            options: {
                en: [
                    "Buckwheat pasta squares from Valtellina traditionally served with butter and cheese",
                    "Eggless ribbon pasta from Puglia with tomato sauce",
                    "Stuffed half-moons from Emilia-Romagna with meat filling",
                    "Long thin spaghetti from Naples with seafood"
                ],
                es: [
                    "Cuadrados de pasta de trigo sarraceno de Valtellina servidos tradicionalmente con mantequilla y queso",
                    "Pasta de cinta sin huevo de Puglia con salsa de tomate",
                    "Medias lunas rellenas de Emilia-Romaña con relleno de carne",
                    "Espaguetis largos y delgados de Nápoles con mariscos"
                ],
                de: [
                    "Buchweizenpasta-Quadrate aus dem Valtellina, traditionell mit Butter und Käse serviert",
                    "Eifreie Bandnudeln aus Apulien mit Tomatensauce",
                    "Gefüllte Halbmonde aus Emilia-Romagna mit Fleischfüllung",
                    "Lange dünne Spaghetti aus Neapel mit Meeresfrüchten"
                ],
                nl: [
                    "Boekweitpasta vierkantjes uit Valtellina traditioneel geserveerd met boter en kaas",
                    "Eiloze lintpasta uit Puglia met tomatensaus",
                    "Gevulde halvemanen uit Emilia-Romagna met vleesvulling",
                    "Lange dunne spaghetti uit Napels met zeevruchten"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Tacconi are traditional buckwheat pasta squares from Valtellina in Lombardy, similar to pizzoccheri but cut into larger squares rather than ribbons. They're typically dressed simply with butter, sage, and local Alpine cheeses like Bitto or Casera. The buckwheat gives them a distinctive earthy, nutty flavor suited to the hearty mountain cuisine of the region.",
                es: "Los tacconi son cuadrados tradicionales de pasta de trigo sarraceno de Valtellina en Lombardía, similares a los pizzoccheri pero cortados en cuadrados más grandes en lugar de cintas. Se aliñan típicamente de forma simple con mantequilla, salvia y quesos alpinos locales como Bitto o Casera. El trigo sarraceno les da un distintivo sabor terroso y a nuez adecuado para la abundante cocina montañosa de la región.",
                de: "Tacconi sind traditionelle Buchweizenpasta-Quadrate aus dem Valtellina in der Lombardei, ähnlich wie Pizzoccheri, aber in größere Quadrate statt Bänder geschnitten. Sie werden typischerweise einfach mit Butter, Salbei und lokalen Alpenkäsen wie Bitto oder Casera angerichtet. Der Buchweizen verleiht ihnen einen charakteristischen erdigen, nussigen Geschmack, der zur herzhaften Bergküche der Region passt.",
                nl: "Tacconi zijn traditionele boekweitpasta vierkantjes uit Valtellina in Lombardije, vergelijkbaar met pizzoccheri maar gesneden in grotere vierkanten in plaats van linten. Ze worden typisch eenvoudig bereid met boter, salie en lokale Alpenkazen zoals Bitto of Casera. De boekweit geeft ze een kenmerkende aardse, nootachtige smaak die past bij de stevige bergkeuken van de regio."
            }
        },
        {
            question: {
                en: "What are strangozzi and what region are they from?",
                es: "¿Qué son los strangozzi y de qué región son?",
                de: "Was sind Strangozzi und aus welcher Region stammen sie?",
                nl: "Wat zijn strangozzi en uit welke regio komen ze?"
            },
            options: {
                en: [
                    "Umbrian square-sectioned egg-free pasta similar to thick spaghetti",
                    "Sardinian braided ring pasta for special occasions",
                    "Sicilian tube pasta filled with ricotta",
                    "Venetian ribbon pasta with whole-wheat flour"
                ],
                es: [
                    "Pasta sin huevo de sección cuadrada de Umbría similar a espaguetis gruesos",
                    "Pasta trenzada en forma de anillo de Cerdeña para ocasiones especiales",
                    "Pasta tubular siciliana rellena de ricotta",
                    "Pasta de cinta veneciana con harina integral"
                ],
                de: [
                    "Umbrische eierfreie Pasta mit quadratischem Querschnitt, ähnlich wie dicke Spaghetti",
                    "Sardische geflochtene Ringpasta für besondere Anlässe",
                    "Sizilianische Röhrenpasta gefüllt mit Ricotta",
                    "Venezianische Bandnudeln mit Vollkornmehl"
                ],
                nl: [
                    "Umbrische vierkant doorsnede eiloze pasta vergelijkbaar met dikke spaghetti",
                    "Sardijnse gevlochten ringpasta voor speciale gelegenheden",
                    "Siciliaanse buispasta gevuld met ricotta",
                    "Venetiaanse lintpasta met volkoren meel"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Strangozzi (also called strengozzi or stringozzi) are traditional pasta from Umbria, particularly Spoleto. They're made without eggs, using just flour and water, and have a distinctive square or rectangular cross-section, making them thicker than regular spaghetti. Traditionally served with black truffle sauce or simple tomato-based sauces, the name supposedly comes from 'strangle' referring to shoelaces.",
                es: "Los strangozzi (también llamados strengozzi o stringozzi) son pasta tradicional de Umbría, particularmente de Spoleto. Se hacen sin huevos, usando solo harina y agua, y tienen una distintiva sección transversal cuadrada o rectangular, haciéndolos más gruesos que los espaguetis regulares. Servidos tradicionalmente con salsa de trufa negra o salsas simples a base de tomate, el nombre supuestamente proviene de 'estrangular' refiriéndose a cordones de zapatos.",
                de: "Strangozzi (auch Strengozzi oder Stringozzi genannt) sind traditionelle Nudeln aus Umbrien, besonders aus Spoleto. Sie werden ohne Eier hergestellt, nur mit Mehl und Wasser, und haben einen charakteristischen quadratischen oder rechteckigen Querschnitt, wodurch sie dicker als normale Spaghetti sind. Traditionell mit schwarzer Trüffelsauce oder einfachen Tomatensaucen serviert, stammt der Name angeblich von 'würgen' in Bezug auf Schnürsenkel.",
                nl: "Strangozzi (ook wel strengozzi of stringozzi genoemd) zijn traditionele pasta uit Umbrië, met name Spoleto. Ze worden gemaakt zonder eieren, met alleen meel en water, en hebben een kenmerkende vierkante of rechthoekige doorsnede, waardoor ze dikker zijn dan gewone spaghetti. Traditioneel geserveerd met zwarte truffelsaus of eenvoudige tomatensauzen, komt de naam vermoedelijk van 'wurgen' verwijzend naar schoenveters."
            }
        },
        {
            question: {
                en: "What are sagne and where are they traditionally made?",
                es: "¿Qué son las sagne y dónde se hacen tradicionalmente?",
                de: "Was sind Sagne und wo werden sie traditionell hergestellt?",
                nl: "Wat zijn sagne en waar worden ze traditioneel gemaakt?"
            },
            options: {
                en: [
                    "Irregular wide ribbon pasta from Abruzzo and Molise regions",
                    "Small stuffed pasta from Liguria with walnut sauce",
                    "Thin angel hair pasta from Campania with clams",
                    "Twisted pasta from Calabria with spicy salami"
                ],
                es: [
                    "Pasta de cinta ancha irregular de las regiones de Abruzzo y Molise",
                    "Pequeña pasta rellena de Liguria con salsa de nuez",
                    "Pasta fina cabello de ángel de Campania con almejas",
                    "Pasta retorcida de Calabria con salami picante"
                ],
                de: [
                    "Unregelmäßige breite Bandnudeln aus den Regionen Abruzzen und Molise",
                    "Kleine gefüllte Pasta aus Ligurien mit Walnusssauce",
                    "Dünne Engelshaar-Pasta aus Kampanien mit Venusmuscheln",
                    "Gedrehte Pasta aus Kalabrien mit scharfer Salami"
                ],
                nl: [
                    "Onregelmatige brede lintpasta uit de regio's Abruzzo en Molise",
                    "Kleine gevulde pasta uit Ligurië met walnotensaus",
                    "Dunne engelhaar pasta uit Campanië met venusschelpen",
                    "Gedraaide pasta uit Calabrië met pittige salami"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Sagne (also sagna or sagnarelli) are traditional wide, flat pasta ribbons from Abruzzo and Molise in central Italy. They're typically hand-cut into irregular strips, giving them a rustic appearance. Commonly served with beans (sagne e fagioli), chickpeas, or rich meat ragùs, they represent the simple, hearty peasant cuisine of the Apennine mountain regions.",
                es: "Las sagne (también sagna o sagnarelli) son cintas tradicionales de pasta ancha y plana de Abruzzo y Molise en el centro de Italia. Se cortan típicamente a mano en tiras irregulares, dándoles una apariencia rústica. Comúnmente servidas con frijoles (sagne e fagioli), garbanzos o ragús de carne ricos, representan la cocina campesina simple y abundante de las regiones montañosas de los Apeninos.",
                de: "Sagne (auch Sagna oder Sagnarelli) sind traditionelle breite, flache Nudelbänder aus den Abruzzen und Molise in Mittelitalien. Sie werden typischerweise von Hand in unregelmäßige Streifen geschnitten, was ihnen ein rustikales Aussehen verleiht. Häufig mit Bohnen (Sagne e Fagioli), Kichererbsen oder reichhaltigen Fleischragouts serviert, repräsentieren sie die einfache, herzhafte Bauernküche der Apennin-Bergregionen.",
                nl: "Sagne (ook wel sagna of sagnarelli) zijn traditionele brede, platte pastalinten uit Abruzzo en Molise in Midden-Italië. Ze worden meestal met de hand gesneden in onregelmatige repen, wat ze een rustiek uiterlijk geeft. Gewoonlijk geserveerd met bonen (sagne e fagioli), kikkererwten of rijke vleesragouts, vertegenwoordigen ze de eenvoudige, stevige boerenkeukens van de Apennijnen berggebieden."
            }
        },
        {
            question: {
                en: "What is the primary difference between cacio e pepe and carbonara?",
                es: "¿Cuál es la diferencia principal entre cacio e pepe y carbonara?",
                de: "Was ist der Hauptunterschied zwischen Cacio e Pepe und Carbonara?",
                nl: "Wat is het belangrijkste verschil tussen cacio e pepe en carbonara?"
            },
            options: {
                en: [
                    "Carbonara adds guanciale and egg yolk while cacio e pepe uses only cheese and pepper",
                    "Carbonara uses cream while cacio e pepe does not",
                    "Carbonara uses parmesan while cacio e pepe uses ricotta",
                    "Carbonara is baked while cacio e pepe is served fresh"
                ],
                es: [
                    "La carbonara añade guanciale y yema de huevo mientras que cacio e pepe usa solo queso y pimienta",
                    "La carbonara usa nata mientras que cacio e pepe no",
                    "La carbonara usa parmesano mientras que cacio e pepe usa ricotta",
                    "La carbonara se hornea mientras que cacio e pepe se sirve fresco"
                ],
                de: [
                    "Carbonara fügt Guanciale und Eigelb hinzu, während Cacio e Pepe nur Käse und Pfeffer verwendet",
                    "Carbonara verwendet Sahne, während Cacio e Pepe dies nicht tut",
                    "Carbonara verwendet Parmesan, während Cacio e Pepe Ricotta verwendet",
                    "Carbonara wird gebacken, während Cacio e Pepe frisch serviert wird"
                ],
                nl: [
                    "Carbonara voegt guanciale en eigeel toe terwijl cacio e pepe alleen kaas en peper gebruikt",
                    "Carbonara gebruikt room terwijl cacio e pepe dat niet doet",
                    "Carbonara gebruikt parmezaan terwijl cacio e pepe ricotta gebruikt",
                    "Carbonara wordt gebakken terwijl cacio e pepe vers geserveerd wordt"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Both are Roman pasta dishes that rely on emulsification without cream. Cacio e pepe is the simplest - just pecorino romano, black pepper, and pasta water. Carbonara builds on this foundation by adding crispy guanciale (cured pork jowl) and egg yolk, creating a richer, more complex sauce. Neither traditional recipe uses cream.",
                es: "Ambos son platos de pasta romanos que se basan en la emulsión sin nata. Cacio e pepe es el más simple - solo pecorino romano, pimienta negra y agua de pasta. La carbonara se basa en esta base añadiendo guanciale crujiente (papada de cerdo curada) y yema de huevo, creando una salsa más rica y compleja. Ninguna receta tradicional usa nata.",
                de: "Beide sind römische Nudelgerichte, die auf Emulgierung ohne Sahne basieren. Cacio e Pepe ist das einfachste - nur Pecorino Romano, schwarzer Pfeffer und Nudelwasser. Carbonara baut auf dieser Grundlage auf, indem knuspriges Guanciale (gepökelte Schweinebacke) und Eigelb hinzugefügt werden, wodurch eine reichhaltigere, komplexere Sauce entsteht. Kein traditionelles Rezept verwendet Sahne.",
                nl: "Beide zijn Romeinse pastagerechten die vertrouwen op emulgering zonder room. Cacio e pepe is het eenvoudigst - alleen pecorino romano, zwarte peper en pastawater. Carbonara bouwt hierop voort door knapperige guanciale (gezouten varkenskaak) en eigeel toe te voegen, waardoor een rijkere, complexere saus ontstaat. Geen enkel traditioneel recept gebruikt room."
            }
        },
        {
            question: {
                en: "What makes fregula different from regular couscous?",
                es: "¿Qué hace que la fregula sea diferente del cuscús regular?",
                de: "Was unterscheidet Fregula von normalem Couscous?",
                nl: "Wat maakt fregula anders dan gewone couscous?"
            },
            options: {
                en: [
                    "Fregula is toasted after forming, giving it a nutty flavor and darker color",
                    "Fregula is made with rice flour instead of wheat",
                    "Fregula is always served cold while couscous is hot",
                    "Fregula contains eggs while couscous is eggless"
                ],
                es: [
                    "La fregula se tuesta después de formarse, dándole un sabor a nuez y color más oscuro",
                    "La fregula se hace con harina de arroz en lugar de trigo",
                    "La fregula siempre se sirve fría mientras que el cuscús se sirve caliente",
                    "La fregula contiene huevos mientras que el cuscús no tiene huevo"
                ],
                de: [
                    "Fregula wird nach dem Formen geröstet, was ihr einen nussigen Geschmack und dunklere Farbe verleiht",
                    "Fregula wird mit Reismehl statt Weizen hergestellt",
                    "Fregula wird immer kalt serviert, während Couscous heiß ist",
                    "Fregula enthält Eier, während Couscous eifrei ist"
                ],
                nl: [
                    "Fregula wordt na vorming geroosterd, wat het een nootachtige smaak en donkerdere kleur geeft",
                    "Fregula wordt gemaakt met rijstmeel in plaats van tarwe",
                    "Fregula wordt altijd koud geserveerd terwijl couscous warm is",
                    "Fregula bevat eieren terwijl couscous zonder ei is"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "While both fregula and couscous are made from semolina rolled into small pellets, fregula undergoes an additional toasting process in the oven. This toasting gives it a distinctive nutty, slightly smoky flavor and golden-brown color that regular couscous lacks. Fregula pearls are also typically larger and more irregular than standard couscous grains.",
                es: "Aunque tanto la fregula como el cuscús se hacen de sémola enrollada en pequeños gránulos, la fregula pasa por un proceso adicional de tostado en el horno. Este tostado le da un distintivo sabor a nuez ligeramente ahumado y color marrón dorado que el cuscús regular no tiene. Las perlas de fregula también son típicamente más grandes e irregulares que los granos de cuscús estándar.",
                de: "Während sowohl Fregula als auch Couscous aus Grieß hergestellt werden, der zu kleinen Pellets gerollt wird, durchläuft Fregula einen zusätzlichen Röstprozess im Ofen. Dieses Rösten verleiht ihr einen charakteristischen nussigen, leicht rauchigen Geschmack und goldbraune Farbe, die normalem Couscous fehlt. Fregula-Perlen sind auch typischerweise größer und unregelmäßiger als Standard-Couscous-Körner.",
                nl: "Hoewel zowel fregula als couscous gemaakt zijn van griesmeel gerold tot kleine korrels, ondergaat fregula een extra roosterproces in de oven. Dit roosteren geeft het een kenmerkende nootachtige, licht rokerige smaak en goudbruine kleur die gewone couscous mist. Fregula parels zijn ook meestal groter en onregelmatiger dan standaard couscous korrels."
            }
        },
        {
            question: {
                en: "Why is the wheat-ear crimp on culurgiones considered culturally important?",
                es: "¿Por qué se considera culturalmente importante el pliegue en forma de espiga en los culurgiones?",
                de: "Warum gilt die Ährenprägung bei Culurgiones als kulturell wichtig?",
                nl: "Waarom wordt de korenaar vouw op culurgiones als cultureel belangrijk beschouwd?"
            },
            options: {
                en: [
                    "It represents an artisanal skill passed down through generations and symbolizes prosperity",
                    "It's purely decorative with no cultural meaning",
                    "It was invented by a famous chef in the 1900s",
                    "It helps the pasta cook more evenly"
                ],
                es: [
                    "Representa una habilidad artesanal transmitida a través de generaciones y simboliza prosperidad",
                    "Es puramente decorativo sin significado cultural",
                    "Fue inventado por un chef famoso en los años 1900",
                    "Ayuda a que la pasta se cocine más uniformemente"
                ],
                de: [
                    "Sie repräsentiert eine handwerkliche Fertigkeit, die über Generationen weitergegeben wird, und symbolisiert Wohlstand",
                    "Sie ist rein dekorativ ohne kulturelle Bedeutung",
                    "Sie wurde von einem berühmten Koch in den 1900er Jahren erfunden",
                    "Sie hilft der Pasta, gleichmäßiger zu garen"
                ],
                nl: [
                    "Het vertegenwoordigt een ambachtelijke vaardigheid doorgegeven door generaties en symboliseert welvaart",
                    "Het is puur decoratief zonder culturele betekenis",
                    "Het werd uitgevonden door een beroemde chef in de jaren 1900",
                    "Het helpt de pasta gelijkmatiger te koken"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "The 'chiusura a spighitta' (wheat-ear closure) on culurgiones is a traditional Sardinian art form that requires years to master. The intricate braided edge symbolizes wheat sheaves and agricultural prosperity. The technique is passed from grandmother to granddaughter, and the quality of the crimp is seen as a mark of a skilled pasta maker. This closure is so culturally significant that poorly crimped culurgiones would be considered shameful.",
                es: "La 'chiusura a spighitta' (cierre en forma de espiga) en los culurgiones es una forma de arte tradicional sarda que requiere años para dominar. El intrincado borde trenzado simboliza gavillas de trigo y prosperidad agrícola. La técnica se transmite de abuela a nieta, y la calidad del pliegue se considera una marca de una hábil fabricante de pasta. Este cierre es tan culturalmente significativo que culurgiones mal plegados se considerarían vergonzosos.",
                de: "Die 'Chiusura a Spighitta' (Ähren-Verschluss) bei Culurgiones ist eine traditionelle sardische Kunstform, deren Beherrschung Jahre erfordert. Der kunstvolle geflochtene Rand symbolisiert Weizengarben und landwirtschaftlichen Wohlstand. Die Technik wird von Großmutter zu Enkelin weitergegeben, und die Qualität der Prägung gilt als Zeichen einer geschickten Nudelmacherin. Dieser Verschluss ist so kulturell bedeutsam, dass schlecht geprägte Culurgiones als beschämend gelten würden.",
                nl: "De 'chiusura a spighitta' (korenaar sluiting) op culurgiones is een traditionele Sardijnse kunstvorm die jaren duurt om te beheersen. De ingewikkelde gevlochten rand symboliseert korenaren en landbouwwelvaart. De techniek wordt doorgegeven van grootmoeder op kleindochter, en de kwaliteit van de vouw wordt gezien als een teken van een bekwame pastamaker. Deze sluiting is zo cultureel belangrijk dat slecht gevouwen culurgiones als beschamend zouden worden beschouwd."
            }
        },
        {
            question: {
                en: "What historical significance do testaroli have in pasta history?",
                es: "¿Qué importancia histórica tienen los testaroli en la historia de la pasta?",
                de: "Welche historische Bedeutung haben Testaroli in der Pasta-Geschichte?",
                nl: "Welke historische betekenis hebben testaroli in de pastageschiedenis?"
            },
            options: {
                en: [
                    "They represent one of the most ancient forms of pasta, predating modern extrusion methods",
                    "They were the first pasta to be commercially produced",
                    "They were invented during the Renaissance by Leonardo da Vinci",
                    "They were brought to Italy by Marco Polo from China"
                ],
                es: [
                    "Representan una de las formas más antiguas de pasta, anterior a los métodos modernos de extrusión",
                    "Fueron la primera pasta en ser producida comercialmente",
                    "Fueron inventados durante el Renacimiento por Leonardo da Vinci",
                    "Fueron traídos a Italia por Marco Polo desde China"
                ],
                de: [
                    "Sie repräsentieren eine der ältesten Formen von Pasta, die modernen Extrusionsverfahren vorausgeht",
                    "Sie waren die erste kommerziell hergestellte Pasta",
                    "Sie wurden während der Renaissance von Leonardo da Vinci erfunden",
                    "Sie wurden von Marco Polo aus China nach Italien gebracht"
                ],
                nl: [
                    "Ze vertegenwoordigen een van de oudste vormen van pasta, van vóór moderne extrusiemethoden",
                    "Ze waren de eerste pasta die commercieel geproduceerd werd",
                    "Ze werden uitgevonden tijdens de Renaissance door Leonardo da Vinci",
                    "Ze werden door Marco Polo vanuit China naar Italië gebracht"
                ]
            },
            correctAnswer: 0,
            explanation: {
                en: "Testaroli are considered among the oldest pasta forms in Italy, dating back potentially to Etruscan or Roman times. Their cooking method - baking a batter on a hot stone surface before cutting and boiling - represents an ancient technique that predates the development of pasta dough rolling and extrusion. This makes them a living link to pre-medieval Italian food culture and shows how pasta evolved from simple grain-based cakes.",
