    ...
    questions: [
      {
        ...
        {
                  "en": "Size of the fish",
                  "es": "Tamaño del pescado",
                  "de": "Größe des Fisches",
                  "nl": "Grootte van de vis"
        },
        {
                  "en": "Fat content and distribution in the flesh",
                  "es": "Contenido de grasa y distribución en la carne",
                  "de": "Fettgehalt und Verteilung im Fleisch",
                  "nl": "Vetgehalte en verdeling in het vlees"
        },
        {
                  "en": "Color of the scales",
                  "es": "Color de las escamas",
                  "de": "Farbe der Schuppen",
                  "nl": "Kleur van de schubben"
        },
        {
                  "en": "Habitat depth",
                  "es": "Profundidad del hábitat",
                  "de": "Lebensraumtiefe",
                  "nl": "Habitat diepte"
        }
        ],
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Quick searing at high heat",
                  "es": "Sellado rápido a fuego alto",
                  "de": "Schnelles Anbraten bei hoher Hitze",
                  "nl": "Snel aanbraden op hoge hitte"
        },
        {
                  "en": "Slow braising for 30 minutes",
                  "es": "Estofado lento durante 30 minutos",
                  "de": "Langsames Schmoren für 30 Minuten",
                  "nl": "Langzaam sudderen voor 30 minuten"
        },
        {
                  "en": "Deep frying for 10 minutes",
                  "es": "Freír durante 10 minutos",
                  "de": "10 Minuten frittieren",
                  "nl": "10 minuten frituren"
        },
        {
                  "en": "Boiling for 15 minutes",
                  "es": "Hervir durante 15 minutos",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Removing the digestive tract",
                  "es": "Quitar el tracto digestivo",
                  "de": "Den Verdauungstrakt entfernen",
                  "nl": "Het spijsverteringskanaal verwijderen"
        },
        {
                  "en": "Removing the tail",
                  "es": "Quitar la cola",
                  "de": "Den Schwanz entfernen",
                  "nl": "De staart verwijderen"
        },
        {
                  "en": "Removing the head",
                  "es": "Quitar la cabeza",
                  "de": "Den Kopf entfernen",
                  "nl": "Het hoofd verwijderen"
        },
        {
                  "en": "Removing the shell",
                  "es": "Quitar la cáscara",
                  "de": "Die Schale entfernen",
                  "nl": "De schaal verwijderen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "To cook the fish partially",
                  "es": "Para cocinar el pescado parcialmente",
                  "de": "Um den Fisch teilweise zu garen",
                  "nl": "Om de vis gedeeltelijk te garen"
        },
        {
                  "en": "To enhance moisture retention and flavor",
                  "es": "Para mejorar la retención de humedad y el sabor",
                  "de": "Um Feuchtigkeitsretention und Geschmack zu verbessern",
                  "nl": "Om vochtretentie en smaak te verbeteren"
        },
        {
                  "en": "To remove scales",
                  "es": "Para quitar las escamas",
                  "de": "Um Schuppen zu entfernen",
                  "nl": "Om schubben te verwijderen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Clean ocean or cucumber scent",
                  "es": "Olor limpio a océano o pepino",
                  "de": "Sauberer Ozean- oder Gurkenduft",
                  "nl": "Schone oceaan- of komkommergeur"
        },
        {
                  "en": "Strong fishy odor",
                  "es": "Olor fuerte a pescado",
                  "de": "Starker Fischgeruch",
                  "nl": "Sterke visachtige geur"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "High vitamin C content",
                  "es": "Alto contenido de vitamina C",
                  "de": "Hoher Vitamin-C-Gehalt",
                  "nl": "Hoog vitamine C-gehalte"
        },
        {
                  "en": "High omega-3 fatty acids",
                  "es": "Altos ácidos grasos omega-3",
                  "de": "Hohe Omega-3-Fettsäuren",
                  "nl": "Hoge omega-3 vetzuren"
        },
        {
                  "en": "High carbohydrate content",
                  "es": "Alto contenido de carbohidratos",
                  "de": "Hoher Kohlenhydratgehalt",
                  "nl": "Hoog koolhydraatgehalte"
        },
        {
                  "en": "High fiber content",
                  "es": "Alto contenido de fibra",
                  "de": "Hoher Ballaststoffgehalt",
                  "nl": "Hoog vezelgehalte"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fish that is specially colored",
                  "es": "Pescado especialmente coloreado",
                  "de": "Speziell gefärbter Fisch",
                  "nl": "Speciaal gekleurde vis"
        },
        {
                  "en": "Fish that has been frozen to kill parasites and is safe to eat raw",
                  "es": "Pescado que ha sido congelado para matar parásitos y es seguro para comer crudo",
                  "de": "Fisch, der eingefroren wurde, um Parasiten zu töten und sicher roh gegessen werden kann",
                  "nl": "Vis die is bevroren om parasieten te doden en veilig rauw kan worden gegeten"
        },
        {
                  "en": "Fish with extra salt",
                  "es": "Pescado con sal extra",
                  "de": "Fisch mit extra Salz",
                  "nl": "Vis met extra zout"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The liver and pancreas",
                  "es": "El hígado y el páncreas",
                  "de": "Die Leber und Bauchspeicheldrüse",
                  "nl": "De lever en alvleesklier"
        },
        {
                  "en": "The gills",
                  "es": "Las branquias",
        ...
        {
                  "en": "The tail muscle",
                  "es": "El músculo de la cola",
                  "de": "Der Schwanzmuskel",
                  "nl": "De staartspier"
        }
        ],
        correct: 0,
      ...
      },
      {
        ...
        {
                  "en": "No difference",
                  "es": "Ninguna diferencia",
                  "de": "Kein Unterschied",
                  "nl": "Geen verschil"
        },
        {
                  "en": "Habitat temperature",
                  "es": "Temperatura del hábitat",
                  "de": "Lebensraumtemperatur",
                  "nl": "Habitat temperatuur"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "To prevent curling and ensure even cooking",
                  "es": "Para prevenir que se enrolle y asegurar cocción uniforme",
                  "de": "Um Verbiegen zu verhindern und gleichmäßiges Garen zu gewährleisten",
                  "nl": "Om krullen te voorkomen en gelijkmatig garen te waarborgen"
        },
        {
                  "en": "To absorb more oil",
                  "es": "Para absorber más aceite",
                  "de": "Um mehr Öl aufzunehmen",
                  "nl": "Om meer olie te absorberen"
        },
        {
                  "en": "To add decoration only",
                  "es": "Solo para agregar decoración",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fried fish with spices",
                  "es": "Pescado frito con especias",
                  "de": "Gebratener Fisch mit Gewürzen",
                  "nl": "Gebakken vis met kruiden"
        },
        {
                  "en": "Fish cooked by marinating in citrus juice",
                  "es": "Pescado cocido marinándolo en jugo cítrico",
                  "de": "Fisch gekocht durch Marinieren in Zitronensaft",
                  "nl": "Vis gekookt door te marineren in citrusvruchtensap"
        },
        {
                  "en": "Grilled fish on skewers",
                  "es": "Pescado a la parrilla en brochetas",
                  "de": "Gegrillter Fisch am Spieß",
                  "nl": "Gegrilde vis op spiesjes"
        },
        {
                  "en": "Fish soup",
                  "es": "Sopa de pescado",
      ...
      },
      {
        ...
        },
        {
                  "en": "Digestive fluid",
                  "es": "Fluido digestivo",
                  "de": "Verdauungsflüssigkeit",
                  "nl": "Spijsverteringsvloeistof"
        },
        {
                  "en": "Fat deposits",
                  "es": "Depósitos de grasa",
                  "de": "Fettablagerungen",
                  "nl": "Vetafzettingen"
        }
        ],
      ...
      },
      {
        ...
        {
                  "en": "Processed white fish",
                  "es": "Pescado blanco procesado",
                  "de": "Verarbeiteter Weißfisch",
                  "nl": "Verwerkte witte vis"
        },
        {
                  "en": "Soy protein",
                  "es": "Proteína de soja",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The dark digestive tract that should be removed",
                  "es": "El tracto digestivo oscuro que debe quitarse",
                  "de": "Der dunkle Verdauungstrakt, der entfernt werden sollte",
                  "nl": "Het donkere spijsverteringskanaal dat verwijderd moet worden"
        },
        {
                  "en": "The muscle that opens the shell",
                  "es": "El músculo que abre el caparazón",
                  "de": "Der Muskel, der die Schale öffnet",
                  "nl": "De spier die de schelp opent"
        },
        {
                  "en": "The outer shell edge",
                  "es": "El borde exterior del caparazón",
                  "de": "Die äußere Schalenrand",
                  "nl": "De buitenste schelp rand"
        },
        {
                  "en": "The water inside the shell",
                  "es": "El agua dentro del caparazón",
                  "de": "Das Wasser in der Schale",
                  "nl": "Het water in de schelp"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "de": "Einfacher zu essen",
                  "nl": "Gemakkelijker te eten"
        },
        {
                  "en": "Adds color",
                  "es": "Agrega color",
        ...
        {
                  "en": "Protection and flavor enhancement",
                  "es": "Protección y mejora del sabor",
                  "de": "Schutz und Geschmacksverbesserung",
                  "nl": "Bescherming en smaakverbetering"
        },
        {
                  "en": "Makes them cook slower",
                  "es": "Los hace cocinar más lento",
                  "de": "Lässt sie langsamer garen",
                  "nl": "Laat ze langzamer koken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A marinade for raw fish",
                  "es": "Un adobo para pescado crudo",
                  "de": "Eine Marinade für rohen Fisch",
                  "nl": "Een marinade voor rauwe vis"
        },
        {
                  "en": "A flavored liquid for poaching fish",
                  "es": "Un líquido aromatizado para escalfar pescado",
                  "de": "Eine aromatisierte Flüssigkeit zum Pochieren von Fisch",
                  "nl": "Een gearomatiseerde vloeistof voor het pocheren van vis"
        },
        {
                  "en": "A sauce for grilled fish",
                  "es": "Una salsa para pescado a la parrilla",
                  "de": "Eine Sauce für gegrillten Fisch",
                  "nl": "Een saus voor gegrilde vis"
        },
        {
                  "en": "A type of fish soup",
                  "es": "Un tipo de sopa de pescado",
                  "de": "Eine Art Fischsuppe",
                  "nl": "Een soort vissoep"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The shell should be tightly closed or close when tapped",
                  "es": "La concha debe estar bien cerrada o cerrarse al golpearla",
                  "de": "Die Schale sollte fest geschlossen sein oder sich beim Klopfen schließen",
                  "nl": "De schelp moet stevig gesloten zijn of sluiten bij tikken"
        },
        {
                  "en": "The shell should be cracked",
                  "es": "La concha debe estar agrietada",
                  "de": "Die Schale sollte gesprungen sein",
                  "nl": "De schelp moet gebarsten zijn"
        },
        {
                  "en": "The shell should be wide open",
                  "es": "La concha debe estar completamente abierta",
                  "de": "Die Schale sollte weit geöffnet sein",
                  "nl": "De schelp moet wijd open zijn"
        },
        {
                  "en": "It should smell strongly of fish",
                  "es": "Debe oler fuertemente a pescado",
                  "de": "Sie sollte stark nach Fisch riechen",
                  "nl": "Het moet sterk naar vis ruiken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The color of the fish",
                  "es": "El color del pescado",
                  "de": "Die Farbe des Fisches",
                  "nl": "De kleur van de vis"
        },
        {
                  "en": "Only the temperature of the smoke room",
                  "es": "Solo la temperatura de la sala de ahumado",
                  "de": "Nur die Temperatur des Räucherraums",
                  "nl": "Alleen de temperatuur van de rookkamer"
        },
        {
                  "en": "Hot-smoked is cooked and flaky, cold-smoked is silky and translucent",
                  "es": "El ahumado en caliente está cocido y desmenuzable, el ahumado en frío es sedoso y translúcido",
                  "de": "Heißgeräuchert ist gekocht und flockig, kaltgeräuchert ist seidig und durchscheinend",
                  "nl": "Heet gerookt is gekookt en vlokkerig, koud gerookt is zijdeachtig en doorschijnend"
        },
        {
                  "en": "The type of wood used",
                  "es": "El tipo de madera utilizada",
                  "de": "Die Art des verwendeten Holzes",
                  "nl": "Het type hout dat wordt gebruikt"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To add flavor only",
                  "es": "Solo para agregar sabor",
                  "de": "Nur um Geschmack hinzuzufügen",
                  "nl": "Alleen om smaak toe te voegen"
        },
        {
                  "en": "To change the color",
                  "es": "Para cambiar el color",
        ...
        {
                  "en": "To create a crispy coating and seal in moisture",
                  "es": "Para crear una capa crujiente y sellar la humedad",
                  "de": "Um eine knusprige Beschichtung zu erzeugen und Feuchtigkeit einzuschließen",
                  "nl": "Om een krokante coating te creëren en vocht in te sluiten"
        },
        {
                  "en": "To make it cook slower",
                  "es": "Para que se cocine más lento",
                  "de": "Damit es langsamer gart",
                  "nl": "Om het langzamer te laten koken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A delicacy with tender, sweet meat",
                  "es": "Un manjar con carne tierna y dulce",
                  "de": "Eine Delikatesse mit zartem, süßem Fleisch",
                  "nl": "Een delicatesse met mals, zoet vlees"
        },
        {
                  "en": "Waste product",
        ...
        },
        {
                  ...
                  "de": "Zu zäh zum Essen",
                  "nl": "Te taai om te eten"
        },
        {
                  "en": "Only good for stock",
                  "es": "Solo bueno para caldo",
                  "de": "Nur gut für Brühe",
                  "nl": "Alleen goed voor bouillon"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cutting deeply along the back and opening flat",
                  "es": "Cortar profundamente a lo largo de la espalda y abrir plano",
                  "de": "Tief entlang des Rückens schneiden und flach öffnen",
                  "nl": "Diep langs de rug snijden en plat openen"
        },
        {
                  "en": "Cutting into small pieces",
                  "es": "Cortar en trozos pequeños",
                  "de": "In kleine Stücke schneiden",
                  "nl": "In kleine stukjes snijden"
        },
        {
                  "en": "Removing the tail",
                  "es": "Quitar la cola",
        ...
        {
                  "en": "Coating with butter",
                  "es": "Cubrir con mantequilla",
                  "de": "Mit Butter überziehen",
                  "nl": "Bedekken met boter"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Very large size",
                  "es": "Tamaño muy grande",
                  "de": "Sehr große Größe",
                  "nl": "Zeer grote maat"
        },
        {
                  "en": "Delicate, sweet flavor and fine texture",
                  "es": "Sabor delicado y dulce y textura fina",
                  "de": "Zarter, süßer Geschmack und feine Textur",
                  "nl": "Delicate, zoete smaak en fijne textuur"
        },
        {
                  "en": "Bright coloring",
                  "es": "Coloración brillante",
                  "de": "Helle Färbung",
                  "nl": "Heldere kleuring"
        },
        {
                  "en": "Long shelf life",
                  "es": "Larga vida útil",
                  "de": "Lange Haltbarkeit",
                  "nl": "Lange houdbaarheid"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Uncooked roe (eggs)",
                  "es": "Hueva cruda (huevos)",
                  "de": "Ungekochter Rogen (Eier)",
                  "nl": "Ongekookte kuit (eieren)"
        },
        {
                  "en": "Shell fragments",
                  "es": "Fragmentos de caparazón",
                  "de": "Schalenfragmente",
                  "nl": "Schelpfragmenten"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Freezer burn and ice crystals",
                  "es": "Quemadura por congelación y cristales de hielo",
                  "de": "Gefrierbrand und Eiskristalle",
                  "nl": "Vriesbrand en ijskristallen"
        },
        {
                  "en": "Firm texture",
                  "es": "Textura firme",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To allow juices to redistribute evenly",
                  "es": "Para permitir que los jugos se redistribuyan uniformemente",
                  "de": "Um Säfte gleichmäßig umzuverteilen",
                  "nl": "Om sappen gelijkmatig te laten herverdelen"
        },
        {
                  "en": "Fish should never rest after cooking",
                  "es": "El pescado nunca debe reposar después de cocinar",
                  "de": "Fisch sollte nach dem Kochen nie ruhen",
                  "nl": "Vis moet nooit rusten na het koken"
        },
        {
                  "en": "To cool it down completely",
                  "es": "Para enfriarlo completamente",
                  "de": "Um es vollständig abzukühlen",
                  "nl": "Om het volledig af te koelen"
        },
        {
                  "en": "To make it easier to cut",
                  "es": "Para que sea más fácil de cortar",
                  "de": "Um es leichter zu schneiden",
                  "nl": "Om het gemakkelijker te snijden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "es": "Vienen de diferentes océanos",
                  "de": "Sie kommen aus verschiedenen Ozeanen",
                  "nl": "Ze komen uit verschillende oceanen"
        },
        {
                  "en": "Calamari is cooked, squid is raw",
                  "es": "El calamari está cocido, el calamar está crudo",
                  "de": "Calamari ist gekocht, Tintenfisch ist roh",
                  "nl": "Calamares is gekookt, inktvis is rauw"
        },
        {
                  "en": "They are the same thing, calamari is the Italian name",
                  "es": "Son lo mismo, calamari es el nombre italiano",
                  "de": "Sie sind dasselbe, Calamari ist der italienische Name",
                  "nl": "Het is hetzelfde, calamares is de Italiaanse naam"
        },
        {
                  "en": "Calamari is larger",
                  "es": "El calamari es más grande",
                  "de": "Calamari ist größer",
                  "nl": "Calamares is groter"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "On the kitchen counter at room temperature",
                  "es": "En la encimera de la cocina a temperatura ambiente",
                  "de": "Auf der Küchentheke bei Raumtemperatur",
                  "nl": "Op het aanrecht bij kamertemperatuur"
        },
        {
                  "en": "In the refrigerator overnight",
                  "es": "En el refrigerador durante la noche",
                  "de": "Über Nacht im Kühlschrank",
                  "nl": "In de koelkast gedurende de nacht"
        },
        {
                  "en": "In direct sunlight",
                  "es": "Bajo luz solar directa",
      ...
      },
      {
        ...
        {
                  "en": "Natural pigment in all fish",
                  "es": "Pigmento natural en todos los peces",
                  "de": "Natürliches Pigment in allen Fischen",
                  "nl": "Natuurlijk pigment in alle vissen"
        },
        {
                  "en": "Blood vessels",
                  "es": "Vasos sanguíneos",
      ...
      },
      {
        ...
        {
                  "en": "Nordic cured salmon with salt, sugar, and dill",
                  "es": "Salmón curado nórdico con sal, azúcar y eneldo",
                  "de": "Nordisch gepökelter Lachs mit Salz, Zucker und Dill",
                  "nl": "Noordse gezouten zalm met zout, suiker en dille"
        },
        {
                  "en": "Salmon soup",
                  "es": "Sopa de salmón",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Albumin, a harmless protein",
                  "es": "Albúmina, una proteína inofensiva",
                  "de": "Albumin, ein harmloses Protein",
                  "nl": "Albumine, een onschadelijk eiwit"
        },
        {
                  "en": "Sign of spoilage",
      ...
      },
      {
        ...
        {
                  "en": "Different color only",
                  "es": "Solo color diferente",
                  "de": "Nur unterschiedliche Farbe",
                  "nl": "Alleen verschillende kleur"
        },
        {
                  "en": "Smaller size and more delicate claws",
                  "es": "Tamaño más pequeño y pinzas más delicadas",
                  "de": "Kleinere Größe und zartere Scheren",
                  "nl": "Kleinere maat en delicatere scharen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Pry from the front",
                  "es": "Hacer palanca desde el frente",
                  "de": "Von vorne aufhebeln",
                  "nl": "Wrikken vanaf de voorkant"
        },
        {
                  "en": "Boil until it opens",
                  "es": "Hervir hasta que se abra",
                  "de": "Kochen bis es sich öffnet",
                  "nl": "Koken tot het opengaat"
        },
        {
                  "en": "Insert knife at hinge, twist, then slide along top shell",
                  "es": "Insertar cuchillo en la bisagra, girar, luego deslizar por la concha superior",
                  "de": "Messer am Scharnier einführen, drehen, dann entlang der oberen Schale gleiten",
                  "nl": "Steek mes in het scharnier, draai en schuif langs de bovenste schelp"
        },
        {
                  "en": "Smash with a hammer",
                  "es": "Golpear con un martillo",
                  "de": "Mit einem Hammer zertrümmern",
                  "nl": "Kapot slaan met een hamer"
        }
        ],
        correct: 2,
        explanation: {
