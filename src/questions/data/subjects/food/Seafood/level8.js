    ...
    questions: [
{
        ...
        options: [
          { en: "Wrapping fish in puff pastry with duxelles layer, sealing edges, egg wash, bake until golden - pastry protects moisture, creates elegant presentation", es: "Envolver pescado en masa de hojaldre con capa de duxelles, sellar bordes, lavar con huevo, hornear hasta dorado - masa protege humedad, crea presentación elegante", de: "Fisch in Blätterteig mit Duxelles-Schicht wickeln, Ränder versiegeln, Eigelb bestreichen, backen bis golden - Teig schützt Feuchtigkeit, schafft elegante Präsentation", nl: "Vis inwikkelen in bladerdeeg met duxelles laag, randen verzegelen, ei wash, bakken tot goudkleurig - deeg beschermt vocht, creëert elegante presentatie" },
          { en: "Boiling in stock only", es: "Solo hervir en caldo", de: "Nur in Brühe kochen", nl: "Alleen koken in bouillon" },
          { en: "Raw fish wrapping", es: "Envolver pescado crudo", de: "Rohen Fisch wickeln", nl: "Rauwe vis inwikkelen" },
      ...
      },
      {
        ...
        options: [
          { en: "Puréed raw fish/shellfish mixed with cream and egg whites, poached or used as forcemeat for quenelles, terrines - delicate, airy texture", es: "Pescado/mariscos crudos en puré mezclados con crema y claras de huevo, escalfados o usados como relleno para quenelles, terrinas - textura delicada y aireada", de: "Pürierte rohe Fisch/Schalentiere gemischt mit Sahne und Eiweiß, pochiert oder als Farce für Quenelles, Terrinen verwendet - zarte, luftige Textur", nl: "Gepureerde rauwe vis/schelpdieren gemengd met room en eiwitten, gepocheerd of gebruikt als farce voor quenelles, terrines - delicate, luchtige textuur" },
          { en: "Grilled fish only", es: "Solo pescado a la parrilla", de: "Nur gegrillter Fisch", nl: "Alleen gegrilde vis" },
          { en: "Fried batter", es: "Masa frita", de: "Frittierter Teig", nl: "Gefrituurde beslag" },
          { en: "Raw fish slicing", es: "Rebanar pescado crudo", de: "Rohen Fisch schneiden", nl: "Rauwe vis snijden" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Fish dredged in flour, pan-fried in butter until golden, served with brown butter (beurre noisette), lemon, parsley - miller's wife style", es: "Pescado empanizado en harina, frito en mantequilla hasta dorado, servido con mantequilla marrón (beurre noisette), limón, perejil - estilo esposa del molinero", de: "Fisch in Mehl gewälzt, in Butter gebraten bis golden, mit brauner Butter (Beurre Noisette), Zitrone, Petersilie serviert - Müllers Frau Art", nl: "Vis door meel gehaald, gebakken in boter tot goudkleurig, geserveerd met bruine boter (beurre noisette), citroen, peterselie - molenaarsvrouw stijl" },
          { en: "Boiled fish", es: "Pescado hervido", de: "Gekochter Fisch", nl: "Gekookte vis" },
          { en: "Raw fish", es: "Pescado crudo", de: "Roher Fisch", nl: "Rauwe vis" },
          { en: "Smoked only", es: "Solo ahumado", de: "Nur geräuchert", nl: "Alleen gerookt" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Boning removes all bones while keeping fish whole; butterflying cuts along backbone, spreads open like book for even cooking - both preserve structure differently", es: "Deshuesar elimina todos los huesos manteniendo pescado entero; abrir en mariposa corta a lo largo de columna, abre como libro para cocción uniforme - ambos preservan estructura diferentemente", de: "Entgräten entfernt alle Knochen während Fisch ganz bleibt; Schmetterlingsschnitt schneidet entlang Rückgrat, öffnet wie Buch für gleichmäßiges Garen - beide bewahren Struktur unterschiedlich", nl: "Ontbenen verwijdert alle botten terwijl vis heel blijft; vlinderschnitt snijdt langs ruggengraat, spreidt open als boek voor gelijkmatig koken - beide behouden structuur verschillend" },
          { en: "Same technique", es: "Misma técnica", de: "Gleiche Technik", nl: "Zelfde techniek" },
          { en: "Only for shellfish", es: "Solo para mariscos", de: "Nur für Schalentiere", nl: "Alleen voor schelpdieren" },
          { en: "Boning is only for chicken", es: "Deshuesar es solo para pollo", de: "Entgräten nur für Huhn", nl: "Ontbenen alleen voor kip" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Russian layered fish pie with salmon, rice, mushrooms, hard-boiled eggs, dill in brioche or puff pastry - complex multi-component dish", es: "Pastel de pescado ruso en capas con salmón, arroz, champiñones, huevos duros, eneldo en brioche o masa de hojaldre - plato complejo de múltiples componentes", de: "Russischer geschichteter Fischpastete mit Lachs, Reis, Pilzen, hartgekochten Eiern, Dill in Brioche oder Blätterteig - komplexes Mehrkomponenten-Gericht", nl: "Russische gelaagde vistaart met zalm, rijst, champignons, hardgekookte eieren, dille in brioche of bladerdeeg - complex multi-component gerecht" },
          { en: "Simple grilled fish", es: "Pescado simple a la parrilla", de: "Einfach gegrillter Fisch", nl: "Simpele gegrilde vis" },
          { en: "Raw fish salad", es: "Ensalada de pescado crudo", de: "Roher Fischsalat", nl: "Rauwe vis salade" },
          { en: "Fried fish", es: "Pescado frito", de: "Frittierter Fisch", nl: "Gefrituurde vis" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Thin fish fillets rolled around stuffing (often mousseline), secured with string, poached in wine-based liquid - elegant presentation", es: "Filetes delgados de pescado enrollados alrededor de relleno (a menudo mousseline), asegurados con cuerda, escalfados en líquido a base de vino - presentación elegante", de: "Dünne Fischfilets um Füllung gerollt (oft Mousseline), mit Schnur gesichert, in Wein-basierter Flüssigkeit pochiert - elegante Präsentation", nl: "Dunne visfilets gerold rond vulling (vaak mousseline), vastgemaakt met touw, gepocheerd in wijn-gebaseerde vloeistof - elegante presentatie" },
          { en: "Fried whole fish", es: "Pescado entero frito", de: "Ganzer frittierter Fisch", nl: "Hele gefrituurde vis" },
          { en: "Raw fish only", es: "Solo pescado crudo", de: "Nur roher Fisch", nl: "Alleen rauwe vis" },
          { en: "Grilled fish steaks", es: "Filetes de pescado a la parrilla", de: "Gegrillte Fischsteaks", nl: "Gegrilde vis steaks" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Whole deboned fish stuffed, rolled, tied in cloth, poached, then chilled and sliced - can be served hot or cold", es: "Pescado entero deshuesado relleno, enrollado, atado en tela, escalfado, luego enfriado y rebanado - puede servirse caliente o frío", de: "Ganzer entgräteter Fisch gefüllt, gerollt, in Tuch gebunden, pochiert, dann gekühlt und geschnitten - kann heiß oder kalt serviert werden", nl: "Hele ontbeende vis gevuld, gerold, gebonden in doek, gepocheerd, dan gekoeld en gesneden - kan warm of koud geserveerd worden" },
          { en: "Grilled fish", es: "Pescado a la parrilla", de: "Gegrillter Fisch", nl: "Gegrilde vis" },
          { en: "Raw fish preparation", es: "Preparación de pescado crudo", de: "Rohe Fisch-Zubereitung", nl: "Rauwe vis bereiding" },
          { en: "Fried fish", es: "Pescado frito", de: "Frittierter Fisch", nl: "Gefrituurde vis" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Removes impurities using egg whites and mirepoix raft to create crystal-clear consommé for elegant presentations and aspics", es: "Elimina impurezas usando claras de huevo y balsa de mirepoix para crear consomé cristalino para presentaciones elegantes y áspics", de: "Entfernt Verunreinigungen mit Eiweiß und Mirepoix-Floß um kristallklare Consommé für elegante Präsentationen und Aspiks zu schaffen", nl: "Verwijdert onzuiverheden met eiwitten en mirepoix vlot om kristalheldere consommé te creëren voor elegante presentaties en aspics" },
          { en: "Adds more fish bones", es: "Añade más huesos de pescado", de: "Fügt mehr Fischknochen hinzu", nl: "Voegt meer visbotten toe" },
          { en: "Makes stock cloudy", es: "Hace caldo turbio", de: "Macht Fond trüb", nl: "Maakt bouillon troebel" },
      ...
      },
      {
        ...
        options: [
          { en: "Emulsified butter sauce made by whisking cold butter into warm water, holds at 160-180°F for gentle poaching seafood, prevents overcooking", es: "Salsa de mantequilla emulsionada hecha batiendo mantequilla fría en agua tibia, mantiene a 160-180°F para escalfar mariscos suavemente, previene sobrecocción", de: "Emulgierte Buttersauce durch Einschlagen kalter Butter in warmes Wasser, hält bei 71-82°C zum sanften Pochieren von Meeresfrüchten, verhindert Überkochen", nl: "Geëmulgeerde botersaus gemaakt door koude boter in warm water te kloppen, houdt op 71-82°C voor zacht pocheren van zeevruchten, voorkomt overkoken" },
          { en: "Plain melted butter", es: "Mantequilla derretida simple", de: "Einfache geschmolzene Butter", nl: "Gewoon gesmolten boter" },
          { en: "Cold butter only", es: "Solo mantequilla fría", de: "Nur kalte Butter", nl: "Alleen koude boter" },
          { en: "Clarified butter", es: "Mantequilla clarificada", de: "Geklärte Butter", nl: "Geklaarde boter" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "White wine fish velouté finished with butter, base for Bercy (shallots), Normande (cream, mushroom), Dieppoise (shrimp, mussels) - classic French mother sauce derivative", es: "Velouté de pescado con vino blanco terminado con mantequilla, base para Bercy (chalotas), Normande (crema, champiñones), Dieppoise (camarones, mejillones) - derivado clásico de salsa madre francesa", de: "Weißwein-Fisch-Velouté mit Butter abgeschlossen, Basis für Bercy (Schalotten), Normande (Sahne, Pilze), Dieppoise (Garnelen, Muscheln) - klassisches französisches Muttersauce-Derivat", nl: "Witte wijn vis velouté afgewerkt met boter, basis voor Bercy (sjalotten), Normande (room, champignons), Dieppoise (garnalen, mosselen) - klassieke Franse moedersaus afgeleid" },
          { en: "Red wine reduction", es: "Reducción de vino tinto", de: "Rotwein-Reduktion", nl: "Rode wijn reductie" },
          { en: "Tomato-based sauce", es: "Salsa a base de tomate", de: "Tomatenbasierte Sauce", nl: "Tomaat-gebaseerde saus" },
          { en: "Cream only", es: "Solo crema", de: "Nur Sahne", nl: "Alleen room" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Serving seafood in its aromatic poaching liquid (court bouillon with vegetables, herbs), presented swimming in broth - emphasizes natural flavors", es: "Servir mariscos en su líquido de escalfado aromático (court bouillon con vegetales, hierbas), presentado nadando en caldo - enfatiza sabores naturales", de: "Meeresfrüchte in ihrer aromatischen Pochierflüssigkeit servieren (Court Bouillon mit Gemüse, Kräutern), schwimmend in Brühe präsentiert - betont natürliche Aromen", nl: "Zeevruchten serveren in zijn aromatische pocheer vloeistof (court bouillon met groenten, kruiden), gepresenteerd zwemmend in bouillon - benadrukt natuurlijke smaken" },
          { en: "Fried and dry", es: "Frito y seco", de: "Frittiert und trocken", nl: "Gefrituurd en droog" },
          { en: "Raw only", es: "Solo crudo", de: "Nur roh", nl: "Alleen rauw" },
          { en: "Grilled without liquid", es: "A la parrilla sin líquido", de: "Gegrillt ohne Flüssigkeit", nl: "Gegrilld zonder vloeistof" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Savory egg yolk emulsion whisked over heat with wine/stock, used to glaze or sauce seafood, finished under broiler for golden top", es: "Emulsión salada de yema de huevo batida sobre calor con vino/caldo, usada para glasear o salsear mariscos, terminada bajo asador para tope dorado", de: "Herzhafte Eigelb-Emulsion über Hitze mit Wein/Fond geschlagen, zum Glasieren oder Saucieren von Meeresfrüchten verwendet, unter Grill für goldene Oberseite fertiggestellt", nl: "Hartige eidooier emulsie geklopt op warmte met wijn/bouillon, gebruikt om zeevruchten te glaceren of sauseren, afgewerkt onder grill voor gouden bovenkant" },
          { en: "Tomato sauce", es: "Salsa de tomate", de: "Tomatensauce", nl: "Tomaten saus" },
          { en: "Butter only", es: "Solo mantequilla", de: "Nur Butter", nl: "Alleen boter" },
          { en: "Oil-based dressing", es: "Aderezo a base de aceite", de: "Ölbasiertes Dressing", nl: "Olie-gebaseerde dressing" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Concentrated fish stock with white wine, sweated aromatics, short cooking (20-30 min) for delicate flavor without bitterness - more refined than basic stock", es: "Caldo de pescado concentrado con vino blanco, aromáticos sudados, cocción corta (20-30 min) para sabor delicado sin amargura - más refinado que caldo básico", de: "Konzentrierter Fischfond mit Weißwein, geschwitzten Aromen, kurzes Kochen (20-30 Min) für zarten Geschmack ohne Bitterkeit - raffinierter als Basis-Fond", nl: "Geconcentreerde visbouillon met witte wijn, gezwete aromaten, kort koken (20-30 min) voor delicate smaak zonder bitterheid - meer verfijnd dan basis bouillon" },
          { en: "Chicken stock with fish", es: "Caldo de pollo con pescado", de: "Hühnerbrühe mit Fisch", nl: "Kippenbouillon met vis" },
          { en: "Boiled water only", es: "Solo agua hervida", de: "Nur gekochtes Wasser", nl: "Alleen gekookt water" },
          { en: "Tomato-based stock", es: "Caldo a base de tomate", de: "Tomatenbasierter Fond", nl: "Tomaat-gebaseerde bouillon" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Precise 1-2mm dice of vegetables for garnishing delicate seafood dishes, stocks, sauces - provides texture without overwhelming, professional presentation", es: "Dados precisos de 1-2mm de vegetales para adornar platos delicados de mariscos, caldos, salsas - proporciona textura sin abrumar, presentación profesional", de: "Präzise 1-2mm Würfel von Gemüse zum Garnieren zarter Meeresfrüchte-Gerichte, Fonds, Saucen - bietet Textur ohne zu überwältigen, professionelle Präsentation", nl: "Precieze 1-2mm blokjes van groenten voor garneren van delicate zeevruchten gerechten, bouillons, sauzen - biedt textuur zonder te overheersen, professionele presentatie" },
          { en: "Large chunks only", es: "Solo trozos grandes", de: "Nur große Stücke", nl: "Alleen grote stukken" },
          { en: "Whole vegetables", es: "Vegetales enteros", de: "Ganze Gemüse", nl: "Hele groenten" },
          { en: "Puréed vegetables", es: "Vegetales en puré", de: "Püriertes Gemüse", nl: "Gepureerde groenten" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Fish stock reduced to syrupy glaze (glace), intensely concentrated flavor, used sparingly to fortify sauces, enrich dishes - professional flavor booster", es: "Caldo de pescado reducido a glaseado almibarado (glace), sabor intensamente concentrado, usado con moderación para fortificar salsas, enriquecer platos - potenciador de sabor profesional", de: "Fischfond zu sirupartiger Glasur reduziert (Glace), intensiv konzentrierter Geschmack, sparsam verwendet um Saucen zu verstärken, Gerichte zu bereichern - professioneller Geschmacksverstärker", nl: "Visbouillon gereduceerd tot siroop glazuur (glace), intens geconcentreerde smaak, spaarzaam gebruikt om sauzen te versterken, gerechten te verrijken - professionele smaak versterker" },
          { en: "Ice cubes", es: "Cubos de hielo", de: "Eiswürfel", nl: "IJsblokjes" },
          { en: "Frozen fish", es: "Pescado congelado", de: "Gefrorener Fisch", nl: "Bevroren vis" },
          { en: "Cold sauce", es: "Salsa fría", de: "Kalte Sauce", nl: "Koude saus" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Finely chopped mushrooms cooked until dry, concentrated umami flavor, creates moisture barrier between fish and pastry, prevents sogginess", es: "Champiñones finamente picados cocidos hasta secos, sabor umami concentrado, crea barrera de humedad entre pescado y masa, previene humedad", de: "Fein gehackte Pilze gekocht bis trocken, konzentrierter Umami-Geschmack, schafft Feuchtigkeitsbarriere zwischen Fisch und Teig, verhindert Durchweichung", nl: "Fijn gehakte champignons gekookt tot droog, geconcentreerde umami smaak, creëert vocht barrière tussen vis en deeg, voorkomt doorweken" },
          { en: "Raw vegetables", es: "Vegetales crudos", de: "Rohes Gemüse", nl: "Rauwe groenten" },
      ...
      },
      {
        ...
        options: [
          { en: "Freshwater fish stew braised in red or white wine with onions, mushrooms, bacon; Matelote Normande (cider, Calvados), Bourguignonne (red wine) - regional French traditions", es: "Guiso de pescado de agua dulce estofado en vino tinto o blanco con cebollas, champiñones, tocino; Matelote Normande (sidra, Calvados), Bourguignonne (vino tinto) - tradiciones francesas regionales", de: "Süßwasserfisch-Eintopf geschmort in Rot- oder Weißwein mit Zwiebeln, Pilzen, Speck; Matelote Normande (Cidre, Calvados), Bourguignonne (Rotwein) - regionale französische Traditionen", nl: "Zoetwatervis stoofschotel gesmoord in rode of witte wijn met uien, champignons, spek; Matelote Normande (cider, Calvados), Bourguignonne (rode wijn) - regionale Franse tradities" },
          { en: "Grilled seafood", es: "Mariscos a la parrilla", de: "Gegrillte Meeresfrüchte", nl: "Gegrilde zeevruchten" },
          { en: "Raw fish dish", es: "Plato de pescado crudo", de: "Rohes Fischgericht", nl: "Rauw vis gerecht" },
          { en: "Fried fish", es: "Pescado frito", de: "Frittierter Fisch", nl: "Gefrituurde vis" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Brown butter cooked until hazelnut color/aroma, nutty flavor from browned milk solids, classic for sole meunière, skate, delicate white fish", es: "Mantequilla marrón cocida hasta color/aroma de avellana, sabor de nuez de sólidos de leche dorados, clásica para lenguado meunière, raya, pescado blanco delicado", de: "Braune Butter gekocht bis Haselnuss-Farbe/Aroma, nussiger Geschmack von gebräunten Milchfeststoffen, klassisch für Seezunge Meunière, Rochen, zarter Weißfisch", nl: "Bruine boter gekookt tot hazelnoot kleur/aroma, nootachtige smaak van gebruinde melkvaste stoffen, klassiek voor tong meunière, rog, delicate witte vis" },
          { en: "Raw cold butter", es: "Mantequilla cruda fría", de: "Rohe kalte Butter", nl: "Rauwe koude boter" },
          { en: "Melted butter only", es: "Solo mantequilla derretida", de: "Nur geschmolzene Butter", nl: "Alleen gesmolten boter" },
          { en: "Clarified butter", es: "Mantequilla clarificada", de: "Geklärte Butter", nl: "Geklaarde boter" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Aromatic poaching liquid with water, wine, vinegar, mirepoix, herbs, peppercorns - used for cooking, not reduction; stock uses bones for body and gelatin", es: "Líquido aromático de escalfado con agua, vino, vinagre, mirepoix, hierbas, granos de pimienta - usado para cocinar, no reducción; caldo usa huesos para cuerpo y gelatina", de: "Aromatische Pochierflüssigkeit mit Wasser, Wein, Essig, Mirepoix, Kräuter, Pfefferkörner - zum Kochen verwendet, nicht Reduktion; Fond nutzt Knochen für Körper und Gelatine", nl: "Aromatische pocheer vloeistof met water, wijn, azijn, mirepoix, kruiden, peperkorrels - gebruikt voor koken, geen reductie; bouillon gebruikt botten voor body en gelatine" },
          { en: "Plain water only", es: "Solo agua simple", de: "Nur einfaches Wasser", nl: "Alleen simpel water" },
          { en: "Milk-based liquid", es: "Líquido a base de leche", de: "Milchbasierte Flüssigkeit", nl: "Melk-gebaseerde vloeistof" },
          { en: "Tomato sauce", es: "Salsa de tomate", de: "Tomatensauce", nl: "Tomaten saus" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Provençal saffron-garlic-chili mayonnaise with breadcrumbs, traditionally served with bouillabaisse on toasted bread - adds heat and richness", es: "Mayonesa provenzal de azafrán-ajo-chile con pan rallado, tradicionalmente servida con bouillabaisse en pan tostado - añade calor y riqueza", de: "Provenzalische Safran-Knoblauch-Chili-Mayonnaise mit Semmelbröseln, traditionell mit Bouillabaisse auf geröstetem Brot serviert - fügt Schärfe und Fülle hinzu", nl: "Provençaalse saffraan-knoflook-chili mayonaise met broodkruimels, traditioneel geserveerd met bouillabaisse op geroosterd brood - voegt warmte en rijkdom toe" },
          { en: "Tomato sauce", es: "Salsa de tomate", de: "Tomatensauce", nl: "Tomaten saus" },
          { en: "Cream sauce", es: "Salsa de crema", de: "Sahnesauce", nl: "Room saus" },
          { en: "Butter sauce", es: "Salsa de mantequilla", de: "Buttersauce", nl: "Boter saus" }
        ],
        correct: 0,
        explanation: {
      ...
      },
{
        ...
        options: [
          { en: "White wine-shallot reduction whisked with cold butter creating emulsion; maintain 160-180°F, constant whisking, never boil - classic fish sauce", es: "Reducción de vino blanco-chalota batida con mantequilla fría creando emulsión; mantener 160-180°F, batido constante, nunca hervir - salsa clásica para pescado", de: "Weißwein-Schalotten-Reduktion mit kalter Butter geschlagen schafft Emulsion; halte 71-82°C, ständiges Schlagen, niemals kochen - klassische Fischsauce", nl: "Witte wijn-sjalot reductie geklopt met koude boter creërend emulsie; handhaaf 71-82°C, constant kloppen, nooit koken - klassieke vis saus" },
          { en: "Tomato sauce", es: "Salsa de tomate", de: "Tomatensauce", nl: "Tomaten saus" },
          { en: "Cream-based sauce", es: "Salsa a base de crema", de: "Sahnebasierte Sauce", nl: "Room-gebaseerde saus" },
          { en: "Butter melted only", es: "Solo mantequilla derretida", de: "Nur geschmolzene Butter", nl: "Alleen gesmolten boter" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Mother sauce made from fish stock and blonde roux, foundation for derivative sauces like vin blanc, Normande, Bercy - essential in classical French cuisine", es: "Salsa madre hecha de caldo de pescado y roux rubio, fundamento para salsas derivadas como vin blanc, Normande, Bercy - esencial en cocina francesa clásica", de: "Muttersauce aus Fischfond und blonder Roux, Grundlage für abgeleitete Saucen wie Vin Blanc, Normande, Bercy - wesentlich in klassischer französischer Küche", nl: "Moedersaus gemaakt van visbouillon en blonde roux, basis voor afgeleide sauzen zoals vin blanc, Normande, Bercy - essentieel in klassieke Franse keuken" },
          { en: "Tomato-based sauce", es: "Salsa a base de tomate", de: "Tomatenbasierte Sauce", nl: "Tomaat-gebaseerde saus" },
          { en: "Cream sauce only", es: "Solo salsa de crema", de: "Nur Sahnesauce", nl: "Alleen room saus" },
          { en: "Butter sauce", es: "Salsa de mantequilla", de: "Buttersauce", nl: "Boter saus" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Rich lobster sauce made from shells, tomatoes, white wine, cognac, aromatics - often flambéed, used for lobster américaine classic", es: "Rica salsa de langosta hecha de conchas, tomates, vino blanco, coñac, aromáticos - a menudo flambeada, usada para langosta américaine clásica", de: "Reiche Hummersauce aus Schalen, Tomaten, Weißwein, Cognac, Aromen - oft flambiert, für Hummer Américaine Klassiker verwendet", nl: "Rijke kreeft saus gemaakt van schalen, tomaten, witte wijn, cognac, aromaten - vaak geflambeerd, gebruikt voor kreeft américaine klassiek" },
          { en: "Cream sauce only", es: "Solo salsa de crema", de: "Nur Sahnesauce", nl: "Alleen room saus" },
          { en: "Butter sauce", es: "Salsa de mantequilla", de: "Buttersauce", nl: "Boter saus" },
          { en: "Cheese sauce", es: "Salsa de queso", de: "Käsesauce", nl: "Kaas saus" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Béchamel or velouté enriched with lobster butter, cream, sometimes truffle - pink color, rich, used for lobster, crab, elegant shellfish presentations", es: "Béchamel o velouté enriquecido con mantequilla de langosta, crema, a veces trufa - color rosa, rico, usado para langosta, cangrejo, presentaciones elegantes de mariscos", de: "Béchamel oder Velouté angereichert mit Hummerbutter, Sahne, manchmal Trüffel - rosa Farbe, reich, für Hummer, Krabbe, elegante Schalentier-Präsentationen verwendet", nl: "Béchamel of velouté verrijkt met kreeft boter, room, soms truffel - roze kleur, rijk, gebruikt voor kreeft, krab, elegante schaaldier presentaties" },
          { en: "Tomato sauce", es: "Salsa de tomate", de: "Tomatensauce", nl: "Tomaten saus" },
          { en: "Butter only", es: "Solo mantequilla", de: "Nur Butter", nl: "Alleen boter" },
          { en: "Oil-based", es: "A base de aceite", de: "Ölbasiert", nl: "Olie-gebaseerd" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Emulsified egg yolk-butter sauce with lemon, rich but tangy, complements delicate fish without masking - classic for poached salmon, asparagus", es: "Salsa emulsionada de yema de huevo-mantequilla con limón, rica pero ácida, complementa pescado delicado sin enmascarar - clásica para salmón escalfado, espárragos", de: "Emulgierte Eigelb-Butter-Sauce mit Zitrone, reich aber säuerlich, ergänzt zarten Fisch ohne zu maskieren - klassisch für pochierten Lachs, Spargel", nl: "Geëmulgeerde eidooier-boter saus met citroen, rijk maar pittig, complementeert delicate vis zonder te maskeren - klassiek voor gepocheerde zalm, asperges" },
          { en: "Tomato-based", es: "A base de tomate", de: "Tomatenbasiert", nl: "Tomaat-gebaseerd" },
          { en: "Cream only", es: "Solo crema", de: "Nur Sahne", nl: "Alleen room" },
          { en: "Stock reduction", es: "Reducción de caldo", de: "Fond-Reduktion", nl: "Bouillon reductie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Velouté or béchamel with aspic, coats cold seafood creating glossy finish for buffet presentations, set with gelatin - hot-cold sauce", es: "Velouté o béchamel con áspic, cubre mariscos fríos creando acabado brillante para presentaciones de buffet, fija con gelatina - salsa caliente-fría", de: "Velouté oder Béchamel mit Aspik, überzieht kalte Meeresfrüchte schafft glänzendes Finish für Buffet-Präsentationen, mit Gelatine gesetzt - heiß-kalt Sauce", nl: "Velouté of béchamel met aspic, bedekt koude zeevruchten creërend glanzend finish voor buffet presentaties, gezet met gelatine - warm-koud saus" },
          { en: "Hot sauce only", es: "Solo salsa caliente", de: "Nur heiße Sauce", nl: "Alleen warme saus" },
          { en: "Tomato sauce", es: "Salsa de tomate", de: "Tomatensauce", nl: "Tomaten saus" },
          { en: "Oil-based dressing", es: "Aderezo a base de aceite", de: "Ölbasiertes Dressing", nl: "Olie-gebaseerde dressing" }
        ],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          { en: "Clear savory jelly from clarified fish stock with gelatin, used to coat/glaze cold seafood, create molded presentations - showcases ingredients suspended in gel", es: "Gelatina salada clara de caldo de pescado clarificado con gelatina, usada para cubrir/glasear mariscos fríos, crear presentaciones moldeadas - muestra ingredientes suspendidos en gel", de: "Klare herzhafte Gelee aus geklärtem Fischfond mit Gelatine, verwendet zum Überziehen/Glasieren kalter Meeresfrüchte, Schaffen geformter Präsentationen - zeigt Zutaten in Gel suspendiert", nl: "Heldere hartige gelei van geklaarde visbouillon met gelatine, gebruikt om koude zeevruchten te bedekken/glaceren, gevormde presentaties te creëren - toont ingrediënten gesuspendeerd in gel" },
          { en: "Tomato sauce", es: "Salsa de tomate", de: "Tomatensauce", nl: "Tomaten saus" },
          { en: "Cream sauce", es: "Salsa de crema", de: "Sahnesauce", nl: "Room saus" },
          { en: "Butter only", es: "Solo mantequilla", de: "Nur Butter", nl: "Alleen boter" }
        ],
      ...
      },
      {
        ...
        options: [
          { en: "Pan-fried fish with beurre noisette, lemon segments, capers, croutons - Grenoble-style, bright, textured finish", es: "Pescado frito con beurre noisette, segmentos de limón, alcaparras, crutones - estilo Grenoble, acabado brillante, texturizado", de: "Gebratener Fisch mit Beurre Noisette, Zitronensegmente, Kapern, Croutons - Grenoble-Stil, helles, texturiertes Finish", nl: "Gebakken vis met beurre noisette, citroen segmenten, kappertjes, croutons - Grenoble-stijl, helder, getextureerd finish" },
          { en: "Tomato sauce", es: "Salsa de tomate", de: "Tomatensauce", nl: "Tomaten saus" },
          { en: "Cream sauce", es: "Salsa de crema", de: "Sahnesauce", nl: "Room saus" },
          { en: "Stock reduction", es: "Reducción de caldo", de: "Fond-Reduktion", nl: "Bouillon reductie" }
        ],
      ...
      },
      {
        ...
        options: [
          { en: "Fish poached with white wine, tomatoes, shallots, finished with velouté and butter - named after Chef Dugléré, classic French technique", es: "Pescado escalfado con vino blanco, tomates, chalotas, terminado con velouté y mantequilla - nombrado por Chef Dugléré, técnica francesa clásica", de: "Fisch pochiert mit Weißwein, Tomaten, Schalotten, mit Velouté und Butter abgeschlossen - benannt nach Chef Dugléré, klassische französische Technik", nl: "Vis gepocheerd met witte wijn, tomaten, sjalotten, afgewerkt met velouté en boter - genoemd naar Chef Dugléré, klassieke Franse techniek" },
          { en: "Grilled fish only", es: "Solo pescado a la parrilla", de: "Nur gegrillter Fisch", nl: "Alleen gegrilde vis" },
      ...
      },
      {
        ...
        options: [
          { en: "Fish velouté enriched with cream, mushroom essence, egg yolks, finished with butter - Normandy-style for sole, turbot, elegant fish", es: "Velouté de pescado enriquecido con crema, esencia de champiñones, yemas de huevo, terminado con mantequilla - estilo Normandía para lenguado, rodaballo, pescado elegante", de: "Fisch-Velouté angereichert mit Sahne, Pilzessenz, Eigelb, mit Butter abgeschlossen - Normandie-Stil für Seezunge, Steinbutt, eleganter Fisch", nl: "Vis velouté verrijkt met room, champignon essence, eidooiers, afgewerkt met boter - Normandië-stijl voor tong, tarbot, elegante vis" },
          { en: "Tomato-based", es: "A base de tomate", de: "Tomatenbasiert", nl: "Tomaat-gebaseerd" },
          { en: "Butter only", es: "Solo mantequilla", de: "Nur Butter", nl: "Alleen boter" },
          { en: "Stock reduction", es: "Reducción de caldo", de: "Fond-Reduktion", nl: "Bouillon reductie" }
        ],
      ...
      },
      {
        ...
        options: [
          { en: "Equal parts soft butter and flour kneaded together, whisked into simmering liquid for last-minute thickening without raw flour taste", es: "Partes iguales de mantequilla blanda y harina amasadas juntas, batidas en líquido hirviendo para espesamiento de último minuto sin sabor a harina cruda", de: "Gleiche Teile weiche Butter und Mehl zusammengeknetet, in köchelnde Flüssigkeit geschlagen für Last-Minute-Verdickung ohne rohen Mehlgeschmack", nl: "Gelijke delen zachte boter en bloem samen gekneed, geklopt in sudderend vocht voor last-minute verdikking zonder rauw meel smaak" },
          { en: "Melted butter only", es: "Solo mantequilla derretida", de: "Nur geschmolzene Butter", nl: "Alleen gesmolten boter" },
          { en: "Flour in water", es: "Harina en agua", de: "Mehl in Wasser", nl: "Meel in water" },
          { en: "Cream reduction", es: "Reducción de crema", de: "Sahne-Reduktion", nl: "Room reductie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Egg yolk and cream mixture whisked into hot sauce for enrichment and silky finish, must not boil or will curdle - final thickening and enriching", es: "Mezcla de yema de huevo y crema batida en salsa caliente para enriquecimiento y acabado sedoso, no debe hervir o se cortará - espesamiento y enriquecimiento final", de: "Eigelb und Sahne Mischung in heiße Sauce geschlagen für Anreicherung und seidiges Finish, darf nicht kochen oder gerinnt - finale Verdickung und Bereicherung", nl: "Eidooier en room mengsel geklopt in warme saus voor verrijking en zijdeachtig finish, mag niet koken of zal schiften - finale verdikking en verrijking" },
          { en: "Flour only", es: "Solo harina", de: "Nur Mehl", nl: "Alleen meel" },
          { en: "Butter chunks", es: "Trozos de mantequilla", de: "Butterstücke", nl: "Boter stukken" },
          { en: "Stock reduction", es: "Reducción de caldo", de: "Fond-Reduktion", nl: "Bouillon reductie" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Soft butter mixed with flavorings (herbs, shellfish roe, citrus), rolled in cylinder, chilled, sliced as garnish - beurre maître d'hôtel, beurre de homard", es: "Mantequilla blanda mezclada con saborizantes (hierbas, huevas de mariscos, cítricos), enrollada en cilindro, enfriada, rebanada como guarnición - beurre maître d'hôtel, beurre de homard", de: "Weiche Butter gemischt mit Aromen (Kräuter, Schalentier-Rogen, Zitrus), in Zylinder gerollt, gekühlt, geschnitten als Garnierung - Beurre Maître d'Hôtel, Beurre de Homard", nl: "Zachte boter gemengd met smaakmakers (kruiden, schaaldier kuit, citrus), gerold in cilinder, gekoeld, gesneden als garnering - beurre maître d'hôtel, beurre de homard" },
          { en: "Plain melted butter", es: "Mantequilla derretida simple", de: "Einfache geschmolzene Butter", nl: "Gewoon gesmolten boter" },
          { en: "Butter with flour", es: "Mantequilla con harina", de: "Butter mit Mehl", nl: "Boter met bloem" },
          { en: "Clarified butter only", es: "Solo mantequilla clarificada", de: "Nur geklärte Butter", nl: "Alleen geklaarde boter" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Mousse uses gelatin for cold preparations (aspic-based); mousseline uses cream/egg whites for hot (poached forcemeat) - different stabilizers", es: "Mousse usa gelatina para preparaciones frías (a base de áspic); mousseline usa crema/claras de huevo para caliente (relleno escalfado) - estabilizadores diferentes", de: "Mousse nutzt Gelatine für kalte Zubereitungen (Aspik-basiert); Mousseline nutzt Sahne/Eiweiß für heiß (pochierte Farce) - verschiedene Stabilisatoren", nl: "Mousse gebruikt gelatine voor koude bereidingen (aspic-gebaseerd); mousseline gebruikt room/eiwitten voor warm (gepocheerde farce) - verschillende stabilisatoren" },
          { en: "Same preparation", es: "Misma preparación", de: "Gleiche Zubereitung", nl: "Zelfde bereiding" },
          { en: "Mousse is sweet only", es: "Mousse es solo dulce", de: "Mousse ist nur süß", nl: "Mousse is alleen zoet" },
      ...
      },
      {
        ...
        options: [
          { en: "Layered seafood forcemeat/mousseline with whole pieces (scallops, shrimp, fish), baked in mold, served cold sliced - shows layers when cut", es: "Relleno de mariscos en capas/mousseline con piezas enteras (vieiras, camarones, pescado), horneado en molde, servido frío rebanado - muestra capas al cortar", de: "Geschichtete Meeresfrüchte-Farce/Mousseline mit ganzen Stücken (Jakobsmuscheln, Garnelen, Fisch), in Form gebacken, kalt geschnitten serviert - zeigt Schichten beim Schneiden", nl: "Gelaagde zeevruchten farce/mousseline met hele stukken (coquilles, garnalen, vis), gebakken in vorm, koud gesneden geserveerd - toont lagen bij snijden" },
          { en: "Grilled fish", es: "Pescado a la parrilla", de: "Gegrillter Fisch", nl: "Gegrilde vis" },
          { en: "Fried seafood", es: "Mariscos fritos", de: "Frittierte Meeresfrüchte", nl: "Gefrituurde zeevruchten" },
          { en: "Raw fish only", es: "Solo pescado crudo", de: "Nur roher Fisch", nl: "Alleen rauwe vis" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Shaping mousseline/forcemeat with two spoons into elegant three-sided oval, poached in liquid or used as plating garnish - classic French presentation", es: "Dar forma a mousseline/relleno con dos cucharas en óvalo elegante de tres lados, escalfado en líquido o usado como guarnición de plato - presentación francesa clásica", de: "Mousseline/Farce mit zwei Löffeln zu elegantem dreiseitigem Oval formen, in Flüssigkeit pochiert oder als Plattier-Garnierung verwendet - klassische französische Präsentation", nl: "Mousseline/farce vormen met twee lepels tot elegante driezijdige ovaal, gepocheerd in vocht of gebruikt als bord garnering - klassieke Franse presentatie" },
          { en: "Cube cutting", es: "Corte en cubos", de: "Würfel-Schneiden", nl: "Kubus snijden" },
          { en: "Round balls only", es: "Solo bolas redondas", de: "Nur runde Bälle", nl: "Alleen ronde ballen" },
          { en: "Flat shapes", es: "Formas planas", de: "Flache Formen", nl: "Platte vormen" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Molded seafood preparation in drum-shaped mold - can be mousseline-based or layered with rice, fish, sauce, unmolded for elegant presentation", es: "Preparación de mariscos moldeada en molde en forma de tambor - puede ser a base de mousseline o en capas con arroz, pescado, salsa, desmoldada para presentación elegante", de: "Geformte Meeresfrüchte-Zubereitung in trommelförmiger Form - kann Mousseline-basiert oder geschichtet mit Reis, Fisch, Sauce sein, gestürzt für elegante Präsentation", nl: "Gevormde zeevruchten bereiding in trommel-vormige vorm - kan mousseline-gebaseerd of gelaagd zijn met rijst, vis, saus, gestort voor elegante presentatie" },
          { en: "Grilled fish", es: "Pescado a la parrilla", de: "Gegrillter Fisch", nl: "Gegrilde vis" },
          { en: "Raw preparation", es: "Preparación cruda", de: "Rohe Zubereitung", nl: "Rauwe bereiding" },
          { en: "Fried only", es: "Solo frito", de: "Nur frittiert", nl: "Alleen gefrituurd" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Simmering fumet to concentrate flavors by evaporating water, creating intense seafood essence for sauces - foundation for professional sauce work", es: "Cocinar fumet a fuego lento para concentrar sabores evaporando agua, creando esencia intensa de mariscos para salsas - fundamento para trabajo profesional de salsas", de: "Fumet köcheln um Aromen durch Verdampfen von Wasser zu konzentrieren, intensive Meeresfrüchte-Essenz für Saucen schaffen - Grundlage für professionelle Saucenarbeit", nl: "Fumet sudderen om smaken te concentreren door water te verdampen, intense zeevruchten essence creërend voor sauzen - basis voor professioneel saus werk" },
          { en: "Boiling water", es: "Agua hirviendo", de: "Kochendes Wasser", nl: "Kokend water" },
          { en: "Adding cream", es: "Añadir crema", de: "Sahne hinzufügen", nl: "Room toevoegen" },
          { en: "Thickening with flour", es: "Espesar con harina", de: "Mit Mehl andicken", nl: "Verdikken met meel" }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
          { en: "Ultra-concentrated cooking liquid from specific ingredient (mushroom essence, shellfish essence) - add spoonful for intense flavor without volume", es: "Líquido de cocción ultra-concentrado de ingrediente específico (esencia de champiñones, esencia de mariscos) - añadir cucharada para sabor intenso sin volumen", de: "Ultra-konzentrierte Kochflüssigkeit von spezifischer Zutat (Pilzessenz, Schalentier-Essenz) - füge Löffel für intensiven Geschmack ohne Volumen hinzu", nl: "Ultra-geconcentreerde kookvloeistof van specifiek ingrediënt (champignon essence, schaaldier essence) - voeg lepel toe voor intense smaak zonder volume" },
          { en: "Plain water", es: "Agua simple", de: "Einfaches Wasser", nl: "Gewoon water" },
          { en: "Cream only", es: "Solo crema", de: "Nur Sahne", nl: "Alleen room" },
          { en: "Oil-based", es: "A base de aceite", de: "Ölbasiert", nl: "Olie-gebaseerd" }
        ],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          { en: "Whisking cold butter into finished sauce off heat to enrich, smooth, add shine - 'mounting' with butter, final touch for professional sauces", es: "Batir mantequilla fría en salsa terminada fuera del fuego para enriquecer, suavizar, añadir brillo - 'montar' con mantequilla, toque final para salsas profesionales", de: "Kalte Butter in fertige Sauce außerhalb der Hitze schlagen um zu bereichern, glätten, Glanz hinzuzufügen - 'Montieren' mit Butter, letzter Schliff für professionelle Saucen", nl: "Koude boter in afgewerkte saus buiten warmte kloppen om te verrijken, glad maken, glans toevoegen - 'monteren' met boter, laatste toets voor professionele sauzen" }
,
          { en: "Melting butter only", es: "Solo derretir mantequilla", de: "Nur Butter schmelzen", nl: "Alleen boter smelten" },
          { en: "Adding flour", es: "Añadir harina", de: "Mehl hinzufügen", nl: "Meel toevoegen" },
          { en: "Boiling sauce", es: "Hervir salsa", de: "Sauce kochen", nl: "Saus koken" }
        ],
        correct: 0,
        explanation: {
