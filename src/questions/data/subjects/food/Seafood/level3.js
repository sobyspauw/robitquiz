    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Any fish from the ocean",
                  "es": "Cualquier pescado del océano",
                  "de": "Jeder Fisch aus dem Ozean",
                  "nl": "Elke vis uit de oceaan"
        },
        {
                  "en": "Only fish caught in Japan",
                  "es": "Solo pescado capturado en Japón",
                  "de": "Nur in Japan gefangener Fisch",
                  "nl": "Alleen vis gevangen in Japan"
        },
        {
                  "en": "Fish that is exactly 24 hours old",
                  "es": "Pescado que tiene exactamente 24 horas",
                  "de": "Fisch, der genau 24 Stunden alt ist",
                  "nl": "Vis die precies 24 uur oud is"
        },
        {
                  "en": "Fish frozen to kill parasites and handled with extreme care",
                  "es": "Pescado congelado para matar parásitos y manejado con extremo cuidado",
                  "de": "Fisch, der eingefroren wurde, um Parasiten zu töten und mit äußerster Sorgfalt behandelt",
                  "nl": "Vis die bevroren is om parasieten te doden en met uiterste zorg behandeld"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Prawns have claws on three pairs of legs and larger bodies; shrimp have claws on two pairs",
                  "es": "Los langostinos tienen pinzas en tres pares de patas y cuerpos más grandes; los camarones tienen pinzas en dos pares",
                  "de": "Garnelen haben Scheren an drei Beinpaaren und größere Körper; Shrimps haben Scheren an zwei Paaren",
                  "nl": "Garnalen hebben klauwen op drie paar poten en grotere lichamen; garnalen hebben klauwen op twee paar"
        },
        {
                  "en": "Prawns live in freshwater only",
                  "es": "Los langostinos viven solo en agua dulce",
                  "de": "Garnelen leben nur im Süßwasser",
                  "nl": "Garnalen leven alleen in zoetwater"
        },
        {
                  "en": "They are the same thing",
                  "es": "Son lo mismo",
                  "de": "Sie sind das Gleiche",
                  "nl": "Ze zijn hetzelfde"
        },
        {
                  "en": "Shrimp are always smaller",
                  "es": "Los camarones siempre son más pequeños",
                  "de": "Shrimps sind immer kleiner",
                  "nl": "Garnalen zijn altijd kleiner"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Grilled fish with lemon",
                  "es": "Pescado a la parrilla con limón",
                  "de": "Gegrillter Fisch mit Zitrone",
                  "nl": "Gegrilde vis met citroen"
        },
        {
                  "en": "Fried fish tacos",
                  "es": "Tacos de pescado frito",
                  "de": "Frittierte Fisch-Tacos",
                  "nl": "Gefrituurde vistacos"
        },
        {
                  "en": "Raw fish 'cooked' by marinating in citrus juice",
                  "es": "Pescado crudo 'cocinado' marinándolo en jugo cítrico",
                  "de": "Roher Fisch, der durch Marinieren in Zitrusfruchtsaft 'gekocht' wird",
                  "nl": "Rauwe vis 'gekookt' door te marineren in citrusap"
        },
        {
                  "en": "Fish soup",
                  "es": "Sopa de pescado",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To thicken sauces",
                  "es": "Para espesar salsas",
                  "de": "Zum Verdicken von Saucen",
                  "nl": "Om sauzen te verdikken"
        },
        {
                  "en": "To add rich, briny flavor and dramatic black color to dishes",
                  "es": "Para añadir sabor rico y salado y color negro dramático a los platillos",
                  "de": "Um reichen, salzigen Geschmack und dramatische schwarze Farbe zu Gerichten hinzuzufügen",
                  "nl": "Om rijke, zilte smaak en dramatische zwarte kleur aan gerechten toe te voegen"
        },
        {
                  "en": "As a food preservative only",
                  "es": "Solo como conservante de alimentos",
                  "de": "Nur als Lebensmittelkonservierungsmittel",
                  "nl": "Alleen als voedselconserveringsmiddel"
        },
        {
                  "en": "It is not used in cooking",
                  "es": "No se usa en la cocina",
                  "de": "Es wird nicht beim Kochen verwendet",
                  "nl": "Het wordt niet gebruikt bij het koken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A marking on the skin",
                  "es": "Una marca en la piel",
                  "de": "Eine Markierung auf der Haut",
                  "nl": "Een markering op de huid"
        },
        {
                  "en": "Actual blood vessels that must always be removed",
                  "es": "Vasos sanguíneos reales que siempre deben quitarse",
                  "de": "Tatsächliche Blutgefäße, die immer entfernt werden müssen",
                  "nl": "Werkelijke bloedvaten die altijd verwijderd moeten worden"
        },
        {
                  "en": "Dark red muscle tissue; often removed for milder flavor",
                  "es": "Tejido muscular rojo oscuro; a menudo se quita para sabor más suave",
                  "de": "Dunkelrotes Muskelgewebe; oft für milderen Geschmack entfernt",
                  "nl": "Donkerrood spierweefsel; vaak verwijderd voor mildere smaak"
        },
        {
                  "en": "Parasites in the fish",
                  "es": "Parásitos en el pescado",
                  "de": "Parasiten im Fisch",
                  "nl": "Parasieten in de vis"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Processed fish paste used to make imitation crab and other products",
                  "es": "Pasta de pescado procesada usada para hacer imitación de cangrejo y otros productos",
                  "de": "Verarbeitete Fischpaste zur Herstellung von Imitatkrabbe und anderen Produkten",
                  "nl": "Verwerkte vispasta gebruikt om imitatiekrab en andere producten te maken"
        },
        {
                  "en": "Fermented fish sauce",
                  "es": "Salsa de pescado fermentada",
                  "de": "Fermentierte Fischsauce",
                  "nl": "Gefermenteerde vissaus"
        },
        {
                  "en": "A type of Japanese seaweed",
                  "es": "Un tipo de alga japonesa",
                  "de": "Eine Art japanischer Seetang",
                  "nl": "Een soort Japanse zeewier"
        },
        {
                  "en": "Raw tuna for sushi",
                  "es": "Atún crudo para sushi",
                  "de": "Roher Thunfisch für Sushi",
                  "nl": "Rauwe tonijn voor sushi"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It's the hepatopancreas which can concentrate toxins and pollutants",
                  "es": "Es el hepatopáncreas que puede concentrar toxinas y contaminantes",
                  "de": "Es ist die Hepatopankreas, die Toxine und Schadstoffe konzentrieren kann",
                  "nl": "Het is de hepatopancreas die toxines en vervuilende stoffen kan concentreren"
        },
        {
                  "en": "It's the crab's brain",
                  "es": "Es el cerebro del cangrejo",
                  "de": "Es ist das Gehirn der Krabbe",
                  "nl": "Het is het brein van de krab"
        },
        {
                  "en": "It's poisonous to humans",
                  "es": "Es venenoso para los humanos",
                  "de": "Es ist giftig für Menschen",
                  "nl": "Het is giftig voor mensen"
        },
        {
                  "en": "It's actually safe and considered a delicacy by some",
                  "es": "En realidad es seguro y considerado un manjar por algunos",
                  "de": "Es ist eigentlich sicher und von einigen als Delikatesse betrachtet",
                  "nl": "Het is eigenlijk veilig en wordt door sommigen als een delicatesse beschouwd"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Hot-smoked uses hickory; cold-smoked uses oak",
                  "es": "Ahumado en caliente usa nogal; ahumado en frío usa roble",
                  "de": "Heißgeräuchert verwendet Hickory; kaltgeräuchert verwendet Eiche",
                  "nl": "Heet-gerookt gebruikt hickory; koud-gerookt gebruikt eik"
        },
        {
                  "en": "They are the same thing",
                  "es": "Son lo mismo",
        ...
        {
                  "en": "Hot-smoked is raw; cold-smoked is cooked",
                  "es": "Ahumado en caliente está crudo; ahumado en frío está cocido",
                  "de": "Heißgeräuchert ist roh; kaltgeräuchert ist gekocht",
                  "nl": "Heet-gerookt is rauw; koud-gerookt is gekookt"
        },
        {
                  "en": "Hot-smoked is fully cooked and flaky; cold-smoked is silky and translucent",
                  "es": "Ahumado en caliente está completamente cocido y escamoso; ahumado en frío es sedoso y translúcido",
                  "de": "Heißgeräuchert ist vollständig gegart und flockig; kaltgeräuchert ist seidig und durchscheinend",
                  "nl": "Heet-gerookt is volledig gekookt en vlokkerig; koud-gerookt is zijdeachtig en doorschijnend"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cartilage from the jaw",
                  "es": "Cartílago de la mandíbula",
                  "de": "Knorpel aus dem Kiefer",
                  "nl": "Kraakbeen uit de kaak"
        },
        {
                  "en": "The gills of the fish",
                  "es": "Las branquias del pescado",
                  "de": "Die Kiemen des Fisches",
                  "nl": "De kieuwen van de vis"
        },
        {
                  "en": "They are not edible",
                  "es": "No son comestibles",
                  "de": "Sie sind nicht essbar",
                  "nl": "Ze zijn niet eetbaar"
        },
        {
                  "en": "Tender muscle from the face; prized for sweet flavor and delicate texture",
                  "es": "Músculo tierno de la cara; apreciado por sabor dulce y textura delicada",
                  "de": "Zartes Muskelfleisch aus dem Gesicht; geschätzt für süßen Geschmack und zarte Textur",
                  "nl": "Teder spierweefsel uit het gezicht; gewaardeerd voor zoete smaak en delicate textuur"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fish don't have pin bones",
                  "es": "Los pescados no tienen espinas pin",
                  "de": "Fische haben keine Stiftgräten",
                  "nl": "Vissen hebben geen pin-graten"
        },
        {
                  "en": "The spine of the fish",
                  "es": "La espina dorsal del pescado",
                  "de": "Das Rückgrat des Fisches",
                  "nl": "De ruggengraat van de vis"
        },
        {
                  "en": "Small bones running along the fillet; removed with tweezers or pliers",
                  "es": "Pequeñas espinas que corren a lo largo del filete; se quitan con pinzas",
                  "de": "Kleine Gräten entlang des Filets; mit Pinzette oder Zange entfernt",
                  "nl": "Kleine graten langs het filet; verwijderd met pincet of tang"
        },
        {
                  "en": "Bones in the tail only",
                  "es": "Espinas solo en la cola",
                  "de": "Gräten nur im Schwanz",
                  "nl": "Graten alleen in de staart"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Fat from the fish",
                  "es": "Grasa del pescado",
                  "de": "Fett vom Fisch",
                  "nl": "Vet van de vis"
        },
        {
                  "en": "A sign the fish is spoiled",
                  "es": "Una señal de que el pescado está descompuesto",
                  "de": "Ein Zeichen, dass der Fisch verdorben ist",
                  "nl": "Een teken dat de vis bedorven is"
        },
        {
                  "en": "Albumin protein; harmless and safe to eat",
                  "es": "Proteína albúmina; inofensiva y segura para comer",
                  "de": "Albuminprotein; harmlos und sicher zu essen",
                  "nl": "Albumine-eiwit; onschadelijk en veilig om te eten"
        },
        {
                  "en": "Parasites",
                  "es": "Parásitos",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "'Sea chicken' because it tastes like poultry",
                  "es": "'Pollo de mar' porque sabe a ave",
                  "de": "'Meereshuhn' weil es wie Geflügel schmeckt",
                  "nl": "'Zeekip' omdat het smaakt als gevogelte"
        },
        {
                  "en": "It has no other name",
                  "es": "No tiene otro nombre",
                  "de": "Es hat keinen anderen Namen",
                  "nl": "Het heeft geen andere naam"
        },
        {
                  "en": "'Ocean beef' for its red color",
                  "es": "'Carne de océano' por su color rojo",
                  "de": "'Ozeanrindfleisch' für seine rote Farbe",
                  "nl": "'Oceaanrundvlees' voor zijn rode kleur"
        },
        {
                  "en": "'Poor man's lobster' due to its firm texture and sweet taste",
                  "es": "'Langosta del pobre' debido a su textura firme y sabor dulce",
                  "de": "'Hummer des armen Mannes' wegen seiner festen Textur und süßen Geschmacks",
                  "nl": "'Arme mans kreeft' vanwege zijn stevige textuur en zoete smaak"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Clams have symmetrical shells and live in sand; mussels have asymmetrical shells and attach to surfaces",
                  "es": "Las almejas tienen conchas simétricas y viven en arena; los mejillones tienen conchas asimétricas y se adhieren a superficies",
                  "de": "Venusmuscheln haben symmetrische Schalen und leben im Sand; Miesmuscheln haben asymmetrische Schalen und haften an Oberflächen",
                  "nl": "Kokkels hebben symmetrische schelpen en leven in zand; mosselen hebben asymmetrische schelpen en hechten aan oppervlakken"
        },
        {
                  "en": "Clams are larger and mussels are smaller",
                  "es": "Las almejas son más grandes y los mejillones son más pequeños",
                  "de": "Venusmuscheln sind größer und Miesmuscheln sind kleiner",
                  "nl": "Kokkels zijn groter en mosselen zijn kleiner"
        },
        {
                  "en": "Clams live in freshwater only",
                  "es": "Las almejas viven solo en agua dulce",
                  "de": "Venusmuscheln leben nur im Süßwasser",
                  "nl": "Kokkels leven alleen in zoetwater"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "Raw tuna belly",
                  "es": "Vientre de atún crudo",
                  "de": "Roher Thunfischbauch",
                  "nl": "Rauwe tonijnbuik"
        },
        {
                  "en": "Flying fish roe",
                  "es": "Huevas de pez volador",
                  "de": "Fliegender Fisch-Rogen",
                  "nl": "Vliegende vis kuit"
        },
        {
                  "en": "Sea urchin roe (gonads)",
                  "es": "Huevas de erizo de mar (gónadas)",
                  "de": "Seeigel-Rogen (Gonaden)",
                  "nl": "Zee-egel kuit (geslachtsklieren)"
        },
        {
                  "en": "Fermented soybeans",
                  "es": "Soja fermentada",
                  "de": "Fermentierte Sojabohnen",
                  "nl": "Gefermenteerde sojabonen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To purge sand and grit from inside the shells",
                  "es": "Para purgar arena y arenilla de dentro de las conchas",
                  "de": "Um Sand und Schmutz aus den Schalen zu spülen",
                  "nl": "Om zand en vuil uit de schelpen te spoelen"
        },
        {
                  "en": "To make them taste saltier",
                  "es": "Para que sepan más salados",
                  "de": "Um sie salziger schmecken zu lassen",
                  "nl": "Om ze zoutiger te laten smaken"
        },
        {
                  "en": "This is not necessary",
                  "es": "Esto no es necesario",
                  "de": "Dies ist nicht notwendig",
                  "nl": "Dit is niet nodig"
        },
        {
                  "en": "To kill them before cooking",
                  "es": "Para matarlos antes de cocinar",
                  "de": "Um sie vor dem Kochen zu töten",
                  "nl": "Om ze te doden voor het koken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Makes the fish cook faster",
                  "es": "Hace que el pescado se cocine más rápido",
                  "de": "Lässt den Fisch schneller garen",
                  "nl": "Zorgt ervoor dat de vis sneller kookt"
        },
        {
                  "en": "Prevents the skin from curling and helps render fat evenly",
                  "es": "Previene que la piel se enrolle y ayuda a derretir la grasa uniformemente",
                  "de": "Verhindert das Krümmen der Haut und hilft, Fett gleichmäßig auszulassen",
                  "nl": "Voorkomt dat de huid krult en helpt vet gelijkmatig te laten uitlopen"
        },
        {
                  "en": "Removes the fishy taste",
                  "es": "Quita el sabor a pescado",
                  "de": "Entfernt den fischigen Geschmack",
                  "nl": "Verwijdert de vissige smaak"
        },
        {
                  "en": "It's only for decoration",
                  "es": "Es solo para decoración",
      ...
      },
      {
        ...
        {
                  "en": "They come from different oceans",
                  "es": "Vienen de océanos diferentes",
                  "de": "Sie kommen aus verschiedenen Ozeanen",
                  "nl": "Ze komen uit verschillende oceanen"
        },
        {
                  "en": "Bay scallops are farmed; sea scallops are wild",
                  "es": "Las vieiras de bahía son cultivadas; las vieiras de mar son salvajes",
                  "de": "Buchtjakobsmuscheln sind gezüchtet; Seejakobsmuscheln sind wild",
                  "nl": "Baai-coquilles zijn gekweekt; zee-coquilles zijn wild"
        },
        {
                  "en": "Bay scallops are smaller and sweeter; sea scallops are larger and meatier",
                  "es": "Las vieiras de bahía son más pequeñas y dulces; las vieiras de mar son más grandes y carnosas",
                  "de": "Buchtjakobsmuscheln sind kleiner und süßer; Seejakobsmuscheln sind größer und fleischiger",
                  "nl": "Baai-coquilles zijn kleiner en zoeter; zee-coquilles zijn groter en vleesachtiger"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bacterial growth indicating spoilage",
                  "es": "Crecimiento bacteriano indicando descomposición",
                  "de": "Bakterienwachstum, das Verderb anzeigt",
                  "nl": "Bacteriële groei die bederf aangeeft"
        },
        {
                  "en": "Oil from cooking",
                  "es": "Aceite de cocinar",
                  "de": "Öl vom Kochen",
                  "nl": "Olie van het koken"
        },
        {
                  "en": "Light reflecting off microscopic structures in skin/muscle; it's normal and safe",
                  "es": "Luz reflejándose en estructuras microscópicas en piel/músculo; es normal y seguro",
                  "de": "Licht, das sich von mikroskopischen Strukturen in Haut/Muskel reflektiert; es ist normal und sicher",
                  "nl": "Licht dat reflecteert op microscopische structuren in huid/spier; het is normaal en veilig"
        },
        {
                  "en": "Chemical contamination",
                  "es": "Contaminación química",
                  "de": "Chemische Kontamination",
                  "nl": "Chemische besmetting"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They taste completely different",
                  "es": "Saben completamente diferente",
                  "de": "Sie schmecken völlig unterschiedlich",
                  "nl": "Ze smaken volledig anders"
        },
        {
                  "en": "Farm-raised is always healthier",
                  "es": "De cultivo siempre es más saludable",
                  "de": "Gezüchtete sind immer gesünder",
                  "nl": "Gekweekt is altijd gezonder"
        },
        {
                  "en": "Wild-caught live in natural habitats; farm-raised are cultivated in controlled environments",
                  "es": "Capturados salvajes viven en hábitats naturales; de cultivo se cultivan en ambientes controlados",
                  "de": "Wild gefangene leben in natürlichen Lebensräumen; gezüchtete werden in kontrollierten Umgebungen kultiviert",
                  "nl": "Wildgevangen leven in natuurlijke habitats; gekweekte worden gecultiveerd in gecontroleerde omgevingen"
        },
        {
                  "en": "Wild-caught is always more expensive",
                  "es": "Capturado salvaje siempre es más costoso",
                  "de": "Wild gefangene sind immer teurer",
                  "nl": "Wildgevangen is altijd duurder"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Deep frying fish",
                  "es": "Freír pescado profundamente",
                  "de": "Fisch frittieren",
                  "nl": "Vis frituren"
        },
        {
                  "en": "Grilling fish on cedar planks",
                  "es": "Asar pescado en tablas de cedro",
                  "de": "Fisch auf Zedernholzbrettern grillen",
                  "nl": "Vis grillen op cederhoutplanken"
        },
        {
                  "en": "Cooking fish sealed in parchment paper or foil packets",
                  "es": "Cocinar pescado sellado en papel pergamino o paquetes de aluminio",
                  "de": "Kochen von Fisch versiegelt in Pergamentpapier oder Folien-Päckchen",
                  "nl": "Vis koken verzegeld in bakpapier of foliepakketjes"
        },
        {
                  "en": "Raw fish preparation",
                  "es": "Preparación de pescado crudo",
                  "de": "Rohe Fischzubereitung",
                  "nl": "Rauwe visbereiding"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "To cool it down for eating",
                  "es": "Para enfriarlo para comer",
                  "de": "Um es zum Essen abzukühlen",
                  "nl": "Om het af te koelen voor het eten"
        },
        {
                  "en": "Only meat needs resting",
                  "es": "Solo la carne necesita reposar",
                  "de": "Nur Fleisch muss ruhen",
                  "nl": "Alleen vlees heeft rust nodig"
        },
        {
                  "en": "Allows juices to redistribute and temperature to equalize for better texture",
                  "es": "Permite que los jugos se redistribuyan y la temperatura se iguale para mejor textura",
                  "de": "Ermöglicht Säften, sich zu verteilen und Temperatur auszugleichen für bessere Textur",
                  "nl": "Laat sappen herverdelen en temperatuur gelijk worden voor betere textuur"
        },
        {
                  "en": "Fish doesn't need to rest",
                  "es": "El pescado no necesita reposar",
                  "de": "Fisch muss nicht ruhen",
                  "nl": "Vis hoeft niet te rusten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They are freshwater only",
                  "es": "Son solo de agua dulce",
                  "de": "Sie sind nur Süßwasser",
                  "nl": "Ze zijn alleen zoetwatersoorten"
        },
        {
                  "en": "They are the smallest clams in the world",
                  "es": "Son las almejas más pequeñas del mundo",
                  "de": "Sie sind die kleinsten Muscheln der Welt",
                  "nl": "Ze zijn de kleinste schelpdieren ter wereld"
        },
        {
                  "en": "Large clams with a long protruding siphon that can't fully retract into the shell",
                  "es": "Almejas grandes con un sifón largo saliente que no puede retraerse completamente en la concha",
                  "de": "Große Muscheln mit einem langen hervorstehenden Siphon, der sich nicht vollständig in die Schale zurückziehen kann",
                  "nl": "Grote schelpdieren met een lange uitstekende sifon die niet volledig in de schelp kan terugtrekken"
        },
        {
                  "en": "They live in trees",
                  "es": "Viven en árboles",
                  "de": "Sie leben in Bäumen",
                  "nl": "Ze leven in bomen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Lox comes from wild salmon only",
                  "es": "Lox proviene solo de salmón salvaje",
                  "de": "Lox kommt nur von Wildlachs",
                  "nl": "Lox komt alleen van wilde zalm"
        },
        {
                  "en": "Lox is salt-cured only; smoked salmon is cured then smoked",
                  "es": "Lox solo se cura con sal; el salmón ahumado se cura y luego se ahuma",
                  "de": "Lox wird nur salzgepökelt; geräucherter Lachs wird gepökelt und dann geräuchert",
                  "nl": "Lox wordt alleen gepekeld met zout; gerookte zalm wordt gepekeld en dan gerookt"
        },
        {
                  "en": "Lox is hot-smoked; smoked salmon is cold-smoked",
                  "es": "Lox se ahuma en caliente; el salmón ahumado se ahuma en frío",
                  "de": "Lox wird heißgeräuchert; geräucherter Lachs wird kaltgeräuchert",
                  "nl": "Lox wordt heet-gerookt; gerookte zalm wordt koud-gerookt"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Seaweed wrapper",
                  "es": "Envoltorio de alga",
                  "de": "Seetang-Umwicklung",
                  "nl": "Zeewier omhulsel"
        },
        {
                  "en": "Soy sauce stain",
                  "es": "Mancha de salsa de soja",
                  "de": "Soja-Soßenfleck",
                  "nl": "Sojasausvlek"
        },
        {
        ...
        {
                  "en": "The bloodline (dark muscle tissue), often removed for aesthetic and flavor reasons",
                  "es": "La línea de sangre (tejido muscular oscuro), a menudo quitado por razones estéticas y de sabor",
                  "de": "Die Blutlinie (dunkles Muskelgewebe), oft aus ästhetischen und Geschmacksgründen entfernt",
                  "nl": "De bloedlijn (donker spierweefsel), vaak verwijderd om esthetische en smaakredenen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Moisture prevents browning and crispy skin; dry fish sears better",
                  "es": "La humedad previene el dorado y la piel crujiente; el pescado seco se sella mejor",
                  "de": "Feuchtigkeit verhindert Bräunung und knusprige Haut; trockener Fisch brät besser an",
                  "nl": "Vocht voorkomt bruining en knapperige huid; droge vis braadt beter aan"
        },
        {
                  "en": "To remove all flavor",
                  "es": "Para quitar todo el sabor",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Made from whole fish; same cooking time as meat stocks",
                  "es": "Hecho de pescado entero; mismo tiempo de cocción que caldos de carne",
                  "de": "Hergestellt aus ganzen Fischen; gleiche Kochzeit wie Fleischfonds",
                  "nl": "Gemaakt van hele vis; zelfde kooktijd als vleesbouillons"
        },
        {
                  "en": "Made from fish bones/heads; cooks much faster (20-45 minutes) than meat stocks",
                  "es": "Hecho de espinas/cabezas de pescado; se cocina mucho más rápido (20-45 minutos) que caldos de carne",
                  "de": "Hergestellt aus Fischgräten/-köpfen; kocht viel schneller (20-45 Minuten) als Fleischfonds",
                  "nl": "Gemaakt van visgraten/-koppen; kookt veel sneller (20-45 minuten) dan vleesbouillons"
        },
        {
                  "en": "Fish stock is always dark brown",
                  "es": "El caldo de pescado siempre es marrón oscuro",
                  "de": "Fischfond ist immer dunkelbraun",
                  "nl": "Visbouillon is altijd donkerbruin"
        },
        {
                  "en": "They are all the same",
                  "es": "Todos son iguales",
                  "de": "Sie sind alle gleich",
                  "nl": "Ze zijn allemaal hetzelfde"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Meat around the clavicle and behind gills; fatty, flavorful, and limited per fish",
                  "es": "Carne alrededor de la clavícula y detrás de las branquias; grasa, sabrosa y limitada por pescado",
                  "de": "Fleisch um das Schlüsselbein und hinter den Kiemen; fett, schmackhaft und begrenzt pro Fisch",
                  "nl": "Vlees rond het sleutelbeen en achter de kieuwen; vet, smaakvol en beperkt per vis"
        },
        {
                  "en": "Decorative scales on the neck",
                  "es": "Escamas decorativas en el cuello",
                  "de": "Dekorative Schuppen am Hals",
                  "nl": "Decoratieve schubben op de nek"
        },
        {
                  "en": "They are not used in cooking",
                  "es": "No se usan en la cocina",
                  "de": "Sie werden nicht beim Kochen verwendet",
                  "nl": "Ze worden niet gebruikt bij het koken"
        },
        {
                  "en": "The gills themselves",
                  "es": "Las branquias mismas",
                  "de": "Die Kiemen selbst",
                  "nl": "De kieuwen zelf"
        }
        ],
        correct: 0,
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Denatures proteins for firmer texture and adds brightness; but can 'overcook' if too long",
                  "es": "Desnaturaliza proteínas para textura más firme y añade luminosidad; pero puede 'sobrecocinar' si es demasiado tiempo",
                  "de": "Denaturiert Proteine für festere Textur und fügt Helligkeit hinzu; kann aber 'überkochen' wenn zu lange",
                  "nl": "Denatureert eiwitten voor stevigere textuur en voegt helderheid toe; maar kan 'te gaar' worden als te lang"
        },
        {
                  "en": "Acid should never be used with seafood",
                  "es": "El ácido nunca debe usarse con mariscos",
                  "de": "Säure sollte niemals mit Meeresfrüchten verwendet werden",
                  "nl": "Zuur mag nooit gebruikt worden met zeevruchten"
        },
        {
                  "en": "Only for flavor, doesn't affect texture",
                  "es": "Solo para sabor, no afecta la textura",
                  "de": "Nur für Geschmack, beeinflusst Textur nicht",
                  "nl": "Alleen voor smaak, beïnvloedt textuur niet"
        },
        {
                  "en": "To make it softer",
                  "es": "Para hacerlo más suave",
                  "de": "Um es weicher zu machen",
                  "nl": "Om het zachter te maken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cured and dried fish roe, grated over pasta or salads",
                  "es": "Huevas de pescado curadas y secadas, ralladas sobre pasta o ensaladas",
                  "de": "Gepökelter und getrockneter Fischrogen, über Pasta oder Salate gerieben",
                  "nl": "Gepekelde en gedroogde viskuit, geraspt over pasta of salades"
        },
        {
                  "en": "Smoked eel",
                  "es": "Anguila ahumada",
        ...
        {
                  "en": "Dried seaweed sheets",
                  "es": "Hojas de alga seca",
                  "de": "Getrocknete Seetangblätter",
                  "nl": "Gedroogde zeewierbladen"
        },
        {
                  "en": "A type of fish sauce",
                  "es": "Un tipo de salsa de pescado",
                  "de": "Eine Art Fischsauce",
                  "nl": "Een soort vissaus"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only buy bivalves with both shells intact",
                  "es": "Solo compra bivalvos con ambas conchas intactas",
                  "de": "Kaufen Sie nur Muscheln mit beiden intakten Schalen",
                  "nl": "Koop alleen tweekleppigen met beide schelpen intact"
        },
        {
                  "en": "Bivalves must be washed twice",
                  "es": "Los bivalvos deben lavarse dos veces",
                  "de": "Muscheln müssen zweimal gewaschen werden",
                  "nl": "Tweekleppigen moeten twee keer gewassen worden"
        },
        {
                  "en": "Each serving should have two shells",
                  "es": "Cada porción debe tener dos conchas",
                  "de": "Jede Portion sollte zwei Schalen haben",
                  "nl": "Elke portie moet twee schelpen hebben"
        },
        {
                  "en": "Live bivalves should have tightly closed shells or close when tapped",
                  "es": "Los bivalvos vivos deben tener conchas bien cerradas o cerrarse al tocarlas",
                  "de": "Lebende Muscheln sollten fest geschlossene Schalen haben oder sich beim Klopfen schließen",
                  "nl": "Levende tweekleppigen moeten stevig gesloten schelpen hebben of sluiten bij tikken"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        },
        {
                  "en": "Dried cod",
                  "es": "Bacalao seco",
                  "de": "Getrockneter Kabeljau",
                  "nl": "Gedroogde kabeljauw"
        },
        {
                  "en": "Salmon cured with salt, sugar, and dill",
                  "es": "Salmón curado con sal, azúcar y eneldo",
                  "de": "Mit Salz, Zucker und Dill gepökelter Lachs",
                  "nl": "Zalm gepekeld met zout, suiker en dille"
        },
        {
                  "en": "Smoked trout",
                  "es": "Trucha ahumada",
                  "de": "Geräucherte Forelle",
                  "nl": "Gerookte forel"
        }
        ],
        correct: 2,
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The digestive tract; removed for aesthetic and textural reasons",
                  "es": "El tracto digestivo; se quita por razones estéticas y de textura",
                  "de": "Der Verdauungstrakt; aus ästhetischen und texturellen Gründen entfernt",
                  "nl": "Het spijsverteringskanaal; verwijderd om esthetische en texturele redenen"
        },
        {
                  "en": "An actual blood vessel",
                  "es": "Un vaso sanguíneo real",
                  "de": "Ein tatsächliches Blutgefäß",
                  "nl": "Een echte bloedvat"
        },
        {
                  "en": "The tail of the shrimp",
                  "es": "La cola del camarón",
                  "de": "Der Schwanz der Garnele",
                  "nl": "De staart van de garnaal"
        },
        {
                  "en": "A parasite that must be removed",
                  "es": "Un parásito que debe quitarse",
                  "de": "Ein Parasit, der entfernt werden muss",
                  "nl": "Een parasiet die verwijderd moet worden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Grilled fresh cod",
                  "es": "Bacalao fresco a la parrilla",
                  "de": "Gegrillter frischer Kabeljau",
                  "nl": "Gegrilde verse kabeljauw"
        },
        {
                  "en": "Fried cod fritters",
                  "es": "Buñuelos de bacalao frito",
                  "de": "Frittierte Kabeljaukrapfen",
                  "nl": "Gefrituurde kabeljauwbeignets"
        },
        {
                  "en": "A creamy French dish of salt cod whipped with olive oil and garlic",
                  "es": "Un platillo cremoso francés de bacalao salado batido con aceite de oliva y ajo",
                  "de": "Ein cremiges französisches Gericht aus Stockfisch mit Olivenöl und Knoblauch geschlagen",
                  "nl": "Een romig Frans gerecht van gezouten kabeljauw geklopt met olijfolie en knoflook"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "145°F (63°C) for food safety",
                  "es": "145°F (63°C) para seguridad alimentaria",
                  "de": "145°F (63°C) für Lebensmittelsicherheit",
                  "nl": "145°F (63°C) voor voedselveiligheid"
        },
        {
                  "en": "180°F (82°C)",
                  "es": "180°F (82°C)",
        ...
        {
                  "en": "165°F (74°C) like chicken",
                  "es": "165°F (74°C) como el pollo",
                  "de": "165°F (74°C) wie Huhn",
                  "nl": "165°F (74°C) zoals kip"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dry are frozen; wet are fresh",
                  "es": "Secas están congeladas; húmedas son frescas",
                  "de": "Trockene sind gefroren; nasse sind frisch",
                  "nl": "Droge zijn bevroren; natte zijn vers"
        },
        {
                  "en": "Dry are smaller; wet are larger",
                  "es": "Secas son más pequeñas; húmedas son más grandes",
                  "de": "Trockene sind kleiner; nasse sind größer",
                  "nl": "Droge zijn kleiner; natte zijn groter"
        },
        {
        ...
        {
                  "en": "Dry are untreated; wet are soaked in preservatives that add water weight",
                  "es": "Secas no están tratadas; húmedas están remojadas en conservantes que añaden peso de agua",
                  "de": "Trockene sind unbehandelt; nasse sind in Konservierungsmitteln eingeweicht, die Wassergewicht hinzufügen",
                  "nl": "Droge zijn onbehandeld; natte zijn geweekt in conserveringsmiddelen die watergewicht toevoegen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Dried seaweed sheets used to wrap sushi and onigiri",
                  "es": "Hojas de alga seca usadas para envolver sushi y onigiri",
                  "de": "Getrocknete Seetangblätter zum Einwickeln von Sushi und Onigiri",
                  "nl": "Gedroogde zeewierbladen gebruikt om sushi en onigiri te wikkelen"
        },
        {
                  "en": "Japanese rice vinegar",
                  "es": "Vinagre de arroz japonés",
                  "de": "Japanischer Reisessig",
                  "nl": "Japanse rijstazijn"
        },
        {
                  "en": "Raw fish for sashimi",
                  "es": "Pescado crudo para sashimi",
                  "de": "Roher Fisch für Sashimi",
                  "nl": "Rauwe vis voor sashimi"
        },
        {
                  "en": "Wasabi paste",
                  "es": "Pasta de wasabi",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It's a different species",
                  "es": "Es una especie diferente",
                  "de": "Es ist eine andere Art",
                  "nl": "Het is een andere soort"
        },
        {
                  "en": "It's been cooked too long",
                  "es": "Ha sido cocido demasiado tiempo",
                  "de": "Es wurde zu lange gekocht",
                  "nl": "Het is te lang gekookt"
        },
        {
                  "en": "It's sick or diseased",
                  "es": "Está enfermo o con enfermedad",
                  "de": "Es ist krank oder erkrankt",
                  "nl": "Het is ziek of aangetast"
        },
        {
                  "en": "It has recently molted and has a new, tender shell",
                  "es": "Recientemente ha mudado y tiene un caparazón nuevo y tierno",
                  "de": "Es hat sich kürzlich gehäutet und hat eine neue, zarte Schale",
                  "nl": "Het is recent verveld en heeft een nieuwe, tere schil"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Unwrapped in the vegetable drawer",
                  "es": "Sin envolver en el cajón de verduras",
                  "de": "Unverpackt im Gemüsefach",
                  "nl": "Onverpakt in de groentelade"
        },
        {
                  "en": "Fish should never be refrigerated",
                  "es": "El pescado nunca debe refrigerarse",
                  "de": "Fisch sollte niemals gekühlt werden",
                  "nl": "Vis mag nooit gekoeld worden"
        },
        {
                  "en": "In warm water",
                  "es": "En agua tibia",
        ...
        {
                  "en": "On ice in the coldest part (32-38°F), wrapped and with drainage",
                  "es": "Sobre hielo en la parte más fría (32-38°F), envuelto y con drenaje",
                  "de": "Auf Eis im kältesten Teil (32-38°F), eingewickelt und mit Drainage",
                  "nl": "Op ijs in het koudste deel (32-38°F), verpakt en met drainage"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Fish cooked then marinated in acidic sauce with spices",
                  "es": "Pescado cocido luego marinado en salsa ácida con especias",
                  "de": "Fisch gekocht und dann in saurer Sauce mit Gewürzen mariniert",
                  "nl": "Vis gekookt en dan gemarineerd in zure saus met kruiden"
        }
        ],
        correct: 3,
        explanation: {
