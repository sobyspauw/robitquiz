    ...
    questions: [
      {
        ...
        options: [
        {
                  "en": "Lettuce, tomatoes, carrots, ranch dressing",
                  "es": "Lechuga, tomates, zanahorias, aderezo ranch",
                  "de": "Kopfsalat, Tomaten, Karotten, Ranch-Dressing",
                  "nl": "Sla, tomaten, wortels, ranch dressing"
        },
        {
                  "en": "Cabbage, carrots, mayonnaise",
                  "es": "Col, zanahorias, mayonesa",
                  "de": "Kohl, Karotten, Mayonnaise",
                  "nl": "Kool, wortels, mayonaise"
        },
        {
                  "en": "Spinach, strawberries, pecans, goat cheese",
                  "es": "Espinaca, fresas, nueces pecanas, queso de cabra",
                  "de": "Spinat, Erdbeeren, Pekannüsse, Ziegenkäse",
                  "nl": "Spinazie, aardbeien, pecannoten, geitenkaas"
        },
        {
                  "en": "Tomatoes, cucumbers, olives, onions, feta cheese, olive oil",
                  "es": "Tomates, pepinos, aceitunas, cebollas, queso feta, aceite de oliva",
                  "de": "Tomaten, Gurken, Oliven, Zwiebeln, Feta-Käse, Olivenöl",
                  "nl": "Tomaten, komkommers, olijven, uien, fetakaas, olijfolie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A pasta salad with vegetables",
                  "es": "Una ensalada de pasta con verduras",
                  "de": "Ein Nudelsalat mit Gemüse",
                  "nl": "Een pastasalade met groenten"
        },
        {
                  "en": "A green salad with mixed lettuces",
                  "es": "Una ensalada verde con lechugas mixtas",
                  "de": "Ein grüner Salat mit gemischten Salaten",
                  "nl": "Een groene salade met gemengde sla"
        },
        {
                  "en": "A composed salad featuring tomatoes, mozzarella, and basil",
                  "es": "Una ensalada compuesta con tomates, mozzarella y albahaca",
                  "de": "Ein komponierter Salat mit Tomaten, Mozzarella und Basilikum",
                  "nl": "Een samengestelde salade met tomaten, mozzarella en basilicum"
        },
        {
                  "en": "A fruit salad with citrus",
                  "es": "Una ensalada de frutas con cítricos",
                  "de": "Ein Obstsalat mit Zitrusfrüchten",
                  "nl": "Een fruitsalade met citrusvruchten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It contains apples, celery, walnuts, and mayonnaise-based dressing",
                  "es": "Contiene manzanas, apio, nueces y aderezo a base de mayonesa",
                  "de": "Er enthält Äpfel, Sellerie, Walnüsse und Mayonnaise-basiertes Dressing",
                  "nl": "Het bevat appels, selderij, walnoten en mayonaise-gebaseerde dressing"
        },
        {
                  "en": "It's served warm",
                  "es": "Se sirve caliente",
                  "de": "Er wird warm serviert",
                  "nl": "Het wordt warm geserveerd"
        },
        {
                  "en": "It contains no dressing",
                  "es": "No contiene aderezo",
                  "de": "Er enthält kein Dressing",
                  "nl": "Het bevat geen dressing"
        },
        {
                  "en": "It only uses tropical fruits",
                  "es": "Solo usa frutas tropicales",
                  "de": "Er verwendet nur tropische Früchte",
                  "nl": "Het gebruikt alleen tropische vruchten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It's made only by professional chefs",
                  "es": "Solo la hacen chefs profesionales",
                  "de": "Er wird nur von professionellen Köchen zubereitet",
                  "nl": "Het wordt alleen gemaakt door professionele koks"
        },
        {
                  "en": "It contains multiple proteins like ham, turkey, and cheese arranged on greens",
                  "es": "Contiene múltiples proteínas como jamón, pavo y queso organizados sobre hojas verdes",
                  "de": "Er enthält mehrere Proteine wie Schinken, Truthahn und Käse, angeordnet auf Grüns",
                  "nl": "Het bevat meerdere eiwitten zoals ham, kalkoen en kaas gerangschikt op groenten"
        },
        {
                  "en": "It's served hot",
                  "es": "Se sirve caliente",
                  "de": "Er wird heiß serviert",
                  "nl": "Het wordt warm geserveerd"
        },
        {
                  "en": "It only contains vegetables",
                  "es": "Solo contiene verduras",
                  "de": "Er enthält nur Gemüse",
                  "nl": "Het bevat alleen groenten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Short, shaped pasta like rotini, penne, or fusilli",
                  "es": "Pasta corta con forma como rotini, penne o fusilli",
                  "de": "Kurze, geformte Pasta wie Rotini, Penne oder Fusilli",
                  "nl": "Korte, gevormde pasta zoals rotini, penne of fusilli"
        },
        {
                  "en": "Fresh pasta only",
                  "es": "Solo pasta fresca",
                  "de": "Nur frische Pasta",
                  "nl": "Alleen verse pasta"
        },
        {
                  "en": "Long pasta like spaghetti or linguine",
                  "es": "Pasta larga como espaguetis o linguine",
                  "de": "Lange Pasta wie Spaghetti oder Linguine",
                  "nl": "Lange pasta zoals spaghetti of linguine"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It's served in rows of different ingredients arranged on lettuce",
                  "es": "Se sirve en filas de diferentes ingredientes organizados sobre lechuga",
                  "de": "Er wird in Reihen verschiedener Zutaten serviert, die auf Kopfsalat angeordnet sind",
                  "nl": "Het wordt geserveerd in rijen van verschillende ingrediënten gerangschikt op sla"
        },
        {
                  "en": "It only contains corn",
                  "es": "Solo contiene maíz",
                  "de": "Er enthält nur Mais",
                  "nl": "Het bevat alleen maïs"
        },
        {
                  "en": "It's served hot",
                  "es": "Se sirve caliente",
        ...
        {
                  "en": "It contains only seafood",
                  "es": "Solo contiene mariscos",
                  "de": "Er enthält nur Meeresfrüchte",
                  "nl": "Het bevat alleen zeevruchten"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A Mexican corn salad",
                  "es": "Una ensalada de maíz mexicana",
                  "de": "Ein mexikanischer Maissalat",
                  "nl": "Een Mexicaanse maïssalade"
        },
        {
                  "en": "An Italian pasta salad",
                  "es": "Una ensalada de pasta italiana",
                  "de": "Ein italienischer Nudelsalat",
                  "nl": "Een Italiaanse pastasalade"
        },
        {
                  "en": "A French potato salad",
                  "es": "Una ensalada de papa francesa",
                  "de": "Ein französischer Kartoffelsalat",
                  "nl": "Een Franse aardappelsalade"
        },
        {
                  "en": "A Middle Eastern bread salad with mixed vegetables and herbs",
                  "es": "Una ensalada de pan del Medio Oriente con verduras mixtas y hierbas",
                  "de": "Ein nahöstlicher Brotsalat mit gemischtem Gemüse und Kräutern",
                  "nl": "Een Midden-Oosterse broodsalade met gemengde groenten en kruiden"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Composed salads are hot, tossed salads are cold",
                  "es": "Las ensaladas compuestas están calientes, las ensaladas mixtas están frías",
                  "de": "Komponierte Salate sind heiß, gemischte Salate sind kalt",
                  "nl": "Samengestelde salades zijn warm, gemengde salades zijn koud"
        },
        {
                  "en": "Composed salads have ingredients arranged separately, tossed salads have mixed ingredients",
                  "es": "Las ensaladas compuestas tienen ingredientes organizados por separado, las ensaladas mixtas tienen ingredientes mezclados",
                  "de": "Komponierte Salate haben separat angeordnete Zutaten, gemischte Salate haben vermischte Zutaten",
                  "nl": "Samengestelde salades hebben ingrediënten apart gerangschikt, gemengde salades hebben gemixte ingrediënten"
        },
        {
                  "en": "Composed salads use only vegetables, tossed salads include fruits",
                  "es": "Las ensaladas compuestas usan solo verduras, las ensaladas mixtas incluyen frutas",
                  "de": "Komponierte Salate verwenden nur Gemüse, gemischte Salate enthalten Früchte",
                  "nl": "Samengestelde salades gebruiken alleen groenten, gemengde salades bevatten fruit"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Warm bacon vinaigrette",
                  "es": "Vinagreta tibia de tocino",
                  "de": "Warme Speck-Vinaigrette",
                  "nl": "Warme spek vinaigrette"
        },
        {
                  "en": "Ranch dressing",
                  "es": "Aderezo ranch",
        ...
        },
        {
                  "en": "Italian dressing",
                  "es": "Aderezo italiano",
                  "de": "Italienisches Dressing",
                  "nl": "Italiaanse dressing"
        },
        {
                  "en": "Caesar dressing",
                  "es": "Aderezo César",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It contains exactly three different types of beans",
                  "es": "Contiene exactamente tres tipos diferentes de frijoles",
                  "de": "Er enthält genau drei verschiedene Arten von Bohnen",
                  "nl": "Het bevat precies drie verschillende soorten bonen"
        },
        {
                  "en": "It's served at three different temperatures",
                  "es": "Se sirve a tres temperaturas diferentes",
                  "de": "Er wird bei drei verschiedenen Temperaturen serviert",
                  "nl": "Het wordt bij drie verschillende temperaturen geserveerd"
        },
        {
                  "en": "It's only eaten three times a year",
                  "es": "Solo se come tres veces al año",
                  "de": "Er wird nur dreimal im Jahr gegessen",
                  "nl": "Het wordt slechts drie keer per jaar gegeten"
        },
        {
                  "en": "It takes three hours to prepare",
                  "es": "Toma tres horas preparar",
                  "de": "Er braucht drei Stunden zur Vorbereitung",
                  "nl": "Het duurt drie uur om te bereiden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Only fresh vegetables",
                  "es": "Solo verduras frescas",
                  "de": "Nur frisches Gemüse",
                  "nl": "Alleen verse groenten"
        },
        {
                  "en": "A variety of Italian cured meats and cheeses",
                  "es": "Una variedad de carnes curadas italianas y quesos",
                  "de": "Eine Vielfalt italienischer geräucherter Fleischwaren und Käse",
                  "nl": "Een verscheidenheid aan Italiaanse gedroogde vleeswaren en kazen"
        },
        {
                  "en": "Pasta",
                  "es": "Pasta",
        ...
        },
        {
                  "en": "Seafood only",
                  "es": "Solo mariscos",
                  "de": "Nur Meeresfrüchte",
                  "nl": "Alleen zeevruchten"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Quinoa (which is actually a seed, not a grain)",
                  "es": "Quinoa (que en realidad es una semilla, no un grano)",
                  "de": "Quinoa (was eigentlich ein Samen ist, kein Getreide)",
                  "nl": "Quinoa (wat eigenlijk een zaad is, geen graan)"
        },
        {
                  "en": "Rice",
                  "es": "Arroz",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Raw vegetables only",
                  "es": "Solo verduras crudas",
                  "de": "Nur rohes Gemüse",
                  "nl": "Alleen rauwe groenten"
        },
        {
                  "en": "Grilling",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It's only served for dessert",
                  "es": "Solo se sirve como postre",
                  "de": "Er wird nur als Dessert serviert",
                  "nl": "Het wordt alleen als dessert geserveerd"
        },
        {
                  "en": "It consists primarily or entirely of fruits",
                  "es": "Consiste principalmente o completamente de frutas",
                  "de": "Er besteht hauptsächlich oder ganz aus Früchten",
                  "nl": "Het bestaat voornamelijk of geheel uit fruit"
        },
        {
                  "en": "It must contain citrus fruits",
                  "es": "Debe contener frutas cítricas",
                  "de": "Er muss Zitrusfrüchte enthalten",
                  "nl": "Het moet citrusvruchten bevatten"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cooking pasta until very soft",
                  "es": "Cocinar la pasta hasta que esté muy suave",
                  "de": "Pasta sehr weich kochen",
                  "nl": "Pasta koken tot zeer zacht"
        },
        {
                  "en": "Cooling the pasta completely and dressing it while cool",
                  "es": "Enfriar la pasta completamente y aderezarla mientras está fría",
                  "de": "Die Pasta vollständig abkühlen und im kalten Zustand anmachen",
                  "nl": "De pasta volledig afkoelen en aankleden terwijl koel"
        },
        {
                  "en": "Adding dressing while pasta is hot",
                  "es": "Agregar aderezo mientras la pasta está caliente",
                  "de": "Dressing hinzufügen während die Pasta heiß ist",
                  "nl": "Dressing toevoegen terwijl pasta heet is"
        },
        {
                  "en": "Using only fresh pasta",
                  "es": "Usar solo pasta fresca",
                  "de": "Nur frische Pasta verwenden",
                  "nl": "Alleen verse pasta gebruiken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It only uses fresh bread",
                  "es": "Solo usa pan fresco",
                  "de": "Er verwendet nur frisches Brot",
                  "nl": "Het gebruikt alleen vers brood"
        },
        {
                  "en": "It contains no vegetables",
                  "es": "No contiene verduras",
                  "de": "Er enthält kein Gemüse",
                  "nl": "Het bevat geen groenten"
        },
        {
                  "en": "It uses stale bread soaked in tomato juices and olive oil",
                  "es": "Usa pan duro empapado en jugos de tomate y aceite de oliva",
                  "de": "Er verwendet altbackenes Brot, das in Tomatensäften und Olivenöl eingeweicht wird",
                  "nl": "Het gebruikt oud brood gedrenkt in tomatensappen en olijfolie"
        },
        {
                  "en": "It's served hot",
                  "es": "Se sirve caliente",
      ...
      },
      {
        ...
        {
                  "en": "4:1 (four parts oil to one part vinegar)",
                  "es": "4:1 (cuatro partes de aceite a una parte de vinagre)",
                  "de": "4:1 (vier Teile Öl zu einem Teil Essig)",
                  "nl": "4:1 (vier delen olie op één deel azijn)"
        },
        {
                  "en": "2:1 (two parts oil to one part vinegar)",
                  "es": "2:1 (dos partes de aceite a una parte de vinagre)",
                  "de": "2:1 (zwei Teile Öl zu einem Teil Essig)",
                  "nl": "2:1 (twee delen olie op één deel azijn)"
        },
        {
                  "en": "3:1 (three parts oil to one part vinegar)",
                  "es": "3:1 (tres partes de aceite a una parte de vinagre)",
                  "de": "3:1 (drei Teile Öl zu einem Teil Essig)",
                  "nl": "3:1 (drie delen olie op één deel azijn)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Crumbled blue cheese mixed into a creamy base",
                  "es": "Queso azul desmenuzado mezclado en una base cremosa",
                  "de": "Zerbröckelter Blauschimmelkäse in einer cremigen Basis",
                  "nl": "Verkruimelde blauwe kaas gemengd in een romige basis"
        },
        {
                  "en": "Blue food coloring",
                  "es": "Colorante alimentario azul",
                  "de": "Blaue Lebensmittelfarbe",
                  "nl": "Blauwe voedselkleurstof"
        },
        {
                  "en": "Blue corn",
                  "es": "Maíz azul",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ketchup or chili sauce",
                  "es": "Ketchup o salsa de chile",
                  "de": "Ketchup oder Chilisauce",
                  "nl": "Ketchup of chilisaus"
        },
        {
                  "en": "Paprika",
                  "es": "Pimentón",
      ...
      },
      {
        ...
        {
                  "en": "Balsamic vinegar from Modena, Italy",
                  "es": "Vinagre balsámico de Módena, Italia",
                  "de": "Balsamico-Essig aus Modena, Italien",
                  "nl": "Balsamico azijn uit Modena, Italië"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Maple syrup and horseradish",
                  "es": "Jarabe de arce y rábano picante",
                  "de": "Ahornsirup und Meerrettich",
                  "nl": "Esdoornsiroop en mierikswortel"
        },
        {
                  "en": "The combination of honey and mustard",
                  "es": "La combinación de miel y mostaza",
                  "de": "Die Kombination aus Honig und Senf",
                  "nl": "De combinatie van honing en mosterd"
        },
        {
                  "en": "Sugar and vinegar only",
                  "es": "Solo azúcar y vinagre",
                  "de": "Nur Zucker und Essig",
                  "nl": "Alleen suiker en azijn"
        },
        {
                  "en": "Brown sugar and soy sauce",
                  "es": "Azúcar moreno y salsa de soja",
                  "de": "Brauner Zucker und Sojasoße",
                  "nl": "Bruine suiker en sojasaus"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Creamy dressings contain dairy or mayonnaise, vinaigrettes are oil-based",
                  "es": "Los aderezos cremosos contienen lácteos o mayonesa, las vinagretas son a base de aceite",
                  "de": "Cremige Dressings enthalten Milchprodukte oder Mayonnaise, Vinaigrettes sind ölbasiert",
                  "nl": "Romige dressings bevatten zuivel of mayonaise, vinaigrettes zijn op oliebasis"
        },
        {
                  "en": "Creamy dressings contain no acid",
                  "es": "Los aderezos cremosos no contienen ácido",
                  "de": "Cremige Dressings enthalten keine Säure",
                  "nl": "Romige dressings bevatten geen zuur"
        },
        {
                  "en": "Creamy dressings are always sweeter",
                  "es": "Los aderezos cremosos son siempre más dulces",
                  "de": "Cremige Dressings sind immer süßer",
                  "nl": "Romige dressings zijn altijd zoeter"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Horseradish and chili sauce",
                  "es": "Rábano picante y salsa de chile",
                  "de": "Meerrettich und Chilisauce",
                  "nl": "Mierikswortel en chilisaus"
        },
        {
                  "en": "Beets",
                  "es": "Remolachas",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It makes the dressing sweeter",
                  "es": "Hace que el aderezo sea más dulce",
                  "de": "Es macht das Dressing süßer",
                  "nl": "Het maakt de dressing zoeter"
        },
        {
                  "en": "It thickens the dressing only",
                  "es": "Solo espesa el aderezo",
                  "de": "Es verdickt nur das Dressing",
                  "nl": "Het verdikt alleen de dressing"
        },
        {
                  "en": "It adds red color",
                  "es": "Añade color rojo",
                  "de": "Es fügt rote Farbe hinzu",
                  "nl": "Het voegt rode kleur toe"
        },
        {
                  "en": "It acts as an emulsifier and adds flavor",
                  "es": "Actúa como emulsionante y añade sabor",
                  "de": "Es wirkt als Emulgator und fügt Geschmack hinzu",
                  "nl": "Het werkt als emulgator en voegt smaak toe"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Fresh herbs like parsley, tarragon, and chives",
                  "es": "Hierbas frescas como perejil, estragón y cebollino",
                  "de": "Frische Kräuter wie Petersilie, Estragon und Schnittlauch",
                  "nl": "Verse kruiden zoals peterselie, dragon en bieslook"
        },
        {
                  "en": "Matcha powder",
                  "es": "Polvo de matcha",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "It uses only white wine",
                  "es": "Solo usa vino blanco",
                  "de": "Es verwendet nur Weißwein",
                  "nl": "Het gebruikt alleen witte wijn"
        },
        {
                  "en": "It often contains ketchup or tomato paste for sweetness and color",
                  "es": "A menudo contiene ketchup o pasta de tomate para dulzura y color",
                  "de": "Es enthält oft Ketchup oder Tomatenmark für Süße und Farbe",
                  "nl": "Het bevat vaak ketchup of tomatenpuree voor zoetheid en kleur"
        },
        {
      ...
      },
      {
        ...
        options: [
        {
                  ...
                  "nl": "Gemalen sesamzaad (tahini pasta)"
        },
        {
                  "en": "Peanut butter",
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sugar is never added to vinaigrettes",
                  "es": "El azúcar nunca se agrega a las vinagretas",
                  "de": "Zucker wird nie zu Vinaigrettes hinzugefügt",
                  "nl": "Suiker wordt nooit toegevoegd aan vinaigrettes"
        },
        {
                  "en": "To balance the acidity of the vinegar",
                  "es": "Para equilibrar la acidez del vinagre",
                  "de": "Um die Säure des Essigs auszugleichen",
                  "nl": "Om de zuurgraad van de azijn te balanceren"
        },
        {
                  "en": "To make it more colorful",
                  "es": "Para hacerlo más colorido",
                  "de": "Um es bunter zu machen",
                  "nl": "Om het kleurrijker te maken"
        },
        {
                  "en": "To help it last longer",
                  "es": "Para que dure más tiempo",
                  "de": "Damit es länger hält",
                  "nl": "Om het langer te laten duren"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "The visible poppy seeds and slightly sweet flavor",
                  "es": "Las semillas de amapola visibles y sabor ligeramente dulce",
                  "de": "Die sichtbaren Mohnsamen und leicht süße Geschmack",
                  "nl": "De zichtbare maanzaad en licht zoete smaak"
        },
        {
                  "en": "It contains no oil",
                  "es": "No contiene aceite",
        ...
        {
                  "en": "It's bright red in color",
                  "es": "Es de color rojo brillante",
                  "de": "Es ist leuchtend rot gefärbt",
                  "nl": "Het is felrood van kleur"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A French salad bowl",
                  "es": "Un tazón francés para ensalada",
                  "de": "Eine französische Salatschüssel",
                  "nl": "Een Franse saladekom"
        },
        {
                  "en": "A caramelized sugar and vinegar reduction used to add sweet-tart flavor",
                  "es": "Una reducción de azúcar caramelizado y vinagre usado para añadir sabor agridulce",
                  "de": "Eine karamellisierte Zucker- und Essigreduktion, die verwendet wird, um süß-säuerlichen Geschmack hinzuzufügen",
                  "nl": "Een gekarameliseerde suiker en azijn reductie gebruikt om zoet-zure smaak toe te voegen"
        },
        {
                  "en": "A vinegar made from grapes",
                  "es": "Un vinagre hecho de uvas",
                  "de": "Ein Essig aus Trauben",
                  "nl": "Een azijn gemaakt van druiven"
        },
        {
                  "en": "A type of lettuce",
                  "es": "Un tipo de lechuga",
                  "de": "Eine Art Kopfsalat",
                  "nl": "Een type sla"
        }
        ],
        correct: 1,
      ...
      },
      {
        ...
        {
                  "en": "The use of cultured buttermilk instead of regular milk",
                  "es": "El uso de suero de leche cultivado en lugar de leche regular",
                  "de": "Die Verwendung von kultivierter Buttermilch statt normaler Milch",
                  "nl": "Het gebruik van gekweekte karnemelk in plaats van gewone melk"
        },
        {
                  "en": "Extra salt",
                  "es": "Sal extra",
        ...
        {
                  "en": "Real butter chunks",
                  "es": "Trozos de mantequilla real",
                  "de": "Echte Butterstücke",
                  "nl": "Echte boterklontjes"
        }
        ],
        correct: 1,
        explanation: {
