  ...
  const level5 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Type of yeast used only for sweet breads",
                  "es": "Tipo de levadura usada solo para panes dulces",
                  "de": "Hefeart nur für süße Brote verwendet",
                  "nl": "Type gist alleen gebruikt voor zoete broden"
        },
        {
                  "en": "Chemical additive that speeds up fermentation",
                  "es": "Aditivo químico que acelera la fermentación",
                  "de": "Chemischer Zusatzstoff der Fermentation beschleunigt",
                  "nl": "Chemische toevoeging die fermentatie versnelt"
        },
        {
                  "en": "Enzyme that breaks down gluten proteins - excessive protease (from overripe sourdough, pineapple, kiwi, papaya) makes dough sticky, slack, unable to hold shape",
                  "es": "Enzima que descompone proteínas de gluten - proteasa excesiva (de masa madre sobre-madura, piña, kiwi, papaya) hace masa pegajosa, floja, incapaz de mantener forma",
                  "de": "Enzym das Glutenproteine abbaut - übermäßige Protease (von überreifem Sauerteig, Ananas, Kiwi, Papaya) macht Teig klebrig, schlaff, unfähig Form zu halten",
                  "nl": "Enzym dat glutenproteïnen afbreekt - overmatige protease (van overrijpe zuurdesem, ananas, kiwi, papaja) maakt deeg plakkerig, slap, kan vorm niet vasthouden"
        },
        {
                  "en": "Enzyme that only improves bread quality in all cases",
                  "es": "Enzima que solo mejora la calidad del pan en todos los casos",
                  "de": "Enzym das nur in allen Fällen die Brotqualität verbessert",
                  "nl": "Enzym dat alleen broodkwaliteit verbetert in alle gevallen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Burnt spots on bread that should be avoided at all costs",
                  "es": "Manchas quemadas en pan que deben evitarse a toda costa",
                  "de": "Verbrannte Stellen auf Brot die um jeden Preis vermieden werden sollten",
                  "nl": "Verbrande plekken op brood die ten koste van alles vermeden moeten worden"
        },
        {
                  "en": "Disease that affects bread dough during rising",
                  "es": "Enfermedad que afecta la masa de pan durante el levado",
                  "de": "Krankheit die Brotteig während des Aufgehens betrifft",
                  "nl": "Ziekte die brooddeeg beïnvloedt tijdens rijzen"
        },
        {
                  "en": "Type of scoring pattern used only for baguettes",
                  "es": "Tipo de patrón de marcado usado solo para baguettes",
                  "de": "Art von Einschnittmuster nur für Baguettes verwendet",
                  "nl": "Type scorepatroon alleen gebruikt voor stokbroden"
        },
        {
                  "en": "Beautiful bubbles/blisters on crust surface - achieved by: high hydration (75%+), cold fermentation, light dusting of flour, high-heat baking with steam in first 15 min",
                  "es": "Hermosas burbujas/ampollas en superficie de corteza - logrado por: alta hidratación (75%+), fermentación fría, ligero espolvoreado de harina, horneado a alta temperatura con vapor en primeros 15 min",
                  "de": "Schöne Blasen auf Krustenoberfläche - erreicht durch: hohe Hydratation (75%+), kalte Fermentation, leichtes Bestäuben mit Mehl, Hochtemperatur-Backen mit Dampf in ersten 15 Min",
                  "nl": "Mooie bellen/blaren op korstoppervlak - bereikt door: hoge hydratatie (75%+), koude fermentatie, lichte bestuiving met meel, hoge-temperatuur bakken met stoom in eerste 15 min"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding butter between layers like croissants",
                  "es": "Añadir mantequilla entre capas como croissants",
                  "de": "Butter zwischen Schichten hinzufügen wie Croissants",
                  "nl": "Boter toevoegen tussen lagen zoals croissants"
        },
        {
                  "en": "Coating bread with plastic wrap before proofing",
                  "es": "Cubrir pan con envoltura plástica antes de fermentar",
                  "de": "Brot vor dem Gehen mit Plastikfolie überziehen",
                  "nl": "Brood bedekken met plastic voor rijzen"
        },
        {
                  "en": "Stretching wet dough paper-thin on counter, optionally adding inclusions (seeds, herbs, cheese), then folding into layers - builds strength, incorporates ingredients evenly without mixing",
                  "es": "Estirar masa húmeda muy delgada sobre mostrador, opcionalmente añadiendo inclusiones (semillas, hierbas, queso), luego doblar en capas - desarrolla fuerza, incorpora ingredientes uniformemente sin mezclar",
                  "de": "Nassen Teig papierdünn auf Arbeitsfläche dehnen, optional Zugaben hinzufügen (Samen, Kräuter, Käse), dann in Schichten falten - baut Stärke auf, integriert Zutaten gleichmäßig ohne Mischen",
                  "nl": "Nat deeg papierdun uitrekken op aanrecht, optioneel toevoegingen toevoegen (zaden, kruiden, kaas), dan vouwen in lagen - bouwt kracht op, integreert ingrediënten gelijkmatig zonder mengen"
        },
        {
                  "en": "Baking bread in a laminating machine",
                  "es": "Hornear pan en una máquina laminadora",
                  "de": "Brot in einer Laminiermaschine backen",
                  "nl": "Brood bakken in een lamineer machine"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "When dough rises perfectly but tastes bad",
                  "es": "Cuando masa sube perfectamente pero sabe mal",
                  "de": "Wenn Teig perfekt aufgeht aber schlecht schmeckt",
                  "nl": "Wanneer deeg perfect rijst maar slecht smaakt"
        },
        {
                  "en": "Dough looks risen but yeast is dead/inactive - happens from: too-hot water killing yeast, expired yeast, or too much salt. Test: dough won't pass poke test, no oven spring, dense crumb",
                  "es": "Masa parece levada pero levadura está muerta/inactiva - ocurre por: agua demasiado caliente matando levadura, levadura vencida, o demasiada sal. Prueba: masa no pasará prueba de poke, sin oven spring, miga densa",
                  "de": "Teig sieht aufgegangen aus aber Hefe ist tot/inaktiv - passiert durch: zu heißes Wasser tötet Hefe, abgelaufene Hefe, oder zu viel Salz. Test: Teig besteht Fingertest nicht, kein Ofentrieb, dichte Krume",
                  "nl": "Deeg ziet gerezen uit maar gist is dood/inactief - gebeurt door: te heet water doodt gist, verlopen gist, of te veel zout. Test: deeg slaagt poke test niet, geen oven spring, dichte kruim"
        },
        {
                  "en": "Using fake yeast instead of real yeast",
                  "es": "Usar levadura falsa en lugar de levadura real",
                  "de": "Falsche Hefe statt echter Hefe verwenden",
                  "nl": "Nep gist gebruiken in plaats van echte gist"
        },
        {
                  "en": "Technique of pretending bread is ready when it isn't",
                  "es": "Técnica de pretender que el pan está listo cuando no lo está",
                  "de": "Technik vorzutäuschen dass Brot fertig ist wenn es nicht ist",
                  "nl": "Techniek van doen alsof brood klaar is terwijl dat niet zo is"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Storing bread in oxygen-free containers for freshness",
                  "es": "Almacenar pan en contenedores sin oxígeno para frescura",
                  "de": "Brot in sauerstofffreien Behältern lagern für Frische",
                  "nl": "Brood bewaren in zuurstofvrije containers voor versheid"
        },
        {
                  "en": "Adding hydrogen peroxide to dough to make it rise faster",
                  "es": "Añadir peróxido de hidrógeno a masa para hacerla subir más rápido",
                  "de": "Wasserstoffperoxid zum Teig hinzufügen um ihn schneller aufgehen zu lassen",
                  "nl": "Waterstofperoxide aan deeg toevoegen om het sneller te laten rijzen"
        },
        {
                  "en": "Baking bread in a pressurized oxygen chamber",
                  "es": "Hornear pan en una cámara de oxígeno presurizada",
                  "de": "Brot in einer Drucksauerstoffkammer backen",
                  "nl": "Brood bakken in een drukkamer met zuurstof"
        },
        {
                  "en": "Incorporating air during mixing strengthens gluten, speeds fermentation (yeast needs O2 for reproduction), and whitens crumb. Chorleywood process relies heavily on mechanical oxygenation",
                  "es": "Incorporar aire durante el mezclado fortalece gluten, acelera fermentación (levadura necesita O2 para reproducción), y blanquea miga. Proceso Chorleywood depende mucho de oxigenación mecánica",
                  "de": "Luft während des Mischens einarbeiten stärkt Gluten, beschleunigt Fermentation (Hefe braucht O2 für Vermehrung), und hellt Krume auf. Chorleywood-Prozess basiert stark auf mechanischer Sauerstoffanreicherung",
                  "nl": "Lucht verwerken tijdens mengen versterkt gluten, versnelt fermentatie (gist heeft O2 nodig voor voortplanting), en maakt kruim witter. Chorleywood proces is sterk afhankelijk van mechanische zuurstoftoevoer"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "How hard you squeeze the bread when testing doneness",
                  "es": "Qué tan fuerte aprietas el pan al probar cocción",
                  "de": "Wie fest man Brot drückt beim Testen der Gare",
                  "nl": "Hoe hard je brood knijpt bij het testen van gaarheid"
        },
        {
                  "en": "Hole size/distribution in bread's interior - controlled by: hydration (higher=more open), degassing (more=tighter), flour protein (higher=more structure for holes), fermentation time, shaping technique",
                  "es": "Tamaño/distribución de agujeros en interior de pan - controlado por: hidratación (mayor=más abierta), desgasificación (más=más apretada), proteína de harina (mayor=más estructura para agujeros), tiempo de fermentación, técnica de formado",
                  "de": "Lochgröße/-verteilung im Brotinneren - kontrolliert durch: Hydratation (höher=offener), Entgasen (mehr=dichter), Mehlprotein (höher=mehr Struktur für Löcher), Fermentationszeit, Formtechnik",
                  "nl": "Gatgrootte/-verdeling in brood binnenste - geregeld door: hydratatie (hoger=opener), ontgassen (meer=dichter), meelproteïne (hoger=meer structuur voor gaten), fermentatietijd, vormtechniek"
        },
        {
                  "en": "How tightly bread is wrapped for storage",
                  "es": "Qué tan apretado se envuelve el pan para almacenar",
                  "de": "Wie fest Brot für Lagerung eingewickelt wird",
                  "nl": "Hoe strak brood is ingepakt voor opslag"
        },
        {
                  "en": "Tension in dough surface before baking",
                  "es": "Tensión en superficie de masa antes de hornear",
                  "de": "Spannung in Teigoberfläche vor dem Backen",
                  "nl": "Spanning in deegoppervlak voor bakken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Enzyme that breaks down fats/lipids - can weaken gluten structure if too active (in whole grain/fresh-milled flour). Also develops flavor in aged cheese-breads and some Italian breads",
                  "es": "Enzima que descompone grasas/lípidos - puede debilitar estructura de gluten si demasiado activa (en harina integral/recién molida). También desarrolla sabor en panes añejados con queso y algunos panes italianos",
                  "de": "Enzym das Fette/Lipide abbaut - kann Glutenstruktur schwächen wenn zu aktiv (in Vollkorn-/frischgemahlenen Mehl). Entwickelt auch Geschmack in gereiften Käsebroten und einigen italienischen Broten",
                  "nl": "Enzym dat vetten/lipiden afbreekt - kan glutenstructuur verzwakken als te actief (in volkoren/vers gemalen meel). Ontwikkelt ook smaak in gerijpte kaasbroden en sommige Italiaanse broden"
        },
        {
                  "en": "Type of fat used only in French bread",
                  "es": "Tipo de grasa usada solo en pan francés",
                  "de": "Fettart nur in französischem Brot verwendet",
                  "nl": "Type vet alleen gebruikt in Frans brood"
        },
        {
                  "en": "Enzyme that only improves bread texture in all cases",
                  "es": "Enzima que solo mejora la textura del pan en todos los casos",
                  "de": "Enzym das nur in allen Fällen Brottextur verbessert",
                  "nl": "Enzym dat alleen broodtextuur verbetert in alle gevallen"
        },
        {
                  "en": "Chemical added to make bread rise faster",
                  "es": "Químico añadido para hacer pan subir más rápido",
                  "de": "Chemikalie hinzugefügt um Brot schneller aufgehen zu lassen",
                  "nl": "Chemische stof toegevoegd om brood sneller te laten rijzen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They are exactly the same product with different names",
                  "es": "Son exactamente el mismo producto con nombres diferentes",
                  "de": "Sie sind genau das gleiche Produkt mit verschiedenen Namen",
                  "nl": "Ze zijn precies hetzelfde product met verschillende namen"
        },
        {
                  ...
                  "es": "Diastático: contiene enzimas activas (amilasa) que descomponen almidones en azúcares - mejora fermentación, color de corteza, oven spring. No diastático: enzimas destruidas por calor, añade solo sabor/color",
                  "de": "Diastatisch: enthält aktive Enzyme (Amylase) die Stärken in Zucker abbauen - verbessert Fermentation, Krustenfarbe, Ofentrieb. Nicht-diastatisch: Enzyme durch Hitze zerstört, fügt nur Geschmack/Farbe hinzu",
                  "nl": "Diastatisch: bevat actieve enzymen (amylase) die zetmelen afbreken tot suikers - verbetert fermentatie, korstkleur, oven spring. Niet-diastatisch: enzymen vernietigd door hitte, voegt alleen smaak/kleur toe"
        },
        {
                  "en": "Diastatic is for sweet breads, non-diastatic is for savory",
                  "es": "Diastático es para panes dulces, no diastático es para salados",
                  "de": "Diastatisch ist für süße Brote, nicht-diastatisch für herzhafte",
                  "nl": "Diastatisch is voor zoete broden, niet-diastatisch voor hartige"
        },
        {
                  "en": "Non-diastatic has more enzymes than diastatic",
                  "es": "No diastático tiene más enzimas que diastático",
                  "de": "Nicht-diastatisch hat mehr Enzyme als diastatisch",
                  "nl": "Niet-diastatisch heeft meer enzymen dan diastatisch"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Slack: high hydration (75-90%), sticky, flows/spreads easily - needs gentle handling (ciabatta, focaccia). Stiff: low hydration (50-65%), firm, easy to shape - tolerates aggressive handling (bagels, pretzels)",
                  "es": "Floja: alta hidratación (75-90%), pegajosa, fluye/se extiende fácilmente - necesita manejo suave (ciabatta, focaccia). Rígida: baja hidratación (50-65%), firme, fácil de formar - tolera manejo agresivo (bagels, pretzels)",
                  "de": "Schlaff: hohe Hydratation (75-90%), klebrig, fließt/verteilt sich leicht - braucht sanfte Handhabung (Ciabatta, Focaccia). Steif: niedrige Hydratation (50-65%), fest, leicht zu formen - toleriert aggressive Handhabung (Bagels, Brezeln)",
                  "nl": "Slap: hoge hydratatie (75-90%), plakkerig, vloeit/verspreidt gemakkelijk - heeft zachte behandeling nodig (ciabatta, focaccia). Stijf: lage hydratatie (50-65%), stevig, makkelijk te vormen - verdraagt agressieve behandeling (bagels, pretzels)"
        },
        {
                  "en": "Slack means old dough, stiff means fresh dough",
                  "es": "Floja significa masa vieja, rígida significa masa fresca",
                  "de": "Schlaff bedeutet alter Teig, steif bedeutet frischer Teig",
                  "nl": "Slap betekent oud deeg, stijf betekent vers deeg"
        },
        {
                  "en": "They refer to dough temperature, not hydration",
                  "es": "Se refieren a temperatura de masa, no hidratación",
                  "de": "Sie beziehen sich auf Teigtemperatur, nicht Hydratation",
                  "nl": "Ze verwijzen naar deegtemperatuur, niet hydratatie"
        },
        {
                  "en": "Slack dough is underproofed, stiff dough is overproofed",
                  "es": "Masa floja está sub-fermentada, masa rígida está sobre-fermentada",
                  "de": "Schlaffer Teig ist untergegangen, steifer Teig ist übergegangen",
                  "nl": "Slap deeg is ondergerezen, stijf deeg is overgerezen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Gently poke shaped dough ½ inch deep: springs back quickly=underproofed, slowly fills back=ready, stays indented=overproofed. Most accurate doneness test for final proof",
                  "es": "Presione suavemente masa formada 1.3 cm de profundidad: rebota rápido=sub-fermentada, se llena lentamente=lista, queda hundida=sobre-fermentada. Prueba más precisa de cocción para fermentación final",
                  "de": "Geformten Teig sanft 1.3 cm tief drücken: springt schnell zurück=untergegangen, füllt sich langsam=fertig, bleibt eingedrückt=übergegangen. Genauester Garetest für Endgare",
                  "nl": "Druk zacht gevormd deeg 1.3 cm diep in: veert snel terug=ondergerezen, vult langzaam terug=klaar, blijft ingedeukt=overgerezen. Nauwkeurigste gaarheidstest voor laatste rijs"
        },
        {
                  "en": "Poking holes in dough to release air bubbles",
                  "es": "Hacer agujeros en masa para liberar burbujas de aire",
                  "de": "Löcher in Teig stechen um Luftblasen freizusetzen",
                  "nl": "Gaten prikken in deeg om luchtbellen vrij te geven"
        },
        {
                  "en": "Using your finger to mix ingredients together",
                  "es": "Usar tu dedo para mezclar ingredientes juntos",
                  "de": "Finger verwenden um Zutaten zusammenzumischen",
                  "nl": "Je vinger gebruiken om ingrediënten samen te mengen"
        },
        {
                  "en": "Testing oven temperature by sticking finger inside",
                  "es": "Probar temperatura de horno metiendo dedo adentro",
                  "de": "Ofentemperatur testen indem man Finger reinsteckt",
                  "nl": "Oventemperatuur testen door vinger erin te steken"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Lab instrument that blows air bubble into dough to measure: P (resistance/tenacity), L (extensibility), W (total strength) - helps millers/bakers select optimal flour for specific bread types",
                  "es": "Instrumento de laboratorio que sopla burbuja de aire en masa para medir: P (resistencia/tenacidad), L (extensibilidad), W (fuerza total) - ayuda a molineros/panaderos seleccionar harina óptima para tipos específicos de pan",
                  "de": "Laborinstrument das Luftblase in Teig bläst um zu messen: P (Widerstand/Zähigkeit), L (Dehnbarkeit), W (Gesamtstärke) - hilft Müllern/Bäckern optimales Mehl für spezifische Brottypen auszuwählen",
                  "nl": "Laboratorium instrument dat luchtbel in deeg blaast om te meten: P (weerstand/taaiheid), L (rekbaarheid), W (totale kracht) - helpt molenaars/bakkers optimaal meel selecteren voor specifieke broodsoorten"
        },
        {
                  "en": "Machine that scores artisan bread automatically",
                  "es": "Máquina que marca pan artesanal automáticamente",
                  "de": "Maschine die handwerkliches Brot automatisch einschneidet",
                  "nl": "Machine die ambachtelijk brood automatisch scoort"
        },
        {
                  "en": "Type of oven thermometer for checking bread temperature",
                  "es": "Tipo de termómetro de horno para verificar temperatura de pan",
                  "de": "Art von Ofenthermometer zum Prüfen der Brottemperatur",
                  "nl": "Type oventhermometer voor het controleren van broodtemperatuur"
        },
        {
                  "en": "Tool for measuring yeast activity in sourdough starter",
                  "es": "Herramienta para medir actividad de levadura en masa madre",
                  "de": "Werkzeug zum Messen der Hefeaktivität im Sauerteig-Starter",
                  "nl": "Gereedschap voor het meten van gistactiviteit in zuurdesem starter"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Decorative pattern scored on top of artisan loaves",
                  "es": "Patrón decorativo marcado en la parte superior de panes artesanales",
                  "de": "Dekoratives Muster auf handwerklichen Laiben eingeschnitten",
                  "nl": "Decoratief patroon gescoord op bovenkant van ambachtelijke broden"
        },
        {
                  "en": "Historical leavening agent (potassium carbonate) - first chemical leavener before baking powder (1790s), extracted from wood ash, used in cookies/quick breads. Precursor to modern baking soda",
                  "es": "Agente leudante histórico (carbonato de potasio) - primer leudante químico antes del polvo de hornear (1790s), extraído de ceniza de madera, usado en galletas/panes rápidos. Precursor de bicarbonato moderno",
                  "de": "Historisches Treibmittel (Kaliumcarbonat) - erstes chemisches Treibmittel vor Backpulver (1790er), aus Holzasche extrahiert, in Keksen/Schnellbroten verwendet. Vorläufer von modernem Natron",
                  "nl": "Historisch rijsmiddel (kaliumcarbonaat) - eerste chemische rijsmiddel voor bakpoeder (1790s), gewonnen uit houtas, gebruikt in koekjes/snelle broden. Voorloper van moderne zuiveringszout"
        },
        {
                  "en": "Type of white flour made only from wheat kernels",
                  "es": "Tipo de harina blanca hecha solo de granos de trigo",
                  "de": "Mehltyp nur aus Weizenkörnern hergestellt",
                  "nl": "Type wit meel alleen gemaakt van tarwekorrels"
        },
        {
                  "en": "Process of polishing bread crust with butter",
                  "es": "Proceso de pulir corteza de pan con mantequilla",
                  "de": "Prozess des Polierens von Brotkruste mit Butter",
                  "nl": "Proces van het polijsten van broodkorst met boter"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Modified autolyse - mix flour+water+levain/starter, rest 30-60 min before adding salt - combines benefits of autolyse (gluten development, extensibility) with flavor from early fermentation",
                  "es": "Autolisis modificada - mezclar harina+agua+levain/iniciador, reposar 30-60 min antes de añadir sal - combina beneficios de autolisis (desarrollo de gluten, extensibilidad) con sabor de fermentación temprana",
                  "de": "Modifizierte Autolyse - Mehl+Wasser+Levain/Starter mischen, 30-60 Min ruhen vor Salzzugabe - kombiniert Vorteile von Autolyse (Glutenentwicklung, Dehnbarkeit) mit Geschmack von früher Fermentation",
                  "nl": "Gewijzigde autolyse - meel+water+levain/starter mengen, 30-60 min rusten voor zout toevoegen - combineert voordelen van autolyse (glutenontwikkeling, rekbaarheid) met smaak van vroege fermentatie"
        },
        {
                  "en": "Freezing dough to stop all fermentation permanently",
                  "es": "Congelar masa para detener toda fermentación permanentemente",
                  "de": "Teig einfrieren um alle Fermentation dauerhaft zu stoppen",
                  "nl": "Deeg bevriezen om alle fermentatie permanent te stoppen"
        },
        {
                  "en": "Adding extra yeast at the end of mixing",
                  "es": "Añadir levadura extra al final del mezclado",
                  "de": "Extra Hefe am Ende des Mischens hinzufügen",
                  "nl": "Extra gist toevoegen aan het einde van mengen"
        },
        {
                  "en": "Technique only used for gluten-free breads",
                  "es": "Técnica solo usada para panes sin gluten",
                  "de": "Technik nur für glutenfreie Brote verwendet",
                  "nl": "Techniek alleen gebruikt voor glutenvrije broden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Desirable light, airy texture that all breads should have",
                  "es": "Textura ligera, aireada deseable que todos los panes deberían tener",
                  "de": "Wünschenswerte leichte, luftige Textur die alle Brote haben sollten",
                  "nl": "Wenselijke lichte, luchtige textuur die alle broden zouden moeten hebben"
        },
        {
                  "en": "Special ingredient added to improve bread shelf life",
                  "es": "Ingrediente especial añadido para mejorar vida útil del pan",
                  "de": "Spezielle Zutat hinzugefügt um Brothaltbarkeit zu verbessern",
                  "nl": "Speciale ingrediënt toegevoegd om broodhoudbaarheid te verbeteren"
        },
        {
                  "en": "Type of coating applied to bread surface before baking",
                  "es": "Tipo de recubrimiento aplicado a superficie de pan antes de hornear",
                  "de": "Art von Beschichtung auf Brotoberfläche vor dem Backen aufgetragen",
                  "nl": "Type coating aangebracht op broodoppervlak voor bakken"
        },
        {
                  "en": "Dense, rubbery, gummy texture in bread - caused by: underbaking (dough not fully set), too much liquid, undermixing (weak gluten), or cutting bread while still hot/steaming",
                  "es": "Textura densa, gomosa, pegajosa en pan - causada por: horneado insuficiente (masa no completamente cuajada), demasiado líquido, mezclado insuficiente (gluten débil), o cortar pan mientras aún está caliente/vapor",
                  "de": "Dichte, gummiartige, klebrige Textur im Brot - verursacht durch: Unterbacken (Teig nicht vollständig fest), zu viel Flüssigkeit, Untermischen (schwaches Gluten), oder Brot schneiden während noch heiß/dampfend",
                  "nl": "Dichte, rubberachtige, kleverige textuur in brood - veroorzaakt door: onderbakken (deeg niet volledig gestold), te veel vloeistof, ondermengen (zwak gluten), of brood snijden terwijl nog heet/dampend"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Ideal room temperature for storing flour",
                  "es": "Temperatura ambiente ideal para almacenar harina",
                  "de": "Ideale Raumtemperatur zum Lagern von Mehl",
                  "nl": "Ideale kamertemperatuur voor het bewaren van meel"
        },
        {
                  "en": "Target final dough temp (usually 75-78°F/24-26°C) for optimal fermentation - calculate water temp needed by accounting for: flour temp, room temp, friction from mixing. Ensures consistent fermentation speed",
                  "es": "Temperatura final objetivo de masa (usualmente 75-78°F/24-26°C) para fermentación óptima - calcular temp de agua necesaria considerando: temp de harina, temp de habitación, fricción del mezclado. Asegura velocidad de fermentación consistente",
                  "de": "Ziel-Endteigtemperatur (üblicherweise 24-26°C) für optimale Fermentation - Wassertemperatur berechnen unter Berücksichtigung von: Mehltemperatur, Raumtemperatur, Reibung vom Mischen. Sichert konstante Fermentationsgeschwindigkeit",
                  "nl": "Doel einddeegtemperatuur (meestal 24-26°C) voor optimale fermentatie - bereken benodigde watertemperatuur door rekening te houden met: meeltemperatuur, kamertemperatuur, wrijving van mengen. Zorgt voor consistente fermentatiesnelheid"
        },
        {
                  "en": "Maximum oven temperature for baking bread",
                  "es": "Temperatura máxima de horno para hornear pan",
                  "de": "Maximale Ofentemperatur zum Brotbacken",
                  "nl": "Maximale oventemperatuur voor brood bakken"
        },
        {
                  "en": "Temperature at which yeast dies completely",
                  "es": "Temperatura a la cual la levadura muere completamente",
                  "de": "Temperatur bei der Hefe vollständig stirbt",
                  "nl": "Temperatuur waarbij gist volledig sterft"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Technique for making transparent bread crust",
                  "es": "Técnica para hacer corteza de pan transparente",
                  "de": "Technik zum Herstellen transparenter Brotkruste",
                  "nl": "Techniek voor het maken van transparante broodkorst"
        },
        {
                  "en": "Process of coating bread with sugar glaze",
                  "es": "Proceso de cubrir pan con glaseado de azúcar",
                  "de": "Prozess des Beschichtens von Brot mit Zuckerglasur",
                  "nl": "Proces van het bedekken van brood met suikerglazuur"
        },
        {
                  "en": "Starch granules absorb water and swell when heated above 140-180°F - transforms dough into set bread structure. Incomplete gelatinization (underbaking) causes gummy texture",
                  "es": "Gránulos de almidón absorben agua y se hinchan cuando se calientan sobre 60-82°C - transforma masa en estructura de pan cuajada. Gelatinización incompleta (horneado insuficiente) causa textura gomosa",
                  "de": "Stärkegranula absorbieren Wasser und schwellen bei Erhitzen über 60-82°C - verwandelt Teig in feste Brotstruktur. Unvollständige Verkleisterung (Unterbacken) verursacht gummiartige Textur",
                  "nl": "Zetmeelkorrels absorberen water en zwellen bij verhitting boven 60-82°C - transformeert deeg in gestolde broodstructuur. Onvolledige gelatinisatie (onderbakken) veroorzaakt kleverige textuur"
        },
        {
                  "en": "Adding gelatin powder to make bread softer",
                  "es": "Añadir polvo de gelatina para hacer pan más suave",
                  "de": "Gelatinepulver hinzufügen um Brot weicher zu machen",
                  "nl": "Gelatine poeder toevoegen om brood zachter te maken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Count of how many times dough must be folded",
                  "es": "Cuenta de cuántas veces debe doblarse la masa",
                  "de": "Zählung wie oft Teig gefaltet werden muss",
                  "nl": "Telling van hoe vaak deeg gevouwen moet worden"
        },
        {
                  "en": "Test to see how fast bread dough falls when dropped",
                  "es": "Prueba para ver qué tan rápido cae la masa de pan cuando se suelta",
                  "de": "Test um zu sehen wie schnell Brotteig fällt wenn fallengelassen",
                  "nl": "Test om te zien hoe snel brooddeeg valt wanneer losgelaten"
        },
        {
                  "en": "Measurement of how long bread takes to cool after baking",
                  "es": "Medición de cuánto tiempo tarda el pan en enfriarse después de hornear",
                  "de": "Messung wie lange Brot nach dem Backen zum Abkühlen braucht",
                  "nl": "Meting van hoe lang brood nodig heeft om af te koelen na bakken"
        },
        {
                  "en": "Measures amylase enzyme activity in flour - low falling number (high enzyme)=sticky dough, poor bread. High number (low enzyme)=weak fermentation. Optimal: 250-350 seconds for bread flour",
                  "es": "Mide actividad de enzima amilasa en harina - número de caída bajo (enzima alta)=masa pegajosa, pan pobre. Número alto (enzima baja)=fermentación débil. Óptimo: 250-350 segundos para harina de pan",
                  "de": "Misst Amylase-Enzymaktivität im Mehl - niedrige Fallzahl (hohes Enzym)=klebriger Teig, schlechtes Brot. Hohe Zahl (niedriges Enzym)=schwache Fermentation. Optimal: 250-350 Sekunden für Brotmehl",
                  "nl": "Meet amylase enzymactiviteit in meel - laag valgetal (hoog enzym)=plakkerig deeg, slecht brood. Hoog getal (laag enzym)=zwakke fermentatie. Optimaal: 250-350 seconden voor broodmeel"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Foam/froth skimmed from fermenting beer - used as leavening agent before commercial yeast (pre-1800s). Contained wild yeast from beer brewing, gave bread distinctive flavor",
                  "es": "Espuma/espuma desnatada de cerveza en fermentación - usada como agente leudante antes de levadura comercial (pre-1800s). Contenía levadura salvaje de elaboración de cerveza, daba sabor distintivo al pan",
                  "de": "Schaum von gärendem Bier abgeschöpft - als Treibmittel verwendet vor kommerzieller Hefe (vor 1800). Enthielt wilde Hefe vom Bierbrauen, gab Brot charakteristischen Geschmack",
                  "nl": "Schuim afgeroomd van fermenterende bier - gebruikt als rijsmiddel voor commerciële gist (voor 1800). Bevatte wilde gist van bierbrouwen, gaf brood kenmerkende smaak"
        },
        {
                  "en": "Modern name for active dry yeast",
                  "es": "Nombre moderno para levadura seca activa",
                  "de": "Moderner Name für aktive Trockenhefe",
                  "nl": "Moderne naam voor actieve droge gist"
        },
        {
                  "en": "Type of whole grain flour from Scotland",
                  "es": "Tipo de harina integral de Escocia",
                  "de": "Vollkornmehltyp aus Schottland",
                  "nl": "Type volkoren meel uit Schotland"
        },
        {
                  "en": "Metal tool for scoring artisan bread",
                  "es": "Herramienta metálica para marcar pan artesanal",
                  "de": "Metallwerkzeug zum Einschneiden von handwerklichem Brot",
                  "nl": "Metalen gereedschap voor het scoren van ambachtelijk brood"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Staling happens in 1 hour, ropiness takes 1 week",
                  "es": "Envejecimiento ocurre en 1 hora, ropiness toma 1 semana",
                  "de": "Altbackenwerden passiert in 1 Stunde, Fadenzieher dauert 1 Woche",
                  "nl": "Veroudering gebeurt in 1 uur, ropiness duurt 1 week"
        },
        {
                  "en": "Ropiness: bacterial spoilage (Bacillus) causing sticky, rope-like strings and fruity smell within 12-48 hrs. Staling: normal retrogradation of starches over 2-5 days making bread firm/dry",
                  "es": "Ropiness: deterioro bacteriano (Bacillus) causando hilos pegajosos tipo cuerda y olor afrutado en 12-48 hrs. Envejecimiento: retrogradación normal de almidones en 2-5 días haciendo pan firme/seco",
                  "de": "Fadenzieher: bakterieller Verderb (Bacillus) verursacht klebrige, seilartige Fäden und fruchtigen Geruch innerhalb 12-48 Std. Altbackenwerden: normale Retrogradation von Stärken über 2-5 Tage macht Brot fest/trocken",
                  "nl": "Ropiness: bacterieel bederf (Bacillus) veroorzaakt plakkerige, touwachtige draden en fruitige geur binnen 12-48 uur. Veroudering: normale retrogradatie van zetmelen over 2-5 dagen maakt brood stevig/droog"
        },
        {
                  "en": "They are the same process with different names",
                  "es": "Son el mismo proceso con nombres diferentes",
                  "de": "Sie sind der gleiche Prozess mit verschiedenen Namen",
                  "nl": "Ze zijn hetzelfde proces met verschillende namen"
        },
        {
                  "en": "Ropiness is good, staling is bad for bread quality",
                  "es": "Ropiness es bueno, envejecimiento es malo para calidad del pan",
                  "de": "Fadenzieher ist gut, Altbackenwerden ist schlecht für Brotqualität",
                  "nl": "Ropiness is goed, veroudering is slecht voor broodkwaliteit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Professional bakers always use volumetric measurements",
                  "es": "Panaderos profesionales siempre usan mediciones volumétricas",
                  "de": "Professionelle Bäcker verwenden immer volumetrische Messungen",
                  "nl": "Professionele bakkers gebruiken altijd volumetrische metingen"
        },
        {
                  "en": "They are the same measuring technique",
                  "es": "Son la misma técnica de medición",
                  "de": "Sie sind die gleiche Messtechnik",
                  "nl": "Ze zijn dezelfde meettechniek"
        },
        {
                  "en": "Volumetric: measuring by cups/spoons (inconsistent due to packing/settling). Gravimetric: measuring by weight/scale (accurate, professional standard) - 1 cup flour can weigh 120-150g depending on packing",
                  "es": "Volumétrica: medir por tazas/cucharas (inconsistente debido a compactación/asentamiento). Gravimétrica: medir por peso/balanza (precisa, estándar profesional) - 1 taza de harina puede pesar 120-150g dependiendo de compactación",
                  "de": "Volumetrisch: Messen mit Tassen/Löffeln (inkonsistent wegen Verdichtung/Absetzen). Gravimetrisch: Messen nach Gewicht/Waage (genau, professioneller Standard) - 1 Tasse Mehl kann 120-150g wiegen je nach Verdichtung",
                  "nl": "Volumetrisch: meten met kopjes/lepels (inconsistent door samenpakken/bezinken). Gravimetrisch: meten op gewicht/weegschaal (nauwkeurig, professionele standaard) - 1 kopje meel kan 120-150g wegen afhankelijk van samenpakken"
        },
        {
                  "en": "Volumetric is more accurate than gravimetric for bread",
                  "es": "Volumétrica es más precisa que gravimétrica para pan",
                  "de": "Volumetrisch ist genauer als gravimetrisch für Brot",
                  "nl": "Volumetrisch is nauwkeuriger dan gravimetrisch voor brood"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Beating eggs before adding to dough",
                  "es": "Batir huevos antes de añadir a masa",
                  "de": "Eier schlagen vor Teigzugabe",
                  "nl": "Eieren kloppen voor toevoegen aan deeg"
        },
        {
                  "en": "Mix dry ingredients with fat first (coats flour proteins), then add liquids - creates tender crumb by limiting gluten development. Used for brioche, challah, milk bread",
                  "es": "Mezclar ingredientes secos con grasa primero (cubre proteínas de harina), luego añadir líquidos - crea miga tierna limitando desarrollo de gluten. Usado para brioche, challah, pan de leche",
                  "de": "Trockene Zutaten zuerst mit Fett mischen (beschichtet Mehlproteine), dann Flüssigkeiten hinzufügen - erzeugt zarte Krume durch Begrenzung der Glutenentwicklung. Verwendet für Brioche, Challah, Milchbrot",
                  "nl": "Droge ingrediënten eerst met vet mengen (bedekt meelproteïnen), dan vloeistoffen toevoegen - creëert zachte kruim door glutenontwikkeling te beperken. Gebruikt voor brioche, challah, melkbrood"
        },
        {
                  "en": "Adding yeast at the end instead of beginning",
                  "es": "Añadir levadura al final en lugar del principio",
                  "de": "Hefe am Ende statt am Anfang hinzufügen",
                  "nl": "Gist aan het einde toevoegen in plaats van begin"
        },
        {
                  "en": "Kneading dough backwards in reverse direction",
                  "es": "Amasar masa hacia atrás en dirección inversa",
                  "de": "Teig rückwärts in umgekehrter Richtung kneten",
                  "nl": "Deeg achteruit in omgekeerde richting kneden"
        }
        ],
        correct: 1,
        explanation: {
