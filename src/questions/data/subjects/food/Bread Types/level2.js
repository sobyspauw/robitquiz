  ...
  const level2 = {
    ...
    questions: [
      ...
      },
      {
        ...
        {
                  "en": "Checking if the bread is waterproof",
                  "es": "Verificar si el pan es impermeable",
                  "de": "Prüfen, ob das Brot wasserdicht ist",
                  "nl": "Controleren of het brood waterdicht is"
        },
        {
                  "en": "Adding extra ingredients",
                  "es": "Añadir ingredientes extra",
                  "de": "Zusätzliche Zutaten hinzufügen",
                  "nl": "Extra ingrediënten toevoegen"
        },
        {
                  "en": "Allowing yeast to ferment and dough to rise",
                  "es": "Permitir que la levadura fermente y la masa suba",
                  "de": "Die Hefe fermentieren und den Teig aufgehen lassen",
                  "nl": "Gist laten fermenteren en deeg laten rijzen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A tool for kneading dough",
                  "es": "Una herramienta para amasar masa",
                  "de": "Ein Werkzeug zum Kneten von Teig",
                  "nl": "Een gereedschap om deeg te kneden"
        },
        {
                  "en": "A knife for scoring bread",
                  "es": "Un cuchillo para cortar pan",
                  "de": "Ein Messer zum Einschneiden von Brot",
                  "nl": "Een mes om brood te scoren"
        },
        {
                  "en": "A special oven for baking",
                  "es": "Un horno especial para hornear",
                  "de": "Ein spezieller Ofen zum Backen",
                  "nl": "Een speciale oven om te bakken"
        },
        {
                  "en": "A basket for supporting dough during final proofing",
                  "es": "Una canasta para sostener la masa durante el leudado final",
                  "de": "Ein Korb zum Stützen des Teigs während des letzten Gehenlassens",
                  "nl": "Een mand om deeg te ondersteunen tijdens het laatste rijzen"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Heating the oven to maximum temperature",
                  "es": "Calentar el horno a temperatura máxima",
                  "de": "Den Ofen auf Höchsttemperatur erhitzen",
                  "nl": "De oven op maximale temperatuur verwarmen"
        },
        {
                  "en": "Resting flour and water mixture before adding other ingredients",
                  "es": "Reposar la mezcla de harina y agua antes de añadir otros ingredientes",
                  "de": "Mehl-Wasser-Mischung ruhen lassen bevor andere Zutaten hinzugefügt werden",
                  "nl": "Meel-watermengsel laten rusten voor het toevoegen van andere ingrediënten"
        },
        {
                  "en": "Cutting the bread after baking",
                  "es": "Cortar el pan después de hornear",
                  "de": "Das Brot nach dem Backen schneiden",
                  "nl": "Het brood snijden na het bakken"
        },
        {
                  "en": "Adding yeast to cold water",
                  "es": "Añadir levadura al agua fría",
                  "de": "Hefe zu kaltem Wasser hinzufügen",
                  "nl": "Gist toevoegen aan koud water"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Testing if dough sticks to glass",
                  "es": "Probar si la masa se pega al vidrio",
                  "de": "Testen, ob Teig an Glas klebt",
                  "nl": "Testen of deeg aan glas plakt"
        },
        {
                  "en": "Baking bread near a window",
                  "es": "Hornear pan cerca de una ventana",
                  "de": "Brot in der Nähe eines Fensters backen",
                  "nl": "Brood bij een raam bakken"
        },
        {
                  "en": "Stretching dough thin to check gluten development",
                  "es": "Estirar la masa fina para verificar el desarrollo del gluten",
                  "de": "Teig dünn dehnen um Glutenentwicklung zu prüfen",
                  "nl": "Deeg dun uitrekken om glutenontwikkeling te controleren"
        },
        {
                  "en": "Holding bread up to a window to check color",
                  "es": "Sostener el pan frente a una ventana para verificar el color",
                  "de": "Brot ans Fenster halten um die Farbe zu prüfen",
                  "nl": "Brood voor een raam houden om kleur te controleren"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Bread baked by rich people",
                  "es": "Pan horneado por gente rica",
                  "de": "Brot gebacken von reichen Leuten",
                  "nl": "Brood gebakken door rijke mensen"
        },
        {
                  "en": "Bread with added vitamins only",
                  "es": "Pan solo con vitaminas añadidas",
                  "de": "Brot nur mit zugesetzten Vitaminen",
                  "nl": "Brood alleen met toegevoegde vitamines"
        },
        {
                  "en": "Bread with added fats, eggs, sugar, or milk",
                  "es": "Pan con grasas, huevos, azúcar o leche añadidos",
                  "de": "Brot mit zugesetzten Fetten, Eiern, Zucker oder Milch",
                  "nl": "Brood met toegevoegde vetten, eieren, suiker of melk"
        },
        {
                  "en": "Expensive artisan bread",
                  "es": "Pan artesanal caro",
                  "de": "Teures handwerkliches Brot",
                  "nl": "Duur ambachtelijk brood"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Lean has minimal fat/sugar, rich has butter/eggs/milk",
                  "es": "Magra tiene grasa/azúcar mínimos, rica tiene mantequilla/huevos/leche",
                  "de": "Mager hat minimales Fett/Zucker, reich hat Butter/Eier/Milch",
                  "nl": "Mager heeft minimaal vet/suiker, rijk heeft boter/eieren/melk"
        },
        {
                  "en": "Rich bread costs more money",
                  "es": "El pan rico cuesta más dinero",
                  "de": "Reiches Brot kostet mehr Geld",
                  "nl": "Rijk brood kost meer geld"
        },
        {
                  "en": "Lean bread is healthier than rich bread",
                  "es": "El pan magro es más saludable que el pan rico",
                  "de": "Mageres Brot ist gesünder als reiches Brot",
                  "nl": "Mager brood is gezonder dan rijk brood"
        },
        {
                  "en": "Lean bread is made for weight loss",
                  "es": "El pan magro se hace para perder peso",
                  "de": "Mageres Brot wird zur Gewichtsabnahme gemacht",
                  "nl": "Mager brood wordt gemaakt voor gewichtsverlies"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Makes the bread cook faster",
                  "es": "Hace que el pan se cocine más rápido",
                  "de": "Lässt das Brot schneller kochen",
                  "nl": "Laat het brood sneller koken"
        },
        {
                  "en": "Controls where bread expands and creates decorative patterns",
                  "es": "Controla dónde se expande el pan y crea patrones decorativos",
                  "de": "Kontrolliert wo Brot sich ausdehnt und erzeugt dekorative Muster",
                  "nl": "Controleert waar brood uitzet en creëert decoratieve patronen"
        },
        {
                  "en": "Adds flavor to the crust",
                  "es": "Añade sabor a la corteza",
                  "de": "Fügt der Kruste Geschmack hinzu",
                  "nl": "Voegt smaak toe aan de korst"
        },
        {
                  "en": "Removes excess moisture",
                  "es": "Elimina el exceso de humedad",
                  "de": "Entfernt überschüssige Feuchtigkeit",
                  "nl": "Verwijdert overtollig vocht"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Creates crispy crust and allows better oven spring",
                  "es": "Crea corteza crujiente y permite mejor expansión en el horno",
                  "de": "Erzeugt knusprige Kruste und ermöglicht besseren Ofentrieb",
                  "nl": "Creëert knapperige korst en staat betere ovenrijs toe"
        },
        {
                  "en": "Makes bread taste sweeter",
                  "es": "Hace que el pan sepa más dulce",
                  "de": "Lässt Brot süßer schmecken",
                  "nl": "Laat brood zoeter smaken"
        },
        {
                  "en": "Speeds up baking time",
                  "es": "Acelera el tiempo de horneado",
                  "de": "Beschleunigt die Backzeit",
                  "nl": "Versnelt baktijd"
        },
        {
                  "en": "Prevents bread from burning",
                  "es": "Evita que el pan se queme",
                  "de": "Verhindert dass Brot verbrennt",
                  "nl": "Voorkomt dat brood verbrandt"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A glaze applied to bread",
                  "es": "Un glaseado aplicado al pan",
                  "de": "Eine Glasur aufgetragen auf Brot",
                  "nl": "Een glazuur aangebracht op brood"
        },
        {
                  "en": "A pre-ferment made with equal parts flour and water plus yeast",
                  "es": "Un pre-fermento hecho con partes iguales de harina y agua más levadura",
                  "de": "Ein Vorteig aus gleichen Teilen Mehl und Wasser plus Hefe",
                  "nl": "Een voordeeg gemaakt met gelijke delen meel en water plus gist"
        },
        {
                  "en": "A special baking tool from Poland",
                  "es": "Una herramienta especial de hornear de Polonia",
                  "de": "Ein spezielles Backwerkzeug aus Polen",
                  "nl": "Een speciaal bakgereedschap uit Polen"
        },
        {
                  "en": "A type of Polish bread",
                  "es": "Un tipo de pan polaco",
                  "de": "Eine Art polnisches Brot",
                  "nl": "Een soort Pools brood"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Using spoiled flour",
                  "es": "Usar harina estropeada",
                  "de": "Verdorbenes Mehl verwenden",
                  "nl": "Bedorven meel gebruiken"
        },
        {
                  "en": "Baking at too high temperature",
                  "es": "Hornear a temperatura demasiado alta",
                  "de": "Bei zu hoher Temperatur backen",
                  "nl": "Bakken op te hoge temperatuur"
        },
        {
                  "en": "Lactic acid bacteria during fermentation",
                  "es": "Bacterias de ácido láctico durante la fermentación",
                  "de": "Milchsäurebakterien während der Fermentation",
                  "nl": "Melkzuurbacteriën tijdens fermentatie"
        },
        {
                  "en": "Adding lemon juice",
                  "es": "Añadir jugo de limón",
                  "de": "Zitronensaft hinzufügen",
                  "nl": "Citroensap toevoegen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A type of spring-loaded oven door",
                  "es": "Un tipo de puerta de horno con resorte",
                  "de": "Eine Art federbelastete Ofentür",
                  "nl": "Een soort verende ovendeur"
        },
        {
                  "en": "The rapid rise of bread in the first minutes of baking",
                  "es": "La subida rápida del pan en los primeros minutos de horneado",
                  "de": "Das schnelle Aufgehen von Brot in den ersten Minuten des Backens",
                  "nl": "De snelle rijs van brood in de eerste minuten van bakken"
        },
        {
                  "en": "The bouncy texture of fresh bread",
                  "es": "La textura elástica del pan fresco",
                  "de": "Die federnde Textur von frischem Brot",
                  "nl": "De veerkrachtige textuur van vers brood"
        },
        {
                  "en": "Baking bread in springtime",
                  "es": "Hornear pan en primavera",
                  "de": "Brot im Frühling backen",
                  "nl": "Brood bakken in de lente"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Milk prevents mold growth",
                  "es": "La leche previene el crecimiento de moho",
                  "de": "Milch verhindert Schimmelwachstum",
                  "nl": "Melk voorkomt schimmelgroei"
        },
        {
                  "en": "Milk creates softer, richer bread with better browning",
                  "es": "La leche crea pan más suave y rico con mejor dorado",
                  "de": "Milch erzeugt weicheres, reicheres Brot mit besserer Bräunung",
                  "nl": "Melk creëert zachter, rijker brood met betere bruining"
        },
        {
                  "en": "Water is too expensive",
                  "es": "El agua es demasiado cara",
                  "de": "Wasser ist zu teuer",
                  "nl": "Water is te duur"
        },
        {
                  "en": "Milk makes bread rise higher",
                  "es": "La leche hace que el pan suba más alto",
                  "de": "Milch lässt Brot höher aufgehen",
                  "nl": "Melk laat brood hoger rijzen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "They are exactly the same product",
                  "es": "Son exactamente el mismo producto",
                  "de": "Sie sind genau dasselbe Produkt",
                  "nl": "Ze zijn precies hetzelfde product"
        },
        {
                  "en": "Active dry needs dissolving in water, instant can be mixed directly with flour",
                  "es": "La activa seca necesita disolverse en agua, la instantánea puede mezclarse directamente con harina",
                  "de": "Aktive Trockenhefe muss in Wasser aufgelöst werden, Instanthefe kann direkt mit Mehl gemischt werden",
                  "nl": "Actieve droge moet opgelost worden in water, instant kan direct gemengd worden met meel"
        },
        {
                  "en": "Active dry yeast works faster",
                  "es": "La levadura seca activa funciona más rápido",
                  "de": "Aktive Trockenhefe wirkt schneller",
                  "nl": "Actieve droge gist werkt sneller"
        },
        {
                  "en": "Instant yeast is always better quality",
                  "es": "La levadura instantánea siempre es de mejor calidad",
                  "de": "Instanthefe ist immer bessere Qualität",
                  "nl": "Instant gist is altijd betere kwaliteit"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Slowing fermentation by refrigerating dough",
                  "es": "Ralentizar la fermentación refrigerando la masa",
                  "de": "Fermentation durch Kühlen des Teigs verlangsamen",
                  "nl": "Fermentatie vertragen door deeg te koelen"
        },
        {
                  "en": "Making dough harder to knead",
                  "es": "Hacer que la masa sea más difícil de amasar",
                  "de": "Teig schwerer zu kneten machen",
                  "nl": "Deeg moeilijker te kneden maken"
        },
        {
                  "en": "Stopping the dough from rising",
                  "es": "Detener que la masa suba",
                  "de": "Das Aufgehen des Teigs stoppen",
                  "nl": "Het deeg stoppen met rijzen"
        },
        {
                  "en": "Removing yeast from dough",
                  "es": "Eliminar levadura de la masa",
                  "de": "Hefe aus Teig entfernen",
                  "nl": "Gist uit deeg verwijderen"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A large Italian oven",
                  "es": "Un horno italiano grande",
                  "de": "Ein großer italienischer Ofen",
                  "nl": "Een grote Italiaanse oven"
        },
        {
                  "en": "An Italian bread knife",
                  "es": "Un cuchillo de pan italiano",
                  "de": "Ein italienisches Brotmesser",
                  "nl": "Een Italiaans broodmes"
        },
        {
                  "en": "An Italian pre-ferment using flour, water, and yeast",
                  "es": "Un pre-fermento italiano usando harina, agua y levadura",
                  "de": "Ein italienischer Vorteig aus Mehl, Wasser und Hefe",
                  "nl": "Een Italiaans voordeeg met meel, water en gist"
        },
        {
                  "en": "A bread-shaping technique",
                  "es": "Una técnica de formar pan",
                  "de": "Eine Brotformtechnik",
                  "nl": "Een broodvormtechniek"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Kills bacteria in flour",
                  "es": "Mata bacterias en la harina",
                  "de": "Tötet Bakterien im Mehl",
                  "nl": "Doodt bacteriën in meel"
        },
        {
                  "en": "Controls fermentation, strengthens gluten, and adds flavor",
                  "es": "Controla la fermentación, fortalece el gluten y añade sabor",
                  "de": "Kontrolliert Fermentation, stärkt Gluten und fügt Geschmack hinzu",
                  "nl": "Controleert fermentatie, versterkt gluten en voegt smaak toe"
        },
        {
                  "en": "Only adds flavor, has no other function",
                  "es": "Solo añade sabor, no tiene otra función",
                  "de": "Fügt nur Geschmack hinzu, hat keine andere Funktion",
                  "nl": "Voegt alleen smaak toe, heeft geen andere functie"
        },
        {
      ...
      },
      {
        ...
        {
                  "en": "Using old flour",
                  "es": "Usar harina vieja",
                  "de": "Altes Mehl verwenden",
                  "nl": "Oud meel gebruiken"
        },
        {
                  "en": "Adding baking soda",
                  "es": "Añadir bicarbonato de sodio",
                  "de": "Natron hinzufügen",
                  "nl": "Zuiveringszout toevoegen"
        },
        {
                  "en": "Baking at very low temperature",
                  "es": "Hornear a temperatura muy baja",
                  "de": "Bei sehr niedriger Temperatur backen",
                  "nl": "Bakken op zeer lage temperatuur"
        },
        {
                  "en": "High hydration dough and proper fermentation",
                  "es": "Masa de alta hidratación y fermentación adecuada",
                  "de": "Hochhydratisierter Teig und richtige Fermentation",
                  "nl": "Hoge hydratie deeg en juiste fermentatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "A decoration technique for bread crust",
                  "es": "Una técnica de decoración para corteza de pan",
                  "de": "Eine Dekorationstechnik für Brotkruste",
                  "nl": "Een decoratietechniek voor broodkorst"
        },
        {
                  "en": "Storing dough in a folded towel",
                  "es": "Almacenar masa en una toalla doblada",
                  "de": "Teig in einem gefalteten Handtuch lagern",
                  "nl": "Deeg bewaren in een gevouwen handdoek"
        },
        {
                  "en": "A gentle kneading technique that strengthens dough during bulk fermentation",
                  "es": "Una técnica suave de amasado que fortalece la masa durante la fermentación en masa",
                  "de": "Eine sanfte Knettechnik die Teig während der Stockgare stärkt",
                  "nl": "Een zachte kneedtechniek die deeg versterkt tijdens bulkfermentatie"
        },
        {
                  "en": "Folding dough in half before baking",
                  "es": "Doblar la masa por la mitad antes de hornear",
                  "de": "Teig vor dem Backen halbieren",
                  "nl": "Deeg halveren voor het bakken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding water to dry bread",
                  "es": "Añadir agua a pan seco",
                  "de": "Wasser zu trockenem Brot hinzufügen",
                  "nl": "Water toevoegen aan droog brood"
        },
        {
                  "en": "Moisture content of finished bread",
                  "es": "Contenido de humedad del pan terminado",
                  "de": "Feuchtigkeitsgehalt von fertigem Brot",
                  "nl": "Vochtgehalte van afgewerkt brood"
        },
        {
                  "en": "The ratio of water to flour in dough, expressed as a percentage",
                  "es": "La proporción de agua a harina en la masa, expresada como porcentaje",
                  "de": "Das Verhältnis von Wasser zu Mehl im Teig, ausgedrückt als Prozentsatz",
                  "nl": "De verhouding van water tot meel in deeg, uitgedrukt als percentage"
        },
        {
                  "en": "How much water the baker drinks",
                  "es": "Cuánta agua bebe el panadero",
                  "de": "Wie viel Wasser der Bäcker trinkt",
                  "nl": "Hoeveel water de bakker drinkt"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Makes bread rise higher only",
                  "es": "Hace que el pan suba más alto solamente",
                  "de": "Lässt Brot nur höher aufgehen",
                  "nl": "Laat brood alleen hoger rijzen"
        },
        {
                  "en": "Strengthens gluten structure",
                  "es": "Fortalece la estructura del gluten",
                  "de": "Stärkt Glutenstruktur",
                  "nl": "Versterkt glutenstructuur"
        },
        {
                  "en": "Feeds yeast, adds flavor, and improves browning",
                  "es": "Alimenta la levadura, añade sabor y mejora el dorado",
                  "de": "Füttert Hefe, fügt Geschmack hinzu und verbessert Bräunung",
                  "nl": "Voedt gist, voegt smaak toe en verbetert bruining"
        },
        {
                  "en": "Prevents bread from getting stale",
                  "es": "Previene que el pan se ponga duro",
                  "de": "Verhindert dass Brot altbacken wird",
                  "nl": "Voorkomt dat brood oud wordt"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Letting shaped dough rest on work surface before final shaping",
                  "es": "Dejar reposar la masa formada en la superficie de trabajo antes del formado final",
                  "de": "Geformten Teig auf Arbeitsfläche ruhen lassen vor endgültigem Formen",
                  "nl": "Gevormd deeg laten rusten op werkoppervlak voor laatste vorming"
        },
        {
                  "en": "Cooling bread on a bench",
                  "es": "Enfriar pan en un banco",
                  "de": "Brot auf einer Bank abkühlen",
                  "nl": "Brood afkoelen op een bank"
        },
        {
                  "en": "Resting after kneading dough",
                  "es": "Descansar después de amasar masa",
                  "de": "Nach dem Kneten von Teig ausruhen",
                  "nl": "Rusten na het kneden van deeg"
        },
        {
                  "en": "Taking a break from baking",
                  "es": "Tomar un descanso de hornear",
                  "de": "Eine Pause vom Backen machen",
                  "nl": "Een pauze nemen van bakken"
        }
        ],
        correct: 0,
        explanation: {
