  ...
  const level4 = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Technique for shaping baguettes into spiral patterns",
                  "es": "Técnica para formar baguettes en patrones espirales",
                  "de": "Technik zum Formen von Baguettes in Spiralmuster",
                  "nl": "Techniek voor het vormen van stokbroden in spiraalpatronen"
        },
        {
                  "en": "Aggressive kneading method only for low-hydration bread dough",
                  "es": "Método de amasado agresivo solo para masa de pan de baja hidratación",
                  "de": "Aggressive Knetmethode nur für niedrig-hydrierten Brotteig",
                  "nl": "Agressieve kneedmethode alleen voor laag gehydrateerd brooddeeg"
        },
        {
                  "en": "Gentle folding method for high-hydration doughs that builds strength without degassing - lift center, let ends fold under like a coil",
                  "es": "Método de plegado suave para masas de alta hidratación que desarrolla fuerza sin desgasificar - levante el centro, deje que los extremos se doblen debajo como una espiral",
                  "de": "Sanfte Falttechnik für hochhydrierte Teige, die Kraft aufbaut ohne zu entgasen - Mitte anheben, Enden falten sich darunter wie eine Spirale",
                  "nl": "Zachte vouwmethode voor hoog gehydrateerd deeg die kracht opbouwt zonder te ontgassen - til het midden op, laat uiteinden eronder vouwen als een spiraal"
        },
        {
                  "en": "Method of cooling bread by wrapping in metal coils",
                  "es": "Método de enfriar pan envolviéndolo en bobinas metálicas",
                  "de": "Methode zum Kühlen von Brot durch Einwickeln in Metallspiralen",
                  "nl": "Methode om brood af te koelen door in metalen spiralen te wikkelen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Vigorous kneading method - lift wet dough high, slap onto counter, fold over itself repeatedly for 5-10 min to develop gluten quickly",
                  "es": "Método de amasado vigoroso - levante la masa húmeda alto, golpee sobre el mostrador, doble sobre sí misma repetidamente durante 5-10 min para desarrollar gluten rápidamente",
                  "de": "Kräftige Knetmethode - nassen Teig hochheben, auf Arbeitsfläche schlagen, wiederholt über sich selbst falten für 5-10 Min um Gluten schnell zu entwickeln",
                  "nl": "Krachtige kneedmethode - til nat deeg hoog op, sla op aanrecht, vouw herhaaldelijk over zichzelf voor 5-10 min om gluten snel te ontwikkelen"
        },
        {
                  "en": "Gentle resting period where dough is covered with towel for 30 minutes",
                  "es": "Período de reposo suave donde la masa se cubre con toalla durante 30 minutos",
                  "de": "Sanfte Ruhezeit wo Teig mit Handtuch bedeckt wird für 30 Minuten",
                  "nl": "Zachte rustperiode waar deeg bedekt wordt met handdoek voor 30 minuten"
        },
        {
                  "en": "Method of scoring bread with quick slapping motions",
                  "es": "Método de marcar pan con movimientos rápidos de golpeteo",
                  "de": "Methode zum Einschneiden von Brot mit schnellen Klatschbewegungen",
                  "nl": "Methode om brood te scoren met snelle klappende bewegingen"
        },
        {
                  "en": "Technique for shaping only French baguettes",
                  "es": "Técnica para formar solo baguettes francesas",
                  "de": "Technik nur zum Formen französischer Baguettes",
                  "nl": "Techniek alleen voor het vormen van Franse stokbroden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Metal spring inside oven that controls temperature",
                  "es": "Resorte metálico dentro del horno que controla la temperatura",
                  "de": "Metallfeder im Ofen die Temperatur kontrolliert",
                  "nl": "Metalen veer in de oven die temperatuur regelt"
        },
        {
                  "en": "Rapid rise in first 10-15 min of baking - maximized by: proper proofing (not over/under), steam injection, scoring, and active yeast producing final CO2 burst from heat",
                  "es": "Aumento rápido en los primeros 10-15 min de horneado - maximizado por: fermentación adecuada (no sobre/sub), inyección de vapor, marcado, y levadura activa produciendo explosión final de CO2 por calor",
                  "de": "Schneller Anstieg in ersten 10-15 Min des Backens - maximiert durch: richtige Gare (nicht über/unter), Dampfeinspritzung, Einschneiden, und aktive Hefe die finalen CO2-Stoß durch Hitze produziert",
                  "nl": "Snelle stijging in eerste 10-15 min van bakken - gemaximaliseerd door: juiste rijzing (niet over/onder), stoominjectie, scoren, en actieve gist die laatste CO2-uitbarsting produceert door hitte"
        },
        {
                  "en": "Slow cooling period after baking where bread contracts",
                  "es": "Período de enfriamiento lento después del horneado donde el pan se contrae",
                  "de": "Langsame Abkühlperiode nach dem Backen wo Brot sich zusammenzieht",
                  "nl": "Langzame afkoelperiode na het bakken waar brood samentrekt"
        },
        {
                  "en": "Adding baking powder to dough just before baking",
                  "es": "Añadir polvo de hornear a la masa justo antes de hornear",
                  "de": "Backpulver zum Teig hinzufügen kurz vor dem Backen",
                  "nl": "Bakpoeder toevoegen aan deeg net voor bakken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Stretch and fold is only for pizza dough, kneading is only for sandwich bread",
                  "es": "Stretch and fold es solo para masa de pizza, amasado es solo para pan de sándwich",
                  "de": "Stretch and Fold ist nur für Pizzateig, Kneten ist nur für Sandwichbrot",
                  "nl": "Stretch and fold is alleen voor pizzadeeg, kneden is alleen voor sandwichbrood"
        },
        {
                  "en": "They are exactly the same technique with different names",
                  "es": "Son exactamente la misma técnica con nombres diferentes",
                  "de": "Sie sind genau die gleiche Technik mit verschiedenen Namen",
                  "nl": "Ze zijn precies dezelfde techniek met verschillende namen"
        },
        {
                  "en": "Kneading is gentle, stretch and fold is aggressive machine mixing",
                  "es": "Amasado es suave, stretch and fold es mezcla agresiva con máquina",
                  "de": "Kneten ist sanft, Stretch and Fold ist aggressives Maschinenmischen",
                  "nl": "Kneden is zacht, stretch and fold is agressief machinaal mixen"
        },
        {
                  "en": "Stretch and fold: gentle periodic folding during bulk fermentation (4-6 times over 2-3 hrs) - less work, preserves air, better for wet doughs. Kneading: intensive upfront work (10 min)",
                  "es": "Stretch and fold: plegado suave periódico durante fermentación en masa (4-6 veces en 2-3 hrs) - menos trabajo, preserva aire, mejor para masas húmedas. Amasado: trabajo intensivo inicial (10 min)",
                  "de": "Stretch and Fold: sanftes periodisches Falten während Stockgare (4-6 Mal über 2-3 Std) - weniger Arbeit, bewahrt Luft, besser für nasse Teige. Kneten: intensive Arbeit im Voraus (10 Min)",
                  "nl": "Stretch and fold: zacht periodiek vouwen tijdens bulk fermentatie (4-6 keer over 2-3 uur) - minder werk, behoudt lucht, beter voor natte degen. Kneden: intensief vooraf werk (10 min)"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Metal tool for scoring bread before baking",
                  "es": "Herramienta metálica para marcar pan antes de hornear",
                  "de": "Metallwerkzeug zum Einschneiden von Brot vor dem Backen",
                  "nl": "Metalen gereedschap voor het scoren van brood voor bakken"
        },
        {
                  "en": "Chemical additive that improves bread texture",
                  "es": "Aditivo químico que mejora la textura del pan",
                  "de": "Chemischer Zusatzstoff der Brottextur verbessert",
                  "nl": "Chemische toevoeging die broodtextuur verbetert"
        },
        {
                  "en": "Rattan/cane proofing basket that supports shaped dough during final rise, wicks away moisture, creates beautiful spiral pattern on crust",
                  "es": "Cesta de fermentación de ratán/caña que soporta masa formada durante el levado final, absorbe humedad, crea hermoso patrón espiral en la corteza",
                  "de": "Rattan/Rohr-Gärkorb der geformten Teig während der Endgare stützt, Feuchtigkeit ableitet, schönes Spiralmuster auf Kruste erzeugt",
                  "nl": "Rotan/riet rijsmand die gevormd deeg ondersteunt tijdens laatste rijs, trekt vocht weg, creëert mooi spiraalpatroon op korst"
        },
        {
                  "en": "French bread-slicing machine used in bakeries",
                  "es": "Máquina francesa de cortar pan usada en panaderías",
                  "de": "Französische Brotschneidemaschine in Bäckereien verwendet",
                  "nl": "Franse broodsnijmachine gebruikt in bakkerijen"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Cold fermentation in fridge (4-24+ hrs) - slows yeast, allows enzyme/bacterial flavor development, fits baking schedule, improves digestibility",
                  "es": "Fermentación fría en refrigerador (4-24+ hrs) - reduce levadura, permite desarrollo de sabor enzimático/bacteriano, se ajusta al horario de horneado, mejora digestibilidad",
                  "de": "Kalte Fermentation im Kühlschrank (4-24+ Std) - verlangsamt Hefe, erlaubt Enzym/Bakterien-Geschmacksentwicklung, passt Backplan, verbessert Verdaulichkeit",
                  "nl": "Koude fermentatie in koelkast (4-24+ uur) - vertraagt gist, staat enzym/bacteriële smaakontwikkeling toe, past bakschema, verbetert verteerbaarheid"
        },
        {
                  "en": "Kneading dough backwards to reverse gluten development",
                  "es": "Amasar masa hacia atrás para revertir el desarrollo de gluten",
                  "de": "Teig rückwärts kneten um Glutenentwicklung umzukehren",
                  "nl": "Deeg achteruit kneden om glutenontwikkeling om te keren"
        },
        {
                  "en": "Adding chemicals to slow down yeast permanently",
                  "es": "Añadir químicos para reducir permanentemente la levadura",
                  "de": "Chemikalien hinzufügen um Hefe dauerhaft zu verlangsamen",
                  "nl": "Chemicaliën toevoegen om gist permanent te vertragen"
        },
        {
                  "en": "Technique only used for sweet dessert breads",
                  "es": "Técnica solo usada para panes dulces de postre",
                  "de": "Technik nur für süße Dessertbrote verwendet",
                  "nl": "Techniek alleen gebruikt voor zoete dessertbroden"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Baking at too low temperature causes tunneling",
                  "es": "Hornear a temperatura demasiado baja causa tunelización",
                  "de": "Backen bei zu niedriger Temperatur verursacht Tunnelbildung",
                  "nl": "Bakken op te lage temperatuur veroorzaakt tunneling"
        },
        {
                  "en": "Using whole wheat flour always creates tunnels",
                  "es": "Usar harina integral siempre crea túneles",
                  "de": "Verwendung von Vollkornmehl erzeugt immer Tunnel",
                  "nl": "Gebruik van volkoren meel creëert altijd tunnels"
        },
        {
                  "en": "Improper degassing before shaping - large air pockets remain and expand during baking; also caused by uneven shaping or too-vigorous handling",
                  "es": "Desgasificación inadecuada antes de formar - grandes bolsas de aire permanecen y se expanden durante el horneado; también causado por formado desigual o manejo demasiado vigoroso",
                  "de": "Unsachgemäßes Entgasen vor dem Formen - große Lufttaschen bleiben und dehnen sich während des Backens aus; auch verursacht durch ungleichmäßiges Formen oder zu kräftige Handhabung",
                  "nl": "Onjuiste ontgassing voor het vormen - grote luchtzakken blijven en zetten uit tijdens bakken; ook veroorzaakt door ongelijk vormen of te krachtige behandeling"
        },
        {
                  "en": "Adding too much water makes bread have holes",
                  "es": "Añadir demasiada agua hace que el pan tenga agujeros",
                  "de": "Zu viel Wasser macht Brot mit Löchern",
                  "nl": "Te veel water toevoegen maakt brood met gaten"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Special refrigerator for storing bread dough",
                  "es": "Refrigerador especial para almacenar masa de pan",
                  "de": "Spezieller Kühlschrank zum Lagern von Brotteig",
                  "nl": "Speciale koelkast voor het bewaren van brooddeeg"
        },
        {
                  "en": "Commercial blend of enzymes, emulsifiers, acids - strengthens gluten, improves volume, extends shelf life, makes dough easier to handle and more tolerant",
                  "es": "Mezcla comercial de enzimas, emulsionantes, ácidos - fortalece gluten, mejora volumen, extiende vida útil, hace masa más fácil de manejar y más tolerante",
                  "de": "Kommerzielle Mischung aus Enzymen, Emulgatoren, Säuren - stärkt Gluten, verbessert Volumen, verlängert Haltbarkeit, macht Teig leichter zu handhaben und toleranter",
                  "nl": "Commerciële mix van enzymen, emulgatoren, zuren - versterkt gluten, verbetert volume, verlengt houdbaarheid, maakt deeg makkelijker te hanteren en toleranter"
        },
        {
                  "en": "Massage technique bakers use to relax bread dough",
                  "es": "Técnica de masaje que los panaderos usan para relajar la masa de pan",
                  "de": "Massagetechnik die Bäcker verwenden um Brotteig zu entspannen",
                  "nl": "Massagetechniek die bakkers gebruiken om brooddeeg te ontspannen"
        },
        {
                  "en": "Type of flour only used in professional bakeries",
                  "es": "Tipo de harina solo usada en panaderías profesionales",
                  "de": "Mehltyp nur in professionellen Bäckereien verwendet",
                  "nl": "Type meel alleen gebruikt in professionele bakkerijen"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Italian sourdough bread with very thick crust",
                  "es": "Pan de masa madre italiano con corteza muy gruesa",
                  "de": "Italienisches Sauerteigbrot mit sehr dicker Kruste",
                  "nl": "Italiaans zuurdesembrood met zeer dikke korst"
        },
        {
                  "en": "French Pullman loaf - enriched with milk/butter, baked in lidded pan for perfectly square shape, fine even crumb, soft crust - ideal for sandwiches",
                  "es": "Pan Pullman francés - enriquecido con leche/mantequilla, horneado en molde con tapa para forma perfectamente cuadrada, miga fina uniforme, corteza suave - ideal para sándwiches",
                  "de": "Französisches Kastenbrot - angereichert mit Milch/Butter, in Kastenform mit Deckel gebacken für perfekt quadratische Form, feine gleichmäßige Krume, weiche Kruste - ideal für Sandwiches",
                  "nl": "Frans Pullman brood - verrijkt met melk/boter, gebakken in pan met deksel voor perfect vierkante vorm, fijne gelijkmatige kruim, zachte korst - ideaal voor sandwiches"
        },
        {
                  "en": "German rye bread with caraway seeds",
                  "es": "Pan de centeno alemán con semillas de alcaravea",
                  "de": "Deutsches Roggenbrot mit Kümmel",
                  "nl": "Duits roggebrood met komijnzaad"
        },
        {
                  "en": "Spanish flatbread cooked on griddle",
                  "es": "Pan plano español cocido en plancha",
                  "de": "Spanisches Fladenbrot auf Grillplatte gekocht",
                  "nl": "Spaans platbrood gekookt op grillplaat"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Stiff starter is frozen, liquid starter is fresh",
                  "es": "Starter rígido es congelado, starter líquido es fresco",
                  "de": "Steifer Starter ist gefroren, flüssiger Starter ist frisch",
                  "nl": "Stijve starter is bevroren, vloeibare starter is vers"
        },
        {
                  "en": "Stiff: 50-60% hydration (1:2 water:flour) - less acidic, milder flavor, slower ferment, better for sweet breads. Liquid: 100%+ hydration (1:1) - more acetic acid, tangy, faster, easier to mix",
                  "es": "Rígido: 50-60% hidratación (1:2 agua:harina) - menos ácido, sabor más suave, fermentación más lenta, mejor para panes dulces. Líquido: 100%+ hidratación (1:1) - más ácido acético, ácido, más rápido, más fácil de mezclar",
                  "de": "Steif: 50-60% Hydratation (1:2 Wasser:Mehl) - weniger sauer, milderer Geschmack, langsamere Fermentation, besser für süße Brote. Flüssig: 100%+ Hydratation (1:1) - mehr Essigsäure, säuerlich, schneller, leichter zu mischen",
                  "nl": "Stijf: 50-60% hydratatie (1:2 water:meel) - minder zuur, mildere smaak, langzamere fermentatie, beter voor zoete broden. Vloeibaar: 100%+ hydratatie (1:1) - meer azijnzuur, zuur, sneller, makkelijker te mengen"
        },
        {
                  "en": "They are the same thing with different names",
                  "es": "Son lo mismo con nombres diferentes",
                  "de": "Sie sind das Gleiche mit verschiedenen Namen",
                  "nl": "Ze zijn hetzelfde met verschillende namen"
        },
        {
                  "en": "Liquid starter is only for pizza, stiff is only for baguettes",
                  "es": "Starter líquido es solo para pizza, rígido es solo para baguettes",
                  "de": "Flüssiger Starter ist nur für Pizza, steifer nur für Baguettes",
                  "nl": "Vloeibare starter is alleen voor pizza, stijf is alleen voor stokbroden"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Burning the top crust with a torch for flavor",
                  "es": "Quemar la corteza superior con un soplete para dar sabor",
                  "de": "Obere Kruste mit Brenner abbrennen für Geschmack",
                  "nl": "Bovenste korst verbranden met brander voor smaak"
        },
        {
                  "en": "Pouring boiling water over rye flour/meal to gelatinize starches - creates moist, sweet, dense crumb, extends shelf life, traditional in Baltic/Russian breads",
                  "es": "Verter agua hirviendo sobre harina/sémola de centeno para gelatinizar almidones - crea miga húmeda, dulce, densa, extiende vida útil, tradicional en panes bálticos/rusos",
                  "de": "Kochendes Wasser über Roggenmehl/-schrot gießen um Stärken zu gelatinieren - erzeugt feuchte, süße, dichte Krume, verlängert Haltbarkeit, traditionell in baltischen/russischen Broten",
                  "nl": "Kokend water over roggenmeel/-grof gieten om zetmelen te gelatineren - creëert vochtige, zoete, dichte kruim, verlengt houdbaarheid, traditioneel in Baltische/Russische broden"
        },
        {
                  "en": "Adding hot oil to dough to improve texture",
                  "es": "Añadir aceite caliente a la masa para mejorar textura",
                  "de": "Heißes Öl zum Teig hinzufügen um Textur zu verbessern",
                  "nl": "Hete olie aan deeg toevoegen om textuur te verbeteren"
        },
        {
                  "en": "Soaking rye berries in cold water for 24 hours",
                  "es": "Remojar bayas de centeno en agua fría durante 24 horas",
                  "de": "Roggenkörner 24 Stunden in kaltem Wasser einweichen",
                  "nl": "Roggekorrels 24 uur weken in koud water"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding ice water and hot water simultaneously",
                  "es": "Añadir agua helada y agua caliente simultáneamente",
                  "de": "Eiswasser und heißes Wasser gleichzeitig hinzufügen",
                  "nl": "IJswater en heet water tegelijk toevoegen"
        },
        {
                  "en": "Adding water in 2 stages - mix to shaggy dough with 80% water, rest, then add final 20% - allows easier gluten development in very wet doughs (80%+ hydration)",
                  "es": "Añadir agua en 2 etapas - mezclar a masa irregular con 80% agua, reposar, luego añadir 20% final - permite desarrollo de gluten más fácil en masas muy húmedas (80%+ hidratación)",
                  "de": "Wasser in 2 Stufen hinzufügen - zu struppigem Teig mit 80% Wasser mischen, ruhen, dann finale 20% hinzufügen - ermöglicht einfachere Glutenentwicklung in sehr nassen Teigen (80%+ Hydratation)",
                  "nl": "Water toevoegen in 2 stadia - mengen tot ruig deeg met 80% water, rusten, dan laatste 20% toevoegen - staat makkelijkere glutenontwikkeling toe in zeer natte degen (80%+ hydratatie)"
        },
        {
                  "en": "Using two different types of water (tap and bottled)",
                  "es": "Usar dos tipos diferentes de agua (grifo y embotellada)",
                  "de": "Zwei verschiedene Wassertypen verwenden (Leitungs- und Flaschenwasser)",
                  "nl": "Twee verschillende soorten water gebruiken (kraan en fles)"
        },
        {
                  "en": "Boiling dough twice before baking",
                  "es": "Hervir masa dos veces antes de hornear",
                  "de": "Teig zweimal kochen vor dem Backen",
                  "nl": "Deeg twee keer koken voor bakken"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "British way of slicing bread into perfect triangles",
                  "es": "Forma británica de cortar pan en triángulos perfectos",
                  "de": "Britische Art Brot in perfekte Dreiecke zu schneiden",
                  "nl": "Britse manier om brood in perfecte driehoeken te snijden"
        },
        {
                  "en": "German method of freezing bread after baking",
                  "es": "Método alemán de congelar pan después de hornear",
                  "de": "Deutsche Methode Brot nach dem Backen einzufrieren",
                  "nl": "Duitse methode om brood na bakken in te vriezen"
        },
        {
                  "en": "French method of adding final 5-10% water very gradually while kneading developed dough - allows achieving very high hydration while maintaining dough strength",
                  "es": "Método francés de añadir 5-10% final de agua muy gradualmente mientras se amasa masa desarrollada - permite lograr hidratación muy alta manteniendo fuerza de masa",
                  "de": "Französische Methode um finale 5-10% Wasser sehr graduell während des Knetens von entwickeltem Teig hinzuzufügen - ermöglicht sehr hohe Hydratation zu erreichen während Teigstärke erhalten bleibt",
                  "nl": "Franse methode om laatste 5-10% water zeer geleidelijk toe te voegen tijdens kneden van ontwikkeld deeg - staat toe zeer hoge hydratatie te bereiken terwijl deegsterkte behouden blijft"
        },
        {
                  "en": "Italian technique for making pizza dough crispy",
                  "es": "Técnica italiana para hacer masa de pizza crujiente",
                  "de": "Italienische Technik um Pizzateig knusprig zu machen",
                  "nl": "Italiaanse techniek om pizzadeeg knapperig te maken"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Skin forms on dough surface during proofing (dried out) - then separates from crumb during baking. Prevented by: covering dough, proper humidity, shorter proof, or misting",
                  "es": "Piel se forma en superficie de masa durante fermentación (secada) - luego se separa de miga durante horneado. Prevenido por: cubrir masa, humedad adecuada, fermentación más corta, o rociar",
                  "de": "Haut bildet sich auf Teigoberfläche während Gare (ausgetrocknet) - trennt sich dann von Krume während Backen. Verhindert durch: Teig abdecken, richtige Luftfeuchtigkeit, kürzere Gare, oder Besprühen",
                  "nl": "Huid vormt op deegoppervlak tijdens rijzing (uitgedroogd) - scheidt dan van kruim tijdens bakken. Voorkomen door: deeg afdekken, juiste vochtigheid, kortere rijs, of benevelen"
        },
        {
                  "en": "Baking bread during windy weather",
                  "es": "Hornear pan durante clima ventoso",
                  "de": "Brot backen bei windigem Wetter",
                  "nl": "Brood bakken tijdens winderig weer"
        },
        {
                  "en": "Using metal pans instead of glass causes this",
                  "es": "Usar moldes metálicos en lugar de vidrio causa esto",
                  "de": "Verwendung von Metallformen statt Glas verursacht dies",
                  "nl": "Gebruik van metalen vormen in plaats van glas veroorzaakt dit"
        },
        {
                  "en": "Adding too much yeast makes crust float away",
                  "es": "Añadir demasiada levadura hace que la corteza flote",
                  "de": "Zu viel Hefe lässt Kruste wegfliegen",
                  "nl": "Te veel gist toevoegen laat korst wegzweven"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Adding actual rope to dough for decoration",
                  "es": "Añadir cuerda real a la masa para decoración",
                  "de": "Tatsächliches Seil zum Teig hinzufügen zur Dekoration",
                  "nl": "Echt touw aan deeg toevoegen voor decoratie"
        },
        {
                  "en": "Normal aging process that makes bread chewy",
                  "es": "Proceso de envejecimiento normal que hace el pan masticable",
                  "de": "Normaler Alterungsprozess der Brot zäh macht",
                  "nl": "Normaal verouderingsproces dat brood taai maakt"
        },
        {
                  "en": "Bacterial spoilage (Bacillus subtilis) causing sticky, stringy texture and fruity odor in bread - prevented by: lowering pH (add vinegar/citric acid), proper cooling, sanitation",
                  "es": "Deterioro bacteriano (Bacillus subtilis) causando textura pegajosa, fibrosa y olor afrutado en pan - prevenido por: bajar pH (añadir vinagre/ácido cítrico), enfriamiento adecuado, sanitización",
                  "de": "Bakterieller Verderb (Bacillus subtilis) verursacht klebrige, faserige Textur und fruchtigen Geruch im Brot - verhindert durch: pH senken (Essig/Zitronensäure hinzufügen), richtiges Abkühlen, Hygiene",
                  "nl": "Bacterieel bederf (Bacillus subtilis) veroorzaakt plakkerige, draadachtige textuur en fruitige geur in brood - voorkomen door: pH verlagen (azijn/citroenzuur toevoegen), goed afkoelen, hygiëne"
        },
        {
                  "en": "Technique of braiding challah bread",
                  "es": "Técnica de trenzar pan challah",
                  "de": "Technik zum Flechten von Challah-Brot",
                  "nl": "Techniek van het vlechten van challahbrood"
        }
        ],
        correct: 2,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Sponge & dough: mix flour, water, yeast first (ferment 3-8 hrs), then add remaining ingredients - better flavor, shelf life, tolerance. Straight: all ingredients mixed at once - faster, simpler",
                  "es": "Esponja y masa: mezclar harina, agua, levadura primero (fermentar 3-8 hrs), luego añadir ingredientes restantes - mejor sabor, vida útil, tolerancia. Directa: todos ingredientes mezclados a la vez - más rápido, más simple",
                  "de": "Schwamm & Teig: Mehl, Wasser, Hefe zuerst mischen (3-8 Std fermentieren), dann restliche Zutaten hinzufügen - besserer Geschmack, Haltbarkeit, Toleranz. Direkt: alle Zutaten auf einmal gemischt - schneller, einfacher",
                  "nl": "Spons & deeg: meel, water, gist eerst mengen (3-8 uur fermenteren), dan resterende ingrediënten toevoegen - betere smaak, houdbaarheid, tolerantie. Direct: alle ingrediënten tegelijk gemengd - sneller, simpeler"
        },
        {
                  "en": "Straight dough uses more yeast and longer fermentation",
                  "es": "Masa directa usa más levadura y fermentación más larga",
                  "de": "Direkter Teig verwendet mehr Hefe und längere Fermentation",
                  "nl": "Direct deeg gebruikt meer gist en langere fermentatie"
        },
        {
                  "en": "They are exactly the same method",
                  "es": "Son exactamente el mismo método",
                  "de": "Sie sind genau die gleiche Methode",
                  "nl": "Ze zijn precies dezelfde methode"
        },
        {
                  "en": "Sponge method is only for cake, dough method is only for bread",
                  "es": "Método de esponja es solo para pastel, método de masa es solo para pan",
                  "de": "Schwammmethode ist nur für Kuchen, Teigmethode nur für Brot",
                  "nl": "Sponsmethode is alleen voor cake, deegmethode is alleen voor brood"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Chemical additive banned in most countries",
                  "es": "Aditivo químico prohibido en la mayoría de países",
                  "de": "Chemischer Zusatzstoff in den meisten Ländern verboten",
                  "nl": "Chemische toevoeging verboden in de meeste landen"
        },
        {
                  "en": "Type of flour only grown in France",
                  "es": "Tipo de harina solo cultivada en Francia",
                  "de": "Mehltyp nur in Frankreich angebaut",
                  "nl": "Type meel alleen geteeld in Frankrijk"
        },
        {
                  "en": "Metal tool used to score artisan bread",
                  "es": "Herramienta metálica usada para marcar pan artesanal",
                  "de": "Metallwerkzeug zum Einschneiden von handwerklichem Brot",
                  "nl": "Metalen gereedschap gebruikt om ambachtelijk brood te scoren"
        },
        {
                  "en": "Enzyme that breaks down starches into sugars - provides food for yeast, improves crust color (Maillard), extends shelf life. Found naturally in flour, activated during fermentation",
                  "es": "Enzima que descompone almidones en azúcares - proporciona alimento para levadura, mejora color de corteza (Maillard), extiende vida útil. Se encuentra naturalmente en harina, activada durante fermentación",
                  "de": "Enzym das Stärken in Zucker abbaut - liefert Nahrung für Hefe, verbessert Krustenfarbe (Maillard), verlängert Haltbarkeit. Natürlich in Mehl vorhanden, während Fermentation aktiviert",
                  "nl": "Enzym dat zetmelen afbreekt tot suikers - levert voedsel voor gist, verbetert korstkleur (Maillard), verlengt houdbaarheid. Natuurlijk aanwezig in meel, geactiveerd tijdens fermentatie"
        }
        ],
        correct: 3,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Industrial method using high-speed mechanical mixing (intense energy) + dough improvers to make bread in 3.5 hrs (no bulk fermentation) - widely used in UK/commercial bakeries",
                  "es": "Método industrial usando mezcla mecánica de alta velocidad (energía intensa) + mejoradores de masa para hacer pan en 3.5 hrs (sin fermentación en masa) - ampliamente usado en UK/panaderías comerciales",
                  "de": "Industrielle Methode mit Hochgeschwindigkeits-mechanischem Mischen (intensive Energie) + Teigverbesserer um Brot in 3,5 Std zu machen (keine Stockgare) - weit verbreitet in UK/kommerziellen Bäckereien",
                  "nl": "Industriële methode met hoge-snelheid mechanisch mixen (intense energie) + deegverbeteraars om brood te maken in 3,5 uur (geen bulk fermentatie) - breed gebruikt in UK/commerciële bakkerijen"
        },
        {
                  "en": "Traditional hand-kneading technique from medieval England",
                  "es": "Técnica tradicional de amasado a mano de la Inglaterra medieval",
                  "de": "Traditionelle Handknettechnik aus dem mittelalterlichen England",
                  "nl": "Traditionele handkneedtechniek uit middeleeuws Engeland"
        },
        {
                  "en": "Slow fermentation method taking 48 hours",
                  "es": "Método de fermentación lenta que toma 48 horas",
                  "de": "Langsame Fermentationsmethode die 48 Stunden dauert",
                  "nl": "Langzame fermentatiemethode die 48 uur duurt"
        },
        {
                  "en": "Type of sourdough starter cultivated in Chorleywood forest",
                  "es": "Tipo de masa madre cultivada en el bosque de Chorleywood",
                  "de": "Art von Sauerteig-Starter im Chorleywood-Wald kultiviert",
                  "nl": "Type zuurdesem starter gekweekt in Chorleywood bos"
        }
        ],
        correct: 0,
        explanation: {
      ...
      },
      {
        ...
        options: [
        {
                  "en": "Special scoring pattern on top of artisan loaves",
                  "es": "Patrón de marcado especial en la parte superior de panes artesanales",
                  "de": "Spezielles Einschnittmuster auf handwerklichen Laiben",
                  "nl": "Speciaal scorepatroon op bovenkant van ambachtelijke broden"
        },
        {
                  "en": "Photo showing cross-section of sliced bread to display internal crumb structure - used to judge: hole size/distribution, texture, proper fermentation, gluten development",
                  "es": "Foto mostrando sección transversal de pan rebanado para mostrar estructura de miga interna - usado para juzgar: tamaño/distribución de agujeros, textura, fermentación adecuada, desarrollo de gluten",
                  "de": "Foto zeigt Querschnitt von geschnittenem Brot um innere Krumenstruktur zu zeigen - verwendet um zu beurteilen: Lochgröße/-verteilung, Textur, richtige Fermentation, Glutenentwicklung",
                  "nl": "Foto toont doorsnede van gesneden brood om interne kruimstructuur te tonen - gebruikt om te beoordelen: gatgrootte/-verdeling, textuur, juiste fermentatie, glutenontwikkeling"
        },
        {
                  "en": "Technique for creating holes in ciabatta using tools",
                  "es": "Técnica para crear agujeros en ciabatta usando herramientas",
                  "de": "Technik zum Erzeugen von Löchern in Ciabatta mit Werkzeugen",
                  "nl": "Techniek voor het creëren van gaten in ciabatta met gereedschap"
        },
        {
                  "en": "Type of camera specifically designed for food photography",
                  "es": "Tipo de cámara específicamente diseñada para fotografía de comida",
                  "de": "Kameratyp speziell für Food-Fotografie entwickelt",
                  "nl": "Type camera speciaal ontworpen voor foodfotografie"
        }
        ],
        correct: 1,
        explanation: {
      ...
      },
      {
        ...
        {
                  "en": "Ropiness is safe to eat, mold is dangerous",
                  "es": "Ropiness es seguro para comer, moho es peligroso",
                  "de": "Fadenzieher ist sicher zu essen, Schimmel ist gefährlich",
                  "nl": "Ropiness is veilig om te eten, schimmel is gevaarlijk"
        },
        {
                  "en": "Mold happens in dry conditions, ropiness in wet",
                  "es": "Moho ocurre en condiciones secas, ropiness en húmedas",
                  "de": "Schimmel passiert in trockenen Bedingungen, Fadenzieher in nassen",
                  "nl": "Schimmel gebeurt in droge omstandigheden, ropiness in natte"
        },
        {
                  "en": "Ropiness: bacterial (Bacillus), sticky/stringy inside, fruity smell, happens in fresh warm bread. Mold: fungal growth on surface, fuzzy appearance, happens after several days in moisture",
                  "es": "Ropiness: bacteriano (Bacillus), pegajoso/fibroso dentro, olor afrutado, ocurre en pan fresco caliente. Moho: crecimiento fúngico en superficie, apariencia peluda, ocurre después de varios días en humedad",
                  "de": "Fadenzieher: bakteriell (Bacillus), klebrig/faserig innen, fruchtiger Geruch, passiert in frischem warmem Brot. Schimmel: Pilzwachstum auf Oberfläche, flaumiges Aussehen, passiert nach mehreren Tagen in Feuchtigkeit",
                  "nl": "Ropiness: bacterieel (Bacillus), plakkerig/draadachtig binnen, fruitige geur, gebeurt in vers warm brood. Schimmel: schimmelgroei op oppervlak, pluizig uiterlijk, gebeurt na meerdere dagen in vochtigheid"
        }
        ],
        correct: 3,
        explanation: {
